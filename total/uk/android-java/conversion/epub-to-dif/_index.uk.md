...
description: Перетворюйте файли EPUB у DIF за допомогою бібліотеки перетворення Android.  
...
{{< blocks/products/pf/feature-page-header h1="Код Android для перетворення файлів EPUB" h2="Розробіть потужну програму для перетворення й експорту EPUB на базі Android.  Перетворіть один або декілька файлів EPUB у DIF та інші формати за допомогою API автоматизації Android." >}}
...
{{% blocks/products/pf/agp/code-block title="Код Android для перетворення EPUB на DIF" offSpacer="" %}}
...
Ще кілька випадків для збереження EPUB у DIF з іншими функціями.
