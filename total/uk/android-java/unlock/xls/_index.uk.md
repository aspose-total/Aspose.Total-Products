---
title: Видаліть XLS Password Protection онлайн або за допомогою мобільних програм Android
description: Видаліть пароль із документа XLS через онлайн-додаток безкоштовно. Код Android API для розблокування захищених паролем файлів XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Розблокуйте пароль документа XLS онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту XLS для блокування та розблокування документів на основі Android. Перерахований код для зняття обмежень пароля з файлу XLS." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Розблокуйте пароль XLS онлайн" %}}

1. Імпортуйте файл XLS, щоб розблокувати його, завантаживши його.
...
{{% blocks/products/pf/agp/feature-section-col title="Видаліть пароль XLS за допомогою програми Android" %}}

1. Довідкова android бібліотека в рамках проекту
1. Завантажте захищений паролем файл XLS за допомогою класу Workbook
...
{{% blocks/products/pf/agp/code-block title="Код: видалити пароль із документа XLS" offSpacer="" %}}
