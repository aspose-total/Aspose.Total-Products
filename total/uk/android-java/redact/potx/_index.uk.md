---
title: Відредагуйте презентацію POTX онлайн або за допомогою мобільних програм Android
description: Відкривайте та редагуйте документ POTX онлайн за допомогою програми безкоштовно. Код Android API для пошуку та заміни тексту POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ POTX онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту редагування презентацій POTX на базі Android. Перелік кодів для пошуку та заміни тексту у файлі POTX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Редагувати онлайн-презентацію POTX" %}}

1. Імпортуйте файл POTX, завантаживши його.
...
{{% blocks/products/pf/agp/feature-section-col title="Відредагуйте файл POTX за допомогою програми Android" %}}

1. Додайте посилання на бібліотеку до проекту Android  
1. Завантажте файл POTX за допомогою класу презентації
1. Використовуйте метод findAndReplaceText класу SlideUtil
1. Надайте відповідні параметри, зокрема пошук і заміну тексту
1. Збережіть файл POTX
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Код: відредагувати презентацію POTX" offSpacer="" %}}
