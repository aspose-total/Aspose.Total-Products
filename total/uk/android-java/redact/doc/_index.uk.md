---
title: Відредагуйте документ DOC онлайн або за допомогою мобільних програм Android
description: Відкривайте та редагуйте документ DOC онлайн за допомогою програми безкоштовно. Код Android API для пошуку та заміни тексту DOC регулярним виразом.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ DOC онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту редагування документів DOC на базі Android. Перерахований код для пошуку та заміни тексту у файлі DOC за допомогою регулярного виразу." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Відредагуйте файл DOC за допомогою програми Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Код: відредагувати документ DOC" offSpacer="" %}}
