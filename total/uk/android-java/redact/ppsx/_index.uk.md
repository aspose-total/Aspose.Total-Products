---
title: Відредагуйте презентацію PPSX онлайн або за допомогою мобільних програм Android
description: Відкривайте та редагуйте документ PPSX онлайн за допомогою програми безкоштовно. Код Android API для пошуку та заміни тексту PPSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ PPSX онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту редагування презентацій PPSX на базі Android. Перелік кодів для пошуку та заміни тексту у файлі PPSX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Редагувати онлайн-презентацію PPSX" %}}

1. Імпортуйте файл PPSX, завантаживши його.
...
{{% blocks/products/pf/agp/feature-section-col title="Відредагуйте файл PPSX за допомогою програми Android" %}}

1. Додайте посилання на бібліотеку до проекту Android  
1. Завантажте файл PPSX за допомогою класу презентації
1. Використовуйте метод findAndReplaceText класу SlideUtil
1. Надайте відповідні параметри, зокрема пошук і заміну тексту
1. Збережіть файл PPSX
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Код: відредагувати презентацію PPSX" offSpacer="" %}}
