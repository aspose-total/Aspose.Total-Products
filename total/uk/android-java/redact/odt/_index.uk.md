---
title: Відредагуйте документ ODT онлайн або за допомогою мобільних програм Android
description: Відкривайте та редагуйте документ ODT онлайн за допомогою програми безкоштовно. Код Android API для пошуку та заміни тексту ODT регулярним виразом.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ ODT онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту редагування документів ODT на базі Android. Перерахований код для пошуку та заміни тексту у файлі ODT за допомогою регулярного виразу." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Відредагуйте файл ODT за допомогою програми Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Код: відредагувати документ ODT" offSpacer="" %}}
