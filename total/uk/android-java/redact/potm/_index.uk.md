---
title: Відредагуйте презентацію POTM онлайн або за допомогою мобільних програм Android
description: Відкривайте та редагуйте документ POTM онлайн за допомогою програми безкоштовно. Код Android API для пошуку та заміни тексту POTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ POTM онлайн або за допомогою програм Android" h2="Розробіть потужну утиліту редагування презентацій POTM на базі Android. Перелік кодів для пошуку та заміни тексту у файлі POTM." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Редагувати онлайн-презентацію POTM" %}}

1. Імпортуйте файл POTM, завантаживши його.
...
{{% blocks/products/pf/agp/feature-section-col title="Відредагуйте файл POTM за допомогою програми Android" %}}

1. Додайте посилання на бібліотеку до проекту Android  
1. Завантажте файл POTM за допомогою класу презентації
1. Використовуйте метод findAndReplaceText класу SlideUtil
1. Надайте відповідні параметри, зокрема пошук і заміну тексту
1. Збережіть файл POTM
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Код: відредагувати презентацію POTM" offSpacer="" %}}
