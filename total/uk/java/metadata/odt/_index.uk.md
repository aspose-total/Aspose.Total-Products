---
title: Перегляньте та оновіть властивості ODT онлайн або оновіть метадані за допомогою Java
description: Безкоштовно переглядайте та змінюйте властивості ODT через онлайн-програму. Код Java API для оновлення властивостей ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Перегляньте або оновіть метадані ODT онлайн або оновіть через Java" h2="Розробіть потужну утиліту керування метаданими документа ODT на основі Java. Перерахований код для оновлення метаданих файлу ODT через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Оновіть властивості ODT через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Код Java для оновлення метаданих ODT" offSpacer="" %}}
