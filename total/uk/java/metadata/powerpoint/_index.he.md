---
title: Перегляд і оновлення властивостей Powerpoint онлайн або оновлення метаданих за допомогою Java
description: Безкоштовно переглядайте та змінюйте властивості Powerpoint через онлайн-програму. Код Java API для оновлення властивостей Powerpoint.
...
{{< blocks/products/pf/feature-page-header-widget h1="Перегляньте або оновіть метадані Powerpoint онлайн або оновіть через Java" h2="Розробіть потужну утиліту керування метаданими документів Powerpoint на основі Java. Перерахований код для оновлення метаданих файлу Powerpoint через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Оновіть властивості Powerpoint через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Код Java для оновлення метаданих Powerpoint" offSpacer="" %}}
