---
title: Перегляд і оновлення властивостей ODP онлайн або оновлення метаданих за допомогою Java
description: Безкоштовно переглядайте та змінюйте властивості ODP через онлайн-програму. Код Java API для оновлення властивостей ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Перегляньте або оновіть метадані ODP онлайн або оновіть через Java" h2="Розробіть потужну утиліту керування метаданими документів ODP на основі Java. Перерахований код для оновлення метаданих файлу ODP через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Оновіть властивості ODP через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Код Java для оновлення метаданих ODP" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Управління метаданими в файлах презентацій ODP за допомогою API в додатках Java покращує організацію та співпрацю в екосистемах з відкритим вихідним кодом.

**Ключові використання:**
- Організація слайд-деків на платформах співпраці з відкритим вихідним кодом.
- Відстеження історії редакцій та власності слайдів.
- Категоризація вмісту презентацій для баз знань компанії.

**Сценарії автоматизації:**
- Фільтрація слайдів за метаданими, такими як заголовок та тема.
- Вилучення ключових метаданих у пакетних робочих процесах.
- Використання штучного інтелекту для розмічання та класифікації слайд-деків інтелектуально.
