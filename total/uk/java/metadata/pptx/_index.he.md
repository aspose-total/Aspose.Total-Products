---
title: Перегляд і оновлення властивостей PPTX онлайн або оновлення метаданих за допомогою Java
description: Безкоштовно переглядайте та змінюйте властивості PPTX через онлайн-програму. Код Java API для оновлення властивостей PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Перегляньте або оновіть метадані PPTX онлайн або оновіть через Java" h2="Розробіть потужну утиліту керування метаданими документів PPTX на основі Java. Перерахований код для оновлення метаданих файлу PPTX через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Оновіть властивості PPTX через Java" %}}

1. Додайте до проекту посилання на бібліотеку Java
1. Завантажте файл PPTX за допомогою класу презентації
1. Отримати всі властивості через getDocumentProperties()
1. Щоб оновити, використовуйте метод встановлення відповідних властивостей, наприклад setAuthor, setSubject
...
{{% blocks/products/pf/agp/code-block title="Код Java для оновлення метаданих PPTX" offSpacer="" %}}
