---
title: Перетворіть MD на XAMLFLOW за допомогою програми на основі Java
description: Перетворіть файли MD у XAMLFLOW за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів MD у файли XAMLFLOW" h2="Розробіть потужну програму перетворення й експорту MD на основі Java. Перетворіть один або кілька файлів MD у XAMLFLOW та інші формати за допомогою Java Automation API." >}}
