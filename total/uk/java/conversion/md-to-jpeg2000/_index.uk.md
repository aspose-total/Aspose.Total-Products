---
title: Перетворіть MD на JPEG2000 за допомогою програми на основі Java
description: Перетворіть файли MD у JPEG2000 за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів MD у файли JPEG2000" h2="Розробіть потужну програму перетворення й експорту MD на основі Java. Перетворіть один або кілька файлів MD у JPEG2000 та інші формати за допомогою Java Automation API." >}}
