---
title: Перетворіть PS на PPS за допомогою програми на основі Java
description: Перетворіть файли PS у PPS за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів PS у файли PPS" h2="Розробіть потужну програму перетворення й експорту PS на основі Java. Перетворіть один або кілька файлів PS у PPS та інші формати за допомогою Java Automation API." >}}
