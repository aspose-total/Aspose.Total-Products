---
title: Перетворіть MD на POTX за допомогою програми на основі Java
description: Перетворіть файли MD у POTX за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів MD у файли POTX" h2="Розробіть потужну програму перетворення й експорту MD на основі Java. Перетворіть один або кілька файлів MD у POTX та інші формати за допомогою Java Automation API." >}}
