---
title: Перетворіть PS на DOT за допомогою програми на основі Java
description: Перетворіть файли PS у DOT за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів PS у файли DOT" h2="Розробіть потужну програму перетворення й експорту PS на основі Java. Перетворіть один або кілька файлів PS у DOT та інші формати за допомогою Java Automation API." >}}
