---
title: Перетворіть MD на DIF за допомогою програми на основі Java
description: Перетворіть файли MD у DIF за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів MD у файли DIF" h2="Розробіть потужну програму перетворення й експорту MD на основі Java. Перетворіть один або кілька файлів MD у DIF та інші формати за допомогою Java Automation API." >}}
