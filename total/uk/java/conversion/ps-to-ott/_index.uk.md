---
title: Перетворіть PS на OTT за допомогою програми на основі Java
description: Перетворіть файли PS у OTT за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів PS у файли OTT" h2="Розробіть потужну програму перетворення й експорту PS на основі Java. Перетворіть один або кілька файлів PS у OTT та інші формати за допомогою Java Automation API." >}}
