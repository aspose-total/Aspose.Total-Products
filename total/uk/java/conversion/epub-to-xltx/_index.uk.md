---
title: Перетворіть EPUB на XLTX за допомогою програми на основі Java
description: Перетворіть файли EPUB у XLTX за допомогою коду бібліотеки перетворення Java.  
...
{{< blocks/products/pf/feature-page-header h1="Код Java для перетворення файлів EPUB у файли XLTX" h2="Розробіть потужну програму перетворення й експорту EPUB на основі Java. Перетворіть один або кілька файлів EPUB у XLTX та інші формати за допомогою Java Automation API." >}}
