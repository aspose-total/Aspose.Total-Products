---
title: Відредагуйте документ PDF онлайн або за допомогою Java
description: Відкривайте та редагуйте документ PDF онлайн за допомогою програми безкоштовно. Код Java API для пошуку та заміни тексту PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Відредагуйте документ PDF онлайн або через Java" h2="Розробіть потужну утиліту редагування документів PDF на основі Java. Перелік кодів для пошуку та заміни тексту у файлі PDF через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Редагувати файл PDF через Java" %}}

1. Додайте посилання на бібліотеку до проекту Java  
1. Завантажте файл PDF за допомогою класу документа
1. Використовуйте об’єкт класу TextFragmentAbsorber із пошуковими термінами як параметром
...
{{% blocks/products/pf/agp/code-block title="Код Java: відредагувати документ PDF" offSpacer="" %}}
...
<h2>Розробка програми редагування PDF через Java</h2>

Потрібно розробити програму чи утиліту редагування PDF? Завдяки [Aspose.PDF for Java](https://products.aspose.com/pdf/java/), дочірньому API [Aspose.Total for Java](https://products.aspose.com/total/java/), будь-який розробник Java може інтегрувати наведений вище код API у свою програму редагування документів. Потужна бібліотека Java дозволяє програмувати будь-яке рішення для редагування документів. Крім того, він може підтримувати багато популярних форматів, включаючи формат PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утиліта Java для редагування файлу PDF" %}}
