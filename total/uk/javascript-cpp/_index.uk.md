---
title: Обробка PDF-файлів і додавання OCR через JavaScript API
description: JavaScript API для роботи з PDF-документами, а також для додавання функції OCR у веб-програми.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaScript API для PDF і OCR" h2="Додайте функції оптичного розпізнавання тексту та обробки PDF-файлів у веб-програми без будь-яких інших програмних залежностей" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total for JavaScript via C++ — це комплексний набір бібліотек JavaScript. Ці бібліотеки пропонують такі функції, як безпосередня робота з PDF-файлами у веб-браузерах і вдосконалення ваших програм за допомогою можливостей оптичного розпізнавання символів.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for JavaScript via C++ містить такі бібліотеки JavaScript:" >}}
...
Aspose.PDF for JavaScript via C++ — це зручний і безпечний інструментарій, призначений для роботи з PDF-файлами безпосередньо у веб-переглядачах. Ця бібліотека підтримує 26 мов, включаючи латиницю, кирилицю та китайські ієрогліфи.<br><br>

Це легке рішення, яке дозволяє розробникам ефективно обробляти PDF-файли за допомогою JavaScript. Він одночасно масштабований і багатофункціональний, що дозволяє розробникам створювати власні продукти для обробки PDF на основі JavaScript і легко ділитися ними в мережі.<br><br>
...
Aspose.OCR for JavaScript via C++ надає вашим програмам ефективне оптичне розпізнавання символів лише за допомогою 8 рядків коду. <br><br>

JavaScript OCR API є універсальним, здатним розпізнавати вміст зі сканованих зображень, фотографій зі смартфона, знімків екрана, окремих областей зображення та сканованих PDF-файлів. Він надає результати в популярних форматах обміну документами та даними. Примітно, що API працює в автономному режимі, усуваючи необхідність підключення до Інтернету.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for JavaScript via C++ пропонує низку потужних функцій для оптимізації керування шрифтами. Він дозволяє без зусиль конвертувати шрифт безпосередньо в браузері, підтримує зручну роботу з різноманітними форматами, як-от TTF, EOT, WOFF, CFF і Type1, і надає повний доступ до метаданих шрифтів для детального аналізу.
...
<h2 class="pr-ft">
 ...
 Огляд JavaScript через бібліотеки C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Додайте зображення в документи PDF
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Витягує текст із зображень і створює PDF-файли з можливістю пошуку
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Підтримує будь-яке зображення, яке можна отримати зі сканера чи камери
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Читає розширену латиницю та кирилицю
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Розпізнає понад 6000 китайських ієрогліфів
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Виявляє та розпізнає всі популярні шрифти та форматування
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Попередньо обробляє зображення перед розпізнаванням
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Обробляє все зображення або лише вибрані ділянки
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Підтримує повернуті, перекошені та зашумлені зображення
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Пакетне розпізнавання всіх зображень в папці або архіві
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Розпізнає зображення, надані як веб-посилання
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Знаходить і автоматично виправляє слова з помилками
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Отримайте результат розпізнавання як JSON
    </p>
   </div>
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total пропонує індивідуальні рішення для інших платформ." >}}
 ...
 {{< blocks/products/pf/offers-section-item link="/total/uk/nodejs-cpp/" imgSrc="/total/images/aspose_total-for-nodejs-cpp.svg" sdkName=" Node.js via C++" >}}
