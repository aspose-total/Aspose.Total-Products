---
title: Переглядайте та оновлюйте властивості DOTM онлайн або оновлюйте метадані за допомогою .NET
description: Безкоштовно переглядайте та змінюйте властивості DOTM через онлайн-програму. Код C# .NET API для оновлення властивостей DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Перегляд або оновлення метаданих DOTM онлайн або оновлення через .NET" h2="Розробіть потужну утиліту для керування метаданими документів DOTM на основі .NET. Перерахований код для оновлення метаданих файлу DOTM через .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Оновіть властивості DOTM через .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Код .NET: оновіть метадані DOTM" offSpacer="" %}}
...
<h2>Розробка програми керування метаданими DOTM через .NET</h2>

Потрібно розробити додаток або утиліту для керування метаданими DOTM? Завдяки [Aspose.Words for .NET](https://products.aspose.com/words/net/), дочірньому API [Aspose.Total for .NET](https://products.aspose.com/total/uk/net/), будь-який розробник .NET може інтегрувати наведений вище код API у свою програму метаданих документів. Потужна бібліотека .NET дозволяє програмувати будь-яке рішення метаданих документів. Крім того, він може підтримувати багато популярних форматів, включаючи формат DOTM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утиліта .NET для керування метаданими DOTM" %}}
