---
title: Витягніть текст і зображення з файлу ODS в Інтернеті та за допомогою .NET
description: Інтернет-додаток аналізатора файлів ODS. Код .NET API C# для вилучення тексту в рядках і комірках з електронних таблиць ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Проаналізуйте файл ODS онлайн, а також через .NET" h2="Розробіть потужну утиліту аналізатора документів ODS на основі .NET. Перелік кодів C# для аналізу документа ODS." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Проаналізуйте файл ODS через .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Код C#: Вилучення зображень з електронних таблиць ODS" offSpacer="" %}}

{{< gist "aspose-com-gists" "56e34ac75fba2313ae00be996cc53d39" "parse-excel-spreadsheet-for-images-extraction.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Код C#: Вилучення тексту електронної таблиці ODS" offSpacer="" %}}
