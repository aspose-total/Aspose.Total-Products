---
title: Маніпуляції з PDF-файлами та додавання OCR через API Node.js
description: API Node.js для роботи з файлами PDF, а також для вилучення тексту із зображень за допомогою програм.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API для вилучення PDF-файлів і тексту зображень" h2="Витягуйте текст із зображень, а також включайте функції обробки PDF-файлів у програмах Node.js без будь-яких інших програмних залежностей" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ — це комплексний набір бібліотек Node.js.  Ці бібліотеки пропонують такі функції, як робота безпосередньо з PDF-файлами та вдосконалення програм для перетворення зображень на текст.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ включає такі бібліотеки Node.js:" >}}
...
Aspose.PDF for Node.js via C++ дає змогу обробляти PDF-файли на сервері.  Використовуючи його, ви можете оптимізувати PDF-файли, включати та видобувати текст і зображення, а також запроваджувати процеси шифрування та дешифрування.  Крім того, функціональні можливості поширюються на можливість легко розділяти та об’єднувати PDF-документи, забезпечуючи комплексний набір інструментів для спрощеної роботи з PDF-файлами.
...
Aspose.OCR for Node.js via C++ дає змогу витягувати текст із зображень, наприклад зі сканованих сторінок і фотографій, на платформах, сумісних з Node.js.  Удосконалюйте локальні продукти, веб-сервіси та безсерверні програми потужною функцією оптичного розпізнавання символів із підтримкою 28 мов, включаючи китайську та хінді в популярних форматах.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for Node.js via C++ дозволяє розробникам завантажувати, відтворювати та зберігати різні формати шрифтів, включаючи TrueType, WOFF, EOT, OpenType, CFF і Type1. Розроблено для спрощення складних операцій зі шрифтами, щоб розробники Node.js могли легко зосередитися на створенні виняткових програм без клопоту складної обробки шрифтів.
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 Огляд Node.js через бібліотеки C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
Ми маємо значний досвід роботи з офісною автоматизацією та продуктом Office Writer від Soft Artisans.  Total.NET від Aspose більш надійний і пропонує більше функціональних можливостей, ніж будь-що, що ми використовували в минулому.
{{< /blocks/products/pf/testimonials-quote >}}
...
imgSrc="/total/images/aspose_total-for-node-java.svg" sdkName=" Node.js via Java" >}}
 ...
 {{< blocks/products/pf/offers-section-item link="/total/uk/javascript-cpp/" imgSrc="/total/images/aspose_total-for-javascript-cpp.svg" sdkName=" JavaScript via C++" >}}
