---
title: ทำซ้ำการนำเสนอ ODP ออนไลน์หรือใช้ Java
description: เปิดและแก้ไขเอกสาร ODP ออนไลน์ผ่านแอปได้ฟรีรหัส Java API เพื่อค้นหาและแทนที่ข้อความ ODP
...
{{< blocks/products/pf/feature-page-header-widget h1="ตรวจทานเอกสาร ODP ออนไลน์หรือผ่าน Java" h2="พัฒนาแอปพลิเคชันอรรถประโยชน์การนำเสนอ ODP ที่ใช้ Java ที่ทรงพลังรหัสที่แสดงสำหรับการค้นหาและแทนที่ข้อความในไฟล์ ODP ผ่านทาง Java" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานไฟล์ ODP ผ่าน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส Java: ทำซ้ำการนำเสนอ ODP" offSpacer="" %}}
