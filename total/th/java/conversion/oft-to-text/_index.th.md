---
title: ส่งออก OFT เป็น TEXT ผ่าน Java
description: Java API เพื่อแปลง OFT เป็น TEXT โดยไม่ต้องใช้ Microsoft Word หรือ Outlook
url_ignore: /th/java/conversion/oft-to-text/
family: total
platformtag: net
feature: conversion
informat: OFT
