---
title: Java API เพื่อแปลง DOTX เป็น XLS
description: แปลง DOTX เป็น XLS ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/java/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง DOTX เป็น XLS ผ่าน Java" h2="บน Premise Java API เพื่อแปลง DOTX เป็น XLS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
