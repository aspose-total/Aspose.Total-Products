---
title: แปลง DOTX เป็น PPT ผ่าน Java
description: Java API เพื่อส่งออก DOTX ไปยัง PPT โดยไม่ต้องใช้ Microsoft Word หรือ PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง DOTX เป็น PPT ผ่าน Java" h2="การแปลง DOTX เป็น PPT โดยใช้ Java API ภายในภายในแอปพลิเคชัน Java J2SE, J2EE, J2ME โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> PowerPoint หรือ Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง DOTX เป็น PPT ผ่าน Java" %}}
...
สำหรับการแปลงไฟล์ DOTX เป็น PPT คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) ตามโครงการและรวมไลบรารีใน pom.xml ของคุณ
