---
title: แปลง TSV เป็น DOC โดยใช้ Java
description: Java API เพื่อส่งออก TSV เป็น DOC โดยใช้ Excel หรือ Word
url: /th/java/conversion/tsv-to-doc/
family: total
platformtag: net
feature: conversion
informat: TSV
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก TSV เป็น DOC" h2="บน Premise Java API เพื่อส่งออก TSV ไปยัง DOC โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
...
1. เปิดไฟล์ TSV โดยใช้คลาส [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/tsv-to-docx/" name="TSV ถึง DOCX" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/tsv-to-pptx/" name="TSV ถึง PPTX" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/tsv-to-powerpoint/" name="TSV ถึง POWERPOINT" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/tsv-to-word/" name="TSV ถึง WORD" description="" >}}
