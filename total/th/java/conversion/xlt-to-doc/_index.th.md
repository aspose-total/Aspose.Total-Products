...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก XLT เป็น DOC หรือทางออนไลน์" h2="บน Premise Java API เพื่อส่งออก XLT ไปยัง DOC โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
