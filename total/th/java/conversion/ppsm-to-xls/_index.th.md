...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPSM เป็น XLS ผ่าน Java หรือทางออนไลน์" h2="บน Premise Java API เพื่อส่งออก PPSM เป็น XLS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง PPSM เป็น XLS ผ่าน Java หรือทางออนไลน์" %}}
