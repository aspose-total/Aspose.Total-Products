---
title: แปลง XPS เป็น SWF ผ่าน Java API
description: Java API เพื่อแปลง XPS เป็น SWF โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xps-to-swf/
family: total
platformtag: net
feature: conversion
informat: XPS
