---
title: แปลง XLTM เป็น WORD โดยใช้ Java
description: Java API เพื่อส่งออก XLTM เป็น WORD โดยใช้ Excel หรือ Word
url: /th/java/conversion/xltm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก XLTM เป็น WORD" h2="บน Premise Java API เพื่อส่งออก XLTM ไปยัง WORD โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
