---
title: แปลง XPS เป็น ODP ผ่าน Java API
description: Java API เพื่อแปลง XPS เป็น ODP โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xps-to-odp/
family: total
platformtag: net
feature: conversion
informat: XPS
