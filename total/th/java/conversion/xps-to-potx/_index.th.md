---
title: แปลง XPS เป็น POTX ผ่าน Java API
description: Java API เพื่อแปลง XPS เป็น POTX โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xps-to-potx/
family: total
platformtag: net
feature: conversion
informat: XPS
