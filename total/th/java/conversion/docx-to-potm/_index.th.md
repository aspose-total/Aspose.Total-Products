---
title: แปลง DOCX เป็น POTM ผ่าน Java
description: Java API เพื่อส่งออก DOCX ไปยัง POTM โดยไม่ต้องใช้ Microsoft Word หรือ PowerPoint
url: /th/java/conversion/docx-to-potm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง DOCX เป็น POTM ผ่าน Java" h2="การแปลง DOCX เป็น POTM โดยใช้ Java API ภายในภายในแอปพลิเคชัน Java J2SE, J2EE, J2ME โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> PowerPoint หรือ Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง DOCX เป็น POTM ผ่าน Java" %}}
...
สำหรับการแปลงไฟล์ DOCX เป็น POTM คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) ตามโครงการและรวมไลบรารีใน pom.xml ของคุณ
