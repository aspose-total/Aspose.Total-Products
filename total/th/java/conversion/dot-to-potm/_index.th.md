---
title: แปลง DOT เป็น POTM ผ่าน Java
description: Java API เพื่อส่งออก DOT ไปยัง POTM โดยไม่ต้องใช้ Microsoft Word หรือ PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง DOT เป็น POTM ผ่าน Java" h2="การแปลง DOT เป็น POTM โดยใช้ Java API ภายในภายในแอปพลิเคชัน Java J2SE, J2EE, J2ME โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> PowerPoint หรือ Word" >}}
...
สำหรับการแปลงไฟล์ DOT เป็น POTM คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) ตามโครงการและรวมไลบรารีใน pom.xml ของคุณ
