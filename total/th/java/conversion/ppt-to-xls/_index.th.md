...
description: แปลงรูปแบบ PPT เป็น XLS ผ่าน Java โดยไม่ต้องใช้ Microsoft Excel หรือ PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPT เป็น XLS ผ่าน Java" h2="บน Premise Java API เพื่อส่งออก PPT เป็น XLS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง PPT เป็น XLS ผ่าน Java" %}}
...
ในการแปลง PPT เป็น XLS คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ โครงการตาม aspose/aspose-total) และรวมไลบรารีใน pom.xml ของคุณ
