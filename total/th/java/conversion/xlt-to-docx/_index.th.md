---
title: แปลง XLT เป็น DOCX โดยใช้ Java
description: Java API เพื่อส่งออก XLT เป็น DOCX โดยใช้ Excel หรือ Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก XLT เป็น DOCX" h2="บน Premise Java API เพื่อส่งออก XLT ไปยัง DOCX โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
