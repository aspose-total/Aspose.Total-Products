...
description: แปลง MOBI เป็น FODS ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง MOBI เป็น FODS ผ่าน Java" h2="บน Premise Java API เพื่อแปลง MOBI เป็น FODS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
