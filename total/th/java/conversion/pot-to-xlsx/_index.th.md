...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง POT เป็น XLSX ผ่าน Java หรือทางออนไลน์" h2="บน Premise Java API เพื่อส่งออก POT เป็น XLSX โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง POT เป็น XLSX ผ่าน Java หรือทางออนไลน์" %}}
