---
title: แปลง XML เป็น PPS ผ่าน Java API
description: Java API เพื่อแปลง XML เป็น PPS โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xml-to-pps/
family: total
platformtag: net
feature: conversion
informat: XML
...
4. บันทึกเอกสารในรูปแบบ PPS โดยใช้เมธอด [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) และตั้งค่า ` Pps` เป็น SaveFormat
