---
title: แปลง FODS เป็น DOCX โดยใช้ Java
description: Java API เพื่อส่งออก FODS เป็น DOCX โดยใช้ Excel หรือ Word
url: /th/java/conversion/fods-to-docx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก FODS เป็น DOCX" h2="บน Premise Java API เพื่อส่งออก FODS ไปยัง DOCX โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
