---
title: แปลง XLSB เป็น DOC โดยใช้ Java
description: Java API เพื่อส่งออก XLSB เป็น DOC โดยใช้ Excel หรือ Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก XLSB เป็น DOC" h2="บน Premise Java API เพื่อส่งออก XLSB ไปยัง DOC โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
