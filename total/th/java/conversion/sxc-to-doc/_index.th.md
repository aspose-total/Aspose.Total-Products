---
title: แปลง SXC เป็น DOC โดยใช้ Java
description: Java API เพื่อส่งออก SXC เป็น DOC โดยใช้ Excel หรือ Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก SXC เป็น DOC" h2="บน Premise Java API เพื่อส่งออก SXC ไปยัง DOC โดยไม่ต้องพึ่ง Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/sxc-to-docx/" name="SXC ถึง DOCX" description="" >}}
