---
title: แปลง XML เป็น XAML ผ่าน Java API
description: Java API เพื่อแปลง XML เป็น XAML โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xml-to-xaml/
family: total
platformtag: net
feature: conversion
informat: XML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API เพื่อส่งออก XML เป็น XAML" h2="ส่งออก XML ไปยัง XAML ผ่าน Java API ในองค์กรโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> PowerPoint หรือ Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API เพื่อแปลง XML เป็น XAML" %}}
