---
title: Java API เพื่อแปลง DOCM เป็น CSV
description: แปลง DOCM เป็น CSV ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/java/conversion/docm-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง DOCM เป็น CSV ผ่าน Java" h2="บน Premise Java API เพื่อแปลง DOCM เป็น CSV โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C ++ API เพื่อแปลง DOCM เป็น CSV" %}}
