---
title: แปลง XML เป็น SWF ผ่าน Java API
description: Java API เพื่อแปลง XML เป็น SWF โดยไม่ต้องใช้ Microsoft Word
url_ignore: /th/java/conversion/xml-to-swf/
family: total
platformtag: net
feature: conversion
informat: XML
