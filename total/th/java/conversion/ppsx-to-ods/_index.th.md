...
description: แปลงรูปแบบ PPSX เป็น ODS ผ่าน Java โดยไม่ต้องใช้ Microsoft Excel หรือ PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPSX เป็น ODS ผ่าน Java" h2="บน Premise Java API เพื่อส่งออก PPSX เป็น ODS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง PPSX เป็น ODS ผ่าน Java" %}}
...
ในการแปลง PPSX เป็น ODS คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ โครงการตาม aspose/aspose-total) และรวมไลบรารีใน pom.xml ของคุณ
