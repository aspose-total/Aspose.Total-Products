---
title: สร้างภาพบาร์โค้ด AUSTRALIAPOST ผ่าน Python
description: สร้างภาพบาร์โค้ดสัญลักษณ์ AUSTRALIAPOST โดยใช้แอปพลิเคชัน Python โดยไม่ต้องใช้ซอฟต์แวร์อื่นใด. 
...
- สำหรับการสร้างบาร์โค้ด AUSTRALIAPOST จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="สร้าง AUSTRALIAPOST Symbology BarCode ใน Python" offSpacer="" %}}
