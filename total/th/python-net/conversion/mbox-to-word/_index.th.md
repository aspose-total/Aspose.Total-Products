---
title: แปลง MBOX เป็น WORD ใน Python
description: บันทึก MBOX เป็น WORD ในแอปพลิเคชัน Python ของคุณโดยไม่ต้องใช้ Microsoft Outlook หรือ Word 
url: /th/python-net/conversion/mbox-to-word/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- สำหรับการแปลง MBOX เป็น WORD จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก MBOX เป็น WORD ใน Python" offSpacer="" %}}
