...
- สำหรับการแปลง EMLX เป็น XPS จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก EMLX เป็น XPS ใน Python" offSpacer="" %}}
