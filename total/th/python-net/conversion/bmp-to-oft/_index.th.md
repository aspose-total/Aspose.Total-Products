...
- สำหรับการแปลง BMP เป็น OFT จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก BMP เป็น OFT ใน Python" offSpacer="" %}}
