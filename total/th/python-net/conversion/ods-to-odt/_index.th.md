---
title: แปลง ODS เป็น ODT โดยใช้ Python
description: การแปลง ODS เป็น ODT ในแอปพลิเคชัน Python โดยไม่ต้องใช้ Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="แปลง ODS เป็น ODT ผ่าน Python" h2="การแปลง ODS เป็น ODT ในแอปพลิเคชัน Python โดยไม่ต้องติดตั้ง Microsoft Excel<sup>&reg;</sup> หรือ Word" >}}
