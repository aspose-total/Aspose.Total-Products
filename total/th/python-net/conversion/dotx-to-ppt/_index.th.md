...
{{% blocks/products/pf/agp/feature-section-col title="แปลง DOTX เป็น PPT ใน Python" %}}
...
-  เรียกใช้เมธอด `บันทึก' ขณะที่ระบุพาธไฟล์เอาต์พุต & SaveFormat.PPT เป็นพารามิเตอร์ ดังนั้นไฟล์ DOTX ของคุณจะถูกแปลงเป็น PPT ตามเส้นทางที่ระบุ
