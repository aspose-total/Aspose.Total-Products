---
title: แปลง DOT เป็นรูปภาพใน Python
description: การแปลง DOT เป็นรูปภาพ TIFF BMP PNG JPEG GIF SVG ในแอปพลิเคชัน Python ของคุณโดยไม่ต้องใช้ Microsoft Word 
url: /th/python-net/conversion/dot-to-images/
family: total
platformtag: Python
feature: conversion
informat: DOT
...
- กำหนดคุณสมบัติ
- เรียกใช้เมธอด `บันทึก' ขณะส่งพาธไฟล์เอาต์พุต & ตัวเลือกที่ระบุเป็นพารามิเตอร์ ดังนั้นไฟล์ DOT ของคุณจะถูกแปลงเป็นรูปภาพตามเส้นทางที่ระบุ

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="ข้อกำหนดการแปลง" %}}

- สำหรับการแปลง DOT เป็นรูปภาพ (JPG, PNG, GIF, BMP, TIFF) จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก DOT เป็นรูปภาพใน Python - การแปลงอย่างง่าย" offSpacer="" %}}

{{< gist "aspose-com-gists" "fe7c3ff0a8c783e4f0ed6bff199c6800" "convert-documents-to-images-simple-in-python.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="การแปลง DOT เป็นรูปภาพด้วยตัวเลือกเฉพาะ" offSpacer="" %}}
