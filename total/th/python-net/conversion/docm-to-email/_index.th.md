---
title: แปลง DOCM เป็น EMAIL ใน Python
description: บันทึก DOCM เป็น EMAIL ภายในแอปพลิเคชัน Python โดยไม่ต้องใช้ Microsoft Word หรือ Outlook
url: /th/python-net/conversion/docm-to-email/
family: total
platformtag: Python
feature: conversion
informat: DOCM
...
- สำหรับการแปลง DOCM เป็น EMAIL จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก DOCM เป็น EMAIL ใน Python" offSpacer="" %}}
