...
- สำหรับการแปลง PST เป็น PNG จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก PST เป็น PNG ใน Python" offSpacer="" %}}
