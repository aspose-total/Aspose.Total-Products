---
title: แปลง ICS เป็น PS ใน Python
description: บันทึก ICS เป็น PS ในแอปพลิเคชัน Python ของคุณโดยไม่ต้องใช้ Microsoft Outlook หรือ Word 
url: /th/python-net/conversion/ics-to-ps/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- สำหรับการแปลง ICS เป็น PS จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก ICS เป็น PS ใน Python" offSpacer="" %}}
