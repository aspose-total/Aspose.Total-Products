---
title: แปลง EPUB เป็น ICS ใน Python
description: บันทึก EPUB เป็น ICS ภายในแอปพลิเคชัน Python โดยไม่ต้องใช้ Microsoft Word หรือ Outlook
url: /th/python-net/conversion/epub-to-ics/
family: total
platformtag: Python
feature: conversion
informat: EPUB
...
- สำหรับการแปลง EPUB เป็น ICS จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก EPUB เป็น ICS ใน Python" offSpacer="" %}}
