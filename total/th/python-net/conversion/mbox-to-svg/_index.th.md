...
- สำหรับการแปลง MBOX เป็น SVG จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก MBOX เป็น SVG ใน Python" offSpacer="" %}}
