---
title: แปลง DOTM เป็น POTM ใน Python
description: การแปลง DOTM เป็น POTM ในแอปพลิเคชัน Python ของคุณโดยไม่ต้องใช้ Microsoft Word หรือ PowerPoint 
url: /th/python-net/conversion/dotm-to-potm/
family: total
platformtag: Python
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOTM เป็น POTM โดยใช้ Python" h2="การแปลง DOTM เป็น POTM ในแอปพลิเคชัน Python ของคุณโดยไม่ต้องติดตั้ง Microsoft Word<sup>&reg;</sup> หรือ PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}

สำหรับนักพัฒนา Python ใครกำลังพยายามเพิ่มคุณสมบัติการแปลง DOTM เป็น POTM ภายในแอปพลิเคชัน ? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API สามารถช่วยทำให้กระบวนการแปลงเป็นไปโดยอัตโนมัติ เป็นแพ็คเกจเต็มรูปแบบของ API ต่างๆ ที่จัดการรูปแบบต่างๆ ดังนั้น **วิธีแปลง DOTM เป็น POTM ใน Python**
...
{{% blocks/products/pf/agp/feature-section-col title="แปลง DOTM เป็น POTM ใน Python" %}}
...
-  เรียกใช้เมธอด `บันทึก' ขณะที่ระบุพาธไฟล์เอาต์พุต & SaveFormat.POTM เป็นพารามิเตอร์ ดังนั้นไฟล์ DOTM ของคุณจะถูกแปลงเป็น POTM ตามเส้นทางที่ระบุ
