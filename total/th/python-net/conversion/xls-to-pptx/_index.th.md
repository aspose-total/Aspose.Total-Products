---
title: แปลง XLS เป็น PPTX โดยใช้ Python
description: การแปลง XLS เป็น PPTX ในแอปพลิเคชัน Python โดยไม่ต้องใช้ Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="แปลง XLS เป็น PPTX ผ่าน Python" h2="การแปลง XLS เป็น PPTX ในแอปพลิเคชัน Python โดยไม่ต้องติดตั้ง Microsoft Excel<sup>&reg;</sup> หรือ PowerPoint" >}}
