---
title: แปลง FLATOPC เป็น OFT ใน Python
description: บันทึก FLATOPC เป็น OFT ภายในแอปพลิเคชัน Python โดยไม่ต้องใช้ Microsoft Word หรือ Outlook
url: /th/python-net/conversion/flatopc-to-oft/
family: total
platformtag: Python
feature: conversion
informat: FLATOPC
...
- สำหรับการแปลง FLATOPC เป็น OFT จำเป็นต้องใช้ Python 3.5 หรือใหม่กว่า
...
{{% blocks/products/pf/agp/code-block title="บันทึก FLATOPC เป็น OFT ใน Python" offSpacer="" %}}
