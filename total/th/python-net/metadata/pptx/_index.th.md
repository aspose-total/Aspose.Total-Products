---
title: ดูและอัปเดตคุณสมบัติ PPTX ออนไลน์หรือใช้ Python
description: ดูและแก้ไขคุณสมบัติ PPTX ผ่านแอปออนไลน์ได้ฟรีรหัส Python API เพื่อดูและแก้ไขคุณสมบัติ PPTX
...
{{< blocks/products/pf/feature-page-header-widget h1="ดูหรืออัปเดตข้อมูลเมตา PPTX ออนไลน์หรือผ่าน Python" h2="พัฒนาแอปพลิเคชันยูทิลิตีการจัดการข้อมูลเมตาเอกสาร PPTX ที่ใช้ Python ที่ทรงพลังรหัสที่แสดงไว้สำหรับการแก้ไขและดูข้อมูลเมตาของไฟล์ PPTX ผ่าน Python" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ดูหรืออัปเดตข้อมูลเมตา PPTX ออนไลน์" %}}

1. นำเข้าไฟล์ PPTX โดยการอัปโหลด
...
{{% blocks/products/pf/agp/feature-section-col title="ดูหรือแก้ไขคุณสมบัติ PPTX ผ่าน Python" %}}
...
1. รับ Properteis ทั้งหมดผ่านทาง document_properties
1. วนซ้ำคุณสมบัติทั้งหมดแล้วพิมพ์
1. หากต้องการอัปเดต ให้ใช้เมธอด set_custom_property_value
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดใน Python เพื่อดูและอัปเดตข้อมูลเมตา PPTX" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>การใช้แอปออนไลน์เพื่อจัดการคุณสมบัติเอกสาร PPTX ปลอดภัยหรือไม่</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">คุณสามารถใช้เว็บเบราว์เซอร์สมัยใหม่เช่น Google Chrome, Firefox, Opera หรือ Safari สำหรับการจัดการคุณสมบัติเอกสาร PPTX ออนไลน์อย่างไรก็ตาม หากคุณกำลังพัฒนาแอปพลิเคชันบนเดสก์ท็อป เราขอแนะนำให้ใช้ API การประมวลผลเอกสาร Aspose.Total เพื่อการจัดการที่มีประสิทธิภาพ</span>
                      </div>
                  </li>
              </ul>
          </div>
