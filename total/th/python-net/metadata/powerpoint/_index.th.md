---
title: ดูและอัปเดตคุณสมบัติ POWERPOINT ออนไลน์หรือใช้ Python
description: ดูและแก้ไขคุณสมบัติ POWERPOINT ผ่านแอปออนไลน์ได้ฟรีรหัส Python API เพื่อดูและแก้ไขคุณสมบัติ POWERPOINT
...
{{< blocks/products/pf/feature-page-header-widget h1="ดูหรืออัปเดตข้อมูลเมตา POWERPOINT ออนไลน์หรือผ่าน Python" h2="พัฒนาแอปพลิเคชันยูทิลิตีการจัดการข้อมูลเมตาเอกสาร POWERPOINT ที่ใช้ Python ที่ทรงพลังรหัสที่แสดงไว้สำหรับการแก้ไขและดูข้อมูลเมตาของไฟล์ POWERPOINT ผ่าน Python" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ดูหรือแก้ไขคุณสมบัติ POWERPOINT ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดใน Python เพื่อดูและอัปเดตข้อมูลเมตา POWERPOINT" offSpacer="" %}}
