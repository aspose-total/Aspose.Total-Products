---
title: ลบคำอธิบายประกอบ PPS ออนไลน์หรือจัดการคำอธิบายประกอบผ่าน C ++
description: ลบความคิดเห็นออกจากไฟล์ PPS ผ่านแอปออนไลน์ฟรีรหัส C++ API เพื่อจัดการความคิดเห็นของไฟล์ PPS
...
{{< blocks/products/pf/feature-page-header-widget h1="ล้างความคิดเห็นจากการนำเสนอ PPS ออนไลน์หรือจัดการผ่าน C ++" h2="พัฒนาแอปพลิเคชันยูทิลิตีคำอธิบายประกอบการนำเสนอ PPS ที่ใช้ C++ ที่ทรงพลังรหัสที่แสดงสำหรับจัดการความคิดเห็นของไฟล์ PPS ผ่าน C ++" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ลบความคิดเห็นการนำเสนอ PPS ผ่าน C ++" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ C ++
1. โหลดการนำเสนอ PPS
1. วนซ้ำผู้เขียนแต่ละคนผ่านการนำเสนอ->get_CommentAuthors()
1. เรียกใช้เมธอด get_Comments()->Clear() เพื่อลบความคิดเห็น
1. เรียกใช้เมธอด get_CommentAuthors()->Clear() เพื่อลบผู้เขียนทั้งหมด
...
{{% blocks/products/pf/agp/code-block title="รหัส C++: ลบความคิดเห็นและผู้แต่งจากการนำเสนอ PPS" offSpacer="" %}}
...
- Install a [แพ็คเกจ NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/). See [เอกสารประกอบ](https://docs.aspose.com/slides/cpp/installation/#option-one-install-or-update-asposeslides-for-c-from-the-nuget-package-manager)
