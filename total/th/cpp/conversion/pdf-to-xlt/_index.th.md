---
title: C++ API เพื่อแปลง PDF เป็น XLT
description: แปลง PDF เป็น XLT ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/pdf-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
