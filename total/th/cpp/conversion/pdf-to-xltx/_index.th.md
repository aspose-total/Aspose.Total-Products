---
title: C++ API เพื่อแปลง PDF เป็น XLTX
description: แปลง PDF เป็น XLTX ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/pdf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: PDF
