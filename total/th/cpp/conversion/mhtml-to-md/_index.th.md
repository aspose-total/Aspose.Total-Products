---
title: C++ API เพื่อแปลง MHTML เป็น MD
description: แปลง MHTML เป็น MD ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/mhtml-to-md/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
