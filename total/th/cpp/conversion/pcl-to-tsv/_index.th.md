---
title: C++ API เพื่อแปลง PCL เป็น TSV
description: แปลง PCL เป็น TSV ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/pcl-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PCL
