---
title: C++ API เพื่อแปลง MHTML เป็น FODS
description: แปลง MHTML เป็น FODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/mhtml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
