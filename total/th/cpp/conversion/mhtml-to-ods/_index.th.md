---
title: C++ API เพื่อแปลง MHTML เป็น ODS
description: แปลง MHTML เป็น ODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
