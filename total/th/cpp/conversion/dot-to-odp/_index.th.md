---
title: แปลง DOT เป็น ODP ผ่าน C++
description: ส่งออก DOT เป็น ODP ในแอปพลิเคชัน C++ ของคุณโดยไม่ต้องใช้ Microsoft Word ของ PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOT เป็น ODP" h2="ส่งออก DOT เป็น ODP ภายในแอปพลิเคชัน C++ ของคุณโดยไม่ต้องใช้ Microsoft Word&reg; หรือ PowerPoint" >}}
