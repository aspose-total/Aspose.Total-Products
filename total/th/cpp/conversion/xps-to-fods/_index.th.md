---
title: C++ API เพื่อแปลง XPS เป็น FODS
description: แปลง XPS เป็น FODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xps-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: XPS
