---
title: C++ API เพื่อแปลง XPS เป็น MD
description: แปลง XPS เป็น MD ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xps-to-md/
family: total
platformtag: cpp
feature: conversion
informat: XPS
