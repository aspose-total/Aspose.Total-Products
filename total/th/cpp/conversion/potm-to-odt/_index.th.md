---
title: C++ API เพื่อแปลง POTM เป็น ODT
description: ส่งออก POTM เป็น ODT ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/potm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล POTM เป็น ODT" h2="ส่งออก POTM เป็น ODT ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
