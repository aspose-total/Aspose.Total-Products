---
title: C++ API เพื่อแปลง CGM เป็น MD
description: แปลง CGM เป็น MD ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/cgm-to-md/
family: total
platformtag: cpp
feature: conversion
informat: CGM
