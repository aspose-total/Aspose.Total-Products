---
title: C++ API เพื่อแปลง TEX เป็น ODS
description: แปลง TEX เป็น ODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/tex-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: TEX
