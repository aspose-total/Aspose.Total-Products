---
title: แปลงรูปแบบ DOT เป็นรูปแบบ JSON ใน C++
description: ส่งออก DOT เป็น JSON ใน C++ โดยไม่ต้องใช้ Microsoft Excel หรือ Word
url: /th/cpp/conversion/dot-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOT เป็นรูปแบบ JSON ผ่าน C++" h2="ส่งออก DOT เป็น JSON ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
ด้วยการใช้ [Aspose.Total สำหรับ C++](https://products.aspose.com/total/cpp/) คุณสามารถแปลง DOT เป็นรูปแบบ JSON ภายในแอปพลิเคชัน C++ ของคุณได้ ประการแรก โดยใช้ [Aspose.Words for C++](https://products.aspose.com/words/cpp/) คุณสามารถส่งออก DOT เป็น HTML หลังจากนั้น เมื่อใช้ [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) คุณจะแปลงรูปแบบ HTML เป็นรูปแบบ JSON ได้ 
{{% /blocks/products/pf/feature-page-summary  %}}
...
คุณยังสามารถเปิดเอกสารที่ป้องกันด้วยรหัสผ่านโดยใช้ API ได้อีกด้วย หากเอกสาร DOT ที่คุณป้อนมีการป้องกันด้วยรหัสผ่าน คุณจะไม่สามารถแปลงเป็นรูปแบบ JSON ได้โดยไม่ต้องใช้รหัสผ่าน เมื่อต้องการทำเช่นนี้ ใช้คอนสตรัคโอเวอร์โหลดพิเศษ ซึ่งยอมรับอ็อบเจ็กต์ LoadOptions วัตถุนี้มีคุณสมบัติ Password ซึ่งระบุสตริงรหัสผ่าน
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/cpp/conversion/dot-to-csv/" name="DOT ถึง CSV" description="" >}}
