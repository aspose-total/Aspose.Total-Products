---
title: C++ API เพื่อแปลง CGM เป็น XLT
description: แปลง CGM เป็น XLT ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/cgm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: CGM
