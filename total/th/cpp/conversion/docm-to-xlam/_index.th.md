---
title: แปลง DOCM เป็น XLAM ใน C++
description: C++ API เพื่อแปลง DOCM เป็น XLAM โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/docm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOCM เป็น XLAM" h2="ส่งออก DOCM เป็น XLAM ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
