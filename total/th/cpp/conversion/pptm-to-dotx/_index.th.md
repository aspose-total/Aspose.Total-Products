---
title: C++ API เพื่อแปลง PPTM เป็น DOTX
description: ส่งออก PPTM เป็น DOTX ภายในแอปพลิเคชัน C++ ของคุณ
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล PPTM เป็น DOTX" h2="ส่งออก PPTM เป็น DOTX ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
