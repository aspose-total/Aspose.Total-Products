---
title: C++ API เพื่อแปลง PPTM เป็น DOCM
description: ส่งออก PPTM เป็น DOCM ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล PPTM เป็น DOCM" h2="ส่งออก PPTM เป็น DOCM ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
