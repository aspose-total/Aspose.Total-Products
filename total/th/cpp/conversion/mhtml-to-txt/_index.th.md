---
title: C++ API เพื่อแปลง MHTML เป็น TXT
description: แปลง MHTML เป็น TXT ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/mhtml-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
