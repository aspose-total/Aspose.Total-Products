---
title: C++ API เพื่อแปลง EPUB เป็น TXT
description: แปลง EPUB เป็น TXT ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/epub-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
