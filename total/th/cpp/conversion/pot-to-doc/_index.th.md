---
title: C++ API เพื่อแปลง POT เป็น DOC
description: ส่งออก POT เป็น DOC ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/pot-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล POT เป็น DOC" h2="ส่งออก POT เป็น DOC ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
