---
title: แปลง DOTM เป็น XLSM ใน C++
description: C++ API เพื่อแปลง DOTM เป็น XLSM โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/dotm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOTM เป็น XLSM" h2="ส่งออก DOTM เป็น XLSM ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
