---
title: แปลง XLSB เป็น WORD ด้วย C++
description: แปลง XLSB เป็น WORD ภายในแอปพลิเคชัน C++
url: /th/cpp/conversion/xlsb-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="แปลง XLSB เป็น WORD ผ่าน C++" h2="ส่งออก Excel<sup>&reg;</sup> XLSB เป็น WORD ภายในแอปพลิเคชัน C++ ที่ทำงานได้เต็มรูปแบบ" >}}
