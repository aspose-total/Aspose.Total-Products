---
title: C++ API เพื่อแปลง MD เป็น PPT
description: แปลง MD เป็น PPT ผ่าน C++ โดยไม่ต้องใช้ Microsoft Word หรือ Adobe Acrobat Reader
url: /th/cpp/conversion/md-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: MD
