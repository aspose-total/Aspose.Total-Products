---
title: แปลง DOCX เป็น EXCEL ใน C++
description: C++ API เพื่อแปลง DOCX เป็น EXCEL โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/docx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOCX เป็น EXCEL" h2="ส่งออก DOCX เป็น EXCEL ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
