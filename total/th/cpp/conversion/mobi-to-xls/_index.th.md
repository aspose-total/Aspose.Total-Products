---
title: แปลง MOBI เป็น XLS ใน C++
description: C++ API เพื่อแปลง MOBI เป็น XLS โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/mobi-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง MOBI เป็น XLS" h2="ส่งออก MOBI เป็น XLS ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
