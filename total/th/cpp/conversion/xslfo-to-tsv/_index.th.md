---
title: C++ API เพื่อแปลง XSLFO เป็น TSV
description: แปลง XSLFO เป็น TSV ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xslfo-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
