---
title: C++ API เพื่อแปลง PPSM เป็น DOTX
description: ส่งออก PPSM เป็น DOTX ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/ppsm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล PPSM เป็น DOTX" h2="ส่งออก PPSM เป็น DOTX ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
...
4. บันทึกเอกสารในรูปแบบ DOTX โดยใช้ [บันทึก](https://reference.aspose.com/words/cpp/class/aspose.words.dotxument#save_string) ฟังก์ชันสมาชิก
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/cpp/conversion/ppsm-to-dotxm/" name="PPSM ถึง DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/cpp/conversion/ppsm-to-dotxx/" name="PPSM ถึง DOTXX" description="" >}}
