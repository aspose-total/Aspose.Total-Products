---
title: C++ API เพื่อแปลง PDF เป็น PPT
description: แปลง PDF เป็น PPT ผ่าน C++ โดยไม่ต้องใช้ Microsoft Word หรือ Adobe Acrobat Reader
url: /th/cpp/conversion/pdf-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
