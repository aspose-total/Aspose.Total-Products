---
title: C++ API เพื่อแปลง PCL เป็น FODS
description: แปลง PCL เป็น FODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/pcl-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PCL
