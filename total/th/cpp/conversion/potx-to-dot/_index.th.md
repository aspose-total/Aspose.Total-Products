---
title: C++ API เพื่อแปลง POTX เป็น DOT
description: ส่งออก POTX เป็น DOT ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล POTX เป็น DOT" h2="ส่งออก POTX เป็น DOT ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
