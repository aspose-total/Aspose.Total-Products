---
title: C++ API เพื่อแปลง TEX เป็น CSV
description: แปลง TEX เป็น CSV ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/tex-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: TEX
