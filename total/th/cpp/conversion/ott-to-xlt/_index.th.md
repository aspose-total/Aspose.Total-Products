---
title: แปลง OTT เป็น XLT ใน C++
description: C++ API เพื่อแปลง OTT เป็น XLT โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/ott-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง OTT เป็น XLT" h2="ส่งออก OTT เป็น XLT ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
