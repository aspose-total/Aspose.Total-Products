---
title: C++ API เพื่อแปลง MHTML เป็น SXC
description: แปลง MHTML เป็น SXC ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/mhtml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
