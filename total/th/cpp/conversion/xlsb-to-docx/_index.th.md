---
title: แปลง XLSB เป็น DOCX ด้วย C++
description: แปลง XLSB เป็น DOCX ภายในแอปพลิเคชัน C++
url: /th/cpp/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="แปลง XLSB เป็น DOCX ผ่าน C++" h2="ส่งออก Excel<sup>&reg;</sup> XLSB เป็น DOCX ภายในแอปพลิเคชัน C++ ที่ทำงานได้เต็มรูปแบบ" >}}
