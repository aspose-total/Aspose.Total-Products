---
title: C++ API เพื่อแปลง POT เป็น TEXT
description: ส่งออก POT เป็น TEXT ภายในแอปพลิเคชัน C++ ของคุณ
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล POT เป็น TEXT" h2="ส่งออก POT เป็น TEXT ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
