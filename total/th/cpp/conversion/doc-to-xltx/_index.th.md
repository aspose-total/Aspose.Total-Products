---
title: แปลง DOC เป็น XLTX ใน C++
description: C++ API เพื่อแปลง DOC เป็น XLTX โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/doc-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOC เป็น XLTX" h2="ส่งออก DOC เป็น XLTX ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API เพื่อแปลง DOC เป็น XLTX" %}}
