---
title: C++ API เพื่อแปลง XSLFO เป็น TXT
description: แปลง XSLFO เป็น TXT ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xslfo-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
