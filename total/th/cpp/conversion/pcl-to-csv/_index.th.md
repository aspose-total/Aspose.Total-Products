---
title: C++ API เพื่อแปลง PCL เป็น CSV
description: แปลง PCL เป็น CSV ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/pcl-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: PCL
