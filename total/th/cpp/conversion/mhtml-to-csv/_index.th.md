---
title: C++ API เพื่อแปลง MHTML เป็น CSV
description: แปลง MHTML เป็น CSV ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
