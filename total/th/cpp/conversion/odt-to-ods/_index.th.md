---
title: แปลง ODT เป็น ODS ใน C++
description: C++ API เพื่อแปลง ODT เป็น ODS โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/odt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง ODT เป็น ODS" h2="ส่งออก ODT เป็น ODS ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
