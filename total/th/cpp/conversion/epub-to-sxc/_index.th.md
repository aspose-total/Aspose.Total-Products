---
title: C++ API เพื่อแปลง EPUB เป็น SXC
description: แปลง EPUB เป็น SXC ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/epub-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
