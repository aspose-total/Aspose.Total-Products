---
title: C++ API เพื่อแปลง XPS เป็น ODS
description: แปลง XPS เป็น ODS ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xps-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: XPS
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/cpp/conversion/xps-to-excel/" name="XPS ถึง EXCEL" description="" >}}
