---
title: แปลง RTF เป็น XLTM ใน C++
description: C++ API เพื่อแปลง RTF เป็น XLTM โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/rtf-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง RTF เป็น XLTM" h2="ส่งออก RTF เป็น XLTM ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API เพื่อแปลง RTF เป็น XLTM" %}}
