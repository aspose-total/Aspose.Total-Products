---
title: แปลงรูปแบบ DOCX เป็นรูปแบบ JSON ใน C++
description: ส่งออก DOCX เป็น JSON ใน C++ โดยไม่ต้องใช้ Microsoft Excel หรือ Word
url: /th/cpp/conversion/docx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOCX เป็นรูปแบบ JSON ผ่าน C++" h2="ส่งออก DOCX เป็น JSON ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
ด้วยการใช้ [Aspose.Total for C++](https://products.aspose.com/total/cpp/) คุณสามารถแปลง DOCX เป็นรูปแบบ JSON ภายในแอปพลิเคชัน C++ ของคุณได้ ประการแรก โดยใช้ [Aspose.Words for C++](https://products.aspose.com/words/cpp/) คุณสามารถส่งออก DOCX เป็น HTML หลังจากนั้น เมื่อใช้ [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) คุณจะแปลงรูปแบบ HTML เป็นรูปแบบ JSON ได้ 
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/cpp/conversion/docx-to-csv/" name="DOCX ถึง CSV" description="" >}}
