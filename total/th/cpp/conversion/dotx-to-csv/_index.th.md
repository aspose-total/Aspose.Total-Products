---
title: แปลง DOTX เป็น CSV ใน C++
description: C++ API เพื่อแปลง DOTX เป็น CSV โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/cpp/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแปลง DOTX เป็น CSV" h2="ส่งออก DOTX เป็น CSV ผ่าน C++ โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API เพื่อแปลง DOTX เป็น CSV" %}}
