---
title: C++ API เพื่อแปลง XPS เป็น EXCEL
description: แปลง XPS เป็น EXCEL ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xps-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: XPS
