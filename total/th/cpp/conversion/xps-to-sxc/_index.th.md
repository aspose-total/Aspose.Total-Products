---
title: C++ API เพื่อแปลง XPS เป็น SXC
description: แปลง XPS เป็น SXC ผ่าน C++ API โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/cpp/conversion/xps-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: XPS
