---
title: C++ API เพื่อแปลง PPTX เป็น DOTM
description: ส่งออก PPTX เป็น DOTM ภายในแอปพลิเคชัน C++ ของคุณ
url: /th/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API เพื่อแสดงผล PPTX เป็น DOTM" h2="ส่งออก PPTX เป็น DOTM ในแอปพลิเคชัน C++ โดยไม่ต้องพึ่งพา Microsoft PowerPoint หรือ Word" >}}
