---
title: ดูและอัปเดตคุณสมบัติ Word ออนไลน์หรืออัปเดตข้อมูลเมตาโดยใช้แอพมือถือ Android
description: ดูและแก้ไขคุณสมบัติ Word ผ่านแอปออนไลน์ได้ฟรีรหัส Android API เพื่ออัปเดตคุณสมบัติ Word
...
{{< blocks/products/pf/feature-page-header-widget h1="ดูหรืออัปเดตข้อมูลเมตา Word ออนไลน์หรืออัปเดตผ่านแอป Android" h2="พัฒนาแอปพลิเคชันยูทิลิตีการจัดการข้อมูลเมตาเอกสาร Word ที่ใช้ Android ที่ทรงพลังรหัสที่แสดงไว้สำหรับอัปเดตข้อมูลเมตาของไฟล์ Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="อัปเดตคุณสมบัติ Word ผ่านแอพ Android" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส: อัปเดตข้อมูลเมตา Word" offSpacer="" %}}
