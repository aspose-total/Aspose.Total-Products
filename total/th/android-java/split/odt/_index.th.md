---
title: แยกไฟล์ ODT ออนไลน์หรือใช้แอพมือถือ Android
description: แอปออนไลน์ฟรีเพื่อแยกไฟล์ ODT ต่างๆโค้ด Java ไลบรารีตัวแยก Android สำหรับเอกสาร ODT 
...
{{< blocks/products/pf/feature-page-header-widget h1="แยกไฟล์ ODT ออนไลน์หรือใช้แอพ Android" h2="พัฒนาแอปพลิเคชันตัวแยกเอกสาร ODT ที่ใช้ Android ที่ทรงพลังแยกเอกสารได้อย่างอิสระ รวมถึงไฟล์ ODT ออนไลน์ผ่านแอปพร้อมการดาวน์โหลดทันที" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="แยกไฟล์ ODT ออนไลน์" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="แยกไฟล์ ODT ผ่านแอพ Android" %}}

1. เพิ่มการอ้างอิงไลบรารี Java ภายในโครงการของคุณ
1. โหลดเอกสาร ODT โดยใช้คลาส Document
1. นับจำนวนหน้าทั้งหมดในไฟล์ ODT
1. วนซ้ำแต่ละหน้าและใช้ extractPages เพื่อแยกหน้า
1. บันทึกหน้าที่แยกออกมาเป็นไฟล์ใหม่

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="รหัส Java: แยกหน้าไฟล์ ODT อย่างชาญฉลาด" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="รหัส Java: แยกไฟล์ ODT ส่วนอย่างชาญฉลาด" offSpacer="" %}}
