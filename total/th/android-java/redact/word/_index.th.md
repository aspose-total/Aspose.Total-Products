---
title: ตรวจทานเอกสาร Word ออนไลน์หรือใช้แอพมือถือ Android
description: เปิดและแก้ไขเอกสาร Word ออนไลน์ผ่านแอปได้ฟรี รหัส Android API เพื่อค้นหาและแทนที่ข้อความ Word ด้วยนิพจน์ทั่วไป
...
{{< blocks/products/pf/feature-page-header-widget h1="ตรวจทานเอกสาร Word ออนไลน์หรือผ่านแอพ Android" h2="พัฒนาแอพพลิเคชั่นยูทิลิตี้การเขียนเอกสาร Word ที่ใช้ Android ที่ทรงพลัง รหัสที่แสดงสำหรับการค้นหาและแทนที่ข้อความในไฟล์ Word โดยใช้นิพจน์ทั่วไป" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานเอกสาร Word ออนไลน์" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานไฟล์ Word ผ่านแอพ Android" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ Android  
1. โหลดไฟล์ Word โดยใช้คลาส Document
1. กำหนดอาร์เรย์รูปแบบนิพจน์ทั่วไป
1. วนซ้ำอาร์เรย์และ 
1. ใช้วิธี getRange().replace ด้วยพารามิเตอร์ที่เกี่ยวข้อง
1. บันทึกเอกสาร Word
...
{{% blocks/products/pf/agp/code-block title="รหัส : ตรวจทานเอกสาร Word" offSpacer="" %}}
