---
title: ทำซ้ำการนำเสนอ ODP ออนไลน์หรือใช้แอพมือถือ Android
description: เปิดและแก้ไขเอกสาร ODP ออนไลน์ผ่านแอปได้ฟรี รหัส Android API เพื่อค้นหาและแทนที่ข้อความ ODP
...
{{< blocks/products/pf/feature-page-header-widget h1="ตรวจทานเอกสาร ODP ออนไลน์หรือผ่านแอพ Android" h2="พัฒนาแอพพลิเคชั่นอรรถประโยชน์การนำเสนอ ODP ที่ใช้ Android ที่ทรงพลัง รหัสที่แสดงสำหรับการค้นหาและแทนที่ข้อความในไฟล์ ODP" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานการนำเสนอ ODP ออนไลน์" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานไฟล์ ODP ผ่านแอพ Android" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ Android  
1. โหลดไฟล์ ODP โดยใช้คลาสการนำเสนอ
1. ใช้เมธอด findAndReplaceText ของคลาส SlideUtil
1. ระบุพารามิเตอร์ที่เกี่ยวข้อง รวมถึงค้นหาและแทนที่ข้อความ
1. บันทึกไฟล์ ODP
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Code : Redact ODP Presentation" offSpacer="" %}}
...
<h2>พัฒนาแอปพลิเคชัน Android Redaction ODP</h2>

ต้องการพัฒนาแอปหรือยูทิลิตี้การแก้ไข ODP หรือไม่ ด้วย [Aspose.Slides for Android via Java](https://products.aspose.com/slides/th/android-java/) ซึ่งเป็น API ลูกของ [Aspose.Total for Android via Java](https://products.aspose.com/total/th/android-java/) นักพัฒนา Android ทุกคนสามารถรวมโค้ด API ข้างต้นภายในแอปพลิเคชันการแก้ไขเอกสารได้ ไลบรารี Android อันทรงพลังช่วยให้สามารถเขียนโปรแกรมโซลูชันการแก้ไขเอกสารได้ นอกจากนี้ยังสามารถรองรับรูปแบบยอดนิยมมากมายรวมถึงรูปแบบ ODP<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ยูทิลิตี้ Android เพื่อตรวจทานไฟล์ ODP" %}}
