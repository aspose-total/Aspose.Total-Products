---
title: ทำซ้ำสเปรดชีต ODS ออนไลน์หรือใช้แอพมือถือ Android
description: เปิดและแก้ไขเอกสาร ODS ออนไลน์ผ่านแอปได้ฟรี รหัส Android API เพื่อค้นหาและแทนที่ข้อความ ODS ด้วยนิพจน์ทั่วไป
...
{{< blocks/products/pf/feature-page-header-widget h1="ตรวจทานเอกสาร ODS ออนไลน์หรือผ่านแอพ Android" h2="พัฒนาแอพพลิเคชั่นยูทิลิตี้การเขียนเอกสาร ODS ที่ใช้ Android ที่ทรงพลัง รหัสที่แสดงสำหรับการค้นหาและแทนที่ข้อความในไฟล์ ODS โดยใช้นิพจน์ทั่วไป" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ตรวจทานไฟล์ ODS ผ่านแอพ Android" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส : ทำซ้ำสเปรดชีต ODS" offSpacer="" %}}
