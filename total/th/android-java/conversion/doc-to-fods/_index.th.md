---
title: Android API เพื่อแปลง DOC เป็น FODS
description: แปลง DOC เป็น FODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/doc-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOC เป็น FODS ในแอปพลิเคชัน Android" h2="ส่งออก DOC เป็น FODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
