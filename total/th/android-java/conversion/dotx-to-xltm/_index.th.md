---
title: Android API เพื่อแปลง DOTX เป็น XLTM
description: แปลง DOTX เป็น XLTM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/dotx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOTX เป็น XLTM ในแอปพลิเคชัน Android" h2="ส่งออก DOTX เป็น XLTM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
