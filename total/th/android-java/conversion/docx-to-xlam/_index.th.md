---
title: Android API เพื่อแปลง DOCX เป็น XLAM
description: แปลง DOCX เป็น XLAM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/docx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOCX เป็น XLAM ในแอปพลิเคชัน Android" h2="ส่งออก DOCX เป็น XLAM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
