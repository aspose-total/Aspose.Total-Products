---
title: Android API เพื่อแสดงผล PDF เป็น OTT
description: แปลง PDF เป็น OTT ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/pdf-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PDF
