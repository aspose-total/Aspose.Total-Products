---
title: Android API เพื่อแปลง DOTX เป็น DIF
description: แปลง DOTX เป็น DIF ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOTX เป็น DIF ในแอปพลิเคชัน Android" h2="ส่งออก DOTX เป็น DIF ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
