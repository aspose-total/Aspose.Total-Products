...
url: /th/android-java/conversion/potx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
ในการแปลง POTX เป็น XLT คุณสามารถใช้ Aspose.Total for Android via Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) และติดตั้งไลบรารีในแอปของคุณ
