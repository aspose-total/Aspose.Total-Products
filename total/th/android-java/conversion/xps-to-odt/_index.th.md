---
title: Android API เพื่อแสดงผล XPS เป็น ODT
description: แปลง XPS เป็น ODT ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/xps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: XPS
