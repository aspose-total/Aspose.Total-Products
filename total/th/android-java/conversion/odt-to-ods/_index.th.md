---
title: Android API เพื่อแปลง ODT เป็น ODS
description: แปลง ODT เป็น ODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/odt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="แปลง ODT เป็น ODS ในแอปพลิเคชัน Android" h2="ส่งออก ODT เป็น ODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
