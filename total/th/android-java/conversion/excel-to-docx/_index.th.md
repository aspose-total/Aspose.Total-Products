---
title: ส่งออก EXCEL เป็น DOCX ใน Android
description: Android API เพื่อแปลง EXCEL เป็น DOCX โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/excel-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล EXCEL เป็น DOCX บน Android ผ่าน Java" h2="แปลง EXCEL เป็น DOCX ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
