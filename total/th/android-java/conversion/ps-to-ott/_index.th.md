---
title: Android API เพื่อแสดงผล PS เป็น OTT
description: แปลง PS เป็น OTT ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/ps-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PS
