---
title: Android API เพื่อแสดงผล XPS เป็น OTT
description: แปลง XPS เป็น OTT ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/xps-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: XPS
