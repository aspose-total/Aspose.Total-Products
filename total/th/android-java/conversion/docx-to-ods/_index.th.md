---
title: Android API เพื่อแปลง DOCX เป็น ODS
description: แปลง DOCX เป็น ODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOCX เป็น ODS ในแอปพลิเคชัน Android" h2="ส่งออก DOCX เป็น ODS ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
