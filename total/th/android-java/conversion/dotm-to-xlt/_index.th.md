---
title: Android API เพื่อแปลง DOTM เป็น XLT
description: แปลง DOTM เป็น XLT ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/dotm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOTM เป็น XLT ในแอปพลิเคชัน Android" h2="ส่งออก DOTM เป็น XLT ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
