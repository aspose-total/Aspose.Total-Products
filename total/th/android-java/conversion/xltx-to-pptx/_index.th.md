---
title: ส่งออก XLTX เป็น PPTX ใน Android
description: Android API เพื่อแปลง XLTX เป็น PPTX โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/xltx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล XLTX เป็น PPTX บน Android ผ่าน Java" h2="แปลง XLTX เป็น PPTX ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
