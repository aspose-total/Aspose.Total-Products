---
title: Android API เพื่อแปลง RTF เป็น XLSB
description: แปลง RTF เป็น XLSB ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="แปลง RTF เป็น XLSB ในแอปพลิเคชัน Android" h2="ส่งออก RTF เป็น XLSB ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
