---
title: Android API เพื่อแปลง DOCM เป็น XLSM
description: แปลง DOCM เป็น XLSM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/docm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOCM เป็น XLSM ในแอปพลิเคชัน Android" h2="ส่งออก DOCM เป็น XLSM ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
