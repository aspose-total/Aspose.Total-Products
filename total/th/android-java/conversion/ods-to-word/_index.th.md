---
title: ส่งออก ODS เป็น WORD ใน Android
description: Android API เพื่อแปลง ODS เป็น WORD โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/ods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล ODS เป็น WORD บน Android ผ่าน Java" h2="แปลง ODS เป็น WORD ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
