---
title: ส่งออก XLS เป็น DOCX ใน Android
description: Android API เพื่อแปลง XLS เป็น DOCX โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล XLS เป็น DOCX บน Android ผ่าน Java" h2="แปลง XLS เป็น DOCX ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
