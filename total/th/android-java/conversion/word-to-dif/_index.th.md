---
title: Android API เพื่อแปลง WORD เป็น DIF
description: แปลง WORD เป็น DIF ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="แปลง WORD เป็น DIF ในแอปพลิเคชัน Android" h2="ส่งออก WORD เป็น DIF ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
