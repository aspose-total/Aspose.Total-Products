---
title: Android API เพื่อแสดงผล XPS เป็น FLATOPC
description: แปลง XPS เป็น FLATOPC ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/xps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: XPS
