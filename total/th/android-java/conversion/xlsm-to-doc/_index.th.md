---
title: ส่งออก XLSM เป็น DOC ใน Android
description: Android API เพื่อแปลง XLSM เป็น DOC โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/xlsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล XLSM เป็น DOC บน Android ผ่าน Java" h2="แปลง XLSM เป็น DOC ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
