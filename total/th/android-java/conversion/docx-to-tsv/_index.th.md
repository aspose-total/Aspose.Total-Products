---
title: Android API เพื่อแปลง DOCX เป็น TSV
description: แปลง DOCX เป็น TSV ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft Word หรือ Microsoft Excel
url: /th/android-java/conversion/docx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOCX เป็น TSV ในแอปพลิเคชัน Android" h2="ส่งออก DOCX เป็น TSV ใน Android ผ่าน Java โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
