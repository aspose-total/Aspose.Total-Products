---
title: แปลง ODT เป็น PPS ใน Android ผ่าน Java
description: การแปลง ODT เป็น PPS ในโทรศัพท์ Android ของคุณโดยไม่ต้องใช้ Microsoft Word of PowerPoint
url: /th/android-java/conversion/odt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="แปลง ODT เป็น PPS ในแอพ Android" h2="การแปลง ODT เป็น PPS ในแอปพลิเคชัน Android ของคุณโดยไม่ต้องติดตั้ง Microsoft Word<sup>&reg;</sup> หรือ PowerPoint" >}}
...
สำหรับการแปลงไฟล์ ODT เป็น PPS คุณสามารถใช้ Aspose.Total for Android via Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) และติดตั้งไลบรารีในแอปของคุณ
