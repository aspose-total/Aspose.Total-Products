---
title: แปลง DOTM เป็น POTM ใน Android ผ่าน Java
description: การแปลง DOTM เป็น POTM ในโทรศัพท์ Android ของคุณโดยไม่ต้องใช้ Microsoft Word of PowerPoint
url: /th/android-java/conversion/dotm-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="แปลง DOTM เป็น POTM ในแอพ Android" h2="การแปลง DOTM เป็น POTM ในแอปพลิเคชัน Android ของคุณโดยไม่ต้องติดตั้ง Microsoft Word<sup>&reg;</sup> หรือ PowerPoint" >}}
...
สำหรับการแปลงไฟล์ DOTM เป็น POTM คุณสามารถใช้ Aspose.Total for Android via Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) และติดตั้งไลบรารีในแอปของคุณ
