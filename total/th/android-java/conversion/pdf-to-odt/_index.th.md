---
title: Android API เพื่อแสดงผล PDF เป็น ODT
description: แปลง PDF เป็น ODT ผ่าน Android ผ่าน Java API
url: /th/android-java/conversion/pdf-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
