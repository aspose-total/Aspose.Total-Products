---
title: ส่งออก SXC เป็น DOCX ใน Android
description: Android API เพื่อแปลง SXC เป็น DOCX โดยไม่ต้องใช้ Microsoft Word
url: /th/android-java/conversion/sxc-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="แสดงผล SXC เป็น DOCX บน Android ผ่าน Java" h2="แปลง SXC เป็น DOCX ภายในแอปพลิเคชัน Android ของคุณโดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel" >}}
