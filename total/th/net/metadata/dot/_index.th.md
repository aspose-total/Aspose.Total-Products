---
title: ดูและอัปเดตคุณสมบัติ DOT ออนไลน์หรืออัปเดตข้อมูลเมตาโดยใช้ .NET
description: ดูและแก้ไขคุณสมบัติ DOT ผ่านแอปออนไลน์ได้ฟรีรหัส C# .NET API เพื่ออัปเดตคุณสมบัติ DOT
...
{{< blocks/products/pf/feature-page-header-widget h1="ดูหรืออัปเดตข้อมูลเมตา DOT ออนไลน์หรืออัปเดตผ่าน .NET" h2="พัฒนาแอปพลิเคชันยูทิลิตีการจัดการข้อมูลเมตาเอกสาร DOT ที่ใช้ .NET อันทรงพลังรหัสที่แสดงไว้สำหรับอัปเดตข้อมูลเมตาของไฟล์ DOT ผ่าน .NET" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="อัปเดตคุณสมบัติ DOT ผ่าน .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส .NET: อัปเดตข้อมูลเมตา DOT" offSpacer="" %}}
...
<h2>พัฒนาแอปพลิเคชันการจัดการข้อมูลเมตา DOT ผ่าน .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility เพื่อจัดการข้อมูลเมตา DOT" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">คุณสามารถใช้เว็บเบราว์เซอร์สมัยใหม่เช่น Google Chrome, Firefox, Opera หรือ Safari สำหรับการจัดการคุณสมบัติเอกสาร DOT ออนไลน์ อย่างไรก็ตาม หากคุณกำลังพัฒนาแอปพลิเคชันบนเดสก์ท็อป เราขอแนะนำให้ใช้ API การประมวลผลเอกสาร Aspose.Total เพื่อการจัดการที่มีประสิทธิภาพ</span>
                      </div>
                  </li>
              </ul>
          </div>
