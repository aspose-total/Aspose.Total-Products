...
1. สร้าง [Aspose.Words.Odtument](https://apireference.aspose.com/words/net/aspose.words/odtument) และกำหนดค่าเริ่มต้นด้วย MemoryStream Object
1. บันทึกเอกสารโดยใช้ [Aspose.Words.Odtument.Save("output.odt", SaveFormat.Odt)](https://apireference.aspose.com/words/net/aspose.words.odtument/save/methods /3)
