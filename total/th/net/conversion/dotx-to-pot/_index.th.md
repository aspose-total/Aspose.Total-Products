---
title: แปลง DOTX เป็น POT ผ่าน C# .NET 
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง DOTX เป็น POT โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงวิธีการแปลง DOTX เป็น POT โดยใช้ C#" offSpacer="" %}}
