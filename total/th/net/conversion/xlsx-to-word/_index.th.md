---
title: แปลง XLSX เป็น WORD ด้วย .NET 
description: แปลง XLSX เป็น WORD บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
url: /th/net/conversion/xlsx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง XLSX เป็น WORD ผ่าน C#" h2="ส่งออก Excel&reg; XLSX เป็น WORD บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
