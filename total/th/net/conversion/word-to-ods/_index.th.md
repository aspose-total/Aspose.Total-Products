...
description: C# API เพื่อแปลง WORD เป็น ODS โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API เพื่อแปลง WORD เป็น ODS" h2="ส่งออก WORD เป็น ODS ผ่าน C# โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
