...
description: แปลง PPT เป็น XLS ใน C# โดยไม่ต้องใช้ Microsoft Excel หรือ Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPT เป็น XLS ผ่าน C#" h2=".NET API สำหรับการแปลง PPT เป็น XLS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
