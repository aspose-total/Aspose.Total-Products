---
title: แปลง PPTM เป็น WORDML ผ่าน C# .NET 
url: /th/net/conversion/pptm-to-wordml/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง PPTM เป็น WORDML โดยใช้ C#" h2="สร้าง Microsoft PowerPoint PPTM Presentation เป็นแอปแปลงเอกสาร Word WORDML บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPTM" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="WORDMLM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง PPTM เป็น WORDML โดยใช้ C#" %}}
...
1. สร้าง [Aspose.Words.Wordmlument](https://apireference.aspose.com/words/net/aspose.words/wordmlument) และกำหนดค่าเริ่มต้นด้วย MemoryStream Object
1. บันทึกเอกสารโดยใช้ [Aspose.Words.Wordmlument.Save("output.wordml", SaveFormat.Wordml)](https://apireference.aspose.com/words/net/aspose.words.wordmlument/save/methods /3)
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงวิธีการแปลง PPTM เป็น WORDML โดยใช้ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/pptm-to-wordmlx" name="PPTM ถึง WORDMLX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/pptm-to-wordmlm" name="PPTM ถึง WORDMLM" description="" >}}
