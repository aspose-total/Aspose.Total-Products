...
4. บันทึกเอกสารเป็นรูปแบบ EPUB โดยใช้เมธอด [Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) และตั้งค่า Epub เป็น SaveFormat
