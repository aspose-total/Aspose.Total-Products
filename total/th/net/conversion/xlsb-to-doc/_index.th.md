---
title: แปลง XLSB เป็น DOC ด้วย .NET 
description: แปลง XLSB เป็น DOC บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง XLSB เป็น DOC ผ่าน C#" h2="ส่งออก Excel&reg; XLSB เป็น DOC บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
