---
title: .NET API เพื่อแปลง OTT เป็น DIF
description: C# API เพื่อแปลง OTT เป็น DIF โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
url: /th/net/conversion/ott-to-dif/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API เพื่อแปลง OTT เป็น DIF" h2="ส่งออก OTT เป็น DIF ผ่าน C# โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
