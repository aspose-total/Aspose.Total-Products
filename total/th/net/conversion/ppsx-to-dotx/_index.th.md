---
title: แปลง PPSX เป็น DOTX ผ่าน C# .NET 
url: /th/net/conversion/ppsx-to-dotx/ 
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง PPSX เป็น DOTX โดยใช้ C#" %}}
...
1. สร้าง [Aspose.Words.Dotxument](https://apireference.aspose.com/words/net/aspose.words/dotxument) และกำหนดค่าเริ่มต้นด้วย MemoryStream Object
1. บันทึกเอกสารโดยใช้ [Aspose.Words.Dotxument.Save("output.dotx", SaveFormat.Dotx)](https://apireference.aspose.com/words/net/aspose.words.dotxument/save/methods /3)
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงวิธีการแปลง PPSX เป็น DOTX โดยใช้ C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/ppsx-to-dotxx" name="PPSX ถึง DOTXX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/th/net/conversion/ppsx-to-dotxm" name="PPSX ถึง DOTXM" description="" >}}
