---
title: แปลง EXCEL เป็น POWERPOINT ด้วย .NET 
description: แปลง EXCEL เป็น POWERPOINT บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="แปลง EXCEL เป็น POWERPOINT ผ่าน C#" h2="ส่งออก Excel<sup>&reg;</sup> EXCEL เป็น POWERPOINT บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="การแปลง EXCEL เป็น POWERPOINT บน .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code สำหรับการแปลง EXCEL เป็น POWERPOINT" gistPath="" %}}
```cs
