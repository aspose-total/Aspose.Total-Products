---
title: แปลง OTT เป็น POTX ผ่าน C# .NET 
url: /th/net/conversion/ott-to-potx/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="แปลง OTT เป็น POTX โดยใช้ C#" h2="สร้างแอปการแปลง Microsoft Word OTT เป็น PowerPoint POTX บน .NET Framework, .NET Core, Windows Azure, Mono หรือ Xamarin Platforms" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="OTTM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง OTT เป็น POTX โดยใช้ C#" %}}
...
1. โหลดไฟล์ OTT โดยใช้คลาส [Aspose.Words.Ottument](https://apireference.aspose.com/words/net/aspose.words/ottument)
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงวิธีการแปลง OTT เป็น POTX โดยใช้ C#" offSpacer="" %}}
...
// To convert multi pages OTT ottuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to POTX.
