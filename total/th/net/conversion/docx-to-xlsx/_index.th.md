...
description: C# API เพื่อแปลง DOCX เป็น XLSX โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API เพื่อแปลง DOCX เป็น XLSX" h2="ส่งออก DOCX เป็น XLSX ผ่าน C# โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
