...
description: แปลง PPSX เป็น DIF ใน C# โดยไม่ต้องใช้ Microsoft Excel หรือ Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPSX เป็น DIF ผ่าน C#" h2=".NET API สำหรับการแปลง PPSX เป็น DIF โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
