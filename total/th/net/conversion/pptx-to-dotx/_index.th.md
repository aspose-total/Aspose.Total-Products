---
title: แปลง PPTX เป็น DOTX ผ่าน C# .NET 
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง PPTX เป็น DOTX โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดนี้แสดงวิธีการแปลง PPTX เป็น DOTX โดยใช้ C#" offSpacer="" %}}
