---
title: แปลง ODS เป็น DOCX ด้วย .NET 
description: แปลง ODS เป็น DOCX บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง ODS เป็น DOCX ผ่าน C#" h2="ส่งออก Excel&reg; ODS เป็น DOCX บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
