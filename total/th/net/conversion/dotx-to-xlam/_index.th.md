...
description: C# API เพื่อแปลง DOTX เป็น XLAM โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API เพื่อแปลง DOTX เป็น XLAM" h2="ส่งออก DOTX เป็น XLAM ผ่าน C# โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
