...
url: /th/net/conversion/docx-to-pptx/ 
...
1. โหลดไฟล์ DOCX โดยใช้คลาส [Aspose.Words.Docxument](https://apireference.aspose.com/words/net/aspose.words/docxument)
...
// To convert multi pages DOCXX docxuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to PPTX.
