---
title: แปลง PPSX เป็น FODS ผ่าน C#
description: แปลง PPSX เป็น FODS ใน C# โดยไม่ต้องใช้ Microsoft Excel หรือ Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPSX เป็น FODS ผ่าน C#" h2=".NET API สำหรับการแปลง PPSX เป็น FODS โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีแปลง PPSX เป็น FODS ผ่าน C#" %}}
...
4. บันทึกเอกสารเป็น FODS โดยใช้วิธี [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
