---
title: แปลง XLS เป็น WORD ด้วย .NET 
description: แปลง XLS เป็น WORD บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
url: /th/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง XLS เป็น WORD ผ่าน C#" h2="ส่งออก Excel&reg; XLS เป็น WORD บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
