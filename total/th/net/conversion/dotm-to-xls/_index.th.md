---
title: .NET API เพื่อแปลง DOTM เป็น XLS
description: C# API เพื่อแปลง DOTM เป็น XLS โดยไม่ต้องใช้ Microsoft Excel หรือ Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API เพื่อแปลง DOTM เป็น XLS" h2="ส่งออก DOTM เป็น XLS ผ่าน C# โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Word หรือ Microsoft<sup>&reg;</sup> Excel" >}}
...
4. บันทึกเอกสารในรูปแบบ XLS โดยใช้วิธี [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) และตั้งค่า `XLS' เป็น SaveFormat
