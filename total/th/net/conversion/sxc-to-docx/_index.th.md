---
title: แปลง SXC เป็น DOCX ด้วย .NET 
description: แปลง SXC เป็น DOCX บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="แปลง SXC เป็น DOCX ผ่าน C#" h2="ส่งออก Excel&reg; SXC เป็น DOCX บน .NET Framework, .NET Core, Mono หรือ Xamarin Platforms">}}
