...
description: แปลง PPSM เป็น XLSB ใน C# โดยไม่ต้องใช้ Microsoft Excel หรือ Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="แปลง PPSM เป็น XLSB ผ่าน C#" h2=".NET API สำหรับการแปลง PPSM เป็น XLSB โดยไม่ต้องใช้ Microsoft<sup>&reg;</sup> Excel หรือ PowerPoint" >}}
