...
4. บันทึกเอกสารเป็นรูปแบบ ODT โดยใช้เมธอด [Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) และตั้งค่า Odt เป็น SaveFormat
