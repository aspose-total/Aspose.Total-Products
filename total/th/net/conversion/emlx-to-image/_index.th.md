...
4. บันทึกเอกสารเป็นรูปแบบ IMAGE โดยใช้เมธอด [Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) และตั้งค่า Image เป็น SaveFormat
