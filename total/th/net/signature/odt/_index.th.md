---
title: เซ็นชื่อไฟล์ ODT แบบดิจิทัลออนไลน์หรือใช้ .NET
description: แอปออนไลน์ฟรีสำหรับลายเซ็นดิจิทัลในไฟล์ ODT พัฒนาแอปพลิเคชัน .NET เพื่อลงนามในเอกสาร ODT ทางอิเล็กทรอนิกส์
...
{{< blocks/products/pf/feature-page-header-widget h1="เซ็นชื่อไฟล์ ODT แบบดิจิทัลออนไลน์ผ่านแอป e-Signature หรือใช้ .NET" h2="พัฒนาแอปพลิเคชันการลงนามเอกสาร ODT ที่ใช้ .NET อันทรงพลัง เพิ่มลายเซ็นดิจิทัลลงในเอกสารต่างๆ ได้อย่างอิสระ รวมถึงไฟล์ ODT ออนไลน์ผ่านแอปพร้อมการดาวน์โหลดทันที" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="เซ็นชื่อไฟล์ ODT แบบดิจิทัลผ่าน .NET" %}}

1. โหลดใบรับรอง pfx โดยใช้คลาส CertificateHolder
1. กำหนดตัวเลือกโดยใช้ SignOptions
1. โหลดไฟล์ ODT โดยใช้ FileStream
1. ใช้คลาส DigitalSignatureUtil เพื่อลงนามในเอกสารที่โหลด

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="รหัส .NET : เพิ่มลายเซ็นดิจิทัลในไฟล์ ODT" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">ใช่ คุณสามารถดาวน์โหลดโค้ดนี้ได้ เราสามารถพัฒนาโซลูชันระดับมืออาชีพเพื่อเพิ่มลายเซ็นดิจิทัลในไฟล์ ODT โดยใช้ .NET ได้อย่างง่ายดาย ใช้ Aspose ODT eSignature API เพื่อพัฒนาซอฟต์แวร์อิสระบนแพลตฟอร์มระดับสูงใน .NET</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">เริ่มต้นด้วยการอัปโหลดไฟล์อย่างน้อย 1 ไฟล์ที่คุณต้องการลงนาม คุณสามารถลากและวางไฟล์ ODT ของคุณหรือเพียงคลิกภายในพื้นที่สีขาว หลังจากนั้น คลิกปุ่ม "ลงชื่อ" จากนั้นแอปออกแบบออนไลน์ของเราจะประมวลผลไฟล์ที่อัปโหลดอย่างรวดเร็ว</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
