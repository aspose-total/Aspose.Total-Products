---
title: ลบคำอธิบายประกอบ PDF ออนไลน์หรือจัดการคำอธิบายประกอบผ่าน .NET
description: ลบความคิดเห็นออกจากไฟล์ PDF ผ่านแอปออนไลน์ฟรีรหัส C# .NET API เพื่อจัดการความคิดเห็นของไฟล์ PDF
...
{{< blocks/products/pf/feature-page-header-widget h1="ล้างความคิดเห็นจากเอกสาร PDF ออนไลน์หรือจัดการผ่าน .NET" h2="พัฒนาแอพพลิเคชั่นยูทิลิตีคำอธิบายประกอบเอกสาร PDF ที่ใช้ .NET อันทรงพลังรหัสที่แสดงสำหรับจัดการความคิดเห็นของไฟล์ PDF ผ่าน. NET" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="เพิ่มคำอธิบายประกอบผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. สร้างวัตถุคลาสเอกสาร
1. เพิ่มหน้าและย่อหน้าใหม่โดยใช้ Pages.Add และ Paragraphs.Add
1. ใช้คลาส TextAnnotation และกำหนดคำอธิบายประกอบ
1. ใช้ Pages[1].Annotations.Add เพื่อเพิ่มคำอธิบายประกอบ
1. เรียกวิธีการบันทึกเพื่อบันทึกไฟล์ที่มีคำอธิบายประกอบ
...
{{% blocks/products/pf/agp/code-block title="รหัส .NET: เพิ่มความคิดเห็นในไฟล์ PDF" offSpacer="" %}}
...
<h2>พัฒนาแอปพลิเคชันคำอธิบายประกอบเอกสาร PDF ผ่าน .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Library เพื่อใส่คำอธิบายประกอบไฟล์ PDF" %}}
