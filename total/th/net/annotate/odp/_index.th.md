---
title: ลบคำอธิบายประกอบ ODP ออนไลน์หรือจัดการคำอธิบายประกอบผ่าน .NET
description: ลบความคิดเห็นออกจากไฟล์ ODP ผ่านแอปออนไลน์ฟรีรหัส .NET API เพื่อจัดการความคิดเห็นของไฟล์ ODP
...
{{< blocks/products/pf/feature-page-header-widget h1="ล้างความคิดเห็นจากการนำเสนอ ODP ออนไลน์หรือจัดการผ่าน .NET" h2="พัฒนาแอปพลิเคชันยูทิลิตีคำอธิบายประกอบการนำเสนอ ODP ที่ใช้ .NET อันทรงพลังรหัสที่แสดงสำหรับจัดการความคิดเห็นของไฟล์ ODP ผ่าน. NET" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ลบความคิดเห็นการนำเสนอ ODP ผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. โหลด ODP ผ่านวัตถุคลาสการนำเสนอ
1. ย้ำผู้เขียนแต่ละคนผ่านการนำเสนอ ความคิดเห็นผู้เขียน
1. เรียกใช้เมธอด Comments.Clear() เพื่อลบความคิดเห็น
...
{{% blocks/products/pf/agp/code-block title="รหัส C#: ลบความคิดเห็นและผู้แต่งจากการนำเสนอ ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="เพิ่มความคิดเห็นการนำเสนอ ODP ผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. โหลด ODP ผ่านวัตถุคลาสการนำเสนอ
1. เพิ่มสไลด์เปล่าโดยใช้วิธี AddEmptySlide
1. ใช้ CommentAuthors.AddAuthor เพื่อเพิ่มผู้เขียนใหม่
1. ใช้ผู้เขียนใหม่กับ Comments.AddComment เพื่อแทรกความคิดเห็น
1. บันทึกการนำเสนอ
...
{{% blocks/products/pf/agp/code-block title="รหัส .NET: การเพิ่มความคิดเห็น" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
ODP (OpenDocument Presentation) เป็นรูปแบบมาตรฐานที่เปิดเผยที่ใช้สำหรับสร้างและแบ่งปันงานนำเสนอ โดยส่วนใหญ่ใช้ในชุดโปรแกรมสำนักงานโอเพนซอร์ส การเพิ่มหมายเหตุในไฟล์ ODP ช่วยในการสร้างความร่วมมือและการตรวจสอบเนื้อหาโดยเฉพาะในกรณีการใช้งานข้ามแพลตฟอร์มหรือในระบบราชการ/การศึกษา

#### การประทับรอยไฟล์ ODP สำหรับการใช้งานร่วมกันในงานนำเสนอรูปแบบเปิด:

- **การทบทวนของทีมโอเพนซอร์ส**  
  เพิ่มความคิดเห็นสำหรับการปรับปรุงเนื้อหาสไลด์, ปัญหาด้านการออกแบบ, หรือองค์ประกอบที่ขาดหายในสภาพแวดล้อมที่ร่วมมือ

- **การพัฒนางานนำเสนอในส่วนราชการ**  
  แทรกหมายเหตุเพื่อตรงตามนโยบายที่กำหนด, มาตรฐานการปฏิบัติ, หรือความต้องการในเรื่องการเข้าถึงในระหว่างการทบทวน

- **ข้อเสนอแนะเนื้อหาข้ามแพลตฟอร์ม**  
  ใช้การประทับรอยเพื่อระบุความไม่สอดคล้องในการจัดรูปแบบหรือเค้าโครงของเนื้อหาในชุดโปรแกรมสำนักงานที่แตกต่างกัน

- **ข้อเสนอแนะสไลด์ในการศึกษา**  
  ให้ข้อเสนอแนะของผู้เรียนหรือผู้สอนในสถานการศึกษาโดยใช้งานนำเสนอรูปแบบเปิด

- **การควบคุมเวอร์ชันและการพัฒนาแบบวนรอบ**  
  เน้นการแก้ไขสไลด์หรือการเปลี่ยนแปลงเนื้อหาในระหว่างการทบทวนเอกสารเพื่อปรับปรุงการติดตามและการประสานงาน
