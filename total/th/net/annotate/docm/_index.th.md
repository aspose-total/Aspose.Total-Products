---
title: ลบคำอธิบายประกอบ DOCM ออนไลน์หรือจัดการคำอธิบายประกอบผ่าน .NET
description: ลบความคิดเห็นออกจากไฟล์ DOCM ผ่านแอปออนไลน์ฟรีรหัส .NET API เพื่อจัดการความคิดเห็นของไฟล์ DOCM
...
{{< blocks/products/pf/feature-page-header-widget h1="ล้างความคิดเห็นจากเอกสาร DOCM ออนไลน์หรือจัดการผ่าน .NET" h2="พัฒนาแอพพลิเคชั่นยูทิลิตีคำอธิบายประกอบเอกสาร DOCM ที่ใช้ .NET อันทรงพลังรหัสที่แสดงสำหรับจัดการความคิดเห็นของไฟล์ DOCM ผ่าน. NET" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ลบความคิดเห็นเกี่ยวกับเอกสาร DOCM ของผู้แต่งเฉพาะเจาะจงผ่าน .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="รหัส C#: ลบความคิดเห็นของผู้เขียนเฉพาะจากไฟล์ DOCM" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code : เพิ่มความคิดเห็นจากไฟล์ DOCM" offSpacer="" %}}
...
<h2>พัฒนาแอปพลิเคชันคำอธิบายประกอบเอกสาร DOCM ผ่าน .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Library เพื่อใส่คำอธิบายประกอบไฟล์ DOCM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
ไฟล์ DOCM (เอกสารที่เปิดใช้งานแมโครของ Microsoft Word) รองรับการผสานแมโครเพื่อการอัตโนมัติ การทำเครื่องหมายบนไฟล์ DOCM ช่วยให้มีบริบทที่จำเป็นรอบกระบวนการอัตโนมัติ ติดตามการเปลี่ยนแปลงที่ทำโดยแมโคร และสะดวกในการทบทวนร่วมกัน

#### การทำเครื่องหมายบนไฟล์ DOCM สำหรับการใช้งานร่วมกันของเอกสารที่เปิดใช้งานแมโคร:

- **เอกสารของขั้นตอนการทำงานของแมโคร**  
  ทำเครื่องหมายบนเอกสารที่เปิดใช้งานแมโครเพื่ออธิบายวัตถุประสงค์ของแต่ละแมโคร ผลลัพธ์ที่คาดหวัง และบทบาทของแมโครในการอัตโนมัติของเอกสาร

- **คำแนะนำสำหรับผู้ใช้เกี่ยวกับฟังก์ชันแมโคร**  
  เพิ่มการทำเครื่องหมายในเอกสารเพื่อแนะนำผู้ใช้เกี่ยวกับวิธีการโต้ตอบกับแมโครหรือข้อมูลที่ต้องการสำหรับการดำเนินการอัตโนมัติ

- **การตรวจสอบข้อผิดพลาดและการติดตามข้อผิดพลาด**  
  แทรกความคิดเห็นเพื่อเน้นส่วนที่แมโครล้มเหลวหรือข้อมูลถูกป้อนผิด ช่วยในการตรวจสอบข้อผิดพลาด

- **ข้อเสนอแนะเกี่ยวกับการอัตโนมัติ**  
  ให้ข้อเสนอแนะเกี่ยวกับประสิทธิภาพของแมโครในการอัตโนมัติงานเอกสาร เช่น การสร้างตาราง การจัดรูปแบบ หรือการเติบโตของเนื้อหา

- **การทบทวนเนื้อหาที่สร้างโดยแมโคร**  
  ทำเครื่องหมายบริเวณที่เนื้อหาที่สร้างโดยแมโครต้องการการทบทวนหรือการปรับเปลี่ยนด้วยมือ
