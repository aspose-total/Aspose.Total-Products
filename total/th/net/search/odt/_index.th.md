---
title: ตัวค้นหาข้อความไฟล์ ODT ออนไลน์หรือสร้างซอฟต์แวร์ค้นหา ODT ผ่าน C#
description: แอปออนไลน์ฟรีเพื่อค้นหาในไฟล์ ODT รหัส C# API สำหรับแอปพลิเคชันค้นหาข้อความไฟล์ ODT
...
{{< blocks/products/pf/feature-page-header h1="แอปเอกสารที่ค้นหาได้ออนไลน์และรหัส API ค้นหาข้อความ ODT" h2="พัฒนาซอฟต์แวร์เครื่องมือค้นหาเอกสาร ODT ที่ใช้ .NET หรือแอพยูทิลิตี้ที่มีประสิทธิภาพ ทดสอบแอปค้นหาข้อความเอกสารออนไลน์ฟรี" >}}
...
1. อัปโหลดไฟล์ ODT เพื่อค้นหาโดยคลิกภายในพื้นที่วางหรือโดยการลากและวาง
...
{{% blocks/products/pf/agp/feature-section-col title="วิธีค้นหาไฟล์ ODT ผ่าน C#" %}}

1. ติดตั้ง 'Aspose.Words สำหรับ .NET'
1. เพิ่มการอ้างอิงไลบรารี (นำเข้าไลบรารี) ให้กับโปรเจ็กต์ C# ของคุณ
1. เปิดไฟล์ ODT ต้นฉบับโดยใช้คลาสเอกสาร
1. ใช้ฟังก์ชัน Range.Replace เพื่อค้นหาและแทนที่ข้อความ
1. หรือตั้งค่าเกณฑ์การค้นหาใน Regex และส่งเป็นพารามิเตอร์ในวิธีการแทนที่
...
{{% blocks/products/pf/agp/code-block title="ตัวอย่างโค้ดใน C# เพื่อค้นหาข้อความในไฟล์ ODT" offSpacer="" %}}
...
<h2>พัฒนา ODT File Search Engine ผ่าน .NET</h2>

ต้องการพัฒนาซอฟต์แวร์หรือยูทิลิตี้ที่สามารถค้นหาได้ของ ODT หรือไม่ ด้วย Aspose.Words สำหรับ .NET ซึ่งเป็น API ลูกของ Aspose.Total สำหรับ .NET นักพัฒนาทุกคนสามารถรวมโค้ด API C# ข้างต้นเพื่อตั้งโปรแกรมค้นหาข้อความในเอกสารต่างๆ ได้ ไลบรารี C# อันทรงพลังช่วยให้สามารถตั้งโปรแกรมซอฟต์แวร์ค้นหาเอกสารที่สามารถรองรับรูปแบบยอดนิยมมากมาย รวมถึงรูปแบบ ODT<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ไลบรารี C# เพื่อค้นหาไฟล์ ODT" %}}
There are three alternative options to install "Aspose.Words for .NET" or "Aspose.Total for .NET" onto your system. โปรดเลือกรายการที่ตรงกับความต้องการของคุณและปฏิบัติตามคำแนะนำทีละขั้นตอน:<br /><br />
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">คุณสามารถใช้เว็บเบราว์เซอร์สมัยใหม่ เช่น Google Chrome, Firefox, Opera หรือ Safari สำหรับการค้นหาเอกสาร ODT ออนไลน์ อย่างไรก็ตาม หากคุณกำลังพัฒนาแอปพลิเคชันบนเดสก์ท็อป ขอแนะนำให้ใช้ Aspose.Total Document Search API เพื่อการประมวลผลที่ราบรื่นและมีประสิทธิภาพ</span>
                      </div>
                  </li>
              </ul>
          </div>
