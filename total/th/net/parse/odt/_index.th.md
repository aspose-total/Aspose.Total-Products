---
title: แยกข้อความและรูปภาพจากไฟล์ ODT ออนไลน์และใช้ .NET
description: แอพแยกวิเคราะห์ไฟล์ ODT ออนไลน์ รหัส .NET API C# เพื่อแยกรูปภาพและเนื้อหาข้อความจากเอกสาร ODT
...
{{< blocks/products/pf/feature-page-header-widget h1="แยกวิเคราะห์ไฟล์ ODT ออนไลน์และผ่านทาง .NET" h2="พัฒนาแอพพลิเคชั่นยูทิลิตี้แยกวิเคราะห์เอกสาร ODT ที่ใช้ .NET อันทรงพลัง รหัส C# ที่แสดงสำหรับการแยกข้อความเอกสาร ODT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="แยกวิเคราะห์ไฟล์ ODT ผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. โหลดไฟล์ ODT โดยใช้วัตถุคลาสเอกสาร
...
{{% blocks/products/pf/agp/code-block title="รหัส C#: การแยกรูปภาพเอกสาร ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="รหัส C#: การแยกข้อความเอกสาร ODT" offSpacer="" %}}
...
<h2>พัฒนาแอปพลิเคชัน Parser ไฟล์ ODT ผ่าน .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ยูทิลิตี้ .NET เพื่อประมวลผลไฟล์ ODT สำหรับแอปพลิเคชันแยกวิเคราะห์" %}}
