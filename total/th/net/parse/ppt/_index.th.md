---
title: แยกข้อความและรูปภาพจากไฟล์ PPT ออนไลน์และใช้ .NET
description: แอพแยกวิเคราะห์ไฟล์ PPT ออนไลน์ รหัส .NET API C# เพื่อแยกรูปภาพและข้อความจากงานนำเสนอ PPT
...
{{< blocks/products/pf/feature-page-header-widget h1="แยกวิเคราะห์ไฟล์ PPT ออนไลน์และผ่านทาง .NET" h2="พัฒนาแอปพลิเคชันแยกวิเคราะห์การนำเสนอ PPT ที่ใช้ .NET อันทรงพลัง รหัส C# ที่แสดงสำหรับการแยกวิเคราะห์ PPT" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="แยกวิเคราะห์การนำเสนอ PPT ผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. โหลดไฟล์ PPT โดยใช้วัตถุคลาสการนำเสนอ
1. กำหนดวัตถุ ITextFrame[]
1. วนซ้ำผ่านเฟรมและส่วน
1. รับข้อความและพิมพ์หรือบันทึก
...
{{% blocks/products/pf/agp/code-block title="รหัส C#: การแยกข้อความการนำเสนอ PPT" offSpacer="" %}}

{{< gist "aspose-com-gists" "56e34ac75fba2313ae00be996cc53d39" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="รหัส C# : การแยกภาพการนำเสนอ PPT" offSpacer="" %}}
