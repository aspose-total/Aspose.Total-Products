---
title: แยกข้อความและรูปภาพจากไฟล์ DOC ออนไลน์และใช้ .NET
description: แอพแยกวิเคราะห์ไฟล์ DOC ออนไลน์ รหัส .NET API C# เพื่อแยกรูปภาพและเนื้อหาข้อความจากเอกสาร DOC
...
{{< blocks/products/pf/feature-page-header-widget h1="แยกวิเคราะห์ไฟล์ DOC ออนไลน์และผ่านทาง .NET" h2="พัฒนาแอพพลิเคชั่นยูทิลิตี้แยกวิเคราะห์เอกสาร DOC ที่ใช้ .NET อันทรงพลัง รหัส C# ที่แสดงสำหรับการแยกข้อความเอกสาร DOC" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="แยกวิเคราะห์เอกสาร DOC ผ่านแอปออนไลน์" %}}

1. นำเข้าไฟล์ DOC เพื่อแยกวิเคราะห์โดยการอัปโหลด
...
{{% blocks/products/pf/agp/feature-section-col title="แยกวิเคราะห์ไฟล์ DOC ผ่าน .NET" %}}

1. เพิ่มการอ้างอิงไลบรารีให้กับโครงการ .NET
1. โหลดไฟล์ DOC โดยใช้วัตถุคลาสเอกสาร
...
{{% blocks/products/pf/agp/code-block title="รหัส C#: การแยกรูปภาพเอกสาร DOC" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="รหัส C#: การแยกข้อความเอกสาร DOC" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>การใช้แอปออนไลน์เพื่อแยกวิเคราะห์เอกสาร DOC ปลอดภัยหรือไม่</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">คุณสามารถใช้เว็บเบราว์เซอร์สมัยใหม่เช่น Google Chrome, Firefox, Opera หรือ Safari สำหรับโปรแกรมแยกวิเคราะห์เอกสาร DOC ออนไลน์อย่างไรก็ตาม หากคุณกำลังพัฒนาแอปพลิเคชันบนเดสก์ท็อป เราขอแนะนำให้ใช้ API การประมวลผลเอกสาร Aspose.Total เพื่อการจัดการที่มีประสิทธิภาพ</span>
                      </div>
                  </li>
              </ul>
          </div>
