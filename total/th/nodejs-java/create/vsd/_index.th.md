---
title: สร้างไดอะแกรม Visio VSD ใน Node.js
description: สร้างไดอะแกรม Microsoft Visio VSD โดยใช้แอปพลิเคชัน Node โดยไม่ต้องใช้ Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="สร้างไฟล์ VSD โดยใช้ Node.js" h2="สร้างไฟล์ Microsoft Visio VSD ผ่านแอปพลิเคชัน Node ของคุณโดยไม่ต้องติดตั้งซอฟต์แวร์อื่นใด" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="สร้างไฟล์ VSD ใน Node.js" %}}

- สร้างอินสแตนซ์คลาส Diagram
- เรียกใช้เมธอดบันทึกด้วยพารามิเตอร์ที่เกี่ยวข้อง
- VSD เส้นทางไฟล์และส่วนขยายที่เกี่ยวข้องกับ SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="ข้อกำหนดในการสร้างสรรค์" %}}

- สำหรับการสร้างเอกสาร VSD จะต้องติดตั้ง Node.js บนระบบ
- ต้องมี Oracle JDK (เวอร์ชัน 7 ขึ้นไป)
- จะต้องตั้งค่าแพ็กเกจ node-java

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - สร้างไฟล์ VSD" offSpacer="" %}}
