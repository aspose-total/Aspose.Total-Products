---
title: Thao tác PDF và bổ sung OCR thông qua API Node.js
description: API Node.js để thao tác với tệp PDF cũng như trích xuất văn bản từ hình ảnh thông qua ứng dụng.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Node.js để trích xuất văn bản PDF và hình ảnh" h2="Trích xuất văn bản từ Hình ảnh cũng như bao gồm các tính năng thao tác PDF trong các ứng dụng Node.js mà không cần bất kỳ phụ thuộc phần mềm nào khác" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total cung cấp các giải pháp riêng cho các nền tảng khác." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/vi/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/vi/nodejs-java/" 
