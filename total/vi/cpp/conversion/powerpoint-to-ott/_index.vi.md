---
title: API C++ để chuyển đổi POWERPOINT sang OTT
description: Xuất POWERPOINT sang OTT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/powerpoint-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POWERPOINT sang OTT" h2="Xuất POWERPOINT sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
