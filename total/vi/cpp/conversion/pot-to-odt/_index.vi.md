---
title: API C++ để chuyển đổi POT sang ODT
description: Xuất POT sang ODT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang ODT" h2="Xuất POT sang ODT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
