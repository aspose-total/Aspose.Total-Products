---
title: Chuyển đổi ODT sang PPSM qua C++
description: Xuất ODT sang PPSM trong các ứng dụng C++ của bạn mà không cần sử dụng Microsoft Word của PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API để chuyển đổi ODT sang PPSM" h2="Xuất ODT sang PPSM trong các ứng dụng C++ của bạn mà không cần sử dụng Microsoft Word <sup>&reg;</sup>; hoặc PowerPoint" >}}
