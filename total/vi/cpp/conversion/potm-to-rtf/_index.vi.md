---
title: API C++ để chuyển đổi POTM sang RTF
description: Xuất POTM sang RTF trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTM sang RTF" h2="Xuất POTM sang RTF trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
