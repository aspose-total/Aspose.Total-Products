---
title: API C++ để chuyển đổi POTX sang DOCX
description: Xuất POTX sang DOCX trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTX sang DOCX" h2="Xuất POTX sang DOCX trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
