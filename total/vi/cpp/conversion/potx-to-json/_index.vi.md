---
title: Chuyển đổi định dạng POTX sang JSON thông qua C++
description: Xuất POTX sang định dạng JSON trong C++ mà không cần sử dụng Microsoft Excel hoặc Powerpoint
url: /vi/cpp/conversion/potx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi định dạng POTX sang JSON thông qua C++" h2="Xuất tệp POTX sang định dạng JSON qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Excel hoặc PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Bằng cách sử dụng [Aspose.Total for C++](https://products.aspose.com/total/cpp/), bạn có thể chuyển đổi tệp POTX sang định dạng JSON trong các ứng dụng C++ bằng hai bước đơn giản. Đầu tiên, bằng cách sử dụng [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), bạn có thể xuất POTX sang HTML. Sau đó, bằng cách sử dụng API lập trình bảng tính [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/), bạn có thể chuyển đổi HTML sang JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Chuyển đổi định dạng POTX sang JSON qua C++" %}}
1. Mở tệp POTX bằng cách sử dụng tham chiếu lớp [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation)
...
{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi POTX được bảo vệ sang định dạng JSON qua C++" %}}
