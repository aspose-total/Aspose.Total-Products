---
title: API C++ để chuyển đổi PPTM sang WORDML
description: Xuất PPTM sang WORDML trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTM sang WORDML" h2="Xuất PPTM sang WORDML trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
