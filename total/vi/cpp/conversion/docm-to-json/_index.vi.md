---
title: Chuyển đổi định dạng DOCM sang JSON trong C++
description: Xuất DOCM sang JSON bằng C++ mà không cần sử dụng Microsoft Excel hoặc Word
url: /vi/cpp/conversion/docm-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{% blocks/products/pf/feature-page-section  h2="Chuyển đổi DOCM được bảo vệ sang định dạng JSON qua C++" %}}
Sử dụng API, bạn cũng có thể mở tài liệu được bảo vệ bằng mật khẩu. Nếu tài liệu DOCM đầu vào của bạn được bảo vệ bằng mật khẩu, bạn không thể chuyển đổi nó sang định dạng JSON mà không sử dụng mật khẩu. Để thực hiện việc này, hãy sử dụng quá tải hàm tạo đặc biệt, chấp nhận một đối tượng LoadOptions. Đối tượng này chứa thuộc tính Mật khẩu, thuộc tính chỉ định chuỗi mật khẩu.
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/cpp/conversion/docm-to-csv/" name="DOCM Đến CSV" description="" >}}
