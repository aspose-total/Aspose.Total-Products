---
title: Chuyển đổi RTF sang XLSB trong C++
description: C++ API để chuyển đổi RTF sang XLSB mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi RTF sang XLSB" h2="Xuất RTF sang XLSB qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ để chuyển đổi RTF sang XLSB" %}}
