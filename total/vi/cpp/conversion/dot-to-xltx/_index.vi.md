---
title: Chuyển đổi DOT sang XLTX trong C++
description: C++ API để chuyển đổi DOT sang XLTX mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/dot-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOT sang XLTX" h2="Xuất DOT sang XLTX qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
