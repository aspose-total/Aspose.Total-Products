---
title: API C++ để chuyển đổi POTM sang WORD
description: Xuất POTM sang WORD trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/potm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTM sang WORD" h2="Xuất POTM sang WORD trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
