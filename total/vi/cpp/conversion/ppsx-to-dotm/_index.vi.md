---
title: API C++ để chuyển đổi PPSX sang DOTM
description: Xuất PPSX sang DOTM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang DOTM" h2="Xuất PPSX sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
