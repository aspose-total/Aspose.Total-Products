---
title: Chuyển đổi WORDML sang SXC trong C++
description: C++ API để chuyển đổi WORDML sang SXC mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/wordml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi WORDML sang SXC" h2="Xuất WORDML sang SXC qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
