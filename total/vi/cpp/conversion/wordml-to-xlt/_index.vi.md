---
title: Chuyển đổi WORDML sang XLT trong C++
description: C++ API để chuyển đổi WORDML sang XLT mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/wordml-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi WORDML sang XLT" h2="Xuất WORDML sang XLT qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
