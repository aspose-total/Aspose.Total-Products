---
title: API C++ để chuyển đổi PPS sang DOCM
description: Xuất PPS sang DOCM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPS sang DOCM" h2="Xuất PPS sang DOCM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
