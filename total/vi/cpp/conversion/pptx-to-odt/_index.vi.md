---
title: API C++ để chuyển đổi PPTX sang ODT
description: Xuất PPTX sang ODT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang ODT" h2="Xuất PPTX sang ODT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
