---
title: Chuyển đổi RTF sang XLTX trong C++
description: C++ API để chuyển đổi RTF sang XLTX mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/rtf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi RTF sang XLTX" h2="Xuất RTF sang XLTX qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ để chuyển đổi RTF sang XLTX" %}}
