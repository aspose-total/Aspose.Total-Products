---
title: API C++ để chuyển đổi PPSX sang DOTX
description: Xuất PPSX sang DOTX trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang DOTX" h2="Xuất PPSX sang DOTX trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
