---
title: API C++ để chuyển đổi POWERPOINT sang DOCM
description: Xuất POWERPOINT sang DOCM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POWERPOINT sang DOCM" h2="Xuất POWERPOINT sang DOCM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
