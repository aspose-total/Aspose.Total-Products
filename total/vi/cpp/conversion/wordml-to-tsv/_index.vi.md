---
title: Chuyển đổi WORDML sang TSV trong C++
description: C++ API để chuyển đổi WORDML sang TSV mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/wordml-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi WORDML sang TSV" h2="Xuất WORDML sang TSV qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
