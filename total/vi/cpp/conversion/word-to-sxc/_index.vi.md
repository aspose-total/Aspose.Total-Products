---
title: Chuyển đổi WORD sang SXC trong C++
description: C++ API để chuyển đổi WORD sang SXC mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/word-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi WORD sang SXC" h2="Xuất WORD sang SXC qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
