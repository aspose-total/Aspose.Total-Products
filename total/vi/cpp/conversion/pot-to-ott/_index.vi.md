---
title: API C++ để chuyển đổi POT sang OTT
description: Xuất POT sang OTT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang OTT" h2="Xuất POT sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
