---
title: Chuyển đổi MOBI sang FODS trong C++
description: C++ API để chuyển đổi MOBI sang FODS mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/mobi-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi MOBI sang FODS" h2="Xuất MOBI sang FODS qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
