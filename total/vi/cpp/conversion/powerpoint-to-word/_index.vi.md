---
title: API C++ để chuyển đổi POWERPOINT sang WORD
description: Xuất POWERPOINT sang WORD trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POWERPOINT sang WORD" h2="Xuất POWERPOINT sang WORD trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
