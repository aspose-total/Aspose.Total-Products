---
title: API C++ để chuyển đổi PPT sang WORDML
description: Xuất PPT sang WORDML trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPT sang WORDML" h2="Xuất PPT sang WORDML trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
