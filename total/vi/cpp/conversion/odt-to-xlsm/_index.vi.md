---
title: Chuyển đổi ODT sang XLSM trong C++
description: C++ API để chuyển đổi ODT sang XLSM mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/odt-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi ODT sang XLSM" h2="Xuất ODT sang XLSM qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ để chuyển đổi ODT sang XLSM" %}}
