---
title: API C++ để chuyển đổi POWERPOINT sang WORDML
description: Xuất POWERPOINT sang WORDML trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POWERPOINT sang WORDML" h2="Xuất POWERPOINT sang WORDML trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
