---
title: API C++ để chuyển đổi PPTX sang DOC
description: Xuất PPTX sang DOC trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang DOC" h2="Xuất PPTX sang DOC trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
