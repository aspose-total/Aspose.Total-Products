---
title: API C++ để chuyển đổi PPT sang DOT
description: Xuất PPT sang DOT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPT sang DOT" h2="Xuất PPT sang DOT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
