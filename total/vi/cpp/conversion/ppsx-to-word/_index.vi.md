---
title: API C++ để chuyển đổi PPSX sang WORD
description: Xuất PPSX sang WORD trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang WORD" h2="Xuất PPSX sang WORD trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
