---
title: API C++ để chuyển đổi POT sang RTF
description: Xuất POT sang RTF trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang RTF" h2="Xuất POT sang RTF trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
