---
title: API C++ để chuyển đổi POTX sang RTF
description: Xuất POTX sang RTF trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTX sang RTF" h2="Xuất POTX sang RTF trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
