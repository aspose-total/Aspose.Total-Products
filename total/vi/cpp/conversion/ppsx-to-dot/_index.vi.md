---
title: API C++ để chuyển đổi PPSX sang DOT
description: Xuất PPSX sang DOT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang DOT" h2="Xuất PPSX sang DOT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
