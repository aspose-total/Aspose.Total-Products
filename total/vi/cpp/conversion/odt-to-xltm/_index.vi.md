---
title: Chuyển đổi ODT sang XLTM trong C++
description: C++ API để chuyển đổi ODT sang XLTM mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/odt-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi ODT sang XLTM" h2="Xuất ODT sang XLTM qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
