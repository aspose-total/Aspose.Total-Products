---
title: API C++ để chuyển đổi PPSX sang FLATOPC
description: Xuất PPSX sang FLATOPC trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang FLATOPC" h2="Xuất PPSX sang FLATOPC trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
