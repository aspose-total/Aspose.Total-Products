---
title: API C++ để chuyển đổi PPT sang DOTM
description: Xuất PPT sang DOTM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPT sang DOTM" h2="Xuất PPT sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
