---
title: Chuyển đổi định dạng JSON sang MOBI thông qua C++
description: C++ API t0 Phân tích cú pháp JSON thành MOBI mà không cần sử dụng Microsoft Word
url: /vi/cpp/conversion/json-to-mobi/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="Chuyển đổi định dạng JSON thành MOBI trong C++" %}}
...
4. Lưu tài liệu sang định dạng MOBI bằng phương pháp [Lưu](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat)
