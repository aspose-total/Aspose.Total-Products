---
title: Chuyển đổi DOCM sang ODS trong C++
description: C++ API để chuyển đổi DOCM sang ODS mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/docm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOCM sang ODS" h2="Xuất DOCM sang ODS qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
