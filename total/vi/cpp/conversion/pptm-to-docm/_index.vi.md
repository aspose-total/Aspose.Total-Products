---
title: API C++ để chuyển đổi PPTM sang DOCM
description: Xuất PPTM sang DOCM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTM sang DOCM" h2="Xuất PPTM sang DOCM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
