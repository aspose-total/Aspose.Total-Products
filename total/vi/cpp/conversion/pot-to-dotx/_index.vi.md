---
title: API C++ để chuyển đổi POT sang DOTX
description: Xuất POT sang DOTX trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang DOTX" h2="Xuất POT sang DOTX trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
