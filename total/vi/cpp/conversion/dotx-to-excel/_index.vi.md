---
title: Chuyển đổi DOTX sang EXCEL trong C++
description: C++ API để chuyển đổi DOTX sang EXCEL mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/dotx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOTX sang EXCEL" h2="Xuất DOTX sang EXCEL qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
