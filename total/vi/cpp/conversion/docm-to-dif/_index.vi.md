---
title: Chuyển đổi DOCM sang DIF trong C++
description: C++ API để chuyển đổi DOCM sang DIF mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/docm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOCM sang DIF" h2="Xuất DOCM sang DIF qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
