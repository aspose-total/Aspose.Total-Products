---
title: Chuyển đổi DOT sang XLT trong C++
description: C++ API để chuyển đổi DOT sang XLT mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/dot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOT sang XLT" h2="Xuất DOT sang XLT qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
