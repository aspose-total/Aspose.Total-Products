---
title: Chuyển đổi RTF sang ODS trong C++
description: C++ API để chuyển đổi RTF sang ODS mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/rtf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi RTF sang ODS" h2="Xuất RTF sang ODS qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
