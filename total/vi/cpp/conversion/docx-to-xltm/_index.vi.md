---
title: Chuyển đổi DOCX sang XLTM trong C++
description: C++ API để chuyển đổi DOCX sang XLTM mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOCX sang XLTM" h2="Xuất DOCX sang XLTM qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
