---
title: API C++ để chuyển đổi POT sang DOTM
description: Xuất POT sang DOTM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang DOTM" h2="Xuất POT sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
