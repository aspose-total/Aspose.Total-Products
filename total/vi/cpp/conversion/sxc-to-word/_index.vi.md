---
title: Chuyển đổi SXC sang WORD bằng C++
description: Chuyển đổi SXC sang WORD trong các ứng dụng C++
url: /vi/cpp/conversion/sxc-to-word/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi SXC sang WORD qua C++" h2="Xuất Excel <sup>&reg;</sup>; SXC sang WORD trong các ứng dụng C++ đầy đủ chức năng" >}}
