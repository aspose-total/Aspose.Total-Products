---
title: API C++ để chuyển đổi POTX sang TEXT
description: Xuất POTX sang TEXT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/potx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTX sang TEXT" h2="Xuất POTX sang TEXT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
