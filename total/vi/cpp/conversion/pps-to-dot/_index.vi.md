---
title: API C++ để chuyển đổi PPS sang DOT
description: Xuất PPS sang DOT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPS sang DOT" h2="Xuất PPS sang DOT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
