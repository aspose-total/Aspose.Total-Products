---
title: API C++ để chuyển đổi POTX sang OTT
description: Xuất POTX sang OTT trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTX sang OTT" h2="Xuất POTX sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
