---
title: API C++ để chuyển đổi PPSX sang DOC
description: Xuất PPSX sang DOC trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang DOC" h2="Xuất PPSX sang DOC trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
