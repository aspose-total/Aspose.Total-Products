---
title: API C++ để chuyển đổi PPT sang DOTX
description: Xuất PPT sang DOTX trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppt-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPT sang DOTX" h2="Xuất PPT sang DOTX trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
