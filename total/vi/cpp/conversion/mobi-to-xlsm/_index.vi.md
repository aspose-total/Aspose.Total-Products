---
title: Chuyển đổi MOBI sang XLSM trong C++
description: C++ API để chuyển đổi MOBI sang XLSM mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/mobi-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi MOBI sang XLSM" h2="Xuất MOBI sang XLSM qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
