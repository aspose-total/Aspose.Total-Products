---
title: API C++ để chuyển đổi POTM sang TEXT
description: Xuất POTM sang TEXT trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTM sang TEXT" h2="Xuất POTM sang TEXT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
