---
title: API C++ để chuyển đổi PPSX sang WORDML
description: Xuất PPSX sang WORDML trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang WORDML" h2="Xuất PPSX sang WORDML trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
