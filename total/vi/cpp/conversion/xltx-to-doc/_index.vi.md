---
title: Chuyển đổi XLTX sang DOC bằng C++
description: Chuyển đổi XLTX sang DOC trong các ứng dụng C++
url: /vi/cpp/conversion/xltx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi XLTX sang DOC qua C++" h2="Xuất Excel <sup>&reg;</sup>; XLTX sang DOC trong các ứng dụng C++ đầy đủ chức năng" >}}
