---
title: API C++ để chuyển đổi POTX sang DOTM
description: Xuất POTX sang DOTM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTX sang DOTM" h2="Xuất POTX sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
