---
title: API C++ để chuyển đổi POT sang TEXT
description: Xuất POT sang TEXT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang TEXT" h2="Xuất POT sang TEXT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
