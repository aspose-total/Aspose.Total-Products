---
title: API C++ để chuyển đổi PPSM sang TEXT
description: Xuất PPSM sang TEXT trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSM sang TEXT" h2="Xuất PPSM sang TEXT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
