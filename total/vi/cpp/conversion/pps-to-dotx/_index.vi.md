---
title: API C++ để chuyển đổi PPS sang DOTX
description: Xuất PPS sang DOTX trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPS sang DOTX" h2="Xuất PPS sang DOTX trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
