---
title: API C++ để chuyển đổi POT sang DOT
description: Xuất POT sang DOT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POT sang DOT" h2="Xuất POT sang DOT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
