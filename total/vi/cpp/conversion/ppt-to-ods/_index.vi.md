...
description: Xuất PPT sang ODS bằng C++ mà không cần sử dụng Microsoft Excel hoặc Powerpoint
url: /vi/cpp/conversion/ppt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi PPT sang ODS qua C++" h2="Chuyển đổi tệp PPT sang ODS qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Excel hoặc PowerPoint" >}}
