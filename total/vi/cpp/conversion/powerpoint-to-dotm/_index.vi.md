---
title: API C++ để chuyển đổi POWERPOINT sang DOTM
description: Xuất POWERPOINT sang DOTM trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POWERPOINT sang DOTM" h2="Xuất POWERPOINT sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
