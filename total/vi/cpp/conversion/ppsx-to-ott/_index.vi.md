---
title: API C++ để chuyển đổi PPSX sang OTT
description: Xuất PPSX sang OTT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSX sang OTT" h2="Xuất PPSX sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
