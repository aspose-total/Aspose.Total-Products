---
title: API C++ để chuyển đổi PPSM sang ODT
description: Xuất PPSM sang ODT trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSM sang ODT" h2="Xuất PPSM sang ODT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
