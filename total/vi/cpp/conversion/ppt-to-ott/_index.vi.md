---
title: API C++ để chuyển đổi PPT sang OTT
description: Xuất PPT sang OTT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppt-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPT sang OTT" h2="Xuất PPT sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
