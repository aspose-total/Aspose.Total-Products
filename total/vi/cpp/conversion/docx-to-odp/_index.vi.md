---
title: Chuyển đổi DOCX sang ODP qua C++
description: Xuất DOCX sang ODP trong các ứng dụng C++ của bạn mà không cần sử dụng Microsoft Word của PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API để chuyển đổi DOCX sang ODP" h2="Xuất DOCX sang ODP trong các ứng dụng C++ của bạn mà không cần sử dụng Microsoft Word <sup>&reg;</sup>; hoặc PowerPoint" >}}
