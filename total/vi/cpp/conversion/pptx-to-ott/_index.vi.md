---
title: API C++ để chuyển đổi PPTX sang OTT
description: Xuất PPTX sang OTT trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang OTT" h2="Xuất PPTX sang OTT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
