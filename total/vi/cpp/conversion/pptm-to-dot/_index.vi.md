---
title: API C++ để chuyển đổi PPTM sang DOT
description: Xuất PPTM sang DOT trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTM sang DOT" h2="Xuất PPTM sang DOT trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
