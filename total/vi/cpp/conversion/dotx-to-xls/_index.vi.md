---
title: Chuyển đổi DOTX sang XLS trong C++
description: C++ API để chuyển đổi DOTX sang XLS mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/cpp/conversion/dotx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để chuyển đổi DOTX sang XLS" h2="Xuất DOTX sang XLS qua C++ mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
