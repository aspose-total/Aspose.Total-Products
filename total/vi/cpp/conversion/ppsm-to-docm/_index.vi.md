---
title: API C++ để chuyển đổi PPSM sang DOCM
description: Xuất PPSM sang DOCM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPSM sang DOCM" h2="Xuất PPSM sang DOCM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
