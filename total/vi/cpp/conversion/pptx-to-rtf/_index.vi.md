---
title: API C++ để chuyển đổi PPTX sang RTF
description: Xuất PPTX sang RTF trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang RTF" h2="Xuất PPTX sang RTF trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
