---
title: API C++ để chuyển đổi PPTX sang DOCM
description: Xuất PPTX sang DOCM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang DOCM" h2="Xuất PPTX sang DOCM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
...
3. Tải tệp HTML đã chuyển đổi bằng cách sử dụng tham chiếu lớp [Docmument](https://reference.aspose.com/words/cpp/class/aspose.words.docmument)
