---
title: API C++ để chuyển đổi POTM sang DOC
description: Xuất POTM sang DOC trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị POTM sang DOC" h2="Xuất POTM sang DOC trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
