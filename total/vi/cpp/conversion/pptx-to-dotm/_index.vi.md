---
title: API C++ để chuyển đổi PPTX sang DOTM
description: Xuất PPTX sang DOTM trong các ứng dụng C++ của bạn
url: /vi/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang DOTM" h2="Xuất PPTX sang DOTM trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/cpp/conversion/pptx-to-dotmm/" name="PPTX Đến DOTMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/cpp/conversion/pptx-to-dotmx/" name="PPTX Đến DOTMX" description="" >}}
