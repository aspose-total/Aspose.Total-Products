---
title: API C++ để chuyển đổi PPTX sang WORDML
description: Xuất PPTX sang WORDML trong các ứng dụng C++ của bạn
...
{{< blocks/products/pf/feature-page-header h1="API C++ để hiển thị PPTX sang WORDML" h2="Xuất PPTX sang WORDML trong các ứng dụng C++ mà không có bất kỳ phụ thuộc Microsoft PowerPoint hoặc Word nào" >}}
