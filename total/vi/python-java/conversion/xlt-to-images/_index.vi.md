---
title: Chuyển đổi XLT sang Hình ảnh bằng Python
description: Chuyển đổi XLT sang hình ảnh TIFF BMP PNG JPEG GIF EMF SVG trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Excel 
url: /vi/python-java/conversion/xlt-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLT
...
- Lưu tất cả các trang của trang tính dưới dạng hình ảnh bằng phương pháp [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). Bây giờ tệp XLT được chuyển đổi thành Hình ảnh theo đường dẫn được chỉ định

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Yêu cầu chuyển đổi" %}}

- Để chuyển đổi XLT sang Hình ảnh (JPG, PNG, GIF, BMP, TIFF), các API tham chiếu trong dự án trực tiếp từ PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Chuyển đổi XLT sang Hình ảnh qua Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLT Tưởng tượng" description="" >}}
