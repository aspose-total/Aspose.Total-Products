...
description: Chuyển đổi DOTM sang ODS qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi DOTM sang ODS qua Java" h2="Trên API Premise Java để chuyển đổi DOTM sang ODS mà không cần sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
