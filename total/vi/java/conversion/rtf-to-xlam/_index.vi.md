---
title: Java API để chuyển đổi RTF sang XLAM
description: Chuyển đổi RTF sang XLAM qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi RTF sang XLAM qua Java" h2="Trên API Premise Java để chuyển đổi RTF sang XLAM mà không cần sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C ++ để chuyển đổi RTF sang XLAM" %}}
...
Sau khi chuyển đổi RTF sang XLAM, [Aspose.Cells for Java](https://products.aspose.com/cells/java/) cho phép bạn lưu tài liệu của mình vào luồng. Nếu bạn cần lưu tệp vào Luồng thì bạn nên tạo một đối tượng FileOutputStream rồi [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.io.OutputStream,%20com.aspose.cells.SaveOptions)) tệp vào đối tượng Luồng đó bằng cách gọi phương thức lưu của [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) vật. 
{{% blocks/products/pf/feature-page-code %}}
