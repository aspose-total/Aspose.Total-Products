...
<iframe title="Ứng dụng chuyển đổi PCL sang ODP trực tuyến miễn phí" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odp&from=pcl" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Mã Java để chuyển đổi PCL sang ODP" offSpacer="" %}}
