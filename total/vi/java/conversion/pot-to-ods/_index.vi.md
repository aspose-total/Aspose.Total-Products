---
title: Chuyển đổi POT sang Định dạng ODS qua Java
description: Chuyển đổi POT sang định dạng ODS qua Java mà không cần sử dụng Microsoft Excel hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POT sang ODS qua Java" h2="Trên API Premise Java để xuất POT sang ODS mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
4. Lưu tài liệu sang định dạng ODS bằng cách sử dụng [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells)).SaveOptions)) Phương thức 
