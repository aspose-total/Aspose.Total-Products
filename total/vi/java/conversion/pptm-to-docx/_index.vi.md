...
url: /vi/java/conversion/pptm-to-docx/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
Để chuyển đổi tệp PPTM sang DOCX, bạn có thể dễ dàng sử dụng Aspose.Total cho Java trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) dựa trên dự án và bao gồm các thư viện trong pom.xml của bạn.
