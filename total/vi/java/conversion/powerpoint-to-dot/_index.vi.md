---
title: Chuyển đổi POWERPOINT sang DOT qua Java
description: Java API để xuất POWERPOINT sang DOT mà không cần sử dụng Microsoft Word hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POWERPOINT sang DOT qua Java" h2="Trên Premise Java API cho PowerPoint chuyển đổi POWERPOINT sang DOT trong bất kỳ ứng dụng Java J2SE, J2EE, J2ME nào" >}}
...
4. Lưu tài liệu sang định dạng DOT bằng phương thức [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int))
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Yêu cầu chuyển đổi" %}}
Để chuyển đổi tệp POWERPOINT sang DOT, bạn có thể dễ dàng sử dụng Aspose.Total for Java trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) dựa trên dự án và bao gồm các thư viện trong pom.xml của bạn.
...
Sử dụng API, bạn cũng có thể thực hiện chuyển đổi tệp POWERPOINT sang DOT với hình mờ. Để thêm hình mờ vào tài liệu DOT, trước tiên bạn có thể chuyển đổi tệp POWERPOINT sang HTML và thêm hình mờ vào đó. Để thêm hình mờ, hãy tải tệp HTML mới được tạo bằng cách sử dụng lớp [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), tạo một bản sao của TextWatermarkOptions và đặt thuộc tính của nó, Gọi phương thức Watermark.setText và chuyển văn bản & đối tượng hình mờ của TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
