---
title: Chuyển đổi DOT sang ODP qua Java
description: Java API để xuất DOT sang ODP mà không cần sử dụng Microsoft Word hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi DOT sang ODP qua Java" h2="Chuyển đổi DOT sang ODP bằng cách sử dụng API Java tiền đề trong bất kỳ ứng dụng Java J2SE, J2EE, J2ME nào mà không cần sử dụng Microsoft<sup>&reg;</sup> PowerPoint hoặc Word" >}}
