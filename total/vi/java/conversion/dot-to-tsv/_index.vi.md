...
description: Chuyển đổi DOT sang TSV qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi DOT sang TSV qua Java" h2="Trên API Premise Java để chuyển đổi DOT sang TSV mà không cần sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
