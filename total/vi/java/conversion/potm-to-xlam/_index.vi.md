...
url: /vi/java/conversion/potm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
Bạn có thể chuyển đổi tệp POTM sang XLAM qua [Aspose.Total cho Java](https://products.aspose.com/total/java/) trong hai bước. Trong bước đầu tiên, bạn có thể xuất POTM sang HTML bằng cách sử dụng [Aspose.Slides cho Java](https://products.aspose.com/slides/java/). Thứ hai, bằng cách sử dụng [Aspose.Cells cho Java](https://products.aspose.com/cells/java/), bạn có thể chuyển đổi HTML sang XLAM.
{{% /blocks/products/pf/feature-page-summary  %}}
...
Để chuyển đổi POTM sang XLAM, bạn có thể dễ dàng sử dụng Aspose.Total cho Java trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ dự án dựa trên aspose/aspose-total) và bao gồm các thư viện trong pom.xml của bạn.
