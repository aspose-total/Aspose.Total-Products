---
title: Chuyển đổi PPSM sang DOC qua Java
description: Java API để xuất PPSM sang DOC mà không cần sử dụng Microsoft Word hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSM sang DOC qua Java" h2="Trên Premise Java API cho PowerPoint chuyển đổi PPSM sang DOC trong bất kỳ ứng dụng Java J2SE, J2EE, J2ME nào" >}}
...
Để chuyển đổi tệp PPSM sang DOC, bạn có thể dễ dàng sử dụng Aspose.Total for Java trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) dựa trên dự án và bao gồm các thư viện trong pom.xml của bạn.
...
Sử dụng API, bạn cũng có thể thực hiện chuyển đổi tệp PPSM sang DOC với hình mờ. Để thêm hình mờ vào tài liệu DOC, trước tiên bạn có thể chuyển đổi tệp PPSM sang HTML và thêm hình mờ vào đó. Để thêm hình mờ, hãy tải tệp HTML mới được tạo bằng cách sử dụng lớp [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), tạo một bản sao của TextWatermarkOptions và đặt thuộc tính của nó, Gọi phương thức Watermark.setText và chuyển văn bản & đối tượng hình mờ của TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
