---
title: Chuyển đổi SXC sang WORD bằng Java
description: Java API để xuất SXC sang WORD bằng Excel hoặc Word
url: /vi/java/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java để xuất SXC sang WORD" h2="Trên API Premise Java để Xuất SXC sang WORD mà không cần dựa vào Microsoft Excel & reg;" >}}
{{% blocks/products/pf/feature-page-summary %}}
Đưa SXC sang WORD là một quá trình gồm hai bước. Trước tiên, bạn sẽ sử dụng API [Aspose.Cells cho Java](https://products.aspose.com/cells/java) để chuyển đổi tài liệu SXC đã cho sang PDF, sau đó bằng cách sử dụng [Aspose.Pdf cho Java](https://products.aspose.com/pdf/java) API, bạn có thể dễ dàng chuyển đổi tài liệu PDF của mình sang WORD. Cả hai API đều nằm trong bộ sưu tập các thư viện tự động hóa định dạng tệp [Aspose.Total cho Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/net/conversion/sxc-to-wordx/" name="SXC Đến WORDX" description="" >}}
