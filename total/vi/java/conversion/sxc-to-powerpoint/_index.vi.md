---
title: Chuyển đổi SXC sang POWERPOINT bằng Java
description: Java API để xuất SXC sang POWERPOINT bằng Excel hoặc Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java để xuất SXC sang POWERPOINT" h2="Trên API Premise Java để Xuất SXC sang POWERPOINT mà không cần dựa vào Microsoft Excel & reg;" >}}
