...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSM sang SXC qua Java hoặc trực tuyến" h2="Trên API Premise Java để xuất PPSM sang SXC mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
