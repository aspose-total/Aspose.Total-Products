---
title: Chuyển đổi XLTX sang DOCX bằng Java
description: Java API để xuất XLTX sang DOCX bằng Excel hoặc Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java để xuất XLTX sang DOCX" h2="Trên API Premise Java để Xuất XLTX sang DOCX mà không cần dựa vào Microsoft Excel & reg;" >}}
