...
description: Chuyển đổi PPTX sang định dạng ODS qua Java mà không cần sử dụng Microsoft Excel hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPTX sang ODS qua Java" h2="Trên API Premise Java để xuất PPTX sang ODS mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
