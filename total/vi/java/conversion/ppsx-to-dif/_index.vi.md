...
description: Chuyển đổi PPSX sang định dạng DIF qua Java mà không cần sử dụng Microsoft Excel hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSX sang DIF qua Java" h2="Trên API Premise Java để xuất PPSX sang DIF mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
