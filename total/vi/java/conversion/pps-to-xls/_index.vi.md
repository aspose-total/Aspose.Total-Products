...
description: Chuyển đổi PPS sang định dạng XLS qua Java mà không cần sử dụng Microsoft Excel hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPS sang XLS qua Java" h2="Trên API Premise Java để xuất PPS sang XLS mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
