...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POT sang CSV qua Java hoặc trực tuyến" h2="Trên API Premise Java để xuất POT sang CSV mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
