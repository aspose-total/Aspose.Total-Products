...
<iframe title="Công cụ trực tuyến chuyển đổi từ doc sang ppsx" style="border: none; height: 426px;" scrolling="no" src="https://widgets.aspose.cloud/total-conversion/?to=ppsx&from=doc" id="child-iframe" width="80%"></iframe>
