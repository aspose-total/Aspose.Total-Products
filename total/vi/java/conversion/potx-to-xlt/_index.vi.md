...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTX sang XLT qua Java hoặc trực tuyến" h2="Trên API Premise Java để xuất POTX sang XLT mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
