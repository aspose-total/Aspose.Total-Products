...
description: Chuyển đổi PPSM sang định dạng DIF qua Java mà không cần sử dụng Microsoft Excel hoặc PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSM sang DIF qua Java" h2="Trên API Premise Java để xuất PPSM sang DIF mà không sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
