---
title: Chuyển đổi FODS sang DOCX bằng Java
description: Java API để xuất FODS sang DOCX bằng Excel hoặc Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java để xuất FODS sang DOCX" h2="Trên API Premise Java để Xuất FODS sang DOCX mà không cần dựa vào Microsoft Excel & reg;" >}}
