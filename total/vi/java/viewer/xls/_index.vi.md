---
title: Xem tệp XLS trực tuyến và sử dụng Java
description: Ứng dụng xem file XLS trực tuyến miễn phí. Mã Java API để đọc tệp XLS cho ứng dụng xem.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tự do xem tệp XLS trực tuyến hoặc qua Java" h2="Phát triển ứng dụng tiện ích xem tài liệu XLS dựa trên Java mạnh mẽ.Mã được liệt kê để xem tài liệu XLS thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Xem tệp XLS qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để xem tệp XLS" offSpacer="" %}}
