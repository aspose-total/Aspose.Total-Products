---
title: Chỉnh sửa bảng tính ODS trực tuyến hoặc sử dụng Java
description: Mở và biên tập lại tài liệu ODS trực tuyến miễn phí qua ứng dụng.Mã Java API để tìm kiếm và thay thế văn bản ODS bằng biểu thức chính quy.
...
{{< blocks/products/pf/feature-page-header-widget h1="Biên tập lại tài liệu ODS trực tuyến hoặc qua Java" h2="Phát triển ứng dụng tiện ích biên tập tài liệu ODS dựa trên Java mạnh mẽ. Mã được liệt kê để tìm kiếm và thay thế văn bản trong tệp ODS bằng biểu thức chính quy thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Biên tập lại tệp ODS qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java: Biên tập lại Bảng tính ODS" offSpacer="" %}}
...
<h2>Phát triển ứng dụng ODS Redaction qua Java</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích Java để biên tập lại tệp ODS" %}}
