---
title: Biên tập lại tài liệu ODT trực tuyến hoặc sử dụng Java
description: Mở và biên tập lại tài liệu ODT trực tuyến miễn phí qua ứng dụng.Mã Java API để tìm kiếm và thay thế văn bản ODT bằng biểu thức chính quy.
...
{{< blocks/products/pf/feature-page-header-widget h1="Biên tập lại tài liệu ODT trực tuyến hoặc qua Java" h2="Phát triển ứng dụng tiện ích biên tập tài liệu ODT dựa trên Java mạnh mẽ.Mã được liệt kê để tìm kiếm và thay thế văn bản trong tệp ODT bằng biểu thức chính quy thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Biên tập lại tệp ODT qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java: Biên tập lại tài liệu ODT" offSpacer="" %}}
