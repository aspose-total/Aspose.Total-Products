---
title: Xem và cập nhật thuộc tính DOCX trực tuyến hoặc Cập nhật siêu dữ liệu bằng Java
description: Xem và sửa đổi các thuộc tính DOCX thông qua ứng dụng trực tuyến miễn phí.Mã Java API để cập nhật thuộc tính DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu DOCX trực tuyến hoặc cập nhật qua Java" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu DOCX dựa trên Java mạnh mẽ.Mã được liệt kê để cập nhật siêu dữ liệu tệp DOCX thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cập nhật thuộc tính DOCX qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để cập nhật siêu dữ liệu DOCX" offSpacer="" %}}
