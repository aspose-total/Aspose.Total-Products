---
title: Xem và cập nhật thuộc tính RTF trực tuyến hoặc Cập nhật siêu dữ liệu bằng Java
description: Xem và sửa đổi các thuộc tính RTF thông qua ứng dụng trực tuyến miễn phí.Mã Java API để cập nhật thuộc tính RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu RTF trực tuyến hoặc cập nhật qua Java" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu RTF dựa trên Java mạnh mẽ.Mã được liệt kê để cập nhật siêu dữ liệu tệp RTF thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cập nhật thuộc tính RTF qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để cập nhật siêu dữ liệu RTF" offSpacer="" %}}
