---
title: Xem và cập nhật thuộc tính DOTX trực tuyến hoặc Cập nhật siêu dữ liệu bằng Java
description: Xem và sửa đổi các thuộc tính DOTX thông qua ứng dụng trực tuyến miễn phí.Mã Java API để cập nhật thuộc tính DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu DOTX trực tuyến hoặc cập nhật qua Java" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu DOTX dựa trên Java mạnh mẽ.Mã được liệt kê để cập nhật siêu dữ liệu tệp DOTX thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cập nhật thuộc tính DOTX qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để cập nhật siêu dữ liệu DOTX" offSpacer="" %}}
