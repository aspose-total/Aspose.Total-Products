---
title: Trích xuất văn bản và hình ảnh từ tệp XLS trực tuyến và sử dụng Java
description: Ứng dụng phân tích tệp XLS trực tuyến. Mã Java API để trích xuất văn bản trong hàng và ô từ bảng tính XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Phân tích tệp XLS trực tuyến cũng như qua Java" h2="Phát triển ứng dụng tiện ích phân tích cú pháp tài liệu XLS dựa trên Java mạnh mẽ.Mã được liệt kê để phân tích tài liệu XLS thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Phân tích tệp XLS qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để phân tích tài liệu XLS" offSpacer="" %}}
