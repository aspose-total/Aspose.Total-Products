---
title: Hợp nhất các tệp PDF trực tuyến hoặc sử dụng Java
description: Ứng dụng trực tuyến miễn phí để kết hợp các tệp PDF khác nhau.Mã Java để hợp nhất các tài liệu PDF sang các định dạng khác.
...
{{< blocks/products/pf/feature-page-header-widget h1="Hợp nhất tài liệu PDF trực tuyến thông qua ứng dụng sáp nhập hoặc sử dụng Java" h2="Phát triển ứng dụng hợp nhất tài liệu PDF dựa trên Java mạnh mẽ. Kết hợp nhiều tài liệu PDF thành một tài liệu trực tuyến miễn phí qua ứng dụng.Lưu tệp PDF dưới dạng PDF, Hình ảnh, Word, Excel, PowerPoint và nhiều định dạng khác trực tuyến." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hợp nhất tệp PDF qua Java" %}}

1. Thêm tham chiếu thư viện Java vào dự án của bạn
1. Tải tài liệu PDF đầu tiên bằng lớp Document.
1. Tải tài liệu PDF thứ hai bằng cách sử dụng một phiên bản khác cùng loại.
1. Sử dụng phiên bản đầu tiên và gọi hàm getPages().add với tham số thứ hai làm tham số.
...
{{% blocks/products/pf/agp/code-block title="Mã Java để hợp nhất các tệp PDF" offSpacer="" %}}
...
<h2>Phát triển File Merger PDF bằng Java</h2>

Bạn cần phát triển tập lệnh Java hoặc ứng dụng tiện ích để dễ dàng hợp nhất nhiều tệp PDF?Với [Aspose.PDF for Java](https://products.aspose.com/pdf/vi/java/), API con của [Aspose.Total for Java](https://products.aspose.com/total/vi/java/), bất kỳ nhà phát triển Java nào cũng có thể tích hợp mã API trên để lập trình ứng dụng hợp nhất trên các tài liệu.Thư viện Java mạnh mẽ cho phép lập trình giải pháp sáp nhập tài liệu có thể hỗ trợ nhiều định dạng phổ biến trong đó có định dạng PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Thư viện hợp nhất Java cho các tệp PDF" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này và sử dụng nó cho mục đích phát triển các ứng dụng dựa trên Java tập trung vào việc kết hợp các tài liệu PDF.Mã này có thể phục vụ như một nguồn tài nguyên có giá trị để nâng cao chức năng và khả năng của các dự án của bạn trong lĩnh vực hợp nhất tài liệu.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
