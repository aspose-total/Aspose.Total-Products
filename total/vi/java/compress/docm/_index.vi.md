---
title: Nén tệp DOCM trực tuyến hoặc qua Java
description: Ứng dụng trực tuyến miễn phí để nén các tệp DOCM khác nhau. Mã thư viện nén Java cho tài liệu DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Nén file DOCM trực tuyến qua ứng dụng nén hoặc sử dụng Java" h2="Phát triển các ứng dụng nén tài liệu DOCM dựa trên Java mạnh mẽ.Tự do nén nhiều tài liệu khác nhau bao gồm các tệp DOCM trực tuyến thông qua ứng dụng với khả năng tải xuống tức thì." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Nén tệp DOCM qua Java" %}}
...
1. Gọi phương thức lưu và lấy tệp DOCM đã nén

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Ví dụ mã trong Java để nén tệp DOCM" offSpacer="" %}}
...
<h2>Phát triển ứng dụng nén file DOCM bằng Java</h2>

Bạn cần phát triển tập lệnh Java hoặc ứng dụng tiện ích để dễ dàng nén nhiều tệp DOCM? Với API con [Aspose.Words for Java](https://products.aspose.com/words/java/) của [Aspose.Total for Java](https://products.aspose.com/total/java/), bất kỳ nhà phát triển Java nào cũng có thể tích hợp mã API trên để lập trình ứng dụng nén trên các tài liệu.Thư viện Java mạnh mẽ để nén tài liệu hỗ trợ nhiều định dạng phổ biến bao gồm định dạng DOCM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Thư viện nén Java cho tệp DOCM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này. Người ta có thể dễ dàng phát triển một giải pháp chuyên nghiệp để nén tệp DOCM bằng Java. Sử dụng API nén Aspose DOCM để phát triển phần mềm độc lập với nền tảng, cấp cao trong Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
