---
title: Bảo vệ tài liệu ODT trực tuyến bằng mật khẩu và sử dụng Java
description: Ứng dụng bảo vệ mật khẩu file ODT trực tuyến.Mã Java API để áp dụng bảo vệ bằng mật khẩu trên tài liệu ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bảo vệ tài liệu ODT trực tuyến hoặc đặt mật khẩu qua Java" h2="Phát triển ứng dụng tiện ích bảo vệ tài liệu ODT dựa trên Java mạnh mẽ.Mã được liệt kê để áp dụng mật khẩu cho tài liệu ODT thông qua Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Bảo vệ mật khẩu ODT qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã Java để bảo vệ mật khẩu tài liệu ODT" offSpacer="" %}}
