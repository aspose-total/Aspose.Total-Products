---
title: Chuyển đổi DOT sang DIF bằng Python
description: Chuyển đổi DOT sang DIF trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word hoặc Excel 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOT sang DIF qua Python" h2="Chuyển đổi DOT sang DIF trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Word<sup>&reg;</sup> hoặc Excel" >}}
