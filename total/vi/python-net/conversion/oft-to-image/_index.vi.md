---
title: Chuyển đổi OFT sang IMAGE bằng Python
description: Lưu OFT thành IMAGE trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-image/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang IMAGE, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành IMAGE bằng Python" offSpacer="" %}}
