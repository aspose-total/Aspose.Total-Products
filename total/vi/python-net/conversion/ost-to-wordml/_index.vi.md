---
title: Chuyển đổi OST sang WORDML bằng Python
description: Lưu OST thành WORDML trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/ost-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Để chuyển đổi OST sang WORDML, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OST thành WORDML bằng Python" offSpacer="" %}}
