---
title: Chuyển đổi DOCM sang FODS bằng Python
description: Chuyển đổi DOCM sang FODS trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word hoặc Excel 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOCM sang FODS qua Python" h2="Chuyển đổi DOCM sang FODS trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Word<sup>&reg;</sup> hoặc Excel" >}}
