---
title: Chuyển đổi OFT sang SVG bằng Python
description: Lưu OFT thành SVG trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-svg/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang SVG, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành SVG bằng Python" offSpacer="" %}}
