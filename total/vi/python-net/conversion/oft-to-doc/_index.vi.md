---
title: Chuyển đổi OFT sang DOC bằng Python
description: Lưu OFT thành DOC trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-doc/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang DOC, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành DOC bằng Python" offSpacer="" %}}
