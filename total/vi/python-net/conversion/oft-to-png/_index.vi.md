---
title: Chuyển đổi OFT sang PNG bằng Python
description: Lưu OFT thành PNG trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-png/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang PNG, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành PNG bằng Python" offSpacer="" %}}
