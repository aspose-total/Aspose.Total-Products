---
title: Chuyển đổi OFT sang TIFF bằng Python
description: Lưu OFT thành TIFF trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang TIFF, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành TIFF bằng Python" offSpacer="" %}}
