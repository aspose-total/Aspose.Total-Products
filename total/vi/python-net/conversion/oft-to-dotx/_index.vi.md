---
title: Chuyển đổi OFT sang DOTX bằng Python
description: Lưu OFT thành DOTX trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang DOTX, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành DOTX bằng Python" offSpacer="" %}}
