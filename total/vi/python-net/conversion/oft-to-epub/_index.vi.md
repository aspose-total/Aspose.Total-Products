---
title: Chuyển đổi OFT sang EPUB bằng Python
description: Lưu OFT thành EPUB trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-epub/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang EPUB, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành EPUB bằng Python" offSpacer="" %}}
