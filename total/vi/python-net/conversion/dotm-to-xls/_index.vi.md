---
title: Chuyển đổi DOTM sang XLS bằng Python
description: Chuyển đổi DOTM sang XLS trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word hoặc Excel 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOTM sang XLS qua Python" h2="Chuyển đổi DOTM sang XLS trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Word<sup>&reg;</sup> hoặc Excel" >}}
