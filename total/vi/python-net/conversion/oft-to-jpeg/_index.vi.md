---
title: Chuyển đổi OFT sang JPEG bằng Python
description: Lưu OFT thành JPEG trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang JPEG, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành JPEG bằng Python" offSpacer="" %}}
