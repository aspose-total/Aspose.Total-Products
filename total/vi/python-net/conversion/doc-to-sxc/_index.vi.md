---
title: Chuyển đổi DOC sang SXC bằng Python
description: Chuyển đổi DOC sang SXC trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word hoặc Excel 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOC sang SXC qua Python" h2="Chuyển đổi DOC sang SXC trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Word<sup>&reg;</sup> hoặc Excel" >}}
