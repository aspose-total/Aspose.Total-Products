...
- Để chuyển đổi OST sang XPS, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OST thành XPS bằng Python" offSpacer="" %}}
