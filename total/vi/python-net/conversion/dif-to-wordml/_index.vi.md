---
title: Chuyển đổi DIF sang WORDML bằng Python
description: Chuyển đổi DIF sang WORDML trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DIF sang WORDML qua Python" h2="Chuyển đổi DIF sang WORDML trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Excel<sup>&reg;</sup> hoặc Word" >}}
