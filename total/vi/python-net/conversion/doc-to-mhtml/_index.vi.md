---
title: Chuyển đổi DOC sang MHTML bằng Python
description: DOC sang mhtml Định dạng lưu trữ web và chuyển đổi tệp HtmlFixed trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word 
url: /vi/python-net/conversion/doc-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOC sang MHTML bằng Python" h2="Chuyển đổi DOC sang MHTML, HtmlFixed và HTML trong Ứng dụng Python của bạn mà không cần cài đặt Microsoft Word <sup>&reg;</sup>." >}}
...
Chúng tôi sử dụng API [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/) nằm trong Gói [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) để thêm tính năng chuyển đổi DOC sang MHTML. Trong trường hợp tệp DOC đơn giản thì nó chỉ có hai dòng mã. Tải tệp DOC và gọi phương thức lưu với đường dẫn tệp thích hợp cùng với kiểu liệt kê SaveFormat dưới dạng MHTML hoặc HTML_FIXED. Nhưng trong trường hợp cần khôi phục mô hình tài liệu gần giống với mô hình ban đầu thì cần phải lưu thêm một số thông tin trong tài liệu kết quả được gọi là thông tin khứ hồi.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Làm thế nào để Chuyển đổi DOC sang MHTML bằng Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Lưu DOC thành MHTML bằng Python - Đơn giản" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Chuyển đổi DOC sang MHTML bằng Python" offSpacer="" %}}
