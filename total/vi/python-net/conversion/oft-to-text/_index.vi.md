---
title: Chuyển đổi OFT sang TEXT bằng Python
description: Lưu OFT thành TEXT trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-text/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang TEXT, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành TEXT bằng Python" offSpacer="" %}}
