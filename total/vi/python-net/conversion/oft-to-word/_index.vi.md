---
title: Chuyển đổi OFT sang WORD bằng Python
description: Lưu OFT thành WORD trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Outlook hoặc Word 
url: /vi/python-net/conversion/oft-to-word/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Để chuyển đổi OFT sang WORD, cần có Python 3.5 trở lên
...
{{% blocks/products/pf/agp/code-block title="Lưu OFT thành WORD bằng Python" offSpacer="" %}}
