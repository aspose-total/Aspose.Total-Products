---
title: Chuyển đổi DOT sang XLAM bằng Python
description: Chuyển đổi DOT sang XLAM trong các ứng dụng Python của bạn mà không cần sử dụng Microsoft Word hoặc Excel 
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOT sang XLAM qua Python" h2="Chuyển đổi DOT sang XLAM trong các ứng dụng Python của bạn mà không cần cài đặt Microsoft Word<sup>&reg;</sup> hoặc Excel" >}}
