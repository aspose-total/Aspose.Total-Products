---
title: Xem file XLS trực tuyến và sử dụng .NET
description: Ứng dụng xem file XLS trực tuyến miễn phí. Mã .NET API C# để đọc tệp XLS cho ứng dụng xem.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tự do xem tệp XLS trực tuyến hoặc qua .NET" h2="Phát triển ứng dụng tiện ích xem tài liệu XLS dựa trên .NET mạnh mẽ. Mã C# được liệt kê để xem tài liệu XLS." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Xem tài liệu XLS qua ứng dụng trực tuyến" %}}
...
1. Điều hướng giữa các trang trong trường hợp tài liệu XLS có nhiều trang.
1. Đặt chế độ phóng to hoặc thu nhỏ chế độ xem trang.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Xem tệp XLS qua .NET" %}}

1. Thêm tham chiếu thư viện .NET vào dự án
1. Tải tệp XLS nguồn bằng đối tượng lớp Workbook
1. Lưu bảng tính dưới dạng tệp HTML
...
{{% blocks/products/pf/agp/code-block title="Mã C#: Xem bảng tính XLS" offSpacer="" %}}
...
<h2>Phát triển ứng dụng XLS File Viewer qua .NET</h2>

Bạn cần phát triển ứng dụng, tiện ích xem XLS?Với [Aspose.Cells for .NET](https://products.aspose.com/cells/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng xem bảng tính của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp hiển thị tài liệu nào có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng XLS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET xử lý file XLS cho ứng dụng hiển thị" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này và sử dụng nó cho mục đích phát triển ứng dụng xem tài liệu dựa trên .NET.Mã này có thể đóng vai trò là tài nguyên quý giá để nâng cao chức năng và khả năng của các dự án của bạn trong lĩnh vực xử lý tài liệu phụ trợ, chẳng hạn như đọc trang tính, hàng và ô tài liệu cho ứng dụng hiển thị.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Sử dụng ứng dụng trực tuyến để xem tài liệu XLS có an toàn không?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bạn có thể sử dụng bất kỳ trình duyệt web hiện đại nào như Google Chrome, Firefox, Opera hoặc Safari để xem tài liệu XLS trực tuyến. Tuy nhiên, nếu bạn đang phát triển một ứng dụng dành cho máy tính để bàn, chúng tôi khuyên bạn nên sử dụng API xử lý tài liệu Aspose.Total để quản lý hiệu quả.</span>
                      </div>
                  </li>
              </ul>
          </div>
