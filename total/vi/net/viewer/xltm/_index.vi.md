---
title: Xem file XLTM trực tuyến và sử dụng .NET
description: Ứng dụng xem file XLTM trực tuyến miễn phí. Mã .NET API C# để đọc tệp XLTM cho ứng dụng xem.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tự do xem tệp XLTM trực tuyến hoặc qua .NET" h2="Phát triển ứng dụng tiện ích xem tài liệu XLTM dựa trên .NET mạnh mẽ. Mã C# được liệt kê để xem tài liệu XLTM." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Xem tệp XLTM qua .NET" %}}

1. Thêm tham chiếu thư viện .NET vào dự án
1. Tải tệp XLTM nguồn bằng đối tượng lớp Workbook
...
{{% blocks/products/pf/agp/code-block title="Mã C#: Xem bảng tính XLTM" offSpacer="" %}}
...
<h2>Phát triển ứng dụng XLTM File Viewer qua .NET</h2>

Bạn cần phát triển ứng dụng, tiện ích xem XLTM?Với [Aspose.Cells for .NET](https://products.aspose.com/cells/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng xem bảng tính của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp hiển thị tài liệu nào có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng XLTM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET xử lý file XLTM cho ứng dụng hiển thị" %}}
