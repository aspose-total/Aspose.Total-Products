---
title: Biên tập lại Bảng tính ODS Trực tuyến hoặc sử dụng .NET
description: Mở và biên tập lại tài liệu ODS trực tuyến miễn phí qua ứng dụng. Mã .NET API C# để tìm kiếm và thay thế văn bản ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Biên tập lại tài liệu ODS trực tuyến hoặc qua .NET" h2="Phát triển ứng dụng tiện ích biên tập tài liệu ODS dựa trên .NET mạnh mẽ. Mã C# được liệt kê để tìm kiếm và thay thế văn bản trong tệp ODS." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Biên tập lại tệp ODS qua .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã C#: Biên tập lại bảng tính ODS" offSpacer="" %}}
...
<h2>Phát triển ứng dụng ODS Redaction qua .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET để biên tập lại tệp ODS" %}}
