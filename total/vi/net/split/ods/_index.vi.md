---
title: Tách file ODS trực tuyến hoặc qua .NET
description: Ứng dụng trực tuyến miễn phí để chia các tờ ODS khác nhau.Mã thư viện bộ chia .NET C# cho bảng tính ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tách tệp ODS trực tuyến qua ứng dụng Splitter hoặc sử dụng .NET" h2="Phát triển các ứng dụng chia tài liệu ODS dựa trên .NET mạnh mẽ.Tự do chia nhỏ tài liệu bao gồm các tệp ODS trực tuyến qua ứng dụng với khả năng tải xuống tức thì." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tách tệp ODS trực tuyến bằng ứng dụng" %}}

1. Tải tệp ODS lên để tách.
...
{{% blocks/products/pf/agp/feature-section-col title="Tách tệp ODS qua .NET" %}}

1. Tải tệp ODS bằng lớp Workbook
1. Lấy ô hiện hoạt
1. Chia cửa sổ bảng tính
1. Gọi phương thức Save() để lưu file

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Mã .NET : Tách file ODS" offSpacer="" %}}
...
<h2>Phát triển ứng dụng File Splitter ODS bằng .NET</h2>

Bạn cần phát triển tập lệnh .NET hoặc ứng dụng tiện ích để dễ dàng chia nhỏ file ODS?Với [Aspose.Cells for .NET](https://products.aspose.com/cells/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng chia tách chương trình.Thư viện .NET mạnh mẽ để chia nhỏ tài liệu hỗ trợ nhiều định dạng phổ biến bao gồm định dạng ODS như tệp PDF, Word, Excel và PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Thư viện ODS Splitter cho .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này. Người ta có thể dễ dàng phát triển một giải pháp chuyên nghiệp để chia nhỏ các tệp ODS bằng .NET.Sử dụng API bộ tách Aspose ODS để phát triển phần mềm độc lập với nền tảng, cấp cao trong .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Sử dụng ứng dụng trực tuyến để chia nhiều tài liệu ODS có an toàn không?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bạn có thể sử dụng bất kỳ trình duyệt web hiện đại nào như Google Chrome, Firefox, Opera hoặc Safari cho Bộ chia tài liệu ODS trực tuyến.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Mất bao lâu để chia nhỏ các tập tin ODS?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
