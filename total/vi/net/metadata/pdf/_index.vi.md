---
title: Xem và cập nhật thuộc tính PDF trực tuyến hoặc Cập nhật siêu dữ liệu bằng .NET
description: Xem và sửa đổi các thuộc tính PDF thông qua ứng dụng trực tuyến miễn phí.Mã API C# .NET để cập nhật thuộc tính PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu PDF trực tuyến hoặc cập nhật qua .NET" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu PDF dựa trên .NET mạnh mẽ.Mã được liệt kê để cập nhật siêu dữ liệu tệp PDF thông qua .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cập nhật siêu dữ liệu PDF qua .NET" %}}

1. Tải tệp PDF bằng lớp Tài liệu.
1. Tạo đối tượng lớp DocumentInfo có đối tượng đầu tiên làm tham số
1. Chỉ định thuộc tính mới
1. Lưu tài liệu với các thuộc tính được cập nhật
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Mã .NET: Cập nhật thuộc tính PDF" offSpacer="" %}}
...
<h2>Phát triển ứng dụng quản lý siêu dữ liệu PDF qua .NET</h2>

Bạn cần phát triển ứng dụng, tiện ích quản lý Metadata PDF?Với [Aspose.PDF for .NET](https://products.aspose.com/pdf/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng siêu dữ liệu tài liệu của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp siêu dữ liệu tài liệu nào.Hơn nữa, nó có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET để quản lý siêu dữ liệu PDF" %}}
