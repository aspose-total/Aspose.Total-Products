---
title: Xem và cập nhật thuộc tính XLSM trực tuyến hoặc Cập nhật siêu dữ liệu bằng .NET
description: Xem và sửa đổi các thuộc tính XLSM thông qua ứng dụng trực tuyến miễn phí. Mã API C# .NET để cập nhật và thêm thuộc tính XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu XLSM trực tuyến hoặc cập nhật qua .NET" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu XLSM dựa trên .NET mạnh mẽ.Mã được liệt kê để thêm và sửa đổi siêu dữ liệu tệp XLSM thông qua .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Quản lý thuộc tính XLSM qua .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã .NET: Cập nhật siêu dữ liệu XLSM" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Mã .NET: Thêm thuộc tính tùy chỉnh XLSM" offSpacer="" %}}
...
<h2>Phát triển ứng dụng quản lý siêu dữ liệu XLSM qua .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET để quản lý siêu dữ liệu XLSM" %}}
