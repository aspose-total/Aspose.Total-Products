---
title: Xem và cập nhật thuộc tính Excel trực tuyến hoặc Cập nhật siêu dữ liệu bằng .NET
description: Xem và sửa đổi các thuộc tính Excel thông qua ứng dụng trực tuyến miễn phí. Mã API C# .NET để cập nhật và thêm thuộc tính Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Xem hoặc cập nhật siêu dữ liệu Excel trực tuyến hoặc cập nhật qua .NET" h2="Phát triển ứng dụng tiện ích quản lý siêu dữ liệu tài liệu Excel dựa trên .NET mạnh mẽ.Mã được liệt kê để thêm và sửa đổi siêu dữ liệu tệp Excel thông qua .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Quản lý thuộc tính Excel qua .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã .NET: Cập nhật siêu dữ liệu Excel" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Mã .NET: Thêm thuộc tính tùy chỉnh Excel" offSpacer="" %}}
...
<h2>Phát triển ứng dụng quản lý siêu dữ liệu Excel qua .NET</h2>

Bạn cần phát triển ứng dụng, tiện ích quản lý Metadata Excel?Với [Aspose.Cells for .NET](https://products.aspose.com/cells/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng siêu dữ liệu tài liệu của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp siêu dữ liệu tài liệu nào.Hơn nữa, nó có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET để quản lý siêu dữ liệu Excel" %}}
