---
title: Hợp nhất tệp RTF trực tuyến hoặc sử dụng .NET
description: Ứng dụng trực tuyến miễn phí để kết hợp các tệp RTF khác nhau.Mã thư viện hợp nhất .NET để hợp nhất tài liệu RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Hợp nhất tài liệu RTF trực tuyến thông qua ứng dụng sáp nhập hoặc sử dụng .NET" h2="Phát triển ứng dụng hợp nhất tài liệu RTF dựa trên .NET mạnh mẽ.Kết hợp nhiều tài liệu RTF thành một tài liệu trực tuyến miễn phí qua ứng dụng.Lưu tệp RTF dưới dạng PDF, Hình ảnh, Word, Excel, PowerPoint và nhiều định dạng khác trực tuyến." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hợp nhất tệp RTF qua .NET" %}}
...
1. Gọi phương thức Save và gộp các file RTF đã hợp nhất thành một
...
{{% blocks/products/pf/agp/code-block title="Mã .NET: Hợp nhất các tệp RTF" offSpacer="" %}}
...
<h2>Phát triển File Merger RTF bằng .NET</h2>

Bạn cần phát triển ứng dụng tiện ích .NET để dễ dàng ghép nhiều file RTF?Với API con [Aspose.Words for .NET](https://products.aspose.com/words/vi/net/) của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên để lập trình ứng dụng hợp nhất trên các tài liệu.Thư viện .NET mạnh mẽ để hợp nhất các tài liệu hỗ trợ nhiều định dạng phổ biến bao gồm định dạng RTF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Thư viện hợp nhất .NET cho tệp RTF" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này. Người ta có thể dễ dàng phát triển một giải pháp chuyên nghiệp để kết hợp RTF bằng .NET.Sử dụng API hợp nhất Aspose RTF để phát triển phần mềm độc lập với nền tảng, cấp cao trong .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
