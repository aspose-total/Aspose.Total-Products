---
title: .NET API để chuyển đổi WORDML sang TSV
description: C# API để chuyển đổi WORDML sang TSV mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi WORDML sang TSV" h2="Xuất WORDML sang TSV qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
