---
title: Chuyển đổi POTX sang TSV qua C# hoặc trực tuyến
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTX sang TSV qua C# hoặc trực tuyến" h2=".NET API để chuyển đổi POTX sang TSV mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
