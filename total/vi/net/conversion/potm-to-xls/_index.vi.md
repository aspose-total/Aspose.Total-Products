---
title: Chuyển đổi POTM sang XLS qua C#
description: Chuyển đổi POTM sang XLS trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
url: /vi/net/conversion/potm-to-xls/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTM sang XLS qua C#" h2=".NET API để chuyển đổi POTM sang XLS mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
