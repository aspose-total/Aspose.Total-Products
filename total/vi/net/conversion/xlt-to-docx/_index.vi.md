---
title: Chuyển đổi XLT sang DOCX với .NET 
description: Chuyển đổi XLT sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xlt-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLT sang DOCX qua C#" h2="Xuất Excel & reg; XLT sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
