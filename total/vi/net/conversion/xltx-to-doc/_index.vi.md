---
title: Chuyển đổi XLTX sang DOC với .NET 
description: Chuyển đổi XLTX sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLTX sang DOC qua C#" h2="Xuất Excel & reg; XLTX sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
