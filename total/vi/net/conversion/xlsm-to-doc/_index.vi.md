---
title: Chuyển đổi XLSM sang DOC với .NET 
description: Chuyển đổi XLSM sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xlsm-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLSM sang DOC qua C#" h2="Xuất Excel & reg; XLSM sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
