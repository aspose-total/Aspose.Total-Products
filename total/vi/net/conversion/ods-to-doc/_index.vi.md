---
title: Chuyển đổi ODS sang DOC với .NET 
description: Chuyển đổi ODS sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi ODS sang DOC qua C#" h2="Xuất Excel & reg; ODS sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
