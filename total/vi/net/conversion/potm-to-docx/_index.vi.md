---
title: Chuyển đổi POTM sang DOCX qua C# .NET 
url: /vi/net/conversion/potm-to-docx/ 
...
Để tự động hóa quy trình chuyển đổi hàng loạt tệp PowerPoint potm sang tệp Word docx, chúng tôi sẽ sử dụng [Aspose.Slides cho .NET](https://products.aspose.com/slides/net) và [Aspose.Words cho các API .NET](https://products.aspose.com/words/net). Trước đây là một API thao tác trình bày PowerPoint cho phép bạn tạo hoặc sửa đổi các trang trình bày Microsoft PowerPoint. Trong khi, cái sau là một API xử lý văn bản để xử lý hoặc thao tác các tài liệu Microsoft Word. Cả hai API đều là một phần của gói [Aspose.Total cho .NET](https://products.aspose.com/total/net). Bạn có thể trực tiếp [tải xuống](https://downloads.aspose.com/) từ Nuget hoặc có thể sử dụng các lệnh sau từ Bảng điều khiển Trình quản lý Gói.
...
1. Tạo [Aspose.Words.Docxument](https://apireference.aspose.com/words/net/aspose.words/docxument) và phức tạp hóa nó bằng MemoryStream Object
1. Lưu tài liệu bằng [Aspose.Words.Docxument.Save ("output.docx", SaveFormat.Docx)](https://apireference.aspose.com/words/net/aspose.words.docxument/save/methods/3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/net/conversion/potm-to-docxx" name="POTM Đến DOCXX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/net/conversion/potm-to-docxm" name="POTM Đến DOCXM" description="" >}}
