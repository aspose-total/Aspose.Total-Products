---
title: Chuyển đổi FODS sang POWERPOINT với .NET 
description: Chuyển đổi FODS sang POWERPOINT trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/fods-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi FODS sang POWERPOINT qua C#" h2="Xuất Excel & reg; FODS sang POWERPOINT trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
