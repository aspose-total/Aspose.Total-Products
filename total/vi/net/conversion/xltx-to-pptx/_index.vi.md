---
title: Chuyển đổi XLTX sang PPTX với .NET 
description: Chuyển đổi XLTX sang PPTX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xltx-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLTX sang PPTX qua C#" h2="Xuất Excel & reg; XLTX sang PPTX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
