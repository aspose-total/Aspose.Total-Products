---
title: Chuyển đổi FODS sang WORD với .NET 
description: Chuyển đổi FODS sang WORD trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/fods-to-word/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi FODS sang WORD qua C#" h2="Xuất Excel & reg; FODS sang WORD trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
