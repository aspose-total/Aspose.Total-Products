---
title: Chuyển đổi XLSX sang DOC với .NET 
description: Chuyển đổi XLSX sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLSX sang DOC qua C#" h2="Xuất Excel & reg; XLSX sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
