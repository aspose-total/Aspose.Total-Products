---
title: .NET API để chuyển đổi RTF sang ODS
description: C# API để chuyển đổi RTF sang ODS mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
url: /vi/net/conversion/rtf-to-ods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi RTF sang ODS" h2="Xuất RTF sang ODS qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Lưu tài liệu sang định dạng ODS bằng phương pháp [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) và đặt `ODS` làm SaveFormat
