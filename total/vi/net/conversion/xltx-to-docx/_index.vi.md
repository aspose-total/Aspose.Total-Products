---
title: Chuyển đổi XLTX sang DOCX với .NET 
description: Chuyển đổi XLTX sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLTX sang DOCX qua C#" h2="Xuất Excel & reg; XLTX sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
