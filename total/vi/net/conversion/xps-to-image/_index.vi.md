...
1. Mở tệp XPS bằng lớp [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document)
...
4. Lưu tài liệu sang định dạng IMAGE bằng phương pháp [Save](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)
...
và lưu nó ở định dạng IMAGE bằng phương pháp [Save](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4).  
{{% blocks/products/pf/feature-page-code %}}
