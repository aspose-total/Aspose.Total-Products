...
description: C# API để chuyển đổi ODT sang XLSX mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi ODT sang XLSX" h2="Xuất ODT sang XLSX qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Lưu tài liệu sang định dạng XLSX bằng phương pháp [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) và đặt `XLSX` làm SaveFormat
