...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPS sang XLT qua C#" h2=".NET API để chuyển đổi PPS sang XLT mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
4. Lưu tài liệu vào XLT bằng phương pháp [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
