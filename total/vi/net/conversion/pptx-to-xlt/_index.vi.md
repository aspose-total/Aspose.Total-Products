...
description: Chuyển đổi PPTX sang XLT trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPTX sang XLT qua C#" h2=".NET API để chuyển đổi PPTX sang XLT mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
