---
title: Chuyển đổi XLT sang DOC với .NET 
description: Chuyển đổi XLT sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xlt-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLT sang DOC qua C#" h2="Xuất Excel & reg; XLT sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
