---
title: Chuyển đổi PPSX sang XLTM qua C#
description: Chuyển đổi PPSX sang XLTM trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSX sang XLTM qua C#" h2=".NET API để chuyển đổi PPSX sang XLTM mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
4. Lưu tài liệu vào XLTM bằng phương pháp [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
