---
title: Chuyển đổi ODS sang WORD với .NET 
description: Chuyển đổi ODS sang WORD trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/ods-to-word/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi ODS sang WORD qua C#" h2="Xuất Excel & reg; ODS sang WORD trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
