---
title: Chuyển đổi XLS sang PPTX với .NET 
description: Chuyển đổi XLS sang PPTX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLS sang PPTX qua C#" h2="Xuất Excel & reg; XLS sang PPTX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
