---
title: Chuyển đổi POTX sang FODS qua C#
description: Chuyển đổi POTX sang FODS trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTX sang FODS qua C#" h2=".NET API để chuyển đổi POTX sang FODS mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
