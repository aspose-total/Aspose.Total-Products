---
title: Chuyển đổi POTX sang XLTX qua C#
description: Chuyển đổi POTX sang XLTX trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
url: /vi/net/conversion/potx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTX sang XLTX qua C#" h2=".NET API để chuyển đổi POTX sang XLTX mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
