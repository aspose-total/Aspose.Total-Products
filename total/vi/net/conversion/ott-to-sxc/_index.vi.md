...
description: C# API để chuyển đổi OTT sang SXC mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
url: /vi/net/conversion/ott-to-sxc/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi OTT sang SXC" h2="Xuất OTT sang SXC qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
