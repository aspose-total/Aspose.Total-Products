---
title: Chuyển đổi XLTM sang DOC với .NET 
description: Chuyển đổi XLTM sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
url: /vi/net/conversion/xltm-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi XLTM sang DOC qua C#" h2="Xuất Excel & reg; XLTM sang DOC trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
