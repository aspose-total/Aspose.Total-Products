---
title: .NET API để chuyển đổi WORD sang XLTX
description: C# API để chuyển đổi WORD sang XLTX mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi WORD sang XLTX" h2="Xuất WORD sang XLTX qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
