---
title: Chuyển đổi PPSM sang TSV qua C#
description: Chuyển đổi PPSM sang TSV trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSM sang TSV qua C#" h2=".NET API để chuyển đổi PPSM sang TSV mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
4. Lưu tài liệu vào TSV bằng phương pháp [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
