...
url: /vi/net/conversion/ppsx-to-dot/ 
...
Để tự động hóa quy trình chuyển đổi hàng loạt tệp PowerPoint ppsx sang tệp Word dot, chúng tôi sẽ sử dụng [Aspose.Slides cho .NET](https://products.aspose.com/slides/net) và [Aspose.Words cho các API .NET](https://products.aspose.com/words/net). Trước đây là một API thao tác trình bày PowerPoint cho phép bạn tạo hoặc sửa đổi các trang trình bày Microsoft PowerPoint. Trong khi, cái sau là một API xử lý văn bản để xử lý hoặc thao tác các tài liệu Microsoft Word. Cả hai API đều là một phần của gói [Aspose.Total cho .NET](https://products.aspose.com/total/net). Bạn có thể trực tiếp [tải xuống](https://downloads.aspose.com/) từ Nuget hoặc có thể sử dụng các lệnh sau từ Bảng điều khiển Trình quản lý Gói.
