---
title: Chuyển đổi POTM sang XLSB qua C#
description: Chuyển đổi POTM sang XLSB trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POTM sang XLSB qua C#" h2=".NET API để chuyển đổi POTM sang XLSB mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
1. Mở tệp POTM bằng lớp [Trình bày](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Xuất POTM dưới dạng HTML bằng cách sử dụng phương pháp [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
