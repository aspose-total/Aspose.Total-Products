...
description: C# API để chuyển đổi DOTM sang XLSX mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi DOTM sang XLSX" h2="Xuất DOTM sang XLSX qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
