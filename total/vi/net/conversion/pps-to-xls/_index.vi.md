---
title: Chuyển đổi PPS sang XLS qua C#
description: Chuyển đổi PPS sang XLS trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPS sang XLS qua C#" h2=".NET API để chuyển đổi PPS sang XLS mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
