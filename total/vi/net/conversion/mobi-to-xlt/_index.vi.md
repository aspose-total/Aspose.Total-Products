...
description: C# API để chuyển đổi MOBI sang XLT mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
url: /vi/net/conversion/mobi-to-xlt/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API để chuyển đổi MOBI sang XLT" h2="Xuất MOBI sang XLT qua C# mà không sử dụng Microsoft<sup>&reg;</sup> Word hoặc Microsoft<sup>&reg;</sup> Excel" >}}
