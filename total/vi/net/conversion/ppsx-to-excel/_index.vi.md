---
title: Chuyển đổi PPSX sang EXCEL qua C#
description: Chuyển đổi PPSX sang EXCEL trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPSX sang EXCEL qua C#" h2=".NET API để chuyển đổi PPSX sang EXCEL mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
2. Xuất PPSX dưới dạng HTML bằng cách sử dụng phương pháp [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
