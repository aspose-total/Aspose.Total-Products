---
title: Chuyển đổi POT sang DIF qua C#
description: Chuyển đổi POT sang DIF trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi POT sang DIF qua C#" h2=".NET API để chuyển đổi POT sang DIF mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
