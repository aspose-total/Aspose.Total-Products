---
title: Chuyển đổi ODS sang DOCX với .NET 
description: Chuyển đổi ODS sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Chuyển đổi ODS sang DOCX qua C#" h2="Xuất Excel & reg; ODS sang DOCX trên Nền tảng .NET Framework, .NET Core, Mono hoặc Xamarin">}}
