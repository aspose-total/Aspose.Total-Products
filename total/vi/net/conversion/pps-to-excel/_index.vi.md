---
title: Chuyển đổi PPS sang EXCEL qua C#
description: Chuyển đổi PPS sang EXCEL trong C# mà không cần sử dụng Microsoft Excel hoặc Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Chuyển đổi PPS sang EXCEL qua C#" h2=".NET API để chuyển đổi PPS sang EXCEL mà không cần sử dụng Microsoft<sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
2. Xuất PPS dưới dạng HTML bằng cách sử dụng phương pháp [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
