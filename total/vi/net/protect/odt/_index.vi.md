---
title: Bảo vệ tài liệu ODT Online bằng mật khẩu và sử dụng .NET
description: Ứng dụng bảo vệ mật khẩu file ODT trực tuyến. Mã C# .NET API để áp dụng bảo vệ bằng mật khẩu trên tài liệu ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bảo vệ tài liệu ODT trực tuyến hoặc đặt mật khẩu qua .NET" h2="Phát triển ứng dụng tiện ích bảo vệ tài liệu ODT dựa trên .NET mạnh mẽ.Mã được liệt kê để áp dụng mật khẩu cho tài liệu ODT thông qua .NET." >}}
...
{{% blocks/products/pf/agp/code-block title="Mã .NET : Bảo vệ mật khẩu tài liệu ODT" offSpacer="" %}}
...
<h2>Phát triển ứng dụng bảo vệ mật khẩu ODT qua .NET</h2>

Bạn cần phát triển ứng dụng, tiện ích bảo vệ mật khẩu ODT?Với [Aspose.Words for .NET](https://products.aspose.com/words/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API trên vào ứng dụng bảo vệ tài liệu của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp bảo vệ mật khẩu tài liệu nào để bảo mật và khóa các tệp.Hơn nữa, nó có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET xử lý file ODT cho ứng dụng bảo vệ" %}}
