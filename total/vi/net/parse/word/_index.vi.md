---
title: Trích xuất văn bản và hình ảnh từ tệp Word trực tuyến và sử dụng .NET
description: Ứng dụng phân tích tệp Word trực tuyến. Mã .NET API C# để trích xuất hình ảnh và nội dung văn bản từ tài liệu Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Phân tích tệp Word trực tuyến cũng như qua .NET" h2="Phát triển ứng dụng tiện ích phân tích cú pháp tài liệu Word dựa trên .NET mạnh mẽ. Mã C# được liệt kê để trích xuất văn bản tài liệu Word." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Phân tích tài liệu Word qua ứng dụng trực tuyến" %}}

1. Nhập tệp Word để phân tích bằng cách tải tệp lên.
...
{{% blocks/products/pf/agp/feature-section-col title="Phân tích tệp Word qua .NET" %}}

1. Thêm tham chiếu thư viện vào dự án .NET
1. Tải tệp Word bằng đối tượng lớp Tài liệu
1. Nhận tất cả các nút con bằng GetChildNodes()
1. Sử dụng NodeType.Shape làm tham số
1. Lặp lại qua từng nút và lưu hình ảnh
1. Để trích xuất văn bản, lặp qua từng trang
1. Gọi phương thức ExtractPages
1. Lưu tệp đã giải nén vào văn bản bằng phương thức Node.ToString
...
{{% blocks/products/pf/agp/code-block title="Mã C#: Trích xuất hình ảnh tài liệu Word" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Mã C#: Trích xuất văn bản tài liệu Word" offSpacer="" %}}
...
<h2>Phát triển ứng dụng File Parser Word qua .NET</h2>

Bạn cần phát triển ứng dụng hoặc phần mềm phân tích cú pháp Word?Với [Aspose.Words for .NET](https://products.aspose.com/words/vi/net/), API con của [Aspose.Total for .NET](https://products.aspose.com/total/vi/net/), bất kỳ nhà phát triển .NET nào cũng có thể tích hợp mã API ở trên trong ứng dụng phân tích cú pháp tài liệu của mình.Thư viện .NET mạnh mẽ cho phép lập trình bất kỳ giải pháp phân tích tài liệu nào để trích xuất hình ảnh cũng như văn bản.Hơn nữa, nó có thể hỗ trợ nhiều định dạng phổ biến bao gồm định dạng Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tiện ích .NET xử lý file Word cho ứng dụng phân tích cú pháp" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Có, bạn có thể tải xuống mã này và sử dụng nó cho mục đích phát triển ứng dụng phân tích cú pháp tài liệu dựa trên .NET.Mã này có thể đóng vai trò là tài nguyên quý giá để nâng cao chức năng và khả năng của các dự án của bạn trong lĩnh vực xử lý tài liệu phụ trợ, chẳng hạn như các nút đọc và tải tài liệu để trích xuất văn bản và hình ảnh.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Sử dụng ứng dụng trực tuyến để phân tích tài liệu Word có an toàn không?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bạn có thể sử dụng bất kỳ trình duyệt web hiện đại nào như Google Chrome, Firefox, Opera hoặc Safari để phân tích cú pháp tài liệu Word trực tuyến.Tuy nhiên, nếu bạn đang phát triển một ứng dụng dành cho máy tính để bàn, chúng tôi khuyên bạn nên sử dụng API xử lý tài liệu Aspose.Total để quản lý hiệu quả.</span>
                      </div>
                  </li>
              </ul>
          </div>
