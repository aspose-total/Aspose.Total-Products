---
title: Xuất ODS sang WORD trong Android
description: API Android để chuyển đổi ODS sang WORD mà không cần sử dụng Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất ODS sang WORD trên Android qua Java" h2="Chuyển đổi ODS sang WORD trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/vi/android-java/conversion/ods-to-wordx/" name="ODS Đến WORDX" description="" >}}
