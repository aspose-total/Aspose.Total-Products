---
title: API Android để chuyển đổi DOTM sang FODS
description: Chuyển đổi DOTM sang FODS trong Android qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/android-java/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOTM sang FODS trong các ứng dụng Android" h2="Xuất DOTM sang FODS trong Android qua Java mà không sử dụng Microsoft <sup> <sup>&reg;</sup>; </sup> Word hoặc Microsoft <sup> <sup>&reg;</sup>; </sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Bằng cách sử dụng [Aspose.Total cho Android qua Java](https://products.aspose.com/total/android-java/), bạn có thể tích hợp tính năng chuyển đổi DOTM sang FODS bên trong các ứng dụng Android của mình. Trước tiên, bạn có thể chuyển đổi DOTM sang HTML bằng cách sử dụng API chuyển đổi và thao tác tài liệu phong phú, giàu tính năng [Aspose.Words dành cho Android qua Java](https://products.aspose.com/words/android-java/). Sau đó, bằng cách sử dụng [Aspose.Cells cho Java](https://products.aspose.com/cells/android-java/), bạn có thể chuyển đổi HTML sang FODS. 
{{% /blocks/products/pf/feature-page-summary  %}}
