---
title: API Android để chuyển đổi DOTX sang XLAM
description: Chuyển đổi DOTX sang XLAM trong Android qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOTX sang XLAM trong các ứng dụng Android" h2="Xuất DOTX sang XLAM trong Android qua Java mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
