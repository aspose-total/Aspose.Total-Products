---
title: Xuất SXC sang DOCX trong Android
description: API Android để chuyển đổi SXC sang DOCX mà không cần sử dụng Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất SXC sang DOCX trên Android qua Java" h2="Chuyển đổi SXC sang DOCX trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel" >}}
