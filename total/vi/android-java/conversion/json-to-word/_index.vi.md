---
title: Chuyển đổi định dạng JSON sang WORD trong Android qua Java
description: Phân tích cú pháp JSON thành WORD trong Java mà không cần sử dụng Microsoft Word
url: /vi/android-java/conversion/json-to-word/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="Chuyển đổi định dạng JSON sang WORD trong Android qua Java" %}}
...
4. Lưu tài liệu sang định dạng WORD bằng cách sử dụng [Lưu](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) phương pháp
