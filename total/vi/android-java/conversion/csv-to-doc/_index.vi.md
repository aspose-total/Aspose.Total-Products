---
title: Xuất CSV sang DOC trong Android
description: API Android để chuyển đổi CSV sang DOC mà không cần sử dụng Microsoft Word
url: /vi/android-java/conversion/csv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất CSV sang DOC trên Android qua Java" h2="Chuyển đổi CSV sang DOC trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup> <sup>&reg;</sup>; </sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total cho Android qua Java](https://products.aspose.com/total/android-java/) là một gói API tự động hóa tệp mạnh mẽ. Bằng cách sử dụng hai trong số các API của nó, bạn có thể tích hợp tính năng chuyển đổi CSV sang DOC bên trong các ứng dụng Android của mình. Trong bước đầu tiên, bạn có thể xuất CSV sang PDF bằng cách sử dụng [Aspose.Cells dành cho Android qua Java](https://products.aspose.com/cells/android-java/). Sau đó, bằng cách sử dụng [Aspose.PDF dành cho Android qua Java](https://products.aspose.com/pdf/android-java/), bạn có thể chuyển đổi PDF sang DOC. 
{{% /blocks/products/pf/feature-page-summary  %}}
