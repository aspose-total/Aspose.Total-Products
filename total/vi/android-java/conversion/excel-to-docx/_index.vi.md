---
title: Xuất EXCEL sang DOCX trong Android
description: API Android để chuyển đổi EXCEL sang DOCX mà không cần sử dụng Microsoft Word
url: /vi/android-java/conversion/excel-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất EXCEL sang DOCX trên Android qua Java" h2="Chuyển đổi EXCEL sang DOCX trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel" >}}
