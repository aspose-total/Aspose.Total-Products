---
title: API Android để chuyển đổi ODT sang SXC
description: Chuyển đổi ODT sang SXC trong Android qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
url: /vi/android-java/conversion/odt-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi ODT sang SXC trong các ứng dụng Android" h2="Xuất ODT sang SXC trong Android qua Java mà không sử dụng Microsoft <sup> <sup>&reg;</sup>; </sup> Word hoặc Microsoft <sup> <sup>&reg;</sup>; </sup> Excel" >}}
