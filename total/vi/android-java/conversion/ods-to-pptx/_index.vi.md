---
title: Xuất ODS sang PPTX trong Android
description: API Android để chuyển đổi ODS sang PPTX mà không cần sử dụng Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất ODS sang PPTX trên Android qua Java" h2="Chuyển đổi ODS sang PPTX trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel" >}}
