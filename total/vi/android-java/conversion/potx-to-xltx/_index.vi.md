...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi POTX sang XLTX trong Android qua Java" h2="Xuất tệp POTX sang XLTX trong các ứng dụng Android mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel hoặc PowerPoint" >}}
...
Để chuyển đổi POTX sang XLTX, bạn có thể dễ dàng sử dụng Aspose.Total for Android via Java trực tiếp từ [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) và cài đặt các thư viện trong ứng dụng của bạn.
