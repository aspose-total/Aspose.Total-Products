---
title: Xuất ODS sang DOCX trong Android
description: API Android để chuyển đổi ODS sang DOCX mà không cần sử dụng Microsoft Word
url: /vi/android-java/conversion/ods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Kết xuất ODS sang DOCX trên Android qua Java" h2="Chuyển đổi ODS sang DOCX trong Ứng dụng Android của bạn mà không cần sử dụng Microsoft <sup>&reg;</sup> Excel" >}}
