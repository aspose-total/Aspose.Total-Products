---
title: API Android để chuyển đổi DOCX sang ODS
description: Chuyển đổi DOCX sang ODS trong Android qua Java mà không cần sử dụng Microsoft Word hoặc Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Chuyển đổi DOCX sang ODS trong các ứng dụng Android" h2="Xuất DOCX sang ODS trong Android qua Java mà không sử dụng Microsoft <sup>&reg;</sup> Word hoặc Microsoft <sup>&reg;</sup> Excel" >}}
