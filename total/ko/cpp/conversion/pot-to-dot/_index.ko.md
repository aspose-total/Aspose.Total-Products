---
title: POT를 DOT로 변환하는 C++ API
description: C++ 애플리케이션 내에서 POT을 DOT로 내보내기
url: /ko/cpp/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT을 DOT로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 POT을 DOT로 내보내기" >}}
