---
title: C++를 사용하여 XLSX를 WORD로 변환
description: C++ 애플리케이션 내에서 XLSX를 WORD로 변환
url: /ko/cpp/conversion/xlsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="C++를 통해 XLSX를 WORD로 변환" h2="엑셀 내보내기&reg; 완전한 기능을 갖춘 C++ 애플리케이션 내에서 XLSX에서 WORD로" >}}
