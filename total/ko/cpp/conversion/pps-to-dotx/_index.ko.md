---
title: PPS를 DOTX로 변환하는 C++ API
description: C++ 애플리케이션 내에서 PPS을 DOTX로 내보내기
url: /ko/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS을 DOTX로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 PPS을 DOTX로 내보내기" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/pps-to-dotxm/" name="PPS 에게 DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/pps-to-dotxx/" name="PPS 에게 DOTXX" description="" >}}
