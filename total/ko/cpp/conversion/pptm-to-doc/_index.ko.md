---
title: PPTM를 DOC로 변환하는 C++ API
description: C++ 애플리케이션 내에서 PPTM을 DOC로 내보내기
url: /ko/cpp/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="PPTM을 DOC로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 PPTM을 DOC로 내보내기" >}}
...
3. [문서](https://reference.aspose.com/words/cpp/class/aspose.words.document) 클래스 참조를 이용하여 변환된 HTML 파일을 로드합니다.
4. [저장](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string) 멤버 함수를 사용하여 문서를 DOC 형식으로 저장합니다.
