---
title: PPTX를 DOCX로 변환하는 C++ API
description: C++ 애플리케이션 내에서 PPTX을 DOCX로 내보내기
url: /ko/cpp/conversion/pptx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX을 DOCX로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 PPTX을 DOCX로 내보내기" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/pptx-to-docxm/" name="PPTX 에게 DOCXM" description="" >}}
