---
title: PPT를 RTF로 변환하는 C++ API
description: C++ 애플리케이션 내에서 PPT을 RTF로 내보내기
url: /ko/cpp/conversion/ppt-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPT을 RTF로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 PPT을 RTF로 내보내기" >}}
...
2. [저장](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) 멤버 기능을 사용하여 PPT을 HTML로 렌더링하고 Html을 SaveFormat으로 설정합니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/ppt-to-rtfm/" name="PPT 에게 RTFM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/ppt-to-rtfx/" name="PPT 에게 RTFX" description="" >}}
