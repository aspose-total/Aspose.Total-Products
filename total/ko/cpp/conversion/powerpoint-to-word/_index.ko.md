...
3. [문서](https://reference.aspose.com/words/cpp/class/aspose.words.wordument) 클래스 참조를 이용하여 변환된 HTML 파일을 로드합니다.
4. [저장](https://reference.aspose.com/words/cpp/class/aspose.words.wordument#save_string) 멤버 함수를 사용하여 문서를 WORD 형식으로 저장합니다.
