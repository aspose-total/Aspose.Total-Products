---
title: POWERPOINT를 WORD로 변환하는 C++ API
description: C++ 애플리케이션 내에서 POWERPOINT을 WORD로 내보내기
url: /ko/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT을 WORD로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 POWERPOINT을 WORD로 내보내기" >}}
