---
title: C++에서 ODT를 XLT로 변환
description: Microsoft Word 또는 Microsoft Excel을 사용하지 않고 ODT를 XLT로 변환하는 C++ API
url: /ko/cpp/conversion/odt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT를 XLT로 변환하는 C++ API" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 C++를 통해 ODT를 XLT로 내보내기" >}}
