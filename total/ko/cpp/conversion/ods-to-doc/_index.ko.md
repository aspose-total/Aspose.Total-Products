---
title: C++를 사용하여 ODS를 DOC로 변환
description: C++ 애플리케이션 내에서 ODS를 DOC로 변환
url: /ko/cpp/conversion/ods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="C++를 통해 ODS를 DOC로 변환" h2="엑셀 내보내기&reg; 완전한 기능을 갖춘 C++ 애플리케이션 내에서 ODS에서 DOC로" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/ods-to-docx/" name="ODS 에게 DOCX" description="" >}}
