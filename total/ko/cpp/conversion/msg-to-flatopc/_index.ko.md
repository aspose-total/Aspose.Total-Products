...
4. [저장](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) 방법을 사용하여 문서를 FLATOPC 형식으로 저장하고 Flatopc를 SaveFormat으로 설정합니다.
