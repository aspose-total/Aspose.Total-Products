...
1. [문서](https://reference.aspose.com/words/cpp/class/aspose.words.docxument) 클래스 참조를 사용하여 DOCX 파일을 엽니다.
2. [저장](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_stdbasicostream_saveoptions) 멤버 함수를 사용하여 DOCX를 HTML로 변환
