---
title: C++를 사용하여 EXCEL를 DOC로 변환
description: C++ 애플리케이션 내에서 EXCEL를 DOC로 변환
url: /ko/cpp/conversion/excel-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="C++를 통해 EXCEL를 DOC로 변환" h2="엑셀 내보내기&reg; 완전한 기능을 갖춘 C++ 애플리케이션 내에서 EXCEL에서 DOC로" >}}
...
3. [문서](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.document) 클래스 참조를 사용하여 변환된 PDF 파일을 로드합니다.
4. [저장](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.document#a6383c010776212483f51cc41235924db) 멤버 함수를 사용하여 문서를 DOC 형식으로 저장하고 Doc을 SaveFormat으로 설정합니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/excel-to-docx/" name="EXCEL 에게 DOCX" description="" >}}
