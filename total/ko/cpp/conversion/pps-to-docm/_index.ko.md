---
title: PPS를 DOCM로 변환하는 C++ API
description: C++ 애플리케이션 내에서 PPS을 DOCM로 내보내기
url: /ko/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS을 DOCM로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 PPS을 DOCM로 내보내기" >}}
...
2. [저장](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) 멤버 기능을 사용하여 PPS을 HTML로 렌더링하고 Html을 SaveFormat으로 설정합니다.
3. [문서](https://reference.aspose.com/words/cpp/class/aspose.words.docmument) 클래스 참조를 이용하여 변환된 HTML 파일을 로드합니다.
4. [저장](https://reference.aspose.com/words/cpp/class/aspose.words.docmument#save_string) 멤버 함수를 사용하여 문서를 DOCM 형식으로 저장합니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/pps-to-docmx/" name="PPS 에게 DOCMX" description="" >}}
