---
title: POTM를 FLATOPC로 변환하는 C++ API
description: C++ 애플리케이션 내에서 POTM을 FLATOPC로 내보내기
url: /ko/cpp/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTM을 FLATOPC로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 POTM을 FLATOPC로 내보내기" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/potm-to-flatopcx/" name="POTM 에게 FLATOPCX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/potm-to-flatopcm/" name="POTM 에게 FLATOPCM" description="" >}}
