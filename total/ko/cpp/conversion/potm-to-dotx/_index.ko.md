---
title: POTM를 DOTX로 변환하는 C++ API
description: C++ 애플리케이션 내에서 POTM을 DOTX로 내보내기
url: /ko/cpp/conversion/potm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTM을 DOTX로 렌더링하는 C++ API" h2="Microsoft PowerPoint 또는 Word 종속성 없이 C++ 응용 프로그램에서 POTM을 DOTX로 내보내기" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/potm-to-dotxx/" name="POTM 에게 DOTXX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/cpp/conversion/potm-to-dotxm/" name="POTM 에게 DOTXM" description="" >}}
