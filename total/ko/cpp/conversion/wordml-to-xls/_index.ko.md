---
title: C++에서 WORDML를 XLS로 변환
description: Microsoft Word 또는 Microsoft Excel을 사용하지 않고 WORDML를 XLS로 변환하는 C++ API
url: /ko/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML를 XLS로 변환하는 C++ API" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 C++를 통해 WORDML를 XLS로 내보내기" >}}
