---
title: C++를 통해 PPTX을 XLTM로 변환
description: Microsoft Excel 또는 Powerpoint를 사용하지 않고 C++에서 PPTX을 XLTM로 내보내기
url: /ko/cpp/conversion/pptx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++를 통해 PPTX을 XLTM로 변환" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 C++를 통해 PPTX에서 XLTM 파일로 변환" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++를 통해 PPTX을 XLTM로 변환하는 방법" %}}
