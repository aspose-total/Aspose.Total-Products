---
title: C++를 통해 RTF를 ODP로 변환
description: PowerPoint의 Microsoft Word를 사용하지 않고 C++ 응용 프로그램에서 RTF를 ODP로 내보내기
url: /ko/cpp/conversion/rtf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF를 ODP로 변환하는 C++ API" h2="Microsoft Word&reg;를 사용하지 않고 C++ 응용 프로그램 내에서 RTF를 ODP로 내보내기 또는 파워포인트" >}}
