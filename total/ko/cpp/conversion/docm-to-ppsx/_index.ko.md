---
title: C++를 통해 DOCM를 PPSX로 변환
description: PowerPoint의 Microsoft Word를 사용하지 않고 C++ 응용 프로그램에서 DOCM를 PPSX로 내보내기
url: /ko/cpp/conversion/docm-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCM를 PPSX로 변환하는 C++ API" h2="Microsoft Word&reg;를 사용하지 않고 C++ 응용 프로그램 내에서 DOCM를 PPSX로 내보내기 또는 파워포인트" >}}
