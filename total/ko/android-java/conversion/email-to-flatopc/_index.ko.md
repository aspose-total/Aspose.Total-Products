---
title: Andorid 앱에서 EMAIL을 FLATOPC로 렌더링
description: Andorid 응용 프로그램에서 Microsoft Word 또는 Outlook을 사용하지 않고 EMAIL을 FLATOPC로 내보내기
url: /ko/android-java/conversion/email-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{% blocks/products/pf/agp/feature-section-col title="Andorid에서 EMAIL을 FLATOPC로 변환" %}}
