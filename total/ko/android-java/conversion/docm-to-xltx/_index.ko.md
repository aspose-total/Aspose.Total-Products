---
title: DOCM를 XLTX로 변환하는 Android API
description: Microsoft Word 또는 Microsoft Excel을 사용하지 않고 Java를 통해 Android에서 DOCM를 XLTX로 변환
url: /ko/android-java/conversion/docm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Android 애플리케이션에서 DOCM를 XLTX로 변환" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 Java를 통해 Android에서 DOCM를 XLTX로 내보내기" >}}
