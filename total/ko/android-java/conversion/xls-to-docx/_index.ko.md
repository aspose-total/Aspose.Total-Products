---
title: Android에서 XLS를 DOCX로 내보내기
description: Microsoft Word를 사용하지 않고 XLS를 DOCX로 변환하는 Android API
url: /ko/android-java/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Java를 통해 Android에서 XLS를 DOCX로 렌더링" h2="Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 Android 애플리케이션 내에서 XLS를 DOCX로 변환" >}}
