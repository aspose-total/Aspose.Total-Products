...
url: /ko/android-java/conversion/ppt-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
[Java를 통한 Android용 Aspose.Total](https://products.aspose.com/total/android-java/)을 사용하면 Android 애플리케이션 내에서 파일 형식을 조작할 수 있습니다. 패키지에 제공된 API를 사용하여 앱에서 PowerPoint PPT에서 Word DOTX로의 변환 프로세스를 자동화할 수 있습니다.
