---
title: Java를 통해 Andorid의 OTT로 PPSX 내보내기
description: 소프트웨어를 설치하지 않고 모바일 앱에서 PPSX을 OTT로 변환
url: /ko/android-java/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Java를 통해 Andorid에서 PPSX을 OTT로 렌더링" h2="Microsoft PowerPoint 또는 Word에 의존하지 않고 Android 앱 내에서 PPSX를 OTT로 변환하는 파일 형식 API" >}}
