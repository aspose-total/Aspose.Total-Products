---
title: Java를 통해 Android에서 OTT를 PPS로 변환
description: PowerPoint의 Microsoft Word를 사용하지 않고 Android 휴대폰에서 OTT에서 PPS로 변환
url: /ko/android-java/conversion/ott-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Android 앱에서 OTT를 PPS로 변환" h2="Microsoft Word<sup>&reg;</sup> 또는 PowerPoint를 설치하지 않고 Android 애플리케이션에서 OTT에서 PPS로 변환" >}}
...
OTT에서 PPS로 파일 변환을 위해 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) 및 앱에 라이브러리를 설치합니다.
