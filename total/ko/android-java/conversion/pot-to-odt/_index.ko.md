---
title: Java를 통해 Andorid의 ODT로 POT 내보내기
description: 소프트웨어를 설치하지 않고 모바일 앱에서 POT을 ODT로 변환
url: /ko/android-java/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Java를 통해 Andorid에서 POT을 ODT로 렌더링" h2="Microsoft PowerPoint 또는 Word에 의존하지 않고 Android 앱 내에서 POT를 ODT로 변환하는 파일 형식 API" >}}
