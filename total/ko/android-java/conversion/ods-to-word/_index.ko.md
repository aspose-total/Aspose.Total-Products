---
title: Android에서 ODS를 WORD로 내보내기
description: Microsoft Word를 사용하지 않고 ODS를 WORD로 변환하는 Android API
url: /ko/android-java/conversion/ods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Java를 통해 Android에서 ODS를 WORD로 렌더링" h2="Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 Android 애플리케이션 내에서 ODS를 WORD로 변환" >}}
