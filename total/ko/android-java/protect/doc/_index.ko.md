---
title: 비밀번호 또는 Android 모바일 앱을 사용하여 온라인으로 DOC 문서를 보호하세요.
description: 온라인 DOC 파일 비밀번호 보호 앱.DOC 문서에 비밀번호 보호를 적용하는 Android API Java 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="온라인 DOC 문서 보호 또는 Android 앱을 통한 비밀번호 설정" h2="강력한 안드로이드 기반 DOC 문서 보호 유틸리티 애플리케이션을 개발하세요.안드로이드를 통해 DOC 문서에 비밀번호를 적용하기 위해 나열된 코드입니다." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="온라인 DOC 비밀번호 보호" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android 앱을 통한 DOC 비밀번호 보호" %}}

1. 프로젝트 내에서 Java 라이브러리 참조
1. Document 클래스 객체를 생성하거나 이 객체를 통해 파일을 로드하세요.
1. 객체를 사용하여 보호 메소드를 호출하십시오.
...
{{% blocks/products/pf/agp/code-block title="Java 코드: DOC 문서 비밀번호 보호" offSpacer="" %}}
...
<h2>DOC 비밀번호 보호 애플리케이션 Android 앱 개발</h2>

DOC 비밀번호 보호 앱 또는 유틸리티를 개발해야 합니까?[Aspose.Total for Android via Java](https://products.aspose.com/total/ko/android-java/)의 하위 API인 [Aspose.Words for Android via Java](https://products.aspose.com/words/ko/android-java/)을 사용하면 모든 안드로이드 개발자가 위의 API 코드를 문서 보호 애플리케이션에 통합할 수 있습니다.강력한 안드로이드 라이브러리를 사용하면 모든 문서 비밀번호 보호 솔루션을 프로그래밍하여 파일을 보호하고 잠글 수 있습니다.또한 DOC 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="보호 앱용 DOC 파일을 처리하는 Android 유틸리티" %}}
