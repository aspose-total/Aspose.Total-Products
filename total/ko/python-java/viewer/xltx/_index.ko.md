---
title: XLTX 파일을 온라인으로 보고 Python을 사용하여 XLTX 문서 읽기
description: 무료 온라인 XLTX 파일 뷰어 앱. 뷰어 애플리케이션용 XLTX 파일을 읽는 Python API 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="XLTX 파일을 온라인으로 자유롭게 보고 Python을 통해 XLTX을 읽습니다." h2="강력한 Python 기반 XLTX 문서 뷰어 유틸리티 애플리케이션을 개발합니다.Python을 통해 XLTX 문서를 로드하거나 읽는 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="뷰어 앱용 Python을 통해 XLTX 파일 읽기" %}}

1. PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))에서 직접 프로젝트 내 필수 패키지 참조
1. Workbook 클래스 개체를 생성하고 이를 사용하여 소스 XLTX 파일을 로드합니다.
1. 모든 워크시트 컬렉션을 가져옵니다.
1. 각 시트와 각 행 및 셀을 반복하여 해당 값을 얻습니다.
1. 이를 보려면 동일한 API의 저장 메소드를 사용하여 소스 XLTX 파일을 HTML로 변환하십시오.
1. 그리고 subprocess.run을 사용하여 브라우저를 호출하여 XLTX 파일을 봅니다.
...
{{% blocks/products/pf/agp/code-block title="XLTX 파일을 보기 위한 Python의 코드 예제" offSpacer="" %}}
...
<h2>Python을 통해 XLTX 파일 뷰어 애플리케이션 개발</h2>

XLTX 뷰어 앱이나 유틸리티를 개발해야 합니까?[Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/)의 하위 API인 [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/)를 사용하면 모든 Python 개발자가 위 API 코드를 문서 뷰어 애플리케이션에 통합할 수 있습니다.강력한 Python 라이브러리를 사용하면 XLTX 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있는 모든 문서 표시 솔루션을 프로그래밍할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="디스플레이 앱용 XLTX 파일을 처리하는 Python 유틸리티" %}}
