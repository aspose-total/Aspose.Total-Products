---
title: 온라인 또는 .NET을 통해 DOCX 파일 압축
description: 다양한 DOCX 파일을 압축하는 무료 온라인 앱입니다.DOCX 문서용 C# .NET 압축 라이브러리 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="압축 앱 또는 .NET을 사용하여 온라인으로 DOCX 파일 압축" h2="강력한 .NET 기반 DOCX 문서 압축 애플리케이션을 개발합니다.즉시 다운로드하여 앱을 통해 온라인으로 DOCX 파일을 포함한 다양한 문서를 자유롭게 압축하세요." >}}
...
1. "압축"버튼을 클릭하십시오.
1. 압축된 DOCX 파일을 다운로드합니다.
1. 크기와 콘텐츠 품질을 확인하여 압축 결과를 보고 가져옵니다.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 DOCX 파일 압축" %}}
...
1. Save 메소드를 호출하고 압축된 DOCX 파일을 가져옵니다.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 코드: DOCX 파일 압축" offSpacer="" %}}
...
<h2>.NET을 사용하여 DOCX 파일 압축 애플리케이션 개발</h2>

여러 DOCX 파일을 쉽게 압축하기 위해 .NET 스크립트 또는 유틸리티 앱을 개발해야 합니까?[Aspose.Total for .NET](https://products.aspose.com/total/net/)의 [Aspose.Words for .NET](https://products.aspose.com/words/net/) 하위 API를 사용하면 모든 .NET 개발자가 위 API 코드를 통합하여 문서 전체에 걸쳐 압축 앱을 프로그래밍할 수 있습니다.문서 압축을 위한 강력한 .NET 라이브러리는 DOCX 형식을 포함하여 널리 사용되는 다양한 형식을 지원합니다.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX 파일용 .NET 압축 라이브러리" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">예, 이 코드를 다운로드하실 수 있습니다. .NET을 사용하여 DOCX 파일을 압축하는 전문 솔루션을 쉽게 개발할 수 있습니다.Aspose DOCX 압축 API를 사용하여 .NET에서 플랫폼 독립적인 높은 수준의 소프트웨어를 개발하세요.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Start by uploading one or more files you want to compress. DOCX 파일을 끌어서 놓거나 흰색 영역 내부를 클릭하면 됩니다.그런 다음 '압축' 버튼을 클릭하면 온라인 압축 앱이 업로드된 파일을 신속하게 처리합니다.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
