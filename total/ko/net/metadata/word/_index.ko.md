---
title: 온라인으로 Word 속성 보기 및 업데이트 또는 .NET을 사용하여 메타데이터 업데이트
description: 온라인 앱을 통해 무료로 Word 속성을 보고 수정하세요.Word 속성을 업데이트하는 C# .NET API 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="온라인으로 Word 메타데이터 보기 또는 업데이트 또는 .NET을 통해 업데이트" h2="강력한 .NET 기반 Word 문서 메타데이터 관리 유틸리티 애플리케이션을 개발합니다..NET을 통해 Word 파일 메타데이터를 업데이트하기 위해 나열된 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 Word 속성 업데이트" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 코드: Word 메타데이터 업데이트" offSpacer="" %}}
...
<h2>.NET을 통해 Word 메타데이터 관리 애플리케이션 개발</h2>

Word 메타데이터 관리 앱 또는 유틸리티를 개발해야 합니까?[Aspose.Total for .NET](https://products.aspose.com/total/ko/net/)의 하위 API인 [Aspose.Words for .NET](https://products.aspose.com/words/ko/net/)을 사용하면 모든 .NET 개발자가 문서 메타데이터 애플리케이션 내에 위의 API 코드를 통합할 수 있습니다.강력한 .NET 라이브러리를 사용하면 모든 문서 메타데이터 솔루션을 프로그래밍할 수 있습니다.또한 Word 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Word 메타데이터를 관리하는 .NET 유틸리티" %}}
