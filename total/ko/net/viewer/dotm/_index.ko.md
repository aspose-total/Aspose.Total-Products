---
title: DOTM 파일을 온라인으로 보고 .NET을 사용하여 보기
description: 무료 온라인 DOTM 파일 뷰어 앱. 뷰어 애플리케이션용 DOTM 파일을 보기 위한 .NET API C# 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="온라인 또는 .NET을 통해 자유롭게 DOTM 파일 보기" h2="강력한 .NET 기반 DOTM 문서 뷰어 유틸리티 애플리케이션을 개발합니다. DOTM 문서를 보기 위해 나열된 C# 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 DOTM 파일 보기" %}}

1. 프로젝트에 .NET 라이브러리 참조 추가
1. Document 클래스 객체를 사용하여 소스 DOTM 파일 로드
1. 문서를 HTML 파일로 저장
...
{{% blocks/products/pf/agp/code-block title="C# 코드 : DOTM 문서 보기" offSpacer="" %}}
...
<h2>.NET을 통해 DOTM 파일 뷰어 애플리케이션 개발</h2>

DOTM 뷰어 앱이나 유틸리티를 개발해야 합니까?[Aspose.Total for .NET](https://products.aspose.com/total/ko/net/)의 하위 API인 [Aspose.Words for .NET](https://products.aspose.com/words/ko/net/)을 사용하면 모든 .NET 개발자가 문서 뷰어 애플리케이션 내에 위의 API 코드를 통합할 수 있습니다.강력한 .NET 라이브러리를 사용하면 DOTM 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있는 모든 문서 표시 솔루션을 프로그래밍할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="디스플레이 앱용 DOTM 파일을 처리하는 .NET 유틸리티" %}}
