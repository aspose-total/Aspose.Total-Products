---
title: Word 파일을 온라인으로 보고 .NET을 사용하여 보기
description: 무료 온라인 Word 파일 뷰어 앱. 뷰어 애플리케이션용 Word 파일을 보기 위한 .NET API C# 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="온라인 또는 .NET을 통해 자유롭게 Word 파일 보기" h2="강력한 .NET 기반 Word 문서 뷰어 유틸리티 애플리케이션을 개발합니다. Word 문서를 보기 위해 나열된 C# 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 Word 파일 보기" %}}

1. 프로젝트에 .NET 라이브러리 참조 추가
1. Document 클래스 객체를 사용하여 소스 Word 파일 로드
1. 문서를 HTML 파일로 저장
...
{{% blocks/products/pf/agp/code-block title="C# 코드 : Word 문서 보기" offSpacer="" %}}
...
<h2>.NET을 통해 Word 파일 뷰어 애플리케이션 개발</h2>

Word 뷰어 앱이나 유틸리티를 개발해야 합니까?[Aspose.Total for .NET](https://products.aspose.com/total/ko/net/)의 하위 API인 [Aspose.Words for .NET](https://products.aspose.com/words/ko/net/)을 사용하면 모든 .NET 개발자가 문서 뷰어 애플리케이션 내에 위의 API 코드를 통합할 수 있습니다.강력한 .NET 라이브러리를 사용하면 Word 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있는 모든 문서 표시 솔루션을 프로그래밍할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="디스플레이 앱용 Word 파일을 처리하는 .NET 유틸리티" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">예, 이 코드를 다운로드하여 .NET 기반 문서 뷰어 응용 프로그램 개발 목적으로 활용하실 수 있습니다.이 코드는 노드 읽기 및 디스플레이 앱용 문서 로드와 같은 백엔드 문서 처리 도메인에서 프로젝트의 기능과 능력을 향상시키는 귀중한 리소스 역할을 할 수 있습니다.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
