---
title: .NET을 사용하여 XLTM를 DOCX로 변환 
description: .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 XLTM를 DOCX로 변환
url: /ko/net/conversion/xltm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 XLTM를 DOCX로 변환" h2="엑셀 내보내기&reg; .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 XLTM를 DOCX로">}}
