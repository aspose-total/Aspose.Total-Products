---
title: WORDML를 FODS로 변환하는 .NET API
description: Microsoft Excel 또는 Adobe Reader를 사용하지 않고 WORDML를 FODS로 변환하는 C# API
url: /ko/net/conversion/wordml-to-fods/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="WORDML를 FODS로 변환하는 C# API" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 C#을 통해 WORDML를 FODS로 내보내기" >}}
