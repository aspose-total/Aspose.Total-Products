...
4. [저장](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) 방법을 사용하여 문서를 DOCX 형식으로 저장하고 Docx를 SaveFormat으로 설정합니다.
