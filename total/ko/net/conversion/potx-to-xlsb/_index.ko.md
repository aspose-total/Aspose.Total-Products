---
title: C#을 통해 POTX을 XLSB로 변환
description: Microsoft Excel 또는 Powerpoint를 사용하지 않고 C#에서 POTX을 XLSB로 변환
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#을 통해 POTX을 XLSB로 변환" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 POTX에서 XLSB로 변환하는 .NET API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 POTX을 XLSB로 변환하는 방법" %}}
