---
title: C#을 통해 PPSM을 XLS로 변환 또는 온라인
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#을 통해 PPSM을 XLS로 변환 또는 온라인" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 PPSM에서 XLS로 변환하는 .NET API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 PPSM을 XLS로 변환 또는 온라인하는 방법" %}}
