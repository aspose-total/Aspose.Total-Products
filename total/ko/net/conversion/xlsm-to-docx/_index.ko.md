---
title: .NET을 사용하여 XLSM를 DOCX로 변환 
description: .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 XLSM를 DOCX로 변환
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C#을 통해 XLSM를 DOCX로 변환" h2="엑셀 내보내기&reg; .NET Framework, .NET Core, Mono 또는 Xamarin 플랫폼에서 XLSM를 DOCX로">}}
