...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 FLATOPC를 PPSX로 변환하는 방법" %}}
...
1. [Aspose.Words.Flatopcument](https://apireference.aspose.com/words/net/aspose.words/flatopcument) 클래스를 사용하여 FLATOPC 파일 로드
...
{{% blocks/products/pf/agp/code-block title="이 코드 샘플은 C#을 사용하여 FLATOPC를 PPSX로 변환하는 방법을 보여줍니다." offSpacer="" %}}
