...
description: Microsoft Excel 또는 Adobe Reader를 사용하지 않고 DOTX를 XLSM로 변환하는 C# API
url: /ko/net/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTX를 XLSM로 변환하는 C# API" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 C#을 통해 DOTX를 XLSM로 내보내기" >}}
