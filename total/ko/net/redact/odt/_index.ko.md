---
title: ODT 문서를 온라인으로 수정하거나 .NET을 사용하여 수정하세요.
description: 무료로 앱을 통해 ODT 문서를 온라인으로 열고 편집하세요.ODT 텍스트를 검색하고 바꾸는 .NET API C# 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="온라인 또는 .NET을 통해 ODT 문서 수정" h2="강력한 .NET 기반 ODT 문서 편집 유틸리티 애플리케이션을 개발합니다.ODT 파일의 텍스트 검색 및 바꾸기를 위해 나열된 C# 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 ODT 파일 수정" %}}

1. .NET 프로젝트에 라이브러리 참조 추가
1. Document 클래스 객체를 생성하거나 이를 사용하여 파일을 로드합니다.
1. 위 객체를 매개변수로 사용하여 DocumentBuilder 객체를 생성합니다.
1. 문서 채우기
1. 정규식 패턴 배열 정의
1. 특정 문자 조합을 검색하고 바꾸려면 바꾸기 방법을 사용하십시오.
1. ODT 문서 저장
...
{{% blocks/products/pf/agp/code-block title="C# 코드: ODT 파일 수정" offSpacer="" %}}
...
<h2>.NET을 통해 ODT 편집 애플리케이션 개발</h2>

ODT 편집 앱이나 유틸리티를 개발해야 합니까?[Aspose.Total for .NET](https://products.aspose.com/total/ko/net/)의 하위 API인 [Aspose.Words for .NET](https://products.aspose.com/words/ko/net/)을 사용하면 모든 .NET 개발자가 위의 API 코드를 문서 편집 애플리케이션에 통합할 수 있습니다.강력한 .NET 라이브러리를 사용하면 모든 문서 편집 솔루션을 프로그래밍할 수 있습니다.또한 ODT 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT 파일을 수정하는 .NET 유틸리티" %}}
시스템에 Aspose.Words for .NET 또는 Aspose.Total for .NET를 설치하는 세 가지 대체 옵션이 있습니다.귀하의 요구 사항과 유사한 것을 선택하고 단계별 지침을 따르십시오.<br /><br />
...
- 커뮤니티 보고서나 학술 논문에서 개인 정보를 수정합니다.
- 정부 또는 기관 문서에서 기밀 섹션을 수정합니다.
- 공유 제안서에서 연락처 정보나 신원 표시를 수정합니다.
