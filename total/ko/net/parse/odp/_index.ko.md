---
title: .NET을 사용하여 온라인으로 ODP 파일에서 텍스트와 이미지를 추출합니다.
description: 온라인 ODP 파일 파서 앱. ODP 프레젠테이션에서 이미지와 텍스트를 추출하는 .NET API C# 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1=".NET을 통해뿐만 아니라 온라인으로 ODP 파일을 구문 분석합니다." h2="강력한 .NET 기반 ODP 프레젠테이션 파서 애플리케이션을 개발합니다. ODP 구문 분석을 위해 나열된 C# 코드입니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET을 통해 ODP 프레젠테이션 구문 분석" %}}
...
{{% blocks/products/pf/agp/code-block title="C# 코드 : ODP 프레젠테이션 텍스트 추출" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 코드 : ODP 프레젠테이션 이미지 추출" offSpacer="" %}}
...
<h2>.NET을 통해 ODP 프레젠테이션 파서 애플리케이션 개발</h2>

ODP 파서 애플리케이션을 개발해야 합니까? [Aspose.Total for .NET](https://products.aspose.com/total/ko/net/)의 하위 API인 [Aspose.Slides for .NET](https://products.aspose.com/slides/ko/net/)을 사용하면 모든 .NET 개발자가 문서 파서 애플리케이션 내에 위의 API 코드를 통합할 수 있습니다.강력한 .NET 라이브러리를 사용하면 모든 문서 구문 분석 솔루션을 프로그래밍하여 텍스트는 물론 이미지도 추출할 수 있습니다.또한 ODP 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="파서 애플리케이션용 ODP 파일을 처리하는 .NET 유틸리티" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## .odp 파일 구문 분석을 위한 사용 사례

- 📄 OpenDocument 프레젠테이션 파일에서 콘텐츠 추출.
- 🔁 `.odp` 파일을 PowerPoint 또는 웹 기반 프레젠테이션으로 변환.
- 🖼️ `.odp` 슬라이드를 검색 및 재사용을 위해 아카이브 및 색인.
