...
description: Microsoft Excel 또는 PowerPoint를 사용하지 않고 Java를 통해 PPSX를 TSV 형식으로 변환
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 PPSX을 TSV로 변환" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 PPSX를 TSV로 내보내는 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PPSX을 TSV로 변환하는 방법" %}}
