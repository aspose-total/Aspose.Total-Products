---
title: Java를 사용하여 TSV를 POWERPOINT로 변환
description: Excel 또는 Word를 사용하여 TSV를 POWERPOINT로 내보내는 Java API
url: /ko/java/conversion/tsv-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: TSV
...
{{< blocks/products/pf/i18n/feature-page-header h1="TSV를 POWERPOINT로 내보내는 Java API" h2="Microsoft Excel에 의존하지 않고 TSV를 POWERPOINT로 내보내기 위한 온프레미스 Java API&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/net/conversion/tsv-to-powerpointx/" name="TSV 에게 POWERPOINTX" description="" >}}
