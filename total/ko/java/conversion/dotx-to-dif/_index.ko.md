...
description: Microsoft Word 또는 Microsoft Excel을 사용하지 않고 Java를 통해 DOTX를 DIF로 변환 또는 온라인 앱 또는 온라인. 코드를 통합하기 전에 무료 DOTX to DIF 온라인 변환기를 빠르게 테스트하십시오. 
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX를 DIF로 변환하는 Java API" %}}
...
<iframe title="dif에서 dotx로 변환 온라인 도구" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dif&from=dotx" id="child-iframe" width="80%"></iframe>
