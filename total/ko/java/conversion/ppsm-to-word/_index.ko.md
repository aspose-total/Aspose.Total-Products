---
title: Java를 통해 PPSM을 WORD로 변환
description: Microsoft Word 또는 PowerPoint를 사용하지 않고 PPSM을 WORD로 내보내는 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 PPSM을 WORD로 변환" h2="모든 Java J2SE, J2EE, J2ME 애플리케이션 내에서 PowerPoint PPSM에서 WORD로의 변환을 위한 온프레미스 Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PPSM을 WORD로 변환하는 방법" %}}
...
API를 사용하여 워터마크를 사용하여 PPSM 파일을 WORD로 변환할 수도 있습니다. WORD 문서에 워터마크를 추가하려면 먼저 PPSM 파일을 HTML로 변환하고 워터마크를 추가할 수 있습니다. 워터마크를 추가하려면 [Wordument](https://apireference.aspose.com/words/java/com.aspose.words/Wordument) 클래스를 사용하여 새로 생성된 HTML 파일을 로드하고 TextWatermarkOptions의 인스턴스를 생성하고 설정합니다. 해당 속성, Watermark.setText 메서드를 호출하고 TextWatermarkOptions의 워터마크 텍스트 및 개체를 전달합니다.  
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/net/conversion/ppsm-to-wordm/" name="PPSM 에게 WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ko/net/conversion/ppsm-to-wordx/" name="PPSM 에게 WORDX" description="" >}}
