---
title: Java를 사용하여 FODS를 DOC로 변환
description: Excel 또는 Word를 사용하여 FODS를 DOC로 내보내는 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="FODS를 DOC로 내보내는 Java API" h2="Microsoft Excel에 의존하지 않고 FODS를 DOC로 내보내기 위한 온프레미스 Java API&reg;" >}}
