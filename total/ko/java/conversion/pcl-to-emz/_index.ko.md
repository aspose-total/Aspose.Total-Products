---
title: Java를 통해 PCL을 EMZ로 변환
description: 타사 응용 프로그램을 사용하지 않고 Java 응용 프로그램에서 PCL 파일을 EMZ로 내보내기
url_ignore: /ko/java/conversion/pcl-to-emz/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 PCL을 EMZ로 변환" h2="Adobe<sup>&reg;</sup> Acrobat Reader를 사용하지 않고 Java J2SE, J2EE, J2ME 응용 프로그램 내에서 PCL 파일을 EMZ로 내보내기" >}}
{{% blocks/products/pf/feature-page-summary %}}
두 가지 간단한 단계를 통해 Java에서 pcl 파일을 EMZ 이미지로 변환할 수 있습니다. 먼저 [Aspose.PDF for Java](https://products.aspose.com/pdf/java/)를 사용하여 PCL을 JPEG로 내보낼 수 있습니다. 그런 다음 [Aspose.Imaging for Java](https://products.aspose.com/imaging/java/) Image Processing API를 사용하여 JPEG를 EMZ로 렌더링할 수 있습니다. 두 API 모두 [Java용 Aspose.Total](https://products.aspose.com/total/java/) 패키지에 있습니다.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PCL을 EMZ로 내보내기" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Java를 통해 PCL을 EMZ 파일로 변환 및 회전" %}}
...
**PCL to EMZ** 변환은 **프린터 명령어 언어** 그래픽을 **향상된 메타파일 (압축) – EMZ** 형식으로 변환하고 압축하여 이미지를 확장 가능한 그래픽 응용 프로그램 및 Microsoft Office 사용에 최적화합니다.

{{% blocks/products/pf/agp/feature-section-col title="주요 사용 사례" %}}

* 오피스나 디자인 소프트웨어에 벡터 기반 인쇄 그래픽 임베딩
* 문서 시스템용 인쇄된 이미지 파일 크기 축소
* PCL 그래픽의 확장 가능성과 품질 보존
* 문서 자동화나 템플릿을 위한 압축된 자산 준비

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="자동화 시나리오" %}}

* 인쇄 생성 다이어그램을 EMZ 이미지로 대량 변환
* 최적화된 이미지 저장을 위한 콘텐츠 관리 시스템 통합
* 문서 게시를 위한 압축된 그래픽 자동 생성
