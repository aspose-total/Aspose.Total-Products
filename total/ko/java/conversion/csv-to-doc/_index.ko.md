---
title: Java를 사용하여 CSV를 DOC로 변환
description: Excel 또는 Word를 사용하여 CSV를 DOC로 내보내는 Java API
url: /ko/java/conversion/csv-to-doc/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/i18n/feature-page-header h1="CSV를 DOC로 내보내는 Java API" h2="Microsoft Excel에 의존하지 않고 CSV를 DOC로 내보내기 위한 온프레미스 Java API&reg;" >}}
