...
description: Microsoft Word 또는 Microsoft Excel을 사용하지 않고 Java를 통해 ODT를 CSV로 변환
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 ODT를 CSV로 변환" h2="Microsoft<sup>&reg;</sup> Word 또는 Microsoft<sup>&reg;</sup> Excel을 사용하지 않고 ODT를 CSV로 변환하는 On Premise Java API" >}}
