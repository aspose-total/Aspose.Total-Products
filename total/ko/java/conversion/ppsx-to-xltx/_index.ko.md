...
description: Microsoft Excel 또는 PowerPoint를 사용하지 않고 Java를 통해 PPSX를 XLTX 형식으로 변환
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 PPSX을 XLTX로 변환" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 PPSX를 XLTX로 내보내는 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PPSX을 XLTX로 변환하는 방법" %}}
1. [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) 클래스를 사용하여 PPSX 파일을 엽니다.
2. [저장](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides)을 사용하여 PPSX을 HTML로 변환합니다. ISaveOptions-) 메서드
