---
title: Java를 통해 PPTM을 WORDML로 변환
description: Microsoft Word 또는 PowerPoint를 사용하지 않고 PPTM을 WORDML로 내보내는 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 PPTM을 WORDML로 변환" h2="모든 Java J2SE, J2EE, J2ME 애플리케이션 내에서 PowerPoint PPTM에서 WORDML로의 변환을 위한 온프레미스 Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 PPTM을 WORDML로 변환하는 방법" %}}
