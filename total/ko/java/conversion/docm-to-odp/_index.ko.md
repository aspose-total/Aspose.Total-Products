---
title: Java를 통해 DOCM를 ODP로 변환
description: Microsoft Word 또는 PowerPoint를 사용하지 않고 DOCM를 ODP로 내보내는 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java를 통해 DOCM를 ODP로 변환" h2="Microsoft<sup>&reg;</sup> PowerPoint 또는 Word를 사용하지 않고 Java J2SE, J2EE, J2ME 애플리케이션 내에서 사내 Java API를 사용하여 DOCM에서 ODP로 변환" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 DOCM를 ODP로 변환하는 방법" %}}
