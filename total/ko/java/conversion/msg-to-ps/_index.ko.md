...
4. [저장](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)을 사용하여 문서를 PS 형식으로 저장합니다.)) 메서드 및 PS를 SaveFormat으로 설정
