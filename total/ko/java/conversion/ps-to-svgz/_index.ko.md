...
2. 클래스 객체를 초기화하고 [Process](https://reference.aspose.com/pdf/java/com.aspose.pdf.devices/JpegDevice#process-com)를 사용하여 PS을 JPEG로 렌더링합니다. aspose.pdf.Page-java.io.OutputStream-) 메서드
