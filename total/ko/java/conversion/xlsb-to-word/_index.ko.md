---
title: Java를 사용하여 XLSB를 WORD로 변환
description: Excel 또는 Word를 사용하여 XLSB를 WORD로 내보내는 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSB를 WORD로 내보내는 Java API" h2="Microsoft Excel에 의존하지 않고 XLSB를 WORD로 내보내기 위한 온프레미스 Java API&reg;" >}}
