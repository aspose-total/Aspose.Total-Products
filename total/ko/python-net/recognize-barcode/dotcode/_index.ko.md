---
title: Python을 통해 DOTCODE 바코드 이미지 인식
description: 다른 소프트웨어를 사용하지 않고 Python 애플리케이션을 사용하여 DOTCODE 기호 바코드 이미지 스캔. 
...
- DOTCODE 바코드 스캐닝을 위해서는 Python 3.5 이상이 필요합니다.
...
{{% blocks/products/pf/agp/code-block title="Python에서 DOTCODE 기호 바코드 인식" offSpacer="" %}}
