---
title: Python에서 ICS를 OTT로 변환
description: Microsoft Outlook 또는 Word를 사용하지 않고 Python 응용 프로그램에서 ICS를 OTT로 저장 
url: /ko/python-net/conversion/ics-to-ott/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- ICS를 OTT로 변환하려면 Python 3.5 이상이 필요합니다.
...
{{% blocks/products/pf/agp/code-block title="Python에서 ICS를 OTT로 저장" offSpacer="" %}}
