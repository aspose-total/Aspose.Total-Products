---
title: Python에서 VCF를 DOTM로 변환
description: Microsoft Outlook 또는 Word를 사용하지 않고 Python 응용 프로그램에서 VCF를 DOTM로 저장 
url: /ko/python-net/conversion/vcf-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
{{< blocks/products/pf/feature-page-header h1="Python을 사용하여 VCF를 DOTM로 변환" h2="Microsoft Word<sup>&reg;</sup> 또는 Outlook을 설치하지 않고도 Python 응용 프로그램에서 VCF를 DOTM로 변환합니다." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python에서 VCF를 DOTM로 변환하는 방법" %}}
...
- VCF를 DOTM로 변환하려면 Python 3.5 이상이 필요합니다.
...
{{% blocks/products/pf/agp/code-block title="Python에서 VCF를 DOTM로 저장" offSpacer="" %}}
