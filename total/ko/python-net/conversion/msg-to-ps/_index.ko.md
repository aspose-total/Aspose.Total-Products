---
title: Python에서 MSG를 PS로 변환
description: Microsoft Outlook 또는 Word를 사용하지 않고 Python 응용 프로그램에서 MSG를 PS로 저장 
url: /ko/python-net/conversion/msg-to-ps/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- MSG를 PS로 변환하려면 Python 3.5 이상이 필요합니다.
...
{{% blocks/products/pf/agp/code-block title="Python에서 MSG를 PS로 저장" offSpacer="" %}}
