---
title: Python을 사용하여 DOTX를 ODS로 변환
description: Microsoft Word 또는 Excel을 사용하지 않고 Python 애플리케이션에서 DOTX를 ODS로 변환 
...
{{< blocks/products/pf/feature-page-header h1="Python을 통해 DOTX를 ODS로 변환" h2="Microsoft Word<sup>&reg;</sup> 또는 Excel을 설치하지 않고 Python 애플리케이션에서 DOTX를 ODS로 변환" >}}
