---
title: Python을 사용하여 POWERPOINT를 CSV로 변환
description: Microsoft Office를 사용하지 않고 Python 애플리케이션에서 POWERPOINT를 CSV로 변환 
...
{{< blocks/products/pf/feature-page-header h1="Python을 통해 POWERPOINT를 CSV로 변환" h2="Microsoft PowerPoint<sup>&reg;</sup> 또는 Excel을 설치하지 않고 Python 애플리케이션에서 POWERPOINT를 CSV로 변환" >}}
