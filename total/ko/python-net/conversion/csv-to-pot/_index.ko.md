---
title: Python을 사용하여 CSV를 POT로 변환
description: Microsoft Office를 사용하지 않고 Python 애플리케이션에서 CSV를 POT로 변환 
...
{{< blocks/products/pf/feature-page-header h1="Python을 통해 CSV를 POT로 변환" h2="Microsoft Excel<sup>&reg;</sup> 또는 PowerPoint를 설치하지 않고 Python 애플리케이션에서 CSV를 POT로 변환" >}}
