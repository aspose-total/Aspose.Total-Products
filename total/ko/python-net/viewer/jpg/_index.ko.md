---
title: JPG 파일을 온라인으로 보고 Python을 사용하여 JPG 파일 로드 또는 읽기
description: 무료 온라인 JPG 파일 뷰어 앱. 뷰어 애플리케이션용 JPG 파일을 읽고 로드하는 Python API 코드입니다.
...
{{< blocks/products/pf/feature-page-header-widget h1="JPG 파일을 온라인으로 자유롭게 보고 Python을 통해 문서를 로드하거나 읽습니다." h2="강력한 Python 기반 JPG 문서 뷰어 유틸리티 애플리케이션을 개발합니다.Python을 통해 JPG 문서를 로드하거나 읽는 코드입니다." >}}




{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="온라인 앱을 통해 JPG 문서 보기" %}}

1. 보려면 JPG 파일을 업로드하세요.
1. 뷰어 앱의 드래그 앤 드롭을 통해 드롭 영역 내부를 클릭하면 됩니다.
1. JPG 파일의 크기와 인터넷 속도에 따라 몇 초 정도 기다립니다.
1. 자동으로 렌더링되어 브라우저에서 열립니다.
1. 여러 페이지의 JPG 문서인 경우 페이지 간을 이동합니다.
1. 페이지 보기 확대 또는 축소를 설정합니다.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Python을 통해 JPG 파일 로드 또는 읽기" %}}

1. PyPI ([Aspose.Imaging](https://pypi.org/project/aspose-imaging-python-net/))에서 직접 프로젝트 내 API 참조
1. Image.load 함수를 사용하여 디스크에서 소스 JPG 파일을 로드합니다.
1. 스트림에서 읽고 로드하는 경우
...
{{% blocks/products/pf/agp/code-block title="디스크에서 JPG을 읽는 Python 코드" offSpacer="" %}}

{{< gist "aspose-com-gists" "8997090ce2d3e626fdc759cba091461e" "opening-image-from-disk.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="스트림에서 JPG을 읽는 Python의 코드 예제" offSpacer="" %}}
...
<h2>Python을 통해 JPG 파일 뷰어 애플리케이션 개발</h2>

JPG 뷰어 앱이나 유틸리티를 개발해야 합니까?[Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/)의 하위 API인 [Aspose.Imaging for Python via .NET](https://products.aspose.com/imaging/python-net/)을 사용하면 모든 Python 개발자가 위 API 코드를 문서 뷰어 애플리케이션에 통합할 수 있습니다.강력한 Python 라이브러리를 사용하면 JPG 형식을 포함하여 널리 사용되는 다양한 형식을 지원할 수 있는 모든 문서 표시 솔루션을 프로그래밍할 수 있습니다.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="JPG 파일을 처리하는 Python 유틸리티" %}}
...
<div class="col-md-12 tl bg-gray-dark howtolist section">
  ...
  <div class="container tl dflex" itemscope="" itemtype="https://schema.org/FAQPage">
      <div class="col-md-4 howtosectiongfx">
          <img class="social-panel-hide-on-mobile" src="https://www.groupJPGs.cloud/templates/brand/images/groupJPGs/conversion/groupJPGs_conversion-brand.png" alt="자주 묻는 질문" width="335" height="283">
      </div>
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>JPG 문서를 보기 위해 온라인 앱을 사용하는 것이 안전한가요?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">온라인 JPG 문서 뷰어에는 Google Chrome, Firefox, Opera 또는 Safari와 같은 최신 웹 브라우저를 사용할 수 있습니다.하지만 데스크톱 애플리케이션을 개발하는 경우 효율적인 관리를 위해 Aspose.Total 문서 처리 API를 사용하는 것이 좋습니다.</span>
                      </div>
                  </li>
              </ul>
          </div>
