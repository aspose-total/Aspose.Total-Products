---
title: Node.js API를 통한 PDF 조작 및 OCR 추가
description: PDF 파일을 조작하고 애플리케이션을 통해 이미지에서 텍스트를 추출하는 Node.js API입니다.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF 및 이미지 텍스트 추출을 위한 Node.js API" h2="이미지에서 텍스트를 추출하고 다른 소프트웨어 종속성 없이 Node.js 애플리케이션 내에 PDF 조작 기능을 포함합니다." logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
C++를 통한 Node.js용 Aspose.Total은 모든 것을 포함하는 Node.js 라이브러리 세트입니다.이러한 라이브러리는 PDF로 직접 작업하고 이미지를 텍스트로 변환하는 애플리케이션을 향상시키는 등의 기능을 제공합니다.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="C++를 통한 Node.js용 Aspose.Total에는 다음 Node.js 라이브러리가 포함되어 있습니다." >}}
...
C++를 통한 Node.js용 Aspose.PDF를 사용하면 백엔드에서 PDF 파일을 처리할 수 있습니다. 이를 활용하면 PDF를 최적화하고, 텍스트와 이미지를 통합 및 추출하고, 암호화 및 암호 해독 프로세스를 구현할 수 있습니다. 또한 이 기능은 PDF 문서를 쉽게 분할하고 병합하는 기능까지 확장되어 효율적인 PDF 파일 조작을 위한 포괄적인 도구 키트를 제공합니다.
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     모든 스캔을 완전히 검색하고 색인화할 수 있는 문서로 변환하세요.
    </p>
   </div>
   <div class="col-lg-4">
...
잘 문서화된 사용 설명서와 Aspose.Total 구성 요소의 견고성 덕분에 DOCO에 간단하게 통합되었습니다. 이는 예상보다 개발 시간을 단축하는 데 도움이 되었습니다.
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total은 다른 플랫폼을 위한 개별 솔루션을 제공합니다." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/ko/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/ko/nodejs-java/" 
