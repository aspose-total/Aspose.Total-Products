---
title: Καταργήστε το ODS Annotation Online ή διαχειριστείτε τους σχολιασμούς χρησιμοποιώντας τις εφαρμογές Android για κινητά
description: διαγράψτε σχόλια από το αρχείο ODS μέσω της διαδικτυακής εφαρμογής δωρεάν.Κώδικας API Android για διαχείριση σχολίων αρχείων ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Εκκαθάριση σχολίων από το ODS Document Online ή Διαχείριση μέσω εφαρμογών Android" h2="Αναπτύξτε μια ισχυρή εφαρμογή βοηθητικού προγράμματος σχολιασμού εγγράφων ODS που βασίζεται σε Android.Κωδικός που παρατίθεται για τη διαχείριση σχολίων του αρχείου ODS." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Καταργήστε τα σχόλια του εγγράφου ODS μέσω του API της εφαρμογής Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Κατάργηση σχολίων από το έγγραφο ODS" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Ενημέρωση σχολίου με νήματα του αρχείου ODS" offSpacer="" %}}
