---
title: Καταργήστε το ODT Annotation Online ή διαχειριστείτε τους σχολιασμούς χρησιμοποιώντας τις εφαρμογές Android για κινητά
description: διαγράψτε σχόλια από το αρχείο ODT μέσω της διαδικτυακής εφαρμογής δωρεάν.Κώδικας API Android για διαχείριση σχολίων αρχείων ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Εκκαθάριση σχολίων από το ODT Document Online ή Διαχείριση μέσω εφαρμογών Android" h2="Αναπτύξτε μια ισχυρή εφαρμογή βοηθητικού προγράμματος σχολιασμού εγγράφων ODT που βασίζεται σε Android.Ο κωδικός παρατίθεται για τη διαχείριση σχολίων του αρχείου ODT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Κατάργηση ODT Annotations Online" %}}

1. Εισαγάγετε το αρχείο ODT για να διαγράψετε σχόλια ανεβάζοντάς το
...
{{% blocks/products/pf/agp/feature-section-col title="Καταργήστε τα σχόλια του εγγράφου ODT μέσω της εφαρμογής Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Διαγραφή σχολίων από το αρχείο ODT" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Αφαιρέστε και προσθέστε την απάντηση σχολίου ODT" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Αφαίρεση και προσθήκη σχολίου απάντησης από το αρχείο ODT" offSpacer="" %}}
