---
title: Καταργήστε το XLT Annotation Online ή διαχειριστείτε τους σχολιασμούς χρησιμοποιώντας τις εφαρμογές Android για κινητά
description: διαγράψτε σχόλια από το αρχείο XLT μέσω της διαδικτυακής εφαρμογής δωρεάν.Κώδικας API Android για διαχείριση σχολίων αρχείων XLT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Εκκαθάριση σχολίων από το XLT Document Online ή Διαχείριση μέσω εφαρμογών Android" h2="Αναπτύξτε μια ισχυρή εφαρμογή βοηθητικού προγράμματος σχολιασμού εγγράφων XLT που βασίζεται σε Android.Κωδικός που παρατίθεται για τη διαχείριση σχολίων του αρχείου XLT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Καταργήστε τα σχόλια του εγγράφου XLT μέσω του API της εφαρμογής Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Κατάργηση σχολίων από το έγγραφο XLT" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ενημέρωση σχολίων XLT με νήματα" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Ενημέρωση σχολίου με νήματα του αρχείου XLT" offSpacer="" %}}
