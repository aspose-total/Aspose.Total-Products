---
title: Διαδικτυακή σύγκριση αρχείων DOTM ή δημιουργία εφαρμογών Android για κινητά για σύγκριση αρχείων DOTM
description: Δωρεάν διαδικτυακή εφαρμογή για σύγκριση διαφορετικών αρχείων DOTM.Κωδικός βιβλιοθήκης σύγκρισης Android για έγγραφα DOTM.
...
{{% blocks/products/pf/agp/feature-section-col title="Συγκρίνετε το αρχείο DOTM μέσω της εφαρμογής Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Συγκρίνετε αρχεία DOTM" offSpacer="" %}}
...
<h2>Αναπτύξτε την εφαρμογή Android σύγκρισης αρχείων DOTM</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Βιβλιοθήκη σύγκρισης DOTM για εφαρμογές Android" %}}
