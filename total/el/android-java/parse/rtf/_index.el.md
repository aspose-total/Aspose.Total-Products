---
title: Εξαγωγή κειμένου και εικόνων από το αρχείο RTF Online και χρησιμοποιώντας εφαρμογές Android για κινητά
description: Διαδικτυακή εφαρμογή ανάλυσης αρχείων RTF. Κώδικας API Android για εξαγωγή εικόνων και περιεχομένου κειμένου από το έγγραφο RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Αναλύστε το αρχείο RTF Online καθώς και εξαγωγή κειμένου μέσω εφαρμογών Android" h2="Αναπτύξτε μια ισχυρή εφαρμογή βοηθητικού προγράμματος ανάλυσης εγγράφων RTF με βάση το Android. Ο κωδικός παρατίθεται για εξαγωγή κειμένου εγγράφου RTF." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ανάλυση εγγράφου RTF σε απευθείας σύνδεση" %}}

1. Εισαγάγετε το αρχείο RTF για ανάλυση ανεβάζοντάς το.
...
{{% blocks/products/pf/agp/feature-section-col title="Εξαγωγή κειμένου από το αρχείο RTF μέσω της εφαρμογής Android" %}}

1. Προσθήκη αναφοράς βιβλιοθήκης στο έργο Java  
1. Φόρτωση αρχείου RTF χρησιμοποιώντας αντικείμενο κλάσης εγγράφου
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Εξαγωγή κειμένου εγγράφου RTF" offSpacer="" %}}
