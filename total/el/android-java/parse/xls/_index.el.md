---
title: Εξαγωγή κειμένου και εικόνων από το αρχείο XLS Online και χρησιμοποιώντας εφαρμογές Android για κινητά
description: Διαδικτυακή εφαρμογή ανάλυσης αρχείων XLS. Κώδικας API Android για εξαγωγή κειμένου σε σειρές και κελιά από υπολογιστικά φύλλα XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Αναλύστε το αρχείο XLS Online καθώς και μέσω εφαρμογών Android" h2="Αναπτύξτε την ισχυρή εφαρμογή βοηθητικού προγράμματος ανάλυσης εγγράφων XLS με βάση το Android. Ο κωδικός παρατίθεται για ανάλυση εγγράφων XLS." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ανάλυση εγγράφου XLS σε απευθείας σύνδεση" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ανάλυση αρχείου XLS μέσω εφαρμογής Android" %}}

1. Προσθήκη αναφοράς βιβλιοθήκης στο έργο Android  
1. Φόρτωση αρχείου XLS χρησιμοποιώντας αντικείμενο κλάσης Βιβλίου εργασίας
...
{{% blocks/products/pf/agp/code-block title="Κωδικός: Ανάλυση εγγράφου XLS" offSpacer="" %}}
