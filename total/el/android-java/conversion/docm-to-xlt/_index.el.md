---
title: Android API για μετατροπή DOCM σε XLT
description: Μετατροπή DOCM σε XLT στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOCM σε XLT στις Εφαρμογές Android" h2="Εξαγωγή DOCM σε XLT στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
