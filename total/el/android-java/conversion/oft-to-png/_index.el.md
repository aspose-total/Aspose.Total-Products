---
title: Απόδοση OFT σε PNG στην εφαρμογή Andorid
description: Εξαγωγή OFT σε PNG χωρίς χρήση του Microsoft Word ή του Outlook σε εφαρμογές Andorid
url: /el/android-java/conversion/oft-to-png/
family: total
platformtag: cpp
feature: conversion
informat: OFT
