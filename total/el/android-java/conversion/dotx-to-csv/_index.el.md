---
title: Android API για μετατροπή DOTX σε CSV
description: Μετατροπή DOTX σε CSV στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTX σε CSV στις Εφαρμογές Android" h2="Εξαγωγή DOTX σε CSV στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
