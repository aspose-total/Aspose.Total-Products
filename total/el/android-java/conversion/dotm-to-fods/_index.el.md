---
title: Android API για μετατροπή DOTM σε FODS
description: Μετατροπή DOTM σε FODS στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTM σε FODS στις Εφαρμογές Android" h2="Εξαγωγή DOTM σε FODS στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
