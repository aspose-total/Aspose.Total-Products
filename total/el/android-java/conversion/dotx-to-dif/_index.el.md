---
title: Android API για μετατροπή DOTX σε DIF
description: Μετατροπή DOTX σε DIF στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/android-java/conversion/dotx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTX σε DIF στις Εφαρμογές Android" h2="Εξαγωγή DOTX σε DIF στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
