---
title: Εξαγωγή FODS σε DOC στο Android
description: Android API για μετατροπή FODS σε DOC χωρίς χρήση του Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Αποδώστε το FODS στο DOC στο Android μέσω Java" h2="Μετατρέψτε το FODS σε DOC στις Εφαρμογές σας Android χωρίς να χρησιμοποιήσετε το Microsoft<sup>&reg;</sup> Excel" >}}
