---
title: Android API για μετατροπή DOTX σε XLAM
description: Μετατροπή DOTX σε XLAM στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTX σε XLAM στις Εφαρμογές Android" h2="Εξαγωγή DOTX σε XLAM στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
