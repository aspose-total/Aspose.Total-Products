---
title: Android API για μετατροπή DOTX σε XLSX
description: Μετατροπή DOTX σε XLSX στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/android-java/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTX σε XLSX στις Εφαρμογές Android" h2="Εξαγωγή DOTX σε XLSX στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
