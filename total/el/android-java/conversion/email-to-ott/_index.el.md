---
title: Απόδοση EMAIL σε OTT στην εφαρμογή Andorid
description: Εξαγωγή EMAIL σε OTT χωρίς χρήση του Microsoft Word ή του Outlook σε εφαρμογές Andorid
url: /el/android-java/conversion/email-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: MSG
