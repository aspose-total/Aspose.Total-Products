---
title: Εξαγωγή SXC σε DOCX στο Android
description: Android API για μετατροπή SXC σε DOCX χωρίς χρήση του Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Αποδώστε το SXC στο DOCX στο Android μέσω Java" h2="Μετατρέψτε το SXC σε DOCX στις Εφαρμογές σας Android χωρίς να χρησιμοποιήσετε το Microsoft<sup>&reg;</sup> Excel" >}}
