---
title: Android API για μετατροπή DOCX σε ODS
description: Μετατροπή DOCX σε ODS στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOCX σε ODS στις Εφαρμογές Android" h2="Εξαγωγή DOCX σε ODS στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
