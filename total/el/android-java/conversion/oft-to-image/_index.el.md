---
title: Απόδοση OFT σε IMAGE στην εφαρμογή Andorid
description: Εξαγωγή OFT σε IMAGE χωρίς χρήση του Microsoft Word ή του Outlook σε εφαρμογές Andorid
url: /el/android-java/conversion/oft-to-image/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/android-java/conversion/oft-to-image/" name="OFT Προς την IMAGE" description="" >}}
