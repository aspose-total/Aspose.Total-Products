---
title: Android API για μετατροπή DOC σε XLSX
description: Μετατροπή DOC σε XLSX στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOC σε XLSX στις Εφαρμογές Android" h2="Εξαγωγή DOC σε XLSX στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
