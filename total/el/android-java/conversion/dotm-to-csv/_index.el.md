---
title: Android API για μετατροπή DOTM σε CSV
description: Μετατροπή DOTM σε CSV στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOTM σε CSV στις Εφαρμογές Android" h2="Εξαγωγή DOTM σε CSV στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
