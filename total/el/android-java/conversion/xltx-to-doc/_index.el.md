---
title: Εξαγωγή XLTX σε DOC στο Android
description: Android API για μετατροπή XLTX σε DOC χωρίς χρήση του Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Αποδώστε το XLTX στο DOC στο Android μέσω Java" h2="Μετατρέψτε το XLTX σε DOC στις Εφαρμογές σας Android χωρίς να χρησιμοποιήσετε το Microsoft<sup>&reg;</sup> Excel" >}}
