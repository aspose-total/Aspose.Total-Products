---
title: Android API για μετατροπή ODT σε XLAM
description: Μετατροπή ODT σε XLAM στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή ODT σε XLAM στις Εφαρμογές Android" h2="Εξαγωγή ODT σε XLAM στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
