---
title: Android API για μετατροπή DOCM σε XLAM
description: Μετατροπή DOCM σε XLAM στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOCM σε XLAM στις Εφαρμογές Android" h2="Εξαγωγή DOCM σε XLAM στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
