---
title: Android API για μετατροπή DOCM σε FODS
description: Μετατροπή DOCM σε FODS στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/android-java/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOCM σε FODS στις Εφαρμογές Android" h2="Εξαγωγή DOCM σε FODS στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
