---
title: Android API για μετατροπή ODT σε XLSM
description: Μετατροπή ODT σε XLSM στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή ODT σε XLSM στις Εφαρμογές Android" h2="Εξαγωγή ODT σε XLSM στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
