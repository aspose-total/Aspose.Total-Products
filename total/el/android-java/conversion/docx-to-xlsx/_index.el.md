---
title: Android API για μετατροπή DOCX σε XLSX
description: Μετατροπή DOCX σε XLSX στο Android μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή DOCX σε XLSX στις Εφαρμογές Android" h2="Εξαγωγή DOCX σε XLSX στο Android μέσω Java χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
