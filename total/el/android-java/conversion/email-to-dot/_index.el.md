---
title: Απόδοση EMAIL σε DOT στην εφαρμογή Andorid
description: Εξαγωγή EMAIL σε DOT χωρίς χρήση του Microsoft Word ή του Outlook σε εφαρμογές Andorid
url: /el/android-java/conversion/email-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
