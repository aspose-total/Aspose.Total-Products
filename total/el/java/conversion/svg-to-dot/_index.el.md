---
title: Java API για εξαγωγή SVG σε DOT
description: Μετατρέψτε το SVG σε DOT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-dot/
family: total
platformtag: net
feature: conversion
informat: SVG
