...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή DOT σε TSV μέσω Java ή Online App" h2="On Premise Java API για μετατροπή DOT σε TSV χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API για μετατροπή DOT σε TSV" %}}
