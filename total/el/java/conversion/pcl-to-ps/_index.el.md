---
title: Java API για εξαγωγή PCL σε PS
description: Μετατρέψτε το PCL σε PS χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-ps/
family: total
platformtag: net
feature: conversion
informat: PCL
