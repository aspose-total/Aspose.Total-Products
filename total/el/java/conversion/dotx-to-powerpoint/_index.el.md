...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή DOTX σε POWERPOINT μέσω Java" h2="Μετατροπή DOTX σε POWERPOINT με χρήση του API Java εντός οποιασδήποτε εφαρμογής Java J2SE, J2EE, J2ME χωρίς χρήση Microsoft<sup>&reg;</sup> PowerPoint ή Word" >}}
