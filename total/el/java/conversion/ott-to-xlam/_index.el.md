---
title: Java API για μετατροπή OTT σε XLAM
description: Μετατροπή OTT σε XLAM μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή OTT σε XLAM μέσω Java" h2="On Premise Java API για μετατροπή OTT σε XLAM χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API για μετατροπή OTT σε XLAM" %}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή XLAM χρησιμοποιώντας το [Save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) μέθοδο
