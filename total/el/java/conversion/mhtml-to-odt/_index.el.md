---
title: Java API για εξαγωγή MHTML σε ODT
description: Μετατρέψτε το MHTML σε ODT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/mhtml-to-odt/
family: total
platformtag: net
feature: conversion
informat: MHTML
