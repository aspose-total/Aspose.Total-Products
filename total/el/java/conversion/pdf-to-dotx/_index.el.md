---
title: Java API για εξαγωγή PDF σε DOTX
description: Μετατρέψτε το PDF σε DOTX χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PDF
