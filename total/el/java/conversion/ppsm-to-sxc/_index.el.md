...
description: Μετατροπή PPSM σε μορφή SXC μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPSM σε SXC μέσω Java" h2="Στο Premise Java API για εξαγωγή PPSM σε SXC χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
