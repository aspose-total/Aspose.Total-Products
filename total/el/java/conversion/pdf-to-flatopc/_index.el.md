---
title: Java API για εξαγωγή PDF σε FLATOPC
description: Μετατρέψτε το PDF σε FLATOPC χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: PDF
