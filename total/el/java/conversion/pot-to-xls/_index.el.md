...
description: Μετατροπή POT σε μορφή XLS μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POT σε XLS μέσω Java" h2="Στο Premise Java API για εξαγωγή POT σε XLS χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
