---
title: Java API για εξαγωγή PDF σε RTF
description: Μετατρέψτε το PDF σε RTF χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-rtf/
family: total
platformtag: net
feature: conversion
informat: PDF
