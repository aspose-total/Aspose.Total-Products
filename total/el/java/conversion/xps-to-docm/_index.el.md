---
title: Java API για εξαγωγή XPS σε DOCM
description: Μετατρέψτε το XPS σε DOCM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-docm/
family: total
platformtag: net
feature: conversion
informat: XPS
