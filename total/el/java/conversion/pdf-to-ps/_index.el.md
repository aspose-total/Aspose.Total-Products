---
title: Java API για εξαγωγή PDF σε PS
description: Μετατρέψτε το PDF σε PS χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-ps/
family: total
platformtag: net
feature: conversion
informat: PDF
