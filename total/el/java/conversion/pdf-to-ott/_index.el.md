---
title: Java API για εξαγωγή PDF σε OTT
description: Μετατρέψτε το PDF σε OTT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-ott/
family: total
platformtag: net
feature: conversion
informat: PDF
