---
title: Java API για εξαγωγή PDF σε ODT
description: Μετατρέψτε το PDF σε ODT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-odt/
family: total
platformtag: net
feature: conversion
informat: PDF
