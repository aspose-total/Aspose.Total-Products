---
title: Java API για εξαγωγή TEX σε PCL
description: Μετατρέψτε το TEX σε PCL χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-pcl/
family: total
platformtag: net
feature: conversion
informat: TEX
