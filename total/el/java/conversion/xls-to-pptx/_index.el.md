---
title: Μετατροπή XLS σε PPTX χρησιμοποιώντας Java
description: Java API για εξαγωγή XLS σε PPTX με χρήση Excel ή Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLS σε PPTX" h2="On Premise Java API για εξαγωγή XLS σε PPTX χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
1. Ανοίξτε το αρχείο XLS χρησιμοποιώντας την τάξη [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
