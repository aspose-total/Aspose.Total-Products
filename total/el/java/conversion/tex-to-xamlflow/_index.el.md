---
title: Java API για εξαγωγή TEX σε XAMLFLOW
description: Μετατρέψτε το TEX σε XAMLFLOW χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: TEX
