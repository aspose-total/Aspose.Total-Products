---
title: Java API για εξαγωγή SVG σε WORDML
description: Μετατρέψτε το SVG σε WORDML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-wordml/
family: total
platformtag: net
feature: conversion
informat: SVG
