---
title: Μετατροπή XLTM σε DOCX χρησιμοποιώντας Java
description: Java API για εξαγωγή XLTM σε DOCX με χρήση Excel ή Word
url: /el/java/conversion/xltm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLTM σε DOCX" h2="On Premise Java API για εξαγωγή XLTM σε DOCX χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
1. Ανοίξτε το αρχείο XLTM χρησιμοποιώντας την τάξη [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
