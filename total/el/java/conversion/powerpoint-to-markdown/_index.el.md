---
title: Μετατροπή POWERPOINT σε μορφή MARKDOWN μέσω Java
description: Μετατροπή POWERPOINT σε μορφή MARKDOWN μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POWERPOINT σε MARKDOWN μέσω Java" h2="Στο Premise Java API για εξαγωγή POWERPOINT σε MARKDOWN χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή MARKDOWN χρησιμοποιώντας [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) μέθοδο
