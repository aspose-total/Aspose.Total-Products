---
title: Java API για εξαγωγή XPS σε MHTML
description: Μετατρέψτε το XPS σε MHTML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: XPS
