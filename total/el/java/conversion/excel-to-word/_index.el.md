---
title: Μετατροπή EXCEL σε WORD χρησιμοποιώντας Java
description: Java API για εξαγωγή EXCEL σε WORD με χρήση Excel ή Word
url: /el/java/conversion/excel-to-word/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή EXCEL σε WORD" h2="On Premise Java API για εξαγωγή EXCEL σε WORD χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
1. Ανοίξτε το αρχείο EXCEL χρησιμοποιώντας την τάξη [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/excel-to-wordx/" name="EXCEL Προς την WORDX" description="" >}}
