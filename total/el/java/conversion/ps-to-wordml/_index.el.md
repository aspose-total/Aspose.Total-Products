---
title: Java API για εξαγωγή PS σε WORDML
description: Μετατρέψτε το PS σε WORDML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PS
