---
title: Java API για εξαγωγή PS σε MHTML
description: Μετατρέψτε το PS σε MHTML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PS
