...
description: Μετατροπή POTM σε μορφή MHTML μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POTM σε MHTML μέσω Java" h2="Στο Premise Java API για εξαγωγή POTM σε MHTML χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
