---
title: Java API για εξαγωγή XPS σε XAMLFLOW
description: Μετατρέψτε το XPS σε XAMLFLOW χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: XPS
