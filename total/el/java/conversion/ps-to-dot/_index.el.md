---
title: Java API για εξαγωγή PS σε DOT
description: Μετατρέψτε το PS σε DOT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-dot/
family: total
platformtag: net
feature: conversion
informat: PS
