---
title: Java API για εξαγωγή PCL σε WORDML
description: Μετατρέψτε το PCL σε WORDML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PCL
