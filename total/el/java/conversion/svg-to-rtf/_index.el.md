---
title: Java API για εξαγωγή SVG σε RTF
description: Μετατρέψτε το SVG σε RTF χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-rtf/
family: total
platformtag: net
feature: conversion
informat: SVG
