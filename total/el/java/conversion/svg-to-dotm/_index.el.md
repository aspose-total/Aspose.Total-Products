---
title: Java API για εξαγωγή SVG σε DOTM
description: Μετατρέψτε το SVG σε DOTM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-dotm/
family: total
platformtag: net
feature: conversion
informat: SVG
