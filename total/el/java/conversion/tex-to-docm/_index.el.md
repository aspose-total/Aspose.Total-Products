---
title: Java API για εξαγωγή TEX σε DOCM
description: Μετατρέψτε το TEX σε DOCM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-docm/
family: total
platformtag: net
feature: conversion
informat: TEX
