---
title: Java API για εξαγωγή PCL σε XAMLFLOW
description: Μετατρέψτε το PCL σε XAMLFLOW χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: PCL
