---
title: Java API για εξαγωγή XPS σε PS
description: Μετατρέψτε το XPS σε PS χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-ps/
family: total
platformtag: net
feature: conversion
informat: XPS
