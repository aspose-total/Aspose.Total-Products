---
title: Java API για εξαγωγή CGM σε PCL
description: Μετατρέψτε το CGM σε PCL χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/cgm-to-pcl/
family: total
platformtag: net
feature: conversion
informat: CGM
