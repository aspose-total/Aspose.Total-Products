...
description: Μετατροπή PPS σε μορφή XLSX μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
url: /el/java/conversion/pps-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPS σε XLSX μέσω Java" h2="Στο Premise Java API για εξαγωγή PPS σε XLSX χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
