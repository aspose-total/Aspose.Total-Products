...
description: Μετατροπή POTX σε μορφή ODS μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POTX σε ODS μέσω Java" h2="Στο Premise Java API για εξαγωγή POTX σε ODS χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
