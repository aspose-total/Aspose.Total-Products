---
title: Java API για εξαγωγή MD σε DOTM
description: Μετατρέψτε το MD σε DOTM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/md-to-dotm/
family: total
platformtag: net
feature: conversion
informat: MD
