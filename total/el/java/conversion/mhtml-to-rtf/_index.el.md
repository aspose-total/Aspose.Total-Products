---
title: Java API για εξαγωγή MHTML σε RTF
description: Μετατρέψτε το MHTML σε RTF χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/mhtml-to-rtf/
family: total
platformtag: net
feature: conversion
informat: MHTML
