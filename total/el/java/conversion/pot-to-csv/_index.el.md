---
title: Μετατροπή POT σε μορφή CSV μέσω Java
description: Μετατροπή POT σε μορφή CSV μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POT σε CSV μέσω Java" h2="Στο Premise Java API για εξαγωγή POT σε CSV χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
2. Μετατρέψτε το POT σε HTML χρησιμοποιώντας το [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides. μέθοδος ISaveOptions-).
