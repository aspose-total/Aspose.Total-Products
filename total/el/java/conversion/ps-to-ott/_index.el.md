---
title: Java API για εξαγωγή PS σε OTT
description: Μετατρέψτε το PS σε OTT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-ott/
family: total
platformtag: net
feature: conversion
informat: PS
