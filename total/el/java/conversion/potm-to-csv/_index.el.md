...
description: Μετατροπή POTM σε μορφή CSV μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POTM σε CSV μέσω Java" h2="Στο Premise Java API για εξαγωγή POTM σε CSV χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
