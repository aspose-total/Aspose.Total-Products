---
title: Μετατροπή OTT σε PPS μέσω Java
description: Java API για εξαγωγή OTT σε PPS χωρίς χρήση Microsoft Word ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή OTT σε PPS μέσω Java" h2="Μετατροπή OTT σε PPS με χρήση του API Java εντός οποιασδήποτε εφαρμογής Java J2SE, J2EE, J2ME χωρίς χρήση Microsoft<sup>&reg;</sup> PowerPoint ή Word" >}}
...
2. Μετατρέψτε το αρχείο OTT σε HTML χρησιμοποιώντας [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) μέθοδος
