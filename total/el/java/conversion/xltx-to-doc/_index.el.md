---
title: Μετατροπή XLTX σε DOC χρησιμοποιώντας Java
description: Java API για εξαγωγή XLTX σε DOC με χρήση Excel ή Word
url: /el/java/conversion/xltx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLTX σε DOC" h2="On Premise Java API για εξαγωγή XLTX σε DOC χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/xltx-to-docx/" name="XLTX Προς την DOCX" description="" >}}
