...
description: Μετατροπή POT σε μορφή ODS μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POT σε ODS μέσω Java" h2="Στο Premise Java API για εξαγωγή POT σε ODS χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
