---
title: Java API για εξαγωγή SVG σε MHTML
description: Μετατρέψτε το SVG σε MHTML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: SVG
