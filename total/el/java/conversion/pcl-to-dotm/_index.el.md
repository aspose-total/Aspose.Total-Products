---
title: Java API για εξαγωγή PCL σε DOTM
description: Μετατρέψτε το PCL σε DOTM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PCL
