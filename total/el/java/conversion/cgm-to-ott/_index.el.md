---
title: Java API για εξαγωγή CGM σε OTT
description: Μετατρέψτε το CGM σε OTT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/cgm-to-ott/
family: total
platformtag: net
feature: conversion
informat: CGM
