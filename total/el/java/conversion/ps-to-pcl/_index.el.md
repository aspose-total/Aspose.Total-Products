---
title: Java API για εξαγωγή PS σε PCL
description: Μετατρέψτε το PS σε PCL χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: PS
