---
title: Μετατροπή XLT σε DOCX χρησιμοποιώντας Java
description: Java API για εξαγωγή XLT σε DOCX με χρήση Excel ή Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLT σε DOCX" h2="On Premise Java API για εξαγωγή XLT σε DOCX χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
