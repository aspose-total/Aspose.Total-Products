---
title: Java API για εξαγωγή SVG σε XAMLFLOW
description: Μετατρέψτε το SVG σε XAMLFLOW χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: SVG
