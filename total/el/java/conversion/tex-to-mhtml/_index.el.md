---
title: Java API για εξαγωγή TEX σε MHTML
description: Μετατρέψτε το TEX σε MHTML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
2. Μετατρέψτε το TEX σε DOC χρησιμοποιώντας το [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions- ) μέθοδος
