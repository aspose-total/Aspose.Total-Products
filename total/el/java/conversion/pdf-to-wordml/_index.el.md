---
title: Java API για εξαγωγή PDF σε WORDML
description: Μετατρέψτε το PDF σε WORDML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PDF
