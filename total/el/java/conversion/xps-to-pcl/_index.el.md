---
title: Java API για εξαγωγή XPS σε PCL
description: Μετατρέψτε το XPS σε PCL χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: XPS
