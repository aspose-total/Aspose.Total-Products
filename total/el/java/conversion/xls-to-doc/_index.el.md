---
title: Μετατροπή XLS σε DOC χρησιμοποιώντας Java
description: Java API για εξαγωγή XLS σε DOC με χρήση Excel ή Word
url: /el/java/conversion/xls-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLS σε DOC" h2="On Premise Java API για εξαγωγή XLS σε DOC χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/xls-to-docx/" name="XLS Προς την DOCX" description="" >}}
