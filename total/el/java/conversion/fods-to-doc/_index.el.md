---
title: Μετατροπή FODS σε DOC χρησιμοποιώντας Java
description: Java API για εξαγωγή FODS σε DOC με χρήση Excel ή Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή FODS σε DOC" h2="On Premise Java API για εξαγωγή FODS σε DOC χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
