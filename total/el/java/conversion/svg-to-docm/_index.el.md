---
title: Java API για εξαγωγή SVG σε DOCM
description: Μετατρέψτε το SVG σε DOCM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-docm/
family: total
platformtag: net
feature: conversion
informat: SVG
