---
title: Java API για εξαγωγή XPS σε DOT
description: Μετατρέψτε το XPS σε DOT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-dot/
family: total
platformtag: net
feature: conversion
informat: XPS
