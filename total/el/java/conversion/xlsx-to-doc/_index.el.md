---
title: Μετατροπή XLSX σε DOC χρησιμοποιώντας Java
description: Java API για εξαγωγή XLSX σε DOC με χρήση Excel ή Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLSX σε DOC" h2="On Premise Java API για εξαγωγή XLSX σε DOC χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
