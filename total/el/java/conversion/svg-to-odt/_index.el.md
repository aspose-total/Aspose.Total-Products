---
title: Java API για εξαγωγή SVG σε ODT
description: Μετατρέψτε το SVG σε ODT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/svg-to-odt/
family: total
platformtag: net
feature: conversion
informat: SVG
