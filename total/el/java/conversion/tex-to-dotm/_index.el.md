---
title: Java API για εξαγωγή TEX σε DOTM
description: Μετατρέψτε το TEX σε DOTM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-dotm/
family: total
platformtag: net
feature: conversion
informat: TEX
