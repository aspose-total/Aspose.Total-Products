...
description: Μετατροπή MOBI σε XLSB μέσω Java χωρίς χρήση του Microsoft Word ή του Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή MOBI σε XLSB μέσω Java" h2="On Premise Java API για μετατροπή MOBI σε XLSB χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
