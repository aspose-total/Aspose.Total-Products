---
title: Java API για εξαγωγή PDF σε DOT
description: Μετατρέψτε το PDF σε DOT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pdf-to-dot/
family: total
platformtag: net
feature: conversion
informat: PDF
