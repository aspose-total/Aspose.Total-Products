---
title: Java API για εξαγωγή TEX σε DOTX
description: Μετατρέψτε το TEX σε DOTX χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-dotx/
family: total
platformtag: net
feature: conversion
informat: TEX
