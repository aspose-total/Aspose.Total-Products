...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατρέψτε το XPS σε WORDML μέσω Java" h2="On Premise Java API για απόδοση XPS σε WORDML χωρίς χρήση εφαρμογής τρίτων" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API για μετατροπή XPS σε WORDML" %}}
