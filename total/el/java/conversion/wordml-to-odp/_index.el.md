---
title: Μετατροπή WORDML σε ODP μέσω Java
description: Java API για εξαγωγή WORDML σε ODP χωρίς χρήση Microsoft Word ή PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή WORDML σε ODP μέσω Java" h2="Μετατροπή WORDML σε ODP με χρήση του API Java εντός οποιασδήποτε εφαρμογής Java J2SE, J2EE, J2ME χωρίς χρήση Microsoft<sup>&reg;</sup> PowerPoint ή Word" >}}
