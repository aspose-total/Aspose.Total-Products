---
title: Java API για εξαγωγή PCL σε DOCM
description: Μετατρέψτε το PCL σε DOCM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-docm/
family: total
platformtag: net
feature: conversion
informat: PCL
