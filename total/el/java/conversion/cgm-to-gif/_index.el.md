---
title: Java API για εξαγωγή CGM σε GIF
description: Μετατρέψτε το CGM σε GIF χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/cgm-to-gif/
family: total
platformtag: net
feature: conversion
informat: CGM
