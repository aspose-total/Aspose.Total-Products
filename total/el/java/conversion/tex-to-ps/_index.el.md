---
title: Java API για εξαγωγή TEX σε PS
description: Μετατρέψτε το TEX σε PS χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-ps/
family: total
platformtag: net
feature: conversion
informat: TEX
