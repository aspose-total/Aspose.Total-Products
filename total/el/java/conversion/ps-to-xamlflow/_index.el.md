---
title: Java API για εξαγωγή PS σε XAMLFLOW
description: Μετατρέψτε το PS σε XAMLFLOW χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: PS
