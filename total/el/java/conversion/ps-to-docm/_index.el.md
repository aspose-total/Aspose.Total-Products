---
title: Java API για εξαγωγή PS σε DOCM
description: Μετατρέψτε το PS σε DOCM χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/ps-to-docm/
family: total
platformtag: net
feature: conversion
informat: PS
