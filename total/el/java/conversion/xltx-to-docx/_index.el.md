---
title: Μετατροπή XLTX σε DOCX χρησιμοποιώντας Java
description: Java API για εξαγωγή XLTX σε DOCX με χρήση Excel ή Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLTX σε DOCX" h2="On Premise Java API για εξαγωγή XLTX σε DOCX χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
