---
title: Java API για εξαγωγή TEX σε DOT
description: Μετατρέψτε το TEX σε DOT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/tex-to-dot/
family: total
platformtag: net
feature: conversion
informat: TEX
