---
title: Java API για εξαγωγή PCL σε MHTML
description: Μετατρέψτε το PCL σε MHTML χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PCL
