---
title: Μετατροπή EXCEL σε PPTX χρησιμοποιώντας Java
description: Java API για εξαγωγή EXCEL σε PPTX με χρήση Excel ή Word
url: /el/java/conversion/excel-to-pptx/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή EXCEL σε PPTX" h2="On Premise Java API για εξαγωγή EXCEL σε PPTX χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/excel-to-pptxx/" name="EXCEL Προς την PPTXX" description="" >}}
