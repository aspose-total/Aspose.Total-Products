---
title: Java API για εξαγωγή XPS σε DOTX
description: Μετατρέψτε το XPS σε DOTX χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: XPS
