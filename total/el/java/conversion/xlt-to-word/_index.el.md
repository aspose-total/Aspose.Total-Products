---
title: Μετατροπή XLT σε WORD χρησιμοποιώντας Java
description: Java API για εξαγωγή XLT σε WORD με χρήση Excel ή Word
url: /el/java/conversion/xlt-to-word/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API για εξαγωγή XLT σε WORD" h2="On Premise Java API για εξαγωγή XLT σε WORD χωρίς να βασίζεστε στο Microsoft Excel&reg;" >}}
