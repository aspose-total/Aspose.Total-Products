---
title: Java API για εξαγωγή PCL σε FLATOPC
description: Μετατρέψτε το PCL σε FLATOPC χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: PCL
