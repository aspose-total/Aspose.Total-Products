---
title: Java API για εξαγωγή PCL σε ODT
description: Μετατρέψτε το PCL σε ODT χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/pcl-to-odt/
family: total
platformtag: net
feature: conversion
informat: PCL
