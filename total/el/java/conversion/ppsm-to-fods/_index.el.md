...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPSM σε FODS μέσω Java ή Online App" h2="Στο Premise Java API για εξαγωγή PPSM σε FODS χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Η διαδικτυακή εφαρμογή για μετατροπή PPSM που ενσωματώθηκε παραπάνω. Για να ξεκινήσετε τη διαδικασία μετατροπής, μπορείτε είτε να σύρετε και να αποθέσετε το αρχείο PPSM στη λευκή περιοχή είτε να κάνετε κλικ σε αυτό για να εισαγάγετε το έγγραφο. Μόλις προστεθεί το αρχείο, απλώς κάντε κλικ στο κουμπί "Μετατροπή". Αφού ολοκληρωθεί η μετατροπή PPSM σε FODS, μπορείτε να κάνετε λήψη του αρχείου που μετατράπηκε. Με ένα μόνο κλικ, θα λάβετε τα αρχεία FODS εξόδου σας.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
