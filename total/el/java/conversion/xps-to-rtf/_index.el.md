---
title: Java API για εξαγωγή XPS σε RTF
description: Μετατρέψτε το XPS σε RTF χρησιμοποιώντας το Java API premise
url_ignore: /el/java/conversion/xps-to-rtf/
family: total
platformtag: net
feature: conversion
informat: XPS
