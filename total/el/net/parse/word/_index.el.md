---
title: Εξαγωγή κειμένου και εικόνων από το αρχείο Word Online και χρησιμοποιώντας .NET
description: Διαδικτυακή εφαρμογή ανάλυσης αρχείων Word. .NET API C# κώδικας για εξαγωγή εικόνων και περιεχομένου κειμένου από το έγγραφο Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Αναλύστε το Word File Online καθώς και μέσω .NET" h2="Αναπτύξτε ισχυρή εφαρμογή βοηθητικού προγράμματος ανάλυσης εγγράφων Word που βασίζεται σε .NET. Ο κώδικας C# παρατίθεται για εξαγωγή κειμένου εγγράφου Word." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ανάλυση αρχείου Word μέσω .NET" %}}

1. Προσθήκη αναφοράς βιβλιοθήκης στο έργο .NET
1. Φόρτωση αρχείου Word χρησιμοποιώντας αντικείμενο κλάσης εγγράφου
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C#: Εξαγωγή κειμένου εγγράφου Word" offSpacer="" %}}
...
<h2>Αναπτύξτε την εφαρμογή ανάλυσης αρχείων Word μέσω .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Βοηθητικό πρόγραμμα .NET για την επεξεργασία αρχείου Word για εφαρμογή ανάλυσης" %}}
