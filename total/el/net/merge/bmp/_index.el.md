---
title: Συγχώνευση αρχείων BMP Online ή χρησιμοποιώντας .NET
description: Δωρεάν διαδικτυακή εφαρμογή για συνδυασμό διαφορετικών αρχείων BMP. Συγχώνευση κώδικα βιβλιοθήκης .NET για συγχώνευση εγγράφων BMP σε μορφή επιλογής.
...
{{< blocks/products/pf/feature-page-header-widget h1="Συγχώνευση εγγράφων BMP Online μέσω της εφαρμογής συγχώνευσης ή χρησιμοποιώντας το .NET" h2="Αναπτύξτε ισχυρή εφαρμογή συγχώνευσης εγγράφων BMP που βασίζεται σε .NET.Συνδυάστε πολλά έγγραφα BMP σε ένα μόνο online δωρεάν μέσω της εφαρμογής.Αποθηκεύστε το συγχωνευμένο αρχείο BMP ως PDF, Εικόνες, Word και πολλές άλλες μορφές online." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Συγχώνευση αρχείων BMP Online χρησιμοποιώντας την εφαρμογή" %}}
...
1. Δείτε και λάβετε το ενιαίο συγχωνευμένο αρχείο BMP

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Συγχώνευση αρχείου BMP μέσω .NET" %}}
...
1. Καλέστε τη μέθοδο Save και λάβετε τα συγχωνευμένα αρχεία BMP σε ένα μόνο αρχείο.
...
{{% blocks/products/pf/agp/code-block title="Κωδικός .NET: Συγχώνευση αρχείων BMP" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ναι, μπορείτε να κάνετε λήψη αυτού του κώδικα και να τον χρησιμοποιήσετε για την ανάπτυξη εφαρμογών που βασίζονται σε .NET που επικεντρώνονται στο συνδυασμό εγγράφων BMP.Κάποιος μπορεί να αναπτύξει επαγγελματική λύση για να συνδυάσει BMP χρησιμοποιώντας .NET. Χρησιμοποιήστε το API συγχώνευσης BMP για να αναπτύξετε λογισμικό υψηλού επιπέδου, ανεξάρτητο από πλατφόρμα στο .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
