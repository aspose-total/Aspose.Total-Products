---
title: Συγχώνευση αρχείων JPEG Online ή χρησιμοποιώντας .NET
description: Δωρεάν διαδικτυακή εφαρμογή για συνδυασμό διαφορετικών αρχείων JPEG. Συγχώνευση κώδικα βιβλιοθήκης .NET για συγχώνευση εγγράφων JPEG σε μορφή επιλογής.
...
{{< blocks/products/pf/feature-page-header-widget h1="Συγχώνευση εγγράφων JPEG Online μέσω της εφαρμογής συγχώνευσης ή χρησιμοποιώντας το .NET" h2="Αναπτύξτε ισχυρή εφαρμογή συγχώνευσης εγγράφων JPEG που βασίζεται σε .NET.Συνδυάστε πολλά έγγραφα JPEG σε ένα μόνο online δωρεάν μέσω της εφαρμογής.Αποθηκεύστε το συγχωνευμένο αρχείο JPEG ως PDF, Εικόνες, Word και πολλές άλλες μορφές online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Συγχώνευση αρχείου JPEG μέσω .NET" %}}

1. Προσθέστε όλες τις εικόνες σε έναν πίνακα
1. Δημιουργία αντικειμένου κλάσης εγγράφου
1. Δημιουργία αντικειμένου κλάσης DocumentBuilder
1. Προσθέστε όλες τις εικόνες στο έγγραφο μέσω του InsertImage
1. Προσαρμόστε τις διαστάσεις
1. Καλέστε τη μέθοδο Save και λάβετε τα συγχωνευμένα αρχεία JPEG σε ένα μόνο αρχείο.
...
{{% blocks/products/pf/agp/code-block title="Κωδικός .NET: Συγχώνευση αρχείων JPEG" offSpacer="" %}}
...
- Εγκαταστήστε τη βιβλιοθήκη με το χέρι χρησιμοποιώντας GIF4
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ναι, μπορείτε να κάνετε λήψη αυτού του κώδικα και να τον χρησιμοποιήσετε για την ανάπτυξη εφαρμογών που βασίζονται σε .NET που επικεντρώνονται στο συνδυασμό εγγράφων JPEG.Κάποιος μπορεί να αναπτύξει επαγγελματική λύση για να συνδυάσει JPEG χρησιμοποιώντας .NET. Χρησιμοποιήστε το API συγχώνευσης JPEG για να αναπτύξετε λογισμικό υψηλού επιπέδου, ανεξάρτητο από πλατφόρμα στο .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
