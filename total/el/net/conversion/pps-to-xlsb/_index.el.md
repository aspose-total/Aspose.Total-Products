---
title: Μετατροπή PPS σε XLSB μέσω C#
description: Μετατροπή PPS σε XLSB σε C# χωρίς χρήση Microsoft Excel ή Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPS σε XLSB μέσω C#" h2=".NET API για μετατροπή PPS σε XLSB χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
1. Ανοίξτε το αρχείο PPS χρησιμοποιώντας την τάξη [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Εξαγωγή PPS ως HTML χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
