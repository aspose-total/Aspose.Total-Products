---
title: Μετατροπή XLTX σε WORD με .NET 
description: Μετατροπή XLTX σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xltx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTX σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; XLTX σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
