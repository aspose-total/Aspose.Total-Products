...
url: /el/net/conversion/pptx-to-dot/ 
...
1. Δημιουργήστε το [Aspose.Words.Dotument](https://apireference.aspose.com/words/net/aspose.words/dotument) και αρχικοποιήστε το με το MemoryStream Object
1. Αποθηκεύστε το έγγραφο χρησιμοποιώντας το [Aspose.Words.Dotument.Save("output.dot", SaveFormat.Dot)](https://apireference.aspose.com/words/net/aspose.words.dotument/save/methods /3)
