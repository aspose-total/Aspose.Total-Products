...
description: C# API για μετατροπή DOTM σε CSV χωρίς χρήση Microsoft Excel ή Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOTM σε CSV" h2="Εξαγωγή DOTM σε CSV μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
