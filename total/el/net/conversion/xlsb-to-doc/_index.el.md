---
title: Μετατροπή XLSB σε DOC με .NET 
description: Μετατροπή XLSB σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xlsb-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSB σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; XLSB σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
