---
title: Μετατροπή FODS σε WORD με .NET 
description: Μετατροπή FODS σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/fods-to-word/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή FODS σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; FODS σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
