---
title: Μετατροπή PPTX σε TSV μέσω C#
description: Μετατροπή PPTX σε TSV σε C# χωρίς χρήση Microsoft Excel ή Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPTX σε TSV μέσω C#" h2=".NET API για μετατροπή PPTX σε TSV χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
4. Αποθηκεύστε το έγγραφο σε TSV χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
