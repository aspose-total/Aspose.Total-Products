---
title: Μετατροπή POT σε RTF μέσω C# .NET 
url: /el/net/conversion/pot-to-rtf/ 
...
1. Δημιουργήστε το [Aspose.Words.Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument) και αρχικοποιήστε το με το MemoryStream Object
1. Αποθηκεύστε το έγγραφο χρησιμοποιώντας το [Aspose.Words.Rtfument.Save("output.rtf", SaveFormat.Rtf)](https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods /3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/pot-to-rtfx" name="POT Προς την RTFX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/pot-to-rtfm" name="POT Προς την RTFM" description="" >}}
