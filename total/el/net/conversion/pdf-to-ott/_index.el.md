---
title: C# API για εξαγωγή PDF σε OTT
description: Μετατροπή PDF σε OTT χωρίς χρήση του Microsoft Word
url_ignore: /el/net/conversion/pdf-to-ott/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση PDF σε OTT μέσω .NET" h2=".NET API για εξαγωγή PDF σε OTT σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή PDF σε OTT" %}}
