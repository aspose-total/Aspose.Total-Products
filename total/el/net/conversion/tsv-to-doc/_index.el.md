---
title: Μετατροπή TSV σε DOC με .NET 
description: Μετατροπή TSV σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/tsv-to-doc/
family: total
platformtag: net
feature: conversion
informat: TSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή TSV σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; TSV σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
