---
title: .NET API για μετατροπή DOT σε DIF
description: C# API για μετατροπή DOT σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOT σε DIF" h2="Εξαγωγή DOT σε DIF μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
