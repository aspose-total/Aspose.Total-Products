---
title: Μετατροπή SXC σε WORD με .NET 
description: Μετατροπή SXC σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή SXC σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; SXC σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
