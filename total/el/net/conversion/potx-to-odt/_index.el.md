---
title: Μετατροπή POTX σε ODT μέσω C# .NET 
url: /el/net/conversion/potx-to-odt/ 
...
1. Δημιουργήστε το [Aspose.Words.Odtument](https://apireference.aspose.com/words/net/aspose.words/odtument) και αρχικοποιήστε το με το MemoryStream Object
1. Αποθηκεύστε το έγγραφο χρησιμοποιώντας το [Aspose.Words.Odtument.Save("output.odt", SaveFormat.Odt)](https://apireference.aspose.com/words/net/aspose.words.odtument/save/methods /3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/potx-to-odtx" name="POTX Προς την ODTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/potx-to-odtm" name="POTX Προς την ODTM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/potx-to-flatopc" name="POTX Προς την FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/net/conversion/potx-to-txt" name="POTX Προς την TXT" description="" >}}
