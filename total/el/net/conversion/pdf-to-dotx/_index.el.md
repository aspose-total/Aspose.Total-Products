---
title: C# API για εξαγωγή PDF σε DOTX
description: Μετατροπή PDF σε DOTX χωρίς χρήση του Microsoft Word
url_ignore: /el/net/conversion/pdf-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση PDF σε DOTX μέσω .NET" h2=".NET API για εξαγωγή PDF σε DOTX σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή PDF σε DOTX" %}}
