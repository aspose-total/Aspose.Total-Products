...
url: /el/net/conversion/potm-to-flatopc/ 
...
1. Δημιουργήστε το [Aspose.Words.Flatopcument](https://apireference.aspose.com/words/net/aspose.words/flatopcument) και αρχικοποιήστε το με το MemoryStream Object
1. Αποθηκεύστε το έγγραφο χρησιμοποιώντας το [Aspose.Words.Flatopcument.Save("output.flatopc", SaveFormat.Flatopc)](https://apireference.aspose.com/words/net/aspose.words.flatopcument/save/methods /3)
