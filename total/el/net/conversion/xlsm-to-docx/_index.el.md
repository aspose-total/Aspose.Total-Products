---
title: Μετατροπή XLSM σε DOCX με .NET 
description: Μετατροπή XLSM σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSM σε DOCX μέσω C#" h2="Εξαγωγή Excel&reg; XLSM σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
