---
title: Μετατροπή ODS σε DOC με .NET 
description: Μετατροπή ODS σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή ODS σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; ODS σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
