---
title: Μετατροπή XLTM σε WORD με .NET 
description: Μετατροπή XLTM σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xltm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTM σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; XLTM σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
