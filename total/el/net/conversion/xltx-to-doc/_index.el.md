---
title: Μετατροπή XLTX σε DOC με .NET 
description: Μετατροπή XLTX σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xltx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTX σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; XLTX σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
