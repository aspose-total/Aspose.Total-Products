---
title: Μετατροπή XLSX σε DOC με .NET 
description: Μετατροπή XLSX σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSX σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; XLSX σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
