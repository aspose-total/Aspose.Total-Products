---
title: .NET API για μετατροπή DOT σε TSV
description: C# API για μετατροπή DOT σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOT σε TSV" h2="Εξαγωγή DOT σε TSV μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
