...
<iframe title="Δωρεάν διαδικτυακή εφαρμογή μετατροπής TEX σε XAMLFLOW" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=xamlflow&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Μετατρέψτε το TEX σε XAMLFLOW μέσω C# .NET" offSpacer="" %}}
