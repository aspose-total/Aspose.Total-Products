---
title: C# API για εξαγωγή TEX σε XAMLFLOW
description: Μετατροπή TEX σε XAMLFLOW χωρίς χρήση του Microsoft Word
url_ignore: /el/net/conversion/tex-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση TEX σε XAMLFLOW μέσω .NET" h2=".NET API για εξαγωγή TEX σε XAMLFLOW σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή TEX σε XAMLFLOW" %}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή XAMLFLOW χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) και ορίστε το Xamlflow ως SaveFormat
