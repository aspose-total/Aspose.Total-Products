---
title: Μετατροπή SXC σε DOC με .NET 
description: Μετατροπή SXC σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/sxc-to-doc/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή SXC σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; SXC σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
