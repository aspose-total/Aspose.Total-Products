---
title: Μετατροπή PPS σε SXC μέσω C#
description: Μετατροπή PPS σε SXC σε C# χωρίς χρήση Microsoft Excel ή Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPS σε SXC μέσω C#" h2=".NET API για μετατροπή PPS σε SXC χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
4. Αποθηκεύστε το έγγραφο σε SXC χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
