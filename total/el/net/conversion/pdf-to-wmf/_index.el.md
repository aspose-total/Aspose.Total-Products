---
title: Μετατροπή PDF σε WMF μέσω C# API
description: Εξάγετε το PDF σε WMF στις εφαρμογές σας .NET χωρίς να χρησιμοποιήσετε καμία εφαρμογή τρίτου μέρους
url_ignore: /el/net/conversion/pdf-to-wmf/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή αρχείου PDF σε WMF μέσω C#" h2="Εξαγωγή PDF σε WMF εντός εφαρμογών .NET χωρίς τη χρήση του Adobe<sup>&reg;</sup> Acrobat Reader ή άλλων εφαρμογών τρίτων" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Μετατροπή αρχείου PDF σε WMF μέσω .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Μετατροπή και περιστροφή αρχείου PDF σε WMF μέσω C#" %}}
