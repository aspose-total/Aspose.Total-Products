...
1. Φορτώστε το αρχείο DOCX χρησιμοποιώντας την κλάση [Aspose.Words.Docxument](https://apireference.aspose.com/words/net/aspose.words/docxument)
