...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLT σε DOCX μέσω C# ή διαδικτυακά" h2="Εξαγωγή Excel&reg; XLT σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
