---
title: Μετατροπή XLTX σε DOCX με .NET 
description: Μετατροπή XLTX σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTX σε DOCX μέσω C#" h2="Εξαγωγή Excel&reg; XLTX σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
