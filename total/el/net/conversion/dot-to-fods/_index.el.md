---
title: .NET API για μετατροπή DOT σε FODS
description: C# API για μετατροπή DOT σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOT σε FODS" h2="Εξαγωγή DOT σε FODS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
