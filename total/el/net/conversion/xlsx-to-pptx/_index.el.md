---
title: Μετατροπή XLSX σε PPTX με .NET 
description: Μετατροπή XLSX σε PPTX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSX σε PPTX μέσω C#" h2="Εξαγωγή Excel&reg; XLSX σε PPTX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
