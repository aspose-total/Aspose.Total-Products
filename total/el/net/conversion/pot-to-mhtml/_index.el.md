---
title: Μετατροπή POT σε MHTML μέσω C#
description: Μετατροπή POT σε MHTML σε C# χωρίς χρήση Microsoft Excel ή Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή POT σε MHTML μέσω C#" h2=".NET API για μετατροπή POT σε MHTML χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
1. Ανοίξτε το αρχείο POT χρησιμοποιώντας την τάξη [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Εξαγωγή POT ως HTML χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
4. Αποθηκεύστε το έγγραφο σε MHTML χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
