...
description: C# API για μετατροπή DOC σε XLS χωρίς χρήση Microsoft Excel ή Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOC σε XLS" h2="Εξαγωγή DOC σε XLS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
