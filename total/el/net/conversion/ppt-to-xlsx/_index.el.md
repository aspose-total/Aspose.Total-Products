---
title: Μετατροπή PPT σε XLSX μέσω C#
description: Μετατροπή PPT σε XLSX σε C# χωρίς χρήση Microsoft Excel ή Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPT σε XLSX μέσω C#" h2=".NET API για μετατροπή PPT σε XLSX χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
...
4. Αποθηκεύστε το έγγραφο σε XLSX χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
