...
1. Φορτώστε το αρχείο WORDML χρησιμοποιώντας την κλάση [Aspose.Words.Wordmlument](https://apireference.aspose.com/words/net/aspose.words/wordmlument)
