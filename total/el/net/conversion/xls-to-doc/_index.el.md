---
title: Μετατροπή XLS σε DOC με .NET 
description: Μετατροπή XLS σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xls-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLS σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; XLS σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
