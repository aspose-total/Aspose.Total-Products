---
title: Μετατροπή EXCEL σε DOC με .NET 
description: Μετατροπή EXCEL σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/excel-to-doc/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή EXCEL σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; EXCEL σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
