---
title: Μετατροπή FODS σε DOCX με .NET 
description: Μετατροπή FODS σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/fods-to-docx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή FODS σε DOCX μέσω C#" h2="Εξαγωγή Excel&reg; FODS σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
