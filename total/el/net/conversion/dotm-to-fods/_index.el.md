...
description: C# API για μετατροπή DOTM σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOTM σε FODS" h2="Εξαγωγή DOTM σε FODS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
