---
title: Μετατροπή XLTM σε DOCX με .NET 
description: Μετατροπή XLTM σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xltm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTM σε DOCX μέσω C#" h2="Εξαγωγή Excel&reg; XLTM σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
