---
title: Μετατροπή XLSM σε WORD με .NET 
description: Μετατροπή XLSM σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xlsm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSM σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; XLSM σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
