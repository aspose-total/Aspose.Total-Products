---
title: Μετατροπή ODS σε POWERPOINT με .NET 
description: Μετατροπή ODS σε POWERPOINT σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/ods-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή ODS σε POWERPOINT μέσω C#" h2="Εξαγωγή Excel&reg; ODS σε POWERPOINT σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
