---
title: Μετατροπή XLSX σε WORD με .NET 
description: Μετατροπή XLSX σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xlsx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSX σε WORD μέσω C#" h2="Εξαγωγή Excel&reg; XLSX σε WORD σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
