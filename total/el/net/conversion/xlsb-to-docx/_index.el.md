...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLSB σε DOCX μέσω C# ή διαδικτυακά" h2="Εξαγωγή Excel&reg; XLSB σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
