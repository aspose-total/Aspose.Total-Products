---
title: Μετατροπή ODS σε PPTX με .NET 
description: Μετατροπή ODS σε PPTX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/ods-to-pptx/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή ODS σε PPTX μέσω C#" h2="Εξαγωγή Excel&reg; ODS σε PPTX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
