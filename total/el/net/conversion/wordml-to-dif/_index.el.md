---
title: .NET API για μετατροπή WORDML σε DIF
description: C# API για μετατροπή WORDML σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/wordml-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή WORDML σε DIF" h2="Εξαγωγή WORDML σε DIF μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή DIF χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) και ορίστε το "DIF" ως SaveFormat
