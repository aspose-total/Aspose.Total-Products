...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTM σε DOC μέσω C# ή διαδικτυακά" h2="Εξαγωγή Excel&reg; XLTM σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
