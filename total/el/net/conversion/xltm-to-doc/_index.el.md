---
title: Μετατροπή XLTM σε DOC με .NET 
description: Μετατροπή XLTM σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
url: /el/net/conversion/xltm-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή XLTM σε DOC μέσω C#" h2="Εξαγωγή Excel&reg; XLTM σε DOC σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
