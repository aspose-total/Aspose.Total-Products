---
title: Μετατροπή ODS σε DOCX με .NET 
description: Μετατροπή ODS σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Μετατροπή ODS σε DOCX μέσω C#" h2="Εξαγωγή Excel&reg; ODS σε DOCX σε πλατφόρμες .NET Framework, .NET Core, Mono ή Xamarin">}}
