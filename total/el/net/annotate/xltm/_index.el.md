---
title: Καταργήστε το XLTM Annotation Online ή διαχειριστείτε τους σχολιασμούς μέσω .NET
description: διαγράψτε σχόλια από το αρχείο XLTM μέσω της διαδικτυακής εφαρμογής δωρεάν.Κώδικας API .NET για διαχείριση σχολίων αρχείων XLTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Διαγραφή σχολίων από το XLTM Document Online ή Διαχείριση μέσω .NET" h2="Αναπτύξτε ισχυρή εφαρμογή βοηθητικού προγράμματος σχολιασμού εγγράφων XLTM που βασίζεται σε .NET.Παρατίθεται κώδικας για τη διαχείριση σχολίων του αρχείου XLTM μέσω .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Κατάργηση σχολίων XLTM μέσω .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός .NET: Διαγραφή σχολίων από το αρχείο XLTM" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Είναι ασφαλές να χρησιμοποιήσετε την ηλεκτρονική εφαρμογή για να σχολιάσετε το έγγραφο XLTM;</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Μπορείτε να χρησιμοποιήσετε οποιοδήποτε σύγχρονο πρόγραμμα περιήγησης ιστού, όπως το Google Chrome, το Firefox, το Opera ή το Safari για online σχολιασμό εγγράφων XLTM. Ωστόσο, εάν αναπτύσσετε μια εφαρμογή επιτραπέζιου υπολογιστή, συνιστούμε να χρησιμοποιήσετε το API επεξεργασίας εγγράφων Aspose.Total για αποτελεσματική διαχείριση.</span>
                      </div>
                  </li>
              </ul>
          </div>
