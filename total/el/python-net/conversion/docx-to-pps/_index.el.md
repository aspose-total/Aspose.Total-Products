...
{{% blocks/products/pf/agp/feature-section-col title="Μετατροπή DOCX σε PPS στην Python" %}}
...
-  Καλέστε τη μέθοδο «αποθήκευση» ενώ προσδιορίζετε τη διαδρομή αρχείου εξόδου και το SaveFormat.PPS ως παραμέτρους. Έτσι, το αρχείο DOCX μετατρέπεται σε PPS στην καθορισμένη διαδρομή.
