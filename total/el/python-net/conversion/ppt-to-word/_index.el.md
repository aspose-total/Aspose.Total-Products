...
{{% blocks/products/pf/agp/feature-section-col title="Μετατροπή PPT σε WORD στην Python" %}}
...
-  Καλέστε τη μέθοδο «αποθήκευση» ενώ καθορίζετε τη διαδρομή αρχείου εξόδου και το SaveFormat.PDF ως παραμέτρους. Έτσι, το αρχείο PPT μετατρέπεται σε PDF στην καθορισμένη διαδρομή.
