---
title: Μετατροπή XLS σε PPSX χρησιμοποιώντας Python
description: Μετατροπή XLS σε PPSX στις εφαρμογές Python σας χωρίς τη χρήση του Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή XLS σε PPSX μέσω Python" h2="Μετατροπή XLS σε PPSX στις εφαρμογές σας Python χωρίς εγκατάσταση του Microsoft Excel<sup>&reg;</sup> ή του PowerPoint" >}}
