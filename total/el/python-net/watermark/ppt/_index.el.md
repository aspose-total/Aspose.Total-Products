---
title: Online Watermarking αρχείων PPT ή Δημιουργία εφαρμογών Python σε αρχεία υδατογραφήματος PPT
description: Δωρεάν διαδικτυακή εφαρμογή για υδατογράφημα διαφορετικών αρχείων PPT. Κώδικας βιβλιοθήκης υδατογραφήματος Python για έγγραφα PPT.
...
{{< blocks/products/pf/feature-page-header h1="Ηλεκτρονική εφαρμογή υδατογραφήματος εγγράφων και κώδικας Python σε αρχεία υδατογραφήματος PPT" h2="Αναπτύξτε ισχυρές εφαρμογές υδατογραφήματος εγγράφων PPT βασισμένες στην Python. Υδατογραφήστε ελεύθερα διάφορα έγγραφα, συμπεριλαμβανομένων αρχείων PPT στο διαδίκτυο μέσω εφαρμογής με άμεση λήψη." >}}
...
<h3>Δωρεάν διαδικτυακή εφαρμογή υδατογραφήματος εγγράφων PPT</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Υδατογράφημα PPT Files Online χρησιμοποιώντας την εφαρμογή" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Αρχείο υδατογραφήματος PPT μέσω Python" %}}
...
1. Χρησιμοποιήστε τη μέθοδο add_auto_shape για να προσθέσετε σχήματα όπως το Ορθογώνιο.
1. Χρησιμοποιήστε το add_text_frame με κείμενο watmark.
1. Καλέστε τη μέθοδο αποθήκευσης κλήσης και αποκτήστε το αρχείο υδατογραφημένο PPT.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Παράδειγμα κώδικα σε python για υδατογράφημα αρχείων PPT" offSpacer="" %}}

{{< gist "aspose-com-gists" "4b5ac1c50cf9403d3bc52d2df2bbcaad" "add-text-watermark-to-presentation.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Κώδικας Python για προσθήκη υδατογραφήματος εικόνας σε αρχεία PPT" offSpacer="" %}}
