---
title: Ηλεκτρονική συμπίεση αρχείων XLSX ή δημιουργία εφαρμογών Python για αρχειοθέτηση αρχείων XLSX
description: Δωρεάν διαδικτυακή εφαρμογή για τη συμπίεση διαφορετικών αρχείων XLSX. Python αρχειοθέτηση κώδικα βιβλιοθήκης για έγγραφα XLSX.
...
<h3>Δωρεάν διαδικτυακή εφαρμογή συμπίεσης εγγράφων XLSX</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Αρχειοθέτηση αρχείου XLSX μέσω Python Compression API" %}}
...
1. Προσθέστε όσα αρχεία XLSX θέλετε να αρχειοθετήσετε χρησιμοποιώντας το create_entry().
1. Καλέστε τη μέθοδο αποθήκευσης και λάβετε το αρχειοθετημένο αρχείο XLSX ως ZIP, RAR κ.λπ.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Παράδειγμα κώδικα σε python για αρχειοθέτηση αρχείου XLSX" offSpacer="" %}}

{{< gist "aspose-com-gists" "533b68e0904932a37c25a576bd20448d" "compress-and-add-single-file-into-archive.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Κώδικας Python για αρχειοθέτηση πολλών αρχείων XLSX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ναι, μπορείτε να κάνετε λήψη αυτού του κώδικα. Μπορεί κανείς εύκολα να αναπτύξει μια επαγγελματική λύση για την αρχειοθέτηση αρχείου XLSX χρησιμοποιώντας Python.Χρησιμοποιήστε το Aspose XLSX compression API για να αναπτύξετε λογισμικό υψηλού επιπέδου, ανεξάρτητο από πλατφόρμα στην Python.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
