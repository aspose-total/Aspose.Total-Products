---
title: Αναγνώριση εικόνων γραμμικού κώδικα DATABAR μέσω Python
description: Σαρώστε εικόνες γραμμωτού κώδικα συμβόλων DATABAR χρησιμοποιώντας εφαρμογές Python χωρίς τη χρήση άλλου λογισμικού. 
...
- Για σάρωση γραμμωτού κώδικα DATABAR, απαιτείται Python 3.5 ή νεότερη έκδοση
...
{{% blocks/products/pf/agp/code-block title="Αναγνωρίστε τον γραμμικό κώδικα συμβολολογίας DATABAR στην Python" offSpacer="" %}}
