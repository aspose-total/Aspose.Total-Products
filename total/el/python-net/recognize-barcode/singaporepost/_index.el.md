---
title: Αναγνώριση εικόνων γραμμικού κώδικα SINGAPOREPOST μέσω Python
description: Σαρώστε εικόνες γραμμωτού κώδικα συμβόλων SINGAPOREPOST χρησιμοποιώντας εφαρμογές Python χωρίς τη χρήση άλλου λογισμικού. 
...
- Για σάρωση γραμμωτού κώδικα SINGAPOREPOST, απαιτείται Python 3.5 ή νεότερη έκδοση
...
{{% blocks/products/pf/agp/code-block title="Αναγνωρίστε τον γραμμικό κώδικα συμβολολογίας SINGAPOREPOST στην Python" offSpacer="" %}}
