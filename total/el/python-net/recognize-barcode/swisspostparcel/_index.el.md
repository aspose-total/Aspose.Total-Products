---
title: Αναγνώριση εικόνων γραμμικού κώδικα SWISSPOSTPARCEL μέσω Python
description: Σαρώστε εικόνες γραμμωτού κώδικα συμβόλων SWISSPOSTPARCEL χρησιμοποιώντας εφαρμογές Python χωρίς τη χρήση άλλου λογισμικού. 
...
- Για σάρωση γραμμωτού κώδικα SWISSPOSTPARCEL, απαιτείται Python 3.5 ή νεότερη έκδοση
...
{{% blocks/products/pf/agp/code-block title="Αναγνωρίστε τον γραμμικό κώδικα συμβολολογίας SWISSPOSTPARCEL στην Python" offSpacer="" %}}
