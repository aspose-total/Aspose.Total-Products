---
title: Αναγνώριση εικόνων γραμμικού κώδικα EAN μέσω Python
description: Σαρώστε εικόνες γραμμωτού κώδικα συμβόλων EAN χρησιμοποιώντας εφαρμογές Python χωρίς τη χρήση άλλου λογισμικού. 
...
- Για σάρωση γραμμωτού κώδικα EAN, απαιτείται Python 3.5 ή νεότερη έκδοση
...
{{% blocks/products/pf/agp/code-block title="Αναγνωρίστε τον γραμμικό κώδικα συμβολολογίας EAN στην Python" offSpacer="" %}}
