---
title: Αναγνώριση εικόνων γραμμικού κώδικα AZTEC μέσω Python
description: Σαρώστε εικόνες γραμμωτού κώδικα συμβόλων AZTEC χρησιμοποιώντας εφαρμογές Python χωρίς τη χρήση άλλου λογισμικού. 
...
- Για σάρωση γραμμωτού κώδικα AZTEC, απαιτείται Python 3.5 ή νεότερη έκδοση
...
{{% blocks/products/pf/agp/code-block title="Αναγνωρίστε τον γραμμικό κώδικα συμβολολογίας AZTEC στην Python" offSpacer="" %}}
