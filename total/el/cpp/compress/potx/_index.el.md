---
title: Συμπίεση αρχείων POTX Online ή μέσω C++
description: Δωρεάν διαδικτυακή εφαρμογή για τη συμπίεση διαφορετικών αρχείων POTX.Κώδικας βιβλιοθήκης συμπίεσης C++ για έγγραφα POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Συμπιέστε το αρχείο POTX Online μέσω της εφαρμογής συμπίεσης ή χρησιμοποιώντας C++" h2="Αναπτύξτε ισχυρές εφαρμογές συμπίεσης εγγράφων POTX που βασίζονται σε C++.Συμπιέστε ελεύθερα διάφορα έγγραφα, συμπεριλαμβανομένων αρχείων POTX online μέσω εφαρμογής με άμεση λήψη." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Συμπίεση αρχείου POTX μέσω C++" %}}

1. Προσθέστε αναφορά βιβλιοθήκης C++ στο έργο
1. Φορτώστε την παρουσίαση POTX
1. Χρησιμοποιήστε τη μέθοδο Compress::RemoveUnusedMasterSlides
1. Καλέστε τη μέθοδο Save και λάβετε τη συμπιεσμένη παρουσίαση POTX

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Κωδικός C++: συμπίεση της παρουσίασης POTX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ναι, μπορείτε να κάνετε λήψη αυτού του κώδικα. Μπορεί κανείς εύκολα να αναπτύξει μια επαγγελματική λύση για τη συμπίεση αρχείου POTX χρησιμοποιώντας C++.Χρησιμοποιήστε το Aspose POTX compression API για να αναπτύξετε λογισμικό υψηλού επιπέδου, ανεξάρτητο από πλατφόρμα σε C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
