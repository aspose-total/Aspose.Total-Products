---
title: Συμπίεση αρχείων PPTM Online ή μέσω C++
description: Δωρεάν διαδικτυακή εφαρμογή για τη συμπίεση διαφορετικών αρχείων PPTM.Κώδικας βιβλιοθήκης συμπίεσης C++ για έγγραφα PPTM.
...
{{% blocks/products/pf/agp/feature-section-col title="Συμπίεση αρχείου PPTM μέσω C++" %}}

1. Προσθέστε αναφορά βιβλιοθήκης C++ στο έργο
1. Φορτώστε την παρουσίαση PPTM
1. Χρησιμοποιήστε τη μέθοδο Compress::RemoveUnusedMasterSlides
1. Καλέστε τη μέθοδο Save και λάβετε τη συμπιεσμένη παρουσίαση PPTM

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Κωδικός C++: συμπίεση της παρουσίασης PPTM" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ναι, μπορείτε να κάνετε λήψη αυτού του κώδικα. Μπορεί κανείς εύκολα να αναπτύξει μια επαγγελματική λύση για τη συμπίεση αρχείου PPTM χρησιμοποιώντας C++.Χρησιμοποιήστε το Aspose PPTM compression API για να αναπτύξετε λογισμικό υψηλού επιπέδου, ανεξάρτητο από πλατφόρμα σε C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
