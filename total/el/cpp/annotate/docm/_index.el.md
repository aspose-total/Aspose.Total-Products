---
title: Καταργήστε το DOCM Annotation Online ή διαχειριστείτε τους σχολιασμούς μέσω C++
description: διαγράψτε σχόλια από το αρχείο DOCM μέσω της διαδικτυακής εφαρμογής δωρεάν. Κώδικας API C++ για διαχείριση σχολίων αρχείων DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Διαγραφή σχολίων από το DOCM Document Online ή Διαχείριση μέσω C++" h2="Αναπτύξτε μια ισχυρή εφαρμογή βοηθητικού προγράμματος σχολιασμού εγγράφων DOCM που βασίζεται σε C++. Παρατίθεται κώδικας για τη διαχείριση σχολίων του αρχείου DOCM μέσω C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Διαγραφή σχολίων εγγράφου DOCM μέσω C++" %}}

1. Προσθήκη αναφοράς βιβλιοθήκης στο έργο C++
1. Φόρτωση αρχείου DOCM
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C++: Διαγραφή σχολίων από το αρχείο DOCM" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Κωδικός C++: Προσθήκη σχολίου στο αρχείο DOCM" offSpacer="" %}}
...
<h2>Αναπτύξτε DOCM Document Annotation Application μέσω C++</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Βιβλιοθήκη C++ για σχολιασμό αρχείων DOCM" %}}
