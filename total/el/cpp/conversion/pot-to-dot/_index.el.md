---
title: C++ API για Μετατροπή POT σε DOT
description: Εξαγωγή POT σε DOT στις εφαρμογές σας C++
url: /el/cpp/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POT σε DOT" h2="Εξαγωγή POT σε DOT σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
