---
title: Μετατροπή FLATOPC σε ODP μέσω C++
description: Εξαγωγή FLATOPC σε ODP στις εφαρμογές σας C++ χωρίς χρήση του Microsoft Word του PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή FLATOPC σε ODP" h2="Εξαγωγή FLATOPC σε ODP εντός των εφαρμογών σας C++ χωρίς χρήση του Microsoft Word&reg; ή PowerPoint" >}}
