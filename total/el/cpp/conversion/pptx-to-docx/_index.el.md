---
title: C++ API για Μετατροπή PPTX σε DOCX
description: Εξαγωγή PPTX σε DOCX στις εφαρμογές σας C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPTX σε DOCX" h2="Εξαγωγή PPTX σε DOCX σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
