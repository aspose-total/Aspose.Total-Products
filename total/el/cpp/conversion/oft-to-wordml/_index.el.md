---
title: Εξαγωγή OFT σε WORDML μέσω C++
description: C++ API για μετατροπή OFT σε WORDML χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε WORDML" h2="Μετατρέψτε το OFT σε WORDML εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API για Μετατροπή OFT σε WORDML" %}}
