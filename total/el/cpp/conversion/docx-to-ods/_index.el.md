---
title: Μετατροπή DOCX σε ODS σε C++
description: C++ API για μετατροπή DOCX σε ODS χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/docx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOCX σε ODS" h2="Εξαγωγή DOCX σε ODS μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
