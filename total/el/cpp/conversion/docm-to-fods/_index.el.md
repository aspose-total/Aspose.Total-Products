---
title: Μετατροπή DOCM σε FODS σε C++
description: C++ API για μετατροπή DOCM σε FODS χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOCM σε FODS" h2="Εξαγωγή DOCM σε FODS μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
