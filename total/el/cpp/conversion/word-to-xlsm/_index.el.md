---
title: Μετατροπή WORD σε XLSM σε C++
description: C++ API για μετατροπή WORD σε XLSM χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/word-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή WORD σε XLSM" h2="Εξαγωγή WORD σε XLSM μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
