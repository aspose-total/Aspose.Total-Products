---
title: Εξαγωγή OFT σε RTF μέσω C++
description: C++ API για μετατροπή OFT σε RTF χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε RTF" h2="Μετατρέψτε το OFT σε RTF εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
