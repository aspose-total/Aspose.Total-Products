---
title: C++ API για Μετατροπή PPS σε DOC
description: Εξαγωγή PPS σε DOC στις εφαρμογές σας C++
url: /el/cpp/conversion/pps-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPS σε DOC" h2="Εξαγωγή PPS σε DOC σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
