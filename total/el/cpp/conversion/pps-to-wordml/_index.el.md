---
title: C++ API για Μετατροπή PPS σε WORDML
description: Εξαγωγή PPS σε WORDML στις εφαρμογές σας C++
url: /el/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPS σε WORDML" h2="Εξαγωγή PPS σε WORDML σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
