---
title: Μετατροπή DOCM σε EXCEL σε C++
description: C++ API για μετατροπή DOCM σε EXCEL χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/docm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOCM σε EXCEL" h2="Εξαγωγή DOCM σε EXCEL μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
