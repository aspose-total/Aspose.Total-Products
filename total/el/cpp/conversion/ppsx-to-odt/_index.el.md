---
title: C++ API για Μετατροπή PPSX σε ODT
description: Εξαγωγή PPSX σε ODT στις εφαρμογές σας C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPSX σε ODT" h2="Εξαγωγή PPSX σε ODT σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
