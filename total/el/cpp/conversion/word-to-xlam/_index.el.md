---
title: Μετατροπή WORD σε XLAM σε C++
description: C++ API για μετατροπή WORD σε XLAM χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/word-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή WORD σε XLAM" h2="Εξαγωγή WORD σε XLAM μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
