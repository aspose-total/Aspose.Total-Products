---
title: Εξαγωγή OFT σε DOTM μέσω C++
description: C++ API για μετατροπή OFT σε DOTM χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε DOTM" h2="Μετατρέψτε το OFT σε DOTM εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
