---
title: C++ API για Μετατροπή POTX σε DOCM
description: Εξαγωγή POTX σε DOCM στις εφαρμογές σας C++
url: /el/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POTX σε DOCM" h2="Εξαγωγή POTX σε DOCM σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
