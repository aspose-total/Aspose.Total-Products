---
title: C++ API για Μετατροπή PPSX σε DOC
description: Εξαγωγή PPSX σε DOC στις εφαρμογές σας C++
url: /el/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPSX σε DOC" h2="Εξαγωγή PPSX σε DOC σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
