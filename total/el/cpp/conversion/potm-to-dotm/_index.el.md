---
title: C++ API για Μετατροπή POTM σε DOTM
description: Εξαγωγή POTM σε DOTM στις εφαρμογές σας C++
url: /el/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POTM σε DOTM" h2="Εξαγωγή POTM σε DOTM σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
