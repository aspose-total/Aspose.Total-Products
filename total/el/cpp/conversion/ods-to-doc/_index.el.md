---
title: Μετατροπή ODS σε DOC με C++
description: Μετατροπή ODS σε DOC εντός εφαρμογών C++
url: /el/cpp/conversion/ods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Μετατροπή ODS σε DOC μέσω C++" h2="Εξαγωγή Excel<sup>&reg;</sup> ODS σε DOC σε πλήρως λειτουργικές εφαρμογές C++" >}}
