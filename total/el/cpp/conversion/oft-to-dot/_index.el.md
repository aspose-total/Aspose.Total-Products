---
title: Εξαγωγή OFT σε DOT μέσω C++
description: C++ API για μετατροπή OFT σε DOT χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε DOT" h2="Μετατρέψτε το OFT σε DOT εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
