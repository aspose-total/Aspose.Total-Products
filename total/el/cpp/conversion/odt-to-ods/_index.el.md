---
title: Μετατροπή ODT σε ODS σε C++
description: C++ API για μετατροπή ODT σε ODS χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/odt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή ODT σε ODS" h2="Εξαγωγή ODT σε ODS μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
