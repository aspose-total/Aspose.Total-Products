---
title: C++ API για Μετατροπή PPT σε WORD
description: Εξαγωγή PPT σε WORD στις εφαρμογές σας C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPT σε WORD" h2="Εξαγωγή PPT σε WORD σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
