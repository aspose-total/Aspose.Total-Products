---
title: C++ API για Μετατροπή POTX σε DOC
description: Εξαγωγή POTX σε DOC στις εφαρμογές σας C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POTX σε DOC" h2="Εξαγωγή POTX σε DOC σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
