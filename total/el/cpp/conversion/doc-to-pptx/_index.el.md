---
title: Μετατροπή DOC σε PPTX μέσω C++
description: Εξαγωγή DOC σε PPTX στις εφαρμογές σας C++ χωρίς χρήση του Microsoft Word του PowerPoint
url: /el/cpp/conversion/doc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOC σε PPTX" h2="Εξαγωγή DOC σε PPTX εντός των εφαρμογών σας C++ χωρίς χρήση του Microsoft Word&reg; ή PowerPoint" >}}
