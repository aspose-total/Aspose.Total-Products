---
title: Μετατροπή DOCX σε XLSX σε C++
description: C++ API για μετατροπή DOCX σε XLSX χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/docx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOCX σε XLSX" h2="Εξαγωγή DOCX σε XLSX μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
