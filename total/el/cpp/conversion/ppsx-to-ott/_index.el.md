---
title: C++ API για Μετατροπή PPSX σε OTT
description: Εξαγωγή PPSX σε OTT στις εφαρμογές σας C++
url: /el/cpp/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
