---
title: C++ API για Μετατροπή PPS σε WORD
description: Εξαγωγή PPS σε WORD στις εφαρμογές σας C++
url: /el/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPS σε WORD" h2="Εξαγωγή PPS σε WORD σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
