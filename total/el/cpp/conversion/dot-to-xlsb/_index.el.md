---
title: Μετατροπή DOT σε XLSB σε C++
description: C++ API για μετατροπή DOT σε XLSB χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/dot-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή DOT σε XLSB" h2="Εξαγωγή DOT σε XLSB μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
