---
title: C++ API για Μετατροπή PPSX σε DOCM
description: Εξαγωγή PPSX σε DOCM στις εφαρμογές σας C++
url: /el/cpp/conversion/ppsx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPSX σε DOCM" h2="Εξαγωγή PPSX σε DOCM σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
