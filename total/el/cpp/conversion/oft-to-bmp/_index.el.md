---
title: Εξαγωγή OFT σε BMP μέσω C++
description: C++ API για μετατροπή OFT σε BMP χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε BMP" h2="Μετατρέψτε το OFT σε BMP εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
