---
title: Εξαγωγή EMAIL σε DOT μέσω C++
description: C++ API για μετατροπή EMAIL σε DOT χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/email-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
