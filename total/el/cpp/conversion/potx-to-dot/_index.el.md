---
title: C++ API για Μετατροπή POTX σε DOT
description: Εξαγωγή POTX σε DOT στις εφαρμογές σας C++
url: /el/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POTX σε DOT" h2="Εξαγωγή POTX σε DOT σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
