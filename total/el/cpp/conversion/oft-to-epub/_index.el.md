---
title: Εξαγωγή OFT σε EPUB μέσω C++
description: C++ API για μετατροπή OFT σε EPUB χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε EPUB" h2="Μετατρέψτε το OFT σε EPUB εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API για Μετατροπή OFT σε EPUB" %}}
