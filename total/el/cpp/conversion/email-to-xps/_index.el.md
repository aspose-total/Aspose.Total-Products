---
title: Εξαγωγή EMAIL σε XPS μέσω C++
description: C++ API για μετατροπή EMAIL σε XPS χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/email-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή EMAIL σε XPS" h2="Μετατρέψτε το EMAIL σε XPS εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
