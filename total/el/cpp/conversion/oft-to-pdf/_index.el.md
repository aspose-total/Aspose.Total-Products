---
title: Εξαγωγή OFT σε PDF μέσω C++
description: C++ API για μετατροπή OFT σε PDF χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε PDF" h2="Μετατρέψτε το OFT σε PDF εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
