---
title: Εξαγωγή OFT σε DOC μέσω C++
description: C++ API για μετατροπή OFT σε DOC χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε DOC" h2="Μετατρέψτε το OFT σε DOC εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
