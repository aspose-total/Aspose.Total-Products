---
title: Μετατροπή WORD σε XLT σε C++
description: C++ API για μετατροπή WORD σε XLT χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/word-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή WORD σε XLT" h2="Εξαγωγή WORD σε XLT μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
