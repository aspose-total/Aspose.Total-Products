---
title: Εξαγωγή OFT σε MD μέσω C++
description: C++ API για μετατροπή OFT σε MD χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-md/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε MD" h2="Μετατρέψτε το OFT σε MD εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API για Μετατροπή OFT σε MD" %}}
