---
title: Μετατροπή WORD σε DIF σε C++
description: C++ API για μετατροπή WORD σε DIF χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API για μετατροπή WORD σε DIF" h2="Εξαγωγή WORD σε DIF μέσω C++ χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
