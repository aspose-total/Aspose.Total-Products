---
title: C++ API για Μετατροπή PPSX σε DOCX
description: Εξαγωγή PPSX σε DOCX στις εφαρμογές σας C++
url: /el/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPSX σε DOCX" h2="Εξαγωγή PPSX σε DOCX σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
