---
title: Εξαγωγή OFT σε DOCM μέσω C++
description: C++ API για μετατροπή OFT σε DOCM χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε DOCM" h2="Μετατρέψτε το OFT σε DOCM εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
