---
title: Εξαγωγή EMAIL σε PDF μέσω C++
description: C++ API για μετατροπή EMAIL σε PDF χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/email-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή EMAIL σε PDF" h2="Μετατρέψτε το EMAIL σε PDF εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
