---
title: C++ API για Μετατροπή PPSX σε WORDML
description: Εξαγωγή PPSX σε WORDML στις εφαρμογές σας C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPSX σε WORDML" h2="Εξαγωγή PPSX σε WORDML σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
