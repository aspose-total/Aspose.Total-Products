---
title: C++ API για Μετατροπή PPS σε DOCX
description: Εξαγωγή PPS σε DOCX στις εφαρμογές σας C++
url: /el/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση PPS σε DOCX" h2="Εξαγωγή PPS σε DOCX σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
