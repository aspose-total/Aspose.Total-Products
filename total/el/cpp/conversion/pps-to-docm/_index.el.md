---
title: C++ API για Μετατροπή PPS σε DOCM
description: Εξαγωγή PPS σε DOCM στις εφαρμογές σας C++
url: /el/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
3. Φορτώστε το αρχείο HTML που έχει μετατραπεί χρησιμοποιώντας την αναφορά κλάσης [Docmument](https://reference.aspose.com/words/cpp/class/aspose.words.docmument)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/el/cpp/conversion/pps-to-docmx/" name="PPS Προς την DOCMX" description="" >}}
