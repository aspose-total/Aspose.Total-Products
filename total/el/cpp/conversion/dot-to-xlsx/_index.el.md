---
title: Μετατροπή DOT σε XLSX σε C++
description: C++ API για μετατροπή DOT σε XLSX χωρίς χρήση του Microsoft Word ή του Microsoft Excel
url: /el/cpp/conversion/dot-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
