---
title: C++ API για Μετατροπή POTX σε ODT
description: Εξαγωγή POTX σε ODT στις εφαρμογές σας C++
url: /el/cpp/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API για απόδοση POTX σε ODT" h2="Εξαγωγή POTX σε ODT σε εφαρμογές C++ χωρίς εξαρτήσεις Microsoft PowerPoint ή Word" >}}
