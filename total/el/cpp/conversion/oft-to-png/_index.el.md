---
title: Εξαγωγή OFT σε PNG μέσω C++
description: C++ API για μετατροπή OFT σε PNG χωρίς χρήση Microsoft Word ή Outlook
url: /el/cpp/conversion/oft-to-png/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API για εξαγωγή OFT σε PNG" h2="Μετατρέψτε το OFT σε PNG εντός της εφαρμογής C++ χωρίς να απαιτείται Microsoft Word ή Outlook" >}}
