---
title: Távolítsa el a DOT Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a DOT fájlból az online alkalmazáson keresztül..NET API kód a DOT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOT Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú DOT dokumentum annotációs segédprogram fejlesztése.A DOT fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Adott szerző DOT dokumentum megjegyzéseinek törlése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód: Adott szerzői megjegyzések törlése a DOT fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzés hozzáadása a DOT fájlból" offSpacer="" %}}
...
<h2>DOT dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a DOT-fájlok megjegyzéseivel" %}}
