---
title: Távolítsa el a XLSB Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a XLSB fájlból az online alkalmazáson keresztül..NET API kód a XLSB fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a XLSB Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú XLSB dokumentum annotációs segédprogram fejlesztése.A XLSB fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLSB megjegyzéseket a .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzések törlése a XLSB fájlból" offSpacer="" %}}
...
<h2>XLSB dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a XLSB-fájlok megjegyzéseivel" %}}
