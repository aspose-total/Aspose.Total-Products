---
title: Távolítsa el a DOTM Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a DOTM fájlból az online alkalmazáson keresztül..NET API kód a DOTM fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOTM Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú DOTM dokumentum annotációs segédprogram fejlesztése.A DOTM fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Adott szerző DOTM dokumentum megjegyzéseinek törlése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód: Adott szerzői megjegyzések törlése a DOTM fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzés hozzáadása a DOTM fájlból" offSpacer="" %}}
...
<h2>DOTM dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a DOTM-fájlok megjegyzéseivel" %}}
