---
title: Távolítsa el a DOCX Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a DOCX fájlból az online alkalmazáson keresztül..NET API kód a DOCX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOCX Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú DOCX dokumentum annotációs segédprogram fejlesztése.A DOCX fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Adott szerző DOCX dokumentum megjegyzéseinek törlése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód: Adott szerzői megjegyzések törlése a DOCX fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzés hozzáadása a DOCX fájlból" offSpacer="" %}}
...
<h2>DOCX dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a DOCX-fájlok megjegyzéseivel" %}}
