---
title: Távolítsa el a XLTX Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a XLTX fájlból az online alkalmazáson keresztül..NET API kód a XLTX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a XLTX Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú XLTX dokumentum annotációs segédprogram fejlesztése.A XLTX fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLTX megjegyzéseket a .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzések törlése a XLTX fájlból" offSpacer="" %}}
...
<h2>XLTX dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a XLTX-fájlok megjegyzéseivel" %}}
