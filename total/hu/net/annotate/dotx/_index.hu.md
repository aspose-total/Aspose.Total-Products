---
title: Távolítsa el a DOTX Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a DOTX fájlból az online alkalmazáson keresztül..NET API kód a DOTX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOTX Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú DOTX dokumentum annotációs segédprogram fejlesztése.A DOTX fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Adott szerző DOTX dokumentum megjegyzéseinek törlése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód: Adott szerzői megjegyzések törlése a DOTX fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzés hozzáadása a DOTX fájlból" offSpacer="" %}}
...
<h2>DOTX dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a DOTX-fájlok megjegyzéseivel" %}}
