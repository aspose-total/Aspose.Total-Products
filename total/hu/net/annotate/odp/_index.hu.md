---
title: Távolítsa el a ODP Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a ODP fájlból az online alkalmazáson keresztül..NET API kód a ODP fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a ODP online prezentációból vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú ODP prezentációs annotációs segédprogram fejlesztése.A ODP fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a ODP-bemutató megjegyzéseit a .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP-bemutató megjegyzések hozzáadása .NET-en keresztül" %}}
...
<h2>ODP dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a ODP-fájlok megjegyzéseivel" %}}
