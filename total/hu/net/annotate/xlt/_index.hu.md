---
title: Távolítsa el a XLT Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a XLT fájlból az online alkalmazáson keresztül..NET API kód a XLT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a XLT Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú XLT dokumentum annotációs segédprogram fejlesztése.A XLT fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLT megjegyzéseket a .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzések törlése a XLT fájlból" offSpacer="" %}}
...
<h2>XLT dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a XLT-fájlok megjegyzéseivel" %}}
