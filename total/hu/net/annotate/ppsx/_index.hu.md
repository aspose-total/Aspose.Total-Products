---
title: Távolítsa el a PPSX Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a PPSX fájlból az online alkalmazáson keresztül..NET API kód a PPSX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a PPSX online prezentációból vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú PPSX prezentációs annotációs segédprogram fejlesztése.A PPSX fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a PPSX megjegyzéseket online" %}}

1. Importáljon PPSX fájlt a megjegyzések feltöltésével való törléséhez
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a PPSX-bemutató megjegyzéseit a .NET-en keresztül" %}}

1. Adjon hozzá könyvtári hivatkozást a .NET projekthez
1. PPSX betöltése a Presentation class objektumon keresztül
1. Ismételje meg az egyes szerzőket a prezentáción keresztül. CommentAuthors
1. A megjegyzés törléséhez hívja meg a Comments.Clear() metódust
...
{{% blocks/products/pf/agp/code-block title="C# kód: Megjegyzések és szerzők törlése a PPSX prezentációból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PPSX-bemutató megjegyzések hozzáadása .NET-en keresztül" %}}

1. Adjon hozzá könyvtári hivatkozást a .NET projekthez
1. PPSX betöltése a Presentation class objektumon keresztül
1. Adjon hozzá egy üres diát az AddEmptySlide módszerrel
1. A CommentAuthors.AddAuthor használatával adja hozzá az új szerzőt
1. Használja az új szerzőt a Comments.AddComment elemmel a megjegyzés beszúrásához
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzések hozzáadása" offSpacer="" %}}
...
<h2>PPSX dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>

PPSX annotációs alkalmazást vagy segédprogramot kell fejlesztenie, hogy visszajelzést adjon, javaslatokat tegyen, vagy együttműködjön másokkal a dokumentumon?A [Aspose.Slides for .NET](https://products.aspose.com/slides/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot dokumentumannotációs alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-annotációs megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a PPSX formátumot.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a PPSX-fájlok megjegyzéseivel" %}}
