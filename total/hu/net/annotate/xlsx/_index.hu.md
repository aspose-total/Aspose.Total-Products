---
title: Távolítsa el a XLSX Annotation Online-t vagy kezelje a megjegyzéseket .NET-en keresztül
description: ingyenesen törölje a megjegyzéseket a XLSX fájlból az online alkalmazáson keresztül..NET API kód a XLSX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a XLSX Document Online szolgáltatásból, vagy kezelje a .NET-en keresztül" h2="Hatékony .NET alapú XLSX dokumentum annotációs segédprogram fejlesztése.A XLSX fájl megjegyzéseinek .NET-en keresztüli kezeléséhez felsorolt kód." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLSX megjegyzéseket online" %}}

1. Importáljon XLSX fájlt a megjegyzések feltöltésével való törléséhez
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLSX megjegyzéseket a .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Megjegyzések törlése a XLSX fájlból" offSpacer="" %}}
...
<h2>XLSX dokumentum-annotációs alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-könyvtár a XLSX-fájlok megjegyzéseivel" %}}
