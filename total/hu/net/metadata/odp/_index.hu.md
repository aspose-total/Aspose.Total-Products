---
title: Tekintse meg és frissítse a ODP tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a ODP tulajdonságait az online alkalmazáson keresztül. C# .NET API kód a ODP tulajdonságainak frissítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tekintse meg vagy frissítse a ODP metaadatokat online, vagy frissítse a .NET-en keresztül" h2="Hatékony .NET-alapú ODP dokumentum-metaadat-kezelő segédprogram fejlesztése.A felsorolt kód a ODP metaadatok .NET-en keresztüli frissítéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Frissítse a ODP tulajdonságait .NET-en keresztül" %}}

1. Prezentációs osztály objektum létrehozása
1. Szerezze be az összes tulajdonságot a DocumentProperties segítségével
1. Rendeljen hozzá új tulajdonságokat, például Szerző, Cím, Tárgy
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a ODP metaadatokat" offSpacer="" %}}
...
<h2>ODP metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

ODP metaadatkezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Slides for .NET](https://products.aspose.com/slides/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a ODP formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a ODP metaadatok kezelésére" %}}
