---
title: Tekintse meg és frissítse a ODT tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a ODT tulajdonságait az online alkalmazáson keresztül. C# .NET API kód a ODT tulajdonságok frissítéséhez és hozzáadásához.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tekintse meg vagy frissítse a ODT metaadatokat online, vagy frissítse a .NET-en keresztül" h2="Hatékony .NET-alapú ODT dokumentum-metaadat-kezelő segédprogram fejlesztése.A ODT fájl metaadatainak .NET-en keresztüli hozzáadásához és módosításához felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODT-tulajdonságok kezelése .NET-en keresztül" %}}
...
1. Hívja a Save() metódust a frissített ODT dokumentum mentéséhez.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a ODT metaadatokat" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: ODT egyéni tulajdonságok hozzáadása" offSpacer="" %}}
...
<h2>ODT metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

ODT metaadat-kezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a ODT formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a ODT metaadatok kezelésére" %}}
