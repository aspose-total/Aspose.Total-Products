---
title: Tekintse meg és frissítse a DOCX tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a DOCX tulajdonságait az online alkalmazáson keresztül.C# .NET API kód a DOCX tulajdonságainak frissítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tekintse meg vagy frissítse a DOCX metaadatokat online, vagy frissítse a .NET-en keresztül" h2="Hatékony .NET-alapú DOCX dokumentum-metaadat-kezelő segédprogram fejlesztése.A DOCX-fájl metaadatainak .NET-en keresztüli frissítéséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Frissítse a DOCX tulajdonságait .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a DOCX metaadatokat" offSpacer="" %}}
...
<h2>DOCX metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

DOCX metaadat-kezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Words for .NET](https://products.aspose.com/words/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a DOCX formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a DOCX metaadatok kezelésére" %}}
