---
title: Tekintse meg és frissítse a DOTX tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a DOTX tulajdonságait az online alkalmazáson keresztül.C# .NET API kód a DOTX tulajdonságainak frissítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tekintse meg vagy frissítse a DOTX metaadatokat online, vagy frissítse a .NET-en keresztül" h2="Hatékony .NET-alapú DOTX dokumentum-metaadat-kezelő segédprogram fejlesztése.A DOTX-fájl metaadatainak .NET-en keresztüli frissítéséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Frissítse a DOTX tulajdonságait .NET-en keresztül" %}}

1. DOTX fájl betöltése a Dokumentum osztály használatával.
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a DOTX metaadatokat" offSpacer="" %}}
...
<h2>DOTX metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

DOTX metaadat-kezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Words for .NET](https://products.aspose.com/words/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a DOTX formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a DOTX metaadatok kezelésére" %}}
