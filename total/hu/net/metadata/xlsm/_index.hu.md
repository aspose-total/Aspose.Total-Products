---
title: Tekintse meg és frissítse a XLSM tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a XLSM tulajdonságait az online alkalmazáson keresztül. C# .NET API kód a XLSM tulajdonságok frissítéséhez és hozzáadásához.
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM-tulajdonságok kezelése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a XLSM metaadatokat" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: XLSM egyéni tulajdonságok hozzáadása" offSpacer="" %}}
...
<h2>XLSM metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

XLSM metaadat-kezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a XLSM formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a XLSM metaadatok kezelésére" %}}
