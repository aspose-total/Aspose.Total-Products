---
title: Tekintse meg és frissítse a PPT tulajdonságait online, vagy frissítse a metaadatokat .NET használatával
description: Ingyenesen megtekintheti és módosíthatja a PPT tulajdonságait az online alkalmazáson keresztül. C# .NET API kód a PPT tulajdonságainak frissítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tekintse meg vagy frissítse a PPT metaadatokat online, vagy frissítse a .NET-en keresztül" h2="Hatékony .NET-alapú PPT dokumentum-metaadat-kezelő segédprogram fejlesztése.A felsorolt kód a PPT metaadatok .NET-en keresztüli frissítéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Frissítse a PPT tulajdonságait .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Frissítse a PPT metaadatokat" offSpacer="" %}}
...
<h2>PPT metaadatkezelő alkalmazás fejlesztése .NET-en keresztül</h2>

PPT metaadatkezelő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Slides for .NET](https://products.aspose.com/slides/hu/net/)-tal a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot dokumentum-metaadat-alkalmazásába.A hatékony .NET-könyvtár lehetővé teszi bármilyen dokumentum-metaadat-megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a PPT formátumot.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a PPT metaadatok kezelésére" %}}
