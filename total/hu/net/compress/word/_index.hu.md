---
title: Tömörítse a Word fájlokat online vagy .NET-en keresztül
description: Ingyenes online alkalmazás különböző Word fájlok tömörítésére.C# .NET tömörítési könyvtár kódja Word dokumentumokhoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Tömörítse a Word fájlt online a Compression App segítségével vagy a .NET használatával" h2="Hatékony .NET alapú Word dokumentumtömörítő alkalmazások fejlesztése.Szabadon tömöríthet különféle dokumentumokat, beleértve a Word fájlokat online, az alkalmazáson keresztül, azonnali letöltéssel." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Word fájl tömörítése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Word fájlok tömörítése" offSpacer="" %}}
...
<h2>Word fájltömörítő alkalmazás fejlesztése .NET használatával</h2>

.NET-szkriptet vagy segédprogramot kell fejlesztenie több Word-fájl egyszerű tömörítéséhez?A [Aspose.Total for .NET](https://products.aspose.com/total/net/) [Aspose.Words for .NET](https://products.aspose.com/words/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentumokon keresztüli tömörítőalkalmazások programozásához.A dokumentumtömörítéshez használható hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a Word formátumot is.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET tömörítési könyvtár Word fájlokhoz" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Könnyen kifejleszthető egy professzionális megoldás a Word fájlok tömörítésére .NET használatával.Használja az Aspose Word tömörítési API-t magas szintű, platformfüggetlen szoftverek fejlesztésére .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Start by uploading one or more files you want to compress. A Word fájlokat húzással vagy egyszerűen rákattinthatja a fehér területre.Ezután kattintson a "Tömörítés" gombra, és online tömörítő alkalmazásunk gyorsan feldolgozza a feltöltött fájlokat.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
