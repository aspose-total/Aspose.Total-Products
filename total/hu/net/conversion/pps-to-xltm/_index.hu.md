---
title: Konvertálja a PPS-ot XLTM-vé a C# segítségével
description: Konvertálja a PPS-ot XLTM-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPS-ot XLTM-vé a C# segítségével" h2=".NET API a PPS-ból XLTM-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
...
4. Mentse a dokumentumot XLTM-fájlba a [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) módszerrel
