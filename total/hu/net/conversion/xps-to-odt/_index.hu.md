...
description: A XPS konvertálása ODT-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/xps-to-odt/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése ODT-ben .NET-en keresztül" h2=".NET API a XPS exportálásához ODT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS ODT-má konvertálásához" %}}
