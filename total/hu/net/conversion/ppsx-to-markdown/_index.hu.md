---
title: Konvertálja a PPSX-ot MARKDOWN-vé a C# segítségével
description: Konvertálja a PPSX-ot MARKDOWN-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPSX-ot MARKDOWN-vé a C# segítségével" h2=".NET API a PPSX-ból MARKDOWN-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
...
1. Nyissa meg a PPSX-fájlt a [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation) osztály használatával
2. Exportálja a PPSX-ot HTML-ként a [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) módszerrel
