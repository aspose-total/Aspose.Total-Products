---
title: Konvertálja a PPSX-ot XLSM-vé a C# segítségével
description: Konvertálja a PPSX-ot XLSM-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPSX-ot XLSM-vé a C# segítségével" h2=".NET API a PPSX-ból XLSM-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
