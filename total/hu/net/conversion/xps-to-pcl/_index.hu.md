---
title: C# API a XPS exportálásához PCL-be
description: A XPS konvertálása PCL-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/xps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése PCL-ben .NET-en keresztül" h2=".NET API a XPS exportálásához PCL-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS PCL-má konvertálásához" %}}
