---
title: .NET API a DOC konvertálásához FODS-vé
description: C# API a DOC konvertálásához FODS-vé Microsoft Excel vagy Adobe Reader használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOC konvertálásához FODS-vé" h2="DOC exportálása FODS-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
2. Alakítsa át a DOC-t HTML-vé a [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) módszerrel
