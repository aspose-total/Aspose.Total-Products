---
title: C# API a PS exportálásához DOCM-be
description: A PS konvertálása DOCM-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/ps-to-docm/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése DOCM-ben .NET-en keresztül" h2=".NET API a PS exportálásához DOCM-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS DOCM-má konvertálásához" %}}
