...
description: A MD konvertálása GIF-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/md-to-gif/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="MD megjelenítése GIF-ben .NET-en keresztül" h2=".NET API a MD exportálásához GIF-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a MD GIF-má konvertálásához" %}}
1. Nyissa meg a MD-fájlt a [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document) osztály használatával
2. Konvertálja a MD-et dokumentummá a [Save](https://apireference.aspose.com/pdf/net/aspose.pdf.document/save/methods/5) módszerrel
