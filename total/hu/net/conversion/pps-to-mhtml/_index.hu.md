---
title: Konvertálja a PPS-ot MHTML-vé a C# segítségével
description: Konvertálja a PPS-ot MHTML-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPS-ot MHTML-vé a C# segítségével" h2=".NET API a PPS-ból MHTML-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
...
1. Nyissa meg a PPS-fájlt a [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation) osztály használatával
2. Exportálja a PPS-ot HTML-ként a [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) módszerrel
...
4. Mentse a dokumentumot MHTML-fájlba a [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) módszerrel
