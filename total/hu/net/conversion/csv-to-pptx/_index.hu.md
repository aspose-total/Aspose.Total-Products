---
title: A CSV konvertálása PPTX formátumba .NET segítségével 
description: A CSV konvertálása PPTX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
url: /hu/net/conversion/csv-to-pptx/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A CSV konvertálása PPTX formátumba C# segítségével" h2="Exportálás Excel&reg; CSV-ből PPTX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
