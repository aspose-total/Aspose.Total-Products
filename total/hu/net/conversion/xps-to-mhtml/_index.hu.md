---
title: C# API a XPS exportálásához MHTML-be
description: A XPS konvertálása MHTML-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/xps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése MHTML-ben .NET-en keresztül" h2=".NET API a XPS exportálásához MHTML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS MHTML-má konvertálásához" %}}
