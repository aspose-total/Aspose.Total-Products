---
title: Konvertálja a POTX-ot DIF-vé a C# segítségével
description: Konvertálja a POTX-ot DIF-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POTX-ot DIF-vé a C# segítségével" h2=".NET API a POTX-ból DIF-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
...
4. Mentse a dokumentumot DIF-fájlba a [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) módszerrel
