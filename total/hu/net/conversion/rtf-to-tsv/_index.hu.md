---
title: .NET API a RTF konvertálásához TSV-vé vagy ingyenes online konverterrel
description: C# API a RTF konvertálásához TSV-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes RTF-TSV online konvertert. 
url_ignore: /hu/net/conversion/rtf-to-tsv/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a RTF konvertálásához TSV-vé vagy Online App" h2="RTF exportálása TSV-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
