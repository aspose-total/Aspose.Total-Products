---
title: Konvertálja a PPTX-ot XLS-vé a C# segítségével
description: Konvertálja a PPTX-ot XLS-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPTX-ot XLS-vé a C# segítségével" h2=".NET API a PPTX-ból XLS-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
