---
title: .NET API a DOCM konvertálásához FODS-vé vagy ingyenes online konverterrel
description: C# API a DOCM konvertálásához FODS-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOCM-FODS online konvertert. 
url_ignore: /hu/net/conversion/docm-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOCM konvertálásához FODS-vé vagy Online App" h2="DOCM exportálása FODS-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
