---
title: A XLTM konvertálása DOCX formátumba .NET segítségével 
description: A XLTM konvertálása DOCX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLTM konvertálása DOCX formátumba C# segítségével" h2="Exportálás Excel&reg; XLTM-ből DOCX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
