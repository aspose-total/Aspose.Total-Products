...
{{< blocks/products/pf/i18n/feature-page-header h1="SVG megjelenítése OTT-ben .NET-en keresztül" h2=".NET API a SVG exportálásához OTT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
