---
title: A FODS konvertálása PPTX formátumba .NET segítségével 
description: A FODS konvertálása PPTX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
url: /hu/net/conversion/fods-to-pptx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A FODS konvertálása PPTX formátumba C# segítségével" h2="Exportálás Excel&reg; FODS-ből PPTX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
