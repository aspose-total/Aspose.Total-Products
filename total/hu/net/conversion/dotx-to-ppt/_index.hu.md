---
title: A DOTX konvertálása PPT-re C# .NET-en keresztül 
url: /hu/net/conversion/dotx-to-ppt/ 
...
// To convert multi pages DOTX dotxuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to PPT.
