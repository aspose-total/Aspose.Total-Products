---
title: C# API a TEX exportálásához ODT-be
description: A TEX konvertálása ODT-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/tex-to-odt/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="TEX megjelenítése ODT-ben .NET-en keresztül" h2=".NET API a TEX exportálásához ODT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a TEX ODT-má konvertálásához" %}}
