---
title: A XLSB konvertálása WORD formátumba .NET segítségével 
description: A XLSB konvertálása WORD formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLSB konvertálása WORD formátumba C# segítségével" h2="Exportálás Excel&reg; XLSB-ből WORD-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
