---
title: C# API a XPS exportálásához WORDML-be
description: A XPS konvertálása WORDML-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/xps-to-wordml/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése WORDML-ben .NET-en keresztül" h2=".NET API a XPS exportálásához WORDML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS WORDML-má konvertálásához" %}}
