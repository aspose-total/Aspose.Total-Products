---
title: A XLS konvertálása PPTX formátumba .NET segítségével 
description: A XLS konvertálása PPTX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLS konvertálása PPTX formátumba C# segítségével" h2="Exportálás Excel&reg; XLS-ből PPTX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
