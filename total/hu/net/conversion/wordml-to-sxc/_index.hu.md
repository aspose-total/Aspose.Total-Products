---
title: .NET API a WORDML konvertálásához SXC-vé vagy ingyenes online konverterrel
description: C# API a WORDML konvertálásához SXC-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes WORDML-SXC online konvertert. 
url_ignore: /hu/net/conversion/wordml-to-sxc/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a WORDML konvertálásához SXC-vé vagy Online App" h2="WORDML exportálása SXC-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
