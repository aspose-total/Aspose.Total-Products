---
title: A XLSX konvertálása DOC formátumba .NET segítségével 
description: A XLSX konvertálása DOC formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLSX konvertálása DOC formátumba C# segítségével" h2="Exportálás Excel&reg; XLSX-ből DOC-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
