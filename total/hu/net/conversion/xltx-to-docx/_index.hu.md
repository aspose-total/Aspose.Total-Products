---
title: A XLTX konvertálása DOCX formátumba .NET segítségével 
description: A XLTX konvertálása DOCX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLTX konvertálása DOCX formátumba C# segítségével" h2="Exportálás Excel&reg; XLTX-ből DOCX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
