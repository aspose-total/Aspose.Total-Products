---
title: .NET API a DOCX konvertálásához XLTX-vé vagy ingyenes online konverterrel
description: C# API a DOCX konvertálásához XLTX-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOCX-XLTX online konvertert. 
url_ignore: /hu/net/conversion/docx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOCX konvertálásához XLTX-vé vagy Online App" h2="DOCX exportálása XLTX-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
