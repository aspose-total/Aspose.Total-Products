---
title: A CSV konvertálása POWERPOINT formátumba .NET segítségével 
description: A CSV konvertálása POWERPOINT formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
url: /hu/net/conversion/csv-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A CSV konvertálása POWERPOINT formátumba C# segítségével" h2="Exportálás Excel&reg; CSV-ből POWERPOINT-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
