...
description: A PS konvertálása MARKDOWN-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/ps-to-markdown/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése MARKDOWN-ben .NET-en keresztül" h2=".NET API a PS exportálásához MARKDOWN-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS MARKDOWN-má konvertálásához" %}}
