---
title: C# API a SVG exportálásához MHTML-be
description: A SVG konvertálása MHTML-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/svg-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="SVG megjelenítése MHTML-ben .NET-en keresztül" h2=".NET API a SVG exportálásához MHTML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a SVG MHTML-má konvertálásához" %}}
