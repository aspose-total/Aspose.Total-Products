---
title: .NET API a DOT konvertálásához EXCEL-vé vagy ingyenes online konverterrel
description: C# API a DOT konvertálásához EXCEL-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOT-EXCEL online konvertert. 
url_ignore: /hu/net/conversion/dot-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOT konvertálásához EXCEL-vé vagy Online App" h2="DOT exportálása EXCEL-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
