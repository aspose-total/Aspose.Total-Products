---
title: .NET API a DOC konvertálásához CSV-vé vagy ingyenes online konverterrel
description: C# API a DOC konvertálásához CSV-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOC-CSV online konvertert. 
url_ignore: /hu/net/conversion/doc-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOC konvertálásához CSV-vé vagy Online App" h2="DOC exportálása CSV-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
