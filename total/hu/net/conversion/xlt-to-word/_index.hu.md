...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLT konvertálása WORD formátumba C# segítségével" h2="Exportálás Excel&reg; XLT-ből WORD-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
