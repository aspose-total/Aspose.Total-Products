...
description: A MD konvertálása MARKDOWN-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/md-to-markdown/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="MD megjelenítése MARKDOWN-ben .NET-en keresztül" h2=".NET API a MD exportálásához MARKDOWN-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a MD MARKDOWN-má konvertálásához" %}}
