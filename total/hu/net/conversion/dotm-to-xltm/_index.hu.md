---
title: .NET API a DOTM konvertálásához XLTM-vé
description: C# API a DOTM konvertálásához XLTM-vé Microsoft Excel vagy Adobe Reader használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOTM konvertálásához XLTM-vé" h2="DOTM exportálása XLTM-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
1. Nyissa meg a DOTM-fájlt a [Dotmument](https://apireference.aspose.com/words/net/aspose.words/dotmument) osztály használatával
2. Alakítsa át a DOTM-t HTML-vé a [Save](https://apireference.aspose.com/words/net/aspose.words.dotmument/save/methods/4) módszerrel
...
4. Mentse a dokumentumot XLTM-formátumba a [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) metódussal, és állítsa be a „XLTM”-t SaveFormat-ként.
