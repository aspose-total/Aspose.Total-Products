...
description: C# API a DOC konvertálásához DIF-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOC-DIF online konvertert. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOC konvertálásához DIF-vé vagy Online App" h2="DOC exportálása DIF-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
