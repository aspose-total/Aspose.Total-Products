---
title: A XLS konvertálása WORD formátumba .NET segítségével 
description: A XLS konvertálása WORD formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
url: /hu/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLS konvertálása WORD formátumba C# segítségével" h2="Exportálás Excel&reg; XLS-ből WORD-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
