...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="A SXC konvertálása DOC formátumba C# segítségével vagy Online App" h2="Exportálás Excel<sup>&reg;</sup> SXC-ből DOC-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
