---
title: .NET API a DOCM konvertálásához XLS-vé vagy ingyenes online konverterrel
description: C# API a DOCM konvertálásához XLS-vé vagy Online App Microsoft Excel vagy Adobe Reader használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOCM-XLS online konvertert. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOCM konvertálásához XLS-vé vagy Online App" h2="DOCM exportálása XLS-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
