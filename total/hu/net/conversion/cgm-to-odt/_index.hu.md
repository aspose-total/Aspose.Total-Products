---
title: C# API a CGM exportálásához ODT-be
description: A CGM konvertálása ODT-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/cgm-to-odt/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="CGM megjelenítése ODT-ben .NET-en keresztül" h2=".NET API a CGM exportálásához ODT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a CGM ODT-má konvertálásához" %}}
