---
title: C# API a CGM exportálásához PS-be
description: A CGM konvertálása PS-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/cgm-to-ps/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="CGM megjelenítése PS-ben .NET-en keresztül" h2=".NET API a CGM exportálásához PS-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a CGM PS-má konvertálásához" %}}
