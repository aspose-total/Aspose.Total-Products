---
title: A XLTX konvertálása PPTX formátumba .NET segítségével 
description: A XLTX konvertálása PPTX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLTX konvertálása PPTX formátumba C# segítségével" h2="Exportálás Excel&reg; XLTX-ből PPTX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
