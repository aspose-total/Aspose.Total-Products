---
title: Konvertálja a POTM-ot SXC-vé a C# segítségével
description: Konvertálja a POTM-ot SXC-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POTM-ot SXC-vé a C# segítségével" h2=".NET API a POTM-ból SXC-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
