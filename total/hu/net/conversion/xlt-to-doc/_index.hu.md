...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="A XLT konvertálása DOC formátumba C# segítségével vagy Online App" h2="Exportálás Excel&reg; XLT-ből DOC-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
