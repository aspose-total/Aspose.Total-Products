---
title: Konvertálja a XSLFO-et TXT-vé a C# API-n keresztül
description: C# API a XSLFO-fájlok TXT-vé konvertálásához Microsoft Excel vagy Adobe Reader használata nélkül
url_ignore: /hu/net/conversion/xslfo-to-txt/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a XSLFO TXT formátumban való megjelenítéséhez" h2="XSLFO-fájl exportálása TXT-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Excel vagy Adobe<sup>&reg;</sup> Acrobat Reader használata nélkül" >}}

{{% blocks/products/pf/feature-page-summary %}}
Az [Aspose.Total for .NET](https://products.aspose.com/total/net/) használatával könnyedén konvertálhat XSLFO-fájlt TXT-formátumba bármely .NET-, C#-, ASP.NET- és VB.NET-alkalmazáson belül. Először is, az [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) használatával exportálhatja a XSLFO-et XLSX formátumba. Ezt követően az [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API használatával konvertálhatja az XLSX-et TXT-vé.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API a XSLFO TXT-vé alakításához" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Védett XSLFO konvertálása TXT-vé C#-on keresztül" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertálja a XSLFO fájlt TXT-vé vízjellel a C# segítségével" %}}
A XSLFO-fájl TXT-vé konvertálásakor vízjelet is hozzáadhat a kimeneti TXT-fájlformátumhoz. Vízjel hozzáadásához létrehozhat egy új munkafüzet-objektumot, megnyithatja az átalakított XLSX-dokumentumot, indexén keresztül kiválaszthatja a Munkalapot, létrehozhat egy alakzatot, és használhatja annak AddTextEffect funkcióját. Ezt követően elmentheti az XLSX-dokumentumot TXT-ként vízjellel. 
{{% blocks/products/pf/feature-page-code %}}
