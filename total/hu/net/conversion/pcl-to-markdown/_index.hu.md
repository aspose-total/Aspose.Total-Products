---
title: C# API a PCL exportálásához MARKDOWN-be
description: A PCL konvertálása MARKDOWN-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/pcl-to-markdown/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="PCL megjelenítése MARKDOWN-ben .NET-en keresztül" h2=".NET API a PCL exportálásához MARKDOWN-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PCL MARKDOWN-má konvertálásához" %}}
