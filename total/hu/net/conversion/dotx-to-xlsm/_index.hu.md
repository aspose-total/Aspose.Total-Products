...
description: C# API a DOTX konvertálásához XLSM-vé Microsoft Excel vagy Adobe Reader használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOTX konvertálásához XLSM-vé" h2="DOTX exportálása XLSM-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
