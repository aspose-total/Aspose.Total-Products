---
title: A SXC konvertálása POWERPOINT formátumba .NET segítségével vagy ingyenes online konverterrel
description: A SXC konvertálása POWERPOINT formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes SXC-POWERPOINT online konvertert.
...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="A SXC konvertálása POWERPOINT formátumba C# segítségével vagy Online App" h2="Exportálás Excel<sup>&reg;</sup> SXC-ből POWERPOINT-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="SXC-ből POWERPOINT-ba konvertálás .NET-en" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# kód a SXC-ből POWERPOINT-ba való konvertáláshoz" gistPath="" %}}
```cs
