---
title: A SXC konvertálása POWERPOINT formátumba .NET segítségével 
description: A SXC konvertálása POWERPOINT formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
url: /hu/net/conversion/sxc-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A SXC konvertálása POWERPOINT formátumba C# segítségével" h2="Exportálás Excel&reg; SXC-ből POWERPOINT-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
