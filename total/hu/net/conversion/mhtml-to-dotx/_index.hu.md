---
title: C# API a MHTML exportálásához DOTX-be
description: A MHTML konvertálása DOTX-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/mhtml-to-dotx/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="MHTML megjelenítése DOTX-ben .NET-en keresztül" h2=".NET API a MHTML exportálásához DOTX-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a MHTML DOTX-má konvertálásához" %}}
