---
title: A XLS konvertálása DOCX formátumba .NET segítségével 
description: A XLS konvertálása DOCX formátumba .NET Framework, .NET Core, Mono vagy Xamarin platformokon
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="A XLS konvertálása DOCX formátumba C# segítségével" h2="Exportálás Excel&reg; XLS-ből DOCX-ba .NET Framework, .NET Core, Mono vagy Xamarin platformokon">}}
