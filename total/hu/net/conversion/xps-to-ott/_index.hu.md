...
description: A XPS konvertálása OTT-re Microsoft Word használata nélkül
url_ignore: /hu/net/conversion/xps-to-ott/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése OTT-ben .NET-en keresztül" h2=".NET API a XPS exportálásához OTT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS OTT-má konvertálásához" %}}
