---
title: Egyesítse a ODP fájlokat online vagy .NET használatával
description: Ingyenes online alkalmazás különböző ODP prezentációk kombinálásához.A C# .NET könyvtárkód egyesítése a ODP prezentáció tetszőleges formátumba való egyesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Egyesítse a ODP dokumentumokat online a Merger App segítségével vagy a .NET használatával" h2="Hatékony .NET alapú ODP dokumentum-egyesítő alkalmazás fejlesztése.Egyesítsen több ODP dokumentumot egyetlen online alkalmazásban ingyenesen.Mentse az egyesített ODP fájlt PDF, Képek, Word, Excel, PowerPoint és sok más online formátumban." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP fájl egyesítése .NET-en keresztül" %}}

1. A ODP betöltése a Presentation class objektum használatával
...
{{% blocks/products/pf/agp/code-block title=".NET kód: ODP fájlok egyesítése" offSpacer="" %}}
...
<h2>ODP fájlegyesítés fejlesztése .NET használatával</h2>

Ki kell fejlesztenie a .NET egyesítő segédprogramot több ODP fájl egyszerű egyesítéséhez?A [Aspose.Slides for .NET](https://products.aspose.com/slides/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentumok egyszerű összefűzéséhez.A dokumentumok egyesítésére szolgáló hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a ODP formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET egyesítő könyvtár ODP fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Könnyen kifejleszthető egy professzionális megoldás a ODP kombinálására .NET használatával. Használja a ODP egyesítő API-t magas szintű, platformfüggetlen szoftverek fejlesztéséhez a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
