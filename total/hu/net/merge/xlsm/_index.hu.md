---
title: Egyesítse a XLSM fájlokat online vagy .NET használatával
description: Ingyenes online alkalmazás különböző XLSM fájlok kombinálásához.C# .NET összevonó könyvtárkód a XLSM munkalapok más formátumokba való egyesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Egyesítse a XLSM dokumentumokat online a Merger App segítségével vagy a .NET használatával" h2="Hatékony .NET alapú XLSM dokumentum-egyesítő alkalmazás fejlesztése.Egyesítsen több XLSM dokumentumot egyetlen online alkalmazásban ingyenesen.Mentse az egyesített XLSM fájlt PDF, Képek, Word, Excel, PowerPoint és sok más online formátumban." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSM fájl egyesítése .NET-en keresztül" %}}

1. Mindkét XLSM betöltése munkafüzet osztályobjektumokkal.
1. Válassza ki az egy munkafüzetet alapfájlként.
1. Használja a Combine metódust az alapobjektum és a második XLSM fájlobjektum paraméterként történő használatával.
1. Hívja a Mentés metódust, és töltse be az egyesített XLSM fájlokat egybe.
...
{{% blocks/products/pf/agp/code-block title=".NET kód: XLSM fájlok egyesítése" offSpacer="" %}}
...
<h2>XLSM fájlegyesítés fejlesztése .NET használatával</h2>

Ki kell fejlesztenie a .NET segédprogramot több XLSM-fájl egyszerű egyesítéséhez?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentumok egyszerű összefűzéséhez.A dokumentumok egyesítésére szolgáló hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a XLSM formátumot is.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET egyesítő könyvtár a XLSM fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Professzionális megoldást lehet kifejleszteni a XLSM kombinálására .NET használatával.Használja a XLSM egyesítő API-t magas szintű, platformfüggetlen szoftverek fejlesztéséhez a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
