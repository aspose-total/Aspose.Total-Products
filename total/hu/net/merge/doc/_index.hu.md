---
title: Egyesítse a DOC fájlokat online vagy .NET használatával
description: Ingyenes online alkalmazás különböző DOC fájlok kombinálásához..NET egyesítő könyvtárkód a DOC dokumentumok egyesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Egyesítse a DOC dokumentumokat online a Merger App segítségével vagy a .NET használatával" h2="Hatékony .NET alapú DOC dokumentum-egyesítő alkalmazás fejlesztése.Egyesítsen több DOC dokumentumot egyetlen online alkalmazásban ingyenesen.Mentse a DOC fájlt PDF, képek, Word, Excel, PowerPoint és sok más formátumban online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOC fájl egyesítése .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: DOC fájlok egyesítése" offSpacer="" %}}
...
<h2>DOC fájlegyesítés fejlesztése .NET használatával</h2>

Ki kell fejlesztenie a .NET segédprogramot több DOC-fájl egyszerű egyesítéséhez?A [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) [Aspose.Words for .NET](https://products.aspose.com/words/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentumok egyesítő alkalmazásainak programozásához.A dokumentumok egyesítésére szolgáló hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a DOC formátumot is.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library a DOC fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Könnyen kifejleszthető egy professzionális megoldás a DOC kombinálására .NET használatával.Használja az Aspose DOC egyesítő API-t magas szintű, platformfüggetlen szoftverek fejlesztéséhez a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
