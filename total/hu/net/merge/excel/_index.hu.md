---
title: Egyesítse a Excel fájlokat online vagy .NET használatával
description: Ingyenes online alkalmazás különböző Excel fájlok kombinálásához.C# .NET összevonó könyvtárkód a Excel munkalapok más formátumokba való egyesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Egyesítse a Excel dokumentumokat online a Merger App segítségével vagy a .NET használatával" h2="Hatékony .NET alapú Excel dokumentum-egyesítő alkalmazás fejlesztése.Egyesítsen több Excel dokumentumot egyetlen online alkalmazásban ingyenesen.Mentse az egyesített Excel fájlt PDF, Képek, Word, Excel, PowerPoint és sok más online formátumban." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Egyesítse a Excel fájlokat online az alkalmazás segítségével" %}}
...
1. Tekintse meg és szerezze be az egyetlen egyesített Excel fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Excel fájl egyesítése .NET-en keresztül" %}}

1. Mindkét Excel betöltése munkafüzet osztályobjektumokkal.
1. Válassza ki az egy munkafüzetet alapfájlként.
1. Használja a Combine metódust az alapobjektum és a második Excel fájlobjektum paraméterként történő használatával.
1. Hívja a Mentés metódust, és töltse be az egyesített Excel fájlokat egybe.
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Excel fájlok egyesítése" offSpacer="" %}}
...
<h2>Excel fájlegyesítés fejlesztése .NET használatával</h2>

Ki kell fejlesztenie a .NET segédprogramot több Excel-fájl egyszerű egyesítéséhez?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a dokumentumok egyszerű összefűzéséhez.A dokumentumok egyesítésére szolgáló hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a Excel formátumot is.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET egyesítő könyvtár a Excel fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Professzionális megoldást lehet kifejleszteni a Excel kombinálására .NET használatával.Használja a Excel egyesítő API-t magas szintű, platformfüggetlen szoftverek fejlesztéséhez a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
