---
title: XLTX fájl megtekintése online és .NET használatával
description: Ingyenes online XLTX fájlnézegető alkalmazás. .NET API C# kód a XLTX fájl olvasásához a megjelenítő alkalmazás számára.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ingyenesen megtekintheti a XLTX fájlt online vagy .NET-en keresztül" h2="Hatékony .NET alapú XLTX dokumentumnézegető segédprogram fejlesztése. C# kód szerepel a XLTX dokumentum megtekintéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLTX fájl megtekintése .NET-en keresztül" %}}

1. Adja hozzá a .NET könyvtár hivatkozását a projekthez
1. Forrás XLTX fájl betöltése munkafüzet osztályobjektum használatával
...
{{% blocks/products/pf/agp/code-block title="C# kód: XLTX táblázatok megtekintése" offSpacer="" %}}
...
<h2>XLTX fájlnézegető alkalmazás fejlesztése .NET-en keresztül</h2>

XLTX megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/) a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával minden .NET-fejlesztő integrálhatja a fenti API-kódot a táblázatkezelő alkalmazásába.A nagy teljesítményű .NET könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a XLTX formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram a XLTX fájl feldolgozásához a megjelenítési alkalmazáshoz" %}}
