---
title: Távolítsa el a XLSX jelszóvédelmet online vagy .NET használatával
description: Ingyenesen távolítsa el a jelszót a XLSX dokumentumból az online alkalmazáson keresztül..NET C# API kód a jelszóval védett XLSX fájlok feloldásához.
...
{{< blocks/products/pf/feature-page-header-widget h1="Oldja fel a XLSX dokumentumjelszót online vagy .NET-en keresztül" h2="Hatékony .NET alapú XLSX dokumentumok zárolására és feloldására szolgáló segédprogramok fejlesztése.A XLSX fájlból a .NET-en keresztüli jelszókorlátozások eltávolításához felsorolt kód." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Oldja fel a XLSX jelszót online" %}}

1. Importáljon XLSX fájlt a feloldáshoz a feltöltéssel.
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a XLSX jelszót a .NET-en keresztül" %}}

1. Töltsön be jelszóval védett XLSX fájlt a Workbook osztály segítségével
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Jelszó eltávolítása a XLSX dokumentumból" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Biztonságos az online alkalmazás használata a XLSX dokumentum eltávolításához?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bármilyen modern webböngészőt használhat, például a Google Chrome-ot, a Firefoxot, az Opera-t vagy a Safarit a XLSX dokumentumok online feloldásához.Ha azonban asztali alkalmazást fejleszt, javasoljuk az Aspose.Total dokumentumfeldolgozási API használatát a hatékony kezelés érdekében.</span>
                      </div>
                  </li>
              </ul>
          </div>
