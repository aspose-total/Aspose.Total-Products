---
title: Vízjel ODP fájl online vagy .NET használatával
description: Ingyenes online alkalmazás különböző ODP fájlok vízjelezéséhez. .NET vízjelkönyvtár C# kód ODP prezentációkhoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Watermark ODP File Online keresztül Watermarking App és a .NET alkalmazások" h2="Hatékony .NET alapú ODP prezentációs vízjel-alkalmazások fejlesztése.Ingyenesen vízjelezhet különféle dokumentumokat, beleértve a ODP prezentációt online alkalmazáson keresztül, azonnali letöltéssel." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Vízjel ODP bemutató online az alkalmazás segítségével" %}}

1. Töltsön fel ODP fájlokat a Watermarkba
1. Írja be a vízjel szövegét
1. Válassza ki a megfelelő színt
1. Kattintson a "Vízjel" gombra
1. Töltse le a Watermarked ODP fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Vízjel ODP fájl .NET-en keresztül" %}}

1. Hozzon létre bemutató osztály objektumot
1. Válassza ki a diát
1. Válasszon alakzatot az AddAutoShape segítségével, és kapjon vízjelképet az Images.AddImage segítségével
1. Rendelje hozzá a megfelelő vízjel paramétereket
1. Szöveges vízjelhez használja az AddTextFrame-et
1. Hívja a Mentés metódust, és szerezze be a Watermarked ODP fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: szöveges vízjel ODP fájlok" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "add-text-watermark-in-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# kód: Kép vízjel hozzáadása a ODP fájlokhoz" offSpacer="" %}}
...
<h2>ODP fájl vízjelező alkalmazás fejlesztése .NET használatával</h2>

.NET-alkalmazást kell fejlesztenie több ODP-fájl egyszerű vízjelezéséhez?A [Aspose.Slides for .NET](https://products.aspose.com/slides/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot, hogy vízjel-alkalmazást programozzon a prezentációk között.A prezentációk vízjelezéséhez használható hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a ODP formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Watermark Library ODP fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. A Watermark ODP fájlhoz egyszerűen professzionális megoldást fejleszthetünk ki .NET használatával.Az Aspose ODP Watermarking API segítségével magas szintű, platformfüggetlen szoftvereket fejleszthet a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Biztonságos az online alkalmazás használata több ODP dokumentum vízjelezésére?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bármilyen modern webböngészőt használhat, például a Google Chrome-ot, a Firefoxot, az Opera-t vagy a Safarit az online ODP dokumentumok vízjelezéséhez.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hogyan lehet több ODP fájlt vízjelezni?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Kezdje azzal, hogy töltsön fel egy vagy több fájlt, amelyet vízjelbe szeretne helyezni. A ODP fájlokat húzással vagy egyszerűen rákattinthatja a fehér területre.Ezután kattintson a „Vízjel” gombra, és online Vízjel alkalmazásunk gyorsan feldolgozza a feltöltött fájlokat.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Mennyi ideig tart a ODP fájlok vízjellel való megjelölése?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
