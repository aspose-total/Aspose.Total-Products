---
title: Vízjel PDF fájlok online vagy .NET használatával
description: Ingyenes online alkalmazás különböző PDF fájlok vízjelezéséhez. .NET vízjelkönyvtár C# kód PDF dokumentumokhoz.
...
{{% blocks/products/pf/agp/feature-section-col title="Vízjel PDF fájl .NET-en keresztül" %}}

1. Töltse be a PDF dokumentumot a Dokumentum osztály használatával
1. Hozzon létre WatermarkArtifact objektumot
1. Használja a műterméket olyan tulajdonságok hozzárendeléséhez, mint a SetTextAndState és egyebek
1. Hívja a Mentés metódust, és szerezze be a Watermarked PDF fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: Vízjel PDF fájlok" offSpacer="" %}}
...
<h2>PDF fájl vízjelező alkalmazás fejlesztése .NET használatával</h2>

.NET-szkriptet vagy segédprogramot kell fejlesztenie több PDF-fájl egyszerű vízjelezéséhez?A [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) [Aspose.PDF for .NET](https://products.aspose.com/pdf/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a vízjel alkalmazás programozásához a dokumentumok között.Hatékony .NET-könyvtár a dokumentumok vízjelezéséhez számos népszerű formátumot támogat, beleértve a PDF formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Watermark Library PDF fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. A Watermark PDF fájlhoz könnyen professzionális megoldást lehet fejleszteni .NET használatával.Az Aspose PDF Watermarking API segítségével magas szintű, platformfüggetlen szoftvereket fejleszthet a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
