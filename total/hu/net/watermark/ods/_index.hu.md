---
title: Vízjel ODS fájl online vagy .NET használatával
description: Ingyenes online alkalmazás különböző ODS fájlok vízjelezéséhez. .NET vízjelkönyvtár C# kód ODS munkalapokhoz.
...
{{% blocks/products/pf/agp/feature-section-col title="Vízjel ODS fájl .NET-en keresztül" %}}

1. Töltsön be ODS fájlt a Workbook osztály segítségével
1. Válassza ki a megfelelő lapot
1. Hozzon létre vízjelet az új alakzat használatával a munkalapon
1. Rendelje hozzá a megfelelő szövegtulajdonságokat
1. Zárja le az alakzatot, és állítson be más zártípusokat
1. Hívja a Mentés metódust, és szerezze be a Watermarked ODS fájlt.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: Vízjel ODS fájl" offSpacer="" %}}
...
<h2>ODS fájl vízjelező alkalmazás fejlesztése .NET használatával</h2>

.NET-szkriptet vagy segédprogramot kell fejlesztenie több ODS-fájl egyszerű vízjelezéséhez?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot, hogy vízjel alkalmazást programozzon a dokumentumokon. Erőteljes .NET-könyvtár dokumentumokhoz A vízjelezés számos népszerű formátumot támogat, beleértve a ODS formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Watermarking Library ODS fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. A Watermark ODS fájlhoz egyszerűen professzionális megoldást fejleszthetünk ki .NET használatával.Az Aspose ODS Watermarking API segítségével magas szintű, platformfüggetlen szoftvereket fejleszthet a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
