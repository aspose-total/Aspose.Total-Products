---
title: Vízjel PPT fájl online vagy .NET használatával
description: Ingyenes online alkalmazás különböző PPT fájlok vízjelezéséhez. .NET vízjelkönyvtár C# kód PPT prezentációkhoz.
...
{{% blocks/products/pf/agp/feature-section-col title="Vízjel PPT fájl .NET-en keresztül" %}}
...
1. Hívja a Mentés metódust, és szerezze be a Watermarked PPT fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: szöveges vízjel PPT fájlok" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "add-text-watermark-in-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# kód: Kép vízjel hozzáadása a PPT fájlokhoz" offSpacer="" %}}
...
<h2>PPT fájl vízjelező alkalmazás fejlesztése .NET használatával</h2>

.NET-alkalmazást kell fejlesztenie több PPT-fájl egyszerű vízjelezéséhez?A [Aspose.Slides for .NET](https://products.aspose.com/slides/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot, hogy vízjel-alkalmazást programozzon a prezentációk között.A prezentációk vízjelezéséhez használható hatékony .NET-könyvtár számos népszerű formátumot támogat, beleértve a PPT formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Watermark Library PPT fájlokhoz" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. A Watermark PPT fájlhoz egyszerűen professzionális megoldást fejleszthetünk ki .NET használatával.Az Aspose PPT Watermarking API segítségével magas szintű, platformfüggetlen szoftvereket fejleszthet a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
