---
title: ODS fájl felosztása online vagy .NET-en keresztül
description: Ingyenes online alkalmazás különböző ODS lapok felosztásához..NET C# splitter könyvtár kódja ODS táblázatokhoz.
...
{{% blocks/products/pf/agp/feature-section-col title="ODS fájl felosztása .NET-en keresztül" %}}

1. ODS fájl betöltése munkafüzet osztály segítségével
1. Szerezd meg az aktív cellát
1. A munkalap ablak felosztása
1. Hívja a Save() metódust a fájl mentéséhez

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód: ODS fájlok felosztása" offSpacer="" %}}
...
<h2>ODS fájlelosztó alkalmazás fejlesztése .NET használatával</h2>

.NET-szkriptet vagy segédprogramot kell fejlesztenie a ODS-fájlok egyszerű felosztásához?A [Aspose.Cells for .NET](https://products.aspose.com/cells/hu/net/)-tal, a [Aspose.Total for .NET](https://products.aspose.com/total/hu/net/) gyermek API-jával bármely .NET-fejlesztő integrálhatja a fenti API-kódot a programosztó alkalmazásba.Hatékony .NET-könyvtár a dokumentumok felosztásához számos népszerű formátumot támogat, beleértve a ODS formátumot, például a PDF, Word, Excel és PowerPoint fájlokat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODS Splitter könyvtár .NET-hez" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Igen, nyugodtan letöltheti ezt a kódot. Könnyen kifejleszthető egy professzionális megoldás a ODS fájlok felosztására .NET használatával.Az Aspose ODS splitter API segítségével magas szintű, platformfüggetlen szoftvereket fejleszthet a .NET-ben.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
