---
title: Védje a XLS dokumentumot online jelszóval és .NET használatával
description: Online XLS fájl jelszóvédő alkalmazás..NET C# API kód jelszavas védelem alkalmazásához XLS táblázatokon.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online XLS dokumentumvédelem vagy jelszó beállítása .NET-en keresztül" h2="Hatékony .NET alapú XLS dokumentumvédelmi segédprogram fejlesztése.A XLS-táblázathoz .NET-en keresztüli jelszó alkalmazásához szükséges kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS jelszavas védelem .NET-en keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: XLS dokumentum jelszavas védelem" offSpacer="" %}}
...
<h2>XLS jelszavas védelmi alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram XLS fájl feldolgozásához védelmi alkalmazáshoz" %}}
