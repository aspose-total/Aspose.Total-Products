---
title: Védje a ODS dokumentumot online jelszóval és .NET használatával
description: Online ODS fájl jelszóvédő alkalmazás..NET C# API kód jelszavas védelem alkalmazásához ODS táblázatokon.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ODS dokumentumvédelem vagy jelszó beállítása .NET-en keresztül" h2="Hatékony .NET alapú ODS dokumentumvédelmi segédprogram fejlesztése.A ODS-táblázathoz .NET-en keresztüli jelszó alkalmazásához szükséges kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS jelszavas védelem .NET-en keresztül" %}}

1. ODS fájl betöltése Workbook osztály objektumon keresztül
1. Hívja a SetEncryptionOptions parancsot a EncryptionType segítségével
1. Adja meg a jelszót a Settings.Password segítségével
1. A munkalap mentéséhez hívja meg a Mentés metódust.
...
{{% blocks/products/pf/agp/code-block title=".NET kód: ODS dokumentum jelszavas védelem" offSpacer="" %}}
...
<h2>ODS jelszavas védelmi alkalmazás fejlesztése .NET-en keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET segédprogram ODS fájl feldolgozásához védelmi alkalmazáshoz" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bármilyen modern webböngészőt használhat, mint például a Google Chrome, a Firefox, az Opera vagy a Safari az online ODS dokumentumvédőhöz.Ha azonban asztali alkalmazást fejleszt, javasoljuk az Aspose.Total dokumentumfeldolgozási API használatát a hatékony kezelés érdekében.</span>
                      </div>
                  </li>
              </ul>
          </div>
