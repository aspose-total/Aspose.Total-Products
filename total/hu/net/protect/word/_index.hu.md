---
title: Védje a Word dokumentumot online jelszóval és .NET használatával
description: Online Word fájl jelszóvédő alkalmazás. C# .NET API kód jelszavas védelem alkalmazásához a Word dokumentumon.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online Word dokumentumvédelem vagy jelszó beállítása .NET-en keresztül" h2="Hatékony .NET alapú Word dokumentumvédelmi segédprogram fejlesztése.A Word-dokumentumhoz .NET-en keresztüli jelszó alkalmazásához felsorolt kód." >}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Word dokumentum jelszavas védelem" offSpacer="" %}}
