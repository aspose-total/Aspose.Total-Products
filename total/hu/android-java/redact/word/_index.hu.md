---
title: Szerkessze vissza a Word dokumentumot online vagy Android mobilalkalmazások használatával
description: Nyissa meg és szerkesztheti a Word dokumentumot online az alkalmazáson keresztül ingyenesen. Android API kód a Word szöveg kereséséhez és reguláris kifejezéssel való helyettesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szerkessze vissza a Word-dokumentumot online vagy Android-alkalmazásokon keresztül" h2="Hatékony Android alapú Word dokumentumszerkesztő segédprogram fejlesztése. A Word fájl szövegének reguláris kifejezéssel történő kereséséhez és cseréjéhez listázott kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Szerkessze vissza a Word fájlt az Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Word dokumentum szerkesztése" offSpacer="" %}}
