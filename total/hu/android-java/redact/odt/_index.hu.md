---
title: Szerkessze vissza a ODT dokumentumot online vagy Android mobilalkalmazások használatával
description: Nyissa meg és szerkesztheti a ODT dokumentumot online az alkalmazáson keresztül ingyenesen. Android API kód a ODT szöveg kereséséhez és reguláris kifejezéssel való helyettesítéséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szerkessze vissza a ODT-dokumentumot online vagy Android-alkalmazásokon keresztül" h2="Hatékony Android alapú ODT dokumentumszerkesztő segédprogram fejlesztése. A ODT fájl szövegének reguláris kifejezéssel történő kereséséhez és cseréjéhez listázott kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Szerkessze vissza a ODT fájlt az Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: ODT dokumentum szerkesztése" offSpacer="" %}}
