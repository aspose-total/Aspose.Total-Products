---
title: Távolítsa el a DOCM Annotation Online-t vagy kezelje a kommentárokat az Android mobilalkalmazások segítségével
description: ingyenesen törölje a megjegyzéseket a DOCM fájlból az online alkalmazáson keresztül.Android API kód a DOCM fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOCM Document Online alkalmazásból, vagy kezelje az Android-alkalmazásokon keresztül" h2="Hatékony Android alapú DOCM dokumentum annotációs segédprogram fejlesztése.A DOCM fájl megjegyzéseinek kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a DOCM-dokumentum megjegyzéseit az Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Megjegyzések törlése a DOCM fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Távolítsa el és adjon hozzá megjegyzést a DOCM fájlhoz" offSpacer="" %}}
