---
title: Távolítsa el a TXT Annotation Online-t vagy kezelje a kommentárokat az Android mobilalkalmazások segítségével
description: ingyenesen törölje a megjegyzéseket a TXT fájlból az online alkalmazáson keresztül.Android API kód a TXT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a TXT Document Online alkalmazásból, vagy kezelje az Android-alkalmazásokon keresztül" h2="Hatékony Android alapú TXT dokumentum annotációs segédprogram fejlesztése.A TXT fájl megjegyzéseinek kezeléséhez felsorolt kód." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a TXT megjegyzéseket online" %}}

1. Importáljon TXT fájlt a megjegyzések feltöltésével való törléséhez
1. Ehhez kattintson a ledobási területen belülre a megjegyzés alkalmazás húzásával
1. A TXT fájl méretétől és az internet sebességétől függően várjon néhány másodpercet
1. Kattintson az "Eltávolítás" gombra a megjegyzések törléséhez
1. Azonnal töltse le a fájlt

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a TXT-dokumentum megjegyzéseit az Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Megjegyzések törlése a TXT fájlból" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="TXT megjegyzés eltávolítása és hozzáadása" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Távolítsa el és adjon hozzá megjegyzést a TXT fájlhoz" offSpacer="" %}}
