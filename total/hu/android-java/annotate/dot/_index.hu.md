---
title: Távolítsa el a DOT Annotation Online-t vagy kezelje a kommentárokat az Android mobilalkalmazások segítségével
description: ingyenesen törölje a megjegyzéseket a DOT fájlból az online alkalmazáson keresztül.Android API kód a DOT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOT Document Online alkalmazásból, vagy kezelje az Android-alkalmazásokon keresztül" h2="Hatékony Android alapú DOT dokumentum annotációs segédprogram fejlesztése.A DOT fájl megjegyzéseinek kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a DOT-dokumentum megjegyzéseit az Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Megjegyzések törlése a DOT fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód: Távolítsa el és adjon hozzá megjegyzést a DOT fájlhoz" offSpacer="" %}}
