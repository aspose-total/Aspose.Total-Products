---
title: Android API a MD megjelenítéséhez PS-be
description: A MD átalakítása PS-re Androidon keresztül Java API-n keresztül
url: /hu/android-java/conversion/md-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MD
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a MD-et PS-be Androidon Java segítségével" h2="Konvertálja a MD-et PS-re a mobilalkalmazásokban szoftver telepítése nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja a MD-et PS-re Androidon Java segítségével" %}}
