---
title: Android API a MOBI konvertálásához XLSM-vé
description: Konvertálja a MOBI-t XLSM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A MOBI konvertálása XLSM formátumba az Android alkalmazásokban" h2="MOBI exportálása XLSM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
