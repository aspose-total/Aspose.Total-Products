---
title: Android API a WORD konvertálásához XLTX-vé
description: Konvertálja a WORD-t XLTX-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A WORD konvertálása XLTX formátumba az Android alkalmazásokban" h2="WORD exportálása XLTX formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
