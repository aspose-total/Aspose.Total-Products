---
title: Konvertálja a OTT-t POTM-vé Androidon Java segítségével
description: OTT konvertálás POTM-re az Android telefonokon Microsoft Word of PowerPoint használata nélkül
url: /hu/android-java/conversion/ott-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a OTT-t POTM-vé az Android alkalmazásokban" h2="OTT- POTM-konverzió az Android-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy a PowerPoint telepítése nélkül" >}}
...
A OTT- és POTM-fájlok konvertálásához egyszerűen használhatja az Aspose.Total for Androidot Java-n keresztül közvetlenül a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) -től , és telepítse a könyvtárakat az alkalmazásba.
