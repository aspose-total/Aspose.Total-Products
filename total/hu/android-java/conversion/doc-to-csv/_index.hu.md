---
title: Android API a DOC konvertálásához CSV-vé
description: Konvertálja a DOC-t CSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/doc-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="A DOC konvertálása CSV formátumba az Android alkalmazásokban" h2="DOC exportálása CSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
