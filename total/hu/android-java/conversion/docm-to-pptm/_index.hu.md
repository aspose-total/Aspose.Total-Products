---
title: Konvertálja a DOCM-t PPTM-vé Androidon Java segítségével
description: DOCM konvertálás PPTM-re az Android telefonokon Microsoft Word of PowerPoint használata nélkül
url: /hu/android-java/conversion/docm-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a DOCM-t PPTM-vé az Android alkalmazásokban" h2="DOCM- PPTM-konverzió az Android-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy a PowerPoint telepítése nélkül" >}}
...
A DOCM- és PPTM-fájlok konvertálásához egyszerűen használhatja az Aspose.Total for Androidot Java-n keresztül közvetlenül a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) -től , és telepítse a könyvtárakat az alkalmazásba.
