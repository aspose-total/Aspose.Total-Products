---
title: Android API a DOC konvertálásához TSV-vé
description: Konvertálja a DOC-t TSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/doc-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="A DOC konvertálása TSV formátumba az Android alkalmazásokban" h2="DOC exportálása TSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
