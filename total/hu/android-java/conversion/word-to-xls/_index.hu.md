---
title: Android API a WORD konvertálásához XLS-vé
description: Konvertálja a WORD-t XLS-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/word-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="A WORD konvertálása XLS formátumba az Android alkalmazásokban" h2="WORD exportálása XLS formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
