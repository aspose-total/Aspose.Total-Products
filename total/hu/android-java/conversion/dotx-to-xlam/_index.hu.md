---
title: Android API a DOTX konvertálásához XLAM-vé
description: Konvertálja a DOTX-t XLAM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOTX konvertálása XLAM formátumba az Android alkalmazásokban" h2="DOTX exportálása XLAM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
