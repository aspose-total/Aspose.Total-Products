---
title: Exportálja a PPSM-ot DOT-ba Andoridon Java-n keresztül
description: Konvertálja a PPSM-ot DOT-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a PPSM-ot DOT-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a PPSM-t DOT-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
