---
title: Exportálja a POTX-ot DOTM-ba Andoridon Java-n keresztül
description: Konvertálja a POTX-ot DOTM-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a POTX-ot DOTM-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a POTX-t DOTM-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
