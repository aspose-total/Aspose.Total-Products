---
title: Android API a WORD konvertálásához FODS-vé
description: Konvertálja a WORD-t FODS-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A WORD konvertálása FODS formátumba az Android alkalmazásokban" h2="WORD exportálása FODS formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
