---
title: Android API a DOC konvertálásához XLT-vé
description: Konvertálja a DOC-t XLT-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOC konvertálása XLT formátumba az Android alkalmazásokban" h2="DOC exportálása XLT formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
