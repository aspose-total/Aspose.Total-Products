---
title: Exportálja a PPSX-ot ODT-ba Andoridon Java-n keresztül
description: Konvertálja a PPSX-ot ODT-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a PPSX-ot ODT-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a PPSX-t ODT-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
