---
title: Exportálja a PPS-ot DOT-ba Andoridon Java-n keresztül
description: Konvertálja a PPS-ot DOT-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a PPS-ot DOT-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a PPS-t DOT-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
