---
title: Android API a PS megjelenítéséhez ODT-be
description: A PS átalakítása ODT-re Androidon keresztül Java API-n keresztül
url: /hu/android-java/conversion/ps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a PS-et ODT-be Androidon Java segítségével" h2="Konvertálja a PS-et ODT-re a mobilalkalmazásokban szoftver telepítése nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja a PS-et ODT-re Androidon Java segítségével" %}}
