---
title: Android API a DOCM konvertálásához CSV-vé
description: Konvertálja a DOCM-t CSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/docm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="A DOCM konvertálása CSV formátumba az Android alkalmazásokban" h2="DOCM exportálása CSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
