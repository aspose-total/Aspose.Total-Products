---
title: Android API a DOCX konvertálásához ODS-vé
description: Konvertálja a DOCX-t ODS-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/docx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="A DOCX konvertálása ODS formátumba az Android alkalmazásokban" h2="DOCX exportálása ODS formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
