---
title: Exportálja a PPSX-ot DOC-ba Andoridon Java-n keresztül
description: Konvertálja a PPSX-ot DOC-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a PPSX-ot DOC-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a PPSX-t DOC-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
