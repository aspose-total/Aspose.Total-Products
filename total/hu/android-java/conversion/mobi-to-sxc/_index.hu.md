---
title: Android API a MOBI konvertálásához SXC-vé
description: Konvertálja a MOBI-t SXC-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/mobi-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="A MOBI konvertálása SXC formátumba az Android alkalmazásokban" h2="MOBI exportálása SXC formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
