---
title: XLSM exportálása DOCX formátumba Androidon
description: Android API a XLSM konvertálásához DOCX formátumba Microsoft Word használata nélkül
url: /hu/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a XLSM-t DOCX-fájlba Androidon Java segítségével" h2="A Microsoft<sup>&reg;</sup> Excel használata nélkül alakítsa át a XLSM-t DOCX formátumba Android-alkalmazásaiban" >}}
