---
title: Android API a DOCM konvertálásához XLTM-vé
description: Konvertálja a DOCM-t XLTM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/docm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="A DOCM konvertálása XLTM formátumba az Android alkalmazásokban" h2="DOCM exportálása XLTM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
