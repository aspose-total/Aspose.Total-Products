---
title: Android API a DOTX konvertálásához CSV-vé
description: Konvertálja a DOTX-t CSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOTX konvertálása CSV formátumba az Android alkalmazásokban" h2="DOTX exportálása CSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
