---
title: Android API a MOBI konvertálásához DIF-vé
description: Konvertálja a MOBI-t DIF-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/mobi-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="A MOBI konvertálása DIF formátumba az Android alkalmazásokban" h2="MOBI exportálása DIF formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
