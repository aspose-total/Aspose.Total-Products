---
title: Konvertálja a DOCM-t PPS-vé Androidon Java segítségével
description: DOCM konvertálás PPS-re az Android telefonokon Microsoft Word of PowerPoint használata nélkül
url: /hu/android-java/conversion/docm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a DOCM-t PPS-vé az Android alkalmazásokban" h2="DOCM- PPS-konverzió az Android-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy a PowerPoint telepítése nélkül" >}}
...
A DOCM- és PPS-fájlok konvertálásához egyszerűen használhatja az Aspose.Total for Androidot Java-n keresztül közvetlenül a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) -től , és telepítse a könyvtárakat az alkalmazásba.
