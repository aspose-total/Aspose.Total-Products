---
title: Android API a MOBI konvertálásához XLAM-vé
description: Konvertálja a MOBI-t XLAM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/mobi-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="A MOBI konvertálása XLAM formátumba az Android alkalmazásokban" h2="MOBI exportálása XLAM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
