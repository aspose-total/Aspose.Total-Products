---
title: Android API a OTT konvertálásához ODS-vé
description: Konvertálja a OTT-t ODS-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A OTT konvertálása ODS formátumba az Android alkalmazásokban" h2="OTT exportálása ODS formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
