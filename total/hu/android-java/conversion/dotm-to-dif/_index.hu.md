---
title: Android API a DOTM konvertálásához DIF-vé
description: Konvertálja a DOTM-t DIF-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/dotm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="A DOTM konvertálása DIF formátumba az Android alkalmazásokban" h2="DOTM exportálása DIF formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
