---
title: Android API a DOT konvertálásához XLT-vé
description: Konvertálja a DOT-t XLT-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/dot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="A DOT konvertálása XLT formátumba az Android alkalmazásokban" h2="DOT exportálása XLT formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
