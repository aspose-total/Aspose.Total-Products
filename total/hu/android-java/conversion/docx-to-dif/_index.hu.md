---
title: Android API a DOCX konvertálásához DIF-vé
description: Konvertálja a DOCX-t DIF-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/docx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="A DOCX konvertálása DIF formátumba az Android alkalmazásokban" h2="DOCX exportálása DIF formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
