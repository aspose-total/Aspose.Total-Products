---
title: Android API a DOC konvertálásához SXC-vé
description: Konvertálja a DOC-t SXC-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOC konvertálása SXC formátumba az Android alkalmazásokban" h2="DOC exportálása SXC formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
