---
title: Android API a DOTM konvertálásához XLSX-vé
description: Konvertálja a DOTM-t XLSX-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/dotm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="A DOTM konvertálása XLSX formátumba az Android alkalmazásokban" h2="DOTM exportálása XLSX formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
