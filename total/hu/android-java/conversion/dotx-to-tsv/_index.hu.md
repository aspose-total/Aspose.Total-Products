---
title: Android API a DOTX konvertálásához TSV-vé
description: Konvertálja a DOTX-t TSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/dotx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="A DOTX konvertálása TSV formátumba az Android alkalmazásokban" h2="DOTX exportálása TSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
