---
title: Android API a OTT konvertálásához DIF-vé
description: Konvertálja a OTT-t DIF-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A OTT konvertálása DIF formátumba az Android alkalmazásokban" h2="OTT exportálása DIF formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
