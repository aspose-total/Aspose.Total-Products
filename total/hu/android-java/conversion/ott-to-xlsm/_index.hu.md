---
title: Android API a OTT konvertálásához XLSM-vé
description: Konvertálja a OTT-t XLSM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/ott-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="A OTT konvertálása XLSM formátumba az Android alkalmazásokban" h2="OTT exportálása XLSM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
