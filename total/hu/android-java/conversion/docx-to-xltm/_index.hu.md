---
title: Android API a DOCX konvertálásához XLTM-vé
description: Konvertálja a DOCX-t XLTM-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOCX konvertálása XLTM formátumba az Android alkalmazásokban" h2="DOCX exportálása XLTM formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
