---
title: Exportálja a POT-ot DOCX-ba Andoridon Java-n keresztül
description: Konvertálja a POT-ot DOCX-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a POT-ot DOCX-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a POT-t DOCX-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
