---
title: Exportálja a POT-ot WORDML-ba Andoridon Java-n keresztül
description: Konvertálja a POT-ot WORDML-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a POT-ot WORDML-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a POT-t WORDML-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
