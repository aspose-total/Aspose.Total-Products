---
title: Konvertálja a OTT-t PPSX-vé Androidon Java segítségével
description: OTT konvertálás PPSX-re az Android telefonokon Microsoft Word of PowerPoint használata nélkül
url: /hu/android-java/conversion/ott-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a OTT-t PPSX-vé az Android alkalmazásokban" h2="OTT- PPSX-konverzió az Android-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy a PowerPoint telepítése nélkül" >}}
...
A OTT- és PPSX-fájlok konvertálásához egyszerűen használhatja az Aspose.Total for Androidot Java-n keresztül közvetlenül a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) -től , és telepítse a könyvtárakat az alkalmazásba.
