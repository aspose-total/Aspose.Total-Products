---
title: Android API a DOC konvertálásához DIF-vé
description: Konvertálja a DOC-t DIF-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOC konvertálása DIF formátumba az Android alkalmazásokban" h2="DOC exportálása DIF formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
