---
title: Android API a DOCM konvertálásához SXC-vé
description: Konvertálja a DOCM-t SXC-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOCM konvertálása SXC formátumba az Android alkalmazásokban" h2="DOCM exportálása SXC formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
