---
title: Android API a DOTM konvertálásához XLSB-vé
description: Konvertálja a DOTM-t XLSB-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOTM konvertálása XLSB formátumba az Android alkalmazásokban" h2="DOTM exportálása XLSB formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
