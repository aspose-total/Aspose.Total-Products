---
title: Exportálja a POTM-ot DOCX-ba Andoridon Java-n keresztül
description: Konvertálja a POTM-ot DOCX-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/potm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a POTM-ot DOCX-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a POTM-t DOCX-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
