---
title: Exportálja a POT-ot DOTM-ba Andoridon Java-n keresztül
description: Konvertálja a POT-ot DOTM-ba mobilalkalmazásokban szoftver telepítése nélkül
url: /hu/android-java/conversion/pot-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Renderelje le a POT-ot DOTM-ba Andoridon Java-n keresztül" h2="Fájlformátumú API-k, amelyek a POT-t DOTM-ba konvertálják Android-alkalmazásokon belül, anélkül, hogy a Microsoft PowerPointtól vagy a Wordtől függnének" >}}
