---
title: Android API a OTT konvertálásához TSV-vé
description: Konvertálja a OTT-t TSV-vé Androidon Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/android-java/conversion/ott-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="A OTT konvertálása TSV formátumba az Android alkalmazásokban" h2="OTT exportálása TSV formátumba Androidon Java segítségével Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
