---
title: Védje meg a ODP dokumentumot online jelszóval vagy Android mobilalkalmazásokkal
description: Online ODP fájl jelszóvédő alkalmazás.Android API Java kód jelszavas védelem alkalmazásához a ODP prezentációkon.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ODP dokumentumvédelem vagy jelszó beállítása az Android alkalmazáson keresztül" h2="Erőteljes Android alapú ODP dokumentumvédelmi segédprogram fejlesztése.A listán szereplő kód a jelszó alkalmazásához a ODP prezentációhoz Androidon keresztül." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Online ODP jelszavas védelem" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP jelszavas védelem Android alkalmazáson keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Java kód: ODP prezentáció jelszavas védelem" offSpacer="" %}}
