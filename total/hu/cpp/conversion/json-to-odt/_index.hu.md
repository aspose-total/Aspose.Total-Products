---
title: Konvertálja a JSON formátumot ODT-re a C++ segítségével
description: C++ API t0 JSON elemzése ODT-re Microsoft Word használata nélkül
url: /hu/cpp/conversion/json-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a JSON formátumot ODT-re a C++ segítségével" h2="Elemezze a JSON-t ODT-be a C++ alkalmazásokon belül a Microsoft<sup>&reg;</sup> Word használata nélkül" >}}

{{% blocks/products/pf/feature-page-summary %}}
Az [Aspose.Total for C++](https://products.aspose.com/total/cpp/) használatával két egyszerű lépésben elemezheti a JSON-t ODT-be a C++ alkalmazásaiban. Először is, az [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) használatával PDF-formátumba exportálhatja a JSON-t. Ezt követően az [Aspose.Words for C++](https://products.aspose.com/words/cppp/) használatával konvertálhatja a PDF-et ODT formátumba. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja a JSON formátumot ODT-re C++ nyelven" %}}
...
4. Mentse a dokumentumot ODT formátumba a [Mentés](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) metódussal
...
{{% blocks/products/pf/feature-page-section  h2="Konvertálja a JSON formátumot ODT-re vízjellel a C++ nyelven" %}}
Az API használatával a JSON-t is elemezheti a ODT-be vízjellel. Ha vízjelet szeretne hozzáadni a ODT-dokumentumhoz, először konvertálja a JSON-t PDF-be, és vízjelet adjon hozzá. Vízjel hozzáadásához töltse be az újonnan létrehozott PDF-fájlt a [Document](https://reference.aspose.com/words/cpp/class/aspose.words.document) osztály segítségével, állítson be különböző tulajdonságokat a szöveges vízjelhez,
hívja meg a SetText metódust, és adja át a vízjel szövegét és a TextWatermarkOptions objektumát. A vízjel hozzáadása után a dokumentumot elmentheti a ODT-be.
{{% blocks/products/pf/feature-page-code %}}
