---
title: Konvertálja a WORD-t XLSX-vé C++-ban
description: C++ API a WORD konvertálásához XLSX-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/word-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a WORD XLSX-vé konvertálásához" h2="WORD exportálása XLSX-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a WORD XLSX-vé konvertálásához" %}}
