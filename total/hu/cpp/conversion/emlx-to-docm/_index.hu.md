---
title: Exportálja az EMLX-t DOCM-be C++-on keresztül
description: C++ API az EMLX DOCM-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/emlx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMLX exportálásához DOCM-be" h2="Alakítsa át az EMLX-t DOCM-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
...
Dokumentumvédelmi funkciókat is hozzáadhat az alkalmazáshoz, miközben exportálja a dokumentumot a EMLX címről a DOCM-be. A védelem hozzáadása a dokumentumhoz egy egyszerű folyamat, hiszen mindössze a védelmi módszert kell alkalmaznia a dokumentumra. A védelem típusát ReadOnly értékre állíthatja, hogy korlátozza a felhasználót a dokumentum szerkesztésében.
{{% blocks/products/pf/feature-page-code %}}
