---
title: Konvertálja a XLSM-t DOC-ba a C++ segítségével
description: A XLSM konvertálása DOC formátumba a C++ alkalmazásokon belül
url: /hu/cpp/conversion/xlsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="A XLSM konvertálása DOC formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLSM-ből DOC-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
