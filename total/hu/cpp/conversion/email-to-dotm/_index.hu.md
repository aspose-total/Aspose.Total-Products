---
title: Exportálja az EMAIL-t DOTM-be C++-on keresztül
description: C++ API az EMAIL DOTM-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/email-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMAIL exportálásához DOTM-be" h2="Alakítsa át az EMAIL-t DOTM-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
