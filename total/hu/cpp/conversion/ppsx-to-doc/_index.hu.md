---
title: C++ API a PPSX DOC formátumba konvertálásához
description: Exportálja a PPSX-ot DOC-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSX rendereléséhez DOC-ba" h2="Exportálja a PPSX-ot DOC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
