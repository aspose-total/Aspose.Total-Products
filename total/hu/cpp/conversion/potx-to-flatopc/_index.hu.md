---
title: C++ API a POTX FLATOPC formátumba konvertálásához
description: Exportálja a POTX-ot FLATOPC-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez FLATOPC-ba" h2="Exportálja a POTX-ot FLATOPC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
