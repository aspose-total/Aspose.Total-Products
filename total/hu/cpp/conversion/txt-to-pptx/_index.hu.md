---
title: A TXT konvertálása PPTX-re C++ segítségével
description: Exportáljon TXT-t PPTX-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/txt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a TXT konvertálásához PPTX-vé" h2="TXT exportálása PPTX-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
