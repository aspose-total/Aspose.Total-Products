---
title: C++ API a POWERPOINT DOCX formátumba konvertálásához
description: Exportálja a POWERPOINT-ot DOCX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POWERPOINT rendereléséhez DOCX-ba" h2="Exportálja a POWERPOINT-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
