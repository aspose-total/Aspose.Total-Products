---
title: C++ API a PPS WORD formátumba konvertálásához
description: Exportálja a PPS-ot WORD-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez WORD-ba" h2="Exportálja a PPS-ot WORD-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
