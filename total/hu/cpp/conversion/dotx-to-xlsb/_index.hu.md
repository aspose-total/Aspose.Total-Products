---
title: Konvertálja a DOTX-t XLSB-vé C++-ban
description: C++ API a DOTX konvertálásához XLSB-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dotx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOTX XLSB-vé konvertálásához" h2="DOTX exportálása XLSB-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOTX XLSB-vé konvertálásához" %}}
