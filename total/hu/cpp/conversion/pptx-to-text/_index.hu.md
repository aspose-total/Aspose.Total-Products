---
title: C++ API a PPTX TEXT formátumba konvertálásához
description: Exportálja a PPTX-ot TEXT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez TEXT-ba" h2="Exportálja a PPTX-ot TEXT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
