---
title: C++ API a PPS DOCX formátumba konvertálásához
description: Exportálja a PPS-ot DOCX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez DOCX-ba" h2="Exportálja a PPS-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
