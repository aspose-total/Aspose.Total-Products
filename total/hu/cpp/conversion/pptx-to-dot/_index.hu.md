---
title: C++ API a PPTX DOT formátumba konvertálásához
description: Exportálja a PPTX-ot DOT-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez DOT-ba" h2="Exportálja a PPTX-ot DOT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
