---
title: C++ API a POTX DOT formátumba konvertálásához
description: Exportálja a POTX-ot DOT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez DOT-ba" h2="Exportálja a POTX-ot DOT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
