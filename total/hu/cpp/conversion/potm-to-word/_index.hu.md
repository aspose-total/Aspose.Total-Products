---
title: C++ API a POTM WORD formátumba konvertálásához vagy ingyenes online konverterrel
description: Exportálja a POTM-ot WORD-ba a C++ alkalmazásaiban vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes POTM-WORD online konvertert.
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez WORD-ba vagy Online App" h2="Exportálja a POTM-ot WORD-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
