---
title: A TXT konvertálása POTM-re C++ segítségével
description: Exportáljon TXT-t POTM-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/txt-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a TXT konvertálásához POTM-vé" h2="TXT exportálása POTM-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
