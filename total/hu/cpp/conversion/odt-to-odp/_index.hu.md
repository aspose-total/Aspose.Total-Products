---
title: A ODT konvertálása ODP-re C++ segítségével
description: Exportáljon ODT-t ODP-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/odt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a ODT konvertálásához ODP-vé" h2="ODT exportálása ODP-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
