---
title: C++ API a PPTX ODT formátumba konvertálásához
description: Exportálja a PPTX-ot ODT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez ODT-ba" h2="Exportálja a PPTX-ot ODT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
