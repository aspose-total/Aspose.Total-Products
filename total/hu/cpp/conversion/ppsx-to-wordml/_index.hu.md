---
title: C++ API a PPSX WORDML formátumba konvertálásához
description: Exportálja a PPSX-ot WORDML-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppsx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSX rendereléséhez WORDML-ba" h2="Exportálja a PPSX-ot WORDML-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
