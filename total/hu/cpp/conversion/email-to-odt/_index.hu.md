---
title: Exportálja az EMAIL-t ODT-be C++-on keresztül
description: C++ API az EMAIL ODT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/email-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMAIL exportálásához ODT-be" h2="Alakítsa át az EMAIL-t ODT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
...
Dokumentumvédelmi funkciókat is hozzáadhat az alkalmazáshoz, miközben exportálja a dokumentumot a EMAIL címről a ODT-be. A védelem hozzáadása a dokumentumhoz egy egyszerű folyamat, hiszen mindössze a védelmi módszert kell alkalmaznia a dokumentumra. A védelem típusát ReadOnly értékre állíthatja, hogy korlátozza a felhasználót a dokumentum szerkesztésében.
{{% blocks/products/pf/feature-page-code %}}
