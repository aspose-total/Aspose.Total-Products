---
title: C++ API a PPTM DOCX formátumba konvertálásához
description: Exportálja a PPTM-ot DOCX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pptm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTM rendereléséhez DOCX-ba" h2="Exportálja a PPTM-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
