---
title: A RTF konvertálása PPT-re C++ segítségével
description: Exportáljon RTF-t PPT-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/rtf-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF konvertálásához PPT-vé" h2="RTF exportálása PPT-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
