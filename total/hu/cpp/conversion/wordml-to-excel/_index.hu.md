---
title: Konvertálja a WORDML-t EXCEL-vé C++-ban
description: C++ API a WORDML konvertálásához EXCEL-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API a WORDML EXCEL-vé konvertálásához" h2="WORDML exportálása EXCEL-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a WORDML EXCEL-vé konvertálásához" %}}
