---
title: C++ API a POTM DOCX formátumba konvertálásához
description: Exportálja a POTM-ot DOCX-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez DOCX-ba" h2="Exportálja a POTM-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
