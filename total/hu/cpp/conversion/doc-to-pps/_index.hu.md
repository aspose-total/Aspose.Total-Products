---
title: A DOC konvertálása PPS-re C++ segítségével
description: Exportáljon DOC-t PPS-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/doc-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOC konvertálásához PPS-vé" h2="DOC exportálása PPS-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
