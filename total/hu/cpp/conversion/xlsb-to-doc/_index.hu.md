---
title: Konvertálja a XLSB-t DOC-ba a C++ segítségével
description: A XLSB konvertálása DOC formátumba a C++ alkalmazásokon belül
url: /hu/cpp/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="A XLSB konvertálása DOC formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLSB-ből DOC-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
