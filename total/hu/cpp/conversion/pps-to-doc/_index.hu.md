---
title: C++ API a PPS DOC formátumba konvertálásához
description: Exportálja a PPS-ot DOC-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez DOC-ba" h2="Exportálja a PPS-ot DOC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
