---
title: C++ API a POTM DOCM formátumba konvertálásához
description: Exportálja a POTM-ot DOCM-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez DOCM-ba" h2="Exportálja a POTM-ot DOCM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
