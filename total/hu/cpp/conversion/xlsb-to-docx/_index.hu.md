---
title: Konvertálja a XLSB-t DOCX-ba a C++ segítségével
description: A XLSB konvertálása DOCX formátumba a C++ alkalmazásokon belül
url: /hu/cpp/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="A XLSB konvertálása DOCX formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLSB-ből DOCX-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
