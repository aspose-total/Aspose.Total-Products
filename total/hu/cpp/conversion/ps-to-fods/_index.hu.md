---
title: C++ API a PS FODS-vé konvertálásához
description: Konvertálja a PS-et FODS-vé a C++ API-n keresztül Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/cpp/conversion/ps-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/cpp/conversion/ps-to-tsv/" name="PS Nak nek TSV" description="" >}}
