---
title: Konvertálja a WORD-t DIF-vé C++-ban
description: C++ API a WORD konvertálásához DIF-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a WORD DIF-vé konvertálásához" h2="WORD exportálása DIF-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a WORD DIF-vé konvertálásához" %}}
