---
title: C++ API a PPSM WORD formátumba konvertálásához
description: Exportálja a PPSM-ot WORD-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSM rendereléséhez WORD-ba" h2="Exportálja a PPSM-ot WORD-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
