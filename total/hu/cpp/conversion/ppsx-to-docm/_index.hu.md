---
title: C++ API a PPSX DOCM formátumba konvertálásához
description: Exportálja a PPSX-ot DOCM-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSX rendereléséhez DOCM-ba" h2="Exportálja a PPSX-ot DOCM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/cpp/conversion/ppsx-to-docmx/" name="PPSX Nak nek DOCMX" description="" >}}
