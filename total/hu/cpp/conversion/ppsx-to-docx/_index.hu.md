---
title: C++ API a PPSX DOCX formátumba konvertálásához
description: Exportálja a PPSX-ot DOCX-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSX rendereléséhez DOCX-ba" h2="Exportálja a PPSX-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
