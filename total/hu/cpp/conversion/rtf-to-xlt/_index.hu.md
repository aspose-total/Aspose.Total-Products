---
title: Konvertálja a RTF-t XLT-vé C++-ban
description: C++ API a RTF konvertálásához XLT-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/rtf-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF XLT-vé konvertálásához" h2="RTF exportálása XLT-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a RTF XLT-vé konvertálásához" %}}
