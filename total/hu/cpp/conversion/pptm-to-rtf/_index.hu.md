---
title: C++ API a PPTM RTF formátumba konvertálásához
description: Exportálja a PPTM-ot RTF-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTM rendereléséhez RTF-ba" h2="Exportálja a PPTM-ot RTF-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
