---
title: Konvertálja a DOTM-t XLT-vé C++-ban
description: C++ API a DOTM konvertálásához XLT-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dotm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOTM XLT-vé konvertálásához" h2="DOTM exportálása XLT-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOTM XLT-vé konvertálásához" %}}
