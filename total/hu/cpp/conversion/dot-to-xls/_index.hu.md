---
title: Konvertálja a DOT-t XLS-vé C++-ban
description: C++ API a DOT konvertálásához XLS-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dot-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOT XLS-vé konvertálásához" h2="DOT exportálása XLS-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOT XLS-vé konvertálásához" %}}
