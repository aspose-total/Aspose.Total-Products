---
title: Exportálja az EMLX-t TEXT-be C++-on keresztül
description: C++ API az EMLX TEXT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/emlx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMLX exportálásához TEXT-be" h2="Alakítsa át az EMLX-t TEXT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API az EMLX TEXT-vé konvertálásához" %}}
