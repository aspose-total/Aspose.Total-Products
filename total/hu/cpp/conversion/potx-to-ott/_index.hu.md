---
title: C++ API a POTX OTT formátumba konvertálásához
description: Exportálja a POTX-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez OTT-ba" h2="Exportálja a POTX-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
