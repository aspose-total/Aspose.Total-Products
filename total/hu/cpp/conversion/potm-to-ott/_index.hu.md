---
title: C++ API a POTM OTT formátumba konvertálásához
description: Exportálja a POTM-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez OTT-ba" h2="Exportálja a POTM-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
