---
title: Konvertálja a DOTX-t XLT-vé C++-ban
description: C++ API a DOTX konvertálásához XLT-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dotx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOTX XLT-vé konvertálásához" h2="DOTX exportálása XLT-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOTX XLT-vé konvertálásához" %}}
