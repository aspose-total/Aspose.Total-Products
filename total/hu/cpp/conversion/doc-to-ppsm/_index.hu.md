---
title: A DOC konvertálása PPSM-re C++ segítségével
description: Exportáljon DOC-t PPSM-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/doc-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOC konvertálásához PPSM-vé" h2="DOC exportálása PPSM-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
