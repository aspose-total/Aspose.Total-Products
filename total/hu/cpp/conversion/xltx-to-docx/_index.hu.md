---
title: Konvertálja a XLTX-t DOCX-ba a C++ segítségével
description: A XLTX konvertálása DOCX formátumba a C++ alkalmazásokon belül
url: /hu/cpp/conversion/xltx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="A XLTX konvertálása DOCX formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLTX-ből DOCX-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
