---
title: Konvertálja a DOCM-t XLTX-vé C++-ban
description: C++ API a DOCM konvertálásához XLTX-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/docm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOCM XLTX-vé konvertálásához" h2="DOCM exportálása XLTX-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOCM XLTX-vé konvertálásához" %}}
