...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOCX konvertálásához POTX-vé vagy Online App" h2="DOCX exportálása POTX-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOCX konvertálás POTX-be C++-on" %}}
