---
title: C++ API a POT OTT formátumba konvertálásához
description: Exportálja a POT-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POT rendereléséhez OTT-ba" h2="Exportálja a POT-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
