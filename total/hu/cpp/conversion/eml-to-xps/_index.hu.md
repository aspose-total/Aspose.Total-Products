---
title: Exportálja az EML-t XPS-be C++-on keresztül
description: C++ API az EML XPS-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/eml-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EML exportálásához XPS-be" h2="Alakítsa át az EML-t XPS-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
