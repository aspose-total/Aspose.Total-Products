---
title: C++ API a PPTX OTT formátumba konvertálásához
description: Exportálja a PPTX-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez OTT-ba" h2="Exportálja a PPTX-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
