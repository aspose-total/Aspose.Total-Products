---
title: A RTF konvertálása ODP-re C++ segítségével
description: Exportáljon RTF-t ODP-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF konvertálásához ODP-vé" h2="RTF exportálása ODP-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
