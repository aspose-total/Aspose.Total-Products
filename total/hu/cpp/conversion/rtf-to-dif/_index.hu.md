---
title: Konvertálja a RTF-t DIF-vé C++-ban
description: C++ API a RTF konvertálásához DIF-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/rtf-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF DIF-vé konvertálásához" h2="RTF exportálása DIF-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a RTF DIF-vé konvertálásához" %}}
