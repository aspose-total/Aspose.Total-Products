---
title: A ODT konvertálása PPTM-re C++ segítségével
description: Exportáljon ODT-t PPTM-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/odt-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a ODT konvertálásához PPTM-vé" h2="ODT exportálása PPTM-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
