---
title: C++ API a POWERPOINT OTT formátumba konvertálásához
description: Exportálja a POWERPOINT-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POWERPOINT rendereléséhez OTT-ba" h2="Exportálja a POWERPOINT-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
