---
title: A TXT konvertálása PPT-re C++ segítségével
description: Exportáljon TXT-t PPT-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/txt-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a TXT konvertálásához PPT-vé" h2="TXT exportálása PPT-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
