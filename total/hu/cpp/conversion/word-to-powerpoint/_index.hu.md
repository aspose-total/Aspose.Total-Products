---
title: A WORD konvertálása POWERPOINT-re C++ segítségével
description: Exportáljon WORD-t POWERPOINT-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/word-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a WORD konvertálásához POWERPOINT-vé" h2="WORD exportálása POWERPOINT-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
