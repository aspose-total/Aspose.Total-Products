---
title: Konvertálja a DOTX-t XLSM-vé C++-ban
description: C++ API a DOTX konvertálásához XLSM-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOTX XLSM-vé konvertálásához" h2="DOTX exportálása XLSM-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOTX XLSM-vé konvertálásához" %}}
