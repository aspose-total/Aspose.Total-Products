---
title: C++ API a POT RTF formátumba konvertálásához
description: Exportálja a POT-ot RTF-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pot-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POT rendereléséhez RTF-ba" h2="Exportálja a POT-ot RTF-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
