---
title: Exportálja az EMLX-t RTF-be C++-on keresztül
description: C++ API az EMLX RTF-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/emlx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMLX exportálásához RTF-be" h2="Alakítsa át az EMLX-t RTF-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
