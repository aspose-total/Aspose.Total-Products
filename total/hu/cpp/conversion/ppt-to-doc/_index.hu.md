---
title: C++ API a PPT DOC formátumba konvertálásához
description: Exportálja a PPT-ot DOC-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPT rendereléséhez DOC-ba" h2="Exportálja a PPT-ot DOC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
