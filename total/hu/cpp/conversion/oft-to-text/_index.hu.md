---
title: Exportálja az OFT-t TEXT-be C++-on keresztül
description: C++ API az OFT TEXT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/oft-to-text/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API az OFT exportálásához TEXT-be" h2="Alakítsa át az OFT-t TEXT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
