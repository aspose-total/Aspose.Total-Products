---
title: A RTF konvertálása POT-re C++ segítségével
description: Exportáljon RTF-t POT-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/rtf-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF konvertálásához POT-vé" h2="RTF exportálása POT-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
