---
title: C++ API a POTM DOTM formátumba konvertálásához
description: Exportálja a POTM-ot DOTM-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez DOTM-ba" h2="Exportálja a POTM-ot DOTM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
