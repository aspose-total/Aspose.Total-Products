---
title: C++ API a PPS OTT formátumba konvertálásához
description: Exportálja a PPS-ot OTT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez OTT-ba" h2="Exportálja a PPS-ot OTT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
