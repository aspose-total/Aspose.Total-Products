---
title: C++ API a PPS DOTX formátumba konvertálásához
description: Exportálja a PPS-ot DOTX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez DOTX-ba" h2="Exportálja a PPS-ot DOTX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
