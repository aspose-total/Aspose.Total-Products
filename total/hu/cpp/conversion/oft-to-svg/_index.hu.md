---
title: Exportálja az OFT-t SVG-be C++-on keresztül
description: C++ API az OFT SVG-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/oft-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API az OFT exportálásához SVG-be" h2="Alakítsa át az OFT-t SVG-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
