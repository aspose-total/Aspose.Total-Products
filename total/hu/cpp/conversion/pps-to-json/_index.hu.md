---
title: Konvertálja az PPS-t JSON formátumba a C++ segítségével
description: Exportálja az PPS-t JSON formátumba C++ formátumban Microsoft Excel vagy Powerpoint használata nélkül
url: /hu/cpp/conversion/pps-to-json/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja az PPS-t JSON formátumba a C++ segítségével" h2="PPS-fájl exportálása JSON formátumba C++-on keresztül Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}

{{% blocks/products/pf/feature-page-summary %}}
Az [Aspose.Total for C++](https://products.aspose.com/total/cpp/) használatával két egyszerű lépésben konvertálhat PPS-fájlt JSON formátumba a C++ alkalmazásokon belül. Először is, az [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) használatával exportálhatja az PPS-t HTML-be. Ezt követően az [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) Spreadsheet Programming API használatával konvertálhatja a HTML-t JSON-ba. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja az PPS-t JSON formátumba a C++ segítségével" %}}
1. Nyissa meg az PPS-fájlt a [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation) osztályhivatkozás használatával
2. Alakítsa át az PPS-t HTML-vé a [Mentés](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba) módszerrel
