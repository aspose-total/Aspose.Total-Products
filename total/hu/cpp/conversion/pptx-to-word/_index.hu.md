---
title: C++ API a PPTX WORD formátumba konvertálásához
description: Exportálja a PPTX-ot WORD-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez WORD-ba" h2="Exportálja a PPTX-ot WORD-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
