...
{{< blocks/products/pf/feature-page-header h1="A XLT konvertálása POWERPOINT formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLT-ből POWERPOINT-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
