---
title: C++ API a POTM RTF formátumba konvertálásához
description: Exportálja a POTM-ot RTF-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez RTF-ba" h2="Exportálja a POTM-ot RTF-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
