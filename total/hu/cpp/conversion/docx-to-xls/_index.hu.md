---
title: Konvertálja a DOCX-t XLS-vé C++-ban
description: C++ API a DOCX konvertálásához XLS-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/docx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOCX XLS-vé konvertálásához" h2="DOCX exportálása XLS-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOCX XLS-vé konvertálásához" %}}
