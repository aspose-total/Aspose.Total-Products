---
title: C++ API a POTX WORDML formátumba konvertálásához
description: Exportálja a POTX-ot WORDML-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez WORDML-ba" h2="Exportálja a POTX-ot WORDML-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
