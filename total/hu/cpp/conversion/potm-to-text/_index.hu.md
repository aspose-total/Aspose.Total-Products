---
title: C++ API a POTM TEXT formátumba konvertálásához
description: Exportálja a POTM-ot TEXT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTM rendereléséhez TEXT-ba" h2="Exportálja a POTM-ot TEXT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
