---
title: Exportálja az MSG-t TEXT-be C++-on keresztül
description: C++ API az MSG TEXT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/msg-to-text/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API az MSG exportálásához TEXT-be" h2="Alakítsa át az MSG-t TEXT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
