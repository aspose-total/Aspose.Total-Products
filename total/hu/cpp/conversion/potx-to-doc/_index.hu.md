---
title: C++ API a POTX DOC formátumba konvertálásához
description: Exportálja a POTX-ot DOC-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/potx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez DOC-ba" h2="Exportálja a POTX-ot DOC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
