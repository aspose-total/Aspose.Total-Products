---
title: C++ API a PPT DOTM formátumba konvertálásához
description: Exportálja a PPT-ot DOTM-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPT rendereléséhez DOTM-ba" h2="Exportálja a PPT-ot DOTM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
