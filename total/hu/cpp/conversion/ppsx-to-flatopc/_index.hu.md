---
title: C++ API a PPSX FLATOPC formátumba konvertálásához
description: Exportálja a PPSX-ot FLATOPC-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSX rendereléséhez FLATOPC-ba" h2="Exportálja a PPSX-ot FLATOPC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
