---
title: Exportálja az EML-t TEXT-be C++-on keresztül
description: C++ API az EML TEXT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/eml-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EML exportálásához TEXT-be" h2="Alakítsa át az EML-t TEXT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
