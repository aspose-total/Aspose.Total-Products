---
title: Konvertálja a DOTM-t XLS-vé C++-ban
description: C++ API a DOTM konvertálásához XLS-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/dotm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOTM XLS-vé konvertálásához" h2="DOTM exportálása XLS-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOTM XLS-vé konvertálásához" %}}
