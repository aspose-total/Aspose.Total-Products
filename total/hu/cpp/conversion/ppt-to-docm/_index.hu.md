---
title: C++ API a PPT DOCM formátumba konvertálásához
description: Exportálja a PPT-ot DOCM-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppt-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPT rendereléséhez DOCM-ba" h2="Exportálja a PPT-ot DOCM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
