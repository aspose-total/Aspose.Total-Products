---
title: A DOTX konvertálása JSON formátumba C++ nyelven
description: Exportálja a DOTX-t JSON-ba C++-ban Microsoft Excel vagy Word használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="A DOTX konvertálása JSON formátumba a C++ segítségével" h2="DOTX exportálása JSON-ba C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Excel használata nélkül" >}}

{{% blocks/products/pf/feature-page-summary %}}
Az [Aspose.Total for C++](https://products.aspose.com/total/cpp/) használatával konvertálhatja a DOTX-t JSON formátumba a C++ alkalmazásaiban. Először is, az [Aspose.Words for C++](https://products.aspose.com/words/cpp/) használatával exportálhatja a DOTX-t HTML-be. Ezt követően az [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) használatával konvertálhatja a HTML-t JSON formátumba. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/cpp/conversion/dotx-to-csv/" name="DOTX Nak nek CSV" description="" >}}
