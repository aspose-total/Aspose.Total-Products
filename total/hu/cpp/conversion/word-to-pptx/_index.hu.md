---
title: A WORD konvertálása PPTX-re C++ segítségével
description: Exportáljon WORD-t PPTX-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/word-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a WORD konvertálásához PPTX-vé" h2="WORD exportálása PPTX-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
