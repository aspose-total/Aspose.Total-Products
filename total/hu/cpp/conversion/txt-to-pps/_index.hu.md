---
title: A TXT konvertálása PPS-re C++ segítségével
description: Exportáljon TXT-t PPS-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
...
{{< blocks/products/pf/feature-page-header h1="C++ API a TXT konvertálásához PPS-vé" h2="TXT exportálása PPS-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
