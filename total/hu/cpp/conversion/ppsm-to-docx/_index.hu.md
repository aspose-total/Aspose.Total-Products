---
title: C++ API a PPSM DOCX formátumba konvertálásához
description: Exportálja a PPSM-ot DOCX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPSM rendereléséhez DOCX-ba" h2="Exportálja a PPSM-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
