---
title: C++ API a PPTX DOTM formátumba konvertálásához
description: Exportálja a PPTX-ot DOTM-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez DOTM-ba" h2="Exportálja a PPTX-ot DOTM-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
