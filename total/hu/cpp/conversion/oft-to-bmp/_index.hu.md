---
title: Exportálja az OFT-t BMP-be C++-on keresztül
description: C++ API az OFT BMP-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/oft-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API az OFT exportálásához BMP-be" h2="Alakítsa át az OFT-t BMP-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API az OFT BMP-vé konvertálásához" %}}
...
Dokumentumvédelmi funkciókat is hozzáadhat az alkalmazáshoz, miközben exportálja a dokumentumot a OFT címről a BMP-be. A védelem hozzáadása a dokumentumhoz egy egyszerű folyamat, hiszen mindössze a védelmi módszert kell alkalmaznia a dokumentumra. A védelem típusát ReadOnly értékre állíthatja, hogy korlátozza a felhasználót a dokumentum szerkesztésében.
{{% blocks/products/pf/feature-page-code %}}
