---
title: C++ API a PPTM TEXT formátumba konvertálásához
description: Exportálja a PPTM-ot TEXT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTM rendereléséhez TEXT-ba" h2="Exportálja a PPTM-ot TEXT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
