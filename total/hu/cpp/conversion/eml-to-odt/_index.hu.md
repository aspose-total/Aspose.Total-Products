---
title: Exportálja az EML-t ODT-be C++-on keresztül
description: C++ API az EML ODT-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/eml-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EML exportálásához ODT-be" h2="Alakítsa át az EML-t ODT-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
