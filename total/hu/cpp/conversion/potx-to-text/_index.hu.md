---
title: C++ API a POTX TEXT formátumba konvertálásához
description: Exportálja a POTX-ot TEXT-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POTX rendereléséhez TEXT-ba" h2="Exportálja a POTX-ot TEXT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/cpp/conversion/potx-to-textx/" name="POTX Nak nek TEXTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/cpp/conversion/potx-to-textm/" name="POTX Nak nek TEXTM" description="" >}}
