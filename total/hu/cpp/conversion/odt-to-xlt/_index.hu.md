---
title: Konvertálja a ODT-t XLT-vé C++-ban
description: C++ API a ODT konvertálásához XLT-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/odt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a ODT XLT-vé konvertálásához" h2="ODT exportálása XLT-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a ODT XLT-vé konvertálásához" %}}
