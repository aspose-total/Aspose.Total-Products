...
{{< blocks/products/pf/feature-page-header h1="C++ API a ODT XLT-vé konvertálásához vagy online" h2="ODT exportálása XLT-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a ODT XLT-vé konvertálásához vagy online" %}}
