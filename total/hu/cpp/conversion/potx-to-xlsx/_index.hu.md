---
title: Konvertálja a POTX-ot XLSX-vé a C++ segítségével
description: Exportálja a POTX-ot XLSX-be C++-ban Microsoft Excel vagy Powerpoint használata nélkül
url: /hu/cpp/conversion/potx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a POTX-ot XLSX-vé a C++ segítségével" h2="POTX-ból XLSX-fájl átalakítás C++-on keresztül Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
