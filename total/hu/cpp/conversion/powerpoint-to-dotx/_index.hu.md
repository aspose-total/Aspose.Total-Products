---
title: C++ API a POWERPOINT DOTX formátumba konvertálásához
description: Exportálja a POWERPOINT-ot DOTX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/powerpoint-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POWERPOINT rendereléséhez DOTX-ba" h2="Exportálja a POWERPOINT-ot DOTX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
