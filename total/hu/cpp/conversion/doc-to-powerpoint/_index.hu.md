---
title: A DOC konvertálása POWERPOINT-re C++ segítségével
description: Exportáljon DOC-t POWERPOINT-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/doc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOC konvertálásához POWERPOINT-vé" h2="DOC exportálása POWERPOINT-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
