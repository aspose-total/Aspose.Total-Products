---
title: C++ API a POT DOC formátumba konvertálásához
description: Exportálja a POT-ot DOC-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POT rendereléséhez DOC-ba" h2="Exportálja a POT-ot DOC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
