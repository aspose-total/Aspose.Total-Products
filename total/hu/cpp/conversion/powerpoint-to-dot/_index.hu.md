---
title: C++ API a POWERPOINT DOT formátumba konvertálásához
description: Exportálja a POWERPOINT-ot DOT-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POWERPOINT rendereléséhez DOT-ba" h2="Exportálja a POWERPOINT-ot DOT-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
