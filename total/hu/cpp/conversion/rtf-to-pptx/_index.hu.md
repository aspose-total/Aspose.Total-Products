---
title: A RTF konvertálása PPTX-re C++ segítségével
description: Exportáljon RTF-t PPTX-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/rtf-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API a RTF konvertálásához PPTX-vé" h2="RTF exportálása PPTX-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
