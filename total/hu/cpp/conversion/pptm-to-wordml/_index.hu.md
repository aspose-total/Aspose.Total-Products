---
title: C++ API a PPTM WORDML formátumba konvertálásához
description: Exportálja a PPTM-ot WORDML-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTM rendereléséhez WORDML-ba" h2="Exportálja a PPTM-ot WORDML-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
