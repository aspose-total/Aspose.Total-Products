---
title: A TXT konvertálása PPSM-re C++ segítségével
description: Exportáljon TXT-t PPSM-be C++-alkalmazásaiban Microsoft Word of PowerPoint használata nélkül
url: /hu/cpp/conversion/txt-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API a TXT konvertálásához PPSM-vé" h2="TXT exportálása PPSM-be a C++-alkalmazásokon belül a Microsoft Word&reg; vagy PowerPoint" >}}
