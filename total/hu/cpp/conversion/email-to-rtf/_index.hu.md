---
title: Exportálja az EMAIL-t RTF-be C++-on keresztül
description: C++ API az EMAIL RTF-vé konvertálásához Microsoft Word vagy Outlook használata nélkül
url: /hu/cpp/conversion/email-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API az EMAIL exportálásához RTF-be" h2="Alakítsa át az EMAIL-t RTF-vé a C++ alkalmazáson belül Microsoft Word vagy Outlook nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API az EMAIL RTF-vé konvertálásához" %}}
...
Dokumentumvédelmi funkciókat is hozzáadhat az alkalmazáshoz, miközben exportálja a dokumentumot a EMAIL címről a RTF-be. A védelem hozzáadása a dokumentumhoz egy egyszerű folyamat, hiszen mindössze a védelmi módszert kell alkalmaznia a dokumentumra. A védelem típusát ReadOnly értékre állíthatja, hogy korlátozza a felhasználót a dokumentum szerkesztésében.
{{% blocks/products/pf/feature-page-code %}}
