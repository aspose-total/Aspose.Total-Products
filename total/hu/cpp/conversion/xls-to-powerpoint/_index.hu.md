---
title: Konvertálja a XLS-t POWERPOINT-ba a C++ segítségével
description: A XLS konvertálása POWERPOINT formátumba a C++ alkalmazásokon belül
url: /hu/cpp/conversion/xls-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="A XLS konvertálása POWERPOINT formátumba C++ segítségével" h2="Exportálás Excel<sup>&reg;</sup> XLS-ből POWERPOINT-ba a teljes funkcionalitású C++ alkalmazásokon belül" >}}
