---
title: C++ API a POT WORD formátumba konvertálásához
description: Exportálja a POT-ot WORD-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POT rendereléséhez WORD-ba" h2="Exportálja a POT-ot WORD-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
