---
title: C++ API a PPTM DOTX formátumba konvertálásához
description: Exportálja a PPTM-ot DOTX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pptm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTM rendereléséhez DOTX-ba" h2="Exportálja a PPTM-ot DOTX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
