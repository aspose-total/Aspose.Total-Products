---
title: C++ API a PPTX DOTX formátumba konvertálásához
description: Exportálja a PPTX-ot DOTX-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez DOTX-ba" h2="Exportálja a PPTX-ot DOTX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
