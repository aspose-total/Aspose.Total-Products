---
title: C++ API a PPTX RTF formátumba konvertálásához
description: Exportálja a PPTX-ot RTF-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez RTF-ba" h2="Exportálja a PPTX-ot RTF-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
