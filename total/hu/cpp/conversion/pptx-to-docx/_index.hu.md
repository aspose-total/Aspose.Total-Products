---
title: C++ API a PPTX DOCX formátumba konvertálásához
description: Exportálja a PPTX-ot DOCX-ba a C++ alkalmazásaiban
url: /hu/cpp/conversion/pptx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPTX rendereléséhez DOCX-ba" h2="Exportálja a PPTX-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
