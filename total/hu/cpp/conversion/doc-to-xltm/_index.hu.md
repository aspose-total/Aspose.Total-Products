---
title: Konvertálja a DOC-t XLTM-vé C++-ban
description: C++ API a DOC konvertálásához XLTM-vé Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/cpp/conversion/doc-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API a DOC XLTM-vé konvertálásához" h2="DOC exportálása XLTM-be C++-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOC XLTM-vé konvertálásához" %}}
