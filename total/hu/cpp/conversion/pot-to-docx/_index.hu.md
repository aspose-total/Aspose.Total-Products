---
title: C++ API a POT DOCX formátumba konvertálásához
description: Exportálja a POT-ot DOCX-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a POT rendereléséhez DOCX-ba" h2="Exportálja a POT-ot DOCX-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
