---
title: C++ API a PPS FLATOPC formátumba konvertálásához
description: Exportálja a PPS-ot FLATOPC-ba a C++ alkalmazásaiban
...
{{< blocks/products/pf/feature-page-header h1="C++ API a PPS rendereléséhez FLATOPC-ba" h2="Exportálja a PPS-ot FLATOPC-ba C++ alkalmazásokban Microsoft PowerPoint vagy Word függőség nélkül" >}}
