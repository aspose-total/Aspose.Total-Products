---
title: Távolítsa el a ODP Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a ODP fájlból az online alkalmazáson keresztül.C++ API kód a ODP fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a ODP Presentation Online-ból vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú ODP prezentációs annotációs segédprogram fejlesztése.A ODP fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a ODP prezentáció megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. ODP bemutató betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések és szerzők törlése a ODP prezentációból" offSpacer="" %}}
...
<h2>ODP dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a ODP fájlok megjegyzéseivel" %}}
