---
title: Távolítsa el a PPS Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a PPS fájlból az online alkalmazáson keresztül.C++ API kód a PPS fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a PPS Presentation Online-ból vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú PPS prezentációs annotációs segédprogram fejlesztése.A PPS fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a PPS prezentáció megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. PPS bemutató betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések és szerzők törlése a PPS prezentációból" offSpacer="" %}}
...
<h2>PPS dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a PPS fájlok megjegyzéseivel" %}}
