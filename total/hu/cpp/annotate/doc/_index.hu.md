---
title: Távolítsa el a DOC Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a DOC fájlból az online alkalmazáson keresztül. C++ API kód a DOC fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOC Document Online alkalmazásból, vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú DOC dokumentum annotációs segédprogram fejlesztése. A DOC fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Törölje a DOC dokumentum megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. DOC fájl betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések törlése a DOC fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzés hozzáadása a DOC fájlhoz" offSpacer="" %}}
...
<h2>DOC dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a DOC fájlok megjegyzéseivel" %}}
