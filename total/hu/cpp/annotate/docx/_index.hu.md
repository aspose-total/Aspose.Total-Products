---
title: Távolítsa el a DOCX Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a DOCX fájlból az online alkalmazáson keresztül. C++ API kód a DOCX fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOCX Document Online alkalmazásból, vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú DOCX dokumentum annotációs segédprogram fejlesztése. A DOCX fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Törölje a DOCX dokumentum megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. DOCX fájl betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések törlése a DOCX fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzés hozzáadása a DOCX fájlhoz" offSpacer="" %}}
...
<h2>DOCX dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a DOCX fájlok megjegyzéseivel" %}}
