---
title: Távolítsa el a PPTM Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a PPTM fájlból az online alkalmazáson keresztül.C++ API kód a PPTM fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a PPTM Presentation Online-ból vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú PPTM prezentációs annotációs segédprogram fejlesztése.A PPTM fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a PPTM prezentáció megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. PPTM bemutató betöltése
1. Ismételje meg az egyes szerzőket a bemutatón keresztül->get_CommentAuthors()
1. Hívja meg a get_Comments()->Clear() metódust a megjegyzés törléséhez
1. Hívja meg a get_CommentAuthors()->Clear() metódust az összes szerző eltávolításához
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések és szerzők törlése a PPTM prezentációból" offSpacer="" %}}
...
<h2>PPTM dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>

PPTM annotációs alkalmazást vagy segédprogramot kell fejlesztenie, hogy visszajelzést adjon, javaslatokat tegyen, vagy együttműködjön másokkal a dokumentumon?A [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/)-tal a [Aspose.Total for C++](https://products.aspose.com/total/hu/cpp/) gyermek API-jával bármely C++ fejlesztő integrálhatja a fenti API-kódot dokumentumannotációs alkalmazásába.A nagy teljesítményű C++ könyvtár lehetővé teszi bármilyen dokumentum annotációs megoldás programozását.Ezenkívül számos népszerű formátumot támogat, beleértve a PPTM formátumot.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a PPTM fájlok megjegyzéseivel" %}}
...
- Install a [NuGet csomag](https://www.nuget.org/packages/Aspose.Slides.Cpp/). See [Dokumentáció](https://docs.aspose.com/slides/cpp/installation/#option-one-install-or-update-asposeslides-for-c-from-the-nuget-package-manager)
