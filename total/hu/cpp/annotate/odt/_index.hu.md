---
title: Távolítsa el a ODT Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a ODT fájlból az online alkalmazáson keresztül. C++ API kód a ODT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a ODT Document Online alkalmazásból, vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú ODT dokumentum annotációs segédprogram fejlesztése. A ODT fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Törölje a ODT dokumentum megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. ODT fájl betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések törlése a ODT fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzés hozzáadása a ODT fájlhoz" offSpacer="" %}}
...
<h2>ODT dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a ODT fájlok megjegyzéseivel" %}}
