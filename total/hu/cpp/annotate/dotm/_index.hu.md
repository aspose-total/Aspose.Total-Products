---
title: Távolítsa el a DOTM Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a DOTM fájlból az online alkalmazáson keresztül. C++ API kód a DOTM fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOTM Document Online alkalmazásból, vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú DOTM dokumentum annotációs segédprogram fejlesztése. A DOTM fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Törölje a DOTM dokumentum megjegyzéseit a C++ segítségével" %}}

1. Adjon hozzá könyvtári hivatkozást a C++ projekthez
1. DOTM fájl betöltése
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések törlése a DOTM fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzés hozzáadása a DOTM fájlhoz" offSpacer="" %}}
...
<h2>DOTM dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a DOTM fájlok megjegyzéseivel" %}}
