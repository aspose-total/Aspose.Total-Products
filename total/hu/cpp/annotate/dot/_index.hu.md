---
title: Távolítsa el a DOT Annotation Online-t vagy kezelje a megjegyzéseket a C++ segítségével
description: ingyenesen törölje a megjegyzéseket a DOT fájlból az online alkalmazáson keresztül. C++ API kód a DOT fájlok megjegyzéseinek kezeléséhez.
...
{{< blocks/products/pf/feature-page-header-widget h1="Törölje a megjegyzéseket a DOT Document Online alkalmazásból, vagy kezelje a C++ segítségével" h2="Hatékony C++ alapú DOT dokumentum annotációs segédprogram fejlesztése. A DOT fájl megjegyzéseinek C++-on keresztüli kezeléséhez felsorolt kód." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Törölje a DOT dokumentum megjegyzéseit a C++ segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzések törlése a DOT fájlból" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ kód: Megjegyzés hozzáadása a DOT fájlhoz" offSpacer="" %}}
...
<h2>DOT dokumentumannotációs alkalmazás fejlesztése C++ segítségével</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ könyvtár a DOT fájlok megjegyzéseivel" %}}
