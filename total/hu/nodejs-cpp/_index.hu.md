---
title: PDF-kezelés és OCR-kiegészítés Node.js API-kon keresztül
description: Node.js API a PDF-fájlok kezeléséhez, valamint a képekből az alkalmazásokon keresztül szövegek kinyeréséhez.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API PDF- és képszöveg-kivonáshoz" h2="Szöveg kinyerése a képekből, valamint PDF-kezelési funkciók beépítése a Node.js alkalmazásokba minden egyéb szoftverfüggőség nélkül" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Az Aspose.Total for Node.js a C++-on keresztül a Node.js könyvtárak mindenre kiterjedő készlete.Ezek a könyvtárak olyan funkciókat kínálnak, mint például a PDF-ekkel való közvetlen munkavégzés, valamint az alkalmazások fejlesztése a képek szöveggé alakításához.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Az Aspose.Total for Node.js a C++-on keresztül a következő Node.js könyvtárakat tartalmazza:" >}}
...
Az Aspose.PDF for Node.js C++-on keresztül lehetővé teszi a PDF-fájlok kezelését a háttérben. Használatával optimalizálhatja a PDF-eket, beépíthet és kivonhat szöveget és képeket, valamint végrehajthat titkosítási és visszafejtési folyamatokat. Ezen túlmenően a funkcionalitás kiterjed a PDF-dokumentumok könnyű felosztására és egyesítésére, így átfogó eszközkészletet biztosít a PDF-fájlok egyszerű kezeléséhez.
...
<h2 class="pr-ft">
 ...
 A Node.js áttekintése a C++ könyvtárakon keresztül
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Képek hozzáadása a PDF dokumentumokhoz
 </p>
</div>
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  PDF titkosítása és visszafejtése
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Szöveg kinyerése okostelefonon készült fényképekből szkennelési szintű pontossággal.
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Bármely beolvasott dokumentumot konvertálhat teljes mértékben kereshető és indexelhető dokumentummá.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Kép felismerése az URL-ből anélkül, hogy helyileg letöltené.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Olvassa el az összes képet többoldalas dokumentumokból, mappákból és archívumokból.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Szöveg azonosítása és felismerése az összes népszerű betűtípusban és stílusban.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Módosítsa az összes OCR paramétert a legjobb felismerési eredmény érdekében.
    </p>
   </div>
...
Valójában az Aspose.Total for .NET csomag az általunk használt komponensek „svájci kése”. A prezentációs réteg komponensei mellett ülve képezi a „ragasztót” az adatfájlok kívánt formátumú lehúzásához és tolásához.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualetech, Franciaország" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Miért Aspose.Total C++-hoz" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Az Aspose.Total egyedi megoldásokat kínál más platformokhoz." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/hu/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/hu/nodejs-java/" 
