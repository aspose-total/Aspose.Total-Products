---
title: Tekintse meg a Word fájlt online és Java használatával
description: Ingyenes online Word fájlnézegető alkalmazás. Java API kód a Word fájl megtekintéséhez a megjelenítő alkalmazáshoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szabadon megtekintheti a Word fájlt online vagy Java-n keresztül" h2="Hatékony Java alapú Word dokumentumnézegető segédprogram fejlesztése.A listában szereplő kód a Word dokumentum Java-n keresztüli megtekintéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Word fájl megtekintése Java-n keresztül" %}}

1. Java könyvtár hivatkozás hozzáadása a projekthez
1. Forrás Word fájl betöltése Dokumentumosztály objektum használatával
...
{{% blocks/products/pf/agp/code-block title="Java kód a Word fájlok megtekintéséhez" offSpacer="" %}}
...
<h2>Word fájlnézegető alkalmazás fejlesztése Java-n keresztül</h2>

Word megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Words for Java](https://products.aspose.com/words/hu/java/)-tal a [Aspose.Total for Java](https://products.aspose.com/total/hu/java/) gyermek API-jával bármely Java fejlesztő integrálhatja a fenti API kódot a dokumentumnézegető alkalmazásába.A nagy teljesítményű Java könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a Word formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java segédprogram a Word fájl feldolgozásához a megjelenítő alkalmazáshoz" %}}
