---
title: Tekintse meg a XLS fájlt online és Java használatával
description: Ingyenes online XLS fájlnézegető alkalmazás. Java API kód a XLS fájl olvasásához a megjelenítő alkalmazáshoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szabadon megtekintheti a XLS fájlt online vagy Java-n keresztül" h2="Hatékony Java alapú XLS dokumentumnézegető segédprogram fejlesztése.A kód listája a XLS dokumentum Java-n keresztüli megtekintéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS fájl megtekintése Java-n keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Java kód a XLS fájlok megtekintéséhez" offSpacer="" %}}
...
<h2>XLS fájlnézegető alkalmazás fejlesztése Java-n keresztül</h2>

XLS megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Cells for Java](https://products.aspose.com/cells/hu/java/) a [Aspose.Total for Java](https://products.aspose.com/total/hu/java/) gyermek API-jával, bármely Java fejlesztő integrálhatja a fenti API kódot a dokumentumnézegető alkalmazásába.A nagy teljesítményű Java könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a XLS formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java segédprogram a XLS fájl feldolgozásához a megjelenítő alkalmazáshoz" %}}
