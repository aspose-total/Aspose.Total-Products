---
title: Tekintse meg a DOTX fájlt online és Java használatával
description: Ingyenes online DOTX fájlnézegető alkalmazás. Java API kód a DOTX fájl megtekintéséhez a megjelenítő alkalmazáshoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szabadon megtekintheti a DOTX fájlt online vagy Java-n keresztül" h2="Hatékony Java alapú DOTX dokumentumnézegető segédprogram fejlesztése.A listában szereplő kód a DOTX dokumentum Java-n keresztüli megtekintéséhez." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX fájl megtekintése Java-n keresztül" %}}

1. Java könyvtár hivatkozás hozzáadása a projekthez
1. Forrás DOTX fájl betöltése Dokumentumosztály objektum használatával
...
{{% blocks/products/pf/agp/code-block title="Java kód a DOTX fájlok megtekintéséhez" offSpacer="" %}}
...
<h2>DOTX fájlnézegető alkalmazás fejlesztése Java-n keresztül</h2>

DOTX megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Words for Java](https://products.aspose.com/words/hu/java/)-tal a [Aspose.Total for Java](https://products.aspose.com/total/hu/java/) gyermek API-jával bármely Java fejlesztő integrálhatja a fenti API kódot a dokumentumnézegető alkalmazásába.A nagy teljesítményű Java könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a DOTX formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java segédprogram a DOTX fájl feldolgozásához a megjelenítő alkalmazáshoz" %}}
