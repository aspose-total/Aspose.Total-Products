---
title: Tekintse meg a DOCM fájlt online és Java használatával
description: Ingyenes online DOCM fájlnézegető alkalmazás. Java API kód a DOCM fájl megtekintéséhez a megjelenítő alkalmazáshoz.
...
{{< blocks/products/pf/feature-page-header-widget h1="Szabadon megtekintheti a DOCM fájlt online vagy Java-n keresztül" h2="Hatékony Java alapú DOCM dokumentumnézegető segédprogram fejlesztése.A listában szereplő kód a DOCM dokumentum Java-n keresztüli megtekintéséhez." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tekintse meg a DOCM dokumentumot az online alkalmazáson keresztül" %}}

1. Importáljon DOCM fájlt a megtekintéshez feltöltéssel.
...
1. Több oldalas DOCM dokumentum esetén navigálhat az oldalak között.
1. Állítsa be az oldalnézet nagyítását vagy kicsinyítését.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="DOCM fájl megtekintése Java-n keresztül" %}}

1. Java könyvtár hivatkozás hozzáadása a projekthez
1. Forrás DOCM fájl betöltése Dokumentumosztály objektum használatával
...
{{% blocks/products/pf/agp/code-block title="Java kód a DOCM fájlok megtekintéséhez" offSpacer="" %}}
...
<h2>DOCM fájlnézegető alkalmazás fejlesztése Java-n keresztül</h2>

DOCM megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Words for Java](https://products.aspose.com/words/hu/java/)-tal a [Aspose.Total for Java](https://products.aspose.com/total/hu/java/) gyermek API-jával bármely Java fejlesztő integrálhatja a fenti API kódot a dokumentumnézegető alkalmazásába.A nagy teljesítményű Java könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a DOCM formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java segédprogram a DOCM fájl feldolgozásához a megjelenítő alkalmazáshoz" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Biztonságos az online alkalmazás használata DOCM dokumentum megtekintéséhez?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
