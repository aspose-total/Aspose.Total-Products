---
title: Online XSLFO konvertálás ODP-re vagy Java alapú alkalmazás fejlesztése XSLFO fájlok konvertálására
description: Ingyenes online alkalmazás az XSLFO fájl ODP fájlokká konvertálásához. Java konverziós könyvtár kódja XSLFO dokumentumokhoz.  
...
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja az XSLFO-t ODP-re a Java Automation API-n keresztül" %}}
...
{{% blocks/products/pf/agp/code-block title="Java kód az XSLFO ODP konvertáláshoz" offSpacer="" %}}
...
Még néhány eset a(z) XSLFO elmentésére a(z) ODP állományba más funkciókkal, mint például az Konverziós követelmények, Nyissa meg a titkosított XSLFO fájlt Java-n keresztül.
