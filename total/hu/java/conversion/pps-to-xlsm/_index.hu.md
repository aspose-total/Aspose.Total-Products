...
{{< blocks/products/pf/i18n/feature-page-header h1="PPS konvertálása XLSM-vé Java segítségével vagy online" h2="On Premise Java API a PPS exportálásához XLSM formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
