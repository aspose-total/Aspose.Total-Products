---
title: Konvertálja a PDF-et OTP-vé Java API-n keresztül
description: Java API a PDF konvertálásához OTP-vé Microsoft Word használata nélkül
url_ignore: /hu/java/conversion/pdf-to-otp/
family: total
platformtag: net
feature: conversion
informat: PDF
