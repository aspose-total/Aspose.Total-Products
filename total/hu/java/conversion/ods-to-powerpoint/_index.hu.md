---
title: A ODS konvertálása POWERPOINT formátumba Java segítségével
description: Java API a ODS exportálásához POWERPOINT-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a ODS exportálásához POWERPOINT-ba" h2="On Premise Java API a ODS exportálásához POWERPOINT-ba anélkül, hogy a Microsoft Excel&reg;" >}}
