...
{{< blocks/products/pf/i18n/feature-page-header h1="PPT konvertálása XLT-vé Java segítségével vagy online" h2="On Premise Java API a PPT exportálásához XLT formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
