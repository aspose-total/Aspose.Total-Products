---
title: A ODS konvertálása PPTX formátumba Java segítségével
description: Java API a ODS exportálásához PPTX-ba Excel vagy Word használatával
url_ignore: /hu/java/conversion/ods-to-pptx/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a ODS exportálásához PPTX-ba" h2="On Premise Java API a ODS exportálásához PPTX-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/ods-to-pptxx/" name="ODS Nak nek PPTXX" description="" >}}
