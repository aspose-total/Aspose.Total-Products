...
{{< blocks/products/pf/i18n/feature-page-header h1="PPSX konvertálása EXCEL-vé Java segítségével vagy online" h2="On Premise Java API a PPSX exportálásához EXCEL formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
