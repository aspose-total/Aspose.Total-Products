---
title: A DOC konvertálása PPSM-re Java segítségével
description: Java API a DOC exportálásához PPSM-be Microsoft Word vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A DOC konvertálása PPSM-re Java segítségével" h2="DOC konvertálása PPSM-be helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül Microsoft<sup>&reg;</sup> PowerPoint vagy Word használata nélkül" >}}
...
A DOC-fájl PPSM-vé konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
