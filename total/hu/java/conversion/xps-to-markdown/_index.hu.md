---
title: Java API a XPS exportálásához MARKDOWN-be
description: Konvertálja a XPS-et MARKDOWN-re a helyszíni Java API használatával
url_ignore: /hu/java/conversion/xps-to-markdown/
family: total
platformtag: net
feature: conversion
informat: XPS
