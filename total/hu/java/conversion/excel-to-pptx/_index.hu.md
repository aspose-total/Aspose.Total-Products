...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a EXCEL exportálásához PPTX-ba vagy online" h2="On Premise Java API a EXCEL exportálásához PPTX-ba vagy online anélkül, hogy a Microsoft Excel<sup>&reg;</sup>" >}}
...
4. Mentse a dokumentumot PPTX formátumba a [save](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions) segítségével-) metódust, és állítsa be a Pptx-ot SaveFormat-ként
...
<h3>Online konverter EXCEL-hez PPTX-be</h3>
