...
{{< blocks/products/pf/i18n/feature-page-header h1="PPTX konvertálása XLTM-vé Java segítségével vagy online" h2="On Premise Java API a PPTX exportálásához XLTM formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
