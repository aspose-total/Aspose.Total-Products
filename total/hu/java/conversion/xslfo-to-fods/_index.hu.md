---
title: Java API a XSLFO FODS formátumban való megjelenítéséhez
description: XSLFO exportálása FODS formátumba Java API-n keresztül Microsoft Excel vagy Adobe Reader használata nélkül
url_ignore: /hu/java/conversion/xslfo-to-fods/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="XSLFO exportálása FODS-be Java-n keresztül" h2="XSLFO-fájl konvertálása FODS-vé a helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
{{% blocks/products/pf/feature-page-summary %}}
Az [Aspose.Total for Java](https://products.aspose.com/total/java/) használatával kétlépéses folyamatban integrálhatja a XSLFO-ből FODS-vé konvertáló funkciót Java-alkalmazásaiba. Először is, az [Aspose.PDF for Java](https://products.aspose.com/pdf/java/) használatával a XSLFO XLSX formátumba renderelhető. A második lépésben az XLSX-et FODS-vé konvertálhatja a Spreadsheet Programming API [Aspose.Cells for Java](https://products.aspose.com/cells/java/) segítségével.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertálja a XSLFO fájlt FODS-vé Java segítségével" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertálja a védett XSLFO-et FODS-vé Java segítségével" %}}
A XSLFO-fájl FODS-vé konvertálásakor vízjelet is hozzáadhat a kimeneti FODS-fájlformátumhoz. Vízjel hozzáadásához hozzon létre egy új munkafüzetet a konvertált XLSX fájl megnyitásához. Válassza ki a Munkalapot az indexén keresztül, hozzon létre egy alakzatot, és használja az addTextEffect funkciót, állítsa be a színeket, az átlátszóságot és így tovább. Ezt követően elmentheti az XLSX-dokumentumot FODS-ként vízjellel. 
{{% blocks/products/pf/feature-page-code %}}
