---
title: A EXCEL konvertálása DOCX formátumba Java segítségével
description: Java API a EXCEL exportálásához DOCX-ba Excel vagy Word használatával
url: /hu/java/conversion/excel-to-docx/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a EXCEL exportálásához DOCX-ba" h2="On Premise Java API a EXCEL exportálásához DOCX-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/excel-to-docxx/" name="EXCEL Nak nek DOCXX" description="" >}}
