---
title: A SXC konvertálása DOC formátumba Java segítségével
description: Java API a SXC exportálásához DOC-ba Excel vagy Word használatával
url: /hu/java/conversion/sxc-to-doc/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a SXC exportálásához DOC-ba" h2="On Premise Java API a SXC exportálásához DOC-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/sxc-to-docx/" name="SXC Nak nek DOCX" description="" >}}
