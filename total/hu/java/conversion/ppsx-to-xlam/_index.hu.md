...
description: Konvertálja a PPSX-ot XLAM formátumba Java segítségével Microsoft Excel vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="PPSX konvertálása XLAM-vé Java segítségével" h2="On Premise Java API a PPSX exportálásához XLAM formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
