---
title: A DOT konvertálása PPS-re Java segítségével
description: Java API a DOT exportálásához PPS-be Microsoft Word vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A DOT konvertálása PPS-re Java segítségével" h2="DOT konvertálása PPS-be helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül Microsoft<sup>&reg;</sup> PowerPoint vagy Word használata nélkül" >}}
...
2. Alakítsa át a DOT fájlt HTML formátumba a [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions) segítségével)) módszer
...
A DOT-fájl PPS-vé konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
