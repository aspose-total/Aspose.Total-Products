...
description: A OTT konvertálása SXC-vé Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A OTT konvertálása SXC-vé Java segítségével" h2="On Premise Java API a OTT konvertálásához SXC-vé Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
