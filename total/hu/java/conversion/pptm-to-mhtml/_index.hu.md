...
description: Konvertálja a PPTM-ot MHTML formátumba Java segítségével Microsoft Excel vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="PPTM konvertálása MHTML-vé Java segítségével" h2="On Premise Java API a PPTM exportálásához MHTML formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
