---
title: A XLTX konvertálása DOC formátumba Java segítségével
description: Java API a XLTX exportálásához DOC-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLTX exportálásához DOC-ba" h2="On Premise Java API a XLTX exportálásához DOC-ba anélkül, hogy a Microsoft Excel&reg;" >}}
