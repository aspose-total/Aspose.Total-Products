---
title: A XLT konvertálása DOC formátumba Java segítségével vagy ingyenes online konverterrel
description: Java API a XLT exportálásához DOC-ba vagy online Excel vagy Word használatával vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes CSV-DOC online konvertert.
url_ignore: /hu/java/conversion/xlt-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLT exportálásához DOC-ba vagy online" h2="On Premise Java API a XLT exportálásához DOC-ba vagy online anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet XLT-t DOC-ba konvertálni Java API-n keresztül" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/xlt-to-docx/" name="XLT Nak nek DOCX" description="" >}}
