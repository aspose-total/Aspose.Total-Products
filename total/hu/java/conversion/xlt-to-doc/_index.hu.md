---
title: A XLT konvertálása DOC formátumba Java segítségével
description: Java API a XLT exportálásához DOC-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLT exportálásához DOC-ba" h2="On Premise Java API a XLT exportálásához DOC-ba anélkül, hogy a Microsoft Excel&reg;" >}}
