---
title: Konvertálja a PPTX-ot WORDML-ba Java segítségével
description: Java API a PPTX exportálásához WORDML-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/pptx-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPTX-ot WORDML-ba Java segítségével" h2="On Premise Java API a PowerPoint PPTX-ból WORDML konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
3. Töltse be a konvertált HTML-fájlt a [Wordmlument](https://apireference.aspose.com/words/java/com.aspose.words/Wordmlument) osztály használatával
4. Mentse a dokumentumot WORDML formátumba a [save](https://apireference.aspose.com/words/java/com.aspose.words/Wordmlument#save(java.lang.String,int)) módszerrel
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Konverziós követelmények" %}}
A PPTX-ból WORDML-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/pptx-to-wordmlm/" name="PPTX Nak nek WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/pptx-to-wordmlx/" name="PPTX Nak nek WORDMLX" description="" >}}
