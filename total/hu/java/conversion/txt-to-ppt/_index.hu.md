---
title: A TXT konvertálása PPT-re Java segítségével
description: Java API a TXT exportálásához PPT-be Microsoft Word vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A TXT konvertálása PPT-re Java segítségével" h2="TXT konvertálása PPT-be helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül Microsoft<sup>&reg;</sup> PowerPoint vagy Word használata nélkül" >}}
