...
description: A DOTM konvertálása DIF-vé Java segítségével vagy Online App Microsoft Word vagy Microsoft Excel használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes DOTM-DIF online konvertert. 
...
{{% blocks/products/pf/agp/feature-section-col title="Java API a DOTM konvertálásához DIF-vé" %}}
...
<iframe title="dotm-ból dif-be konvertáló online eszköz" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dif&from=dotm" id="child-iframe" width="80%"></iframe>
