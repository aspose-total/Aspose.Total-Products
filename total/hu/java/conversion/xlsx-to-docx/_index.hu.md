---
title: A XLSX konvertálása DOCX formátumba Java segítségével
description: Java API a XLSX exportálásához DOCX-ba Excel vagy Word használatával
url_ignore: /hu/java/conversion/xlsx-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLSX exportálásához DOCX-ba" h2="On Premise Java API a XLSX exportálásához DOCX-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/xlsx-to-docxx/" name="XLSX Nak nek DOCXX" description="" >}}
