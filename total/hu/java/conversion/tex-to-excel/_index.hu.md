---
title: Java API a TEX EXCEL formátumban való megjelenítéséhez
description: TEX exportálása EXCEL formátumba Java API-n keresztül Microsoft Excel vagy Adobe Reader használata nélkül
url_ignore: /hu/java/conversion/tex-to-excel/
family: total
platformtag: net
feature: conversion
informat: TEX
