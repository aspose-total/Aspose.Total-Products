...
description: A RTF konvertálása DIF-vé Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A RTF konvertálása DIF-vé Java segítségével" h2="On Premise Java API a RTF konvertálásához DIF-vé Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
