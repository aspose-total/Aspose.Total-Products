...
2. Inicializálja a osztályobjektumot, és a [Process](https://reference.aspose.com/pdf/java/com.aspose.pdf.devices/JpegDevice#process-com) segítségével jelenítse meg a PDF-et JPEG formátumba. aspose.pdf.Page-java.io.OutputStream-) metódus
