---
title: A SXC konvertálása WORD formátumba Java segítségével
description: Java API a SXC exportálásához WORD-ba Excel vagy Word használatával
url: /hu/java/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a SXC exportálásához WORD-ba" h2="On Premise Java API a SXC exportálásához WORD-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/sxc-to-wordx/" name="SXC Nak nek WORDX" description="" >}}
