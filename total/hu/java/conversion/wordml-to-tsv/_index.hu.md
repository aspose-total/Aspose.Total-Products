...
{{% blocks/products/pf/agp/feature-section-col title="Java API a WORDML konvertálásához TSV-vé" %}}
...
<iframe title="wordml-ból tsv-be konvertáló online eszköz" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=tsv&from=wordml" id="child-iframe" width="80%"></iframe>
