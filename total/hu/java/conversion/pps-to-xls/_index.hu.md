---
title: Konvertálja a PPS-ot XLS formátumba Java segítségével
description: Konvertálja a PPS-ot XLS formátumba Java segítségével Microsoft Excel vagy PowerPoint használata nélkül vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes POT-CSV online konvertert. vagy ingyenes online konverterrel
...
{{< blocks/products/pf/i18n/feature-page-header h1="PPS konvertálása XLS-vé Java segítségével vagy online" h2="On Premise Java API a PPS exportálásához XLS formátumba Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
