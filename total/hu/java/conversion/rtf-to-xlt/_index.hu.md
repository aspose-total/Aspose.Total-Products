---
title: Java API a RTF konvertálásához XLT-vé
description: A RTF konvertálása XLT-vé Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/java/conversion/rtf-to-xlt/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="A RTF konvertálása XLT-vé Java segítségével" h2="On Premise Java API a RTF konvertálásához XLT-vé Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API a RTF konvertálásához XLT-vé" %}}
...
2. A [Mentés](https://apireference.aspose.com/words/java/com.aspose.words/Rtfument#save(java.lang.String,com.aspose.words.SaveOptions) segítségével konvertálja a RTF-t HTML-vé. ) módszerrel
...
Az Aspose.Total for Java könnyen használható közvetlenül [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) alapú projektből és tartalmazza az [Aspose.Words for Java](https://rtfs.aspose.com/words/java/installation/) és az [Aspose.Cells for Java](https://rtfs.aspose.com/cells/java/) install/) a pom.xml-ben.
