---
title: Konvertálja a POTX-ot DOC-ba Java segítségével
description: Java API a POTX exportálásához DOC-ba Microsoft Word vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POTX-ot DOC-ba Java segítségével" h2="On Premise Java API a PowerPoint POTX-ból DOC konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
A POTX-ból DOC-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
