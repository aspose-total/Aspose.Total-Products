---
title: A FODS konvertálása WORD formátumba Java segítségével
description: Java API a FODS exportálásához WORD-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a FODS exportálásához WORD-ba" h2="On Premise Java API a FODS exportálásához WORD-ba anélkül, hogy a Microsoft Excel&reg;" >}}
