---
title: A XLTM konvertálása PPTX formátumba Java segítségével
description: Java API a XLTM exportálásához PPTX-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLTM exportálásához PPTX-ba" h2="On Premise Java API a XLTM exportálásához PPTX-ba anélkül, hogy a Microsoft Excel&reg;" >}}
...
1. Nyissa meg a XLTM-fájlt a [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) osztály használatával
