---
title: A XLTM konvertálása DOCX formátumba Java segítségével
description: Java API a XLTM exportálásához DOCX-ba Excel vagy Word használatával
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLTM exportálásához DOCX-ba" h2="On Premise Java API a XLTM exportálásához DOCX-ba anélkül, hogy a Microsoft Excel&reg;" >}}
