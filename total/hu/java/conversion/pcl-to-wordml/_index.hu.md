---
title: Java API a PCL exportálásához WORDML-be
description: Konvertálja a PCL-et WORDML-re a helyszíni Java API használatával
url: /hu/java/conversion/pcl-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="A PCL átalakítása WORDML-re Java segítségével" h2="On Premise Java API a PCL megjelenítéséhez WORDML-ben harmadik féltől származó alkalmazások használata nélkül" >}}
{{% blocks/products/pf/feature-page-summary %}}
Két egyszerű lépéssel a PCL-et WORDML-má konvertálhatja. Először is le kell renderelnie a PCL-fájlt DOC-ban az [Aspose.PDF for Java] használatával (https://products.aspose.com/pdf/java/). Ezt követően a hatékony dokumentumfeldolgozási API [Aspose.Words for Java](https://products.aspose.com/words/java/) használatával a DOC-t WORDML-má konvertálhatja. Mindkét API az [Aspose.Total for Java](https://products.aspose.com/total/java/) csomagban található.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java API a PCL WORDML-má konvertálásához" %}}
