...
description: A DOTM konvertálása XLTM-vé Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="A DOTM konvertálása XLTM-vé Java segítségével" h2="On Premise Java API a DOTM konvertálásához XLTM-vé Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
