---
title: Konvertálja a PPTX-ot DOTX-ba Java segítségével
description: Java API a PPTX exportálásához DOTX-ba Microsoft Word vagy PowerPoint használata nélkül
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPTX-ot DOTX-ba Java segítségével" h2="On Premise Java API a PowerPoint PPTX-ból DOTX konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
4. Mentse a dokumentumot DOTX formátumba a [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) módszerrel
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Konverziós követelmények" %}}
A PPTX-ból DOTX-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
