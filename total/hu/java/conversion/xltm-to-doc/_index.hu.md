---
title: A XLTM konvertálása DOC formátumba Java segítségével vagy ingyenes online konverterrel
description: Java API a XLTM exportálásához DOC-ba vagy online Excel vagy Word használatával vagy online. A kód integrálása előtt gyorsan tesztelje az ingyenes CSV-DOC online konvertert.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API a XLTM exportálásához DOC-ba vagy online" h2="On Premise Java API a XLTM exportálásához DOC-ba vagy online anélkül, hogy a Microsoft Excel<sup>&reg;</sup>" >}}
