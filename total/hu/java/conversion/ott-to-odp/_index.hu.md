---
title: A OTT konvertálása ODP-re Java segítségével
description: Java API a OTT exportálásához ODP-be Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/ott-to-odp/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="A OTT konvertálása ODP-re Java segítségével" h2="OTT konvertálása ODP-be helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül Microsoft<sup>&reg;</sup> PowerPoint vagy Word használata nélkül" >}}
...
A OTT-fájl ODP-vé konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
