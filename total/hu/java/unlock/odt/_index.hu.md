---
title: Távolítsa el a ODT jelszóvédelmet online vagy Java használatával
description: Ingyenesen oldja fel a jelszót a ODT dokumentumból az online alkalmazáson keresztül. Java API kód a jelszó törléséhez a ODT fájlokból.
...
{{< blocks/products/pf/feature-page-header-widget h1="Oldja fel a ODT dokumentumjelszót online vagy Java-n keresztül" h2="Hatékony Java alapú ODT dokumentumfeloldó segédprogram fejlesztése.A jelszókorlátozások eltávolítására szolgáló kód a ODT fájlból Java-n keresztül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a ODT jelszót Java-n keresztül" %}}

1. Referencia Java könyvtár a projekten belül
1. Töltsön be jelszóval védett ODT fájlt a Dokumentum osztály használatával
...
{{% blocks/products/pf/agp/code-block title="Java kód a jelszó eltávolításához a ODT dokumentumból" offSpacer="" %}}
...
<h2>ODT védelemkezelő alkalmazás fejlesztése Java-n keresztül</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java segédprogram a ODT védelem kezelésére" %}}
