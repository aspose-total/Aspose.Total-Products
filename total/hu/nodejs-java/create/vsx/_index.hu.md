---
title: Hozzon létre VSX Visio diagramokat a Node.js-ben
description: Microsoft Visio VSX diagramok létrehozása Node-alkalmazásokkal Microsoft Office használata nélkül.  
...
{{< blocks/products/pf/feature-page-header h1="Hozzon létre VSX fájlt a Node.js használatával" h2="Hozzon létre Microsoft Visio VSX fájlokat a csomópont-alkalmazásokon keresztül, bármilyen más szoftver telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hozzon létre VSX fájlt a Node.js-ben" %}}

- Diagram osztálypéldány létrehozása.
- Hívja meg a mentési metódust a megfelelő paraméterekkel
- VSX Fájl elérési útja és a SaveFileFormat megfelelő kiterjesztés

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Létrehozási követelmények" %}}

- Az VSX dokumentum létrehozásához a Node.js fájlt telepíteni kell a rendszerre.
- Oracle JDK (7-es vagy újabb verzió) szükséges.
- A node-java csomagot be kell állítani.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js – VSX fájlok létrehozása" offSpacer="" %}}
