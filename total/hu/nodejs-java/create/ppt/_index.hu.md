---
title: Hozzon létre PPT prezentációkat a Node.js-ben
description: Microsoft Powerpoint PPT prezentáció létrehozása Node-alkalmazásokkal Microsoft Office használata nélkül.  
...
- Írja meg a módosított bemutatót PPT fájlként.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Létrehozási követelmények" %}}

- Az PPT dokumentum létrehozásához a Node.js fájlt telepíteni kell a rendszerre.
- Oracle JDK (7-es vagy újabb verzió) szükséges.
- A node-java csomagot be kell állítani.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js – PPT fájlok létrehozása" offSpacer="" %}}
