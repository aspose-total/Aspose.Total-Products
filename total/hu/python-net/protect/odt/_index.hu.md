---
title: Védje a ODT dokumentumot jelszóval Online és Python használatával
description: Online ODT fájl jelszó alkalmazás. Python API kód jelszavas védelem alkalmazásához a ODT dokumentumon.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ODT dokumentumvédelem vagy jelszó beállítása Python segítségével" h2="Hatékony Python alapú ODT dokumentumvédelmi segédprogram fejlesztése.A kód a Pythonon keresztüli ODT-dokumentum jelszó alkalmazásához." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT jelszavas védelem online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODT jelszavas védelem Python segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="Kódpélda Pythonban a ODT dokumentum jelszavának beállításához" offSpacer="" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Bármilyen modern webböngészőt használhat, mint például a Google Chrome, a Firefox, az Opera vagy a Safari az online ODT dokumentumvédőhöz.Ha azonban asztali alkalmazást fejleszt, javasoljuk az Aspose.Total dokumentumfeldolgozási API használatát a hatékony kezelés érdekében.</span>
                      </div>
                  </li>
              </ul>
          </div>
