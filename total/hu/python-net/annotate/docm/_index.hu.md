---
title: Törölje a DOCM megjegyzéseket online és Python használatával
description: Ingyenesen távolítsa el a megjegyzéseket a DOCM dokumentumból az online alkalmazáson keresztül.Python API kód a megjegyzések törléséhez DOCM fájlokból.
...
{{< blocks/products/pf/feature-page-header-widget h1="Távolítsa el a megjegyzéseket a DOCM Document Online vagy a Python segítségével" h2="Hatékony Python alapú DOCM dokumentum annotációs segédprogram fejlesztése. Kód a megjegyzések törléséhez a DOCM fájlból Pythonon keresztül." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCM megjegyzések törlése online" %}}

1. Importáljon DOCM fájlt a megjegyzések törléséhez a feltöltéssel.
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a DOCM dokumentumhoz fűzött megjegyzéseket a Python segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="Kódpélda Pythonban a megjegyzések eltávolítására a DOCM dokumentumból" offSpacer="" %}}
