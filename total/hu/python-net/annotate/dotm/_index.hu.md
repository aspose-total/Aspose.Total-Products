---
title: Törölje a DOTM megjegyzéseket online és Python használatával
description: Ingyenesen távolítsa el a megjegyzéseket a DOTM dokumentumból az online alkalmazáson keresztül.Python API kód a megjegyzések törléséhez DOTM fájlokból.
...
{{< blocks/products/pf/feature-page-header-widget h1="Távolítsa el a megjegyzéseket a DOTM Document Online vagy a Python segítségével" h2="Hatékony Python alapú DOTM dokumentum annotációs segédprogram fejlesztése. Kód a megjegyzések törléséhez a DOTM fájlból Pythonon keresztül." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOTM megjegyzések törlése online" %}}

1. Importáljon DOTM fájlt a megjegyzések törléséhez a feltöltéssel.
...
{{% blocks/products/pf/agp/feature-section-col title="Távolítsa el a DOTM dokumentumhoz fűzött megjegyzéseket a Python segítségével" %}}
...
{{% blocks/products/pf/agp/code-block title="Kódpélda Pythonban a megjegyzések eltávolítására a DOTM dokumentumból" offSpacer="" %}}
