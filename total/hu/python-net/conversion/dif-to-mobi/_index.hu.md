---
title: Konvertálja a DIF-t MOBI-be Python segítségével
description: DIF-ből MOBI-be konvertálás a Python-alkalmazásokban Microsoft Office használata nélkül 
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a DIF-t MOBI-be Python segítségével" h2="DIF-ből MOBI-be konvertálás a Python-alkalmazásokban a Microsoft Excel<sup>&reg;</sup> vagy a Word telepítése nélkül" >}}
