---
title: Konvertálja a TEXT-t ICS-be Pythonban
description: TEXT mentése ICS formátumba Python alkalmazásokban Microsoft Word vagy Outlook használata nélkül
url: /hu/python-net/conversion/text-to-ics/
family: total
platformtag: Python
feature: conversion
informat: TEXT
...
- A TEXT-ből ICS-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="TEXT mentése ICS-be Pythonban" offSpacer="" %}}
