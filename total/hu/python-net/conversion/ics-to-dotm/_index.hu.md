...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a ICS-t DOTM-be Python segítségével" h2="ICS-ből DOTM-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a ICS-t DOTM-be konvertálni a Pythonban" %}}
...
- A ICS-ből DOTM-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="ICS mentése DOTM-be Pythonban" offSpacer="" %}}
