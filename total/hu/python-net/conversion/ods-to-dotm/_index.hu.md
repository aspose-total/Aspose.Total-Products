---
title: Konvertálja a ODS-t DOTM-be Python segítségével
description: ODS-ből DOTM-be konvertálás a Python-alkalmazásokban Microsoft Office használata nélkül 
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a ODS-t DOTM-be Python segítségével" h2="ODS-ből DOTM-be konvertálás a Python-alkalmazásokban a Microsoft Excel<sup>&reg;</sup> vagy a Word telepítése nélkül" >}}
