...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a MBOX-t PCL-be Python segítségével" h2="MBOX-ből PCL-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a MBOX-t PCL-be konvertálni a Pythonban" %}}
...
- A MBOX-ből PCL-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="MBOX mentése PCL-be Pythonban" offSpacer="" %}}
