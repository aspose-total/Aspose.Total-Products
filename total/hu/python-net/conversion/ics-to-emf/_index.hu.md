...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a ICS-t EMF-be Python segítségével" h2="ICS-ből EMF-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a ICS-t EMF-be konvertálni a Pythonban" %}}
...
- A ICS-ből EMF-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="ICS mentése EMF-be Pythonban" offSpacer="" %}}
