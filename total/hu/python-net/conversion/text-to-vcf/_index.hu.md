---
title: Konvertálja a TEXT-t VCF-be Pythonban
description: TEXT mentése VCF formátumba Python alkalmazásokban Microsoft Word vagy Outlook használata nélkül
url: /hu/python-net/conversion/text-to-vcf/
family: total
platformtag: Python
feature: conversion
informat: TEXT
...
- A TEXT-ből VCF-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="TEXT mentése VCF-be Pythonban" offSpacer="" %}}
