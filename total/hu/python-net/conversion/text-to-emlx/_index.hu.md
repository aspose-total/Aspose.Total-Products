...
- A TEXT-ből EMLX-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="TEXT mentése EMLX-be Pythonban" offSpacer="" %}}
