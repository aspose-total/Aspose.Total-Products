...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a EMLX-t DOTM-be Python segítségével" h2="EMLX-ből DOTM-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a EMLX-t DOTM-be konvertálni a Pythonban" %}}
...
- A EMLX-ből DOTM-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="EMLX mentése DOTM-be Pythonban" offSpacer="" %}}
