---
title: Konvertálja a ICS-t PS-be Pythonban
description: Mentse a ICS-t PS formátumba Python-alkalmazásaiban Microsoft Outlook vagy Word használata nélkül 
url: /hu/python-net/conversion/ics-to-ps/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a ICS-t PS-be Python segítségével" h2="ICS-ből PS-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a ICS-t PS-be konvertálni a Pythonban" %}}
...
- A ICS-ből PS-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="ICS mentése PS-be Pythonban" offSpacer="" %}}
