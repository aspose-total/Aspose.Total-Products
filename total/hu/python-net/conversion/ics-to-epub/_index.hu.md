---
title: Konvertálja a ICS-t EPUB-be Pythonban
description: Mentse a ICS-t EPUB formátumba Python-alkalmazásaiban Microsoft Outlook vagy Word használata nélkül 
url: /hu/python-net/conversion/ics-to-epub/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a ICS-t EPUB-be Python segítségével" h2="ICS-ből EPUB-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a ICS-t EPUB-be konvertálni a Pythonban" %}}
...
- A ICS-ből EPUB-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="ICS mentése EPUB-be Pythonban" offSpacer="" %}}
