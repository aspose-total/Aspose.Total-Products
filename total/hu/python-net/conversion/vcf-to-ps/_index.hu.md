---
title: Konvertálja a VCF-t PS-be Pythonban
description: Mentse a VCF-t PS formátumba Python-alkalmazásaiban Microsoft Outlook vagy Word használata nélkül 
url: /hu/python-net/conversion/vcf-to-ps/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a VCF-t PS-be Python segítségével" h2="VCF-ből PS-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a VCF-t PS-be konvertálni a Pythonban" %}}
...
- A VCF-ből PS-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="VCF mentése PS-be Pythonban" offSpacer="" %}}
