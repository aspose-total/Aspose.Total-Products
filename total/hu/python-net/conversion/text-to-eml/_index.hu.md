---
title: Konvertálja a TEXT-t EML-be Pythonban
description: TEXT mentése EML formátumba Python alkalmazásokban Microsoft Word vagy Outlook használata nélkül
url: /hu/python-net/conversion/text-to-eml/
family: total
platformtag: Python
feature: conversion
informat: TEXT
...
- A TEXT-ből EML-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="TEXT mentése EML-be Pythonban" offSpacer="" %}}
