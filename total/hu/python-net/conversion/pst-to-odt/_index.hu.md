---
title: Konvertálja a PST-t ODT-be Pythonban
description: Mentse a PST-t ODT formátumba Python-alkalmazásaiban Microsoft Outlook vagy Word használata nélkül 
url: /hu/python-net/conversion/pst-to-odt/
family: total
platformtag: Python
feature: conversion
informat: PST
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a PST-t ODT-be Python segítségével" h2="PST-ből ODT-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Outlook telepítése nélkül." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a PST-t ODT-be konvertálni a Pythonban" %}}
...
- A PST-ből ODT-be konvertáláshoz Python 3.5 vagy újabb verzió szükséges
...
{{% blocks/products/pf/agp/code-block title="PST mentése ODT-be Pythonban" offSpacer="" %}}
