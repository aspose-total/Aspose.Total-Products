---
title: Konvertálja a DOT-t DIF-be Python segítségével
description: DOT-ből DIF-be konvertálás a Python-alkalmazásokban Microsoft Word vagy Excel használata nélkül 
...
{{< blocks/products/pf/feature-page-header h1="Konvertálja a DOT-t DIF-be Python segítségével" h2="DOT-ből DIF-be konvertálás a Python-alkalmazásokban a Microsoft Word<sup>&reg;</sup> vagy az Excel telepítése nélkül" >}}
