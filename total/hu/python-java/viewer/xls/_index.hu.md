---
title: Tekintse meg a XLS fájlt online és olvassa el a XLS dokumentumot Python segítségével
description: Ingyenes online XLS fájlnézegető alkalmazás. Python API kód a XLS fájl olvasásához a megjelenítő alkalmazás számára.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ingyenesen tekintse meg a XLS fájlt online és olvassa el a XLS-et Python segítségével" h2="Hatékony Python alapú XLS dokumentumnézegető segédprogram fejlesztése.A felsorolt kód a XLS dokumentum Pythonon keresztüli betöltéséhez vagy olvasásához." >}}




{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Tekintse meg a XLS dokumentumot az online alkalmazáson keresztül" %}}
...
1. Több oldalas XLS dokumentum esetén navigálhat az oldalak között.
1. Állítsa be az oldalnézet nagyítását vagy kicsinyítését.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Olvasson XLS fájlt a Python for Viewer alkalmazáson keresztül" %}}
...
1. Hozzon létre munkafüzet osztályobjektumot, és töltse be a XLS forrásfájlt a segítségével.
...
1. Megtekintéséhez konvertálja a forrás XLS fájlt HTML-re ugyanazon API mentési módszerével.
1. A subprocess.run segítségével hívja meg a böngészőt a XLS fájl megtekintéséhez.
...
{{% blocks/products/pf/agp/code-block title="Kódpélda Pythonban a XLS fájlok megtekintéséhez" offSpacer="" %}}
...
<h2>XLS fájlnézegető alkalmazás fejlesztése Python segítségével</h2>

XLS megjelenítő alkalmazást vagy segédprogramot szeretne fejleszteni?A [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/)-mal a [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) gyermek API-jával bármely python-fejlesztő integrálhatja a fenti API-kódot a dokumentumnézegető alkalmazásába.A hatékony Python könyvtár lehetővé teszi bármilyen dokumentummegjelenítési megoldás programozását, amely számos népszerű formátumot támogat, beleértve a XLS formátumot is.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python segédprogram a XLS fájl feldolgozásához a megjelenítési alkalmazáshoz" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Biztonságos az online alkalmazás használata XLS dokumentum megtekintéséhez?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Az online XLS dokumentumnézegetőhöz bármilyen modern webböngészőt használhat, például a Google Chrome-ot, a Firefoxot, az Opera-t vagy a Safarit.Ha azonban asztali alkalmazást fejleszt, javasoljuk az Aspose.Total dokumentumfeldolgozási API használatát a hatékony kezelés érdekében.</span>
                      </div>
                  </li>
              </ul>
          </div>
