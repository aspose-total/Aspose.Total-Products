...
- Mentse el a munkalap összes oldalát képként a [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)) módszerrel. Most a JSON fájlt képekké alakítja a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="JSON képek konvertálása Python segítségével" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="JSON Elképzelni" description="" >}}
