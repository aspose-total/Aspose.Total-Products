---
title: Převést VCF na EMF v Pythonu
description: Uložte VCF do EMF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-emf/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na EMF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do EMF v Pythonu" offSpacer="" %}}
