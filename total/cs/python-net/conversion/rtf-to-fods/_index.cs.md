---
title: Převeďte RTF na FODS pomocí Pythonu nebo pomocí bezplatného online převodníku
description: Převod RTF na FODS ve vašich aplikacích Python bez použití Microsoft Word nebo Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  RTF na FODS. 
...
{{< blocks/products/pf/feature-page-header h1="Převést RTF na FODS pomocí Pythonu nebo online aplikace" h2="Převod RTF na FODS ve vašich aplikacích Python bez instalace Microsoft Word<sup>&reg;</sup> nebo Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}

Pro vývojáře Pythonu, který se snaží přidat do aplikace funkci převodu RTF na FODS. [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API může pomoci automatizovat proces převodu. Je to plný balík různých API zabývajících se různými formáty.
...
{{% blocks/products/pf/agp/feature-section-col title="Jak převést RTF na FODS v Pythonu" %}}
...
-  Zavolejte metodu `save` a zadávejte cestu k výstupnímu souboru FODS. Váš soubor RTF je tedy převeden na FODS v zadané cestě

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Požadavky na převod" %}}

- Pro převod RTF na FODS je vyžadován Python 3.5 nebo novější
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online převodník RTF na FODS lze použít v jakémkoli moderním prohlížeči, jako je Google Chrome, Firefox, Opera a Safari. Pokud však vyvíjíte desktopovou aplikaci, Aspose.Total RTF Conversion API může poskytnout hladké a spolehlivé řešení pro vaše potřeby.</span>
                      </div>
                  </li>
              </ul>
          </div>
