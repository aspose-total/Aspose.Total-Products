---
title: Převést OFT na WORDML v Pythonu
description: Uložte OFT do WORDML ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/oft-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Pro převod OFT na WORDML je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do WORDML v Pythonu" offSpacer="" %}}
