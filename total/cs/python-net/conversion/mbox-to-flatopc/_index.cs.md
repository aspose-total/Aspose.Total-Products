---
title: Převést MBOX na FLATOPC v Pythonu
description: Uložte MBOX do FLATOPC ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na FLATOPC je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do FLATOPC v Pythonu" offSpacer="" %}}
