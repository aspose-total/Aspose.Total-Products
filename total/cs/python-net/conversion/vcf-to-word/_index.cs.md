---
title: Převést VCF na WORD v Pythonu
description: Uložte VCF do WORD ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-word/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na WORD je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do WORD v Pythonu" offSpacer="" %}}
