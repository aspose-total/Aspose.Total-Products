---
title: Převést MBOX na ODT v Pythonu
description: Uložte MBOX do ODT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-odt/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na ODT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do ODT v Pythonu" offSpacer="" %}}
