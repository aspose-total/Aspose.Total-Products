---
title: Převést VCF na FLATOPC v Pythonu
description: Uložte VCF do FLATOPC ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na FLATOPC je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do FLATOPC v Pythonu" offSpacer="" %}}
