---
title: Převést MBOX na DOTX v Pythonu
description: Uložte MBOX do DOTX ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na DOTX je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do DOTX v Pythonu" offSpacer="" %}}
