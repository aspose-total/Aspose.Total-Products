---
title: Převést VCF na BMP v Pythonu
description: Uložte VCF do BMP ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na BMP je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do BMP v Pythonu" offSpacer="" %}}
