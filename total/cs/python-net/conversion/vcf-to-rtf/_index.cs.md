---
title: Převést VCF na RTF v Pythonu
description: Uložte VCF do RTF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na RTF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do RTF v Pythonu" offSpacer="" %}}
