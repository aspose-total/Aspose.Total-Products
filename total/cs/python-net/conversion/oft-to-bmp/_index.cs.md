---
title: Převést OFT na BMP v Pythonu
description: Uložte OFT do BMP ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/oft-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Pro převod OFT na BMP je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do BMP v Pythonu" offSpacer="" %}}
