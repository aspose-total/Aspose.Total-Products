---
title: Převést VCF na ODT v Pythonu
description: Uložte VCF do ODT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-odt/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na ODT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do ODT v Pythonu" offSpacer="" %}}
