---
title: Převést VCF na DOTX v Pythonu
description: Uložte VCF do DOTX ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na DOTX je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do DOTX v Pythonu" offSpacer="" %}}
