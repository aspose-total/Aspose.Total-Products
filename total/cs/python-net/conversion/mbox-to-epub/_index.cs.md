---
title: Převést MBOX na EPUB v Pythonu
description: Uložte MBOX do EPUB ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-epub/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na EPUB je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do EPUB v Pythonu" offSpacer="" %}}
