---
title: Převést MBOX na EMF v Pythonu
description: Uložte MBOX do EMF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-emf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na EMF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do EMF v Pythonu" offSpacer="" %}}
