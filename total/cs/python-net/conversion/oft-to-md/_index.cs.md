---
title: Převést OFT na MD v Pythonu
description: Uložte OFT do MD ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
...
- Pro převod OFT na MD je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do MD v Pythonu" offSpacer="" %}}
