...
- Pro převod OFT na EPUB je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do EPUB v Pythonu" offSpacer="" %}}
