---
title: Převést OFT na IMAGE v Pythonu
description: Uložte OFT do IMAGE ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/oft-to-image/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Pro převod OFT na IMAGE je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do IMAGE v Pythonu" offSpacer="" %}}
