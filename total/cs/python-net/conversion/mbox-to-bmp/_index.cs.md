---
title: Převést MBOX na BMP v Pythonu
description: Uložte MBOX do BMP ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na BMP je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do BMP v Pythonu" offSpacer="" %}}
