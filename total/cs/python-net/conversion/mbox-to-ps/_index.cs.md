---
title: Převést MBOX na PS v Pythonu
description: Uložte MBOX do PS ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-ps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na PS je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do PS v Pythonu" offSpacer="" %}}
