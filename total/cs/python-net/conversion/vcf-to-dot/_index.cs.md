---
title: Převést VCF na DOT v Pythonu
description: Uložte VCF do DOT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-dot/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na DOT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do DOT v Pythonu" offSpacer="" %}}
