---
title: Převést MBOX na WORDML v Pythonu
description: Uložte MBOX do WORDML ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na WORDML je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do WORDML v Pythonu" offSpacer="" %}}
