---
title: Převést MBOX na RTF v Pythonu
description: Uložte MBOX do RTF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na RTF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do RTF v Pythonu" offSpacer="" %}}
