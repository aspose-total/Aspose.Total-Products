---
title: Převést MBOX na DOT v Pythonu
description: Uložte MBOX do DOT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-dot/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na DOT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do DOT v Pythonu" offSpacer="" %}}
