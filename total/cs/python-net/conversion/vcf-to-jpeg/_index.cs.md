---
title: Převést VCF na JPEG v Pythonu
description: Uložte VCF do JPEG ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na JPEG je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do JPEG v Pythonu" offSpacer="" %}}
