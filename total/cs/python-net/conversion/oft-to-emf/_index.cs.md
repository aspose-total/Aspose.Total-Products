---
title: Převést OFT na EMF v Pythonu
description: Uložte OFT do EMF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/oft-to-emf/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Pro převod OFT na EMF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do EMF v Pythonu" offSpacer="" %}}
