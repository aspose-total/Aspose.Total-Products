---
title: Převést VCF na SVG v Pythonu
description: Uložte VCF do SVG ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-svg/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na SVG je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do SVG v Pythonu" offSpacer="" %}}
