---
title: Převést EMLX na FLATOPC v Pythonu
description: Uložte EMLX do FLATOPC ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
...
- Pro převod EMLX na FLATOPC je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit EMLX do FLATOPC v Pythonu" offSpacer="" %}}
