---
title: Převést MBOX na TEXT v Pythonu
description: Uložte MBOX do TEXT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na TEXT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do TEXT v Pythonu" offSpacer="" %}}
