---
title: Převést VCF na MD v Pythonu
description: Uložte VCF do MD ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-md/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na MD je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do MD v Pythonu" offSpacer="" %}}
