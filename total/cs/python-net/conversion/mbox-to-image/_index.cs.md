---
title: Převést MBOX na IMAGE v Pythonu
description: Uložte MBOX do IMAGE ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-image/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na IMAGE je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do IMAGE v Pythonu" offSpacer="" %}}
