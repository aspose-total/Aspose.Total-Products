---
title: Převést VCF na DOTM v Pythonu
description: Uložte VCF do DOTM ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na DOTM je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do DOTM v Pythonu" offSpacer="" %}}
