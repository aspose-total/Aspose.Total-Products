---
title: Převést VCF na XPS v Pythonu
description: Uložte VCF do XPS ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-xps/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na XPS je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do XPS v Pythonu" offSpacer="" %}}
