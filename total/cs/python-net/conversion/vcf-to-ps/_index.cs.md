---
title: Převést VCF na PS v Pythonu
description: Uložte VCF do PS ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-ps/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na PS je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do PS v Pythonu" offSpacer="" %}}
