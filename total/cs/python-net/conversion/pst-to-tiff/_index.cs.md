---
title: Převést PST na TIFF v Pythonu
description: Uložte PST do TIFF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
...
- Pro převod PST na TIFF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit PST do TIFF v Pythonu" offSpacer="" %}}
