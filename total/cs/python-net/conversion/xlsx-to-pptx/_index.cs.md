---
title: Převeďte XLSX na PPTX pomocí Pythonu
description: Převod XLSX na PPTX ve vašich aplikacích Python bez použití Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSX na PPTX pomocí Pythonu" h2="Převod XLSX na PPTX ve vašich aplikacích Python bez instalace Microsoft Excel<sup>&reg;</sup> nebo PowerPoint" >}}
