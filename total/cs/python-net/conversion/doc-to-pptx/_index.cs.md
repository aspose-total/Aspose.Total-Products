---
title: Převést DOC na PPTX v Pythonu nebo pomocí bezplatného online převodníku
description: Převod DOC na PPTX ve vašich aplikacích Python bez použití Microsoft Word nebo PowerPoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOC na PPTX. 
...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOC na PPTX pomocí Pythonu nebo online aplikace" h2="Převod DOC na PPTX ve vašich aplikacích Python bez instalace Microsoft Word<sup>&reg;</sup> nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}

Pro vývojáře Pythonu, který se snaží přidat funkci převodu DOC na PPTX v rámci aplikace? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API může pomoci automatizovat proces převodu. Je to plný balík různých API zabývajících se různými formáty.  

Je to hlavně ve dvou krocích. Nejprve použijte [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/) API pro převod DOC souboru do PDF. Poté pomocí PowerPoint Python API [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/) uložte vytvořený PDF do Presentation jako formát PPTX. 

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Jak převést DOC na PPTX v Pythonu" %}}
...
-  Volejte metodu `save` a zadávejte cestu k výstupnímu souboru a SaveFormat.PPTX jako parametry. Váš soubor DOC je tedy převeden na PPTX v zadané cestě.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Požadavky na konverzi" %}}

- Pro převod DOC na PPTX je vyžadován Python 3.5 nebo novější
