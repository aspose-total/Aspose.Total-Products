---
title: Převést MBOX na DOC v Pythonu
description: Uložte MBOX do DOC ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-doc/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na DOC je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do DOC v Pythonu" offSpacer="" %}}
