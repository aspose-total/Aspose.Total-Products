---
title: Převést VCF na GIF v Pythonu
description: Uložte VCF do GIF ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-gif/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na GIF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do GIF v Pythonu" offSpacer="" %}}
