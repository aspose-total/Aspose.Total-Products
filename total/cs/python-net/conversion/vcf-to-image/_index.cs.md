---
title: Převést VCF na IMAGE v Pythonu
description: Uložte VCF do IMAGE ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-image/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na IMAGE je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do IMAGE v Pythonu" offSpacer="" %}}
