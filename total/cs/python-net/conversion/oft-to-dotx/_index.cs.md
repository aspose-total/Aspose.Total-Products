...
- Pro převod OFT na DOTX je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit OFT do DOTX v Pythonu" offSpacer="" %}}
