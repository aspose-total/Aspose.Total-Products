---
title: Převést MBOX na MD v Pythonu
description: Uložte MBOX do MD ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-md/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na MD je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do MD v Pythonu" offSpacer="" %}}
