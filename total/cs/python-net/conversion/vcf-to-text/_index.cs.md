---
title: Převést VCF na TEXT v Pythonu
description: Uložte VCF do TEXT ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/vcf-to-text/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Pro převod VCF na TEXT je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit VCF do TEXT v Pythonu" offSpacer="" %}}
