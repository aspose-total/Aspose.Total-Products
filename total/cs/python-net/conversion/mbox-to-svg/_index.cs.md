---
title: Převést MBOX na SVG v Pythonu
description: Uložte MBOX do SVG ve svých aplikacích Python bez použití Microsoft Outlook nebo Word 
url: /cs/python-net/conversion/mbox-to-svg/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Pro převod MBOX na SVG je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Uložit MBOX do SVG v Pythonu" offSpacer="" %}}
