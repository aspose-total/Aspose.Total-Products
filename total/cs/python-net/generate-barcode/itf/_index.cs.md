---
title: Vytvářejte obrázky čárových kódů ITF pomocí Pythonu
description: Vytvářejte obrázky čárových kódů symboliky ITF pomocí aplikací Python bez použití jakéhokoli jiného softwaru. 
...
- Pro vytvoření čárového kódu ITF je vyžadován Python 3.5 nebo novější
...
{{% blocks/products/pf/agp/code-block title="Vygenerujte čárový kód symboliky ITF v Pythonu" offSpacer="" %}}
