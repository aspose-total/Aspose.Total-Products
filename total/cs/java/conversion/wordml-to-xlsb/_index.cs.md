---
title: Java API pro převod WORDML do XLSB
description: Převeďte WORDML na XLSB přes Java bez použití Microsoft Word nebo Microsoft Excel
url_ignore: /cs/java/conversion/wordml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést WORDML na XLSB přes Java" h2="On Premise Java API pro převod WORDML na XLSB bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod WORDML do XLSB" %}}
