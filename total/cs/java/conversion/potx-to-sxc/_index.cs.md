...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTX do SXC přes Java" h2="On Premise Java API pro export POTX do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POTX na SXC, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
