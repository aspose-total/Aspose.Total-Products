...
description: Převeďte DOC na ODS přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/doc-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOC na ODS přes Java" h2="On Premise Java API pro převod DOC na ODS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
