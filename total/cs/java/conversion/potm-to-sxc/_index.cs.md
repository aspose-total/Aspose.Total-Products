...
description: Převeďte POTM do formátu SXC přes Java bez použití Microsoft Excel nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTM do SXC přes Java" h2="On Premise Java API pro export POTM do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POTM na SXC, můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
