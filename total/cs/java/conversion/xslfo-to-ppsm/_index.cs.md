---
title: Online konverze XSLFO na PPSM nebo vývoj aplikace založené na Java pro konverzi souborů XSLFO
description: Bezplatná online aplikace pro převod souborů XSLFO na soubory PPSM. Kód knihovny konverze Java pro dokumenty XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="Online aplikace pro převod XSLFO na PPSM a kód Java pro převod souborů XSLFO" h2="Vyvíjejte výkonnou aplikaci pro konverzi a export XSLFO založenou na Javě.  Převeďte jeden nebo více souborů XSLFO do formátu PPSM a dalších formátů pomocí rozhraní Java automation API.  Zdarma převádějte soubory XSLFO online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Převeďte XSLFO na PPSM pomocí Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód Java pro konverzi XSLFO na PPSM" offSpacer="" %}}
...
Několik dalších případů pro uložení XSLFO do PPSM s dalšími funkcemi, jako je Požadavky na převod, Otevřete šifrovaný soubor XSLFO přes Java.
