---
title: Převeďte FODS na DOCX pomocí Java
description: Java API pro export FODS do DOCX pomocí Excelu nebo Wordu
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API pro export FODS do DOCX" h2="On Premise Java API pro export FODS do DOCX bez spoléhání se na Microsoft Excel&reg;" >}}
