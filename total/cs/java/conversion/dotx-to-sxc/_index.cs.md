---
title: Java API pro převod DOTX do SXC nebo pomocí bezplatného online převodníku
description: Převeďte DOTX na SXC přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOTX na SXC. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTX na SXC přes Java nebo online aplikace" h2="On Premise Java API pro převod DOTX na SXC bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOTX do SXC" %}}
...
<h3>Zdarma online převodník DOTX na SXC</h3>

<iframe title="Online nástroj sxc až dotx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=sxc&from=dotx" id="child-iframe" width="80%"></iframe>
