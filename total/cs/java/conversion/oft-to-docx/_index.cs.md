---
title: Export OFT do DOCX přes Java
description: Java API pro převod OFT do DOCX bez použití Microsoft Word nebo Outlook
url_ignore: /cs/java/conversion/oft-to-docx/
family: total
platformtag: net
feature: conversion
informat: OFT
