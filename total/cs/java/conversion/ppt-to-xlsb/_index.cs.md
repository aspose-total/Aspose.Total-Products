...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPT do XLSB přes Java nebo online" h2="On Premise Java API pro export PPT do XLSB bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
