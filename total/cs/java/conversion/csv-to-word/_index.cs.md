---
title: Převeďte CSV na WORD pomocí Java
description: Java API pro export CSV do WORD pomocí Excelu nebo Wordu
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API pro export CSV do WORD" h2="On Premise Java API pro export CSV do WORD bez spoléhání se na Microsoft Excel&reg;" >}}
...
1. Otevřete soubor CSV pomocí třídy [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
