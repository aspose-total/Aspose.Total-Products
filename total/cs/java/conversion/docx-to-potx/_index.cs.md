---
title: Převést DOCX na POTX přes Java
description: Java API pro export DOCX do POTX bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCX na POTX přes Java" h2="Konverze DOCX na POTX pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
...
Pro konverzi souborů DOCX na POTX můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
