...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTX do ODS přes Java nebo online" h2="On Premise Java API pro export PPTX do ODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
