---
title: Převeďte POTX na DOCX přes Java
description: Java API pro export POTX do DOCX bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTX na DOCX přes Java" h2="On Premise Java API pro PowerPoint převod POTX na DOCX v jakékoli Java J2SE, J2EE, J2ME aplikací" >}}
...
Pro převod souborů POTX na DOCX můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
