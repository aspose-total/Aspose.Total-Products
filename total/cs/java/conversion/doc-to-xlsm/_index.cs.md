---
title: Java API pro převod DOC do XLSM nebo pomocí bezplatného online převodníku
description: Převeďte DOC na XLSM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOC na XLSM. 
url_ignore: /cs/java/conversion/doc-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOC na XLSM přes Java nebo online aplikace" h2="On Premise Java API pro převod DOC na XLSM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOC do XLSM" %}}
