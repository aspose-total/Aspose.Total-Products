---
title: Převeďte PPTX na ODT přes Java
description: Java API pro export PPTX do ODT bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTX na ODT přes Java" h2="On Premise Java API pro PowerPoint převod PPTX na ODT v jakékoli Java J2SE, J2EE, J2ME aplikací" >}}
...
Pro převod souborů PPTX na ODT můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
...
Pomocí API můžete také provést převod PPTX souboru na ODT s vodoznakem. Chcete-li přidat vodoznak do dokumentu ODT, můžete nejprve převést soubor PPTX do HTML a přidat do něj vodoznak. Chcete-li přidat vodoznak, načtěte nově vytvořený soubor HTML pomocí třídy [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), vytvořte instanci TextWatermarkOptions a nastavte jeho vlastnosti, zavolejte metodu Watermark.setText a předejte text vodoznaku a objekt TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
