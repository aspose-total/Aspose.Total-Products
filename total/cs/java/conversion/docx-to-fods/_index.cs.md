---
title: Java API pro převod DOCX do FODS
description: Převeďte DOCX na FODS přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/docx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCX na FODS přes Java" h2="On Premise Java API pro převod DOCX na FODS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCX do FODS" %}}
