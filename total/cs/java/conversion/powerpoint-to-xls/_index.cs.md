...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POWERPOINT do XLS přes Java nebo online" h2="On Premise Java API pro export POWERPOINT do XLS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
