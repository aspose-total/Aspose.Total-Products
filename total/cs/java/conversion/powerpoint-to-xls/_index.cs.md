...
description: Převeďte POWERPOINT do formátu XLS přes Java bez použití Microsoft Excel nebo PowerPoint
url: /cs/java/conversion/powerpoint-to-xls/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POWERPOINT do XLS přes Java" h2="On Premise Java API pro export POWERPOINT do XLS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POWERPOINT na XLS, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
