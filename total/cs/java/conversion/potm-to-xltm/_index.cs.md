...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTM do XLTM přes Java nebo online" h2="On Premise Java API pro export POTM do XLTM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
