---
title: Převeďte PPTM na DOC přes Java
description: Java API pro export PPTM do DOC bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTM na DOC přes Java" h2="On Premise Java API pro PowerPoint převod PPTM na DOC v jakékoli Java J2SE, J2EE, J2ME aplikací" >}}
...
Pro převod souborů PPTM na DOC můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
...
Pomocí API můžete také provést převod PPTM souboru na DOC s vodoznakem. Chcete-li přidat vodoznak do dokumentu DOC, můžete nejprve převést soubor PPTM do HTML a přidat do něj vodoznak. Chcete-li přidat vodoznak, načtěte nově vytvořený soubor HTML pomocí třídy [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), vytvořte instanci TextWatermarkOptions a nastavte jeho vlastnosti, zavolejte metodu Watermark.setText a předejte text vodoznaku a objekt TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
