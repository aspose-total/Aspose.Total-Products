...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOC na XLS přes Java nebo online" h2="On Premise Java API pro převod DOC na XLS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
