...
* Ukládání e-mailů ve plně strukturovaném formátu XML
* Integrování e-mailových dat do podnikových systémů
* Umožnění standardizace dokumentů napříč pracovními postupy
* Dodržování předpisů a archivace dat

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Scénáře automatizace" %}}

* Potrubí MSG-to-FLATOPC pro systémy dokumentů založené na XML
* Automatizovaná transformace hromadných e-mailů pro systémy ERP/CRM
* Archivační řešení s využitím standardizovaných formátů XML
* Interoperabilita napříč platformami založenými na aplikacích z kancelářského balíku
