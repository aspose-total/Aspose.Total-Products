---
title: Java API pro převod DOTM do XLAM nebo pomocí bezplatného online převodníku
description: Převeďte DOTM na XLAM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOTM na XLAM. 
url_ignore: /cs/java/conversion/dotm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTM na XLAM přes Java nebo online aplikace" h2="On Premise Java API pro převod DOTM na XLAM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOTM do XLAM" %}}
