...
description: Převeďte WORDML na XLS přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/wordml-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést WORDML na XLS přes Java" h2="On Premise Java API pro převod WORDML na XLS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
