...
description: Převeďte PPSX do formátu XLSM přes Java bez použití Microsoft Excel nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPSX do XLSM přes Java" h2="On Premise Java API pro export PPSX do XLSM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
2. Převeďte PPSX do HTML pomocí [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-).
...
Chcete-li převést PPSX na XLSM, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
