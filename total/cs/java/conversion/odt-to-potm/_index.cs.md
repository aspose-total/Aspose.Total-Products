---
title: Převést ODT na POTM přes Java
description: Java API pro export ODT do POTM bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést ODT na POTM přes Java" h2="Konverze ODT na POTM pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
...
Pro konverzi souborů ODT na POTM můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
