...
description: Převeďte DOTM na XLTX přes Java bez použití Microsoft Word nebo Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTM na XLTX přes Java" h2="On Premise Java API pro převod DOTM na XLTX bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
