---
title: Java API pro převod WORD do XLTM nebo pomocí bezplatného online převodníku
description: Převeďte WORD na XLTM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  WORD na XLTM. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést WORD na XLTM přes Java nebo online aplikace" h2="On Premise Java API pro převod WORD na XLTM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod WORD do XLTM" %}}
