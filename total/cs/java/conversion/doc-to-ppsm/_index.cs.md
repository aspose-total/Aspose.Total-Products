---
title: Převést DOC na PPSM přes Java nebo pomocí bezplatného online převodníku 
description: Java API pro export DOC do PPSM bez použití Microsoft Word nebo PowerPoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOC na PPSM. 
url_ignore: /cs/java/conversion/doc-to-ppsm/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOC na PPSM přes Java nebo online aplikace" h2="Konverze DOC na PPSM pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
...
Pro konverzi souborů DOC na PPSM můžete snadno použít Aspose.Total for Java přímo z [Maven](https://releases.aspose.com/total/java/) a zahrňte knihovny do vašeho pom.xml.
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Výše integrovaná online aplikace vám umožňuje převádět soubory DOC na PPSM. Chcete-li začít, jednoduše přetáhněte nebo klikněte do bílé oblasti a importujte soubor DOC. Po nahrání souboru klikněte na tlačítko „Převést“. Po dokončení procesu převodu DOC na PPSM si můžete stáhnout převedený soubor jediným kliknutím.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
