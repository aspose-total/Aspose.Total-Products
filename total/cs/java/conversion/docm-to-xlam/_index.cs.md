---
title: Java API pro převod DOCM do XLAM nebo pomocí bezplatného online převodníku
description: Převeďte DOCM na XLAM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOCM na XLAM. 
url_ignore: /cs/java/conversion/docm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCM na XLAM přes Java nebo online aplikace" h2="On Premise Java API pro převod DOCM na XLAM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOCM do XLAM" %}}
