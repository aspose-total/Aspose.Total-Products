---
title: Java API pro převod DOT do XLTM
description: Převeďte DOT na XLTM přes Java bez použití Microsoft Word nebo Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOT na XLTM přes Java" h2="On Premise Java API pro převod DOT na XLTM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOT do XLTM" %}}
