...
description: Převeďte PPS do formátu MARKDOWN přes Java bez použití Microsoft Excel nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPS do MARKDOWN přes Java" h2="On Premise Java API pro export PPS do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést PPS na MARKDOWN, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
