---
title: Online konverze PCL na OTT nebo vývoj aplikace založené na Java pro konverzi souborů PCL
description: Bezplatná online aplikace pro převod souborů PCL na soubory OTT. Kód knihovny konverze Java pro dokumenty PCL.  
...
{{< blocks/products/pf/feature-page-header h1="Online aplikace pro převod PCL na OTT a kód Java pro převod souborů PCL" h2="Vyvíjejte výkonnou aplikaci pro konverzi a export PCL založenou na Javě.  Převeďte jeden nebo více souborů PCL do formátu OTT a dalších formátů pomocí rozhraní Java automation API.  Zdarma převádějte soubory PCL online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Převeďte PCL na OTT pomocí Java Automation API" %}}
...
Několik dalších případů pro uložení PCL do OTT s dalšími funkcemi, jako je Požadavky na převod, Otevřete dokument PCL chráněný heslem přes Java.
...
Převádění **PCL na OTT** převádí výstup z **Printer Command Language** do formátu **OpenDocument Text Template (.OTT)** pro standardizované dokumentové šablony v **LibreOffice Writer**.

{{% blocks/products/pf/agp/feature-section-col title="Klíčové použití" %}}

* Vytváření opakovaně použitelných šablon dokumentů z formulářů PCL
* Vytváření standardizovaných obchodních rozvržení pro korespondenci
* Převádění záhlaví nebo zpráv PCL do upravitelných šablon
* Podpora otevřených dokumentových pracovních postupů s konzistentním formátováním

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Automatizační scénáře" %}}

* Automatické generování OTT z návrhových systémů tisku
* Integrace s pracovními postupy tvorby obsahu podniku
* Hromadná konverze tištěných šablon do formátu OTT pro opakované použití dokumentů
