---
title: Převést FLATOPC na PPSM přes Java
description: Java API pro export FLATOPC do PPSM bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést FLATOPC na PPSM přes Java" h2="Konverze FLATOPC na PPSM pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
...
Pro konverzi souborů FLATOPC na PPSM můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
