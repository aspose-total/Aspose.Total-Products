---
title: Převést DOCM na POTM přes Java
description: Java API pro export DOCM do POTM bez použití Microsoft Word nebo PowerPoint
url: /cs/java/conversion/docm-to-potm/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCM na POTM přes Java" h2="Konverze DOCM na POTM pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
...
Pro konverzi souborů DOCM na POTM můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) a zahrňte knihovny do vašeho pom.xml.
