---
title: Java API pro převod DOCM do XLS nebo pomocí bezplatného online převodníku
description: Převeďte DOCM na XLS přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOCM na XLS. 
url_ignore: /cs/java/conversion/docm-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCM na XLS přes Java nebo online aplikace" h2="On Premise Java API pro převod DOCM na XLS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOCM do XLS" %}}
