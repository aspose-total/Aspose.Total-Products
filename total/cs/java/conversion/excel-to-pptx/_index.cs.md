---
title: Převeďte EXCEL na PPTX pomocí Java
description: Java API pro export EXCEL do PPTX pomocí Excelu nebo Wordu
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API pro export EXCEL do PPTX" h2="On Premise Java API pro export EXCEL do PPTX bez spoléhání se na Microsoft Excel&reg;" >}}
