...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPS do FODS přes Java" h2="On Premise Java API pro export PPS do FODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést PPS na FODS, můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
