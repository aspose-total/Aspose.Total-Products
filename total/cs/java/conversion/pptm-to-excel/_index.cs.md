...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTM do EXCEL přes Java nebo online" h2="On Premise Java API pro export PPTM do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
