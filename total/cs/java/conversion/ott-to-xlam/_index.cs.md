...
description: Převeďte OTT na XLAM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  OTT na XLAM. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést OTT na XLAM přes Java nebo online aplikace" h2="On Premise Java API pro převod OTT na XLAM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod OTT do XLAM" %}}
