...
description: Převeďte POTX do formátu TSV přes Java bez použití Microsoft Excel nebo PowerPoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník POT na CSV. nebo pomocí bezplatného online převodníku
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTX do TSV přes Java nebo online" h2="On Premise Java API pro export POTX do TSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
