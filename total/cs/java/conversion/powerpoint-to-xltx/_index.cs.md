...
description: Převeďte POWERPOINT do formátu XLTX přes Java bez použití Microsoft Excel nebo PowerPoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník POT na CSV. nebo pomocí bezplatného online převodníku
url_ignore: /cs/java/conversion/powerpoint-to-xltx/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POWERPOINT do XLTX přes Java nebo online" h2="On Premise Java API pro export POWERPOINT do XLTX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POWERPOINT na XLTX, můžete snadno použít Aspose.Total for Java přímo z [Maven](https://releases.aspose.com/total/java/) a zahrňte knihovny do vašeho pom.xml.
