...
description: Převeďte PPTM do formátu SXC přes Java bez použití Microsoft Excel nebo PowerPoint
url: /cs/java/conversion/pptm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTM do SXC přes Java" h2="On Premise Java API pro export PPTM do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést PPTM na SXC, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
