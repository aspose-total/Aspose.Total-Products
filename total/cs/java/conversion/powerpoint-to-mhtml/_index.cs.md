---
title: Převeďte POWERPOINT do formátu MHTML přes Java
description: Převeďte POWERPOINT do formátu MHTML přes Java bez použití Microsoft Excel nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POWERPOINT do MHTML přes Java" h2="On Premise Java API pro export POWERPOINT do MHTML bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
2. Převeďte POWERPOINT do HTML pomocí [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-).
...
Chcete-li převést POWERPOINT na MHTML, můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
