...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPT do ODS přes Java nebo online" h2="On Premise Java API pro export PPT do ODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
