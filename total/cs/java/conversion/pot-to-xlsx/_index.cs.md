...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POT do XLSX přes Java nebo online" h2="On Premise Java API pro export POT do XLSX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
