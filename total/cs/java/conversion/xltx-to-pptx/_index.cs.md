---
title: Převeďte XLTX na PPTX pomocí Java
description: Java API pro export XLTX do PPTX pomocí Excelu nebo Wordu
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API pro export XLTX do PPTX" h2="On Premise Java API pro export XLTX do PPTX bez spoléhání se na Microsoft Excel&reg;" >}}
