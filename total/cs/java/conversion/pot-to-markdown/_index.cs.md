...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POT do MARKDOWN přes Java nebo online" h2="On Premise Java API pro export POT do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
