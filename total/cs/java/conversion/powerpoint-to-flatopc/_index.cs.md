          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tento online převodník je navržen tak, aby poskytoval rychlou a efektivní konverzi POWERPOINT na FLATOPC. Rychlost procesu převodu se může lišit v závislosti na velikosti souboru POWERPOINT. Malé soubory POWERPOINT lze převést na FLATOPC během několika sekund. Pokud však konverzní kód integrujete do aplikace .NET, může rychlost konverze záviset na tom, jak dobře jste aplikaci optimalizovali. V každém případě je náš nástroj pro převod POWERPOINT na FLATOPC vybaven nejmodernější technologií, která zajišťuje nejlepší možný výkon a kvalitu výstupu.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
