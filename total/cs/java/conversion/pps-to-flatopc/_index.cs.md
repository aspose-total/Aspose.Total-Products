---
title: Převeďte PPS na FLATOPC přes Java
description: Java API pro export PPS do FLATOPC bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPS na FLATOPC přes Java" h2="On Premise Java API pro PowerPoint převod PPS na FLATOPC v jakékoli Java J2SE, J2EE, J2ME aplikací" >}}
...
Pro převod souborů PPS na FLATOPC můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
