...
<iframe title="Bezplatná online aplikace pro převod XML na PPSX" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppsx&from=xml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Kód Java pro konverzi XML na PPSX" offSpacer="" %}}
