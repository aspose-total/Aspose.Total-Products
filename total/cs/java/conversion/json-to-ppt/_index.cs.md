...
4. Uložte dokument do formátu PPT pomocí metody [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
Pomocí API můžete také převést JSON na PPT s vodoznakem. Chcete-li do dokumentu PPT přidat vodoznak, můžete nejprve analyzovat JSON na PPTX a přidat do něj vodoznak. Chcete-li přidat vodoznak, načtěte nově vytvořený soubor PPTX pomocí třídy [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation), projděte všechny snímky, přidejte text pomocí addTextFrame nastavte všechny relevantní možnosti, jako je barva, fillType a další, a můžete uložit dokument do PPT. 
{{% blocks/products/pf/feature-page-code %}}
