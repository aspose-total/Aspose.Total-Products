...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPT do XLSM přes Java" h2="On Premise Java API pro export PPT do XLSM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést PPT na XLSM, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
