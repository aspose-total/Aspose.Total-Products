...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPSX do MARKDOWN přes Java nebo online" h2="On Premise Java API pro export PPSX do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
