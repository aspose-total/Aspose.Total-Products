...
description: Převeďte DOTX na XLSB přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/dotx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTX na XLSB přes Java" h2="On Premise Java API pro převod DOTX na XLSB bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
