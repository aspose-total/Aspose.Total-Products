---
title: Převést DOCX na POT přes Java nebo online
description: Java API pro export DOCX do POT bez použití Microsoft Word nebo PowerPoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník POT na CSV. nebo pomocí bezplatného online převodníku
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCX na POT přes Java nebo online" h2="Konverze DOCX na POT pomocí místního rozhraní Java API v jakékoli aplikaci Java J2SE, J2EE, J2ME bez použití Microsoft<sup>&reg;</sup> PowerPoint nebo Word" >}}
