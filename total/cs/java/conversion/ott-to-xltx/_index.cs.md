---
title: Java API pro převod OTT do XLTX nebo pomocí bezplatného online převodníku
description: Převeďte OTT na XLTX přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  OTT na XLTX. 
url_ignore: /cs/java/conversion/ott-to-xltx/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést OTT na XLTX přes Java nebo online aplikace" h2="On Premise Java API pro převod OTT na XLTX bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
