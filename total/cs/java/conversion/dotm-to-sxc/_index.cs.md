---
title: Java API pro převod DOTM do SXC nebo pomocí bezplatného online převodníku
description: Převeďte DOTM na SXC přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOTM na SXC. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTM na SXC přes Java nebo online aplikace" h2="On Premise Java API pro převod DOTM na SXC bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOTM do SXC" %}}
