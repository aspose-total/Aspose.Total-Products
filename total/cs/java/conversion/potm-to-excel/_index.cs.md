...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTM do EXCEL přes Java" h2="On Premise Java API pro export POTM do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POTM na EXCEL, můžete snadno použít Aspose.Total for Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
