...
description: Převeďte PPTX do formátu FODS přes Java bez použití Microsoft Excel nebo PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTX do FODS přes Java" h2="On Premise Java API pro export PPTX do FODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést PPTX na FODS, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
