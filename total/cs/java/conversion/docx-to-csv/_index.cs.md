...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOCX do CSV" %}}
...
<iframe title="Online nástroj csv až docx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=csv&from=docx" id="child-iframe" width="80%"></iframe>
