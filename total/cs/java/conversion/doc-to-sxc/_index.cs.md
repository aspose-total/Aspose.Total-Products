...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOC do SXC" %}}
...
<iframe title="Online nástroj sxc až doc" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=sxc&from=doc" id="child-iframe" width="80%"></iframe>
