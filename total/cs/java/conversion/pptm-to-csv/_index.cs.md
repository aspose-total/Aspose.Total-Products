...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte PPTM do CSV přes Java nebo online" h2="On Premise Java API pro export PPTM do CSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
