---
title: Java API pro převod DOTX do XLSM nebo pomocí bezplatného online převodníku
description: Převeďte DOTX na XLSM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  DOTX na XLSM. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOTX na XLSM přes Java nebo online aplikace" h2="On Premise Java API pro převod DOTX na XLSM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod DOTX do XLSM" %}}
