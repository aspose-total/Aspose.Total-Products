---
title: Java API pro převod DOCX do ODS
description: Převeďte DOCX na ODS přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/docx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCX na ODS přes Java" h2="On Premise Java API pro převod DOCX na ODS bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCX do ODS" %}}
