---
title: Java API pro převod ODT do XLTM nebo pomocí bezplatného online převodníku
description: Převeďte ODT na XLTM přes Java bez použití Microsoft Word nebo Microsoft Excel nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  ODT na XLTM. 
url_ignore: /cs/java/conversion/odt-to-xltm/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést ODT na XLTM přes Java nebo online aplikace" h2="On Premise Java API pro převod ODT na XLTM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API pro převod ODT do XLTM" %}}
