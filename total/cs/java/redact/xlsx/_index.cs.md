---
title: Redact XLSX Spreadsheet Online nebo pomocí Java
description: Otevřete a upravte dokument XLSX online prostřednictvím aplikace zdarma.Java API kód pro vyhledávání a nahrazování textu XLSX regulárním výrazem.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaktujte dokument XLSX online nebo přes Java" h2="Vyvíjejte výkonnou aplikaci pro úpravu dokumentů XLSX na bázi Java. Kód uvedený pro vyhledávání a nahrazování textu v souboru XLSX pomocí regulárního výrazu prostřednictvím Javy." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Úprava souboru XLSX přes Java" %}}

1. Přidejte odkaz na knihovnu do projektu Java
1. Načtěte soubor XLSX pomocí třídy Workbook
1. Získejte příslušný list pomocí getWorksheets().get(index)
...
{{% blocks/products/pf/agp/code-block title="Java Code: Redact XLSX Spreadsheet" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci XLSX Redaction přes Javu</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro úpravu XLSX?S [Aspose.Cells for Java](https://products.aspose.com/cells/cs/java/), podřízeným API [Aspose.Total for Java](https://products.aspose.com/total/cs/java/), může kterýkoli vývojář Java integrovat výše uvedený kód API do své aplikace pro úpravu dokumentů.Výkonná Java knihovna umožňuje programování libovolného řešení redakce tabulek.Navíc může podporovat mnoho populárních formátů včetně formátu XLSX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java Utility pro úpravu souboru XLSX" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, můžete si stáhnout tento kód a použít jej pro účely vývoje aplikace pro úpravu dokumentů na bázi Java.Tento kód může sloužit jako cenný zdroj pro vylepšení funkčnosti a schopností vašich projektů v oblasti zpracování a manipulace s dokumenty.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
