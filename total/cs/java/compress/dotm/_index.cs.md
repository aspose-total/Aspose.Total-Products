---
title: Komprimujte soubory DOTM online nebo přes Java
description: Bezplatná online aplikace pro kompresi různých souborů DOTM. Kód knihovny pro kompresi Java pro dokumenty DOTM.
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor DOTM přes Java" %}}
...
1. Zavolejte metodu uložení a získejte komprimovaný soubor DOTM

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Příklad kódu v Javě pro kompresi souborů DOTM" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů DOTM pomocí Javy</h2>

Potřebujete vyvinout Java skript nebo obslužnou aplikaci pro snadnou kompresi více souborů DOTM? S [Aspose.Words for Java](https://products.aspose.com/words/java/) podřízenými API [Aspose.Total for Java](https://products.aspose.com/total/java/) může kterýkoli vývojář Java integrovat výše uvedený kód API k naprogramování kompresní aplikace napříč dokumenty.Výkonná Java knihovna pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu DOTM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java Compression Library pro soubory DOTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru DOTM pomocí Java. Použijte Aspose DOTM kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v Javě.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci ke kompresi více dokumentů DOTM?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
