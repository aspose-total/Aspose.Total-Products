---
title: Komprimujte soubory DOC online nebo přes Java
description: Bezplatná online aplikace pro kompresi různých souborů DOC. Kód knihovny pro kompresi Java pro dokumenty DOC.
...
{{< blocks/products/pf/feature-page-header-widget h1="Komprimujte soubor DOC online prostřednictvím aplikace Compression nebo pomocí Java" h2="Vyvíjejte výkonné aplikace pro kompresi dokumentů DOC založené na Javě.Zdarma komprimujte různé dokumenty včetně souborů DOC online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor DOC přes Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Příklad kódu v Javě pro kompresi souborů DOC" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů DOC pomocí Javy</h2>

Potřebujete vyvinout Java skript nebo obslužnou aplikaci pro snadnou kompresi více souborů DOC? S [Aspose.Words for Java](https://products.aspose.com/words/java/) podřízenými API [Aspose.Total for Java](https://products.aspose.com/total/java/) může kterýkoli vývojář Java integrovat výše uvedený kód API k naprogramování kompresní aplikace napříč dokumenty.Výkonná Java knihovna pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu DOC.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java Compression Library pro soubory DOC" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru DOC pomocí Java. Použijte Aspose DOC kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v Javě.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Začněte nahráním jednoho nebo více souborů, které chcete komprimovat. Soubory DOC můžete buď přetáhnout myší, nebo jednoduše kliknout do bílé oblasti. Poté klikněte na tlačítko „Komprimovat“ a naše online aplikace pro kompresi nahrané soubory rychle zpracuje.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
