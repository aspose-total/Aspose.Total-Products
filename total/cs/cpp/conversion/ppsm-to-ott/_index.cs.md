---
title: C++ API pro převod PPSM na OTT
description: Exportujte PPSM do OTT v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppsm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSM do OTT" h2="Export PPSM do OTT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
