---
title: Převést WORD na XLSM v C++
description: C++ API pro převod WORD do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do XLSM" h2="Export WORD do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
