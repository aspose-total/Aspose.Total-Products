---
title: Převést RTF na DIF v C++
description: C++ API pro převod RTF do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do DIF" h2="Export RTF do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
