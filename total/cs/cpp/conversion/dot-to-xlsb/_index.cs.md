---
title: Převést DOT na XLSB v C++
description: C++ API pro převod DOT do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do XLSB" h2="Export DOT do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
