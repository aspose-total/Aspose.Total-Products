---
title: Převést DOC na PPTX přes C++
description: Exportujte DOC do PPTX ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/doc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC na PPTX" h2="Exportujte DOC do PPTX v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
