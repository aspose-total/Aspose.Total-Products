---
title: Převeďte PPSX do formátu JSON pomocí C++
description: Export PPSX do formátu JSON v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSX na formát JSON pomocí C++" h2="Export souboru PPSX do formátu JSON přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for C++](https://products.aspose.com/total/cpp/) můžete převést soubor PPSX do formátu JSON v aplikacích C++ ve dvou jednoduchých krocích. Za prvé, pomocí [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) můžete exportovat PPSX do HTML. Poté můžete pomocí rozhraní [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) Spreadsheet Programming API převést HTML na JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Převeďte PPSX na formát JSON pomocí C++" %}}
...
2. Převeďte PPSX na HTML pomocí metody [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba)
...
{{% blocks/products/pf/feature-page-section  h2="Převeďte chráněný PPSX na formát JSON pomocí C++" %}}
