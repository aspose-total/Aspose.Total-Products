---
title: Převést DOTX na XLAM v C++
description: C++ API pro převod DOTX do XLAM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do XLAM" h2="Export DOTX do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
