---
title: Převést ODT na FODS v C++
description: C++ API pro převod ODT do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do FODS" h2="Export ODT do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
