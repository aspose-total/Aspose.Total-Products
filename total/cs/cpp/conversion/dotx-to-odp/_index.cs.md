---
title: Převést DOTX na ODP přes C++
description: Exportujte DOTX do ODP ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX na ODP" h2="Exportujte DOTX do ODP v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
