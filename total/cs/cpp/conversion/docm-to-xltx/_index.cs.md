---
title: Převést DOCM na XLTX v C++
description: C++ API pro převod DOCM do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLTX" h2="Export DOCM do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
