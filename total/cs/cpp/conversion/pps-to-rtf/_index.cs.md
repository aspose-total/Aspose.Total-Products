...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPS do RTF nebo online" h2="Export PPS do RTF v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
