---
title: Převeďte XLSB na WORD pomocí C++
description: Převeďte XLSB na WORD v aplikacích C++
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSB na WORD přes C++" h2="Export Excel<sup>&reg;</sup> XLSB do WORD v rámci plně funkčních aplikací C++" >}}
