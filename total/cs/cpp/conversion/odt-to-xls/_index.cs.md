---
title: Převést ODT na XLS v C++
description: C++ API pro převod ODT do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLS" h2="Export ODT do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod ODT do XLS" %}}
