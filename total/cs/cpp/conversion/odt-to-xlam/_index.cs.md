---
title: Převést ODT na XLAM v C++
description: C++ API pro převod ODT do XLAM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLAM" h2="Export ODT do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
