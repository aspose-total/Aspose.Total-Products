...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPT do TEXT nebo online" h2="Export PPT do TEXT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
