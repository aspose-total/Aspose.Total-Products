---
title: C++ API pro převod PPT na TEXT
description: Exportujte PPT do TEXT v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppt-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPT do TEXT" h2="Export PPT do TEXT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
