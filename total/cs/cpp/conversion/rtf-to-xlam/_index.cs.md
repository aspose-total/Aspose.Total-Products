---
title: Převést RTF na XLAM v C++
description: C++ API pro převod RTF do XLAM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do XLAM" h2="Export RTF do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
