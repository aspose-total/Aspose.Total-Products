---
title: Převést DOT na POTM přes C++
description: Exportujte DOT do POTM ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT na POTM" h2="Exportujte DOT do POTM v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
