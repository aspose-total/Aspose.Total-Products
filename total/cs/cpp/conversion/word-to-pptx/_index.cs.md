---
title: Převést WORD na PPTX přes C++
description: Exportujte WORD do PPTX ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/word-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD na PPTX" h2="Exportujte WORD do PPTX v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
