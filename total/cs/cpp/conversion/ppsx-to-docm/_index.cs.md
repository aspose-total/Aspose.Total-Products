---
title: C++ API pro převod PPSX na DOCM
description: Exportujte PPSX do DOCM v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppsx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do DOCM" h2="Export PPSX do DOCM v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
