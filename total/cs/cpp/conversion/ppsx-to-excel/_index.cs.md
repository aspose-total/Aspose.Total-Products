---
title: Převeďte PPSX do EXCEL přes C++
description: Exportujte PPSX do EXCEL v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSX do EXCEL přes C++" h2="Konverze souborů PPSX do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
