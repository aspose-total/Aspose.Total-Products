---
title: Převést WORD na FODS v C++
description: C++ API pro převod WORD do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do FODS" h2="Export WORD do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod WORD do FODS" %}}
...
4. Uložte dokument do formátu FODS pomocí členské funkce [Uložit](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
