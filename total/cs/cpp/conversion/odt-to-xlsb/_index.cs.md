---
title: Převést ODT na XLSB v C++
description: C++ API pro převod ODT do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLSB" h2="Export ODT do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
