---
title: Převést DOCM na XLS v C++
description: C++ API pro převod DOCM do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLS" h2="Export DOCM do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
