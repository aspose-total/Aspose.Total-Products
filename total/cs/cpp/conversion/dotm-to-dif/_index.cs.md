---
title: Převést DOTM na DIF v C++
description: C++ API pro převod DOTM do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do DIF" h2="Export DOTM do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
