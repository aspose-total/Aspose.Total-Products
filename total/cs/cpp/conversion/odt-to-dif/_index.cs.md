---
title: Převést ODT na DIF v C++
description: C++ API pro převod ODT do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do DIF" h2="Export ODT do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
