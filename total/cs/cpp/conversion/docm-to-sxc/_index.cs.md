---
title: Převést DOCM na SXC v C++
description: C++ API pro převod DOCM do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do SXC" h2="Export DOCM do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
