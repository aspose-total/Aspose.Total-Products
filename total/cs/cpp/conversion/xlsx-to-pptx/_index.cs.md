---
title: Převeďte XLSX na PPTX pomocí C++
description: Převeďte XLSX na PPTX v aplikacích C++
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSX na PPTX přes C++" h2="Export Excel<sup>&reg;</sup> XLSX do PPTX v rámci plně funkčních aplikací C++" >}}
