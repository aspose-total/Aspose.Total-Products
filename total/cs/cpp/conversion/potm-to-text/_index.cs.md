---
title: C++ API pro převod POTM na TEXT
description: Exportujte POTM do TEXT v rámci vašich aplikací C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTM do TEXT" h2="Export POTM do TEXT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
