---
title: C++ API pro převod POT na FLATOPC
description: Exportujte POT do FLATOPC v rámci vašich aplikací C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POT do FLATOPC" h2="Export POT do FLATOPC v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
