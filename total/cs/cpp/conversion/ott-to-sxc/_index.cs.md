---
title: Převést OTT na SXC v C++
description: C++ API pro převod OTT do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do SXC" h2="Export OTT do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
