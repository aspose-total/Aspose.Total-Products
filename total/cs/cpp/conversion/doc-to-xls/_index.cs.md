---
title: Převést DOC na XLS v C++
description: C++ API pro převod DOC do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do XLS" h2="Export DOC do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
