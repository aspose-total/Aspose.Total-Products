---
title: C++ API pro převod PPSX na DOC
description: Exportujte PPSX do DOC v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do DOC" h2="Export PPSX do DOC v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
