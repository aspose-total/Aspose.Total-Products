---
title: C++ API pro převod POTM na WORD
description: Exportujte POTM do WORD v rámci vašich aplikací C++
url: /cs/cpp/conversion/potm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTM do WORD" h2="Export POTM do WORD v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
