...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do ODT nebo online aplikace" h2="Export PPSX do ODT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online aplikace pro převod PPSX je integrována výše. Chcete-li převést soubor PPSX na ODT pomocí tohoto online nástroje, můžete soubor PPSX přetáhnout do určené oblasti nebo kliknutím do bílé oblasti vybrat soubor ze zařízení. Jakmile je soubor PPSX vybrán, klikněte na tlačítko Převést. Po dokončení převodu PPSX na ODT si můžete stáhnout převedený soubor ODT jediným kliknutím.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
