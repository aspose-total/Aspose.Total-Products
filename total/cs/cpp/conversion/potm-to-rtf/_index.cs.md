---
title: C++ API pro převod POTM na RTF
description: Exportujte POTM do RTF v rámci vašich aplikací C++
url: /cs/cpp/conversion/potm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTM do RTF" h2="Export POTM do RTF v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
