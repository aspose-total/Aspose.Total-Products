---
title: Převést DOTM na XLSX v C++
description: C++ API pro převod DOTM do XLSX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do XLSX" h2="Export DOTM do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
