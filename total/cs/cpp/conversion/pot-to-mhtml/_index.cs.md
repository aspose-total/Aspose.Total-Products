---
title: Převeďte POT do MHTML přes C++
description: Exportujte POT do MHTML v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do MHTML přes C++" h2="Konverze souborů POT do MHTML přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
