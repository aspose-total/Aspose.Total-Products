---
title: Převeďte SXC na DOC pomocí C++
description: Převeďte SXC na DOC v aplikacích C++
url: /cs/cpp/conversion/sxc-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Převést SXC na DOC přes C++" h2="Export Excel<sup>&reg;</sup> SXC do DOC v rámci plně funkčních aplikací C++" >}}
