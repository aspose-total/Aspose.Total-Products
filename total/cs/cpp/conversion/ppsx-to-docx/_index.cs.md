---
title: C++ API pro převod PPSX na DOCX nebo pomocí bezplatného online převodníku
description: Exportujte PPSX do DOCX v rámci vašich aplikací C++ nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  PPSX na DOCX.
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod PPSX na DOCX" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online aplikace pro převod PPSX je integrována výše. Chcete-li převést soubor PPSX na DOCX pomocí tohoto online nástroje, můžete soubor PPSX přetáhnout do určené oblasti nebo kliknutím do bílé oblasti vybrat soubor ze zařízení. Jakmile je soubor PPSX vybrán, klikněte na tlačítko Převést. Po dokončení převodu PPSX na DOCX si můžete stáhnout převedený soubor DOCX jediným kliknutím.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
