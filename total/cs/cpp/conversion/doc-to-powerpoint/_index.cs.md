---
title: Převést DOC na POWERPOINT přes C++
description: Exportujte DOC do POWERPOINT ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC na POWERPOINT" h2="Exportujte DOC do POWERPOINT v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
