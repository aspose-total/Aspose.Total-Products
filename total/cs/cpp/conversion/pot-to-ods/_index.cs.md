---
title: Převeďte POT do ODS přes C++
description: Exportujte POT do ODS v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do ODS přes C++" h2="Konverze souborů POT do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
