---
title: Převést WORD na XLTM v C++
description: C++ API pro převod WORD do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do XLTM" h2="Export WORD do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
