---
title: Převést RTF na TSV v C++
description: C++ API pro převod RTF do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do TSV" h2="Export RTF do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
