---
title: Převést DOTX na DIF v C++
description: C++ API pro převod DOTX do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do DIF" h2="Export DOTX do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
