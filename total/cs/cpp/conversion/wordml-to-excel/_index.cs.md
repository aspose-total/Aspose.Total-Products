---
title: Převést WORDML na EXCEL v C++
description: C++ API pro převod WORDML do EXCEL bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do EXCEL" h2="Export WORDML do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
