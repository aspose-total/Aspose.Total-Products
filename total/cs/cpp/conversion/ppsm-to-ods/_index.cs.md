---
title: Převeďte PPSM do ODS přes C++
description: Exportujte PPSM do ODS v C++ bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSM do ODS přes C++" h2="Konverze souborů PPSM do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
