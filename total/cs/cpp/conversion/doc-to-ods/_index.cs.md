---
title: Převést DOC na ODS v C++
description: C++ API pro převod DOC do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do ODS" h2="Export DOC do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
