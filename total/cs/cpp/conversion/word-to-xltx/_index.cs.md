---
title: Převést WORD na XLTX v C++
description: C++ API pro převod WORD do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do XLTX" h2="Export WORD do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
