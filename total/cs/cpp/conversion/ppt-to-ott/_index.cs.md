---
title: C++ API pro převod PPT na OTT
description: Exportujte PPT do OTT v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppt-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPT do OTT" h2="Export PPT do OTT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
