---
title: Převést OTT na XLT v C++
description: C++ API pro převod OTT do XLT bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do XLT" h2="Export OTT do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
