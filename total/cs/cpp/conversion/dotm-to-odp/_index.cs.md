---
title: Převést DOTM na ODP přes C++
description: Exportujte DOTM do ODP ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM na ODP" h2="Exportujte DOTM do ODP v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
