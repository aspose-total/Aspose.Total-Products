---
title: Převést WORD na XLS v C++
description: C++ API pro převod WORD do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do XLS" h2="Export WORD do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
