---
title: C++ API pro převod POT na DOCM
description: Exportujte POT do DOCM v rámci vašich aplikací C++
url: /cs/cpp/conversion/pot-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POT do DOCM" h2="Export POT do DOCM v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
