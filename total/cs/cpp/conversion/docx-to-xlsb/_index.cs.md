---
title: Převést DOCX na XLSB v C++
description: C++ API pro převod DOCX do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLSB" h2="Export DOCX do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCX do XLSB" %}}
