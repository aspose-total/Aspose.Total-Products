---
title: Převést RTF na XLS v C++
description: C++ API pro převod RTF do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do XLS" h2="Export RTF do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
