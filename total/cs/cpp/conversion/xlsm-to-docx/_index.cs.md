---
title: Převeďte XLSM na DOCX pomocí C++
description: Převeďte XLSM na DOCX v aplikacích C++
url: /cs/cpp/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSM na DOCX přes C++" h2="Export Excel<sup>&reg;</sup> XLSM do DOCX v rámci plně funkčních aplikací C++" >}}
