---
title: Převést ODT na XLSX v C++
description: C++ API pro převod ODT do XLSX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLSX" h2="Export ODT do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
