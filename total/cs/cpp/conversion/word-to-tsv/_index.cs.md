---
title: Převést WORD na TSV v C++
description: C++ API pro převod WORD do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do TSV" h2="Export WORD do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
