...
url: /cs/cpp/conversion/svg-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: SVG
...
Jste vývojář C++, který chce přidat integraci funkce převodu SVG na POTX do vašich aplikací C++? Můžete to udělat ve dvou jednoduchých krocích. SVG můžete exportovat do PPTX pomocí [Aspose.PDF pro C++](https://products.aspose.com/pdf/cpp/). Za druhé, pomocí [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) můžete převést PPTX na POTX. Obě rozhraní API jsou součástí balíčku [Aspose.Total pro C++](https://products.aspose.com/total/cpp/). 
{{% /blocks/products/pf/feature-page-summary  %}}
