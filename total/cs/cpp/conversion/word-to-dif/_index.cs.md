---
title: Převést WORD na DIF v C++
description: C++ API pro převod WORD do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do DIF" h2="Export WORD do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
