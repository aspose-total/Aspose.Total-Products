---
title: Převeďte PPSX do DIF přes C++
description: Exportujte PPSX do DIF v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSX do DIF přes C++" h2="Konverze souborů PPSX do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
