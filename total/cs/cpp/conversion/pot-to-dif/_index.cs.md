---
title: Převeďte POT do DIF přes C++
description: Exportujte POT do DIF v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do DIF přes C++" h2="Konverze souborů POT do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
