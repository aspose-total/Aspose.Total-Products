...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do TEXT nebo online" h2="Export PPSX do TEXT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
