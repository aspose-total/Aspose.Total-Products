...
description: Exportujte PPS do DOCX v rámci vašich aplikací C++ nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  PPS na DOCX.
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPS do DOCX nebo online aplikace" h2="Export PPS do DOCX v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online aplikace pro převod PPS je integrována výše. Chcete-li převést soubor PPS na DOCX pomocí tohoto online nástroje, můžete soubor PPS přetáhnout do určené oblasti nebo kliknutím do bílé oblasti vybrat soubor ze zařízení. Jakmile je soubor PPS vybrán, klikněte na tlačítko Převést. Po dokončení převodu PPS na DOCX si můžete stáhnout převedený soubor DOCX jediným kliknutím.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
