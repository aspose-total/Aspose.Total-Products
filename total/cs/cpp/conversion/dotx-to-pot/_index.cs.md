---
title: Převést DOTX na POT přes C++
description: Exportujte DOTX do POT ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/dotx-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX na POT" h2="Exportujte DOTX do POT v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
