---
title: Převeďte XLS na DOC pomocí C++
description: Převeďte XLS na DOC v aplikacích C++
url: /cs/cpp/conversion/xls-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Převést XLS na DOC přes C++" h2="Export Excel<sup>&reg;</sup> XLS do DOC v rámci plně funkčních aplikací C++" >}}
