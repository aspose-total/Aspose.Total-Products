---
title: Převést DOTM na EXCEL v C++
description: C++ API pro převod DOTM do EXCEL bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do EXCEL" h2="Export DOTM do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
