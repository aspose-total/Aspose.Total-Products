---
title: Převést DOCX na CSV v C++
description: C++ API pro převod DOCX do CSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do CSV" h2="Export DOCX do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
