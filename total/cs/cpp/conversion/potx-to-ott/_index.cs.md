---
title: C++ API pro převod POTX na OTT
description: Exportujte POTX do OTT v rámci vašich aplikací C++
url: /cs/cpp/conversion/potx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTX do OTT" h2="Export POTX do OTT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
