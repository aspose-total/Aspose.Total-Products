---
title: Exportujte MSG do PNG přes C++
description: C++ API pro převod MSG do PNG bez použití Microsoft Word nebo Outlook
url: /cs/cpp/conversion/msg-to-png/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
Při exportu dokumentu z MSG do PNG můžete do aplikace přidat také funkce ochrany dokumentů. Přidání ochrany do vašeho dokumentu je jednoduchý proces, protože vše, co musíte udělat, je použít metodu ochrany vašeho dokumentu. Můžete nastavit typ ochrany na ReadOnly a omezit uživatele na úpravy dokumentu.
{{% blocks/products/pf/feature-page-code %}}
