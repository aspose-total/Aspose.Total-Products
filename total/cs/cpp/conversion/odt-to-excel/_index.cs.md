---
title: Převést ODT na EXCEL v C++
description: C++ API pro převod ODT do EXCEL bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do EXCEL" h2="Export ODT do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
