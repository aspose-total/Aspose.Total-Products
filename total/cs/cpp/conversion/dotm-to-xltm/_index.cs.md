---
title: Převést DOTM na XLTM v C++
description: C++ API pro převod DOTM do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do XLTM" h2="Export DOTM do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
