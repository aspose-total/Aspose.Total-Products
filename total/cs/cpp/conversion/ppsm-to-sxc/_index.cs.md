---
title: Převeďte PPSM do SXC přes C++
description: Exportujte PPSM do SXC v C++ bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSM do SXC přes C++" h2="Konverze souborů PPSM do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
