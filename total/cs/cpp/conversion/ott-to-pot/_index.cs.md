---
title: Převést OTT na POT přes C++
description: Exportujte OTT do POT ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/ott-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT na POT" h2="Exportujte OTT do POT v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
