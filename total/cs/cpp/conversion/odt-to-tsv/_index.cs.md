---
title: Převést ODT na TSV v C++
description: C++ API pro převod ODT do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do TSV" h2="Export ODT do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
2. Převeďte ODT do HTML pomocí členské funkce [Uložit](https://reference.aspose.com/words/cpp/class/aspose.words.odtument#save_string_saveformat)
