---
title: Převést DOT na ODS v C++
description: C++ API pro převod DOT do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do ODS" h2="Export DOT do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
