---
title: Převést DOTM na TSV v C++
description: C++ API pro převod DOTM do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do TSV" h2="Export DOTM do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
