---
title: Převést DOCX na FODS v C++
description: C++ API pro převod DOCX do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do FODS" h2="Export DOCX do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
