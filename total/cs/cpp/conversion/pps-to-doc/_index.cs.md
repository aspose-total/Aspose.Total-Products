---
title: C++ API pro převod PPS na DOC
description: Exportujte PPS do DOC v rámci vašich aplikací C++
url: /cs/cpp/conversion/pps-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPS do DOC" h2="Export PPS do DOC v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
