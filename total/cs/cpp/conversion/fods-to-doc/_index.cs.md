---
title: Převeďte FODS na DOC pomocí C++
description: Převeďte FODS na DOC v aplikacích C++
url: /cs/cpp/conversion/fods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Převést FODS na DOC přes C++" h2="Export Excel<sup>&reg;</sup> FODS do DOC v rámci plně funkčních aplikací C++" >}}
