---
title: Převeďte POT do XLSX přes C++
description: Exportujte POT do XLSX v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do XLSX přes C++" h2="Konverze souborů POT do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
