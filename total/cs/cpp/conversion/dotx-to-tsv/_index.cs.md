---
title: Převést DOTX na TSV v C++
description: C++ API pro převod DOTX do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do TSV" h2="Export DOTX do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
