---
title: Převést DOT na XLSM v C++
description: C++ API pro převod DOT do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do XLSM" h2="Export DOT do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
