---
title: C++ API pro převod POTX na WORDML
description: Exportujte POTX do WORDML v rámci vašich aplikací C++
url: /cs/cpp/conversion/potx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTX do WORDML" h2="Export POTX do WORDML v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
