---
title: Převést DOT na XLTX v C++
description: C++ API pro převod DOT do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do XLTX" h2="Export DOT do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
