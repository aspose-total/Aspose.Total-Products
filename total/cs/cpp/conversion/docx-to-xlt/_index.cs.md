---
title: Převést DOCX na XLT v C++
description: C++ API pro převod DOCX do XLT bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLT" h2="Export DOCX do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
