---
title: C++ API pro převod PPSM na DOCM nebo pomocí bezplatného online převodníku
description: Exportujte PPSM do DOCM v rámci vašich aplikací C++ nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  PPSM na DOCM.
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSM do DOCM nebo online aplikace" h2="Export PPSM do DOCM v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online aplikace pro převod PPSM je integrována výše. Chcete-li převést soubor PPSM na DOCM pomocí tohoto online nástroje, můžete soubor PPSM přetáhnout do určené oblasti nebo kliknutím do bílé oblasti vybrat soubor ze zařízení. Jakmile je soubor PPSM vybrán, klikněte na tlačítko Převést. Po dokončení převodu PPSM na DOCM si můžete stáhnout převedený soubor DOCM jediným kliknutím.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
