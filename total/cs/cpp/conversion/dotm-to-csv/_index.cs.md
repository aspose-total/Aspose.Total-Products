---
title: Převést DOTM na CSV v C++
description: C++ API pro převod DOTM do CSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do CSV" h2="Export DOTM do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOTM do CSV" %}}
