---
title: Převeďte PPT do FODS přes C++
description: Exportujte PPT do FODS v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do FODS přes C++" h2="Konverze souborů PPT do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
