---
title: Převést DOCM na XLAM v C++
description: C++ API pro převod DOCM do XLAM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLAM" h2="Export DOCM do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
