---
title: Převést ODT na ODS v C++
description: C++ API pro převod ODT do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do ODS" h2="Export ODT do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
