---
title: Převést WORD na XLSB v C++
description: C++ API pro převod WORD do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do XLSB" h2="Export WORD do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
