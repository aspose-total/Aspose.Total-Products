---
title: Převést DOCM na XLSM v C++
description: C++ API pro převod DOCM do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLSM" h2="Export DOCM do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCM do XLSM" %}}
