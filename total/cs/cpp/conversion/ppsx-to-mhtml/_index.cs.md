---
title: Převeďte PPSX do MHTML přes C++
description: Exportujte PPSX do MHTML v C++ bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSX do MHTML přes C++" h2="Konverze souborů PPSX do MHTML přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
