---
title: Převést WORDML na XLTX v C++
description: C++ API pro převod WORDML do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do XLTX" h2="Export WORDML do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
