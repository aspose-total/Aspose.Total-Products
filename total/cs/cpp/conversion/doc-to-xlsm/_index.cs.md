---
title: Převést DOC na XLSM v C++
description: C++ API pro převod DOC do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do XLSM" h2="Export DOC do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
