---
title: Převést WORDML na ODS v C++
description: C++ API pro převod WORDML do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do ODS" h2="Export WORDML do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
