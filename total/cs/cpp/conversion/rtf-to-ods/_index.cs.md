---
title: Převést RTF na ODS v C++
description: C++ API pro převod RTF do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do ODS" h2="Export RTF do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
