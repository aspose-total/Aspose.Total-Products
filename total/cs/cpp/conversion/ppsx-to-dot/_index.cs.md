---
title: C++ API pro převod PPSX na DOT
description: Exportujte PPSX do DOT v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do DOT" h2="Export PPSX do DOT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
