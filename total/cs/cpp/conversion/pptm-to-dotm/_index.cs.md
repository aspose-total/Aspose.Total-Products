---
title: C++ API pro převod PPTM na DOTM
description: Exportujte PPTM do DOTM v rámci vašich aplikací C++
url: /cs/cpp/conversion/pptm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTM do DOTM" h2="Export PPTM do DOTM v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
