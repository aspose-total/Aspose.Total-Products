---
title: Převést OTT na XLAM v C++
description: C++ API pro převod OTT do XLAM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do XLAM" h2="Export OTT do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
