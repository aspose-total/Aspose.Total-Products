---
title: Převést OTT na XLTX v C++
description: C++ API pro převod OTT do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do XLTX" h2="Export OTT do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
