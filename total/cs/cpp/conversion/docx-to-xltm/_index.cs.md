---
title: Převést DOCX na XLTM v C++
description: C++ API pro převod DOCX do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLTM" h2="Export DOCX do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
