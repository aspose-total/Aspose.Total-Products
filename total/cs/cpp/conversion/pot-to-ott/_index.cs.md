---
title: C++ API pro převod POT na OTT
description: Exportujte POT do OTT v rámci vašich aplikací C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POT do OTT" h2="Export POT do OTT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
