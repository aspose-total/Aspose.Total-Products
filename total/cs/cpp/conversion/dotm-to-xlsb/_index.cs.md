---
title: Převést DOTM na XLSB v C++
description: C++ API pro převod DOTM do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do XLSB" h2="Export DOTM do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOTM do XLSB" %}}
...
4. Uložte dokument do formátu XLSB pomocí členské funkce [Uložit](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
