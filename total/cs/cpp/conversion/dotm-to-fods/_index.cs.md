---
title: Převést DOTM na FODS v C++
description: C++ API pro převod DOTM do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do FODS" h2="Export DOTM do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
