---
title: C++ API pro převod PPTX na TEXT
description: Exportujte PPTX do TEXT v rámci vašich aplikací C++
url: /cs/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTX do TEXT" h2="Export PPTX do TEXT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
