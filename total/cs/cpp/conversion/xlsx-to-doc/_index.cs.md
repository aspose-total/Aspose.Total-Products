---
title: Převeďte XLSX na DOC pomocí C++
description: Převeďte XLSX na DOC v aplikacích C++
url: /cs/cpp/conversion/xlsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSX na DOC přes C++" h2="Export Excel<sup>&reg;</sup> XLSX do DOC v rámci plně funkčních aplikací C++" >}}
