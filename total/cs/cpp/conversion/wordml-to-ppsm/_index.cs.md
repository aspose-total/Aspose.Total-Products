---
title: Převést WORDML na PPSM přes C++
description: Exportujte WORDML do PPSM ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/wordml-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML na PPSM" h2="Exportujte WORDML do PPSM v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
