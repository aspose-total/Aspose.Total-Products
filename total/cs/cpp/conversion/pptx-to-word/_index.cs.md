---
title: C++ API pro převod PPTX na WORD
description: Exportujte PPTX do WORD v rámci vašich aplikací C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTX do WORD" h2="Export PPTX do WORD v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
