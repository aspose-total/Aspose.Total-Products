---
title: Převést OTT na TSV v C++
description: C++ API pro převod OTT do TSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do TSV" h2="Export OTT do TSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
