---
title: Převést DOCX na ODS v C++
description: C++ API pro převod DOCX do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do ODS" h2="Export DOCX do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
