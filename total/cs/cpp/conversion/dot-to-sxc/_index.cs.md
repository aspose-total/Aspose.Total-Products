---
title: Převést DOT na SXC v C++
description: C++ API pro převod DOT do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do SXC" h2="Export DOT do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
