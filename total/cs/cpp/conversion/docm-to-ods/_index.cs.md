---
title: Převést DOCM na ODS v C++
description: C++ API pro převod DOCM do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do ODS" h2="Export DOCM do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
