---
title: Převést DOCM na FODS v C++
description: C++ API pro převod DOCM do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do FODS" h2="Export DOCM do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
