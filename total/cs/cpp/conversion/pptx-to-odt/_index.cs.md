---
title: C++ API pro převod PPTX na ODT
description: Exportujte PPTX do ODT v rámci vašich aplikací C++
url: /cs/cpp/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTX do ODT" h2="Export PPTX do ODT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
