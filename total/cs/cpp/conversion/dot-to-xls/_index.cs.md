---
title: Převést DOT na XLS v C++
description: C++ API pro převod DOT do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do XLS" h2="Export DOT do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
