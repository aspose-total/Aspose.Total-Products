---
title: Převeďte XLSB na DOC pomocí C++
description: Převeďte XLSB na DOC v aplikacích C++
url: /cs/cpp/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSB na DOC přes C++" h2="Export Excel<sup>&reg;</sup> XLSB do DOC v rámci plně funkčních aplikací C++" >}}
