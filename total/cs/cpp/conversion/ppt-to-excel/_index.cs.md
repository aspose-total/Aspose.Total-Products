---
title: Převeďte PPT do EXCEL přes C++
description: Exportujte PPT do EXCEL v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do EXCEL přes C++" h2="Konverze souborů PPT do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
