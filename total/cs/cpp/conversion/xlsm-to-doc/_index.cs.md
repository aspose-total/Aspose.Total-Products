---
title: Převeďte XLSM na DOC pomocí C++
description: Převeďte XLSM na DOC v aplikacích C++
url: /cs/cpp/conversion/xlsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSM na DOC přes C++" h2="Export Excel<sup>&reg;</sup> XLSM do DOC v rámci plně funkčních aplikací C++" >}}
