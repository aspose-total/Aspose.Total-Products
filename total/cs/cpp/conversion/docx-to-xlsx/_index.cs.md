---
title: Převést DOCX na XLSX v C++
description: C++ API pro převod DOCX do XLSX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLSX" h2="Export DOCX do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
