---
title: Převeďte XLS na PPTX pomocí C++
description: Převeďte XLS na PPTX v aplikacích C++
url: /cs/cpp/conversion/xls-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Převést XLS na PPTX přes C++" h2="Export Excel<sup>&reg;</sup> XLS do PPTX v rámci plně funkčních aplikací C++" >}}
