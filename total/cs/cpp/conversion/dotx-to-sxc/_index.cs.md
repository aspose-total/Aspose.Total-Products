---
title: Převést DOTX na SXC v C++
description: C++ API pro převod DOTX do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do SXC" h2="Export DOTX do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
