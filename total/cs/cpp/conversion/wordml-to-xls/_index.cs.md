---
title: Převést WORDML na XLS v C++
description: C++ API pro převod WORDML do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do XLS" h2="Export WORDML do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod WORDML do XLS" %}}
