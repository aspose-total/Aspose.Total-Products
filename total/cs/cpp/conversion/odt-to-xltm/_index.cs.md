---
title: Převést ODT na XLTM v C++
description: C++ API pro převod ODT do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLTM" h2="Export ODT do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod ODT do XLTM" %}}
