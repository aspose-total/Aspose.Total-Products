---
title: Převést RTF na ODP přes C++
description: Exportujte RTF do ODP ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/rtf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF na ODP" h2="Exportujte RTF do ODP v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
