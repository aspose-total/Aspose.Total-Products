---
title: C++ API pro převod PPSX na FLATOPC
description: Exportujte PPSX do FLATOPC v rámci vašich aplikací C++
url: /cs/cpp/conversion/ppsx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPSX do FLATOPC" h2="Export PPSX do FLATOPC v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
