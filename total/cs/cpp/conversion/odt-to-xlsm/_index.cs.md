---
title: Převést ODT na XLSM v C++
description: C++ API pro převod ODT do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLSM" h2="Export ODT do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
