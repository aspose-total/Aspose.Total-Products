---
title: Převést ODT na CSV v C++
description: C++ API pro převod ODT do CSV bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do CSV" h2="Export ODT do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
