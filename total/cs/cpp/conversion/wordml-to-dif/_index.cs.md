---
title: Převést WORDML na DIF v C++
description: C++ API pro převod WORDML do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do DIF" h2="Export WORDML do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
