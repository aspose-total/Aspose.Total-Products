---
title: Exportujte OFT do XPS přes C++
description: C++ API pro převod OFT do XPS bez použití Microsoft Word nebo Outlook
url: /cs/cpp/conversion/oft-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
Při exportu dokumentu z OFT do XPS můžete do aplikace přidat také funkce ochrany dokumentů. Přidání ochrany do vašeho dokumentu je jednoduchý proces, protože vše, co musíte udělat, je použít metodu ochrany vašeho dokumentu. Můžete nastavit typ ochrany na ReadOnly a omezit uživatele na úpravy dokumentu.
{{% blocks/products/pf/feature-page-code %}}
