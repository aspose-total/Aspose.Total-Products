---
title: Převést DOTX na ODS v C++
description: C++ API pro převod DOTX do ODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do ODS" h2="Export DOTX do ODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
