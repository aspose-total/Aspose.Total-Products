---
title: Převést DOCX na XLS v C++
description: C++ API pro převod DOCX do XLS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLS" h2="Export DOCX do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
