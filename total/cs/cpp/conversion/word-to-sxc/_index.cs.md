---
title: Převést WORD na SXC v C++
description: C++ API pro převod WORD do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/word-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORD do SXC" h2="Export WORD do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
