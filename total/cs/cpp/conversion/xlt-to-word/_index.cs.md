---
title: Převeďte XLT na WORD pomocí C++
description: Převeďte XLT na WORD v aplikacích C++
url: /cs/cpp/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Převést XLT na WORD přes C++" h2="Export Excel<sup>&reg;</sup> XLT do WORD v rámci plně funkčních aplikací C++" >}}
