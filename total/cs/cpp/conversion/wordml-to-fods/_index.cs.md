---
title: Převést WORDML na FODS v C++
description: C++ API pro převod WORDML do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do FODS" h2="Export WORDML do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
