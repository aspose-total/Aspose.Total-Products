---
title: C++ API pro převod POWERPOINT na DOCX
description: Exportujte POWERPOINT do DOCX v rámci vašich aplikací C++
url: /cs/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POWERPOINT do DOCX" h2="Export POWERPOINT do DOCX v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
