---
title: Převést DOCX na SXC v C++
description: C++ API pro převod DOCX do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do SXC" h2="Export DOCX do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCX do SXC" %}}
