---
title: Převést DOCX na XLSM v C++
description: C++ API pro převod DOCX do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLSM" h2="Export DOCX do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
