---
title: Převést DOC na XLSB v C++
description: C++ API pro převod DOC do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do XLSB" h2="Export DOC do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
