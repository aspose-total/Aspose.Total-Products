---
title: Převést OTT na XLTM v C++
description: C++ API pro převod OTT do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do XLTM" h2="Export OTT do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
