---
title: C++ API pro převod POTM na ODT
description: Exportujte POTM do ODT v rámci vašich aplikací C++
url: /cs/cpp/conversion/potm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTM do ODT" h2="Export POTM do ODT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
