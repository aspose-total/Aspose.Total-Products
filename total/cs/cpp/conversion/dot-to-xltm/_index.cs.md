---
title: Převést DOT na XLTM v C++
description: C++ API pro převod DOT do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do XLTM" h2="Export DOT do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
