...
url: /cs/cpp/conversion/xltm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Převést XLTM na PPTX přes C++" h2="Export Excel&reg; XLTM do PPTX v rámci plně funkčních aplikací C++" >}}
