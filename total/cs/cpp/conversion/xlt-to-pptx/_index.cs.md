---
title: Převeďte XLT na PPTX pomocí C++
description: Převeďte XLT na PPTX v aplikacích C++
url: /cs/cpp/conversion/xlt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Převést XLT na PPTX přes C++" h2="Export Excel<sup>&reg;</sup> XLT do PPTX v rámci plně funkčních aplikací C++" >}}
