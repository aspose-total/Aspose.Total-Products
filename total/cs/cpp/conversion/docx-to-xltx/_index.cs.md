---
title: Převést DOCX na XLTX v C++
description: C++ API pro převod DOCX do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCX do XLTX" h2="Export DOCX do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
