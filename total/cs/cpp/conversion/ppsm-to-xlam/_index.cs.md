---
title: Převeďte PPSM do XLAM přes C++
description: Exportujte PPSM do XLAM v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSM do XLAM přes C++" h2="Konverze souborů PPSM do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
