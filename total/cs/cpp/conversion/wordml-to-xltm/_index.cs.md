---
title: Převést WORDML na XLTM v C++
description: C++ API pro převod WORDML do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do XLTM" h2="Export WORDML do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
