---
title: C++ API pro převod POTX na DOT
description: Exportujte POTX do DOT v rámci vašich aplikací C++
url: /cs/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTX do DOT" h2="Export POTX do DOT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
