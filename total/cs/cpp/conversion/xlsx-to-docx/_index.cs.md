---
title: Převeďte XLSX na DOCX pomocí C++
description: Převeďte XLSX na DOCX v aplikacích C++
url: /cs/cpp/conversion/xlsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Převést XLSX na DOCX přes C++" h2="Export Excel<sup>&reg;</sup> XLSX do DOCX v rámci plně funkčních aplikací C++" >}}
