---
title: Převeďte POT do CSV přes C++
description: Exportujte POT do CSV v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do CSV přes C++" h2="Konverze souborů POT do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
