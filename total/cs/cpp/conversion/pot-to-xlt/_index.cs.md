---
title: Převeďte POT do XLT přes C++
description: Exportujte POT do XLT v C++ bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do XLT přes C++" h2="Konverze souborů POT do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
