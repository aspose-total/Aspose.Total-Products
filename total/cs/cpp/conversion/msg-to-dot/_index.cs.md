...
4. Uložte dokument do formátu DOT pomocí metody [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) a nastavte Dot jako SaveFormat
