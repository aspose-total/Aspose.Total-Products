---
title: Převést DOTM na XLT v C++
description: C++ API pro převod DOTM do XLT bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTM do XLT" h2="Export DOTM do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
