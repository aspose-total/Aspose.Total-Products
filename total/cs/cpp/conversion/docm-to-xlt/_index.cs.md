---
title: Převést DOCM na XLT v C++
description: C++ API pro převod DOCM do XLT bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLT" h2="Export DOCM do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
