---
title: Převést RTF na PPS přes C++
description: Exportujte RTF do PPS ve svých aplikacích C++ bez použití Microsoft Word nebo PowerPoint
url: /cs/cpp/conversion/rtf-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF na PPS" h2="Exportujte RTF do PPS v rámci vašich C++ aplikací bez použití Microsoft Word&reg; nebo PowerPoint" >}}
