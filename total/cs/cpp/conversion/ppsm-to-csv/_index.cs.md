---
title: Převeďte PPSM do CSV přes C++
description: Exportujte PPSM do CSV v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSM do CSV přes C++" h2="Konverze souborů PPSM do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
