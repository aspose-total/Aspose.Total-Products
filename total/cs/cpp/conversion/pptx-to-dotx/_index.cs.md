---
title: C++ API pro převod PPTX na DOTX
description: Exportujte PPTX do DOTX v rámci vašich aplikací C++
url: /cs/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTX do DOTX" h2="Export PPTX do DOTX v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
