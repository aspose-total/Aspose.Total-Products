---
title: Převést DOT na DIF v C++
description: C++ API pro převod DOT do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dot-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOT do DIF" h2="Export DOT do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOT do DIF" %}}
1. Otevřete soubor DOT pomocí odkazu třídy [Dotument](https://reference.aspose.com/words/cpp/class/aspose.words.dotument)
2. Převeďte DOT do HTML pomocí členské funkce [Uložit](https://reference.aspose.com/words/cpp/class/aspose.words.dotument#save_string_saveformat)
