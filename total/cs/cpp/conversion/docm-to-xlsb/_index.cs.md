---
title: Převést DOCM na XLSB v C++
description: C++ API pro převod DOCM do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLSB" h2="Export DOCM do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
