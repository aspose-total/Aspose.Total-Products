---
title: Převést DOC na XLTX v C++
description: C++ API pro převod DOC do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do XLTX" h2="Export DOC do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOC do XLTX" %}}
