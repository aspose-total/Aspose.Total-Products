---
title: Převést DOCM na XLTM v C++
description: C++ API pro převod DOCM do XLTM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLTM" h2="Export DOCM do XLTM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
