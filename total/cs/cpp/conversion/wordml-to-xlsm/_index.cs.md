---
title: Převést WORDML na XLSM v C++
description: C++ API pro převod WORDML do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do XLSM" h2="Export WORDML do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Uložte dokument do formátu XLSM pomocí členské funkce [Uložit](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
