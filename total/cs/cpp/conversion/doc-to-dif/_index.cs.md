---
title: Převést DOC na DIF v C++
description: C++ API pro převod DOC do DIF bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do DIF" h2="Export DOC do DIF přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
