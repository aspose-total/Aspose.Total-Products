---
title: Převeďte PPSX do XLS přes C++
description: Exportujte PPSX do XLS v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppsx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPSX do XLS přes C++" h2="Konverze souborů PPSX do XLS přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
