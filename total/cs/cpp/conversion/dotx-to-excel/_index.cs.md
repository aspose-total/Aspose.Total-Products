---
title: Převést DOTX na EXCEL v C++
description: C++ API pro převod DOTX do EXCEL bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do EXCEL" h2="Export DOTX do EXCEL přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
