---
title: Převést DOCM na XLSX v C++
description: C++ API pro převod DOCM do XLSX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/docm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOCM do XLSX" h2="Export DOCM do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
