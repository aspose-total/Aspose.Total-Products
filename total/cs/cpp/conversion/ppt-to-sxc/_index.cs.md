---
title: Převeďte PPT do SXC přes C++
description: Exportujte PPT do SXC v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppt-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do SXC přes C++" h2="Konverze souborů PPT do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
