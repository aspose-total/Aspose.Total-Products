---
title: Převeďte PPT do XLSB přes C++
description: Exportujte PPT do XLSB v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppt-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do XLSB přes C++" h2="Konverze souborů PPT do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
