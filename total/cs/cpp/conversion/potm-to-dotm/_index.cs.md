---
title: C++ API pro převod POTM na DOTM
description: Exportujte POTM do DOTM v rámci vašich aplikací C++
url: /cs/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení POTM do DOTM" h2="Export POTM do DOTM v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
