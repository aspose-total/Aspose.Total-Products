---
title: Převeďte PPT do XLT přes C++
description: Exportujte PPT do XLT v C++ bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do XLT přes C++" h2="Konverze souborů PPT do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
