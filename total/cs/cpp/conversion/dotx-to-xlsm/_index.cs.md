---
title: Převést DOTX na XLSM v C++
description: C++ API pro převod DOTX do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do XLSM" h2="Export DOTX do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
