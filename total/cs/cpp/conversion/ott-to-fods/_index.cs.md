---
title: Převést OTT na FODS v C++
description: C++ API pro převod OTT do FODS bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do FODS" h2="Export OTT do FODS přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
