---
title: C++ API pro převod PPTM na OTT
description: Exportujte PPTM do OTT v rámci vašich aplikací C++
url: /cs/cpp/conversion/pptm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro vykreslení PPTM do OTT" h2="Export PPTM do OTT v aplikacích C++ bez jakýchkoli závislostí Microsoft PowerPoint nebo Word" >}}
