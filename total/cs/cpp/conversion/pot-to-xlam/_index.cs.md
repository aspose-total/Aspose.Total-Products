---
title: Převeďte POT do XLAM přes C++
description: Exportujte POT do XLAM v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/pot-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte POT do XLAM přes C++" h2="Konverze souborů POT do XLAM přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
