---
title: Převeďte PPT do CSV přes C++
description: Exportujte PPT do CSV v C++ bez použití Microsoft Excel nebo Powerpoint
url: /cs/cpp/conversion/ppt-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte PPT do CSV přes C++" h2="Konverze souborů PPT do CSV přes C++ bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
