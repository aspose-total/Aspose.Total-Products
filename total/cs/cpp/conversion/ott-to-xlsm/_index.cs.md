---
title: Převést OTT na XLSM v C++
description: C++ API pro převod OTT do XLSM bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/ott-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod OTT do XLSM" h2="Export OTT do XLSM přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
