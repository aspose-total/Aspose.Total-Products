---
title: Převést ODT na SXC v C++
description: C++ API pro převod ODT do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do SXC" h2="Export ODT do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
