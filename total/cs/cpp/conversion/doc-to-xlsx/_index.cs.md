---
title: Převést DOC na XLSX v C++
description: C++ API pro převod DOC do XLSX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOC do XLSX" h2="Export DOC do XLSX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
