---
title: Převést DOTX na XLT v C++
description: C++ API pro převod DOTX do XLT bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/dotx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod DOTX do XLT" h2="Export DOTX do XLT přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOTX do XLT" %}}
