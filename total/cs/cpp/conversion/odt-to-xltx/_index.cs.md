---
title: Převést ODT na XLTX v C++
description: C++ API pro převod ODT do XLTX bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/odt-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod ODT do XLTX" h2="Export ODT do XLTX přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
