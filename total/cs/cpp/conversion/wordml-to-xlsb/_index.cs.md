---
title: Převést WORDML na XLSB v C++
description: C++ API pro převod WORDML do XLSB bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/wordml-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod WORDML do XLSB" h2="Export WORDML do XLSB přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
