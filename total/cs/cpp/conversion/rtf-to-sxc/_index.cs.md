---
title: Převést RTF na SXC v C++
description: C++ API pro převod RTF do SXC bez použití Microsoft Word nebo Microsoft Excel
url: /cs/cpp/conversion/rtf-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API pro převod RTF do SXC" h2="Export RTF do SXC přes C++ bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
