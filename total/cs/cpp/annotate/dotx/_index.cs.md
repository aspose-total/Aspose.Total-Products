---
title: Odeberte DOTX Annotation Online nebo Spravujte anotace pomocí C++
description: odstranit komentáře ze souboru DOTX prostřednictvím online aplikace zdarma. C++ API kód pro správu komentářů souborů DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Vymazat komentáře z DOTX Document Online nebo Spravovat přes C++" h2="Vyvíjejte výkonnou aplikaci pro anotaci dokumentů DOTX na bázi C++. Uvedený kód pro správu komentářů k souboru DOTX prostřednictvím C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Odstraňte komentáře dokumentu DOTX pomocí C++" %}}

1. Přidejte odkaz na knihovnu do projektu C++
1. Načtěte soubor DOTX
...
{{% blocks/products/pf/agp/code-block title="Kód C++: Odstraňte komentáře ze souboru DOTX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód C++: Přidejte komentář k souboru DOTX" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro anotaci dokumentů DOTX prostřednictvím C++</h2>

Potřebujete vyvinout anotační aplikaci nebo nástroj DOTX pro poskytování zpětné vazby, návrhy nebo spolupráci s ostatními na dokumentu?S [Aspose.Words for C++](https://products.aspose.com/words/cpp/), podřízeným API [Aspose.Total for C++](https://products.aspose.com/total/cs/cpp/), může každý vývojář C++ integrovat výše uvedený kód API do své aplikace pro anotaci dokumentů.Výkonná knihovna C++ umožňuje programování libovolného řešení anotací dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu DOTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Knihovna C++ pro anotaci souborů DOTX" %}}
