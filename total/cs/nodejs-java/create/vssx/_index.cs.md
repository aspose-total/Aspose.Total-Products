---
title: Vytvořte VSSX diagramy Visio v Node.js
description: Generujte diagramy Microsoft Visio VSSX pomocí aplikací Node bez použití sady Microsoft Office.  
...
{{< blocks/products/pf/feature-page-header h1="Vytvořte soubor VSSX pomocí Node.js" h2="Vytvářejte soubory Microsoft Visio VSSX prostřednictvím aplikací Node bez instalace dalšího softwaru." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Vytvořte soubor VSSX v Node.js" %}}

- Vytvořte instanci třídy Diagram.
- Zavolejte metodu uložení s příslušnými parametry
- VSSX Cesta k souboru a relevantní přípona SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Požadavky na vytvoření" %}}

- Pro vytvoření dokumentu VSSX musí být v systému nainstalován soubor Node.js.
- Vyžaduje se Oracle JDK (verze 7 nebo novější).
- Balíček node-java musí být nastaven.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js – Vytvořte soubory VSSX" offSpacer="" %}}
