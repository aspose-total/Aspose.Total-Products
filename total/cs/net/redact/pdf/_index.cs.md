---
title: Redaktujte dokument PDF online nebo pomocí .NET
description: Otevřete a upravte dokument PDF online prostřednictvím aplikace zdarma. .NET API C# kód pro vyhledávání a nahrazování textu PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaktujte dokument PDF online nebo přes .NET" h2="Vyvinout výkonnou aplikaci pro úpravu dokumentů PDF na bázi .NET.C# Kód uvedený pro vyhledávání a nahrazování textu v souboru PDF prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Úprava souboru PDF přes .NET" %}}
...
1. Získejte všechny TextFragmenty v TextFragmentCollection
1. Procházejte každou kolekci fragmentů
1. Definujte RedactionAnnotation a zavolejte metodu Redact().
...
{{% blocks/products/pf/agp/code-block title="Kód C#: Redigovat soubor PDF" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci PDF Redaction přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro úpravu PDF?S [Aspose.PDF for .NET](https://products.aspose.com/pdf/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro úpravu dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení redakce dokumentů. Navíc může podporovat mnoho populárních formátů včetně formátu PDF.<br /><br />
