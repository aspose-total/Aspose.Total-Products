---
title: Redaktujte dokument ODT online nebo pomocí .NET
description: Otevřete a upravte dokument ODT online prostřednictvím aplikace zdarma..NET API C# kód pro vyhledávání a nahrazování textu ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaktujte dokument ODT online nebo přes .NET" h2="Vyvinout výkonnou aplikaci pro úpravu dokumentů ODT na bázi .NET.C# Kód uvedený pro vyhledávání a nahrazování textu v souboru ODT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Redaktujte dokument ODT online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Úprava souboru ODT přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód C#: Redigovat soubor ODT" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci ODT Redaction přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro úpravu ODT?S [Aspose.Words for .NET](https://products.aspose.com/words/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro úpravu dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení redakce dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro úpravu souboru ODT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 Redakce v .odt (OpenDocument Text)

- Redigujte osobní údaje z komunitních zpráv nebo akademických prací.
- Redigujte důvěrné části ve vládních nebo organizačních dokumentech.
- Redigujte kontaktní informace nebo identifikační značky ve sdílených návrzích.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci ke správě redakce dokumentů ODT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Pro online redigování dokumentů ODT můžete použít jakýkoli moderní webový prohlížeč, jako je Google Chrome, Firefox, Opera nebo Safari.Pokud však vyvíjíte desktopovou aplikaci, doporučujeme pro efektivní správu použít rozhraní API pro zpracování dokumentů Aspose.Total.</span>
                      </div>
                  </li>
              </ul>
          </div>
