---
title: Redact PPTX Presentation Online nebo pomocí .NET
description: Otevřete a upravte dokument PPTX online prostřednictvím aplikace zdarma. .NET API C# kód pro vyhledávání a nahrazování textu PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redact PPTX Document Online nebo přes .NET" h2="Vyvinout výkonnou .NET založenou PPTX aplikaci pro úpravu prezentací. C# Kód uvedený pro vyhledávání a nahrazování textu v souboru PPTX." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Úprava souboru PPTX přes .NET" %}}
...
<h2>Vyvíjejte aplikaci PPTX Redaction přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro úpravu PPTX?S [Aspose.Slides for .NET](https://products.aspose.com/slides/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro úpravu dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení redakce dokumentů. Navíc může podporovat mnoho populárních formátů včetně formátu PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro úpravu souboru PPTX" %}}
