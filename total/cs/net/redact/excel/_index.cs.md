---
title: Redact Excel Spreadsheet Online nebo pomocí .NET
description: Otevřete a upravte dokument Excel online prostřednictvím aplikace zdarma. .NET API C# kód pro vyhledávání a nahrazování textu Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaktujte dokument Excel online nebo přes .NET" h2="Vyvinout výkonnou aplikaci pro úpravu dokumentů Excel na bázi .NET. C# Kód uvedený pro vyhledávání a nahrazování textu v souboru Excel." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Úprava souboru Excel přes .NET" %}}
...
<h2>Vyvíjejte aplikaci Excel Redaction přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro úpravu Excel? S [Aspose.Cells for .NET](https://products.aspose.com/cells/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro úpravu dokumentů. Výkonná knihovna .NET umožňuje programování libovolného řešení redakce tabulek. Navíc může podporovat mnoho populárních formátů včetně formátu Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro úpravu souboru Excel" %}}
