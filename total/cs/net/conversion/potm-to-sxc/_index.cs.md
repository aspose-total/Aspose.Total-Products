...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na SXC přes C#" h2=".NET API pro převod POTM do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
