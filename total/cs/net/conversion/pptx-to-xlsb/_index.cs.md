---
title: Převést PPTX na XLSB přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na XLSB přes C# nebo online" h2=".NET API pro převod PPTX do XLSB bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
