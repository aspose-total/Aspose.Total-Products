---
title: Převeďte XLSX na DOCX pomocí .NET 
description: Převeďte XLSX na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSX na DOCX přes C#" h2="Export Excel&reg; XLSX do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
