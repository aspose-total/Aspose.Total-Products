---
title: .NET API pro převod DOTX do ODS
description: C# API pro převod DOTX do ODS bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/dotx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOTX na ODS" h2="Export DOTX do ODS přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
