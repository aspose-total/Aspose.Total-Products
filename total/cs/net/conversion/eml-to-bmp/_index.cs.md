...
4. Uložte dokument do formátu BMP pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Bmp jako SaveFormat
