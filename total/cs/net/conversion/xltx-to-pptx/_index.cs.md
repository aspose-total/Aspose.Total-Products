---
title: Převeďte XLTX na PPTX pomocí .NET 
description: Převeďte XLTX na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xltx-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTX na PPTX přes C#" h2="Export Excel&reg; XLTX do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
