---
title: .NET API pro převod ODT do SXC
description: C# API pro převod ODT do SXC bez použití Microsoft Excel nebo Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod ODT na SXC" h2="Export ODT do SXC přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
