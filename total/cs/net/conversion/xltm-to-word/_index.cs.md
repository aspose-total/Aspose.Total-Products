---
title: Převeďte XLTM na WORD pomocí .NET 
description: Převeďte XLTM na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTM na WORD přes C#" h2="Export Excel&reg; XLTM do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
