...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTM na WORD přes C# nebo online aplikace" h2="Export Excel&reg; XLTM do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
