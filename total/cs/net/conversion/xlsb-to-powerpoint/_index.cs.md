---
title: Převeďte XLSB na POWERPOINT pomocí .NET 
description: Převeďte XLSB na POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlsb-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSB na POWERPOINT přes C#" h2="Export Excel&reg; XLSB do POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
