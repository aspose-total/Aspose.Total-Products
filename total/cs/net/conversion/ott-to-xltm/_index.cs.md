...
description: C# API pro převod OTT do XLTM bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/ott-to-xltm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod OTT na XLTM" h2="Export OTT do XLTM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
