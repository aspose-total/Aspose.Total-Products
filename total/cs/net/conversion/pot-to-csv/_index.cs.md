---
title: Převést POT na CSV přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POT na CSV přes C# nebo online" h2=".NET API pro převod POT do CSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
