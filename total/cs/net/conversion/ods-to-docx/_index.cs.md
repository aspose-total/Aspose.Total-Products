---
title: Převeďte ODS na DOCX pomocí .NET 
description: Převeďte ODS na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/ods-to-docx/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést ODS na DOCX přes C#" h2="Export Excel&reg; ODS do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
