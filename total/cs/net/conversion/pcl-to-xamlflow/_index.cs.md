---
title: C# API pro export PCL do XAMLFLOW
description: Převeďte PCL na XAMLFLOW bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/pcl-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete PCL na XAMLFLOW přes .NET" h2=".NET API pro export PCL do XAMLFLOW na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod PCL na XAMLFLOW" %}}
1. Otevřete soubor PCL pomocí třídy [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document)
2. Převeďte PCL na Doc pomocí metody [Save](https://apireference.aspose.com/pdf/net/aspose.pdf.document/save/methods/5)
