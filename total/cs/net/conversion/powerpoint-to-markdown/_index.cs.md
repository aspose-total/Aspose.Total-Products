---
title: Převést POWERPOINT na MARKDOWN přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na MARKDOWN přes C# nebo online" h2=".NET API pro převod POWERPOINT do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
