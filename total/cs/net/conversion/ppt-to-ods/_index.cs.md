---
title: Převést PPT na ODS přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPT na ODS přes C# nebo online" h2=".NET API pro převod PPT do ODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
