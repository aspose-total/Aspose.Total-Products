---
title: Převést POTX na XLT přes C#
description: Převeďte POTX na XLT v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na XLT přes C#" h2=".NET API pro převod POTX do XLT bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
