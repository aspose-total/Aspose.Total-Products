---
title: Převeďte XLTM na DOCX pomocí .NET 
description: Převeďte XLTM na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTM na DOCX přes C#" h2="Export Excel&reg; XLTM do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
