---
title: Převést PPT na XLTM přes C#
description: Převeďte PPT na XLTM v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPT na XLTM přes C#" h2=".NET API pro převod PPT do XLTM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
