...
4. Uložte dokument do formátu ODP pomocí metody [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) a nastavte `Odp` jako SaveFormat
