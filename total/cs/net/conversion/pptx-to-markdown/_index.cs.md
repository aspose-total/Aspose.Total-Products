---
title: Převést PPTX na MARKDOWN přes C#
description: Převeďte PPTX na MARKDOWN v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na MARKDOWN přes C#" h2=".NET API pro převod PPTX do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
