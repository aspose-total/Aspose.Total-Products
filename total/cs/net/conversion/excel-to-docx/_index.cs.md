---
title: Převeďte EXCEL na DOCX pomocí .NET 
description: Převeďte EXCEL na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést EXCEL na DOCX přes C#" h2="Export Excel&reg; EXCEL do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
