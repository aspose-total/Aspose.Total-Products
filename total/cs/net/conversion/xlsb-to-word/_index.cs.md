...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSB na WORD přes C# nebo online" h2="Export Excel&reg; XLSB do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
