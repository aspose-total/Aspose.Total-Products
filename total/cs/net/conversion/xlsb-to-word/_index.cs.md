---
title: Převeďte XLSB na WORD pomocí .NET 
description: Převeďte XLSB na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlsb-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSB na WORD přes C#" h2="Export Excel&reg; XLSB do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
