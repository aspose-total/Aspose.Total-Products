---
title: Převeďte XLSM na DOCX pomocí .NET 
description: Převeďte XLSM na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSM na DOCX přes C#" h2="Export Excel&reg; XLSM do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
