---
title: Převést PPTX na XLTX přes C#
description: Převeďte PPTX na XLTX v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na XLTX přes C#" h2=".NET API pro převod PPTX do XLTX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
