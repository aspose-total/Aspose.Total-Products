...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOC na XLT nebo online" h2="Export DOC do XLT přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
