---
title: Převést PPSX na XLTX přes C#
description: Převeďte PPSX na XLTX v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPSX na XLTX přes C#" h2=".NET API pro převod PPSX do XLTX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
