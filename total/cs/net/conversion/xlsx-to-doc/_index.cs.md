---
title: Převeďte XLSX na DOC pomocí .NET 
description: Převeďte XLSX na DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSX na DOC přes C#" h2="Export Excel&reg; XLSX do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
