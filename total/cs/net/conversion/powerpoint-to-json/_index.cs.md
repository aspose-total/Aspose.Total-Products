...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na formát JSON přes C#" h2="Exportujte POWERPOINT do JSON přes C# bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for .NET](https://products.aspose.com/total/net/) můžete převést POWERPOINT na formát JSON v rámci libovolné aplikace .NET, C#, ASP.NET a VB.NET ve dvou jednoduché kroky. Za prvé, pomocí [Aspose.Slides for .NET](https://products.aspose.com/slides/net/) můžete exportovat POWERPOINT do HTML. Poté můžete pomocí rozhraní [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API převést HTML na JSON.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Převést POWERPOINT na formát JSON přes C#" %}}
...
2. Převeďte POWERPOINT na HTML pomocí metody [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Převést chráněný POWERPOINT na formát JSON přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést POWERPOINT na JSON v rozsahu přes C#" %}}
