---
title: Převést POTM na XLAM přes C#
description: Převeďte POTM na XLAM v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na XLAM přes C#" h2=".NET API pro převod POTM do XLAM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
