---
title: Převést PPTX na EXCEL přes C#
description: Převeďte PPTX na EXCEL v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na EXCEL přes C#" h2=".NET API pro převod PPTX do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
