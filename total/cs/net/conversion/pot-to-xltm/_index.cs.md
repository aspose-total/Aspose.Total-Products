---
title: Převést POT na XLTM přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POT na XLTM přes C# nebo online" h2=".NET API pro převod POT do XLTM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
