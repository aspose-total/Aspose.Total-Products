---
title: C# API pro export PDF do ODT
description: Převeďte PDF na ODT bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/pdf-to-odt/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete PDF na ODT přes .NET" h2=".NET API pro export PDF do ODT na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod PDF na ODT" %}}
