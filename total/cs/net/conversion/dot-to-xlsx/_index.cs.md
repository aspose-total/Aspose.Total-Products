---
title: .NET API pro převod DOT do XLSX
description: C# API pro převod DOT do XLSX bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/dot-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOT na XLSX" h2="Export DOT do XLSX přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
