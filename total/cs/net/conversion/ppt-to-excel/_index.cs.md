...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPT na EXCEL přes C#" h2=".NET API pro převod PPT do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
