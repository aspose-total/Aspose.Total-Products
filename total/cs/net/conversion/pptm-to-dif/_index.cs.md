---
title: Převést PPTM na DIF přes C#
description: Převeďte PPTM na DIF v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTM na DIF přes C#" h2=".NET API pro převod PPTM do DIF bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
