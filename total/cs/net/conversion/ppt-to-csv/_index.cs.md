---
title: Převést PPT na CSV přes C#
description: Převeďte PPT na CSV v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPT na CSV přes C#" h2=".NET API pro převod PPT do CSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
