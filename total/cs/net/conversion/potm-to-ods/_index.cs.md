---
title: Převést POTM na ODS přes C#
description: Převeďte POTM na ODS v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na ODS přes C#" h2=".NET API pro převod POTM do ODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
