---
title: C# API pro export CGM do GIF
description: Převeďte CGM na GIF bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/cgm-to-gif/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete CGM na GIF přes .NET" h2=".NET API pro export CGM do GIF na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod CGM na GIF" %}}
...
4. Uložte dokument do formátu GIF pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Gif jako SaveFormat
