...
description: C# API pro převod DOCM do SXC bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/docm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOCM na SXC" h2="Export DOCM do SXC přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
