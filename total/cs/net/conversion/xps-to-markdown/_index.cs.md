...
description: Převeďte XPS na MARKDOWN bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/xps-to-markdown/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete XPS na MARKDOWN přes .NET" h2=".NET API pro export XPS do MARKDOWN na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod XPS na MARKDOWN" %}}
