---
title: Převeďte XLTX na DOC pomocí .NET 
description: Převeďte XLTX na DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTX na DOC přes C#" h2="Export Excel&reg; XLTX do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
