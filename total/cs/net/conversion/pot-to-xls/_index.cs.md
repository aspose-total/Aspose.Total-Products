---
title: Převést POT na XLS přes C#
description: Převeďte POT na XLS v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pot-to-xls/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POT na XLS přes C#" h2=".NET API pro převod POT do XLS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
