---
title: Převeďte XLT na POWERPOINT pomocí .NET 
description: Převeďte XLT na POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlt-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLT na POWERPOINT přes C#" h2="Export Excel&reg; XLT do POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
