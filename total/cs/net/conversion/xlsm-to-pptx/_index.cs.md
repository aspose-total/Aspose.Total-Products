---
title: Převeďte XLSM na PPTX pomocí .NET 
description: Převeďte XLSM na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlsm-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSM na PPTX přes C#" h2="Export Excel&reg; XLSM do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
