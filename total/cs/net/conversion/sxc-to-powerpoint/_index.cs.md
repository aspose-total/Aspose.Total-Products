---
title: Převeďte SXC na POWERPOINT pomocí .NET 
description: Převeďte SXC na POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/sxc-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést SXC na POWERPOINT přes C#" h2="Export Excel&reg; SXC do POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
