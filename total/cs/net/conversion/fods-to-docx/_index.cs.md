---
title: Převeďte FODS na DOCX pomocí .NET 
description: Převeďte FODS na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést FODS na DOCX přes C#" h2="Export Excel&reg; FODS do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
