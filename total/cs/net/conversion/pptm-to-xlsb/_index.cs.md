---
title: Převést PPTM na XLSB přes C#
description: Převeďte PPTM na XLSB v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTM na XLSB přes C#" h2=".NET API pro převod PPTM do XLSB bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
