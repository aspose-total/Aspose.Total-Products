...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete XPS na WORDML přes .NET" h2=".NET API pro export XPS do WORDML na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod XPS na WORDML" %}}
