---
title: Převeďte XLTX na WORD pomocí .NET 
description: Převeďte XLTX na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xltx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTX na WORD přes C#" h2="Export Excel&reg; XLTX do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
