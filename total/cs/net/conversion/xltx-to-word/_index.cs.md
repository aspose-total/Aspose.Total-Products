...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTX na WORD přes C# nebo online" h2="Export Excel&reg; XLTX do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
