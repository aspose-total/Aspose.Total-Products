...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOTM na XLTM nebo online" h2="Export DOTM do XLTM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
