---
title: .NET API pro převod WORDML do XLAM
description: C# API pro převod WORDML do XLAM bez použití Microsoft Excel nebo Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod WORDML na XLAM" h2="Export WORDML do XLAM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
