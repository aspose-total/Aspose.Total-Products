---
title: Převést PPSX na XLSX přes C#
description: Převeďte PPSX na XLSX v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPSX na XLSX přes C#" h2=".NET API pro převod PPSX do XLSX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
