---
title: Převeďte XLTM na PPTX pomocí .NET 
description: Převeďte XLTM na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xltm-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTM na PPTX přes C#" h2="Export Excel&reg; XLTM do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
