...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod OTT na XLT nebo online" h2="Export OTT do XLT přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
