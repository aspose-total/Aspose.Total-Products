...
description: Převeďte XLSB na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  XLSB na DOCX.
...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="Převést XLSB na DOCX přes C# nebo online aplikace" h2="Export Excel<sup>&reg;</sup> XLSB do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
