...
description: C# API pro převod WORDML do FODS bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/wordml-to-fods/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod WORDML na FODS" h2="Export WORDML do FODS přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
