---
title: Převést POTM na CSV přes C#
description: Převeďte POTM na CSV v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/potm-to-csv/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na CSV přes C#" h2=".NET API pro převod POTM do CSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
