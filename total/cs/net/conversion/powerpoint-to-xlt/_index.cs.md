---
title: Převést POWERPOINT na XLT přes C#
description: Převeďte POWERPOINT na XLT v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na XLT přes C#" h2=".NET API pro převod POWERPOINT do XLT bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
