---
title: Převeďte ODS na DOC pomocí .NET 
description: Převeďte ODS na DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést ODS na DOC přes C#" h2="Export Excel&reg; ODS do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
