---
title: Převést POTX na ODS přes C# nebo online aplikace
description: Převeďte POTX na ODS v C# bez použití Microsoft Excel nebo Powerpoint nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  POTX na ODS. nebo pomocí bezplatného online převodníku
url_ignore: /cs/net/conversion/potx-to-ods/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na ODS přes C# nebo online aplikace" h2=".NET API pro převod POTX do ODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
