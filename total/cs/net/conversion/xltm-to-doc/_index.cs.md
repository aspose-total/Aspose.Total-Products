...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLTM na DOC přes C# nebo online" h2="Export Excel&reg; XLTM do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
