...
<iframe title="Bezplatná online aplikace pro převod SVG na OTT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ott&from=svg" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Převeďte SVG na OTT přes C# .NET" offSpacer="" %}}
