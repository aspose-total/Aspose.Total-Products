---
title: Převeďte XLS na WORD pomocí .NET 
description: Převeďte XLS na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLS na WORD přes C#" h2="Export Excel&reg; XLS do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
