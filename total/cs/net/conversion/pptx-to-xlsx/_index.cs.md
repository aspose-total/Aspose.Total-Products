---
title: Převést PPTX na XLSX přes C#
description: Převeďte PPTX na XLSX v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na XLSX přes C#" h2=".NET API pro převod PPTX do XLSX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
