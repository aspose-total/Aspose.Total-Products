...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete SVG na MARKDOWN přes .NET" h2=".NET API pro export SVG do MARKDOWN na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod SVG na MARKDOWN" %}}
1. Otevřete soubor SVG pomocí třídy [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document)
2. Převeďte SVG na Doc pomocí metody [Save](https://apireference.aspose.com/pdf/net/aspose.pdf.document/save/methods/5)
...
4. Uložte dokument do formátu MARKDOWN pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Markdown jako SaveFormat
