---
title: Převeďte FODS na DOC pomocí .NET 
description: Převeďte FODS na DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/fods-to-doc/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést FODS na DOC přes C#" h2="Export Excel&reg; FODS do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
