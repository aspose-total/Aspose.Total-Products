...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést SXC na WORD přes C# nebo online aplikace" h2="Export Excel&reg; SXC do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
