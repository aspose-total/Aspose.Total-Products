---
title: Převeďte SXC na WORD pomocí .NET 
description: Převeďte SXC na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést SXC na WORD přes C#" h2="Export Excel&reg; SXC do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
