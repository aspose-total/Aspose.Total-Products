---
title: Převést POTM na XLT přes C#
description: Převeďte POTM na XLT v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na XLT přes C#" h2=".NET API pro převod POTM do XLT bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
