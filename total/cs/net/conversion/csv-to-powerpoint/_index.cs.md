---
title: Převeďte CSV na POWERPOINT pomocí .NET 
description: Převeďte CSV na POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/csv-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést CSV na POWERPOINT přes C#" h2="Export Excel&reg; CSV do POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
