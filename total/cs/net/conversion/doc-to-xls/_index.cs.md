---
title: .NET API pro převod DOC do XLS nebo pomocí bezplatného online převodníku
description: C# API pro převod DOC do XLS bez použití Microsoft Excel nebo Adobe Reader nebo online. Před integrací kódu rychle otestujte bezplatný online převodník CSV na DOC. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOC na XLS nebo online aplikace" h2="Export DOC do XLS přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tento online konvertor funguje rychle, ale hlavně závisí na velikosti souboru DOC. Malý soubor DOC můžete vykreslit na XLS během několika sekund. Navíc, pokud jste integrovali konverzní kód do aplikace .NET, záleží na tom, jak jste optimalizovali svou aplikaci pro proces převodu.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
