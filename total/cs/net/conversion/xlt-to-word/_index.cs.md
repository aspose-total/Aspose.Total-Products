...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLT na WORD přes C# nebo online" h2="Export Excel&reg; XLT do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
