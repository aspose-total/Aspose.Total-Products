---
title: Převeďte XLT na WORD pomocí .NET 
description: Převeďte XLT na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlt-to-word/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLT na WORD přes C#" h2="Export Excel&reg; XLT do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
