---
title: Převést PPS na MHTML přes C#
description: Převeďte PPS na MHTML v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPS na MHTML přes C#" h2=".NET API pro převod PPS do MHTML bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
