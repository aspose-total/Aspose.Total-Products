---
title: Převést ODP na DOCX přes C# .NET 
url: /cs/net/conversion/odp-to-docx/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést ODP na DOCX pomocí C#" h2="Vytvářejte aplikace Microsoft PowerPoint ODP Presentation do aplikací pro převod dokumentů Word DOCX na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCXM" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/net/conversion/odp-to-docxx" name="ODP Na DOCXX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/net/conversion/odp-to-docxm" name="ODP Na DOCXM" description="" >}}
