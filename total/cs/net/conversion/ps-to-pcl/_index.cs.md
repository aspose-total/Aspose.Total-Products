---
title: C# API pro export PS do PCL
description: Převeďte PS na PCL bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/ps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete PS na PCL přes .NET" h2=".NET API pro export PS do PCL na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod PS na PCL" %}}
