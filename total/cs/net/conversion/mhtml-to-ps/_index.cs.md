---
title: C# API pro export MHTML do PS
description: Převeďte MHTML na PS bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/mhtml-to-ps/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete MHTML na PS přes .NET" h2=".NET API pro export MHTML do PS na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod MHTML na PS" %}}
