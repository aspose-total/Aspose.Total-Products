---
title: Převést PPTX na SXC přes C#
description: Převeďte PPTX na SXC v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na SXC přes C#" h2=".NET API pro převod PPTX do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
4. Uložte dokument do SXC pomocí metody [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
