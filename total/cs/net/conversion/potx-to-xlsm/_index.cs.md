---
title: Převést POTX na XLSM přes C# nebo online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na XLSM přes C# nebo online" h2=".NET API pro převod POTX do XLSM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
