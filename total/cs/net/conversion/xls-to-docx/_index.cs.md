...
{{< blocks/products/pf/agp/upper-banner-autogen-total h1="Převést XLS na DOCX přes C# nebo online aplikace" h2="Export Excel<sup>&reg;</sup> XLS do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
...
<iframe title="Online nástroj docx až xls" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=docx&from=xls" id="child-iframe" width="80%"></iframe>
