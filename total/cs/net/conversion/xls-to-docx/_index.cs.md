---
title: Převeďte XLS na DOCX pomocí .NET 
description: Převeďte XLS na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xls-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLS na DOCX přes C#" h2="Export Excel&reg; XLS do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
