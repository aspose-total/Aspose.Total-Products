---
title: Převeďte CSV na PPTX pomocí .NET 
description: Převeďte CSV na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/csv-to-pptx/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést CSV na PPTX přes C#" h2="Export Excel&reg; CSV do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
