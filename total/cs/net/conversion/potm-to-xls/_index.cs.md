---
title: Převést POTM na XLS přes C#
description: Převeďte POTM na XLS v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na XLS přes C#" h2=".NET API pro převod POTM do XLS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
