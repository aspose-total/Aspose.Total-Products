---
title: Převést POT na MARKDOWN přes C#
description: Převeďte POT na MARKDOWN v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POT na MARKDOWN přes C#" h2=".NET API pro převod POT do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
