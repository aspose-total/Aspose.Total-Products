---
title: Převést POTX na MHTML přes C#
description: Převeďte POTX na MHTML v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na MHTML přes C#" h2=".NET API pro převod POTX do MHTML bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
