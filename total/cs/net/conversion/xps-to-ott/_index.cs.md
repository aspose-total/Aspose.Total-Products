---
title: C# API pro export XPS do OTT
description: Převeďte XPS na OTT bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/xps-to-ott/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete XPS na OTT přes .NET" h2=".NET API pro export XPS do OTT na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod XPS na OTT" %}}
