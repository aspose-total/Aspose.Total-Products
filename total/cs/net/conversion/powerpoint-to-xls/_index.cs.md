---
title: Převést POWERPOINT na XLS přes C#
description: Převeďte POWERPOINT na XLS v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na XLS přes C#" h2=".NET API pro převod POWERPOINT do XLS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
