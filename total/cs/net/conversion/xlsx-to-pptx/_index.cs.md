---
title: Převeďte XLSX na PPTX pomocí .NET 
description: Převeďte XLSX na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSX na PPTX přes C#" h2="Export Excel&reg; XLSX do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
