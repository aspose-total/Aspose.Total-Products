...
description: C# API pro převod DOTX do XLTX bez použití Microsoft Excel nebo Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOTX na XLTX" h2="Export DOTX do XLTX přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
