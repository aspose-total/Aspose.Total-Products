---
title: Převeďte SXC na DOCX pomocí .NET 
description: Převeďte SXC na DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést SXC na DOCX přes C#" h2="Export Excel&reg; SXC do DOCX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
