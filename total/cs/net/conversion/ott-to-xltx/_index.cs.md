---
title: .NET API pro převod OTT do XLTX
description: C# API pro převod OTT do XLTX bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/ott-to-xltx/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod OTT na XLTX" h2="Export OTT do XLTX přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
