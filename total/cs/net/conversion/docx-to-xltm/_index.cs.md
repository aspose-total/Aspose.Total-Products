---
title: .NET API pro převod DOCX do XLTM
description: C# API pro převod DOCX do XLTM bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/docx-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOCX na XLTM" h2="Export DOCX do XLTM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
