...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod RTF na XLAM nebo online" h2="Export RTF do XLAM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
