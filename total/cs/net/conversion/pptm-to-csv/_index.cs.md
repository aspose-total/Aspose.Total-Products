---
title: Převést PPTM na CSV přes C#
description: Převeďte PPTM na CSV v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTM na CSV přes C#" h2=".NET API pro převod PPTM do CSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
4. Uložte dokument do CSV pomocí metody [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
