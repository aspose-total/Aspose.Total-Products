---
title: Převeďte XLS na PPTX pomocí .NET 
description: Převeďte XLS na PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLS na PPTX přes C#" h2="Export Excel&reg; XLS do PPTX na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
