---
title: C# API pro export TEX do DOTX
description: Převeďte TEX na DOTX bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/tex-to-dotx/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete TEX na DOTX přes .NET" h2=".NET API pro export TEX do DOTX na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod TEX na DOTX" %}}
