---
title: .NET API pro převod OTT do XLAM
description: C# API pro převod OTT do XLAM bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/ott-to-xlam/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod OTT na XLAM" h2="Export OTT do XLAM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Uložte dokument do formátu XLAM pomocí metody [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) a nastavte „XLAM“ jako SaveFormat
