...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na FODS přes C#" h2=".NET API pro převod POWERPOINT do FODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
