---
title: Převést RTF na PPT přes C# .NET 
url: /cs/net/conversion/rtf-to-ppt/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Převést RTF na PPT pomocí C#" h2="Vytvářejte aplikace pro převod PPT z Microsoft Word RTF na PowerPoint na platformách .NET Framework, .NET Core, Windows Azure, Mono nebo Xamarin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPT" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTFM" >}}
...
1. Načtěte soubor RTF pomocí třídy [Aspose.Words.Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument)
