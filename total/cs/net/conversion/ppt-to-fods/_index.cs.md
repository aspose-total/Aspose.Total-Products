---
title: Převést PPT na FODS přes C#
description: Převeďte PPT na FODS v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPT na FODS přes C#" h2=".NET API pro převod PPT do FODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
