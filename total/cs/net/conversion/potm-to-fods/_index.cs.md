---
title: Převést POTM na FODS přes C#
description: Převeďte POTM na FODS v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na FODS přes C#" h2=".NET API pro převod POTM do FODS bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
