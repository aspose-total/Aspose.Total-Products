---
title: .NET API pro převod WORD do XLAM nebo pomocí bezplatného online převodníku
description: C# API pro převod WORD do XLAM bez použití Microsoft Excel nebo Adobe Reader nebo online. Před integrací kódu rychle otestujte bezplatný online převodník  WORD na XLAM. 
url_ignore: /cs/net/conversion/word-to-xlam/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod WORD na XLAM nebo online aplikace" h2="Export WORD do XLAM přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
