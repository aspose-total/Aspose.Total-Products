---
title: Převeďte XLSM na WORD pomocí .NET 
description: Převeďte XLSM na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/xlsm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLSM na WORD přes C#" h2="Export Excel&reg; XLSM do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
