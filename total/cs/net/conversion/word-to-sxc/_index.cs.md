---
title: .NET API pro převod WORD do SXC
description: C# API pro převod WORD do SXC bez použití Microsoft Excel nebo Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod WORD na SXC" h2="Export WORD do SXC přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
