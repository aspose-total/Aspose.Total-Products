---
title: Převést POTM na EXCEL přes C#
description: Převeďte POTM na EXCEL v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na EXCEL přes C#" h2=".NET API pro převod POTM do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
