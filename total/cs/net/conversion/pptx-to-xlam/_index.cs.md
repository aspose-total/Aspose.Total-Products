...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na XLAM přes C#" h2=".NET API pro převod PPTX do XLAM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
