...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést XLT na DOC přes C# nebo online aplikace" h2="Export Excel&reg; XLT do DOC na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
