...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTM na MARKDOWN přes C#" h2=".NET API pro převod PPTM do MARKDOWN bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
