---
title: Převést POTM na XLSB přes C#
description: Převeďte POTM na XLSB v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTM na XLSB přes C#" h2=".NET API pro převod POTM do XLSB bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
