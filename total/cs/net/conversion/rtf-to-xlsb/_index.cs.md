...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod RTF na XLSB nebo online" h2="Export RTF do XLSB přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
