---
title: Převést PPSX na MHTML přes C#
description: Převeďte PPSX na MHTML v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPSX na MHTML přes C#" h2=".NET API pro převod PPSX do MHTML bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
