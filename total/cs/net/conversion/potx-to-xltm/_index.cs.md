---
title: Převést POTX na XLTM přes C#
description: Převeďte POTX na XLTM v C# bez použití Microsoft Excel nebo Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na XLTM přes C#" h2=".NET API pro převod POTX do XLTM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
