---
title: .NET API pro převod OTT do SXC
description: C# API pro převod OTT do SXC bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/ott-to-sxc/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod OTT na SXC" h2="Export OTT do SXC přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
