---
title: .NET API pro převod DOCX do DIF
description: C# API pro převod DOCX do DIF bez použití Microsoft Excel nebo Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod DOCX na DIF" h2="Export DOCX do DIF přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
