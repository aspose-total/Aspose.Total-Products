---
title: C# API pro export MD do OTT
description: Převeďte MD na OTT bez použití aplikace Microsoft Word
url_ignore: /cs/net/conversion/md-to-ott/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete MD na OTT přes .NET" h2=".NET API pro export MD do OTT na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod MD na OTT" %}}
...
4. Uložte dokument do formátu OTT pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Ott jako SaveFormat
