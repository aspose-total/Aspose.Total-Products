...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na XLTX přes C#" h2=".NET API pro převod POWERPOINT do XLTX bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
