---
title: Převeďte ODS na WORD pomocí .NET 
description: Převeďte ODS na WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/ods-to-word/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést ODS na WORD přes C#" h2="Export Excel&reg; ODS do WORD na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
