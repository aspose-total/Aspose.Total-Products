---
title: Převeďte FODS na POWERPOINT pomocí .NET 
description: Převeďte FODS na POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin
url: /cs/net/conversion/fods-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Převést FODS na POWERPOINT přes C#" h2="Export Excel&reg; FODS do POWERPOINT na platformách .NET Framework, .NET Core, Mono nebo Xamarin">}}
