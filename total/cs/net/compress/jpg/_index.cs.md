---
title: Komprimujte soubory JPG online nebo přes .NET
description: Bezplatná online aplikace pro kompresi různých souborů JPG. Kód kompresní knihovny .NET pro dokumenty JPG.
...
{{< blocks/products/pf/feature-page-header-widget h1="Komprimujte soubor JPG online prostřednictvím aplikace pro kompresi nebo pomocí .NET" h2="Vyvíjejte výkonné aplikace pro kompresi dokumentů JPG založené na .NET.Zdarma komprimujte různé dokumenty včetně souborů JPG online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor JPG přes .NET" %}}
...
1. Importujte obrázek JPG pomocí metody insertImage().
1. Použijte ImageSaveOptions a nastavte kvalitu
1. Zavolejte metodu uložení a získejte komprimovaný soubor JPG.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Příklad kódu v .NET pro kompresi souborů JPG" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů JPG pomocí .NET</h2>

Potřebujete vyvinout skript .NET nebo obslužnou aplikaci pro snadnou kompresi více souborů JPG?S [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může každý vývojář .NET integrovat výše uvedený kód API do aplikace pro kompresi obrázků.Výkonná knihovna .NET pro kompresi podporuje mnoho oblíbených formátů včetně formátu JPG.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompresní knihovna .NET pro soubory JPG" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru JPG pomocí .NET. Použijte Aspose JPG kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci ke kompresi více dokumentů JPG?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Začněte nahráním jednoho nebo více souborů, které chcete komprimovat.Soubory JPG můžete buď přetáhnout myší, nebo jednoduše kliknout do bílé oblasti. Poté klikněte na tlačítko „Komprimovat“ a naše online aplikace pro kompresi nahrané soubory rychle zpracuje.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
