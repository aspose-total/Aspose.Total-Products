---
title: Komprimujte soubory DOT online nebo přes .NET
description: Bezplatná online aplikace pro kompresi různých souborů DOT.Kód kompresní knihovny C# .NET pro dokumenty DOT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Komprimujte soubor DOT online prostřednictvím aplikace pro kompresi nebo pomocí .NET" h2="Vyvíjejte výkonné aplikace pro kompresi dokumentů DOT založené na .NET.Zdarma komprimujte různé dokumenty včetně souborů DOT online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor DOT přes .NET" %}}
...
1. Zavolejte metodu Save a získejte komprimovaný soubor DOT

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kód .NET : Komprimujte soubory DOT" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů DOT pomocí .NET</h2>

Potřebujete vyvinout skript .NET nebo obslužnou aplikaci pro snadnou kompresi více souborů DOT?S [Aspose.Words for .NET](https://products.aspose.com/words/net/) podřízenými API [Aspose.Total for .NET](https://products.aspose.com/total/net/) může každý .NET vývojář integrovat výše uvedený API kód do programování kompresní aplikace napříč dokumenty.Výkonná knihovna .NET pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu DOT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompresní knihovna .NET pro soubory DOT" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru DOT pomocí .NET.Použijte Aspose DOT kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Start by uploading one or more files you want to compress. Soubory DOT můžete buď přetáhnout myší, nebo jednoduše kliknout do bílé oblasti.Poté klikněte na tlačítko „Komprimovat“ a naše online aplikace pro kompresi nahrané soubory rychle zpracuje.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
