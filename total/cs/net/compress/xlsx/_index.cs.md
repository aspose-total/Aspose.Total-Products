---
title: Komprimujte soubory XLSX online nebo přes .NET
description: Bezplatná online aplikace pro kompresi různých souborů XLSX.Kód kompresní knihovny .NET pro dokumenty XLSX.
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor XLSX přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET: Komprimujte soubory XLSX" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů XLSX pomocí .NET</h2>

Potřebujete vyvinout skript .NET nebo obslužnou aplikaci pro snadnou kompresi více souborů XLSX?S [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API k naprogramování aplikace pro kompresi napříč dokumenty.Výkonná knihovna .NET pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu XLSX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompresní knihovna .NET pro soubory XLSX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru XLSX pomocí .NET.Použijte Aspose XLSX kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
