---
title: Komprimujte soubory XLTX online nebo přes .NET
description: Bezplatná online aplikace pro kompresi různých souborů XLTX.Kód kompresní knihovny .NET pro dokumenty XLTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Komprimujte soubor XLTX online prostřednictvím aplikace pro kompresi nebo pomocí .NET" h2="Vyvíjejte výkonné aplikace pro kompresi dokumentů XLTX založené na .NET.Zdarma komprimujte různé dokumenty včetně souborů XLTX online prostřednictvím aplikace s okamžitým stažením." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor XLTX přes .NET" %}}
...
1. Zavolejte metodu uložení a získejte komprimovaný soubor XLTX

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kód .NET: Komprimujte soubory XLTX" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů XLTX pomocí .NET</h2>

Potřebujete vyvinout skript .NET nebo obslužnou aplikaci pro snadnou kompresi více souborů XLTX?S [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API k naprogramování aplikace pro kompresi napříč dokumenty.Výkonná knihovna .NET pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu XLTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompresní knihovna .NET pro soubory XLTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru XLTX pomocí .NET.Použijte Aspose XLTX kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci ke komprimaci více dokumentů XLTX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
