---
title: Komprimujte soubory XLTM online nebo přes .NET
description: Bezplatná online aplikace pro kompresi různých souborů XLTM.Kód kompresní knihovny .NET pro dokumenty XLTM.
...
{{% blocks/products/pf/agp/feature-section-col title="Komprimujte soubor XLTM přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET: Komprimujte soubory XLTM" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro kompresi souborů XLTM pomocí .NET</h2>

Potřebujete vyvinout skript .NET nebo obslužnou aplikaci pro snadnou kompresi více souborů XLTM?S [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API k naprogramování aplikace pro kompresi napříč dokumenty.Výkonná knihovna .NET pro kompresi dokumentů podporuje mnoho oblíbených formátů včetně formátu XLTM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompresní knihovna .NET pro soubory XLTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro kompresi souboru XLTM pomocí .NET.Použijte Aspose XLTM kompresní API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
