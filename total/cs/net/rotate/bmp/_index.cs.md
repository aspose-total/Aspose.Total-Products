---
title: Otočte dokumenty BMP online nebo pomocí .NET
description: Otočte dokument BMP prostřednictvím online aplikace zdarma..NET API C# kód pro otáčení souborů BMP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Otočte dokument BMP online nebo přes .NET" h2="Vyvíjejte výkonnou aplikaci pro rotaci dokumentů BMP na bázi .NET.Uvedený kód pro rotaci souboru BMP prostřednictvím .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Otočte BMP online" %}}

1. Importujte soubor BMP a odemkněte jej nahráním.
1. Udělejte to kliknutím do oblasti přetažení pomocí aplikace pro otáčení přetažením.
1. V závislosti na velikosti souboru BMP a rychlosti internetu počkejte několik sekund.
...
{{% blocks/products/pf/agp/feature-section-col title="Otočte soubor BMP přes .NET" %}}

1. Načtěte soubor BMP pomocí Image.Load
...
{{% blocks/products/pf/agp/code-block title="Kód .NET : Otočte soubory BMP" offSpacer="" %}}
...
<h2>Vyvíjejte rotační aplikaci BMP přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro rotaci BMP?S [Aspose.Imaging for .NET](https://products.aspose.com/imaging/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro rotaci dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení rotace dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu BMP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro správu rotace BMP" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Použití pro rotaci BMP

- Otočte naskenované inženýrské plány nebo architektonické plány uložené ve formátu BMP.
- Upravte orientaci starších obrázků generovaných systémem Windows pro správné zobrazení.
- Připravte BMP obrázky pro vložení do dokumentace nebo zpráv.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci k otáčení dokumentu BMP?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Pro online rotaci dokumentů BMP můžete použít jakýkoli moderní webový prohlížeč, jako je Google Chrome, Firefox, Opera nebo Safari.Pokud však vyvíjíte desktopovou aplikaci, doporučujeme pro efektivní správu použít rozhraní API pro zpracování dokumentů Aspose.Total.</span>
                      </div>
                  </li>
              </ul>
          </div>
