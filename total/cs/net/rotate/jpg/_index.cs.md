---
title: Otočte dokumenty JPG online nebo pomocí .NET
description: Otočte dokument JPG prostřednictvím online aplikace zdarma..NET API C# kód pro otáčení souborů JPG.
...
{{< blocks/products/pf/feature-page-header-widget h1="Otočte dokument JPG online nebo přes .NET" h2="Vyvíjejte výkonnou aplikaci pro rotaci dokumentů JPG na bázi .NET.Uvedený kód pro rotaci souboru JPG prostřednictvím .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Otočte JPG online" %}}

1. Importujte soubor JPG a odemkněte jej nahráním.
...
{{% blocks/products/pf/agp/feature-section-col title="Otočte soubor JPG přes .NET" %}}

1. Načtěte soubor JPG pomocí Image.Load
...
{{% blocks/products/pf/agp/code-block title="Kód .NET : Otočte soubory JPG" offSpacer="" %}}
...
<h2>Vyvíjejte rotační aplikaci JPG přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro rotaci JPG?S [Aspose.Imaging for .NET](https://products.aspose.com/imaging/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro rotaci dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení rotace dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu JPG.<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
## Použití pro rotaci JPG

- Normalizace orientace obrázkových galerií nahrávaných uživateli.
- Otočení snímků krajiny pro konzistentní prezentaci na sociálních médiích.
- Úprava orientace fotografií nemovitostí pro virtuální prohlídky.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Je bezpečné používat online aplikaci k otáčení dokumentu JPG?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Pro online rotaci dokumentů JPG můžete použít jakýkoli moderní webový prohlížeč, jako je Google Chrome, Firefox, Opera nebo Safari.Pokud však vyvíjíte desktopovou aplikaci, doporučujeme pro efektivní správu použít rozhraní API pro zpracování dokumentů Aspose.Total.</span>
                      </div>
                  </li>
              </ul>
          </div>
