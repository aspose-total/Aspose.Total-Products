---
title: Chraňte dokument Powerpoint online pomocí hesla a pomocí .NET
description: Online aplikace pro ochranu souborů Powerpoint heslem.Kód .NET C# API pro použití ochrany heslem na prezentace Powerpoint.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ochrana dokumentů Powerpoint nebo nastavení hesla přes .NET" h2="Vyvíjejte výkonnou aplikaci pro ochranu dokumentů Powerpoint na bázi .NET.Uvedený kód pro použití hesla na prezentaci Powerpoint prostřednictvím .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Online ochrana heslem Powerpoint prostřednictvím aplikace" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ochrana heslem Powerpoint přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET: Ochrana heslem prezentace Powerpoint" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci na ochranu heslem Powerpoint prostřednictvím .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj na ochranu heslem Powerpoint?S [Aspose.Slides for .NET](https://products.aspose.com/slides/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro ochranu dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení ochrany dokumentů heslem pro zabezpečení a uzamčení prezentací.Navíc může podporovat mnoho populárních formátů včetně formátu Powerpoint.<br /><br />
