---
title: Zobrazení a aktualizace vlastností ODT online nebo aktualizace metadat pomocí .NET
description: Prohlížejte a upravujte vlastnosti ODT prostřednictvím online aplikace zdarma. C# .NET API kód pro aktualizaci a přidání vlastností ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Zobrazit nebo aktualizovat metadata ODT online nebo aktualizovat přes .NET" h2="Vyvíjejte výkonnou aplikaci pro správu metadat dokumentů ODT na bázi .NET.Uvedený kód pro přidávání a úpravu metadat souboru ODT prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Správa vlastností ODT přes .NET" %}}

1. Vytvořte třídu sešitu.
1. Přístup k vlastnostem definovaným systémem pomocí BuiltInDocumentProperties
1. Přiřaďte aktualizované hodnoty, například Jazyk
1. Voláním metody Save() uložte aktualizovaný dokument ODT.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET: Aktualizujte metadata ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kód .NET: Přidejte uživatelské vlastnosti ODT" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro správu metadat ODT prostřednictvím .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro správu metadat ODT?S [Aspose.Cells for .NET](https://products.aspose.com/cells/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace metadat dokumentu.Výkonná knihovna .NET umožňuje programování libovolného řešení metadat dokumentu.Navíc může podporovat mnoho populárních formátů včetně formátu ODT.<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
## 📘 Použití pro OpenDocument Text (`.odt`)

- Použití metadat k zajištění kompatibility napříč kancelářskými balíky.
- Sledování přispěvatelů a historie spolupráce.
- Organizace a vyhledávání dokumentů ve formátu otevřeného typu v rámci firemních systémů.
- Podpora AI/ML nástrojů, které analyzují ODT pro poznatky.
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Pro online správu vlastností dokumentu ODT můžete použít jakýkoli moderní webový prohlížeč, jako je Google Chrome, Firefox, Opera nebo Safari. Pokud však vyvíjíte desktopovou aplikaci, doporučujeme pro efektivní správu použít rozhraní API pro zpracování dokumentů Aspose.Total.</span>
                      </div>
                  </li>
              </ul>
          </div>
