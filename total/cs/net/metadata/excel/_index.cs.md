---
title: Zobrazení a aktualizace vlastností Excel online nebo aktualizace metadat pomocí .NET
description: Prohlížejte a upravujte vlastnosti Excel prostřednictvím online aplikace zdarma. C# .NET API kód pro aktualizaci a přidání vlastností Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Zobrazit nebo aktualizovat metadata Excel online nebo aktualizovat přes .NET" h2="Vyvíjejte výkonnou aplikaci pro správu metadat dokumentů Excel na bázi .NET.Uvedený kód pro přidávání a úpravu metadat souboru Excel prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Správa vlastností Excel přes .NET" %}}
...
1. Voláním metody Save() uložte aktualizovaný dokument Excel.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET: Aktualizujte metadata Excel" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kód .NET: Přidejte uživatelské vlastnosti Excel" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro správu metadat Excel prostřednictvím .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro správu metadat Excel?S [Aspose.Cells for .NET](https://products.aspose.com/cells/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace metadat dokumentu.Výkonná knihovna .NET umožňuje programování libovolného řešení metadat dokumentu.Navíc může podporovat mnoho populárních formátů včetně formátu Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro správu Excel metadat" %}}
