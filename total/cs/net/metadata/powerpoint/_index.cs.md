---
title: Zobrazení a aktualizace vlastností Powerpoint online nebo aktualizace metadat pomocí .NET
description: Prohlížejte a upravujte vlastnosti Powerpoint prostřednictvím online aplikace zdarma. C# .NET API kód pro aktualizaci vlastností Powerpoint.
...
{{< blocks/products/pf/feature-page-header-widget h1="Zobrazit nebo aktualizovat metadata Powerpoint online nebo aktualizovat přes .NET" h2="Vyvíjejte výkonnou aplikaci pro správu metadat dokumentů Powerpoint na bázi .NET.Uvedený kód pro aktualizaci metadat Powerpoint prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Aktualizujte vlastnosti Powerpoint přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET : Aktualizujte metadata Powerpoint" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro správu metadat Powerpoint prostřednictvím .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro správu metadat Powerpoint?S [Aspose.Slides for .NET](https://products.aspose.com/slides/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace metadat dokumentu.Výkonná knihovna .NET umožňuje programování libovolného řešení metadat dokumentu.Navíc může podporovat mnoho populárních formátů včetně formátu Powerpoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility pro správu Powerpoint metadat" %}}
