---
title: Extrahujte text a obrázky ze souboru PDF Online a pomocí .NET
description: Online aplikace pro analýzu souborů PDF. .NET API C# kód pro extrahování obrázků a textu z dokumentu PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyzujte soubor PDF online a také extrahujte text nebo obrázky přes .NET" h2="Vyvíjejte výkonnou obslužnou aplikaci pro analýzu dokumentů PDF na bázi .NET.C# kód uvedený pro obrázky dokumentů PDF a extrakci textu." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyzujte soubor PDF přes .NET" %}}

1. Přidejte odkaz na knihovnu do projektu .NET
1. Načtěte soubor PDF pomocí třídy Document
1. Použijte objekt třídy TextAbsorber
1. Přijměte absorbér pro všechny stránky
1. Získejte extrahovaný text a napište
...
{{% blocks/products/pf/agp/code-block title="Kód C#: Extrakce obrázků dokumentů PDF" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci PDF File Parser přes .NET</h2>

Potřebujete vyvinout aplikaci nebo nástroj pro analýzu PDF?S [Aspose.PDF for .NET](https://products.aspose.com/pdf/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může každý vývojář pythonu integrovat výše uvedený kód API do své aplikace analyzátoru dokumentů.Výkonná knihovna .NET umožňuje naprogramovat jakékoli řešení analýzy dokumentů pro extrahování obrázků i textu.Navíc může podporovat mnoho populárních formátů včetně formátu PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Nástroj .NET pro zpracování souboru PDF pro aplikaci parser" %}}
