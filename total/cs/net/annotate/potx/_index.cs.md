---
title: Odeberte POTX Annotation Online nebo Spravujte anotace přes .NET
description: odstranit komentáře ze souboru POTX prostřednictvím online aplikace zdarma..NET API kód pro správu komentářů souborů POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Vymazat komentáře z POTX Presentation Online nebo Spravovat přes .NET" h2="Vyvinout výkonnou .NET založenou POTX prezentační anotační aplikaci.Uvedený kód pro správu komentářů k souboru POTX prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Odebrat komentáře k prezentaci POTX přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kód: Odstraňte komentáře a autory z prezentace POTX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Přidejte komentáře k prezentaci POTX přes .NET" %}}
...
<h2>Vyvíjejte aplikaci pro anotaci dokumentů POTX prostřednictvím .NET</h2>

Potřebujete vyvinout anotační aplikaci nebo nástroj POTX pro poskytování zpětné vazby, návrhy nebo spolupráci s ostatními na dokumentu?S [Aspose.Slides for .NET](https://products.aspose.com/slides/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro anotaci dokumentů.Výkonná knihovna .NET umožňuje programování libovolného řešení anotací dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu POTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Knihovna .NET pro anotaci souborů POTX" %}}
