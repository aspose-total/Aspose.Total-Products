---
title: Odeberte DOTX Annotation Online nebo Spravujte anotace přes .NET
description: odstranit komentáře ze souboru DOTX prostřednictvím online aplikace zdarma..NET API kód pro správu komentářů souborů DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Vymazat komentáře z DOTX Document Online nebo Spravovat přes .NET" h2="Vyvíjejte výkonnou aplikaci pro anotaci dokumentů DOTX na bázi .NET.Uvedený kód pro správu komentářů k souboru DOTX prostřednictvím .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Smazat komentáře konkrétního autora DOTX dokumentu přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód C#: Odstraňte konkrétní komentáře autora ze souboru DOTX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód .NET : Přidejte komentář ze souboru DOTX" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro anotaci dokumentů DOTX prostřednictvím .NET</h2>

Potřebujete vyvinout anotační aplikaci nebo nástroj DOTX, abyste mohli poskytovat zpětnou vazbu, navrhovat nebo spolupracovat s ostatními na dokumentu?S [Aspose.Words for .NET](https://products.aspose.com/words/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do své aplikace pro anotaci dokumentů.Výkonná knihovna .NET umožňuje programování libovolného řešení anotací dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu DOTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Knihovna .NET pro anotaci souborů DOTX" %}}
