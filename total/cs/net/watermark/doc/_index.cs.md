---
title: Watermark DOC Files Online nebo pomocí .NET
description: Bezplatná online aplikace pro vodoznak pro různé soubory DOC.Knihovna vodoznaků .NET C# kód pro dokumenty DOC.
...
{{% blocks/products/pf/agp/feature-section-col title="Vodoznak DOC Soubor přes .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET kód: Přidat textový vodoznak DOC soubory" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kód C#: Přidání vodoznaku obrázku do souborů DOC" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro vodoznakování souborů DOC pomocí .NET</h2>

Potřebujete vyvinout obslužnou aplikaci .NET pro snadné vodoznakování více souborů DOC?S [Aspose.Words for .NET](https://products.aspose.com/words/cs/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/cs/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API k naprogramování vodoznakové aplikace napříč dokumenty.Výkonná knihovna .NET pro vodoznaky dokumentů podporuje mnoho oblíbených formátů včetně formátu DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Knihovna vodoznaků .NET pro soubory DOC" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout. Jeden může snadno vyvinout profesionální řešení pro vodoznak DOC souboru pomocí. NET.Použijte Aspose DOC Watermarking API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
