---
title: Online porovnání souborů DOCM nebo sestavení aplikací .NET pro porovnání souborů DOCM
description: Bezplatná online aplikace pro porovnání různých souborů DOCM. Kód srovnávací knihovny C# .NET pro dokumenty DOCM.
...
{{% blocks/products/pf/agp/feature-section-col title="Porovnejte soubor DOCM přes .NET" %}}

1. Přidejte odkaz na knihovnu do projektu .NET.
1. Vložte oba dokumenty DOCM pomocí třídy Document.
1. Jako parametr použijte metodu Compare s prvním objektem a druhým objektem.
1. Pro srovnání použijte Revisions.Count.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET kód pro porovnání souborů DOCM" offSpacer="" %}}
...
<h2>Vyvíjejte aplikaci pro porovnávání souborů DOCM pomocí .NET</h2>

Potřebujete vyvinout software nebo pomocnou aplikaci založenou na .NET pro snadné porovnání souborů DOCM?S [Aspose.Words for .NET](https://products.aspose.com/words/net/), podřízeným API [Aspose.Total for .NET](https://products.aspose.com/total/net/), může kterýkoli vývojář .NET integrovat výše uvedený kód API do aplikace pro porovnání programů.Výkonná knihovna .NET pro porovnávání dokumentů podporuje mnoho oblíbených formátů včetně formátu DOCM, jako je PDF, Word, PowerPoint, e-mailové zprávy a soubory Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCM Srovnávací knihovna pro .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ano, tento kód si můžete stáhnout.Jeden může snadno vyvinout profesionální řešení pro porovnání souborů DOCM pomocí .NET.Použijte Aspose DOCM porovnání API k vývoji softwaru na vysoké úrovni, nezávislého na platformě v .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Máte možnost zahájit porovnávání dokumentů z jakéhokoli zařízení, bez ohledu na operační systém, na kterém běží, ať už je to Windows, Linux, Mac OS nebo Android. Vše, co k tomu potřebujete, je moderní webový prohlížeč a aktivní připojení k internetu.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
