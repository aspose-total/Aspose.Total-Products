---
title: Manipulace s PDF a přidávání OCR prostřednictvím rozhraní API Node.js
description: Node.js API pro manipulaci se soubory PDF a extrahování textu z obrázků prostřednictvím aplikací.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API pro PDF a extrakci textu obrázku" h2="Extrahujte text z obrázků a také zahrňte funkce pro manipulaci s PDF v aplikacích Node.js bez jakýchkoli dalších závislostí na softwaru" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total pro Node.js přes C++ je all-inclusive sada knihoven Node.js.Tyto knihovny nabízejí funkce, jako je přímá práce s PDF a vylepšení vašich aplikací pro přeměnu obrázků na text.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total pro Node.js prostřednictvím C++ obsahuje následující knihovny Node.js:" >}}
...
<h2 class="pr-ft">
 ...
 Přehled Node.js prostřednictvím knihoven C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Přidejte obrázky do dokumentů PDF
 </p>
</div>
<div class="col-lg-4">
...
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualetech, Francie" >}}
...
{{< blocks/products/pf/slr-element name="Reference API" href="https://reference.aspose.com/" >}} 
...
{{< blocks/products/pf/slr-tab tabTitle="Proč Aspose.Total pro C++" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total nabízí individuální řešení pro jiné platformy." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/cs/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/cs/nodejs-java/" 
