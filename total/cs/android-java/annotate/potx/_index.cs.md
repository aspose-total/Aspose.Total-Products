---
title: Odeberte online anotaci POTX nebo spravujte anotace pomocí mobilních aplikací pro Android
description: odstranit komentáře ze souboru POTX prostřednictvím online aplikace zdarma.Android API kód pro správu komentářů souborů POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Vymazat komentáře z POTX Presentation Online nebo spravovat prostřednictvím aplikací pro Android" h2="Vyvíjejte výkonnou prezentační anotační aplikaci POTX pro Android.Uvedený kód pro správu komentářů souboru POTX." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Odstraňte komentáře k prezentaci POTX prostřednictvím aplikace pro Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Kód : Smazat komentáře a autory z prezentace POTX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Přidejte komentáře k prezentaci POTX prostřednictvím aplikace pro Android" %}}
...
<h2>Vyvinout aplikaci pro Android Anotace dokumentu POTX</h2>

Potřebujete vyvinout anotační mobilní aplikaci nebo nástroj POTX, abyste mohli poskytovat zpětnou vazbu, navrhovat nebo spolupracovat s ostatními na dokumentu?S [Aspose.Slides for Android via Java](https://products.aspose.com/slides/cs/android-java/), podřízeným API [Aspose.Total for Android via Java](https://products.aspose.com/total/cs/android-java/), může každý vývojář Androidu integrovat výše uvedený kód API do své aplikace pro anotaci dokumentů.Výkonná knihovna pro Android umožňuje naprogramovat jakékoli řešení anotací dokumentů.Navíc může podporovat mnoho populárních formátů včetně formátu POTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Knihovna Android pro anotaci souborů POTX" %}}
