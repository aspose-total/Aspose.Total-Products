---
title: Export PPSX do OTT na Andorid přes Java
description: Převeďte PPSX na OTT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do OTT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na OTT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
