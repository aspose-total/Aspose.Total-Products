---
title: Export POTM do RTF na Andorid přes Java
description: Převeďte POTM na RTF v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTM do RTF na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTM na RTF v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
