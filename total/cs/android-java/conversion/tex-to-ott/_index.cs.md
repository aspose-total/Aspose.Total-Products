...
Funkci převodu TEX na OTT můžete integrovat do svých mobilních aplikací pomocí dvou rozhraní API balíčku [Aspose.Total pro Android Java](https://products.aspose.com/total/android-java/). Nejprve musíte převést soubor TEX na DOC pomocí [Aspose.PDF pro Android přes Java](https://products.aspose.com/pdf/android-java/). Za druhé, pomocí rozhraní API pro zpracování textu [Aspose.Words pro Android Java](https://products.aspose.com/words/android-java/) můžete vykreslit DOC do OTT. 
{{% /blocks/products/pf/feature-page-summary  %}}
