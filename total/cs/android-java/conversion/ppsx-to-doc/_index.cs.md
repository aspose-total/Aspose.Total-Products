---
title: Export PPSX do DOC na Andorid přes Java
description: Převeďte PPSX na DOC v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOC na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOC v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
