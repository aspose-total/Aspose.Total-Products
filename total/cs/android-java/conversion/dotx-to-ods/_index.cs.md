...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTX na ODS v aplikacích pro Android nebo online" h2="Export DOTX do ODS v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
