---
title: Export PPSX do DOT na Andorid přes Java
description: Převeďte PPSX na DOT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
