---
title: Export PPSX do DOTM na Andorid přes Java
description: Převeďte PPSX na DOTM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOTM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOTM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/android-java/conversion/ppsx-to-dotmm/" name="PPSX Na DOTMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/android-java/conversion/ppsx-to-dotmx/" name="PPSX Na DOTMX" description="" >}}
