---
title: Android API pro vykreslení TEX do WORDML
description: Transformujte TEX na WORDML přes Android přes Java API
url: /cs/android-java/conversion/tex-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: TEX
