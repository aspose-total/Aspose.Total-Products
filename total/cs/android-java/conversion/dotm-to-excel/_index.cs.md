---
title: Android API pro převod DOTM na EXCEL
description: Převeďte DOTM na EXCEL v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTM na EXCEL v aplikacích pro Android" h2="Export DOTM do EXCEL v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
