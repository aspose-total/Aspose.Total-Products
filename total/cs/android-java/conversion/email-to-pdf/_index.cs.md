...
Aplikace Andorid jsou snadno použitelné pro koncové uživatele na každodenní bázi. Počet uživatelů telefonů Andorid se každým dnem zvyšuje. Pomocí výkonných knihoven [Aspose.Total pro Android přes Java](https://products.aspose.com/total/android-java/) File Format Automation můžete vyvíjet aplikace pro manipulaci a konverzi e-mailů. E-mailovou adresu EMAIL můžete převést na PDF kombinací [Aspose.Email pro Android Java](https://products.aspose.com/email/android-java/) a [Aspose.Words pro Andorid Java](https://products.aspose.com/words/android-java/). Pomocí prvního API můžete převést formát souboru EMAIL do HTML a pomocí druhého API můžete vykreslit HTML jako PDF. 
{{% /blocks/products/pf/feature-page-summary  %}}
