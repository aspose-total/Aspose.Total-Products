---
title: Export POTX do DOCM na Andorid přes Java
description: Převeďte POTX na DOCM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTX do DOCM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTX na DOCM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
