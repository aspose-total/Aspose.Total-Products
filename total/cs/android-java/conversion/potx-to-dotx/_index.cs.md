---
title: Export POTX do DOTX na Andorid přes Java
description: Převeďte POTX na DOTX v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTX do DOTX na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTX na DOTX v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
