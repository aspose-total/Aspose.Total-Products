---
title: Export XLTX do PPTX v Androidu
description: Android API pro převod XLTX na PPTX bez použití aplikace Microsoft Word
url: /cs/android-java/conversion/xltx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Vykreslení XLTX do PPTX na Androidu přes Java" h2="Transformujte XLTX na PPTX ve svých aplikacích pro Android bez použití Microsoft<sup>&reg;</sup> Excel" >}}
