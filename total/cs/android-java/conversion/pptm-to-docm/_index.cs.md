---
title: Export PPTM do DOCM na Andorid přes Java
description: Převeďte PPTM na DOCM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPTM do DOCM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPTM na DOCM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
