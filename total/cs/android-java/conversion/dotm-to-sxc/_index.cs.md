...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTM na SXC v aplikacích pro Android nebo online" h2="Export DOTM do SXC v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
