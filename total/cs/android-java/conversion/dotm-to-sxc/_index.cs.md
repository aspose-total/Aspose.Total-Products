---
title: Android API pro převod DOTM na SXC
description: Převeďte DOTM na SXC v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/dotm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTM na SXC v aplikacích pro Android" h2="Export DOTM do SXC v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
