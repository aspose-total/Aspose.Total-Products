---
title: Export ODS do PPTX v Androidu
description: Android API pro převod ODS na PPTX bez použití aplikace Microsoft Word
url: /cs/android-java/conversion/ods-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Vykreslení ODS do PPTX na Androidu přes Java" h2="Transformujte ODS na PPTX ve svých aplikacích pro Android bez použití Microsoft<sup>&reg;</sup> Excel" >}}
