---
title: Export PPSX do DOTX na Andorid přes Java
description: Převeďte PPSX na DOTX v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOTX na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOTX v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
