---
title: Export XLSX do DOCX v Androidu
description: Android API pro převod XLSX na DOCX bez použití aplikace Microsoft Word
url: /cs/android-java/conversion/xlsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Vykreslení XLSX do DOCX na Androidu přes Java" h2="Transformujte XLSX na DOCX ve svých aplikacích pro Android bez použití Microsoft<sup>&reg;</sup> Excel" >}}
