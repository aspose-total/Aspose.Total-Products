---
title: Export POTX do ODT na Andorid přes Java
description: Převeďte POTX na ODT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTX do ODT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTX na ODT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
