---
title: Vykreslete EMLX do EMF v aplikaci Andorid
description: Exportujte EMLX do EMF bez použití Microsoft Word nebo Outlook ve vašich aplikacích Andorid
url: /cs/android-java/conversion/emlx-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{% blocks/products/pf/agp/feature-section-col title="Převést EMLX na EMF v Andoridu" %}}
...
4. Uložte dokument do formátu EMF pomocí [uložit](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) a nastavte EMF jako SaveFormat
