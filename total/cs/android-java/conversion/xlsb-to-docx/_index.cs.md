---
title: Export XLSB do DOCX v Androidu
description: Android API pro převod XLSB na DOCX bez použití aplikace Microsoft Word
url: /cs/android-java/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Vykreslení XLSB do DOCX na Androidu přes Java" h2="Transformujte XLSB na DOCX ve svých aplikacích pro Android bez použití Microsoft<sup>&reg;</sup> Excel" >}}
