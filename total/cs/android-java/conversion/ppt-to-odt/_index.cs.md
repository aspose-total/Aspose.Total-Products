---
title: Export PPT do ODT na Andorid přes Java
description: Převeďte PPT na ODT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPT do ODT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPT na ODT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
