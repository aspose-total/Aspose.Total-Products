---
title: Android API pro převod DOTX na XLT
description: Převeďte DOTX na XLT v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/dotx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTX na XLT v aplikacích pro Android" h2="Export DOTX do XLT v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total pro Android přes Java](https://products.aspose.com/total/android-java/) můžete integrovat funkci převodu DOTX na XLT do svých aplikací pro Android. Za prvé, můžete převést DOTX do HTML pomocí rozhraní API pro manipulaci s dokumenty a konverzi s bohatými funkcemi [Aspose.Words pro Android přes Java](https://products.aspose.com/words/android-java/). Poté můžete pomocí [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) převést HTML na XLT. 
{{% /blocks/products/pf/feature-page-summary  %}}
