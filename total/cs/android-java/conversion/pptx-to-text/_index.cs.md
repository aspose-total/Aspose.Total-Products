---
title: Export PPTX do TEXT na Andorid přes Java
description: Převeďte PPTX na TEXT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPTX do TEXT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPTX na TEXT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
