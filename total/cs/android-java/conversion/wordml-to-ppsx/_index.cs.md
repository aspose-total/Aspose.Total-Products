---
title: Převést WORDML na PPSX v Androidu přes Java
description: Převod WORDML na PPSX ve vašich telefonech Android bez použití aplikace Microsoft Word nebo PowerPoint
url: /cs/android-java/conversion/wordml-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="Převeďte WORDML na PPSX v aplikacích pro Android" h2="Převod WORDML na PPSX ve vašich aplikacích pro Android bez instalace Microsoft Word<sup>&reg;</sup> nebo PowerPoint" >}}
...
Pro konverzi souborů WORDML na PPSX můžete snadno použít Aspose.Total pro Android přes Javu přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) a nainstalujte si knihovny do své aplikace.
