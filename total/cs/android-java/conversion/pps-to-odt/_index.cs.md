---
title: Export PPS do ODT na Andorid přes Java
description: Převeďte PPS na ODT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPS do ODT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPS na ODT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
