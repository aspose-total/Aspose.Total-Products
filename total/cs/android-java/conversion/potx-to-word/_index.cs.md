---
title: Export POTX do WORD na Andorid přes Java
description: Převeďte POTX na WORD v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTX do WORD na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTX na WORD v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/android-java/conversion/potx-to-wordx/" name="POTX Na WORDX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/cs/android-java/conversion/potx-to-wordm/" name="POTX Na WORDM" description="" >}}
