---
title: Export PPSX do DOCM na Andorid přes Java
description: Převeďte PPSX na DOCM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOCM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOCM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
