---
title: Export PPSX do ODT na Andorid přes Java
description: Převeďte PPSX na ODT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do ODT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na ODT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
