---
title: Export POTX do TEXT na Andorid přes Java
description: Převeďte POTX na TEXT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTX do TEXT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTX na TEXT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
