---
title: Android API pro převod RTF na FODS
description: Převeďte RTF na FODS v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/rtf-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Převeďte RTF na FODS v aplikacích pro Android" h2="Export RTF do FODS v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
