---
title: Android API pro převod ODT na FODS
description: Převeďte ODT na FODS v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/odt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Převeďte ODT na FODS v aplikacích pro Android" h2="Export ODT do FODS v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
