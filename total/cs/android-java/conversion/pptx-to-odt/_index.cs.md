---
title: Export PPTX do ODT na Andorid přes Java
description: Převeďte PPTX na ODT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPTX do ODT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPTX na ODT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
