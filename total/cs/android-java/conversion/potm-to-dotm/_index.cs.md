---
title: Export POTM do DOTM na Andorid přes Java
description: Převeďte POTM na DOTM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTM do DOTM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTM na DOTM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
