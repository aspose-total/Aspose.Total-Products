---
title: Export POTM do DOTX na Andorid přes Java
description: Převeďte POTM na DOTX v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/potm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POTM do DOTX na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POTM na DOTX v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
