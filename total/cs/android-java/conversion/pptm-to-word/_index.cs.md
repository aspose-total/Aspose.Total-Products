---
title: Export PPTM do WORD na Andorid přes Java
description: Převeďte PPTM na WORD v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPTM do WORD na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPTM na WORD v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
