---
title: Export PPS do DOT na Andorid přes Java
description: Převeďte PPS na DOT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPS do DOT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPS na DOT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
