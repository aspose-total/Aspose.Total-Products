---
title: Export POT do OTT na Andorid přes Java
description: Převeďte POT na OTT v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Renderujte POT do OTT na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod POT na OTT v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
