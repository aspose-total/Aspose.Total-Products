---
title: Android API pro převod DOTM na XLTX
description: Převeďte DOTM na XLTX v Androidu přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/android-java/conversion/dotm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Převeďte DOTM na XLTX v aplikacích pro Android" h2="Export DOTM do XLTX v Androidu přes Java bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
