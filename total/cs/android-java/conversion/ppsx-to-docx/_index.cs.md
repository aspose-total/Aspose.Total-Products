---
title: Export PPSX do DOCX na Andorid přes Java
description: Převeďte PPSX na DOCX v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPSX do DOCX na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPSX na DOCX v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
