---
title: Export PPT do DOTM na Andorid přes Java
description: Převeďte PPT na DOTM v mobilních aplikacích bez instalace jakéhokoli softwaru
url: /cs/android-java/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Renderujte PPT do DOTM na Andoridu přes Javu" h2="Rozhraní API pro formát souborů pro převod PPT na DOTM v aplikacích pro Android bez závislosti na Microsoft PowerPoint nebo Word" >}}
