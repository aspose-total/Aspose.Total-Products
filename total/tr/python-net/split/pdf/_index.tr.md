---
title: Çevrimiçi PDF Dosya Ayırıcı veya PDF Dosyalarını Bölmek için Python Uygulamaları Oluşturun
description: Farklı PDF dosyalarını bölmek için ücretsiz çevrimiçi uygulama.PDF belgeleri için Python Splitter kitaplık kodu.
...
<h3>Ücretsiz Çevrimiçi PDF Belge Ayırıcı Uygulaması</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="PDF Dosyasını Python ile Böl" %}}
...
1. Document sınıfının yeni nesnesini oluşturun ve sayfaları.add(Page) kullanarak Sayfayı ekleyin.
1. Save() yöntemini kullanarak sayfayı yeni dosyaya kaydedin.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Python'da PDF Dosyalarını Bölmek İçin Kod Örneği Sayfa Bilge" offSpacer="" %}}

{{< gist "aspose-com-gists" "cab3cbb646eef9f3bdf5e1922d739399" "split-pdf-documents.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="PDF Sayfa Aralığını Bölmek için Python Kodu" offSpacer="" %}}
...
<h2>Python kullanarak PDF Dosya Ayırıcı Uygulaması Geliştirin</h2>

PDF dosyalarını kolayca bölmek için python betiği veya yardımcı program uygulaması geliştirmeniz mi gerekiyor? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/)'ün alt API'si olan [Aspose.PDF for Python via .NET](https://products.aspose.com/pdf/python-net/) ile herhangi bir python geliştiricisi, Splitter uygulamasını programlamak için yukarıdaki API kodunu entegre edebilir.Belgeyi bölmeye yönelik güçlü Python kitaplığı, PDF, Word, PowerPoint ve Excel dosyaları gibi PDF formatı da dahil olmak üzere birçok popüler formatı destekler.<br /><br />
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Evet, bu kodu indirebilirsiniz. Python kullanarak PDF dosyalarını bölmek için kolayca profesyonel bir çözüm geliştirilebilir.Python'da üst düzey, platformdan bağımsız yazılım geliştirmek için Aspose PDF splitter API'yi kullanın.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
