---
title: Python'da MBOX'yi DOCM'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi DOCM'e kaydedin 
url: /tr/python-net/conversion/mbox-to-docm/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den DOCM'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi DOCM'e Kaydet" offSpacer="" %}}
