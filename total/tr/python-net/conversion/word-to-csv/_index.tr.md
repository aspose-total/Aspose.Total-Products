---
title: Python kullanarak WORD'yi CSV'e dönüştürün
description: Python uygulamalarınızda Microsoft Word veya Excel kullanmadan WORD'den CSV'e dönüştürme 
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi Python aracılığıyla CSV'e dönüştürün" h2="Microsoft Word<sup>&reg;</sup> veya Excel yüklemeden Python uygulamalarınızda WORD'den CSV'e dönüştürme" >}}
