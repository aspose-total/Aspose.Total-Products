---
title: Python'da EMAIL'yi DOCM'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOCM'e kaydedin 
url: /tr/python-net/conversion/email-to-docm/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOCM'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOCM'e Kaydet" offSpacer="" %}}
