---
title: Python'da EMAIL'yi DOTM'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOTM'e kaydedin 
url: /tr/python-net/conversion/email-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOTM'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOTM'e Kaydet" offSpacer="" %}}
