---
title: Python'da EMAIL'yi DOT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOT'e kaydedin 
url: /tr/python-net/conversion/email-to-dot/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOT'e Kaydet" offSpacer="" %}}
