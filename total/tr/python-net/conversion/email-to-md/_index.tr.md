---
title: Python'da EMAIL'yi MD'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi MD'e kaydedin 
url: /tr/python-net/conversion/email-to-md/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den MD'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi MD'e Kaydet" offSpacer="" %}}
