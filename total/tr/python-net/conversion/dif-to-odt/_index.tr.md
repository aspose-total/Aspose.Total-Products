---
title: Python kullanarak DIF'yi ODT'e dönüştürün
description: Microsoft Office kullanmadan Python uygulamalarınızda DIF'den ODT'e dönüştürme 
...
{{< blocks/products/pf/feature-page-header h1="DIF'yi Python aracılığıyla ODT'e dönüştürün" h2="Python uygulamalarınızda Microsoft Excel<sup>&reg;</sup> veya Word yüklemeden DIF'den ODT'e dönüştürme" >}}
