...
description: Microsoft Office kullanmadan Python uygulamalarınızda DIF'den ODT'e dönüştürme veya çevrimiçi. Kodu entegre etmeden önce ücretsiz CSV'den POT'e çevrimiçi dönüştürücüyü hızlı bir şekilde test edin. 
...
{{< blocks/products/pf/feature-page-header h1="DIF'yi Python aracılığıyla ODT'e dönüştürün veya çevrimiçi" h2="Python uygulamalarınızda Microsoft Excel<sup>&reg;</sup> veya Word yüklemeden DIF'den ODT'e dönüştürme" >}}
