---
title: Python'da EMAIL'yi BMP'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi BMP'e kaydedin 
url: /tr/python-net/conversion/email-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den BMP'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi BMP'e Kaydet" offSpacer="" %}}
