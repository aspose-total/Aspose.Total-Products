---
title: Python'da EMAIL'yi DOTX'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOTX'e kaydedin 
url: /tr/python-net/conversion/email-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOTX'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOTX'e Kaydet" offSpacer="" %}}
