---
title: Python'da MBOX'yi TIFF'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi TIFF'e kaydedin 
url: /tr/python-net/conversion/mbox-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den TIFF'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi TIFF'e Kaydet" offSpacer="" %}}
