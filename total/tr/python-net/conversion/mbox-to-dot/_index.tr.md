---
title: Python'da MBOX'yi DOT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi DOT'e kaydedin 
url: /tr/python-net/conversion/mbox-to-dot/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den DOT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi DOT'e Kaydet" offSpacer="" %}}
