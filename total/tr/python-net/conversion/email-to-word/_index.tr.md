---
title: Python'da EMAIL'yi WORD'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi WORD'e kaydedin 
url: /tr/python-net/conversion/email-to-word/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den WORD'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi WORD'e Kaydet" offSpacer="" %}}
