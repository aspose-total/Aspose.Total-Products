---
title: Python'da EMAIL'yi RTF'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi RTF'e kaydedin 
url: /tr/python-net/conversion/email-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den RTF'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi RTF'e Kaydet" offSpacer="" %}}
