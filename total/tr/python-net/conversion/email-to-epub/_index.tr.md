---
title: Python'da EMAIL'yi EPUB'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi EPUB'e kaydedin 
url: /tr/python-net/conversion/email-to-epub/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den EPUB'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi EPUB'e Kaydet" offSpacer="" %}}
