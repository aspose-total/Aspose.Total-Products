---
title: Python kullanarak WORD'yi XLSX'e dönüştürün
description: Python uygulamalarınızda Microsoft Word veya Excel kullanmadan WORD'den XLSX'e dönüştürme 
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi Python aracılığıyla XLSX'e dönüştürün" h2="Microsoft Word<sup>&reg;</sup> veya Excel yüklemeden Python uygulamalarınızda WORD'den XLSX'e dönüştürme" >}}
