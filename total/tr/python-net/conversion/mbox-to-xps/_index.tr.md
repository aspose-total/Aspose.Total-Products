---
title: Python'da MBOX'yi XPS'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi XPS'e kaydedin 
url: /tr/python-net/conversion/mbox-to-xps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den XPS'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi XPS'e Kaydet" offSpacer="" %}}
