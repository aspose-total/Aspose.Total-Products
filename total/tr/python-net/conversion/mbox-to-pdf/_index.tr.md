---
title: Python'da MBOX'yi PDF'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi PDF'e kaydedin 
url: /tr/python-net/conversion/mbox-to-pdf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den PDF'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi PDF'e Kaydet" offSpacer="" %}}
