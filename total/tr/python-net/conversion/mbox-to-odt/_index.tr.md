---
title: Python'da MBOX'yi ODT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi ODT'e kaydedin 
url: /tr/python-net/conversion/mbox-to-odt/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den ODT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi ODT'e Kaydet" offSpacer="" %}}
