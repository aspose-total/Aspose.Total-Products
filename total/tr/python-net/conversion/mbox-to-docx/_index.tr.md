---
title: Python'da MBOX'yi DOCX'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi DOCX'e kaydedin 
url: /tr/python-net/conversion/mbox-to-docx/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den DOCX'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi DOCX'e Kaydet" offSpacer="" %}}
