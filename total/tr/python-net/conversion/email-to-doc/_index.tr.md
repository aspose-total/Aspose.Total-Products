---
title: Python'da EMAIL'yi DOC'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOC'e kaydedin 
url: /tr/python-net/conversion/email-to-doc/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOC'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOC'e Kaydet" offSpacer="" %}}
