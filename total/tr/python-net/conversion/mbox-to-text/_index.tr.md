---
title: Python'da MBOX'yi TEXT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi TEXT'e kaydedin 
url: /tr/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den TEXT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi TEXT'e Kaydet" offSpacer="" %}}
