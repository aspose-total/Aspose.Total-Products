---
title: Python'da EMAIL'yi ODT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi ODT'e kaydedin 
url: /tr/python-net/conversion/email-to-odt/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den ODT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi ODT'e Kaydet" offSpacer="" %}}
