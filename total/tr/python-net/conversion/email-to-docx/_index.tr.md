---
title: Python'da EMAIL'yi DOCX'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi DOCX'e kaydedin 
url: /tr/python-net/conversion/email-to-docx/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den DOCX'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi DOCX'e Kaydet" offSpacer="" %}}
