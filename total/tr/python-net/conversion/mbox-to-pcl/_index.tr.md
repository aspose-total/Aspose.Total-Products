---
title: Python'da MBOX'yi PCL'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi PCL'e kaydedin 
url: /tr/python-net/conversion/mbox-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den PCL'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi PCL'e Kaydet" offSpacer="" %}}
