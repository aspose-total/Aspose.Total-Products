---
title: Python'da MBOX'yi MD'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi MD'e kaydedin 
url: /tr/python-net/conversion/mbox-to-md/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den MD'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi MD'e Kaydet" offSpacer="" %}}
