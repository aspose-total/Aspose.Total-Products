...
- OFT'den IMAGE'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da OFT'yi IMAGE'e Kaydet" offSpacer="" %}}
