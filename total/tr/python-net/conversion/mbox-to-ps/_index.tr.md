---
title: Python'da MBOX'yi PS'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi PS'e kaydedin 
url: /tr/python-net/conversion/mbox-to-ps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den PS'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi PS'e Kaydet" offSpacer="" %}}
