---
title: Python'da MBOX'yi RTF'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi RTF'e kaydedin 
url: /tr/python-net/conversion/mbox-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den RTF'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi RTF'e Kaydet" offSpacer="" %}}
