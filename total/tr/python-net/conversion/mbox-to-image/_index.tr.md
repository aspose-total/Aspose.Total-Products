---
title: Python'da MBOX'yi IMAGE'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda MBOX'yi IMAGE'e kaydedin 
url: /tr/python-net/conversion/mbox-to-image/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- MBOX'den IMAGE'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da MBOX'yi IMAGE'e Kaydet" offSpacer="" %}}
