---
title: Python'da EMAIL'yi OTT'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi OTT'e kaydedin 
url: /tr/python-net/conversion/email-to-ott/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den OTT'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi OTT'e Kaydet" offSpacer="" %}}
