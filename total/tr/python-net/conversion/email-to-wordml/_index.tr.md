---
title: Python'da EMAIL'yi WORDML'e Dönüştür
description: Microsoft Outlook veya Word kullanmadan Python uygulamalarınızda EMAIL'yi WORDML'e kaydedin 
url: /tr/python-net/conversion/email-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL'den WORDML'e dönüştürme için Python 3.5 veya üstü gereklidir
...
{{% blocks/products/pf/agp/code-block title="Python'da EMAIL'yi WORDML'e Kaydet" offSpacer="" %}}
