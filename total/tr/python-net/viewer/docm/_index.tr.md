---
title: DOCM Dosyasını Çevrimiçi Görüntüleyin ve Python kullanarak DOCM Dosyasını Yükleyin veya Okuyun
description: Ücretsiz çevrimiçi DOCM dosya görüntüleme uygulaması. Görüntüleyici uygulaması için DOCM dosyasını okumak ve yüklemek için Python API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="DOCM Dosyasını Çevrimiçi Olarak Özgürce Görüntüleyin ve Python ile Belgeyi Yükleyin veya Okuyun" h2="Güçlü Python tabanlı DOCM belge görüntüleme yardımcı programı uygulaması geliştirin.DOCM belgesini Python aracılığıyla yüklemek veya okumak için listelenen kod." >}}
...
1. DOCM dosyasını yükleyerek görüntülemek için içe aktarın.
...
{{% blocks/products/pf/agp/feature-section-col title="Viewer Uygulaması için Python aracılığıyla DOCM Dosyasını Yükleyin veya Okuyun" %}}

1. Proje içindeki API'lere doğrudan PyPI GIF'ten referans verin1
1. Belge sınıfı nesnesi oluşturun ve onu kullanarak kaynak DOCM dosyasını yükleyin.
...
1. Ve DOCM dosyasını görüntülemek üzere tarayıcıyı çağırmak için subprocess.run'u kullanın.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="DOCM Dosyalarını görüntülemek için Python'daki kod örneği" offSpacer="" %}}
