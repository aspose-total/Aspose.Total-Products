---
title: DOT Dosyasını Çevrimiçi Görüntüleyin ve Python kullanarak DOT Dosyasını Yükleyin veya Okuyun
description: Ücretsiz çevrimiçi DOT dosya görüntüleme uygulaması. Görüntüleyici uygulaması için DOT dosyasını okumak ve yüklemek için Python API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="DOT Dosyasını Çevrimiçi Olarak Özgürce Görüntüleyin ve Python ile Belgeyi Yükleyin veya Okuyun" h2="Güçlü Python tabanlı DOT belge görüntüleme yardımcı programı uygulaması geliştirin.DOT belgesini Python aracılığıyla yüklemek veya okumak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Viewer Uygulaması için Python aracılığıyla DOT Dosyasını Yükleyin veya Okuyun" %}}

1. Proje içindeki API'lere doğrudan PyPI GIF'ten referans verin1
1. Belge sınıfı nesnesi oluşturun ve onu kullanarak kaynak DOT dosyasını yükleyin.
...
1. Ve DOT dosyasını görüntülemek üzere tarayıcıyı çağırmak için subprocess.run'u kullanın.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="DOT Dosyalarını görüntülemek için Python'daki kod örneği" offSpacer="" %}}
