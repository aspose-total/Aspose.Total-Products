---
title: ODT Şifre Korumasının kilidini Çevrimiçi olarak veya Python kullanarak açın
description: Ücretsiz çevrimiçi uygulama aracılığıyla ODT belgesinden şifreyi kaldırın.Parola korumalı ODT dosyalarının kilidini açmak için Python API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parolayı ODT Document Online'dan veya Python aracılığıyla kaldırın" h2="Güçlü Python tabanlı ODT belge kilitleme ve kilit açma yardımcı uygulaması geliştirin.Python aracılığıyla ODT dosyasındaki şifre kısıtlamalarını kaldırmak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python ile ODT Şifresini Kaldır" %}}
...
{{% blocks/products/pf/agp/code-block title="ODT belgesinden şifreyi kaldırmak için Python'daki kod örneği" offSpacer="" %}}
...
<h2>Python ile ODT Koruma Yönetimi Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT Korumasını Yönetmek için Python Yardımcı Programı" %}}
