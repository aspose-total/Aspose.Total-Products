---
title: EXCEL Şifre Korumasının kilidini Çevrimiçi olarak veya Python kullanarak açın
description: Ücretsiz çevrimiçi uygulama aracılığıyla EXCEL belgesinden şifreyi kaldırın.Parola korumalı EXCEL dosyalarının kilidini açmak için Python API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parolayı EXCEL Document Online'dan veya Python aracılığıyla kaldırın" h2="Güçlü Python tabanlı EXCEL belge kilitleme ve kilit açma yardımcı uygulaması geliştirin.Python aracılığıyla EXCEL dosyasındaki şifre kısıtlamalarını kaldırmak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python ile EXCEL Şifresini Kaldır" %}}

1. Proje içindeki API'lere doğrudan PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))'den başvurun.
1. Document sınıfını kullanarak parola korumalı EXCEL dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="EXCEL belgesinden şifreyi kaldırmak için Python'daki kod örneği" offSpacer="" %}}
...
<h2>Python ile EXCEL Koruma Yönetimi Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="EXCEL Korumasını Yönetmek için Python Yardımcı Programı" %}}
