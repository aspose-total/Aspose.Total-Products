---
title: XLSX Şifre Korumasının kilidini Çevrimiçi olarak veya Python kullanarak açın
description: Ücretsiz çevrimiçi uygulama aracılığıyla XLSX belgesinden şifreyi kaldırın.Parola korumalı XLSX dosyalarının kilidini açmak için Python API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parolayı XLSX Document Online'dan veya Python aracılığıyla kaldırın" h2="Güçlü Python tabanlı XLSX belge kilitleme ve kilit açma yardımcı uygulaması geliştirin.Python aracılığıyla XLSX dosyasındaki şifre kısıtlamalarını kaldırmak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python ile XLSX Şifresini Kaldır" %}}

1. Proje içindeki API'lere doğrudan PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))'den başvurun.
1. Document sınıfını kullanarak parola korumalı XLSX dosyasını yükleyin.
...
{{% blocks/products/pf/agp/code-block title="XLSX belgesinden şifreyi kaldırmak için Python'daki kod örneği" offSpacer="" %}}
...
<h2>Python ile XLSX Koruma Yönetimi Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="XLSX Korumasını Yönetmek için Python Yardımcı Programı" %}}
