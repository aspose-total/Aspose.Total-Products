---
title: Node.js'de VSD Visio Diyagramları Oluşturun
description: Microsoft Office kullanmadan Node uygulamalarını kullanarak Microsoft Visio VSD Diyagramları oluşturun. 
...
{{< blocks/products/pf/feature-page-header h1="Node.js kullanarak VSD Dosyası Oluşturun" h2="Başka hiçbir yazılım yüklemeden Node Uygulamalarınız aracılığıyla Microsoft Visio VSD Dosyaları oluşturun." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Node.js'de VSD Dosyası Oluşturun" %}}

- Diyagram sınıf örneği oluşturun.
- İlgili parametrelerle save metodunu çağırın
- VSD Dosya Yolu ve SaveFileFormat ilgili uzantısı

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Yaratılış Gereksinimleri" %}}

- VSD belgesi oluşturmak için sistemde Node.js kurulu olmalıdır.
- Oracle JDK (sürüm 7 veya üzeri) gereklidir.
- node-java paketinin kurulması gerekiyor.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - VSD Dosyaları Oluşturma" offSpacer="" %}}
