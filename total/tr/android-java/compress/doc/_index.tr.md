---
title: DOC Dosyalarını Çevrimiçi Olarak veya Android Mobil Uygulamalarını Kullanarak Sıkıştırın
description: Farklı DOC dosyalarını sıkıştırmak için ücretsiz çevrimiçi uygulama.DOC belgeleri için Android sıkıştırma kitaplığı Java kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="DOC Dosyasını Çevrimiçi Olarak veya Android Uygulamasını Kullanarak Sıkıştırın" h2="Güçlü android tabanlı DOC belge sıkıştırma uygulamaları geliştirin.DOC dosyaları da dahil olmak üzere çeşitli belgeleri uygulama aracılığıyla çevrimiçi olarak anında indirerek özgürce sıkıştırın." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC Dosyalarını Çevrimiçi Olarak Sıkıştırın ve Optimize Edin" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOC Dosyasını Android Uygulamasıyla Sıkıştırın" %}}
...
1. Kaydetme yöntemini çağırın ve sıkıştırılmış DOC dosyasını alın

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Java Kodu: DOC Dosyalarını Sıkıştır" offSpacer="" %}}
