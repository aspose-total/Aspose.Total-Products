---
title: RTF'yi TSV'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de RTF'yi TSV'ye dönüştürün
url: /tr/android-java/conversion/rtf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında RTF'yi TSV'ye Dönüştür" h2="RTF'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de TSV'ye aktarın" >}}
