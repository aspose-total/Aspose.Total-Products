---
title: Android'de SXC'yi WORD'a aktarın
description: Microsoft Word kullanmadan SXC'yi WORD'ye dönüştürmek için Android API
url: /tr/android-java/conversion/sxc-to-word/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de SXC'yi WORD'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda SXC'yi WORD'ye dönüştürün" >}}
