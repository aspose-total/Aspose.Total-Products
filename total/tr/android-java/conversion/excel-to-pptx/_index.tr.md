---
title: Android'de EXCEL'yi PPTX'a aktarın
description: Microsoft Word kullanmadan EXCEL'yi PPTX'ye dönüştürmek için Android API
url: /tr/android-java/conversion/excel-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de EXCEL'yi PPTX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda EXCEL'yi PPTX'ye dönüştürün" >}}
