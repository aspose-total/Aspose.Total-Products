---
title: DOCM'yi SXC'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOCM'yi SXC'ye dönüştürün
url: /tr/android-java/conversion/docm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOCM'yi SXC'ye Dönüştür" h2="DOCM'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de SXC'ye aktarın" >}}
