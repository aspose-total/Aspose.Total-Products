---
title: Android'de XLSM'yi WORD'a aktarın
description: Microsoft Word kullanmadan XLSM'yi WORD'ye dönüştürmek için Android API
url: /tr/android-java/conversion/xlsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de XLSM'yi WORD'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda XLSM'yi WORD'ye dönüştürün" >}}
