---
title: RTF'yi XLS'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de RTF'yi XLS'ye dönüştürün
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında RTF'yi XLS'ye Dönüştür" h2="RTF'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLS'ye aktarın" >}}
