---
title: Java aracılığıyla Andorid'de POTM'u DOC'a aktarın
description: Herhangi bir yazılım yüklemeden mobil uygulamalarda POTM'u DOC'ye dönüştürün
url: /tr/android-java/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Andorid'de POTM'u DOC'a dönüştürün" h2="Microsoft PowerPoint veya Word'e bağlı kalmadan Android uygulamalarında POTM'u DOC'ye dönüştürmek için dosya biçimi API'leri" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Java aracılığıyla Android için Aspose.Total](https://products.aspose.com/total/android-java/), Android uygulamalarında dosya biçimlerinin değiştirilmesine olanak tanır. Pakette sağlanan API'leri kullanarak, uygulamalarınızda PowerPoint POTM'tan Word DOC'ye dönüştürme işlemini otomatikleştirebilirsiniz.
