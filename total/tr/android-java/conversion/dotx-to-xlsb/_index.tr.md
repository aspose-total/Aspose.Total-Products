---
title: DOTX'yi XLSB'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOTX'yi XLSB'ye dönüştürün
url: /tr/android-java/conversion/dotx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOTX'yi XLSB'ye Dönüştür" h2="DOTX'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLSB'ye aktarın" >}}
