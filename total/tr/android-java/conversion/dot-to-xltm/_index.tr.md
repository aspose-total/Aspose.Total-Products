---
title: DOT'yi XLTM'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOT'yi XLTM'ye dönüştürün
url: /tr/android-java/conversion/dot-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOT'yi XLTM'ye Dönüştür" h2="DOT'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLTM'ye aktarın" >}}
