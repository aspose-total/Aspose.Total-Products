---
title: MOBI'yi XLTX'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de MOBI'yi XLTX'ye dönüştürün
url: /tr/android-java/conversion/mobi-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında MOBI'yi XLTX'ye Dönüştür" h2="MOBI'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLTX'ye aktarın" >}}
