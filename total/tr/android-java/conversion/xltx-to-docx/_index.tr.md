---
title: Android'de XLTX'yi DOCX'a aktarın
description: Microsoft Word kullanmadan XLTX'yi DOCX'ye dönüştürmek için Android API
url: /tr/android-java/conversion/xltx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de XLTX'yi DOCX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda XLTX'yi DOCX'ye dönüştürün" >}}
