---
title: RTF'yi XLAM'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de RTF'yi XLAM'ye dönüştürün
url: /tr/android-java/conversion/rtf-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında RTF'yi XLAM'ye Dönüştür" h2="RTF'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLAM'ye aktarın" >}}
