---
title: DOC'yi XLSM'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOC'yi XLSM'ye dönüştürün
url: /tr/android-java/conversion/doc-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOC'yi XLSM'ye Dönüştür" h2="DOC'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLSM'ye aktarın" >}}
