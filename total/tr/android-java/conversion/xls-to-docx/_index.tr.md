---
title: Android'de XLS'yi DOCX'a aktarın
description: Microsoft Word kullanmadan XLS'yi DOCX'ye dönüştürmek için Android API
url: /tr/android-java/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de XLS'yi DOCX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda XLS'yi DOCX'ye dönüştürün" >}}
