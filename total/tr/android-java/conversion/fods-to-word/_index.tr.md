---
title: Android'de FODS'yi WORD'a aktarın
description: Microsoft Word kullanmadan FODS'yi WORD'ye dönüştürmek için Android API
url: /tr/android-java/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de FODS'yi WORD'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda FODS'yi WORD'ye dönüştürün" >}}
