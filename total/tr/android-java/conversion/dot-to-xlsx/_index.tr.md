---
title: DOT'yi XLSX'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOT'yi XLSX'ye dönüştürün
url: /tr/android-java/conversion/dot-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOT'yi XLSX'ye Dönüştür" h2="DOT'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLSX'ye aktarın" >}}
