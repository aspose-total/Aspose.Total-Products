---
title: OTT'yi XLTX'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de OTT'yi XLTX'ye dönüştürün
url: /tr/android-java/conversion/ott-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında OTT'yi XLTX'ye Dönüştür" h2="OTT'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLTX'ye aktarın" >}}
