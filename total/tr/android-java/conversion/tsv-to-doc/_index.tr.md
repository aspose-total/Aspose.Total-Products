---
title: Android'de TSV'yi DOC'a aktarın
description: Microsoft Word kullanmadan TSV'yi DOC'ye dönüştürmek için Android API
url: /tr/android-java/conversion/tsv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de TSV'yi DOC'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda TSV'yi DOC'ye dönüştürün" >}}
