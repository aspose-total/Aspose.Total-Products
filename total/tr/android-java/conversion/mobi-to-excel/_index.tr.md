---
title: MOBI'yi EXCEL'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de MOBI'yi EXCEL'ye dönüştürün
url: /tr/android-java/conversion/mobi-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında MOBI'yi EXCEL'ye Dönüştür" h2="MOBI'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de EXCEL'ye aktarın" >}}
