---
title: Java aracılığıyla Andorid'de POT'u DOT'a aktarın
description: Herhangi bir yazılım yüklemeden mobil uygulamalarda POT'u DOT'ye dönüştürün
url: /tr/android-java/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Andorid'de POT'u DOT'a dönüştürün" h2="Microsoft PowerPoint veya Word'e bağlı kalmadan Android uygulamalarında POT'u DOT'ye dönüştürmek için dosya biçimi API'leri" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Java aracılığıyla Android için Aspose.Total](https://products.aspose.com/total/android-java/), Android uygulamalarında dosya biçimlerinin değiştirilmesine olanak tanır. Pakette sağlanan API'leri kullanarak, uygulamalarınızda PowerPoint POT'tan Word DOT'ye dönüştürme işlemini otomatikleştirebilirsiniz.
