---
title: DOCM'yi XLT'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOCM'yi XLT'ye dönüştürün
url: /tr/android-java/conversion/docm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOCM'yi XLT'ye Dönüştür" h2="DOCM'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLT'ye aktarın" >}}
