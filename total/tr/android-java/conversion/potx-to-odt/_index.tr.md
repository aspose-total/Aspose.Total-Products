---
title: Java aracılığıyla Andorid'de POTX'u ODT'a aktarın
description: Herhangi bir yazılım yüklemeden mobil uygulamalarda POTX'u ODT'ye dönüştürün
url: /tr/android-java/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Andorid'de POTX'u ODT'a dönüştürün" h2="Microsoft PowerPoint veya Word'e bağlı kalmadan Android uygulamalarında POTX'u ODT'ye dönüştürmek için dosya biçimi API'leri" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Java aracılığıyla Android için Aspose.Total](https://products.aspose.com/total/android-java/), Android uygulamalarında dosya biçimlerinin değiştirilmesine olanak tanır. Pakette sağlanan API'leri kullanarak, uygulamalarınızda PowerPoint POTX'tan Word ODT'ye dönüştürme işlemini otomatikleştirebilirsiniz.
