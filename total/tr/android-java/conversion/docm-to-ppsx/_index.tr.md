...
url: /tr/android-java/conversion/docm-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
Ayrıca Android uygulamalarınızda şifre korumalı DOCM'nizi PPSX'ye dönüştürebilirsiniz. Girdiğiniz DOCM belgeniz parola korumalıysa, parolayı kullanmadan PPSX biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Docmument yapıcısına iletebilirsiniz.
{{% blocks/products/pf/feature-page-code %}}
