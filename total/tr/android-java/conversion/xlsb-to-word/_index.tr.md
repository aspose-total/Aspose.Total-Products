---
title: Android'de XLSB'yi WORD'a aktarın
description: Microsoft Word kullanmadan XLSB'yi WORD'ye dönüştürmek için Android API
url: /tr/android-java/conversion/xlsb-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de XLSB'yi WORD'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda XLSB'yi WORD'ye dönüştürün" >}}
