...
url: /tr/android-java/conversion/ppsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
[Java aracılığıyla Android için Aspose.Total](https://products.aspose.com/total/android-java/), Android uygulamalarında dosya biçimlerinin değiştirilmesine olanak tanır. Pakette sağlanan API'leri kullanarak, uygulamalarınızda PowerPoint PPSM'tan Word DOC'ye dönüştürme işlemini otomatikleştirebilirsiniz.
