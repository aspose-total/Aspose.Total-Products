---
title: DOTX'yi EXCEL'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOTX'yi EXCEL'ye dönüştürün
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOTX'yi EXCEL'ye Dönüştür" h2="DOTX'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de EXCEL'ye aktarın" >}}
