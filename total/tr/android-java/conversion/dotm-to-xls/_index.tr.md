---
title: DOTM'yi XLS'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOTM'yi XLS'ye dönüştürün
url: /tr/android-java/conversion/dotm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOTM'yi XLS'ye Dönüştür" h2="DOTM'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLS'ye aktarın" >}}
