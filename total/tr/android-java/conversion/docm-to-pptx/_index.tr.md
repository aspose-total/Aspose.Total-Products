---
title: Java ile Android'de DOCM'yi PPTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan Android Telefonlarınızda DOCM'den PPTX'ye dönüştürme
url: /tr/android-java/conversion/docm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOCM'yi PPTX'ye Dönüştür" h2="Microsoft Word<sup>&reg;</sup> veya PowerPoint yüklemeden Android Uygulamalarınızda DOCM'den PPTX'ye dönüştürme" >}}
...
Ayrıca Android uygulamalarınızda şifre korumalı DOCM'nizi PPTX'ye dönüştürebilirsiniz. Girdiğiniz DOCM belgeniz parola korumalıysa, parolayı kullanmadan PPTX biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Docmument yapıcısına iletebilirsiniz.
{{% blocks/products/pf/feature-page-code %}}
