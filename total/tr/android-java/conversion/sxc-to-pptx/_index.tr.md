---
title: Android'de SXC'yi PPTX'a aktarın
description: Microsoft Word kullanmadan SXC'yi PPTX'ye dönüştürmek için Android API
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de SXC'yi PPTX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda SXC'yi PPTX'ye dönüştürün" >}}
