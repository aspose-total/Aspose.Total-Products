---
title: Android'de SXC'yi POWERPOINT'a aktarın
description: Microsoft Word kullanmadan SXC'yi POWERPOINT'ye dönüştürmek için Android API
url: /tr/android-java/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de SXC'yi POWERPOINT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda SXC'yi POWERPOINT'ye dönüştürün" >}}
