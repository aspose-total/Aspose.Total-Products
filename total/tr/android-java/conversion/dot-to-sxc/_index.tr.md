---
title: DOT'yi SXC'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOT'yi SXC'ye dönüştürün
url: /tr/android-java/conversion/dot-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOT'yi SXC'ye Dönüştür" h2="DOT'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de SXC'ye aktarın" >}}
