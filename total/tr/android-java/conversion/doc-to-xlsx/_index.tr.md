---
title: DOC'yi XLSX'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOC'yi XLSX'ye dönüştürün
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOC'yi XLSX'ye Dönüştür" h2="DOC'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de XLSX'ye aktarın" >}}
