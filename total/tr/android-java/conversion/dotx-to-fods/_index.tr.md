---
title: DOTX'yi FODS'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOTX'yi FODS'ye dönüştürün
url: /tr/android-java/conversion/dotx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOTX'yi FODS'ye Dönüştür" h2="DOTX'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de FODS'ye aktarın" >}}
