---
title: DOTM'yi FODS'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOTM'yi FODS'ye dönüştürün
url: /tr/android-java/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOTM'yi FODS'ye Dönüştür" h2="DOTM'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de FODS'ye aktarın" >}}
