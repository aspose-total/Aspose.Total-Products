---
title: Java ile Android'de DOCM'yi JSON Formatına Dönüştür
description: Microsoft Word veya Excel kullanmadan Java aracılığıyla Android'de DOCM'u JSON formatına ayrıştırın
url: /tr/android-java/conversion/docm-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{% blocks/products/pf/feature-page-section  h2="Java ile Android'de Korumalı DOCM'yi JSON Formatına Dönüştür" %}}
API'yi kullanarak parola korumalı belgeyi de açabilirsiniz. Girdiğiniz DOCM belgeniz parola korumalıysa, parolayı kullanmadan JSON biçimine dönüştüremezsiniz. API, bir LoadOptions nesnesinde doğru parolayı ileterek şifrelenmiş belgeyi açmanıza olanak tanır. Aşağıdaki kod örneği, şifrelenmiş bir belgenin bir parola ile nasıl açıldığını gösterir.
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="Java ile Android'de Aralıkta DOCM'yi JSON'a dönüştürün" %}}
