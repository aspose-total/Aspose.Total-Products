---
title: Java aracılığıyla Andorid'de PPT'u DOCX'a aktarın
description: Herhangi bir yazılım yüklemeden mobil uygulamalarda PPT'u DOCX'ye dönüştürün
url: /tr/android-java/conversion/ppt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Andorid'de PPT'u DOCX'a dönüştürün" h2="Microsoft PowerPoint veya Word'e bağlı kalmadan Android uygulamalarında PPT'u DOCX'ye dönüştürmek için dosya biçimi API'leri" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Java aracılığıyla Android için Aspose.Total](https://products.aspose.com/total/android-java/), Android uygulamalarında dosya biçimlerinin değiştirilmesine olanak tanır. Pakette sağlanan API'leri kullanarak, uygulamalarınızda PowerPoint PPT'tan Word DOCX'ye dönüştürme işlemini otomatikleştirebilirsiniz.
