---
title: Android'de EXCEL'yi WORD'a aktarın
description: Microsoft Word kullanmadan EXCEL'yi WORD'ye dönüştürmek için Android API
url: /tr/android-java/conversion/excel-to-word/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de EXCEL'yi WORD'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda EXCEL'yi WORD'ye dönüştürün" >}}
