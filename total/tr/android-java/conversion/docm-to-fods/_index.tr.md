---
title: DOCM'yi FODS'ye Dönüştürmek için Android API
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla Android'de DOCM'yi FODS'ye dönüştürün
...
{{< blocks/products/pf/feature-page-header h1="Android Uygulamalarında DOCM'yi FODS'ye Dönüştür" h2="DOCM'yi, Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan Java aracılığıyla Android'de FODS'ye aktarın" >}}
