---
title: Android'de XLSB'yi DOC'a aktarın
description: Microsoft Word kullanmadan XLSB'yi DOC'ye dönüştürmek için Android API
url: /tr/android-java/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Java aracılığıyla Android'de XLSB'yi DOC'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel kullanmadan Android Uygulamalarınızda XLSB'yi DOC'ye dönüştürün" >}}
