---
title: DOTX Özelliklerini Çevrimiçi Görüntüleyin ve Güncelleyin veya Android Mobil Uygulamalarını kullanarak meta verileri güncelleyin
description: DOTX özelliklerini çevrimiçi uygulama aracılığıyla ücretsiz olarak görüntüleyin ve değiştirin.DOTX özelliklerini güncellemek için Android API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="DOTX Meta Verilerini Çevrimiçi Görüntüleyin veya Güncelleyin veya Android Uygulamaları aracılığıyla Güncelleyin" h2="Güçlü android tabanlı DOTX belge meta veri yönetimi yardımcı programı uygulaması geliştirin.DOTX dosyası meta verilerini güncellemek için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX Özelliklerini Android Uygulaması ile Güncelleyin" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod: DOTX Meta Verilerini Güncelleyin" offSpacer="" %}}
...
<h2>DOTX Meta Veri Yönetimi Android Uygulamasını Geliştirin</h2>

Bir DOTX Meta Veri yönetimi uygulaması veya yardımcı programı geliştirmeniz mi gerekiyor?[Aspose.Words for Android via Java](https://products.aspose.com/words/tr/android-java/), [Aspose.Total for Android via Java](https://products.aspose.com/total/tr/android-java/)'nin alt API'si olduğundan, herhangi bir android geliştiricisi yukarıdaki API kodunu kendi belge meta veri uygulamasına entegre edebilir.Güçlü Android kitaplığı, herhangi bir belge meta veri çözümünün programlanmasına olanak tanır.Üstelik DOTX formatı da dahil olmak üzere birçok popüler formatı destekleyebilir.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOTX Meta Verilerini Yönetmek için Android Yardımcı Programı" %}}
