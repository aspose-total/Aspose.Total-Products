---
title: JavaScript API'leri aracılığıyla PDF İşleme ve OCR Ekleme
description: PDF belgelerini yönetmek ve web uygulamalarına OCR özelliği eklemek için JavaScript API'si.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF ve OCR için JavaScript API'si" h2="Başka herhangi bir yazılım bağımlılığı olmadan web uygulamalarına OCR ve PDF işleme özellikleri ekleyin" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total for JavaScript via C++, her şeyi kapsayan bir JavaScript kütüphaneleri setidir.Bu kitaplıklar, web tarayıcılarındaki PDF'lerle doğrudan çalışma ve uygulamalarınızı optik karakter tanıma yetenekleriyle geliştirme gibi işlevler sunar.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for JavaScript via C++ aşağıdaki JavaScript kütüphanelerini içerir:" >}}
...
<h2 class="pr-ft">
 ...
 C++ Kitaplıkları aracılığıyla JavaScript'e Genel Bakış
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  PDF'yi Şifrele ve Şifresini Çöz
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Bir tarayıcı veya kameradan alabileceğiniz her türlü görüntüyü destekler
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Genişletilmiş Latin ve Kiril alfabelerini okur
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Görüntüleri tanımadan önce ön işleme tabi tutar
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Görüntünün tamamını veya yalnızca seçilen alanları işler
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Döndürülmüş, çarpık ve gürültülü görüntüleri destekler
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Bir klasör veya arşivdeki tüm görüntülerin toplu olarak tanınması
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Web bağlantıları olarak sağlanan görselleri tanır
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Yanlış yazılan kelimeleri bulur ve otomatik olarak düzeltir
    </p>
   </div>
   <div class="col-lg-4">
