---
title: ODS Şifre Korumasını Çevrimiçi olarak veya .NET kullanarak kaldırın
description: Ücretsiz çevrimiçi uygulama aracılığıyla ODS belgesinden şifreyi kaldırın.Parola korumalı ODS dosyalarının kilidini açmak için .NET C# API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="ODS Belge Parolasının Kilidini Çevrimiçi veya .NET aracılığıyla açın" h2="Güçlü .NET tabanlı ODS belge kilitleme ve kilit açma yardımcı uygulaması geliştirin..NET aracılığıyla ODS dosyasındaki parola kısıtlamalarını kaldırmak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODS Şifresini .NET aracılığıyla kaldırın" %}}

1. Workbook sınıfını kullanarak parola korumalı ODS dosyasını yükleyin
...
{{% blocks/products/pf/agp/code-block title=".NET Kodu : ODS Belgesinden Şifreyi Kaldır" offSpacer="" %}}
...
<h2>.NET aracılığıyla ODS Koruma Yönetimi Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODS Korumasını Yönetmek için .NET Yardımcı Programı" %}}
