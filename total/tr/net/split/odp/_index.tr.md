---
title: ODP Dosyalarını Çevrimiçi veya .NET aracılığıyla Bölün
description: Farklı ODP dosyalarını bölmek için ücretsiz çevrimiçi uygulama. ODP belgeleri için .NET C# Ayırıcı kitaplık kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="ODP Dosyalarını Splitter Uygulaması veya .NET kullanarak Çevrimiçi Bölün" h2="Güçlü .NET tabanlı ODP belge ayırıcı uygulamaları geliştirin.Anında indirme ile ODP dosyaları da dahil olmak üzere belgeleri uygulama aracılığıyla çevrimiçi olarak serbestçe bölün." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP Dosyasını .NET ile Böl" %}}
...
1. Son olarak slaydı yeni ODP dosyasına kaydedin

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Kodu : ODP Dosyalarını Böl" offSpacer="" %}}
...
<h2>.NET kullanarak ODP Dosya Ayırıcı Uygulaması geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET için ODP Ayırıcı kitaplığı" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Evet, bu kodu indirebilirsiniz. .NET kullanarak ODP dosyalarını bölmek için kolayca profesyonel bir çözüm geliştirilebilir..NET'te üst düzey, platformdan bağımsız yazılım geliştirmek için Aspose ODP Splitter API'yi kullanın.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
