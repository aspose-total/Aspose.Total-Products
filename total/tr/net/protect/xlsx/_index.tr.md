---
title: XLSX belgesini çevrimiçi olarak parolayla ve .NET kullanarak koruyun
description: Çevrimiçi XLSX dosyası şifre koruma uygulaması.XLSX elektronik tablolarına parola koruması uygulamak için .NET C# API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi XLSX Belge Koruması veya .NET aracılığıyla Şifre Ayarlama" h2="Güçlü .NET tabanlı XLSX belge koruma yardımcı programı uygulaması geliştirin..NET aracılığıyla XLSX elektronik tablosuna parola uygulamak için listelenen kod." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Uygulama aracılığıyla Çevrimiçi XLSX Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET aracılığıyla XLSX Şifre Koruması" %}}

1. XLSX dosyasını Workbook sınıfı nesnesi aracılığıyla yükleyin
...
{{% blocks/products/pf/agp/code-block title=".NET Kodu : XLSX Belge Şifre Koruması" offSpacer="" %}}
...
<h2>.NET üzerinden XLSX Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Koruma uygulaması için XLSX dosyasını işlemek için .NET yardımcı programı" %}}
