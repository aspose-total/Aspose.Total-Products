---
title: ODP belgesini çevrimiçi olarak parolayla ve .NET kullanarak koruyun
description: Çevrimiçi ODP dosyası şifre koruma uygulaması.ODP sunumlarına parola koruması uygulamak için .NET C# API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi ODP Belge Koruması veya .NET aracılığıyla Şifre Ayarlama" h2="Güçlü .NET tabanlı ODP belge koruma yardımcı programı uygulaması geliştirin..NET aracılığıyla ODP sunumuna parola uygulamak için listelenen kod." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Uygulama aracılığıyla Çevrimiçi ODP Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET aracılığıyla ODP Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Kodu : ODP Sunum Şifre Koruması" offSpacer="" %}}
...
<h2>.NET üzerinden ODP Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Uygulamayı korumak için ODP dosyasını işlemek için .NET yardımcı programı" %}}
