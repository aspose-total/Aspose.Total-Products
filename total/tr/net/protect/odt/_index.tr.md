---
title: ODT belgesini çevrimiçi olarak parolayla ve .NET kullanarak koruyun
description: Çevrimiçi ODT dosyası şifre koruma uygulaması. ODT belgesine parola koruması uygulamak için C# .NET API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi ODT Belge Koruması veya .NET aracılığıyla Şifre Ayarlama" h2="Güçlü .NET tabanlı ODT belge koruma yardımcı programı uygulaması geliştirin..NET aracılığıyla ODT belgesine parola uygulamak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/code-block title=".NET Kodu : ODT Belge Şifre Koruması" offSpacer="" %}}
...
<h2>.NET üzerinden ODT Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Koruma uygulaması için ODT dosyasını işlemek için .NET yardımcı programı" %}}
