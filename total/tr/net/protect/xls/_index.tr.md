---
title: XLS belgesini çevrimiçi olarak parolayla ve .NET kullanarak koruyun
description: Çevrimiçi XLS dosyası şifre koruma uygulaması.XLS elektronik tablolarına parola koruması uygulamak için .NET C# API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi XLS Belge Koruması veya .NET aracılığıyla Şifre Ayarlama" h2="Güçlü .NET tabanlı XLS belge koruma yardımcı programı uygulaması geliştirin..NET aracılığıyla XLS elektronik tablosuna parola uygulamak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET aracılığıyla XLS Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Kodu : XLS Belge Şifre Koruması" offSpacer="" %}}
...
<h2>.NET üzerinden XLS Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Koruma uygulaması için XLS dosyasını işlemek için .NET yardımcı programı" %}}
