...
description: Microsoft Excel veya Adobe Reader kullanmadan DOCM'yi XLSB'ye dönüştürmek için C# API'si
url: /tr/net/conversion/docm-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOCM'yi XLSB'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOCM'yi C# aracılığıyla XLSB'ye aktarın" >}}
