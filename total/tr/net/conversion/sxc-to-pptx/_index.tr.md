---
title: .NET ile SXC'yi PPTX'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında SXC'yi PPTX'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile SXC'yi PPTX'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında SXC'den PPTX'ye">}}
