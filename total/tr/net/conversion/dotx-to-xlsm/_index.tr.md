...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTX'yi XLSM'ye Dönüştürmek için C# API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C# aracılığıyla XLSM'ye aktarın" >}}
