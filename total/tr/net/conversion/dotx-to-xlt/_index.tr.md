...
description: Microsoft Excel veya Adobe Reader kullanmadan DOTX'yi XLT'ye dönüştürmek için C# API'si
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTX'yi XLT'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C# aracılığıyla XLT'ye aktarın" >}}
