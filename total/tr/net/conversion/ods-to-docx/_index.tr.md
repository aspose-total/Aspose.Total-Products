---
title: .NET ile ODS'yi DOCX'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında ODS'yi DOCX'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile ODS'yi DOCX'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında ODS'den DOCX'ye">}}
