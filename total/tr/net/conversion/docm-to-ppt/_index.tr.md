---
title: DOCM'yi C# .NET aracılığıyla PPT'ye dönüştürün 
url: /tr/net/conversion/docm-to-ppt/ 
...
1. DOCM dosyasını [Aspose.Words.Docmument](https://apireference.aspose.com/words/net/aspose.words/docmument) sınıfını kullanarak yükleyin
...
// To convert multi pages DOCMM docmuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to PPT.
