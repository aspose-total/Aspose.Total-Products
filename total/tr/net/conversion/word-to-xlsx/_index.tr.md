...
description: Microsoft Excel veya Adobe Reader kullanmadan WORD'yi XLSX'ye dönüştürmek için C# API'si
url: /tr/net/conversion/word-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="WORD'yi XLSX'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C# aracılığıyla XLSX'ye aktarın" >}}
