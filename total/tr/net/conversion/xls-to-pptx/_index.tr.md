---
title: .NET ile XLS'yi PPTX'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLS'yi PPTX'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile XLS'yi PPTX'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLS'den PPTX'ye">}}
