---
title: .NET ile XLTX'yi DOC'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLTX'yi DOC'ye dönüştürün
url: /tr/net/conversion/xltx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile XLTX'yi DOC'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLTX'den DOC'ye">}}
