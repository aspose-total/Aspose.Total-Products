...
description: Microsoft Excel veya Adobe Reader kullanmadan MOBI'yi XLTM'ye dönüştürmek için C# API'si
url: /tr/net/conversion/mobi-to-xltm/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="MOBI'yi XLTM'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi C# aracılığıyla XLTM'ye aktarın" >}}
...
1. MOBI dosyasını [Document](https://apireference.aspose.com/words/net/aspose.words/mobiument) sınıfını kullanarak açın
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) ayrıca akış yoluyla MOBI belgesini yüklemenizi sağlar. Bir akıştan bir belge açmak için belgeyi içeren bir akış nesnesini [Document](https://apireference.aspose.com/words/net/aspose.words/mobiument) yapıcısına iletmeniz yeterlidir. Aşağıdaki kod örneği, bir akıştan bir belgenin nasıl açılacağını gösterir:  
{{% blocks/products/pf/feature-page-code %}}
