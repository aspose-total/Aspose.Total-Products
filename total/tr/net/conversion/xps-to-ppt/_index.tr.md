...
<iframe title="Ücretsiz Çevrimiçi XPS - PPT Dönüştürme Uygulaması" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppt&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="XPS'yi C# .NET ile PPT'ye dönüştürün" offSpacer="" %}}
