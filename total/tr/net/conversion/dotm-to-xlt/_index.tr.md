...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTM'yi XLT'ye Dönüştürmek için C# API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTM'yi C# aracılığıyla XLT'ye aktarın" >}}
