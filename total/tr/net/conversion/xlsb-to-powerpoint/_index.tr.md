---
title: .NET ile XLSB'yi POWERPOINT'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB'yi POWERPOINT'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile XLSB'yi POWERPOINT'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB'den POWERPOINT'ye">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET'te XLSB'den POWERPOINT'ye Dönüştürme" %}}
1. [Çalışma Kitabı](https://apireference.aspose.com/cells/net/aspose.cells/workbook) sınıfını kullanarak XLSB dosyasını açın
