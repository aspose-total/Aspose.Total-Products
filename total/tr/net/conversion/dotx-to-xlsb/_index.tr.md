...
description: Microsoft Excel veya Adobe Reader kullanmadan DOTX'yi XLSB'ye dönüştürmek için C# API'si
url: /tr/net/conversion/dotx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTX'yi XLSB'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C# aracılığıyla XLSB'ye aktarın" >}}
