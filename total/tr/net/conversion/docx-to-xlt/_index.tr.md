---
title: DOCX'yi XLT'ye Dönüştürmek için .NET API
description: Microsoft Excel veya Adobe Reader kullanmadan DOCX'yi XLT'ye dönüştürmek için C# API'si
url: /tr/net/conversion/docx-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOCX'yi XLT'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOCX'yi C# aracılığıyla XLT'ye aktarın" >}}
