...
<iframe title="Ücretsiz Çevrimiçi PPSX - JSON Dönüştürme Uygulaması" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=json&from=ppsx" id="child-iframe" width="80%"></iframe>
...
1. [Sunum](https://reference.aspose.com/slides/net/aspose.slides/presentation) sınıfını kullanarak PPSX dosyasını açın
