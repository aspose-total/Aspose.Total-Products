...
description: Microsoft Excel veya Adobe Reader kullanmadan OTT'yi CSV'ye dönüştürmek için C# API'si
url: /tr/net/conversion/ott-to-csv/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="OTT'yi CSV'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan OTT'yi C# aracılığıyla CSV'ye aktarın" >}}
