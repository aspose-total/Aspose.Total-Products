---
title: .NET ile XLSB'yi PPTX'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB'yi PPTX'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile XLSB'yi PPTX'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLSB'den PPTX'ye">}}
