---
title: .NET ile XLT'yi DOC'ye dönüştürün 
description: .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLT'yi DOC'ye dönüştürün
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C# ile XLT'yi DOC'ye dönüştürün" h2="Excel'i Dışa Aktar&reg; .NET Framework, .NET Core, Mono veya Xamarin Platformlarında XLT'den DOC'ye">}}
