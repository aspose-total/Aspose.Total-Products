---
title: ODP belgesini çevrimiçi olarak şifreyle ve Java kullanarak koruyun
description: Çevrimiçi ODP dosyası şifre koruma uygulaması.ODP sunumlarına parola koruması uygulamak için Java API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi ODP Belge Koruması veya Java Aracılığıyla Şifre Ayarlama" h2="Güçlü Java tabanlı ODP belge koruma yardımcı programı uygulaması geliştirin.Java aracılığıyla ODP sunumuna parola uygulamak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla ODP Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/code-block title="ODP Sunum Parola Koruması için Java Kodu" offSpacer="" %}}
...
<h2>Java ile ODP Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Uygulamayı korumak için ODP dosyasını işlemek için Java yardımcı programı" %}}
