---
title: ODT belgesini çevrimiçi olarak şifreyle ve Java kullanarak koruyun
description: Çevrimiçi ODT dosyası şifre koruma uygulaması.ODT belgesine parola koruması uygulamak için Java API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi ODT Belge Koruması veya Java Aracılığıyla Şifre Ayarlama" h2="Güçlü Java tabanlı ODT belge koruma yardımcı programı uygulaması geliştirin.Java aracılığıyla ODT belgesine parola uygulamak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla ODT Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/code-block title="ODT Belge Parola Koruması için Java Kodu" offSpacer="" %}}
...
<h2>Java ile ODT Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Koruma uygulaması için ODT dosyasını işlemeye yönelik Java yardımcı programı" %}}
