---
title: ODS belgesini çevrimiçi olarak şifreyle ve Java kullanarak koruyun
description: Çevrimiçi ODS dosyası şifre koruma uygulaması.ODS elektronik tablolarına şifre koruması uygulamak için Java API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="Çevrimiçi ODS Belge Koruması veya Java Aracılığıyla Şifre Ayarlama" h2="Güçlü Java tabanlı ODS belge koruma yardımcı programı uygulaması geliştirin.Java aracılığıyla ODS elektronik tablosuna şifre uygulamak için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla ODS Şifre Koruması" %}}
...
{{% blocks/products/pf/agp/code-block title="ODS Belge Parola Koruması için Java Kodu" offSpacer="" %}}
...
<h2>Java ile ODS Şifre Koruma Uygulamasını Geliştirin</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Koruma uygulaması için ODS dosyasını işlemeye yönelik Java yardımcı programı" %}}
