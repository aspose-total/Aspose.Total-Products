...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSX'u XLAM'ye dönüştürün veya Çevrimiçi Uygulama" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPSX'u XLAM'ye aktarmak için Şirket İçi Java API'si" >}}
...
<iframe title="ppsx'dan xlam'ye Çevrimiçi Dönüştürme Aracı" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xlam&from=ppsx" id="child-iframe" width="80%"></iframe>
