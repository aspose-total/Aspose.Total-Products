...
API ayrıca parola korumalı ODT belgelerini PPTM'ye dönüştürmenize olanak tanır. Girdiğiniz ODT belgeniz parola korumalıysa, parolayı kullanmadan PPTM biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Odtument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
