---
title: Java ile ODT'yi PPTM'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan ODT'yi PPTM'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile ODT'yi PPTM'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak ODT'den PPTM'ye dönüştürme" >}}
