...
description: Microsoft Excel veya PowerPoint kullanmadan POTM'u Java aracılığıyla ODS formatına dönüştürün
url: /tr/java/conversion/potm-to-ods/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POTM'u ODS'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan POTM'u ODS'ye aktarmak için Şirket İçi Java API'si" >}}
