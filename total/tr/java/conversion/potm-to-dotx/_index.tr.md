---
title: Java ile POTM'u DOTX'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan POTM'u DOTX'a Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POTM'u DOTX'ye dönüştürün" h2="Herhangi bir Java J2SE, J2EE, J2ME uygulamasında PowerPoint POTM'tan DOTX'ye dönüştürme için Şirket İçi Java API'si" >}}
...
4. Belgeyi [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) yöntemini kullanarak DOTX biçiminde kaydedin
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/potm-to-dotxm/" name="POTM İle DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/potm-to-dotxx/" name="POTM İle DOTXX" description="" >}}
