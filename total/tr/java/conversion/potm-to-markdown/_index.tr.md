...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POTM'u MARKDOWN'ye dönüştürün veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan POTM'u MARKDOWN'ye aktarmak için Şirket İçi Java API'si" >}}
