...
description: Microsoft Excel veya PowerPoint kullanmadan POTM'u Java aracılığıyla MARKDOWN formatına dönüştürün veya çevrimiçi. Kodu entegre etmeden önce ücretsiz POT'den CSV'e çevrimiçi dönüştürücüyü hızlı bir şekilde test edin. veya ücretsiz Çevrimiçi Dönüştürücü ile
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POTM'u MARKDOWN'ye dönüştürün veya Çevrimiçi Uygulama" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan POTM'u MARKDOWN'ye aktarmak için Şirket İçi Java API'si" >}}
