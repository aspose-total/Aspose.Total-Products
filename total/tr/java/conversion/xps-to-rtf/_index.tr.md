...
<iframe title="Ücretsiz Çevrimiçi XPS - RTF Dönüştürme Uygulaması" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="XPS'den RTF'ye Dönüşüm için Java Kodu" offSpacer="" %}}
