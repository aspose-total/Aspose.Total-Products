---
title: Java ile DOCX'yi POT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOCX'yi POT'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOCX'yi POT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOCX'den POT'ye dönüştürme" >}}
