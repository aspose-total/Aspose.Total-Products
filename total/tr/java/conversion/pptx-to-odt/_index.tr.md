---
title: Java ile PPTX'u ODT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan PPTX'u ODT'a Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPTX'u ODT'ye dönüştürün" h2="Herhangi bir Java J2SE, J2EE, J2ME uygulamasında PowerPoint PPTX'tan ODT'ye dönüştürme için Şirket İçi Java API'si" >}}
...
4. Belgeyi [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) yöntemini kullanarak ODT biçiminde kaydedin
