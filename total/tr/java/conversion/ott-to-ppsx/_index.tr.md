---
title: Java ile OTT'yi PPSX'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan OTT'yi PPSX'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile OTT'yi PPSX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak OTT'den PPSX'ye dönüştürme" >}}
...
1. OTT dosyasını [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) sınıfını kullanarak açın
2. [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions) kullanarak OTT dosyasını HTML'ye dönüştürün)) yöntem
