...
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla MOBI'yi XLS'ye dönüştürün
url: /tr/java/conversion/mobi-to-xls/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile MOBI'yi XLS'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi XLS'ye dönüştürmek için Şirket İçi Java API'si" >}}
