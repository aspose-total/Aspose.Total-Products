...
description: Microsoft Excel veya PowerPoint kullanmadan PPTX'u Java aracılığıyla MARKDOWN formatına dönüştürün
url: /tr/java/conversion/pptx-to-markdown/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPTX'u MARKDOWN'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPTX'u MARKDOWN'ye aktarmak için Şirket İçi Java API'si" >}}
