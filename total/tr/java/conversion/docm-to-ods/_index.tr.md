...
{{% blocks/products/pf/agp/feature-section-col title="DOCM'yi ODS'ye Dönüştürmek için Java API" %}}
...
<iframe title="docm'dan ods'ye Çevrimiçi Dönüştürme Aracı" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=docm" id="child-iframe" width="80%"></iframe>
