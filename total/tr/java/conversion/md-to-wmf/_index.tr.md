---
title: Java aracılığıyla MD'yi WMF'ye dönüştürün
description: Herhangi bir üçüncü taraf uygulaması kullanmadan MD dosyasını Java uygulamalarınızda WMF'ye aktarın
url_ignore: /tr/java/conversion/md-to-wmf/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java aracılığıyla MD'yi WMF'ye dönüştürün" h2="MD dosyasını Adobe<sup>&reg;</sup> Acrobat Reader kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasından WMF'ye aktarın" >}}
{{% blocks/products/pf/feature-page-summary %}}
Java'da md dosyasını WMF görüntüsüne iki basit adımda dönüştürebilirsiniz. İlk olarak, [Aspose.PDF for Java](https://products.aspose.com/pdf/java/) kullanarak MD'yi JPEG'e aktarabilirsiniz. Bundan sonra, [Aspose.Imaging for Java](https://products.aspose.com/imaging/java/) Görüntü İşleme API'sini kullanarak JPEG'i WMF'ye dönüştürebilirsiniz. Her iki API de [Aspose.Total for Java](https://products.aspose.com/total/java/) paketi kapsamında gelir.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="MD'yi Java aracılığıyla WMF'ye aktarın" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Java ile MD'yi WMF Dosyasına Dönüştür ve Döndür" %}}
...
Markdown (MD) dosyalarını WMF (Windows Metafile) formatına dönüştürmek, eski Windows uygulamalarıyla uyumlu vektör tabanlı grafikler üretir. WMF dosyaları, çizgi tabanlı hassasiyeti korur ve diyagramlar, grafikler ve şemalar için uygundur.
...
* Markdown akış şemalarını eski Windows uygulamaları için dışa aktarma.

* Teknik tabloları ölçeklenebilir WMF diyagramlarına dönüştürme.

* WMF'yi destekleyen eski ofis yazılımlarına diyagramlar gömme.

* Markdown içeriğinden çizgi tabanlı görselleri koruma.
...
* Arşiv veya uyumluluk amaçları için otomatik WMF oluşturma.

* Eski sistemler için Markdown tabanlı görsellerin toplu dönüşümü.

* Belgelendirme portalları için diyagramların zamanlanmış güncellemeleri.

* Kurumsal raporlar için WMF grafikleri üreten iş akışlarıyla entegrasyon.
