---
title: Java kullanarak FODS'yi POWERPOINT'ye dönüştürün
description: Excel veya Word kullanarak FODS'yi POWERPOINT'a Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="FODS'yi POWERPOINT'a Dışa Aktarmak için Java API" h2="Microsoft Excel&reg;" >}}
...
1. [Çalışma Kitabı](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) sınıfını kullanarak FODS dosyasını açın
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/fods-to-powerpointx/" name="FODS İle POWERPOINTX" description="" >}}
