---
title: Java ile DOC'yi PPTX'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOC'yi PPTX'ye Dışa Aktarmak için Java API
url: /tr/java/conversion/doc-to-pptx/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOC'yi PPTX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOC'den PPTX'ye dönüştürme" >}}
