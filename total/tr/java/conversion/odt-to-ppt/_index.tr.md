---
title: Java ile ODT'yi PPT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan ODT'yi PPT'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile ODT'yi PPT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak ODT'den PPT'ye dönüştürme" >}}
...
API ayrıca parola korumalı ODT belgelerini PPT'ye dönüştürmenize olanak tanır. Girdiğiniz ODT belgeniz parola korumalıysa, parolayı kullanmadan PPT biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Odtument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
