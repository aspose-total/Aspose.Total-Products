...
description: Microsoft Excel veya PowerPoint kullanmadan PPSM'u Java aracılığıyla XLT formatına dönüştürün
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSM'u XLT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPSM'u XLT'ye aktarmak için Şirket İçi Java API'si" >}}
