---
title: Java ile OTT'yi POT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan OTT'yi POT'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile OTT'yi POT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak OTT'den POT'ye dönüştürme" >}}
