---
title: Java ile PPSX'u OTT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan PPSX'u OTT'a Aktarmak için Java API
url: /tr/java/conversion/ppsx-to-ott/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSX'u OTT'ye dönüştürün" h2="Herhangi bir Java J2SE, J2EE, J2ME uygulamasında PowerPoint PPSX'tan OTT'ye dönüştürme için Şirket İçi Java API'si" >}}
...
API'yi kullanarak, filigranlı PPSX dosyasını OTT'ye dönüştürme işlemini de gerçekleştirebilirsiniz. OTT belgenize filigran eklemek için öncelikle PPSX dosyasını HTML'ye çevirebilir ve ona bir filigran ekleyebilirsiniz. Filigran eklemek için, yeni oluşturulan HTML dosyasını [Document](https://apireference.aspose.com/words/java/com.aspose.words/Ottument) sınıfını kullanarak yükleyin, bir TextWatermarkOptions örneği oluşturun ve ayarlayın özellikleri, Watermark.setText yöntemini çağırın ve filigran metnini ve TextWatermarkOptions nesnesini iletin.  
{{% blocks/products/pf/feature-page-code %}}
