...
description: Microsoft Excel veya PowerPoint kullanmadan PPSX'u Java aracılığıyla XLSB formatına dönüştürün
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSX'u XLSB'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPSX'u XLSB'ye aktarmak için Şirket İçi Java API'si" >}}
