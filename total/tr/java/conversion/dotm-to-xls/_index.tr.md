...
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla DOTM'yi XLS'ye dönüştürün
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOTM'yi XLS'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTM'yi XLS'ye dönüştürmek için Şirket İçi Java API'si" >}}
