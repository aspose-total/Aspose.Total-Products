...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOC'yi XLTM'ye dönüştürün veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi XLTM'ye dönüştürmek için Şirket İçi Java API'si" >}}
