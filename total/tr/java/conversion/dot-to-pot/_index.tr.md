...
API ayrıca parola korumalı DOT belgelerini POT'ye dönüştürmenize olanak tanır. Girdiğiniz DOT belgeniz parola korumalıysa, parolayı kullanmadan POT biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Dotument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
