---
title: Java ile PPSM'u TEXT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan PPSM'u TEXT'a Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSM'u TEXT'ye dönüştürün" h2="Herhangi bir Java J2SE, J2EE, J2ME uygulamasında PowerPoint PPSM'tan TEXT'ye dönüştürme için Şirket İçi Java API'si" >}}
...
2. [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides) kullanarak PPSM'u HTML'ye dönüştürün. ISaveOptions-) yöntemi ve Html'yi SaveFormat olarak ayarlayın
3. Dönüştürülen HTML dosyasını [Textument](https://apireference.aspose.com/words/java/com.aspose.words/Textument) sınıfını kullanarak yükleyin
4. Belgeyi [save](https://apireference.aspose.com/words/java/com.aspose.words/Textument#save(java.lang.String,int)) yöntemini kullanarak TEXT biçiminde kaydedin
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/ppsm-to-textm/" name="PPSM İle TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/ppsm-to-textx/" name="PPSM İle TEXTX" description="" >}}
