---
title: Java ile WORD'yi PPT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan WORD'yi PPT'ye Dışa Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile WORD'yi PPT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak WORD'den PPT'ye dönüştürme" >}}
...
API ayrıca parola korumalı WORD belgelerini PPT'ye dönüştürmenize olanak tanır. Girdiğiniz WORD belgeniz parola korumalıysa, parolayı kullanmadan PPT biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Wordument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
