---
title: Java kullanarak XLTM'yi DOCX'ye dönüştürün
description: Excel veya Word kullanarak XLTM'yi DOCX'a Dışa Aktarmak için Java API
url: /tr/java/conversion/xltm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTM'yi DOCX'a Dışa Aktarmak için Java API" h2="Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/xltm-to-docxx/" name="XLTM İle DOCXX" description="" >}}
