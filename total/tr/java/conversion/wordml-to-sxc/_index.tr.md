...
description: Microsoft Word veya Microsoft Excel kullanmadan Java aracılığıyla WORDML'yi SXC'ye dönüştürün veya çevrimiçi. Kodu entegre etmeden önce ücretsiz POT'den CSV'e çevrimiçi dönüştürücüyü hızlı bir şekilde test edin. veya ücretsiz Çevrimiçi Dönüştürücü ile
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile WORDML'yi SXC'ye dönüştürün veya Çevrimiçi Uygulama" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi SXC'ye dönüştürmek için Şirket İçi Java API'si" >}}
