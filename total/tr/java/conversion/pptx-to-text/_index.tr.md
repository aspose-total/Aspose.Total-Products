---
title: Java ile PPTX'u TEXT'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan PPTX'u TEXT'a Aktarmak için Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPTX'u TEXT'ye dönüştürün" h2="Herhangi bir Java J2SE, J2EE, J2ME uygulamasında PowerPoint PPTX'tan TEXT'ye dönüştürme için Şirket İçi Java API'si" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/pptx-to-textm/" name="PPTX İle TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/net/conversion/pptx-to-textx/" name="PPTX İle TEXTX" description="" >}}
