---
title: Java ile DOT'yi POTX'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOT'yi POTX'ye Dışa Aktarmak için Java API
url: /tr/java/conversion/dot-to-potx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOT'yi POTX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOT'den POTX'ye dönüştürme" >}}
