---
title: POT'u Java ile DIF Formatına Dönüştür veya ücretsiz Çevrimiçi Dönüştürücü ile
description: Microsoft Excel veya PowerPoint kullanmadan POT'u Java aracılığıyla DIF formatına dönüştürün veya çevrimiçi. Kodu entegre etmeden önce ücretsiz POT'den DIF'e çevrimiçi dönüştürücüyü hızlı bir şekilde test edin. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POT'u DIF'ye dönüştürün veya Çevrimiçi Uygulama" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan POT'u DIF'ye aktarmak için Şirket İçi Java API'si" >}}
