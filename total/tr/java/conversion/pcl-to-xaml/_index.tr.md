---
title: Çevrimiçi PCL'yi XAML'ye Dönüştürme veya PCL Dosyalarını Dönüştürmek için Java tabanlı Uygulama Geliştirme
description: PCL dosyalarını XAML dosyalarına dönüştürmek için ücretsiz çevrimiçi uygulama. PCL belgeleri için Java dönüştürme kitaplığı kodu. 
...
{{% blocks/products/pf/agp/feature-section-col title="PCL'yi Java Otomasyon API'si aracılığıyla XAML'ye dönüştürün" %}}
...
{{% blocks/products/pf/agp/code-block title="PCL'den XAML'ye Dönüşüm için Java Kodu" offSpacer="" %}}
...
PCL dosyasını XAML dosyasına Dönüşüm Gereksinimleri, Java ile Şifreli PCL Dosyasını Açın gibi diğer özelliklerle kaydetmek için birkaç örnek daha.
