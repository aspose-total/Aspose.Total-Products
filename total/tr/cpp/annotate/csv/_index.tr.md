---
title: CSV Annotation Online'ı kaldırın veya C++ ile Ek Açıklamaları Yönetin
description: CSV dosyasındaki yorumları çevrimiçi uygulama aracılığıyla ücretsiz olarak silin. CSV dosyalarının yorumlarını yönetmek için C++ API kodu.
...
{{< blocks/products/pf/feature-page-header-widget h1="CSV Document Online'dan Yorumları Temizle veya C++ ile Yönetin" h2="Güçlü C++ tabanlı CSV belge açıklama yardımcı programı uygulaması geliştirin. CSV dosyasının yorumlarını C++ aracılığıyla yönetmek için listelenen kod." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="CSV Yorumlarını C++ ile kaldırın" %}}

1. C++ projesine kitaplık referansı ekleme
1. CreateIWorkbook'u kullanarak CSV dosyasını yükleyin
1. Dizinini kullanarak ilgili Çalışma Sayfasını seçin
1. Yorum eklemek için GetIComments()->Add komutunu kullanın
1. Yorumu almak için GetIComments()->GetObjectByIndex'i kullanın
1. Yorum notları eklemek için SetNote yöntemini kullanın
...
{{% blocks/products/pf/agp/code-block title="C++ Kodu: CSV Dosya Açıklaması" offSpacer="" %}}
...
<h2>C++ ile CSV Belge Açıklama Uygulamasını Geliştirin</h2>

Geri bildirimde bulunmak, önerilerde bulunmak veya belge üzerinde başkalarıyla işbirliği yapmak için bir CSV açıklama uygulaması veya yardımcı programı geliştirmeniz mi gerekiyor?[Aspose.Cells for C++](https://products.aspose.com/cells/cpp/), [Aspose.Total for C++](https://products.aspose.com/total/tr/cpp/)'nin alt API'si olduğundan, herhangi bir C++ geliştiricisi yukarıdaki API kodunu kendi belge açıklama uygulamasına entegre edebilir.Güçlü C++ kitaplığı, herhangi bir belge açıklama çözümünün programlanmasına olanak tanır. Üstelik CSV formatı da dahil olmak üzere birçok popüler formatı destekleyebilir.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="CSV Dosyalarına Açıklama Eklemek için C++ Kitaplığı" %}}
...
- Install a [NuGet Paketi](https://www.nuget.org/packages/Aspose.Cells.Cpp/). See [Dokümantasyon](https://docs.aspose.com/cells/cpp/installation/)
