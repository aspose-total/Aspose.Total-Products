---
title: DOC'yi C++'da XLSX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOC'yi XLSX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOC'yi XLSX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi C++ aracılığıyla XLSX'ye aktarın" >}}
