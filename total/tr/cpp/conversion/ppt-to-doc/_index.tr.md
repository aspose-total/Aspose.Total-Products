---
title: PPT'u DOC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPT'u DOC'a aktarın
url: /tr/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPT'u DOC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPT'u DOC'a aktarın" >}}
