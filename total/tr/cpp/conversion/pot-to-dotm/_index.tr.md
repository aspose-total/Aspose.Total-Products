---
title: POT'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POT'u DOTM'a aktarın
url: /tr/cpp/conversion/pot-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POT'u DOTM'a aktarın" >}}
