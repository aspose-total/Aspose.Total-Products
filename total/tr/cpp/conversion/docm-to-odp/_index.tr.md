---
title: DOCM'yi C++ ile ODP'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda DOCM'yi ODP'ye aktarın
url: /tr/cpp/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCM'yi ODP'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde DOCM'yi ODP'ye aktarın veya PowerPoint" >}}
