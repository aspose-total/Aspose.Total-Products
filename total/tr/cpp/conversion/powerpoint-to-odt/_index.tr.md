---
title: POWERPOINT'u ODT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u ODT'a aktarın
url: /tr/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u ODT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u ODT'a aktarın" >}}
