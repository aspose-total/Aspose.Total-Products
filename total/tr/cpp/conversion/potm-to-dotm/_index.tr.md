---
title: POTM'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTM'u DOTM'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="POTM'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTM'u DOTM'a aktarın" >}}
