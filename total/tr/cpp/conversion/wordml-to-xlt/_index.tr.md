---
title: WORDML'yi C++'da XLT'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORDML'yi XLT'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/wordml-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi XLT'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi C++ aracılığıyla XLT'ye aktarın" >}}
