---
title: RTF'yi C++'da XLTX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan RTF'yi XLTX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/rtf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF'yi XLTX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan RTF'yi C++ aracılığıyla XLTX'ye aktarın" >}}
...
1. [Belge](https://reference.aspose.com/words/cpp/class/aspose.words.rtfument) sınıf referansını kullanarak RTF dosyasını açın
