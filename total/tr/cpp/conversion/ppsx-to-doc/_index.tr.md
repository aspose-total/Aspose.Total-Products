---
title: PPSX'u DOC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u DOC'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u DOC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u DOC'a aktarın" >}}
