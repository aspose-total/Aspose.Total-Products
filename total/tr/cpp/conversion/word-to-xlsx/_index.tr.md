---
title: WORD'yi C++'da XLSX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORD'yi XLSX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/word-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi XLSX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C++ aracılığıyla XLSX'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="WORD'yi XLSX'ye Dönüştürmek için C++ API" %}}
