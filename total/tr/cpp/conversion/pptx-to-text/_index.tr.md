---
title: PPTX'u TEXT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u TEXT'a aktarın
url: /tr/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u TEXT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u TEXT'a aktarın" >}}
