---
title: PPTX'u RTF'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u RTF'a aktarın
url: /tr/cpp/conversion/pptx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u RTF'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u RTF'a aktarın" >}}
