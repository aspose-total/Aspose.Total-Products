---
title: WORD'yi C++'da XLSB'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORD'yi XLSB'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi XLSB'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C++ aracılığıyla XLSB'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="WORD'yi XLSB'ye Dönüştürmek için C++ API" %}}
