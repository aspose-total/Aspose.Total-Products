...
{{< blocks/products/pf/feature-page-header h1="WORD'yi XLSB'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C++ aracılığıyla XLSB'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="WORD'yi XLSB'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
