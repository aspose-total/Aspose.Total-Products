---
title: POTM'u FLATOPC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTM'u FLATOPC'a aktarın
url: /tr/cpp/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTM'u FLATOPC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTM'u FLATOPC'a aktarın" >}}
