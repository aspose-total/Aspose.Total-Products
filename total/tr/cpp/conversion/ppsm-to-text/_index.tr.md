---
title: PPSM'u TEXT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u TEXT'a aktarın
url: /tr/cpp/conversion/ppsm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u TEXT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u TEXT'a aktarın" >}}
...
3. Dönüştürülen HTML dosyasını [Belge](https://reference.aspose.com/words/cpp/class/aspose.words.textument) sınıf referansını kullanarak yükleyin
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/cpp/conversion/ppsm-to-textx/" name="PPSM İle TEXTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/cpp/conversion/ppsm-to-textm/" name="PPSM İle TEXTM" description="" >}}
