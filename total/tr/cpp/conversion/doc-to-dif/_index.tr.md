...
{{< blocks/products/pf/feature-page-header h1="DOC'yi DIF'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi C++ aracılığıyla DIF'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOC'yi DIF'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
