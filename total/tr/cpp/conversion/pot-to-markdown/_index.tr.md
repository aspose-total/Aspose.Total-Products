...
description: Microsoft Excel veya Powerpoint kullanmadan POT'u C++'da MARKDOWN'ye aktarın
url: /tr/cpp/conversion/pot-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u C++ ile MARKDOWN'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan C++ aracılığıyla POT'tan MARKDOWN Dosyasına Dönüştürme" >}}
