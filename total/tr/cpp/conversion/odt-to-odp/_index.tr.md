---
title: ODT'yi C++ ile ODP'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda ODT'yi ODP'ye aktarın
url: /tr/cpp/conversion/odt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT'yi ODP'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde ODT'yi ODP'ye aktarın veya PowerPoint" >}}
