---
title: POTX'u DOCM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTX'u DOCM'a aktarın
url: /tr/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTX'u DOCM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTX'u DOCM'a aktarın" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/tr/cpp/conversion/potx-to-docmx/" name="POTX İle DOCMX" description="" >}}
