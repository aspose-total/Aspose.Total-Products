---
title: WORDML'yi C++'da XLS'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORDML'yi XLS'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi XLS'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi C++ aracılığıyla XLS'ye aktarın" >}}
