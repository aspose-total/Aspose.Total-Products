---
title: PPSX'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u DOT'a aktarın
url: /tr/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u DOT'a aktarın" >}}
