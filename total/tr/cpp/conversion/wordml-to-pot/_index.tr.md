---
title: WORDML'yi C++ ile POT'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi POT'ye aktarın
url: /tr/cpp/conversion/wordml-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi POT'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi POT'ye aktarın veya PowerPoint" >}}
