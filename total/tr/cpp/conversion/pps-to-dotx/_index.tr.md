---
title: PPS'u DOTX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u DOTX'a aktarın
url: /tr/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u DOTX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u DOTX'a aktarın" >}}
