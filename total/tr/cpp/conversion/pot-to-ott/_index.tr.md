---
title: POT'u OTT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POT'u OTT'a aktarın
url: /tr/cpp/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u OTT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POT'u OTT'a aktarın" >}}
