---
title: PPSX'u RTF'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u RTF'a aktarın
url: /tr/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u RTF'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u RTF'a aktarın" >}}
