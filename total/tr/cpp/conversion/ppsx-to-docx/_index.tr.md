---
title: PPSX'u DOCX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u DOCX'a aktarın
url: /tr/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u DOCX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u DOCX'a aktarın" >}}
...
3. Dönüştürülen HTML dosyasını [Belge](https://reference.aspose.com/words/cpp/class/aspose.words.docxument) sınıf referansını kullanarak yükleyin
