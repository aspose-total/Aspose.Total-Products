...
{{< blocks/products/pf/feature-page-header h1="DOTX'yi XLAM'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C++ aracılığıyla XLAM'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX'yi XLAM'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
