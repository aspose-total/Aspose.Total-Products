---
title: POWERPOINT'u OTT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u OTT'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u OTT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u OTT'a aktarın" >}}
