---
title: PPSX'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u DOTM'a aktarın
url: /tr/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u DOTM'a aktarın" >}}
