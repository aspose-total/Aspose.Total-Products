---
title: PPS'u FLATOPC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u FLATOPC'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPS'u FLATOPC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u FLATOPC'a aktarın" >}}
