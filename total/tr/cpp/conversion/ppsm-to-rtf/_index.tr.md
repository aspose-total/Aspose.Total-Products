---
title: PPSM'u RTF'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u RTF'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u RTF'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u RTF'a aktarın" >}}
