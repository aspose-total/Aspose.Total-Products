---
title: DOTM'yi C++ ile PPTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda DOTM'yi PPTX'ye aktarın
url: /tr/cpp/conversion/dotm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTM'yi PPTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde DOTM'yi PPTX'ye aktarın veya PowerPoint" >}}
