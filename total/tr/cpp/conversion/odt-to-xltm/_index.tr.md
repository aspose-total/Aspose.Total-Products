---
title: ODT'yi C++'da XLTM'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan ODT'yi XLTM'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/odt-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT'yi XLTM'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan ODT'yi C++ aracılığıyla XLTM'ye aktarın" >}}
