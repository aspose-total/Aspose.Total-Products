---
title: POWERPOINT'u WORDML'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u WORDML'a aktarın
url: /tr/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u WORDML'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u WORDML'a aktarın" >}}
