---
title: OFT'i C++ aracılığıyla DOCX'ye aktarın
description: Microsoft Word veya Outlook kullanmadan OFT'i DOCX'ye Dönüştürmek için C++ API
url: /tr/cpp/conversion/oft-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="OFT'i DOCX'ye Dışa Aktarmak için C++ API" h2="Microsoft Word veya Outlook gerektirmeden OFT'i C++ uygulaması içinde DOCX'ye dönüştürün" >}}

{{% blocks/products/pf/feature-page-summary %}}
Uygulamalarınıza e-posta dönüştürme özellikleri eklemek isteyen bir C++ geliştiricisi misiniz? [Aspose.Oft for C++](https://products.aspose.com/oft/cpp/) kullanarak OFT dosya biçimini HTML'ye dönüştürebilirsiniz. Bundan sonra, [Aspose.Words for C++](https://products.aspose.com/words/cpp/) API'sini kullanarak HTML'yi DOCX'ye aktarabilirsiniz. Her iki API de [Aspose.Total for C++](https://products.aspose.com/total/cpp/) paketi kapsamında gelir. 
{{% /blocks/products/pf/feature-page-summary  %}}
