---
title: PPSM'u DOC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u DOC'a aktarın
url: /tr/cpp/conversion/ppsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u DOC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u DOC'a aktarın" >}}
