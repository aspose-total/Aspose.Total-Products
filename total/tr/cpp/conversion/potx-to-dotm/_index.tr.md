---
title: POTX'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTX'u DOTM'a aktarın
url: /tr/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTX'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTX'u DOTM'a aktarın" >}}
