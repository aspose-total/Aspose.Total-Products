---
title: PPSX'u WORDML'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u WORDML'a aktarın
url: /tr/cpp/conversion/ppsx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u WORDML'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u WORDML'a aktarın" >}}
