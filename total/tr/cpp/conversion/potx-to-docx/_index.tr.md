---
title: POTX'u DOCX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTX'u DOCX'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="POTX'u DOCX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTX'u DOCX'a aktarın" >}}
