---
title: DOC'yi C++'da ODS'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOC'yi ODS'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/doc-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOC'yi ODS'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi C++ aracılığıyla ODS'ye aktarın" >}}
