---
title: DOCX'yi C++ ile PPTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda DOCX'yi PPTX'ye aktarın
url: /tr/cpp/conversion/docx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="DOCX'yi PPTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde DOCX'yi PPTX'ye aktarın veya PowerPoint" >}}
