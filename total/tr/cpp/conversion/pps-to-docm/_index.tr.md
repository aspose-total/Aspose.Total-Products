---
title: PPS'u DOCM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u DOCM'a aktarın
url: /tr/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u DOCM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u DOCM'a aktarın" >}}
