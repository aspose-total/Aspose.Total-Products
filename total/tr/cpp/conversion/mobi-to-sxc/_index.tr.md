---
title: MOBI'yi C++'da SXC'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan MOBI'yi SXC'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/mobi-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="MOBI'yi SXC'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi C++ aracılığıyla SXC'ye aktarın" >}}
