...
{{< blocks/products/pf/feature-page-header h1="RTF'yi XLS'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan RTF'yi C++ aracılığıyla XLS'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="RTF'yi XLS'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
