---
title: WORDML'yi C++'da XLTX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORDML'yi XLTX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/wordml-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi XLTX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi C++ aracılığıyla XLTX'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="WORDML'yi XLTX'ye Dönüştürmek için C++ API" %}}
