---
title: PPSM'u WORDML'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u WORDML'a aktarın
url: /tr/cpp/conversion/ppsm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u WORDML'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u WORDML'a aktarın" >}}
