---
title: POTX'u FLATOPC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTX'u FLATOPC'a aktarın
url: /tr/cpp/conversion/potx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTX'u FLATOPC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTX'u FLATOPC'a aktarın" >}}
