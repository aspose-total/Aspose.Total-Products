---
title: PPSX'u DOTX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u DOTX'a aktarın
url: /tr/cpp/conversion/ppsx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u DOTX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u DOTX'a aktarın" >}}
