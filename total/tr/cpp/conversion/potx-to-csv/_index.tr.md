...
description: Microsoft Excel veya Powerpoint kullanmadan POTX'u C++'da CSV'ye aktarın
url: /tr/cpp/conversion/potx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTX'u C++ ile CSV'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan C++ aracılığıyla POTX'tan CSV Dosyasına Dönüştürme" >}}
