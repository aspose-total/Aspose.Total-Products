---
title: PPTX'u DOTX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u DOTX'a aktarın
url: /tr/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u DOTX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u DOTX'a aktarın" >}}
