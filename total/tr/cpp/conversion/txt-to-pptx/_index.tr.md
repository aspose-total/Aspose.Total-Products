---
title: TXT'yi C++ ile PPTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda TXT'yi PPTX'ye aktarın
url: /tr/cpp/conversion/txt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXT'yi PPTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde TXT'yi PPTX'ye aktarın veya PowerPoint" >}}
