---
title: MOBI'yi C++'da CSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan MOBI'yi CSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/mobi-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="MOBI'yi CSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi C++ aracılığıyla CSV'ye aktarın" >}}
