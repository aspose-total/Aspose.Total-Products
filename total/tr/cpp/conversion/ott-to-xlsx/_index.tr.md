---
title: OTT'yi C++'da XLSX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan OTT'yi XLSX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/ott-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTT'yi XLSX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan OTT'yi C++ aracılığıyla XLSX'ye aktarın" >}}
