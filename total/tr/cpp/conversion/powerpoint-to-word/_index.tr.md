---
title: POWERPOINT'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u WORD'a aktarın
url: /tr/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u WORD'a aktarın" >}}
