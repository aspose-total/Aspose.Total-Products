---
title: PPT'u DOTX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPT'u DOTX'a aktarın
url: /tr/cpp/conversion/ppt-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPT'u DOTX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPT'u DOTX'a aktarın" >}}
