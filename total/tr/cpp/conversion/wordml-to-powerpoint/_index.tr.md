---
title: WORDML'yi C++ ile POWERPOINT'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi POWERPOINT'ye aktarın
url: /tr/cpp/conversion/wordml-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi POWERPOINT'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi POWERPOINT'ye aktarın veya PowerPoint" >}}
