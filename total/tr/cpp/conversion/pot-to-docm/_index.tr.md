---
title: POT'u DOCM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POT'u DOCM'a aktarın
url: /tr/cpp/conversion/pot-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u DOCM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POT'u DOCM'a aktarın" >}}
