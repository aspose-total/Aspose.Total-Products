---
title: POWERPOINT'u DOC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u DOC'a aktarın
url: /tr/cpp/conversion/powerpoint-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u DOC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u DOC'a aktarın" >}}
