---
title: PPSX'u ODT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u ODT'a aktarın
url: /tr/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u ODT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u ODT'a aktarın" >}}
