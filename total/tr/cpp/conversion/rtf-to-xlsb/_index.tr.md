---
title: RTF'yi C++'da XLSB'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan RTF'yi XLSB'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF'yi XLSB'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan RTF'yi C++ aracılığıyla XLSB'ye aktarın" >}}
