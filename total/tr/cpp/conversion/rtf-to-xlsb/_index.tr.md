...
{{< blocks/products/pf/feature-page-header h1="RTF'yi XLSB'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan RTF'yi C++ aracılığıyla XLSB'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="RTF'yi XLSB'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
