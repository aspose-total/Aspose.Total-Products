---
title: PPS'u OTT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u OTT'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPS'u OTT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u OTT'a aktarın" >}}
