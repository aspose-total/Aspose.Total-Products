---
title: RTF'yi C++'da CSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan RTF'yi CSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/rtf-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF'yi CSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan RTF'yi C++ aracılığıyla CSV'ye aktarın" >}}
