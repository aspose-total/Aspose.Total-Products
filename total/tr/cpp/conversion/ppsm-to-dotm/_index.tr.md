---
title: PPSM'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u DOTM'a aktarın
url: /tr/cpp/conversion/ppsm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u DOTM'a aktarın" >}}
