---
title: PPSM'u ODT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u ODT'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u ODT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u ODT'a aktarın" >}}
