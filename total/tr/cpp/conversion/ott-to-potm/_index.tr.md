---
title: OTT'yi C++ ile POTM'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda OTT'yi POTM'ye aktarın
url: /tr/cpp/conversion/ott-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTT'yi POTM'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde OTT'yi POTM'ye aktarın veya PowerPoint" >}}
