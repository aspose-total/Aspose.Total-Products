---
title: POT'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POT'u WORD'a aktarın
url: /tr/cpp/conversion/pot-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POT'u WORD'a aktarın" >}}
