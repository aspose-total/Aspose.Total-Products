---
title: WORDML'yi C++ ile PPTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi PPTX'ye aktarın
url: /tr/cpp/conversion/wordml-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi PPTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi PPTX'ye aktarın veya PowerPoint" >}}
