---
title: DOT'yi C++'da XLT'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOT'yi XLT'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/dot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="DOT'yi XLT'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOT'yi C++ aracılığıyla XLT'ye aktarın" >}}
