...
{{< blocks/products/pf/feature-page-header h1="DOT'yi XLT'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOT'yi C++ aracılığıyla XLT'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOT'yi XLT'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
