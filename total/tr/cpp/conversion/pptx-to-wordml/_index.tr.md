---
title: PPTX'u WORDML'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u WORDML'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u WORDML'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u WORDML'a aktarın" >}}
