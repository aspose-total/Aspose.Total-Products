---
title: WORD'yi C++'da SXC'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORD'yi SXC'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/word-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi SXC'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C++ aracılığıyla SXC'ye aktarın" >}}
