---
title: OTT'yi C++'da ODS'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan OTT'yi ODS'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/ott-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTT'yi ODS'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan OTT'yi C++ aracılığıyla ODS'ye aktarın" >}}
