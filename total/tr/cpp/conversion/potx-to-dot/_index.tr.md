---
title: POTX'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTX'u DOT'a aktarın
url: /tr/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTX'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTX'u DOT'a aktarın" >}}
