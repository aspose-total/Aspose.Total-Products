---
title: ODT'yi C++'da XLTX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan ODT'yi XLTX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/odt-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT'yi XLTX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan ODT'yi C++ aracılığıyla XLTX'ye aktarın" >}}
