---
title: POWERPOINT'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u DOT'a aktarın
url: /tr/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u DOT'a aktarın" >}}
