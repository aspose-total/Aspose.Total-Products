---
title: PPSM'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u DOT'a aktarın
url: /tr/cpp/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u DOT'a aktarın" >}}
