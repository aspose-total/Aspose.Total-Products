---
title: ODT'yi C++ ile POTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda ODT'yi POTX'ye aktarın
url: /tr/cpp/conversion/odt-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT'yi POTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde ODT'yi POTX'ye aktarın veya PowerPoint" >}}
