---
title: DOT'yi C++'da TSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOT'yi TSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/dot-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="DOT'yi TSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOT'yi C++ aracılığıyla TSV'ye aktarın" >}}
