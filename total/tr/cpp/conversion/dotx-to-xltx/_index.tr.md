---
title: DOTX'yi C++'da XLTX'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOTX'yi XLTX'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/dotx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTX'yi XLTX'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C++ aracılığıyla XLTX'ye aktarın" >}}
