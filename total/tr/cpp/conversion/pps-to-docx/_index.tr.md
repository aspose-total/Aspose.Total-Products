---
title: PPS'u DOCX'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u DOCX'a aktarın
url: /tr/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u DOCX'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u DOCX'a aktarın" >}}
