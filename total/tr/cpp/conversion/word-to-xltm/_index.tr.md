---
title: WORD'yi C++'da XLTM'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORD'yi XLTM'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="WORD'yi XLTM'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORD'yi C++ aracılığıyla XLTM'ye aktarın" >}}
