---
title: OTT'yi C++'da XLS'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan OTT'yi XLS'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/ott-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTT'yi XLS'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan OTT'yi C++ aracılığıyla XLS'ye aktarın" >}}
