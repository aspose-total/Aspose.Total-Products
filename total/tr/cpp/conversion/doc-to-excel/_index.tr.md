---
title: DOC'yi C++'da EXCEL'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOC'yi EXCEL'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/doc-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOC'yi EXCEL'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi C++ aracılığıyla EXCEL'ye aktarın" >}}
