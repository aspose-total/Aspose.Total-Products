---
title: DOTM'yi C++ ile PPS'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda DOTM'yi PPS'ye aktarın
url: /tr/cpp/conversion/dotm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTM'yi PPS'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde DOTM'yi PPS'ye aktarın veya PowerPoint" >}}
