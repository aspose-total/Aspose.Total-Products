---
title: PPS'u TEXT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u TEXT'a aktarın
url: /tr/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u TEXT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u TEXT'a aktarın" >}}
