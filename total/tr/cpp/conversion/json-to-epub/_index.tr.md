---
title: JSON Formatını C++ ile EPUB'ye Dönüştür
description: C++ API t0 Microsoft Word kullanmadan JSON'u EPUB'ye ayrıştırma
url: /tr/cpp/conversion/json-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{< blocks/products/pf/feature-page-header h1="JSON Formatını C++ ile EPUB'ye Dönüştür" h2="Microsoft<sup>&reg;</sup> Word kullanmadan JSON'u C++ uygulamaları içinde EPUB'ye ayrıştırın" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total for C++](https://products.aspose.com/total/cpp/) kullanarak, iki basit adımda C++ uygulamalarınızda JSON'u EPUB'ye ayrıştırabilirsiniz. İlk olarak, [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) kullanarak JSON'u PDF'ye aktarabilirsiniz. Bundan sonra, [Aspose.Words for C++](https://products.aspose.com/words/cppp/) kullanarak PDF'yi EPUB'ye dönüştürebilirsiniz. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="JSON Formatını C++'da EPUB'ye Dönüştür" %}}
...
4. [Kaydet](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) yöntemini kullanarak dokümanı EPUB formatına kaydedin
...
{{% blocks/products/pf/feature-page-section  h2="C++'da Filigran ile JSON Formatını EPUB'ye Dönüştürme" %}}
API'yi kullanarak JSON'u EPUB'ye filigranla ayrıştırabilirsiniz. EPUB belgenize filigran eklemek için önce JSON'u PDF'ye dönüştürebilir ve ona bir filigran ekleyebilirsiniz. Filigran eklemek için yeni oluşturulan PDF dosyasını [Document](https://reference.aspose.com/words/cpp/class/aspose.words.document) sınıfını kullanarak yükleyin, metin filigranı için farklı özellikler ayarlayın,
SetText yöntemini çağırın ve filigran metnini ve TextWatermarkOptions nesnesini iletin. Filigranı ekledikten sonra belgeyi EPUB'ye kaydedebilirsiniz.
{{% blocks/products/pf/feature-page-code %}}
