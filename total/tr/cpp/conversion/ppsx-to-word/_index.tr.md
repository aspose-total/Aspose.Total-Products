---
title: PPSX'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSX'u WORD'a aktarın
url: /tr/cpp/conversion/ppsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSX'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSX'u WORD'a aktarın" >}}
