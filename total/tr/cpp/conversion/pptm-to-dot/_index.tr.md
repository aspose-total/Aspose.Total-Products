---
title: PPTM'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTM'u DOT'a aktarın
url: /tr/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="PPTM'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTM'u DOT'a aktarın" >}}
