---
title: PPTX'u OTT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u OTT'a aktarın
url: /tr/cpp/conversion/pptx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u OTT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u OTT'a aktarın" >}}
