---
title: ODT'yi C++'da CSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan ODT'yi CSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/odt-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODT'yi CSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan ODT'yi C++ aracılığıyla CSV'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODT'yi CSV'ye Dönüştürmek için C++ API" %}}
