---
title: WORDML'yi C++'da SXC'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORDML'yi SXC'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/wordml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi SXC'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi C++ aracılığıyla SXC'ye aktarın" >}}
