---
title: PPTX'u DOCM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u DOCM'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u DOCM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u DOCM'a aktarın" >}}
