---
title: DOT'yi C++'da DIF'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOT'yi DIF'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/dot-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="DOT'yi DIF'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOT'yi C++ aracılığıyla DIF'ye aktarın" >}}
