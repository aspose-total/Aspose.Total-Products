---
title: POTM'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POTM'u DOT'a aktarın
url: /tr/cpp/conversion/potm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTM'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POTM'u DOT'a aktarın" >}}
