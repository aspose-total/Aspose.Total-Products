---
title: RTF'yi C++ ile PPSX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda RTF'yi PPSX'ye aktarın
url: /tr/cpp/conversion/rtf-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF'yi PPSX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde RTF'yi PPSX'ye aktarın veya PowerPoint" >}}
