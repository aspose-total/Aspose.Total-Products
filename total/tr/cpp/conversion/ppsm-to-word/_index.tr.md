---
title: PPSM'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPSM'u WORD'a aktarın
url: /tr/cpp/conversion/ppsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSM'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPSM'u WORD'a aktarın" >}}
