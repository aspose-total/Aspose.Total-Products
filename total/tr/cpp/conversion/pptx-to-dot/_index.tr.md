---
title: PPTX'u DOT'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTX'u DOT'a aktarın
url: /tr/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTX'u DOT'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTX'u DOT'a aktarın" >}}
