---
title: MOBI'yi C++'da TSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan MOBI'yi TSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/mobi-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="MOBI'yi TSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi C++ aracılığıyla TSV'ye aktarın" >}}
