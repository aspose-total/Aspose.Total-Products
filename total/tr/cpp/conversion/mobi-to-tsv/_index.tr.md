...
{{< blocks/products/pf/feature-page-header h1="MOBI'yi TSV'ye Dönüştürmek için C++ API veya çevrimiçi" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan MOBI'yi C++ aracılığıyla TSV'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="MOBI'yi TSV'ye Dönüştürmek için C++ API veya çevrimiçi" %}}
