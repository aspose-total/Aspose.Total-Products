---
title: DOCM'yi C++ ile POTX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda DOCM'yi POTX'ye aktarın
url: /tr/cpp/conversion/docm-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCM'yi POTX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde DOCM'yi POTX'ye aktarın veya PowerPoint" >}}
