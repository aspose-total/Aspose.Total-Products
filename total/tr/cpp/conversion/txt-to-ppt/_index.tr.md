---
title: TXT'yi C++ ile PPT'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda TXT'yi PPT'ye aktarın
url: /tr/cpp/conversion/txt-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXT'yi PPT'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde TXT'yi PPT'ye aktarın veya PowerPoint" >}}
