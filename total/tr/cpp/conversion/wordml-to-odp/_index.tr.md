---
title: WORDML'yi C++ ile ODP'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi ODP'ye aktarın
url: /tr/cpp/conversion/wordml-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi ODP'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi ODP'ye aktarın veya PowerPoint" >}}
