---
title: DOC'yi C++'da XLS'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOC'yi XLS'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/doc-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOC'yi XLS'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOC'yi C++ aracılığıyla XLS'ye aktarın" >}}
