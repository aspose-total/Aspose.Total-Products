---
title: PPS'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u WORD'a aktarın
url: /tr/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u WORD'a aktarın" >}}
