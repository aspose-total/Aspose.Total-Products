---
title: RTF'yi C++ ile PPS'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda RTF'yi PPS'ye aktarın
url: /tr/cpp/conversion/rtf-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTF'yi PPS'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde RTF'yi PPS'ye aktarın veya PowerPoint" >}}
