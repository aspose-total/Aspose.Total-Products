---
title: POWERPOINT'u RTF'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u RTF'a aktarın
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u RTF'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u RTF'a aktarın" >}}
