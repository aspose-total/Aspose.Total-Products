---
title: PPS'u WORDML'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPS'u WORDML'a aktarın
url: /tr/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPS'u WORDML'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPS'u WORDML'a aktarın" >}}
