---
title: DOTX'yi C++'da CSV'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan DOTX'yi CSV'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTX'yi CSV'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan DOTX'yi C++ aracılığıyla CSV'ye aktarın" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX'yi CSV'ye Dönüştürmek için C++ API" %}}
