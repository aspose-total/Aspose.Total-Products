---
title: POWERPOINT'u DOTM'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POWERPOINT'u DOTM'a aktarın
url: /tr/cpp/conversion/powerpoint-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINT'u DOTM'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POWERPOINT'u DOTM'a aktarın" >}}
