---
title: WORDML'yi C++'da EXCEL'ye dönüştürün
description: Microsoft Word veya Microsoft Excel kullanmadan WORDML'yi EXCEL'ye dönüştürmek için C++ API
url: /tr/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi EXCEL'ye Dönüştürmek için C++ API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan WORDML'yi C++ aracılığıyla EXCEL'ye aktarın" >}}
