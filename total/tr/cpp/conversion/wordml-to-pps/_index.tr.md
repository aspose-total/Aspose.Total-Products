---
title: WORDML'yi C++ ile PPS'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi PPS'ye aktarın
url: /tr/cpp/conversion/wordml-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi PPS'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi PPS'ye aktarın veya PowerPoint" >}}
