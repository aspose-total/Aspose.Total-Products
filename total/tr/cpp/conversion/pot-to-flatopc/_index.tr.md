---
title: POT'u FLATOPC'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda POT'u FLATOPC'a aktarın
url: /tr/cpp/conversion/pot-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POT'u FLATOPC'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında POT'u FLATOPC'a aktarın" >}}
