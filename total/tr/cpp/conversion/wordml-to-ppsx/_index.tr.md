---
title: WORDML'yi C++ ile PPSX'ye dönüştürün
description: Microsoft Word of PowerPoint kullanmadan C++ uygulamalarınızda WORDML'yi PPSX'ye aktarın
url: /tr/cpp/conversion/wordml-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDML'yi PPSX'ye Dönüştürmek için C++ API" h2="Microsoft Word&reg; kullanmadan C++ uygulamalarınız içinde WORDML'yi PPSX'ye aktarın veya PowerPoint" >}}
