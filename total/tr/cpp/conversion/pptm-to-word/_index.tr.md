---
title: PPTM'u WORD'a Dönüştürmek için C++ API
description: C++ uygulamalarınızda PPTM'u WORD'a aktarın
url: /tr/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="PPTM'u WORD'ye Dönüştürmek için C++ API" h2="Microsoft PowerPoint veya Word bağımlılığı olmadan C++ uygulamalarında PPTM'u WORD'a aktarın" >}}
