---
title: Node.js API के माध्यम से PDF हेरफेर और OCR परिवर्धन
description: Node.js एपीआई पीडीएफ फाइलों में हेरफेर करने के साथ-साथ अनुप्रयोगों के माध्यम से छवियों से पाठ निकालने के लिए।
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="पीडीएफ और छवि पाठ निष्कर्षण के लिए Node.js एपीआई" h2="छवियों से टेक्स्ट निकालें और साथ ही बिना किसी अन्य सॉफ़्टवेयर निर्भरता के Node.js अनुप्रयोगों के भीतर पीडीएफ हेरफेर सुविधाओं को शामिल करें" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
C++ के माध्यम से Node.js के लिए Aspose.Total, Node.js पुस्तकालयों का एक सर्व-समावेशी सेट है।ये लाइब्रेरी सीधे पीडीएफ के साथ काम करने और छवियों को टेक्स्ट में बदलने के लिए आपके एप्लिकेशन को बढ़ाने जैसी कार्यक्षमताएं प्रदान करती हैं।

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="C++ के माध्यम से Node.js के लिए Aspose.Total में निम्नलिखित Node.js लाइब्रेरी शामिल हैं:" >}}
...
C++ के माध्यम से Node.js के लिए Aspose.PDF आपको बैकएंड पर PDF फ़ाइलों को संभालने का अधिकार देता है। इसका उपयोग करके, आप पीडीएफ को अनुकूलित कर सकते हैं, टेक्स्ट और छवियों को शामिल और निकाल सकते हैं, साथ ही एन्क्रिप्शन और डिक्रिप्शन प्रक्रियाओं को लागू कर सकते हैं। इसके अलावा, कार्यक्षमता पीडीएफ दस्तावेजों को आसानी से विभाजित और मर्ज करने की क्षमता तक फैली हुई है, जो सुव्यवस्थित पीडीएफ फाइल हेरफेर के लिए एक व्यापक टूलकिट प्रदान करती है।
...
C++ के माध्यम से Node.js के लिए Aspose.OCR, Node.js-संगत प्लेटफ़ॉर्म पर स्कैन किए गए पृष्ठों और फ़ोटो जैसी छवियों से पाठ निष्कर्षण को सक्षम बनाता है।लोकप्रिय प्रारूपों में चीनी और हिंदी सहित 28 भाषाओं का समर्थन करते हुए, शक्तिशाली ऑप्टिकल कैरेक्टर पहचान कार्यक्षमता के साथ ऑन-प्रिमाइसेस उत्पादों, वेब सेवाओं और सर्वर रहित अनुप्रयोगों को बढ़ाएं।
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 C++ लाइब्रेरीज़ के माध्यम से Node.js का अवलोकन
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total अन्य प्लेटफार्मों के लिए व्यक्तिगत समाधान प्रदान करता है।" >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/hi/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/hi/nodejs-java/" 
