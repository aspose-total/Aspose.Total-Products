---
title: जावा के माध्यम से TXT को POTM में बदलें
...
{{< blocks/products/pf/i18n/feature-page-header h1="जावा के माध्यम से TXT को POTM में बदलें" h2="Microsoft<sup>&reg;</sup> PowerPoint या Word का उपयोग किए बिना किसी भी Java J2SE, J2EE, J2ME अनुप्रयोगों में ऑन-प्रिमाइसेस Java API का उपयोग करके TXT से POTM रूपांतरण" >}}
...
1. [Document](https://apireference.aspose.com/words/java/com.aspose.words/Txtument) वर्ग का उपयोग करके TXT फ़ाइल खोलें
2. [save](https://apireference.aspose.com/words/java/com.aspose.words/Txtument#save(java.lang.String,com.aspose.words.SaveOptions) का उपयोग करके TXT फ़ाइल को HTML में बदलें)) तरीका
