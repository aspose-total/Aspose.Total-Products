...
description: Microsoft Word या PowerPoint का उपयोग किए बिना FLATOPC को POTX निर्यात करने के लिए Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="जावा के माध्यम से पीओटी को डीओसी में कनवर्ट करें" h2="किसी भी जावा J2SE, J2EE, J2ME अनुप्रयोगों के भीतर PowerPoint POTX से FLATOPC रूपांतरण के लिए परिसर जावा एपीआई पर" >}}
...
1. [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) वर्ग का उपयोग करके POTX फ़ाइल खोलें
...
3. परिवर्तित HTML फ़ाइल को [Document](https://apireference.aspose.com/words/java/com.aspose.words/Flatopcument) वर्ग का उपयोग करके लोड करें
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potx-to-flatopcm/" name="POTX सेवा FLATOPCM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potx-to-flatopcx/" name="POTX सेवा FLATOPCX" description="" >}}
