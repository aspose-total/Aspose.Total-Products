...
url_ignore: /hi/java/conversion/rtf-to-dif/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="जावा के माध्यम से RTF को DIF में बदलें या ऑनलाइन ऐप" h2="Microsoft<sup>&reg;</sup> Word या Microsoft<sup>&reg;</sup> Excel का उपयोग किए बिना RTF को DIF में कनवर्ट करने के लिए Premise Java API पर" >}}
