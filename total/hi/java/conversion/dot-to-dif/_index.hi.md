...
{{< blocks/products/pf/i18n/feature-page-header h1="जावा के माध्यम से DOT को DIF में बदलें" h2="Microsoft<sup>&reg;</sup> Word या Microsoft<sup>&reg;</sup> Excel का उपयोग किए बिना DOT को DIF में कनवर्ट करने के लिए Premise Java API पर" >}}
