...
url_ignore: /hi/java/conversion/odt-to-tsv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="जावा के माध्यम से ODT को TSV में बदलें या ऑनलाइन ऐप" h2="Microsoft<sup>&reg;</sup> Word या Microsoft<sup>&reg;</sup> Excel का उपयोग किए बिना ODT को TSV में कनवर्ट करने के लिए Premise Java API पर" >}}
