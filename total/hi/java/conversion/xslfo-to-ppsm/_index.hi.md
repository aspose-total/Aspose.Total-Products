...
4. [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) विधि का उपयोग करके दस्तावेज़ को PPSM प्रारूप में सहेजें और ` PPSM` SaveFormat के रूप में
