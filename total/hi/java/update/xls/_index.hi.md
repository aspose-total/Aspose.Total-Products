...
description: Microsoft Excel का उपयोग किए बिना Java अनुप्रयोगों में XLS दस्तावेज़ को संशोधित करें। जावा में एक्सेल फ़ाइल को लिखने और संपादित करने के सबसे तेज़ तरीके के लिए कोड ऑप्टिमाइज़ करें।
url: /hi/java/update/xls/
family: total
platformtag: Java
feature: update
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="जावा के माध्यम से बीएमपी फ़ाइल अपडेट करें" h2="Microsoft Office<sup>&reg;</sup> स्थापित किए बिना अपने जावा आधारित अनुप्रयोगों के माध्यम से XLS स्प्रेडशीट को संशोधित करें।" >}}
...
- स्रोत XLS फ़ाइल को पैरामीटर के रूप में रखते हुए नई [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook) क्लास ऑब्जेक्ट बनाएं
...
- फ़ाइल को पैरामीटर के रूप में पथ के साथ पास करके सेव () विधि का उपयोग करके फ़ाइल को .xls फ़ाइल के रूप में सहेजें
