---
title: पायथन का उपयोग करके XLSB फ़ाइल ऑनलाइन देखें और XLSB दस्तावेज़ पढ़ें
description: मुफ़्त ऑनलाइन XLSB फ़ाइल व्यूअर ऐप। व्यूअर एप्लिकेशन के लिए XLSB फ़ाइल को पढ़ने के लिए पायथन एपीआई कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="XLSB फ़ाइल को स्वतंत्र रूप से ऑनलाइन देखें और Python के माध्यम से XLSB पढ़ें" h2="शक्तिशाली पायथन आधारित XLSB दस्तावेज़ व्यूअर उपयोगिता एप्लिकेशन विकसित करें।पायथन के माध्यम से XLSB दस्तावेज़ को लोड करने या पढ़ने के लिए सूचीबद्ध कोड।" >}}
...
1. वर्कबुक क्लास ऑब्जेक्ट बनाएं और इसका उपयोग करके स्रोत XLSB फ़ाइल लोड करें।
...
1. और XLSB फ़ाइल देखने के लिए ब्राउज़र को प्रारंभ करने के लिए सबप्रोसेस.रन का उपयोग करें।
...
{{% blocks/products/pf/agp/code-block title="XLSB फ़ाइलें देखने के लिए पायथन में कोड उदाहरण" offSpacer="" %}}
...
<h2>पायथन के माध्यम से XLSB फ़ाइल व्यूअर एप्लिकेशन विकसित करें</h2>

क्या आपको XLSB व्यूअर ऐप या उपयोगिता विकसित करने की आवश्यकता है?[Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/) के [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) के चाइल्ड एपीआई के साथ, कोई भी पायथन डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ व्यूअर एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली पायथन लाइब्रेरी किसी भी दस्तावेज़ प्रदर्शन समाधान को प्रोग्रामिंग करने की अनुमति देती है जो बीएमपी1 प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकती है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="डिस्प्ले ऐप के लिए XLSB फ़ाइल को संसाधित करने के लिए पायथन उपयोगिता" %}}
