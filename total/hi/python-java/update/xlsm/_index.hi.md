...
description: Microsoft Excel का उपयोग किए बिना Python अनुप्रयोगों में XLSM दस्तावेज़ को संशोधित करें। 
...
{{< blocks/products/pf/feature-page-header h1="पायथन के माध्यम से बीएमपी फ़ाइल अपडेट करें" h2="Microsoft Office<sup>&reg;</sup> को स्थापित किए बिना अपने Python अनुप्रयोगों के माध्यम से XLSM स्प्रैडशीट्स को संशोधित करें।" >}}
...
- स्रोत XLSM फ़ाइल को पैरामीटर के रूप में रखते हुए नई [Workbook](https://reference.aspose.com/cells/python-java/asposecells.api/Workbook) क्लास ऑब्जेक्ट बनाएं
...
- इसके अलावा, [डाउनलोड](https://releases.aspose.com/cells/python-java) सेक्शन से API पैकेज डाउनलोड करें
