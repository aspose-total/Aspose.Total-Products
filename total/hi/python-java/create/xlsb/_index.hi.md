...
description: Microsoft Office का उपयोग किए बिना Python अनुप्रयोगों का उपयोग करके XLSB फ़ाइल बनाएँ। 
url: /hi/python-java/create/xlsb/
family: total
platformtag: Python
feature: create
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="पायथन का उपयोग करके बीएमपी बनाएं" h2="Microsoft Office<sup>&reg;</sup> को स्थापित किए बिना अपने Python अनुप्रयोगों के माध्यम से XLSB जेनरेट करें।" >}}
...
- फ़ाइल को पैरामीटर के रूप में पथ के साथ पास करके [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) का उपयोग करके दस्तावेज़ को .xlsb फ़ाइल के रूप में सहेजें
