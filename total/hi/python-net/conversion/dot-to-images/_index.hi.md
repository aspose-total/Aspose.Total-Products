---
title: DOT को Python में इमेज में बदलें
...
url: /hi/python-net/conversion/dot-to-images/
family: total
platformtag: Python
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="पायथन का उपयोग करके DOT को छवियों में बदलें" h2="Microsoft Word<sup>&reg;</sup> इंस्टॉल किए बिना आपके पायथन एप्लिकेशन में DOT से JPG, TIFF, BMP, PNG और GIF छवि रूपांतरण।" >}}
...
{{% blocks/products/pf/agp/code-block title="पायथन में छवियों के लिए DOT सहेजें - सरल रूपांतरण" offSpacer="" %}}

{{< gist "aspose-com-gists" "fe7c3ff0a8c783e4f0ed6bff199c6800" "convert-documents-to-images-simple-in-python.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="विशिष्ट विकल्पों के साथ छवि रूपांतरण के लिए DOT" offSpacer="" %}}
