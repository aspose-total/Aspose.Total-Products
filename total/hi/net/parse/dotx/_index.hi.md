---
title: DOTX फ़ाइल से टेक्स्ट और छवियाँ ऑनलाइन निकालें और .NET का उपयोग करें
description: ऑनलाइन DOTX फ़ाइल पार्सर ऐप। DOTX दस्तावेज़ से चित्र और पाठ सामग्री निकालने के लिए .NET API C# कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="DOTX फ़ाइल को ऑनलाइन और साथ ही .NET के माध्यम से पार्स करें" h2="शक्तिशाली .NET आधारित DOTX दस्तावेज़ पार्सर उपयोगिता एप्लिकेशन विकसित करें। DOTX दस्तावेज़ पाठ निष्कर्षण के लिए C# कोड सूचीबद्ध।" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET के माध्यम से DOTX फ़ाइल को पार्स करें" %}}

1. .NET प्रोजेक्ट में लाइब्रेरी संदर्भ जोड़ें
1. दस्तावेज़ वर्ग ऑब्जेक्ट का उपयोग करके DOTX फ़ाइल लोड करें
1. GetChildNodes() का उपयोग करके सभी चाइल्ड नोड्स प्राप्त करें
1. पैरामीटर के रूप में NodeType.Shape का उपयोग करें
1. प्रत्येक नोड के माध्यम से पुनरावृति करें और छवि को सहेजें
1. पाठ निकालने के लिए, प्रत्येक पृष्ठ पर लूप करें
1. एक्स्ट्रैक्टपेज विधि को कॉल करें
1. Node.ToString विधि का उपयोग करके निकाली गई फ़ाइल को टेक्स्ट में सहेजें
...
{{% blocks/products/pf/agp/code-block title="सी# कोड: बीएमपी1 दस्तावेज़ छवियाँ निष्कर्षण" offSpacer="" %}}

{{< gist "aspose-com-gists" "56e34ac75fba2313ae00be996cc53d39" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="सी# कोड: बीएमपी1 दस्तावेज़ टेक्स्ट निष्कर्षण" offSpacer="" %}}
...
<h2>.NET के माध्यम से DOTX फ़ाइल पार्सर एप्लिकेशन विकसित करें</h2>

DOTX पार्सर एप्लिकेशन या सॉफ़्टवेयर विकसित करने की आवश्यकता है?[Aspose.Words for .NET](https://products.aspose.com/words/hi/net/), [Aspose.Total for .NET](https://products.aspose.com/total/hi/net/) के चाइल्ड एपीआई के साथ, कोई भी .NET डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ पार्सर एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली .NET लाइब्रेरी छवियों के साथ-साथ पाठ को निकालने के लिए किसी भी दस्तावेज़ पार्सिंग समाधान को प्रोग्रामिंग करने की अनुमति देती है।इसके अलावा यह DOTX प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकता है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="पार्सर एप्लिकेशन के लिए DOTX फ़ाइल को संसाधित करने के लिए .NET उपयोगिता" %}}
