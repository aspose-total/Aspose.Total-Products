...
{{% blocks/products/pf/agp/feature-section-col title="PPSX को C# के माध्यम से DOC में बदलने के चरण" %}}
...
1. दस्तावेज़ को [मेमोरीस्ट्रीम](https://docs.microsoft.com/en-us/dotnet/api/system.io.memorystream?view=net-5.0) ऑब्जेक्ट में सेव करें
...
1. [Aspose.Words.Document.Save("output.doc", SaveFormat.Doc)](https://apireference.aspose.com/words/net/aspose.words.document/save/methods) का उपयोग करके दस्तावेज़ को सहेजें / 3)
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="PPSX को DOC में बदलने के लिए फ्री ऐप" sectionDescription="" >}}
