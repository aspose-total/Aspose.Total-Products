---
title: C# .NET . के माध्यम से POTM को WORDML में बदलें 
url: /hi/net/conversion/potm-to-wordml/ 
...
1. [Aspose.Words.Wordmlument](https://apireference.aspose.com/words/net/aspose.words/wordmlument) बनाएं और इसे मेमोरीस्ट्रीम ऑब्जेक्ट के साथ प्रारंभ करें
1. [Aspose.Words.Wordmlument.Save("output.wordml", SaveFormat.Wordml)](https://apireference.aspose.com/words/net/aspose.words.wordmlument/save/methods) का उपयोग करके दस्तावेज़ को सहेजें / 3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potm-to-wordmlx" name="POTM प्रति WORDMLX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potm-to-wordmlm" name="POTM प्रति WORDMLM" description="" >}}
