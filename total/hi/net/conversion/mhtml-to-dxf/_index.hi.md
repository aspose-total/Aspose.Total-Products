---
title: C# API के माध्यम से MHTML को DXF में बदलें
description: किसी भी तृतीय पक्ष एप्लिकेशन का उपयोग किए बिना अपने .NET अनुप्रयोगों में MHTML को DXF में निर्यात करें
url_ignore: /hi/net/conversion/mhtml-to-dxf/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="सी # के माध्यम से सीजीएम फ़ाइल को एपीएनजी में कनवर्ट करें" h2="Adobe<sup>&reg;</sup> Acrobat Reader या किसी अन्य तृतीय पक्ष एप्लिकेशन का उपयोग किए बिना .NET अनुप्रयोगों के भीतर DXF को MHTML निर्यात करें" >}}
