...
{{< blocks/products/pf/i18n/feature-page-header h1="सी # एपीआई सीएसवी को सीजीएम प्रस्तुत करने के लिए" h2="Microsoft<sup>&reg;</sup> Excel या Adobe<sup>&reg;</sup> Acrobat Reader का उपयोग किए बिना C# के माध्यम से CGM फ़ाइल को CSV में निर्यात करें" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total for .NET](https://products.aspose.com/total/net/) का उपयोग करके आप किसी भी .NET, C#, ASP.NET और VB.NET अनुप्रयोगों में आसानी से CGM फ़ाइल को CSV में कनवर्ट कर सकते हैं। सबसे पहले, [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) का उपयोग करके, आप CGM को XLSX में निर्यात कर सकते हैं। उसके बाद, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) स्प्रेडशीट प्रोग्रामिंग API का उपयोग करके, आप XLSX को CSV में बदल सकते हैं।
{{% /blocks/products/pf/feature-page-summary  %}}
