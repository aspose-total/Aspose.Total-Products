---
title: C# API के माध्यम से PDF को WMZ में बदलें
description: किसी भी तृतीय पक्ष एप्लिकेशन का उपयोग किए बिना अपने .NET अनुप्रयोगों में PDF को WMZ में निर्यात करें
url_ignore: /hi/net/conversion/pdf-to-wmz/
family: total
platformtag: net
feature: conversion
informat: PDF
