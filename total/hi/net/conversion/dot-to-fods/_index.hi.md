---
title: DOT को FODS में बदलने के लिए .NET API
...
{{< blocks/products/pf/i18n/feature-page-header h1="सी # एपीआई डीओसी को सीएसवी में कनवर्ट करने के लिए" h2="Microsoft<sup>&reg;</sup> Word या Microsoft<sup>&reg;</sup> Excel का उपयोग किए बिना DOT को C# के माध्यम से FODS में निर्यात करें" >}}
...
1. [Document](https://apireference.aspose.com/words/net/aspose.words/Document) वर्ग का उपयोग करके DOT फ़ाइल खोलें
2. [Save](https://apireference.aspose.com/words/net/aspose.words.Document/save/methods/4) विधि का उपयोग करके DOT को HTML में बदलें
