...
1. [Document](https://apireference.aspose.com/words/net/aspose.words/Document) वर्ग का उपयोग करके RTF फ़ाइल खोलें
2. [Save](https://apireference.aspose.com/words/net/aspose.words.Document/save/methods/4) विधि का उपयोग करके RTF को HTML में बदलें
