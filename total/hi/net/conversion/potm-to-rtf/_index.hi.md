---
title: C# .NET . के माध्यम से POTM को RTF में बदलें 
url: /hi/net/conversion/potm-to-rtf/ 
...
1. [Aspose.Words.Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument) बनाएं और इसे मेमोरीस्ट्रीम ऑब्जेक्ट के साथ प्रारंभ करें
1. [Aspose.Words.Rtfument.Save("output.rtf", SaveFormat.Rtf)](https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods) का उपयोग करके दस्तावेज़ को सहेजें / 3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potm-to-rtfx" name="POTM प्रति RTFX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/net/conversion/potm-to-rtfm" name="POTM प्रति RTFM" description="" >}}
