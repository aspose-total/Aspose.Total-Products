...
4. [सेव](https://reference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4) विधि का उपयोग करके दस्तावेज़ को IMAGE प्रारूप में सहेजें
...
और इसे [Save](https://reference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4) मेथड का इस्तेमाल करके IMAGE फॉर्मेट में सेव करें।  
{{% blocks/products/pf/feature-page-code %}}
