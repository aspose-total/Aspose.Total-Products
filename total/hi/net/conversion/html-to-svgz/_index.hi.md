---
title: C# API के माध्यम से HTML को SVGZ में बदलें
description: किसी भी तृतीय पक्ष एप्लिकेशन का उपयोग किए बिना अपने .NET अनुप्रयोगों में HTML को SVGZ में निर्यात करें
url_ignore: /hi/net/conversion/html-to-svgz/
family: total
platformtag: net
feature: conversion
informat: HTML
