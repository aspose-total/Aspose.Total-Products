---
title: DOCM फ़ाइल ऑनलाइन देखें और .NET का उपयोग करें
description: मुफ़्त ऑनलाइन DOCM फ़ाइल व्यूअर ऐप। व्यूअर एप्लिकेशन के लिए DOCM फ़ाइल देखने के लिए .NET API C# कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="DOCM फ़ाइल को ऑनलाइन या .NET के माध्यम से स्वतंत्र रूप से देखें" h2="शक्तिशाली .NET आधारित DOCM दस्तावेज़ व्यूअर उपयोगिता एप्लिकेशन विकसित करें। DOCM दस्तावेज़ देखने के लिए C# कोड सूचीबद्ध है।" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ऑनलाइन ऐप के माध्यम से DOCM दस्तावेज़ देखें" %}}

1. इसे अपलोड करके देखने के लिए DOCM फ़ाइल आयात करें।
...
1. एकाधिक पृष्ठों वाले DOCM दस्तावेज़ के मामले में पृष्ठों के बीच नेविगेट करें।
1. पृष्ठ दृश्य को ज़ूम-इन या ज़ूम-आउट सेट करें।

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title=".NET के माध्यम से DOCM फ़ाइल देखें" %}}

1. प्रोजेक्ट में .NET लाइब्रेरी संदर्भ जोड़ें
1. दस्तावेज़ वर्ग ऑब्जेक्ट का उपयोग करके स्रोत DOCM फ़ाइल लोड करें
...
<h2>.NET के माध्यम से DOCM फ़ाइल व्यूअर एप्लिकेशन विकसित करें</h2>

क्या आपको DOCM व्यूअर ऐप या उपयोगिता विकसित करने की आवश्यकता है?[Aspose.Words for .NET](https://products.aspose.com/words/hi/net/), [Aspose.Total for .NET](https://products.aspose.com/total/hi/net/) के चाइल्ड एपीआई के साथ, कोई भी .NET डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ व्यूअर एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली .NET लाइब्रेरी किसी भी दस्तावेज़ प्रदर्शन समाधान को प्रोग्रामिंग करने की अनुमति देती है जो DOCM प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकती है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="डिस्प्ले ऐप के लिए DOCM फ़ाइल को संसाधित करने के लिए .NET उपयोगिता" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>क्या DOCM दस्तावेज़ देखने के लिए ऑनलाइन ऐप का उपयोग करना सुरक्षित है?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">आप ऑनलाइन DOCM दस्तावेज़ व्यूअर के लिए Google Chrome, फ़ायरफ़ॉक्स, ओपेरा, या Safari जैसे किसी भी आधुनिक वेब ब्राउज़र का उपयोग कर सकते हैं। हालाँकि, यदि आप एक डेस्कटॉप एप्लिकेशन विकसित कर रहे हैं, तो हम कुशल प्रबंधन के लिए Aspose.Total दस्तावेज़ प्रोसेसिंग एपीआई का उपयोग करने की सलाह देते हैं।</span>
                      </div>
                  </li>
              </ul>
          </div>
