---
title: DOC दस्तावेज़ को ऑनलाइन या .NET का उपयोग करके संशोधित करें
description: बीएमपी1 दस्तावेज़ को ऐप के माध्यम से मुफ़्त में ऑनलाइन खोलें और संशोधित करें।DOC टेक्स्ट को खोजने और बदलने के लिए .NET API C# कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="DOC दस्तावेज़ को ऑनलाइन या .NET के माध्यम से संशोधित करें" h2="शक्तिशाली .NET आधारित DOC दस्तावेज़ संपादन उपयोगिता एप्लिकेशन विकसित करें।DOC फ़ाइल में टेक्स्ट को खोजने और बदलने के लिए C# कोड सूचीबद्ध है।" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC दस्तावेज़ को ऑनलाइन संशोधित करें" %}}

1. इसे अपलोड करके DOC फ़ाइल आयात करें.
...
{{% blocks/products/pf/agp/feature-section-col title=".NET के माध्यम से DOC फ़ाइल को संशोधित करें" %}}

1. .NET प्रोजेक्ट में लाइब्रेरी संदर्भ जोड़ें
1. दस्तावेज़ क्लास ऑब्जेक्ट बनाएं या इसका उपयोग करके फ़ाइल लोड करें
1. पैरामीटर के रूप में उपरोक्त ऑब्जेक्ट के साथ DocumentBuilder ऑब्जेक्ट बनाएं
1. दस्तावेज़ भरें
1. रेगुलर एक्सप्रेशन पैटर्न सरणी को परिभाषित करें
1. विशेष वर्ण संयोजनों को खोजने और बदलने के लिए रिप्लेस विधि का उपयोग करें
1. DOC दस्तावेज़ सहेजें
...
{{% blocks/products/pf/agp/code-block title="सी# कोड: बीएमपी1 फ़ाइल को संशोधित करें" offSpacer="" %}}
...
<h2>.NET के माध्यम से DOC रिडक्शन एप्लिकेशन विकसित करें</h2>

DOC रिडक्शन ऐप या उपयोगिता विकसित करने की आवश्यकता है?[Aspose.Words for .NET](https://products.aspose.com/words/hi/net/), [Aspose.Total for .NET](https://products.aspose.com/total/hi/net/) के चाइल्ड एपीआई के साथ, कोई भी .NET डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ रिडक्शन एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली .NET लाइब्रेरी किसी भी दस्तावेज़ सुधार समाधान की प्रोग्रामिंग की अनुमति देती है।इसके अलावा यह DOC प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकता है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC फ़ाइल को संशोधित करने के लिए .NET उपयोगिता" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>क्या DOC दस्तावेज़ संशोधन को प्रबंधित करने के लिए ऑनलाइन ऐप का उपयोग करना सुरक्षित है?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
