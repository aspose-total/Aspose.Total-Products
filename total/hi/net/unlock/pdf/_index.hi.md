---
title: PDF पासवर्ड सुरक्षा ऑनलाइन या .NET का उपयोग करके हटाएँ
description: ऑनलाइन ऐप के माध्यम से PDF दस्तावेज़ से निःशुल्क पासवर्ड हटाएँ। पासवर्ड से सुरक्षित PDF फ़ाइलों को अनलॉक करने के लिए .NET C# API कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="PDF दस्तावेज़ पासवर्ड ऑनलाइन या .NET के माध्यम से अनलॉक करें" h2="शक्तिशाली .NET आधारित PDF दस्तावेज़ लॉकिंग और अनलॉकिंग उपयोगिता एप्लिकेशन विकसित करें।.NET के माध्यम से PDF फ़ाइल से पासवर्ड प्रतिबंध हटाने के लिए सूचीबद्ध कोड।" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET के माध्यम से PDF पासवर्ड हटाएँ" %}}

1. दस्तावेज़ वर्ग का उपयोग करके पासवर्ड से सुरक्षित PDF फ़ाइल लोड करें
1. पासवर्ड हटाने के लिए डिक्रिप्ट() विधि लागू करें
...
{{% blocks/products/pf/agp/code-block title=".NET कोड: PDF दस्तावेज़ से पासवर्ड हटाएँ" offSpacer="" %}}
...
<h2>.NET के माध्यम से PDF सुरक्षा प्रबंधन एप्लिकेशन विकसित करें</h2>

PDF सुरक्षा प्रबंधन ऐप या उपयोगिता विकसित करने की आवश्यकता है?[Aspose.PDF for .NET](https://products.aspose.com/pdf/hi/net/), [Aspose.Total for .NET](https://products.aspose.com/total/hi/net/) के चाइल्ड एपीआई के साथ, कोई भी .NET डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ सुरक्षा या असुरक्षा एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली .NET लाइब्रेरी किसी भी दस्तावेज़ सुरक्षा समाधान की प्रोग्रामिंग की अनुमति देती है। इसके अलावा यह PDF प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकता है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="PDF सुरक्षा को प्रबंधित करने के लिए .NET उपयोगिता" %}}
आपके सिस्टम पर "Aspose.PDF for .NET" या "Aspose.Total for .NET" स्थापित करने के लिए तीन वैकल्पिक विकल्प हैं। कृपया वह चुनें जो आपकी आवश्यकताओं से मेल खाता हो और चरण-दर-चरण निर्देशों का पालन करें:<br /><br />
