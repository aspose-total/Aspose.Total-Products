---
title: DOCX प्रॉपर्टीज़ को ऑनलाइन देखें और अपडेट करें या .NET का उपयोग करके मेटाडेटा अपडेट करें
description: ऑनलाइन ऐप के माध्यम से DOCX संपत्तियों को निःशुल्क देखें और संशोधित करें।DOCX गुणों को अद्यतन करने के लिए C# .NET API कोड।
...
{{< blocks/products/pf/feature-page-header-widget h1="DOCX मेटाडेटा ऑनलाइन देखें या अपडेट करें या .NET के माध्यम से अपडेट करें" h2="शक्तिशाली .NET आधारित DOCX दस्तावेज़ मेटाडेटा प्रबंधन उपयोगिता एप्लिकेशन विकसित करें।.NET के माध्यम से DOCX फ़ाइल मेटाडेटा को अद्यतन करने के लिए कोड सूचीबद्ध है।" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET के माध्यम से DOCX गुण अद्यतन करें" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET कोड: DOCX मेटाडेटा अपडेट करें" offSpacer="" %}}
...
<h2>.NET के माध्यम से DOCX मेटाडेटा प्रबंधन एप्लिकेशन विकसित करें</h2>

DOCX मेटाडेटा प्रबंधन ऐप या उपयोगिता विकसित करने की आवश्यकता है?[Aspose.Words for .NET](https://products.aspose.com/words/hi/net/), [Aspose.Total for .NET](https://products.aspose.com/total/hi/net/) के चाइल्ड एपीआई के साथ, कोई भी .NET डेवलपर उपरोक्त एपीआई कोड को अपने दस्तावेज़ मेटाडेटा एप्लिकेशन में एकीकृत कर सकता है।शक्तिशाली .NET लाइब्रेरी किसी भी दस्तावेज़ मेटाडेटा समाधान की प्रोग्रामिंग की अनुमति देती है।इसके अलावा यह DOCX प्रारूप सहित कई लोकप्रिय प्रारूपों का समर्थन कर सकता है।<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX मेटाडेटा को प्रबंधित करने के लिए .NET उपयोगिता" %}}
