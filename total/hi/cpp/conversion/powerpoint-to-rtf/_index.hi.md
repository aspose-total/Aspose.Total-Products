...
url: /hi/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="सी ++ एपीआई डीओसी को पॉट प्रस्तुत करने के लिए" h2="बिना किसी Microsoft PowerPoint या Word निर्भरता के C++ अनुप्रयोगों में RTF को POWERPOINT निर्यात करें" >}}
...
3. परिवर्तित HTML फ़ाइल को [दस्तावेज़](https://reference.aspose.com/words/cpp/class/aspose.words.rtfument) वर्ग संदर्भ का उपयोग करके लोड करें
