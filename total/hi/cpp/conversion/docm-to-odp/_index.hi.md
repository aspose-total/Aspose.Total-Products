---
title: DOCM को C++ के माध्यम से ODP में बदलें
description: PowerPoint के Microsoft Word का उपयोग किए बिना अपने C++ अनुप्रयोगों में DOCM को ODP में निर्यात करें
url: /hi/cpp/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCM को ODP में बदलने के लिए C++ API" h2="Microsoft Word का उपयोग किए बिना अपने C++ अनुप्रयोगों में DOCM को ODP में निर्यात करें&reg; या पावरपॉइंट" >}}
