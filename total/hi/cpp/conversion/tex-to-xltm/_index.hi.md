...
url: /hi/cpp/conversion/tex-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: TEX
...
{{< blocks/products/pf/feature-page-header h1="C++ अनुप्रयोगों में XLTM को TEX प्रदान करें" h2="Microsoft<sup>&reg;</sup> Excel या Adobe<sup>&reg;</sup> Acrobat Reader की आवश्यकता के बिना TEX को मूल C++ अनुप्रयोगों में XLTM में बदलें" >}}
