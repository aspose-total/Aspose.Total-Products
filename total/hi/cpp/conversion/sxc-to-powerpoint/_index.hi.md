---
title: C++ के साथ SXC को POWERPOINT में बदलें
description: C++ अनुप्रयोगों के भीतर SXC को POWERPOINT में बदलें
url: /hi/cpp/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="C++ के माध्यम से SXC को POWERPOINT में बदलें" h2="एक्सेल निर्यात करें&reg; पूर्ण-कार्यात्मक सी ++ अनुप्रयोगों के भीतर सीएसवी से डीओसी तक" >}}
...
3. परिवर्तित पीडीएफ फाइल को [दस्तावेज़](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.powerpointument) वर्ग संदर्भ का उपयोग करके लोड करें
4. [सहेजें](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.powerpointument#a6383c010776212483f51cc41235924db) सदस्य फ़ंक्शन का उपयोग करके दस्तावेज़ को POWERPOINT प्रारूप में सहेजें और दस्तावेज़ को SaveFormat के रूप में सेट करें
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hi/cpp/conversion/sxc-to-powerpointx/" name="SXC प्रति POWERPOINTX" description="" >}}
