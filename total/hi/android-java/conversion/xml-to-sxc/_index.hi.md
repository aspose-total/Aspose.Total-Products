...
url: /hi/android-java/conversion/xml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: XML
...
{{< blocks/products/pf/feature-page-header h1="जावा के माध्यम से एंड्रॉइड में सीएसवी को सीजीएम प्रस्तुत करें" h2="Microsoft<sup>&reg;</sup> Excel या Adobe<sup>&reg;</sup> Acrobat Reader की आवश्यकता के बिना Android अनुप्रयोगों में XML को SXC में रूपांतरित करें" >}}
