...
url: /hi/android-java/conversion/xml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: XML
...
{{% blocks/products/pf/feature-page-section  h2="जावा के माध्यम से Android में ODS दस्तावेज़ को सुरक्षित रखें" %}}
[Java के माध्यम से Android के लिए Aspose.Cells](https://products.aspose.com/cells/android-java/) आपकी ज़रूरतों के आधार पर आपकी ODS फ़ाइल की सुरक्षा का समर्थन करता है। अपने दस्तावेज़ की सुरक्षा के लिए आप [workbook] की [protectSharedWorkbook](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#protectSharedWorkbook(java.lang.String)) विधि का उपयोग कर सकते हैं। https://reference.aspose.com/cells/java/com.aspose.cells/Workbook) वर्ग।
{{% blocks/products/pf/feature-page-code %}}
