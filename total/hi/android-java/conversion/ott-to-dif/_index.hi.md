---
title: OTT को DIF में बदलने के लिए Android API
...
url: /hi/android-java/conversion/ott-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Android एप्लिकेशन में OTT को DIF में बदलें" h2="Microsoft<sup>&reg;</sup> Word या Microsoft<sup>&reg;</sup> Excel का उपयोग किए बिना जावा के द्वारा Android में OTT को DIF में निर्यात करें" >}}
