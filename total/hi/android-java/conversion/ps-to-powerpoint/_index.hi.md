---
title: Android में PS को POWERPOINT में निर्यात करें
description: माइक्रोसॉफ्ट वर्ड का उपयोग किए बिना सीजीएम को ओडीपी में बदलने के लिए एंड्रॉइड एपीआई
url: /hi/android-java/conversion/ps-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: PS
