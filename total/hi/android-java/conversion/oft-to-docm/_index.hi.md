---
title: Andorid ऐप में DOCM को OFT रेंडर करें
description: आप Andorid अनुप्रयोगों में Microsoft Word या Outlook का उपयोग किए बिना OFT को DOCM में निर्यात करें
url: /hi/android-java/conversion/oft-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
