---
title: API C++ per convertire PPTX in DOT
description: Esporta PPTX in DOT all'interno delle tue applicazioni C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTX in DOT" h2="Esporta PPTX in DOT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
