---
title: API C++ per convertire PPSX in DOTX
description: Esporta PPSX in DOTX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSX in DOTX" h2="Esporta PPSX in DOTX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
