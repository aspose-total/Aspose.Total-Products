---
title: API C++ per convertire POTM in DOTX
description: Esporta POTM in DOTX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTM in DOTX" h2="Esporta POTM in DOTX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
