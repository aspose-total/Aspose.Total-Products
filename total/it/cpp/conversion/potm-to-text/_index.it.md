---
title: API C++ per convertire POTM in TEXT
description: Esporta POTM in TEXT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTM in TEXT" h2="Esporta POTM in TEXT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
