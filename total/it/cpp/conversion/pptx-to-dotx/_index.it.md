---
title: API C++ per convertire PPTX in DOTX
description: Esporta PPTX in DOTX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTX in DOTX" h2="Esporta PPTX in DOTX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
