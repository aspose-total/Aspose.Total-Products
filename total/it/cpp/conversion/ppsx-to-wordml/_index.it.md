---
title: API C++ per convertire PPSX in WORDML
description: Esporta PPSX in WORDML all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSX in WORDML" h2="Esporta PPSX in WORDML in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
