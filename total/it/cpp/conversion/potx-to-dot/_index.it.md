---
title: API C++ per convertire POTX in DOT
description: Esporta POTX in DOT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in DOT" h2="Esporta POTX in DOT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
