---
title: Esporta EMLX in TEXT tramite C++
description: API C++ per convertire EMLX in TEXT senza utilizzare Microsoft Word o Outlook
url: /it/cpp/conversion/emlx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per esportare EMLX in TEXT" h2="Trasforma EMLX in TEXT all'interno dell'applicazione C++ senza richiedere Microsoft Word o Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Sei uno sviluppatore C++ e stai cercando di aggiungere funzionalità di conversione e-mail all'interno delle tue applicazioni? Usando [Aspose.Emlx per C++](https://products.aspose.com/emlx/cpp/) puoi convertire il formato del file EMLX in HTML. Successivamente, utilizzando l'API [Aspose.Words for C++](https://products.aspose.com/words/cpp/), puoi esportare HTML in TEXT. Entrambe le API rientrano nel pacchetto [Aspose.Total for C++](https://products.aspose.com/total/cpp/). 
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salvare il documento in formato TEXT utilizzando il metodo [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) e impostare Text come SaveFormat
