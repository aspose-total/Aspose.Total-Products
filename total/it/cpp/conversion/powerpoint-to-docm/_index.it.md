---
title: API C++ per convertire POWERPOINT in DOCM
description: Esporta POWERPOINT in DOCM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POWERPOINT in DOCM" h2="Esporta POWERPOINT in DOCM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
