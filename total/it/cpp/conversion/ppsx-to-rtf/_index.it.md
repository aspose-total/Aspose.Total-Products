---
title: API C++ per convertire PPSX in RTF
description: Esporta PPSX in RTF all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSX in RTF" h2="Esporta PPSX in RTF in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
