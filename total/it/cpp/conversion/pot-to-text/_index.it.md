---
title: API C++ per convertire POT in TEXT
description: Esporta POT in TEXT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pot-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POT in TEXT" h2="Esporta POT in TEXT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
