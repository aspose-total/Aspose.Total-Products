---
title: API C++ per convertire POWERPOINT in DOCX
description: Esporta POWERPOINT in DOCX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POWERPOINT in DOCX" h2="Esporta POWERPOINT in DOCX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
