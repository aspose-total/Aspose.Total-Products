---
title: API C++ per convertire POTX in DOC
description: Esporta POTX in DOC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in DOC" h2="Esporta POTX in DOC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
