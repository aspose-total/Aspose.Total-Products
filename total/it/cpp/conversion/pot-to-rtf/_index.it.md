---
title: API C++ per convertire POT in RTF
description: Esporta POT in RTF all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pot-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POT in RTF" h2="Esporta POT in RTF in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
