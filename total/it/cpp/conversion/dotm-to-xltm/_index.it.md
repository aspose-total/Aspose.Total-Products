---
title: Converti DOTM in XLTM in C++
description: API C++ per convertire DOTM in XLTM senza utilizzare Microsoft Word o Microsoft Excel
url: /it/cpp/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per convertire DOTM in XLTM" h2="Esporta DOTM in XLTM tramite C++ senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ per convertire DOTM in XLTM" %}}
...
4. Salvare il dotmumento in formato XLTM utilizzando la funzione membro [Salva](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
