---
title: API C++ per convertire PPS in DOTX
description: Esporta PPS in DOTX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPS in DOTX" h2="Esporta PPS in DOTX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
