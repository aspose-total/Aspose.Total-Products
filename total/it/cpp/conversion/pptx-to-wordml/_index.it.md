---
title: API C++ per convertire PPTX in WORDML
description: Esporta PPTX in WORDML all'interno delle tue applicazioni C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTX in WORDML" h2="Esporta PPTX in WORDML in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
