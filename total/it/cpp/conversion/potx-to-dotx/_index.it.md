---
title: API C++ per convertire POTX in DOTX
description: Esporta POTX in DOTX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in DOTX" h2="Esporta POTX in DOTX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
