---
title: API C++ per convertire POTM in DOTM
description: Esporta POTM in DOTM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTM in DOTM" h2="Esporta POTM in DOTM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
