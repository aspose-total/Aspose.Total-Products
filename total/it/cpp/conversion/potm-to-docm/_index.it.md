---
title: API C++ per convertire POTM in DOCM
description: Esporta POTM in DOCM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTM in DOCM" h2="Esporta POTM in DOCM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/potm-to-docmx/" name="POTM Per DOCMX" description="" >}}
