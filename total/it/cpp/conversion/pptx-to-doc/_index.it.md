---
title: API C++ per convertire PPTX in DOC
description: Esporta PPTX in DOC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTX in DOC" h2="Esporta PPTX in DOC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
