---
title: API C++ per convertire PPTM in DOCM
description: Esporta PPTM in DOCM all'interno delle tue applicazioni C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTM in DOCM" h2="Esporta PPTM in DOCM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
