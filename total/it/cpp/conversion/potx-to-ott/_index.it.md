---
title: API C++ per convertire POTX in OTT
description: Esporta POTX in OTT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in OTT" h2="Esporta POTX in OTT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
