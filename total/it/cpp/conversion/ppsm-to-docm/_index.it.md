---
title: API C++ per convertire PPSM in DOCM
description: Esporta PPSM in DOCM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSM in DOCM" h2="Esporta PPSM in DOCM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
