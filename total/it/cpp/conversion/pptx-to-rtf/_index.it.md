---
title: API C++ per convertire PPTX in RTF
description: Esporta PPTX in RTF all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pptx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTX in RTF" h2="Esporta PPTX in RTF in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
...
4. Salvare il rtfumento in formato RTF utilizzando [Salva](https://reference.aspose.com/words/cpp/class/aspose.words.rtfument#save_string) funzione membro
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/pptx-to-rtfm/" name="PPTX Per RTFM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/pptx-to-rtfx/" name="PPTX Per RTFX" description="" >}}
