---
title: Esporta EML in XPS tramite C++
description: API C++ per convertire EML in XPS senza utilizzare Microsoft Word o Outlook
url: /it/cpp/conversion/eml-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
4. Salvare il documento in formato XPS utilizzando il metodo [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) e impostare Xps come SaveFormat
