---
title: API C++ per convertire PPS in WORD
description: Esporta PPS in WORD all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPS in WORD" h2="Esporta PPS in WORD in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
