---
title: API C++ per convertire PPSX in DOC
description: Esporta PPSX in DOC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSX in DOC" h2="Esporta PPSX in DOC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
