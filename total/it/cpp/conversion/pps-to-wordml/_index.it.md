---
title: API C++ per convertire PPS in WORDML
description: Esporta PPS in WORDML all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPS in WORDML" h2="Esporta PPS in WORDML in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
