---
title: Converti DOTM in XLSB in C++
description: API C++ per convertire DOTM in XLSB senza utilizzare Microsoft Word o Microsoft Excel
url: /it/cpp/conversion/dotm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per convertire DOTM in XLSB" h2="Esporta DOTM in XLSB tramite C++ senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il dotmumento in formato XLSB utilizzando la funzione membro [Salva](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
