...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POWERPOINT in ODT" h2="Esporta POWERPOINT in ODT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
...
4. Salvare il odtumento in formato ODT utilizzando [Salva](https://reference.aspose.com/words/cpp/class/aspose.words.odtument#save_string) funzione membro
