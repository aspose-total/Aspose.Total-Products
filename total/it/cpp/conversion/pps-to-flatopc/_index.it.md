---
title: API C++ per convertire PPS in FLATOPC
description: Esporta PPS in FLATOPC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPS in FLATOPC" h2="Esporta PPS in FLATOPC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
