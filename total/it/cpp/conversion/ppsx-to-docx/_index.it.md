---
title: API C++ per convertire PPSX in DOCX
description: Esporta PPSX in DOCX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPSX in DOCX" h2="Esporta PPSX in DOCX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
