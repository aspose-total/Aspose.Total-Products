---
title: Converti il formato WORD in JSON in C++
description: Esporta WORD in JSON in C++ senza utilizzare Microsoft Excel o Word
url: /it/cpp/conversion/word-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Converti WORD in formato JSON tramite C++" h2="Esporta WORD in JSON tramite C++ senza utilizzare Microsoft<sup>&reg;</sup> Word o Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Utilizzando [Aspose.Total for C++](https://products.aspose.com/total/cpp/) puoi convertire il formato WORD in JSON all'interno delle tue applicazioni C++. Innanzitutto, utilizzando [Aspose.Words for C++](https://products.aspose.com/words/cpp/), puoi esportare WORD in HTML. Successivamente, utilizzando [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/), puoi convertire HTML in formato JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salva il wordumento in formato JSON utilizzando la funzione membro [Salva](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/word-to-csv/" name="WORD Per CSV" description="" >}}
