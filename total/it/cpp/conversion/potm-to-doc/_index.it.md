---
title: API C++ per convertire POTM in DOC
description: Esporta POTM in DOC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTM in DOC" h2="Esporta POTM in DOC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
