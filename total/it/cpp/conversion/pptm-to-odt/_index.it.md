---
title: API C++ per convertire PPTM in ODT
description: Esporta PPTM in ODT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pptm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPTM in ODT" h2="Esporta PPTM in ODT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
