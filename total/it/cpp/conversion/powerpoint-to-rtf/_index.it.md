---
title: API C++ per convertire POWERPOINT in RTF
description: Esporta POWERPOINT in RTF all'interno delle tue applicazioni C++
url: /it/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POWERPOINT in RTF" h2="Esporta POWERPOINT in RTF in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
