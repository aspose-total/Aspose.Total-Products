---
title: API C++ per convertire POTX in DOTM
description: Esporta POTX in DOTM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in DOTM" h2="Esporta POTX in DOTM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
