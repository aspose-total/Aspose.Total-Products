---
title: API C++ per convertire PPT in DOCM
description: Esporta PPT in DOCM all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppt-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPT in DOCM" h2="Esporta PPT in DOCM in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
