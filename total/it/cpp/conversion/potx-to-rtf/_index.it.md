---
title: API C++ per convertire POTX in RTF
description: Esporta POTX in RTF all'interno delle tue applicazioni C++
url: /it/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di POTX in RTF" h2="Esporta POTX in RTF in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/potx-to-rtfx/" name="POTX Per RTFX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/cpp/conversion/potx-to-rtfm/" name="POTX Per RTFM" description="" >}}
