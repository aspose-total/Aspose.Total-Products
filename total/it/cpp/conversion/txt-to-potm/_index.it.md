---
title: Converti TXT in POTM tramite C++
description: Esporta TXT in POTM nelle tue applicazioni C++ senza utilizzare Microsoft Word di PowerPoint
url: /it/cpp/conversion/txt-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per convertire TXT in POTM" h2="Esporta TXT in POTM all'interno delle tue applicazioni C++ senza utilizzare Microsoft Word&reg; o PowerPoint" >}}
...
6. Salva il txtumento in formato POTM utilizzando il metodo [Salva](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) e imposta Potm come SaveFormat
