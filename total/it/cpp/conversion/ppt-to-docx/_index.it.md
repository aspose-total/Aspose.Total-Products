---
title: API C++ per convertire PPT in DOCX
description: Esporta PPT in DOCX all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPT in DOCX" h2="Esporta PPT in DOCX in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
