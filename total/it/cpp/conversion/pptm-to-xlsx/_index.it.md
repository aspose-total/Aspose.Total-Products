...
description: Esporta PPTM in XLSX in C++ senza utilizzare Microsoft Excel o PowerPoint
url: /it/cpp/conversion/pptm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Converti PPTM in XLSX tramite C++" h2="Conversione da file PPTM a XLSX tramite C++ senza utilizzare Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
4. Salvare il documento in formato XLSX utilizzando il metodo [Salva](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
