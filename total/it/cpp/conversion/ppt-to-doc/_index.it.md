---
title: API C++ per convertire PPT in DOC
description: Esporta PPT in DOC all'interno delle tue applicazioni C++
url: /it/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPT in DOC" h2="Esporta PPT in DOC in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
