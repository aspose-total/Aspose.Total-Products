---
title: Converti DOTX in PPSM tramite C++
description: Esporta DOTX in PPSM nelle tue applicazioni C++ senza utilizzare Microsoft Word di PowerPoint
url: /it/cpp/conversion/dotx-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ per convertire DOTX in PPSM" h2="Esporta DOTX in PPSM all'interno delle tue applicazioni C++ senza utilizzare Microsoft Word&reg; o PowerPoint" >}}
...
6. Salva il dotxumento in formato PPSM utilizzando il metodo [Salva](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) e imposta Ppsm come SaveFormat
