---
title: API C++ per convertire PPS in TEXT
description: Esporta PPS in TEXT all'interno delle tue applicazioni C++
url: /it/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPS in TEXT" h2="Esporta PPS in TEXT in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
