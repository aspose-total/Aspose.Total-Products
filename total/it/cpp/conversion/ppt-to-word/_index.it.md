---
title: API C++ per convertire PPT in WORD
description: Esporta PPT in WORD all'interno delle tue applicazioni C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ per il rendering di PPT in WORD" h2="Esporta PPT in WORD in applicazioni C++ senza dipendenze da Microsoft PowerPoint o Word" >}}
...
4. Salvare il wordumento in formato WORD utilizzando [Salva](https://reference.aspose.com/words/cpp/class/aspose.words.wordument#save_string) funzione membro
