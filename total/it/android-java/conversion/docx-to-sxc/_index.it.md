---
title: API Android per convertire DOCX in SXC
description: Converti DOCX in SXC in Android tramite Java senza utilizzare Microsoft Word o Microsoft Excel
url: /it/android-java/conversion/docx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Converti DOCX in SXC nelle applicazioni Android" h2="Esporta DOCX in SXC in Android tramite Java senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Utilizzando [Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/) puoi integrare la funzione di conversione da DOCX a SXC all'interno delle tue applicazioni Android. In primo luogo, puoi convertire DOCX in HTML utilizzando l'API di conversione e manipolazione dei docxumenti ricca di funzionalità [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/). Successivamente, utilizzando [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/), puoi convertire HTML in SXC. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salvare il docxumento in formato SXC utilizzando [Save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)).
