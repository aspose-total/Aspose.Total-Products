---
title: API Android per convertire DOTX in CSV
description: Converti DOTX in CSV in Android tramite Java senza utilizzare Microsoft Word o Microsoft Excel
url: /it/android-java/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Converti DOTX in CSV nelle applicazioni Android" h2="Esporta DOTX in CSV in Android tramite Java senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
