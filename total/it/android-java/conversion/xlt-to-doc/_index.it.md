---
title: Esporta XLT in DOC in Android
description: API Android per convertire XLT in DOC senza utilizzare Microsoft Word
url: /it/android-java/conversion/xlt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Rendi XLT in DOC su Android tramite Java" h2="Trasforma XLT in DOC all'interno delle tue applicazioni Android senza utilizzare Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total per Android tramite Java](https://products.aspose.com/total/android-java/) è un pacchetto di potenti API di automazione dei file. Utilizzando due delle sue API, puoi integrare la funzione di conversione da XLT a DOC all'interno delle tue applicazioni Android. Nel primo passaggio puoi esportare XLT in PDF utilizzando [Aspose.Cells per Android tramite Java](https://products.aspose.com/cells/android-java/). Successivamente, utilizzando [Aspose.PDF per Android tramite Java](https://products.aspose.com/pdf/android-java/), puoi convertire PDF in DOC. 
{{% /blocks/products/pf/feature-page-summary  %}}
