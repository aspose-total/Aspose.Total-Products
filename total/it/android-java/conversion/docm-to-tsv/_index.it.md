---
title: API Android per convertire DOCM in TSV
description: Converti DOCM in TSV in Android tramite Java senza utilizzare Microsoft Word o Microsoft Excel
url: /it/android-java/conversion/docm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Converti DOCM in TSV nelle applicazioni Android" h2="Esporta DOCM in TSV in Android tramite Java senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Utilizzando [Aspose.Total per Android tramite Java](https://products.aspose.com/total/android-java/) puoi integrare la funzione di conversione da DOCM a TSV all'interno delle tue applicazioni Android. In primo luogo, puoi convertire DOCM in HTML utilizzando l'API di conversione e manipolazione dei docmumenti ricca di funzionalità [Aspose.Words per Android tramite Java](https://products.aspose.com/words/android-java/). Successivamente, utilizzando [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/), puoi convertire HTML in TSV. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salvare il docmumento in formato TSV utilizzando [Salva](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)).
