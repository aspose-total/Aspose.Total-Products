---
title: Crea presentazioni PPSX in Node.js
description: Genera una presentazione Microsoft Powerpoint PPSX utilizzando le applicazioni Node senza utilizzare Microsoft Office. 
...
- Scrivere la presentazione modificata come file PPSX.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisiti di creazione" %}}

- Per la creazione di documenti PPSX, Node.js deve essere installato sul sistema.
- È richiesto Oracle JDK (versione 7 o successiva).
- È necessario configurare il pacchetto node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Crea file PPSX" offSpacer="" %}}
