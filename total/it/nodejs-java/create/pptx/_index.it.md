---
title: Crea presentazioni PPTX in Node.js
description: Genera una presentazione Microsoft Powerpoint PPTX utilizzando le applicazioni Node senza utilizzare Microsoft Office. 
...
- Per la creazione di documenti PPTX, Node.js deve essere installato sul sistema.
- È richiesto Oracle JDK (versione 7 o successiva).
- È necessario configurare il pacchetto node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Crea file PPTX" offSpacer="" %}}
