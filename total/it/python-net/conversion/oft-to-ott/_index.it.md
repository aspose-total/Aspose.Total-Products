---
title: Converti OFT in OTT in Python
description: Salva OFT in OTT nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-ott/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a OTT, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in OTT in Python" offSpacer="" %}}
