...
- Per la conversione da OST a FLATOPC, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OST in FLATOPC in Python" offSpacer="" %}}
