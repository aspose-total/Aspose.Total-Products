---
title: Converti ICS in DOTM in Python
description: Salva ICS in DOTM nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a DOTM, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in DOTM in Python" offSpacer="" %}}
