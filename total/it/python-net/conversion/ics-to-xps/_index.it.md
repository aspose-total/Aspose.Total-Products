---
title: Converti ICS in XPS in Python
description: Salva ICS in XPS nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-xps/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a XPS, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in XPS in Python" offSpacer="" %}}
