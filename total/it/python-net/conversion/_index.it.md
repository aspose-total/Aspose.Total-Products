...
{{% blocks/products/pf/feature-page-section  h2="Conversione da e-mail a Word, PDF, HTML e immagini" %}}
Per la conversione dei file e-mail in PDF, Word, Immagini e HTML, Email Python API [Aspose.Email for Python via .NET](https://products.aspose.com/email/python-net/) esegue la conversione. L'API carica il file di origine nel suo modello a oggetti e richiama il metodo Save con i parametri pertinenti. 

{{% blocks/products/pf/feature-page-code h3="Python - Conversione di file per e-mail in Word" %}}
