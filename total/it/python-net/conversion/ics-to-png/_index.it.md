...
- Per la conversione da ICS a PNG, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in PNG in Python" offSpacer="" %}}
