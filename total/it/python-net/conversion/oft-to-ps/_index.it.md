---
title: Converti OFT in PS in Python
description: Salva OFT in PS nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-ps/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a PS, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in PS in Python" offSpacer="" %}}
