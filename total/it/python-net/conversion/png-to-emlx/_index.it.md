...
- Per la conversione da PNG a EMLX, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva PNG in EMLX in Python" offSpacer="" %}}
