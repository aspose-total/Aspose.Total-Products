---
title: Converti ICS in WORDML in Python
description: Salva ICS in WORDML nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a WORDML, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in WORDML in Python" offSpacer="" %}}
