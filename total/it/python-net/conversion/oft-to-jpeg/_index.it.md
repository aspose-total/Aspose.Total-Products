---
title: Converti OFT in JPEG in Python
description: Salva OFT in JPEG nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a JPEG, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in JPEG in Python" offSpacer="" %}}
