---
title: Converti ICS in DOTX in Python
description: Salva ICS in DOTX nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a DOTX, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in DOTX in Python" offSpacer="" %}}
