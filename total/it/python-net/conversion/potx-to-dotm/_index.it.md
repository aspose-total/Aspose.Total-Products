...
url: /it/python-net/conversion/potx-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: POTX
...
{{% blocks/products/pf/agp/feature-section-col title="Converti POTX in DOTM in Python" %}}
