...
- Per la conversione da WORD a OFT, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva WORD in OFT in Python" offSpacer="" %}}
