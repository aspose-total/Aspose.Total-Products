---
title: Converti OFT in FLATOPC in Python
description: Salva OFT in FLATOPC nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a FLATOPC, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in FLATOPC in Python" offSpacer="" %}}
