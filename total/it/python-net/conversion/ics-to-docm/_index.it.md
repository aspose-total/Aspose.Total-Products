---
title: Converti ICS in DOCM in Python
description: Salva ICS in DOCM nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-docm/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a DOCM, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in DOCM in Python" offSpacer="" %}}
