---
title: Converti ICS in FLATOPC in Python
description: Salva ICS in FLATOPC nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a FLATOPC, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in FLATOPC in Python" offSpacer="" %}}
