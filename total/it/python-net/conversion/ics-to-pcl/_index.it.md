---
title: Converti ICS in PCL in Python
description: Salva ICS in PCL nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/ics-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Per la conversione da ICS a PCL, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva ICS in PCL in Python" offSpacer="" %}}
