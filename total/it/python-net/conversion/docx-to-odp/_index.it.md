---
title: Converti DOCX in ODP in Python o con il convertitore online gratuito
description: Conversione da DOCX a ODP nelle tue applicazioni Python senza utilizzare Microsoft Word o PowerPoint o in linea. Prova rapidamente il convertitore online gratuito da DOCX a ODP prima di integrare il codice. 
...
{{< blocks/products/pf/feature-page-header h1="Converti DOCX in ODP usando Python o App online" h2="Conversione da DOCX a ODP nelle tue applicazioni Python senza installare Microsoft Word<sup>&reg;</sup> o PowerPoint" >}}
...
-  Chiama il metodo `save` mentre specifichi il percorso del file di output e SaveFormat.ODP come parametri. Quindi il tuo file DOCX viene convertito in ODP nel percorso specificato.
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puoi utilizzare qualsiasi browser Web moderno come Google Chrome, Firefox, Opera o Safari per questa conversione online da DOCX a ODP. Tuttavia, se stai creando un'applicazione desktop, l'API Aspose.Total DOCX Conversion funzionerà perfettamente.</span>
                      </div>
                  </li>
              </ul>
          </div>
