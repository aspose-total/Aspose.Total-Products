---
title: Converti OFT in WORD in Python
description: Salva OFT in WORD nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-word/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a WORD, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in WORD in Python" offSpacer="" %}}
