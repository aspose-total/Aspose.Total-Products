...
- Per la conversione da OFT a EPUB, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in EPUB in Python" offSpacer="" %}}
