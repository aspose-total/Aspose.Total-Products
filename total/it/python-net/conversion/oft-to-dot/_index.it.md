---
title: Converti OFT in DOT in Python
description: Salva OFT in DOT nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-dot/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a DOT, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in DOT in Python" offSpacer="" %}}
