---
title: Converti OFT in IMAGE in Python
description: Salva OFT in IMAGE nelle tue applicazioni Python senza utilizzare Microsoft Outlook o Word 
url: /it/python-net/conversion/oft-to-image/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Per la conversione da OFT a IMAGE, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva OFT in IMAGE in Python" offSpacer="" %}}
