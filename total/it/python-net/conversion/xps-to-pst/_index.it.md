...
- Per la conversione da XPS a PST, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva XPS in PST in Python" offSpacer="" %}}
