---
title: Converti DOCX in OST in Python
description: Salva DOCX in OST all'interno delle applicazioni Python senza utilizzare Microsoft Word o Outlook
url: /it/python-net/conversion/docx-to-ost/
family: total
platformtag: Python
feature: conversion
informat: DOCX
...
- Per la conversione da DOCX a OST, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva DOCX in OST in Python" offSpacer="" %}}
