...
- Per la conversione da PST a PCL, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva PST in PCL in Python" offSpacer="" %}}
