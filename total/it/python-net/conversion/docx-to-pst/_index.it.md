---
title: Converti DOCX in PST in Python
description: Salva DOCX in PST all'interno delle applicazioni Python senza utilizzare Microsoft Word o Outlook
url: /it/python-net/conversion/docx-to-pst/
family: total
platformtag: Python
feature: conversion
informat: DOCX
...
- Per la conversione da DOCX a PST, è richiesto Python 3.5 o successivo
...
{{% blocks/products/pf/agp/code-block title="Salva DOCX in PST in Python" offSpacer="" %}}
