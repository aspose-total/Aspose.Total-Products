---
title: API Java per esportare PCL in DOTM
description: Converti PCL in DOTM utilizzando l'API Java locale
url_ignore: /it/java/conversion/pcl-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PCL
