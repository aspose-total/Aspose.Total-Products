---
title: Converti PPS in DOCM tramite Java
description: API Java per esportare PPS in DOCM senza utilizzare Microsoft Word o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti PPS in DOCM tramite Java" h2="API Java on-premise per la conversione PowerPoint da PPS a DOCM all'interno di qualsiasi applicazione Java J2SE, J2EE, J2ME" >}}
...
Per la conversione di file da PPS a DOCM, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e includi le librerie nel tuo pom.xml.
