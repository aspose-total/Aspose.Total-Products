---
title: API Java per esportare TEX in DOTM
description: Converti TEX in DOTM utilizzando l'API Java locale
url_ignore: /it/java/conversion/tex-to-dotm/
family: total
platformtag: net
feature: conversion
informat: TEX
