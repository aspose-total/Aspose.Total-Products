...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti PPT in XLS tramite Java" h2="API Java in loco per esportare PPT in XLS senza utilizzare Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
Per convertire PPT in XLS, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e includi le librerie nel tuo pom.xml.
