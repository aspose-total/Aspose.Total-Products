...
description: Converti RTF in TSV tramite Java senza utilizzare Microsoft Word o Microsoft Excel
url: /it/java/conversion/rtf-to-tsv/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti RTF in TSV tramite Java" h2="API Java in loco per convertire RTF in TSV senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
{{% blocks/products/pf/feature-page-summary %}}
La conversione di RTF in TSV tramite [Aspose.Total for Java](https://products.aspose.com/total/java/) è un semplice processo in due fasi. Utilizzando l'API di conversione e manipolazione dei rtfumenti ricca di funzionalità [Aspose.Words per Java](https://products.aspose.com/words/java/), puoi esportare RTF in HTML. Successivamente, utilizzando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), puoi convertire HTML in TSV.
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salvare il rtfumento in formato TSV utilizzando [Salva](https://apiference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) metodo
