---
title: Converti POWERPOINT in DOC tramite Java
description: API Java per esportare POWERPOINT in DOC senza utilizzare Microsoft Word o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti POWERPOINT in DOC tramite Java" h2="API Java on-premise per la conversione PowerPoint da POWERPOINT a DOC all'interno di qualsiasi applicazione Java J2SE, J2EE, J2ME" >}}
...
Per la conversione di file da POWERPOINT a DOC, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e includi le librerie nel tuo pom.xml.
