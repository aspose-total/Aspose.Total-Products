---
title: Converti POWERPOINT in WORDML tramite Java
description: API Java per esportare POWERPOINT in WORDML senza utilizzare Microsoft Word o PowerPoint
url: /it/java/conversion/powerpoint-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Per la conversione di file da POWERPOINT a WORDML, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e includi le librerie nel tuo pom.xml.
