---
title: Converti FODS in PPTX usando Java
description: API Java per esportare FODS in PPTX utilizzando Excel o Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java per esportare FODS in PPTX" h2="API Java in loco per esportare FODS in PPTX senza fare affidamento su Microsoft Excel&reg;" >}}
{{% blocks/products/pf/feature-page-summary %}}
Il rendering di FODS in PPTX è un processo in due fasi. Utilizzerai prima l'API [Aspose.Cells for Java](https://products.aspose.com/cells/java) per convertire il pptxumento FODS specificato in PDF, quindi utilizzerai [Aspose.Pdf for Java](https ://products.aspose.com/pdf/java) API, puoi convertire facilmente il tuo pptxumento PDF in PPTX. Entrambe le API rientrano nella raccolta di librerie di automazione dei formati di file [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
