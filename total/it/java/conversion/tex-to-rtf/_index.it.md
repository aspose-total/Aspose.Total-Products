...
<iframe title="App gratuita di conversione online da TEX a RTF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Codice Java per la conversione da TEX a RTF" offSpacer="" %}}
