---
title: API Java per esportare XPS in WORDML
description: Converti XPS in WORDML utilizzando l'API Java locale
url_ignore: /it/java/conversion/xps-to-wordml/
family: total
platformtag: net
feature: conversion
informat: XPS
