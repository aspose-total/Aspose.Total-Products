---
title: API Java per convertire MOBI in XLSX
description: Converti MOBI in XLSX tramite Java senza utilizzare Microsoft Word o Microsoft Excel
url: /it/java/conversion/mobi-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti MOBI in XLSX tramite Java" h2="API Java in loco per convertire MOBI in XLSX senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ per convertire MOBI in XLSX" %}}
1. Aprire il file MOBI utilizzando la classe [Mobiument](https://apiference.aspose.com/words/java/com.aspose.words/Mobiument)
2. Converti MOBI in HTML utilizzando [Salva](https://apiference.aspose.com/words/java/com.aspose.words/Mobiument#save(java.lang.String,com.aspose.words.SaveOptions) ) metodo
