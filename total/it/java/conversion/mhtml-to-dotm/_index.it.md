---
title: API Java per esportare MHTML in DOTM
description: Converti MHTML in DOTM utilizzando l'API Java locale
url_ignore: /it/java/conversion/mhtml-to-dotm/
family: total
platformtag: net
feature: conversion
informat: MHTML
