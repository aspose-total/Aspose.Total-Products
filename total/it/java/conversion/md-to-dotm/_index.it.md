---
title: API Java per esportare MD in DOTM
description: Converti MD in DOTM utilizzando l'API Java locale
url_ignore: /it/java/conversion/md-to-dotm/
family: total
platformtag: net
feature: conversion
informat: MD
