---
title: Converti PPS in ODT tramite Java
description: API Java per esportare PPS in ODT senza utilizzare Microsoft Word o PowerPoint
...
Per la conversione di file da PPS a ODT, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e includi le librerie nel tuo pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/net/conversion/pps-to-odtm/" name="PPS A ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/it/net/conversion/pps-to-odtx/" name="PPS A ODTX" description="" >}}
