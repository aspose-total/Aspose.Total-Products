---
title: API Java per esportare PDF in WORDML
description: Converti PDF in WORDML utilizzando l'API Java locale
url_ignore: /it/java/conversion/pdf-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PDF
