...
<iframe title="App gratuita di conversione online da MHTML a ODT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odt&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Codice Java per la conversione da MHTML a ODT" offSpacer="" %}}
