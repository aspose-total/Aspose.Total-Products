---
title: API Java per esportare XPS in DOTM
description: Converti XPS in DOTM utilizzando l'API Java locale
url_ignore: /it/java/conversion/xps-to-dotm/
family: total
platformtag: net
feature: conversion
informat: XPS
