---
title: API Java per esportare SVG in WORDML
description: Converti SVG in WORDML utilizzando l'API Java locale
url_ignore: /it/java/conversion/svg-to-wordml/
family: total
platformtag: net
feature: conversion
informat: SVG
