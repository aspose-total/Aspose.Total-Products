...
description: Converti POWERPOINT in formato XLS tramite Java senza utilizzare Microsoft Excel o PowerPoint
url: /it/java/conversion/powerpoint-to-xls/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti POWERPOINT in XLS tramite Java" h2="API Java in loco per esportare POWERPOINT in XLS senza utilizzare Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
Per convertire POWERPOINT in XLS, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e includi le librerie nel tuo pom.xml.
