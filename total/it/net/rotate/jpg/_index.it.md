---
title: Ruota documenti JPG online o utilizzando .NET
description: Ruota gratuitamente il documento JPG tramite l'app online.Codice C# API .NET per ruotare i file JPG.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ruota il documento JPG online o tramite .NET" h2="Sviluppa una potente applicazione di utilità di rotazione dei documenti JPG basata su .NET.Codice elencato per la rotazione del file JPG tramite .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ruota JPG in linea" %}}

1. Importa il file JPG da sbloccare caricandolo.
1. Fallo facendo clic all'interno dell'area di rilascio tramite trascinamento della selezione dell'app di rotazione.
1. A seconda della dimensione del file JPG e della velocità di Internet, attendere alcuni secondi.
...
{{% blocks/products/pf/agp/feature-section-col title="Ruota il file JPG tramite .NET" %}}

1. Carica il file JPG utilizzando Image.Load
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: ruota i file JPG" offSpacer="" %}}
...
<h2>Sviluppare l'applicazione di rotazione JPG tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità di rotazione JPG?Con [Aspose.Imaging for .NET](https://products.aspose.com/imaging/it/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di rotazione dei documenti.La potente libreria .NET consente di programmare qualsiasi soluzione di rotazione dei documenti.Inoltre può supportare molti formati popolari incluso il formato JPG.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilità .NET per gestire la rotazione JPG" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>È sicuro utilizzare l'app online per ruotare il documento JPG?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puoi utilizzare qualsiasi browser Web moderno come Google Chrome, Firefox, Opera o Safari per la rotazione dei documenti JPG online.Tuttavia, se stai sviluppando un'applicazione desktop, ti consigliamo di utilizzare l'API di elaborazione dei documenti Aspose.Total per una gestione efficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
