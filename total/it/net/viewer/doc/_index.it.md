---
title: Visualizza file DOC online e utilizzando .NET
description: App gratuita per la visualizzazione di file DOC online. Codice C# API .NET per visualizzare il file DOC per l'applicazione visualizzatore.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualizza liberamente il file DOC online o tramite .NET" h2="Sviluppa una potente applicazione di utilità per la visualizzazione di documenti DOC basata su .NET. Codice C# elencato per visualizzare il documento DOC." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Visualizza il documento DOC tramite l'app online" %}}

1. Importa il file DOC da visualizzare caricandolo.
...
1. Navigare tra le pagine in caso di documenti DOC multipagina.
1. Imposta lo zoom in avanti o lo zoom indietro della visualizzazione della pagina.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Visualizza file DOC tramite .NET" %}}

1. Aggiungi il riferimento alla libreria .NET nel progetto
1. Carica il file DOC di origine utilizzando l'oggetto classe Document
...
{{% blocks/products/pf/agp/code-block title="Codice C#: visualizza il documento DOC" offSpacer="" %}}
...
<h2>Sviluppare l'applicazione visualizzatore di file DOC tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità per il visualizzatore DOC?Con [Aspose.Words for .NET](https://products.aspose.com/words/it/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di visualizzazione di documenti.La potente libreria .NET consente di programmare qualsiasi soluzione di visualizzazione di documenti in grado di supportare molti formati popolari, incluso il formato DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilità .NET per elaborare il file DOC per l'app di visualizzazione" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>È sicuro utilizzare l'app online per visualizzare il documento DOC?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puoi utilizzare qualsiasi browser Web moderno come Google Chrome, Firefox, Opera o Safari per il visualizzatore di documenti DOC online. Tuttavia, se stai sviluppando un'applicazione desktop, ti consigliamo di utilizzare l'API di elaborazione dei documenti Aspose.Total per una gestione efficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
