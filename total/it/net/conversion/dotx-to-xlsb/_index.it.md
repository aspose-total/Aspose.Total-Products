...
description: API C# per convertire DOTX in XLSB senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/dotx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire DOTX in XLSB" h2="Esporta DOTX in XLSB tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il dotxumento in formato XLSB utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLSB` come SaveFormat
