---
title: API C# per esportare TEX in PS
description: Converti TEX in PS senza utilizzare Microsoft Word
url_ignore: /it/net/conversion/tex-to-ps/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da TEX a PS tramite .NET" h2="API .NET per esportare TEX in PS su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire TEX in PS" %}}
