---
title: API .NET per convertire DOTX in XLAM
description: API C# per convertire DOTX in XLAM senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/dotx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire DOTX in XLAM" h2="Esporta DOTX in XLAM tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il dotxumento in formato XLAM utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLAM` come SaveFormat
