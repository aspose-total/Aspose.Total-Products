...
description: API C# per convertire WORD in DIF senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/word-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire WORD in DIF" h2="Esporta WORD in DIF tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il wordumento in formato DIF utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `DIF` come SaveFormat
