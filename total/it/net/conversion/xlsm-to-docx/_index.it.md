---
title: Converti XLSM in DOCX con .NET 
description: Converti XLSM in DOCX su piattaforme .NET Framework, .NET Core, Mono o Xamarin
url: /it/net/conversion/xlsm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converti XLSM in DOCX tramite C#" h2="Esporta Excel&reg; XLSM a DOCX su piattaforme .NET Framework, .NET Core, Mono o Xamarin">}}
...
3. Caricare il file PDF convertito utilizzando la classe [Docxument](https://apiference.aspose.com/pdf/net/aspose.pdf/docxument)
4. Salva il docxumento in formato DOCX utilizzando il metodo [Salva](https://apiference.aspose.com/pdf/net/aspose.pdf.docxument/save/methods/5) e imposta Docx come SaveFormat
