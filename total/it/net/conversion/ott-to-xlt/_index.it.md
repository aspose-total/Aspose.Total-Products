...
description: API C# per convertire OTT in XLT senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/ott-to-xlt/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire OTT in XLT" h2="Esporta OTT in XLT tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il ottumento in formato XLT utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLT` come SaveFormat
