...
<iframe title="App gratuita di conversione online da PDF a POT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=pot&from=pdf" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertire PDF in POT tramite C# .NET" offSpacer="" %}}
