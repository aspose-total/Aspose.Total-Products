---
title: API .NET per convertire DOT in CSV
description: API C# per convertire DOT in CSV senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/dot-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire DOT in CSV" h2="Esporta DOT in CSV tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il dotumento in formato CSV utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `CSV` come SaveFormat
