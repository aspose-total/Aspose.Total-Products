---
title: API .NET per convertire WORD in FODS
description: API C# per convertire WORD in FODS senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/word-to-fods/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire WORD in FODS" h2="Esporta WORD in FODS tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Aprire il file WORD utilizzando la classe [Wordument](https://apiference.aspose.com/words/net/aspose.words/wordument)
2. Converti WORD in HTML utilizzando il metodo [Save](https://apiference.aspose.com/words/net/aspose.words.wordument/save/methods/4)
3. Caricare il wordumento HTML utilizzando la classe [Workbook](https://apiference.aspose.com/cells/net/aspose.cells/workbook)
4. Salvare il wordumento in formato FODS utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `FODS` come SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Carica wordumento WORD da Stream tramite C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) consente anche di caricare wordumenti WORD tramite stream. Per aprire un wordumento da uno stream, è sufficiente passare un oggetto stream che contiene il wordumento nel costruttore [Wordument](https://apiference.aspose.com/words/net/aspose.words/wordument). L'esempio di codice seguente mostra come aprire un wordumento da un flusso:  
{{% blocks/products/pf/feature-page-code %}}
...
Durante la conversione di WORD in FODS, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) consente di aggiungere proprietà personalizzate nei wordumenti FODS. Per aggiungere una proprietà personalizzata, è possibile utilizzare il metodo [Add](https://apiference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection/methods/add/index) per il metodo [CustomWordumentPropertyCollection](https://apiference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection). Il metodo Add aggiunge la proprietà al file Excel e restituisce un riferimento per la nuova proprietà del wordumento come [Aspose.Cells.Properties.WordumentProperty](https://apiference.aspose.com/cells/net/aspose.cells.properties /proprietà wordumento). 
{{% blocks/products/pf/feature-page-code %}}
