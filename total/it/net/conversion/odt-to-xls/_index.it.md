---
title: API .NET per convertire ODT in XLS
description: API C# per convertire ODT in XLS senza utilizzare Microsoft Excel o Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire ODT in XLS" h2="Esporta ODT in XLS tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il odtumento in formato XLS utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLS` come SaveFormat
