---
title: API C# per esportare CGM in WORDML
description: Converti CGM in WORDML senza utilizzare Microsoft Word
url_ignore: /it/net/conversion/cgm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da CGM a WORDML tramite .NET" h2="API .NET per esportare CGM in WORDML su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire CGM in WORDML" %}}
