---
title: API .NET per convertire OTT in XLSX
description: API C# per convertire OTT in XLSX senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/ott-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire OTT in XLSX" h2="Esporta OTT in XLSX tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il ottumento in formato XLSX utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLSX` come SaveFormat
