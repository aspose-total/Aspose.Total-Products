---
title: API .NET per convertire DOTX in XLTX
description: API C# per convertire DOTX in XLTX senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/dotx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire DOTX in XLTX" h2="Esporta DOTX in XLTX tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il dotxumento in formato XLTX utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLTX` come SaveFormat
