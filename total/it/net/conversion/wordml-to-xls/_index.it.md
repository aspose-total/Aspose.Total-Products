---
title: API .NET per convertire WORDML in XLS
description: API C# per convertire WORDML in XLS senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/wordml-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire WORDML in XLS" h2="Esporta WORDML in XLS tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salvare il wordmlumento in formato XLS utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLS` come SaveFormat
