---
title: Rimuovi l'annotazione XLSB online o gestisci le annotazioni tramite .NET
description: elimina gratuitamente i commenti dal file XLSB tramite l'app online.Codice API .NET per gestire i commenti dei file XLSB.
...
{{< blocks/products/pf/feature-page-header-widget h1="Cancella commenti dal documento XLSB online o gestisci tramite .NET" h2="Sviluppa una potente applicazione di utilità per l'annotazione di documenti XLSB basata su .NET.Codice elencato per la gestione dei commenti del file XLSB tramite .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Rimuovi le annotazioni XLSB online" %}}

1. Importa il file XLSB per eliminare i commenti caricandolo
...
{{% blocks/products/pf/agp/feature-section-col title="Rimuovere i commenti XLSB tramite .NET" %}}
...
1. Utilizzare Comments.RemoveAt con la colonna specifica come indice
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: elimina commenti dal file XLSB" offSpacer="" %}}
...
<h2>Sviluppare un'applicazione di annotazione di documenti XLSB tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità di annotazione XLSB per fornire feedback, dare suggerimenti o collaborare con altri sul documento?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di annotazione dei documenti.La potente libreria .NET consente di programmare qualsiasi soluzione di annotazione di documenti.Inoltre può supportare molti formati popolari incluso il formato XLSB.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Libreria .NET per annotare file XLSB" %}}
