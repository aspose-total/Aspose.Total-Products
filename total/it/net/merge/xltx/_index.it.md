---
title: Unisci file XLTX online o utilizzando .NET
description: App online gratuita per combinare diversi file XLTX.Codice della libreria di unione C# .NET per unire i fogli di lavoro XLTX in altri formati.
...
{{< blocks/products/pf/feature-page-header-widget h1="Unisci documenti XLTX online tramite l'app Merger o utilizzando .NET" h2="Sviluppa una potente applicazione di fusione di documenti XLTX basata su .NET.Combina più documenti XLTX in uno solo online gratuitamente tramite l'app.Salva il file XLTX unito come PDF, Immagini, Word, Excel, PowerPoint e molti altri formati online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Unisci file XLTX tramite .NET" %}}

1. Carica entrambi i XLTX utilizzando gli oggetti della classe Workbook.
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: unisci file XLTX" offSpacer="" %}}
...
<h2>Sviluppa la fusione di file XLTX utilizzando .NET</h2>

Hai bisogno di sviluppare un'app di utilità .NET per unire facilmente più file XLTX?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/it/net/), API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra per concatenare facilmente i documenti.La potente libreria .NET per l'unione di documenti supporta molti formati popolari incluso il formato XLTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Libreria di unione .NET per file XLTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sì, puoi scaricare questo codice. È possibile sviluppare una soluzione professionale per combinare XLTX utilizzando .NET.Utilizza l'API di unione XLTX per sviluppare software di alto livello indipendente dalla piattaforma in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
