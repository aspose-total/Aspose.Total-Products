---
title: Visualizza e aggiorna le proprietà ODT online o aggiorna i metadati utilizzando .NET
description: Visualizza e modifica gratuitamente le proprietà ODT tramite l'app online. Codice API C# .NET per aggiornare e aggiungere proprietà ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualizza o aggiorna i metadati ODT online o aggiorna tramite .NET" h2="Sviluppa una potente applicazione di utilità per la gestione dei metadati dei documenti ODT basata su .NET.Codice elencato per l'aggiunta e la modifica dei metadati del file ODT tramite .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gestisci le proprietà ODT tramite .NET" %}}
...
1. Chiama il metodo Save() per salvare il documento ODT aggiornato.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: aggiorna i metadati ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Codice .NET: aggiungi proprietà personalizzate ODT" offSpacer="" %}}
...
<h2>Sviluppare un'applicazione di gestione dei metadati ODT tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità per la gestione dei metadati ODT?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/it/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di metadati del documento.La potente libreria .NET consente di programmare qualsiasi soluzione di metadati di documenti.Inoltre può supportare molti formati popolari incluso il formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilità .NET per gestire i metadati ODT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📘 Casi d'uso per OpenDocument Text (`.odt`)

- Utilizzare i metadati per garantire la compatibilità tra le suite per ufficio.
- Tenere traccia dei contributori e della cronologia della collaborazione.
- Organizzare e cercare documenti in formato aperto all'interno dei sistemi aziendali.
- Supportare i motori di intelligenza artificiale/apprendimento automatico che analizzano ODT per ottenere informazioni.
