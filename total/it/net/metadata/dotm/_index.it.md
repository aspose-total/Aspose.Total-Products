---
title: Visualizza e aggiorna le proprietà DOTM online o aggiorna i metadati utilizzando .NET
description: Visualizza e modifica gratuitamente le proprietà DOTM tramite l'app online.Codice API C# .NET per aggiornare le proprietà DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualizza o aggiorna i metadati DOTM online o aggiorna tramite .NET" h2="Sviluppa una potente applicazione di utilità per la gestione dei metadati dei documenti DOTM basata su .NET.Codice elencato per l'aggiornamento dei metadati del file DOTM tramite .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Visualizza o aggiorna i metadati DOTM online" %}}

1. Importa il file DOTM caricandolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Aggiorna le proprietà DOTM tramite .NET" %}}

1. Carica il file DOTM utilizzando la classe Document.
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: aggiorna i metadati DOTM" offSpacer="" %}}
...
<h2>Sviluppare un'applicazione di gestione dei metadati DOTM tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità per la gestione dei metadati DOTM?Con [Aspose.Words for .NET](https://products.aspose.com/words/it/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di metadati del documento.La potente libreria .NET consente di programmare qualsiasi soluzione di metadati di documenti.Inoltre può supportare molti formati popolari incluso il formato DOTM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilità .NET per gestire i metadati DOTM" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>È sicuro utilizzare l'app online per gestire le proprietà dei documenti DOTM?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puoi utilizzare qualsiasi browser Web moderno come Google Chrome, Firefox, Opera o Safari per la gestione online delle proprietà dei documenti DOTM. Tuttavia, se stai sviluppando un'applicazione desktop, ti consigliamo di utilizzare l'API di elaborazione dei documenti Aspose.Total per una gestione efficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
