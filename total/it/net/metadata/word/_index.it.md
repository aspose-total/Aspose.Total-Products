---
title: Visualizza e aggiorna le proprietà Word online o aggiorna i metadati utilizzando .NET
description: Visualizza e modifica gratuitamente le proprietà Word tramite l'app online.Codice API C# .NET per aggiornare le proprietà Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualizza o aggiorna i metadati Word online o aggiorna tramite .NET" h2="Sviluppa una potente applicazione di utilità per la gestione dei metadati dei documenti Word basata su .NET.Codice elencato per l'aggiornamento dei metadati del file Word tramite .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Aggiorna le proprietà Word tramite .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Codice .NET: aggiorna i metadati Word" offSpacer="" %}}
...
<h2>Sviluppare un'applicazione di gestione dei metadati Word tramite .NET</h2>

Hai bisogno di sviluppare un'app o un'utilità per la gestione dei metadati Word?Con [Aspose.Words for .NET](https://products.aspose.com/words/it/net/), un'API figlio di [Aspose.Total for .NET](https://products.aspose.com/total/it/net/), qualsiasi sviluppatore .NET può integrare il codice API riportato sopra all'interno della propria applicazione di metadati del documento.La potente libreria .NET consente di programmare qualsiasi soluzione di metadati di documenti.Inoltre può supportare molti formati popolari incluso il formato Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilità .NET per gestire i metadati Word" %}}
