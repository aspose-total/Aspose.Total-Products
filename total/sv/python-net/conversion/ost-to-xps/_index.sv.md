---
title: Konvertera OST till XPS i Python
description: Spara OST till XPS i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/ost-to-xps/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- För OST till XPS-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara OST till XPS i Python" offSpacer="" %}}
