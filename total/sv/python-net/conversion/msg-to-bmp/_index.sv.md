---
title: Konvertera MSG till BMP i Python
description: Spara MSG till BMP i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/msg-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- För MSG till BMP-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara MSG till BMP i Python" offSpacer="" %}}
