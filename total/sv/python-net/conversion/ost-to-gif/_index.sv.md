---
title: Konvertera OST till GIF i Python
description: Spara OST till GIF i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/ost-to-gif/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- För OST till GIF-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara OST till GIF i Python" offSpacer="" %}}
