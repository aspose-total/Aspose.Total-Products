---
title: Konvertera PST till XPS i Python
description: Spara PST till XPS i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/pst-to-xps/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- För PST till XPS-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara PST till XPS i Python" offSpacer="" %}}
