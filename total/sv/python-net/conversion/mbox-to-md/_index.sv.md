---
title: Konvertera MBOX till MD i Python
description: Spara MBOX till MD i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/mbox-to-md/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- För MBOX till MD-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara MBOX till MD i Python" offSpacer="" %}}
