---
title: Konvertera MBOX till TEXT i Python
description: Spara MBOX till TEXT i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- För MBOX till TEXT-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara MBOX till TEXT i Python" offSpacer="" %}}
