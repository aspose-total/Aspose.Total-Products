---
title: Konvertera PST till TIFF i Python
description: Spara PST till TIFF i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/pst-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- För PST till TIFF-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara PST till TIFF i Python" offSpacer="" %}}
