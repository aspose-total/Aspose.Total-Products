---
title: Konvertera DOC till POTM i Python
description: DOC till POTM-konvertering i dina Python-applikationer utan att använda Microsoft Word eller PowerPoint 
url: /sv/python-net/conversion/doc-to-potm/
family: total
platformtag: Python
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOC till POTM med Python" h2="DOC till POTM-konvertering i dina Python-applikationer utan att installera Microsoft Word<sup>&reg;</sup> eller PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}

För en Python-utvecklare, vem försöker lägga till en DOC till POTM-konverteringsfunktion i applikationen? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API kan hjälpa till att automatisera konverteringsprocessen. Det är ett komplett paket med olika API:er som hanterar olika format. Så **Hur konverterar man DOC till POTM i Python?**
...
{{% blocks/products/pf/agp/feature-section-col title="Konvertera DOC till POTM i Python" %}}
...
-  Anropa 'spara'-metoden samtidigt som du anger sökvägen för utdatafilen & SaveFormat.POTM som parametrar. Så din DOC-fil konverteras till POTM på den angivna sökvägen.
