---
title: Konvertera PST till BMP i Python
description: Spara PST till BMP i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/pst-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- För PST till BMP-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara PST till BMP i Python" offSpacer="" %}}
