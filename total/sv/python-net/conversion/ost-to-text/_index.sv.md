---
title: Konvertera OST till TEXT i Python
description: Spara OST till TEXT i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/ost-to-text/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- För OST till TEXT-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara OST till TEXT i Python" offSpacer="" %}}
