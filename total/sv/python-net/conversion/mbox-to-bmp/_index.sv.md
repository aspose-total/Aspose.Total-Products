---
title: Konvertera MBOX till BMP i Python
description: Spara MBOX till BMP i dina Python-applikationer utan att använda Microsoft Outlook eller Word 
url: /sv/python-net/conversion/mbox-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- För MBOX till BMP-konvertering krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Spara MBOX till BMP i Python" offSpacer="" %}}
