---
title: Generera AUSTRALIAPOST streckkodsbilder via Python
description: Skapa AUSTRALIAPOST symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För att skapa AUSTRALIAPOST-streckkoder krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Generera AUSTRALIAPOST Symbology BarCode i Python" offSpacer="" %}}
