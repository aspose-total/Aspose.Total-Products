---
title: Generera ITF streckkodsbilder via Python
description: Skapa ITF symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För att skapa ITF-streckkoder krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Generera ITF Symbology BarCode i Python" offSpacer="" %}}
