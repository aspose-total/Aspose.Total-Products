---
title: Generera CODE39 streckkodsbilder via Python
description: Skapa CODE39 symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För att skapa CODE39-streckkoder krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Generera CODE39 Symbology BarCode i Python" offSpacer="" %}}
