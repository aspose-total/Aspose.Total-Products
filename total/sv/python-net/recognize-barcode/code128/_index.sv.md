---
title: Känn igen CODE128 streckkodsbilder via Python
description: Skanna CODE128 symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För CODE128 streckkodsskanning krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Känn igen CODE128 Symbology BarCode i Python" offSpacer="" %}}
