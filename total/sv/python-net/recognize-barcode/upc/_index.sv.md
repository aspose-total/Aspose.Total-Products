---
title: Känn igen UPC streckkodsbilder via Python
description: Skanna UPC symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För UPC streckkodsskanning krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Känn igen UPC Symbology BarCode i Python" offSpacer="" %}}
