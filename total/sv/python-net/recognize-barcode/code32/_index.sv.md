---
title: Känn igen CODE32 streckkodsbilder via Python
description: Skanna CODE32 symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För CODE32 streckkodsskanning krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Känn igen CODE32 Symbology BarCode i Python" offSpacer="" %}}
