---
title: Känn igen PLANET streckkodsbilder via Python
description: Skanna PLANET symbologi streckkodsbilder med Python-applikationer utan att använda någon annan programvara. 
...
- För PLANET streckkodsskanning krävs Python 3.5 eller senare
...
{{% blocks/products/pf/agp/code-block title="Känn igen PLANET Symbology BarCode i Python" offSpacer="" %}}
