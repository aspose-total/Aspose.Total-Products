---
title: Konvertera EXCEL till bild med Python
description: EXCEL till bild TIFF BMP PNG JPEG GIF EMF SVG-konvertering i dina Python-applikationer utan att använda Microsoft Excel 
url: /sv/python-java/conversion/excel-to-images/
family: total
platformtag: Python
feature: conversion
informat: EXCEL
...
- Spara alla sidor i kalkylbladet som en bild med [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String))-metoden. Nu konverteras EXCEL-filen till bilder på den angivna sökvägen

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Konverteringskrav" %}}

- För konvertering av EXCEL till bilder (JPG, PNG, GIF, BMP, TIFF), referera till API:er inom projektet direkt från PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="EXCEL till bildkonvertering via Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="EXCEL Att föreställa sig" description="" >}}
