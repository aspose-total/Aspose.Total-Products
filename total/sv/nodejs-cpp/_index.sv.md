---
title: PDF-manipulation och OCR-tillägg via Node.js API:er
description: Node.js API för att manipulera PDF-filer samt extrahera text från bilder via applikationer.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API för PDF- och bildtextextraktion" h2="Extrahera text från bilder och inkludera PDF-manipuleringsfunktioner i Node.js-applikationer utan några andra mjukvaruberoenden" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total för Node.js via C++ är en allomfattande uppsättning av Node.js-bibliotek.Dessa bibliotek erbjuder funktioner som att arbeta direkt med PDF-filer och förbättra dina applikationer för att omvandla bilder till text.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total för Node.js via C++ inkluderar följande Node.js-bibliotek:" >}}
...
Aspose.PDF för Node.js via C++ ger dig möjlighet att hantera PDF-filer på backend. Genom att använda den kan du optimera PDF-filer, infoga och extrahera text och bilder, samt implementera krypterings- och dekrypteringsprocesser. Funktionaliteten sträcker sig dessutom till möjligheten att enkelt dela och slå samman PDF-dokument, vilket ger en omfattande verktygslåda för strömlinjeformad PDF-filmanipulation.
...
Aspose.OCR för Node.js via C++ möjliggör textextraktion från bilder som skannade sidor och foton på Node.js-kompatibla plattformar.Förbättra lokala produkter, webbtjänster och serverlösa applikationer med kraftfull funktionalitet för optisk teckenigenkänning, som stöder 28 språk inklusive kinesiska och hindi i populära format.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for Node.js via C++ tillåter utvecklare att ladda, rendera och spara olika teckensnittsformat, inklusive TrueType, WOFF, EOT, OpenType, CFF och Type1. Designad för att förenkla komplexa teckensnittsoperationer, så Node.js-utvecklare kan enkelt fokusera på att skapa exceptionella applikationer utan krångel med intrikat teckensnittshantering.
{{< /blocks/products/pf/total/product-item >}}
<!--<p></p>-->
<h2 class="pr-ft">
 <a class="anchor" id="features" name="features">
 </a>
 Översikt över Node.js via C++-bibliotek
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total erbjuder individuella lösningar för andra plattformar." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/sv/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/sv/nodejs-java/" 
