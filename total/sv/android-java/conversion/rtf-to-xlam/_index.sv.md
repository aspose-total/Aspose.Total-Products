---
title: Android API för att konvertera RTF till XLAM
description: Konvertera RTF till XLAM i Android via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Konvertera RTF till XLAM i Android-applikationer" h2="Exportera RTF till XLAM i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
