---
title: Android API för att konvertera DOCX till SXC
description: Konvertera DOCX till SXC i Android via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOCX till SXC i Android-applikationer" h2="Exportera DOCX till SXC i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
