---
title: Android API för att konvertera DOCX till XLTM
description: Konvertera DOCX till XLTM i Android via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/android-java/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOCX till XLTM i Android-applikationer" h2="Exportera DOCX till XLTM i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
