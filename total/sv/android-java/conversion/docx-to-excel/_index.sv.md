---
title: Android API för att konvertera DOCX till EXCEL
description: Konvertera DOCX till EXCEL i Android via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/android-java/conversion/docx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOCX till EXCEL i Android-applikationer" h2="Exportera DOCX till EXCEL i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
