---
title: Exportera XLSB till DOCX i Android
description: Android API för att konvertera XLSB till DOCX utan att använda Microsoft Word
url: /sv/android-java/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Rendera XLSB till DOCX på Android via Java" h2="Förvandla XLSB till DOCX i dina Android-applikationer utan att använda Microsoft<sup>&reg;</sup> Excel" >}}
