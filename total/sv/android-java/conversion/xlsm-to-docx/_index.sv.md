---
title: Exportera XLSM till DOCX i Android
description: Android API för att konvertera XLSM till DOCX utan att använda Microsoft Word
url: /sv/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Rendera XLSM till DOCX på Android via Java" h2="Förvandla XLSM till DOCX i dina Android-applikationer utan att använda Microsoft<sup>&reg;</sup> Excel" >}}
