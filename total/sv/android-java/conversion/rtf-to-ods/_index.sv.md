---
title: Android API för att konvertera RTF till ODS
description: Konvertera RTF till ODS i Android via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/android-java/conversion/rtf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Konvertera RTF till ODS i Android-applikationer" h2="Exportera RTF till ODS i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
