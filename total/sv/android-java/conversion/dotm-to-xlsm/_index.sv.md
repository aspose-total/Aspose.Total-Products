---
title: Android API för att konvertera DOTM till XLSM
description: Konvertera DOTM till XLSM i Android via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/android-java/conversion/dotm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOTM till XLSM i Android-applikationer" h2="Exportera DOTM till XLSM i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
