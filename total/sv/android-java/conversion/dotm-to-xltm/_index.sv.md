---
title: Android API för att konvertera DOTM till XLTM
description: Konvertera DOTM till XLTM i Android via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOTM till XLTM i Android-applikationer" h2="Exportera DOTM till XLTM i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
