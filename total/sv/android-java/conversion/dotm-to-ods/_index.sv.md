---
title: Android API för att konvertera DOTM till ODS
description: Konvertera DOTM till ODS i Android via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Konvertera DOTM till ODS i Android-applikationer" h2="Exportera DOTM till ODS i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
