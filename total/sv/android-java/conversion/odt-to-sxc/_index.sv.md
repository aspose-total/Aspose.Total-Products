---
title: Android API för att konvertera ODT till SXC
description: Konvertera ODT till SXC i Android via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/android-java/conversion/odt-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Konvertera ODT till SXC i Android-applikationer" h2="Exportera ODT till SXC i Android via Java utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
