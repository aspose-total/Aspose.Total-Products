---
title: Ta bort ODT lösenordsskydd online eller med Android-mobilappar
description: låsa upp lösenord från ODT-dokument via online-appen gratis. Android API-kod för att radera lösenord från ODT-filer.
...
{{< blocks/products/pf/feature-page-header-widget h1="Lås upp ODT-dokumentlösenord online eller via Android-appar" h2="Utveckla kraftfull Android-baserad ODT-dokumentupplåsningsapplikation. Kod listad för att ta bort lösenordsbegränsningar från ODT-fil." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Lås upp ODT-lösenord online" %}}

1. Importera ODT-fil för att låsa upp genom att ladda upp den
...
{{% blocks/products/pf/agp/feature-section-col title="Ta bort ODT-lösenord via Android-appen" %}}

1. Referera till Android-biblioteket inom projektet 
1. Ladda lösenordsskyddad ODT-fil med Document class
...
{{% blocks/products/pf/agp/code-block title="Kod : Ta bort lösenord från ODT-dokument" offSpacer="" %}}
...
<h2>Utveckla ODT Protection Management Android-applikation</h2>

Need to develop a ODT protection management app or utility? Med [Aspose.Words for Android via Java](https://products.aspose.com/words/sv/android-java/), ett underordnat API av [Aspose.Total for Android via Java](https://products.aspose.com/total/sv/android-java/), kan vilken Android-utvecklare som helst integrera ovanstående API-kod i sitt dokumentskydds- eller avskyddsprogram. Kraftfullt Android-bibliotek tillåter programmering av alla dokumentskyddslösningar. Dessutom kan den stödja många populära format inklusive ODT-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Android-verktyg för att hantera ODT-skydd" %}}
