---
title: Konvertera POTX till DOCM via Java
description: Java API för att exportera POTX till DOCM utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POTX till DOCM via Java" h2="On Premise Java API för PowerPoint POTX till DOCM-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
