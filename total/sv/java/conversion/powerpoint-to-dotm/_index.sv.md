---
title: Konvertera POWERPOINT till DOTM via Java
description: Java API för att exportera POWERPOINT till DOTM utan att använda Microsoft Word eller PowerPoint
url: /sv/java/conversion/powerpoint-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POWERPOINT till DOTM via Java" h2="On Premise Java API för PowerPoint POWERPOINT till DOTM-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
...
För konvertering av POWERPOINT till DOTM-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
