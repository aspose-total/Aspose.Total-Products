---
title: Konvertera TXT till PPT via Java
description: Java API för att exportera TXT till PPT utan att använda Microsoft Word eller PowerPoint
url: /sv/java/conversion/txt-to-ppt/
family: total
platformtag: net
feature: conversion
informat: TXT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera TXT till PPT via Java" h2="TXT till PPT-konvertering genom att använda lokalt Java API inom alla Java J2SE, J2EE, J2ME-applikationer utan att använda Microsoft<sup>&reg;</sup> PowerPoint eller Word" >}}
...
För konvertering av TXT till PPT-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
