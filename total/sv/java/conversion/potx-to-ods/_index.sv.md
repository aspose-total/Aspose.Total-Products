...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POTX till ODS via Java" h2="On Premise Java API för att exportera POTX till ODS utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
...
För att konvertera POTX till ODS kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
