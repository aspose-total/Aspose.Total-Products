---
title: Konvertera PPTX till RTF via Java
description: Java API för att exportera PPTX till RTF utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPTX till RTF via Java" h2="On Premise Java API för PowerPoint PPTX till RTF-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
...
För konvertering av PPTX till RTF-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
