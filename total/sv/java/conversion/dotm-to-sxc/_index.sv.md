...
description: Konvertera DOTM till SXC via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera DOTM till SXC via Java" h2="On Premise Java API för att konvertera DOTM till SXC utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
