---
title: Java API för att exportera PCL till DOTM
description: Konvertera PCL till DOTM med hjälp av det lokala Java API
url_ignore: /sv/java/conversion/pcl-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Förvandla PCL till DOTM via Java" h2="On Premise Java API för att rendera PCL till DOTM utan att använda någon tredjepartsapplikation" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API för att konvertera PCL till DOTM" %}}
