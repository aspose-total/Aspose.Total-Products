---
title: Java API för att konvertera RTF till XLTM
description: Konvertera RTF till XLTM via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/java/conversion/rtf-to-xltm/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera RTF till XLTM via Java" h2="On Premise Java API för att konvertera RTF till XLTM utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
