---
title: Konvertera PPTX till XLT-format via Java
description: Konvertera PPTX till XLT-format via Java utan att använda Microsoft Excel eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPTX till XLT via Java" h2="On Premise Java API för att exportera PPTX till XLT utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
...
2. Konvertera PPTX till HTML genom att använda [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) metod
...
För att konvertera PPTX till XLT kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
