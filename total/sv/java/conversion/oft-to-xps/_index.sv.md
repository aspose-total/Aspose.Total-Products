...
Att konvertera **OFT till XPS** skapar **XML Paper Specification-filer**, vilket möjliggör plattformsoberoende, fast layout-dokumentrepresentation av Outlook-mallar för visning, delning och utskrift.

{{% blocks/products/pf/agp/feature-section-col title="Viktiga användningsfall" %}}

* Bevara mallens layout och formatering över olika enheter
* Dela e-postmallar som fast layout-dokument
* Arkivering av OFT-innehåll för efterlevnad och registerhållning
* Skriva ut mallar med konsekvent utseende
* Visa mallar utan Microsoft Outlook eller Word

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Automatiserade scenarier" %}}

* Automatisk OFT-till-XPS-konvertering för företagsdistribution
* Integration med dokumenthanteringssystem
* Batch-generering av fast layout-arkiv från e-postmallar
* Pipelin för säker delning och utskrift av mallar
* Långsiktig arkivering av Outlook-malldesigner
