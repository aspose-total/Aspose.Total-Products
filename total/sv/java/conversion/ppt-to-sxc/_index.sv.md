...
description: Konvertera PPT till SXC-format via Java utan att använda Microsoft Excel eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPT till SXC via Java" h2="On Premise Java API för att exportera PPT till SXC utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
