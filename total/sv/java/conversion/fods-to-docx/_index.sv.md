---
title: Konvertera FODS till DOCX med Java
description: Java API för att exportera FODS till DOCX med hjälp av Excel eller Word
url: /sv/java/conversion/fods-to-docx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API för att exportera FODS till DOCX" h2="On Premise Java API för att exportera FODS till DOCX utan att förlita sig på Microsoft Excel&reg;" >}}
