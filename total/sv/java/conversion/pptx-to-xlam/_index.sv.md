...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPTX till XLAM via Java" h2="On Premise Java API för att exportera PPTX till XLAM utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
...
För att konvertera PPTX till XLAM kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
