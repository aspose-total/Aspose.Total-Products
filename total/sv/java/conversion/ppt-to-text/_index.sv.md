...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPT till TEXT via Java" h2="On Premise Java API för PowerPoint PPT till TEXT-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
...
För konvertering av PPT till TEXT-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
