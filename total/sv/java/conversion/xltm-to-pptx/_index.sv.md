...
description: Java API för att exportera XLTM till PPTX med hjälp av Excel eller Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API för att exportera XLTM till PPTX" h2="On Premise Java API för att exportera XLTM till PPTX utan att förlita sig på Microsoft Excel&reg;" >}}
...
1. Öppna XLTM-filen med klassen [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/net/conversion/xltm-to-pptxx/" name="XLTM Till PPTXX" description="" >}}
