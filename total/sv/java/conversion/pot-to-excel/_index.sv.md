...
description: Konvertera POT till EXCEL-format via Java utan att använda Microsoft Excel eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till EXCEL via Java" h2="On Premise Java API för att exportera POT till EXCEL utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
...
För att konvertera POT till EXCEL kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
