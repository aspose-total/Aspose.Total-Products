---
title: Konvertera XLT till POWERPOINT med Java
description: Java API för att exportera XLT till POWERPOINT med hjälp av Excel eller Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API för att exportera XLT till POWERPOINT" h2="On Premise Java API för att exportera XLT till POWERPOINT utan att förlita sig på Microsoft Excel&reg;" >}}
...
4. Spara dokumentet i POWERPOINT-format med [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-) och ställ in Powerpoint som SaveFormat
