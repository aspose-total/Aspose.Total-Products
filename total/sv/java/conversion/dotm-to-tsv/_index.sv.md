---
title: Java API för att konvertera DOTM till TSV
description: Konvertera DOTM till TSV via Java utan att använda Microsoft Word eller Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera DOTM till TSV via Java" h2="On Premise Java API för att konvertera DOTM till TSV utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTM till TSV" %}}
