...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API för att exportera SXC till DOCX eller online" h2="On Premise Java API för att exportera SXC till DOCX eller online utan att förlita sig på Microsoft Excel<sup>&reg;</sup>" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hur man konverterar SXC till DOCX via Java API" %}}
...
<h3>Online-omvandlare för SXC till DOCX</h3>
