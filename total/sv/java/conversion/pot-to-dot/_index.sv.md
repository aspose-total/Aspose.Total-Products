---
title: Konvertera POT till DOT via Java
description: Java API för att exportera POT till DOT utan att använda Microsoft Word eller PowerPoint
url: /sv/java/conversion/pot-to-dot/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till DOT via Java" h2="On Premise Java API för PowerPoint POT till DOT-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
...
3. Ladda den konverterade HTML-filen med klassen [Dotument](https://apireference.aspose.com/words/java/com.aspose.words/Dotument)
4. Spara dokumentet i DOT-format med metoden [save](https://apireference.aspose.com/words/java/com.aspose.words/Dotument#save(java.lang.String,int))
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Konverteringskrav" %}}
För konvertering av POT till DOT-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
