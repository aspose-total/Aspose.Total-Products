...
description: Konvertera WORD till EXCEL via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/java/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera WORD till EXCEL via Java" h2="On Premise Java API för att konvertera WORD till EXCEL utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
