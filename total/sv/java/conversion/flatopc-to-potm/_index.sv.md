---
title: Konvertera FLATOPC till POTM via Java
description: Java API för att exportera FLATOPC till POTM utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera FLATOPC till POTM via Java" h2="FLATOPC till POTM-konvertering genom att använda lokalt Java API inom alla Java J2SE, J2EE, J2ME-applikationer utan att använda Microsoft<sup>&reg;</sup> PowerPoint eller Word" >}}
...
För konvertering av FLATOPC till POTM-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
