---
title: Java API för att konvertera RTF till XLSM
description: Konvertera RTF till XLSM via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/java/conversion/rtf-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera RTF till XLSM via Java" h2="On Premise Java API för att konvertera RTF till XLSM utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
