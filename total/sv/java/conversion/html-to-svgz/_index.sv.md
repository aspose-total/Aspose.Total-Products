...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera HTML till SVGZ via Java" h2="Exportera HTML-fil till SVGZ inom valfri Java J2SE, J2EE, J2ME-applikation utan att använda Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Exportera HTML till SVGZ via Java" %}}
...
{{% /blocks/products/pf/feature-page-code %}}
{{< /blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/feature-page-section  h2="Konvertera HTML till SVGZ i en enda fil via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera HTML till SVGZ med vattenstämpel via Java" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konvertera och rotera HTML till SVGZ-fil via Java" %}}
