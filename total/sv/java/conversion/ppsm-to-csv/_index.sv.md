---
title: Konvertera PPSM till CSV-format via Java
description: Konvertera PPSM till CSV-format via Java utan att använda Microsoft Excel eller PowerPoint
url: /sv/java/conversion/ppsm-to-csv/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPSM till CSV via Java" h2="On Premise Java API för att exportera PPSM till CSV utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
...
2. Konvertera PPSM till HTML genom att använda [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) metod
...
För att konvertera PPSM till CSV kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
