...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera XSLFO till DICOM via Java" h2="Exportera XSLFO-fil till DICOM inom valfri Java J2SE, J2EE, J2ME-applikation utan att använda Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Exportera XSLFO till DICOM via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera XSLFO till DICOM med vattenstämpel via Java" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konvertera och rotera XSLFO till DICOM-fil via Java" %}}
