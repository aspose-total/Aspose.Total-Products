---
title: Konvertera POWERPOINT till OTT via Java
description: Java API för att exportera POWERPOINT till OTT utan att använda Microsoft Word eller PowerPoint
url: /sv/java/conversion/powerpoint-to-ott/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POWERPOINT till OTT via Java" h2="On Premise Java API för PowerPoint POWERPOINT till OTT-konvertering inom alla Java J2SE, J2EE, J2ME-applikationer" >}}
...
För konvertering av POWERPOINT till OTT-fil kan du enkelt använda Aspose.Total för Java direkt från en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) baserat projekt och inkludera bibliotek i din pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/net/conversion/powerpoint-to-ottm/" name="POWERPOINT Till OTTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/net/conversion/powerpoint-to-ottx/" name="POWERPOINT Till OTTX" description="" >}}
