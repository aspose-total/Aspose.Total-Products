---
title: Konvertera TSV till WORD med Java
description: Java API för att exportera TSV till WORD med hjälp av Excel eller Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API för att exportera TSV till WORD" h2="On Premise Java API för att exportera TSV till WORD utan att förlita sig på Microsoft Excel&reg;" >}}
...
1. Öppna TSV-filen med klassen [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
