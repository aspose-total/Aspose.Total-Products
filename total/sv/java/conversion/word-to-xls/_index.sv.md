...
description: Konvertera WORD till XLS via Java utan att använda Microsoft Word eller Microsoft Excel
url: /sv/java/conversion/word-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera WORD till XLS via Java" h2="On Premise Java API för att konvertera WORD till XLS utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
