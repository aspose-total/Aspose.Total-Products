---
title: Slå samman ODT-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika ODT-filer..NET sammanfogar bibliotekskod för att slå samman ODT-dokument.
...
{{< blocks/products/pf/feature-page-header-widget h1="Slå samman ODT-dokument online via Merger-appen eller med .NET" h2="Utveckla kraftfulla .NET-baserade ODT dokumentsammanslagningsprogram.Kombinera flera ODT-dokument till ett enda online gratis via app.Spara ODT-fil som PDF, bilder, Word, Excel, PowerPoint och många andra format online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman ODT-fil via .NET" %}}

1. Skapa dokumentklassobjekt
1. Ladda båda dokumenten i två separata dokumentklassobjekt
1. Använd funktionen AppendDocument för att kombinera dokumenten
1. Ring Spara-metoden och få de sammanslagna ODT-filerna till en
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman ODT-filer" offSpacer="" %}}
...
<h2>Utveckla ODT File Merger med .NET</h2>

Behöver du utveckla en .NET-app för att enkelt slå samman flera ODT-filer?Med [Aspose.Words for .NET](https://products.aspose.com/words/sv/net/) underordnade API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/) kan alla .NET-utvecklare integrera ovanstående API-kod för att programmera sammanslagningsappar över dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive ODT-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library för ODT-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan enkelt utveckla en professionell lösning för att kombinera ODT med .NET.Använd Aspose ODT sammanslagnings-API för att utveckla plattformsoberoende mjukvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
