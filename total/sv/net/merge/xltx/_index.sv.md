---
title: Slå samman XLTX-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika XLTX-filer.C# .NET slår samman bibliotekskod för att slå samman XLTX-kalkylblad till andra format.
...
{{< blocks/products/pf/feature-page-header-widget h1="Slå samman XLTX-dokument online via Merger-appen eller med .NET" h2="Utveckla kraftfulla .NET-baserade XLTX dokumentsammanslagningsprogram.Kombinera flera XLTX-dokument till ett enda online gratis via app.Spara sammanslagen XLTX-fil som PDF, bilder, Word, Excel, PowerPoint och många andra format online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman XLTX-fil via .NET" %}}

1. Ladda båda XLTX med Workbook-klassobjekt.
1. Välj den ena arbetsboken som basfil.
1. Använd Combine-metoden med basobect och andra XLTX-filobjekt som parameter.
1. Ring Spara-metoden och få de sammanslagna XLTX-filerna till en.
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman XLTX-filer" offSpacer="" %}}
...
<h2>Utveckla XLTX File Merger med .NET</h2>

Behöver du utveckla en .NET-app för att enkelt slå samman flera XLTX-filer?Med [Aspose.Cells for .NET](https://products.aspose.com/cells/sv/net/), barn-API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod för att enkelt sammanfoga dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive XLTX-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merging Library för XLTX-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan utveckla en professionell lösning för att kombinera XLTX med .NET.Använd XLTX sammanslagnings-API för att utveckla plattformsoberoende programvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
