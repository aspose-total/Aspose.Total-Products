---
title: Slå samman TSV-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika TSV-filer.C# .NET slår samman bibliotekskod för att slå samman TSV-kalkylblad till andra format.
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman TSV-fil via .NET" %}}

1. Ladda båda TSV med Workbook-klassobjekt.
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman TSV-filer" offSpacer="" %}}
...
<h2>Utveckla TSV File Merger med .NET</h2>

Behöver du utveckla en .NET-app för att enkelt slå samman flera TSV-filer?Med [Aspose.Cells for .NET](https://products.aspose.com/cells/sv/net/), barn-API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod för att enkelt sammanfoga dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive TSV-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merging Library för TSV-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan utveckla en professionell lösning för att kombinera TSV med .NET.Använd TSV sammanslagnings-API för att utveckla plattformsoberoende programvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
