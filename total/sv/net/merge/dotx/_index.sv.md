---
title: Slå samman DOTX-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika DOTX-filer..NET sammanfogar bibliotekskod för att slå samman DOTX-dokument.
...
{{< blocks/products/pf/feature-page-header-widget h1="Slå samman DOTX-dokument online via Merger-appen eller med .NET" h2="Utveckla kraftfulla .NET-baserade DOTX dokumentsammanslagningsprogram.Kombinera flera DOTX-dokument till ett enda online gratis via app.Spara DOTX-fil som PDF, bilder, Word, Excel, PowerPoint och många andra format online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman DOTX-fil via .NET" %}}
...
1. Ring Spara-metoden och få de sammanslagna DOTX-filerna till en
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman DOTX-filer" offSpacer="" %}}
...
<h2>Utveckla DOTX File Merger med .NET</h2>

Behöver du utveckla en .NET-app för att enkelt slå samman flera DOTX-filer?Med [Aspose.Words for .NET](https://products.aspose.com/words/sv/net/) underordnade API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/) kan alla .NET-utvecklare integrera ovanstående API-kod för att programmera sammanslagningsappar över dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive DOTX-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library för DOTX-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan enkelt utveckla en professionell lösning för att kombinera DOTX med .NET.Använd Aspose DOTX sammanslagnings-API för att utveckla plattformsoberoende mjukvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
