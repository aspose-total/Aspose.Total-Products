---
title: Slå samman XLS-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika XLS-filer.C# .NET slår samman bibliotekskod för att slå samman XLS-kalkylblad till andra format.
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman XLS-fil via .NET" %}}

1. Ladda båda XLS med Workbook-klassobjekt.
1. Välj den ena arbetsboken som basfil.
1. Använd Combine-metoden med basobect och andra XLS-filobjekt som parameter.
1. Ring Spara-metoden och få de sammanslagna XLS-filerna till en.
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman XLS-filer" offSpacer="" %}}
...
<h2>Utveckla XLS File Merger med .NET</h2>

Behöver du utveckla en .NET-app för att enkelt slå samman flera XLS-filer?Med [Aspose.Cells for .NET](https://products.aspose.com/cells/sv/net/), barn-API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod för att enkelt sammanfoga dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive XLS-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merging Library för XLS-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan utveckla en professionell lösning för att kombinera XLS med .NET.Använd XLS sammanslagnings-API för att utveckla plattformsoberoende programvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Är det säkert att använda onlineappen för att kombinera flera XLS-dokument?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Du kan använda vilken modern webbläsare som helst som Google Chrome, Firefox, Opera eller Safari för att sammanfoga XLS-dokument online.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hur kan jag slå ihop flera XLS-filer?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Börja med att ladda upp en eller flera filer du vill slå samman. Du kan antingen dra och släppa dina XLS-filer eller helt enkelt klicka i det vita området.Klicka sedan på knappen "Slå samman" så kommer vår sammanslagning snabbt att bearbeta de uppladdade filerna.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hur lång tid tar det att slå samman XLS-filerna?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
