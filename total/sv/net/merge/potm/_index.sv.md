---
title: Slå samman POTM-filer online eller med .NET
description: Gratis onlineapp för att kombinera olika POTM-presentationer.C# .NET slår samman bibliotekskod för att slå samman POTM-presentation till valfritt format.
...
{{< blocks/products/pf/feature-page-header-widget h1="Slå samman POTM-dokument online via Merger-appen eller med .NET" h2="Utveckla kraftfulla .NET-baserade POTM dokumentsammanslagningsprogram.Kombinera flera POTM-dokument till ett enda online gratis via app.Spara sammanslagen POTM-fil som PDF, bilder, Word, Excel, PowerPoint och många andra format online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Slå samman POTM-fil via .NET" %}}

1. Ladda POTM med Presentation class object
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Slå samman POTM-filer" offSpacer="" %}}
...
<h2>Utveckla POTM File Merger med .NET</h2>

Behöver du utveckla en .NET merger-app för att enkelt slå samman flera POTM-filer?Med [Aspose.Slides for .NET](https://products.aspose.com/slides/sv/net/), barn-API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod för att enkelt sammanfoga dokument.Kraftfullt .NET-bibliotek för sammanslagning av dokument stöder många populära format inklusive POTM-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merging Library för POTM-filer" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden. Man kan enkelt utveckla en professionell lösning för att kombinera POTM med .NET. Använd POTM sammanslagnings-API för att utveckla plattformsoberoende programvara på hög nivå i .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
