---
title: Uppdatera XLT-fil med .NET
description: Ändra XLT-dokument i C# VB.NET-applikationer utan att använda Microsoft Excel. 
url: /sv/net/update/xlt/
family: total
platformtag: .NET
feature: update
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Uppdatera XLT-fil via .NET" h2="Ändra XLT-kalkylblad via dina .NET-baserade applikationer utan att installera Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

För en utvecklare, vem försöker uppdatera XLT-filer via .NET-applikationen? [Aspose.Total for .NET](https://products.aspose.com/total/net/) API kan hjälpa till att automatisera uppdateringsprocessen. Det är ett komplett paket med olika .NET API:er som hanterar olika format inklusive Microsoft Excel-filer. ASPOSE.CELL API som är en del av [Aspose.Total for .NET](https://products.aspose.com/total/net/)-paketet gör denna modifieringsprocessen enkel. Nedan följer processen för att uppdatera XLT-dokumentet.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Hur man uppdaterar XLT-fil i .NET" %}}

- Skapa nytt [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/)-klassobjekt med käll-XLT-filen som parameter
...
- Spara filen som .xlt-fil med metoden save() genom att skicka filen med sökvägen som parameter

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Ändringskrav" %}}

- För XLT-modifiering, Microsoft Windows eller ett kompatibelt operativsystem med .NET, .NET Core, Mono eller Xamarin-plattformar
...
{{% blocks/products/pf/agp/code-block title="Kod - Uppdatera XLT-fil i .NET" offSpacer="" %}}
