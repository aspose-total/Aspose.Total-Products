---
title: Ta bort DOCM Annotation Online eller Hantera Annotations via .NET
description: ta bort kommentarer från DOCM-filen via onlineappen gratis..NET API-kod för att hantera kommentarer för DOCM-filer.
...
{{< blocks/products/pf/feature-page-header-widget h1="Rensa kommentarer från DOCM-dokument online eller hantera via .NET" h2="Utveckla kraftfulla .NET-baserade DOCM-dokumentanteckningsverktyg.Kod listad för att hantera kommentarer för DOCM-fil via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ta bort Specific Author DOCM Document Comments via .NET" %}}

1. Lägg till biblioteksreferens till .NET-projektet
1. Ladda dokument via dokumentklassobjekt
1. Få alla nodkommentarer genom att använda GetChildNodes som har NodeType.Comment
1. Iterera igenom alla kommentarer och matcha författarens namn
1. Anropa metoden Ta bort för att ta bort den specifika författarekommentaren
...
{{% blocks/products/pf/agp/code-block title="C#-kod: Ta bort specifika författarekommentarer från DOCM-fil" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lägg till kommentarer via .NET" %}}

1. Skapa dokumentklassobjekt
1. Använd klassen Kommentar
1. Lägg till det nya stycket med Paragraphs.Add
1. Använd FirstParagraph.Runs.Add lägg till kommentaren
...
1. Ladda dokument via dokumentklassobjekt
1. Skapa ett ArrayList-objekt
1. Få alla GetChildNodes i NodeCollection
1. Iterera genom varje samling och lägg till kommentarer i ArrayList
...
{{% blocks/products/pf/agp/code-block title=".NET-kod : Lägg till kommentar från DOCM-fil" offSpacer="" %}}
...
<h2>Utveckla DOCM Document Annotation Application via .NET</h2>

Behöver du utveckla en DOCM-anteckningsapp eller ett verktyg för att ge feedback, ge förslag eller samarbeta med andra om dokumentet?Med [Aspose.Words for .NET](https://products.aspose.com/words/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentanteckningsapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentkommentarer.Dessutom kan den stödja många populära format inklusive DOCM-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-bibliotek för att kommentera DOCM-filer" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, du är välkommen att ladda ner den här koden och använda den för att utveckla ett .NET-baserat dokumentanteckningsprogram.Den här koden kan fungera som en värdefull resurs för att förbättra funktionaliteten och kapaciteten hos dina projekt inom området backend-dokumentbehandling och -manipulation.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
