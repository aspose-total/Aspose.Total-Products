---
title: Ta bort Excel Annotation Online eller Hantera Annotations via .NET
description: ta bort kommentarer från Excel-filen via onlineappen gratis..NET API-kod för att hantera kommentarer för Excel-filer.
...
{{< blocks/products/pf/feature-page-header-widget h1="Rensa kommentarer från Excel-dokument online eller hantera via .NET" h2="Utveckla kraftfulla .NET-baserade Excel-dokumentanteckningsverktyg.Kod listad för att hantera kommentarer för Excel-fil via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ta bort Excel-kommentarer via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Ta bort kommentarer från Excel-fil" offSpacer="" %}}
...
<h2>Utveckla Excel Document Annotation Application via .NET</h2>

Behöver du utveckla en Excel-anteckningsapp eller ett verktyg för att ge feedback, ge förslag eller samarbeta med andra om dokumentet?Med [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentanteckningsapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentkommentarer.Dessutom kan den stödja många populära format inklusive Excel-format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-bibliotek för att kommentera Excel-filer" %}}
