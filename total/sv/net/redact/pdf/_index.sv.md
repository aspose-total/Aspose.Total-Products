---
title: Redigera PDF-dokument online eller med .NET
description: Öppna och redigera PDF-dokument online via app gratis. .NET API C#-kod för att söka och ersätta PDF-text.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redigera PDF-dokument online eller via .NET" h2="Utveckla kraftfull .NET-baserad PDF-dokumentredigeringsprogram.C#-kod listad för att söka och ersätta text i PDF-fil via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redigera PDF-fil via .NET" %}}
...
1. Få alla TextFragment i TextFragmentCollection
1. Iterera genom varje fragmentsamling
1. Definiera RedactionAnnotation och anrop Redact()-metoden
...
{{% blocks/products/pf/agp/code-block title="C#-kod: Redact PDF-fil" offSpacer="" %}}
...
<h2>Utveckla PDF Redaction Application via .NET</h2>

Behöver du utveckla en PDF-redigeringsapp eller ett verktyg?Med [Aspose.PDF for .NET](https://products.aspose.com/pdf/sv/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentredigeringsapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentredigeringslösningar. Dessutom kan den stödja många populära format inklusive PDF-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att redigera PDF-fil" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Är det säkert att använda onlineappen för att hantera PDF-dokumentredigering?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Du kan använda vilken modern webbläsare som helst som Google Chrome, Firefox, Opera eller Safari för onlineredigering av PDF-dokument.Men om du utvecklar ett skrivbordsprogram rekommenderar vi att du använder Aspose.Total-dokumentbearbetnings-API:et för effektiv hantering.</span>
                      </div>
                  </li>
              </ul>
          </div>
