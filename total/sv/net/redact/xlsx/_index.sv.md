---
title: Redagera XLSX-kalkylblad online eller med .NET
description: Öppna och redigera XLSX-dokument online via app gratis. .NET API C#-kod för att söka och ersätta XLSX-text.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redigera XLSX-dokument online eller via .NET" h2="Utveckla kraftfull .NET-baserad XLSX-dokumentredigeringsprogram. C#-kod listad för att söka och ersätta text i XLSX-fil." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redigera XLSX-fil via .NET" %}}

1. Lägg till biblioteksreferens till .NET-projektet
1. Ladda XLSX-fil med Workbook-klassen
1. Skaffa det relevanta bladet med hjälp av dess index
1. Använd klassen FindOptions och ställ in alternativen
1. Använd sökmetoden för att hitta den relevanta texten
1. Iterera genom varje cell och använd PutValue för att uppdatera värdet
1. Eller använd metoden Ersätt för att hitta och ersätta i hela arbetsboken
...
{{% blocks/products/pf/agp/code-block title="C#-kod: Redact XLSX-kalkylblad" offSpacer="" %}}
...
<h2>Utveckla XLSX Redaction Application via .NET</h2>

Behöver du utveckla en XLSX-redigeringsapp eller ett verktyg? Med [Aspose.Cells for .NET](https://products.aspose.com/cells/sv/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentredigeringsapplikation. Kraftfullt .NET-bibliotek gör det möjligt att programmera alla redigeringslösningar för kalkylblad. Dessutom kan den stödja många populära format inklusive XLSX-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att redigera XLSX-fil" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📊 Redigering i .xlsx (Microsoft Excel)

- Redigera anställdas löner, bonusar eller personuppgifter i lönefiler.
- Redigera kund- eller leverantörsinformation i försäljnings- eller inköpsrapporter.
- Redigera interna budgettilldelningar eller vinstmarginaler i finansiella arbetsböcker.
- Redigera konfidentiella data i prestandadashboards eller KPI-spårningsblad.
