---
title: Ta bort ODP lösenordsskydd online eller med .NET
description: Ta bort lösenordet från ODP-dokumentet via onlineappen gratis..NET C# API-kod för att låsa upp lösenordsskyddade ODP-filer.
...
{{< blocks/products/pf/feature-page-header-widget h1="Lås upp ODP-dokumentlösenord online eller via .NET" h2="Utveckla kraftfulla .NET-baserade ODP-dokumentlåsnings- och upplåsningsapplikationer.Kod listad för att ta bort lösenordsbegränsningar från ODP-fil via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ta bort ODP-lösenord via .NET" %}}

1. Ladda ODP-fil med presentationsklass med laddningsalternativ
...
{{% blocks/products/pf/agp/code-block title=".NET-kod : Ta bort lösenord från ODP-dokument" offSpacer="" %}}
...
<h2>Utveckla ODP Protection Management Application via .NET</h2>

Behöver du utveckla en ODP-skyddshanteringsapp eller ett verktyg?Med [Aspose.Slides for .NET](https://products.aspose.com/slides/sv/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sitt dokumentskydds- eller avskyddsprogram.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentskyddslösningar.Dessutom kan den stödja många populära format inklusive ODP-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att hantera ODP-skydd" %}}
