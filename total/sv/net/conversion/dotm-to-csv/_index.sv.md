---
title: .NET API för att konvertera DOTM till CSV eller med gratis Online Converter
description: C# API för att konvertera DOTM till CSV eller onlineapp utan att använda Microsoft Excel eller Adobe Reader eller online. Testa gratis DOTM till CSV online-omvandlare snabbt innan du integrerar koden. 
url_ignore: /sv/net/conversion/dotm-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOTM till CSV eller onlineapp" h2="Exportera DOTM till CSV via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
