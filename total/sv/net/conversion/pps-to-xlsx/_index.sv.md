---
title: Konvertera PPS till XLSX via C#
description: Konvertera PPS till XLSX i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till XLSX via C#" h2=".NET API för PPS till XLSX-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
