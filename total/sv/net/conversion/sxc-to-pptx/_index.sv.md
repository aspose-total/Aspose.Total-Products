---
title: Konvertera SXC till PPTX med .NET 
description: Konvertera SXC till PPTX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera SXC till PPTX via C#" h2="Exportera Excel&reg; SXC till PPTX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar">}}
