---
title: Konvertera XLSM till DOCX med .NET 
description: Konvertera XLSM till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera XLSM till DOCX via C#" h2="Exportera Excel&reg; XLSM till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar">}}
