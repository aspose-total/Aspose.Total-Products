...
description: C# API för att konvertera WORD till DIF utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/word-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera WORD till DIF" h2="Exportera WORD till DIF via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
