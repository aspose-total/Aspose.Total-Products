---
title: Konvertera POT till XLAM via C#
description: Konvertera POT till XLAM i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till XLAM via C#" h2=".NET API för POT till XLAM-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
