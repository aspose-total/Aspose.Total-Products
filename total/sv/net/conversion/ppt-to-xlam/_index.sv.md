---
title: Konvertera PPT till XLAM via C#
description: Konvertera PPT till XLAM i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPT till XLAM via C#" h2=".NET API för PPT till XLAM-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
