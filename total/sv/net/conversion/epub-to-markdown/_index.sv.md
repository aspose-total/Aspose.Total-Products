...
4. Spara dokumentet i MARKDOWN-format med metoden [Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) och ställ in Markdown som SaveFormat
