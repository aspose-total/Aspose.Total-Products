...
description: C# API för att konvertera DOT till TSV utan att använda Microsoft Excel eller Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOT till TSV" h2="Exportera DOT till TSV via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
