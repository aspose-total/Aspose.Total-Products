---
title: Konvertera PPS till XLT via C#
description: Konvertera PPS till XLT i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till XLT via C#" h2=".NET API för PPS till XLT-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
