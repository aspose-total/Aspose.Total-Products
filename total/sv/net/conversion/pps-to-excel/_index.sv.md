---
title: Konvertera PPS till EXCEL via C#
description: Konvertera PPS till EXCEL i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till EXCEL via C#" h2=".NET API för PPS till EXCEL-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
