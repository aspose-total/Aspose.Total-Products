---
title: Konvertera PPT till SXC via C#
description: Konvertera PPT till SXC i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPT till SXC via C#" h2=".NET API för PPT till SXC-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
