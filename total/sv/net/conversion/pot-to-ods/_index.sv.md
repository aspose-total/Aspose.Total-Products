---
title: Konvertera POT till ODS via C#
description: Konvertera POT till ODS i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till ODS via C#" h2=".NET API för POT till ODS-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
