...
description: Konvertera PPSM till MARKDOWN i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPSM till MARKDOWN via C#" h2=".NET API för PPSM till MARKDOWN-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
