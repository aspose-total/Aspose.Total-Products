---
title: Konvertera XLS till DOC med .NET 
description: Konvertera XLS till DOC på .NET Framework, .NET Core, Mono eller Xamarin-plattformar
url: /sv/net/conversion/xls-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera XLS till DOC via C#" h2="Exportera Excel&reg; XLS till DOC på .NET Framework, .NET Core, Mono eller Xamarin-plattformar">}}
