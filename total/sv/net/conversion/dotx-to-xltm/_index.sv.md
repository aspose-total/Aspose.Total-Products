...
description: C# API för att konvertera DOTX till XLTM utan att använda Microsoft Excel eller Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOTX till XLTM" h2="Exportera DOTX till XLTM via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
