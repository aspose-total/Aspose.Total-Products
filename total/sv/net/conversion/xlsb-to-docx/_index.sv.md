---
title: Konvertera XLSB till DOCX med .NET 
description: Konvertera XLSB till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera XLSB till DOCX via C#" h2="Exportera Excel&reg; XLSB till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar">}}
