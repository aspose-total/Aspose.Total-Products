---
title: Konvertera PPS till CSV via C#
description: Konvertera PPS till CSV i C# utan att använda Microsoft Excel eller Powerpoint
url: /sv/net/conversion/pps-to-csv/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till CSV via C#" h2=".NET API för PPS till CSV-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
