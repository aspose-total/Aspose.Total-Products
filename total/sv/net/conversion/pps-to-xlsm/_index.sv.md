...
description: Konvertera PPS till XLSM i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till XLSM via C#" h2=".NET API för PPS till XLSM-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
