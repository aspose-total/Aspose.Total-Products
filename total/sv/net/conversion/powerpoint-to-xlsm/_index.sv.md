...
description: Konvertera POWERPOINT till XLSM i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POWERPOINT till XLSM via C#" h2=".NET API för POWERPOINT till XLSM-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
