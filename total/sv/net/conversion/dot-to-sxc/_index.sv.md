---
title: .NET API för att konvertera DOT till SXC
description: C# API för att konvertera DOT till SXC utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/dot-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOT till SXC" h2="Exportera DOT till SXC via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
