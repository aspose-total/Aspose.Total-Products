...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till JSON-format via C#" h2="Exportera POT till JSON via C# utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Genom att använda [Aspose.Total for .NET](https://products.aspose.com/total/net/) kan du konvertera POT till JSON-format i valfri .NET, C#, ASP.NET och VB.NET applikation i två enkla steg. För det första, genom att använda [Aspose.Slides for .NET](https://products.aspose.com/slides/net/), kan du exportera POT till HTML. Efter det, genom att använda [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, kan du konvertera HTML till JSON.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertera POT till JSON-format via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera skyddad POT till JSON-format via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera POT till JSON i Range via C#" %}}
