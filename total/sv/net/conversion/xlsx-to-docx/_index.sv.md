---
title: Konvertera XLSX till DOCX med .NET 
description: Konvertera XLSX till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertera XLSX till DOCX via C#" h2="Exportera Excel&reg; XLSX till DOCX på .NET Framework, .NET Core, Mono eller Xamarin-plattformar">}}
