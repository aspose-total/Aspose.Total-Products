---
title: .NET API för att konvertera DOT till CSV
description: C# API för att konvertera DOT till CSV utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/dot-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOT till CSV" h2="Exportera DOT till CSV via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
