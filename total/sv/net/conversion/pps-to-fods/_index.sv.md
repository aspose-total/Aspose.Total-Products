...
description: Konvertera PPS till FODS i C# utan att använda Microsoft Excel eller Powerpoint
url: /sv/net/conversion/pps-to-fods/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till FODS via C#" h2=".NET API för PPS till FODS-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
