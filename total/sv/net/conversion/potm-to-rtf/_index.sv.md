---
title: Konvertera POTM till RTF via C# .NET 
url: /sv/net/conversion/potm-to-rtf/ 
...
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera POTM till RTF med C#" h2="Bygg Microsoft PowerPoint POTM-presentation till Word RTF-dokumentkonverteringsappar på .NET Framework, .NET Core, Windows Azure, Mono eller Xamarin-plattformar." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="RTFM" >}}
...
1. Skapa [Aspose.Words.Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument) och initialisera det med MemoryStream Object
1. Spara dokumentet med [Aspose.Words.Rtfument.Save("output.rtf", SaveFormat.Rtf)](https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods /3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/net/conversion/potm-to-rtfx" name="POTM Till RTFX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/net/conversion/potm-to-rtfm" name="POTM Till RTFM" description="" >}}
