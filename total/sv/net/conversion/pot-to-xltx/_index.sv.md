---
title: Konvertera POT till XLTX via C#
description: Konvertera POT till XLTX i C# utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POT till XLTX via C#" h2=".NET API för POT till XLTX-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
