...
description: C# API för att konvertera WORDML till SXC utan att använda Microsoft Excel eller Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera WORDML till SXC" h2="Exportera WORDML till SXC via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
