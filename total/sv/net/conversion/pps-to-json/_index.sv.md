---
title: Konvertera PPS till JSON-format via .NET
description: Konvertera PPS till JSON i C# utan att använda Microsoft Excel eller Powerpoint
url_ignore: /sv/net/conversion/pps-to-json/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera PPS till JSON-format via C#" h2="Exportera PPS till JSON via C# utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Genom att använda [Aspose.Total for .NET](https://products.aspose.com/total/net/) kan du konvertera PPS till JSON-format i valfri .NET, C#, ASP.NET och VB.NET applikation i två enkla steg. För det första, genom att använda [Aspose.Slides for .NET](https://products.aspose.com/slides/net/), kan du exportera PPS till HTML. Efter det, genom att använda [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, kan du konvertera HTML till JSON.
{{% /blocks/products/pf/feature-page-summary  %}}
...
2. Konvertera PPS till HTML med metoden [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Konvertera PPS till JSON i Range via C#" %}}
