...
description: Konvertera POWERPOINT till XLTX i C# utan att använda Microsoft Excel eller Powerpoint
url: /sv/net/conversion/powerpoint-to-xltx/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertera POWERPOINT till XLTX via C#" h2=".NET API för POWERPOINT till XLTX-konvertering utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
