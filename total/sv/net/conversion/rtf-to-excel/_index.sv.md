---
title: .NET API för att konvertera RTF till EXCEL
description: C# API för att konvertera RTF till EXCEL utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/rtf-to-excel/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera RTF till EXCEL" h2="Exportera RTF till EXCEL via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Öppna RTF-filen med klassen [Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument)
2. Konvertera RTF till HTML med metoden [Save](https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods/4)
...
När du konverterar RTF till EXCEL gör [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) det möjligt för dig att lägga till anpassade egenskaper i dina EXCEL-dokument. För att lägga till en anpassad egenskap kan du använda metoden [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customrtfumentpropertycollection/methods/add/index) för [CustomRtfumentPropertyCollection](https://apireference.aspose.com/cells/net/aspose.cells.properties/customrtfumentpropertycollection) klass. Add-metoden lägger till egenskapen i Excel-filen och returnerar en referens för den nya dokumentegenskapen som en [Aspose.Cells.Properties.RtfumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /rtfumentproperty) objekt. 
{{% blocks/products/pf/feature-page-code %}}
