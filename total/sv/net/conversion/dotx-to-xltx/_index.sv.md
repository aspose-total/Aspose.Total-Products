...
description: C# API för att konvertera DOTX till XLTX utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/dotx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOTX till XLTX" h2="Exportera DOTX till XLTX via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
