---
title: Skydda PDF Document Online med lösenord och med .NET
description: Online PDF fil lösenordsskydd app..NET C# API-kod för att tillämpa lösenordsskydd på PDF-dokument.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online PDF-dokumentskydd eller ange lösenord via .NET" h2="Utveckla kraftfulla .NET-baserade PDF-dokumentskyddsprogram.Kod listad för applicering av lösenord till PDF-dokument via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PDF Lösenordsskydd via .NET" %}}

1. Ladda PDF-filen via Document class
1. Anropa kryptera metoden
1. Ange lösenord, förbyar och skyddstyp som parametrar
1. Anropa metoden Spara för att spara det skyddade dokumentet
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: PDF-dokumentlösenordsskydd" offSpacer="" %}}
...
<h2>Utveckla PDF lösenordsskyddsprogram via .NET</h2>

Behöver du utveckla en PDF lösenordsskyddsapp eller ett verktyg?Med [Aspose.PDF for .NET](https://products.aspose.com/pdf/sv/net/) ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentskyddsapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentlösenordsskyddslösningar för att säkra och låsa filerna.Dessutom kan den stödja många populära format inklusive PDF-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att bearbeta PDF-fil för skyddsapp" %}}
