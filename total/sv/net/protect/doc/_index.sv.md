---
title: Skydda DOC-dokument Online med lösenord och med .NET
description: Online DOC fil lösenordsskydd app. C# .NET API-kod för att tillämpa lösenordsskydd på DOC-dokument.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online DOC-dokumentskydd eller ange lösenord via .NET" h2="Utveckla kraftfulla .NET-baserade DOC-dokumentskyddsprogram.Kod listad för applicering av lösenord till DOC-dokument via .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Online DOC lösenordsskydd via app" %}}
...
1. Använd objektet anropa Protect()-metoden
1. Ange skyddstypen som Tillåt endast formulärfält och lösenord som parametrar
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: DOC-dokumentlösenordsskydd" offSpacer="" %}}
...
<h2>Utveckla DOC lösenordsskyddsprogram via .NET</h2>

Behöver du utveckla en DOC lösenordsskyddsapp eller ett verktyg?Med [Aspose.Words for .NET](https://products.aspose.com/words/sv/net/) ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentskyddsapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentlösenordsskyddslösningar för att säkra och låsa filerna.Dessutom kan den stödja många populära format inklusive DOC-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att bearbeta DOC-fil för skyddsapp" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Är det säkert att använda onlineappen för att säkra DOC-dokument?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Du kan använda vilken modern webbläsare som helst som Google Chrome, Firefox, Opera eller Safari för online DOC-dokumentskydd.Men om du utvecklar ett skrivbordsprogram rekommenderar vi att du använder Aspose.Total-dokumentbearbetnings-API:et för effektiv hantering.</span>
                      </div>
                  </li>
              </ul>
          </div>
