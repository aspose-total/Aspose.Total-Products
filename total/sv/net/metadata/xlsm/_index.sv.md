---
title: Visa och uppdatera XLSM-egenskaper online eller uppdatera metadata med .NET
description: Visa och ändra XLSM-egenskaper via online-appen gratis. C# .NET API-kod för att uppdatera och lägga till XLSM-egenskaper.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visa eller uppdatera XLSM-metadata online eller uppdatera via .NET" h2="Utveckla kraftfulla .NET-baserade XLSM-dokumentmetadatahanteringsprogram.Kod listad för att lägga till och ändra XLSM-filmetadata via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hantera XLSM-egenskaper via .NET" %}}

1. Skapa arbetsboksklass.
1. Få åtkomst till systemdefinierade egenskaper med BuiltInDocumentProperties
1. Tilldela uppdaterade värden som Språk
...
{{% blocks/products/pf/agp/code-block title=".NET-kod: Uppdatera XLSM-metadata" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title=".NET-kod: Lägg till anpassade XLSM-egenskaper" offSpacer="" %}}
...
<h2>Utveckla XLSM Metadata Management Application via .NET</h2>

Behöver du utveckla en XLSM-metadatahanteringsapp eller ett verktyg?Med [Aspose.Cells for .NET](https://products.aspose.com/cells/sv/net/), ett underordnat API av [Aspose.Total for .NET](https://products.aspose.com/total/sv/net/), kan alla .NET-utvecklare integrera ovanstående API-kod i sin dokumentmetadataapplikation.Kraftfullt .NET-bibliotek tillåter programmering av alla dokumentmetadatalösningar.Dessutom kan den stödja många populära format inklusive XLSM-format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-verktyg för att hantera XLSM-metadata" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 🧠 Användningsfall för makroaktiverad arbetsbok (`.xlsm`)

- Identifiera arbetsböcker med aktiva skript med hjälp av inbäddad metadata.
- Hjälp efterlevnadsteam att klassificera och granska makroanvändning.
- Stöd metadata-utlösta varningar för känsliga finansiella modeller.
