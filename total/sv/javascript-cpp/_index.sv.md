---
title: PDF-bearbetning och OCR-tillägg via JavaScript API:er
description: JavaScript API för att manipulera PDF-dokument samt lägga till OCR-funktion i webbapplikationer.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaScript API för PDF och OCR" h2="Lägg till OCR- och PDF-manipuleringsfunktioner i webbapplikationer utan några andra mjukvaruberoenden" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total for JavaScript via C++ är en allomfattande uppsättning JavaScript-bibliotek.Dessa bibliotek erbjuder funktioner som att arbeta direkt med PDF-filer i webbläsare och förbättra dina applikationer med funktioner för optisk teckenigenkänning.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total för JavaScript via C++ inkluderar följande JavaScript-bibliotek:" >}}
...
Aspose.PDF for JavaScript via C++ är en användarvänlig och säker verktygslåda designad för att arbeta med PDF-filer direkt i webbläsare.Det här biblioteket stöder 26 språk, inklusive latinska, kyrilliska skrifter och kinesiska tecken.

Det är en lättviktslösning som gör det möjligt för utvecklare att effektivt bearbeta PDF-filer med JavaScript.Det är både skalbart och funktionsrikt, vilket gör att utvecklare kan skapa sina egna JavaScript-baserade PDF-manipuleringsprodukter och enkelt dela dem över webben.
...
Aspose.Cells for JavaScript via C++ är ett kraftfullt WebAssembly-baserat API som levererar nästan native prestanda för att skapa, redigera, konvertera och rendera kalkylblad i Excel-format (XLS, XLSX, XLSB, XLSM), ODS, CSV och HTML i både webbläsar- och Node.js-miljöer. Det är utformat för maximal kompatibilitet och flexibilitet och möjliggör sömlös kalkylbladsbearbetning utan server, vilket gör det idealiskt för serverlösa applikationer, dashboards, datapipelines och dokumentgenereringsverktyg. Med sitt lätta format och fulla stöd för de flesta Excel-format säkerställer Aspose.Cells för JavaScript via C++ snabb, pålitlig och högpresterande kalkylbladshantering över webb-, server- och hybridplattformar.
...
Aspose.OCR for JavaScript via C++ ger dina applikationer effektiv optisk teckenigenkänning på bara 8 rader kod.

JavaScript OCR API är mångsidigt och kan känna igen innehåll från skannade bilder, smartphonefoton, skärmdumpar, specifika bildområden och skannade PDF-filer.Det ger resultat i populära dokument- och datautbytesformat. Noterbart är att API:et fungerar offline, vilket eliminerar behovet av en internetanslutning.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for JavaScript via C++ erbjuder en rad kraftfulla funktioner för att effektivisera teckensnittshanteringen. Det möjliggör enkel teckensnittskonvertering direkt i webbläsaren, stöder sömlös hantering av olika format som TTF, EOT, WOFF, CFF och Type1, och ger omfattande tillgång till teckensnittsmetadata för detaljerade insikter.
...
<h2 class="pr-ft">
 ...
 Översikt över JavaScript via C++-bibliotek
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Lägg till bilder i PDF-dokument
 </p>
</div>
<div class="col-lg-4">
...
Vi har betydande erfarenhet av både Office Automation och Soft Artisans Office Writer-produkt.Asposes Total.NET är mer robust och erbjuder mer funktionalitet än något vi har använt tidigare.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Mark Foley | Lion Nathan National Foods, Australien" >}}
I själva verket är Aspose.Total för .NET-sviten den "schweiziska armékniven" av komponenter vi använder.Den sitter bredvid presentationslagerkomponenter och bildar "limmet" för att dra och trycka datafiler i önskat format.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualetech, Frankrike" >}}
...
{{< blocks/products/pf/slr-element name="Blogg" href="https://blog.aspose.com/" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Varför Aspose.Total för C++" tabId="success-stories" >}}
