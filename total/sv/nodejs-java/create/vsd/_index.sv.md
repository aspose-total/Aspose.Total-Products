---
title: Skapa VSD Visio-diagram i Node.js
description: Generera Microsoft Visio VSD-diagram med Node-applikationer utan att använda Microsoft Office.  
...
{{< blocks/products/pf/feature-page-header h1="Skapa VSD-fil med Node.js" h2="Generera Microsoft Visio VSD-filer via dina nodapplikationer utan att installera någon annan programvara." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Skapa VSD-fil i Node.js" %}}

- Skapa Diagram-klassinstans.
- Anropa sparmetoden med relevanta parametrar
- VSD Filsökväg och SaveFileFormat relevant tillägg

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Skapande krav" %}}

- För att skapa VSD-dokument måste Node.js vara installerat på systemet.
- Oracle JDK (version 7 eller senare) krävs.
- Node-java-paketet måste ställas in.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Skapa VSD-filer" offSpacer="" %}}
