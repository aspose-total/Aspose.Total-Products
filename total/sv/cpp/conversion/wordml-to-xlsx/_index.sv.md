---
title: Konvertera WORDML till XLSX i C++
description: C++ API för att konvertera WORDML till XLSX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till XLSX" h2="Exportera WORDML till XLSX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
