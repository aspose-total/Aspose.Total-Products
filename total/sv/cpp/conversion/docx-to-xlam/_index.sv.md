---
title: Konvertera DOCX till XLAM i C++
description: C++ API för att konvertera DOCX till XLAM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till XLAM" h2="Exportera DOCX till XLAM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
