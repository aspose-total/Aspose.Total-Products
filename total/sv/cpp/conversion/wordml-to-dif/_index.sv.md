---
title: Konvertera WORDML till DIF i C++
description: C++ API för att konvertera WORDML till DIF utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till DIF" h2="Exportera WORDML till DIF via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera WORDML till DIF" %}}
