---
title: Konvertera DOTM till DIF i C++
description: C++ API för att konvertera DOTM till DIF utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till DIF" h2="Exportera DOTM till DIF via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
