---
title: Konvertera OTT till XLSX i C++
description: C++ API för att konvertera OTT till XLSX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLSX" h2="Exportera OTT till XLSX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
