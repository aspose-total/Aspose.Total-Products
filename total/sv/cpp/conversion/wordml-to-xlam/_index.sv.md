---
title: Konvertera WORDML till XLAM i C++
description: C++ API för att konvertera WORDML till XLAM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till XLAM" h2="Exportera WORDML till XLAM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
