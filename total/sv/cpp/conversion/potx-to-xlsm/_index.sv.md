---
title: Konvertera POTX till XLSM via C++
description: Exportera POTX till XLSM i C++ utan att använda Microsoft Excel eller Powerpoint
url: /sv/cpp/conversion/potx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Konvertera POTX till XLSM via C++" h2="POTX till XLSM-filkonvertering via C++ utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
