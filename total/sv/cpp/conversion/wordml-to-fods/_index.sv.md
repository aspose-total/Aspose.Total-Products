---
title: Konvertera WORDML till FODS i C++
description: C++ API för att konvertera WORDML till FODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till FODS" h2="Exportera WORDML till FODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
