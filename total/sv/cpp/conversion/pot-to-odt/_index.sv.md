---
title: C++ API för att konvertera POT till ODT
description: Exportera POT till ODT i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till ODT" h2="Exportera POT till ODT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
