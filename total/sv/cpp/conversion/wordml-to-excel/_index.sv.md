---
title: Konvertera WORDML till EXCEL i C++
description: C++ API för att konvertera WORDML till EXCEL utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till EXCEL" h2="Exportera WORDML till EXCEL via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
