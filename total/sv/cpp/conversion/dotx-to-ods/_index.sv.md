---
title: Konvertera DOTX till ODS i C++
description: C++ API för att konvertera DOTX till ODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till ODS" h2="Exportera DOTX till ODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTX till ODS" %}}
