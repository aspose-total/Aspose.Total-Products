---
title: C++ API för att konvertera POT till DOCX
description: Exportera POT till DOCX i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till DOCX" h2="Exportera POT till DOCX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
