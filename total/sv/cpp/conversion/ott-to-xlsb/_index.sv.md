---
title: Konvertera OTT till XLSB i C++
description: C++ API för att konvertera OTT till XLSB utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLSB" h2="Exportera OTT till XLSB via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
