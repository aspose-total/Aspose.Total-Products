---
title: Konvertera ODS till DOCX med C++
description: Konvertera ODS till DOCX inom C++-applikationer
url: /sv/cpp/conversion/ods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Konvertera ODS till DOCX via C++" h2="Exportera Excel<sup>&reg;</sup> ODS till DOCX inom fullfunktionella C++-applikationer" >}}
...
3. Ladda den konverterade PDF-filen med klassreferens [Dokument](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.docxument)
4. Spara dokumentet i DOCX-format med hjälp av medlemsfunktionen [Save](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.docxument#a6383c010776212483f51cc41235924db) och ställ in Docx som SaveFormat
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/cpp/conversion/ods-to-docx/" name="ODS Till DOCX" description="" >}}
