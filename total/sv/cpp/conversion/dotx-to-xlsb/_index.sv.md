---
title: Konvertera DOTX till XLSB i C++
description: C++ API för att konvertera DOTX till XLSB utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLSB" h2="Exportera DOTX till XLSB via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
