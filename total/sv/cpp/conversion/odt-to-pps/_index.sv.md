---
title: Konvertera ODT till PPS via C++
description: Exportera ODT till PPS i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera ODT till PPS" h2="Exportera ODT till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
