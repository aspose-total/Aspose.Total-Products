---
title: Konvertera DOTM till XLS i C++
description: C++ API för att konvertera DOTM till XLS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLS" h2="Exportera DOTM till XLS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
