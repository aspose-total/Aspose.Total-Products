---
title: C++ API för att konvertera POWERPOINT till DOTX
description: Exportera POWERPOINT till DOTX i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till DOTX" h2="Exportera POWERPOINT till DOTX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
