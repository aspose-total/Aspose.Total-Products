---
title: Konvertera DOTX till FODS i C++
description: C++ API för att konvertera DOTX till FODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till FODS" h2="Exportera DOTX till FODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTX till FODS" %}}
