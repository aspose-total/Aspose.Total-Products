---
title: Konvertera DOTX till PPTX via C++
description: Exportera DOTX till PPTX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/dotx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till PPTX" h2="Exportera DOTX till PPTX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
