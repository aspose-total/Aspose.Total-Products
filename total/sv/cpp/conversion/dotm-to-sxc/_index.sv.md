---
title: Konvertera DOTM till SXC i C++
description: C++ API för att konvertera DOTM till SXC utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till SXC" h2="Exportera DOTM till SXC via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
