---
title: C++ API för att konvertera PPSM till DOC
description: Exportera PPSM till DOC i dina C++-applikationer
url: /sv/cpp/conversion/ppsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSM till DOC" h2="Exportera PPSM till DOC i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
