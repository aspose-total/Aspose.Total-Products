---
title: Konvertera MOBI till XLSB i C++
description: C++ API för att konvertera MOBI till XLSB utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till XLSB" h2="Exportera MOBI till XLSB via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
