---
title: C++ API för att konvertera PPSX till WORD
description: Exportera PPSX till WORD i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till WORD" h2="Exportera PPSX till WORD i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
