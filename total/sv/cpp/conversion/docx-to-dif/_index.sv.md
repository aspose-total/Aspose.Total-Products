---
title: Konvertera DOCX till DIF i C++
description: C++ API för att konvertera DOCX till DIF utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till DIF" h2="Exportera DOCX till DIF via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
