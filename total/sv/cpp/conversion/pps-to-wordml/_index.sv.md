---
title: C++ API för att konvertera PPS till WORDML
description: Exportera PPS till WORDML i dina C++-applikationer
url: /sv/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPS till WORDML" h2="Exportera PPS till WORDML i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
