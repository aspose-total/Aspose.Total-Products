---
title: C++ API för att konvertera POWERPOINT till DOC
description: Exportera POWERPOINT till DOC i dina C++-applikationer
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till DOC" h2="Exportera POWERPOINT till DOC i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
