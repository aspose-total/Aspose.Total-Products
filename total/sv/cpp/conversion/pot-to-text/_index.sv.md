---
title: C++ API för att konvertera POT till TEXT
description: Exportera POT till TEXT i dina C++-applikationer
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till TEXT" h2="Exportera POT till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
