---
title: Konvertera DOTX till EXCEL i C++
description: C++ API för att konvertera DOTX till EXCEL utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till EXCEL" h2="Exportera DOTX till EXCEL via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTX till EXCEL" %}}
