---
title: C++ API för att konvertera PPSX till DOTM
description: Exportera PPSX till DOTM i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till DOTM" h2="Exportera PPSX till DOTM i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
