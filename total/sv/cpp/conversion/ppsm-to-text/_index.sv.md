---
title: C++ API för att konvertera PPSM till TEXT
description: Exportera PPSM till TEXT i dina C++-applikationer
url: /sv/cpp/conversion/ppsm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSM till TEXT" h2="Exportera PPSM till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
