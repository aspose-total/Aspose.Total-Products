---
title: C++ API för att konvertera POTX till DOCX
description: Exportera POTX till DOCX i dina C++-applikationer
url: /sv/cpp/conversion/potx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POTX till DOCX" h2="Exportera POTX till DOCX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
...
3. Ladda den konverterade HTML-filen genom att använda klassreferensen [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)
4. Spara dokumentet i DOCX-format genom att använda medlemsfunktionen [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/sv/cpp/conversion/potx-to-docxm/" name="POTX Till DOCXM" description="" >}}
