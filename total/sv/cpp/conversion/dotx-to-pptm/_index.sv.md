...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till PPTM eller online" h2="Exportera DOTX till PPTM i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
