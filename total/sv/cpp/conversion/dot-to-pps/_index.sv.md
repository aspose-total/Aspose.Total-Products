---
title: Konvertera DOT till PPS via C++
description: Exportera DOT till PPS i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOT till PPS" h2="Exportera DOT till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
