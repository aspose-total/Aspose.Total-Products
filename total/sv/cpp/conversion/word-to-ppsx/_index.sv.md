---
title: Konvertera WORD till PPSX via C++
description: Exportera WORD till PPSX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORD till PPSX" h2="Exportera WORD till PPSX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
