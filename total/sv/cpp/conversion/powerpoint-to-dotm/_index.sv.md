---
title: C++ API för att konvertera POWERPOINT till DOTM
description: Exportera POWERPOINT till DOTM i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till DOTM" h2="Exportera POWERPOINT till DOTM i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
