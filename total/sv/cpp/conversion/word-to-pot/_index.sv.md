---
title: Konvertera WORD till POT via C++
description: Exportera WORD till POT i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/word-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORD till POT" h2="Exportera WORD till POT i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
