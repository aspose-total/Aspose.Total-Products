---
title: C++ API för att konvertera PPTM till TEXT
description: Exportera PPTM till TEXT i dina C++-applikationer
url: /sv/cpp/conversion/pptm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPTM till TEXT" h2="Exportera PPTM till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
