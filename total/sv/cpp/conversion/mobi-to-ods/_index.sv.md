---
title: Konvertera MOBI till ODS i C++
description: C++ API för att konvertera MOBI till ODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till ODS" h2="Exportera MOBI till ODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
