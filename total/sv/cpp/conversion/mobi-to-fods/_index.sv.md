---
title: Konvertera MOBI till FODS i C++
description: C++ API för att konvertera MOBI till FODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till FODS" h2="Exportera MOBI till FODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
