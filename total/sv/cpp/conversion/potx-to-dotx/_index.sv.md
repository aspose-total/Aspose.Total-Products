---
title: C++ API för att konvertera POTX till DOTX
description: Exportera POTX till DOTX i dina C++-applikationer
url: /sv/cpp/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POTX till DOTX" h2="Exportera POTX till DOTX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
