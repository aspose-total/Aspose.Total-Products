---
title: Konvertera DOTM till XLTM i C++
description: C++ API för att konvertera DOTM till XLTM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLTM" h2="Exportera DOTM till XLTM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
