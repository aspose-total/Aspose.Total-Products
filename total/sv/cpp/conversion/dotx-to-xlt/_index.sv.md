---
title: Konvertera DOTX till XLT i C++
description: C++ API för att konvertera DOTX till XLT utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLT" h2="Exportera DOTX till XLT via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
