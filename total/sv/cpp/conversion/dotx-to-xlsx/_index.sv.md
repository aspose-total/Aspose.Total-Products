---
title: Konvertera DOTX till XLSX i C++
description: C++ API för att konvertera DOTX till XLSX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLSX" h2="Exportera DOTX till XLSX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
