---
title: C++ API för att konvertera PPS till FLATOPC
description: Exportera PPS till FLATOPC i dina C++-applikationer
url: /sv/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPS till FLATOPC" h2="Exportera PPS till FLATOPC i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
