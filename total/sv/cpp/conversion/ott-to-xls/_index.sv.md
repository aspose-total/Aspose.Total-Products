---
title: Konvertera OTT till XLS i C++
description: C++ API för att konvertera OTT till XLS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLS" h2="Exportera OTT till XLS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
