---
title: C++ API för att konvertera POT till DOC
description: Exportera POT till DOC i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till DOC" h2="Exportera POT till DOC i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
