---
title: Konvertera MOBI till TSV i C++
description: C++ API för att konvertera MOBI till TSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till TSV" h2="Exportera MOBI till TSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
