---
title: Konvertera DOTM till XLSB i C++
description: C++ API för att konvertera DOTM till XLSB utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLSB" h2="Exportera DOTM till XLSB via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTM till XLSB" %}}
