---
title: C++ API för att konvertera PPS till TEXT
description: Exportera PPS till TEXT i dina C++-applikationer
url: /sv/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPS till TEXT" h2="Exportera PPS till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
