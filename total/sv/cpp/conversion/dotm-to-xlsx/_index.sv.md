---
title: Konvertera DOTM till XLSX i C++
description: C++ API för att konvertera DOTM till XLSX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLSX" h2="Exportera DOTM till XLSX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTM till XLSX" %}}
