---
title: Konvertera WORD till PPS via C++
description: Exportera WORD till PPS i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/word-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORD till PPS" h2="Exportera WORD till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
