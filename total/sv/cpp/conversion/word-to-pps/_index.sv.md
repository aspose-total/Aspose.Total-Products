...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORD till PPS eller online" h2="Exportera WORD till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
