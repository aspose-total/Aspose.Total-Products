---
title: Konvertera MOBI till DIF i C++
description: C++ API för att konvertera MOBI till DIF utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till DIF" h2="Exportera MOBI till DIF via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
