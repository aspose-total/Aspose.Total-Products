---
title: Konvertera DOTM till FODS i C++
description: C++ API för att konvertera DOTM till FODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till FODS" h2="Exportera DOTM till FODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
