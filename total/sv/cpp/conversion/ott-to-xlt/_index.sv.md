---
title: Konvertera OTT till XLT i C++
description: C++ API för att konvertera OTT till XLT utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLT" h2="Exportera OTT till XLT via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
