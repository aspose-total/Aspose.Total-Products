---
title: C++ API för att konvertera PPSX till RTF
description: Exportera PPSX till RTF i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till RTF" h2="Exportera PPSX till RTF i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
