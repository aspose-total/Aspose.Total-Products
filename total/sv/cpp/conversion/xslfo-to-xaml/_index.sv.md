...
I processen att rendera XSLFO till XAML kan du öppna en lösenordsskyddad XSLFO och även ändra dess lösenord. För att ändra lösenordet för en XSLFO-fil måste du känna till ägarlösenordet för det dokumentet. Du kan ladda lösenordsskyddade PDF-dokument med [Aspose.PDF for C++](https://products.aspose.com/pdf/cpp/) genom att ange dess ägarlösenord och använda ChangePasswords-metoden för att ändra lösenordet.
{{% blocks/products/pf/feature-page-code %}}
