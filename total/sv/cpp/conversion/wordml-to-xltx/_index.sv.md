---
title: Konvertera WORDML till XLTX i C++
description: C++ API för att konvertera WORDML till XLTX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till XLTX" h2="Exportera WORDML till XLTX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
