---
title: C++ API för att konvertera POT till FLATOPC
description: Exportera POT till FLATOPC i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till FLATOPC" h2="Exportera POT till FLATOPC i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
