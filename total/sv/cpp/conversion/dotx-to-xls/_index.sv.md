---
title: Konvertera DOTX till XLS i C++
description: C++ API för att konvertera DOTX till XLS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLS" h2="Exportera DOTX till XLS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTX till XLS" %}}
