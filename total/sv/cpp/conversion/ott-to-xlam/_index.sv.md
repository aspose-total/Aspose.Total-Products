---
title: Konvertera OTT till XLAM i C++
description: C++ API för att konvertera OTT till XLAM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLAM" h2="Exportera OTT till XLAM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
