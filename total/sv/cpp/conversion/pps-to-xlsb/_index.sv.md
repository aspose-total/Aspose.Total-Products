...
description: Exportera PPS till XLSB i C++ utan att använda Microsoft Excel eller Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Konvertera PPS till XLSB via C++" h2="PPS till XLSB-filkonvertering via C++ utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
