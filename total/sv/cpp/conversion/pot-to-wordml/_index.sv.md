---
title: C++ API för att konvertera POT till WORDML
description: Exportera POT till WORDML i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till WORDML" h2="Exportera POT till WORDML i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
