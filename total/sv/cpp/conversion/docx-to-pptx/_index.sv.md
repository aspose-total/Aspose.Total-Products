---
title: Konvertera DOCX till PPTX via C++
description: Exportera DOCX till PPTX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/docx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till PPTX" h2="Exportera DOCX till PPTX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
...
2. Konvertera DOCX till HTML genom att använda medlemsfunktionen [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_stdbasicostream_saveoptions)
