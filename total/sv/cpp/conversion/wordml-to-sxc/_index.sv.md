---
title: Konvertera WORDML till SXC i C++
description: C++ API för att konvertera WORDML till SXC utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till SXC" h2="Exportera WORDML till SXC via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
