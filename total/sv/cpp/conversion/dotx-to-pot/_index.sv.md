...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till POT eller online" h2="Exportera DOTX till POT i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
