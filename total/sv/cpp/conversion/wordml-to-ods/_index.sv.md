---
title: Konvertera WORDML till ODS i C++
description: C++ API för att konvertera WORDML till ODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till ODS" h2="Exportera WORDML till ODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
