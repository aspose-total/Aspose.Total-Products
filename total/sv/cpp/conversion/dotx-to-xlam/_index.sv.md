---
title: Konvertera DOTX till XLAM i C++
description: C++ API för att konvertera DOTX till XLAM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLAM" h2="Exportera DOTX till XLAM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
