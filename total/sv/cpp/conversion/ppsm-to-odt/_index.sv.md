---
title: C++ API för att konvertera PPSM till ODT
description: Exportera PPSM till ODT i dina C++-applikationer
url: /sv/cpp/conversion/ppsm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSM till ODT" h2="Exportera PPSM till ODT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
