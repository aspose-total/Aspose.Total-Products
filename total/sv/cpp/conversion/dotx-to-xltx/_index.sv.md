---
title: Konvertera DOTX till XLTX i C++
description: C++ API för att konvertera DOTX till XLTX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLTX" h2="Exportera DOTX till XLTX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
