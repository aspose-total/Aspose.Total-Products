---
title: Konvertera MOBI till CSV i C++
description: C++ API för att konvertera MOBI till CSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till CSV" h2="Exportera MOBI till CSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
