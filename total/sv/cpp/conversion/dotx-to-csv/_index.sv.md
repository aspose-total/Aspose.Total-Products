---
title: Konvertera DOTX till CSV i C++
description: C++ API för att konvertera DOTX till CSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till CSV" h2="Exportera DOTX till CSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
