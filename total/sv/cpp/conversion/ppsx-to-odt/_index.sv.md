---
title: C++ API för att konvertera PPSX till ODT
description: Exportera PPSX till ODT i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till ODT" h2="Exportera PPSX till ODT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
