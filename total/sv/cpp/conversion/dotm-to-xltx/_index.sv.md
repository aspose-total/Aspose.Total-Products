---
title: Konvertera DOTM till XLTX i C++
description: C++ API för att konvertera DOTM till XLTX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLTX" h2="Exportera DOTM till XLTX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
