---
title: Konvertera DOTM till CSV i C++
description: C++ API för att konvertera DOTM till CSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till CSV" h2="Exportera DOTM till CSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
