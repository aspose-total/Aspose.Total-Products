---
title: Konvertera DOCX till XLTX i C++
description: C++ API för att konvertera DOCX till XLTX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till XLTX" h2="Exportera DOCX till XLTX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
