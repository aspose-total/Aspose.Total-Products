---
title: Konvertera DOTM till EXCEL i C++
description: C++ API för att konvertera DOTM till EXCEL utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till EXCEL" h2="Exportera DOTM till EXCEL via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
