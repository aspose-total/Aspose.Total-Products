---
title: Konvertera DOTM till TSV i C++
description: C++ API för att konvertera DOTM till TSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till TSV" h2="Exportera DOTM till TSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
