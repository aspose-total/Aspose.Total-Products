---
title: C++ API för att konvertera POT till OTT
description: Exportera POT till OTT i dina C++-applikationer
url: /sv/cpp/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POT till OTT" h2="Exportera POT till OTT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
