---
title: Konvertera DOTM till ODS i C++
description: C++ API för att konvertera DOTM till ODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till ODS" h2="Exportera DOTM till ODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
