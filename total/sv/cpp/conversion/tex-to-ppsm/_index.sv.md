---
title: C++ API för att konvertera TEX till PPSM
description: Konvertera TEX till PPSM via C++ utan att använda Microsoft Word eller Adobe Acrobat Reader
url: /sv/cpp/conversion/tex-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: TEX
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att exportera TEX till PPSM" %}}
