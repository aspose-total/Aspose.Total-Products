---
title: Konvertera MOBI till XLSM i C++
description: C++ API för att konvertera MOBI till XLSM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till XLSM" h2="Exportera MOBI till XLSM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera MOBI till XLSM" %}}
