---
title: Konvertera TXT till PPS via C++
description: Exportera TXT till PPS i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/txt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera TXT till PPS" h2="Exportera TXT till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
