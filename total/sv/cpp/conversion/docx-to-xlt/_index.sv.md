---
title: Konvertera DOCX till XLT i C++
description: C++ API för att konvertera DOCX till XLT utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till XLT" h2="Exportera DOCX till XLT via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
