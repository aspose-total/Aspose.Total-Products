---
title: Konvertera ODT till ODP via C++
description: Exportera ODT till ODP i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/odt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera ODT till ODP" h2="Exportera ODT till ODP i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
