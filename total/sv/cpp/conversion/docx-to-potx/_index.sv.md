---
title: Konvertera DOCX till POTX via C++
description: Exportera DOCX till POTX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/docx-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till POTX" h2="Exportera DOCX till POTX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
