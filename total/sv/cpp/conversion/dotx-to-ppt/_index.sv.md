...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till PPT eller online" h2="Exportera DOTX till PPT i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
