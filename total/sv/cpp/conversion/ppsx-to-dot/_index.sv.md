---
title: C++ API för att konvertera PPSX till DOT
description: Exportera PPSX till DOT i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till DOT" h2="Exportera PPSX till DOT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
