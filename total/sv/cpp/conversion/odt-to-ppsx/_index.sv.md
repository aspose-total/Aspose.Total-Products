---
title: Konvertera ODT till PPSX via C++
description: Exportera ODT till PPSX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/odt-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera ODT till PPSX" h2="Exportera ODT till PPSX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
