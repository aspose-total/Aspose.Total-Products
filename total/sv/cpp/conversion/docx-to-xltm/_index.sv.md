---
title: Konvertera DOCX till XLTM i C++
description: C++ API för att konvertera DOCX till XLTM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till XLTM" h2="Exportera DOCX till XLTM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
