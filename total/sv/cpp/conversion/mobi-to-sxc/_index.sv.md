---
title: Konvertera MOBI till SXC i C++
description: C++ API för att konvertera MOBI till SXC utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till SXC" h2="Exportera MOBI till SXC via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
