---
title: C++ API för att konvertera POTX till DOT
description: Exportera POTX till DOT i dina C++-applikationer
url: /sv/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POTX till DOT" h2="Exportera POTX till DOT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
