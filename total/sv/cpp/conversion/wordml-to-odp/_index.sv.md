---
title: Konvertera WORDML till ODP via C++
description: Exportera WORDML till ODP i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/wordml-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till ODP" h2="Exportera WORDML till ODP i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
