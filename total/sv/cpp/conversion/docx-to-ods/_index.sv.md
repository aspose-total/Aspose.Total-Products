---
title: Konvertera DOCX till ODS i C++
description: C++ API för att konvertera DOCX till ODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till ODS" h2="Exportera DOCX till ODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
