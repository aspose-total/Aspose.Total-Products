---
title: Konvertera DOTM till XLAM i C++
description: C++ API för att konvertera DOTM till XLAM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLAM" h2="Exportera DOTM till XLAM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
