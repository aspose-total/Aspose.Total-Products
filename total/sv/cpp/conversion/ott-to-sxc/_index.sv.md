---
title: Konvertera OTT till SXC i C++
description: C++ API för att konvertera OTT till SXC utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till SXC" h2="Exportera OTT till SXC via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
