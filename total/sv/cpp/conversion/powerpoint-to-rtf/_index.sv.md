---
title: C++ API för att konvertera POWERPOINT till RTF
description: Exportera POWERPOINT till RTF i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till RTF" h2="Exportera POWERPOINT till RTF i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
