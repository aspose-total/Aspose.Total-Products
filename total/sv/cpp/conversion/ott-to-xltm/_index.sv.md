---
title: Konvertera OTT till XLTM i C++
description: C++ API för att konvertera OTT till XLTM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLTM" h2="Exportera OTT till XLTM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera OTT till XLTM" %}}
