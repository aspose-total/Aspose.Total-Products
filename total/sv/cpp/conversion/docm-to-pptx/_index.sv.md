---
title: Konvertera DOCM till PPTX via C++
description: Exportera DOCM till PPTX i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/docm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCM till PPTX" h2="Exportera DOCM till PPTX i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
