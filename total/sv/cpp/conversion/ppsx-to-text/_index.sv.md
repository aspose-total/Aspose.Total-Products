---
title: C++ API för att konvertera PPSX till TEXT
description: Exportera PPSX till TEXT i dina C++-applikationer
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till TEXT" h2="Exportera PPSX till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
