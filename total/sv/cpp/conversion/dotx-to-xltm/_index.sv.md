---
title: Konvertera DOTX till XLTM i C++
description: C++ API för att konvertera DOTX till XLTM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till XLTM" h2="Exportera DOTX till XLTM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
