---
title: Konvertera DOTX till PPS via C++
description: Exportera DOTX till PPS i dina C++-applikationer utan att använda Microsoft Word eller PowerPoint
url: /sv/cpp/conversion/dotx-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTX till PPS" h2="Exportera DOTX till PPS i dina C++-program utan att använda Microsoft Word&reg; eller PowerPoint" >}}
