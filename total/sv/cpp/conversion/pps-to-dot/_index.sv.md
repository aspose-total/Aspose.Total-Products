---
title: C++ API för att konvertera PPS till DOT
description: Exportera PPS till DOT i dina C++-applikationer
url: /sv/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPS till DOT" h2="Exportera PPS till DOT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
