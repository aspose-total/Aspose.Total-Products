---
title: Konvertera DOCX till TSV i C++
description: C++ API för att konvertera DOCX till TSV utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till TSV" h2="Exportera DOCX till TSV via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOCX till TSV" %}}
