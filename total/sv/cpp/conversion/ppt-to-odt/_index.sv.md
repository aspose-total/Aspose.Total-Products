---
title: C++ API för att konvertera PPT till ODT
description: Exportera PPT till ODT i dina C++-applikationer
url: /sv/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPT till ODT" h2="Exportera PPT till ODT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
