---
title: C++ API för att konvertera POTM till TEXT
description: Exportera POTM till TEXT i dina C++-applikationer
url: /sv/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POTM till TEXT" h2="Exportera POTM till TEXT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
