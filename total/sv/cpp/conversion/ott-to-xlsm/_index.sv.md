---
title: Konvertera OTT till XLSM i C++
description: C++ API för att konvertera OTT till XLSM utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till XLSM" h2="Exportera OTT till XLSM via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
