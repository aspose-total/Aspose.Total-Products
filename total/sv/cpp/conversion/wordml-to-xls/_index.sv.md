---
title: Konvertera WORDML till XLS i C++
description: C++ API för att konvertera WORDML till XLS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera WORDML till XLS" h2="Exportera WORDML till XLS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera WORDML till XLS" %}}
