...
description: Exportera PPS till ODS i C++ utan att använda Microsoft Excel eller Powerpoint
url: /sv/cpp/conversion/pps-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Konvertera PPS till ODS via C++" h2="PPS till ODS-filkonvertering via C++ utan att använda Microsoft<sup>&reg;</sup> Excel eller PowerPoint" >}}
