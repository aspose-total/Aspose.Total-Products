---
title: Konvertera DOTM till XLT i C++
description: C++ API för att konvertera DOTM till XLT utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/dotm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOTM till XLT" h2="Exportera DOTM till XLT via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API för att konvertera DOTM till XLT" %}}
