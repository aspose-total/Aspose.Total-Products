---
title: C++ API för att konvertera PPSX till DOCX
description: Exportera PPSX till DOCX i dina C++-applikationer
url: /sv/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera PPSX till DOCX" h2="Exportera PPSX till DOCX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
