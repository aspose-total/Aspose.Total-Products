---
title: C++ API för att konvertera POWERPOINT till DOCX
description: Exportera POWERPOINT till DOCX i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till DOCX" h2="Exportera POWERPOINT till DOCX i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
