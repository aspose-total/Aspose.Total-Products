---
title: C++ API för att konvertera POWERPOINT till ODT
description: Exportera POWERPOINT till ODT i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till ODT" h2="Exportera POWERPOINT till ODT i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
