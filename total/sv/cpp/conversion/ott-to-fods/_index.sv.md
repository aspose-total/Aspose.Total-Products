---
title: Konvertera OTT till FODS i C++
description: C++ API för att konvertera OTT till FODS utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/ott-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera OTT till FODS" h2="Exportera OTT till FODS via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
