---
title: C++ API för att konvertera POWERPOINT till WORDML
description: Exportera POWERPOINT till WORDML i dina C++-applikationer
url: /sv/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att rendera POWERPOINT till WORDML" h2="Exportera POWERPOINT till WORDML i C++-applikationer utan några Microsoft PowerPoint- eller Word-beroenden" >}}
