---
title: Konvertera DOCX till SXC i C++
description: C++ API för att konvertera DOCX till SXC utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/docx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera DOCX till SXC" h2="Exportera DOCX till SXC via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
