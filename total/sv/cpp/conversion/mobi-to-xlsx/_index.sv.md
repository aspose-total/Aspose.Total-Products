---
title: Konvertera MOBI till XLSX i C++
description: C++ API för att konvertera MOBI till XLSX utan att använda Microsoft Word eller Microsoft Excel
url: /sv/cpp/conversion/mobi-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API för att konvertera MOBI till XLSX" h2="Exportera MOBI till XLSX via C++ utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
