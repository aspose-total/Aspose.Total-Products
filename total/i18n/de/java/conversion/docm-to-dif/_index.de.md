---
title: Java-API zum Konvertieren von DOCM in DIF
description: Konvertieren Sie DOCM über Java in DIF, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/docm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOCM über Java in DIF" h2="Lokale Java-API zum Konvertieren von DOCM in DIF, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
{{% blocks/products/pf/feature-page-summary %}}
Das Konvertieren von DOCM in DIF über [Aspose.Total for Java](https://products.aspose.com/total/java/) ist ein einfacher zweistufiger Prozess. Durch die Verwendung der funktionsreichen Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words for Java](https://products.aspose.com/words/java/) können Sie DOCM in HTML exportieren. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/java/) HTML in DIF konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
