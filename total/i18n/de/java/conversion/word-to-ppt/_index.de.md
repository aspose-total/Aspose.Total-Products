...
Mit der API können Sie auch passwortgeschützte WORD-Dokumente in PPT konvertieren. Wenn Ihr eingegebenes WORD-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das PPT-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Wordument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
