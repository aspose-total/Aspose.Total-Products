---
title: Java-API zum Konvertieren von ODT in XLT
description: Konvertieren Sie ODT über Java in XLT, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/odt-to-xlt/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie ODT über Java in XLT" h2="Lokale Java-API zum Konvertieren von ODT in XLT, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
{{% blocks/products/pf/feature-page-summary %}}
Das Konvertieren von ODT in XLT über [Aspose.Total for Java](https://products.aspose.com/total/java/) ist ein einfacher zweistufiger Prozess. Durch die Verwendung der funktionsreichen Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words for Java](https://products.aspose.com/words/java/) können Sie ODT in HTML exportieren. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/java/) HTML in XLT konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
...
2. Konvertieren Sie ODT in HTML mit [Save](https://apireference.aspose.com/words/java/com.aspose.words/Odtument#save(java.lang.String,com.aspose.words.SaveOptions) ) Methode
...
Sie können Aspose.Total für Java direkt aus einem auf [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) basierenden Projekt verwenden und enthalten [Aspose.Words for Java](https://odts.aspose.com/words/java/installation/) und [Aspose.Cells for Java](https://odts.aspose.com/cells/java/ installation/) in Ihrer pom.xml.
