...
description: Konvertieren Sie DOTM über Java in XLSB, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/dotm-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOTM über Java in XLSB" h2="Lokale Java-API zum Konvertieren von DOTM in XLSB, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOTM in XLSB" %}}
1. Öffnen Sie die DOTM-Datei mit der Klasse [Dotmument](https://apireference.aspose.com/words/java/com.aspose.words/Dotmument).
2. Konvertieren Sie DOTM in HTML mit [Save](https://apireference.aspose.com/words/java/com.aspose.words/Dotmument#save(java.lang.String,com.aspose.words.SaveOptions) ) Methode
