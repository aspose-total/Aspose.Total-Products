...
Mit der API können Sie auch passwortgeschützte DOTX-Dokumente in PPSM konvertieren. Wenn Ihr eingegebenes DOTX-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das PPSM-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Dotxument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
