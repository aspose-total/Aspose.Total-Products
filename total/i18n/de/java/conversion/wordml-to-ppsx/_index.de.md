---
title: Konvertieren Sie WORDML über Java in PPSX
description: Java-API zum Exportieren von WORDML in PPSX, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/java/conversion/wordml-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie WORDML über Java in PPSX" h2="WORDML-zu-PPSX-Konvertierung durch Verwendung der lokalen Java-API in beliebigen Java J2SE-, J2EE-, J2ME-Anwendungen ohne Verwendung von Microsoft<sup>&reg;</sup> PowerPoint oder Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie WORDML über Java in PPSX" %}}
...
Für die Konvertierung von WORDML- in PPSX-Dateien können Sie Aspose.Total für Java direkt von einem [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total)-basiertes Projekt und fügen Sie Bibliotheken in Ihre pom.xml ein.
...
Mit der API können Sie auch passwortgeschützte WORDML-Dokumente in PPSX konvertieren. Wenn Ihr eingegebenes WORDML-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das PPSX-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Wordmlument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
