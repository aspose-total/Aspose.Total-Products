...
description: Konvertieren Sie OTT über Java in DIF, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/ott-to-dif/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie OTT über Java in DIF" h2="Lokale Java-API zum Konvertieren von OTT in DIF, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von OTT in DIF" %}}
