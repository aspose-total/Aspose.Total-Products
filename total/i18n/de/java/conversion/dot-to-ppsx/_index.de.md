---
title: Konvertieren Sie DOT über Java in PPSX
description: Java-API zum Exportieren von DOT in PPSX, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/java/conversion/dot-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOT über Java in PPSX" h2="DOT-zu-PPSX-Konvertierung durch Verwendung der lokalen Java-API in beliebigen Java J2SE-, J2EE-, J2ME-Anwendungen ohne Verwendung von Microsoft<sup>&reg;</sup> PowerPoint oder Word" >}}
...
Für die Konvertierung von DOT- in PPSX-Dateien können Sie Aspose.Total für Java direkt von einem [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total)-basiertes Projekt und fügen Sie Bibliotheken in Ihre pom.xml ein.
...
Mit der API können Sie auch passwortgeschützte DOT-Dokumente in PPSX konvertieren. Wenn Ihr eingegebenes DOT-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das PPSX-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Dotument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
