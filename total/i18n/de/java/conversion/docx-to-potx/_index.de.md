...
Mit der API können Sie auch passwortgeschützte DOCX-Dokumente in POTX konvertieren. Wenn Ihr eingegebenes DOCX-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das POTX-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Docxument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
