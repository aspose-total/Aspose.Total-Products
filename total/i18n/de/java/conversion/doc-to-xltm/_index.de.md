---
title: Java-API zum Konvertieren von DOC in XLTM
description: Konvertieren Sie DOC über Java in XLTM, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/doc-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOC über Java in XLTM" h2="Lokale Java-API zum Konvertieren von DOC in XLTM, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOC in XLTM" %}}
