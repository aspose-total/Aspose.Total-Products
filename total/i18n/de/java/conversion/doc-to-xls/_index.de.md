---
title: Java-API zum Konvertieren von DOC in XLS
description: Konvertieren Sie DOC über Java in XLS, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/doc-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOC über Java in XLS" h2="Lokale Java-API zum Konvertieren von DOC in XLS, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
{{% blocks/products/pf/feature-page-summary %}}
Das Konvertieren von DOC in XLS über [Aspose.Total for Java](https://products.aspose.com/total/java/) ist ein einfacher zweistufiger Prozess. Durch die Verwendung der funktionsreichen Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words for Java](https://products.aspose.com/words/java/) können Sie DOC in HTML exportieren. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/java/) HTML in XLS konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
