---
title: Konvertieren Sie PDF über die Java-API in PPT
description: Java-API zum Konvertieren von PDF in PPT ohne Verwendung von Microsoft Word
url: /de/java/conversion/pdf-to-ppt/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java-API zum Exportieren von PDF nach PPT" h2="Exportieren Sie PDF über die lokale Java-API nach PPT, ohne Microsoft<sup>&reg;</sup> PowerPoint oder Adobe<sup>&reg;</sup> Acrobat Reader zu verwenden" >}}
{{% blocks/products/pf/feature-page-summary %}}
Mit [Aspose.Total for Java](https://products.aspose.com/total/java/) können Sie PDF in jeder Java J2SE-, J2EE-, J2ME-Anwendung problemlos in PPT konvertieren. Erstens können Sie mit [Aspose.PDF for Java](https://products.aspose.com/pdf/java/) PDF nach PPTX exportieren. Danach können Sie mithilfe der [Aspose.Slides for Java](https://products.aspose.com/slides/java/) PowerPoint-Verarbeitungs-API PPTX in PPT konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-API zum Konvertieren von PDF in PPT" %}}
