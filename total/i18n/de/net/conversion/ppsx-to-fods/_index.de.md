---
title: Konvertieren Sie PPSX über C# in FODS
description: Konvertieren Sie PPSX in C# in FODS, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/net/conversion/ppsx-to-fods/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie PPSX über C# in FODS" h2=".NET-API für die PPSX-zu-FODS-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie PPSX über C# in FODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PPSX in FODS mit Wasserzeichen über C#" %}}
