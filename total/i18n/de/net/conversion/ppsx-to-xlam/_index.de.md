---
title: Konvertieren Sie PPSX über C# in XLAM
description: Konvertieren Sie PPSX in C# in XLAM, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/net/conversion/ppsx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie PPSX über C# in XLAM" h2=".NET-API für die PPSX-zu-XLAM-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie PPSX über C# in XLAM" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie Protected PPSX über C# in XLAM" %}}
Wenn Ihr eingegebenes PPSX-Dokument beim Konvertieren der PPSX-Datei in XLAM passwortgeschützt ist, können Sie es nicht in XLAM konvertieren, ohne das Dokument zu entschlüsseln. Wenn Ihr Dokument passwortgeschützt ist, bedeutet dies, dass bestimmte Einschränkungen für die Präsentation erzwungen werden. Um die Einschränkungen aufzuheben, muss das Passwort eingegeben werden. Eine passwortgeschützte Präsentation gilt als gesperrte Präsentation. Die API ermöglicht es Ihnen, das verschlüsselte Dokument zu öffnen, indem Sie das richtige Kennwort in einem LoadOptions-Objekt übergeben.  
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PPSX in XLAM mit Wasserzeichen über C#" %}}
Beim Konvertieren der PPSX-Datei in XLAM können Sie Ihrem Ausgabe-XLAM-Dateiformat auch Wasserzeichen hinzufügen. Um ein Wasserzeichen hinzuzufügen, können Sie ein neues Workbook-Objekt erstellen und das konvertierte HTML-Dokument öffnen, Worksheet über seinen Index auswählen, eine Form erstellen und seine AddTextEffect-Funktion verwenden. Danach können Sie Ihr HTML-Dokument als XLAM mit Wasserzeichen speichern. 
{{% blocks/products/pf/feature-page-code %}}
