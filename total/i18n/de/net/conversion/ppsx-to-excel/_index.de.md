---
title: Konvertieren Sie PPSX über C# in EXCEL
description: Konvertieren Sie PPSX in C# in EXCEL, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/net/conversion/ppsx-to-excel/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie PPSX über C# in EXCEL" h2=".NET-API für die PPSX-zu-EXCEL-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie PPSX über C# in EXCEL" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie Protected PPSX über C# in EXCEL" %}}
Wenn Ihr eingegebenes PPSX-Dokument beim Konvertieren der PPSX-Datei in EXCEL passwortgeschützt ist, können Sie es nicht in EXCEL konvertieren, ohne das Dokument zu entschlüsseln. Wenn Ihr Dokument passwortgeschützt ist, bedeutet dies, dass bestimmte Einschränkungen für die Präsentation erzwungen werden. Um die Einschränkungen aufzuheben, muss das Passwort eingegeben werden. Eine passwortgeschützte Präsentation gilt als gesperrte Präsentation. Die API ermöglicht es Ihnen, das verschlüsselte Dokument zu öffnen, indem Sie das richtige Kennwort in einem LoadOptions-Objekt übergeben.  
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie PPSX in EXCEL mit Wasserzeichen über C#" %}}
