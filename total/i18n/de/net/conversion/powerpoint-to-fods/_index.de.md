---
title: Konvertieren Sie POWERPOINT über C# in FODS
description: Konvertieren Sie POWERPOINT in C# in FODS, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/net/conversion/powerpoint-to-fods/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie POWERPOINT über C# in FODS" h2=".NET-API für die POWERPOINT-zu-FODS-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie POWERPOINT über C# in FODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie POWERPOINT in FODS mit Wasserzeichen über C#" %}}
Beim Konvertieren der POWERPOINT-Datei in FODS können Sie Ihrem Ausgabe-FODS-Dateiformat auch Wasserzeichen hinzufügen. Um ein Wasserzeichen hinzuzufügen, können Sie ein neues Workbook-Objekt erstellen und das konvertierte HTML-Dokument öffnen, Worksheet über seinen Index auswählen, eine Form erstellen und seine AddTextEffect-Funktion verwenden. Danach können Sie Ihr HTML-Dokument als FODS mit Wasserzeichen speichern. 
{{% blocks/products/pf/feature-page-code %}}
