---
title: .NET-API zum Konvertieren von DOCX in TSV
description: C#-API zum Konvertieren von DOCX in TSV ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/docx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOCX in TSV" h2="DOCX über C# in TSV exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie die DOCX-zu-TSV-Konvertierungsfunktion in jede .NET-, C#-, ASP.NET- und VB.NET-Anwendung integrieren zwei einfache Schritte. Erstens können Sie mit [Aspose.Words for .NET](https://products.aspose.com/words/net/) DOCX in HTML exportieren. Danach können Sie mithilfe der Spreadsheet Programming API [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) HTML in TSV konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
