---
title: .NET-API zum Konvertieren von DOTX in XLS
description: C#-API zum Konvertieren von DOTX in XLS ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOTX in XLS" h2="DOTX über C# in XLS exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
1. Öffnen Sie die DOTX-Datei mit der Klasse [Dotxument](https://apireference.aspose.com/words/net/aspose.words/dotxument).
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) ermöglicht es Ihnen auch, DOTX-Dokumente per Stream zu laden. Um ein Dokument aus einem Stream zu öffnen, übergeben Sie einfach ein Stream-Objekt, das das Dokument enthält, an den Konstruktor [Dotxument](https://apireference.aspose.com/words/net/aspose.words/dotxument). Das folgende Codebeispiel zeigt, wie Sie ein Dokument aus einem Stream öffnen:  
{{% blocks/products/pf/feature-page-code %}}
...
Beim Konvertieren von DOTX in XLS können Sie mit [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Ihren XLS-Dokumenten benutzerdefinierte Eigenschaften hinzufügen. Um eine benutzerdefinierte Eigenschaft hinzuzufügen, können Sie die Methode [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customdotxumentpropertycollection/methods/add/index) für die [CustomDotxumentPropertyCollection]( https://apireference.aspose.com/cells/net/aspose.cells.properties/customdotxumentpropertycollection) Klasse. Die Add-Methode fügt die Eigenschaft zur Excel-Datei hinzu und gibt eine Referenz für die neue Dokumenteigenschaft als [Aspose.Cells.Properties.DotxumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /dotxumentproperty)-Objekt. 
{{% blocks/products/pf/feature-page-code %}}
