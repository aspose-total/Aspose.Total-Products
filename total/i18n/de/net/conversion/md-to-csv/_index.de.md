---
title: Konvertieren Sie MD über die C#-API in CSV
description: C#-API zum Konvertieren von MD-Dateien in CSV ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/md-to-csv/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Rendern von MD in CSV" h2="MD-Datei über C# in CSV exportieren, ohne Microsoft<sup>&reg;</sup> Excel oder Adobe<sup>&reg;</sup> Acrobat Reader zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Mit [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie MD-Dateien in allen .NET-, C#-, ASP.NET- und VB.NET-Anwendungen problemlos in CSV konvertieren. Erstens können Sie mit [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) MD nach XLSX exportieren. Danach können Sie mithilfe der [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API XLSX in CSV konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-API zum Konvertieren von MD in CSV" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie geschütztes MD in CSV über C#" %}}
Wenn Ihr MD-Dokument passwortgeschützt ist, können Sie es ohne das Passwort nicht in CSV konvertieren. Mit der API können Sie das geschützte Dokument zunächst mit einem gültigen Passwort öffnen und anschließend konvertieren. Um die verschlüsselte Datei zu öffnen, können Sie eine neue Instanz der Klasse [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document) initialisieren und den Dateinamen und das Passwort als Argumente übergeben.  
{{% blocks/products/pf/feature-page-code %}}
