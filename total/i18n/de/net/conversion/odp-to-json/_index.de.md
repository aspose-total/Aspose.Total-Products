---
title: Konvertieren Sie ODP in das JSON-Format über .NET
description: Konvertieren Sie ODP in C# in JSON, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/net/conversion/odp-to-json/
family: total
platformtag: net
feature: conversion
informat: ODP
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie ODP in das JSON-Format über C#" h2="Exportieren Sie ODP über C# nach JSON, ohne Microsoft<sup>&reg;</sup> Excel oder PowerPoint zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie ODP in das JSON-Format innerhalb jeder .NET-, C#-, ASP.NET- und VB.NET-Anwendung in zwei konvertieren einfache Schritte. Erstens können Sie mit [Aspose.Slides for .NET](https://products.aspose.com/slides/net/) ODP in HTML exportieren. Danach können Sie mithilfe der Spreadsheet Programming API [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) HTML in JSON konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie ODP in das JSON-Format über C#" %}}
1. Öffnen Sie die ODP-Datei mit der Klasse [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation).
2. Konvertieren Sie ODP in HTML, indem Sie die Methode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) verwenden
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie ODP in JSON in Range über C#" %}}
