---
title: .NET-API zum Konvertieren von DOTM in ODS
description: C#-API zum Konvertieren von DOTM in ODS ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/dotm-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOTM in ODS" h2="DOTM über C# in ODS exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie die DOTM-zu-ODS-Konvertierungsfunktion in jede .NET-, C#-, ASP.NET- und VB.NET-Anwendung integrieren zwei einfache Schritte. Erstens können Sie mit [Aspose.Words for .NET](https://products.aspose.com/words/net/) DOTM in HTML exportieren. Danach können Sie mithilfe der Spreadsheet Programming API [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) HTML in ODS konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}
