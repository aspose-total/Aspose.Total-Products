---
title: Java API om PCL naar OTT te exporteren
description: Converteer PCL naar OTT met behulp van on-premise Java API
url: /nl/java/conversion/pcl-to-ott/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Transformeer PCL naar OTT via Java" h2="On Premise Java API om PCL naar OTT te renderen zonder een applicatie van derden te gebruiken" >}}
{{% blocks/products/pf/feature-page-summary %}}
U kunt PCL naar OTT converteren met behulp van twee eenvoudige stappen. Eerst moet u het PCL-bestand naar DOC renderen met [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Daarna kunt u met behulp van de krachtige API voor documentverwerking [Aspose.Words for Java](https://products.aspose.com/words/java/) DOC naar OTT converteren. Beide API's vallen onder het pakket [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java API om PCL naar OTT te converteren" %}}
...
4. Sla het document op in OTT-formaat met behulp van [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) methode en stel OTT in als OpslaanFormaat
