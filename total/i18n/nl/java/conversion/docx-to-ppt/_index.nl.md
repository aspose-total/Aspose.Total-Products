---
title: Converteer DOCX naar PPT via Java
description: Java API om DOCX naar PPT te exporteren zonder Microsoft Word of PowerPoint te gebruiken
url: /nl/java/conversion/docx-to-ppt/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer DOCX naar PPT via Java" h2="DOCX naar PPT-conversie door gebruik te maken van on-premise Java API binnen alle Java J2SE-, J2EE-, J2ME-applicaties zonder Microsoft<sup>&reg;</sup> PowerPoint of Word te gebruiken" >}}
...
6. Sla het docxument op in PPT met de methode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Conversievereisten" %}}
Voor DOCX naar PPT-bestandsconversie kunt u Aspose.Total voor Java eenvoudig rechtstreeks vanuit een [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) gebaseerd project en neem bibliotheken op in uw pom.xml.
...
Met de API kunt u ook met een wachtwoord beveiligde DOCX-docxumenten naar PPT converteren. Als uw DOCX-invoerdocxument met een wachtwoord is beveiligd, kunt u het niet converteren naar PPT-indeling zonder het wachtwoord te gebruiken. Om een versleuteld docxument te openen, kunt u het juiste wachtwoord instellen in het object LoadOptions en dit doorgeven aan de docxumentconstructor.  
{{% blocks/products/pf/feature-page-code %}}
