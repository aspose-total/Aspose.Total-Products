---
title: Converteer POT naar DOCX via Java
description: Java API om POT naar DOCX te exporteren zonder Microsoft Word of PowerPoint te gebruiken
url: /nl/java/conversion/pot-to-docx/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer POT naar DOCX via Java" h2="On Premise Java API voor PowerPoint POT naar DOCX conversie binnen alle Java J2SE, J2EE, J2ME applicaties" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hoe POT naar DOCX te converteren via Java" %}}
...
Voor POT-naar-DOCX-bestandsconversie kunt u Aspose.Total voor Java eenvoudig rechtstreeks vanuit een [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) gebaseerd project en neem bibliotheken op in uw pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/nl/net/conversion/pot-to-docxm/" name="POT Tot DOCXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/nl/net/conversion/pot-to-docxx/" name="POT Tot DOCXX" description="" >}}
