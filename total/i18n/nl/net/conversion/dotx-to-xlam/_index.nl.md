---
title: .NET API om DOTX naar XLAM te converteren
description: C# API om DOTX naar XLAM te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/dotx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Sla het dotxument op in XLAM-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLAM` in als SaveFormat
