...
description: C# API om DOCM naar EXCEL te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/docm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOCM naar EXCEL te converteren" h2="Exporteer DOCM naar EXCEL via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het docmument op in EXCEL-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `EXCEL` in als SaveFormat
