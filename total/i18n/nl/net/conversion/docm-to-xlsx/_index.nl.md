---
title: .NET API om DOCM naar XLSX te converteren
description: C# API om DOCM naar XLSX te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/docm-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOCM naar XLSX te converteren" h2="Exporteer DOCM naar XLSX via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}

{{% blocks/products/pf/feature-page-summary %}}
Door [Aspose.Total for .NET](https://products.aspose.com/total/net/) te gebruiken, kunt u DOCM naar XLSX-conversiefunctie opnemen in elke .NET-, C#-, ASP.NET- en VB.NET-toepassing in twee eenvoudige stappen. Ten eerste, door [Aspose.Words for .NET](https://products.aspose.com/words/net/) te gebruiken, kunt u DOCM naar HTML exporteren. Daarna kunt u met behulp van [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API HTML naar XLSX converteren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API om DOCM naar XLSX te converteren" %}}
1. Open het DOCM-bestand met de klasse [Docmument](https://apireference.aspose.com/words/net/aspose.words/docmument)
2. Converteer DOCM naar HTML met behulp van de [Save](https://apireference.aspose.com/words/net/aspose.words.docmument/save/methods/4) methode
3. Laad HTML-docmument met behulp van [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) class
4. Sla het docmument op in XLSX-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLSX` in als SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Laad DOCM Docmument van Stream via C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) stelt u ook in staat om DOCM-docmumenten via stream te laden. Om een docmument uit een stream te openen, geeft u eenvoudig een stream-object dat het docmument bevat door aan de [Docmument](https://apireference.aspose.com/words/net/aspose.words/docmument)-constructor. Het volgende codevoorbeeld laat zien hoe u een docmument vanuit een stream opent:  
{{% blocks/products/pf/feature-page-code %}}
...
Tijdens het converteren van DOCM naar XLSX kunt u met [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) aangepaste eigenschappen toevoegen aan uw XLSX-docmumenten. Om een aangepaste eigenschap toe te voegen, kunt u de methode [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection/methods/add/index) gebruiken voor de [CustomDocmumentPropertyCollection]( https://apireference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection) klasse. De Add-methode voegt de eigenschap toe aan het Excel-bestand en retourneert een verwijzing voor de nieuwe docmumenteigenschap als [Aspose.Cells.Properties.DocmumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /docmumentproperty) object. 
{{% blocks/products/pf/feature-page-code %}}
