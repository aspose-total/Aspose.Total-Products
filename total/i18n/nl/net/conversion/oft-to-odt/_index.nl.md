---
title: C# API om OFT naar ODT te exporteren
description: Converteer OFT naar ODT zonder Microsoft Word of Outlook te gebruiken op .NET
url: /nl/net/conversion/oft-to-odt/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exporteer OFT naar ODT via .NET" h2=".NET API om OFT naar ODT te renderen op Windows, macOS en Linux zonder Word of Outlook te gebruiken" >}}

{{% blocks/products/pf/feature-page-summary %}}
Als u een .NET-ontwikkelaar bent die OFT-naar-ODT-conversiefuncties in uw toepassingen wilt toevoegen, zijn [Aspose.Total for .NET](https://products.aspose.com/total/net/) bestandsformaatmanipulatie-API's de juiste keuze vooruit. Door [Aspose.Oft for .NET](https://products.aspose.com/oft/net/) te gebruiken, kunt u het OFT-bestandsformaat converteren naar HTML. Daarna kunt u met [Aspose.Words for .NET](https://products.aspose.com/words/net/) HTML naar ODT renderen.
{{% /blocks/products/pf/feature-page-summary  %}}
