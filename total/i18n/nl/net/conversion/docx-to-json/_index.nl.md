---
title: Converteer DOCX naar JSON-formaat via .NET
description: Converteer DOCX naar JSON in C# zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/docx-to-json/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer DOCX naar JSON-formaat via C#" h2="Parseer DOCX naar JSON via C# zonder Microsoft<sup>&reg;</sup> Word of Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Door [Aspose.Total for .NET](https://products.aspose.com/total/net/) te gebruiken, kunt u DOCX naar JSON-indeling converteren binnen elke .NET-, C#-, ASP.NET- en VB.NET-toepassing in twee eenvoudige stappen. Ten eerste, door [Aspose.Words for .NET](https://products.aspose.com/words/net/) te gebruiken, kunt u DOCX naar HTML exporteren. Daarna kunt u met behulp van [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API HTML naar JSON converteren.
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converteer DOCX naar JSON binnen bereik via C#" %}}
