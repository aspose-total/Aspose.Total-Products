---
title: .NET API om OTT naar EXCEL te converteren
description: C# API om OTT naar EXCEL te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/ott-to-excel/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om OTT naar EXCEL te converteren" h2="Exporteer OTT naar EXCEL via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}

{{% blocks/products/pf/feature-page-summary %}}
Door [Aspose.Total for .NET](https://products.aspose.com/total/net/) te gebruiken, kunt u OTT naar EXCEL-conversiefunctie opnemen in elke .NET-, C#-, ASP.NET- en VB.NET-toepassing in twee eenvoudige stappen. Ten eerste, door [Aspose.Words for .NET](https://products.aspose.com/words/net/) te gebruiken, kunt u OTT naar HTML exporteren. Daarna kunt u met behulp van [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API HTML naar EXCEL converteren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API om OTT naar EXCEL te converteren" %}}
1. Open het OTT-bestand met de klasse [Ottument](https://apireference.aspose.com/words/net/aspose.words/ottument)
2. Converteer OTT naar HTML met behulp van de [Save](https://apireference.aspose.com/words/net/aspose.words.ottument/save/methods/4) methode
3. Laad HTML-ottument met behulp van [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) class
4. Sla het ottument op in EXCEL-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `EXCEL` in als SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Laad OTT Ottument van Stream via C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) stelt u ook in staat om OTT-ottumenten via stream te laden. Om een ottument uit een stream te openen, geeft u eenvoudig een stream-object dat het ottument bevat door aan de [Ottument](https://apireference.aspose.com/words/net/aspose.words/ottument)-constructor. Het volgende codevoorbeeld laat zien hoe u een ottument vanuit een stream opent:  
{{% blocks/products/pf/feature-page-code %}}
...
Tijdens het converteren van OTT naar EXCEL kunt u met [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) aangepaste eigenschappen toevoegen aan uw EXCEL-ottumenten. Om een aangepaste eigenschap toe te voegen, kunt u de methode [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customottumentpropertycollection/methods/add/index) gebruiken voor de [CustomOttumentPropertyCollection]( https://apireference.aspose.com/cells/net/aspose.cells.properties/customottumentpropertycollection) klasse. De Add-methode voegt de eigenschap toe aan het Excel-bestand en retourneert een verwijzing voor de nieuwe ottumenteigenschap als [Aspose.Cells.Properties.OttumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /ottumentproperty) object. 
{{% blocks/products/pf/feature-page-code %}}
