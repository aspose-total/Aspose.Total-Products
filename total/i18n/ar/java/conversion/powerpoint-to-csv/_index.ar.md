---
title: تحويل POWERPOINT إلى تنسيق CSV عبر Java
description: قم بتحويل POWERPOINT إلى تنسيق CSV عبر Java دون استخدام Microsoft Excel أو PowerPoint
url: /ar/java/conversion/powerpoint-to-csv/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POWERPOINT إلى CSV عبر Java" h2="في Premise Java API لتصدير POWERPOINT إلى CSV بدون استخدام Microsoft <sup> & reg؛ </sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى CSV عبر Java" %}}
...
لتحويل POWERPOINT إلى CSV ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose / aspose-total) قائم على المشروع وقم بتضمين مكتبات في ملفك pom.xml.
