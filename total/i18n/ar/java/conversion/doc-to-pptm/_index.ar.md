---
title: تحويل DOC إلى PPTM عبر Java
description: Java API لتصدير DOC إلى PPTM دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/doc-to-pptm/
family: total
platformtag: net
feature: conversion
informat: DOC
...
لتحويل ملف DOC إلى PPTM ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose / aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
تتيح لك واجهة برمجة التطبيقات أيضًا تحويل مستندات DOC المحمية بكلمة مرور إلى PPTM. إذا كان مستند DOC الذي أدخلته محميًا بكلمة مرور ، فلا يمكنك تحويله إلى تنسيق PPTM بدون استخدام كلمة المرور. لفتح مستند مشفر ، يمكنك تعيين كلمة المرور الصحيحة في كائن LoadOptions وتمريرها إلى مُنشئ المستند.  
{{% blocks/products/pf/feature-page-code %}}
