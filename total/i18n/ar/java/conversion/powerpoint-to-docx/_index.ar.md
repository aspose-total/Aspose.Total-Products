---
title: تحويل POWERPOINT إلى DOCX عبر Java
description: Java API لتصدير POWERPOINT إلى DOCX دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/powerpoint-to-docx/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POWERPOINT إلى DOCX عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل POWERPOINT إلى DOCX داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى DOCX عبر Java" %}}
...
لتحويل ملف POWERPOINT إلى DOCX ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose / aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/powerpoint-to-docxm/" name="POWERPOINT ل DOCXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/powerpoint-to-docxx/" name="POWERPOINT ل DOCXX" description="" >}}
