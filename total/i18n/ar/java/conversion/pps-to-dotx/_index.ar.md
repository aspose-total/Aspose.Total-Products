---
title: تحويل PPS إلى DOTX عبر Java
description: Java API لتصدير PPS إلى DOTX دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/pps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPS إلى DOTX عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل PPS إلى DOTX داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPS إلى DOTX عبر Java" %}}
...
لتحويل ملف PPS إلى DOTX ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose / aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pps-to-dotxm/" name="PPS ل DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pps-to-dotxx/" name="PPS ل DOTXX" description="" >}}
