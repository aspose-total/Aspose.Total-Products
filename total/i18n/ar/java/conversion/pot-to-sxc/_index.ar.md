---
title: تحويل POT إلى تنسيق SXC عبر Java
description: قم بتحويل POT إلى تنسيق SXC عبر Java دون استخدام Microsoft Excel أو PowerPoint
url: /ar/java/conversion/pot-to-sxc/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى SXC عبر Java" h2="في Premise Java API لتصدير POT إلى SXC بدون استخدام Microsoft <sup> & reg؛ </sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى SXC عبر Java" %}}
...
لتحويل POT إلى SXC ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose / aspose-total) قائم على المشروع وقم بتضمين مكتبات في ملفك pom.xml.
