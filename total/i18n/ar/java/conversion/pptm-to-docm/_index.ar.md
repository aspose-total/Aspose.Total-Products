---
title: تحويل PPTM إلى DOCM عبر Java
description: Java API لتصدير PPTM إلى DOCM دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/pptm-to-docm/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPTM إلى DOCM عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل PPTM إلى DOCM داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPTM إلى DOCM عبر Java" %}}
...
لتحويل ملف PPTM إلى DOCM ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose / aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pptm-to-docmm/" name="PPTM ل DOCMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pptm-to-docmx/" name="PPTM ل DOCMX" description="" >}}
