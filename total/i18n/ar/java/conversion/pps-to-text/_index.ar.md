---
title: تحويل PPS إلى TEXT عبر Java
description: Java API لتصدير PPS إلى TEXT دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/pps-to-text/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPS إلى TEXT عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل PPS إلى TEXT داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
لتحويل ملف PPS إلى TEXT ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose / aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pps-to-textm/" name="PPS ل TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/pps-to-textx/" name="PPS ل TEXTX" description="" >}}
