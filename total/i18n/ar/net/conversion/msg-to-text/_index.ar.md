...
4. احفظ المستند بتنسيق TEXT باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) وقم بتعيين Text كـ SaveFormat
