...
4. احفظ المستند بتنسيق POTM باستخدام طريقة [حفظ] (https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) وعيّن `Potm` على أنه SaveFormat
