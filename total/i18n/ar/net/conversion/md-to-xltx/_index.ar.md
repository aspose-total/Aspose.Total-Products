---
title: تحويل MD إلى XLTX عبر C # API
description: C # API لتحويل ملف MD إلى XLTX بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/md-to-xltx/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C # API لتقديم MD إلى XLTX" h2="تصدير ملف MD إلى XLTX عبر C # بدون استخدام Microsoft <sup> & reg؛ </sup> Excel أو Adobe <sup> & reg؛ </sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
باستخدام [Aspose.Total for .NET] (https://products.aspose.com/total/net/) يمكنك بسهولة تحويل ملف MD إلى XLTX ضمن أي تطبيقات .NET و C # و ASP.NET و VB.NET. أولاً ، باستخدام [Aspose.PDF for .NET] (https://products.aspose.com/pdf/net/) ، يمكنك تصدير MD إلى XLSX. بعد ذلك ، باستخدام [Aspose.Cells for .NET] (https://products.aspose.com/cells/net/) Spreadsheet Programming API ، يمكنك تحويل XLSX إلى XLTX.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="NET API لتحويل MD إلى XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل المحمية MD إلى XLTX عبر C #" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل ملف MD إلى XLTX بعلامة مائية عبر C #" %}}
أثناء تحويل ملف MD إلى XLTX ، يمكنك أيضًا إضافة علامة مائية إلى تنسيق ملف XLTX الناتج. لإضافة علامة مائية ، يمكنك إنشاء كائن مصنف جديد وفتح مستند XLSX المحول ، وتحديد ورقة العمل عبر الفهرس الخاص به ، وإنشاء شكل واستخدام وظيفة AddTextEffect الخاصة به. بعد ذلك يمكنك حفظ مستند XLSX كملف XLTX مع علامة مائية. 
{{% blocks/products/pf/feature-page-code %}}
