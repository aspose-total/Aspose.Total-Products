...
4. احفظ المستند بتنسيق EPUB باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) وقم بتعيين Epub كـ SaveFormat
