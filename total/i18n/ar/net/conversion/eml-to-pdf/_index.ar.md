...
2. تحويل EML إلى HTML باستخدام طريقة [حفظ] (https://apireference.aspose.com/eml/net/aspose.eml.mailmessage/save/methods/3)
3. قم بتحميل HTML باستخدام فئة [Document] (https://apireference.aspose.com/words/net/aspose.words/document)
4. احفظ المستند بتنسيق PDF باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) وقم بتعيين Pdf كـ SaveFormat
