---
title: تحويل POT إلى SXC عبر C#
description: قم بتحويل POT إلى SXC في C# بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/net/conversion/pot-to-sxc/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى SXC عبر C#" h2="NET API لتحويل POT إلى SXC بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى SXC عبر C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل المحمية POT إلى SXC عبر C#" %}}
أثناء تحويل ملف POT إلى SXC ، إذا كان مستند POT الذي تم إدخاله محميًا بكلمة مرور ، فلا يمكنك تحويله إلى SXC بدون فك تشفير المستند. عندما يكون المستند محميًا بكلمة مرور ، فهذا يعني أنه يفرض قيودًا معينة على العرض التقديمي. لإزالة القيود ، يجب إدخال كلمة المرور. يعتبر العرض التقديمي المحمي بكلمة مرور عرضًا تقديميًا مغلقًا. تسمح لك واجهة برمجة التطبيقات بفتح المستند المشفر عن طريق تمرير كلمة المرور الصحيحة في كائن LoadOptions.  
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل POT إلى SXC مع علامة مائية عبر C#" %}}
أثناء تحويل ملف POT إلى SXC ، يمكنك أيضًا إضافة علامة مائية إلى تنسيق ملف SXC الناتج. لإضافة علامة مائية ، يمكنك إنشاء كائن مصنف جديد وفتح مستند HTML المحول ، وتحديد ورقة العمل عبر الفهرس الخاص به ، وإنشاء شكل واستخدام وظيفة AddTextEffect الخاصة به. بعد ذلك يمكنك حفظ مستند HTML كملف SXC مع علامة مائية. 
{{% blocks/products/pf/feature-page-code %}}
