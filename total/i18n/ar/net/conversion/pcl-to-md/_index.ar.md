---
title: تحويل PCL إلى MD عبر C# API
description: C# API لتحويل ملف PCL إلى MD بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/pcl-to-md/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/agp/feature-section-col title="NET API لتحويل PCL إلى MD" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل المحمية PCL إلى MD عبر C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل ملف PCL إلى MD بعلامة مائية عبر C#" %}}
أثناء تحويل ملف PCL إلى MD ، يمكنك أيضًا إضافة علامة مائية إلى تنسيق ملف MD الناتج. لإضافة علامة مائية ، يمكنك إنشاء كائن مصنف جديد وفتح مستند XLSX المحول ، وتحديد ورقة العمل عبر الفهرس الخاص به ، وإنشاء شكل واستخدام وظيفة AddTextEffect الخاصة به. بعد ذلك يمكنك حفظ مستند XLSX كملف MD مع علامة مائية. 
{{% blocks/products/pf/feature-page-code %}}
