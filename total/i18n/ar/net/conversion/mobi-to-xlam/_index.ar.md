...
description: C # API لتحويل MOBI إلى XLAM بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/mobi-to-xlam/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C # API لتحويل MOBI إلى XLAM" h2="تصدير MOBI إلى XLAM عبر C # بدون استخدام Microsoft <sup> & reg؛ </sup> Word أو Microsoft <sup> & reg؛ </sup> Excel" >}}
...
4. احفظ المستند بتنسيق XLAM باستخدام طريقة [حفظ] (https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) وعيّن `XLAM` على أنه SaveFormat
