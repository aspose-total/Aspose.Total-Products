...
4. احفظ المستند بتنسيق TIFF باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) وقم بتعيين Tiff كـ SaveFormat
