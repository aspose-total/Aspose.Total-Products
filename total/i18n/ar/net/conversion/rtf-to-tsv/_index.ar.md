---
title: NET API لتحويل RTF إلى TSV
description: C # API لتحويل RTF إلى TSV بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/rtf-to-tsv/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C # API لتحويل RTF إلى TSV" h2="تصدير RTF إلى TSV عبر C # بدون استخدام Microsoft <sup> & reg؛ </sup> Word أو Microsoft <sup> & reg؛ </sup> Excel" >}}
...
2. تحويل RTF إلى HTML باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods/4)
