...
4. احفظ المستند بتنسيق SWF باستخدام طريقة [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) وعيّن `Swf` على أنه SaveFormat
