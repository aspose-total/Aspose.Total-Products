...
description: C # API لتحويل RTF إلى XLT بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/rtf-to-xlt/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C # API لتحويل RTF إلى XLT" h2="تصدير RTF إلى XLT عبر C # بدون استخدام Microsoft <sup> & reg؛ </sup> Word أو Microsoft <sup> & reg؛ </sup> Excel" >}}
...
4. احفظ المستند بتنسيق XLT باستخدام طريقة [حفظ] (https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) وعيّن `XLT` على أنه SaveFormat
