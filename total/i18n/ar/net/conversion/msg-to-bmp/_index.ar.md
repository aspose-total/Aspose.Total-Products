...
4. احفظ المستند بتنسيق BMP باستخدام طريقة [حفظ] (https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) وقم بتعيين Bmp كـ SaveFormat
