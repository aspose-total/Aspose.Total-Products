---
title: C# API do eksportu PDF do DOCM
description: Konwertuj PDF na DOCM bez użycia Microsoft Word
url: /pl/net/conversion/pdf-to-docm/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderuj PDF do DOCM przez .NET" h2=".NET API do eksportu PDF do DOCM w systemach Windows, macOS i Linux bez użycia Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API do konwersji PDF na DOCM" %}}
...
Przed konwersją PDF do DOCM, jeśli chcesz odszyfrować swój dokument, możesz to zrobić za pomocą interfejsu API. Aby odszyfrować plik PDF, musisz najpierw utworzyć obiekt [Dokument](https://apireference.aspose.com/pdf/net/aspose.pdf/document) i otworzyć PDF przy użyciu hasła właściciela. Następnie musisz wywołać metodę [Decrypt](https://apireference.aspose.com/pdf/net/aspose.pdf/document/methods/decrypt) obiektu Document. Na koniec zapisz zaktualizowany plik za pomocą metody Save obiektu Document.  
{{% blocks/products/pf/feature-page-code %}}
```cs
