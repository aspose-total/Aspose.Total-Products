---
title: Eksportuj SVG do POTX przez C# API
description: .NET API do konwersji SVG na POTX bez użycia Microsoft Word
url: /pl/net/conversion/svg-to-potx/
family: total
platformtag: net
feature: conversion
informat: SVG
...
4. Zapisz dokument w formacie POTX za pomocą metody [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) i ustaw `Potx` jako SaveFormat
