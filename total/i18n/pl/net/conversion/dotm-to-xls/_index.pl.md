...
description: C# API do konwersji DOTM na XLS bez użycia Microsoft Excel lub Adobe Reader
url: /pl/net/conversion/dotm-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji DOTM na XLS" h2="Eksportuj DOTM do XLS za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API do konwersji DOTM na XLS" %}}
