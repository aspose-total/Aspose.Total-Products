---
title: Konwertuj HTML na PSD przez C# API
description: Eksportuj HTML do PSD w swoich aplikacjach .NET bez korzystania z aplikacji innych firm
url: /pl/net/conversion/html-to-psd/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj plik HTML na PSD za pomocą C#" h2="Eksportuj HTML do PSD w aplikacjach .NET bez użycia programu Adobe<sup>&reg;</sup> Acrobat Reader lub innych aplikacji innych firm" >}}

{{% blocks/products/pf/feature-page-summary %}}
Używając [Aspose.Total for .NET](https://products.aspose.com/total/net/) możesz łatwo wyeksportować HTML do obrazu PSD w dowolnej aplikacji .NET w dwóch prostych krokach. Po pierwsze, używając [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), możesz wyeksportować HTML do JPEG. Następnie za pomocą interfejsu API przetwarzania obrazów [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/) możesz przekonwertować JPEG na PSD.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj plik HTML na PSD przez .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj i obróć plik HTML do PSD za pomocą C#" %}}
