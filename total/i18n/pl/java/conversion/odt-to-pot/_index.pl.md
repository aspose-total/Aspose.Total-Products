---
title: Konwertuj ODT na POT za pomocą Javy
description: Java API do eksportu ODT do POT bez użycia Microsoft Word lub PowerPoint
url: /pl/java/conversion/odt-to-pot/
family: total
platformtag: net
feature: conversion
informat: ODT
...
Do konwersji plików ODT na POT można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) i dołącz biblioteki do swojego pom.xml.
