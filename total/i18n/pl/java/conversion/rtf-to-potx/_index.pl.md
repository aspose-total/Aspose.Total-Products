---
title: Konwertuj RTF na POTX za pomocą Javy
description: Java API do eksportu RTF do POTX bez użycia Microsoft Word lub PowerPoint
url: /pl/java/conversion/rtf-to-potx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
Do konwersji plików RTF na POTX można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) i dołącz biblioteki do swojego pom.xml.
