---
title: Java API do eksportu PCL do DOTX
description: Konwertuj PCL na DOTX za pomocą lokalnego interfejsu Java API
url: /pl/java/conversion/pcl-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Przekształć PCL w DOTX za pomocą Javy" h2="On Premise Java API do renderowania PCL do DOTX bez korzystania z aplikacji innych firm" >}}
{{% blocks/products/pf/feature-page-summary %}}
Możesz przekonwertować PCL na DOTX, wykonując dwa proste kroki. Najpierw musisz wyrenderować plik PCL do DOC za pomocą [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Następnie, korzystając z potężnego interfejsu API przetwarzania dokumentów [Aspose.Words for Java](https://products.aspose.com/words/java/), możesz przekonwertować DOC na DOTX. Oba interfejsy API są objęte pakietem [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java API do konwersji PCL na DOTX" %}}
