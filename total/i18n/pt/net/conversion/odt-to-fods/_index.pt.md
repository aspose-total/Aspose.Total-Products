---
title: API .NET para converter ODT para FODS
description: API C# para converter ODT para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-fods/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
