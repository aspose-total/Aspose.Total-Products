---
title: API .NET para converter RTF para FODS
description: API C# para converter RTF para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-fods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
