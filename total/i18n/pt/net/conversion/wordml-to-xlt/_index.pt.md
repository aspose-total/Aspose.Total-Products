---
title: API .NET para converter WORDML para XLT
description: API C# para converter WORDML para XLT sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xlt/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato XLT usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLT" como SaveFormat
