---
title: API C# para exportar PCL para DOT
description: Converter PCL para DOT sem usar o Microsoft Word
url: /pt/net/conversion/pcl-to-dot/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PCL para DOT via .NET" h2="API .NET para exportar PCL para DOT no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PCL em DOT" %}}
