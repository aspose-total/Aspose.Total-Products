---
title: API .NET para converter DOTM para SXC
description: API C# para converter DOTM para SXC sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato SXC usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "SXC" como SaveFormat
