---
title: API .NET para converter OTT para FODS
description: API C# para converter OTT para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-fods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Salve o ottumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
