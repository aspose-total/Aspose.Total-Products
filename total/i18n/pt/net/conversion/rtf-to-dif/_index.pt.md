---
title: API .NET para converter RTF para DIF
description: API C# para converter RTF para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-dif/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
