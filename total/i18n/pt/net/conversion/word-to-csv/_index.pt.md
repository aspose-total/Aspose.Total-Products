---
title: API .NET para converter WORD para CSV
description: API C# para converter WORD para CSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Salve o wordumento no formato CSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "CSV" como SaveFormat
