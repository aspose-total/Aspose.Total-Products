---
title: API C# para exportar MD para PS
description: Converter MD para PS sem usar o Microsoft Word
url: /pt/net/conversion/md-to-ps/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar MD para PS via .NET" h2="API .NET para exportar MD para PS no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter MD em PS" %}}
