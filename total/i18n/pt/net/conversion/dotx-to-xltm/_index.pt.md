---
title: API .NET para converter DOTX para XLTM
description: API C# para converter DOTX para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotx-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Salve o dotxumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
