---
title: API C# para exportar MD para DOTX
description: Converter MD para DOTX sem usar o Microsoft Word
url: /pt/net/conversion/md-to-dotx/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar MD para DOTX via .NET" h2="API .NET para exportar MD para DOTX no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter MD em DOTX" %}}
