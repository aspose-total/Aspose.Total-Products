---
title: API .NET para converter WORDML para XLAM
description: API C# para converter WORDML para XLAM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xlam/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato XLAM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLAM" como SaveFormat
