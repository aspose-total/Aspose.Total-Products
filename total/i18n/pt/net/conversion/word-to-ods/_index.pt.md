---
title: API .NET para converter WORD para ODS
description: API C# para converter WORD para ODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-ods/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Salve o wordumento no formato ODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "ODS" como SaveFormat
