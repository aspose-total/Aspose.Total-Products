---
title: API .NET para converter DOCM para XLTM
description: API C# para converter DOCM para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docm-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Salve o docmumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
