---
title: API .NET para converter DOCM para DIF
description: API C# para converter DOCM para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Salve o docmumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
