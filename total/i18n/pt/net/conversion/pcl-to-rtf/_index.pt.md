---
title: API C# para exportar PCL para RTF
description: Converter PCL para RTF sem usar o Microsoft Word
url: /pt/net/conversion/pcl-to-rtf/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PCL para RTF via .NET" h2="API .NET para exportar PCL para RTF no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PCL em RTF" %}}
