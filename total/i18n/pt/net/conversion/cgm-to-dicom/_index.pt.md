---
title: Converter CGM para DICOM via API C#
description: Exporte CGM para DICOM em seus aplicativos .NET sem usar nenhum aplicativo de terceiros
url: /pt/net/conversion/cgm-to-dicom/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter arquivo CGM para DICOM via C#" h2="Exporte CGM para DICOM em aplicativos .NET sem usar o Adobe<sup>&reg;</sup> Acrobat Reader ou qualquer outro aplicativo de terceiros" >}}

{{% blocks/products/pf/feature-page-summary %}}
Usando [Aspose.Total for .NET](https://products.aspose.com/total/net/) você pode exportar facilmente CGM para imagem DICOM em qualquer aplicativo .NET em duas etapas simples. Em primeiro lugar, usando [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), você pode exportar CGM para JPEG. Depois disso, usando [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/) API de processamento de imagem, você pode converter JPEG para DICOM.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converter arquivo CGM para DICOM via .NET" %}}
...
{{< /blocks/products/pf/agp/feature-section >}}
C#
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo CGM para DICOM em um único arquivo via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converta e gire o arquivo CGM para DICOM via C#" %}}
