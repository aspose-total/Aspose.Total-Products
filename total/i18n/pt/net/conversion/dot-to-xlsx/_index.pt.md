---
title: API .NET para converter DOT para XLSX
description: API C# para converter DOT para XLSX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dot-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Salve o dotumento no formato XLSX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSX" como SaveFormat
