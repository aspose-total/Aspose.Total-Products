---
title: API .NET para converter DOCX para DIF
description: API C# para converter DOCX para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Salve o docxumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
