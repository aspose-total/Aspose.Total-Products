---
title: API .NET para converter WORDML para XLTX
description: API C# para converter WORDML para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xltx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato XLTX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTX" como SaveFormat
