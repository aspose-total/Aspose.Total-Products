---
title: Converter POWERPOINT para CSV via C#
description: Converter POWERPOINT para CSV em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/powerpoint-to-csv/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POWERPOINT para CSV via C#" h2="API .NET para conversão de POWERPOINT para CSV sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Usando [Aspose.Total for .NET](https://products.aspose.com/total/net/) você pode converter o arquivo POWERPOINT para CSV em qualquer aplicativo .NET, C#, ASP.NET e VB.NET em dois passos simples. Em primeiro lugar, usando [Aspose.Slides for .NET](https://products.aspose.com/slides/net/), você pode exportar POWERPOINT para HTML. Depois disso, usando a API de programação de planilha [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), você pode converter HTML para CSV.
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter POWERPOINT Protegido para CSV via C#" %}}
