---
title: API .NET para converter ODT para CSV
description: API C# para converter ODT para CSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-csv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato CSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "CSV" como SaveFormat
