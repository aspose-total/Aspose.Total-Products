---
title: API .NET para converter DOCM para XLS
description: API C# para converter DOCM para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docm-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Salve o docmumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
