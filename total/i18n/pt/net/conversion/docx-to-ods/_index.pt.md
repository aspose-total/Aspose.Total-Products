...
url: /pt/net/conversion/docx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para converter DOCX para ODS" %}}
...
4. Salve o docxumento no formato ODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "ODS" como SaveFormat
