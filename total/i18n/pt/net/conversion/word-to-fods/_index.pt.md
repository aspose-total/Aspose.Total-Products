---
title: API .NET para converter WORD para FODS
description: API C# para converter WORD para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-fods/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Salve o wordumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
