---
title: Converter DOT para formato JSON via .NET
description: Converter DOT para JSON em C# sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dot-to-json/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Salve o dotumento no formato JSON usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Converter DOT para JSON no intervalo via C#" %}}
