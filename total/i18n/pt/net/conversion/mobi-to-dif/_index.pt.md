---
title: API .NET para converter MOBI para DIF
description: API C# para converter MOBI para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/mobi-to-dif/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Salve o mobiumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
