---
title: API .NET para converter OTT para XLT
description: API C# para converter OTT para XLT sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xlt/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Salve o ottumento no formato XLT usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLT" como SaveFormat
