---
title: API .NET para converter DOC para XLAM
description: API C# para converter DOC para XLAM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/doc-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOC para XLAM" h2="Exporte DOC para XLAM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para converter DOC para XLAM" %}}
