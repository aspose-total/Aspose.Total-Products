---
title: API .NET para converter RTF para XLTX
description: API C# para converter RTF para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-xltx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter RTF para XLTX" h2="Exporte RTF para XLTX via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o rtfumento no formato XLTX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTX" como SaveFormat
