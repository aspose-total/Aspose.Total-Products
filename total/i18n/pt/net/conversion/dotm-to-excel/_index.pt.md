---
title: API .NET para converter DOTM para EXCEL
description: API C# para converter DOTM para EXCEL sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato EXCEL usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "EXCEL" como SaveFormat
