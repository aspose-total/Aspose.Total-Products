---
title: API .NET para converter RTF para XLAM
description: API C# para converter RTF para XLAM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-xlam/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato XLAM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLAM" como SaveFormat
