---
title: Converter PPS para DIF via C#
description: Converter PPS para DIF em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/pps-to-dif/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para DIF via C#" h2="API .NET para conversão de PPS para DIF sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
