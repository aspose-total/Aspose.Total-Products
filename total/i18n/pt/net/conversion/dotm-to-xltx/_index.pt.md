---
title: API .NET para converter DOTM para XLTX
description: API C# para converter DOTM para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTM
