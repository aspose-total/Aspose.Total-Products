---
title: API C# para exportar TEX para MHTML
description: Converter TEX para MHTML sem usar o Microsoft Word
url: /pt/net/conversion/tex-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar TEX para MHTML via .NET" h2="API .NET para exportar TEX para MHTML no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter TEX em MHTML" %}}
