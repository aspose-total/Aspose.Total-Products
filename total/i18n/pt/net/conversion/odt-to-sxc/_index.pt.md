---
title: API .NET para converter ODT para SXC
description: API C# para converter ODT para SXC sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-sxc/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato SXC usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "SXC" como SaveFormat
