---
title: API .NET para converter DOTM para XLS
description: API C# para converter DOTM para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
