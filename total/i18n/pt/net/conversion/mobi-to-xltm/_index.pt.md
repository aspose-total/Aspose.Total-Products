---
title: API .NET para converter MOBI para XLTM
description: API C# para converter MOBI para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/mobi-to-xltm/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Salve o mobiumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
