---
title: API C# para exportar OFT para OTT
description: Converta OFT para OTT sem usar o Microsoft Word ou Outlook em .NET
url: /pt/net/conversion/oft-to-ott/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exportar OFT para OTT via .NET" h2="API .NET para renderizar OFT para OTT no Windows, macOS e Linux sem usar Word ou Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Se você é um desenvolvedor .NET que deseja adicionar recursos de conversão de OFT para OTT dentro de seus aplicativos, as APIs de manipulação de formato de arquivo [Aspose.Total for .NET](https://products.aspose.com/total/net/) são o caminho. frente. Usando [Aspose.Oft para .NET](https://products.aspose.com/oft/net/), você pode converter o formato de arquivo OFT para HTML. Depois disso, usando [Aspose.Words for .NET](https://products.aspose.com/words/net/), você pode renderizar HTML para OTT.
{{% /blocks/products/pf/feature-page-summary  %}}
