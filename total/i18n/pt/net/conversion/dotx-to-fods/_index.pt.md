---
title: API .NET para converter DOTX para FODS
description: API C# para converter DOTX para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Salve o dotxumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
