---
title: API .NET para converter ODT para XLTX
description: API C# para converter ODT para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-xltx/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato XLTX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTX" como SaveFormat
