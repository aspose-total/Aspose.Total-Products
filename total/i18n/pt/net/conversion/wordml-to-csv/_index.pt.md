---
title: API .NET para converter WORDML para CSV
description: API C# para converter WORDML para CSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato CSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "CSV" como SaveFormat
