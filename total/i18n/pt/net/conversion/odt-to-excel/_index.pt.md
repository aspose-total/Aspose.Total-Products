---
title: API .NET para converter ODT para EXCEL
description: API C# para converter ODT para EXCEL sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-excel/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato EXCEL usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "EXCEL" como SaveFormat
