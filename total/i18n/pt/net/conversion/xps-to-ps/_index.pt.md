---
title: API C# para exportar XPS para PS
description: Converter XPS para PS sem usar o Microsoft Word
url: /pt/net/conversion/xps-to-ps/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar XPS para PS via .NET" h2="API .NET para exportar XPS para PS no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter XPS em PS" %}}
