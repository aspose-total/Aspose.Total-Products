---
title: API C# para exportar TEX para DOT
description: Converter TEX para DOT sem usar o Microsoft Word
url: /pt/net/conversion/tex-to-dot/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar TEX para DOT via .NET" h2="API .NET para exportar TEX para DOT no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter TEX em DOT" %}}
