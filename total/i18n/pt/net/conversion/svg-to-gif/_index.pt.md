---
title: API C# para exportar SVG para GIF
description: Converter SVG para GIF sem usar o Microsoft Word
url: /pt/net/conversion/svg-to-gif/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar SVG para GIF via .NET" h2="API .NET para exportar SVG para GIF no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter SVG em GIF" %}}
