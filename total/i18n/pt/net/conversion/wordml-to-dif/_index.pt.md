---
title: API .NET para converter WORDML para DIF
description: API C# para converter WORDML para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
