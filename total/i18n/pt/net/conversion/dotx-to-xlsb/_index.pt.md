---
title: API .NET para converter DOTX para XLSB
description: API C# para converter DOTX para XLSB sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Salve o dotxumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
