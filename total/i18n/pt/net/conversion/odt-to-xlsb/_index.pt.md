---
title: API .NET para converter ODT para XLSB
description: API C# para converter ODT para XLSB sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
