---
title: API .NET para converter DOTM para FODS
description: API C# para converter DOTM para FODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato FODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "FODS" como SaveFormat
