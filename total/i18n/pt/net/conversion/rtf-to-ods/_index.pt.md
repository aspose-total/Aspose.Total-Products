---
title: API .NET para converter RTF para ODS
description: API C# para converter RTF para ODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-ods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato ODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "ODS" como SaveFormat
