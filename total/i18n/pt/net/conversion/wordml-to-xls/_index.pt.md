---
title: API .NET para converter WORDML para XLS
description: API C# para converter WORDML para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Salve o wordmlumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
