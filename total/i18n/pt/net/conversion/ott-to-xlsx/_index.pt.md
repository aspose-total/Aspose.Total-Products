---
title: API .NET para converter OTT para XLSX
description: API C# para converter OTT para XLSX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Salve o ottumento no formato XLSX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSX" como SaveFormat
