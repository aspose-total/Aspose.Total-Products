---
title: API .NET para converter ODT para TSV
description: API C# para converter ODT para TSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/odt-to-tsv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Salve o odtumento no formato TSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "TSV" como SaveFormat
