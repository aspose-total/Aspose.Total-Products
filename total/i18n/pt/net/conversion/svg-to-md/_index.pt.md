---
title: Converter SVG para MD via API C#
description: API C# para converter arquivo SVG em MD sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/svg-to-md/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para renderizar SVG para MD" h2="Exporte o arquivo SVG para MD via C# sem usar o Microsoft<sup>&reg;</sup> Excel ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
Usando [Aspose.Total for .NET](https://products.aspose.com/total/net/) você pode facilmente converter arquivos SVG para MD em qualquer aplicativo .NET, C#, ASP.NET e VB.NET. Em primeiro lugar, usando [Aspose.PDF para .NET](https://products.aspose.com/pdf/net/), você pode exportar SVG para XLSX. Depois disso, usando [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, você pode converter XLSX para MD.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API .NET para converter SVG em MD" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter SVG Protegido para MD via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo SVG para MD com marca d'água via C#" %}}
