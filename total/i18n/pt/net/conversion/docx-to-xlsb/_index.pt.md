---
title: API .NET para converter DOCX para XLSB
description: API C# para converter DOCX para XLSB sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Salve o docxumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
