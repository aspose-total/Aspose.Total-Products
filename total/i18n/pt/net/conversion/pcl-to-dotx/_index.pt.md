---
title: API C# para exportar PCL para DOTX
description: Converter PCL para DOTX sem usar o Microsoft Word
url: /pt/net/conversion/pcl-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PCL para DOTX via .NET" h2="API .NET para exportar PCL para DOTX no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PCL em DOTX" %}}
