...
description: Converter PPS para SXC em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/pps-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPS
...
4. Salve o documento em SXC usando o método [Salvar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Converter PPS para SXC com marca d'água via C#" %}}
