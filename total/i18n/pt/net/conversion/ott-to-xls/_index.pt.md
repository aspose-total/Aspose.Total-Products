---
title: API .NET para converter OTT para XLS
description: API C# para converter OTT para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Salve o ottumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
