---
title: API .NET para converter DOTX para XLSM
description: API C# para converter DOTX para XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Salve o dotxumento no formato XLSM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSM" como SaveFormat
