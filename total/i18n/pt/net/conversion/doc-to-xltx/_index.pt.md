---
title: API .NET para converter DOC para XLTX
description: API C# para converter DOC para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/doc-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOC
