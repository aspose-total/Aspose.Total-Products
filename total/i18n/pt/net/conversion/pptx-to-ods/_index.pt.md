---
title: Converter PPTX para ODS via C#
description: Converter PPTX para ODS em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/pptx-to-ods/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPTX para ODS via C#" h2="API .NET para conversão de PPTX para ODS sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter PPTX para ODS via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter PPTX para ODS com marca d'água via C#" %}}
