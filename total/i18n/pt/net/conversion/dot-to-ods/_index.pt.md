---
title: API .NET para converter DOT para ODS
description: API C# para converter DOT para ODS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dot-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Salve o dotumento no formato ODS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "ODS" como SaveFormat
