---
title: API .NET para converter RTF para XLTM
description: API C# para converter RTF para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-xltm/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
