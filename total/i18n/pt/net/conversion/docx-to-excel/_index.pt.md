---
title: API .NET para converter DOCX para EXCEL
description: API C# para converter DOCX para EXCEL sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Salve o docxumento no formato EXCEL usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "EXCEL" como SaveFormat
