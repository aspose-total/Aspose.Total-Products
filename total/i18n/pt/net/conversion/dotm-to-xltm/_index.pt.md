---
title: API .NET para converter DOTM para XLTM
description: API C# para converter DOTM para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
