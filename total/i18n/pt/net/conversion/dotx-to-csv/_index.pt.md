---
title: API .NET para converter DOTX para CSV
description: API C# para converter DOTX para CSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotx-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Salve o dotxumento no formato CSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "CSV" como SaveFormat
