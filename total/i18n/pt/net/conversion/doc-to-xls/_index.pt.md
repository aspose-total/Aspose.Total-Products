---
title: API .NET para converter DOC para XLS
description: API C# para converter DOC para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/doc-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOC para XLS" h2="Exporte DOC para XLS via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para converter DOC para XLS" %}}
...
4. Salve o documento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
