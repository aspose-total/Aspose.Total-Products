...
description: Converter POWERPOINT para DIF em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/powerpoint-to-dif/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POWERPOINT para DIF via C#" h2="API .NET para conversão de POWERPOINT para DIF sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
