---
title: Converter PCL para TGA via API C#
description: Exporte PCL para TGA em seus aplicativos .NET sem usar nenhum aplicativo de terceiros
url: /pt/net/conversion/pcl-to-tga/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter arquivo PCL para TGA via C#" h2="Exporte PCL para TGA em aplicativos .NET sem usar o Adobe<sup>&reg;</sup> Acrobat Reader ou qualquer outro aplicativo de terceiros" >}}

{{% blocks/products/pf/feature-page-summary %}}
Usando [Aspose.Total for .NET](https://products.aspose.com/total/net/) você pode exportar facilmente PCL para imagem TGA em qualquer aplicativo .NET em duas etapas simples. Em primeiro lugar, usando [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), você pode exportar PCL para JPEG. Depois disso, usando [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/) API de processamento de imagem, você pode converter JPEG para TGA.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converter arquivo PCL para TGA via .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converta e gire o arquivo PCL para TGA via C #" %}}
