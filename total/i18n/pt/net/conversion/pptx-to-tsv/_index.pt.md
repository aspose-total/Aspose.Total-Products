---
title: Converter PPTX para TSV via C#
description: Converter PPTX para TSV em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/pptx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPTX para TSV via C#" h2="API .NET para conversão de PPTX para TSV sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter PPTX para TSV via C#" %}}
