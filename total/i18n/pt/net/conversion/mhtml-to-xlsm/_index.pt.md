---
title: Converter MHTML para XLSM via API C#
description: API C# para converter arquivo MHTML em XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/mhtml-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/feature-page-section  h2="Converter MHTML Protegido para XLSM via C#" %}}
Se o seu documento MHTML estiver protegido por senha, você não poderá convertê-lo em XLSM sem a senha. Usando a API, você pode primeiro abrir o documento protegido usando uma senha válida e convertê-lo depois. Para abrir o arquivo criptografado, você pode inicializar uma nova instância da classe [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document) e passar o nome do arquivo e a senha como argumentos.  
{{% blocks/products/pf/feature-page-code %}}
