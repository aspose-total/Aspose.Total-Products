---
title: API C# para exportar CGM para XAMLFLOW
description: Converter CGM para XAMLFLOW sem usar o Microsoft Word
url: /pt/net/conversion/cgm-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar CGM para XAMLFLOW via .NET" h2="API .NET para exportar CGM para XAMLFLOW no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter CGM em XAMLFLOW" %}}
