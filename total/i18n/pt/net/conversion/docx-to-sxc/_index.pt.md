---
title: API .NET para converter DOCX para SXC
description: API C# para converter DOCX para SXC sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Salve o docxumento no formato SXC usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "SXC" como SaveFormat
