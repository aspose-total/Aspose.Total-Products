---
title: Converter DOTM para formato JSON via .NET
description: Converter DOTM para JSON em C# sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-json/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato JSON usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Converter DOTM para JSON no intervalo via C #" %}}
