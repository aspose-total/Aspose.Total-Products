---
title: API .NET para converter DOC para DIF
description: API C# para converter DOC para DIF sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/doc-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOC
