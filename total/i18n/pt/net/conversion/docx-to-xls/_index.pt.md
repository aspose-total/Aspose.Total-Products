---
title: API .NET para converter DOCX para XLS
description: API C# para converter DOCX para XLS sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Salve o docxumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
