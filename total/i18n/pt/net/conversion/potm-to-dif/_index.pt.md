...
description: Converter POTM para DIF em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/potm-to-dif/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
4. Salve o documento em DIF usando o método [Salvar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Converter POTM para DIF com marca d'água via C #" %}}
