---
title: API .NET para converter WORD para XLT
description: API C# para converter WORD para XLT sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-xlt/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Salve o wordumento no formato XLT usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLT" como SaveFormat
