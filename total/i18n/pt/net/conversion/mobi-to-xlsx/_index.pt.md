---
title: API .NET para converter MOBI para XLSX
description: API C# para converter MOBI para XLSX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/mobi-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Salve o mobiumento no formato XLSX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSX" como SaveFormat
