---
title: API .NET para converter DOTM para XLT
description: API C# para converter DOTM para XLT sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dotm-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Salve o dotmumento no formato XLT usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLT" como SaveFormat
