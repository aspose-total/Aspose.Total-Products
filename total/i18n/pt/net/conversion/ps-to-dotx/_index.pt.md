---
title: API C# para exportar PS para DOTX
description: Converter PS para DOTX sem usar o Microsoft Word
url: /pt/net/conversion/ps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PS para DOTX via .NET" h2="API .NET para exportar PS para DOTX no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PS em DOTX" %}}
