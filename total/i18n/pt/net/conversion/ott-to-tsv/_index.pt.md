---
title: API .NET para converter OTT para TSV
description: API C# para converter OTT para TSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-tsv/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Salve o ottumento no formato TSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "TSV" como SaveFormat
