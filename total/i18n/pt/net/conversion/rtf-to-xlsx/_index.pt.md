---
title: API .NET para converter RTF para XLSX
description: API C# para converter RTF para XLSX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/rtf-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Salve o rtfumento no formato XLSX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSX" como SaveFormat
