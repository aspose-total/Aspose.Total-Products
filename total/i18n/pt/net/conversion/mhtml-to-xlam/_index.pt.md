---
title: Converter MHTML para XLAM via API C#
description: API C# para converter arquivo MHTML em XLAM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/mhtml-to-xlam/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/feature-page-section  h2="Converter MHTML Protegido para XLAM via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo MHTML para XLAM com marca d'água via C#" %}}
