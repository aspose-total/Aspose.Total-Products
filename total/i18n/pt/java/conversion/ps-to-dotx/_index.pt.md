---
title: API Java para exportar PS para DOTX
description: Converter PS para DOTX usando a API Java local
url: /pt/java/conversion/ps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PS
...
4. Salve o documento no formato DOTX usando o método [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) e defina o DOTX como SalvarFormato
