---
title: Converter POWERPOINT para formato XLSB via Java
description: Converta o formato POWERPOINT para XLSB via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/java/conversion/powerpoint-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POWERPOINT para XLSB via Java" h2="API Java no local para exportar POWERPOINT para XLSB sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
{{% blocks/products/pf/feature-page-summary %}}
Você pode converter o arquivo POWERPOINT para XLSB via [Aspose.Total for Java](https://products.aspose.com/total/java/) em duas etapas. Na primeira etapa, você pode exportar POWERPOINT para HTML usando [Aspose.Slides for Java](https://products.aspose.com/slides/java/). Em segundo lugar, usando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), você pode converter HTML para XLSB.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Como converter POWERPOINT para XLSB via Java" %}}
...
Para converter POWERPOINT para XLSB, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
...
Usando a API, você também pode abrir o documento protegido por senha. Se o documento POWERPOINT de entrada estiver protegido por senha, você não poderá convertê-lo em XLSB sem usar a senha. A API permite que você abra o documento criptografado passando a senha correta em um objeto LoadOptions.  
{{% blocks/products/pf/feature-page-code %}}

{{< gist "aspose-com-gists" "4b527b3966d48e40c1b50136eebdbb6e" "convert-protected-powerpoint-to-excel.java" >}}
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Converter POWERPOINT Protegido para XLSB via Java" %}}
