...
6. Salve o docmumento no POTM usando o método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
A API também permite converter docmumentos DOCM protegidos por senha em POTM. Se o docmumento DOCM de entrada estiver protegido por senha, você não poderá convertê-lo para o formato POTM sem usar a senha. Para abrir um docmumento criptografado, você pode definir a senha correta no objeto LoadOptions e passá-la para o construtor Docmument.  
{{% blocks/products/pf/feature-page-code %}}
