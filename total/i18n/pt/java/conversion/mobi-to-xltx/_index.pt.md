---
title: API Java para converter MOBI para XLTX
description: Converta MOBI para XLTX via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/java/conversion/mobi-to-xltx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter MOBI para XLTX via Java" h2="API Java no local para converter MOBI para XLTX sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
{{% blocks/products/pf/feature-page-summary %}}
Converter MOBI para XLTX via [Aspose.Total for Java](https://products.aspose.com/total/java/) é um processo simples de duas etapas. Usando a API de conversão e manipulação de mobiumentos rica em recursos [Aspose.Words for Java](https://products.aspose.com/words/java/), você pode exportar MOBI para HTML. Depois disso, usando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), você pode converter HTML para XLTX.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API C++ para converter MOBI para XLTX" %}}
...
4. Salve o mobiumento no formato XLTX usando [Salvar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) método
