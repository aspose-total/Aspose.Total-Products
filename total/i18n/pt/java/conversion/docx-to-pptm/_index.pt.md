...
6. Salve o docxumento no PPTM usando o método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
A API também permite converter docxumentos DOCX protegidos por senha em PPTM. Se o docxumento DOCX de entrada estiver protegido por senha, você não poderá convertê-lo para o formato PPTM sem usar a senha. Para abrir um docxumento criptografado, você pode definir a senha correta no objeto LoadOptions e passá-la para o construtor Docxument.  
{{% blocks/products/pf/feature-page-code %}}
