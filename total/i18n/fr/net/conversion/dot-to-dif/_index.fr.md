---
title: API .NET pour convertir DOT en DIF
description: API C# pour convertir DOT en DIF sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dot-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Enregistrez le dotument au format DIF à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `DIF` comme SaveFormat
