---
title: Convertir XPS en DXF via l'API C#
description: Exportez XPS vers DXF dans vos applications .NET sans utiliser d'application tierce
url: /fr/net/conversion/xps-to-dxf/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir et faire pivoter le fichier XPS en DXF via C #" %}}
