---
title: API C# pour exporter TEX vers PS
description: Convertir TEX en PS sans utiliser Microsoft Word
url: /fr/net/conversion/tex-to-ps/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre TEX en PS via .NET" h2="API .NET pour exporter TEX vers PS sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir TEX en PS" %}}
