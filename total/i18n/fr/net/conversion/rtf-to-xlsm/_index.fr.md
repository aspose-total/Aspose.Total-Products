---
title: API .NET pour convertir RTF en XLSM
description: API C# pour convertir RTF en XLSM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Enregistrez le rtfument au format XLSM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSM` comme SaveFormat
