---
title: Convertir le format DOT au format JSON via .NET
description: Convertir DOT en JSON en C# sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dot-to-json/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{% blocks/products/pf/feature-page-section  h2="Convertir DOT en JSON dans Range via C#" %}}
