---
title: API .NET pour convertir OTT en TSV
description: API C # pour convertir OTT en TSV sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/ott-to-tsv/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Enregistrez le ottument au format TSV à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `TSV` comme SaveFormat
