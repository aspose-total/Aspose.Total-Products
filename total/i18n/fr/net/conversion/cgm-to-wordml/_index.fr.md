---
title: API C# pour exporter CGM vers WORDML
description: Convertir CGM en WORDML sans utiliser Microsoft Word
url: /fr/net/conversion/cgm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre CGM en WORDML via .NET" h2="API .NET pour exporter CGM vers WORDML sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir CGM en WORDML" %}}
