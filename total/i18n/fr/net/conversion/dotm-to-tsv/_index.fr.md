---
title: API .NET pour convertir DOTM en TSV
description: API C # pour convertir DOTM en TSV sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Enregistrez le dotmument au format TSV à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `TSV` comme SaveFormat
