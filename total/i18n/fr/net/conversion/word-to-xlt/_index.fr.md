---
title: API .NET pour convertir WORD en XLT
description: API C# pour convertir WORD en XLT sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-xlt/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Enregistrez le wordument au format XLT à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLT` comme SaveFormat
