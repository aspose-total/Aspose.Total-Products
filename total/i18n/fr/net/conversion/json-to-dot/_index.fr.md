...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en DOT via C#" %}}
...
4. Enregistrez le document au format DOT en utilisant la méthode [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/3)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en DOT via C #" %}}
