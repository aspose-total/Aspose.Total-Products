---
title: API .NET pour convertir DOT en XLSM
description: API C# pour convertir DOT en XLSM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dot-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Enregistrez le dotument au format XLSM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSM` comme SaveFormat
