---
title: API .NET pour convertir RTF en ODS
description: API C# pour convertir RTF en ODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-ods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Enregistrez le rtfument au format ODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `ODS` comme SaveFormat
