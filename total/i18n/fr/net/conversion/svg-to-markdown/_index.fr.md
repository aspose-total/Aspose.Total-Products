---
title: API C# pour exporter SVG vers MARKDOWN
description: Convertir SVG en MARKDOWN sans utiliser Microsoft Word
url: /fr/net/conversion/svg-to-markdown/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre SVG en MARKDOWN via .NET" h2="API .NET pour exporter SVG vers MARKDOWN sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir SVG en MARKDOWN" %}}
