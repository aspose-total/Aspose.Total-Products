---
title: API .NET pour convertir ODT en XLT
description: API C # pour convertir ODT en XLT sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/odt-to-xlt/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Enregistrez le odtument au format XLT à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLT` comme SaveFormat
