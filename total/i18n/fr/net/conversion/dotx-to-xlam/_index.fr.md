---
title: API .NET pour convertir DOTX en XLAM
description: API C# pour convertir DOTX en XLAM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Enregistrez le dotxument au format XLAM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLAM` comme SaveFormat
