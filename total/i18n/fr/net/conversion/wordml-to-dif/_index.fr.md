---
title: API .NET pour convertir WORDML en DIF
description: API C # pour convertir WORDML en DIF sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/wordml-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Enregistrez le wordmlument au format DIF à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `DIF` comme SaveFormat
