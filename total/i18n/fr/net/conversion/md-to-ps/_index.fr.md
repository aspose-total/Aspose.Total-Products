---
title: API C# pour exporter MD vers PS
description: Convertir MD en PS sans utiliser Microsoft Word
url: /fr/net/conversion/md-to-ps/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MD en PS via .NET" h2="API .NET pour exporter MD vers PS sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir MD en PS" %}}
