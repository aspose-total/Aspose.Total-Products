...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir ODT en XLSB" %}}
...
4. Enregistrez le odtument au format XLSB à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSB` comme SaveFormat
