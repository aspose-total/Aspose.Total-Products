---
title: API .NET pour convertir MOBI en TSV
description: API C# pour convertir MOBI en TSV sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/mobi-to-tsv/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Enregistrez le mobiument au format TSV à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `TSV` comme SaveFormat
