---
title: API .NET pour convertir RTF en XLTX
description: API C # pour convertir RTF en XLTX sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-xltx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Enregistrez le rtfument au format XLTX à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLTX` comme SaveFormat
