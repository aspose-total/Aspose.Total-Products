---
title: API .NET pour convertir ODT en XLTM
description: API C# pour convertir ODT en XLTM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/odt-to-xltm/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Enregistrez le odtument au format XLTM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLTM` comme SaveFormat
