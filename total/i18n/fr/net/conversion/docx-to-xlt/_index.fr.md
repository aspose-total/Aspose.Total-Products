---
title: API .NET pour convertir DOCX en XLT
description: API C # pour convertir DOCX en XLT sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Enregistrez le docxument au format XLT à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLT` comme SaveFormat
