---
title: Convertir POTM au format JSON via .NET
description: Convertir POTM en JSON en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/potm-to-json/
family: total
platformtag: net
feature: conversion
informat: POTM
...
2. Convertissez POTM en HTML en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir l'POTM protégé au format JSON via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir POTM en JSON dans Range via C#" %}}
