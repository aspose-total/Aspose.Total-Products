---
title: Convertir PPT au format JSON via .NET
description: Convertir PPT en JSON en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/ppt-to-json/
family: total
platformtag: net
feature: conversion
informat: PPT
...
2. Convertissez PPT en HTML en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PPT en JSON dans Range via C#" %}}
