---
title: Convertir PPS en ODS via C#
description: Convertir PPS en ODS en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/pps-to-ods/
family: total
platformtag: net
feature: conversion
informat: PPS
...
4. Enregistrez le document au format ODS à l'aide de la méthode [Enregistrer] (https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PPS en ODS avec filigrane via C#" %}}
