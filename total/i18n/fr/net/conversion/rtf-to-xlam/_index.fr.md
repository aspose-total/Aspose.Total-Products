---
title: API .NET pour convertir RTF en XLAM
description: API C# pour convertir RTF en XLAM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-xlam/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir RTF en XLAM" h2="Exportez RTF vers XLAM via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le rtfument au format XLAM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLAM` comme SaveFormat
