---
title: API .NET pour convertir DOCM en DIF
description: API C# pour convertir DOCM en DIF sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Enregistrez le docmument au format DIF à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `DIF` comme SaveFormat
