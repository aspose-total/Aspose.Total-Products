---
title: API .NET pour convertir WORDML en XLAM
description: API C # pour convertir WORDML en XLAM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/wordml-to-xlam/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Enregistrez le wordmlument au format XLAM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLAM` comme SaveFormat
