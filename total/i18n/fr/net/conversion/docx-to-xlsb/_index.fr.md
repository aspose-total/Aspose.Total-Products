---
title: API .NET pour convertir DOCX en XLSB
description: API C # pour convertir DOCX en XLSB sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Enregistrez le docxument au format XLSB à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSB` comme SaveFormat
