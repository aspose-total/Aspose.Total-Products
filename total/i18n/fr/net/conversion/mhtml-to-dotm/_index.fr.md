---
title: API C# pour exporter MHTML vers DOTM
description: Convertir MHTML en DOTM sans utiliser Microsoft Word
url: /fr/net/conversion/mhtml-to-dotm/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MHTML en DOTM via .NET" h2="API .NET pour exporter MHTML vers DOTM sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir MHTML en DOTM" %}}
