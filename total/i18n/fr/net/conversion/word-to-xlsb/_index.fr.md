---
title: API .NET pour convertir WORD en XLSB
description: API C # pour convertir WORD en XLSB sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Enregistrez le wordument au format XLSB à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSB` comme SaveFormat
