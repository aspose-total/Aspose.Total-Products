...
description: Convertir XPS en ODT sans utiliser Microsoft Word
url: /fr/net/conversion/xps-to-odt/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre XPS en ODT via .NET" h2="API .NET pour exporter XPS vers ODT sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir XPS en ODT" %}}
