...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir PPS en XLSX via C#" %}}
...
4. Enregistrez le document au format XLSX à l'aide de la méthode [Enregistrer](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PPS en XLSX avec filigrane via C#" %}}
