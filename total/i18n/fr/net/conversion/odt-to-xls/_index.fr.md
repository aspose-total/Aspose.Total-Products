---
title: API .NET pour convertir ODT en XLS
description: API C# pour convertir ODT en XLS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/odt-to-xls/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Enregistrez le odtument au format XLS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLS` comme SaveFormat
