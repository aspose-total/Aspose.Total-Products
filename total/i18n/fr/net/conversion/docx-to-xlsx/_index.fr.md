---
title: API .NET pour convertir DOCX en XLSX
description: API C # pour convertir DOCX en XLSX sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Enregistrez le docxument au format XLSX à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSX` comme SaveFormat
