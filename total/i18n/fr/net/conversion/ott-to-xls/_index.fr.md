---
title: API .NET pour convertir OTT en XLS
description: API C# pour convertir OTT en XLS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Enregistrez le ottument au format XLS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLS` comme SaveFormat
