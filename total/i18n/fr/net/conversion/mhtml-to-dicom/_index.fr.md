...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le fichier MHTML en DICOM via .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir et faire pivoter le fichier MHTML en DICOM via C#" %}}
