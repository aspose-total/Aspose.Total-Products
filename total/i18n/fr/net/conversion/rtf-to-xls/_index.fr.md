---
title: API .NET pour convertir RTF en XLS
description: API C # pour convertir RTF en XLS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-xls/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Enregistrez le rtfument au format XLS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLS` comme SaveFormat
