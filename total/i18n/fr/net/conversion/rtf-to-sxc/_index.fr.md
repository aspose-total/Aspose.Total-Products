---
title: API .NET pour convertir RTF en SXC
description: API C# pour convertir RTF en SXC sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-sxc/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir RTF en SXC" h2="Exportez RTF vers SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le rtfument au format SXC à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `SXC` comme SaveFormat
