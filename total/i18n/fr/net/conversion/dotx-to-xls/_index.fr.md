---
title: API .NET pour convertir DOTX en XLS
description: API C# pour convertir DOTX en XLS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Enregistrez le dotxument au format XLS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLS` comme SaveFormat
