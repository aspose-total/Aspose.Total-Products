---
title: API .NET pour convertir RTF en XLSB
description: API C # pour convertir RTF en XLSB sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/rtf-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Enregistrez le rtfument au format XLSB à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSB` comme SaveFormat
