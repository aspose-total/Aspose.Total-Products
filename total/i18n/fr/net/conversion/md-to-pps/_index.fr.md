---
title: Exporter MD vers PPS via l'API C#
description: API .NET pour convertir MD en PPS sans utiliser Microsoft Word
url: /fr/net/conversion/md-to-pps/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MD vers PPS via .NET" h2="API .NET pour exporter MD vers PPS sur Windows, macOS et Linux sans utiliser Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir MD en PPS" %}}
