---
title: API .NET pour convertir MOBI en XLSX
description: API C# pour convertir MOBI en XLSX sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/mobi-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Enregistrez le mobiument au format XLSX à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSX` comme SaveFormat
