---
title: API .NET pour convertir OTT en FODS
description: API C# pour convertir OTT en FODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/ott-to-fods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Enregistrez le ottument au format FODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `FODS` comme SaveFormat
