---
title: API .NET pour convertir DOTM en FODS
description: API C# pour convertir DOTM en FODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotm-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Enregistrez le dotmument au format FODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `FODS` comme SaveFormat
