---
title: API .NET pour convertir DOTM en XLSM
description: API C # pour convertir DOTM en XLSM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotm-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Enregistrez le dotmument au format XLSM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSM` comme SaveFormat
