---
title: API C# pour exporter TEX vers RTF
description: Convertir TEX en RTF sans utiliser Microsoft Word
url: /fr/net/conversion/tex-to-rtf/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre TEX en RTF via .NET" h2="API .NET pour exporter TEX vers RTF sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir TEX en RTF" %}}
