---
title: Convertir PPSX au format JSON via .NET
description: Convertir PPSX en JSON en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/ppsx-to-json/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
2. Convertissez PPSX en HTML en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir l'PPSX protégé au format JSON via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PPSX en JSON dans Range via C#" %}}
