---
title: API C# pour exporter SVG vers GIF
description: Convertir SVG en GIF sans utiliser Microsoft Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre SVG en GIF via .NET" h2="API .NET pour exporter SVG vers GIF sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir SVG en GIF" %}}
