---
title: API .NET pour convertir DOTX en TSV
description: API C# pour convertir DOTX en TSV sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Enregistrez le dotxument au format TSV à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `TSV` comme SaveFormat
