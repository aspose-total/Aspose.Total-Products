---
title: Convertir le format JSON en FLATOPC via .NET
description: Analyser JSON en FLATOPC en C # sans utiliser Microsoft Word
url: /fr/net/conversion/json-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. Enregistrez le document au format FLATOPC en utilisant la méthode [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/3)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en FLATOPC via C #" %}}
