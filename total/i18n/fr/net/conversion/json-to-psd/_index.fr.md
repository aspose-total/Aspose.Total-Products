...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en PSD via C#" %}}
...
4. Enregistrez le document au format PSD en utilisant la méthode [Save](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en PSD via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Analyser le format JSON en PSD avec filigrane" %}}
