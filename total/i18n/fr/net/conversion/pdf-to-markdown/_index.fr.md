---
title: API C# pour exporter PDF vers MARKDOWN
description: Convertir PDF en MARKDOWN sans utiliser Microsoft Word
url: /fr/net/conversion/pdf-to-markdown/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PDF en MARKDOWN via .NET" h2="API .NET pour exporter PDF vers MARKDOWN sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PDF en MARKDOWN" %}}
