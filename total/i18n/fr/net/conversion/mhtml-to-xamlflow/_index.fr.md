---
title: API C# pour exporter MHTML vers XAMLFLOW
description: Convertir MHTML en XAMLFLOW sans utiliser Microsoft Word
url: /fr/net/conversion/mhtml-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MHTML en XAMLFLOW via .NET" h2="API .NET pour exporter MHTML vers XAMLFLOW sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir MHTML en XAMLFLOW" %}}
