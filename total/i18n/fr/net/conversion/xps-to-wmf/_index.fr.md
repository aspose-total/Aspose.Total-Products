...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le fichier XPS en WMF via .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir et faire pivoter le fichier XPS en WMF via C #" %}}
