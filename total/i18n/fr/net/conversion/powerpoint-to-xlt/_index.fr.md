...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir POWERPOINT en XLT via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir POWERPOINT en XLT avec filigrane via C#" %}}
