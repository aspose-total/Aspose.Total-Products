---
title: Exporter TEX vers ODP via l'API C#
description: API .NET pour convertir TEX en ODP sans utiliser Microsoft Word
url: /fr/net/conversion/tex-to-odp/
family: total
platformtag: net
feature: conversion
informat: TEX
...
4. Enregistrez le document au format ODP à l'aide de la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) et définissez `Odp` comme SaveFormat
