...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir SVG en DIF" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir SVG protégé en DIF via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir un fichier SVG en DIF avec filigrane via C#" %}}
