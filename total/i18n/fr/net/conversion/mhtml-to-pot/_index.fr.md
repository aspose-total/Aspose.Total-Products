---
title: Exporter MHTML vers POT via l'API C#
description: API .NET pour convertir MHTML en POT sans utiliser Microsoft Word
url: /fr/net/conversion/mhtml-to-pot/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
4. Enregistrez le document au format POT à l'aide de la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) et définissez `Pot` comme SaveFormat
