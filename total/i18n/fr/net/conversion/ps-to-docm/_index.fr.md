---
title: API C# pour exporter PS vers DOCM
description: Convertir PS en DOCM sans utiliser Microsoft Word
url: /fr/net/conversion/ps-to-docm/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PS en DOCM via .NET" h2="API .NET pour exporter PS vers DOCM sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PS en DOCM" %}}
