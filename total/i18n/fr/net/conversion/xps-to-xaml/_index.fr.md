---
title: Exporter XPS vers XAML via l'API C#
description: API .NET pour convertir XPS en XAML sans utiliser Microsoft Word
url: /fr/net/conversion/xps-to-xaml/
family: total
platformtag: net
feature: conversion
informat: XPS
