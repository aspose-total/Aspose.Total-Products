---
title: API .NET pour convertir WORD en XLS
description: API C# pour convertir WORD en XLS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Enregistrez le wordument au format XLS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLS` comme SaveFormat
