...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en EMZ via C#" %}}
...
4. Enregistrez le document au format EMZ en utilisant la méthode [Save](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)
