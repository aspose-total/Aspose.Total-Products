---
title: API C# pour exporter XPS vers DOT
description: Convertir XPS en DOT sans utiliser Microsoft Word
url: /fr/net/conversion/xps-to-dot/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre XPS en DOT via .NET" h2="API .NET pour exporter XPS vers DOT sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir XPS en DOT" %}}
