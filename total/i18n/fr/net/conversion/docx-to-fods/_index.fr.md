...
4. Enregistrez le docxument au format FODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `FODS` comme SaveFormat
