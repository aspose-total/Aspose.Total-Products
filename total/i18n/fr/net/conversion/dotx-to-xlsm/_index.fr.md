---
title: API .NET pour convertir DOTX en XLSM
description: API C # pour convertir DOTX en XLSM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Enregistrez le dotxument au format XLSM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSM` comme SaveFormat
