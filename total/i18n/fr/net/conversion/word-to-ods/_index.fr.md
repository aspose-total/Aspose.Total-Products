---
title: API .NET pour convertir WORD en ODS
description: API C # pour convertir WORD en ODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-ods/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Enregistrez le wordument au format ODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `ODS` comme SaveFormat
