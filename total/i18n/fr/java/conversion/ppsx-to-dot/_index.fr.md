---
title: Convertir PPSX en DOT via Java
description: API Java pour exporter PPSX vers DOT sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/ppsx-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
3. Chargez le fichier HTML converti à l'aide de la classe [Dotument](https://apireference.aspose.com/words/java/com.aspose.words/Dotument)
4. Enregistrez le dotument au format DOT à l'aide de la méthode [save](https://apireference.aspose.com/words/java/com.aspose.words/Dotument#save(java.lang.String,int))
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Exigences de conversion" %}}
Pour la conversion de fichiers PPSX en DOT, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
