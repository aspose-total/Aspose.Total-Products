---
title: Convertir DOCM en PPS via Java
description: API Java pour exporter DOCM vers PPS sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/docm-to-pps/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir DOCM en PPS via Java" h2="Conversion DOCM en PPS en utilisant l'API Java sur site dans toutes les applications Java J2SE, J2EE, J2ME sans utiliser Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir DOCM en PPS via Java" %}}
...
6. Enregistrez le docmument dans PPS à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Exigences de conversion" %}}
Pour la conversion de fichiers DOCM en PPS, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
L'API vous permet également de convertir des docmuments DOCM protégés par mot de passe en PPS. Si votre docmument DOCM d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format PPS sans utiliser le mot de passe. Pour ouvrir un docmument crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Docmument.  
{{% blocks/products/pf/feature-page-code %}}
