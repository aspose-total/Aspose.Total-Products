---
title: Convertir POTM au format ODS via Java
description: Convertissez le format POTM au format ODS via Java sans utiliser Microsoft Excel ou PowerPoint
url: /fr/java/conversion/potm-to-ods/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTM en ODS via Java" h2="API Java sur site pour exporter POTM vers ODS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir POTM en ODS via Java" %}}
...
Afin de convertir POTM en ODS, vous pouvez facilement utiliser Aspose.Total pour Java directement depuis un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ projet basé sur aspose/aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
