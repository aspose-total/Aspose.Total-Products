---
title: Convertir POWERPOINT en DOCX via Java
description: API Java pour exporter POWERPOINT vers DOCX sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/powerpoint-to-docx/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
3. Chargez le fichier HTML converti à l'aide de la classe [Docxument](https://apireference.aspose.com/words/java/com.aspose.words/Docxument)
4. Enregistrez le docxument au format DOCX à l'aide de la méthode [save](https://apireference.aspose.com/words/java/com.aspose.words/Docxument#save(java.lang.String,int))
...
À l'aide de l'API, vous pouvez également effectuer une conversion de fichier POWERPOINT en DOCX avec filigrane. Afin d'ajouter un filigrane à votre docxument DOCX, vous pouvez d'abord convertir le fichier POWERPOINT en HTML et y ajouter un filigrane. Pour ajouter un filigrane, chargez le fichier HTML nouvellement créé à l'aide de la classe [Docxument](https://apireference.aspose.com/words/java/com.aspose.words/Docxument), créez une instance de TextWatermarkOptions et définissez ses propriétés, appelez la méthode Watermark.setText et transmettez le texte et l'objet du filigrane de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
