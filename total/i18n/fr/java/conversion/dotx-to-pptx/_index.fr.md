---
title: Convertir DOTX en PPTX via Java
description: API Java pour exporter DOTX vers PPTX sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/dotx-to-pptx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
6. Enregistrez le dotxument dans PPTX à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Exigences de conversion" %}}
Pour la conversion de fichiers DOTX en PPTX, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
L'API vous permet également de convertir des dotxuments DOTX protégés par mot de passe en PPTX. Si votre dotxument DOTX d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format PPTX sans utiliser le mot de passe. Pour ouvrir un dotxument crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Dotxument.  
{{% blocks/products/pf/feature-page-code %}}
