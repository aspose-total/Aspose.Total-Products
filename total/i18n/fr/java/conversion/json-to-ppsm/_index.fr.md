---
title: Convertir le format JSON en PPSM via Java
description: Analyser JSON en PPSM en Java sans utiliser Microsoft PowerPoint
url: /fr/java/conversion/json-to-ppsm/
family: total
platformtag: net
feature: conversion
informat: JSON
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir le format JSON en PPSM via Java" h2="API Java pour analyser le format JSON en PPSM sans utiliser Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en PPSM via Java" %}}
...
4. Enregistrez le document au format PPSM à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en PPSM via Java" %}}
