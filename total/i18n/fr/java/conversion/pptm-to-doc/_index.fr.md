---
title: Convertir PPTM en DOC via Java
description: API Java pour exporter PPTM vers DOC sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/pptm-to-doc/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
Pour la conversion de fichiers PPTM en DOC, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
