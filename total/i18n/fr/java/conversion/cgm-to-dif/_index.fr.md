---
title: API Java pour rendre CGM en DIF
description: Exportez CGM vers DIF via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/java/conversion/cgm-to-dif/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{% blocks/products/pf/feature-page-section  h2="Convertir CGM protégé en DIF via Java" %}}
