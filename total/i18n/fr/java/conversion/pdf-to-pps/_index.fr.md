---
title: Convertir PDF en PPS via l'API Java
description: API Java pour convertir PDF en PPS sans utiliser Microsoft Word
url: /fr/java/conversion/pdf-to-pps/
family: total
platformtag: net
feature: conversion
informat: PDF
