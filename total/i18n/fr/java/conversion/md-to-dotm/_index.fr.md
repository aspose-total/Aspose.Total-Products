---
title: API Java pour exporter MD vers DOTM
description: Convertir MD en DOTM à l'aide de l'API Java sur site
url: /fr/java/conversion/md-to-dotm/
family: total
platformtag: net
feature: conversion
informat: MD
