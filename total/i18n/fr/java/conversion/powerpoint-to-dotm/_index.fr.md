---
title: Convertir POWERPOINT en DOTM via Java
description: API Java pour exporter POWERPOINT vers DOTM sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/powerpoint-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Pour la conversion de fichiers POWERPOINT en DOTM, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/powerpoint-to-dotmm/" name="POWERPOINT Pour DOTMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/powerpoint-to-dotmx/" name="POWERPOINT Pour DOTMX" description="" >}}
