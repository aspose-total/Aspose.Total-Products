---
title: Convertir DOC en POTM via Java
description: API Java pour exporter DOC vers POTM sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/doc-to-potm/
family: total
platformtag: net
feature: conversion
informat: DOC
...
Pour la conversion de fichiers DOC en POTM, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
L'API vous permet également de convertir des documents DOC protégés par mot de passe en POTM. Si votre document DOC d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format POTM sans utiliser le mot de passe. Pour ouvrir un document crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Document.  
{{% blocks/products/pf/feature-page-code %}}
