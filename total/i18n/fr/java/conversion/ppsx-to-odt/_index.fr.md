---
title: Convertir PPSX en ODT via Java
description: API Java pour exporter PPSX vers ODT sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/ppsx-to-odt/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
Pour la conversion de fichiers PPSX en ODT, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/ppsx-to-odtm/" name="PPSX Pour ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/ppsx-to-odtx/" name="PPSX Pour ODTX" description="" >}}
