---
title: Convertir PPSM en DOT via Java
description: API Java pour exporter PPSM vers DOT sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/ppsm-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
Pour la conversion de fichiers PPSM en DOT, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
