---
title: Convertir PPTX en WORD via Java
description: API Java pour exporter PPTX vers WORD sans utiliser Microsoft Word ou PowerPoint
...
Pour la conversion de fichiers PPTX en WORD, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/pptx-to-wordm/" name="PPTX Pour WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/pptx-to-wordx/" name="PPTX Pour WORDX" description="" >}}
