---
title: Convertir OTT en PPSX via Java
description: API Java pour exporter OTT vers PPSX sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/ott-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: OTT
...
6. Enregistrez le ottument dans PPSX à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Exigences de conversion" %}}
Pour la conversion de fichiers OTT en PPSX, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
