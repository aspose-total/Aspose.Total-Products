...
6. Enregistrez le docmument dans POTX à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
L'API vous permet également de convertir des docmuments DOCM protégés par mot de passe en POTX. Si votre docmument DOCM d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format POTX sans utiliser le mot de passe. Pour ouvrir un docmument crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Docmument.  
{{% blocks/products/pf/feature-page-code %}}
