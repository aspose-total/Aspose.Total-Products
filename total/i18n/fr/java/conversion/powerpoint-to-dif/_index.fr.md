---
title: Convertir POWERPOINT au format DIF via Java
description: Convertissez le format POWERPOINT au format DIF via Java sans utiliser Microsoft Excel ou PowerPoint
url: /fr/java/conversion/powerpoint-to-dif/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POWERPOINT en DIF via Java" h2="API Java sur site pour exporter POWERPOINT vers DIF sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
