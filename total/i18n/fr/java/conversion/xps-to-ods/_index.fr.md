---
title: API Java pour rendre XPS en ODS
description: Exportez XPS vers ODS via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/java/conversion/xps-to-ods/
family: total
platformtag: net
feature: conversion
informat: XPS
