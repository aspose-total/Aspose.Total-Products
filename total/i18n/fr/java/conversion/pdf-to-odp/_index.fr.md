---
title: Convertir PDF en ODP via l'API Java
description: API Java pour convertir PDF en ODP sans utiliser Microsoft Word
url: /fr/java/conversion/pdf-to-odp/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java pour exporter PDF vers ODP" h2="Exportez PDF vers ODP via l'API Java sur site sans utiliser Microsoft<sup>&reg;</sup> PowerPoint ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API Java pour convertir PDF en ODP" %}}
...
4. Enregistrez le document au format ODP à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) et définissez ` Odp` comme format de sauvegarde
