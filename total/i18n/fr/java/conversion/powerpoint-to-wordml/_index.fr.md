---
title: Convertir POWERPOINT en WORDML via Java
description: API Java pour exporter POWERPOINT vers WORDML sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/powerpoint-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Pour la conversion de fichiers POWERPOINT en WORDML, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/powerpoint-to-wordmlm/" name="POWERPOINT Pour WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/powerpoint-to-wordmlx/" name="POWERPOINT Pour WORDMLX" description="" >}}
