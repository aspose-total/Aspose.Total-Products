...
6. Enregistrez le wordument dans PPT à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
L'API vous permet également de convertir des worduments WORD protégés par mot de passe en PPT. Si votre wordument WORD d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format PPT sans utiliser le mot de passe. Pour ouvrir un wordument crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Wordument.  
{{% blocks/products/pf/feature-page-code %}}
