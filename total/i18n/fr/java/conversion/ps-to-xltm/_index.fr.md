---
title: API Java pour rendre PS en XLTM
description: Exportez PS vers XLTM via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/java/conversion/ps-to-xltm/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PS protégé en XLTM via Java" %}}
