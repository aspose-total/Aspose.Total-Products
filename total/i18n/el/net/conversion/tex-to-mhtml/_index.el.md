---
title: C# API για εξαγωγή TEX σε MHTML
description: Μετατροπή TEX σε MHTML χωρίς χρήση του Microsoft Word
url: /el/net/conversion/tex-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση TEX σε MHTML μέσω .NET" h2=".NET API για εξαγωγή TEX σε MHTML σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή TEX σε MHTML" %}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή MHTML χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) και ορίστε το Mhtml ως SaveFormat
