---
title: .NET API για μετατροπή DOCX σε FODS
description: C# API για μετατροπή DOCX σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
