---
title: .NET API για μετατροπή DOTM σε TSV
description: C# API για μετατροπή DOTM σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOTM
