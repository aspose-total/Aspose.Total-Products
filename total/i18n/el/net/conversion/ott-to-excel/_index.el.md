---
title: .NET API για μετατροπή OTT σε EXCEL
description: C# API για μετατροπή OTT σε EXCEL χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-excel/
family: total
platformtag: net
feature: conversion
informat: OTT
