---
title: .NET API για μετατροπή DOT σε XLTM
description: C# API για μετατροπή DOT σε XLTM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOT
