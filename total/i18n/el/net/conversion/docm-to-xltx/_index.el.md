---
title: .NET API για μετατροπή DOCM σε XLTX
description: C# API για μετατροπή DOCM σε XLTX χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCMM
