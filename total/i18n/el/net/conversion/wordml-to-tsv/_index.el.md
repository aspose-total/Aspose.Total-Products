---
title: .NET API για μετατροπή WORDML σε TSV
description: C# API για μετατροπή WORDML σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/wordml-to-tsv/
family: total
platformtag: net
feature: conversion
informat: WORDML
