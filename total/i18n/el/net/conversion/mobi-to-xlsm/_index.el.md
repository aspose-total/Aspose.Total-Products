---
title: .NET API για μετατροπή MOBI σε XLSM
description: C# API για μετατροπή MOBI σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/mobi-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: MOBI
