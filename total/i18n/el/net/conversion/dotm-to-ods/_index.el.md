---
title: .NET API για μετατροπή DOTM σε ODS
description: C# API για μετατροπή DOTM σε ODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOTM
