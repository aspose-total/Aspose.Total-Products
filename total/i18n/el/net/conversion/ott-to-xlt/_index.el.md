---
title: .NET API για μετατροπή OTT σε XLT
description: C# API για μετατροπή OTT σε XLT χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-xlt/
family: total
platformtag: net
feature: conversion
informat: OTT
