---
title: .NET API για μετατροπή DOCM σε XLAM
description: C# API για μετατροπή DOCM σε XLAM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOCMM
