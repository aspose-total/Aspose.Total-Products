---
title: .NET API για μετατροπή RTF σε XLSB
description: C# API για μετατροπή RTF σε XLSB χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: RTF
