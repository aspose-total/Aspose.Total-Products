---
title: .NET API για μετατροπή DOCX σε DIF
description: C# API για μετατροπή DOCX σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCXX
