---
title: .NET API για μετατροπή RTF σε TSV
description: C# API για μετατροπή RTF σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-tsv/
family: total
platformtag: net
feature: conversion
informat: RTF
