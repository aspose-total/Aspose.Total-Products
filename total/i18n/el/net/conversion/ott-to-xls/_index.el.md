---
title: .NET API για μετατροπή OTT σε XLS
description: C# API για μετατροπή OTT σε XLS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
