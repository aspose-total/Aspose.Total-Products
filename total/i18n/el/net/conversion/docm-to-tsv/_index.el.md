---
title: .NET API για μετατροπή DOCM σε TSV
description: C# API για μετατροπή DOCM σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
