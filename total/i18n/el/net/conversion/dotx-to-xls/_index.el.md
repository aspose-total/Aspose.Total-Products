---
title: .NET API για μετατροπή DOTX σε XLS
description: C# API για μετατροπή DOTX σε XLS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
