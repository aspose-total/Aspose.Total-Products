---
title: .NET API για μετατροπή DOTM σε XLAM
description: C# API για μετατροπή DOTM σε XLAM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTM
