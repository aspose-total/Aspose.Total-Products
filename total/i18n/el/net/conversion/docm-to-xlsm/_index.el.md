---
title: .NET API για μετατροπή DOCM σε XLSM
description: C# API για μετατροπή DOCM σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docm-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOCMM
