---
title: C# API για εξαγωγή XPS σε DOCM
description: Μετατροπή XPS σε DOCM χωρίς χρήση του Microsoft Word
url: /el/net/conversion/xps-to-docm/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση XPS σε DOCM μέσω .NET" h2=".NET API για εξαγωγή XPS σε DOCM σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή XPS σε DOCM" %}}
