---
title: .NET API για μετατροπή DOCX σε SXC
description: C# API για μετατροπή DOCX σε SXC χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCXX
