---
title: .NET API για μετατροπή DOT σε CSV
description: C# API για μετατροπή DOT σε CSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOT
