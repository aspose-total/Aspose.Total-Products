---
title: .NET API για μετατροπή OTT σε FODS
description: C# API για μετατροπή OTT σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-fods/
family: total
platformtag: net
feature: conversion
informat: OTT
