---
title: .NET API για μετατροπή ODT σε SXC
description: C# API για μετατροπή ODT σε SXC χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/odt-to-sxc/
family: total
platformtag: net
feature: conversion
informat: ODT
