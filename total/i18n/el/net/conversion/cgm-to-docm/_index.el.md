---
title: C# API για εξαγωγή CGM σε DOCM
description: Μετατροπή CGM σε DOCM χωρίς χρήση του Microsoft Word
url: /el/net/conversion/cgm-to-docm/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση CGM σε DOCM μέσω .NET" h2=".NET API για εξαγωγή CGM σε DOCM σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή CGM σε DOCM" %}}
