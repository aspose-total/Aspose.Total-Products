---
title: .NET API για μετατροπή RTF σε XLSM
description: C# API για μετατροπή RTF σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: RTF
