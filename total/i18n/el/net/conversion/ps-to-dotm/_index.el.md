...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση PS σε DOTM μέσω .NET" h2=".NET API για εξαγωγή PS σε DOTM σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή PS σε DOTM" %}}
...
4. Αποθηκεύστε το έγγραφο σε μορφή DOTM χρησιμοποιώντας τη μέθοδο [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) και ορίστε το Dotm ως SaveFormat
