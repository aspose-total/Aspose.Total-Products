---
title: .NET API για μετατροπή MOBI σε CSV
description: C# API για μετατροπή MOBI σε CSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/mobi-to-csv/
family: total
platformtag: net
feature: conversion
informat: MOBI
