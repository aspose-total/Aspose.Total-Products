---
title: C# API για εξαγωγή XPS σε DOTX
description: Μετατροπή XPS σε DOTX χωρίς χρήση του Microsoft Word
url: /el/net/conversion/xps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση XPS σε DOTX μέσω .NET" h2=".NET API για εξαγωγή XPS σε DOTX σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή XPS σε DOTX" %}}
