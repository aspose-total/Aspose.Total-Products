---
title: .NET API για μετατροπή RTF σε FODS
description: C# API για μετατροπή RTF σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-fods/
family: total
platformtag: net
feature: conversion
informat: RTF
