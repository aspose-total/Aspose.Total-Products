---
title: .NET API για μετατροπή ODT σε DIF
description: C# API για μετατροπή ODT σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/odt-to-dif/
family: total
platformtag: net
feature: conversion
informat: ODT
