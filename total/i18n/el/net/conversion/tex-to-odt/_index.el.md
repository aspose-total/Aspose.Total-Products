---
title: C# API για εξαγωγή TEX σε ODT
description: Μετατροπή TEX σε ODT χωρίς χρήση του Microsoft Word
url: /el/net/conversion/tex-to-odt/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση TEX σε ODT μέσω .NET" h2=".NET API για εξαγωγή TEX σε ODT σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή TEX σε ODT" %}}
