---
title: .NET API για μετατροπή DOTX σε XLAM
description: C# API για μετατροπή DOTX σε XLAM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOTX
