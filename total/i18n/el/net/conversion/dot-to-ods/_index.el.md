---
title: .NET API για μετατροπή DOT σε ODS
description: C# API για μετατροπή DOT σε ODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOT
