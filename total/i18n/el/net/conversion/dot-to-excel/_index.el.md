---
title: .NET API για μετατροπή DOT σε EXCEL
description: C# API για μετατροπή DOT σε EXCEL χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOT
