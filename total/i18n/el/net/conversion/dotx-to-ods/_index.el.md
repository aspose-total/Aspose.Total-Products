---
title: .NET API για μετατροπή DOTX σε ODS
description: C# API για μετατροπή DOTX σε ODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOTX σε ODS" h2="Εξαγωγή DOTX σε ODS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
