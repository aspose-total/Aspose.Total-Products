---
title: .NET API για μετατροπή RTF σε ODS
description: C# API για μετατροπή RTF σε ODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-ods/
family: total
platformtag: net
feature: conversion
informat: RTF
