---
title: C# API για εξαγωγή EPUB σε PCL
description: Μετατροπή EPUB σε PCL χωρίς χρήση του Microsoft Word
url: /el/net/conversion/epub-to-pcl/
family: total
platformtag: net
feature: conversion
informat: EPUB
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση EPUB σε PCL μέσω .NET" h2=".NET API για εξαγωγή EPUB σε PCL σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή EPUB σε PCL" %}}
