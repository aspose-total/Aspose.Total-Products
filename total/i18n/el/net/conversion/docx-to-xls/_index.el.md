---
title: .NET API για μετατροπή DOCX σε XLS
description: C# API για μετατροπή DOCX σε XLS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOCXX
