---
title: .NET API για μετατροπή WORD σε CSV
description: C# API για μετατροπή WORD σε CSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/word-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORD
