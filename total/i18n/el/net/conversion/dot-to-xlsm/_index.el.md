---
title: .NET API για μετατροπή DOT σε XLSM
description: C# API για μετατροπή DOT σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dot-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOT
