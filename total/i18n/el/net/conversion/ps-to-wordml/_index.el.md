---
title: C# API για εξαγωγή PS σε WORDML
description: Μετατροπή PS σε WORDML χωρίς χρήση του Microsoft Word
url: /el/net/conversion/ps-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση PS σε WORDML μέσω .NET" h2=".NET API για εξαγωγή PS σε WORDML σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή PS σε WORDML" %}}
