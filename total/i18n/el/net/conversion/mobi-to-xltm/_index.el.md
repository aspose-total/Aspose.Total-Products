---
title: .NET API για μετατροπή MOBI σε XLTM
description: C# API για μετατροπή MOBI σε XLTM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/mobi-to-xltm/
family: total
platformtag: net
feature: conversion
informat: MOBI
