---
title: .NET API για μετατροπή ODT σε XLSM
description: C# API για μετατροπή ODT σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/odt-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: ODT
