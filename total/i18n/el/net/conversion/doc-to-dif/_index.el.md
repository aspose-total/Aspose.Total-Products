---
title: .NET API για μετατροπή DOC σε DIF
description: C# API για μετατροπή DOC σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/doc-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOC
