---
title: .NET API για μετατροπή OTT σε XLSM
description: C# API για μετατροπή OTT σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: OTT
