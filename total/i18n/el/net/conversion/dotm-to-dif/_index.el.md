---
title: .NET API για μετατροπή DOTM σε DIF
description: C# API για μετατροπή DOTM σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOTM
