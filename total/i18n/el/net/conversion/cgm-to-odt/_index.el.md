---
title: C# API για εξαγωγή CGM σε ODT
description: Μετατροπή CGM σε ODT χωρίς χρήση του Microsoft Word
url: /el/net/conversion/cgm-to-odt/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση CGM σε ODT μέσω .NET" h2=".NET API για εξαγωγή CGM σε ODT σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή CGM σε ODT" %}}
