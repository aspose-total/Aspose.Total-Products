---
title: .NET API για μετατροπή DOCM σε FODS
description: C# API για μετατροπή DOCM σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docm-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή DOCM σε FODS" h2="Εξαγωγή DOCM σε FODS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
