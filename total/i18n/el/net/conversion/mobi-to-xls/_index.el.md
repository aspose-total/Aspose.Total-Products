...
description: C# API για μετατροπή MOBI σε XLS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/mobi-to-xls/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API για μετατροπή MOBI σε XLS" h2="Εξαγωγή MOBI σε XLS μέσω C# χωρίς χρήση Microsoft<sup>&reg;</sup> Word ή Microsoft<sup>&reg;</sup> Excel" >}}
