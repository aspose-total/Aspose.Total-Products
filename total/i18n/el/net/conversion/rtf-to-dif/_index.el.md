---
title: .NET API για μετατροπή RTF σε DIF
description: C# API για μετατροπή RTF σε DIF χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/rtf-to-dif/
family: total
platformtag: net
feature: conversion
informat: RTF
