---
title: .NET API για μετατροπή DOTX σε EXCEL
description: C# API για μετατροπή DOTX σε EXCEL χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTX
