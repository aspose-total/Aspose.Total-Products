---
title: .NET API για μετατροπή MOBI σε TSV
description: C# API για μετατροπή MOBI σε TSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/mobi-to-tsv/
family: total
platformtag: net
feature: conversion
informat: MOBI
