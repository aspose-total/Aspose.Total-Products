---
title: .NET API για μετατροπή DOTM σε EXCEL
description: C# API για μετατροπή DOTM σε EXCEL χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTM
