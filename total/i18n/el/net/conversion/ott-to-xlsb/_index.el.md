---
title: .NET API για μετατροπή OTT σε XLSB
description: C# API για μετατροπή OTT σε XLSB χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: OTT
