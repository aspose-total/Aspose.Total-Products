---
title: .NET API για μετατροπή DOTX σε XLTM
description: C# API για μετατροπή DOTX σε XLTM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOTX
