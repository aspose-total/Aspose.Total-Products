---
title: .NET API για μετατροπή DOTM σε XLSX
description: C# API για μετατροπή DOTM σε XLSX χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOTM
