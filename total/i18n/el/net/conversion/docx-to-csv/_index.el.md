---
title: .NET API για μετατροπή DOCX σε CSV
description: C# API για μετατροπή DOCX σε CSV χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/docx-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOCXX
