---
title: C# API για εξαγωγή TEX σε DOT
description: Μετατροπή TEX σε DOT χωρίς χρήση του Microsoft Word
url: /el/net/conversion/tex-to-dot/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση TEX σε DOT μέσω .NET" h2=".NET API για εξαγωγή TEX σε DOT σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή TEX σε DOT" %}}
