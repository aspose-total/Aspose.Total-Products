---
title: .NET API για μετατροπή ODT σε FODS
description: C# API για μετατροπή ODT σε FODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/odt-to-fods/
family: total
platformtag: net
feature: conversion
informat: ODT
