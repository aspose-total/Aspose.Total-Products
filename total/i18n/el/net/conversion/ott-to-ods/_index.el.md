---
title: .NET API για μετατροπή OTT σε ODS
description: C# API για μετατροπή OTT σε ODS χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/ott-to-ods/
family: total
platformtag: net
feature: conversion
informat: OTT
