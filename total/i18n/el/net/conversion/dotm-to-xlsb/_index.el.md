---
title: .NET API για μετατροπή DOTM σε XLSB
description: C# API για μετατροπή DOTM σε XLSB χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOTM
