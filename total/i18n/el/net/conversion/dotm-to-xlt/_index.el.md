---
title: .NET API για μετατροπή DOTM σε XLT
description: C# API για μετατροπή DOTM σε XLT χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotm-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOTM
