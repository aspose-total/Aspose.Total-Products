---
title: .NET API για μετατροπή ODT σε EXCEL
description: C# API για μετατροπή ODT σε EXCEL χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/odt-to-excel/
family: total
platformtag: net
feature: conversion
informat: ODT
