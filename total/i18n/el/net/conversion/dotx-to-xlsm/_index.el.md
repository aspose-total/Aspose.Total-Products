---
title: .NET API για μετατροπή DOTX σε XLSM
description: C# API για μετατροπή DOTX σε XLSM χωρίς χρήση Microsoft Excel ή Adobe Reader
url: /el/net/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
