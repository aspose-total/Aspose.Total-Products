---
title: C# API για εξαγωγή XPS σε XAMLFLOW
description: Μετατροπή XPS σε XAMLFLOW χωρίς χρήση του Microsoft Word
url: /el/net/conversion/xps-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Απόδοση XPS σε XAMLFLOW μέσω .NET" h2=".NET API για εξαγωγή XPS σε XAMLFLOW σε Windows, macOS και Linux χωρίς χρήση του Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API για μετατροπή XPS σε XAMLFLOW" %}}
