---
title: Java API για εξαγωγή EPUB σε MARKDOWN
description: Μετατρέψτε το EPUB σε MARKDOWN χρησιμοποιώντας το Java API premise
url: /el/java/conversion/epub-to-markdown/
family: total
platformtag: net
feature: conversion
informat: EPUB
