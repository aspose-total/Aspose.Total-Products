...
description: Μετατροπή PPSM σε μορφή FODS μέσω Java χωρίς χρήση Microsoft Excel ή PowerPoint
url: /el/java/conversion/ppsm-to-fods/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Μετατροπή PPSM σε FODS μέσω Java" h2="Στο Premise Java API για εξαγωγή PPSM σε FODS χωρίς χρήση Microsoft<sup>&reg;</sup> Excel ή PowerPoint" >}}
