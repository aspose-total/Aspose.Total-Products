---
title: Java API για εξαγωγή TEX σε ODT
description: Μετατρέψτε το TEX σε ODT χρησιμοποιώντας το Java API premise
url: /el/java/conversion/tex-to-odt/
family: total
platformtag: net
feature: conversion
informat: TEX
