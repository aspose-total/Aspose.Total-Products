---
title: Java API για εξαγωγή TEX σε FLATOPC
description: Μετατρέψτε το TEX σε FLATOPC χρησιμοποιώντας το Java API premise
url: /el/java/conversion/tex-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: TEX
