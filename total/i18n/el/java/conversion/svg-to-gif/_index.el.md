---
title: Java API για εξαγωγή SVG σε GIF
description: Μετατρέψτε το SVG σε GIF χρησιμοποιώντας το Java API premise
url: /el/java/conversion/svg-to-gif/
family: total
platformtag: net
feature: conversion
informat: SVG
