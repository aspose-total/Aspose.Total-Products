---
title: Java API για εξαγωγή XPS σε FLATOPC
description: Μετατρέψτε το XPS σε FLATOPC χρησιμοποιώντας το Java API premise
url: /el/java/conversion/xps-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: XPS
