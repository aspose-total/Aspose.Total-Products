---
title: Java API για εξαγωγή XPS σε OTT
description: Μετατρέψτε το XPS σε OTT χρησιμοποιώντας το Java API premise
url: /el/java/conversion/xps-to-ott/
family: total
platformtag: net
feature: conversion
informat: XPS
