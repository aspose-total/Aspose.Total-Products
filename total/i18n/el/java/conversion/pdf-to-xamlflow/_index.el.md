---
title: Java API για εξαγωγή PDF σε XAMLFLOW
description: Μετατρέψτε το PDF σε XAMLFLOW χρησιμοποιώντας το Java API premise
url: /el/java/conversion/pdf-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: PDF
