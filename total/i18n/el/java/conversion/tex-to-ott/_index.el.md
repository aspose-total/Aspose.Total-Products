---
title: Java API για εξαγωγή TEX σε OTT
description: Μετατρέψτε το TEX σε OTT χρησιμοποιώντας το Java API premise
url: /el/java/conversion/tex-to-ott/
family: total
platformtag: net
feature: conversion
informat: TEX
