---
title: Java API για εξαγωγή PS σε DOTM
description: Μετατρέψτε το PS σε DOTM χρησιμοποιώντας το Java API premise
url: /el/java/conversion/ps-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PS
