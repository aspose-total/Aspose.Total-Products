---
title: Java API για εξαγωγή XPS σε DOTM
description: Μετατρέψτε το XPS σε DOTM χρησιμοποιώντας το Java API premise
url: /el/java/conversion/xps-to-dotm/
family: total
platformtag: net
feature: conversion
informat: XPS
