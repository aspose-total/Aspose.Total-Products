---
title: Java API για εξαγωγή PDF σε PCL
description: Μετατρέψτε το PDF σε PCL χρησιμοποιώντας το Java API premise
url: /el/java/conversion/pdf-to-pcl/
family: total
platformtag: net
feature: conversion
informat: PDF
