---
title: Java API για εξαγωγή SVG σε OTT
description: Μετατρέψτε το SVG σε OTT χρησιμοποιώντας το Java API premise
url: /el/java/conversion/svg-to-ott/
family: total
platformtag: net
feature: conversion
informat: SVG
