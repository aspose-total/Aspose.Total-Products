---
title: Java API για εξαγωγή EPUB σε PCL
description: Μετατρέψτε το EPUB σε PCL χρησιμοποιώντας το Java API premise
url: /el/java/conversion/epub-to-pcl/
family: total
platformtag: net
feature: conversion
informat: EPUB
