---
title: Μετατροπή ODT σε ODP μέσω Java
description: Java API για εξαγωγή ODT σε ODP χωρίς χρήση Microsoft Word ή PowerPoint
url: /el/java/conversion/odt-to-odp/
family: total
platformtag: net
feature: conversion
informat: ODT
...
Για μετατροπή αρχείου ODT σε ODP, μπορείτε εύκολα να χρησιμοποιήσετε το Aspose.Total για Java απευθείας από ένα [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose έργο που βασίζεται στο /aspose-total) και συμπεριλάβετε βιβλιοθήκες στο pom.xml σας.
...
Το API σάς επιτρέπει επίσης να μετατρέπετε έγγραφα ODT που προστατεύονται με κωδικό πρόσβασης σε ODP. Εάν το έγγραφο ODT εισόδου σας προστατεύεται με κωδικό πρόσβασης, δεν μπορείτε να το μετατρέψετε σε μορφή ODP χωρίς να χρησιμοποιήσετε τον κωδικό πρόσβασης. Για να ανοίξετε ένα κρυπτογραφημένο έγγραφο, μπορείτε να ορίσετε τον σωστό κωδικό πρόσβασης στο αντικείμενο LoadOptions και να τον μεταβιβάσετε στον κατασκευαστή του εγγράφου.  
{{% blocks/products/pf/feature-page-code %}}
