...
url: /ja/net/conversion/json-to-mobi/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. [保存](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/3）メソッドを使用してドキュメントをMOBI形式で保存します
...
{{% blocks/products/pf/feature-page-](https: h2="レイアウトを設定し、C＃を介してJSON形式をMOBIに変換します" %}}
