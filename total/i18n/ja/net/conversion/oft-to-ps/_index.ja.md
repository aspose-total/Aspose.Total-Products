---
title: OFTをPSにエクスポートするためのC＃API
description: .NETでMicrosoftWordまたはOutlookを使用せずにOFTをPSに変換する
url: /ja/net/conversion/oft-to-ps/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{% blocks/products/pf/agp/feature-section-col title="OFTをPSに変換するC＃API" %}}
