...
url: /ja/net/conversion/json-to-pot/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. [保存](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5）メソッドを使用してドキュメントをPOT形式で保存します
...
{{% blocks/products/pf/feature-page](https:  h2="レイアウトを設定し、C＃を介してJSON形式をPOTに変換します" %}}
