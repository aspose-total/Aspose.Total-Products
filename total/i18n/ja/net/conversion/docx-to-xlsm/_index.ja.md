...
description: MicrosoftExcelまたはAdobeReaderを使用せずにDOCXをXLSMに変換するC＃API
url: /ja/net/conversion/docx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOCXをXLSMに変換するC＃API" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </ sup> Excelを使用せずにC＃経由でDOCXをXLSMにエクスポートする" >}}
...
{{% blocks/products/pf/feature-page-section  h2="C＃経由でストリームからDOCXドキュメントをロードする" %}}[Document]
