---
title: API C# per esportare EPUB in DOTX
description: Converti EPUB in DOTX senza utilizzare Microsoft Word
url: /it/net/conversion/epub-to-dotx/
family: total
platformtag: net
feature: conversion
informat: EPUB
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da EPUB a DOTX tramite .NET" h2="API .NET per esportare EPUB in DOTX su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire EPUB in DOTX" %}}
