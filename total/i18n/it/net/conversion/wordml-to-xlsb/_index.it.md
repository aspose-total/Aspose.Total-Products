---
title: API .NET per convertire WORDML in XLSB
description: API C# per convertire WORDML in XLSB senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/wordml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire WORDML in XLSB" h2="Esporta WORDML in XLSB tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET per convertire WORDML in XLSB" %}}
...
4. Salvare il wordmlumento in formato XLSB utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `XLSB` come SaveFormat
