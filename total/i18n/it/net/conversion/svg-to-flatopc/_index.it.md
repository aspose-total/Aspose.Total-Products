...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da SVG a FLATOPC tramite .NET" h2="API .NET per esportare SVG in FLATOPC su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire SVG in FLATOPC" %}}
