...
description: API C# per convertire OTT in FODS senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/ott-to-fods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire OTT in FODS" h2="Esporta OTT in FODS tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET per convertire OTT in FODS" %}}
...
4. Salvare il ottumento in formato FODS utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `FODS` come SaveFormat
