---
title: API C# per esportare SVG in DOTM
description: Converti SVG in DOTM senza utilizzare Microsoft Word
url: /it/net/conversion/svg-to-dotm/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da SVG a DOTM tramite .NET" h2="API .NET per esportare SVG in DOTM su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire SVG in DOTM" %}}
