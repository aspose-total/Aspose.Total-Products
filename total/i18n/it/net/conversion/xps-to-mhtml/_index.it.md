---
title: API C# per esportare XPS in MHTML
description: Converti XPS in MHTML senza utilizzare Microsoft Word
url: /it/net/conversion/xps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da XPS a MHTML tramite .NET" h2="API .NET per esportare XPS in MHTML su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire XPS in MHTML" %}}
