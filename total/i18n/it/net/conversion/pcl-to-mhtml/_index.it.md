---
title: API C# per esportare PCL in MHTML
description: Converti PCL in MHTML senza utilizzare Microsoft Word
url: /it/net/conversion/pcl-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendering da PCL a MHTML tramite .NET" h2="API .NET per esportare PCL in MHTML su Windows, macOS e Linux senza utilizzare Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# per convertire PCL in MHTML" %}}
