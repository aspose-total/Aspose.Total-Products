---
title: API .NET per convertire DOCM in TSV
description: API C# per convertire DOCM in TSV senza utilizzare Microsoft Excel o Adobe Reader
url: /it/net/conversion/docm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# per convertire DOCM in TSV" h2="Esporta DOCM in TSV tramite C# senza utilizzare Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Aprire il file DOCM utilizzando la classe [Docmument](https://apiference.aspose.com/words/net/aspose.words/docmument)
2. Converti DOCM in HTML utilizzando il metodo [Save](https://apiference.aspose.com/words/net/aspose.words.docmument/save/methods/4)
3. Caricare il docmumento HTML utilizzando la classe [Workbook](https://apiference.aspose.com/cells/net/aspose.cells/workbook)
4. Salvare il docmumento in formato TSV utilizzando il metodo [Salva](https://apiference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e impostare `TSV` come SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Carica docmumento DOCM da Stream tramite C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) consente anche di caricare docmumenti DOCM tramite stream. Per aprire un docmumento da uno stream, è sufficiente passare un oggetto stream che contiene il docmumento nel costruttore [Docmument](https://apiference.aspose.com/words/net/aspose.words/docmument). L'esempio di codice seguente mostra come aprire un docmumento da un flusso:  
{{% blocks/products/pf/feature-page-code %}}
...
Durante la conversione di DOCM in TSV, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) consente di aggiungere proprietà personalizzate nei docmumenti TSV. Per aggiungere una proprietà personalizzata, è possibile utilizzare il metodo [Add](https://apiference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection/methods/add/index) per il metodo [CustomDocmumentPropertyCollection]( https://apiference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection). Il metodo Add aggiunge la proprietà al file Excel e restituisce un riferimento per la nuova proprietà del docmumento come [Aspose.Cells.Properties.DocmumentProperty](https://apiference.aspose.com/cells/net/aspose.cells.properties /proprietà docmumento). 
{{% blocks/products/pf/feature-page-code %}}
