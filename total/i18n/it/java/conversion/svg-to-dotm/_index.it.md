---
title: API Java per esportare SVG in DOTM
description: Converti SVG in DOTM utilizzando l'API Java locale
url: /it/java/conversion/svg-to-dotm/
family: total
platformtag: net
feature: conversion
informat: SVG
