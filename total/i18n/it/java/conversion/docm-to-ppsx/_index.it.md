...
6. Salvare il docmumento in PPSX utilizzando il metodo [save](https://apiference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
L'API consente inoltre di convertire docmumenti DOCM protetti da password in PPSX. Se il docmumento DOCM di input è protetto da password, non è possibile convertirlo in formato PPSX senza utilizzare la password. Per aprire un docmumento crittografato è possibile impostare la password corretta nell'oggetto LoadOptions e passarla al costruttore del docmumento.  
{{% blocks/products/pf/feature-page-code %}}
