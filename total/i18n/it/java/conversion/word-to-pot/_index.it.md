...
6. Salvare il wordumento in POT utilizzando il metodo [save](https://apiference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
L'API consente inoltre di convertire wordumenti WORD protetti da password in POT. Se il wordumento WORD di input è protetto da password, non è possibile convertirlo in formato POT senza utilizzare la password. Per aprire un wordumento crittografato è possibile impostare la password corretta nell'oggetto LoadOptions e passarla al costruttore del wordumento.  
{{% blocks/products/pf/feature-page-code %}}
