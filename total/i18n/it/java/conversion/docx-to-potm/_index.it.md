---
title: Converti DOCX in POTM tramite Java
description: API Java per esportare DOCX in POTM senza utilizzare Microsoft Word o PowerPoint
url: /it/java/conversion/docx-to-potm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converti DOCX in POTM tramite Java" h2="Conversione da DOCX a POTM utilizzando l'API Java in locale all'interno di qualsiasi applicazione Java J2SE, J2EE, J2ME senza utilizzare Microsoft<sup>&reg;</sup> PowerPoint o Word" >}}
...
6. Salvare il docxumento in POTM utilizzando il metodo [save](https://apiference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisiti di conversione" %}}
Per la conversione di file da DOCX a POTM, puoi facilmente utilizzare Aspose.Total per Java direttamente da un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e includi le librerie nel tuo pom.xml.
...
L'API consente inoltre di convertire docxumenti DOCX protetti da password in POTM. Se il docxumento DOCX di input è protetto da password, non è possibile convertirlo in formato POTM senza utilizzare la password. Per aprire un docxumento crittografato è possibile impostare la password corretta nell'oggetto LoadOptions e passarla al costruttore del docxumento.  
{{% blocks/products/pf/feature-page-code %}}
