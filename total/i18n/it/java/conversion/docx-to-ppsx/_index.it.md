...
6. Salvare il docxumento in PPSX utilizzando il metodo [save](https://apiference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
L'API consente inoltre di convertire docxumenti DOCX protetti da password in PPSX. Se il docxumento DOCX di input è protetto da password, non è possibile convertirlo in formato PPSX senza utilizzare la password. Per aprire un docxumento crittografato è possibile impostare la password corretta nell'oggetto LoadOptions e passarla al costruttore del docxumento.  
{{% blocks/products/pf/feature-page-code %}}
