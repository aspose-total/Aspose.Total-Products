---
title: C#을 통해 POTX을 MARKDOWN로 변환
description: Microsoft Excel 또는 Powerpoint를 사용하지 않고 C#에서 POTX을 MARKDOWN로 변환
url: /ko/net/conversion/potx-to-markdown/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#을 통해 POTX을 MARKDOWN로 변환" h2="Microsoft<sup>&reg;</sup> Excel 또는 PowerPoint를 사용하지 않고 POTX에서 MARKDOWN로 변환하는 .NET API" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total for .NET](https://products.aspose.com/total/net/)을 사용하면 모든 .NET, C#, ASP.NET 및 VB.NET 응용 프로그램 내에서 POTX 파일을 MARKDOWN로 변환할 수 있습니다. 간단한 단계. 먼저 [Aspose.Slides for .NET](https://products.aspose.com/slides/net/)을 사용하여 POTX을 HTML로 내보낼 수 있습니다. 그런 다음 [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API를 사용하여 HTML을 MARKDOWN로 변환할 수 있습니다.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 POTX을 MARKDOWN로 변환하는 방법" %}}
...
{{% blocks/products/pf/feature-page-section  h2="C#을 통해 보호된 POTX을 MARKDOWN로 변환" %}}
POTX 파일을 MARKDOWN로 변환하는 동안 입력 POTX 문서가 비밀번호로 보호되어 있으면 문서를 해독하지 않고는 MARKDOWN로 변환할 수 없습니다. 문서가 암호로 보호되어 있다는 것은 프레젠테이션에 특정 제한을 적용한다는 의미입니다. 제한을 제거하려면 암호를 입력해야 합니다. 암호로 보호된 프레젠테이션은 잠긴 프레젠테이션으로 간주됩니다. API를 사용하면 LoadOptions 개체에 올바른 암호를 전달하여 암호화된 문서를 열 수 있습니다.  
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="C#을 통해 워터마크를 사용하여 POTX을 MARKDOWN로 변환" %}}
POTX 파일을 MARKDOWN로 변환하는 동안 출력 MARKDOWN 파일 형식에 워터마크를 추가할 수도 있습니다. 워터마크를 추가하려면 새 통합 문서 개체를 만들고 변환된 HTML 문서를 열고 해당 인덱스를 통해 워크시트를 선택하고 모양을 만들고 해당 AddTextEffect 기능을 사용할 수 있습니다. 그런 다음 Watermark를 사용하여 HTML 문서를 MARKDOWN로 저장할 수 있습니다. 
{{% blocks/products/pf/feature-page-code %}}
