---
title: Převeďte POTX do formátu JSON přes .NET
description: Převeďte POTX na JSON v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/potx-to-json/
family: total
platformtag: net
feature: conversion
informat: POTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na formát JSON přes C#" h2="Exportujte POTX do JSON přes C# bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for .NET](https://products.aspose.com/total/net/) můžete převést POTX na formát JSON v rámci libovolné aplikace .NET, C#, ASP.NET a VB.NET ve dvou jednoduché kroky. Za prvé, pomocí [Aspose.Slides for .NET] (https://products.aspose.com/slides/net/) můžete exportovat POTX do HTML. Poté můžete pomocí rozhraní [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API převést HTML na JSON.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Převést POTX na formát JSON přes C#" %}}
1. Otevřete soubor POTX pomocí třídy [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Převeďte POTX na HTML pomocí metody [Uložit](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Převést chráněný POTX na formát JSON přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést POTX na JSON v rozsahu přes C#" %}}
