...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete SVG na XAMLFLOW přes .NET" h2=".NET API pro export SVG do XAMLFLOW na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod SVG na XAMLFLOW" %}}
