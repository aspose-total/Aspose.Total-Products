...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete MHTML na DOTX přes .NET" h2=".NET API pro export MHTML do DOTX na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod MHTML na DOTX" %}}
