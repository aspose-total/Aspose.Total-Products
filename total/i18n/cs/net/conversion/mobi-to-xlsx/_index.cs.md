---
title: .NET API pro převod MOBI do XLSX
description: C# API pro převod MOBI do XLSX bez použití Microsoft Excel nebo Adobe Reader
url: /cs/net/conversion/mobi-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API pro převod MOBI na XLSX" h2="Export MOBI do XLSX přes C# bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Uložte dokument do formátu XLSX pomocí metody [Uložit](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) a nastavte „XLSX“ jako SaveFormat
