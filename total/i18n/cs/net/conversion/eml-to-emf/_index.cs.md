...
4. Uložte dokument do formátu EMF pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Emf jako SaveFormat
