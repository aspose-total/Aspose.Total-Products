...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete XPS na FLATOPC přes .NET" h2=".NET API pro export XPS do FLATOPC na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod XPS na FLATOPC" %}}
