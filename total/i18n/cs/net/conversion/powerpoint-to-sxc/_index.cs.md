...
url: /cs/net/conversion/powerpoint-to-sxc/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{% blocks/products/pf/agp/feature-section-col title="Jak převést POWERPOINT na SXC přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést POWERPOINT na SXC s vodoznakem přes C#" %}}
Při převodu souboru POWERPOINT na SXC můžete také přidat vodoznak do výstupního formátu souboru SXC. Chcete-li přidat vodoznak, můžete vytvořit nový objekt Workbook a otevřít převedený HTML dokument, vybrat Worksheet přes jeho index, vytvořit Shape a použít jeho funkci AddTextEffect. Powerpointé můžete svůj HTML dokument uložit jako SXC s vodoznakem. 
{{% blocks/products/pf/feature-page-code %}}
