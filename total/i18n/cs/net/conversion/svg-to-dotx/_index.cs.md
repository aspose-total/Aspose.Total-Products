---
title: C# API pro export SVG do DOTX
description: Převeďte SVG na DOTX bez použití aplikace Microsoft Word
url: /cs/net/conversion/svg-to-dotx/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete SVG na DOTX přes .NET" h2=".NET API pro export SVG do DOTX na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod SVG na DOTX" %}}
