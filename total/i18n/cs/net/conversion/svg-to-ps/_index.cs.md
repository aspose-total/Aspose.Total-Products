...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete SVG na PS přes .NET" h2=".NET API pro export SVG do PS na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod SVG na PS" %}}
