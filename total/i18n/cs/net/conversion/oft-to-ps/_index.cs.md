...
4. Uložte dokument do formátu PS pomocí metody [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Ps jako SaveFormat
