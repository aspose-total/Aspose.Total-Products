---
title: Převést PPTM na SXC přes C#
description: Převeďte PPTM na SXC v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pptm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTM na SXC přes C#" h2=".NET API pro převod PPTM do SXC bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
