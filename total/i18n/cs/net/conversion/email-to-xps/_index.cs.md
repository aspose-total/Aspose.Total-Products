...
4. Uložte dokument do formátu XPS pomocí metody [Uložit](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Xps jako SaveFormat
