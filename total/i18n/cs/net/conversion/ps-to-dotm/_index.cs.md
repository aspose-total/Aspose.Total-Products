---
title: C# API pro export PS do DOTM
description: Převeďte PS na DOTM bez použití aplikace Microsoft Word
url: /cs/net/conversion/ps-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete PS na DOTM přes .NET" h2=".NET API pro export PS do DOTM na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod PS na DOTM" %}}
