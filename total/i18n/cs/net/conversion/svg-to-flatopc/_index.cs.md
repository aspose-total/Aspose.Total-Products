---
title: C# API pro export SVG do FLATOPC
description: Převeďte SVG na FLATOPC bez použití aplikace Microsoft Word
url: /cs/net/conversion/svg-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete SVG na FLATOPC přes .NET" h2=".NET API pro export SVG do FLATOPC na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod SVG na FLATOPC" %}}
...
4. Uložte dokument do formátu FLATOPC pomocí metody [Uložit](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Flatopc jako SaveFormat
