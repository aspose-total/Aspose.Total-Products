---
title: Převést POWERPOINT na MHTML přes C#
description: Převeďte POWERPOINT na MHTML v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/powerpoint-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POWERPOINT na MHTML přes C#" h2=".NET API pro převod POWERPOINT do MHTML bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for .NET](https://products.aspose.com/total/net/) můžete převést soubor POWERPOINT na MHTML v rámci libovolné aplikace .NET, C#, ASP.NET a VB.NET ve dvou jednoduché kroky. Za prvé, pomocí [Aspose.Slides for .NET] (https://products.aspose.com/slides/net/) můžete exportovat POWERPOINT do HTML. Powerpointé můžete pomocí rozhraní [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API převést HTML na MHTML.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Jak převést POWERPOINT na MHTML přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést POWERPOINT na MHTML s vodoznakem přes C#" %}}
Při převodu souboru POWERPOINT na MHTML můžete také přidat vodoznak do výstupního formátu souboru MHTML. Chcete-li přidat vodoznak, můžete vytvořit nový objekt Workbook a otevřít převedený HTML dokument, vybrat Worksheet přes jeho index, vytvořit Shape a použít jeho funkci AddTextEffect. Powerpointé můžete svůj HTML dokument uložit jako MHTML s vodoznakem. 
{{% blocks/products/pf/feature-page-code %}}
