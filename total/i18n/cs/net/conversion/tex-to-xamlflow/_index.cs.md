...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete TEX na XAMLFLOW přes .NET" h2=".NET API pro export TEX do XAMLFLOW na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod TEX na XAMLFLOW" %}}
