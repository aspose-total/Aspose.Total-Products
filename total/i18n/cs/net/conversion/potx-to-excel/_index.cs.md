---
title: Převést POTX na EXCEL přes C#
description: Převeďte POTX na EXCEL v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/potx-to-excel/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést POTX na EXCEL přes C#" h2=".NET API pro převod POTX do EXCEL bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for .NET](https://products.aspose.com/total/net/) můžete převést soubor POTX na EXCEL v rámci libovolné aplikace .NET, C#, ASP.NET a VB.NET ve dvou jednoduché kroky. Za prvé, pomocí [Aspose.Slides for .NET] (https://products.aspose.com/slides/net/) můžete exportovat POTX do HTML. Potxé můžete pomocí rozhraní [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API převést HTML na EXCEL.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Jak převést POTX na EXCEL přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést POTX na EXCEL s vodoznakem přes C#" %}}
Při převodu souboru POTX na EXCEL můžete také přidat vodoznak do výstupního formátu souboru EXCEL. Chcete-li přidat vodoznak, můžete vytvořit nový objekt Workbook a otevřít převedený HTML dokument, vybrat Worksheet přes jeho index, vytvořit Shape a použít jeho funkci AddTextEffect. Potxé můžete svůj HTML dokument uložit jako EXCEL s vodoznakem. 
{{% blocks/products/pf/feature-page-code %}}
