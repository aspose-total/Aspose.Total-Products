...
description: Převeďte MHTML na OTT bez použití aplikace Microsoft Word
url: /cs/net/conversion/mhtml-to-ott/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete MHTML na OTT přes .NET" h2=".NET API pro export MHTML do OTT na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod MHTML na OTT" %}}
...
4. Uložte dokument do formátu OTT pomocí metody [Uložit](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Ott jako SaveFormat
