---
title: Převést PPS na EXCEL přes C#
description: Převeďte PPS na EXCEL v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pps-to-excel/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{% blocks/products/pf/feature-page-section  h2="Převést chráněný PPS na EXCEL přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést PPS na EXCEL s vodoznakem přes C#" %}}
