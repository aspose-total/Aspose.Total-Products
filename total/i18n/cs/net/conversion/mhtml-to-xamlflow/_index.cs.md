...
4. Uložte dokument do formátu XAMLFLOW pomocí metody [Uložit](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) a nastavte Xamlflow jako SaveFormat
