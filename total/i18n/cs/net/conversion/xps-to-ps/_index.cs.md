...
description: Převeďte XPS na PS bez použití aplikace Microsoft Word
url: /cs/net/conversion/xps-to-ps/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Vykreslete XPS na PS přes .NET" h2=".NET API pro export XPS do PS na Windows, macOS a Linux bez použití Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API pro převod XPS na PS" %}}
