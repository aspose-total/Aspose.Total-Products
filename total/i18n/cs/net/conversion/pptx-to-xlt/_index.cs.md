---
title: Převést PPTX na XLT přes C#
description: Převeďte PPTX na XLT v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pptx-to-xlt/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPTX na XLT přes C#" h2=".NET API pro převod PPTX do XLT bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Pomocí [Aspose.Total for .NET](https://products.aspose.com/total/net/) můžete převést soubor PPTX na XLT v rámci libovolné aplikace .NET, C#, ASP.NET a VB.NET ve dvou jednoduché kroky. Za prvé, pomocí [Aspose.Slides for .NET] (https://products.aspose.com/slides/net/) můžete exportovat PPTX do HTML. Pptxé můžete pomocí rozhraní [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API převést HTML na XLT.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Jak převést PPTX na XLT přes C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Převést PPTX na XLT s vodoznakem přes C#" %}}
Při převodu souboru PPTX na XLT můžete také přidat vodoznak do výstupního formátu souboru XLT. Chcete-li přidat vodoznak, můžete vytvořit nový objekt Workbook a otevřít převedený HTML dokument, vybrat Worksheet přes jeho index, vytvořit Shape a použít jeho funkci AddTextEffect. Pptxé můžete svůj HTML dokument uložit jako XLT s vodoznakem. 
{{% blocks/products/pf/feature-page-code %}}
