---
title: Převést PPS na XLAM přes C#
description: Převeďte PPS na XLAM v C# bez použití Microsoft Excel nebo Powerpoint
url: /cs/net/conversion/pps-to-xlam/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést PPS na XLAM přes C#" h2=".NET API pro převod PPS do XLAM bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
