...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCM na XLSX přes Java" h2="On Premise Java API pro převod DOCM na XLSX bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCM do XLSX" %}}
