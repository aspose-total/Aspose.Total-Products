---
title: Java API pro převod DOCX do XLAM
description: Převeďte DOCX na XLAM přes Java bez použití Microsoft Word nebo Microsoft Excel
url: /cs/java/conversion/docx-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převést DOCX na XLAM přes Java" h2="On Premise Java API pro převod DOCX na XLAM bez použití Microsoft<sup>&reg;</sup> Word nebo Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API pro převod DOCX do XLAM" %}}
