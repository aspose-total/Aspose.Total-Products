---
title: Převeďte POTX do formátu TSV přes Java
description: Převeďte POTX do formátu TSV přes Java bez použití Microsoft Excel nebo PowerPoint
url: /cs/java/conversion/potx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Převeďte POTX do TSV přes Java" h2="On Premise Java API pro export POTX do TSV bez použití Microsoft<sup>&reg;</sup> Excel nebo PowerPoint" >}}
...
Chcete-li převést POTX na TSV, můžete snadno použít Aspose.Total pro Java přímo z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose/aspose-total) a zahrňte knihovny do vašeho pom.xml.
