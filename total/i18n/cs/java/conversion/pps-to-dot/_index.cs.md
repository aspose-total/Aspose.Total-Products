---
title: Převeďte PPS na DOT přes Java
description: Java API pro export PPS do DOT bez použití Microsoft Word nebo PowerPoint
url: /cs/java/conversion/pps-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPS
...
Pomocí API můžete také provést převod PPS souboru na DOT s vodoznakem. Chcete-li přidat vodoznak do dokumentu DOT, můžete nejprve převést soubor PPS do HTML a přidat do něj vodoznak. Chcete-li přidat vodoznak, načtěte nově vytvořený soubor HTML pomocí třídy [Dotument](https://apireference.aspose.com/words/java/com.aspose.words/Dotument), vytvořte instanci TextWatermarkOptions a nastavte jeho vlastnosti, zavolejte metodu Watermark.setText a předejte text vodoznaku a objekt TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
