---
title: .NET API để chuyển đổi ODT sang XLS
description: C # API để chuyển đổi ODT sang XLS mà không cần sử dụng Microsoft Excel hoặc Adobe Reader
url: /vi/net/conversion/odt-to-xls/
family: total
platformtag: net
feature: conversion
informat: ODT
