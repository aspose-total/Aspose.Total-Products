...
url: /vi/net/conversion/odt-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: ODT
...
2. Chuyển đổi ODT sang HTML bằng phương pháp [Lưu](https://apireference.aspose.com/words/net/aspose.words.odtument/save/methods/4)
...
{{% blocks/products/pf/fe](re-page-section  h2="Tải tài liệu ODT từ Luồng qua C#" %}}
[Aspose. AdWords for .NET](https://products.aspose.com/words/net/) cũng cho phép bạn tải tài liệu ODT qua luồng. Để mở tài liệu từ luồng, chỉ cần chuyển đối tượng luồng có chứa tài liệu vào phương thức khởi tạo [Odtument](https://apireference.aspose.com/words/net/aspose.words/odtument). Ví dụ mã sau đây cho thấy cách mở một tài liệu từ một luồng:  
{{% blocks/products/pf/feature-page-code %}}
