---
title: API de Java para convertir OTT a TSV
description: Convierta OTT a TSV a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/ott-to-tsv/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta OTT a TSV a través de Java" h2="API de Java local para convertir OTT a TSV sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el ottumento en formato TSV mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
