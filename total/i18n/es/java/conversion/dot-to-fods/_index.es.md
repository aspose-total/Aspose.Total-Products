...
description: Convierta DOT a FODS a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/dot-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOT a FODS a través de Java" h2="API de Java local para convertir DOT a FODS sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotumento en formato FODS mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
