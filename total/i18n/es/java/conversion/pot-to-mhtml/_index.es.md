---
title: Convierta POT a formato MHTML a través de Java
description: Convierta POT a formato MHTML a través de Java sin usar Microsoft Excel o PowerPoint
url: /es/java/conversion/pot-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta POT a MHTML a través de Java" h2="API de Java local para exportar POT a MHTML sin usar Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir POT a MHTML a través de Java" %}}
...
Para convertir POT a MHTML, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose/aspose-total) e incluya bibliotecas en su pom.xml.
...
Usando la API, también puede abrir el documento protegido por contraseña. Si su documento POT de entrada está protegido con contraseña, no puede convertirlo a MHTML sin usar la contraseña. La API le permite abrir el documento cifrado pasando la contraseña correcta en un objeto LoadOptions.  
{{% blocks/products/pf/feature-page-code %}}

{{< gist "aspose-com-gists" "4b527b3966d48e40c1b50136eebdbb6e" "convert-protected-powerpoint-to-excel.java" >}}
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Convierta POT protegido a MHTML a través de Java" %}}
Al convertir un archivo POT a MHTML, también puede agregar una marca de agua a su formato de archivo MHTML de salida. Para agregar una marca de agua, cree un nuevo libro de trabajo para abrir el archivo HTML convertido. Seleccione Hoja de trabajo a través de su índice, cree una Forma y use su función addTextEffect, establezca colores, transparencia y más. Después de eso, puede guardar su documento HTML como MHTML con marca de agua. 
{{% blocks/products/pf/feature-page-code %}}
