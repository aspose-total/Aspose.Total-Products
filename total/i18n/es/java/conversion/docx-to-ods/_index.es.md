---
title: API de Java para convertir DOCX a ODS
description: Convierta DOCX a ODS a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/docx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOCX a ODS a través de Java" h2="API de Java local para convertir DOCX a ODS sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docxumento en formato ODS mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
