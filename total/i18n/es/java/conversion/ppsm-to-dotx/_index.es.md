...
Usando la API, también puede realizar una conversión de archivo PPSM a DOTX con marca de agua. Para agregar una marca de agua a su dotxumento DOTX, primero puede convertir el archivo PPSM a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Dotxument](https://apireference.aspose.com/words/java/com.aspose.words/Dotxument), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
