---
title: API de Java para convertir DOTM a EXCEL
description: Convierta DOTM a EXCEL a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/dotm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOTM a EXCEL a través de Java" h2="API de Java local para convertir DOTM a EXCEL sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
{{% blocks/products/pf/feature-page-summary %}}
Convertir DOTM a EXCEL a través de [Aspose.Total for Java](https://products.aspose.com/total/java/) es un proceso simple de dos pasos. Mediante el uso de la API de conversión y manipulación de dotmumentos rica en funciones [Aspose.Words for Java](https://products.aspose.com/words/java/), puede exportar DOTM a HTML. Después de eso, usando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), puede convertir HTML a EXCEL.
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Guarde el dotmumento en formato EXCEL mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
