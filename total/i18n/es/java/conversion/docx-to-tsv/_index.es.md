---
title: API de Java para convertir DOCX a TSV
description: Convierta DOCX a TSV a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/docx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOCX a TSV a través de Java" h2="API de Java local para convertir DOCX a TSV sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOCX a TSV" %}}
...
4. Guarde el docxumento en formato TSV mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
