...
6. Guarde el wordumento en POTM usando el método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
La API también le permite convertir wordumentos WORD protegidos con contraseña a POTM. Si su wordumento WORD de entrada está protegido con contraseña, no puede convertirlo al formato POTM sin usar la contraseña. Para abrir un wordumento cifrado, puede establecer la contraseña correcta en el objeto LoadOptions y pasarla al constructor del wordumento.  
{{% blocks/products/pf/feature-page-code %}}
