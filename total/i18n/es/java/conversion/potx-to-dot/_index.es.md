...
Usando la API, también puede realizar una conversión de archivo POTX a DOT con marca de agua. Para agregar una marca de agua a su dotumento DOT, primero puede convertir el archivo POTX a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Dotument](https://apireference.aspose.com/words/java/com.aspose.words/Dotument), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
