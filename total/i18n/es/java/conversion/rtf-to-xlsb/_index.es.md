...
url: /es/java/conversion/rtf-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir RTF a XLSB" %}}
...
4. Guarde el rtfumento en formato XLSB mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
