---
title: API .NET para convertir ODT a XLAM
description: API de C# para convertir ODT a XLAM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/odt-to-xlam/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Guarde el odtumento en formato XLAM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLAM` como SaveFormat
