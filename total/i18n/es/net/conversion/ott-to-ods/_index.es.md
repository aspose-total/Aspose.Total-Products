---
title: API .NET para convertir OTT a ODS
description: API de C# para convertir OTT a ODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-ods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
3. Cargue el ottumento HTML utilizando la clase [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook)
4. Guarde el ottumento en formato ODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `ODS` como SaveFormat
