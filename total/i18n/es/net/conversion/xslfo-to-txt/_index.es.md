---
title: Convierta XSLFO a TXT a través de la API de C#
description: API C# para convertir archivos XSLFO a TXT sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/xslfo-to-txt/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar XSLFO a TXT" h2="Exporte el archivo XSLFO a TXT a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir XSLFO a TXT" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convierta XSLFO protegido a TXT a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo XSLFO a TXT con marca de agua a través de C#" %}}
