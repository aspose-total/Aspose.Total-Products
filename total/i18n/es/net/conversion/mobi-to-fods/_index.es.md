...
url: /es/net/conversion/mobi-to-fods/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Guarde el mobiumento en formato FODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `FODS` como SaveFormat
