---
title: API .NET para convertir ODT a CSV
description: API de C# para convertir ODT a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/odt-to-csv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Guarde el odtumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
