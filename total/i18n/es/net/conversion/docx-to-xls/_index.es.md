...
url: /es/net/conversion/docx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Guarde el docxumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
