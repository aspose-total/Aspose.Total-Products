---
title: API .NET para convertir ODT a XLS
description: API de C# para convertir ODT a XLS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/odt-to-xls/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Guarde el odtumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
