...
description: API de C# para convertir DOCM a TSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOCM a TSV" h2="Exporte DOCM a TSV a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docmumento en formato TSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `TSV` como SaveFormat
