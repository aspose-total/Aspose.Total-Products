---
title: Convierta PCL a TGA a través de la API de C#
description: Exporte PCL a TGA en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/pcl-to-tga/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PCL a TGA a través de C#" %}}
