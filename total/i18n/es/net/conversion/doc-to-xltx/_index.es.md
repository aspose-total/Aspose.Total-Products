---
title: API .NET para convertir DOC a XLTX
description: API de C# para convertir DOC a XLTX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/doc-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOC
