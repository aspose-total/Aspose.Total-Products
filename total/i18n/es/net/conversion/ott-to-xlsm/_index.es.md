---
title: API .NET para convertir OTT a XLSM
description: API de C# para convertir OTT a XLSM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
