---
title: API .NET para convertir OTT a XLT
description: API de C# para convertir OTT a XLT sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-xlt/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato XLT usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLT` como SaveFormat
