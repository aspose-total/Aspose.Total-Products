---
title: API .NET para convertir WORD a TSV
description: API de C# para convertir WORD a TSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/word-to-tsv/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato TSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `TSV` como SaveFormat
