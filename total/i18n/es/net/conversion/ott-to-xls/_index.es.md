---
title: API .NET para convertir OTT a XLS
description: API de C# para convertir OTT a XLS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
