---
title: API .NET para convertir MOBI a CSV
description: API de C# para convertir MOBI a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/mobi-to-csv/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Guarde el mobiumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
