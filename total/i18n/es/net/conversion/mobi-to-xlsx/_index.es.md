---
title: API .NET para convertir MOBI a XLSX
description: API de C# para convertir MOBI a XLSX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/mobi-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Guarde el mobiumento en formato XLSX usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSX` como SaveFormat
