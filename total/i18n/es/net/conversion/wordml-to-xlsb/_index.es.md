---
title: API .NET para convertir WORDML a XLSB
description: API de C# para convertir WORDML a XLSB sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Guarde el wordmlumento en formato XLSB usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSB` como SaveFormat
