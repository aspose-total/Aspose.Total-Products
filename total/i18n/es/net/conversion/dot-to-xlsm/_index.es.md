---
title: API .NET para convertir DOT a XLSM
description: API de C# para convertir DOT a XLSM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
