---
title: API .NET para convertir DOCM a DIF
description: API de C# para convertir DOCM a DIF sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Guarde el docmumento en formato DIF usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `DIF` como SaveFormat
