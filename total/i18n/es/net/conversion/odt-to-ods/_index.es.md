---
title: API .NET para convertir ODT a ODS
description: API de C# para convertir ODT a ODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/odt-to-ods/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Guarde el odtumento en formato ODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `ODS` como SaveFormat
