---
title: API .NET para convertir DOT a SXC
description: API de C# para convertir DOT a SXC sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato SXC usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `SXC` como SaveFormat
