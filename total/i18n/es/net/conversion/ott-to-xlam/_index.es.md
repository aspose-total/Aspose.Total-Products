---
title: API .NET para convertir OTT a XLAM
description: API de C# para convertir OTT a XLAM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-xlam/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato XLAM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLAM` como SaveFormat
