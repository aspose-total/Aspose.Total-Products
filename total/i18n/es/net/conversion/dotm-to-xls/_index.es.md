---
title: API .NET para convertir DOTM a XLS
description: API de C# para convertir DOTM a XLS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotm-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Guarde el dotmumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
