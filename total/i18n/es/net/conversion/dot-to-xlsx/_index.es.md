---
title: API .NET para convertir DOT a XLSX
description: API de C# para convertir DOT a XLSX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato XLSX usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSX` como SaveFormat
