---
title: API .NET para convertir RTF a TSV
description: API de C# para convertir RTF a TSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/rtf-to-tsv/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Guarde el rtfumento en formato TSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `TSV` como SaveFormat
