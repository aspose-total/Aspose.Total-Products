---
title: API .NET para convertir DOT a XLS
description: API de C# para convertir DOT a XLS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
