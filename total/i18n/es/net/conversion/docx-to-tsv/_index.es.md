---
title: API .NET para convertir DOCX a TSV
description: API de C# para convertir DOCX a TSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Guarde el docxumento en formato TSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `TSV` como SaveFormat
