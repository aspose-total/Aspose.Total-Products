---
title: Convierta XSLFO a XLAM a través de la API de C#
description: API C# para convertir archivos XSLFO a XLAM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/xslfo-to-xlam/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo XSLFO a XLAM con marca de agua a través de C#" %}}
Al convertir un archivo XSLFO a XLAM, también puede agregar una marca de agua a su formato de archivo XLAM de salida. Para agregar una marca de agua, puede crear un nuevo objeto Libro de trabajo y abrir el documento XLSX convertido, seleccionar Hoja de trabajo a través de su índice, crear una Forma y usar su función AddTextEffect. Después de eso, puede guardar su documento XLSX como XLAM con marca de agua. 
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/xslfo-to-tsv/" name="XSLFO Para TSV" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/xslfo-to-txt/" name="XSLFO Para TXT" description="" >}}
