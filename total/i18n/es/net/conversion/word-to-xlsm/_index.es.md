---
title: API .NET para convertir WORD a XLSM
description: API de C# para convertir WORD a XLSM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/word-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
