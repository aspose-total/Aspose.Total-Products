---
title: API .NET para convertir RTF a XLSB
description: API de C# para convertir RTF a XLSB sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/rtf-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Guarde el rtfumento en formato XLSB usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSB` como SaveFormat
