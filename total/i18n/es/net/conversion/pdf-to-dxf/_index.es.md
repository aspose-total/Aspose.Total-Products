---
title: Convierta PDF a DXF a través de la API de C#
description: Exporte PDF a DXF en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/pdf-to-dxf/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PDF a DXF a través de C#" %}}
