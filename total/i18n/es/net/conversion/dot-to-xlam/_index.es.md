---
title: API .NET para convertir DOT a XLAM
description: API de C# para convertir DOT a XLAM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato XLAM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLAM` como SaveFormat
