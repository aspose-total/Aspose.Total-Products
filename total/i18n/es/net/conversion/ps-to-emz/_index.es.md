---
title: Convierta PS a EMZ a través de la API de C#
description: Exporte PS a EMZ en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/ps-to-emz/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PS a EMZ a través de C#" %}}
