---
title: API .NET para convertir DOCM a CSV
description: API de C# para convertir DOCM a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docm-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Guarde el docmumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Cargar docmumento DOCM desde Stream a través de C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) también le permite cargar docmumentos DOCM a través de la transmisión. Para abrir un docmumento desde una secuencia, simplemente pase un objeto de secuencia que contenga el docmumento al constructor [Docmumento](https://apireference.aspose.com/words/net/aspose.words/docmument). El siguiente ejemplo de código muestra cómo abrir un docmumento desde una secuencia:  
{{% blocks/products/pf/feature-page-code %}}
...
Al convertir DOCM a CSV, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) le permite agregar propiedades personalizadas en sus docmumentos CSV. Para agregar una propiedad personalizada, puede usar el método [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection/methods/add/index) para la [CustomDocmumentPropertyCollection]( https://apireference.aspose.com/cells/net/aspose.cells.properties/customdocmumentpropertycollection) clase. El método Add agrega la propiedad al archivo de Excel y devuelve una referencia para la propiedad del nuevo docmumento como [Aspose.Cells.Properties.DocmumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /propiedaddocmumento) objeto. 
{{% blocks/products/pf/feature-page-code %}}
