---
title: API .NET para convertir WORDML a XLTX
description: API de C# para convertir WORDML a XLTX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-xltx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Guarde el wordmlumento en formato XLTX usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLTX` como SaveFormat
