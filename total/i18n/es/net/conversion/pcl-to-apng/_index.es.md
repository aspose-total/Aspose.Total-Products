---
title: Convierta PCL a APNG a través de la API de C#
description: Exporte PCL a APNG en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/pcl-to-apng/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta el archivo PCL a APNG a través de C#" h2="Exporte PCL a APNG dentro de aplicaciones .NET sin utilizar Adobe<sup>&reg;</sup> Acrobat Reader ni ninguna otra aplicación de terceros" >}}

{{% blocks/products/pf/feature-page-summary %}}
Con [Aspose.Total para .NET](https://products.aspose.com/total/net/) puede exportar fácilmente una imagen PCL a APNG dentro de cualquier aplicación .NET en dos sencillos pasos. En primer lugar, al usar [Aspose.PDF para .NET](https://products.aspose.com/pdf/net/), puede exportar PCL a JPEG. Después de eso, al usar [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/) API de procesamiento de imágenes, puede convertir JPEG a APNG.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convierta el archivo PCL a APNG a través de .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PCL a APNG a través de C#" %}}
