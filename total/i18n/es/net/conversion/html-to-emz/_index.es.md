---
title: Convierta HTML a EMZ a través de la API de C#
description: Exporte HTML a EMZ en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/html-to-emz/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos HTML a EMZ a través de C#" %}}
