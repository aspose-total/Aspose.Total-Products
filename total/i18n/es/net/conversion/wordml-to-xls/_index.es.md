---
title: API .NET para convertir WORDML a XLS
description: API de C# para convertir WORDML a XLS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-xls/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Guarde el wordmlumento en formato XLS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLS` como SaveFormat
