---
title: API .NET para convertir DOCX a XLTX
description: API de C# para convertir DOCX a XLTX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCXX
