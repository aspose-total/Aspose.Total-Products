---
title: Convierta XSLFO a FODS a través de la API de C#
description: API C# para convertir archivos XSLFO a FODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/xslfo-to-fods/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar XSLFO a FODS" h2="Exporte el archivo XSLFO a FODS a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir XSLFO a FODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo XSLFO a FODS con marca de agua a través de C#" %}}
