---
title: Convierta PS a PSD a través de la API de C#
description: Exporte PS a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/ps-to-psd/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PS a PSD a través de C#" %}}
