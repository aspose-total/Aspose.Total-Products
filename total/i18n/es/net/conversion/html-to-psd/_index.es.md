---
title: Convierta HTML a PSD a través de la API de C#
description: Exporte HTML a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/html-to-psd/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta el archivo HTML a PSD a través de C#" h2="Exporte HTML a PSD dentro de aplicaciones .NET sin utilizar Adobe<sup>&reg;</sup> Acrobat Reader ni ninguna otra aplicación de terceros" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convierta el archivo HTML a PSD a través de .NET" %}}
1. Abra el archivo HTML usando la clase [Documento](https://apireference.aspose.com/pdf/net/aspose.pdf/document)
2. Inicialice el objeto de clase [JpegDevice](https://apireference.aspose.com/pdf/net/aspose.pdf.devices/jpegdevice) y renderice HTML a JPEG mediante [Process](https://apireference.aspose. com/pdf/net/aspose.pdf.devices.pagedevice/process/methods/1) método
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos HTML a PSD a través de C#" %}}
