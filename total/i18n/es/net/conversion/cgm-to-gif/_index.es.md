---
title: API de C# para exportar CGM a GIF
description: Convierta CGM a GIF sin usar Microsoft Word
url: /es/net/conversion/cgm-to-gif/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar CGM a GIF a través de .NET" h2="API .NET para exportar CGM a GIF en Windows, macOS y Linux sin usar Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C# para convertir CGM a GIF" %}}
