---
title: API .NET para convertir RTF a XLT
description: API de C# para convertir RTF a XLT sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/rtf-to-xlt/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Guarde el rtfumento en formato XLT usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLT` como SaveFormat
