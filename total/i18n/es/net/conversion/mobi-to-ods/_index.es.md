---
title: API .NET para convertir MOBI a ODS
description: API de C# para convertir MOBI a ODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/mobi-to-ods/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Guarde el mobiumento en formato ODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `ODS` como SaveFormat
