---
title: API .NET para convertir DOT a XLT
description: API de C# para convertir DOT a XLT sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Guarde el dotumento en formato XLT usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLT` como SaveFormat
