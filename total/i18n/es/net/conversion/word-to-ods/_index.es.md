---
title: API .NET para convertir WORD a ODS
description: API de C# para convertir WORD a ODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/word-to-ods/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato ODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `ODS` como SaveFormat
