---
title: API .NET para convertir DOCX a FODS
description: API de C# para convertir DOCX a FODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
4. Guarde el docxumento en formato FODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `FODS` como SaveFormat
