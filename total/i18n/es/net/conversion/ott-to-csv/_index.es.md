---
title: API .NET para convertir OTT a CSV
description: API de C# para convertir OTT a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-csv/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
