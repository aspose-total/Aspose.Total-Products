---
title: API .NET para convertir RTF a XLAM
description: API de C# para convertir RTF a XLAM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/rtf-to-xlam/
family: total
platformtag: net
feature: conversion
informat: RTF
...
4. Guarde el rtfumento en formato XLAM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLAM` como SaveFormat
