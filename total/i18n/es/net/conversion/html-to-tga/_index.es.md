---
title: Convierta HTML a TGA a través de la API de C#
description: Exporte HTML a TGA en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/html-to-tga/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos HTML a TGA a través de C#" %}}
