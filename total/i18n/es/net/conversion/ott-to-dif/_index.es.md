---
title: API .NET para convertir OTT a DIF
description: API de C# para convertir OTT a DIF sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/ott-to-dif/
family: total
platformtag: net
feature: conversion
informat: OTT
...
4. Guarde el ottumento en formato DIF usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `DIF` como SaveFormat
