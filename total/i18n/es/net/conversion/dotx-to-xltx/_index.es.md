---
title: API .NET para convertir DOTX a XLTX
description: API de C# para convertir DOTX a XLTX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Guarde el dotxumento en formato XLTX usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLTX` como SaveFormat
