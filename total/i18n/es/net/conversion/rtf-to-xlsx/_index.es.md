---
title: API .NET para convertir RTF a XLSX
description: API de C# para convertir RTF a XLSX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/rtf-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: RTF
