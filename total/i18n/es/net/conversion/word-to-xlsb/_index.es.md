---
title: API .NET para convertir WORD a XLSB
description: API de C# para convertir WORD a XLSB sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/word-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato XLSB usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSB` como SaveFormat
