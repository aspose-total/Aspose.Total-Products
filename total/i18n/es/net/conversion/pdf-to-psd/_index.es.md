---
title: Convierta PDF a PSD a través de la API de C#
description: Exporte PDF a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/pdf-to-psd/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PDF a PSD a través de C#" %}}
