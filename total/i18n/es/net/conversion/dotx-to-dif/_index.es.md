---
title: API .NET para convertir DOTX a DIF
description: API de C# para convertir DOTX a DIF sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
4. Guarde el dotxumento en formato DIF usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `DIF` como SaveFormat
