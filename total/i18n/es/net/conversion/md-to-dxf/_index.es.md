---
title: Convierta MD a DXF a través de la API de C#
description: Exporte MD a DXF en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/md-to-dxf/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos MD a DXF a través de C#" %}}
