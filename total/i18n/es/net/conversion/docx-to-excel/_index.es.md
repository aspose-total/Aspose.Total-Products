...
4. Guarde el docxumento en formato EXCEL usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `EXCEL` como SaveFormat
