---
title: Convierta XSLFO a XLTX a través de la API de C#
description: API C# para convertir archivos XSLFO a XLTX sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/xslfo-to-xltx/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar XSLFO a XLTX" h2="Exporte el archivo XSLFO a XLTX a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir XSLFO a XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convierta XSLFO protegido a XLTX a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo XSLFO a XLTX con marca de agua a través de C#" %}}
