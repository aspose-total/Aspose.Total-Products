---
title: API .NET para convertir MOBI a EXCEL
description: API de C# para convertir MOBI a EXCEL sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/mobi-to-excel/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
4. Guarde el mobiumento en formato EXCEL usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `EXCEL` como SaveFormat
