---
title: API .NET para convertir DOTM a CSV
description: API de C# para convertir DOTM a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotm-to-csv/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Guarde el dotmumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
