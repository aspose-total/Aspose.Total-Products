---
title: API .NET para convertir DOCM a SXC
description: API de C# para convertir DOCM a SXC sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
4. Guarde el docmumento en formato SXC usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `SXC` como SaveFormat
