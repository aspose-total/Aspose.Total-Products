---
title: Convierta XPS a DXF a través de la API de C#
description: Exporte XPS a DXF en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url: /es/net/conversion/xps-to-dxf/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos XPS a DXF a través de C#" %}}
