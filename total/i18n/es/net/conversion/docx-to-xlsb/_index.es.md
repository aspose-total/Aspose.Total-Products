---
title: API .NET para convertir DOCX a XLSB
description: API de C# para convertir DOCX a XLSB sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/docx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOCX a XLSB" h2="Exporte DOCX a XLSB a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docxumento en formato XLSB usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSB` como SaveFormat
