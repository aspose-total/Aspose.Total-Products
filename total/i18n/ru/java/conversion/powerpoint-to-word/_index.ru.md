---
title: Конвертировать POWERPOINT в WORD через Java
description: Java API для экспорта POWERPOINT в WORD без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/powerpoint-to-word/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Для преобразования файлов POWERPOINT в WORD вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/powerpoint-to-wordm/" name="POWERPOINT К WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/powerpoint-to-wordx/" name="POWERPOINT К WORDX" description="" >}}
