---
title: Конвертировать PPSX в DOTM через Java
description: Java API для экспорта PPSX в DOTM без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsx-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
Для преобразования файлов PPSX в DOTM вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-dotmm/" name="PPSX К DOTMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-dotmx/" name="PPSX К DOTMX" description="" >}}
