---
title: Конвертировать PPSX в RTF через Java
description: Java API для экспорта PPSX в RTF без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsx-to-rtf/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
Для преобразования файлов PPSX в RTF вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-rtfm/" name="PPSX К RTFM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-rtfx/" name="PPSX К RTFX" description="" >}}
