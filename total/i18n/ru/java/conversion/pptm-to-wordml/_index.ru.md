---
title: Конвертировать PPTM в WORDML через Java
description: Java API для экспорта PPTM в WORDML без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pptm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
Для преобразования файлов PPTM в WORDML вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptm-to-wordmlm/" name="PPTM К WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptm-to-wordmlx/" name="PPTM К WORDMLX" description="" >}}
