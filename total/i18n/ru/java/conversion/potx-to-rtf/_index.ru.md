---
title: Конвертировать POTX в RTF через Java
description: Java API для экспорта POTX в RTF без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/potx-to-rtf/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
Для преобразования файлов POTX в RTF вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potx-to-rtfm/" name="POTX К RTFM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potx-to-rtfx/" name="POTX К RTFX" description="" >}}
