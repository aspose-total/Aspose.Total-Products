---
title: Java API для преобразования DOTX в XLSX
description: Преобразование DOTX в XLSX через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/dotx-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOTX
