---
title: Конвертировать POWERPOINT в DOTM через Java
description: Java API для экспорта POWERPOINT в DOTM без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/powerpoint-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Для преобразования файлов POWERPOINT в DOTM вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/powerpoint-to-dotmm/" name="POWERPOINT К DOTMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/powerpoint-to-dotmx/" name="POWERPOINT К DOTMX" description="" >}}
