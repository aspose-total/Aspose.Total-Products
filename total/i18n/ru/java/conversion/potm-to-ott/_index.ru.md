---
title: Конвертировать POTM в OTT через Java
description: Java API для экспорта POTM в OTT без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/potm-to-ott/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
Для преобразования файлов POTM в OTT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potm-to-ottm/" name="POTM К OTTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potm-to-ottx/" name="POTM К OTTX" description="" >}}
