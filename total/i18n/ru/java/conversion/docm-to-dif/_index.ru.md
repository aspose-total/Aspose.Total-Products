---
title: Java API для преобразования DOCM в DIF
description: Преобразование DOCM в DIF через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/docm-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCMM
