---
title: Конвертировать PPT в WORDML через Java
description: Java API для экспорта PPT в WORDML без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppt-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPT
...
Для преобразования файлов PPT в WORDML вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppt-to-wordmlm/" name="PPT К WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppt-to-wordmlx/" name="PPT К WORDMLX" description="" >}}
