---
title: Конвертировать PPTX в DOCM через Java
description: Java API для экспорта PPTX в DOCM без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pptx-to-docm/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Для преобразования файлов PPTX в DOCM вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptx-to-docmm/" name="PPTX К DOCMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptx-to-docmx/" name="PPTX К DOCMX" description="" >}}
