---
title: Java API для преобразования DOTX в XLSM
description: Преобразование DOTX в XLSM через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
