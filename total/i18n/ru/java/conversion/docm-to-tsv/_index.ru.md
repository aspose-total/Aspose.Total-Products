---
title: Java API для преобразования DOCM в TSV
description: Преобразование DOCM в TSV через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/docm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCMM
