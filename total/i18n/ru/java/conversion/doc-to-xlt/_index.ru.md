---
title: Java API для преобразования DOC в XLT
description: Преобразование DOC в XLT через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/doc-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOC
