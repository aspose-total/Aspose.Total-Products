---
title: Конвертировать POT в DOC через Java
description: Java API для экспорта POT в DOC без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pot-to-doc/
family: total
platformtag: net
feature: conversion
informat: POT
...
Для преобразования файлов POT в DOC вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
