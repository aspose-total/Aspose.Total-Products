---
title: Конвертировать PPS в DOCM через Java
description: Java API для экспорта PPS в DOCM без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pps-to-docm/
family: total
platformtag: net
feature: conversion
informat: PPS
...
Для преобразования файлов PPS в DOCM вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pps-to-docmm/" name="PPS К DOCMM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pps-to-docmx/" name="PPS К DOCMX" description="" >}}
