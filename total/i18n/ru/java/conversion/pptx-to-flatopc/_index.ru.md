---
title: Конвертировать PPTX в FLATOPC через Java
description: Java API для экспорта PPTX в FLATOPC без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pptx-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Для преобразования файлов PPTX в FLATOPC вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptx-to-flatopcm/" name="PPTX К FLATOPCM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptx-to-flatopcx/" name="PPTX К FLATOPCX" description="" >}}
