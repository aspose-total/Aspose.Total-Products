---
title: Конвертировать PPSM в WORDML через Java
description: Java API для экспорта PPSM в WORDML без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
Для преобразования файлов PPSM в WORDML вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-wordmlm/" name="PPSM К WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-wordmlx/" name="PPSM К WORDMLX" description="" >}}
