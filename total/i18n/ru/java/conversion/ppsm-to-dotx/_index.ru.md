---
title: Конвертировать PPSM в DOTX через Java
description: Java API для экспорта PPSM в DOTX без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsm-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
Для преобразования файлов PPSM в DOTX вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-dotxm/" name="PPSM К DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-dotxx/" name="PPSM К DOTXX" description="" >}}
