---
title: Java API для преобразования DOCM в XLTX
description: Преобразование DOCM в XLTX через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/docm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCMM
