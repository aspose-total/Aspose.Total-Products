---
title: Конвертировать PPT в TEXT через Java
description: Java API для экспорта PPT в TEXT без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppt-to-text/
family: total
platformtag: net
feature: conversion
informat: PPT
...
Для преобразования файлов PPT в TEXT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppt-to-textm/" name="PPT К TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppt-to-textx/" name="PPT К TEXTX" description="" >}}
