---
title: Java API для преобразования DOTX в FODS
description: Преобразование DOTX в FODS через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/dotx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOTX
