---
title: Конвертировать PPSX в DOCX через Java
description: Java API для экспорта PPSX в DOCX без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsx-to-docx/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
Для преобразования файлов PPSX в DOCX вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-docxm/" name="PPSX К DOCXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-docxx/" name="PPSX К DOCXX" description="" >}}
