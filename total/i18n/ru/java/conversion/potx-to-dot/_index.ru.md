---
title: Конвертировать POTX в DOT через Java
description: Java API для экспорта POTX в DOT без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/potx-to-dot/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
Для преобразования файлов POTX в DOT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
