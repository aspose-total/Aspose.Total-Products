---
title: Java API для преобразования WORDML в ODS
description: Преобразование WORDML в ODS через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/wordml-to-ods/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать WORDML в ODS через Java" h2="Локальный Java API для преобразования WORDML в ODS без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
