---
title: Java API для преобразования DOT в XLTX
description: Преобразование DOT в XLTX через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/dot-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
Вы можете легко использовать Aspose.Total для Java непосредственно из проекта на основе [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total). и включите [Aspose.Words для Java](https://dots.aspose.com/words/java/installation/) и [Aspose.Cells для Java](https://dots.aspose.com/cells/java/ установка/) в вашем pom.xml.
