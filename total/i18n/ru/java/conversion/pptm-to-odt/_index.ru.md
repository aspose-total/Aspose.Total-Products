---
title: Конвертировать PPTM в ODT через Java
description: Java API для экспорта PPTM в ODT без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pptm-to-odt/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
Для преобразования файлов PPTM в ODT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptm-to-odtm/" name="PPTM К ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pptm-to-odtx/" name="PPTM К ODTX" description="" >}}
