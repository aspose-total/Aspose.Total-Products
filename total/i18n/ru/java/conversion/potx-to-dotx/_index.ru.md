---
title: Конвертировать POTX в DOTX через Java
description: Java API для экспорта POTX в DOTX без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/potx-to-dotx/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
Для преобразования файлов POTX в DOTX вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potx-to-dotxm/" name="POTX К DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potx-to-dotxx/" name="POTX К DOTXX" description="" >}}
