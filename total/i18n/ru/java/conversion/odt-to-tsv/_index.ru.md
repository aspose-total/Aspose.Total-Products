---
title: Java API для преобразования ODT в TSV
description: Преобразование ODT в TSV через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/odt-to-tsv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
4. Сохраните документ в формате TSV с помощью [Сохранить](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) метод
