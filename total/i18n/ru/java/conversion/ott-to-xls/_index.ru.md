---
title: Java API для преобразования OTT в XLS
description: Преобразование OTT в XLS через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать OTT в XLS через Java" h2="Локальный Java API для преобразования OTT в XLS без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования OTT в XLS" %}}
