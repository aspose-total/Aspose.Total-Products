---
title: Конвертировать PPSM в WORD через Java
description: Java API для экспорта PPSM в WORD без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsm-to-word/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
Для преобразования файлов PPSM в WORD вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-wordm/" name="PPSM К WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsm-to-wordx/" name="PPSM К WORDX" description="" >}}
