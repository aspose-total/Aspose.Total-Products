---
title: Конвертировать PPSX в WORD через Java
description: Java API для экспорта PPSX в WORD без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/ppsx-to-word/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
Для преобразования файлов PPSX в WORD вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-wordm/" name="PPSX К WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/ppsx-to-wordx/" name="PPSX К WORDX" description="" >}}
