---
title: Конвертировать POTM в WORD через Java
description: Java API для экспорта POTM в WORD без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/potm-to-word/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
Для преобразования файлов POTM в WORD вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potm-to-wordm/" name="POTM К WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/potm-to-wordx/" name="POTM К WORDX" description="" >}}
