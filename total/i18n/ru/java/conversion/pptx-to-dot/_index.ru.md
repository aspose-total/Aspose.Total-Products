---
title: Конвертировать PPTX в DOT через Java
description: Java API для экспорта PPTX в DOT без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pptx-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Для преобразования файлов PPTX в DOT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
