---
title: Конвертировать POT в WORDML через Java
description: Java API для экспорта POT в WORDML без использования Microsoft Word или PowerPoint
url: /ru/java/conversion/pot-to-wordml/
family: total
platformtag: net
feature: conversion
informat: POT
...
Для преобразования файлов POT в WORDML вы можете легко использовать Aspose.Total для Java непосредственно из [Maven] (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) и включите библиотеки в ваш pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pot-to-wordmlm/" name="POT К WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/pot-to-wordmlx/" name="POT К WORDMLX" description="" >}}
