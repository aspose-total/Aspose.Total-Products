---
title: Java API для преобразования DOTX в SXC
description: Преобразование DOTX в SXC через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/dotx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать DOTX в SXC через Java" h2="Локальный Java API для преобразования DOTX в SXC без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования DOTX в SXC" %}}
