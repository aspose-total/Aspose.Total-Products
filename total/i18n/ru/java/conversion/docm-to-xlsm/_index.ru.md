---
title: Java API для преобразования DOCM в XLSM
description: Преобразование DOCM в XLSM через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/docm-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOCMM
