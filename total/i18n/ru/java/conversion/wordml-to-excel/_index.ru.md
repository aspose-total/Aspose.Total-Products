---
title: Java API для преобразования WORDML в EXCEL
description: Преобразование WORDML в EXCEL через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/wordml-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать WORDML в EXCEL через Java" h2="Локальный Java API для преобразования WORDML в EXCEL без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
