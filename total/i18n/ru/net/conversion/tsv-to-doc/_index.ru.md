---
title: Преобразование TSV в DOC с помощью .NET 
description: Преобразование TSV в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.
url: /ru/net/conversion/tsv-to-doc/
family: total
platformtag: net
feature: conversion
informat: TSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование TSV в DOC через C#" h2="Экспорт Excel&reg; TSV в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование TSV в DOC на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования TSV в DOC" gistPath="" %}}
