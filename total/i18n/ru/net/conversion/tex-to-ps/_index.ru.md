---
title: C# API для экспорта TEX в PS
description: Преобразование TEX в PS без использования Microsoft Word
url: /ru/net/conversion/tex-to-ps/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг TEX в PS через .NET" h2=".NET API для экспорта TEX в PS в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования TEX в PS" %}}
