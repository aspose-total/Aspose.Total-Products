---
title: Конвертируйте FODS в POWERPOINT с помощью .NET 
description: Преобразование FODS в POWERPOINT на платформах .NET Framework, .NET Core, Mono или Xamarin.
url: /ru/net/conversion/fods-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте FODS в POWERPOINT через C#" h2="Экспорт Excel&reg; FODS в POWERPOINT на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование FODS в POWERPOINT на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования FODS в POWERPOINT" gistPath="" %}}
