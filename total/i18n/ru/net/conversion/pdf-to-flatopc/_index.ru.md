...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг PDF в FLATOPC через .NET" h2=".NET API для экспорта PDF в FLATOPC в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования PDF в FLATOPC" %}}
