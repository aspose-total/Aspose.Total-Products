---
title: C# API для экспорта SVG в GIF
description: Преобразование SVG в GIF без использования Microsoft Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг SVG в GIF через .NET" h2=".NET API для экспорта SVG в GIF в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования SVG в GIF" %}}
