---
title: Конвертируйте SXC в POWERPOINT с помощью .NET 
description: Преобразование SXC в POWERPOINT на платформах .NET Framework, .NET Core, Mono или Xamarin
url: /ru/net/conversion/sxc-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертируйте SXC в POWERPOINT через C#" h2="Экспорт Excel&reg; SXC в POWERPOINT на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование SXC в POWERPOINT на .NET" %}}
1. Откройте файл SXC, используя класс [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook).
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования SXC в POWERPOINT" gistPath="" %}}
