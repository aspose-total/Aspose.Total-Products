---
title: C# API для экспорта TEX в ODT
description: Преобразование TEX в ODT без использования Microsoft Word
url: /ru/net/conversion/tex-to-odt/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг TEX в ODT через .NET" h2=".NET API для экспорта TEX в ODT в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования TEX в ODT" %}}
