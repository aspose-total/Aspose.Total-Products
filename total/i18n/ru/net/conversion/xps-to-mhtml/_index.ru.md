---
title: C# API для экспорта XPS в MHTML
description: Преобразование XPS в MHTML без использования Microsoft Word
url: /ru/net/conversion/xps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг XPS в MHTML через .NET" h2=".NET API для экспорта XPS в MHTML в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования XPS в MHTML" %}}
