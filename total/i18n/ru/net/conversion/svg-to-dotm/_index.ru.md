...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг SVG в DOTM через .NET" h2=".NET API для экспорта SVG в DOTM в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования SVG в DOTM" %}}
...
4. Сохраните документ в формате DOTM с помощью метода [Сохранить](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Dotm как SaveFormat.
