...
description: Преобразование XLTX в PPTX на платформах .NET Framework, .NET Core, Mono или Xamarin.
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLTX в PPTX через C#" h2="Экспорт Excel&reg; XLTX в PPTX на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование XLTX в PPTX на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования XLTX в PPTX" gistPath="" %}}
