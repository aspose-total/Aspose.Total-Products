...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг XPS в DOCM через .NET" h2=".NET API для экспорта XPS в DOCM в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования XPS в DOCM" %}}
