---
title: Преобразование XLTX в DOCX с помощью .NET 
description: Преобразование XLTX в DOCX на платформах .NET Framework, .NET Core, Mono или Xamarin.
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLTX в DOCX через C#" h2="Экспорт Excel&reg; XLTX в DOCX на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования XLTX в DOCX" gistPath="" %}}
