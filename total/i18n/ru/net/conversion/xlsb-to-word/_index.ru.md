---
title: Преобразование XLSB в WORD с помощью .NET 
description: Преобразование XLSB в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin
url: /ru/net/conversion/xlsb-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLSB в WORD через C#" h2="Экспорт Excel&reg; XLSB в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование XLSB в WORD на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования XLSB в WORD" gistPath="" %}}
