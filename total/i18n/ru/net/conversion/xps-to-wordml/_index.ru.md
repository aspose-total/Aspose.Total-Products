---
title: C# API для экспорта XPS в WORDML
description: Преобразование XPS в WORDML без использования Microsoft Word
url: /ru/net/conversion/xps-to-wordml/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг XPS в WORDML через .NET" h2=".NET API для экспорта XPS в WORDML в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования XPS в WORDML" %}}
