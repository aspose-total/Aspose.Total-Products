...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг TEX в PCL через .NET" h2=".NET API для экспорта TEX в PCL в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования TEX в PCL" %}}
