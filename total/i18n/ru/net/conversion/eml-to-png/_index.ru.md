...
4. Сохраните документ в формате PNG с помощью метода [Сохранить](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Png в качестве формата сохранения.
