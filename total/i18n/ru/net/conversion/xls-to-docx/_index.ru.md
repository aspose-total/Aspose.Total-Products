---
title: Преобразование XLS в DOCX с помощью .NET 
description: Преобразование XLS в DOCX на платформах .NET Framework, .NET Core, Mono или Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLS в DOCX через C#" h2="Экспорт Excel&reg; XLS в DOCX на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование XLS в DOCX на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования XLS в DOCX" gistPath="" %}}
