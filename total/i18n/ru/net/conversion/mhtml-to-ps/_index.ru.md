---
title: C# API для экспорта MHTML в PS
description: Преобразование MHTML в PS без использования Microsoft Word
url: /ru/net/conversion/mhtml-to-ps/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг MHTML в PS через .NET" h2=".NET API для экспорта MHTML в PS в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования MHTML в PS" %}}
