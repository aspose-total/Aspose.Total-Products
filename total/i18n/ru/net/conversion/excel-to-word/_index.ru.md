...
description: Преобразование EXCEL в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать EXCEL в WORD через C#" h2="Экспорт Excel&reg; EXCEL в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование EXCEL в WORD на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования EXCEL в WORD" gistPath="" %}}
