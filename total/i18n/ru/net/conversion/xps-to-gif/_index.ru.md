---
title: C# API для экспорта XPS в GIF
description: Преобразование XPS в GIF без использования Microsoft Word
url: /ru/net/conversion/xps-to-gif/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг XPS в GIF через .NET" h2=".NET API для экспорта XPS в GIF в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования XPS в GIF" %}}
