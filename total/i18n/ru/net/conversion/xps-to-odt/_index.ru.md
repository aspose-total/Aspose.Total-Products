---
title: C# API для экспорта XPS в ODT
description: Преобразование XPS в ODT без использования Microsoft Word
url: /ru/net/conversion/xps-to-odt/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг XPS в ODT через .NET" h2=".NET API для экспорта XPS в ODT в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования XPS в ODT" %}}
