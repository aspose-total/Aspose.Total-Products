---
title: Преобразование XLTM в WORD с помощью .NET 
description: Преобразование XLTM в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin
url: /ru/net/conversion/xltm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLTM в WORD через C#" h2="Экспорт Excel&reg; XLTM в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование XLTM в WORD на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования XLTM в WORD" gistPath="" %}}
