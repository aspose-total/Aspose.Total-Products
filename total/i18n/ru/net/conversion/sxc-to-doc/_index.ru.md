---
title: Преобразование SXC в DOC с помощью .NET 
description: Преобразование SXC в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.
url: /ru/net/conversion/sxc-to-doc/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование SXC в DOC через C#" h2="Экспорт Excel&reg; SXC в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование SXC в DOC на .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Код .NET C# для преобразования SXC в DOC" gistPath="" %}}
