---
title: C# API для экспорта PDF в ODT
description: Преобразование PDF в ODT без использования Microsoft Word
url: /ru/net/conversion/pdf-to-odt/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг PDF в ODT через .NET" h2=".NET API для экспорта PDF в ODT в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования PDF в ODT" %}}
