...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг PDF в MARKDOWN через .NET" h2=".NET API для экспорта PDF в MARKDOWN в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования PDF в MARKDOWN" %}}
