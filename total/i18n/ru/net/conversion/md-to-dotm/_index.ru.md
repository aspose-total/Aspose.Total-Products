...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг MD в DOTM через .NET" h2=".NET API для экспорта MD в DOTM в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования MD в DOTM" %}}
