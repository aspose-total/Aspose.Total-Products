...
url: /zh/net/conversion/docm-to-json/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
1.使用[Docmument](https://apireference.aspose.com/words/net/aspose.words/docmument)类打开DOCM文件
2. 使用 [Save](https://apireference.aspose.com/words/net/aspose.words.docmument/save/methods/4) 方法将 DOCM 转换为 HTML
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/net/conversion/docm-to-csv/" name="DOCM 转 CSV" description="" >}}
