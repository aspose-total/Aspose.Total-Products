---
title: 使用 .NET 将 FODS 转换为 WORD 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 FODS 转换为 WORD
url: /zh/net/conversion/fods-to-word/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 FODS 转换为 WORD" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 FODS 到 WORD">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 FODS 到 WORD 转换" %}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 FODS 到 WORD 转换的 .NET C# 代码" gistPath="" %}}
