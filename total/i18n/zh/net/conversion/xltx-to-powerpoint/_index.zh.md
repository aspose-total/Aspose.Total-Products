...
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 XLTX 转换为 POWERPOINT
url: /zh/net/conversion/xltx-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLTX 转换为 POWERPOINT" h2="导出 Excel&reg; XLTX 到 .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 POWERPOINT">}}
