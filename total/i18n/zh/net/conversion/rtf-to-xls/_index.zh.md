---
title: .NET API 将 RTF 转换为 XLS
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 RTF 转换为 XLS 的 C# API
url: /zh/net/conversion/rtf-to-xls/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 RTF 转换为 XLS 的 C# API" h2="通过 C# 将 RTF 导出为 XLS，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
通过使用 [Aspose.Total for .NET](https://products.aspose.com/total/net/)，您可以在任何 .NET、C#、ASP.NET 和 VB.NET 应用程序中包含 RTF 到 XLS 的转换功能两个简单的步骤。首先，通过使用 [Aspose.Words for .NET](https://products.aspose.com/words/net/)，您可以将 RTF 导出为 HTML。之后，通过使用 [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) 电子表格编程 API，您可以将 HTML 转换为 XLS。
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API 将 RTF 转换为 XLS" %}}
1.使用[Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument)类打开RTF文件
2. 使用 [Save](https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods/4) 方法将 RTF 转换为 HTML
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) 还允许您通过流加载 RTF 文档。要从流中打开文档，只需将包含文档的流对象传递给 [Rtfument](https://apireference.aspose.com/words/net/aspose.words/rtfument) 构造函数。以下代码示例显示了如何从流中打开文档：  
{{% blocks/products/pf/feature-page-code %}}
...
在将 RTF 转换为 XLS 时，[Aspose.Cells for .NET](https://products.aspose.com/cells/net/) 允许您在 XLS 文档中添加自定义属性。为了添加自定义属性，您可以对 [CustomRtfumentPropertyCollection]( https://apireference.aspose.com/cells/net/aspose.cells.properties/customrtfumentpropertycollection）类。 Add 方法将属性添加到 Excel 文件，并以 [Aspose.Cells.Properties.RtfumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties) 的形式返回新文档属性的引用/rtfumentproperty) 对象。 
{{% blocks/products/pf/feature-page-code %}}
