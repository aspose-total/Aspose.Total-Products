---
title: 使用 .NET 将 XLTM 转换为 PPTX 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 XLTM 转换为 PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLTM 转换为 PPTX" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLTM 到 PPTX">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 XLTM 到 PPTX 转换" %}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 XLTM 到 PPTX 转换的 .NET C# 代码" gistPath="" %}}
