---
title: 通过 C# .NET 将 DOC 转换为 POTM 
url: /zh/net/conversion/doc-to-potm/ 
description: 使用 C# 将 Word doc 文档转换为 PowerPoint potm 文件。在 ASP.NET 或其他 .NET 应用程序中转换多个文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="使用 C# 将 DOC 转换为 POTM" h2="在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上构建 Microsoft Word DOC 到 PowerPoint POTM 转换应用程序。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 DOC 转换为 POTM" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 DOC 转换为 POTM 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Total 使开发人员只需几行代码即可轻松加载 DOC 文件并将其转换为 POTM。
...
{{% blocks/products/pf/agp/code-block title="此代码示例展示了如何使用 C# 将 DOC 转换为 POTM" offSpacer="" %}}
...
// 要转换多页 DOC 文档，请使用 Aspose.Words 分别将每个页面导出为 HTML，然后使用以下代码转换为 POTM。
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 DOC 转换为 POTM 的免费应用程序" sectionDescription="查看我们的 [DOC 到 POTM 转换](https://products.aspose.app/words/conversion/word-to-potm) 的现场演示，具有以下优势。" >}}
