---
title: 通过 C# .NET 将 POTX 转换为 TXT 
url: /zh/net/conversion/potx-to-txt/ 
description: 使用 C# 将 PowerPoint potx 文档转换为 Word txt 文件。在 ASP.NET 或其他 .NET 应用程序中转换多个文件。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="使用 C# 将 POTX 转换为 TXT" h2="在 .NET Framework、.NET Core、Windows Azure、Mono 或 Xamarin 平台上构建 Microsoft PowerPoint POTX 演示文稿到 Word TXT 文档转换应用程序。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TXT" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="POTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 POTX 转换为 TXT 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Total 使开发人员只需几行代码即可轻松加载 POTX 文件并将其转换为 TXT。
...
{{% blocks/products/pf/agp/code-block title="此代码示例展示了如何使用 C# 将 POTX 转换为 TXT" offSpacer="" %}}
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="将 POTX 转换为 TXT 的免费应用程序" sectionDescription="查看我们的 [POTX 到 TXT 转换](https://products.aspose.app/slides/conversion/) 的现场演示，具有以下优势。" >}}
