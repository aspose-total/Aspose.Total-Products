---
title: 使用 .NET 将 XLSX 转换为 POWERPOINT 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 XLSX 转换为 POWERPOINT
url: /zh/net/conversion/xlsx-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLSX 转换为 POWERPOINT" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLSX 到 POWERPOINT">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 XLSX 到 POWERPOINT 转换" %}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 XLSX 到 POWERPOINT 转换的 .NET C# 代码" gistPath="" %}}
