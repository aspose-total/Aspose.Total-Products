---
title: 使用 .NET 将 XLT 转换为 PPTX 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 XLT 转换为 PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLT 转换为 PPTX" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLT 到 PPTX">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 XLT 到 PPTX 转换" %}}
