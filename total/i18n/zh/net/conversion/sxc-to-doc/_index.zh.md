---
title: 使用 .NET 将 SXC 转换为 DOC 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 SXC 转换为 DOC
url: /zh/net/conversion/sxc-to-doc/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 SXC 转换为 DOC" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 SXC 到 DOC">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 SXC 到 DOC 转换" %}}
