---
title: 使用 .NET 将 EXCEL 转换为 WORD 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 EXCEL 转换为 WORD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 EXCEL 转换为 WORD" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 EXCEL 到 WORD">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 EXCEL 到 WORD 转换" %}}
1.使用[Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook)类打开EXCEL文件
2. 将EXCEL转为PDF并将SaveFormat设置为Auto
...
{{% blocks/products/pf/agp/code-autogen title="用于 EXCEL 到 WORD 转换的 .NET C# 代码" gistPath="" %}}
