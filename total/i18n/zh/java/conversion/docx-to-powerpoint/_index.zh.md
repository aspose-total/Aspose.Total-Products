...
该 API 还允许您将受密码保护的 DOCX 文档转换为 POWERPOINT。如果您输入的 DOCX 文档受密码保护，则您无法在不使用密码的情况下将其转换为 POWERPOINT 格式。为了打开加密文档，您可以在 LoadOptions 对象中设置正确的密码并将其传递给 Document 构造函数。  
{{% blocks/products/pf/feature-page-code %}}
