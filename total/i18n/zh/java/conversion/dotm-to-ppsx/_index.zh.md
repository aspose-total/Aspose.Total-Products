---
title: 通过 Java 将 DOTM 转换为 PPSX
description: 无需使用 Microsoft Word 或 PowerPoint 即可将 DOTM 导出为 PPSX 的 Java API
url: /zh/java/conversion/dotm-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 DOTM 转换为 PPSX" h2="通过在任何 Java J2SE、J2EE、J2ME 应用程序中使用本地 Java API 将 DOTM 转换为 PPSX，而无需使用 Microsoft<sup>&reg;</sup> PowerPoint 或 Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 将 DOTM 转换为 PPSX" %}}
...
对于 DOTM 到 PPSX 文件的转换，您可以直接从 [Maven] 轻松使用 Aspose.Total for Java (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) 基于项目并在 pom.xml 中包含库。
