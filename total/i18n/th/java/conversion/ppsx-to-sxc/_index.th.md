...
url: /th/java/conversion/ppsx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
ในการแปลง PPSX เป็น SXC คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ โครงการตาม aspose/aspose-total) และรวมไลบรารีใน pom.xml ของคุณ
