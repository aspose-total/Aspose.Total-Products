---
title: แปลง TXT เป็น POT ผ่าน Java
description: Java API เพื่อส่งออก TXT ไปยัง POT โดยไม่ต้องใช้ Microsoft Word หรือ PowerPoint
url: /th/java/conversion/txt-to-pot/
family: total
platformtag: net
feature: conversion
informat: TXT
...
สำหรับการแปลงไฟล์ TXT เป็น POT คุณสามารถใช้ Aspose.Total สำหรับ Java ได้โดยตรงจาก [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) ตามโครงการและรวมไลบรารีใน pom.xml ของคุณ
...
API ยังช่วยให้คุณแปลงเอกสาร TXT ที่ป้องกันด้วยรหัสผ่านเป็น POT หากเอกสาร TXT ที่คุณป้อนมีการป้องกันด้วยรหัสผ่าน คุณจะไม่สามารถแปลงเป็นรูปแบบ POT ได้โดยไม่ต้องใช้รหัสผ่าน ในการเปิดเอกสารที่เข้ารหัส คุณสามารถตั้งรหัสผ่านที่ถูกต้องในวัตถุ LoadOptions และส่งผ่านไปยังตัวสร้างเอกสาร  
{{% blocks/products/pf/feature-page-code %}}
