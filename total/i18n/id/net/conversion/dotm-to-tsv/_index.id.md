---
title: .NET API untuk Mengonversi DOTM ke TSV
description: C# API untuk Mengonversi DOTM ke TSV tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/net/conversion/dotm-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi DOTM ke TSV" h2="Ekspor DOTM ke TSV melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
