---
title: Konversi TEX ke TXT melalui C# API
description: C# API untuk Mengonversi File TEX ke TXT tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/net/conversion/tex-to-txt/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Merender TEX ke TXT" h2="Ekspor File TEX ke TXT melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Excel atau Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
Menggunakan [Aspose.Total for .NET](https://products.aspose.com/total/net/) Anda dapat dengan mudah mengonversi file TEX ke TXT dalam aplikasi .NET, C#, ASP.NET, dan VB.NET apa pun. Pertama, dengan menggunakan [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), Anda dapat mengekspor TEX ke XLSX. Setelah itu, dengan menggunakan [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, Anda dapat mengonversi XLSX ke TXT.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API untuk Mengonversi TEX ke TXT" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konversi TEX Terproteksi ke TXT melalui C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konversi File TEX ke TXT dengan Watermark melalui C#" %}}
Saat mengonversi file TEX ke TXT, Anda juga dapat menambahkan tanda air ke format file TXT keluaran Anda. Untuk menambahkan tanda air, Anda dapat membuat objek Buku Kerja baru dan membuka dokumen XLSX yang dikonversi, memilih Lembar Kerja melalui indeksnya, membuat Bentuk dan menggunakan fungsi AddTextEffect-nya. Setelah itu Anda dapat menyimpan dokumen XLSX Anda sebagai TXT dengan Watermark. 
{{% blocks/products/pf/feature-page-code %}}
