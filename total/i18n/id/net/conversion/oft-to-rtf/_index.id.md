---
title: C# API untuk Mengekspor OFT ke RTF
description: Konversi OFT ke RTF tanpa menggunakan Microsoft Word atau Outlook di .NET
url: /id/net/conversion/oft-to-rtf/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Ekspor OFT ke RTF melalui .NET" h2=".NET API untuk Merender OFT ke RTF di Windows, macOS, dan Linux tanpa menggunakan Word atau Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Jika Anda adalah pengembang .NET yang ingin menambahkan fitur konversi OFT ke RTF di dalam aplikasi Anda, [Aspose.Total for .NET](https://products.aspose.com/total/net/) API manipulasi format file adalah caranya maju. Dengan menggunakan [Aspose.Oft for .NET](https://products.aspose.com/oft/net/), Anda dapat mengonversi format file OFT ke HTML. Setelah itu, dengan menggunakan [Aspose.Words for .NET](https://products.aspose.com/words/net/), Anda dapat merender HTML ke RTF.
{{% /blocks/products/pf/feature-page-summary  %}}
