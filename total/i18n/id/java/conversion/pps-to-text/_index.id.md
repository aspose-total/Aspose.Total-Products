---
title: Konversi PPS ke TEXT melalui Java
description: Java API untuk Mengekspor PPS ke TEXT tanpa menggunakan Microsoft Word atau PowerPoint
url: /id/java/conversion/pps-to-text/
family: total
platformtag: net
feature: conversion
informat: PPS
...
Untuk konversi file PPS ke TEXT, Anda dapat dengan mudah menggunakan Aspose.Total untuk Java langsung dari [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) berdasarkan proyek dan sertakan perpustakaan di pom.xml Anda.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/id/net/conversion/pps-to-textm/" name="PPS Ke TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/id/net/conversion/pps-to-textx/" name="PPS Ke TEXTX" description="" >}}
