---
title: Java API untuk Merender TEX ke FODS
description: Ekspor TEX ke FODS melalui Java API tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/java/conversion/tex-to-fods/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Ekspor TEX ke FODS melalui Java" h2="Konversikan file TEX ke FODS dengan menggunakan Java API lokal dalam aplikasi Java J2SE, J2EE, J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi File TEX ke FODS melalui Java" %}}
