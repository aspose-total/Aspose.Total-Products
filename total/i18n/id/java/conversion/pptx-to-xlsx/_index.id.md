---
title: Konversi Format PPTX ke XLSX melalui Java
description: Konversi format PPTX ke XLSX melalui Java tanpa menggunakan Microsoft Excel atau PowerPoint
url: /id/java/conversion/pptx-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi PPTX ke XLSX melalui Java" h2="On Premise Java API untuk mengekspor PPTX ke XLSX tanpa menggunakan Microsoft<sup>&reg;</sup> Excel atau PowerPoint" >}}
{{% blocks/products/pf/feature-page-summary %}}
Anda dapat mengonversi file PPTX ke XLSX melalui [Aspose.Total for Java](https://products.aspose.com/total/java/) dalam dua langkah langkah. Pada langkah pertama Anda dapat mengekspor PPTX ke HTML dengan menggunakan [Aspose.Slides for Java](https://products.aspose.com/slides/java/). Kedua, dengan menggunakan [Aspose.Cells for Java](https://products.aspose.com/cells/java/), Anda dapat mengonversi HTML ke XLSX.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Cara Mengonversi PPTX ke XLSX melalui Java" %}}
...
Untuk mengonversi PPTX ke XLSX, Anda dapat dengan mudah menggunakan Aspose.Total untuk Java langsung dari [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ proyek berbasis aspose/aspose-total) dan sertakan perpustakaan di pom.xml Anda.
...
{{% blocks/products/pf/feature-page-section  h2="Konversikan PPTX Terproteksi ke XLSX melalui Java" %}}
Saat mengonversi file PPTX ke XLSX, Anda juga dapat menambahkan tanda air ke format file XLSX keluaran Anda. Untuk menambahkan tanda air, buat Buku Kerja baru untuk membuka file HTML yang dikonversi. Pilih Lembar Kerja melalui indeksnya, buat Bentuk dan gunakan fungsi addTextEffect, atur warna, transparansi, dan lainnya. Setelah itu Anda dapat menyimpan dokumen HTML Anda sebagai XLSX dengan Watermark. 
{{% blocks/products/pf/feature-page-code %}}
