---
title: Konvertálja a POTX-ot DOT-ba Java segítségével
description: Java API a POTX exportálásához DOT-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/potx-to-dot/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POTX-ot DOT-ba Java segítségével" h2="On Premise Java API a PowerPoint POTX-ból DOT konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a POTX-ot DOT-ba konvertálni Java-n keresztül" %}}
...
A POTX-ból DOT-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
