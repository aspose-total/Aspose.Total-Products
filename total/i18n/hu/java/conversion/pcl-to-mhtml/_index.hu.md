---
title: Java API a PCL exportálásához MHTML-be
description: Konvertálja a PCL-et MHTML-re a helyszíni Java API használatával
url: /hu/java/conversion/pcl-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="A PCL átalakítása MHTML-re Java segítségével" h2="On Premise Java API a PCL megjelenítéséhez MHTML-ben harmadik féltől származó alkalmazások használata nélkül" >}}
{{% blocks/products/pf/feature-page-summary %}}
Két egyszerű lépéssel a PCL-et MHTML-má konvertálhatja. Először is le kell renderelnie a PCL-fájlt DOC-ban az [Aspose.PDF for Java] használatával (https://products.aspose.com/pdf/java/). Ezt követően a hatékony dokumentumfeldolgozási API [Aspose.Words for Java] (https://products.aspose.com/words/java/) használatával a DOC-t MHTML-má konvertálhatja. Mindkét API az [Aspose.Total for Java](https://products.aspose.com/total/java/) csomagban található.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java API a PCL MHTML-má konvertálásához" %}}
