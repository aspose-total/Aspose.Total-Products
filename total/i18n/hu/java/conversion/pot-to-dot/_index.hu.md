---
title: Konvertálja a POT-ot DOT-ba Java segítségével
description: Java API a POT exportálásához DOT-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/pot-to-dot/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POT-ot DOT-ba Java segítségével" h2="On Premise Java API a PowerPoint POT-ból DOT konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a POT-ot DOT-ba konvertálni Java-n keresztül" %}}
...
A POT-ból DOT-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
