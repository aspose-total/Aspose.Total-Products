---
title: Java API a DOCM konvertálásához EXCEL-vé
description: A DOCM konvertálása EXCEL-vé Java segítségével Microsoft Word vagy Microsoft Excel használata nélkül
url: /hu/java/conversion/docm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="A DOCM konvertálása EXCEL-vé Java segítségével" h2="On Premise Java API a DOCM konvertálásához EXCEL-vé Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
{{% blocks/products/pf/feature-page-summary %}}
A DOCM konvertálása EXCEL-vé az [Aspose.Total for Java] segítségével (https://products.aspose.com/total/java/) egy egyszerű kétlépéses folyamat. A funkciókban gazdag, dokumentumkezelési és -konverziós API [Aspose.Words for Java](https://products.aspose.com/words/java/) használatával DOCM-t HTML-be exportálhat. Ezt követően az [Aspose.Cells for Java](https://products.aspose.com/cells/java/) használatával konvertálhatja a HTML-t EXCEL-vé.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ API a DOCM konvertálásához EXCEL-vé" %}}
