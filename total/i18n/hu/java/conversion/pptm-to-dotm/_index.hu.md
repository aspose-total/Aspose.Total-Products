---
title: Konvertálja a PPTM-ot DOTM-ba Java segítségével
description: Java API a PPTM exportálásához DOTM-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/pptm-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPTM-ot DOTM-ba Java segítségével" h2="On Premise Java API a PowerPoint PPTM-ból DOTM konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a PPTM-ot DOTM-ba konvertálni Java-n keresztül" %}}
...
A PPTM-ból DOTM-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
