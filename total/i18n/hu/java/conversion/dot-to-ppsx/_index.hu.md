---
title: A DOT konvertálása PPSX-re Java segítségével
description: Java API a DOT exportálásához PPSX-be Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/dot-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="A DOT konvertálása PPSX-re Java segítségével" h2="DOT konvertálása PPSX-be helyszíni Java API használatával bármely Java J2SE, J2EE, J2ME alkalmazáson belül Microsoft<sup>&reg;</sup> PowerPoint vagy Word használata nélkül" >}}
...
A DOT-fájl PPSX-vé konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
