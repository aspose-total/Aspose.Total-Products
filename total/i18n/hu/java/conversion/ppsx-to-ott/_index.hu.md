---
title: Konvertálja a PPSX-ot OTT-ba Java segítségével
description: Java API a PPSX exportálásához OTT-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/ppsx-to-ott/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPSX-ot OTT-ba Java segítségével" h2="On Premise Java API a PowerPoint PPSX-ból OTT konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hogyan lehet a PPSX-ot OTT-ba konvertálni Java-n keresztül" %}}
...
A PPSX-ból OTT-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
