---
title: Konvertálja a POTM-ot ODT-ba Java segítségével
description: Java API a POTM exportálásához ODT-ba Microsoft Word vagy PowerPoint használata nélkül
url: /hu/java/conversion/potm-to-odt/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a POTM-ot ODT-ba Java segítségével" h2="On Premise Java API a PowerPoint POTM-ból ODT konvertáláshoz bármely Java J2SE, J2EE, J2ME alkalmazáson belül" >}}
...
A POTM-ból ODT-fájlba konvertálásához egyszerűen használhatja az Aspose.Total for Java-t közvetlenül a [Maven]-ből (https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) alapú projektet, és vegyen fel könyvtárakat a pom.xml fájlba.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/potm-to-odtm/" name="POTM Nak nek ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/hu/net/conversion/potm-to-odtx/" name="POTM Nak nek ODTX" description="" >}}
