---
title: C# API a PCL exportálásához GIF-be
description: A PCL konvertálása GIF-re Microsoft Word használata nélkül
url: /hu/net/conversion/pcl-to-gif/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="PCL megjelenítése GIF-ben .NET-en keresztül" h2=".NET API a PCL exportálásához GIF-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PCL GIF-má konvertálásához" %}}
