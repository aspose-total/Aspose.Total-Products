---
title: C# API a CGM exportálásához DOT-be
description: A CGM konvertálása DOT-re Microsoft Word használata nélkül
url: /hu/net/conversion/cgm-to-dot/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="CGM megjelenítése DOT-ben .NET-en keresztül" h2=".NET API a CGM exportálásához DOT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a CGM DOT-má konvertálásához" %}}
