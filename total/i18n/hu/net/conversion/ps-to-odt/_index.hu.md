...
description: A PS konvertálása ODT-re Microsoft Word használata nélkül
url: /hu/net/conversion/ps-to-odt/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése ODT-ben .NET-en keresztül" h2=".NET API a PS exportálásához ODT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS ODT-má konvertálásához" %}}
