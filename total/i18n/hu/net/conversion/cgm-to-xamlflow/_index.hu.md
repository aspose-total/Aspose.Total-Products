...
description: A CGM konvertálása XAMLFLOW-re Microsoft Word használata nélkül
url: /hu/net/conversion/cgm-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="CGM megjelenítése XAMLFLOW-ben .NET-en keresztül" h2=".NET API a CGM exportálásához XAMLFLOW-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a CGM XAMLFLOW-má konvertálásához" %}}
