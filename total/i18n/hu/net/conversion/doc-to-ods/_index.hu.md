...
description: C# API a DOC konvertálásához ODS-vé Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/net/conversion/doc-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOC konvertálásához ODS-vé" h2="DOC exportálása ODS-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
