---
title: Konvertálja a PPS-ot XLSM-vé a C# segítségével
description: Konvertálja a PPS-ot XLSM-vé C#-ban Microsoft Excel vagy Powerpoint használata nélkül
url: /hu/net/conversion/pps-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertálja a PPS-ot XLSM-vé a C# segítségével" h2=".NET API a PPS-ból XLSM-vé konvertáláshoz Microsoft<sup>&reg;</sup> Excel vagy PowerPoint használata nélkül" >}}
