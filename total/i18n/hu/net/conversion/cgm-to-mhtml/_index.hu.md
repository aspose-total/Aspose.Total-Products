---
title: C# API a CGM exportálásához MHTML-be
description: A CGM konvertálása MHTML-re Microsoft Word használata nélkül
url: /hu/net/conversion/cgm-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="CGM megjelenítése MHTML-ben .NET-en keresztül" h2=".NET API a CGM exportálásához MHTML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a CGM MHTML-má konvertálásához" %}}
...
4. Mentse a dokumentumot MHTML-formátumba a [Mentés](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) metódussal, és állítsa be a Mhtml-et SaveFormat-ként.
