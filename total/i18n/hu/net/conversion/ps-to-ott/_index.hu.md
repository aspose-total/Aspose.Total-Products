---
title: C# API a PS exportálásához OTT-be
description: A PS konvertálása OTT-re Microsoft Word használata nélkül
url: /hu/net/conversion/ps-to-ott/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése OTT-ben .NET-en keresztül" h2=".NET API a PS exportálásához OTT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS OTT-má konvertálásához" %}}
