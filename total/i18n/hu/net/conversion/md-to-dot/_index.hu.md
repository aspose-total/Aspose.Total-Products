---
title: C# API a MD exportálásához DOT-be
description: A MD konvertálása DOT-re Microsoft Word használata nélkül
url: /hu/net/conversion/md-to-dot/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="MD megjelenítése DOT-ben .NET-en keresztül" h2=".NET API a MD exportálásához DOT-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a MD DOT-má konvertálásához" %}}
