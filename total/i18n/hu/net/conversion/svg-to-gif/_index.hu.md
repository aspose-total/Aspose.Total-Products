---
title: C# API a SVG exportálásához GIF-be
description: A SVG konvertálása GIF-re Microsoft Word használata nélkül
url: /hu/net/conversion/svg-to-gif/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="SVG megjelenítése GIF-ben .NET-en keresztül" h2=".NET API a SVG exportálásához GIF-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a SVG GIF-má konvertálásához" %}}
