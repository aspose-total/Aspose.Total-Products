---
title: C# API a PCL exportálásához DOCM-be
description: A PCL konvertálása DOCM-re Microsoft Word használata nélkül
url: /hu/net/conversion/pcl-to-docm/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="PCL megjelenítése DOCM-ben .NET-en keresztül" h2=".NET API a PCL exportálásához DOCM-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PCL DOCM-má konvertálásához" %}}
