---
title: C# API a MD exportálásához WORDML-be
description: A MD konvertálása WORDML-re Microsoft Word használata nélkül
url: /hu/net/conversion/md-to-wordml/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="MD megjelenítése WORDML-ben .NET-en keresztül" h2=".NET API a MD exportálásához WORDML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a MD WORDML-má konvertálásához" %}}
