---
title: C# API a SVG exportálásához FLATOPC-be
description: A SVG konvertálása FLATOPC-re Microsoft Word használata nélkül
url: /hu/net/conversion/svg-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a SVG FLATOPC-má konvertálásához" %}}
