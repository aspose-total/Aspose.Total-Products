---
title: .NET API a OTT konvertálásához XLSM-vé
description: C# API a OTT konvertálásához XLSM-vé Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/net/conversion/ott-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a OTT konvertálásához XLSM-vé" h2="OTT exportálása XLSM-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
