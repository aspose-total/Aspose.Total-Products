---
title: C# API a PDF exportálásához PS-be
description: A PDF konvertálása PS-re Microsoft Word használata nélkül
url: /hu/net/conversion/pdf-to-ps/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="PDF megjelenítése PS-ben .NET-en keresztül" h2=".NET API a PDF exportálásához PS-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PDF PS-má konvertálásához" %}}
