---
title: C# API a XPS exportálásához GIF-be
description: A XPS konvertálása GIF-re Microsoft Word használata nélkül
url: /hu/net/conversion/xps-to-gif/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése GIF-ben .NET-en keresztül" h2=".NET API a XPS exportálásához GIF-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS GIF-má konvertálásához" %}}
...
4. Mentse a dokumentumot GIF-formátumba a [Mentés](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) metódussal, és állítsa be a Gif-et SaveFormat-ként.
