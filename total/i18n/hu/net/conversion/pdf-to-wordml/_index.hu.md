---
title: C# API a PDF exportálásához WORDML-be
description: A PDF konvertálása WORDML-re Microsoft Word használata nélkül
url: /hu/net/conversion/pdf-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="PDF megjelenítése WORDML-ben .NET-en keresztül" h2=".NET API a PDF exportálásához WORDML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PDF WORDML-má konvertálásához" %}}
