---
title: .NET API a RTF konvertálásához DIF-vé
description: C# API a RTF konvertálásához DIF-vé Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/net/conversion/rtf-to-dif/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a RTF konvertálásához DIF-vé" h2="RTF exportálása DIF-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
