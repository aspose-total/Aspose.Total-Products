---
title: .NET API a DOTX konvertálásához DIF-vé
description: C# API a DOTX konvertálásához DIF-vé Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/net/conversion/dotx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a DOTX konvertálásához DIF-vé" h2="DOTX exportálása DIF-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
