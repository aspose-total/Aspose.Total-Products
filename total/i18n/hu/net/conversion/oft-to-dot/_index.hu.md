---
title: C# API az OFT DOT-be való exportálásához
description: Konvertálja az OFT-t DOT-vé Microsoft Word vagy Outlook használata nélkül a .NET-en
url: /hu/net/conversion/oft-to-dot/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exportálja az OFT-t DOT-be .NET-en keresztül" h2=".NET API az OFT DOT formátumban való megjelenítéséhez Windows, macOS és Linux rendszeren Word vagy Outlook használata nélkül" >}}

{{% blocks/products/pf/feature-page-summary %}}
Ha Ön .NET-fejlesztő, szeretné hozzáadni az OFT-t az alkalmazásokon belüli DOT-konverziós funkciókhoz, az [Aspose.Total for .NET](https://products.aspose.com/total/net/) fájlformátum-manipulációs API-k jelentik az utat. előre. Az [Aspose.Oft for .NET] (https://products.aspose.com/oft/net/) használatával konvertálhatja az OFT fájlformátumot HTML-re. Ezt követően az [Aspose.Words for .NET] (https://products.aspose.com/words/net/) használatával a HTML-t DOT-be renderelheti.
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Mentse a dokumentumot DOT formátumba a [Mentés](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) módszerrel, és állítsa be a Dot-t SaveFormat-ként.
