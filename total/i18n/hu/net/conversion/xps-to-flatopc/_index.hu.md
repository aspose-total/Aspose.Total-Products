---
title: C# API a XPS exportálásához FLATOPC-be
description: A XPS konvertálása FLATOPC-re Microsoft Word használata nélkül
url: /hu/net/conversion/xps-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése FLATOPC-ben .NET-en keresztül" h2=".NET API a XPS exportálásához FLATOPC-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS FLATOPC-má konvertálásához" %}}
