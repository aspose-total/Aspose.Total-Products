...
description: A XPS konvertálása PS-re Microsoft Word használata nélkül
url: /hu/net/conversion/xps-to-ps/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="XPS megjelenítése PS-ben .NET-en keresztül" h2=".NET API a XPS exportálásához PS-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a XPS PS-má konvertálásához" %}}
