---
title: C# API a TEX exportálásához MARKDOWN-be
description: A TEX konvertálása MARKDOWN-re Microsoft Word használata nélkül
url: /hu/net/conversion/tex-to-markdown/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="TEX megjelenítése MARKDOWN-ben .NET-en keresztül" h2=".NET API a TEX exportálásához MARKDOWN-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a TEX MARKDOWN-má konvertálásához" %}}
