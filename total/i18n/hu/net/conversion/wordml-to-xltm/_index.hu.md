---
title: .NET API a WORDML konvertálásához XLTM-vé
description: C# API a WORDML konvertálásához XLTM-vé Microsoft Excel vagy Adobe Reader használata nélkül
url: /hu/net/conversion/wordml-to-xltm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API a WORDML konvertálásához XLTM-vé" h2="WORDML exportálása XLTM-fájlba C#-on keresztül Microsoft<sup>&reg;</sup> Word vagy Microsoft<sup>&reg;</sup> Excel használata nélkül" >}}
