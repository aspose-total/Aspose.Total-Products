---
title: C# API a TEX exportálásához WORDML-be
description: A TEX konvertálása WORDML-re Microsoft Word használata nélkül
url: /hu/net/conversion/tex-to-wordml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="TEX megjelenítése WORDML-ben .NET-en keresztül" h2=".NET API a TEX exportálásához WORDML-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a TEX WORDML-má konvertálásához" %}}
