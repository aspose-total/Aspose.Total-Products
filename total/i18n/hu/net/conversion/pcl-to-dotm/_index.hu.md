---
title: C# API a PCL exportálásához DOTM-be
description: A PCL konvertálása DOTM-re Microsoft Word használata nélkül
url: /hu/net/conversion/pcl-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="PCL megjelenítése DOTM-ben .NET-en keresztül" h2=".NET API a PCL exportálásához DOTM-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PCL DOTM-má konvertálásához" %}}
1. Nyissa meg a PCL-fájlt a [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document) osztály használatával
2. Konvertálja a PCL-et dokumentummá a [Mentés](https://apireference.aspose.com/pdf/net/aspose.pdf.document/save/methods/5) módszerrel
