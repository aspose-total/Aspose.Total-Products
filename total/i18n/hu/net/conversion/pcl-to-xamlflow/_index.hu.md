---
title: C# API a PCL exportálásához XAMLFLOW-be
description: A PCL konvertálása XAMLFLOW-re Microsoft Word használata nélkül
url: /hu/net/conversion/pcl-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="PCL megjelenítése XAMLFLOW-ben .NET-en keresztül" h2=".NET API a PCL exportálásához XAMLFLOW-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PCL XAMLFLOW-má konvertálásához" %}}
