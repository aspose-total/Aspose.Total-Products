---
title: C# API a PS exportálásához RTF-be
description: A PS konvertálása RTF-re Microsoft Word használata nélkül
url: /hu/net/conversion/ps-to-rtf/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése RTF-ben .NET-en keresztül" h2=".NET API a PS exportálásához RTF-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS RTF-má konvertálásához" %}}
