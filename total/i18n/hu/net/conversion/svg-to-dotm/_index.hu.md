---
title: C# API a SVG exportálásához DOTM-be
description: A SVG konvertálása DOTM-re Microsoft Word használata nélkül
url: /hu/net/conversion/svg-to-dotm/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="SVG megjelenítése DOTM-ben .NET-en keresztül" h2=".NET API a SVG exportálásához DOTM-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a SVG DOTM-má konvertálásához" %}}
...
4. Mentse a dokumentumot DOTM-formátumba a [Mentés](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) metódussal, és állítsa be a Dotm-et SaveFormat-ként.
