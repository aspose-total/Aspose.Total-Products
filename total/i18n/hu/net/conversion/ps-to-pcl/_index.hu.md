---
title: C# API a PS exportálásához PCL-be
description: A PS konvertálása PCL-re Microsoft Word használata nélkül
url: /hu/net/conversion/ps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="PS megjelenítése PCL-ben .NET-en keresztül" h2=".NET API a PS exportálásához PCL-be Windows, macOS és Linux rendszeren Microsoft Word használata nélkül" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API a PS PCL-má konvertálásához" %}}
