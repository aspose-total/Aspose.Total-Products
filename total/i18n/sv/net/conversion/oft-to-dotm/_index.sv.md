---
title: C# API för att exportera OFT till DOTM
description: Konvertera OFT till DOTM utan att använda Microsoft Word eller Outlook på .NET
url: /sv/net/conversion/oft-to-dotm/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exportera OFT till DOTM via .NET" h2=".NET API för att rendera OFT till DOTM på Windows, macOS och Linux utan att använda Word eller Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Om du är en .NET-utvecklare som vill lägga till OFT till DOTM-konverteringsfunktioner i dina applikationer, är [Aspose.Total for .NET](https://products.aspose.com/total/net/) API:er för filformatsmanipulation vägen fram. Genom att använda [Aspose.Oft for .NET](https://products.aspose.com/oft/net/), kan du konvertera OFT-filformat till HTML. Efter det, genom att använda [Aspose.Words for .NET](https://products.aspose.com/words/net/), kan du rendera HTML till DOTM.
{{% /blocks/products/pf/feature-page-summary  %}}
