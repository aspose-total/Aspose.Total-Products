---
title: .NET API för att konvertera OTT till ODS
description: C# API för att konvertera OTT till ODS utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/ott-to-ods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera OTT till ODS" h2="Exportera OTT till ODS via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
Genom att använda [Aspose.Total för .NET](https://products.aspose.com/total/net/) kan du inkludera OTT till ODS-konverteringsfunktion i alla .NET-, C#-, ASP.NET- och VB.NET-applikationer i två enkla steg. För det första, genom att använda [Aspose.Words for .NET](https://products.aspose.com/words/net/), kan du exportera OTT till HTML. Efter det, genom att använda [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, kan du konvertera HTML till ODS.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API för att konvertera OTT till ODS" %}}
