---
title: C# API för att exportera MSG till WORD
description: Konvertera MSG till WORD utan att använda Microsoft Word eller Outlook på .NET
url: /sv/net/conversion/msg-to-word/
family: total
platformtag: net
feature: conversion
informat: MSG
...
4. Spara dokumentet i WORD-format med metoden [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) och ställ in Word som SaveFormat
