---
title: C# API för att exportera OFT till FLATOPC
description: Konvertera OFT till FLATOPC utan att använda Microsoft Word eller Outlook på .NET
url: /sv/net/conversion/oft-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: OFT
...
Om du är en .NET-utvecklare som vill lägga till OFT till FLATOPC-konverteringsfunktioner i dina applikationer, är [Aspose.Total for .NET](https://products.aspose.com/total/net/) API:er för filformatsmanipulation vägen fram. Genom att använda [Aspose.Oft for .NET](https://products.aspose.com/oft/net/), kan du konvertera OFT-filformat till HTML. Efter det, genom att använda [Aspose.Words for .NET](https://products.aspose.com/words/net/), kan du rendera HTML till FLATOPC.
{{% /blocks/products/pf/feature-page-summary  %}}
