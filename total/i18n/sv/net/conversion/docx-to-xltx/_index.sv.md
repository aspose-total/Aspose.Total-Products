...
description: C# API för att konvertera DOCX till XLTX utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/docx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera DOCX till XLTX" h2="Exportera DOCX till XLTX via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
