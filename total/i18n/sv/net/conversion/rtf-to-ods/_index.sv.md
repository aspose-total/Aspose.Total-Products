---
title: .NET API för att konvertera RTF till ODS
description: C# API för att konvertera RTF till ODS utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/rtf-to-ods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera RTF till ODS" h2="Exportera RTF till ODS via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
