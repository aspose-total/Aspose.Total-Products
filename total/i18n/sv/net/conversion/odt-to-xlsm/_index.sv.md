...
description: C# API för att konvertera ODT till XLSM utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/odt-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera ODT till XLSM" h2="Exportera ODT till XLSM via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
