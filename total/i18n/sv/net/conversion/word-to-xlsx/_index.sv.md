...
description: C# API för att konvertera WORD till XLSX utan att använda Microsoft Excel eller Adobe Reader
url: /sv/net/conversion/word-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API för att konvertera WORD till XLSX" h2="Exportera WORD till XLSX via C# utan att använda Microsoft<sup>&reg;</sup> Word eller Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API för att konvertera WORD till XLSX" %}}
