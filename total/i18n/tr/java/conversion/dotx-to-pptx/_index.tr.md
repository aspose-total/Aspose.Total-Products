---
title: Java ile DOTX'yi PPTX'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOTX'yi PPTX'ye Dışa Aktarmak için Java API
url: /tr/java/conversion/dotx-to-pptx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOTX'yi PPTX'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOTX'den PPTX'ye dönüştürme" >}}
...
API ayrıca parola korumalı DOTX belgelerini PPTX'ye dönüştürmenize olanak tanır. Girdiğiniz DOTX belgeniz parola korumalıysa, parolayı kullanmadan PPTX biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Dotxument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
