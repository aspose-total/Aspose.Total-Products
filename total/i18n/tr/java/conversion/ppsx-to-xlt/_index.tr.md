---
title: PPSX'u Java ile XLT Formatına Dönüştür
description: Microsoft Excel veya PowerPoint kullanmadan PPSX'u Java aracılığıyla XLT formatına dönüştürün
url: /tr/java/conversion/ppsx-to-xlt/
family: total
platformtag: net
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPSX'u XLT'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPSX'u XLT'ye aktarmak için Şirket İçi Java API'si" >}}
