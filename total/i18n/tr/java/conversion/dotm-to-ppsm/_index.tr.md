---
title: Java ile DOTM'yi PPSM'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOTM'yi PPSM'ye Dışa Aktarmak için Java API
url: /tr/java/conversion/dotm-to-ppsm/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOTM'yi PPSM'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOTM'den PPSM'ye dönüştürme" >}}
