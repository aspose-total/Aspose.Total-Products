...
API ayrıca parola korumalı DOCX belgelerini PPTX'ye dönüştürmenize olanak tanır. Girdiğiniz DOCX belgeniz parola korumalıysa, parolayı kullanmadan PPTX biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Docxument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
