...
description: Microsoft Excel veya PowerPoint kullanmadan POT'u Java aracılığıyla DIF formatına dönüştürün
url: /tr/java/conversion/pot-to-dif/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile POT'u DIF'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan POT'u DIF'ye aktarmak için Şirket İçi Java API'si" >}}
