---
title: PPS'u Java ile TSV Formatına Dönüştür
description: Microsoft Excel veya PowerPoint kullanmadan PPS'u Java aracılığıyla TSV formatına dönüştürün
url: /tr/java/conversion/pps-to-tsv/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile PPS'u TSV'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> Excel veya PowerPoint kullanmadan PPS'u TSV'ye aktarmak için Şirket İçi Java API'si" >}}
