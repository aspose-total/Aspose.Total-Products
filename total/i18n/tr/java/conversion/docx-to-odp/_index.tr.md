---
title: Java ile DOCX'yi ODP'ye dönüştürün
description: Microsoft Word veya PowerPoint kullanmadan DOCX'yi ODP'ye Dışa Aktarmak için Java API
url: /tr/java/conversion/docx-to-odp/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java ile DOCX'yi ODP'ye dönüştürün" h2="Microsoft<sup>&reg;</sup> PowerPoint veya Word kullanmadan herhangi bir Java J2SE, J2EE, J2ME uygulamasında şirket içi Java API kullanarak DOCX'den ODP'ye dönüştürme" >}}
...
2. [save](https://apireference.aspose.com/words/java/com.aspose.words/Docxument#save(java.lang.String,com.aspose.words.SaveOptions) kullanarak DOCX dosyasını HTML'ye dönüştürün )) yöntem
...
API ayrıca parola korumalı DOCX belgelerini ODP'ye dönüştürmenize olanak tanır. Girdiğiniz DOCX belgeniz parola korumalıysa, parolayı kullanmadan ODP biçimine dönüştüremezsiniz. Şifrelenmiş bir belgeyi açmak için LoadOptions nesnesinde doğru parolayı ayarlayabilir ve bunu Docxument yapıcısına iletebilirsiniz.  
{{% blocks/products/pf/feature-page-code %}}
