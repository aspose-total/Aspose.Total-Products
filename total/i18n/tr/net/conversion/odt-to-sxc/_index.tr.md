...
description: Microsoft Excel veya Adobe Reader kullanmadan ODT'yi SXC'ye dönüştürmek için C# API'si
url: /tr/net/conversion/odt-to-sxc/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="ODT'yi SXC'ye Dönüştürmek için C# API" h2="Microsoft<sup>&reg;</sup> Word veya Microsoft<sup>&reg;</sup> Excel kullanmadan ODT'yi C# aracılığıyla SXC'ye aktarın" >}}
