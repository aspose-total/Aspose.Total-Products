...
url: /tr/net/conversion/ps-to-pcl/
family: total
platformtag: net
feature: conversion
informat: PS
...
2. [Kaydet](https://apireference.aspose.com/pdf/net/aspose.pdf.document/save/methods/5) yöntemini kullanarak PS'yi Dokümana dönüştürün
...
4. [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) yöntemini kullanarak dokümanı PCL formatına kaydedin ve Pcl'i SaveFormat olarak ayarlayın
...
{{% blocks/products/pf/feature-page-section  h2=".NET aracılığıyla Sahip Parolasını kullanarak PS Dosyasının Şifresini Çözme" %}}
