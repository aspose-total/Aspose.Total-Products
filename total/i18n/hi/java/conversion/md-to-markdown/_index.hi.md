...
url: /hi/java/conversion/md-to-markdown/
family: total
platformtag: net
feature: conversion
informat: MD
...
आप दो सरल चरणों का उपयोग करके MD को MARKDOWN में परिवर्तित कर सकते हैं। सबसे पहले आपको [जावा के लिए Aspose.PDF](https://products.aspose.com/pdf/java/) का उपयोग करके DOC को MD फ़ाइल प्रस्तुत करनी होगी। उसके बाद, शक्तिशाली दस्तावेज़ संसाधन API [Aspose.Words for Java](https://products.aspose.com/words/java/) का उपयोग करके, आप DOC को MARKDOWN में बदल सकते हैं। दोनों एपीआई [Aspose.Total for Java](https://products.aspose.com/total/java/) पैकेज के तहत आते हैं।
{{% /blocks/products/pf/feature-page-summary  %}}
