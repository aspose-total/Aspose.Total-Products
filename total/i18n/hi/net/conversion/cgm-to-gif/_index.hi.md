...
description: Microsoft Word का उपयोग किए बिना CGM को GIF में बदलें
url: /hi/net/conversion/cgm-to-gif/
family: total
platformtag: net
feature: conversion
informat: CGM
...
4. [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) विधि का उपयोग करके दस्तावेज़ को GIF प्रारूप में सहेजें और Gif को SaveFormat के रूप में सेट करें
