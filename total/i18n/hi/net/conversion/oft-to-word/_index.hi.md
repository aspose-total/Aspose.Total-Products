...
description: .NET पर Microsoft Word या Outlook का उपयोग किए बिना OFT को WORD में बदलें
url: /hi/net/conversion/oft-to-word/
family: total
platformtag: net
feature: conversion
informat: OFT
...
यदि आप एक .NET डेवलपर हैं, जो अपने एप्लिकेशन के अंदर OFT को WORD रूपांतरण सुविधाओं में जोड़ना चाहते हैं, तो [Aspose.Total for .NET](https://products.aspose.com/total/net/) फ़ाइल प्रारूप में हेरफेर API एक तरीका है। आगे। [Aspose.Oft for .NET](https://products.aspose.com/oft/net/) का उपयोग करके, आप OFT फ़ाइल स्वरूप को HTML में बदल सकते हैं। उसके बाद, [Aspose.Words for .NET](https://products.aspose.com/words/net/) का उपयोग करके, आप HTML को WORD में रेंडर कर सकते हैं।
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) विधि का उपयोग करके दस्तावेज़ को WORD प्रारूप में सहेजें और Word को SaveFormat के रूप में सेट करें
...
{{% blocks/products/pf/feature-page-section  h2=".NET के माध्यम से WORD दस्तावेज़ संपादन प्रतिबंधित करें" %}}
दस्तावेज़ को OFT से WORD में सहेजते समय, आपको अपने आउटपुट दस्तावेज़ को सुरक्षित रखने की आवश्यकता हो सकती है। कभी-कभी आपको किसी दस्तावेज़ को संपादित करने की क्षमता को सीमित करना पड़ सकता है और इसके साथ केवल कुछ क्रियाओं की अनुमति देनी पड़ सकती है। यह अन्य लोगों को आपके दस्तावेज़ में संवेदनशील और गोपनीय जानकारी को संपादित करने से रोकने के लिए उपयोगी हो सकता है। [Aspose.Words for .NET](https://products.aspose.com/words/net/) API, आपको [ProtectionType](https://apireference.aspose. का उपयोग करके सामग्री को प्रतिबंधित करने के तरीके को नियंत्रित करने में सक्षम बनाता है। com/words/net/aspose.words/protectiontype) एन्यूमरेशन पैरामीटर। आप कोड की निम्नलिखित पंक्तियों का उपयोग करके अपने दस्तावेज़ को केवल-पढ़ने के लिए सेट कर सकते हैं। 
{{% blocks/products/pf/feature-page-code %}}
