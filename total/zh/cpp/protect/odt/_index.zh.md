---
title: 使用密码和 C++ 在线保护 ODT 文档
description: 在线 ODT 文件密码保护应用程序。C++ API 代码对 ODT 文档应用密码保护。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 C++ 在线保护 ODT 文档或设置密码" h2="开发功能强大的基于 C++ 的 ODT 文档保护实用应用程序。列出的是通过 C++ 将密码应用于 ODT 文档的代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="通过应用程序在线保护ODT密码" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 进行 ODT 密码保护" %}}
 
1. 通过 Document 类对象加载 ODT 文件
1. 调用 Protect() 方法
...
{{% blocks/products/pf/agp/code-block title="C++ 代码：ODT 文档密码保护" offSpacer="" %}}
...
<h2>通过 C++ 开发 ODT 密码保护应用程序</h2>

需要开发 ODT 密码保护应用程序或实用程序吗？借助 [Aspose.Words for C++](https://products.aspose.com/words/cpp/)（[Aspose.Total for C++](https://products.aspose.com/total/zh/cpp/) 的子 API），任何 C++ 开发人员都可以将上述 API 代码集成到其文档保护应用程序中。强大的 C++ 库允许编写任何文档密码保护解决方案来保护和锁定文件。此外，它还可以支持许多流行格式，包括 ODT 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于处理保护应用程序的 ODT 文件的 C++ 实用程序" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序保护 ODT 文档安全吗？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（如 Google Chrome、Firefox、Opera 或 Safari）来使用在线 ODT 文档保护器。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
