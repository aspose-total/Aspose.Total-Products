---
title: 在线或通过 C++ 分割 ODT 文件
description: 用于分割不同 ODT 文件的免费在线应用程序。ODT 文档的 C++ 分割器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter App 或使用 C++ 在线分割 ODT 文件" h2="开发强大的基于 C++ 的 ODT 文档分割器应用程序。通过应用程序在线自由分割文档（包括 ODT 文件）并即时下载。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用应用程序在线分割ODT文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C++ 分割 ODT 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ 代码：按页面拆分 ODT 文档" offSpacer="" %}}
...
<h2>使用 C++ 开发 ODT 文件分割器应用程序</h2>

需要开发 C++ 脚本或实用程序应用程序来轻松分割 ODT 文件吗？借助 [Aspose.Words for C++](https://products.aspose.com/words/cpp/)（[Aspose.Total for C++](https://products.aspose.com/total/zh/cpp/) 的子 API），任何 C++ 开发人员都可以集成上述 API 代码来编写分割器应用程序。强大的文档分割 C++ 库支持许多流行格式，包括 ODT 格式，例如 PDF、Word、Excel 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于 C++ 的 ODT 分割器库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用 C++ 可以轻松开发专业的 ODT 文件分割解决方案。使用 Aspose ODT 分离器 API 以 C++ 开发高级、独立于平台的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序拆分多个 ODT 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（如 Google Chrome、Firefox、Opera 或 Safari）来使用在线 ODT 文档分割器。</span>
                      </div>
                  </li>
