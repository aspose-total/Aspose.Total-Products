---
title: 将 POTM 转换为 TEXT 的 C++ API
description: 在 C++ 应用程序中将 POTM 导出为 TEXT
url: /zh/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="将 POTM 渲染为 TEXT 的 C++ API" h2="在 C++ 应用程序中将 POTM 导出为 TEXT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
