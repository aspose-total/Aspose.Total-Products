---
title: 通过 C++ 将 DOCX 转换为 PPTX
description: 在您的 C++ 应用程序中将 DOCX 导出为 PPTX，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/docx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="将 DOCX 转换为 PPTX 的 C++ API" h2="在您的 C++ 应用程序中将 DOCX 导出为 PPTX，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
