---
title: 通过 C++ 将 DOTX 转换为 POTM
description: 在您的 C++ 应用程序中将 DOTX 导出为 POTM，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/dotx-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="将 DOTX 转换为 POTM 的 C++ API" h2="在您的 C++ 应用程序中将 DOTX 导出为 POTM，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
