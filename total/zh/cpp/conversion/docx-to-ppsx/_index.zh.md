---
title: 通过 C++ 将 DOCX 转换为 PPSX
description: 在您的 C++ 应用程序中将 DOCX 导出为 PPSX，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/docx-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="将 DOCX 转换为 PPSX 的 C++ API" h2="在您的 C++ 应用程序中将 DOCX 导出为 PPSX，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
...
1.使用[Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)类参考打开DOCX文件
2. 使用 [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_stdbasicostream_saveoptions) 成员函数将 DOCX 转换为 HTML
