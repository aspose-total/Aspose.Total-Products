---
title: 将 POT 转换为 ODT 的 C++ API
description: 在 C++ 应用程序中将 POT 导出为 ODT
url: /zh/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="将 POT 渲染为 ODT 的 C++ API" h2="在 C++ 应用程序中将 POT 导出为 ODT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
