...
description: 在 C++ 中将 PPS 导出为 XLT，而不使用 Microsoft Excel 或 Powerpoint
url: /zh/cpp/conversion/pps-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 PPS 转换为 XLT" h2="通过 C++ 将 PPS 转换为 XLT 文件，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
