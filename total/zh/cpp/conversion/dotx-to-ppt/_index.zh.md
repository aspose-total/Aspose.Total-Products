---
title: 通过 C++ 将 DOTX 转换为 PPT
description: 在您的 C++ 应用程序中将 DOTX 导出为 PPT，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/dotx-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="将 DOTX 转换为 PPT 的 C++ API" h2="在您的 C++ 应用程序中将 DOTX 导出为 PPT，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
