---
title: 使用 C++ 将 SXC 转换为 DOC
description: 在 C++ 应用程序中将 SXC 转换为 DOC
url: /zh/cpp/conversion/sxc-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 SXC 转换为 DOC" h2="导出 Excel<sup>&reg;</sup>全功能 C++ 应用程序中的 SXC 到 DOC" >}}
