---
title: 将 PPSX 转换为 FLATOPC 的 C++ API
description: 在 C++ 应用程序中将 PPSX 导出为 FLATOPC
url: /zh/cpp/conversion/ppsx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="将 PPSX 渲染为 FLATOPC 的 C++ API" h2="在 C++ 应用程序中将 PPSX 导出为 FLATOPC，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/cpp/conversion/ppsx-to-flatopcx/" name="PPSX 至 FLATOPCX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/cpp/conversion/ppsx-to-flatopcm/" name="PPSX 至 FLATOPCM" description="" >}}
