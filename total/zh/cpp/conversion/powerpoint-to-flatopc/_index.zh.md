---
title: 将 POWERPOINT 转换为 FLATOPC 的 C++ API
description: 在 C++ 应用程序中将 POWERPOINT 导出为 FLATOPC
url: /zh/cpp/conversion/powerpoint-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="将 POWERPOINT 渲染为 FLATOPC 的 C++ API" h2="在 C++ 应用程序中将 POWERPOINT 导出为 FLATOPC，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
