---
title: 通过 C++ 将 POT 转换为 XLAM
description: 在 C++ 中将 POT 导出为 XLAM，而不使用 Microsoft Excel 或 Powerpoint
url: /zh/cpp/conversion/pot-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 POT 转换为 XLAM" h2="通过 C++ 将 POT 转换为 XLAM 文件，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 C++ 将 POT 转换为 XLAM" %}}
