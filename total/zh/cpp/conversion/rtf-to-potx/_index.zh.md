---
title: 通过 C++ 将 RTF 转换为 POTX
description: 在您的 C++ 应用程序中将 RTF 导出为 POTX，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/rtf-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="将 RTF 转换为 POTX 的 C++ API" h2="在您的 C++ 应用程序中将 RTF 导出为 POTX，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
