---
title: 使用 C++ 将 FODS 转换为 DOCX
description: 在 C++ 应用程序中将 FODS 转换为 DOCX
url: /zh/cpp/conversion/fods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 FODS 转换为 DOCX" h2="导出 Excel<sup>&reg;</sup>全功能 C++ 应用程序中的 FODS 到 DOCX" >}}
