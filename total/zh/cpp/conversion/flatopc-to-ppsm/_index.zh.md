---
title: 通过 C++ 将 FLATOPC 转换为 PPSM
description: 在您的 C++ 应用程序中将 FLATOPC 导出为 PPSM，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/flatopc-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="将 FLATOPC 转换为 PPSM 的 C++ API" h2="在您的 C++ 应用程序中将 FLATOPC 导出为 PPSM，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
...
1.使用[Flatopcument](https://reference.aspose.com/words/cpp/class/aspose.words.flatopcument)类参考打开FLATOPC文件
