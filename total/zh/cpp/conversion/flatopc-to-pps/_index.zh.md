---
title: 通过 C++ 将 FLATOPC 转换为 PPS
description: 在您的 C++ 应用程序中将 FLATOPC 导出为 PPS，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/flatopc-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="将 FLATOPC 转换为 PPS 的 C++ API" h2="在您的 C++ 应用程序中将 FLATOPC 导出为 PPS，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
