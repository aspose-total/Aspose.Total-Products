---
title: 通过 C++ 将 EMLX 导出为 WORDML
description: 无需使用 Microsoft Word 或 Outlook 即可将 EMLX 转换为 WORDML 的 C++ API
url: /zh/cpp/conversion/emlx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="将 EMLX 导出为 WORDML 的 C++ API" h2="在 C++ 应用程序中将 EMLX 转换为 WORDML，无需 Microsoft Word 或 Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
您是一名 C++ 开发人员，希望在您的应用程序中添加电子邮件转换功能吗？使用 [Aspose.Emlx for C++](https://products.aspose.com/emlx/cpp/)，您可以将 EMLX 文件格式转换为 HTML。之后，通过使用 [Aspose.Words for C++](https://products.aspose.com/words/cpp/) API，您可以将 HTML 导出为 WORDML。这两个 API 都属于 [Aspose.Total for C++](https://products.aspose.com/total/cpp/) 包。 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="将 EMLX 转换为 WORDML 的 C++ API" %}}
...
4. 使用 [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) 方法将文档保存为 WORDML 格式，并将 Wordml 设置为 SaveFormat
...
您不仅可以将 EMLX 转换为 WORDML，还可以阅读、操作和解析 EMLX 文档。您可以使用 [Aspose.Emlx for C++](https://products.aspose.com/emlx/cpp/) API 的 MapiMessage 类获取电子邮件的主题、地址、正文、收件人信息。例如，您可以使用 get_SenderEmlxAddress() 属性检查转换的特定发件人电子邮件。
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="限制 WORDML 文件格式编辑的 C++ API" %}}
在将文档从 EMLX 导出到 WORDML 时，您还可以在应用程序中添加文档保护功能。为您的文档添加保护是一个简单的过程，因为您需要做的就是将保护方法应用于您的文档。您可以将保护类型设置为只读以限制用户编辑文档。
{{% blocks/products/pf/feature-page-code %}}
