---
title: 将 PPTX 转换为 DOCM 的 C++ API
description: 在 C++ 应用程序中将 PPTX 导出为 DOCM
url: /zh/cpp/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="将 PPTX 渲染为 DOCM 的 C++ API" h2="在 C++ 应用程序中将 PPTX 导出为 DOCM，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
