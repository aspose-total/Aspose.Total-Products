---
title: 将 PPSX 转换为 WORD 的 C++ API
description: 在 C++ 应用程序中将 PPSX 导出为 WORD
url: /zh/cpp/conversion/ppsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="将 PPSX 渲染为 WORD 的 C++ API" h2="在 C++ 应用程序中将 PPSX 导出为 WORD，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
