---
title: 将 POTX 转换为 ODT 的 C++ API
description: 在 C++ 应用程序中将 POTX 导出为 ODT
url: /zh/cpp/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="将 POTX 渲染为 ODT 的 C++ API" h2="在 C++ 应用程序中将 POTX 导出为 ODT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
