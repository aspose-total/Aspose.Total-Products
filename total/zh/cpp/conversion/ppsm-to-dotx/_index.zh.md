---
title: 将 PPSM 转换为 DOTX 的 C++ API
description: 在 C++ 应用程序中将 PPSM 导出为 DOTX
url: /zh/cpp/conversion/ppsm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="将 PPSM 渲染为 DOTX 的 C++ API" h2="在 C++ 应用程序中将 PPSM 导出为 DOTX，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/cpp/conversion/ppsm-to-dotxm/" name="PPSM 至 DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/cpp/conversion/ppsm-to-dotxx/" name="PPSM 至 DOTXX" description="" >}}
