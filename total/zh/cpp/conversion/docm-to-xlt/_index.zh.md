...
description: 无需使用 Microsoft Word 或 Microsoft Excel 即可将 DOCM 转换为 XLT 的 C++ API 或在线 或在线。在集成代码之前快速测试免费的 POT 到 CSV 在线转换器。
...
{{< blocks/products/pf/feature-page-header h1="将 DOCM 转换为 XLT 的 C++ API 或在线" h2="通过 C++ 将 DOCM 导出为 XLT，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="将 DOCM 转换为 XLT 的 C++ API 或在线" %}}
