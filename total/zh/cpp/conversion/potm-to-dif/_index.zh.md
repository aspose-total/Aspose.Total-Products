---
title: 通过 C++ 将 POTM 转换为 DIF
description: 在 C++ 中将 POTM 导出为 DIF，而不使用 Microsoft Excel 或 Powerpoint
url: /zh/cpp/conversion/potm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 POTM 转换为 DIF" h2="通过 C++ 将 POTM 转换为 DIF 文件，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 C++ 将 POTM 转换为 DIF" %}}
