---
title: 将 PPTM 转换为 DOT 的 C++ API
description: 在 C++ 应用程序中将 PPTM 导出为 DOT
url: /zh/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="将 PPTM 渲染为 DOT 的 C++ API" h2="在 C++ 应用程序中将 PPTM 导出为 DOT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
