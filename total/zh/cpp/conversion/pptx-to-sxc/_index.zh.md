...
description: 在 C++ 中将 PPTX 导出为 SXC，而不使用 Microsoft Excel 或 Powerpoint
url: /zh/cpp/conversion/pptx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 PPTX 转换为 SXC" h2="通过 C++ 将 PPTX 转换为 SXC 文件，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
