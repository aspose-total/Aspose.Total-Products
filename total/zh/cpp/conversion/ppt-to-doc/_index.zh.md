---
title: 将 PPT 转换为 DOC 的 C++ API
description: 在 C++ 应用程序中将 PPT 导出为 DOC
url: /zh/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="将 PPT 渲染为 DOC 的 C++ API" h2="在 C++ 应用程序中将 PPT 导出为 DOC，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
