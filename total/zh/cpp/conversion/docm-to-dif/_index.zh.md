---
title: 在 C++ 中将 DOCM 转换为 DIF
description: 无需使用 Microsoft Word 或 Microsoft Excel 即可将 DOCM 转换为 DIF 的 C++ API
url: /zh/cpp/conversion/docm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="将 DOCM 转换为 DIF 的 C++ API" h2="通过 C++ 将 DOCM 导出为 DIF，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
