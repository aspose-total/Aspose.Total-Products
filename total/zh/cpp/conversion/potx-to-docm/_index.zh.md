---
title: 将 POTX 转换为 DOCM 的 C++ API
description: 在 C++ 应用程序中将 POTX 导出为 DOCM
url: /zh/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="将 POTX 渲染为 DOCM 的 C++ API" h2="在 C++ 应用程序中将 POTX 导出为 DOCM，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
...
3. 使用 [Docmument](https://reference.aspose.com/words/cpp/class/aspose.words.docmument) 类引用加载转换后的 HTML 文件
