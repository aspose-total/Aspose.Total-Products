---
title: 将 PPS 转换为 DOT 的 C++ API
description: 在 C++ 应用程序中将 PPS 导出为 DOT
url: /zh/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="将 PPS 渲染为 DOT 的 C++ API" h2="在 C++ 应用程序中将 PPS 导出为 DOT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
