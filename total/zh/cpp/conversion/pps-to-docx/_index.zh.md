---
title: 将 PPS 转换为 DOCX 的 C++ API
description: 在 C++ 应用程序中将 PPS 导出为 DOCX
url: /zh/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="将 PPS 渲染为 DOCX 的 C++ API" h2="在 C++ 应用程序中将 PPS 导出为 DOCX，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/cpp/conversion/pps-to-docxm/" name="PPS 至 DOCXM" description="" >}}
