---
title: 将 POTM 转换为 DOTM 的 C++ API
description: 在 C++ 应用程序中将 POTM 导出为 DOTM
url: /zh/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="将 POTM 渲染为 DOTM 的 C++ API" h2="在 C++ 应用程序中将 POTM 导出为 DOTM，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
