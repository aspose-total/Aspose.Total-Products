---
title: 在 C++ 中将 OTT 转换为 XLSX
description: 无需使用 Microsoft Word 或 Microsoft Excel 即可将 OTT 转换为 XLSX 的 C++ API
url: /zh/cpp/conversion/ott-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="将 OTT 转换为 XLSX 的 C++ API" h2="通过 C++ 将 OTT 导出为 XLSX，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
