...
description: 在 C++ 中将 POTM 导出为 MHTML，而不使用 Microsoft Excel 或 Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="通过 C++ 将 POTM 转换为 MHTML" h2="通过 C++ 将 POTM 转换为 MHTML 文件，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
