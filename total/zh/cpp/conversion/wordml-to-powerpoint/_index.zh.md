---
title: 通过 C++ 将 WORDML 转换为 POWERPOINT
description: 在您的 C++ 应用程序中将 WORDML 导出为 POWERPOINT，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/wordml-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="将 WORDML 转换为 POWERPOINT 的 C++ API" h2="在您的 C++ 应用程序中将 WORDML 导出为 POWERPOINT，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
