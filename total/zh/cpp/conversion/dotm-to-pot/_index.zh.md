---
title: 通过 C++ 将 DOTM 转换为 POT
description: 在您的 C++ 应用程序中将 DOTM 导出为 POT，而无需使用 Microsoft Word of PowerPoint
url: /zh/cpp/conversion/dotm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="将 DOTM 转换为 POT 的 C++ API" h2="在您的 C++ 应用程序中将 DOTM 导出为 POT，而无需使用 Microsoft Word&reg;或 PowerPoint" >}}
