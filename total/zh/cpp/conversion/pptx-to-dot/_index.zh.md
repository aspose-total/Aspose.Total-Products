---
title: 将 PPTX 转换为 DOT 的 C++ API
description: 在 C++ 应用程序中将 PPTX 导出为 DOT
url: /zh/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="将 PPTX 渲染为 DOT 的 C++ API" h2="在 C++ 应用程序中将 PPTX 导出为 DOT，无需任何 Microsoft PowerPoint 或 Word 依赖项" >}}
