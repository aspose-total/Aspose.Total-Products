---
title: 通过 Node.js API 进行 PDF 操作和 OCR 添加
description: Node.js API 用于操作 PDF 文件以及通过应用程序从图像中提取文本。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用于 PDF 和图像文本提取的 Node.js API" h2="从图像中提取文本以及在 Node.js 应用程序中包含 PDF 操作功能，无需任何其他软件依赖项" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ 是一组包罗万象的 Node.js 库。这些库提供的功能包括直接处理 PDF 以及增强将图像转换为文本的应用程序。

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ 包括以下 Node.js 库：" >}}
...
Aspose.PDF for Node.js via C++ 使您能够在后端处理 PDF 文件。利用它，您可以优化 PDF、合并和提取文本和图像，以及实施加密和解密过程。此外，该功能还扩展到轻松拆分和合并 PDF 文档的能力，为简化 PDF 文件操作提供了全面的工具包。
...
Aspose.OCR for Node.js via C++ 可以在 Node.js 兼容平台上从扫描页面和照片等图像中提取文本。通过强大的光学字符识别功能增强本地产品、Web 服务和无服务器应用程序，支持 28 种语言，包括流行格式的中文和印地语。
{{< /blocks/products/pf/total/product-item >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total 为其他平台提供个性化解决方案。" >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/zh/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/zh/nodejs-java/" 
