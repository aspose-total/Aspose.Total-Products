---
title: 在线或使用 Python 解锁 EXCEL 密码保护
description: 通过在线应用程序免费删除 EXCEL 文档的密码。用于解锁受密码保护的 EXCEL 文件的 Python API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 Python 从 EXCEL 文档中删除密码" h2="开发强大的基于 Python 的 EXCEL 文档锁定和解锁实用程序。列出用于通过 Python 从 EXCEL 文件中删除密码限制的代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过Python删除EXCEL密码" %}}

1. 直接从 PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/)) 引用项目内的 API。
1. 使用 Document 类加载受密码保护的 EXCEL 文件。
...
{{% blocks/products/pf/agp/code-block title="Python 中从 EXCEL 文档中删除密码的代码示例" offSpacer="" %}}
...
<h2>通过Python开发EXCEL保护管理应用程序</h2>

需要开发 EXCEL 保护管理应用程序或实用程序？借助 [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/)（[Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) 的子 API），任何 Python 开发人员都可以将上述 API 代码集成到其文档保护或取消保护应用程序中。强大的 Python 库允许对任何文档保护解决方案进行编程。而且它可以支持许多流行的格式，包括EXCEL格式。<br /><br />
