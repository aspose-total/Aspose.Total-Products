---
title: 使用 Python 将 XLS 转换为图像
description: XLS 到图像 TIFF BMP PNG JPEG GIF EMF SVG 在 Python 应用程序中的转换，无需使用 Microsoft Excel 
url: /zh/python-java/conversion/xls-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 XLS 转换为图像" h2="在您的 Python 应用程序中将 XLS 转换为 JPG、TIFF、BMP、PNG、GIF 图像，而无需安装 Microsoft Office<sup>&reg;</sup>。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何在 Python 中将 XLS 转换为图像" %}}

- 创建 [Workbook](https://reference.aspose.com/cells/python-java/asposecells.api/Workbook) 类对象以加载 XLS 文件
...
- 使用 [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)) 方法将工作表的所有页面保存为图像。 现在 XLS 文件被转换为指定路径的图像

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="转换要求" %}}

- 对于 XLS 到图像（JPG、PNG、GIF、BMP、TIFF）的转换，请直接从 PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/)) 引用项目内的 API
...
{{% blocks/products/pf/agp/code-block title="通过 Python 将 XLS 转换为图像" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLS 印象" description="" >}}
