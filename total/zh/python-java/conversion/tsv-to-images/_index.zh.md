---
title: 使用 Python 将 TSV 转换为图像
description: TSV 到图像 TIFF BMP PNG JPEG GIF EMF SVG 在 Python 应用程序中的转换，无需使用 Microsoft Excel 
url: /zh/python-java/conversion/tsv-to-images/
family: total
platformtag: Python
feature: conversion
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 TSV 转换为图像" h2="在您的 Python 应用程序中将 TSV 转换为 JPG、TIFF、BMP、PNG、GIF 图像，而无需安装 Microsoft Office<sup>&reg;</sup>。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何在 Python 中将 TSV 转换为图像" %}}

- 创建 [Workbook](https://reference.aspose.com/cells/python-java/asposecells.api/Workbook) 类对象以加载 TSV 文件
...
- 使用 [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)) 方法将工作表的所有页面保存为图像。 现在 TSV 文件被转换为指定路径的图像
...
{{% blocks/products/pf/agp/code-block title="通过 Python 将 TSV 转换为图像" offSpacer="" %}}
