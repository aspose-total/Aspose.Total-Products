---
title: 在线或使用 .NET 对 XLSX 文件进行数字签名
description: 用于 XLSX 电子表格中数字签名的免费在线应用程序。开发 C# .NET 应用程序以电子方式签署 XLSX 电子表格。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过电子签名应用程序或使用 .NET 对 XLSX 文件进行在线数字签名" h2="开发功能强大的基于 .NET 的 XLSX 文档签名应用程序。通过应用程序在线自由添加数字签名到各种文档，包括 XLSX 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 对 XLSX 文件进行数字签名" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：在 XLSX 文件中添加数字签名" offSpacer="" %}}
...
需要开发 .NET 脚本或实用程序应用程序来轻松对多个 XLSX 文件进行数字签名？ 借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)，任何 .NET 开发人员都可以集成上述 API 代码来编写 eSignature 应用程序，以便跨电子表格进行签名。用于电子表格签名的强大.NET 库，支持许多流行格式，包括 XLSX 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 XLSX 电子签名库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松地开发一种专业的解决方案，使用.NET 在 XLSX 文件中添加数字签名。使用 Aspose XLSX eSignature API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
