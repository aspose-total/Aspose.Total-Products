---
title: 在线或使用 .NET 对 ODT 文件进行数字签名
description: 用于 ODT 文件数字签名的免费在线应用程序。 开发 .NET 应用程序以电子方式签署 ODT 文档。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过电子签名应用程序或使用 .NET 对 ODT 文件进行在线数字签名" h2="开发功能强大的基于 .NET 的 ODT 文档签名应用程序。 通过应用程序在线自由添加数字签名到各种文档，包括 ODT 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 对 ODT 文件进行数字签名" %}}

1. 使用CertificateHolder类加载pfx证书
1. 使用 SignOptions 定义选项
1. 使用FileStream加载ODT文件
1. 使用 DigitalSignatureUtil 类对加载的文档进行签名

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 代码：在 ODT 文件中添加数字签名" offSpacer="" %}}
...
需要开发 .NET 脚本或实用程序应用程序来轻松对多个 ODT 文件进行数字签名？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)，任何 .NET 开发人员都可以集成上述 API 代码来编写 eSignature 应用程序以进行跨文档签名。强大的.NET文档签名库，支持许多流行的格式，包括ODT格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 ODT 电子签名库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松地开发一种专业的解决方案，使用.NET 在 ODT 文件中添加数字签名。 使用 Aspose ODT eSignature API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
