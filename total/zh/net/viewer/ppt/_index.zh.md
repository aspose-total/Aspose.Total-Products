---
title: 在线查看 PPT 文件并使用 .NET
description: 免费在线 PPT 文件查看器应用程序。用于查看查看器应用程序的 PPT 演示文稿的 .NET API C# 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 .NET 自由查看 PPT 文件" h2="开发功能强大的基于 .NET 的 PPT 演示文稿查看器实用程序。列出用于查看 PPT 演示文稿的 C# 代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="通过在线应用程序查看 PPT 演示文稿" %}}

1. 导入PPT文件上传即可查看。
1. 通过拖放查看器应用程序在放置区域内单击来完成此操作。
1. 根据 PPT 文件的大小和互联网速度，等待几秒钟。
1. 它将自动渲染并在浏览器中打开以供查看。
1. 如果是多页 PPT 文档，则在页面之间导航。
1. 设置页面视图放大或缩小。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 查看 PPT 演示文稿" %}}

1. 将 .NET 库引用添加到项目中
1. 使用Presentation类对象加载源PPT文件
1. 将文档另存为 HTML 文件
...
{{% blocks/products/pf/agp/code-block title="C# 代码：查看 PPT 演示文稿" offSpacer="" %}}
...
<h2>通过.NET 开发 PPT 文件查看器应用程序</h2>

需要开发 PPT 查看器应用程序或实用程序？通过 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档查看器应用程序中。强大的.NET 库允许对任何支持多种流行格式（包括 PPT 格式）的文档显示解决方案进行编程。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于处理显示应用程序的 PPT 文件的 .NET 实用程序" %}}

还有其他选项可以将 Aspose.Slides for .NET 或 Aspose.Total for .NET 安装到您的系统上。请选择符合您需求的一项并按照分步说明进行操作：<br /><br />
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码并使用它来开发基于 .NET 的文档查看器应用程序。此代码可以作为宝贵的资源来增强项目在后端文档处理领域的功能和能力，例如阅读幻灯片和加载显示应用程序的演示文稿。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序查看 PPT 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代 Web 浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）来进行在线 PPT 文档查看器。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
