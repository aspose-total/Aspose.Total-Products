---
title: 在线或通过 .NET 压缩 TSV 文件
description: 用于压缩不同 TSV 文件的免费在线应用程序。TSV 文档的.NET 压缩库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过压缩应用程序或使用.NET在线压缩TSV文件" h2="开发功能强大的基于 .NET 的 TSV 文档压缩应用程序。通过应用程序在线自由压缩包括 TSV 文件在内的各种文档，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET压缩TSV文件" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：压缩 TSV 文件" offSpacer="" %}}
...
<h2>使用.NET开发TSV文件压缩应用程序</h2>

需要开发 .NET 脚本或实用程序应用程序来轻松压缩多个 TSV 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/net/) 的子 API [Aspose.Cells for .NET](https://products.aspose.com/cells/net/)，任何 .NET 开发人员都可以将上述 API 代码集成到跨文档的压缩应用程序中。强大的.NET 文档压缩库支持许多流行的格式，包括 TSV 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="TSV 文件的 .NET 压缩库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用.NET 可以轻松开发专业的解决方案来压缩TSV 文件。使用 Aspose TSV 压缩 API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
