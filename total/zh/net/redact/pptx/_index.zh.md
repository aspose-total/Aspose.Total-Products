---
title: 在线编辑 PPTX 演示文稿或使用 .NET
description: 通过应用程序免费在线打开和编辑 PPTX 文档。用于搜索和替换 PPTX 文本的 .NET API C# 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 .NET 编辑 PPTX 文档" h2="开发功能强大的基于 .NET 的 PPTX 演示文稿编辑实用程序。列出用于搜索和替换 PPTX 文件中文本的 C# 代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="在线编辑 PPTX 演示文稿" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 编辑 PPTX 文件" %}}

1. 将库引用添加到 .NET 项目
1. 使用Presentation类加载PPTX文件
1. 遍历每张幻灯片，然后遍历框架
1. 使用替换方法
1. 保存 PPTX 文件
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="C# 代码：编辑 PPTX 演示文稿" offSpacer="" %}}
...
<h2>通过 .NET 开发 PPTX 修订应用程序</h2>

需要开发 PPTX 修订应用程序或实用程序？通过 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档编辑应用程序中。强大的 .NET 库允许对任何文档编辑解决方案进行编程。而且它可以支持许多流行的格式，包括PPTX格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于编辑 PPTX 文件的 .NET 实用程序" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📽️ PowerPoint文档中的红action（微软PowerPoint）

- 在企业展示中，删除内部财务数据或预测信息。
- 从商业提案文件或利益相关者更新中删除客户或合作伙伴姓名。
- 在产品路线图或发布说明中，删除战略内容。
- 在公开发布前，删除机密图片、图表或演讲笔记。
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序管理 PPTX 文档修订是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代 Web 浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 PPTX 文档编辑。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
