---
title: 在线编辑 XLS 电子表格或使用 .NET
description: 通过应用程序免费在线打开和编辑 XLS 文档。用于搜索和替换 XLS 文本的 .NET API C# 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 .NET 编辑 XLS 文档" h2="开发功能强大的基于 .NET 的 XLS 文档编辑实用程序。列出用于搜索和替换 XLS 文件中文本的 C# 代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="在线编辑 XLS 文档" %}}

1. 通过上传导入 XLS 文件。
1. 通过拖放注释应用程序在放置区域内单击来完成此操作。
1. 根据 XLS 文件的大小和互联网速度，等待几秒钟。
1. 输入要搜索和编辑的文本
1. 输入要编辑的替换文本
1. 按“编辑”按钮
1. 立即下载密文文件。
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 编辑 XLS 文件" %}}

1. 将库引用添加到 .NET 项目
1. 使用Workbook类加载XLS文件
1. 使用其索引获取相关工作表
1. 使用 FindOptions 类并设置选项
1. 使用Find方法查找相关文本
1. 迭代每个单元格并使用 PutValue 更新值
1. 或者使用 Replace 方法在整个工作簿中查找并替换
1. 保存 XLS 电子表格
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="C# 代码：编辑 XLS 电子表格" offSpacer="" %}}
...
<h2>通过 .NET 开发 XLS 修订应用程序</h2>

需要开发 XLS 修订应用程序或实用程序？通过 [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档编辑应用程序中。强大的 .NET 库允许对任何电子表格编辑解决方案进行编程。而且它可以支持许多流行的格式，包括XLS格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于编辑 XLS 文件的 .NET 实用程序" %}}

还有其他选项可以将 Aspose.Cells for .NET 或 Aspose.Total for .NET 安装到您的系统上。请选择符合您需求的一项并按照分步说明进行操作：<br /><br />
...
- 在Excel文件中进行红action，涉及财务值、预算线或薪酬细节的业务表格中进行操作。
- 对于人力资源或财务报告中的员工数据或审计结果进行红action。
- 对于共享的操作性文件中的客户或供应商信息进行红action。
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序管理 XLS 文档修订是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代 Web 浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 XLS 文档编辑。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
