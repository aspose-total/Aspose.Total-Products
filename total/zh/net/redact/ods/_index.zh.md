---
title: 在线编辑 ODS 电子表格或使用 .NET
description: 通过应用程序免费在线打开和编辑 ODS 文档。用于搜索和替换 ODS 文本的 .NET API C# 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 .NET 编辑 ODS 文档" h2="开发功能强大的基于 .NET 的 ODS 文档编辑实用程序。列出用于搜索和替换 ODS 文件中文本的 C# 代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 编辑 ODS 文件" %}}
...
<h2>通过 .NET 开发 ODS 修订应用程序</h2>

需要开发 ODS 修订应用程序或实用程序？通过 [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档编辑应用程序中。强大的 .NET 库允许对任何电子表格编辑解决方案进行编程。而且它可以支持许多流行的格式，包括ODS格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于编辑 ODS 文件的 .NET 实用程序" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📊 在 .ods (OpenDocument 表格文件) 中进行红色覆盖处理

- 对调查回应或统计数据在外部发布前进行红色覆盖处理。
- 对内部规划表格中的机密财务信息进行删除。
- 对共享数据集中用户可识别的信息进行删除。
