---
title: 在线删除 XLS 注释或通过 .NET 管理注释
description: 通过在线应用程序免费删除 XLS 文件中的注释。用于管理 XLS 文件注释的 .NET API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="清除来自 XLS 在线文档的注释或通过 .NET 管理" h2="开发功能强大的基于 .NET 的 XLS 文档注释实用程序。列出用于通过 .NET 管理 XLS 文件注释的代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="在线删除 XLS 注释" %}}

1. 导入XLS文件上传删除评论
1. 通过拖放注释应用程序在放置区域内单击来完成此操作
1. 根据 XLS 文件的大小和互联网速度等待几秒钟
1. 点击“删除”按钮清除评论
1. 立即下载文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 删除 XLS 注释" %}}

1. 将库引用添加到 .NET 项目
1. 通过 Workbook 类对象加载文档
1. 选择特定的工作表
1. 使用 Comments.RemoveAt 并将特定列作为索引
1. 调用Save方法保存文件
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：从 XLS 文件中删除注释" offSpacer="" %}}
...
<h2>通过.NET开发XLS文档注释应用程序</h2>

需要开发 XLS 注释应用程序或实用程序来提供反馈、提出建议或与其他人协作处理文档？通过 [Aspose.Cells for .NET](https://products.aspose.com/cells/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档注释应用程序中。强大的.NET 库允许对任何文档注释解决方案进行编程。而且它可以支持许多流行的格式，包括XLS格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于注释 XLS 文件的 .NET 库" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
EXCEL（电子表格二进制文件格式）在财务数据和商业报告中应用广泛。通过注释EXCEL文件，团队可以直接嵌入评论到数据集中，从而提供精准的反馈并促进协作分析。

#### 通过注释EXCEL文件增强财务报告 - 用途：

- **财务审计**：注释预算表以标记异常和合规问题。
- **利益相关方评审**：在季度报告中添加评论，以收集批准或反馈。
- **协作建模**：标记公式单元格以供审核或调整财务模型。
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序注释 XLS 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 XLS 文档注释。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
