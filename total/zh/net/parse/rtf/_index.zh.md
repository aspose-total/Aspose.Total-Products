---
title: 使用 .NET 在线从 RTF 文件中提取文本和图像
description: 在线 RTF 文件解析器应用程序。 .NET API C# 代码，用于从 RTF 文档中提取图像和文本内容。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线以及通过 .NET 解析 RTF 文件" h2="开发强大的基于 .NET 的 RTF 文档解析器实用程序。列出用于 RTF 文档文本提取的 C# 代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET解析RTF文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C#代码：RTF文档图像提取" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C#代码：RTF文档文本提取" offSpacer="" %}}
...
<h2>通过 .NET 开发 RTF 文件解析器应用程序</h2>

需要开发 RTF 解析器应用程序或软件？通过 [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档解析器应用程序中。强大的 .NET 库允许对任何文档解析解决方案进行编程以提取图像和文本。而且它可以支持许多流行的格式，包括RTF格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 实用程序为解析器应用程序处理 RTF 文件" %}}
...
- 📄 从富文本格式文件中提取格式化文本和基本图像。
- 🧾 将 `.rtf` 文档转换为纯文本或 HTML，以适用于网络使用。
- 📚 将遗留的 `.rtf` 文档迁移到现代内容系统中。
