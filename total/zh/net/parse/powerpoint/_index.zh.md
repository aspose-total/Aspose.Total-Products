---
title: 使用 .NET 在线从 Powerpoint 文件中提取文本和图像
description: 在线 Powerpoint 文件解析器应用程序。 .NET API C# 代码，用于从 Powerpoint 演示文稿中提取图像和文本。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线以及通过 .NET 解析 Powerpoint 文件" h2="开发功能强大的基于 .NET 的 Powerpoint 表示解析器应用程序。列出用于解析 Powerpoint 的 C# 代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="通过在线应用程序解析 Powerpoint 演示文稿" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 解析 Powerpoint 演示文稿" %}}

1. 将库引用添加到 .NET 项目
1. 使用Presentation类对象加载Powerpoint文件
1. 定义 ITextFrame[] 对象
1. 迭代框架和部分
1. 获取文本并打印或保存
...
{{% blocks/products/pf/agp/code-block title="C# 代码：Powerpoint 演示文稿文本提取" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 代码：Powerpoint 演示图像提取" offSpacer="" %}}
...
<h2>通过 .NET 开发 Powerpoint 表示解析器应用程序</h2>

需要开发 Powerpoint 解析器应用程序吗？通过 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档解析器应用程序中。强大的 .NET 库允许对任何文档解析解决方案进行编程以提取图像和文本。而且它可以支持许多流行的格式，包括Powerpoint格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 实用程序为解析器应用程序处理 Powerpoint 文件" %}}
