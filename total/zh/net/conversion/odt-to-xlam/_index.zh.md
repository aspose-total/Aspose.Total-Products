...
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 ODT 转换为 XLAM 的 C# API
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 ODT 转换为 XLAM 的 C# API" h2="通过 C# 将 ODT 导出为 XLAM，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
1.使用[Document](https://reference.aspose.com/words/net/aspose.words/document)类打开ODT文件
