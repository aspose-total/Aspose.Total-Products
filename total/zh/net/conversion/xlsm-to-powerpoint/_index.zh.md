...
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 XLSM 转换为 POWERPOINT
url: /zh/net/conversion/xlsm-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLSM 转换为 POWERPOINT" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLSM 到 POWERPOINT">}}
