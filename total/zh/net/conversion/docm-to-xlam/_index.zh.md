...
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 DOCM 转换为 XLAM 的 C# API
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 DOCM 转换为 XLAM 的 C# API" h2="通过 C# 将 DOCM 导出为 XLAM，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
