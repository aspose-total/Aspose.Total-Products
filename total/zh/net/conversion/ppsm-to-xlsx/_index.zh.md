---
title: 通过 C# 将 PPSM 转换为 XLSX 或在线
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 PPSM 转换为 XLSX 或在线" h2="用于 PPSM 到 XLSX 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
