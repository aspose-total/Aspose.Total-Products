---
title: 通过 C# 将 PPTM 转换为 MARKDOWN 或在线
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 PPTM 转换为 MARKDOWN 或在线" h2="用于 PPTM 到 MARKDOWN 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 C# 将 PPTM 转换为 MARKDOWN 或在线" %}}
