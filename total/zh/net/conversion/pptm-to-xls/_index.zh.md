---
title: 通过 C# 将 PPTM 转换为 XLS 或在线应用程序
description: 在 C# 中将 PPTM 转换为 XLS，而不使用 Microsoft Excel 或 Powerpoint 或在线。在集成代码之前快速测试免费的 PPTM 到 XLS 在线转换器。 或使用免费的在线转换器
url_ignore: /zh/net/conversion/pptm-to-xls/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 PPTM 转换为 XLS 或在线应用程序" h2="用于 PPTM 到 XLS 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">上面集成了用于 PPTM 转换的在线应用程序。要启动 PPTM 到 XLS 的转换过程，只需通过将 PPTM 文件拖放到指定区域或单击它以导入文档来添加 PPTM 文件。接下来，单击“转换”按钮。 PPTM 到 XLS 的转换完成后，您可以下载转换后的文件。只需单击一下，您就会收到输出的 XLS 文件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">当然！ PPTM 到 XLS 的转换完成后，您将可以立即访问转换后的 XLS 文件的下载链接。请注意，我们会在 24 小时后自动删除所有上传的文件，并且下载链接在此时间段后将不再有效。您的文件是完全安全和私密的，因为没有其他人可以访问它们。文件转换过程，包括 PPTM 转换，使用绝对安全。我们提供此免费应用程序主要用于测试目的，以便您可以在集成代码之前评估结果。</span>
                      </div>
                  </li>                 
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
