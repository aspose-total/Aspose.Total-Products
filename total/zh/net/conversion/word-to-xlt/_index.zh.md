---
title: .NET API 将 WORD 转换为 XLT
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 WORD 转换为 XLT 的 C# API
url: /zh/net/conversion/word-to-xlt/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 WORD 转换为 XLT 的 C# API" h2="通过 C# 将 WORD 导出为 XLT，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
