---
title: .NET API 将 WORDML 转换为 XLSX
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 WORDML 转换为 XLSX 的 C# API
url: /zh/net/conversion/wordml-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 WORDML 转换为 XLSX 的 C# API" h2="通过 C# 将 WORDML 导出为 XLSX，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
