---
title: 通过 C# 将 POTX 转换为 DIF 或在线应用程序
description: 在 C# 中将 POTX 转换为 DIF，而不使用 Microsoft Excel 或 Powerpoint 或在线。在集成代码之前快速测试免费的 POTX 到 DIF 在线转换器。 或使用免费的在线转换器
url_ignore: /zh/net/conversion/potx-to-dif/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 POTX 转换为 DIF 或在线应用程序" h2="用于 POTX 到 DIF 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
