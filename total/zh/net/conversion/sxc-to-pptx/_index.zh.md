...
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 SXC 转换为 PPTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 SXC 转换为 PPTX" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 SXC 到 PPTX">}}
