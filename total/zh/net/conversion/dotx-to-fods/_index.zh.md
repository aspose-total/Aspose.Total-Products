...
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 DOTX 转换为 FODS 的 C# API
url: /zh/net/conversion/dotx-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 DOTX 转换为 FODS 的 C# API" h2="通过 C# 将 DOTX 导出为 FODS，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
