...
<iframe title="免费在线 MHTML 至 PPT 转换应用程序" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppt&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="通过 C# .NET 将 MHTML 转换为 PPT" offSpacer="" %}}
