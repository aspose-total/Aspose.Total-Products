...
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上将 FODS 转换为 DOC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 FODS 转换为 DOC" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 FODS 到 DOC">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 FODS 到 DOC 转换" %}}
1. 使用 [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) 类打开 FODS 文件
...
{{% blocks/products/pf/agp/code-autogen title="用于 FODS 到 DOC 转换的 .NET C# 代码" gistPath="" %}}
