...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 XLSB 转换为 DOC 或在线应用程序" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLSB 到 DOC">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 XLSB 到 DOC 转换" %}}
1. 使用 [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook) 类打开 XLSB 文件
2. XLSB转换为PDF并将SaveFormat设置为Auto
...
{{% blocks/products/pf/agp/code-autogen title="用于 XLSB 到 DOC 转换的 .NET C# 代码" gistPath="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/net/conversion/xlsb-to-docx/" name="XLSB 转 DOCX" description="" >}}
