---
title: .NET API 将 DOCX 转换为 DIF
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 DOCX 转换为 DIF 的 C# API
url: /zh/net/conversion/docx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 DOCX 转换为 DIF 的 C# API" h2="通过 C# 将 DOCX 导出为 DIF，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
