...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通过 C# 将 SXC 转换为 DOCX 或在线应用程序" h2="导出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 SXC 到 DOCX">}}
{{< blocks/products/pf/main-container >}}

{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title=".NET 上的 SXC 到 DOCX 转换" %}}
...
{{% blocks/products/pf/agp/code-autogen title="用于 SXC 到 DOCX 转换的 .NET C# 代码" gistPath="" %}}
