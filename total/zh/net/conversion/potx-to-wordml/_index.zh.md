---
title: 通过 C# .NET 将 POTX 转换为 WORDML 
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 POTX 转换为 WORDML" %}}
...
{{% blocks/products/pf/agp/code-block title="此代码示例展示了如何使用 C# 将 POTX 转换为 WORDML" offSpacer="" %}}
