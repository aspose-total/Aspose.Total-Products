...
description: 在 C# 中将 POTX 转换为 MARKDOWN，而不使用 Microsoft Excel 或 Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 POTX 转换为 MARKDOWN" h2="用于 POTX 到 MARKDOWN 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
