---
title: .NET API 将 RTF 转换为 FODS
description: 无需使用 Microsoft Excel 或 Adobe Reader 即可将 RTF 转换为 FODS 的 C# API
...
{{< blocks/products/pf/i18n/feature-page-header h1="将 RTF 转换为 FODS 的 C# API" h2="通过 C# 将 RTF 导出为 FODS，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
1.使用[Document](https://apireference.aspose.com/words/net/aspose.words/Document)类打开RTF文件
2. 使用 [Save](https://apireference.aspose.com/words/net/aspose.words.Document/save/methods/4) 方法将 RTF 转换为 HTML
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) 还允许您通过流加载 RTF 文档。要从流中打开文档，只需将包含文档的流对象传递给 [Document](https://apireference.aspose.com/words/net/aspose.words/Document) 构造函数。以下代码示例显示了如何从流中打开文档：  
{{% blocks/products/pf/feature-page-code %}}
