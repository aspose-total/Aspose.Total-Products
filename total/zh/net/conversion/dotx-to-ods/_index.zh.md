...
{{< blocks/products/pf/i18n/feature-page-header h1="将 DOTX 转换为 ODS 的 C# API" h2="通过 C# 将 DOTX 导出为 ODS，无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
