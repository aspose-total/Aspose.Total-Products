---
title: 通过 C# 将 PPSM 转换为 MARKDOWN
description: 在 C# 中将 PPSM 转换为 MARKDOWN，而不使用 Microsoft Excel 或 Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 C# 将 PPSM 转换为 MARKDOWN" h2="用于 PPSM 到 MARKDOWN 转换的 .NET API，无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 C# 将 PPSM 转换为 MARKDOWN" %}}
...
4. 使用 [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) 方法将文档保存为 MARKDOWN
