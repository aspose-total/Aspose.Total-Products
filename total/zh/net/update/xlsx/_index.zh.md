...
description: 在不使用 Microsoft Excel 的情况下修改 C# VB.NET 应用程序中的 XLSX 文档。 
url: /zh/net/update/xlsx/
family: total
platformtag: .NET
feature: update
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="通过 .NET 更新 XLSX 文件" h2="通过基于 .NET 的应用程序修改 XLSX 电子表格，无需安装 Microsoft Office<sup>&reg;</sup>。" >}}

{{% blocks/products/pf/feature-page-summary %}}

对于开发人员，谁正在尝试通过 .NET 应用程序更新 XLSX 文件？ [Aspose.Total for .NET](https://products.aspose.com/total/net/) API 可以帮助自动化更新过程。 它是处理不同格式（包括 Microsoft Excel 文件）的各种 .NET API 的完整包。 [Aspose.Total for .NET](https://products.aspose.com/total/net/) 包中的 ASPOSE.CELL API 使这个修改过程变得容易。 以下是更新 XLSX 文档的过程。
...
- 创建以源 XLSX 文件为参数的新 [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) 类对象
...
- 通过将带有路径的文件作为参数传递，使用 save() 方法将文件保存为 .xlsx 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="修改要求" %}}

- 对于 XLSX 修改，Microsoft Windows 或具有 .NET、.NET Core、Mono 或 Xamarin 平台的兼容操作系统
...
{{% blocks/products/pf/agp/code-block title="代码 - 在 .NET 中更新 XLSX 文件" offSpacer="" %}}
