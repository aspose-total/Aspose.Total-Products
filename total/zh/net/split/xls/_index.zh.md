---
title: 在线或通过 .NET 分割 XLS 文件
description: 用于分割不同 XLS 工作表的免费在线应用程序。XLS 电子表格的 .NET C# 拆分器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter 应用程序或使用 .NET 在线分割 XLS 文件" h2="开发功能强大的基于 .NET 的 XLS 文档分割器应用程序。通过应用程序在线自由分割文档，包括 XLS 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET分割XLS文件" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：分割 XLS 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 XLS 文件分割器应用程序</h2>

需要开发 .NET 脚本或实用程序应用程序来轻松分割 XLS 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)，任何 .NET 开发人员都可以将上述 API 代码集成到分割器应用程序中。强大的.NET 文档分割库支持多种流行格式，包括 XLS 格式，如 PDF、Word、Excel 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 XLS 拆分器库" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
微软Excel电子表格文件格式（.xls）——分割用途

- 将旧版Excel电子表格分割以提高性能并简化编辑。  
- 分享财务或数据模型的部分内容给不同团队成员。
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松开发一种专业的解决方案来使用 .NET 分割 XLS 文件。使用 Aspose XLS splitter API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
