---
title: 在线或通过 .NET 分割 PPTX 文件
description: 用于分割不同 PPTX 文件的免费在线应用程序。 PPTX 文档的 .NET C# Splitter 库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter 应用程序或使用 .NET 在线分割 PPTX 文件" h2="开发功能强大的基于 .NET 的 PPTX 文档分割器应用程序。通过应用程序在线自由分割文档，包括 PPTX 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET分割PPTX文件" %}}
...
1. 最后将幻灯片保存到新的 PPTX 文件中

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 代码：分割 PPTX 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 PPTX 文件分割器应用程序</h2>

需要开发 .NET 脚本或实用程序应用程序来轻松分割 PPTX 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Slides for .NET](https://products.aspose.com/slides/zh/net/)，任何 .NET 开发人员都可以将上述 API 代码集成到分割器应用程序中。强大的 .NET 文档分割器库支持许多流行的格式，包括 PPTX 格式，如 PDF、Microsoft Word 文档、Excel 电子表格和 PowerPoint 演示文稿。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 PPTX 拆分器库" %}}
...
- 将现代PowerPoint演示拆分为更小的幻灯片组，实现模块化使用。  
- 通过将幻灯片组分配给不同编辑者，实现协作工作。
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用 .NET 可以轻松开发专业的解决方案来分割 PPTX 文件。使用 Aspose PPTX Splitter API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
