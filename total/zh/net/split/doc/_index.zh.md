---
title: 在线或通过 .NET 分割 DOC 文件
description: 用于分割不同 DOC 文件的免费在线应用程序。 DOC 文档的 .NET C# 拆分器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter 应用程序或使用 .NET 在线分割 DOC 文件" h2="开发功能强大的基于 .NET 的 DOC 文档分割器应用程序。 通过应用程序在线自由分割文档，包括 DOC 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET分割DOC文件" %}}

1. 使用 Document 类加载 DOC 文档。
1. 使用页数获取总页数。
1. 循环遍历每个页面并使用 ExtractPages 提取页面。
1. 将提取的页面保存到新的 DOC 文件中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 代码：按页拆分 DOC 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 DOC 文件分割器应用程序</h2>

需要开发 .NET 脚本或实用程序应用程序来轻松分割 DOC 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)，任何 .NET 开发人员都可以将上述 API 代码集成到分割器应用程序中。 强大的.NET 文档分割库支持多种流行格式，包括 DOC 格式，如 PDF、Word、Excel 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 DOC 拆分器库" %}}
...
- 管理较旧的Word文档，将大文件拆分成更易编辑的小部分。  
- 通过分发各个部分给团队成员协作于遗留文件。
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松开发一种专业的解决方案来使用 .NET 分割 DOC 文件。使用 Aspose DOC splitter API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
