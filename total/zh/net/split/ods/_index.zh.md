---
title: 在线或通过 .NET 分割 ODS 文件
description: 用于分割不同 ODS 工作表的免费在线应用程序。ODS 电子表格的 .NET C# 拆分器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter 应用程序或使用 .NET 在线分割 ODS 文件" h2="开发功能强大的基于 .NET 的 ODS 文档分割器应用程序。通过应用程序在线自由分割文档，包括 ODS 文件，并可即时下载。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用App在线分割ODS文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET分割ODS文件" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：分割 ODS 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 ODS 文件分割器应用程序</h2>

需要开发 .NET 脚本或实用程序应用程序来轻松分割 ODS 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)，任何 .NET 开发人员都可以将上述 API 代码集成到分割器应用程序中。强大的.NET 文档分割库支持多种流行格式，包括 ODS 格式，如 PDF、Word、Excel 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="适用于 .NET 的 ODS 拆分器库" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### .ods (OpenDocument Spreadsheet) — 分割用途
- 将大型.ods文件分割，以适用于如LibreOffice这样的开源电子表格应用程序。  
- 将数据集的不同部分分配给个别贡献者，以促进协作工作流程。
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松开发一种专业的解决方案来使用 .NET 分割 ODS 文件。使用 Aspose ODS splitter API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序分割多个 ODS 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）来进行在线 ODS 文档拆分器。</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>分割ODS文件需要多长时间？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
