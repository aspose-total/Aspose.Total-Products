---
title: 使用密码和.NET 在线保护 ODT 文档
description: 在线ODT文件密码保护应用程序。对 ODT 文档应用密码保护的 C# .NET API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线 ODT 文档保护或通过 .NET 设置密码" h2="开发强大的基于 .NET 的 ODT 文档保护实用程序。列出用于通过 .NET 将密码应用到 ODT 文档的代码。" >}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：ODT 文档密码保护" offSpacer="" %}}
...
<h2>通过.NET开发ODT密码保护应用程序</h2>

需要开发 ODT 密码保护应用程序或实用程序？通过 [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档保护应用程序中。强大的 .NET 库允许对任何文档密码保护解决方案进行编程以保护和锁定文件。而且它可以支持许多流行的格式，包括ODT格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 实用程序处理 ODT 文件以保护应用程序" %}}
