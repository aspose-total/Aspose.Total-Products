---
title: 使用密码和.NET 在线保护 Word 文档
description: 在线Word文件密码保护应用程序。对 Word 文档应用密码保护的 C# .NET API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线 Word 文档保护或通过 .NET 设置密码" h2="开发强大的基于 .NET 的 Word 文档保护实用程序。列出用于通过 .NET 将密码应用到 Word 文档的代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="通过应用程序进行在线 Word 密码保护" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：Word 文档密码保护" offSpacer="" %}}
...
<h2>通过.NET开发Word密码保护应用程序</h2>

需要开发 Word 密码保护应用程序或实用程序？通过 [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档保护应用程序中。强大的 .NET 库允许对任何文档密码保护解决方案进行编程以保护和锁定文件。而且它可以支持许多流行的格式，包括Word格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 实用程序处理 Word 文件以保护应用程序" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序来保护 Word 文档安全吗？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）作为在线 Word 文档保护器。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
