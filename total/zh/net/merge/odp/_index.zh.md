---
title: 在线或使用 .NET 合并 ODP 文件
description: 免费在线应用程序可组合不同的 ODP 演示文稿。C# .NET 合并库代码可将 ODP 演示文稿合并为您选择的格式。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过合并应用程序或使用 .NET 在线合并 ODP 文档" h2="开发功能强大的基于 .NET 的 ODP 文档合并应用程序。通过应用程序免费在线将多个 ODP 文档合并为一个文档。将合并的 ODP 文件保存为 PDF、图像、Word、Excel、PowerPoint 和许多其他在线格式。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用应用程序在线合并 ODP 文件" %}}

1. 上传 ODP 文件，将它们合并为一个
1. 输入参数，例如从下拉列表中选择
1. 保存为所需格式：PPTX、PDF、DOCX、DOC、XLSX、图像、HTML 等
1. 单击“合并”按钮将 ODP 合并为所需格式
1. 下载合并后的ODP文件
1. 查看并获取单个合并的 ODP 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="通过.NET合并ODP文件" %}}

1. 使用Presentation类对象加载ODP
1. 选择一个演示文稿作为基础文件
1. 循环浏览其他幻灯片的每张幻灯片
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：合并 ODP 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 ODP 文件合并器</h2>

需要开发 .NET 合并实用程序应用程序来轻松合并多个 ODP 文件吗？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Slides for .NET](https://products.aspose.com/slides/zh/net/)，任何 .NET 开发人员都可以集成上述 API 代码来轻松连接文档。用于合并文档的强大 .NET 库支持许多流行格式，包括 ODP 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODP 文件的 .NET 合并库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松地开发出一种专业的解决方案来使用 .NET 组合 ODP。使用 ODP 合并 API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序合并多个 ODP 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 ODP 文档合并。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>如何合并多个 ODP 文件？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">首先上传一个或多个要合并的文件。您可以拖放 ODP 文件或只需在白色区域内单击。之后，单击“合并”按钮，我们的合并器将快速处理上传的文件。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>合并 ODP 文件需要多长时间？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
