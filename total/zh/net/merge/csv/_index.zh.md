---
title: 在线或使用 .NET 合并 CSV 文件
description: 用于组合不同 CSV 文件的免费在线应用程序。C# .NET 合并库代码可将 CSV 工作表合并为其他格式。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过合并应用程序或使用 .NET 在线合并 CSV 文档" h2="开发功能强大的基于 .NET 的 CSV 文档合并应用程序。通过应用程序免费在线将多个 CSV 文档合并为一个文档。将合并的 CSV 文件保存为 PDF、图像、Word、Excel、PowerPoint 和许多其他在线格式。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用应用程序在线合并 CSV 文件" %}}

1. 上传 CSV 文件，将它们合并为一个
1. 输入参数，例如从下拉列表中选择
1. 保存为所需格式：XLSX、PPTX、PDF、DOCX、DOC、图像、HTML 等
1. 单击“合并”按钮将 CSV 合并为所需格式
1. 下载合并后的CSV文件
1. 查看并获取单个合并的 CSV 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="通过.NET合并CSV文件" %}}

1. 使用 Workbook 类对象加载两个 CSV。
1. 选择一个工作簿作为基础文件。
1. 使用组合方法，使用基本对象和第二个 CSV 文件对象作为参数。
1. 调用Save方法将合并后的CSV文件合并为一个。
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：合并 CSV 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 CSV 文件合并器</h2>

需要开发 .NET 实用应用程序来轻松合并多个 CSV 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API [Aspose.Cells for .NET](https://products.aspose.com/cells/zh/net/)，任何 .NET 开发人员都可以集成上述 API 代码来轻松连接文档。用于合并文档的强大 .NET 库支持许多流行格式，包括 CSV 格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="CSV 文件的 .NET 合并库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以使用.NET开发专业的解决方案来组合CSV。使用 CSV 合并 API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序合并多个 CSV 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 CSV 文档合并。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>如何合并多个 CSV 文件？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">首先上传一个或多个要合并的文件。您可以拖放 CSV 文件或只需在白色区域内单击。之后，单击“合并”按钮，我们的合并器将快速处理上传的文件。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>合并 CSV 文件需要多长时间？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
