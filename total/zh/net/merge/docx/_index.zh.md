---
title: 在线或使用 .NET 合并 DOCX 文件
description: 用于组合不同 DOCX 文件的免费在线应用程序。.NET 合并库代码用于合并 DOCX 文档。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过合并应用程序或使用 .NET 在线合并 DOCX 文档" h2="开发功能强大的基于 .NET 的 DOCX 文档合并应用程序。通过应用程序免费在线将多个 DOCX 文档合并为一个文档。将 DOCX 文件保存为 PDF、图像、Word、Excel、PowerPoint 和许多其他在线格式。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用应用程序在线合并 DOCX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过.NET合并DOCX文件" %}}

1. 创建文档类对象
1. 将两个文档加载到两个单独的 Document 类对象中
1. 使用 AppendDocument 函数合并文档
1. 调用Save方法将合并后的DOCX文件合并为一个
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：合并 DOCX 文件" offSpacer="" %}}
...
<h2>使用 .NET 开发 DOCX 文件合并器</h2>

需要开发 .NET 实用应用程序来轻松合并多个 DOCX 文件？借助 [Aspose.Total for .NET](https://products.aspose.com/total/net/) 的 [Aspose.Words for .NET](https://products.aspose.com/words/net/) 子 API，任何 .NET 开发人员都可以集成上述 API 代码来编写跨文档的合并应用程序。用于合并文档的强大 .NET 库支持许多流行格式，包括 DOCX 格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX 文件的 .NET 合并库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松地开发出一种专业的解决方案来使用 .NET 组合 DOCX。使用 Aspose DOCX 合并 API 在 .NET 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
