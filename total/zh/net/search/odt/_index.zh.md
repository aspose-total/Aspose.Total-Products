...
{{< blocks/products/pf/feature-page-header h1="在线可搜索文档应用程序和 ODT 文本搜索 API 代码" h2="开发功能强大的基于 .NET 的 ODT 文档搜索引擎软件或实用应用程序。 免费测试在线文档文本查找器应用程序。" >}}
...
<h2>通过.NET开发ODT文件搜索引擎</h2>

需要开发 ODT 可搜索软件或实用程序？ 借助 Aspose.Words for .NET（Aspose.Total for .NET 的子 API），任何开发人员都可以集成上述 API C# 代码来编写跨文档的文本搜索程序。 强大的C#库允许编程文档搜索软件解决方案，该解决方案可以支持许多流行的格式，包括ODT格式。<br /><br />
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代 Web 浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 ODT 文档搜索。 但是，如果您正在开发桌面应用程序，建议使用 Aspose.Total Document Search API 以实现平稳高效的处理。</span>
                      </div>
                  </li>
              </ul>
          </div>
