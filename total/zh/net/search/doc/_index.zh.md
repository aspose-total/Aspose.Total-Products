---
title: 在线 DOC 文件文本查找器或通过 C# 构建 DOC 搜索软件
description: 用于搜索 DOC 文件的免费在线应用程序。 适用于任何 DOC 文件文本搜索应用程序的 C# API 代码。
...
{{< blocks/products/pf/feature-page-header h1="在线可搜索文档应用程序和 DOC 文本搜索 API 代码" h2="开发功能强大的基于 .NET 的 DOC 文档搜索引擎软件或实用应用程序。 免费测试在线文档文本查找器应用程序。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何使用App在线搜索DOC文件" %}}

1. 通过在放置区域内单击或通过拖放上传 DOC 文件以进行搜索。
1. 通过指定参数输入搜索条件。 
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过C#搜索DOC文件" %}}

1. 安装“Aspose.Words for .NET”。
1. 将库引用（导入库）添加到您的 C# 项目。
1. 使用 Document 类打开源 DOC 文件。
1. 使用 Range.Replace 函数查找和替换文本。
1. 或者在 Regex 中设置搜索条件并将其作为 Replace 方法中的参数传递。
1. 调用“Save()”方法来保存传递输出文件名的文档。
...
{{% blocks/products/pf/agp/code-block title="用于在 DOC 文件中搜索文本的 C# 代码示例" offSpacer="" %}}
...
<h2>通过.NET开发DOC文件搜索引擎</h2>

需要开发 DOC 可搜索软件或实用程序？ 借助 Aspose.Words for .NET（Aspose.Total for .NET 的子 API），任何开发人员都可以集成上述 API C# 代码来编写跨文档的文本搜索程序。 强大的C#库允许编程文档搜索软件解决方案，该解决方案可以支持许多流行的格式，包括DOC格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于搜索 DOC 文件的 C# 库" %}}
There are three alternative options to install "Aspose.Words for .NET" or "Aspose.Total for .NET" onto your system. 请选择符合您需求的一项并按照分步说明进行操作：<br /><br />
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序 DOC 文档搜索安全吗？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代 Web 浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 DOC 文档搜索。 但是，如果您正在开发桌面应用程序，建议使用 Aspose.Total Document Search API 以实现平稳高效的处理。</span>
                      </div>
                  </li>
              </ul>
          </div>
