---
title: 在线查看和更新 DOCX 属性或使用 .NET 更新元数据
description: 通过在线应用程序免费查看和修改 DOCX 属性。用于更新 DOCX 属性的 C# .NET API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线查看或更新 DOCX 元数据或通过 .NET 更新" h2="开发功能强大的基于 .NET 的 DOCX 文档元数据管理实用程序。列出用于通过 .NET 更新 DOCX 文件元数据的代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 更新 DOCX 属性" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：更新 DOCX 元数据" offSpacer="" %}}
...
<h2>通过.NET 开发 DOCX 元数据管理应用程序</h2>

需要开发 DOCX 元数据管理应用程序或实用程序？通过 [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档元数据应用程序中。强大的.NET 库允许对任何文档元数据解决方案进行编程。而且它可以支持许多流行的格式，包括DOCX格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于管理 DOCX 元数据的 .NET 实用程序" %}}
