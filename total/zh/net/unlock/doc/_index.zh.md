---
title: 在线或使用 .NET 删除 DOC 密码保护
description: 通过在线应用程序免费解锁 DOC 文档的密码。用于从 DOC 文件中删除密码的 .NET C# API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 .NET 解锁 DOC 文档密码" h2="开发功能强大的基于 .NET 的 DOC 文档解锁实用应用程序。列出用于通过 .NET 从 DOC 文件中删除密码限制的代码。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="在线解锁DOC密码" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 .NET 删除 DOC 密码" %}}

1. 使用 Document 类加载受密码保护的 DOC 文件
...
{{% blocks/products/pf/agp/code-block title=".NET 代码：从 DOC 文档中删除密码" offSpacer="" %}}
...
<h2>通过.NET开发DOC保护管理应用程序</h2>

需要开发 DOC 保护管理应用程序或实用程序？借助 [Aspose.Words for .NET](https://products.aspose.com/words/zh/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh/net/) 的子 API），任何 .NET 开发人员都可以将上述 API 代码集成到其文档保护或取消保护应用程序中。强大的.NET 库允许对任何文档保护解决方案进行编程。而且它可以支持许多流行的格式，包括DOC格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于管理 DOC 保护的 .NET 实用程序" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序取消 DOC 文档的保护是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 DOC 文档解锁。但是，如果您正在开发桌面应用程序，我们建议使用 Aspose.Total 文档处理 API 进行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
