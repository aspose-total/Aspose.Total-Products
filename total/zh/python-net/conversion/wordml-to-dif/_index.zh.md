---
title: 使用 Python 将 WORDML 转换为 DIF
description: 在不使用 Microsoft Word 或 Excel 的 Python 应用程序中将 WORDML 转换为 DIF 
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 WORDML 转换为 DIF" h2="无需安装 Microsoft Word<sup>&reg;</sup> 或 Excel，即可在 Python 应用程序中将 WORDML 转换为 DIF" >}}
