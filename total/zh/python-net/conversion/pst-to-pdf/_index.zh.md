---
title: 在 Python 中将 PST 转换为 PDF
description: 在 Python 应用程序中将 PST 保存为 PDF，而无需使用 Microsoft Outlook 或 Word 
url: /zh/python-net/conversion/pst-to-pdf/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- 对于 PST 到 PDF 的转换，需要 Python 3.5 或更高版本
...
{{% blocks/products/pf/agp/code-block title="在 Python 中将 PST 保存为 PDF" offSpacer="" %}}
