---
title: 使用 Python 将 XLSB 转换为 MOBI
description: 在不使用 Microsoft Office 的情况下在 Python 应用程序中将 XLSB 转换为 MOBI 
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 XLSB 转换为 MOBI" h2="无需安装 Microsoft Excel<sup>&reg;</sup> 或 Word，即可在 Python 应用程序中将 XLSB 转换为 MOBI" >}}
