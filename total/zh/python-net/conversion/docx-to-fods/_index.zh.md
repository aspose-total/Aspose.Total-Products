---
title: 使用 Python 将 DOCX 转换为 FODS
description: 在不使用 Microsoft Word 或 Excel 的 Python 应用程序中将 DOCX 转换为 FODS 
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 DOCX 转换为 FODS" h2="无需安装 Microsoft Word<sup>&reg;</sup> 或 Excel，即可在 Python 应用程序中将 DOCX 转换为 FODS" >}}
