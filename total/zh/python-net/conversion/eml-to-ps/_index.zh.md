---
title: 在 Python 中将 EML 转换为 PS
description: 在 Python 应用程序中将 EML 保存为 PS，而无需使用 Microsoft Outlook 或 Word 
url: /zh/python-net/conversion/eml-to-ps/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- 对于 EML 到 PS 的转换，需要 Python 3.5 或更高版本
...
{{% blocks/products/pf/agp/code-block title="在 Python 中将 EML 保存为 PS" offSpacer="" %}}
