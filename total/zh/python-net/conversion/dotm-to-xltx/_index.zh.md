---
title: 使用 Python 将 DOTM 转换为 XLTX
description: 在不使用 Microsoft Word 或 Excel 的 Python 应用程序中将 DOTM 转换为 XLTX 
...
{{< blocks/products/pf/feature-page-header h1="通过 Python 将 DOTM 转换为 XLTX" h2="无需安装 Microsoft Word<sup>&reg;</sup> 或 Excel，即可在 Python 应用程序中将 DOTM 转换为 XLTX" >}}
