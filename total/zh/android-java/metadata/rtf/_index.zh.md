---
title: 使用 Android 移动应用在线查看和更新 RTF 属性或更新元数据
description: 通过在线应用程序免费查看和修改RTF属性。用于更新 RTF 属性的 Android API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线查看或更新 RTF 元数据或通过 Android 应用程序更新" h2="开发功能强大的基于android的RTF文档元数据管理实用应用程序。列出用于更新 RTF 文件元数据的代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Android 应用程序更新 RTF 属性" %}}
...
{{% blocks/products/pf/agp/code-block title="代码：更新 RTF 元数据" offSpacer="" %}}
...
<h2>开发 RTF 元数据管理 Android 应用程序</h2>

需要开发 RTF 元数据管理应用程序或实用程序吗？借助 [Aspose.Words for Android via Java](https://products.aspose.com/words/zh/android-java/)（[Aspose.Total for Android via Java](https://products.aspose.com/total/zh/android-java/) 的子 API），任何 Android 开发人员都可以将上述 API 代码集成到其文档元数据应用程序中。强大的 android 库允许编程任何文档元数据解决方案。此外，它还可以支持许多流行格式，包括 RTF 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于管理 RTF 元数据的 Android 实用程序" %}}
