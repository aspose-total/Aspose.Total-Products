---
title: 在线删除 PPSX 注释或使用 Android 移动应用程序管理注释
description: 通过在线应用程序免费从 PPSX 文件中删除注释。用于管理 PPSX 文件注释的 Android API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线清除 PPSX 演示文稿中的注释或通过 Android 应用程序进行管理" h2="开发功能强大的基于Android的PPSX演示注释实用应用程序。列出用于管理 PPSX 文件注释的代码。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过Android应用程序删除PPSX演示文稿评论" %}}

1. 向 android 项目添加库引用
1. 通过 Presentation 类对象加载 PPSX
...
{{% blocks/products/pf/agp/code-block title="代码：从 PPSX 演示文稿中删除评论和作者" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Android 应用程序添加 PPSX 演示文稿评论" %}}
