---
title: 通过 Java 将 PPTX 导出到 Andorid 上的 DOTX
description: 在移动应用程序中将 PPTX 转换为 DOTX，无需安装任何软件
url: /zh/android-java/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 PPTX 渲染到 DOTX" h2="文件格式 API 可在 Android 应用程序中将 PPTX 转换为 DOTX，而不依赖于 Microsoft PowerPoint 或 Word" >}}
