---
title: Android API 将 OTT 转换为 EXCEL
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情况下，通过 Java 在 Android 中将 OTT 转换为 EXCEL
url: /zh/android-java/conversion/ott-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用程序中将 OTT 转换为 EXCEL" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情况下，通过 Java 在 Android 中将 OTT 导出为 EXCEL" >}}
