---
title: 在 Android 中将 XLSX 导出为 PPTX
description: 无需使用 Microsoft Word 即可将 XLSX 转换为 PPTX 的 Android API
url: /zh/android-java/conversion/xlsx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 XLSX 渲染为 PPTX" h2="在您的 Android 应用程序中将 XLSX 转换为 PPTX，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
