---
title: 在 Android 中将 XLTX 导出为 DOCX
description: 无需使用 Microsoft Word 即可将 XLTX 转换为 DOCX 的 Android API
url: /zh/android-java/conversion/xltx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 XLTX 渲染为 DOCX" h2="在您的 Android 应用程序中将 XLTX 转换为 DOCX，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
