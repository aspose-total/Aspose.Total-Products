---
title: 在 Android 中将 XLT 导出为 DOC
description: 无需使用 Microsoft Word 即可将 XLT 转换为 DOC 的 Android API
url: /zh/android-java/conversion/xlt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 XLT 渲染为 DOC" h2="在您的 Android 应用程序中将 XLT 转换为 DOC，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
