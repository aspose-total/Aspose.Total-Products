---
title: 在 Android 中通过 Java 将 TXT 转换为 ODP
description: 在您的 Android 手机中将 TXT 转换为 ODP，而无需使用 Microsoft Word 的 PowerPoint
url: /zh/android-java/conversion/txt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用中将 TXT 转换为 ODP" h2="在您的 Android 应用程序中将 TXT 转换为 ODP，无需安装 Microsoft Word<sup>&reg;</sup> 或 PowerPoint" >}}
...
对于 TXT 到 ODP 文件的转换，您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total)并在您的应用程序中安装库。
