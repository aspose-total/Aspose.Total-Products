---
title: 通过 Java 将 PPT 导出到 Andorid 上的 DOT
description: 在移动应用程序中将 PPT 转换为 DOT，无需安装任何软件
url: /zh/android-java/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 PPT 渲染到 DOT" h2="文件格式 API 可在 Android 应用程序中将 PPT 转换为 DOT，而不依赖于 Microsoft PowerPoint 或 Word" >}}
