...
url: /zh/android-java/conversion/md-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: MD
...
您可以使用 [Aspose.Total for Android Java](https://products.aspose.com/total/android-java/) 包的两个 API 在您的移动应用程序中集成 MD 到 FLATOPC 的转换功能。首先，您需要使用 [Aspose.PDF for Android via Java](https://products.aspose.com/pdf/android-java/) 将 MD 文件转换为 DOC。其次，通过使用文字处理 API [Aspose.Words for Android Java](https://products.aspose.com/words/android-java/)，您可以将 DOC 渲染为 FLATOPC。 
{{% /blocks/products/pf/feature-page-summary  %}}
