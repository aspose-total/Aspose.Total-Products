---
title: 通过 Java 将 PPSX 导出到 Andorid 上的 RTF
description: 在移动应用程序中将 PPSX 转换为 RTF，无需安装任何软件
url: /zh/android-java/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 PPSX 渲染到 RTF" h2="文件格式 API 可在 Android 应用程序中将 PPSX 转换为 RTF，而不依赖于 Microsoft PowerPoint 或 Word" >}}
