---
title: Android API 将 DOC 转换为 XLAM
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情况下，通过 Java 在 Android 中将 DOC 转换为 XLAM
url: /zh/android-java/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用程序中将 DOC 转换为 XLAM" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情况下，通过 Java 在 Android 中将 DOC 导出为 XLAM" >}}
