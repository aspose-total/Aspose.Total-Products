---
title: 在 Android 中通过 Java 将 DOCM 转换为 POT 或使用免费的在线转换器
description: 在您的 Android 手机中将 DOCM 转换为 POT，而无需使用 Microsoft Word 的 PowerPoint 或在线。在集成代码之前快速测试免费的 CSV 到 DOC 在线转换器。
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用中将 DOCM 转换为 POT 或在线应用程序" h2="在您的 Android 应用程序中将 DOCM 转换为 POT，无需安装 Microsoft Word<sup>&reg;</sup> 或 PowerPoint" >}}
...
对于 DOCM 到 POT 文件的转换，您可以直接从 [Maven](https://releases.aspose.com/total/java/)并在您的应用程序中安装库。
