---
title: 在 Android 中通过 Java 将 OTT 转换为 POT
description: 在您的 Android 手机中将 OTT 转换为 POT，而无需使用 Microsoft Word 的 PowerPoint
url: /zh/android-java/conversion/ott-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用中将 OTT 转换为 POT" h2="在您的 Android 应用程序中将 OTT 转换为 POT，无需安装 Microsoft Word<sup>&reg;</sup> 或 PowerPoint" >}}
...
对于 OTT 到 POT 文件的转换，您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total)并在您的应用程序中安装库。
