---
title: 通过 Java 将 PPSM 导出到 Andorid 上的 DOCM
description: 在移动应用程序中将 PPSM 转换为 DOCM，无需安装任何软件
url: /zh/android-java/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 PPSM 渲染到 DOCM" h2="文件格式 API 可在 Android 应用程序中将 PPSM 转换为 DOCM，而不依赖于 Microsoft PowerPoint 或 Word" >}}
...
3. 使用 [Docmument](https://reference.aspose.com/words/java/com.aspose.words/Docmument) 类加载转换后的 HTML 文件
4. 使用[save](https://reference.aspose.com/words/java/com.aspose.words/Docmument#save(java.lang.String,int))方法将文档保存为DOCM格式并设置Docm保存格式
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/android-java/conversion/ppsm-to-docmx/" name="PPSM 至 DOCMX" description="" >}}
