---
title: 通过 Java 将 POTM 导出到 Andorid 上的 TEXT
description: 在移动应用程序中将 POTM 转换为 TEXT，无需安装任何软件
url: /zh/android-java/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 POTM 渲染到 TEXT" h2="文件格式 API 可在 Android 应用程序中将 POTM 转换为 TEXT，而不依赖于 Microsoft PowerPoint 或 Word" >}}
