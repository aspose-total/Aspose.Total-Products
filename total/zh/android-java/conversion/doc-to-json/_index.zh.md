---
title: 通过 Java 在 Android 中将 DOC 转换为 JSON 格式
description: 在不使用 Microsoft Word 或 Excel 的情况下，通过 Java 在 Android 中将 DOC 解析为 JSON 格式
url: /zh/android-java/conversion/doc-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 中将 DOC 转换为 JSON 格式" h2="设计 Android 应用程序以将 DOC 导出为 JSON，而无需使用 Microsoft<sup>&reg;</sup> Word 或 Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
您可以通过 [Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/) 在您的 Android 应用程序中将 DOC 转换为 JSON 格式。通过使用文档操作和转换 API [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/)，您可以将 DOC 导出为 HTML。之后，通过使用 [Aspose.Cells for Android via Java](https://products.aspose.com/cells/android-java/)，您可以将 HTML 转换为 JSON。 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="在 Android 中将 DOC 转换为 JSON 格式" %}}
...
{{% blocks/products/pf/feature-page-section  h2="通过 Java 在 Android 中将受保护的 DOC 转换为 JSON 格式" %}}
使用 API，您还可以打开受密码保护的文档。如果您的输入 DOC 文档受密码保护，则您无法在不使用密码的情况下将其转换为 JSON 格式。 API 允许您通过在 LoadOptions 对象中传递正确的密码来打开加密的文档。以下代码示例显示如何使用密码打开加密文档。
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="通过Java在Android中将DOC转换为范围内的JSON" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/android-java/conversion/doc-to-csv/" name="DOC 至 CSV" description="" >}}
