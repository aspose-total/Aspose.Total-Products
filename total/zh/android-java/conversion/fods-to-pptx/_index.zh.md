---
title: 在 Android 中将 FODS 导出为 PPTX
description: 无需使用 Microsoft Word 即可将 FODS 转换为 PPTX 的 Android API
url: /zh/android-java/conversion/fods-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 FODS 渲染为 PPTX" h2="在您的 Android 应用程序中将 FODS 转换为 PPTX，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/android-java/conversion/fods-to-pptxx/" name="FODS 至 PPTXX" description="" >}}
