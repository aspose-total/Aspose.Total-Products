---
title: 通过 Java 将 POTX 导出到 Andorid 上的 DOCM
description: 在移动应用程序中将 POTX 转换为 DOCM，无需安装任何软件
url: /zh/android-java/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 POTX 渲染到 DOCM" h2="文件格式 API 可在 Android 应用程序中将 POTX 转换为 DOCM，而不依赖于 Microsoft PowerPoint 或 Word" >}}
