---
title: 在 Android 中将 SXC 导出为 POWERPOINT
description: 无需使用 Microsoft Word 即可将 SXC 转换为 POWERPOINT 的 Android API
url: /zh/android-java/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 SXC 渲染为 POWERPOINT" h2="在您的 Android 应用程序中将 SXC 转换为 POWERPOINT，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
