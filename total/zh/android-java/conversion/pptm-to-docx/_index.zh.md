---
title: 通过 Java 将 PPTM 导出到 Andorid 上的 DOCX
description: 在移动应用程序中将 PPTM 转换为 DOCX，无需安装任何软件
url: /zh/android-java/conversion/pptm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 PPTM 渲染到 DOCX" h2="文件格式 API 可在 Android 应用程序中将 PPTM 转换为 DOCX，而不依赖于 Microsoft PowerPoint 或 Word" >}}
