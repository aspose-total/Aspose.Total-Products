---
title: 通过 Java 将 POWERPOINT 导出到 Andorid 上的 FLATOPC
description: 在移动应用程序中将 POWERPOINT 转换为 FLATOPC，无需安装任何软件
url: /zh/android-java/conversion/powerpoint-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Andorid 上将 POWERPOINT 渲染到 FLATOPC" h2="文件格式 API 可在 Android 应用程序中将 POWERPOINT 转换为 FLATOPC，而不依赖于 Microsoft PowerPoint 或 Word" >}}
