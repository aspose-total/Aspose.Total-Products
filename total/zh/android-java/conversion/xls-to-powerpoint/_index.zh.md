---
title: 在 Android 中将 XLS 导出为 POWERPOINT
description: 无需使用 Microsoft Word 即可将 XLS 转换为 POWERPOINT 的 Android API
url: /zh/android-java/conversion/xls-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="通过 Java 在 Android 上将 XLS 渲染为 POWERPOINT" h2="在您的 Android 应用程序中将 XLS 转换为 POWERPOINT，而无需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/android-java/conversion/xls-to-powerpointx/" name="XLS 至 POWERPOINTX" description="" >}}
