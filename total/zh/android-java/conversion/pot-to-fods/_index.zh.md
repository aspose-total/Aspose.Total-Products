...
url: /zh/android-java/conversion/pot-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
为了将 POT 转换为 FODS，您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total)并在您的应用程序中安装库。
