---
title: 在 Android 中通过 Java 将 DOCM 转换为 ODP
description: 在您的 Android 手机中将 DOCM 转换为 ODP，而无需使用 Microsoft Word 的 PowerPoint
url: /zh/android-java/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用中将 DOCM 转换为 ODP" h2="在您的 Android 应用程序中将 DOCM 转换为 ODP，无需安装 Microsoft Word<sup>&reg;</sup> 或 PowerPoint" >}}
