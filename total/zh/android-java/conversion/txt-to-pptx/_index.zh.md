---
title: 在 Android 中通过 Java 将 TXT 转换为 PPTX
description: 在您的 Android 手机中将 TXT 转换为 PPTX，而无需使用 Microsoft Word 的 PowerPoint
url: /zh/android-java/conversion/txt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
对于 TXT 到 PPTX 文件的转换，您可以直接从 [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total)并在您的应用程序中安装库。
