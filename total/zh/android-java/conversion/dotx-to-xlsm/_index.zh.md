---
title: Android API 将 DOTX 转换为 XLSM
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情况下，通过 Java 在 Android 中将 DOTX 转换为 XLSM
url: /zh/android-java/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用程序中将 DOTX 转换为 XLSM" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情况下，通过 Java 在 Android 中将 DOTX 导出为 XLSM" >}}
