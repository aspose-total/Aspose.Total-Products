---
title: Android API 将 DOCM 转换为 XLSB
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情况下，通过 Java 在 Android 中将 DOCM 转换为 XLSB
url: /zh/android-java/conversion/docm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="在 Android 应用程序中将 DOCM 转换为 XLSB" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情况下，通过 Java 在 Android 中将 DOCM 导出为 XLSB" >}}
