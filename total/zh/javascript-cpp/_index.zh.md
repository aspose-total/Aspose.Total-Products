---
title: 通过 JavaScript API 进行 PDF 处理和 OCR 添加
description: JavaScript API 用于操作 PDF 文档以及在 Web 应用程序中添加 OCR 功能。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用于 PDF 和 OCR 的 JavaScript API" h2="在 Web 应用程序中添加 OCR 和 PDF 操作功能，无需任何其他软件依赖" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
{{< blocks/products/pf/total/products description="Aspose.Total for JavaScript via C++ 包括以下 JavaScript 库：" >}}
...
Aspose.Cells for JavaScript via C++ 是一款功能强大的基于 WebAssembly 的 API，可在浏览器和 Node.js 环境中提供近乎原生的性能，支持 Excel 格式（XLS、XLSX、XLSB、XLSM）、ODS、CSV 和 HTML 的电子表格创建、编辑、转换和渲染。它专为实现最大兼容性和灵活性而设计，无需服务器即可实现无缝电子表格处理，是无服务器应用程序、仪表板、数据管道和文档生成工具的理想选择。凭借其轻量级的体积和对主流 Excel 格式的全面支持，Aspose.Cells for JavaScript via C++ 可确保在 Web、服务器端和混合平台上快速、可靠、高性能地处理电子表格。
...
Aspose.Font for JavaScript via C++ 提供一系列强大的功能来简化字体管理。它可以直接在浏览器中轻松转换字体，支持无缝处理各种格式，如 TTF、EOT、WOFF、CFF 和 Type1，并提供对字体元数据的全面访问，以获得详细的见解。
...
详细记录的说明手册和 Aspose.Total 组件的稳健性使得可以直接集成到 DOCO 中。这帮助我们比预期缩短了更多的开发时间。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="布莱恩·桑顿 |美国净反应有限责任公司" >}}
我们在办公自动化和 Soft Artisans 的 Office Writer 产品方面拥有丰富的经验。Aspose 的 Total.NET 更强大，提供的功能比我们过去使用的任何产品都多。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="马克·弗利 |狮子内森国家食品公司，澳大利亚" >}}
实际上，Aspose.Total for .NET 套件是我们使用的组件中的“瑞士军刀”。它与表示层组件并排，形成“粘合剂”，以所需的格式拉取和推送数据文件。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="亚辛·劳达 |法国奎莱泰克" >}}
实现很简单，我们真正专注于我们的架构，而 Aspose 非常适合。我们的架构针对性能和多线程进行了高度优化，使用 Aspose.Total.net 也没有问题。
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-tab tabTitle="为什么选择 Aspose.Total 用于 C++" tabId="success-stories" >}}
