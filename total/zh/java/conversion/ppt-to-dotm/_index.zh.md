...
使用 API，您还可以执行 PPT 文件到带有水印的 DOTM 转换。为了给您的 DOTM 文档添加水印，您可以先将 PPT 文件转换为 HTML 并为其添加水印。为了添加水印，使用 [Dotmument](https://apireference.aspose.com/words/java/com.aspose.words/Dotmument) 类加载新创建的 HTML 文件，创建 TextWatermarkOptions 的实例并设置它的属性，调用 Watermark.setText 方法并传递水印文本和 TextWatermarkOptions 的对象。  
{{% blocks/products/pf/feature-page-code %}}
