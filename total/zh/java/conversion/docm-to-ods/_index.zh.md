---
title: Java API 将 DOCM 转换为 ODS
description: 通过 Java 将 DOCM 转换为 ODS，而不使用 Microsoft Word 或 Microsoft Excel
url: /zh/java/conversion/docm-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 DOCM 转换为 ODS" h2="无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 即可将 DOCM 转换为 ODS 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="将 DOCM 转换为 ODS 的 C++ API" %}}
