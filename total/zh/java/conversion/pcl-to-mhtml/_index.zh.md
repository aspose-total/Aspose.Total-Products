---
title: 在线将 PCL 转换为 MHTML 或开发基于 Java 的应用程序来转换 PCL 文件
description: 免费在线应用程序将 PCL 文件转换为 MHTML 文件。PCL 文档的 Java 转换库代码。 
...
{{< blocks/products/pf/feature-page-header h1="在线 PCL 到 MHTML 转换应用程序和 Java 代码来转换 PCL 文件" h2="开发强大的基于 Java 的 PCL 转换和导出应用程序。 通过 Java 自动化 API 将单个或多个 PCL 文件转换为 MHTML 和其他格式。 通过应用程序在线自由转换 PCL 文件并即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 自动化 API 将 PCL 转换为 MHTML" %}}
...
{{% blocks/products/pf/agp/code-block title="PCL 到 MHTML 转换的 Java 代码" offSpacer="" %}}
...
使用其他功能（如 通过 Java 打开受密码保护的 PCL 文档, 通过 Java 将 MHTML 文档保存到数据库）将 PCL 保存为 MHTML 的情况较少。
