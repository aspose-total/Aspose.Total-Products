---
title: 在线将 SVG 转换为 OTP 或开发基于 Java 的应用程序来转换 SVG 文件
description: 免费在线应用程序将 SVG 文件转换为 OTP 文件。SVG 文档的 Java 转换库代码。 
...
{{< blocks/products/pf/feature-page-header h1="在线 SVG 到 OTP 转换应用程序和 Java 代码来转换 SVG 文件" h2="开发强大的基于 Java 的 SVG 转换和导出应用程序。 通过 Java 自动化 API 将单个或多个 SVG 文件转换为 OTP 和其他格式。 通过应用程序在线自由转换 SVG 文件并即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 自动化 API 将 SVG 转换为 OTP" %}}
...
{{% blocks/products/pf/agp/code-block title="SVG 到 OTP 转换的 Java 代码" offSpacer="" %}}
...
使用其他功能（如 通过 Java 打开加密的 SVG 文件, 通过 Java 保存具有预定义视图类型的 OTP 文件）将 SVG 保存为 OTP 的情况较少。
