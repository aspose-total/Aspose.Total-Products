---
title: 使用 Java 将 ODS 转换为 DOCX
description: 使用 Excel 或 Word 将 ODS 导出为 DOCX 的 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="用于将 ODS 导出为 DOCX 的 Java API" h2="无需依赖 Microsoft Excel 即可将 ODS 导出为 DOCX 的 On Premise Java API" >}}
...
1. 使用 [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) 类打开 ODS 文件
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh/net/conversion/ods-to-docxx/" name="ODS 到 DOCXX" description="" >}}
