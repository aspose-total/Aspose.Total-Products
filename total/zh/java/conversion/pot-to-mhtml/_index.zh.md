---
title: 通过 Java 将 POT 转换为 MHTML 格式
description: 通过 Java 将 POT 转换为 MHTML 格式，而不使用 Microsoft Excel 或 PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 POT 转换为 MHTML" h2="无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint 即可将 POT 导出为 MHTML 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 将 POT 转换为 MHTML" %}}
1. 使用 [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) 类打开 POT 文件
2. 使用 [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides) 将 POT 转换为 HTML。 ISaveOptions-) 方法
