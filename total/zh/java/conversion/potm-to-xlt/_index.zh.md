---
title: 通过 Java 将 POTM 转换为 XLT 格式
description: 通过 Java 将 POTM 转换为 XLT 格式，而不使用 Microsoft Excel 或 PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 POTM 转换为 XLT" h2="无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint 即可将 POTM 导出为 XLT 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 将 POTM 转换为 XLT" %}}
