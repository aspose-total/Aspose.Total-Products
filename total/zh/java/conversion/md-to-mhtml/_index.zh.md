...
url_ignore: /zh/java/conversion/md-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: MD
...
在将 MD 转换为 MHTML 时，即使您的文档受密码保护，您仍然可以使用 PDF 操作 API [Aspose.PDF for Java](https://docs.aspose.com/pdf/java/installation/) 打开它。为了打开加密文件，您需要创建一个 [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document) 对象并使用所有者的密码打开 MD。  
{{% blocks/products/pf/feature-page-code %}}
```cs
