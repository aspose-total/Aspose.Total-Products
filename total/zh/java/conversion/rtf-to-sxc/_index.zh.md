---
title: Java API 将 RTF 转换为 SXC
description: 通过 Java 将 RTF 转换为 SXC，而不使用 Microsoft Word 或 Microsoft Excel
url: /zh/java/conversion/rtf-to-sxc/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 RTF 转换为 SXC" h2="无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 即可将 RTF 转换为 SXC 的 On Premise Java API" >}}
