...
description: 通过 Java 将 MOBI 转换为 CSV 或在线应用程序，而不使用 Microsoft Word 或 Microsoft Excel 或在线。在集成代码之前快速测试免费的 MOBI 到 CSV 在线转换器。 
...
{{% blocks/products/pf/agp/feature-section-col title="将 MOBI 转换为 CSV 的 Java API" %}}
...
<iframe title="mobi 到 csv 转换在线工具" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=csv&from=mobi" id="child-iframe" width="80%"></iframe>
