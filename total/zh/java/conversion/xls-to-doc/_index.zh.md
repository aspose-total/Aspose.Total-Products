...
4. 使用[save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions)将文档保存为DOC格式-) 方法并将 Doc 设置为 SaveFormat
