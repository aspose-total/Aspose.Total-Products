---
title: 通过 Java 将 POT 转换为 XLT 或在线 格式
description: 通过 Java 将 POT 转换为 XLT 或在线 格式，而不使用 Microsoft Excel 或 PowerPoint 或在线。在集成代码之前快速测试免费的 POT 到 CSV 在线转换器。 或使用免费的在线转换器
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 POT 转换为 XLT 或在线" h2="无需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint 即可将 POT 导出为 XLT 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 将 POT 转换为 XLT 或在线" %}}
