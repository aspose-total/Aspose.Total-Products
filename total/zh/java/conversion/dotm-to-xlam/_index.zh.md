...
description: 通过 Java 将 DOTM 转换为 XLAM，而不使用 Microsoft Word 或 Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 DOTM 转换为 XLAM" h2="无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 即可将 DOTM 转换为 XLAM 的 On Premise Java API" >}}
