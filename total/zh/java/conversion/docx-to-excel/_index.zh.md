---
title: Java API 将 DOCX 转换为 EXCEL
description: 通过 Java 将 DOCX 转换为 EXCEL，而不使用 Microsoft Word 或 Microsoft Excel
url: /zh/java/conversion/docx-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 DOCX 转换为 EXCEL" h2="无需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 即可将 DOCX 转换为 EXCEL 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="将 DOCX 转换为 EXCEL 的 C++ API" %}}
