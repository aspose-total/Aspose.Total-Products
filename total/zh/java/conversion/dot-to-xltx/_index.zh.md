---
title: Java API 将 DOT 转换为 XLTX 或使用免费的在线转换器
description: 通过 Java 将 DOT 转换为 XLTX 或在线应用程序，而不使用 Microsoft Word 或 Microsoft Excel 或在线。在集成代码之前快速测试免费的 DOT 到 XLTX 在线转换器。 
...
{{% blocks/products/pf/agp/feature-section-col title="将 DOT 转换为 XLTX 的 Java API" %}}
...
将 **DOT** 转换为 **XLTX（Excel 模板开放 XML）** 对于从 Word 文档构建现代、可重用的 Excel 模板、支持云工作流和可扩展的报告框架至关重要。
