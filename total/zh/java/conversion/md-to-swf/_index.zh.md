...
url_ignore: /zh/java/conversion/md-to-swf/
family: total
platformtag: net
feature: conversion
informat: MD
...
将 MD 转换为 SWF 后，您还可以为演示文稿添加预定义的视图类型。 [Aspose.Slides for Java](https://products.aspose.com/slides/java/) 提供了一种工具来设置生成的演示文稿在通过 [ViewProperties](https:// /apireference.aspose.com/slides/java/com.aspose.slides/ViewProperties) 类。 [setLastView](https://reference.aspose.com/slides/java/com.aspose.slides/ViewProperties#setLastView-int-) 属性用于通过使用[ViewType](https:// /apireference.aspose.com/slides/java/com.aspose.slides/ViewType) 枚举器。 
{{% blocks/products/pf/feature-page-code %}}
...
将Markdown（MD）转换为SWF（Shockwave Flash）可以将文本、图表和图表转换为交互式Flash动画。SWF非常适合用于传统教育内容、教程和动画网络演示。
...
* 将Markdown教程转换为交互式SWF内容。

* 从Markdown生成的电子学习模块的动画图表。

* 用于网络交付的传统基于Flash的演示文稿。

* 在教育平台中嵌入交互式Markdown可视化内容。
...
* 用于在线培训材料的自动化Markdown到SWF流水线。

* 将MD内容批量转换为交互式Flash文件。

* 来自Markdown的SWF学习模块的定期更新。

* 为基于Web的传统平台触发生成SWF可视化内容。
