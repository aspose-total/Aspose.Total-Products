---
title: 通过 Java 将 PPT 转换为 DOCX
description: 无需使用 Microsoft Word 或 PowerPoint 即可将 PPT 导出为 DOCX 的 Java API
...
{{< blocks/products/pf/i18n/feature-page-header h1="通过 Java 将 PPT 转换为 DOCX" h2="在任何 Java J2SE、J2EE、J2ME 应用程序中用于 PowerPoint PPT 到 DOCX 的 On Premise Java API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Java 将 PPT 转换为 DOCX" %}}
...
使用 API，您还可以执行 PPT 文件到带有水印的 DOCX 转换。为了给您的 DOCX 文档添加水印，您可以先将 PPT 文件转换为 HTML 并为其添加水印。为了添加水印，使用 [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) 类加载新创建的 HTML 文件，创建 TextWatermarkOptions 的实例并设置它的属性，调用 Watermark.setText 方法并传递水印文本和 TextWatermarkOptions 的对象。  
{{% blocks/products/pf/feature-page-code %}}
