---
title: 在线或使用 Java 编辑 Word 文档
description: 通过应用程序免费在线打开和编辑 Word 文档。用于使用正则表达式搜索和替换 Word 文本的 Java API 代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="在线或通过 Java 编辑 Word 文档" h2="开发强大的基于 Java 的 Word 文档编辑实用程序。列出的代码用于通过 Java 使用正则表达式搜索和替换 Word 文件中的文本。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 编辑 Word 文件" %}}

1. 添加库引用到Java项目
1. 使用 Document 类加载 Word 文件
1. 定义正则表达式模式数组
1. 迭代数组并
1. 使用 getRange().replace 方法和相关参数
1. 保存 Word 文档。
...
{{% blocks/products/pf/agp/code-block title="Java 代码：编辑 Word 文档" offSpacer="" %}}
...
<h2>通过 Java 开发 Word 修订应用程序</h2>

需要开发 Word 修订应用程序或实用程序？借助 [Aspose.Words for Java](https://products.aspose.com/words/zh/java/)（[Aspose.Total for Java](https://products.aspose.com/total/zh/java/) 的子 API），任何 Java 开发人员都可以将上述 API 代码集成到其文档编辑应用程序中。强大的 Java 库允许对任何文档编辑解决方案进行编程。而且它可以支持许多流行的格式，包括Word格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于编辑 Word 文件的 Java 实用程序" %}}
