---
title: 在线或通过 Java 分割 Word 文件
description: 用于分割不同 Word 文件的免费在线应用程序。Word 文档的 Java 分割器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter App 或使用 Java 在线分割 Word 文件" h2="开发强大的基于 Java 的 Word 文档分割器应用程序。通过应用程序在线自由分割文档，包括 Word 文件，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过Java分割Word文件" %}}
...
{{% blocks/products/pf/agp/code-block title="Java 中按页拆分 Word 文件的代码示例" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="用于按节分割 Word 文件的 Java 代码" offSpacer="" %}}
...
<h2>使用 Java 开发 Word 文件分割器应用程序</h2>

需要开发 Java 脚本或实用程序应用程序来轻松分割 Word 文件？通过 [Aspose.Total for Java](https://products.aspose.com/total/zh/java/) 的子 API [Aspose.Words for Java](https://products.aspose.com/words/zh/java/)，任何 Java 开发人员都可以将上述 API 代码集成到分割器应用程序中。强大的用于分割文档的 Java 库支持许多流行的格式，包括 Word 格式，如 PDF、Word 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于 Java 的 Word Splitter 库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用 Java 可以轻松开发专业的 Word 文件分割解决方案。 使用 Aspose Word splitter API 在 Java 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
