---
title: 在线或通过 Java 分割 DOC 文件
description: 用于分割不同 DOC 文件的免费在线应用程序。DOC 文档的 Java 分割器库代码。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过 Splitter App 或使用 Java 在线分割 DOC 文件" h2="开发强大的基于 Java 的 DOC 文档分割器应用程序。通过应用程序在线自由分割文档，包括 DOC 文件，并可即时下载。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用App在线分割DOC文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过Java分割DOC文件" %}}

1. 在项目中添加 Java 库引用。
1. 使用 Document 类加载 DOC 文档。
1. 计算 DOC 文件中的总页数。
...
{{% blocks/products/pf/agp/code-block title="Java 中按页拆分 DOC 文件的代码示例" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="用于按节分割 DOC 文件的 Java 代码" offSpacer="" %}}
...
<h2>使用 Java 开发 DOC 文件分割器应用程序</h2>

需要开发 Java 脚本或实用程序应用程序来轻松分割 DOC 文件？通过 [Aspose.Total for Java](https://products.aspose.com/total/zh/java/) 的子 API [Aspose.Words for Java](https://products.aspose.com/words/zh/java/)，任何 Java 开发人员都可以将上述 API 代码集成到分割器应用程序中。强大的用于分割文档的 Java 库支持许多流行的格式，包括 DOC 格式，如 PDF、Word 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用于 Java 的 DOC Splitter 库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用 Java 可以轻松开发专业的 DOC 文件分割解决方案。 使用 Aspose DOC splitter API 在 Java 中开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序分割多个 DOC 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）来进行在线 DOC 文档拆分器。</span>
                      </div>
                  </li>
