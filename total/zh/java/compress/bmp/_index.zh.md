---
title: 在线或通过 Java 压缩 BMP 文件
description: 用于压缩不同 BMP 文件的免费在线应用程序。BMP 文档的 Java 压缩库代码。 
...
{{< blocks/products/pf/feature-page-header-widget h1="通过压缩应用程序或使用Java在线压缩BMP文件" h2="开发功能强大的基于 Java 的 BMP 文档压缩应用程序。通过应用程序在线自由压缩包括 BMP 文件在内的各种文档，并可即时下载。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过Java压缩BMP文件" %}}

1. 将 Java 库引用添加到您的 Java 项目中
1. 创建文档类对象
1. 将其加载到 DocumentBuilder 类对象中
1. 使用 insertImage() 方法导入 BMP 图像
1. 使用 ImageSaveOptions 并设置质量
1. 调用save方法，得到压缩后的BMP文件。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Java 中压缩 BMP 文件的代码示例" offSpacer="" %}}
...
<h2>使用 Java 开发 BMP 文件压缩应用程序</h2>

需要开发 Java 脚本或实用应用程序来轻松压缩多个 BMP 文件？通过 [Aspose.Total for Java](https://products.aspose.com/total/zh/java/) 的子 API [Aspose.Words for Java](https://products.aspose.com/words/zh/java/)，任何 Java 开发人员都可以集成上述 API 代码来编写图像压缩应用程序。另一种方法是使用 [Aspose.Imaging for Java](https://products.aspose.com/imaging/zh/java/) API，这也是 [Aspose.Total for Java](https://products.aspose.com/total/zh/java/) API 的一部分。强大的 [图像压缩](https://products.aspose.com/imaging/zh/java/compress/) Java 库支持许多流行的格式，包括 BMP 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="BMP 文件的 Java 压缩库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。使用 Java 可以轻松开发专业的 BMP 文件压缩解决方案。使用 Aspose BMP 压缩 API 用 Java 开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
