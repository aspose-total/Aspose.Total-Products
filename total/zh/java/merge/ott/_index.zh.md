---
title: 在线或使用 Java 合并 OTT 文件
description: 用于组合不同 OTT 文件的免费在线应用程序。Java合并库代码，用于合并OTT文档。
...
{{< blocks/products/pf/feature-page-header-widget h1="通过合并应用程序或使用 Java 在线合并 OTT 文档" h2="开发强大的基于 Java 的 OTT 文档合并应用程序。通过应用程序免费在线将多个 OTT 文档合并为一个文档。将 OTT 文件保存为 PDF、图像、Word、Excel、PowerPoint 和许多其他在线格式。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用应用程序在线合并 OTT 文件" %}}

1. 上传 OTT 文件，将它们合并为一个
1. 输入参数，例如从下拉列表中选择
1. 保存为所需格式：DOCX、DOC、PDF、XLSX、PPTX、图像、HTML 等
1. 单击“合并”按钮将 OTT 合并为所需格式
1. 下载合并后的OTT文件
1. 查看并获取单个合并的 OTT 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="通过Java合并OTT文件" %}}

1. 将 Java 库引用添加到您的项目中
1. 将两个文档加载到两个单独的 Document 类对象中
1. 使用appendDocument函数合并文档
1. 调用save方法将合并后的OTT文件合并为一个
...
{{% blocks/products/pf/agp/code-block title="合并 OTT 文件的 Java 代码" offSpacer="" %}}
...
<h2>使用 Java 开发 OTT 文件合并</h2>

需要开发 Java 实用应用程序来轻松合并多个 OTT 文件吗？通过[Aspose.Total for Java](https://products.aspose.com/total/zh/java/)的[Aspose.Words for Java](https://products.aspose.com/words/zh/java/)子API，任何Java开发人员都可以集成上述API代码来编写跨文档的合并应用程序。用于合并文档的强大 Java 库支持许多流行格式，包括 OTT 格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="OTT 文件的 Java 合并库" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，欢迎您下载此代码。人们可以轻松地开发出一种专业的解决方案来使用 Java 组合 OTT。使用 Aspose OTT 合并 API 用 Java 开发高级、平台无关的软件。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用在线应用程序合并多个 OTT 文档是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何现代网络浏览器（例如 Google Chrome、Firefox、Opera 或 Safari）进行在线 OTT 文档合并。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>如何合并多个 OTT 文件？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">首先上传一个或多个要合并的文件。您可以拖放 OTT 文件或只需在白色区域内单击。之后，单击“合并”按钮，我们的合并器将快速处理上传的文件。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>合并 OTT 文件需要多长时间？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
