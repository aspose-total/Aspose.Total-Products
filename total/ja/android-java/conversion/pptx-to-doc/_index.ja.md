...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOCに変換するファイル形式のAPI" >}}
