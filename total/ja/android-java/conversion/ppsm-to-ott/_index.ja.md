---
title: Java経由でAndoridのOTTにPPSMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPSMをOTTに変換する
url: /ja/android-java/conversion/ppsm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのOTTにPPSMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPSMをOTTに変換するファイル形式のAPI" >}}
