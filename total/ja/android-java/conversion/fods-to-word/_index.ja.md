---
title: AndroidのWORDにFODSをエクスポートする
description: MicrosoftWordを使用せずにFODSをWORDに変換するAndroidAPI
url: /ja/android-java/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のWORDにFODSをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でFODSをWORDに変換する" >}}
