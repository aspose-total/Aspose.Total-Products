---
title: Java経由でAndoridのRTFにPPTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTMをRTFに変換する
url: /ja/android-java/conversion/pptm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPPTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをRTFに変換するファイル形式のAPI" >}}
