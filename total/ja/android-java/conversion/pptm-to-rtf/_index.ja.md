...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPPTMをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをRTFに変換するファイル形式のAPI" >}}
