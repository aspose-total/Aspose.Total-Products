---
title: DOCMをXLSBに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでDOCMをXLSBに変換する
url: /ja/android-java/conversion/docm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでDOCMをXLSBに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのXLSBにDOCMをエクスポートする" >}}
