---
title: Java経由でAndoridのDOTにPOTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTXをDOTに変換する
url: /ja/android-java/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPOTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTXをDOTに変換するファイル形式のAPI" >}}
