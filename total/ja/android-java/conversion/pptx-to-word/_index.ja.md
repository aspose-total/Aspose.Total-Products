---
title: Java経由でAndoridのWORDにPPTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTXをWORDに変換する
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDにPPTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをWORDに変換するファイル形式のAPI" >}}
