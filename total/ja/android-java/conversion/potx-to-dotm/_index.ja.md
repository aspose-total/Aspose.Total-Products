---
title: Java経由でAndoridのDOTMにPOTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTXをDOTMに変換する
url: /ja/android-java/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTMにPOTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTXをDOTMに変換するファイル形式のAPI" >}}
