---
title: ODTをXLTXに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでODTをXLTXに変換する
url: /ja/android-java/conversion/odt-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでODTをXLTXに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのXLTXにODTをエクスポートする" >}}
