---
title: Javaを介してAndroidでXMLをODSに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでXMLをODSにレンダリングする
url: /ja/android-java/conversion/xml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: XML
