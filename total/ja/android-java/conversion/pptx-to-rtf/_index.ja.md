...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをRTFに変換するファイル形式のAPI" >}}
