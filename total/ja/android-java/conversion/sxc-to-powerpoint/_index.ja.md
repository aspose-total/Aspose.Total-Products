---
title: AndroidのPOWERPOINTにSXCをエクスポートする
description: MicrosoftWordを使用せずにSXCをPOWERPOINTに変換するAndroidAPI
url: /ja/android-java/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPOWERPOINTにSXCをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でSXCをPOWERPOINTに変換する" >}}
