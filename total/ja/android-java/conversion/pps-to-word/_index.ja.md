---
title: Java経由でAndoridのWORDにPPSをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPSをWORDに変換する
url: /ja/android-java/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDにPPSをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPSをWORDに変換するファイル形式のAPI" >}}
