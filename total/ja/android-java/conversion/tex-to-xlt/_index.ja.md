---
title: Javaを介してAndroidでTEXをXLTに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでTEXをXLTにレンダリングする
url: /ja/android-java/conversion/tex-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: TEX
