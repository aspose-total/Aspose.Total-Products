...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのFLATOPCにPPTをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTをFLATOPCに変換するファイル形式のAPI" >}}
