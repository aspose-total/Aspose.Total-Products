---
title: Java経由でAndoridのFLATOPCにPOTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTMをFLATOPCに変換する
url: /ja/android-java/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのFLATOPCにPOTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTMをFLATOPCに変換するファイル形式のAPI" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/potm-to-flatopcm/" name="POTM に FLATOPCM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/potm-to-flatopcx/" name="POTM に FLATOPCX" description="" >}}
