...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTXにPPTMをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをDOTXに変換するファイル形式のAPI" >}}
