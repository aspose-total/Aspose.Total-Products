---
title: AndroidのPPTXにODSをエクスポートする
description: MicrosoftWordを使用せずにODSをPPTXに変換するAndroidAPI
url: /ja/android-java/conversion/ods-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPPTXにODSをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でODSをPPTXに変換する" >}}
