...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPOTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTXをRTFに変換するファイル形式のAPI" >}}
