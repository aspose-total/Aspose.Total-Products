---
title: AndroidのPOWERPOINTにXLTXをエクスポートする
description: MicrosoftWordを使用せずにXLTXをPOWERPOINTに変換するAndroidAPI
url: /ja/android-java/conversion/xltx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPOWERPOINTにXLTXをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLTXをPOWERPOINTに変換する" >}}
