---
title: AndroidのDOCにXLSBをエクスポートする
description: MicrosoftWordを使用せずにXLSBをDOCに変換するAndroidAPI
url: /ja/android-java/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のDOCにXLSBをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLSBをDOCに変換する" >}}
...
4. [保存](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions)を使用してドキュメントをDOC形式で保存します-) 方法
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/xlsb-to-docx/" name="XLSB に DOCX" description="" >}}
