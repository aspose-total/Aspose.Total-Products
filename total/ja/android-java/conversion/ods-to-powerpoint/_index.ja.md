---
title: AndroidのPOWERPOINTにODSをエクスポートする
description: MicrosoftWordを使用せずにODSをPOWERPOINTに変換するAndroidAPI
url: /ja/android-java/conversion/ods-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPOWERPOINTにODSをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でODSをPOWERPOINTに変換する" >}}
