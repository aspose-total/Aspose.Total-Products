---
title: Javaを介してAndroidでCGMをDIFに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでCGMをDIFにレンダリングする
url: /ja/android-java/conversion/cgm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: CGM
