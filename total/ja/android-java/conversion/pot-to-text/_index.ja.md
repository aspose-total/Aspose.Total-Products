...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのTEXTにPOTをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTをTEXTに変換するファイル形式のAPI" >}}
