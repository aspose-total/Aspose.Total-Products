---
title: Javaを介してAndroidでJSON形式をODPに変換する
description: MicrosoftPowerPointを使用せずにAndroidアプリケーションでJSONをODPに解析する
url: /ja/android-java/conversion/json-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="AndroidでJSON形式をODPに変換する" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Java経由でAndroidの透かしを使用してJSON形式をODPに変換する" %}}
APIを使用して、JSONを透かし付きのODPに変換することもできます。 ODPドキュメントに透かしを追加するには、最初にJSONをPPTXに解析して、透かしを追加します。透かしを追加するには、[プレゼンテーション](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation)クラスを使用して、新しく作成したPPTXファイルを読み込み、すべてのスライドをループして、テキストを追加します。 addTextFrameを使用して、color、fillTypeなどの関連するすべてのオプションを設定し、ドキュメントをODPに保存できます。
{{% blocks/products/pf/feature-page-code %}}
