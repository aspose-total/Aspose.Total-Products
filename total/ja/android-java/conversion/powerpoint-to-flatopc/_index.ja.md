---
title: Java経由でAndoridのFLATOPCにPOWERPOINTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOWERPOINTをFLATOPCに変換する
url: /ja/android-java/conversion/powerpoint-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのFLATOPCにPOWERPOINTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOWERPOINTをFLATOPCに変換するファイル形式のAPI" >}}
