---
title: Javaを介してAndroidでCGMをXLAMに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでCGMをXLAMにレンダリングする
url: /ja/android-java/conversion/cgm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: CGM
