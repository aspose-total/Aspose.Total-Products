---
title: Java経由でAndoridのDOTXにPPSMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPSMをDOTXに変換する
url: /ja/android-java/conversion/ppsm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTXにPPSMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPSMをDOTXに変換するファイル形式のAPI" >}}
