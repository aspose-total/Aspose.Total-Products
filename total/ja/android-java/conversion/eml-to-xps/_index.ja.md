...
{{< blocks/products/pf/feature-page-header h1="AndoridアプリでメールをXPSに変換する" h2="JavaAPIを介してAndoridを使用してEMLをXPSにエクスポートするためのAndoridアプリケーションの設計" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="AndoridでEMLをXPSに変換する" %}}
