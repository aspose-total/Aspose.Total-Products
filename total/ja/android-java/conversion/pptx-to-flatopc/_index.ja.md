---
title: Java経由でAndoridのFLATOPCにPPTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTXをFLATOPCに変換する
url: /ja/android-java/conversion/pptx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのFLATOPCにPPTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをFLATOPCに変換するファイル形式のAPI" >}}
