...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのFLATOPCにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをFLATOPCに変換するファイル形式のAPI" >}}
