---
title: Javaを介してAndroidでCGMをTSVに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでCGMをTSVにレンダリングする
url: /ja/android-java/conversion/cgm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: CGM
