---
title: AndroidのPOWERPOINTにFODSをエクスポートする
description: MicrosoftWordを使用せずにFODSをPOWERPOINTに変換するAndroidAPI
url: /ja/android-java/conversion/fods-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPOWERPOINTにFODSをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でFODSをPOWERPOINTに変換する" >}}
