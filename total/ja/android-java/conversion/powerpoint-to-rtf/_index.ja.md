---
title: Java経由でAndoridのRTFにPOWERPOINTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOWERPOINTをRTFに変換する
url: /ja/android-java/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPOWERPOINTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOWERPOINTをRTFに変換するファイル形式のAPI" >}}
