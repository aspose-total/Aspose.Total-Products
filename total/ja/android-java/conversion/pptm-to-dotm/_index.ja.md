---
title: Java経由でAndoridのDOTMにPPTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTMをDOTMに変換する
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTMにPPTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをDOTMに変換するファイル形式のAPI" >}}
