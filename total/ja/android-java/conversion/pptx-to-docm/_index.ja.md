...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCMにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOCMに変換するファイル形式のAPI" >}}
