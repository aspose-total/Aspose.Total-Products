---
title: Java経由でAndoridのDOCMにPPTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTXをDOCMに変換する
url: /ja/android-java/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCMにPPTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOCMに変換するファイル形式のAPI" >}}
