---
title: DOCXをFODSに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでDOCXをFODSに変換する
url: /ja/android-java/conversion/docx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでDOCXをFODSに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのFODSにDOCXをエクスポートする" >}}
