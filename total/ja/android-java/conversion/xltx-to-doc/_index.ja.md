---
title: AndroidのDOCにXLTXをエクスポートする
description: MicrosoftWordを使用せずにXLTXをDOCに変換するAndroidAPI
url: /ja/android-java/conversion/xltx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のDOCにXLTXをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLTXをDOCに変換する" >}}
