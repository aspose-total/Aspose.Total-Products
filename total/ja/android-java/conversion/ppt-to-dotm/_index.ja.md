---
title: Java経由でAndoridのDOTMにPPTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTをDOTMに変換する
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTMにPPTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTをDOTMに変換するファイル形式のAPI" >}}
