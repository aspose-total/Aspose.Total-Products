---
title: AndroidのPPTXにXLSMをエクスポートする
description: MicrosoftWordを使用せずにXLSMをPPTXに変換するAndroidAPI
url: /ja/android-java/conversion/xlsm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のPPTXにXLSMをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLSMをPPTXに変換する" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/xlsm-to-pptxx/" name="XLSM に PPTXX" description="" >}}
