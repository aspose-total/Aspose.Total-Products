...
description: AndoridアプリケーションでMicrosoftWordまたはOutlookを使用せずにEMLをODTにエクスポートする
url: /ja/android-java/conversion/eml-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="AndoridアプリでメールをODTに変換する" h2="JavaAPIを介してAndoridを使用してEMLをODTにエクスポートするためのAndoridアプリケーションの設計" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="AndoridでEMLをODTに変換する" %}}
