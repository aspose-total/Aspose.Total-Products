...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTXにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOTXに変換するファイル形式のAPI" >}}
