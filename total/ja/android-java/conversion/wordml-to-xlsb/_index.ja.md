---
title: WORDMLをXLSBに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでWORDMLをXLSBに変換する
url: /ja/android-java/conversion/wordml-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでWORDMLをXLSBに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのXLSBにWORDMLをエクスポートする" >}}
