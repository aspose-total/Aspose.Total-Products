---
title: Java経由でAndoridのWORDにPOTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTMをWORDに変換する
url: /ja/android-java/conversion/potm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDにPOTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTMをWORDに変換するファイル形式のAPI" >}}
