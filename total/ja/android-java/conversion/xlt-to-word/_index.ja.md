---
title: AndroidのWORDにXLTをエクスポートする
description: MicrosoftWordを使用せずにXLTをWORDに変換するAndroidAPI
url: /ja/android-java/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のWORDにXLTをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLTをWORDに変換する" >}}
