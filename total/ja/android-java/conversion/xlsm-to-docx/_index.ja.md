---
title: AndroidのDOCXにXLSMをエクスポートする
description: MicrosoftWordを使用せずにXLSMをDOCXに変換するAndroidAPI
url: /ja/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のDOCXにXLSMをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLSMをDOCXに変換する" >}}
