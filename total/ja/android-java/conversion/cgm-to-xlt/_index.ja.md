---
title: Javaを介してAndroidでCGMをXLTに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでCGMをXLTにレンダリングする
url: /ja/android-java/conversion/cgm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: CGM
