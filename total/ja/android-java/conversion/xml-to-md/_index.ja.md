---
title: Javaを介してAndroidでXMLをMDに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでXMLをMDにレンダリングする
url: /ja/android-java/conversion/xml-to-md/
family: total
platformtag: cpp
feature: conversion
informat: XML
