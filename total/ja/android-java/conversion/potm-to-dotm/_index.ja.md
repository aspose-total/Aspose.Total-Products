---
title: Java経由でAndoridのDOTMにPOTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTMをDOTMに変換する
url: /ja/android-java/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTMにPOTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTMをDOTMに変換するファイル形式のAPI" >}}
