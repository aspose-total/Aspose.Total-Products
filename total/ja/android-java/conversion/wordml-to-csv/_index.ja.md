---
title: WORDMLをCSVに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでWORDMLをCSVに変換する
url: /ja/android-java/conversion/wordml-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでWORDMLをCSVに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのCSVにWORDMLをエクスポートする" >}}
...
2. [保存](https://reference.aspose.com/words/java/com.aspose.words/Wordmlument#save(java.lang.String,com.aspose.words.SaveOptions)を使用してWORDMLをHTMLに変換します) 方法
