---
title: ODTをXLTに変換するAndroidAPI
description: MicrosoftWordまたはMicrosoftExcelを使用せずに、Javaを介してAndroidでODTをXLTに変換する
url: /ja/android-java/conversion/odt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリケーションでODTをXLTに変換する" h2="Microsoft <sup>＆reg; </ sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにJava経由でAndroidのXLTにODTをエクスポートする" >}}
