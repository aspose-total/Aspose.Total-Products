---
title: Java経由でAndoridのODTにPPSをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPSをODTに変換する
url: /ja/android-java/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのODTにPPSをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPSをODTに変換するファイル形式のAPI" >}}
