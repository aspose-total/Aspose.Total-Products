---
title: Javaを介してAndroidでSVGをXLSBに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでSVGをXLSBにレンダリングする
url: /ja/android-java/conversion/svg-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: SVG
