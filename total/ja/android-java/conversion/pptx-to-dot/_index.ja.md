---
title: Java経由でAndoridのDOTにPPTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTXをDOTに変換する
url: /ja/android-java/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPPTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOTに変換するファイル形式のAPI" >}}
