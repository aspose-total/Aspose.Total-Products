...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOTに変換するファイル形式のAPI" >}}
