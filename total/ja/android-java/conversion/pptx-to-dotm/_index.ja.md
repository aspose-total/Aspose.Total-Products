...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTMにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをDOTMに変換するファイル形式のAPI" >}}
