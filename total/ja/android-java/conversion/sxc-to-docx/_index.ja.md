---
title: AndroidのDOCXにSXCをエクスポートする
description: MicrosoftWordを使用せずにSXCをDOCXに変換するAndroidAPI
url: /ja/android-java/conversion/sxc-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のDOCXにSXCをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でSXCをDOCXに変換する" >}}
