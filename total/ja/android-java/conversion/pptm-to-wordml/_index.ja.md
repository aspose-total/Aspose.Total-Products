---
title: Java経由でAndoridのWORDMLにPPTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTMをWORDMLに変換する
url: /ja/android-java/conversion/pptm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDMLにPPTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをWORDMLに変換するファイル形式のAPI" >}}
