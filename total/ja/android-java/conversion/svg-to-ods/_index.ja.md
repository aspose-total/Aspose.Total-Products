---
title: Javaを介してAndroidでSVGをODSに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでSVGをODSにレンダリングする
url: /ja/android-java/conversion/svg-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: SVG
