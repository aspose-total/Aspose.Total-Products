...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCにPOTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTXをDOCに変換するファイル形式のAPI" >}}
