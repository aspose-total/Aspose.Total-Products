...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCにPPTMをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをDOCに変換するファイル形式のAPI" >}}
