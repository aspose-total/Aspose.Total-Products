---
title: Java経由でAndoridのTEXTにPPTMをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTMをTEXTに変換する
url: /ja/android-java/conversion/pptm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのTEXTにPPTMをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTMをTEXTに変換するファイル形式のAPI" >}}
