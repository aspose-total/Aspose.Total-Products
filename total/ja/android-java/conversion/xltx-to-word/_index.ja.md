---
title: AndroidのWORDにXLTXをエクスポートする
description: MicrosoftWordを使用せずにXLTXをWORDに変換するAndroidAPI
url: /ja/android-java/conversion/xltx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のWORDにXLTXをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLTXをWORDに変換する" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/xltx-to-wordx/" name="XLTX に WORDX" description="" >}}
