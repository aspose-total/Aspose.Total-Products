...
{{< blocks/products/pf/feature-page-header h1="AndoridアプリでメールをTEXTに変換する" h2="JavaAPIを介してAndoridを使用してEMLXをTEXTにエクスポートするためのAndoridアプリケーションの設計" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="AndoridでEMLXをTEXTに変換する" %}}
