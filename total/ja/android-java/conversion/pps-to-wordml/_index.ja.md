---
title: Java経由でAndoridのWORDMLにPPSをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPSをWORDMLに変換する
url: /ja/android-java/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDMLにPPSをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPSをWORDMLに変換するファイル形式のAPI" >}}
