...
description: AndoridアプリケーションでMicrosoftWordまたはOutlookを使用せずにEMLXをOTTにエクスポートする
url: /ja/android-java/conversion/emlx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="AndoridアプリでメールをOTTに変換する" h2="JavaAPIを介してAndoridを使用してEMLXをOTTにエクスポートするためのAndoridアプリケーションの設計" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="AndoridでEMLXをOTTに変換する" %}}
