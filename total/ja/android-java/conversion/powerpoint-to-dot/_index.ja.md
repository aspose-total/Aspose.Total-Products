---
title: Java経由でAndoridのDOTにPOWERPOINTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOWERPOINTをDOTに変換する
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPOWERPOINTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOWERPOINTをDOTに変換するファイル形式のAPI" >}}
