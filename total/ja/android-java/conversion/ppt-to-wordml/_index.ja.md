---
title: Java経由でAndoridのWORDMLにPPTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTをWORDMLに変換する
url: /ja/android-java/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDMLにPPTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTをWORDMLに変換するファイル形式のAPI" >}}
