...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのWORDMLにPPTXをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをWORDMLに変換するファイル形式のAPI" >}}
