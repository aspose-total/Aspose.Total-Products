---
title: AndroidのDOCXにXLTXをエクスポートする
description: MicrosoftWordを使用せずにXLTXをDOCXに変換するAndroidAPI
url: /ja/android-java/conversion/xltx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のDOCXにXLTXをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLTXをDOCXに変換する" >}}
