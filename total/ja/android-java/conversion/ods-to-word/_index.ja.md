---
title: AndroidのWORDにODSをエクスポートする
description: MicrosoftWordを使用せずにODSをWORDに変換するAndroidAPI
url: /ja/android-java/conversion/ods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のWORDにODSをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でODSをWORDに変換する" >}}
