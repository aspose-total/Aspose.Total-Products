---
title: Java経由でAndoridのDOCMにPOTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTをDOCMに変換する
url: /ja/android-java/conversion/pot-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOCMにPOTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTをDOCMに変換するファイル形式のAPI" >}}
