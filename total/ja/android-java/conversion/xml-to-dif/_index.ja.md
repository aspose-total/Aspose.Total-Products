---
title: Javaを介してAndroidでXMLをDIFに変換する
description: MicrosoftExcelまたはAdobeReaderを使用せずに、JavaAPIを介してAndroidでXMLをDIFにレンダリングする
url: /ja/android-java/conversion/xml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: XML
