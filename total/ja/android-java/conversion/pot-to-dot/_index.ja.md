...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPOTをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTをDOTに変換するファイル形式のAPI" >}}
