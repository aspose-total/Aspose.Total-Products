---
title: Java経由でAndoridのDOTにPOTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPOTをDOTに変換する
url: /ja/android-java/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTにPOTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTをDOTに変換するファイル形式のAPI" >}}
