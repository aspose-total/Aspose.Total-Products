---
title: Javaを介してAndroidでFLATOPCをODPに変換する
description: Microsoft WordofPowerPointを使用せずにAndroidフォンでFLATOPCからODPに変換
url: /ja/android-java/conversion/flatopc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="AndroidアプリでFLATOPCをODPに変換する" h2="Microsoft Word <sup>＆reg;</sup>またはPowerPointをインストールせずにAndroidアプリケーションでFLATOPCからODPに変換" >}}
...
FLATOPCからODPファイルへの変換では、[Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total)そしてアプリにライブラリをインストールします。
