---
title: Java経由でAndoridのODTにPPTXをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTXをODTに変換する
url: /ja/android-java/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのODTにPPTXをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTXをODTに変換するファイル形式のAPI" >}}
