...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのRTFにPOTをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPOTをRTFに変換するファイル形式のAPI" >}}
