---
title: Java経由でAndoridのDOTXにPPTをエクスポートする
description: ソフトウェアをインストールせずにモバイルアプリでPPTをDOTXに変換する
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTXにPPTをレンダリングする" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTをDOTXに変換するファイル形式のAPI" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/ppt-to-dotxm/" name="PPT に DOTXM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/android-java/conversion/ppt-to-dotxx/" name="PPT に DOTXX" description="" >}}
