...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndoridのDOTXにPPTをレンダリングする またはオンライン" h2="Microsoft PowerPointやWordに依存せずに、Androidアプリ内でPPTをDOTXに変換するファイル形式のAPI" >}}
