---
title: AndroidのWORDにXLSMをエクスポートする
description: MicrosoftWordを使用せずにXLSMをWORDに変換するAndroidAPI
url: /ja/android-java/conversion/xlsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Java経由でAndroid上のWORDにXLSMをレンダリングする" h2="Microsoft <sup>＆reg; </ sup> Excelを使用せずに、Androidアプリケーション内でXLSMをWORDに変換する" >}}
