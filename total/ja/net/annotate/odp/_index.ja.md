---
title: ODP 注釈をオンラインで削除するか、.NET 経由で注釈を管理する
description: オンラインアプリを通じてODPファイルからコメントを無料で削除します。ODP ファイルのコメントを管理するための .NET API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="オンラインでの ODP プレゼンテーションからのコメントのクリアまたは .NET 経由での管理" h2="強力な .NET ベースの ODP プレゼンテーション注釈ユーティリティ アプリケーションを開発します。.NET を介して ODP ファイルのコメントを管理するためのコードのリスト。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET 経由で ODP プレゼンテーション コメントを削除する" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でODPプレゼンテーションコメントを追加" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">オンラインの ODP ドキュメントの注釈には、Google Chrome、Firefox、Opera、Safari などの最新の Web ブラウザを使用できます。ただし、デスクトップ アプリケーションを開発している場合は、効率的な管理のために Aspose.Total ドキュメント処理 API を使用することをお勧めします。</span>
                      </div>
                  </li>
              </ul>
          </div>
