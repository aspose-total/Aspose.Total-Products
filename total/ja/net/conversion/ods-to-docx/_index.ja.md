---
title: .NETを使用してODSをDOCXに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでODSをDOCXに変換する
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でODSをDOCXに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのODSからDOCXへ">}}
