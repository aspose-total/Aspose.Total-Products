...
{{% blocks/products/pf/agp/content h2="C＃を使用してPOTMをOTTに変換する方法" %}}
...
1. [Aspose.Words.Ottument]（https://apireference.aspose.com/words/net/aspose.words/ottument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Ottument.Save（ "output.ott"、SaveFormat.Ott）]（https://apireference.aspose.com/words/net/aspose.words.ottument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPOTMをOTTに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potm-to-ottx" name="POTM に OTTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potm-to-ottm" name="POTM に OTTM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potm-to-flatopc" name="POTM に FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potm-to-txt" name="POTM に TXT" description="" >}}
