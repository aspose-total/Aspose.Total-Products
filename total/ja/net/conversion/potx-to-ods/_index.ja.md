---
title: C＃を介してPOTXをODSに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTXをODSに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTXをODSに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTXからODSに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPOTXをODSに変換する方法" %}}
...
4. [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)メソッドを使用してドキュメントをODSに保存します
