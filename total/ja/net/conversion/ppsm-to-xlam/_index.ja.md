...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSMをXLAMに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSMをXLAMに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSMからXLAMに変換するための.NETAPI" >}}
