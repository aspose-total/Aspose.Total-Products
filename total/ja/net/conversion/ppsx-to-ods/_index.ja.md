---
title: C＃を介してPPSXをODSに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSXをODSに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSXをODSに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSXからODSに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPSXをODSに変換する方法" %}}
