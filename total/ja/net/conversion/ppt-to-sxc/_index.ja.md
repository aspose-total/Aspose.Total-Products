---
title: C＃を介してPPTをSXCに変換する またはオンライン
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTをSXCに変換する またはオンライン" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTからSXCに変換するための.NETAPI" >}}
