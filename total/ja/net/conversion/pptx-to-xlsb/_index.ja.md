...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTXをXLSBに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTXからXLSBに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPTXをXLSBに変換する方法" %}}
