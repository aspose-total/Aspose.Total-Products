---
title: C＃を介してPPSXをMARKDOWNに変換する またはオンライン
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSXをMARKDOWNに変換する またはオンライン" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSXからMARKDOWNに変換するための.NETAPI" >}}
