---
title: .NETを使用してXLSBをDOCXに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでXLSBをDOCXに変換する
url: /ja/net/conversion/xlsb-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLSBをDOCXに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLSBからDOCXへ">}}
