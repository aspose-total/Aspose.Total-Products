...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをXLTに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをXLTに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからXLTに変換するための.NETAPI" >}}
