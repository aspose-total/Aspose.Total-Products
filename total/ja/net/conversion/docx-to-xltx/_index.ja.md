...
description: MicrosoftExcelまたはAdobeReaderを使用せずにDOCXをXLTXに変換するC＃API
url: /ja/net/conversion/docx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOCXをXLTXに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でDOCXをXLTXにエクスポートする" >}}
