...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSMをXLTMに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSMをXLTMに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSMからXLTMに変換するための.NETAPI" >}}
