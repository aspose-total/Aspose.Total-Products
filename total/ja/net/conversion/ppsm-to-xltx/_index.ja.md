...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSMをXLTXに変換する
url: /ja/net/conversion/ppsm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSMをXLTXに変換する" h2="Microsoft <sup>＆reg; </sup>ExcelまたはPowerPointを使用せずにPPSMからXLTXに変換するための.NETAPI" >}}
