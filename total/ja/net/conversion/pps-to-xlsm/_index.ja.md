---
title: C＃を介してPPSをXLSMに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSをXLSMに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSをXLSMに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSからXLSMに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPSをXLSMに変換する方法" %}}
