---
title: C＃.NETを介してPPSMをDOCXに変換する 
url: /ja/net/conversion/ppsm-to-docx/ 
description: PowerPointのppsmドキュメントをC＃を使用してWordのドキュメントファイルに変換します。 ASP.NETまたは他の.NETアプリケーション内で複数のファイルを変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を使用してPPSMをDOCXに変換する" h2=".NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでMicrosoftPowerPointPPSMプレゼンテーションからWordDOCXドキュメントへの変換アプリを構築します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSM" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCXM" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSMをDOCXに変換する方法" %}}
...
1. [Aspose.Words.Docxument]（https://apireference.aspose.com/words/net/aspose.words/docxument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Docxument.Save（ "output.docx"、SaveFormat.Docx）]（https://apireference.aspose.com/words/net/aspose.words.docxument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPPSMをDOCXに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsm-to-docxx" name="PPSM に DOCXX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsm-to-docxm" name="PPSM に DOCXM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsm-to-flatopc" name="PPSM に FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsm-to-txt" name="PPSM に TXT" description="" >}}
