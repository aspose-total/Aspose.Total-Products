---
title: C＃.NETを介してPPSXをWORDMLに変換する 
url: /ja/net/conversion/ppsx-to-wordml/ 
description: PowerPointのppsxドキュメントをC＃を使用してWordのドキュメントファイルに変換します。 ASP.NETまたは他の.NETアプリケーション内で複数のファイルを変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を使用してPPSXをWORDMLに変換する" h2=".NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでMicrosoftPowerPointPPSXプレゼンテーションからWordWORDMLドキュメントへの変換アプリを構築します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="WORDMLM" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSXをWORDMLに変換する方法" %}}
...
1. [Aspose.Words.Wordmlument]（https://apireference.aspose.com/words/net/aspose.words/wordmlument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Wordmlument.Save（ "output.wordml"、SaveFormat.Wordml）]（https://apireference.aspose.com/words/net/aspose.words.wordmlument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPPSXをWORDMLに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsx-to-wordmlx" name="PPSX に WORDMLX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppsx-to-wordmlm" name="PPSX に WORDMLM" description="" >}}
