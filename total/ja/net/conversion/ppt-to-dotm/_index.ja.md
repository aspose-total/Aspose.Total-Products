...
url: /ja/net/conversion/ppt-to-dotm/ 
...
1. [Aspose.Words.Dotmument]（https://apireference.aspose.com/words/net/aspose.words/dotmument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Dotmument.Save（ "output.dotm"、SaveFormat.Dotm）]（https://apireference.aspose.com/words/net/aspose.words.dotmument/save/methods）を使用してドキュメントを保存します/ 3）
