...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをXLSBに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをXLSBに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからXLSBに変換するための.NETAPI" >}}
