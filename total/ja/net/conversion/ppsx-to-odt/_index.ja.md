...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSXをODTに変換する方法" %}}
...
1. [Aspose.Words.Odtument]（https://apireference.aspose.com/words/net/aspose.words/odtument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Odtument.Save（ "output.odt"、SaveFormat.Odt）]（https://apireference.aspose.com/words/net/aspose.words.odtument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPPSXをODTに変換する方法を示しています" offSpacer="" %}}
