...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTをXLSXに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTをXLSXに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTからXLSXに変換するための.NETAPI" >}}
