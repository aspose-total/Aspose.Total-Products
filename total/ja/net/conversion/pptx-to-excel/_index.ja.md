...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTXをEXCELに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTXからEXCELに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPTXをEXCELに変換する方法" %}}
