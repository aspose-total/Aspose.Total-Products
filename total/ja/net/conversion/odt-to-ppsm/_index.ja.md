...
{{% blocks/products/pf/agp/content h2="C＃を使用してODTをPPSMに変換する方法" %}}
...
1. [Aspose.Words.Odtument]（https://apireference.aspose.com/words/net/aspose.words/odtument）クラスを使用してODTファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してODTをPPSMに変換する方法を示しています" offSpacer="" %}}
