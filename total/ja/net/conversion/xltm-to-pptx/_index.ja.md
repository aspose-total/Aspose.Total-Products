---
title: .NETを使用してXLTMをPPTXに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでXLTMをPPTXに変換する
url: /ja/net/conversion/xltm-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLTMをPPTXに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLTMからPPTXへ">}}
