...
description: MicrosoftExcelまたはAdobeReaderを使用せずにRTFをFODSに変換するC＃API
url: /ja/net/conversion/rtf-to-fods/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="RTFをFODSに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でRTFをFODSにエクスポートする" >}}
