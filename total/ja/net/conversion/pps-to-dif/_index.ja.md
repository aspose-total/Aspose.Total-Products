---
title: C＃を介してPPSをDIFに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSをDIFに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSをDIFに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSからDIFに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPSをDIFに変換する方法" %}}
