---
title: .NETを使用してXLSをWORDに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでXLSをWORDに変換する
url: /ja/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLSをWORDに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLSからWORDへ">}}
