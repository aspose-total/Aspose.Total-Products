---
title: C＃を介してPOTMをMARKDOWNに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをMARKDOWNに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをMARKDOWNに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからMARKDOWNに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPOTMをMARKDOWNに変換する方法" %}}
