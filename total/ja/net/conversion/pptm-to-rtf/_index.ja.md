...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPTMをRTFに変換する方法" %}}
...
1. [Aspose.Words.Rtfument]（https://apireference.aspose.com/words/net/aspose.words/rtfument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Rtfument.Save（ "output.rtf"、SaveFormat.Rtf）]（https://apireference.aspose.com/words/net/aspose.words.rtfument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPPTMをRTFに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pptm-to-rtfx" name="PPTM に RTFX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pptm-to-rtfm" name="PPTM に RTFM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pptm-to-flatopc" name="PPTM に FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pptm-to-txt" name="PPTM に TXT" description="" >}}
