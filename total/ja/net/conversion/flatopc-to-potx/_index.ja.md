---
title: C＃.NETを介してFLATOPCをPOTXに変換する 
url: /ja/net/conversion/flatopc-to-potx/ 
description: C＃を使用してWordドキュメントドキュメントをPowerPointpotxファイルに変換します。 ASP.NETまたは他の.NETアプリケーション内で複数のファイルを変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="C＃を使用してFLATOPCをPOTXに変換する" h2=".NET Framework、.NET Core、Windows Azure、Mono、またはXamarinプラットフォームでMicrosoftWordFLATOPCからPowerPointPOTXへの変換アプリを構築します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FLATOPCM" >}}
...
{{% blocks/products/pf/agp/content h2="C＃を使用してFLATOPCをPOTXに変換する方法" %}}
...
1. [Aspose.Words.Flatopcument]（https://apireference.aspose.com/words/net/aspose.words/flatopcument）クラスを使用してFLATOPCファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してFLATOPCをPOTXに変換する方法を示しています" offSpacer="" %}}
