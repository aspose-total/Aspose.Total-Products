---
title: C＃を介してPOTMをEXCELに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをEXCELに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをEXCELに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからEXCELに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPOTMをEXCELに変換する方法" %}}
