...
4. [保存](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)メソッドを使用してドキュメントをDICOM形式で保存します
...
[保存](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)メソッドを使用してDICOM形式で保存します。  
{{% blocks/products/pf/feature-page-code %}}
