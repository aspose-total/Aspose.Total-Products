...
description: MicrosoftExcelまたはAdobeReaderを使用せずにDOCXをXLSBに変換するC＃API
url: /ja/net/conversion/docx-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOCXをXLSBに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でDOCXをXLSBにエクスポートする" >}}
