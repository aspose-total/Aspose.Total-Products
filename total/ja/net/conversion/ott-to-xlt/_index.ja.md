...
{{< blocks/products/pf/i18n/feature-page-header h1="OTTをXLTに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でOTTをXLTにエクスポートする" >}}
