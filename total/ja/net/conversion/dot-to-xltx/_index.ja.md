...
description: MicrosoftExcelまたはAdobeReaderを使用せずにDOTをXLTXに変換するC＃API
url: /ja/net/conversion/dot-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="DOTをXLTXに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でDOTをXLTXにエクスポートする" >}}
