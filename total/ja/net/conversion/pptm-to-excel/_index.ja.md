...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPTMをEXCELに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTMをEXCELに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTMからEXCELに変換するための.NETAPI" >}}
