...
{{% blocks/products/pf/agp/content h2="C＃を使用してPOTXをDOCMに変換する方法" %}}
...
1. [Aspose.Words.Docmument]（https://apireference.aspose.com/words/net/aspose.words/docmument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Docmument.Save（ "output.docm"、SaveFormat.Docm）]（https://apireference.aspose.com/words/net/aspose.words.docmument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPOTXをDOCMに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potx-to-docmx" name="POTX に DOCMX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potx-to-docmm" name="POTX に DOCMM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potx-to-flatopc" name="POTX に FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/potx-to-txt" name="POTX に TXT" description="" >}}
