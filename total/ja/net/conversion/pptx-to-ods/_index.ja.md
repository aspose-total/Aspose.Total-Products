...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTXをODSに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTXからODSに変換するための.NETAPI" >}}
...
2. [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)メソッドを使用してPPTXをHTMLとしてエクスポートします
