...
description: MicrosoftExcelまたはAdobeReaderを使用せずにRTFをEXCELに変換するC＃API
url: /ja/net/conversion/rtf-to-excel/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="RTFをEXCELに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でRTFをEXCELにエクスポートする" >}}
