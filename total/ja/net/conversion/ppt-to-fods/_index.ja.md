---
title: C＃を介してPPTをFODSに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPTをFODSに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTをFODSに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTからFODSに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPTをFODSに変換する方法" %}}
