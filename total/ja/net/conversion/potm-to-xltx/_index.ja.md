...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをXLTXに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをXLTXに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからXLTXに変換するための.NETAPI" >}}
