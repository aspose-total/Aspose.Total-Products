...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLTXをDOCに変換 またはオンラインアプリ" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLTXからDOCへ">}}
