...
{{% blocks/products/pf/agp/content h2="C＃を使用してOTTをODPに変換する方法" %}}
...
1. [Aspose.Words.Ottument]（https://apireference.aspose.com/words/net/aspose.words/ottument）クラスを使用してOTTファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してOTTをODPに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ott-to-odp/" name="OTT に ODP" description="" >}}
