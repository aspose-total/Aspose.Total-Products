...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPSXをXLSBに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPSXをXLSBに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSXからXLSBに変換するための.NETAPI" >}}
