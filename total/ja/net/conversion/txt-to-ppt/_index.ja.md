...
{{% blocks/products/pf/agp/content h2="C＃を使用してTXTをPPTに変換する方法" %}}
...
1. [Aspose.Words.Txtument]（https://apireference.aspose.com/words/net/aspose.words/txtument）クラスを使用してTXTファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してTXTをPPTに変換する方法を示しています" offSpacer="" %}}
