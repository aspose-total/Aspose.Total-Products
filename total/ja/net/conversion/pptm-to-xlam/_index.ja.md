...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPTMをXLAMに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTMをXLAMに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTMからXLAMに変換するための.NETAPI" >}}
