---
title: .NETを使用してODSをDOCに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでODSをDOCに変換する
url: /ja/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でODSをDOCに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのODSからDOCへ">}}
