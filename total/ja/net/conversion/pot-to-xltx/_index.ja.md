...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTをXLTXに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTをXLTXに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTからXLTXに変換するための.NETAPI" >}}
