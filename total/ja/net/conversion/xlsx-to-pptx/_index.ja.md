---
title: .NETを使用してXLSXをPPTXに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでXLSXをPPTXに変換する
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLSXをPPTXに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLSXからPPTXへ">}}
