...
description: MicrosoftExcelまたはAdobeReaderを使用せずにOTTをXLTMに変換するC＃API
url: /ja/net/conversion/ott-to-xltm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="OTTをXLTMに変換するC＃API" h2="Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg;</sup> Excelを使用せずにC＃経由でOTTをXLTMにエクスポートする" >}}
