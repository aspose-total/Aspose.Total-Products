...
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPOTMをXLSに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPOTMをXLSに変換する" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTMからXLSに変換するための.NETAPI" >}}
