---
title: C＃を介してPPTMをXLTMに変換する またはオンライン
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTMをXLTMに変換する またはオンライン" h2="Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPTMからXLTMに変換するための.NETAPI" >}}
