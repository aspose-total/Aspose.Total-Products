---
title: .NETを使用してXLSをDOCXに変換する 
description: .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでXLSをDOCXに変換する
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="C＃経由でXLSをDOCXに変換" h2="Excelをエクスポート＆reg; .NET Framework、.NET Core、Mono、またはXamarinプラットフォームでのXLSからDOCXへ">}}
