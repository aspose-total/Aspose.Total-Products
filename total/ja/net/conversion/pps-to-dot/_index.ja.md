...
{{% blocks/products/pf/agp/content h2="C＃を使用してPPSをDOTに変換する方法" %}}
...
1. [Aspose.Words.Dotument]（https://apireference.aspose.com/words/net/aspose.words/dotument）を作成し、MemoryStreamオブジェクトで初期化します。
1. [Aspose.Words.Dotument.Save（ "output.dot"、SaveFormat.Dot）]（https://apireference.aspose.com/words/net/aspose.words.dotument/save/methods）を使用してドキュメントを保存します/ 3）
...
{{% blocks/products/pf/agp/code-block title="このコードサンプルは、C＃を使用してPPSをDOTに変換する方法を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pps-to-flatopc" name="PPS に FLATOPC" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/pps-to-txt" name="PPS に TXT" description="" >}}
