---
title: C＃を介してPPTをXLTXに変換する
description: Microsoft ExcelまたはPowerpointを使用せずにC＃でPPTをXLTXに変換する
url: /ja/net/conversion/ppt-to-xltx/
family: total
platformtag: net
feature: conversion
informat: PPT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C＃を介してPPTをXLTXに変換する" h2="Microsoft <sup>＆reg; </sup>ExcelまたはPowerPointを使用せずにPPTからXLTXに変換するための.NETAPI" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C＃を介してPPTをXLTXに変換する方法" %}}
