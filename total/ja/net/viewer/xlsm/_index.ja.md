---
title: .NET を使用して XLSM ファイルをオンラインで表示する
description: 無料のオンライン XLSM ファイル ビューア アプリ。ビューア アプリケーション用の XLSM ファイルを読み取るための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="XLSM ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの XLSM ドキュメント ビューア ユーティリティ アプリケーションを開発します。 XLSM ドキュメントを表示するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でXLSMファイルを表示" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード : XLSM スプレッドシートの表示" offSpacer="" %}}
