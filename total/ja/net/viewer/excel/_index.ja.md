---
title: .NET を使用して Excel ファイルをオンラインで表示する
description: 無料のオンライン Excel ファイル ビューア アプリ。ビューア アプリケーション用の Excel ファイルを読み取るための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="Excel ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの Excel ドキュメント ビューア ユーティリティ アプリケーションを開発します。 Excel ドキュメントを表示するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でExcelファイルを表示" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード : Excel スプレッドシートの表示" offSpacer="" %}}
