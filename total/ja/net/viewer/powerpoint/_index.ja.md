---
title: .NET を使用して Powerpoint ファイルをオンラインで表示する
description: 無料のオンライン Powerpoint ファイル ビューア アプリ。ビューア アプリケーションの Powerpoint プレゼンテーションを表示するための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="Powerpoint ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの Powerpoint プレゼンテーション ビューア ユーティリティ アプリケーションを開発します。 Powerpoint プレゼンテーションを表示するための C# コードのリスト。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="オンライン アプリで Powerpoint プレゼンテーションを表示" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET 経由で Powerpoint プレゼンテーションを表示する" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード: Powerpoint プレゼンテーションの表示" offSpacer="" %}}
