---
title: .NET を使用して XLS ファイルをオンラインで表示する
description: 無料のオンライン XLS ファイル ビューア アプリ。ビューア アプリケーション用の XLS ファイルを読み取るための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="XLS ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの XLS ドキュメント ビューア ユーティリティ アプリケーションを開発します。 XLS ドキュメントを表示するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でXLSファイルを表示" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード : XLS スプレッドシートの表示" offSpacer="" %}}
