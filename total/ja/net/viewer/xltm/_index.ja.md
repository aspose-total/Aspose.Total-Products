---
title: .NET を使用して XLTM ファイルをオンラインで表示する
description: 無料のオンライン XLTM ファイル ビューア アプリ。ビューア アプリケーション用の XLTM ファイルを読み取るための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="XLTM ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの XLTM ドキュメント ビューア ユーティリティ アプリケーションを開発します。 XLTM ドキュメントを表示するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でXLTMファイルを表示" %}}

1. .NET ライブラリ参照をプロジェクトに追加する
1. Workbookクラスオブジェクトを使用してソースXLTMファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="C# コード : XLTM スプレッドシートの表示" offSpacer="" %}}
