---
title: .NET を使用して PPSM ファイルをオンラインで表示する
description: 無料のオンライン PPSM ファイル ビューア アプリ。ビューア アプリケーションの PPSM プレゼンテーションを表示するための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="PPSM ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの PPSM プレゼンテーション ビューア ユーティリティ アプリケーションを開発します。 PPSM プレゼンテーションを表示するための C# コードのリスト。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="オンライン アプリで PPSM プレゼンテーションを表示" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET 経由で PPSM プレゼンテーションを表示する" %}}

1. .NET ライブラリ参照をプロジェクトに追加する
1. プレゼンテーションクラスオブジェクトを使用してソースPPSMファイルをロードします
...
{{% blocks/products/pf/agp/code-block title="C# コード: PPSM プレゼンテーションの表示" offSpacer="" %}}
