---
title: .NET を使用して XLTX ファイルをオンラインで表示する
description: 無料のオンライン XLTX ファイル ビューア アプリ。ビューア アプリケーション用の XLTX ファイルを読み取るための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="XLTX ファイルをオンラインまたは .NET 経由で自由に表示" h2="強力な .NET ベースの XLTX ドキュメント ビューア ユーティリティ アプリケーションを開発します。 XLTX ドキュメントを表示するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でXLTXファイルを表示" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード : XLTX スプレッドシートの表示" offSpacer="" %}}
