---
title: オンラインまたは .NET を使用して XLS スプレッドシートを編集する
description: アプリ経由で XLS ドキュメントをオンラインで無料で開いて編集できます。 XLS テキストを検索および置換するための .NET API C# コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="オンラインまたは .NET 経由で XLS ドキュメントを編集する" h2="強力な .NET ベースの XLS ドキュメント編集ユーティリティ アプリケーションを開発します。 XLS ファイル内のテキストを検索および置換するための C# コードがリストされています。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET経由でXLSファイルを編集する" %}}
...
{{% blocks/products/pf/agp/code-block title="C# コード: XLS スプレッドシートを編集する" offSpacer="" %}}
...
<h2>.NET 経由で XLS リダクション アプリケーションを開発する</h2>

XLS 編集アプリまたはユーティリティを開発する必要がありますか? [Aspose.Total for .NET](https://products.aspose.com/total/ja/net/) の子 API である [Aspose.Cells for .NET](https://products.aspose.com/cells/ja/net/) を使用すると、.NET 開発者は、ドキュメント編集アプリケーション内に上記の API コードを統合できます。強力な .NET ライブラリにより、あらゆるスプレッドシート編集ソリューションをプログラミングできます。さらに、XLS 形式を含む多くの一般的な形式をサポートできます。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="XLS ファイルを編集するための .NET ユーティリティ" %}}
...
- ビジネススプレッドシートでの金額、予算ライン、給与詳細の編集。
- 人事または財務レポートでの従業員データや監査結果の編集。
- 共有された運用ファイルでの顧客やベンダー情報の編集。
