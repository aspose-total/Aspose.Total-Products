---
title: ODT プロパティをオンラインで表示および更新するか、.NET を使用してメタデータを更新する
description: オンライン アプリを通じて ODT プロパティを無料で表示および変更できます。 ODT プロパティを更新および追加するための C# .NET API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="ODT メタデータをオンラインで表示または更新するか、.NET 経由で更新します" h2="強力な .NET ベースの ODT ドキュメント メタデータ管理ユーティリティ アプリケーションを開発します。.NET を介して ODT ファイルのメタデータを追加および変更するためのコードのリスト。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET 経由で ODT プロパティを管理する" %}}

1. ワークブッククラスを作成します。
1. BuiltInDocumentProperties を使用してシステム定義のプロパティにアクセスする
1. 言語などの更新された値を割り当てる
1. Save() メソッドを呼び出して、更新された ODT ドキュメントを保存します。
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title=".NET コード: ODT メタデータを更新する" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title=".NET コード: ODT カスタム プロパティを追加する" offSpacer="" %}}
...
<h2>.NET 経由で ODT メタデータ管理アプリケーションを開発する</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT メタデータを管理するための .NET ユーティリティ" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📘 OpenDocument Text（.odt）の使用事例

- オフィススイート間の互換性を確保するためにメタデータを使用します。
- 寄稿者と協力履歴を追跡します。
- エンタープライズシステム内でオープンフォーマットのドキュメントを整理および検索します。
- ODTを解析するAI/MLエンジンをサポートします。
