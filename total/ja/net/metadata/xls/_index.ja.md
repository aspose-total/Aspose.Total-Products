---
title: XLS プロパティをオンラインで表示および更新するか、.NET を使用してメタデータを更新する
description: オンライン アプリを通じて XLS プロパティを無料で表示および変更できます。 XLS プロパティを更新および追加するための C# .NET API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="XLS メタデータをオンラインで表示または更新するか、.NET 経由で更新します" h2="強力な .NET ベースの XLS ドキュメント メタデータ管理ユーティリティ アプリケーションを開発します。.NET を介して XLS ファイルのメタデータを追加および変更するためのコードのリスト。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="XLS メタデータをオンラインで表示または更新する" %}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET 経由で XLS プロパティを管理する" %}}

1. ワークブッククラスを作成します。
1. BuiltInDocumentProperties を使用してシステム定義のプロパティにアクセスする
1. 言語などの更新された値を割り当てる
1. Save() メソッドを呼び出して、更新された XLS ドキュメントを保存します。
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title=".NET コード: XLS メタデータを更新する" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title=".NET コード: XLS カスタム プロパティを追加する" offSpacer="" %}}
...
<h2>.NET 経由で XLS メタデータ管理アプリケーションを開発する</h2>

XLS メタデータ管理アプリまたはユーティリティを開発する必要がありますか?[Aspose.Total for .NET](https://products.aspose.com/total/ja/net/) の子 API である [Aspose.Cells for .NET](https://products.aspose.com/cells/ja/net/) を使用すると、.NET 開発者は上記の API コードをドキュメント メタデータ アプリケーション内に統合できます。強力な .NET ライブラリにより、あらゆるドキュメント メタデータ ソリューションをプログラミングできます。さらに、XLS 形式を含む多くの一般的な形式をサポートできます。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="XLS メタデータを管理するための .NET ユーティリティ" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📊 Excelスプレッドシート（`.xls`）の使用例

- ドキュメントの目的と所有権メタデータを保存します。
- 内部ファイルの追跡と検索を改善します。
- メタデータルールを使用して財務またはプロジェクトベースのワークフローを自動化します。
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">オンラインの XLS ドキュメント プロパティ管理には、Google Chrome、Firefox、Opera、Safari などの最新の Web ブラウザを使用できます。ただし、デスクトップ アプリケーションを開発している場合は、効率的な管理のために Aspose.Total ドキュメント処理 API を使用することをお勧めします。</span>
                      </div>
                  </li>
              </ul>
          </div>
