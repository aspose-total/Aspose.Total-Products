---
title: オンラインまたは Java を使用して DOC ドキュメントを編集する
description: アプリ経由で DOC ドキュメントをオンラインで無料で開いて編集できます。DOC テキストを検索し、正規表現で置換する Java API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="DOC ドキュメントをオンラインまたは Java 経由で編集する" h2="強力な Java ベースの DOC ドキュメント編集ユーティリティ アプリケーションを開発します。Java を介して正規表現を使用して DOC ファイル内のテキストを検索および置換するためにリストされたコード。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java 経由で DOC ファイルを編集する" %}}

1. Java プロジェクトにライブラリ参照を追加する
1. Documentクラスを使用してDOCファイルをロードします
1. 正規表現パターン配列を定義する
1. 配列を反復処理し、
1. getRange().replace メソッドを関連パラメータとともに使用します
1. DOC ドキュメントを保存します。
...
{{% blocks/products/pf/agp/code-block title="Java コード: DOC ドキュメントを編集する" offSpacer="" %}}
...
<h2>Java 経由で DOC リダクション アプリケーションを開発する</h2>

DOC 編集アプリまたはユーティリティを開発する必要がありますか?[Aspose.Total for Java](https://products.aspose.com/total/ja/java/) の子 API である [Aspose.Words for Java](https://products.aspose.com/words/ja/java/) を使用すると、Java 開発者はドキュメント編集アプリケーション内に上記の API コードを統合できます。強力な Java ライブラリにより、あらゆる文書編集ソリューションをプログラミングできます。さらに、DOC 形式を含む多くの一般的な形式をサポートできます。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC ファイルを編集するための Java ユーティリティ" %}}
