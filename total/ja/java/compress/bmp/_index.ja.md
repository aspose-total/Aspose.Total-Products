---
title: BMP ファイルをオンラインまたは Java 経由で圧縮する
description: さまざまな BMP ファイルを圧縮する無料のオンライン アプリ。BMP ドキュメント用の Java 圧縮ライブラリ コード。 
...
{{< blocks/products/pf/feature-page-header-widget h1="圧縮アプリまたはJavaを使用してBMPファイルをオンラインで圧縮します" h2="強力な Java ベースの BMP ドキュメント圧縮アプリケーションを開発します。BMP ファイルを含むさまざまなドキュメントをアプリ経由でオンラインで自由に圧縮し、即時ダウンロードできます。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="アプリを使用してオンラインで BMP ファイルを圧縮および最適化する" %}}

1. BMP ファイルをアップロードして圧縮および最適化する
1. 圧縮レベルを選択します (低、中、または高)
1. 「圧縮」ボタンをクリックします
1. 圧縮されたBMPファイルをダウンロードします
1. サイズとコンテンツの品質を確認して、圧縮結果を表示および取得します。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Java経由でBMPファイルを圧縮" %}}

1. Java ライブラリ参照を Java プロジェクトに追加する
1. Documentクラスオブジェクトの作成
1. それをDocumentBuilderクラスオブジェクトにロードします。
1. insertImage() メソッドを使用して BMP イメージをインポートします
1. ImageSaveOptions を使用して品質を設定する
1. save メソッドを呼び出して、圧縮された BMP ファイルを取得します。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="BMP ファイルを圧縮する Java のコード例" offSpacer="" %}}
...
<h2>Javaを使用したBMPファイル圧縮アプリケーションの開発</h2>

複数の BMP ファイルを簡単に圧縮する Java スクリプトまたはユーティリティ アプリを開発する必要がありますか?[Aspose.Total for Java](https://products.aspose.com/total/ja/java/) の子 API である [Aspose.Words for Java](https://products.aspose.com/words/ja/java/) を使用すると、Java 開発者は上記の API コードを統合して画像圧縮アプリをプログラムできます。もう 1 つの方法は、[Aspose.Total for Java](https://products.aspose.com/total/ja/java/) API の一部である [Aspose.Imaging for Java](https://products.aspose.com/imaging/ja/java/) API を使用することです。[画像圧縮](https://products.aspose.com/imaging/ja/java/compress/) 用の強力な Java ライブラリは、BMP 形式を含む多くの一般的な形式をサポートしています。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="BMP ファイル用の Java 圧縮ライブラリ" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">はい、このコードをダウンロードして構いません。 Java を使用して BMP ファイルを圧縮する専門的なソリューションを簡単に開発できます。 Aspose BMP 圧縮 API を使用して、Java でプラットフォームに依存しない高レベルのソフトウェアを開発します。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
