---
title: MHTML ファイルをオンラインまたは Java 経由で圧縮する
description: さまざまな MHTML ファイルを圧縮する無料のオンライン アプリ。 MHTML ドキュメント用の Java 圧縮ライブラリ コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="圧縮アプリまたはJavaを使用してMHTMLファイルをオンラインで圧縮します" h2="強力な Java ベースの MHTML ドキュメント圧縮アプリケーションを開発します。MHTML ファイルを含むさまざまなドキュメントをアプリ経由でオンラインで自由に圧縮し、即時ダウンロードできます。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java経由でMHTMLファイルを圧縮" %}}

1. Java ライブラリをプロジェクトに参照する
1. ドキュメントをロードします
1. 画像を持つすべてのノードを取得し、各ノードをループします
1. setImageを使用して圧縮画像を設定します
1. save メソッドを呼び出して、圧縮された MHTML ファイルを取得します

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="MHTML ファイルを圧縮する Java のコード例" offSpacer="" %}}
...
<h2>Javaを使用したMHTMLファイル圧縮アプリケーションの開発</h2>

複数の MHTML ファイルを簡単に圧縮する Java スクリプトまたはユーティリティ アプリを開発する必要がありますか?[Aspose.Total for Java](https://products.aspose.com/total/ja/java/) の [Aspose.Words for Java](https://products.aspose.com/words/ja/java/) 子 API を使用すると、Java 開発者は上記の API コードを統合して、複数のドキュメントにわたる圧縮アプリをプログラムできます。ドキュメント圧縮用の強力な Java ライブラリは、MHTML 形式を含む多くの一般的な形式をサポートしています。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="MHTML ファイル用の Java 圧縮ライブラリ" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">はい、このコードをダウンロードして構いません。Java を使用して MHTML ファイルを圧縮する専門的なソリューションを簡単に開発できます。Aspose MHTML 圧縮 API を使用して、Java でプラットフォームに依存しない高レベルのソフトウェアを開発します。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
