...
description: MicrosoftExcelまたはPowerPointを使用せずにJava経由でPOTMをSXC形式に変換する
url: /ja/java/conversion/potm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPOTMをSXCに変換する" h2="オンプレミスのJavaAPIを使用して、Microsoft <sup>＆reg; </sup>ExcelまたはPowerPointを使用せずにPOTMをSXCにエクスポートする" >}}
