---
title: Javaを使用してSXCをPPTXに変換する
description: ExcelまたはWordを使用してSXCをPPTXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="SXCをPPTXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにSXCをPPTXにエクスポートします。" >}}
