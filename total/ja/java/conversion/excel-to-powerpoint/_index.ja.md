---
title: Javaを使用してEXCELをPOWERPOINTに変換する
description: ExcelまたはWordを使用してEXCELをPOWERPOINTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="EXCELをPOWERPOINTにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにEXCELをPOWERPOINTにエクスポートします。" >}}
...
1. [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)クラスを使用してEXCELファイルを開きます
