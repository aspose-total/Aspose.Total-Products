---
title: Javaを使用してXLTMをPOWERPOINTに変換する
description: ExcelまたはWordを使用してXLTMをPOWERPOINTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTMをPOWERPOINTにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLTMをPOWERPOINTにエクスポートします。" >}}
