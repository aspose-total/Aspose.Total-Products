---
title: Javaを使用してXLSXをPPTXに変換する
description: ExcelまたはWordを使用してXLSXをPPTXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSXをPPTXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSXをPPTXにエクスポートします。" >}}
