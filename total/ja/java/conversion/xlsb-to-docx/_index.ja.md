---
title: Javaを使用してXLSBをDOCXに変換する
description: ExcelまたはWordを使用してXLSBをDOCXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSBをDOCXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSBをDOCXにエクスポートします。" >}}
...
1. [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)クラスを使用してXLSBファイルを開きます
