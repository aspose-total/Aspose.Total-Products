---
title: DOCXをXLTMに変換するJavaAPI
description: MicrosoftWordやMicrosoftExcelを使用せずに、Java経由でDOCXをXLTMに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でDOCXをXLTMに変換する" h2="オンプレミスのJavaAPIを使用して、Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにDOCXをXLTMに変換する" >}}
