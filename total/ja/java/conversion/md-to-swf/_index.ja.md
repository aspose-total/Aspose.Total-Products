...
url_ignore: /ja/java/conversion/md-to-swf/
family: total
platformtag: net
feature: conversion
informat: MD
...
MDをSWFに変換した後、プレゼンテーションに事前定義されたビュータイプを追加することもできます。 [Aspose.Slides for Java](https://products.aspose.com/slides/java/)は、[ViewProperties](https：/)を介してPowerPointで開いたときに、生成されたプレゼンテーションのビュータイプを設定する機能を提供します。 /apireference.aspose.com/slides/java/com.aspose.slides/ViewProperties)クラス。 [setLastView](https://reference.aspose.com/slides/java/com.aspose.slides/ViewProperties#setLastView-int-)プロパティは、[ViewType](https：/ /apireference.aspose.com/slides/java/com.aspose.slides/ViewType)列挙子。 
{{% blocks/products/pf/feature-page-code %}}
...
Markdown（MD）をSWF（Shockwave Flash）に変換すると、テキスト、図、チャートをインタラクティブなFlashアニメーションに変換できます。SWFは、古い教育コンテンツ、チュートリアル、アニメーションWebプレゼンテーションに最適です。
...
* MarkdownチュートリアルをインタラクティブなSWFコンテンツに変換する。

* Markdownから生成されたeラーニングモジュール用のアニメーション図。

* Web配信用の古いFlashベースのプレゼンテーション。

* 教育プラットフォームにインタラクティブなMarkdownビジュアルを埋め込む。
...
* オンライントレーニング資料用の自動化されたMarkdown-to-SWFパイプライン。

* MDコンテンツのバッチ変換をインタラクティブなFlashファイルに。

* Markdownから派生したSWF学習モジュールの定期的な更新。

* Webベースの古いプラットフォーム向けのSWFビジュアルのトリガー生成。
