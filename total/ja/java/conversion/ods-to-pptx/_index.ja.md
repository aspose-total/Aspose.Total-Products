---
title: Javaを使用してODSをPPTXに変換する
description: ExcelまたはWordを使用してODSをPPTXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="ODSをPPTXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにODSをPPTXにエクスポートします。" >}}
