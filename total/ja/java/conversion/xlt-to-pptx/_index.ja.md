---
title: Javaを使用してXLTをPPTXに変換する
description: ExcelまたはWordを使用してXLTをPPTXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTをPPTXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLTをPPTXにエクスポートします。" >}}
