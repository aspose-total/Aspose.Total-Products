---
title: Javaを使用してXLSBをPOWERPOINTに変換する
description: ExcelまたはWordを使用してXLSBをPOWERPOINTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSBをPOWERPOINTにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSBをPOWERPOINTにエクスポートします。" >}}
