...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLTをWORDにエクスポートします。" >}}
...
1. [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)クラスを使用してXLTファイルを開きます
