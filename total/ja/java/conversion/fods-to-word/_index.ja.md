---
title: Javaを使用してFODSをWORDに変換する
description: ExcelまたはWordを使用してFODSをWORDにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="FODSをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにFODSをWORDにエクスポートします。" >}}
