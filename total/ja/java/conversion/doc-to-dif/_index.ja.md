...
description: MicrosoftWordやMicrosoftExcelを使用せずに、Java経由でDOCをDIFに変換する
url: /ja/java/conversion/doc-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でDOCをDIFに変換する" h2="オンプレミスのJavaAPIを使用して、Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにDOCをDIFに変換する" >}}
...
4. [保存]（https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells）を使用して、ドキュメントをDIF形式で保存します。 SaveOptions））メソッド
