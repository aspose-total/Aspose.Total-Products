---
title: Java経由でEMLXをFLATOPCにエクスポートする
description: MicrosoftWordやOutlookを使用せずにEMLXをFLATOPCに変換するJavaAPI
url_ignore: /ja/java/conversion/emlx-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: EMLX
