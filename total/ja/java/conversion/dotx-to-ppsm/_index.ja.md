---
title: Java経由でDOTXをPPSMに変換する
description: MicrosoftWordやPowerPointを使用せずにDOTXをPPSMにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でDOTXをPPSMに変換する" h2="Microsoft<sup>＆reg;</sup> PowerPointまたはWordを使用せずに、Java J2SE、J2EE、J2MEアプリケーション内でオンプレミスのJavaAPIを使用することによるDOTXからPPSMへの変換" >}}
