---
title: Javaを使用してXLTMをDOCに変換する
description: ExcelまたはWordを使用してXLTMをDOCにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTMをDOCにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLTMをDOCにエクスポートします。" >}}
