---
title: Javaを使用してFODSをDOCに変換する
description: ExcelまたはWordを使用してFODSをDOCにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="FODSをDOCにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにFODSをDOCにエクスポートします。" >}}
