---
title: Javaを使用してXLSXをDOCXに変換する
description: ExcelまたはWordを使用してXLSXをDOCXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSXをDOCXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSXをDOCXにエクスポートします。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/xlsx-to-docxx/" name="XLSX に DOCXX" description="" >}}
