---
title: Javaを使用してXLSをWORDに変換する
description: ExcelまたはWordを使用してXLSをWORDにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSをWORDにエクスポートします。" >}}
