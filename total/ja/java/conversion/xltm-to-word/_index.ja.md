---
title: Javaを使用してXLTMをWORDに変換する
description: ExcelまたはWordを使用してXLTMをWORDにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLTMをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLTMをWORDにエクスポートします。" >}}
