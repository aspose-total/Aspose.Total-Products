...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSをDOCにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSをDOCにエクスポートします。" >}}
...
1. [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)クラスを使用してXLSファイルを開きます
