...
APIを使用すると、パスワードで保護されたOTTドキュメントをPPTXに変換することもできます。入力OTTドキュメントがパスワードで保護されている場合、パスワードを使用せずにPPTX形式に変換することはできません。暗号化されたドキュメントを開くには、LoadOptionsオブジェクトに正しいパスワードを設定し、それをOttumentコンストラクターに渡すことができます。  
{{% blocks/products/pf/feature-page-code %}}
