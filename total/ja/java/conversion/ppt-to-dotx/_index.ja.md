---
title: Java経由でPPTをDOTXに変換する
description: MicrosoftWordやPowerPointを使用せずにPPTをDOTXにエクスポートするJavaAPI
url: /ja/java/conversion/ppt-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PPT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPTをDOTXに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPTからDOTXへの変換のためのオンプレミスJavaAPI" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppt-to-dotxm/" name="PPT に DOTXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppt-to-dotxx/" name="PPT に DOTXX" description="" >}}
