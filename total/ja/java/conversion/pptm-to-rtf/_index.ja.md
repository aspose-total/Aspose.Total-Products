---
title: Java経由でPPTMをRTFに変換する
description: MicrosoftWordやPowerPointを使用せずにPPTMをRTFにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPTMをRTFに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPTMからRTFへの変換のためのオンプレミスJavaAPI" >}}
