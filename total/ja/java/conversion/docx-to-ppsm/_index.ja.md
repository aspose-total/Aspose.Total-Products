---
title: Java経由でDOCXをPPSMに変換する またはオンライン
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でDOCXをPPSMに変換する またはオンライン" h2="Microsoft<sup>＆reg;</sup> PowerPointまたはWordを使用せずに、Java J2SE、J2EE、J2MEアプリケーション内でオンプレミスのJavaAPIを使用することによるDOCXからPPSMへの変換" >}}
