...
description: MicrosoftExcelまたはPowerPointを使用せずにJava経由でPOTXをFODS形式に変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPOTXをFODSに変換する" h2="オンプレミスのJavaAPIを使用して、Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPOTXをFODSにエクスポートする" >}}
