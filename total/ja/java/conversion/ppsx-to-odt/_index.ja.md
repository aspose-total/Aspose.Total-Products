---
title: Java経由でPPSXをODTに変換する
description: MicrosoftWordやPowerPointを使用せずにPPSXをODTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPSXをODTに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPSXからODTへの変換のためのオンプレミスJavaAPI" >}}
