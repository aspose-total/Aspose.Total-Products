---
title: Javaを使用してSXCをWORDに変換する
description: ExcelまたはWordを使用してSXCをWORDにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="SXCをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにSXCをWORDにエクスポートします。" >}}
