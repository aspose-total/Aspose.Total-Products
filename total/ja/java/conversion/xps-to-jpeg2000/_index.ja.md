...
XPSを**JPEG2000**に変換すると、プロフェッショナルな出版、医療、アーカイブ用途に適した高品質で圧縮された画像が得られます。
...
* XPSアーカイブをJPEG2000に自動変換して効率的に保存。
