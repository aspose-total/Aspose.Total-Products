...
url: /ja/java/conversion/docx-to-odp/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
APIを使用すると、パスワードで保護されたDOCXドキュメントをODPに変換することもできます。入力DOCXドキュメントがパスワードで保護されている場合、パスワードを使用せずにODP形式に変換することはできません。暗号化されたドキュメントを開くには、LoadOptionsオブジェクトに正しいパスワードを設定し、それをDocxumentコンストラクターに渡すことができます。  
{{% blocks/products/pf/feature-page-code %}}
