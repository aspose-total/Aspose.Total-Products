---
title: Java経由でPPSをDOTXに変換する
description: MicrosoftWordやPowerPointを使用せずにPPSをDOTXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPSをDOTXに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPSからDOTXへの変換のためのオンプレミスJavaAPI" >}}
