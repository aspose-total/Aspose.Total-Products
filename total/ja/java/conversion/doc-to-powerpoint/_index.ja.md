---
title: Java経由でDOCをPOWERPOINTに変換する
description: MicrosoftWordやPowerPointを使用せずにDOCをPOWERPOINTにエクスポートするJavaAPI
url: /ja/java/conversion/doc-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でDOCをPOWERPOINTに変換する" h2="Microsoft<sup>＆reg;</sup> PowerPointまたはWordを使用せずに、Java J2SE、J2EE、J2MEアプリケーション内でオンプレミスのJavaAPIを使用することによるDOCからPOWERPOINTへの変換" >}}
