...
APIを使用すると、パスワードで保護されたODTドキュメントをODPに変換することもできます。入力ODTドキュメントがパスワードで保護されている場合、パスワードを使用せずにODP形式に変換することはできません。暗号化されたドキュメントを開くには、LoadOptionsオブジェクトに正しいパスワードを設定し、それをOdtumentコンストラクターに渡すことができます。  
{{% blocks/products/pf/feature-page-code %}}
