...
<iframe title="無料のオンライン MHTML から OTP への変換アプリ" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=otp&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="MHTML から OTP への変換のための Java コード" offSpacer="" %}}
