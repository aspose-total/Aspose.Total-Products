---
title: Java経由でPPSMをDOCMに変換する
description: MicrosoftWordやPowerPointを使用せずにPPSMをDOCMにエクスポートするJavaAPI
url: /ja/java/conversion/ppsm-to-docm/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPSMをDOCMに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPSMからDOCMへの変換のためのオンプレミスJavaAPI" >}}
