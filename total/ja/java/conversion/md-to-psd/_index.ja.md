---
title: Javaを介してMDをPSDに変換する
description: サードパーティのアプリケーションを使用せずに、JavaアプリケーションのPSDにMDファイルをエクスポートします
url_ignore: /ja/java/conversion/md-to-psd/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Javaを介してMDをPSDに変換する" h2="Adobe <sup>&reg;</sup> Acrobat Readerを使用せずに、Java J2SE、J2EE、J2MEアプリケーション内の任意の場所でMDファイルをPSDにエクスポートします。" >}}
{{% blocks/products/pf/feature-page-summary %}}
2つの簡単なステップでmdファイルをJavaでPSD画像に変換できます。まず、[Aspose.PDF for Java](https://products.aspose.com/pdf/java/)を使用すると、MDをJPEGにエクスポートできます。その後、[Aspose.Imaging for Java](https://products.aspose.com/imaging/java/)Image Processing APIを使用して、JPEGをPSDにレンダリングできます。どちらのAPIも、[Aspose.Total for Java](https://products.aspose.com/total/java/)パッケージに含まれています。
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java経由でMDをPSDにエクスポート" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Javaを介してMDをPSDファイルに変換および回転" %}}
...
Markdown（MD）をPSD（Photoshopドキュメント）に変換することで、デザイナーはテキストと構造化されたコンテンツをレイヤー化して編集可能なPhotoshopファイルにインポートできます。PSDを使用すると、Markdownベースの図をプロフェッショナルなグラフィック編集と組み合わせることができます。
...
* Markdownのノートを編集可能なデザインモックアップに変換する。

* インフォグラフィックやマーケティングコンテンツ用のレイヤー化された図を作成する。

* Markdownで生成したビジュアルをブランディング資産と組み合わせる。

* 共同作業型のクリエイティブワークフロー用にデザインファイルを準備する。
...
* マーケティングチーム向けの自動化されたMarkdownからPSDへの変換。

* Markdownリポジトリからのレイヤー化されたビジュアルアセットの一括作成。

* コンテンツ制作のためのグラフィックパイプラインとの統合。

* 共同デザインプロジェクト向けのトリガーされたPSD生成。
