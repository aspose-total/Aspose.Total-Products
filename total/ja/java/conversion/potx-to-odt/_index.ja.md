---
title: Java経由でPOTXをODTに変換する
description: MicrosoftWordやPowerPointを使用せずにPOTXをODTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPOTXをODTに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPOTXからODTへの変換のためのオンプレミスJavaAPI" >}}
