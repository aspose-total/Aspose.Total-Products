---
title: Javaを使用してEXCELをDOCXに変換する
description: ExcelまたはWordを使用してEXCELをDOCXにエクスポートするJavaAPI
url: /ja/java/conversion/excel-to-docx/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="EXCELをDOCXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにEXCELをDOCXにエクスポートします。" >}}
