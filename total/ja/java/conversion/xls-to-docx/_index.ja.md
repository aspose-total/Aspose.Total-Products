---
title: Javaを使用してXLSをDOCXに変換する
description: ExcelまたはWordを使用してXLSをDOCXにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSをDOCXにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSをDOCXにエクスポートします。" >}}
