...
description: MicrosoftWordやMicrosoftExcelを使用せずに、Java経由でDOCXをXLTXに変換する またはオンラインアプリ またはオンライン。コードを統合する前に、無料の POT から CSV へのオンライン コンバーターをすばやくテストします。 
...
[Maven](https://releases.aspose.com/total/java/)ベースのプロジェクトから直接Aspose.TotalforJavaを簡単に使用できます[Aspose.Words for Java](https://docxs.aspose.com/words/java/installation/)と[Aspose.Cells for Java](https://docxs.aspose.com/cells/java/installation/)を含めますあなたのpom.xmlの。
