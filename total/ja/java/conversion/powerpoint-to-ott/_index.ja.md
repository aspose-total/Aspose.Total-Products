---
title: Java経由でPOWERPOINTをOTTに変換する
description: MicrosoftWordやPowerPointを使用せずにPOWERPOINTをOTTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPOWERPOINTをOTTに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPOWERPOINTからOTTへの変換のためのオンプレミスJavaAPI" >}}
