...
XPSを**画像（一般的なラスターフォーマット、PNGやBMPなど）に変換することで、レポート、文書、デジタルコンテンツ配布に広く互換性を確保します。
...
* レポートやアーカイブ用の高品質画像エクスポート。

* オンラインまたは印刷物配布用の教育資料。

* XPSファイルから派生したマーケティング資料。
...
* バッチXPSから画像への変換パイプライン。

* Web公開やイントラネットシステムとの統合。

* XPSリポジトリから画像アーカイブの定期的な作成。

* コンテンツ共有のための自動化された文書から画像へのワークフロー。
