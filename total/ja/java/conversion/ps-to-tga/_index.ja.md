---
title: Javaを介してPSをTGAに変換する
description: サードパーティのアプリケーションを使用せずに、JavaアプリケーションのTGAにPSファイルをエクスポートします
url_ignore: /ja/java/conversion/ps-to-tga/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Javaを介してPSをTGAに変換する" h2="Adobe <sup>&reg;</sup> Acrobat Readerを使用せずに、Java J2SE、J2EE、J2MEアプリケーション内の任意の場所でPSファイルをTGAにエクスポートします。" >}}
{{% blocks/products/pf/feature-page-summary %}}
2つの簡単なステップでpsファイルをJavaでTGA画像に変換できます。まず、[Aspose.PDF for Java](https://products.aspose.com/pdf/java/)を使用すると、PSをJPEGにエクスポートできます。その後、[Aspose.Imaging for Java](https://products.aspose.com/imaging/java/)Image Processing APIを使用して、JPEGをTGAにレンダリングできます。どちらのAPIも、[Aspose.Total for Java](https://products.aspose.com/total/java/)パッケージに含まれています。
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java経由でPSをTGAにエクスポート" %}}
1. [ドキュメント](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document)クラスを使用してPSファイルを開きます
2. JpegDeviceクラスオブジェクトを初期化し、[Process](https://reference.aspose.com/pdf/java/com.aspose.pdf.devices/JpegDevice#process-com)を使用してPSをJPEGにレンダリングします。 aspose.pdf.Page-java.io.OutputStream-)メソッド
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Javaを介してPSをTGAファイルに変換および回転" %}}
...
PS（PostScript）ファイルをTGA（Targa Image）に変換することで、PostScriptグラフィックスをビデオ、マルチメディア、ゲームデザインプロジェクトで使用するための高品質なラスタライズが可能となります。TGAはカラーの深さを維持し、アルファチャンネルをサポートして高度な画像合成を行います。

{{% blocks/products/pf/agp/feature-section-col title="主な使用用途" %}}

* マルチメディア制作のためにPostScriptのイラストをTGA画像に変換する。
* 3DレンダリングやアニメーションパイプラインでのPSダイアグラムの使用のために変換する。
* ゲームデザインアセット用の技術グラフィックスをエクスポートする。
* ビデオオーバーレイや合成ワークフロー用にPSレイアウトを準備する。

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="自動化シナリオ" %}}

* マルチメディア制作パイプラインでの自動化されたPSからTGAへの変換。
* ビデオやゲームプロジェクトのためのPS画像のバッチ処理。
* 動的なレンダリングワークフローのためのグラフィックスエンジンとの統合。
* TGA出力用のPSビジュアルのAI支援最適化とアルファチャンネル。
