---
title: Javaを使用してXLSXをPOWERPOINTに変換する
description: ExcelまたはWordを使用してXLSXをPOWERPOINTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSXをPOWERPOINTにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSXをPOWERPOINTにエクスポートします。" >}}
