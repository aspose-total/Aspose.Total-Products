...
description: MicrosoftWordやMicrosoftExcelを使用せずに、Java経由でODTをXLSに変換する
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でODTをXLSに変換する" h2="オンプレミスのJavaAPIを使用して、Microsoft<sup>＆reg;</sup>WordまたはMicrosoft<sup>＆reg; </sup>Excelを使用せずにODTをXLSに変換する" >}}
...
2. [保存](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)を使用してODTをHTMLに変換します) 方法
