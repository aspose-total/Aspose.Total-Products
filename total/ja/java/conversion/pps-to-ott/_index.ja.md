---
title: Java経由でPPSをOTTに変換する
description: MicrosoftWordやPowerPointを使用せずにPPSをOTTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPSをOTTに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPSからOTTへの変換のためのオンプレミスJavaAPI" >}}
