---
title: Javaを使用してTSVをPOWERPOINTに変換する
description: ExcelまたはWordを使用してTSVをPOWERPOINTにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="TSVをPOWERPOINTにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにTSVをPOWERPOINTにエクスポートします。" >}}
