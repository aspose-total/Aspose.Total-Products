---
title: Javaを使用してXLSBをWORDに変換する
description: ExcelまたはWordを使用してXLSBをWORDにエクスポートするJavaAPI
...
{{< blocks/products/pf/i18n/feature-page-header h1="XLSBをWORDにエクスポートするJavaAPI" h2="オンプレミスのJavaAPIを使用して、MicrosoftExcelに依存せずにXLSBをWORDにエクスポートします。" >}}
