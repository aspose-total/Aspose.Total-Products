...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPSMをEXCELに変換する またはオンライン" h2="オンプレミスのJavaAPIを使用して、Microsoft<sup>＆reg;</sup>ExcelまたはPowerPointを使用せずにPPSMをEXCELにエクスポートする" >}}
