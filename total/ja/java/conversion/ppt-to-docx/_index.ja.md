---
title: Java経由でPPTをDOCXに変換する
description: MicrosoftWordやPowerPointを使用せずにPPTをDOCXにエクスポートするJavaAPI
url: /ja/java/conversion/ppt-to-docx/
family: total
platformtag: net
feature: conversion
informat: PPT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java経由でPPTをDOCXに変換する" h2="任意のJavaJ2SE、J2EE、J2MEアプリケーション内でのPowerPointPPTからDOCXへの変換のためのオンプレミスJavaAPI" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppt-to-docxm/" name="PPT に DOCXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/net/conversion/ppt-to-docxx/" name="PPT に DOCXX" description="" >}}
