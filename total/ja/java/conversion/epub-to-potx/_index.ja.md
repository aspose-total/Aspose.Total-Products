...
4. [save]（https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-）メソッドを使用してドキュメントをPOTX形式で保存し、`を設定します。 SaveFormatとしてのPotx`
