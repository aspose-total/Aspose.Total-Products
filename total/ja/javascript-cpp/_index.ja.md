---
title: JavaScript API を介した PDF 処理と OCR の追加
description: PDF ドキュメントを操作したり、Web アプリケーションに OCR 機能を追加したりするための JavaScript API。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF および OCR 用の JavaScript API" h2="他のソフトウェアに依存することなく、Web アプリケーション内に OCR および PDF 操作機能を追加します" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total for JavaScript via C++ は、JavaScript ライブラリの包括的なセットです。これらのライブラリは、Web ブラウザで PDF を直接操作したり、光学式文字認識機能でアプリケーションを強化したりする機能を提供します。

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for JavaScript via C++ には、次の JavaScript ライブラリが含まれています。" >}}
...
Aspose.PDF for JavaScript via C++ は、Web ブラウザで PDF を直接操作するために設計された、使いやすく安全なツールキットです。このライブラリは、ラテン語、キリル文字、漢字を含む 26 の言語をサポートしています。<br><br>

これは、開発者が JavaScript を使用して PDF を効率的に処理できる軽量のソリューションです。スケーラブルで機能が豊富なため、開発者は独自の JavaScript ベースの PDF 操作製品を作成し、Web 上で簡単に共有できます。<br><br>
...
Aspose.OCR for JavaScript via C++ は、わずか 8 行のコードで効率的な光学式文字認識をアプリケーションに提供します。<br><br>
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     スキャナーまたはカメラから取得できるあらゆる画像をサポートします
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/testimonials title="人々の意見" subTitle="私たちの言葉をそのまま鵜呑みにしないでください。 Aspose.Total API についてのユーザーの意見をご覧ください。" caseStudiesLink="https://releases.aspose.com/corporate/case-studies/aspose.total/" >}}
{{< blocks/products/pf/testimonials-quote poster="ステファン・シュテューダー | Nowhow Solutions AG、スイス" >}}
十分に文書化された取扱説明書と Aspose.Total コンポーネントの堅牢性により、DOCO への簡単な統合が実現しました。これにより、予想以上に開発時間を短縮できました。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="ブライアン・ソーントンNet Reaction LLC、米国" >}}
当社は、オフィス オートメーションと Soft Artisans の Office Writer 製品の両方に関して豊富な経験を持っています。Aspose の Total.NET はより堅牢であり、これまでに使用したものよりも多くの機能を提供します。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="マーク・フォーリー |ライオン ネイサン ナショナル フーズ、オーストラリア" >}}
事実上、Aspose.Total for .NET スイートは、私たちが使用するコンポーネントの「スイス アーミー ナイフ」です。プレゼンテーション層コンポーネントと並んで配置され、目的の形式でデータ ファイルをプルおよびプッシュするための「接着剤」を形成します。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="ヤシン・ラウダッド |クアレテック（フランス）" >}}
実装は簡単で、私たちはアーキテクチャに重点を置いており、Aspose は単純に適合します。私たちのアーキテクチャはパフォーマンスとマルチスレッド向けに高度に最適化されており、これも Aspose.Total.net を使用するのに問題ありません。
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="APIリファレンス" href="https://reference.aspose.com/" >}} 
...
{{< blocks/products/pf/slr-tab tabTitle="C++ に Aspose.Total を使用する理由" tabId="success-stories" >}}
