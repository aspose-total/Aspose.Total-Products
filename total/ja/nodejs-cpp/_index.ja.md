---
title: Node.js API を介した PDF 操作と OCR の追加
description: PDF ファイルを操作したり、アプリケーション経由で画像からテキストを抽出したりするための Node.js API。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="PDF および画像テキスト抽出用の Node.js API" h2="他のソフトウェアに依存することなく、画像からテキストを抽出し、Node.js アプリケーション内に PDF 操作機能を組み込みます。" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ は、Node.js ライブラリの包括的なセットです。これらのライブラリは、PDF を直接操作したり、画像をテキストに変換するアプリケーションを強化したりする機能を提供します。

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="C++ 経由の Node.js 用 Aspose.Total には、次の Node.js ライブラリが含まれています。" >}}
...
Aspose.PDF for Node.js (C++ 経由) を使用すると、バックエンドで PDF ファイルを処理できるようになります。これを利用すると、PDF の最適化、テキストと画像の組み込みと抽出、暗号化と復号化のプロセスの実装が可能になります。さらに、この機能は PDF ドキュメントを簡単に分割および結合できるように拡張され、PDF ファイル操作を合理化するための包括的なツールキットを提供します。
...
C++ 経由の Aspose.OCR for Node.js を使用すると、Node.js 互換プラットフォームでスキャンしたページや写真などの画像からテキストを抽出できます。強力な光学式文字認識機能でオンプレミス製品、Web サービス、サーバーレス アプリケーションを強化し、一般的な形式で中国語やヒンディー語を含む 28 言語をサポートします。
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for Node.js via C++ を使用すると、開発者は TrueType、WOFF、EOT、OpenType、CFF、Type1 などのさまざまなフォント形式を読み込み、レンダリングし、保存できます。複雑なフォント操作を簡素化するように設計されているため、Node.js 開発者は複雑なフォント処理に煩わされることなく、優れたアプリケーションの作成に集中できます。
{{< /blocks/products/pf/total/product-item >}}
...
当社には、オフィス オートメーションと Soft Artisans の Office Writer 製品の両方に関して豊富な経験があります。 Aspose の Total.NET はより堅牢であり、これまでに使用したものよりも多くの機能を提供します。
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total は、他のプラットフォーム向けに個別のソリューションを提供します。" >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/ja/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/ja/nodejs-java/" 
