---
title: PPTをDOCMに変換するC++API
description: C++アプリケーション内でPPTをDOCMにエクスポートする
url: /ja/cpp/conversion/ppt-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPTをDOCMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTをDOCMにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppt-to-docmx/" name="PPT に DOCMX" description="" >}}
