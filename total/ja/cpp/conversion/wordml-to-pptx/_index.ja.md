---
title: C++を介してWORDMLをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでWORDMLをPPTXにエクスポートする
url: /ja/cpp/conversion/wordml-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDMLをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でWORDMLをPPTXにエクスポートします。またはPowerPoint" >}}
