...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをXLSXにエクスポートする
url: /ja/cpp/conversion/potm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからXLSXファイルに変換" >}}
