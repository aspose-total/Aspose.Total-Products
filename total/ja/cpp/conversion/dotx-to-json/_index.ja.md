...
{{< blocks/products/pf/feature-page-header h1="C++を介してDOTXをJSON形式に変換する" h2="Microsoft <sup>&reg;</sup>WordまたはExcelを使用せずにC++経由でDOTXをJSONにエクスポートする" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total for C++](https://products.aspose.com/total/cpp/)を使用すると、C++アプリケーション内でDOTXをJSON形式に変換できます。まず、[Aspose.Words for C++](https://products.aspose.com/words/cpp/)を使用して、DOTXをHTMLにエクスポートできます。その後、[Aspose.Cells for C++](https://products.aspose.com/cells/cpp/)を使用して、HTMLをJSON形式に変換できます。 
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/dotx-to-csv/" name="DOTX に CSV" description="" >}}
