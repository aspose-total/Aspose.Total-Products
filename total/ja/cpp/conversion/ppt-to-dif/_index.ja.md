...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをDIFにエクスポートする
url: /ja/cpp/conversion/ppt-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからDIFファイルに変換" >}}
