---
title: C++を介してPPSXをTSVに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをTSVにエクスポートする
url: /ja/cpp/conversion/ppsx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからTSVファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPPSXをTSVに変換する方法" %}}
