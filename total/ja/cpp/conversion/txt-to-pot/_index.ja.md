---
title: C++を介してTXTをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPOTにエクスポートする
url: /ja/cpp/conversion/txt-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPOTにエクスポートします。またはPowerPoint" >}}
