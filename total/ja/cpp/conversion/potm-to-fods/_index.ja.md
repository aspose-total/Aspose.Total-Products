...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをFODSにエクスポートする
url: /ja/cpp/conversion/potm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからFODSファイルに変換" >}}
