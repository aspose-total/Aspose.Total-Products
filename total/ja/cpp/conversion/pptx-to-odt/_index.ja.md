---
title: PPTXをODTに変換するC++API
description: C++アプリケーション内でPPTXをODTにエクスポートする
url: /ja/cpp/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTXをODTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTXをODTにエクスポートする" >}}
