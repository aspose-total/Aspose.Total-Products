---
title: POTMをDOCに変換するC++API
description: C++アプリケーション内でPOTMをDOCにエクスポートする
url: /ja/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをDOCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをDOCにエクスポートする" >}}
