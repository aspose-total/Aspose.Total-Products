...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLSXにエクスポートする
url: /ja/cpp/conversion/ppt-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLSXファイルに変換" >}}
