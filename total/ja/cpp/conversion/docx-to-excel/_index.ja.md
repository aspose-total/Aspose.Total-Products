...
{{< blocks/products/pf/feature-page-header h1="DOCXをEXCELに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でDOCXをEXCELにエクスポートする" >}}
