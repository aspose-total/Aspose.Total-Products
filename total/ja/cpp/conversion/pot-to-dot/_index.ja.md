---
title: POTをDOTに変換するC++API
description: C++アプリケーション内でPOTをDOTにエクスポートする
url: /ja/cpp/conversion/pot-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POTをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTをDOTにエクスポートする" >}}
