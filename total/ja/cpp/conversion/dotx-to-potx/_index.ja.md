---
title: C++を介してDOTXをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPOTXにエクスポートする
url: /ja/cpp/conversion/dotx-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPOTXにエクスポートします。またはPowerPoint" >}}
