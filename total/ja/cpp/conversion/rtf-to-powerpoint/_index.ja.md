---
title: C++を介してRTFをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/rtf-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
