---
title: PPSMをDOTに変換するC++API
description: C++アプリケーション内でPPSMをDOTにエクスポートする
url: /ja/cpp/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSMをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSMをDOTにエクスポートする" >}}
