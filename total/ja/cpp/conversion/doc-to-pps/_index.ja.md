---
title: C++を介してDOCをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPPSにエクスポートする
url: /ja/cpp/conversion/doc-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPPSにエクスポートします。またはPowerPoint" >}}
