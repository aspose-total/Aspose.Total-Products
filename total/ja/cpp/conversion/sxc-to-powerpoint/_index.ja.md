---
title: C++でSXCをPOWERPOINTに変換する
description: C++アプリケーション内でSXCをPOWERPOINTに変換する
url: /ja/cpp/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="C++経由でSXCをPOWERPOINTに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのSXCからPOWERPOINTへ" >}}
