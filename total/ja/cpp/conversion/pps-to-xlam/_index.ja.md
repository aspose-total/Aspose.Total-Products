...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLAMにエクスポートする
url: /ja/cpp/conversion/pps-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLAMファイルに変換" >}}
