---
title: C++を介してOTTをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPPSにエクスポートする
url: /ja/cpp/conversion/ott-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPPSにエクスポートします。またはPowerPoint" >}}
