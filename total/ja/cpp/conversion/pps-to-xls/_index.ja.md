...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLSにエクスポートする
url: /ja/cpp/conversion/pps-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLSファイルに変換" >}}
