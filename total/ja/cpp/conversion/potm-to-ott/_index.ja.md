---
title: POTMをOTTに変換するC++API
description: C++アプリケーション内でPOTMをOTTにエクスポートする
url: /ja/cpp/conversion/potm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをOTTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをOTTにエクスポートする" >}}
