---
title: POTXをDOTMに変換するC++API
description: C++アプリケーション内でPOTXをDOTMにエクスポートする
url: /ja/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTXをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTXをDOTMにエクスポートする" >}}
