---
title: C++を介してODTをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/odt-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
