---
title: C++を介してFLATOPCをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをPOTMにエクスポートする
url: /ja/cpp/conversion/flatopc-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをPOTMにエクスポートします。またはPowerPoint" >}}
