---
title: C++でODTをXLSに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにODTをXLSに変換するC++API
url: /ja/cpp/conversion/odt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをXLSに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でODTをXLSにエクスポートする" >}}
