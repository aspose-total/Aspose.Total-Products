...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをXLSBにエクスポートする
url: /ja/cpp/conversion/potx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからXLSBファイルに変換" >}}
