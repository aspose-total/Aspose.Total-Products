...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLSBにエクスポートする
url: /ja/cpp/conversion/pps-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLSBファイルに変換" >}}
