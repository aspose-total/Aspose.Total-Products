---
title: POTをFLATOPCに変換するC++API
description: C++アプリケーション内でPOTをFLATOPCにエクスポートする
url: /ja/cpp/conversion/pot-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POTをFLATOPCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTをFLATOPCにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pot-to-flatopcm/" name="POT に FLATOPCM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pot-to-flatopcx/" name="POT に FLATOPCX" description="" >}}
