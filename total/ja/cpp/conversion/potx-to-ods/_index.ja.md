...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをODSにエクスポートする
url: /ja/cpp/conversion/potx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからODSファイルに変換" >}}
