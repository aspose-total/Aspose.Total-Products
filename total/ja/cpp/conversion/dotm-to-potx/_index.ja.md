---
title: C++を介してDOTMをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTMをPOTXにエクスポートする
url: /ja/cpp/conversion/dotm-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTMをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTMをPOTXにエクスポートします。またはPowerPoint" >}}
