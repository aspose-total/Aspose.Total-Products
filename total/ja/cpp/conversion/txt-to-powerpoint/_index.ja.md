---
title: C++を介してTXTをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/txt-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
