---
title: PPSXをDOTMに変換するC++API
description: C++アプリケーション内でPPSXをDOTMにエクスポートする
url: /ja/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをDOTMにエクスポートする" >}}
