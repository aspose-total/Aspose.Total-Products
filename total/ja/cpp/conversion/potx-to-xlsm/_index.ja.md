...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをXLSMにエクスポートする
url: /ja/cpp/conversion/potx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをXLSMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからXLSMファイルに変換" >}}
