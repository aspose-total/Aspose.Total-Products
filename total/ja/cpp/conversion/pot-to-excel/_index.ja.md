...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをEXCELにエクスポートする
url: /ja/cpp/conversion/pot-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをEXCELに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからEXCELファイルに変換" >}}
