---
title: POWERPOINTをDOCに変換するC++API
description: C++アプリケーション内でPOWERPOINTをDOCにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをDOCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをDOCにエクスポートする" >}}
