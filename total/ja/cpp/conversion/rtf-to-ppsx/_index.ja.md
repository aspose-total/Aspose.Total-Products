---
title: C++を介してRTFをPPSXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPPSXにエクスポートする
url: /ja/cpp/conversion/rtf-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPPSXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPPSXにエクスポートします。またはPowerPoint" >}}
