...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLTXにエクスポートする
url: /ja/cpp/conversion/ppt-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLTXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLTXファイルに変換" >}}
