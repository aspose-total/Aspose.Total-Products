...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをSXCにエクスポートする
url: /ja/cpp/conversion/potx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからSXCファイルに変換" >}}
