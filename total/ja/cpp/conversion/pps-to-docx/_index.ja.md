---
title: PPSをDOCXに変換するC++API
description: C++アプリケーション内でPPSをDOCXにエクスポートする
url: /ja/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをDOCXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをDOCXにエクスポートする" >}}
