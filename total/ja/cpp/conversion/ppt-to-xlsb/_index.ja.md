...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLSBにエクスポートする
url: /ja/cpp/conversion/ppt-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLSBファイルに変換" >}}
