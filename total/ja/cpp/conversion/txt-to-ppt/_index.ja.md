---
title: C++を介してTXTをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPPTにエクスポートする
url: /ja/cpp/conversion/txt-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPPTにエクスポートします。またはPowerPoint" >}}
