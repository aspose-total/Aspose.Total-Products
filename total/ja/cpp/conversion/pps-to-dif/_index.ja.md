...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをDIFにエクスポートする
url: /ja/cpp/conversion/pps-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからDIFファイルに変換" >}}
