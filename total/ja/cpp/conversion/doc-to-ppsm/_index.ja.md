---
title: C++を介してDOCをPPSMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPPSMにエクスポートする
url: /ja/cpp/conversion/doc-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPPSMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPPSMにエクスポートします。またはPowerPoint" >}}
