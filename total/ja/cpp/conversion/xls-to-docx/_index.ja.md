---
title: C++でXLSをDOCXに変換する
description: C++アプリケーション内でXLSをDOCXに変換する
url: /ja/cpp/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLSをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLSからDOCXへ" >}}
