---
title: PPSXをDOCMに変換するC++API
description: C++アプリケーション内でPPSXをDOCMにエクスポートする
url: /ja/cpp/conversion/ppsx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをDOCMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをDOCMにエクスポートする" >}}
