---
title: POTMをTEXTに変換するC++API
description: C++アプリケーション内でPOTMをTEXTにエクスポートする
url: /ja/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをTEXTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをTEXTにエクスポートする" >}}
...
2. [保存](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e)メンバー関数を使用してPOTMをHTMLにレンダリングし、HtmlをSaveFormatとして設定します
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/potm-to-textm/" name="POTM に TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/potm-to-textx/" name="POTM に TEXTX" description="" >}}
