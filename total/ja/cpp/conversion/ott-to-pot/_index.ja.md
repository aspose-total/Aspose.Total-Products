---
title: C++を介してOTTをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPOTにエクスポートする
url: /ja/cpp/conversion/ott-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPOTにエクスポートします。またはPowerPoint" >}}
