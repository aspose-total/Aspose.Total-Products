...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをEXCELにエクスポートする
url: /ja/cpp/conversion/potm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをEXCELに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからEXCELファイルに変換" >}}
