---
title: C++を介してFLATOPCをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをPPTにエクスポートする
url: /ja/cpp/conversion/flatopc-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをPPTにエクスポートします。またはPowerPoint" >}}
