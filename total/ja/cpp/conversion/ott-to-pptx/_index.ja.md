---
title: C++を介してOTTをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPPTXにエクスポートする
url: /ja/cpp/conversion/ott-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPPTXにエクスポートします。またはPowerPoint" >}}
