...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをEXCELにエクスポートする
url: /ja/cpp/conversion/potx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをEXCELに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからEXCELファイルに変換" >}}
