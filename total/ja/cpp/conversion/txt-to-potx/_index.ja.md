---
title: C++を介してTXTをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPOTXにエクスポートする
url: /ja/cpp/conversion/txt-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPOTXにエクスポートします。またはPowerPoint" >}}
...
6. [保存](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e)メソッドを使用してドキュメントをPOTX形式で保存し、PotxをSaveFormatとして設定します
