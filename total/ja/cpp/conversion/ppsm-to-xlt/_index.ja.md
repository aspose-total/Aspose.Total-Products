...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをXLTにエクスポートする
url: /ja/cpp/conversion/ppsm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからXLTファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPPSMをXLTに変換する方法" %}}
