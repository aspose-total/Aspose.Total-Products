---
title: POWERPOINTをODTに変換するC++API
description: C++アプリケーション内でPOWERPOINTをODTにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをODTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをODTにエクスポートする" >}}
