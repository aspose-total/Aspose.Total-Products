---
title: C++を介してRTFをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPPSにエクスポートする
url: /ja/cpp/conversion/rtf-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPPSにエクスポートします。またはPowerPoint" >}}
