---
title: C++を介してPOTMをXLSBに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをXLSBにエクスポートする
url: /ja/cpp/conversion/potm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからXLSBファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTMをXLSBに変換する方法" %}}
