...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをDIFにエクスポートする
url: /ja/cpp/conversion/potm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからDIFファイルに変換" >}}
