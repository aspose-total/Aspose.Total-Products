---
title: C++を介してDOCMをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPOTにエクスポートする
url: /ja/cpp/conversion/docm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPOTにエクスポートします。またはPowerPoint" >}}
