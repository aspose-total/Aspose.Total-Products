---
title: PPTをDOTに変換するC++API
description: C++アプリケーション内でPPTをDOTにエクスポートする
url: /ja/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPTをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTをDOTにエクスポートする" >}}
