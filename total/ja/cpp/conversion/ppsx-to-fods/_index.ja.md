...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをFODSにエクスポートする
url: /ja/cpp/conversion/ppsx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからFODSファイルに変換" >}}
