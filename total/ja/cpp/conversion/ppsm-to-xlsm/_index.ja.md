...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをXLSMにエクスポートする
url: /ja/cpp/conversion/ppsm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをXLSMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからXLSMファイルに変換" >}}
