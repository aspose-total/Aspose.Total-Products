...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをXLSBにエクスポートする
url: /ja/cpp/conversion/pot-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからXLSBファイルに変換" >}}
