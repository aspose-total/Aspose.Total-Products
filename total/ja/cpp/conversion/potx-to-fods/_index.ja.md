...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをFODSにエクスポートする
url: /ja/cpp/conversion/potx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからFODSファイルに変換" >}}
