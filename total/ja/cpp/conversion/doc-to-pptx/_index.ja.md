---
title: C++を介してDOCをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPPTXにエクスポートする
url: /ja/cpp/conversion/doc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPPTXにエクスポートします。またはPowerPoint" >}}
...
2. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stdbasicostream_saveoptions)メンバー関数を使用してDOCをHTMLに変換します
