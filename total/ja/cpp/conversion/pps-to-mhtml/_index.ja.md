...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをMHTMLにエクスポートする
url: /ja/cpp/conversion/pps-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからMHTMLファイルに変換" >}}
