...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOWERPOINTをSXCにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOWERPOINTをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOWERPOINTからSXCファイルに変換" >}}
