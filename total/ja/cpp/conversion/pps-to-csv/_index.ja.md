...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをCSVにエクスポートする
url: /ja/cpp/conversion/pps-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをCSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからCSVファイルに変換" >}}
