...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをXLSMにエクスポートする
url: /ja/cpp/conversion/pot-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをXLSMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからXLSMファイルに変換" >}}
