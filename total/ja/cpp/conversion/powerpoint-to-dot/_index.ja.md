---
title: POWERPOINTをDOTに変換するC++API
description: C++アプリケーション内でPOWERPOINTをDOTにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをDOTにエクスポートする" >}}
