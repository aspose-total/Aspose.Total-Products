---
title: C++でXLTをDOCに変換する
description: C++アプリケーション内でXLTをDOCに変換する
url: /ja/cpp/conversion/xlt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLTをDOCに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLTからDOCへ" >}}
