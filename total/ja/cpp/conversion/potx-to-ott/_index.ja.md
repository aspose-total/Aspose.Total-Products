...
{{< blocks/products/pf/feature-page-header h1="POTXをOTTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTXをOTTにエクスポートする" >}}
...
4. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.ottument#save_string)メンバー機能を使用して、ドキュメントをOTT形式で保存します。
