---
title: PPSをOTTに変換するC++API
description: C++アプリケーション内でPPSをOTTにエクスポートする
url: /ja/cpp/conversion/pps-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをOTTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをOTTにエクスポートする" >}}
