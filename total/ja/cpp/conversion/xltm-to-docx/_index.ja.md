---
title: C++でXLTMをDOCXに変換する
description: C++アプリケーション内でXLTMをDOCXに変換する
url: /ja/cpp/conversion/xltm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLTMをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLTMからDOCXへ" >}}
