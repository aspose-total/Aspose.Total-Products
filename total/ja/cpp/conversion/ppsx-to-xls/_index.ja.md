---
title: C++を介してPPSXをXLSに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをXLSにエクスポートする
url: /ja/cpp/conversion/ppsx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをXLSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからXLSファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPPSXをXLSに変換する方法" %}}
