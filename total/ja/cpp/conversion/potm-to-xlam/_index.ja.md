...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをXLAMにエクスポートする
url: /ja/cpp/conversion/potm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからXLAMファイルに変換" >}}
