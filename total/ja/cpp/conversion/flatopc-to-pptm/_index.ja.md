---
title: C++を介してFLATOPCをPPTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをPPTMにエクスポートする
url: /ja/cpp/conversion/flatopc-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをPPTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをPPTMにエクスポートします。またはPowerPoint" >}}
