---
title: C++を介してFLATOPCをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをPPTXにエクスポートする
url: /ja/cpp/conversion/flatopc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをPPTXにエクスポートします。またはPowerPoint" >}}
