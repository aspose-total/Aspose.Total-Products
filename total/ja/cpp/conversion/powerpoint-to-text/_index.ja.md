---
title: POWERPOINTをTEXTに変換するC++API
description: C++アプリケーション内でPOWERPOINTをTEXTにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをTEXTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをTEXTにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pptx-to-textm/" name="PPTX に TEXTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pptx-to-textx/" name="PPTX に TEXTX" description="" >}}
