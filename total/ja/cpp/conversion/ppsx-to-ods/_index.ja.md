...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをODSにエクスポートする
url: /ja/cpp/conversion/ppsx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからODSファイルに変換" >}}
