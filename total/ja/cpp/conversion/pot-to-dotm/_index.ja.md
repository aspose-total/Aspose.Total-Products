---
title: POTをDOTMに変換するC++API
description: C++アプリケーション内でPOTをDOTMにエクスポートする
url: /ja/cpp/conversion/pot-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POTをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTをDOTMにエクスポートする" >}}
