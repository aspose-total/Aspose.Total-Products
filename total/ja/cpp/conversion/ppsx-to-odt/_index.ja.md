---
title: PPSXをODTに変換するC++API
description: C++アプリケーション内でPPSXをODTにエクスポートする
url: /ja/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをODTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをODTにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppsx-to-odtx/" name="PPSX に ODTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppsx-to-odtm/" name="PPSX に ODTM" description="" >}}
