---
title: C++を介してDOTXをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/dotx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
