...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをTSVにエクスポートする
url: /ja/cpp/conversion/pot-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからTSVファイルに変換" >}}
