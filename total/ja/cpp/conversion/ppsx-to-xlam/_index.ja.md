...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをXLAMにエクスポートする
url: /ja/cpp/conversion/ppsx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからXLAMファイルに変換" >}}
