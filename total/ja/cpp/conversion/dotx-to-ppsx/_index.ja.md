---
title: C++を介してDOTXをPPSXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPPSXにエクスポートする
url: /ja/cpp/conversion/dotx-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPPSXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPPSXにエクスポートします。またはPowerPoint" >}}
