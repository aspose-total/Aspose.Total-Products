...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをFODSにエクスポートする
url: /ja/cpp/conversion/ppt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからFODSファイルに変換" >}}
