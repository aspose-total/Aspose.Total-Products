---
title: PPSMをOTTに変換するC++API
description: C++アプリケーション内でPPSMをOTTにエクスポートする
url: /ja/cpp/conversion/ppsm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSMをOTTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSMをOTTにエクスポートする" >}}
