---
title: C++を介してPOTをXLSXに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをXLSXにエクスポートする
url: /ja/cpp/conversion/pot-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからXLSXファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTをXLSXに変換する方法" %}}
