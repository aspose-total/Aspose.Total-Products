---
title: C++を介してOTTをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPOTMにエクスポートする
url: /ja/cpp/conversion/ott-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPOTMにエクスポートします。またはPowerPoint" >}}
