...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをXLTXにエクスポートする
url: /ja/cpp/conversion/potx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをXLTXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからXLTXファイルに変換" >}}
