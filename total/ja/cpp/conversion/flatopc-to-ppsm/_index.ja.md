---
title: C++を介してFLATOPCをPPSMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをPPSMにエクスポートする
url: /ja/cpp/conversion/flatopc-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをPPSMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをPPSMにエクスポートします。またはPowerPoint" >}}
...
2. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.flatopcument#save_stdbasicostream_saveoptions)メンバー関数を使用してFLATOPCをHTMLに変換します
