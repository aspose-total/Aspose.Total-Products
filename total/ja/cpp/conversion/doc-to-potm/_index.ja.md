---
title: C++を介してDOCをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPOTMにエクスポートする
url: /ja/cpp/conversion/doc-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPOTMにエクスポートします。またはPowerPoint" >}}
