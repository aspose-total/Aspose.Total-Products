---
title: PPTをWORDMLに変換するC++API
description: C++アプリケーション内でPPTをWORDMLにエクスポートする
url: /ja/cpp/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPTをWORDMLにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTをWORDMLにエクスポートする" >}}
