...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをFLATOPCにレンダリングするC++API またはオンライン" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをFLATOPCにエクスポートする" >}}
