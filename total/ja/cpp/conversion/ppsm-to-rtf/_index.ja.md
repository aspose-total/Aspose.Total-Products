---
title: PPSMをRTFに変換するC++API
description: C++アプリケーション内でPPSMをRTFにエクスポートする
url: /ja/cpp/conversion/ppsm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSMをRTFにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSMをRTFにエクスポートする" >}}
