...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをFODSにエクスポートする
url: /ja/cpp/conversion/pps-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからFODSファイルに変換" >}}
