...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLTにエクスポートする
url: /ja/cpp/conversion/pps-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLTファイルに変換" >}}
