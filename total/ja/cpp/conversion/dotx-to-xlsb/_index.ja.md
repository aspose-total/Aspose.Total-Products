---
title: C++でDOTXをXLSBに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにDOTXをXLSBに変換するC++API
url: /ja/cpp/conversion/dotx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをXLSBに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でDOTXをXLSBにエクスポートする" >}}
