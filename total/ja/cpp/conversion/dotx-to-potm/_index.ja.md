---
title: C++を介してDOTXをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPOTMにエクスポートする
url: /ja/cpp/conversion/dotx-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPOTMにエクスポートします。またはPowerPoint" >}}
