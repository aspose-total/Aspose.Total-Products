---
title: C++を介してODTをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをPOTXにエクスポートする
url: /ja/cpp/conversion/odt-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをPOTXにエクスポートします。またはPowerPoint" >}}
