---
title: C++を介してRTFをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをODPにエクスポートする
url: /ja/cpp/conversion/rtf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをODPにエクスポートします。またはPowerPoint" >}}
