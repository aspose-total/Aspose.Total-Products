---
title: C++を介してOTTをPPTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPPTMにエクスポートする
url: /ja/cpp/conversion/ott-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPPTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPPTMにエクスポートします。またはPowerPoint" >}}
