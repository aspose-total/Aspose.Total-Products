---
title: PPSをODTに変換するC++API
description: C++アプリケーション内でPPSをODTにエクスポートする
url: /ja/cpp/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをODTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをODTにエクスポートする" >}}
