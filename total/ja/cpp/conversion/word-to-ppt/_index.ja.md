---
title: C++を介してWORDをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでWORDをPPTにエクスポートする
url: /ja/cpp/conversion/word-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="WORDをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でWORDをPPTにエクスポートします。またはPowerPoint" >}}
