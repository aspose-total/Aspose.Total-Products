...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLTにエクスポートする
url: /ja/cpp/conversion/ppt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLTファイルに変換" >}}
