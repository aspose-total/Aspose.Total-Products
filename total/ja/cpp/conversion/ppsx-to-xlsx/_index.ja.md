...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをXLSXにエクスポートする
url: /ja/cpp/conversion/ppsx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからXLSXファイルに変換" >}}
