...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをMARKDOWNにエクスポートする
url: /ja/cpp/conversion/potx-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをMARKDOWNに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからMARKDOWNファイルに変換" >}}
