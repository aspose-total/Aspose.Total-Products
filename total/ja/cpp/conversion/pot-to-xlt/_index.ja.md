---
title: C++を介してPOTをXLTに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをXLTにエクスポートする
url: /ja/cpp/conversion/pot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからXLTファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTをXLTに変換する方法" %}}
