---
title: PPSをDOTMに変換するC++API
description: C++アプリケーション内でPPSをDOTMにエクスポートする
url: /ja/cpp/conversion/pps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをDOTMにエクスポートする" >}}
