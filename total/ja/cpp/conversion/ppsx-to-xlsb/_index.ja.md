---
title: C++を介してPPSXをXLSBに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをXLSBにエクスポートする
url: /ja/cpp/conversion/ppsx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからXLSBファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPPSXをXLSBに変換する方法" %}}
