...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをEXCELにエクスポートする
url: /ja/cpp/conversion/ppt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをEXCELに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからEXCELファイルに変換" >}}
