---
title: PPSMをWORDMLに変換するC++API
description: C++アプリケーション内でPPSMをWORDMLにエクスポートする
url: /ja/cpp/conversion/ppsm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSMをWORDMLにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSMをWORDMLにエクスポートする" >}}
