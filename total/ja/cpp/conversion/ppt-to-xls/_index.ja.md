...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLSにエクスポートする
url: /ja/cpp/conversion/ppt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLSファイルに変換" >}}
