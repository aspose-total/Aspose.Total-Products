---
title: C++でXLSBをDOCに変換する
description: C++アプリケーション内でXLSBをDOCに変換する
url: /ja/cpp/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLSBをDOCに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLSBからDOCへ" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/xlsb-to-docx/" name="XLSB に DOCX" description="" >}}
