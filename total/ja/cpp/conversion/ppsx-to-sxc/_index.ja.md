...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをSXCにエクスポートする
url: /ja/cpp/conversion/ppsx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからSXCファイルに変換" >}}
