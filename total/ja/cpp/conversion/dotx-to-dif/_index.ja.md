---
title: C++でDOTXをDIFに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにDOTXをDIFに変換するC++API
url: /ja/cpp/conversion/dotx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをDIFに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でDOTXをDIFにエクスポートする" >}}
