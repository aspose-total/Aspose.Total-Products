...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLSXにエクスポートする
url: /ja/cpp/conversion/pps-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLSXファイルに変換" >}}
