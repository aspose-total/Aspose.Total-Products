---
title: PPSXをDOTに変換するC++API
description: C++アプリケーション内でPPSXをDOTにエクスポートする
url: /ja/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをDOTにエクスポートする" >}}
