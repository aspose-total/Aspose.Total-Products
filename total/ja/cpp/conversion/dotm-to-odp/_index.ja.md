---
title: C++を介してDOTMをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTMをODPにエクスポートする
url: /ja/cpp/conversion/dotm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTMをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTMをODPにエクスポートします。またはPowerPoint" >}}
