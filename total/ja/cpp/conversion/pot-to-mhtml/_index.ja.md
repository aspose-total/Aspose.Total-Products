...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをMHTMLにエクスポートする
url: /ja/cpp/conversion/pot-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからMHTMLファイルに変換" >}}
