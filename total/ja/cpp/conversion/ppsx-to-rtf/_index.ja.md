---
title: PPSXをRTFに変換するC++API
description: C++アプリケーション内でPPSXをRTFにエクスポートする
url: /ja/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをRTFにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをRTFにエクスポートする" >}}
