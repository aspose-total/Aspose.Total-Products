---
title: POWERPOINTをDOTMに変換するC++API
description: C++アプリケーション内でPOWERPOINTをDOTMにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをDOTMにエクスポートする" >}}
