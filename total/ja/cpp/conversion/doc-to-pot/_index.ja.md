---
title: C++を介してDOCをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPOTにエクスポートする
url: /ja/cpp/conversion/doc-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPOTにエクスポートします。またはPowerPoint" >}}
