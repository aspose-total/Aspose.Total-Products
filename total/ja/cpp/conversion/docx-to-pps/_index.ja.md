---
title: C++を介してDOCXをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCXをPPSにエクスポートする
url: /ja/cpp/conversion/docx-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="DOCXをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCXをPPSにエクスポートします。またはPowerPoint" >}}
