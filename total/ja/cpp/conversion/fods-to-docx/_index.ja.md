---
title: C++でFODSをDOCXに変換する
description: C++アプリケーション内でFODSをDOCXに変換する
url: /ja/cpp/conversion/fods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="C++経由でFODSをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのFODSからDOCXへ" >}}
