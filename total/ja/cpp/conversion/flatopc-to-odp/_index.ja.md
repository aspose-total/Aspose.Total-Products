---
title: C++を介してFLATOPCをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでFLATOPCをODPにエクスポートする
url: /ja/cpp/conversion/flatopc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="FLATOPCをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でFLATOPCをODPにエクスポートします。またはPowerPoint" >}}
