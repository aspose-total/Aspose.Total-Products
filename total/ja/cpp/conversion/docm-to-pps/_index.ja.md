---
title: C++を介してDOCMをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPPSにエクスポートする
url: /ja/cpp/conversion/docm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPPSにエクスポートします。またはPowerPoint" >}}
