---
title: C++を介してWORDをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでWORDをPOTXにエクスポートする
url: /ja/cpp/conversion/word-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="WORDをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でWORDをPOTXにエクスポートします。またはPowerPoint" >}}
