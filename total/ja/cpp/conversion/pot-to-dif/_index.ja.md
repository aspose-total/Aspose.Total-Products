---
title: C++を介してPOTをDIFに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをDIFにエクスポートする
url: /ja/cpp/conversion/pot-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからDIFファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTをDIFに変換する方法" %}}
