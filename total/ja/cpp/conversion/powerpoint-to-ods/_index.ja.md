---
title: C++を介してPOWERPOINTをODSに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOWERPOINTをODSにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOWERPOINTをODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOWERPOINTからODSファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOWERPOINTをODSに変換する方法" %}}
