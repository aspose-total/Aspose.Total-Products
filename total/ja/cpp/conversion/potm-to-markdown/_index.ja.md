...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをMARKDOWNにエクスポートする
url: /ja/cpp/conversion/potm-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをMARKDOWNに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからMARKDOWNファイルに変換" >}}
