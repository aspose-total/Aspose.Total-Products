...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLSMにエクスポートする
url: /ja/cpp/conversion/pps-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLSMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLSMファイルに変換" >}}
