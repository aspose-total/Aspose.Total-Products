---
title: C++を介してPOTXをTSVに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをTSVにエクスポートする
url: /ja/cpp/conversion/potx-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからTSVファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTXをTSVに変換する方法" %}}
