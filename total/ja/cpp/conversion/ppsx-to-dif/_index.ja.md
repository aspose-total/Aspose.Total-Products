...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをDIFにエクスポートする
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからDIFファイルに変換" >}}
