---
title: C++を介してDOTXをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPPTXにエクスポートする
url: /ja/cpp/conversion/dotx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPPTXにエクスポートします。またはPowerPoint" >}}
