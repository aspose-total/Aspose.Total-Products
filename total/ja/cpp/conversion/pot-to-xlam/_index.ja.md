---
title: C++を介してPOTをXLAMに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをXLAMにエクスポートする
url: /ja/cpp/conversion/pot-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからXLAMファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTをXLAMに変換する方法" %}}
