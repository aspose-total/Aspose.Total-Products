---
title: POTMをDOCXに変換するC++API
description: C++アプリケーション内でPOTMをDOCXにエクスポートする
url: /ja/cpp/conversion/potm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをDOCXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをDOCXにエクスポートする" >}}
