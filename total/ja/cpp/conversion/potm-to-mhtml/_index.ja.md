...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをMHTMLにエクスポートする
url: /ja/cpp/conversion/potm-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからMHTMLファイルに変換" >}}
