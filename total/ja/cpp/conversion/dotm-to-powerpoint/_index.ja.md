---
title: C++を介してDOTMをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTMをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/dotm-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTMをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTMをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
