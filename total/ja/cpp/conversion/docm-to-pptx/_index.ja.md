---
title: C++を介してDOCMをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPPTXにエクスポートする
url: /ja/cpp/conversion/docm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPPTXにエクスポートします。またはPowerPoint" >}}
