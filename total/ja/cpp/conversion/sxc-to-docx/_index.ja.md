---
title: C++でSXCをDOCXに変換する
description: C++アプリケーション内でSXCをDOCXに変換する
url: /ja/cpp/conversion/sxc-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="C++経由でSXCをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのSXCからDOCXへ" >}}
