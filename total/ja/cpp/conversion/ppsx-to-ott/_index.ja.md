---
title: PPSXをOTTに変換するC++API
description: C++アプリケーション内でPPSXをOTTにエクスポートする
url: /ja/cpp/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="PPSXをOTTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSXをOTTにエクスポートする" >}}
