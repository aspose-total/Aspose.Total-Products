---
title: PPTXをDOCに変換するC++API
description: C++アプリケーション内でPPTXをDOCにエクスポートする
url: /ja/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTXをDOCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTXをDOCにエクスポートする" >}}
...
4. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string)メンバー機能を使用して、ドキュメントをDOC形式で保存します。
