...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをTSVにエクスポートする
url: /ja/cpp/conversion/potm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからTSVファイルに変換" >}}
