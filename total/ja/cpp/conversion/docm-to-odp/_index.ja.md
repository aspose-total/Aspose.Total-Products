---
title: C++を介してDOCMをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをODPにエクスポートする
url: /ja/cpp/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをODPにエクスポートします。またはPowerPoint" >}}
