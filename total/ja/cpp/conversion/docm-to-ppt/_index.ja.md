---
title: C++を介してDOCMをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPPTにエクスポートする
url: /ja/cpp/conversion/docm-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPPTにエクスポートします。またはPowerPoint" >}}
