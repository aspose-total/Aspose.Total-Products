---
title: C++でWORDMLをXLSMに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにWORDMLをXLSMに変換するC++API
url: /ja/cpp/conversion/wordml-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDMLをXLSMに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でWORDMLをXLSMにエクスポートする" >}}
