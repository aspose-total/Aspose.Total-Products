---
title: C++を介してDOCをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをODPにエクスポートする
url: /ja/cpp/conversion/doc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをODPにエクスポートします。またはPowerPoint" >}}
