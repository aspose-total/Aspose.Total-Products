...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをSXCにエクスポートする
url: /ja/cpp/conversion/pot-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからSXCファイルに変換" >}}
