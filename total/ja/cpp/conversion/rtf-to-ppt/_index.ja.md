---
title: C++を介してRTFをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPPTにエクスポートする
url: /ja/cpp/conversion/rtf-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPPTにエクスポートします。またはPowerPoint" >}}
