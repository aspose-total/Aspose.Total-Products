---
title: C++を介してDOCMをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/docm-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
