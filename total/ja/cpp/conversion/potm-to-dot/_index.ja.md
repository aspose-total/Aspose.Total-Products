---
title: POTMをDOTに変換するC++API
description: C++アプリケーション内でPOTMをDOTにエクスポートする
url: /ja/cpp/conversion/potm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをDOTにエクスポートする" >}}
