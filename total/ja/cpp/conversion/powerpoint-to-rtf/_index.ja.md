---
title: POWERPOINTをRTFに変換するC++API
description: C++アプリケーション内でPOWERPOINTをRTFにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをRTFにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをRTFにエクスポートする" >}}
