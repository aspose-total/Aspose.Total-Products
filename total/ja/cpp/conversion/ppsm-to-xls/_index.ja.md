...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをXLSにエクスポートする
url: /ja/cpp/conversion/ppsm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをXLSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからXLSファイルに変換" >}}
