...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをMHTMLにエクスポートする
url: /ja/cpp/conversion/ppt-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからMHTMLファイルに変換" >}}
