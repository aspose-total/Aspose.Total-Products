...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをEXCELにエクスポートする
url: /ja/cpp/conversion/pps-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをEXCELに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからEXCELファイルに変換" >}}
