...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをSXCにエクスポートする
url: /ja/cpp/conversion/ppsm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからSXCファイルに変換" >}}
