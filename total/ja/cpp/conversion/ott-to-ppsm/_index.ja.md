---
title: C++を介してOTTをPPSMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPPSMにエクスポートする
url: /ja/cpp/conversion/ott-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPPSMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPPSMにエクスポートします。またはPowerPoint" >}}
