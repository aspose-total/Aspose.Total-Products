---
title: C++を介してDOCをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPPTにエクスポートする
url: /ja/cpp/conversion/doc-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPPTにエクスポートします。またはPowerPoint" >}}
