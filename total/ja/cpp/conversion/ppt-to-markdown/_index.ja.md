...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをMARKDOWNにエクスポートする
url: /ja/cpp/conversion/ppt-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをMARKDOWNに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからMARKDOWNファイルに変換" >}}
