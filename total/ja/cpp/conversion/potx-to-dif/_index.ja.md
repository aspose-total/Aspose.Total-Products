---
title: C++を介してPOTXをDIFに変換する
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをDIFにエクスポートする
url: /ja/cpp/conversion/potx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからDIFファイルに変換" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++を介してPOTXをDIFに変換する方法" %}}
