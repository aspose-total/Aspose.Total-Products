---
title: PPSMをDOCXに変換するC++API
description: C++アプリケーション内でPPSMをDOCXにエクスポートする
url: /ja/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="PPSMをDOCXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSMをDOCXにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppsm-to-docxm/" name="PPSM に DOCXM" description="" >}}
