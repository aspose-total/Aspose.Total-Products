...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをTSVにエクスポートする
url: /ja/cpp/conversion/ppsm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからTSVファイルに変換" >}}
