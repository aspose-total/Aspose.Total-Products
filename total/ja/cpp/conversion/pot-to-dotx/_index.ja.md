---
title: POTをDOTXに変換するC++API
description: C++アプリケーション内でPOTをDOTXにエクスポートする
url: /ja/cpp/conversion/pot-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POTをDOTXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTをDOTXにエクスポートする" >}}
