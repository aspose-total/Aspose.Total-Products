---
title: C++でXLSBをDOCXに変換する
description: C++アプリケーション内でXLSBをDOCXに変換する
url: /ja/cpp/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLSBをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLSBからDOCXへ" >}}
