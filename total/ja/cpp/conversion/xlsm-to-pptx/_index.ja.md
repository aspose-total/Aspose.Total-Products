---
title: C++でXLSMをPPTXに変換する
description: C++アプリケーション内でXLSMをPPTXに変換する
url: /ja/cpp/conversion/xlsm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLSMをPPTXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLSMからPPTXへ" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/xlsm-to-pptxx/" name="XLSM に PPTXX" description="" >}}
