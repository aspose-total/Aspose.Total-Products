---
title: C++を介してDOCをPOTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPOTXにエクスポートする
url: /ja/cpp/conversion/doc-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPOTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPOTXにエクスポートします。またはPowerPoint" >}}
