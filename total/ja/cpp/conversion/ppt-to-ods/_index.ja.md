...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをODSにエクスポートする
url: /ja/cpp/conversion/ppt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからODSファイルに変換" >}}
