---
title: C++でFODSをWORDに変換する
description: C++アプリケーション内でFODSをWORDに変換する
url: /ja/cpp/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="C++経由でFODSをWORDに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのFODSからWORDへ" >}}
