---
title: PPSをFLATOPCに変換するC++API
description: C++アプリケーション内でPPSをFLATOPCにエクスポートする
url: /ja/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをFLATOPCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをFLATOPCにエクスポートする" >}}
...
4. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.flatopcument#save_string)メンバー機能を使用して、ドキュメントをFLATOPC形式で保存します。
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pps-to-flatopcx/" name="PPS に FLATOPCX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/pps-to-flatopcm/" name="PPS に FLATOPCM" description="" >}}
