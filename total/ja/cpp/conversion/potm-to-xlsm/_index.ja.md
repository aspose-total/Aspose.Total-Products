...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをXLSMにエクスポートする
url: /ja/cpp/conversion/potm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをXLSMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからXLSMファイルに変換" >}}
