---
title: C++でXLSMをDOCXに変換する
description: C++アプリケーション内でXLSMをDOCXに変換する
url: /ja/cpp/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="C++経由でXLSMをDOCXに変換する" h2="Excelをエクスポート＆reg;フル機能のC++アプリケーション内でのXLSMからDOCXへ" >}}
