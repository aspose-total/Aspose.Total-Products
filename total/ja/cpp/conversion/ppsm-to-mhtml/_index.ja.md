...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをMHTMLにエクスポートする
url: /ja/cpp/conversion/ppsm-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからMHTMLファイルに変換" >}}
