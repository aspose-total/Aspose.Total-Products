---
title: C++を介してODTをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをPOTMにエクスポートする
url: /ja/cpp/conversion/odt-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをPOTMにエクスポートします。またはPowerPoint" >}}
