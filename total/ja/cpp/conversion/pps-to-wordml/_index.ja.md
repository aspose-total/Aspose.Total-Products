---
title: PPSをWORDMLに変換するC++API
description: C++アプリケーション内でPPSをWORDMLにエクスポートする
url: /ja/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをWORDMLにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをWORDMLにエクスポートする" >}}
