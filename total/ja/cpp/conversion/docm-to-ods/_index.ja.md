---
title: C++でDOCMをODSに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにDOCMをODSに変換するC++API
url: /ja/cpp/conversion/docm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをODSに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でDOCMをODSにエクスポートする" >}}
