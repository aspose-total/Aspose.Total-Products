...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをXLTにエクスポートする
url: /ja/cpp/conversion/potx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからXLTファイルに変換" >}}
