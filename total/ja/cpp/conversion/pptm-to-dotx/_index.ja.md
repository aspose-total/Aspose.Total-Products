---
title: PPTMをDOTXに変換するC++API
description: C++アプリケーション内でPPTMをDOTXにエクスポートする
url: /ja/cpp/conversion/pptm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="PPTMをDOTXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTMをDOTXにエクスポートする" >}}
