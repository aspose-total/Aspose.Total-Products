---
title: POTXをDOCMに変換するC++API
description: C++アプリケーション内でPOTXをDOCMにエクスポートする
url: /ja/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTXをDOCMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTXをDOCMにエクスポートする" >}}
