---
title: C++を介してDOCXをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCXをODPにエクスポートする
url: /ja/cpp/conversion/docx-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="DOCXをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCXをODPにエクスポートします。またはPowerPoint" >}}
