...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをXLTにエクスポートする
url: /ja/cpp/conversion/ppsx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからXLTファイルに変換" >}}
