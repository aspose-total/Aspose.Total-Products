...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをMARKDOWNにエクスポートする
url: /ja/cpp/conversion/ppsx-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをMARKDOWNに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからMARKDOWNファイルに変換" >}}
