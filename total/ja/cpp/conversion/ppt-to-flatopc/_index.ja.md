---
title: PPTをFLATOPCに変換するC++API
description: C++アプリケーション内でPPTをFLATOPCにエクスポートする
url: /ja/cpp/conversion/ppt-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPTをFLATOPCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTをFLATOPCにエクスポートする" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppt-to-flatopcm/" name="PPT に FLATOPCM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ja/cpp/conversion/ppt-to-flatopcx/" name="PPT に FLATOPCX" description="" >}}
