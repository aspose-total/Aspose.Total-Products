---
title: POTをDOCXに変換するC++API
description: C++アプリケーション内でPOTをDOCXにエクスポートする
url: /ja/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="POTをDOCXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTをDOCXにエクスポートする" >}}
