---
title: C++を介してDOTXをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをPOTにエクスポートする
url: /ja/cpp/conversion/dotx-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをPOTにエクスポートします。またはPowerPoint" >}}
