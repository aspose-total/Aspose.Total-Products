...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをDIFにエクスポートする
url: /ja/cpp/conversion/ppsm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをDIFに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからDIFファイルに変換" >}}
