---
title: C++を介してWORDをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでWORDをPPSにエクスポートする
url: /ja/cpp/conversion/word-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="WORDをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でWORDをPPSにエクスポートします。またはPowerPoint" >}}
