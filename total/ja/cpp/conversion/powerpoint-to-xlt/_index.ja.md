...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOWERPOINTをXLTにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOWERPOINTをXLTに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOWERPOINTからXLTファイルに変換" >}}
