---
title: C++を介してODTをPPTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをPPTにエクスポートする
url: /ja/cpp/conversion/odt-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをPPTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをPPTにエクスポートします。またはPowerPoint" >}}
