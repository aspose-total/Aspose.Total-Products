---
title: POTMをODTに変換するC++API
description: C++アプリケーション内でPOTMをODTにエクスポートする
url: /ja/cpp/conversion/potm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをODTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをODTにエクスポートする" >}}
