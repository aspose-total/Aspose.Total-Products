...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをXLSXにエクスポートする
url: /ja/cpp/conversion/ppsm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをXLSXに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからXLSXファイルに変換" >}}
