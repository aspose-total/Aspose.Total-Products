---
title: POTXをDOTに変換するC++API
description: C++アプリケーション内でPOTXをDOTにエクスポートする
url: /ja/cpp/conversion/potx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="POTXをDOTにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTXをDOTにエクスポートする" >}}
