---
title: POWERPOINTをDOCMに変換するC++API
description: C++アプリケーション内でPOWERPOINTをDOCMにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをDOCMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをDOCMにエクスポートする" >}}
