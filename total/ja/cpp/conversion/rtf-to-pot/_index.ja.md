---
title: C++を介してRTFをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPOTにエクスポートする
url: /ja/cpp/conversion/rtf-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPOTにエクスポートします。またはPowerPoint" >}}
