---
title: C++を介してOTTをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/ott-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
