---
title: C++を介してTXTをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPPTXにエクスポートする
url: /ja/cpp/conversion/txt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPPTXにエクスポートします。またはPowerPoint" >}}
