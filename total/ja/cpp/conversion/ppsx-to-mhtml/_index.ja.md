...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSXをMHTMLにエクスポートする
url: /ja/cpp/conversion/ppsx-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSXをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSXからMHTMLファイルに変換" >}}
