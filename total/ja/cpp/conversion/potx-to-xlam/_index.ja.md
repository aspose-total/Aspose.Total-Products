...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをXLAMにエクスポートする
url: /ja/cpp/conversion/potx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからXLAMファイルに変換" >}}
