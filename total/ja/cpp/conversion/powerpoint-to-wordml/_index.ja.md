...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをWORDMLにレンダリングするC++API またはオンライン" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをWORDMLにエクスポートする" >}}
