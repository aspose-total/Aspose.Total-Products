---
title: POWERPOINTをWORDMLに変換するC++API
description: C++アプリケーション内でPOWERPOINTをWORDMLにエクスポートする
url: /ja/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="POWERPOINTをWORDMLにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOWERPOINTをWORDMLにエクスポートする" >}}
