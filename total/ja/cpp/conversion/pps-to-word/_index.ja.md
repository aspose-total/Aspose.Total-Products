---
title: PPSをWORDに変換するC++API
description: C++アプリケーション内でPPSをWORDにエクスポートする
url: /ja/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="PPSをWORDにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPSをWORDにエクスポートする" >}}
