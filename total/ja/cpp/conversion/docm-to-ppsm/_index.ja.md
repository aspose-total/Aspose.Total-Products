---
title: C++を介してDOCMをPPSMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCMをPPSMにエクスポートする
url: /ja/cpp/conversion/docm-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="DOCMをPPSMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCMをPPSMにエクスポートします。またはPowerPoint" >}}
...
2. [保存](https://reference.aspose.com/words/cpp/class/aspose.words.docmument#save_stdbasicostream_saveoptions)メンバー関数を使用してDOCMをHTMLに変換します
