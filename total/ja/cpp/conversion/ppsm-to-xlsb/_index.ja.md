...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSMをXLSBにエクスポートする
url: /ja/cpp/conversion/ppsm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSMをXLSBに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSMからXLSBファイルに変換" >}}
