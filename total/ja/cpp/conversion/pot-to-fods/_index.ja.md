...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをFODSにエクスポートする
url: /ja/cpp/conversion/pot-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをFODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからFODSファイルに変換" >}}
