---
title: PPTをDOCXに変換するC++API
description: C++アプリケーション内でPPTをDOCXにエクスポートする
url: /ja/cpp/conversion/ppt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="PPTをDOCXにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTをDOCXにエクスポートする" >}}
