---
title: C++を介してWORDをPPTXに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでWORDをPPTXにエクスポートする
url: /ja/cpp/conversion/word-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="WORDをPPTXに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でWORDをPPTXにエクスポートします。またはPowerPoint" >}}
