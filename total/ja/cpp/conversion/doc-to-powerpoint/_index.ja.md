---
title: C++を介してDOCをPOWERPOINTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOCをPOWERPOINTにエクスポートする
url: /ja/cpp/conversion/doc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="DOCをPOWERPOINTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOCをPOWERPOINTにエクスポートします。またはPowerPoint" >}}
