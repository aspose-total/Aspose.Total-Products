...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをSXCにエクスポートする
url: /ja/cpp/conversion/pps-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをSXCに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからSXCファイルに変換" >}}
