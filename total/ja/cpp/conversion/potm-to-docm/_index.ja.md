---
title: POTMをDOCMに変換するC++API
description: C++アプリケーション内でPOTMをDOCMにエクスポートする
url: /ja/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをDOCMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをDOCMにエクスポートする" >}}
