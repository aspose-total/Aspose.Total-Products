...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをTSVにエクスポートする
url: /ja/cpp/conversion/pps-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをTSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからTSVファイルに変換" >}}
