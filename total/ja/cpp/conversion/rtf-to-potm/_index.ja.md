---
title: C++を介してRTFをPOTMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでRTFをPOTMにエクスポートする
url: /ja/cpp/conversion/rtf-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="RTFをPOTMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でRTFをPOTMにエクスポートします。またはPowerPoint" >}}
