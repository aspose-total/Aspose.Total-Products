...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをCSVにエクスポートする
url: /ja/cpp/conversion/potx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをCSVに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからCSVファイルに変換" >}}
