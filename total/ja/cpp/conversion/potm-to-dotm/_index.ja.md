---
title: POTMをDOTMに変換するC++API
description: C++アプリケーション内でPOTMをDOTMにエクスポートする
url: /ja/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="POTMをDOTMにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPOTMをDOTMにエクスポートする" >}}
