---
title: PPTXをFLATOPCに変換するC++API
description: C++アプリケーション内でPPTXをFLATOPCにエクスポートする
url: /ja/cpp/conversion/pptx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="PPTXをFLATOPCにレンダリングするC++API" h2="MicrosoftPowerPointやWordに依存せずにC++アプリケーションでPPTXをFLATOPCにエクスポートする" >}}
