...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTをODSにエクスポートする
url: /ja/cpp/conversion/pot-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTをODSに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTからODSファイルに変換" >}}
