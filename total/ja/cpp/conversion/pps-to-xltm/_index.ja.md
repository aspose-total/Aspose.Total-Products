...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPSをXLTMにエクスポートする
url: /ja/cpp/conversion/pps-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPSをXLTMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPSからXLTMファイルに変換" >}}
