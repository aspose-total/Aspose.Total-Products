---
title: C++を介してOTTをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでOTTをODPにエクスポートする
url: /ja/cpp/conversion/ott-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="OTTをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でOTTをODPにエクスポートします。またはPowerPoint" >}}
