---
title: C++を介してODTをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをODPにエクスポートする
url: /ja/cpp/conversion/odt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをODPにエクスポートします。またはPowerPoint" >}}
