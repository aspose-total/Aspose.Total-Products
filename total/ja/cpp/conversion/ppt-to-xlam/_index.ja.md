...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPPTをXLAMにエクスポートする
url: /ja/cpp/conversion/ppt-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPPTをXLAMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPPTからXLAMファイルに変換" >}}
...
2. [保存](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba)メソッドを使用してPPTをHTMLに変換します
