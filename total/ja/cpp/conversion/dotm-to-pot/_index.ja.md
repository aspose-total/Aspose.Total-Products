---
title: C++を介してDOTMをPOTに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTMをPOTにエクスポートする
url: /ja/cpp/conversion/dotm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="DOTMをPOTに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTMをPOTにエクスポートします。またはPowerPoint" >}}
