---
title: C++を介してTXTをPPSに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでTXTをPPSにエクスポートする
url: /ja/cpp/conversion/txt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="TXTをPPSに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でTXTをPPSにエクスポートします。またはPowerPoint" >}}
