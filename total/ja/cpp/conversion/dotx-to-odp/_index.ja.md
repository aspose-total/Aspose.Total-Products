---
title: C++を介してDOTXをODPに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでDOTXをODPにエクスポートする
url: /ja/cpp/conversion/dotx-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="DOTXをODPに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でDOTXをODPにエクスポートします。またはPowerPoint" >}}
