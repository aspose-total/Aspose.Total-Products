...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTXをMHTMLにエクスポートする
url: /ja/cpp/conversion/potx-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTXをMHTMLに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTXからMHTMLファイルに変換" >}}
