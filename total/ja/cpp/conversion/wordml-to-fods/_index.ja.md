---
title: C++でWORDMLをFODSに変換する
description: MicrosoftWordまたはMicrosoftExcelを使用せずにWORDMLをFODSに変換するC++API
url: /ja/cpp/conversion/wordml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="WORDMLをFODSに変換するC++API" h2="Microsoft <sup>&reg;</sup>WordまたはMicrosoft<sup>&reg;</sup>Excelを使用せずにC++経由でWORDMLをFODSにエクスポートする" >}}
