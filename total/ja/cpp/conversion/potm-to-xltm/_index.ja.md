...
description: MicrosoftExcelまたはPowerpointを使用せずにC++でPOTMをXLTMにエクスポートする
url: /ja/cpp/conversion/potm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++を介してPOTMをXLTMに変換する" h2="Microsoft <sup>&reg;</sup>ExcelまたはPowerPointを使用せずにC++を介してPOTMからXLTMファイルに変換" >}}
