---
title: C++を介してODTをPPSMに変換する
description: Microsoft WordofPowerPointを使用せずにC++アプリケーションでODTをPPSMにエクスポートする
url: /ja/cpp/conversion/odt-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="ODTをPPSMに変換するC++API" h2="Microsoft Wordを使用せずに、C++アプリケーション内でODTをPPSMにエクスポートします。またはPowerPoint" >}}
