---
title: Python を使用して XLS を MOBI に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLS から MOBI への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをMOBIに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLS から MOBI への変換" >}}
