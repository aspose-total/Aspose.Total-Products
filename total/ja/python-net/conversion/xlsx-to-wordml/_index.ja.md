---
title: Python を使用して XLSX を WORDML に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLSX から WORDML への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSXをWORDMLに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLSX から WORDML への変換" >}}
