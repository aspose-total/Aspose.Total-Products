---
title: Python で OFT を ODT に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで OFT を ODT に保存します。 
url: /ja/python-net/conversion/oft-to-odt/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Python を使用して OFT を ODT に変換する" h2="Microsoft Word<sup>&reg;</sup> または Outlook をインストールせずに、Python アプリケーションで OFT から ODT への変換。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python で OFT を ODT に変換する方法" %}}
...
- OFT から ODT への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでOFTをODTに保存" offSpacer="" %}}
