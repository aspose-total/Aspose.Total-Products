---
title: Python を使用して XLTX を POT に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLTX から POT への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTXをPOTに変換" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLTX から POT への変換" >}}
