---
title: Python で EMAIL を OTT に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EMAIL を OTT に保存します。 
url: /ja/python-net/conversion/email-to-ott/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL から OTT への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMAILをOTTに保存" offSpacer="" %}}
