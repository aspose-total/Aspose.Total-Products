---
title: Python で MSG を DOC に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで MSG を DOC に保存します。 
url: /ja/python-net/conversion/msg-to-doc/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- MSG から DOC への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでMSGをDOCに保存" offSpacer="" %}}
