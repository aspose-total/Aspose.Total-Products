...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTをDOTに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLT から DOT への変換" >}}
