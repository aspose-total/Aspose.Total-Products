...
{{< blocks/products/pf/feature-page-header h1="Python を使用して RTF を PPTM に変換する またはオンライン" h2="Microsoft Word<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで RTF から PPTM への変換" >}}
