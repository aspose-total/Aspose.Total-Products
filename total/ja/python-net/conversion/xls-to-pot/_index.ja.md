...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをPOTに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLS から POT への変換" >}}
