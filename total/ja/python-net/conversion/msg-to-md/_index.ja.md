---
title: Python で MSG を MD に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで MSG を MD に保存します。 
url: /ja/python-net/conversion/msg-to-md/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- MSG から MD への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでMSGをMDに保存" offSpacer="" %}}
