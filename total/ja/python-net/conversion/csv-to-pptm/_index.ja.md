---
title: Python を使用して CSV を PPTM に変換する
description: Microsoft Office を使用しない Python アプリケーションでの CSV から PPTM への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でCSVをPPTMに変換" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで CSV から PPTM への変換" >}}
