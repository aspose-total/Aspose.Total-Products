---
title: Python を使用して XLT を DOTM に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLT から DOTM への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTをDOTMに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLT から DOTM への変換" >}}
