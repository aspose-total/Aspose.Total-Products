...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTXをPPTMに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLTX から PPTM への変換" >}}
