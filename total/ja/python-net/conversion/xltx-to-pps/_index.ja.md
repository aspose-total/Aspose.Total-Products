---
title: Python を使用して XLTX を PPS に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLTX から PPS への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTXをPPSに変換" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLTX から PPS への変換" >}}
