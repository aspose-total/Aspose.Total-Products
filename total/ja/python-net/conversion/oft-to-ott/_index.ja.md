---
title: Python で OFT を OTT に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで OFT を OTT に保存します。 
url: /ja/python-net/conversion/oft-to-ott/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- OFT から OTT への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでOFTをOTTに保存" offSpacer="" %}}
