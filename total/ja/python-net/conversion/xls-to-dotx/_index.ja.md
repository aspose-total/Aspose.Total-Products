...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをDOTXに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLS から DOTX への変換" >}}
