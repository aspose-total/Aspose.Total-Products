---
title: Python を使用して PPSX を XLSB に変換する
description: Microsoft Office を使用しない Python アプリケーションでの PPSX から XLSB への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でPPSXをXLSBに変換" h2="Microsoft PowerPoint<sup>&reg;</sup> または Excel をインストールせずに、Python アプリケーションで PPSX から XLSB への変換" >}}
