---
title: Python で EML を DOC に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EML を DOC に保存します。 
url: /ja/python-net/conversion/eml-to-doc/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- EML から DOC への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMLをDOCに保存" offSpacer="" %}}
