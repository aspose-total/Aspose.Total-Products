---
title: Python を使用して XLS を ODT に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLS から ODT への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをODTに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLS から ODT への変換" >}}
