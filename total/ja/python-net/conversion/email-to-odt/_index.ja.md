---
title: Python で EMAIL を ODT に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EMAIL を ODT に保存します。 
url: /ja/python-net/conversion/email-to-odt/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
{{< blocks/products/pf/feature-page-header h1="Python を使用して EMAIL を ODT に変換する" h2="Microsoft Word<sup>&reg;</sup> または Outlook をインストールせずに、Python アプリケーションで EMAIL から ODT への変換。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python で EMAIL を ODT に変換する方法" %}}
...
- EMAIL から ODT への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMAILをODTに保存" offSpacer="" %}}
