---
title: Python で EMAIL を DOCM に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EMAIL を DOCM に保存します。 
url: /ja/python-net/conversion/email-to-docm/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL から DOCM への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMAILをDOCMに保存" offSpacer="" %}}
