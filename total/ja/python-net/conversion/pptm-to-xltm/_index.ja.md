---
title: Python を使用して PPTM を XLTM に変換する
description: Microsoft Office を使用しない Python アプリケーションでの PPTM から XLTM への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でPPTMをXLTMに変換" h2="Microsoft PowerPoint<sup>&reg;</sup> または Excel をインストールせずに、Python アプリケーションで PPTM から XLTM への変換" >}}
