...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTXをPPTに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLTX から PPT への変換" >}}
