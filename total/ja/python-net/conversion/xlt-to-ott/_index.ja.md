---
title: Python を使用して XLT を OTT に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLT から OTT への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTをOTTに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLT から OTT への変換" >}}
