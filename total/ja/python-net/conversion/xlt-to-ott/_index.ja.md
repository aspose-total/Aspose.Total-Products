...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTをOTTに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLT から OTT への変換" >}}
