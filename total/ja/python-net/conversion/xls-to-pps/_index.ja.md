---
title: Python を使用して XLS を PPS に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLS から PPS への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをPPSに変換" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLS から PPS への変換" >}}
