---
title: Python を使用して XLSX を DOT に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLSX から DOT への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSXをDOTに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLSX から DOT への変換" >}}
