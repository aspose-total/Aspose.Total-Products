---
title: Python を使用して FODS を WORDML に変換する
description: Microsoft Office を使用しない Python アプリケーションでの FODS から WORDML への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でFODSをWORDMLに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで FODS から WORDML への変換" >}}
