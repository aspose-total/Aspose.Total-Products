---
title: Python で MSG を OTT に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで MSG を OTT に保存します。 
url: /ja/python-net/conversion/msg-to-ott/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- MSG から OTT への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでMSGをOTTに保存" offSpacer="" %}}
