---
title: Python で EMAIL を MD に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EMAIL を MD に保存します。 
url: /ja/python-net/conversion/email-to-md/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- EMAIL から MD への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMAILをMDに保存" offSpacer="" %}}
