---
title: Python を使用して XLTX を POTX に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLTX から POTX への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLTXをPOTXに変換" h2="Microsoft Excel<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで XLTX から POTX への変換" >}}
