...
{{< blocks/products/pf/feature-page-header h1="Python経由でODSをDOTMに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで ODS から DOTM への変換" >}}
