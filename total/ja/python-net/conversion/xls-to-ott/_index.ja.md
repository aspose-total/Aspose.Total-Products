---
title: Python を使用して XLS を OTT に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLS から OTT への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSをOTTに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLS から OTT への変換" >}}
