---
title: Python で OFT を DOCM に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで OFT を DOCM に保存します。 
url: /ja/python-net/conversion/oft-to-docm/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- OFT から DOCM への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでOFTをDOCMに保存" offSpacer="" %}}
