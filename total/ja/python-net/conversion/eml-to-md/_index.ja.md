---
title: Python で EML を MD に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで EML を MD に保存します。 
url: /ja/python-net/conversion/eml-to-md/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- EML から MD への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでEMLをMDに保存" offSpacer="" %}}
