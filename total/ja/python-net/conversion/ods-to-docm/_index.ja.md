...
{{< blocks/products/pf/feature-page-header h1="Python経由でODSをDOCMに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで ODS から DOCM への変換" >}}
