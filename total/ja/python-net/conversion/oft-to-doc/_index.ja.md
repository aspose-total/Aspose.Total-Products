---
title: Python で OFT を DOC に変換する
description: Microsoft Outlook や Word を使用せずに、Python アプリケーションで OFT を DOC に保存します。 
url: /ja/python-net/conversion/oft-to-doc/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- OFT から DOC への変換には、Python 3.5 以降が必要です。
...
{{% blocks/products/pf/agp/code-block title="PythonでOFTをDOCに保存" offSpacer="" %}}
