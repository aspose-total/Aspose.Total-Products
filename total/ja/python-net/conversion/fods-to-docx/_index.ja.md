...
{{< blocks/products/pf/feature-page-header h1="Python経由でFODSをDOCXに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで FODS から DOCX への変換" >}}
