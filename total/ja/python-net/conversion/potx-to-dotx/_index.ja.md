...
{{< blocks/products/pf/feature-page-header h1="Python を使用して POTX を DOTX に変換する またはオンライン" h2="Microsoft Word<sup>&reg;</sup> または PowerPoint をインストールせずに、Python アプリケーションで POTX から DOTX への変換" >}}
