...
{{< blocks/products/pf/feature-page-header h1="Python経由でCSVをWORDに変換 またはオンライン" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで CSV から WORD への変換" >}}
