---
title: Python を使用して XLSX を DOTM に変換する
description: Microsoft Office を使用しない Python アプリケーションでの XLSX から DOTM への変換 
...
{{< blocks/products/pf/feature-page-header h1="Python経由でXLSXをDOTMに変換" h2="Microsoft Excel<sup>&reg;</sup> または Word をインストールせずに、Python アプリケーションで XLSX から DOTM への変換" >}}
