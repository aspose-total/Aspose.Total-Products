---
title: PPSX ファイルをオンラインで表示し、Python を使用して PPSX ファイルをロードまたは開く
description: 無料のオンライン PPSX ファイル ビューア アプリ。ビューア アプリケーション用の PPSX ファイルをロードして開くための Python API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="PPSX ファイルをオンラインで自由に表示し、Python 経由でドキュメントを開いたりロードしたりできます" h2="強力な Python ベースの PPSX ドキュメント ビューア ユーティリティ アプリケーションを開発します。Python を介して PPSX ドキュメントをロードまたは開くためのコードのリスト。" >}}




{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="オンラインアプリ経由でPPSXドキュメントを表示" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ビューア アプリ用に Python 経由で PPSX ファイルをロードまたは開く" %}}

1. PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/)) からプロジェクト内の API を直接参照する
1. Presentation クラス オブジェクトを作成し、それを使用してソース PPSX ファイルを読み込みます。
1. 各スライドを繰り返し処理して、独自に開発した Viewer アプリのコンテンツを取得します。
1. または、同じAPIのsaveメソッドを使用してソースファイルをHTMLに変換します。
1. そして、subprocess.run を使用してブラウザを起動し、PPSX ファイルを表示します。
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="PPSX ファイルを表示するための Python のコード例" offSpacer="" %}}
