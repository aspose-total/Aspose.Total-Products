---
title: PPS ファイルをオンラインで表示し、Python を使用して PPS ファイルをロードまたは開く
description: 無料のオンライン PPS ファイル ビューア アプリ。ビューア アプリケーション用の PPS ファイルをロードして開くための Python API コード。
...
{{< blocks/products/pf/feature-page-header-widget h1="PPS ファイルをオンラインで自由に表示し、Python 経由でドキュメントを開いたりロードしたりできます" h2="強力な Python ベースの PPS ドキュメント ビューア ユーティリティ アプリケーションを開発します。Python を介して PPS ドキュメントをロードまたは開くためのコードのリスト。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ビューア アプリ用に Python 経由で PPS ファイルをロードまたは開く" %}}

1. PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/)) からプロジェクト内の API を直接参照する
1. Presentation クラス オブジェクトを作成し、それを使用してソース PPS ファイルを読み込みます。
1. 各スライドを繰り返し処理して、独自に開発した Viewer アプリのコンテンツを取得します。
1. または、同じAPIのsaveメソッドを使用してソースファイルをHTMLに変換します。
1. そして、subprocess.run を使用してブラウザを起動し、PPS ファイルを表示します。
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="PPS ファイルを表示するための Python のコード例" offSpacer="" %}}
