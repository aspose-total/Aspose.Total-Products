---
title: Traitement PDF et ajout OCR via les API JavaScript
description: API JavaScript pour manipuler des documents PDF et ajouter une fonctionnalité OCR dans les applications Web.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API JavaScript pour PDF et OCR" h2="Ajoutez des fonctionnalités de manipulation OCR et PDF dans les applications Web sans aucune autre dépendance logicielle" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.PDF for JavaScript via C++ est une boîte à outils conviviale et sécurisée conçue pour travailler avec des PDF directement dans les navigateurs Web.Cette bibliothèque prend en charge 26 langues, dont les caractères latins, cyrilliques et chinois.
...
Aspose.Cells for JavaScript via C++ est une puissante API basée sur WebAssembly qui offre des performances quasi natives pour la création, l'édition, la conversion et le rendu de feuilles de calcul aux formats Excel (XLS, XLSX, XLSB, XLSM), ODS, CSV et HTML, dans les navigateurs et les environnements Node.js. Conçue pour une compatibilité et une flexibilité maximales, elle permet un traitement fluide des feuilles de calcul sans serveur, ce qui la rend idéale pour les applications sans serveur, les tableaux de bord, les pipelines de données et les outils de génération de documents. Grâce à sa légèreté et à sa prise en charge complète des principaux formats Excel, Aspose.Cells pour JavaScript via C++ garantit une manipulation rapide, fiable et performante des feuilles de calcul sur les plateformes web, côté serveur et hybrides.
...
Aspose.OCR for JavaScript via C++ donne à vos applications une reconnaissance optique efficace des caractères en seulement 8 lignes de code.
...
<h2 class="pr-ft">
 ...
 Présentation de JavaScript via les bibliothèques C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Ajouter des images dans des documents PDF
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Prend en charge n'importe quelle image que vous pouvez obtenir à partir d'un scanner ou d'un appareil photo
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Détecte et reconnaît toutes les polices et formats populaires
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Traite l'image entière ou les zones sélectionnées uniquement
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Prend en charge les images pivotées, asymétriques et bruitées
    </p>
   </div>
   <div class="col-lg-4">
...
{{< blocks/products/pf/testimonials-quote poster="Stefan Studer | Nowhow Solutions SA, Suisse" >}}
Le manuel d'instructions bien documenté et la robustesse des composants Aspose.Total ont conduit à une intégration simple dans DOCO.Cela nous a aidé à réduire le temps de développement plus que prévu.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Bryan Thornton | Net Reaction LLC, États-Unis" >}}
Nous avons une expérience significative avec la bureautique et le produit Office Writer de Soft Artisans.Total.NET d'Aspose est plus robuste et offre plus de fonctionnalités que tout ce que nous avons utilisé dans le passé.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Mark Foley | Lion Nathan National Foods, Australie" >}}
En effet, la suite Aspose.Total pour .NET est le « couteau suisse » des composants que nous utilisons.Assis aux côtés des composants de la couche de présentation, il constitue le « ciment » pour extraire et pousser les fichiers de données dans le format souhaité.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualitech, France" >}}
La mise en œuvre a été simple, nous nous concentrons vraiment sur notre architecture et Aspose s'intègre simplement. Notre architecture est hautement optimisée pour les performances et le multi-threading, et encore une fois, l'utilisation d'Aspose.Total.net ne pose aucun problème.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Total pour C++" tabId="success-stories" >}}
