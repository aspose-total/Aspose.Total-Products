---
title: Supprimez l'annotation XLS en ligne ou gérez les annotations via .NET
description: supprimez gratuitement les commentaires du fichier XLS via l'application en ligne.Code API .NET pour gérer les commentaires des fichiers XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Effacer les commentaires du document XLS en ligne ou gérer via .NET" h2="Développez une puissante application utilitaire d’annotation de documents XLS basée sur .NET.Code répertorié pour la gestion des commentaires du fichier XLS via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires XLS via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : supprimer les commentaires du fichier XLS" offSpacer="" %}}
