---
title: Supprimez l'annotation XLT en ligne ou gérez les annotations via .NET
description: supprimez gratuitement les commentaires du fichier XLT via l'application en ligne.Code API .NET pour gérer les commentaires des fichiers XLT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Effacer les commentaires du document XLT en ligne ou gérer via .NET" h2="Développez une puissante application utilitaire d’annotation de documents XLT basée sur .NET.Code répertorié pour la gestion des commentaires du fichier XLT via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires XLT via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : supprimer les commentaires du fichier XLT" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents XLT via .NET</h2>

Besoin de développer une application ou un utilitaire d'annotation XLT pour fournir des commentaires, faire des suggestions ou collaborer avec d'autres sur le document ?Avec [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format XLT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque .NET pour annoter les fichiers XLT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
Les fichiers XLT (modèles Excel) offrent des structures préalablement définies pour les tableurs. Les annotations identifient les emplacements de remplacement, fournissent des instructions ou capturent des commentaires pendant la personnalisation du modèle.

- **Instructions du Modèle** : Ajouter des commentaires pour guider les utilisateurs finals sur les champs d'entrée.
  
- **Révision du Modèle** : Annoter des formules ou des suggestions de mise en page pour améliorer le modèle.
  
- **Notes Équipe** : Collaborer sur les ébauches initiales des modèles avec des notes contextuelles.
