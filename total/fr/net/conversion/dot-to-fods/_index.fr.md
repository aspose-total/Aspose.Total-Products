---
title: API .NET pour convertir DOT en FODS ou avec le convertisseur en ligne gratuit
description: API C# pour convertir DOT en FODS ou application en ligne sans utiliser Microsoft Excel ou Adobe Reader ou en ligne. Testez rapidement le convertisseur en ligne DOT vers FODS gratuit avant d'intégrer le code. 
url_ignore: /fr/net/conversion/dot-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOT en FODS ou application en ligne" h2="Exportez DOT vers FODS via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
