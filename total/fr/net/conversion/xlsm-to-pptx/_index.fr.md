---
title: Convertir XLSM en PPTX avec .NET 
description: Convertir XLSM en PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSM en PPTX via C#" h2="Exporter Excel® XLSM vers PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
