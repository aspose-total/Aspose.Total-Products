---
title: API .NET pour convertir DOTX en XLTX
description: API C# pour convertir DOTX en XLTX sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOTX en XLTX" h2="Exportez DOTX vers XLTX via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le dotxument au format XLTX à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLTX` comme SaveFormat
