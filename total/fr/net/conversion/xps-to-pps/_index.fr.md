...
<iframe title="Application de conversion en ligne gratuite XPS vers PPS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=pps&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertir XPS en PPS via C# .NET" offSpacer="" %}}
