---
title: Convertir PPSX en CSV via C#
description: Convertir PPSX en CSV en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSX en CSV via C#" h2="API .NET pour la conversion PPSX en CSV sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
