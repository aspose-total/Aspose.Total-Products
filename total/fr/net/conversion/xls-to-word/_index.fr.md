---
title: Convertir XLS en WORD avec .NET 
description: Convertir XLS en WORD sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
url: /fr/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLS en WORD via C#" h2="Exporter Excel® XLS vers WORD sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
