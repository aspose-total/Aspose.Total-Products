---
title: Convertir XLSB en DOCX avec .NET 
description: Convertir XLSB en DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSB en DOCX via C#" h2="Exporter Excel® XLSB vers DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
