---
title: Exporter MHTML vers PPS via l'API C#
description: API .NET pour convertir MHTML en PPS sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/mhtml-to-pps/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MHTML vers PPS via .NET" h2="API .NET pour exporter MHTML vers PPS sur Windows, macOS et Linux sans utiliser Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir MHTML en PPS" %}}
