---
title: Convertir POTX en FLATOPC via C# .NET ou avec le convertisseur en ligne gratuit
description: Convertissez des documents PowerPoint potx en fichiers flatopc Word avec C#. Convertissez plusieurs fichiers dans ASP.NET ou d'autres applications .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir POTX en FLATOPC en utilisant C# ou en ligne" h2="Créez des applications de conversion de documents Microsoft PowerPoint POTX vers Word FLATOPC sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTX" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Total " subTitlepfName="for .NET" >}}
{{% blocks/products/pf/agp/content h2="Comment convertir POTX en FLATOPC en utilisant C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir POTX en FLATOPC via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre comment convertir un POTX en FLATOPC à l'aide de C#" offSpacer="" %}}
...
<h3>Convertisseur en ligne pour POTX en FLATOPC</h3>
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Application gratuite pour convertir POTX en FLATOPC" sectionDescription="" >}}
