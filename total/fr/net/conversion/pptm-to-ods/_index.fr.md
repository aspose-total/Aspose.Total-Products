---
title: Conversion en ligne de PPTM en ODS ou création d'une application basée sur .NET pour convertir des fichiers PPTM
description: Application en ligne gratuite pour convertir des fichiers PPTM en ODS. Code de bibliothèque de conversion .NET C# pour les documents PPTM. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne PPTM en ODS et code .NET pour convertir les fichiers PPTM" h2="Développer une puissante application de conversion et d'exportation PPTM basée sur .NET. Convertissez un ou plusieurs fichiers PPTM en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers PPTM en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite PPTM vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=pptm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers PPTM en ODS en ligne à l'aide de l'application" %}}
...
1. PPTM sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir PPTM en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir PPTM en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer PPTM dans ODS avec d'autres fonctionnalités comme Convertir PPTM protégé en ODS via C#, Convertir PPTM en ODS avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de PPTM dans les exigences de l'application ODS" %}}
