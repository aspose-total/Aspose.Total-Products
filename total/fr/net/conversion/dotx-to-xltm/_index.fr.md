---
title: API .NET pour convertir DOTX en XLTM
description: API C# pour convertir DOTX en XLTM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotx-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOTX en XLTM" h2="Exportez DOTX vers XLTM via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le dotxument au format XLTM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLTM` comme SaveFormat
