---
title: Convertir PPS en FLATOPC via C# .NET 
url: /fr/net/conversion/pps-to-flatopc/ 
description: Convertissez des flatopcuments PowerPoint pps en fichiers flatopc Word avec C#. Convertissez plusieurs fichiers dans ASP.NET ou d'autres applications .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir PPS en FLATOPC en utilisant C#" h2="Créez des applications de conversion de flatopcuments Microsoft PowerPoint PPS vers Word FLATOPC sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PPS" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="FLATOPCM" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/pps-to-flatopcx" name="PPS À FLATOPCX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/pps-to-flatopcm" name="PPS À FLATOPCM" description="" >}}
