---
title: API C# pour exporter PS vers ODT
description: Convertir PS en ODT sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/ps-to-odt/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PS en ODT via .NET" h2="API .NET pour exporter PS vers ODT sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PS en ODT" %}}
