---
title: API .NET pour convertir WORD en EXCEL
description: API C# pour convertir WORD en EXCEL sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir WORD en EXCEL" h2="Exportez WORD vers EXCEL via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le wordument au format EXCEL à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `EXCEL` comme SaveFormat
