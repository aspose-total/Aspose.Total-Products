---
title: Convertir MD en SXC via l'API C#
description: API C# pour convertir un fichier MD en SXC sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/net/conversion/md-to-sxc/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour rendre MD en SXC" h2="Exporter le fichier MD au format SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Excel ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
En utilisant [Aspose.Total for .NET](https://products.aspose.com/total/net/), vous pouvez facilement convertir un fichier MD en SXC dans n'importe quelle application .NET, C#, ASP.NET et VB.NET. Tout d'abord, en utilisant [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), vous pouvez exporter MD vers XLSX. Après cela, en utilisant l'API de programmation de feuille de calcul [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), vous pouvez convertir XLSX en SXC.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir MD en SXC" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir MD protégé en SXC via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir un fichier MD en SXC avec filigrane via C#" %}}
