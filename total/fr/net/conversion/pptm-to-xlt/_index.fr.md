...
description: Convertir PPTM en XLT en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTM en XLT via C#" h2="API .NET pour la conversion PPTM en XLT sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
