...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir WORD en SXC" h2="Exportez WORD vers SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
