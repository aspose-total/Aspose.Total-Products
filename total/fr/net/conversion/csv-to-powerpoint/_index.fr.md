---
title: Convertir CSV en POWERPOINT avec .NET 
description: Convertir CSV en POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
url: /fr/net/conversion/csv-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir CSV en POWERPOINT via C#" h2="Exporter Excel® CSV vers POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
