---
title: Convertir FODS en PPTX avec .NET 
description: Convertir FODS en PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en PPTX via C#" h2="Exporter Excel® FODS vers PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
