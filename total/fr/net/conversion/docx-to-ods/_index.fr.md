---
title: API .NET pour convertir DOCX en ODS
description: API C# pour convertir DOCX en ODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOCX en ODS" h2="Exportez DOCX vers ODS via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
