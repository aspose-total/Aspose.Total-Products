---
title: Convertir XLTM en PPTX avec .NET 
description: Convertir XLTM en PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLTM en PPTX via C#" h2="Exporter Excel® XLTM vers PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
