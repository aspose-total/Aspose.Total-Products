---
title: Convertir POTM en XLAM via C#
description: Convertir POTM en XLAM en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTM en XLAM via C#" h2="API .NET pour la conversion POTM en XLAM sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
