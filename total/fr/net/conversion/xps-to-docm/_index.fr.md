---
title: API C# pour exporter XPS vers DOCM
description: Convertir XPS en DOCM sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/xps-to-docm/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre XPS en DOCM via .NET" h2="API .NET pour exporter XPS vers DOCM sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir XPS en DOCM" %}}
