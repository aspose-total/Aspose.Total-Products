---
title: Convertir PPTX en FODS via C#
description: Convertir PPTX en FODS en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTX en FODS via C#" h2="API .NET pour la conversion PPTX en FODS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
4. Enregistrez le document au format FODS à l'aide de la méthode [Enregistrer](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
