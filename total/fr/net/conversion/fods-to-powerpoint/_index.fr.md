---
title: Convertir FODS en POWERPOINT avec .NET 
description: Convertir FODS en POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir FODS en POWERPOINT via C#" h2="Exporter Excel® FODS vers POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
