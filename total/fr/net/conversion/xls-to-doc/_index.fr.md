---
title: Convertir XLS en DOC avec .NET 
description: Convertir XLS en DOC sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
url: /fr/net/conversion/xls-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLS en DOC via C#" h2="Exporter Excel® XLS vers DOC sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
