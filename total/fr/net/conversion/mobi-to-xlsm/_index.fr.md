...
description: API C# pour convertir MOBI en XLSM sans utiliser Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir MOBI en XLSM" h2="Exportez MOBI vers XLSM via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le mobiument au format XLSM à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSM` comme SaveFormat
