---
title: Convertir PCL en JPEG2000 via l'API C#
description: Exportez PCL vers JPEG2000 dans vos applications .NET sans utiliser d'application tierce
url_ignore: /fr/net/conversion/pcl-to-jpeg2000/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir le fichier PCL en JPEG2000 via C#" h2="Exportez PCL vers JPEG2000 dans les applications .NET sans utiliser Adobe<sup>&reg;</sup> Acrobat Reader ou toute autre application tierce" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le fichier PCL en JPEG2000 via .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir et faire pivoter le fichier PCL en JPEG2000 via C#" %}}
