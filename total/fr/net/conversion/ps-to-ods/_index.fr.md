---
title: Convertir PS en ODS via l'API C#
description: API C# pour convertir un fichier PS en ODS sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/net/conversion/ps-to-ods/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour rendre PS en ODS" h2="Exporter le fichier PS au format ODS via C# sans utiliser Microsoft<sup>&reg;</sup> Excel ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
En utilisant [Aspose.Total for .NET](https://products.aspose.com/total/net/), vous pouvez facilement convertir un fichier PS en ODS dans n'importe quelle application .NET, C#, ASP.NET et VB.NET. Tout d'abord, en utilisant [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), vous pouvez exporter PS vers XLSX. Après cela, en utilisant l'API de programmation de feuille de calcul [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), vous pouvez convertir XLSX en ODS.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir PS en ODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir PS protégé en ODS via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir un fichier PS en ODS avec filigrane via C#" %}}
