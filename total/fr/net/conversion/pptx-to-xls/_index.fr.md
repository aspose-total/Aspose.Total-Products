---
title: Convertir PPTX en XLS via C#
description: Convertir PPTX en XLS en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTX en XLS via C#" h2="API .NET pour la conversion PPTX en XLS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
