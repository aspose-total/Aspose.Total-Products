---
title: API C# pour exporter CGM vers XAMLFLOW
description: Convertir CGM en XAMLFLOW sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/cgm-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre CGM en XAMLFLOW via .NET" h2="API .NET pour exporter CGM vers XAMLFLOW sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir CGM en XAMLFLOW" %}}
