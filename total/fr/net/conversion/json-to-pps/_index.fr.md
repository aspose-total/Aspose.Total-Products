---
title: Convertir le format JSON en PPS via .NET
description: Analyser JSON en PPS en C# sans utiliser Microsoft PowerPoint
url_ignore: /fr/net/conversion/json-to-pps/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. Enregistrez le document au format PPS en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en PPS avec filigrane" %}}
