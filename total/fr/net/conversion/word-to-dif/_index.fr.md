...
description: API C# pour convertir WORD en DIF sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/word-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir WORD en DIF" h2="Exportez WORD vers DIF via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
