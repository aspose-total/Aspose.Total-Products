---
title: Exporter TEX vers XAML via l'API C#
description: API .NET pour convertir TEX en XAML sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/tex-to-xaml/
family: total
platformtag: net
feature: conversion
informat: TEX
