---
title: Convertir PPSX en MARKDOWN via C# ou en ligne
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSX en MARKDOWN via C# ou en ligne" h2="API .NET pour la conversion PPSX en MARKDOWN sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
