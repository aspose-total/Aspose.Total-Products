---
title: Convertir PPSX en XLT via C#
description: Convertir PPSX en XLT en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSX en XLT via C#" h2="API .NET pour la conversion PPSX en XLT sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
