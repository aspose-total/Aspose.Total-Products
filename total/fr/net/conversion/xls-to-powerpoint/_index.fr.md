---
title: Convertir XLS en POWERPOINT avec .NET 
description: Convertir XLS en POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
url: /fr/net/conversion/xls-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLS en POWERPOINT via C#" h2="Exporter Excel® XLS vers POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
