---
title: Convertir PPSX en SXC via C# ou en ligne
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSX en SXC via C# ou en ligne" h2="API .NET pour la conversion PPSX en SXC sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
