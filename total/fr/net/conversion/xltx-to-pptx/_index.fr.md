---
title: Convertir XLTX en PPTX avec .NET 
description: Convertir XLTX en PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLTX en PPTX via C#" h2="Exporter Excel® XLTX vers PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
