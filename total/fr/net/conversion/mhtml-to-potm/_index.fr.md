---
title: Exporter MHTML vers POTM via l'API C#
description: API .NET pour convertir MHTML en POTM sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/mhtml-to-potm/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
4. Enregistrez le document au format POTM à l'aide de la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) et définissez `Potm` comme SaveFormat
