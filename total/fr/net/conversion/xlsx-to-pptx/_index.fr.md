---
title: Convertir XLSX en PPTX avec .NET 
description: Convertir XLSX en PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSX en PPTX via C#" h2="Exporter Excel® XLSX vers PPTX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
