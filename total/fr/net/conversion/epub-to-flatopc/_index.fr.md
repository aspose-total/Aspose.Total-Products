---
title: API C# pour exporter EPUB vers FLATOPC
description: Convertir EPUB en FLATOPC sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/epub-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: EPUB
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre EPUB en FLATOPC via .NET" h2="API .NET pour exporter EPUB vers FLATOPC sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir EPUB en FLATOPC" %}}
...
4. Enregistrez le document au format FLATOPC à l'aide de la méthode [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) et définissez Flatopc comme SaveFormat
