---
title: Convertir POTX en XLTX via C#
description: Convertir POTX en XLTX en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en XLTX via C#" h2="API .NET pour la conversion POTX en XLTX sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
