---
title: Conversion en ligne de XSLFO en XLT ou création d'une application basée sur .NET pour convertir des fichiers XSLFO
description: Application en ligne gratuite pour convertir des fichiers XSLFO en XLT. Code de bibliothèque de conversion .NET C# pour les documents XSLFO. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne XSLFO en XLT et code .NET pour convertir les fichiers XSLFO" h2="Développer une puissante application de conversion et d'exportation XSLFO basée sur .NET. Convertissez un ou plusieurs fichiers XSLFO en XLT et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers XSLFO en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite XSLFO vers XLT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=xlt&from=xslfo" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers XSLFO en XLT en ligne à l'aide de l'application" %}}
...
1. XSLFO sera converti en document XLT
1. Téléchargez le fichier XLT converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir XSLFO en XLT via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir XSLFO en XLT via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer XSLFO dans XLT avec d'autres fonctionnalités comme Convertir XSLFO protégé en XLT via C#, Convertir un fichier XSLFO en XLT avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de XSLFO dans les exigences de l'application XLT" %}}
