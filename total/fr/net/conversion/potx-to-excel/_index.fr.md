---
title: Convertir POTX en EXCEL via C# ou en ligne
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en EXCEL via C# ou en ligne" h2="API .NET pour la conversion POTX en EXCEL sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
