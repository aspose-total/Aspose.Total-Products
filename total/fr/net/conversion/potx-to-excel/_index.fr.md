---
title: Convertir POTX en EXCEL via C#
description: Convertir POTX en EXCEL en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en EXCEL via C#" h2="API .NET pour la conversion POTX en EXCEL sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
