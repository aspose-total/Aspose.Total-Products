---
title: API .NET pour convertir DOT en XLT
description: API C# pour convertir DOT en XLT sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dot-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOT en XLT" h2="Exportez DOT vers XLT via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le dotument au format XLT à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLT` comme SaveFormat
