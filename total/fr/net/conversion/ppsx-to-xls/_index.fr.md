...
description: Convertir PPSX en XLS en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSX en XLS via C#" h2="API .NET pour la conversion PPSX en XLS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
