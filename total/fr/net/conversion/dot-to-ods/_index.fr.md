---
title: Conversion en ligne de DOT en ODS ou création d'une application basée sur .NET pour convertir des fichiers DOT
description: Application en ligne gratuite pour convertir des fichiers DOT en ODS. Code de bibliothèque de conversion .NET C# pour les documents DOT. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne DOT en ODS et code .NET pour convertir les fichiers DOT" h2="Développer une puissante application de conversion et d'exportation DOT basée sur .NET. Convertissez un ou plusieurs fichiers DOT en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers DOT en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite DOT vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=dot" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers DOT en ODS en ligne à l'aide de l'application" %}}
...
1. DOT sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir DOT en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir DOT en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer DOT dans ODS avec d'autres fonctionnalités comme Charger le Document DOT à partir du flux via C#, Ajouter des propriétés personnalisées dans le fichier ODS via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de DOT dans les exigences de l'application ODS" %}}
