...
description: Convertir SVG en ODT sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/svg-to-odt/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre SVG en ODT via .NET" h2="API .NET pour exporter SVG vers ODT sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir SVG en ODT" %}}
