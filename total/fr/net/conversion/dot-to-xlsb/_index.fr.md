...
url: /fr/net/conversion/dot-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOT
...
4. Enregistrez le dotument au format XLSB à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSB` comme SaveFormat
