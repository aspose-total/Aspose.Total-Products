---
title: API C# pour exporter PCL vers DOTM
description: Convertir PCL en DOTM sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/pcl-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PCL en DOTM via .NET" h2="API .NET pour exporter PCL vers DOTM sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PCL en DOTM" %}}
