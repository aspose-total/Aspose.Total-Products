---
title: Convertir POWERPOINT au format JSON via .NET
description: Convertir POWERPOINT en JSON en C# sans utiliser Microsoft Excel ou Powerpoint
url_ignore: /fr/net/conversion/powerpoint-to-json/
family: total
platformtag: net
feature: conversion
informat: PPT
...
2. Convertissez POWERPOINT en HTML en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir POWERPOINT en JSON dans Range via C#" %}}
