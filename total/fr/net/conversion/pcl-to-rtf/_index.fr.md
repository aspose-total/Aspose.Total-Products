---
title: API C# pour exporter PCL vers RTF
description: Convertir PCL en RTF sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/pcl-to-rtf/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PCL en RTF via .NET" h2="API .NET pour exporter PCL vers RTF sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PCL en RTF" %}}
