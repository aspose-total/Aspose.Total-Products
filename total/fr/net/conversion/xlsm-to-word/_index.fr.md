---
title: Convertir XLSM en WORD avec .NET 
description: Convertir XLSM en WORD sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSM en WORD via C#" h2="Exporter Excel® XLSM vers WORD sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
