---
title: API .NET pour convertir DOCX en XLTM
description: API C# pour convertir DOCX en XLTM sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-xltm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOCX en XLTM" h2="Exportez DOCX vers XLTM via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
