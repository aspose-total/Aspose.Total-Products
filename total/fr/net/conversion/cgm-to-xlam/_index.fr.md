---
title: Convertir CGM en XLAM via l'API C#
description: API C# pour convertir un fichier CGM en XLAM sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/net/conversion/cgm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour rendre CGM en XLAM" h2="Exporter le fichier CGM au format XLAM via C# sans utiliser Microsoft<sup>&reg;</sup> Excel ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir CGM en XLAM" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir CGM protégé en XLAM via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir un fichier CGM en XLAM avec filigrane via C#" %}}
