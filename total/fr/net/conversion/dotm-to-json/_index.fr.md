---
title: Convertir le format DOTM au format JSON via .NET
description: Convertir DOTM en JSON en C# sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/net/conversion/dotm-to-json/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Enregistrez le dotmument au format JSON à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir DOTM en JSON dans Range via C#" %}}
