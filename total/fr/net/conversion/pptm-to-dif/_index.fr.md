...
description: Convertir PPTM en DIF en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/pptm-to-dif/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTM en DIF via C#" h2="API .NET pour la conversion PPTM en DIF sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
