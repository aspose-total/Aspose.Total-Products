...
<iframe title="Application de conversion en ligne gratuite XPS vers PS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ps&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertir XPS en PS via C# .NET" offSpacer="" %}}
