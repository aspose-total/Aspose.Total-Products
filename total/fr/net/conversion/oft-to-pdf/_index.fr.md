---
title: API C# pour exporter OFT vers PDF
description: Convertir OFT en PDF sans utiliser Microsoft Word ou Outlook sur .NET
url_ignore: /fr/net/conversion/oft-to-pdf/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir OFT en PDF" %}}
