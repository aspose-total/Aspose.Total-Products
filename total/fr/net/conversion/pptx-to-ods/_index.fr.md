---
title: Conversion en ligne de PPTX en ODS ou création d'une application basée sur .NET pour convertir des fichiers PPTX
description: Application en ligne gratuite pour convertir des fichiers PPTX en ODS. Code de bibliothèque de conversion .NET C# pour les documents PPTX. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne PPTX en ODS et code .NET pour convertir les fichiers PPTX" h2="Développer une puissante application de conversion et d'exportation PPTX basée sur .NET. Convertissez un ou plusieurs fichiers PPTX en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers PPTX en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite PPTX vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=pptx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers PPTX en ODS en ligne à l'aide de l'application" %}}
...
1. PPTX sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir PPTX en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir PPTX en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer PPTX dans ODS avec d'autres fonctionnalités comme Convertir PPTX protégé en ODS via C#, Convertir PPTX en ODS avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de PPTX dans les exigences de l'application ODS" %}}
