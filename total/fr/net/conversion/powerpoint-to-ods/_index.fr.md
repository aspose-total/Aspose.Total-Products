---
title: Conversion en ligne de PowerPoint en ODS ou création d'une application basée sur .NET pour convertir des fichiers PowerPoint
description: Application en ligne gratuite pour convertir des fichiers PowerPoint en ODS. Code de bibliothèque de conversion .NET C# pour les documents PowerPoint. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne PowerPoint en ODS et code .NET pour convertir les fichiers PowerPoint" h2="Développer une puissante application de conversion et d'exportation PowerPoint basée sur .NET. Convertissez un ou plusieurs fichiers PowerPoint en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers PowerPoint en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite PowerPoint vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=ppt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers PowerPoint en ODS en ligne à l'aide de l'application" %}}
...
1. PowerPoint sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir PowerPoint en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir PowerPoint en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer PowerPoint dans ODS avec d'autres fonctionnalités comme Convertir POWERPOINT protégé en ODS via C#, Convertir POWERPOINT en ODS avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de PowerPoint dans les exigences de l'application ODS" %}}
