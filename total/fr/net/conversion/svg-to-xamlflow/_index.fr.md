...
description: Convertir SVG en XAMLFLOW sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/svg-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre SVG en XAMLFLOW via .NET" h2="API .NET pour exporter SVG vers XAMLFLOW sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir SVG en XAMLFLOW" %}}
...
4. Enregistrez le document au format XAMLFLOW à l'aide de la méthode [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) et définissez Xamlflow comme SaveFormat
