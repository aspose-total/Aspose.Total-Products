---
title: API .NET pour convertir DOTM en SXC
description: API C# pour convertir DOTM en SXC sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotm-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOTM en SXC" h2="Exportez DOTM vers SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le dotmument au format SXC à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `SXC` comme SaveFormat
