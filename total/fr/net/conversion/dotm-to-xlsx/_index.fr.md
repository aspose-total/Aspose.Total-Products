---
title: API .NET pour convertir DOTM en XLSX
description: API C# pour convertir DOTM en XLSX sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/dotm-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
4. Enregistrez le dotmument au format XLSX à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLSX` comme SaveFormat
...
[Aspose.Words pour .NET](https://products.aspose.com/words/net/) vous permet également de charger un dotmument DOTM via un flux. Pour ouvrir un dotmument à partir d'un flux, transmettez simplement un objet de flux contenant le dotmument dans le constructeur [Dotmument](https://apireference.aspose.com/words/net/aspose.words/dotmument). L'exemple de code suivant montre comment ouvrir un dotmument à partir d'un flux :  
{{% blocks/products/pf/feature-page-code %}}
