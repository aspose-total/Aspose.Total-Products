---
title: Convertir XML en CSV via l'API C#
description: API C# pour convertir un fichier XML en CSV sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/net/conversion/xml-to-csv/
family: total
platformtag: net
feature: conversion
informat: XML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour rendre XML en CSV" h2="Exporter le fichier XML au format CSV via C# sans utiliser Microsoft<sup>&reg;</sup> Excel ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET pour convertir XML en CSV" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir XML protégé en CSV via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir un fichier XML en CSV avec filigrane via C#" %}}
