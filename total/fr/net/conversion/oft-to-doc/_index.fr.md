---
title: API C# pour exporter OFT vers DOC
description: Convertir OFT en DOC sans utiliser Microsoft Word ou Outlook sur .NET
url_ignore: /fr/net/conversion/oft-to-doc/
family: total
platformtag: net
feature: conversion
informat: OFT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exporter OFT vers DOC via .NET" h2="API .NET pour rendre OFT en DOC sous Windows, macOS et Linux sans utiliser Word ou Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Si vous êtes un développeur .NET cherchant à ajouter des fonctionnalités de conversion OFT vers DOC dans vos applications, les API de manipulation de format de fichier [Aspose.Total for .NET](https://products.aspose.com/total/net/) sont la solution. avant. En utilisant [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), vous pouvez convertir le format de fichier OFT en HTML. Après cela, en utilisant [Aspose.Words for .NET](https://products.aspose.com/words/net/), vous pouvez restituer HTML en DOC.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir OFT en DOC" %}}
