---
title: API .NET pour convertir DOCX en SXC
description: API C# pour convertir DOCX en SXC sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/docx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir DOCX en SXC" h2="Exportez DOCX vers SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
