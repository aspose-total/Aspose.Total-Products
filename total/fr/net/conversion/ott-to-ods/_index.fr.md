---
title: API .NET pour convertir OTT en ODS
description: API C# pour convertir OTT en ODS sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/ott-to-ods/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir OTT en ODS" h2="Exportez OTT vers ODS via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le ottument au format ODS à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `ODS` comme SaveFormat
