---
title: Convertir POTX au format JSON via .NET
description: Convertir POTX en JSON en C# sans utiliser Microsoft Excel ou Powerpoint
url_ignore: /fr/net/conversion/potx-to-json/
family: total
platformtag: net
feature: conversion
informat: POTX
...
2. Convertissez POTX en HTML en utilisant la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir POTX en JSON dans Range via C#" %}}
