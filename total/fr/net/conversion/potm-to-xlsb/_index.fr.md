...
description: Convertir POTM en XLSB en C# sans utiliser Microsoft Excel ou Powerpoint
url: /fr/net/conversion/potm-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTM en XLSB via C#" h2="API .NET pour la conversion POTM en XLSB sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
