---
title: Exporter XPS vers PPSX via l'API C#
description: API .NET pour convertir XPS en PPSX sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/xps-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: XPS
...
4. Enregistrez le document au format PPSX à l'aide de la méthode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) et définissez `Ppsx` comme SaveFormat
