---
title: API C# pour exporter MHTML vers GIF
description: Convertir MHTML en GIF sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/mhtml-to-gif/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MHTML en GIF via .NET" h2="API .NET pour exporter MHTML vers GIF sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir MHTML en GIF" %}}
