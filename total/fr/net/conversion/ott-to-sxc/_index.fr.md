...
4. Enregistrez le ottument au format SXC à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `SXC` comme SaveFormat
