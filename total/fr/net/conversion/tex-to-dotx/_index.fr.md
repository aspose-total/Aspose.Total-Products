---
title: API C# pour exporter TEX vers DOTX
description: Convertir TEX en DOTX sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/tex-to-dotx/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre TEX en DOTX via .NET" h2="API .NET pour exporter TEX vers DOTX sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir TEX en DOTX" %}}
