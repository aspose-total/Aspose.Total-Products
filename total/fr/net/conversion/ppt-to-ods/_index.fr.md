---
title: Conversion en ligne de PPT en ODS ou création d'une application basée sur .NET pour convertir des fichiers PPT
description: Application en ligne gratuite pour convertir des fichiers PPT en ODS. Code de bibliothèque de conversion .NET C# pour les documents PPT. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne PPT en ODS et code .NET pour convertir les fichiers PPT" h2="Développer une puissante application de conversion et d'exportation PPT basée sur .NET. Convertissez un ou plusieurs fichiers PPT en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers PPT en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite PPT vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=ppt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers PPT en ODS en ligne à l'aide de l'application" %}}
...
1. PPT sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir PPT en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir PPT en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer PPT dans ODS avec d'autres fonctionnalités comme Convertir PPT protégé en ODS via C#, Convertir PPT en ODS avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de PPT dans les exigences de l'application ODS" %}}
