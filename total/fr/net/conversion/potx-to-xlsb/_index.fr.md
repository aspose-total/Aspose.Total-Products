---
title: Convertir POTX en XLSB via C# ou en ligne
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en XLSB via C# ou en ligne" h2="API .NET pour la conversion POTX en XLSB sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
