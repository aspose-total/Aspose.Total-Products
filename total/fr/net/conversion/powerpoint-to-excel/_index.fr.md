---
title: Convertir POWERPOINT en EXCEL via C#
description: Convertir POWERPOINT en EXCEL en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POWERPOINT en EXCEL via C#" h2="API .NET pour la conversion POWERPOINT en EXCEL sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
