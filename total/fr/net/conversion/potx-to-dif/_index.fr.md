---
title: Convertir POTX en DIF via C# ou en ligne
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en DIF via C# ou en ligne" h2="API .NET pour la conversion POTX en DIF sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
