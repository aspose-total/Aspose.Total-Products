---
title: Conversion en ligne de POTM en ODS ou création d'une application basée sur .NET pour convertir des fichiers POTM
description: Application en ligne gratuite pour convertir des fichiers POTM en ODS. Code de bibliothèque de conversion .NET C# pour les documents POTM. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne POTM en ODS et code .NET pour convertir les fichiers POTM" h2="Développer une puissante application de conversion et d'exportation POTM basée sur .NET. Convertissez un ou plusieurs fichiers POTM en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers POTM en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite POTM vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=potm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers POTM en ODS en ligne à l'aide de l'application" %}}
...
1. POTM sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir POTM en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir POTM en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer POTM dans ODS avec d'autres fonctionnalités comme Convertir POTM protégé en ODS via C#, Convertir POTM en ODS avec filigrane via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de POTM dans les exigences de l'application ODS" %}}
