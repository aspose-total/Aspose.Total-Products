---
title: Conversion en ligne de ODT en ODS ou création d'une application basée sur .NET pour convertir des fichiers ODT
description: Application en ligne gratuite pour convertir des fichiers ODT en ODS. Code de bibliothèque de conversion .NET C# pour les documents ODT. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne ODT en ODS et code .NET pour convertir les fichiers ODT" h2="Développer une puissante application de conversion et d'exportation ODT basée sur .NET. Convertissez un ou plusieurs fichiers ODT en ODS et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers ODT en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite ODT vers ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ods&from=odt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers ODT en ODS en ligne à l'aide de l'application" %}}
...
1. ODT sera converti en document ODS
1. Téléchargez le fichier ODS converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir ODT en ODS via l'API d'automatisation .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Convertir ODT en ODS via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer ODT dans ODS avec d'autres fonctionnalités comme Charger le document ODT à partir du flux via C#, Ajouter des propriétés personnalisées dans le fichier ODS via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de ODT dans les exigences de l'application ODS" %}}
