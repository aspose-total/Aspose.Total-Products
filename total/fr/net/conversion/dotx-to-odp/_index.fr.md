...
description: Convertissez des dotxuments Word en fichiers PowerPoint odp avec C#. Convertissez plusieurs fichiers dans ASP.NET ou d'autres applications .NET.
---
...
1. Enregistrez le dotxument en utilisant [Aspose.Slides.Presentation.Save("output.odp", SaveFormat.Odp)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
