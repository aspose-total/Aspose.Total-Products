---
title: Convertir XLS en DOCX avec .NET 
description: Convertir XLS en DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLS en DOCX via C#" h2="Exporter Excel® XLS vers DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
