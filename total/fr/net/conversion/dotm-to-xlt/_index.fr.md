---
title: Conversion en ligne de DOTM en XLT ou création d'une application basée sur .NET pour convertir des fichiers DOTM
description: Application en ligne gratuite pour convertir des fichiers DOTM en XLT. Code de bibliothèque de conversion .NET C# pour les documents DOTM. 
...
{{< blocks/products/pf/feature-page-header h1="Application de conversion en ligne DOTM en XLT et code .NET pour convertir les fichiers DOTM" h2="Développer une puissante application de conversion et d'exportation DOTM basée sur .NET. Convertissez un ou plusieurs fichiers DOTM en XLT et d'autres formats via l'API d'automatisation .NET. Convertissez librement les fichiers DOTM en ligne via l'application avec téléchargement instantané." >}}
...
<iframe title="Application de conversion en ligne gratuite DOTM vers XLT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=xlt&from=dotm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertissez des fichiers DOTM en XLT en ligne à l'aide de l'application" %}}
...
1. DOTM sera converti en document XLT
1. Téléchargez le fichier XLT converti

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Convertir DOTM en XLT via l'API d'automatisation .NET" %}}
...
4. Enregistrez le dotmument au format XLT à l'aide de la méthode [Save](https://reference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `XLT` comme SaveFormat



{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Convertir DOTM en XLT via C# .NET" offSpacer="" %}}
...
Quelques cas supplémentaires pour enregistrer DOTM dans XLT avec d'autres fonctionnalités comme Charger le dotmument DOTM à partir du flux via C#, Ajouter des propriétés personnalisées dans le fichier XLT via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Enregistrement de DOTM dans les exigences de l'application XLT" %}}
