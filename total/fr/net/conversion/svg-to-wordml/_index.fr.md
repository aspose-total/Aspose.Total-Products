---
title: API C# pour exporter SVG vers WORDML
description: Convertir SVG en WORDML sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/svg-to-wordml/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre SVG en WORDML via .NET" h2="API .NET pour exporter SVG vers WORDML sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir SVG en WORDML" %}}
