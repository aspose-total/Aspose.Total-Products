---
title: API .NET pour convertir WORDML en SXC
description: API C# pour convertir WORDML en SXC sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/net/conversion/wordml-to-sxc/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# pour convertir WORDML en SXC" h2="Exportez WORDML vers SXC via C# sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le wordmlument au format SXC à l'aide de la méthode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) et définissez `SXC` comme SaveFormat
