---
title: Convertir XLSB en POWERPOINT avec .NET 
description: Convertir XLSB en POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSB en POWERPOINT via C#" h2="Exporter Excel® XLSB vers POWERPOINT sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
