---
title: Convertir XLSM en DOCX avec .NET 
description: Convertir XLSM en DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convertir XLSM en DOCX via C#" h2="Exporter Excel® XLSM vers DOCX sur les plates-formes .NET Framework, .NET Core, Mono ou Xamarin">}}
