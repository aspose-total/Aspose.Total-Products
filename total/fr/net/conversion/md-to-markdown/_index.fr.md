---
title: API C# pour exporter MD vers MARKDOWN
description: Convertir MD en MARKDOWN sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/md-to-markdown/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre MD en MARKDOWN via .NET" h2="API .NET pour exporter MD vers MARKDOWN sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir MD en MARKDOWN" %}}
