---
title: Convertir PPS en SXC via C#
description: Convertir PPS en SXC en C# sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPS en SXC via C#" h2="API .NET pour la conversion PPS en SXC sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
