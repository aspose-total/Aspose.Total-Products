---
title: API C# pour exporter PDF vers DOTX
description: Convertir PDF en DOTX sans utiliser Microsoft Word
url_ignore: /fr/net/conversion/pdf-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Rendre PDF en DOTX via .NET" h2="API .NET pour exporter PDF vers DOTX sous Windows, macOS et Linux sans utiliser Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# pour convertir PDF en DOTX" %}}
