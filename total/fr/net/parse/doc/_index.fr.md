---
title: Extraire le texte et les images du fichier DOC en ligne et à l'aide de .NET
description: Application d'analyse de fichiers DOC en ligne. Code C# de l'API .NET pour extraire des images et du contenu textuel d'un document DOC.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier DOC en ligne ainsi que via .NET" h2="Développez une puissante application utilitaire d'analyse de documents DOC basée sur .NET. Code C# répertorié pour l’extraction de texte du document DOC." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier DOC via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Charger le fichier DOC à l'aide de l'objet de classe Document
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de documents DOC" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code C# : Extraction de texte de document DOC" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers DOC via .NET</h2>

Besoin de développer une application ou un logiciel d'analyseur DOC ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier DOC pour l'application d'analyseur" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Cas d'utilisation pour le traitement des fichiers .doc

- 📄 Extraire des textes, tableaux et images pour affichage, recherche ou traitement.
- 🧾 Convertir les documents Word anciens en formats modernes comme Markdown ou HTML.
- 📚 Archiver les fichiers .doc anciens en les convertissant en formats numériques recherchables.
