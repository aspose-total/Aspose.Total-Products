---
title: Extraire le texte et les images du fichier PPTX en ligne et à l'aide de .NET
description: Application d'analyse de fichiers PPTX en ligne. Code C# de l'API .NET pour extraire des images et du texte de la présentation PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier PPTX en ligne ainsi que via .NET" h2="Développez une puissante application d'analyse de présentation PPTX basée sur .NET. Code C# répertorié pour l’analyse de PPTX." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser la présentation PPTX via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Charger le fichier PPTX à l'aide de l'objet de classe Présentation
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de présentation PPTX" offSpacer="" %}}
...
<h2>Développer une application d'analyse de présentation PPTX via .NET</h2>

Besoin de développer une application d'analyseur PPTX ? Avec [Aspose.Slides for .NET](https://products.aspose.com/slides/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PPTX pour l'application d'analyseur" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
Utilisations des cas d'analyse des fichiers .pptx

- Extraire le texte des diapositives, les images et les métadonnées pour usage web ou application.
- Automatiser les flux de génération et de conversion de présentations.
- Convertir les fichiers .pptx en HTML, en PDF ou en formats interactifs.
