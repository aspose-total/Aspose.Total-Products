---
title: Extraire le texte et les images du fichier ODT en ligne et à l'aide de .NET
description: Application d'analyse de fichiers ODT en ligne. Code C# de l'API .NET pour extraire des images et du contenu textuel d'un document ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier ODT en ligne ainsi que via .NET" h2="Développez une puissante application utilitaire d'analyse de documents ODT basée sur .NET. Code C# répertorié pour l’extraction de texte du document ODT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document ODT via une application en ligne" %}}

1. Importez le fichier ODT à analyser en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier ODT via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Charger le fichier ODT à l'aide de l'objet de classe Document
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de documents ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code C# : Extraction de texte de document ODT" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers ODT via .NET</h2>

Besoin de développer une application ou un logiciel d'analyseur ODT ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier ODT pour l'application d'analyseur" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
- Extraire le texte, les images et les métadonnées des fichiers OpenDocument Text.  
- Convertissez les fichiers .odt en HTML, Markdown ou PDF pour la publication.  
- Archiver les formats de documents open-source en convertissant et en indexant le contenu.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour analyser un document ODT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'analyseur de documents ODT en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
