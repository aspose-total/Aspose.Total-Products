---
title: Extraire le texte et les images du fichier RTF en ligne et à l'aide de .NET
description: Application d'analyse de fichiers RTF en ligne. Code C# de l'API .NET pour extraire des images et du contenu textuel d'un document RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier RTF en ligne ainsi que via .NET" h2="Développez une puissante application utilitaire d'analyse de documents RTF basée sur .NET. Code C# répertorié pour l’extraction de texte du document RTF." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document RTF via une application en ligne" %}}

1. Importez le fichier RTF à analyser en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier RTF via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Charger le fichier RTF à l'aide de l'objet de classe Document
1. Obtenez tous les nœuds enfants en utilisant GetChildNodes()
1. Utiliser NodeType.Shape comme paramètre
1. Parcourez chaque nœud et enregistrez l'image
1. Pour extraire du texte, parcourez chaque page
1. Appelez la méthode ExtractPages
1. Enregistrez le fichier extrait sous forme de texte à l'aide de la méthode Node.ToString
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de documents RTF" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code C# : Extraction de texte de document RTF" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers RTF via .NET</h2>

Besoin de développer une application ou un logiciel d'analyseur RTF ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format RTF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier RTF pour l'application d'analyseur" %}}

Il existe des options alternatives pour installer Aspose.Words for .NET ou Aspose.Total for .NET sur votre système.Veuillez en choisir un qui correspond à vos besoins et suivre les instructions étape par étape :<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
## Cas d'utilisation pour l'analyse des fichiers .rtf

- 📄 Extraire le texte formaté et les images de base à partir des fichiers Rich Text Format.
- 🧾 Conserver les documents .rtf en texte brut ou en HTML pour l'utilisation web.
- 📚 Migrer les documents .rtf héritage dans les systèmes de contenu moderne.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour analyser un document RTF ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'analyseur de documents RTF en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
