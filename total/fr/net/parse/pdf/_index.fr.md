---
title: Extraire le texte et les images du fichier PDF en ligne et à l'aide de .NET
description: Application d'analyse de fichiers PDF en ligne. Code C# de l'API .NET pour extraire des images et du texte d'un document PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier PDF en ligne et extraire du texte ou des images via .NET" h2="Développez une puissante application utilitaire d'analyse de documents PDF basée sur .NET.Code C# répertorié pour les images de documents PDF et l’extraction de texte." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier PDF via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Chargez le fichier PDF à l'aide de la classe Document
1. Utiliser l'objet de classe TextAbsorber
1. Acceptez l'absorbeur pour toutes les pages
1. Récupérez le texte extrait et écrivez
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction de texte de document PDF" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "parse-pdf-documents-by-extracting-text.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de documents PDF" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers PDF via .NET</h2>

Besoin de développer une application ou un utilitaire d'analyseur PDF ?Avec [Aspose.PDF for .NET](https://products.aspose.com/pdf/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PDF pour l'application d'analyseur" %}}
