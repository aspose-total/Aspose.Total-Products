---
title: Extraire le texte et les images du fichier PPT en ligne et à l'aide de .NET
description: Application d'analyse de fichiers PPT en ligne. Code C# de l'API .NET pour extraire des images et du texte de la présentation PPT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier PPT en ligne ainsi que via .NET" h2="Développez une puissante application d'analyse de présentation PPT basée sur .NET. Code C# répertorié pour l’analyse de PPT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser la présentation PPT via l'application en ligne" %}}

1. Importez le fichier PPT à analyser en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser la présentation PPT via .NET" %}}

1. Ajouter une référence de bibliothèque au projet .NET
1. Charger le fichier PPT à l'aide de l'objet de classe Présentation
...
{{% blocks/products/pf/agp/code-block title="Code C# : Extraction de texte de présentation PPT" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code C# : Extraction d'images de présentation PPT" offSpacer="" %}}
...
<h2>Développer une application d'analyse de présentation PPT via .NET</h2>

Besoin de développer une application d'analyseur PPT ? Avec [Aspose.Slides for .NET](https://products.aspose.com/slides/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PPT pour l'application d'analyseur" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Cas d'utilisation pour l'analyse des fichiers .ppt

- 🖼️ Extraire le contenu tel que le texte, les images et les médias des fichiers PowerPoint anciens.
- 🔁 Convertir les présentations .ppt en formats modernes .pptx ou PDF.
- 📽️ Archiver les présentations anciennes ou les intégrer dans des déossages mis à jour.
- 🧩 Automatiser la migration du contenu de presentations dans les environnements d'entreprise.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour analyser un document PPT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'analyseur de documents PPT en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
