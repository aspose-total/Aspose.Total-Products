---
title: Protégez le document DOCX en ligne avec un mot de passe et en utilisant .NET
description: Application de protection par mot de passe du fichier DOCX en ligne. Code API C# .NET pour appliquer la protection par mot de passe sur le document DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents DOCX en ligne ou définition d'un mot de passe via .NET" h2="Développez une puissante application utilitaire de protection de documents DOCX basée sur .NET.Code répertorié pour appliquer le mot de passe au document DOCX via .NET." >}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : Protection par mot de passe des documents DOCX" offSpacer="" %}}
