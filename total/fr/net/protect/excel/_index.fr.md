---
title: Protégez le document Excel en ligne avec un mot de passe et en utilisant .NET
description: Application de protection par mot de passe du fichier Excel en ligne.Code API .NET C# pour appliquer la protection par mot de passe sur les feuilles de calcul Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents Excel en ligne ou définition d'un mot de passe via .NET" h2="Développez une puissante application utilitaire de protection de documents Excel basée sur .NET.Code répertorié pour appliquer le mot de passe à la feuille de calcul Excel via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protection par mot de passe Excel via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : Protection par mot de passe des documents Excel" offSpacer="" %}}
