---
title: Protégez le document ODT en ligne avec un mot de passe et en utilisant .NET
description: Application de protection par mot de passe du fichier ODT en ligne. Code API C# .NET pour appliquer la protection par mot de passe sur le document ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents ODT en ligne ou définition d'un mot de passe via .NET" h2="Développez une puissante application utilitaire de protection de documents ODT basée sur .NET.Code répertorié pour appliquer le mot de passe au document ODT via .NET." >}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : Protection par mot de passe des documents ODT" offSpacer="" %}}
