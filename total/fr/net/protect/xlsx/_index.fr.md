---
title: Protégez le document XLSX en ligne avec un mot de passe et en utilisant .NET
description: Application de protection par mot de passe du fichier XLSX en ligne.Code API .NET C# pour appliquer la protection par mot de passe sur les feuilles de calcul XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents XLSX en ligne ou définition d'un mot de passe via .NET" h2="Développez une puissante application utilitaire de protection de documents XLSX basée sur .NET.Code répertorié pour appliquer le mot de passe à la feuille de calcul XLSX via .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Protection par mot de passe XLSX en ligne via l'application" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protection par mot de passe XLSX via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : Protection par mot de passe des documents XLSX" offSpacer="" %}}
...
<h2>Développer une application de protection par mot de passe XLSX via .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier XLSX pour l'application de protection" %}}
