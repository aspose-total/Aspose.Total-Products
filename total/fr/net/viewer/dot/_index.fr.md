---
title: Afficher le fichier DOT en ligne et en utilisant .NET
description: Application gratuite de visualisation de fichiers DOT en ligne. Code C# de l'API .NET pour afficher le fichier DOT pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier DOT en ligne ou via .NET" h2="Développez une puissante application utilitaire de visualisation de documents DOT basée sur .NET. Code C# répertorié pour afficher le document DOT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Afficher le fichier DOT via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C# : Afficher le document DOT" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers DOT via .NET</h2>

Besoin de développer une application ou un utilitaire de visualisation DOT ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format DOT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier DOT pour l'application d'affichage" %}}
