---
title: Afficher le fichier DOCX en ligne et en utilisant .NET
description: Application gratuite de visualisation de fichiers DOCX en ligne. Code C# de l'API .NET pour afficher le fichier DOCX pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier DOCX en ligne ou via .NET" h2="Développez une puissante application utilitaire de visualisation de documents DOCX basée sur .NET. Code C# répertorié pour afficher le document DOCX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Afficher le document DOCX via l'application en ligne" %}}
...
1. Naviguez entre les pages dans le cas d’un document DOCX multi-pages.
1. Définissez le zoom avant ou arrière de l'affichage de la page.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Afficher le fichier DOCX via .NET" %}}

1. Ajouter une référence de bibliothèque .NET dans le projet
1. Charger le fichier source DOCX à l'aide de l'objet de classe Document
...
{{% blocks/products/pf/agp/code-block title="Code C# : Afficher le document DOCX" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers DOCX via .NET</h2>

Besoin de développer une application ou un utilitaire de visualisation DOCX ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format DOCX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier DOCX pour l'application d'affichage" %}}
...
- Mono >= 2.6.7
<br /><br />
Comme le code .NET ne repose pas sur le matériel ou le système d'exploitation sous-jacent, mais uniquement sur une machine virtuelle, vous êtes donc libre de développer tout type de logiciel pour Windows, macOS, Android, iOS et Linux.Just make sure you have installed the corresponding version of .NET Framework, .NET Core, Windows Azure, Mono or Xamarin.<br /><br />
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code et l'utiliser dans le but de développer une application de visualisation de documents basée sur .NET.Ce code peut servir de ressource précieuse pour améliorer les fonctionnalités et les capacités de vos projets dans le domaine du traitement des documents back-end, tels que la lecture des nœuds et le chargement du document pour l'application d'affichage.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour visualiser le document DOCX ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la visionneuse de documents DOCX en ligne. Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
