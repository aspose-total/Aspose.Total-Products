---
title: Afficher le fichier PPT en ligne et en utilisant .NET
description: Application gratuite de visualisation de fichiers PPT en ligne. Code C# de l'API .NET pour afficher la présentation PPT pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier PPT en ligne ou via .NET" h2="Développez une puissante application utilitaire de visualisation de présentation PPT basée sur .NET. Code C# répertorié pour afficher la présentation PPT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Voir la présentation PPT via l'application en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Afficher la présentation PPT via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C# : Voir la présentation PPT" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers PPT via .NET</h2>

Besoin de développer une application ou un utilitaire de visualisation PPT ?Avec [Aspose.Slides for .NET](https://products.aspose.com/slides/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PPT pour l'application d'affichage" %}}
