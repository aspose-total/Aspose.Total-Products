---
title: Afficher le fichier PPS en ligne et en utilisant .NET
description: Application gratuite de visualisation de fichiers PPS en ligne. Code C# de l'API .NET pour afficher la présentation PPS pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier PPS en ligne ou via .NET" h2="Développez une puissante application utilitaire de visualisation de présentation PPS basée sur .NET. Code C# répertorié pour afficher la présentation PPS." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Voir la présentation PPS via l'application en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Afficher la présentation PPS via .NET" %}}

1. Ajouter une référence de bibliothèque .NET dans le projet
1. Charger le fichier source PPS à l'aide de l'objet de classe Présentation
...
{{% blocks/products/pf/agp/code-block title="Code C# : Voir la présentation PPS" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers PPS via .NET</h2>

Besoin de développer une application ou un utilitaire de visualisation PPS ?Avec [Aspose.Slides for .NET](https://products.aspose.com/slides/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PPS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PPS pour l'application d'affichage" %}}
