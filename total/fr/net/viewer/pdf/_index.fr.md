---
title: Afficher le fichier PDF en ligne et en utilisant .NET
description: Application gratuite de visualisation de fichiers PDF en ligne. Code C# de l'API .NET pour afficher le fichier PDF pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier PDF en ligne ou via .NET" h2="Développez une puissante application utilitaire de visualisation de documents PDF basée sur .NET. Code C# répertorié pour afficher le document PDF." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Afficher le document PDF via .NET" %}}

1. Ajouter une référence de bibliothèque .NET dans le projet
1. Charger le fichier source PDF à l'aide de l'objet de classe Document
...
{{% blocks/products/pf/agp/code-block title="Code C# : Afficher le document PDF" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers PDF via .NET</h2>

Besoin de développer une application ou un utilitaire de visualisation PDF ?Avec [Aspose.PDF for .NET](https://products.aspose.com/pdf/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque .NET permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour traiter le fichier PDF pour l'application d'affichage" %}}

Il existe des options alternatives pour installer Aspose.PDF for .NET ou Aspose.Total for .NET sur votre système. Veuillez en choisir un qui correspond à vos besoins et suivre les instructions étape par étape :<br /><br />
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code et l'utiliser dans le but de développer une application de visualisation de documents basée sur .NET.Ce code peut servir de ressource précieuse pour améliorer les fonctionnalités et les capacités de vos projets dans le domaine du traitement back-end des documents, comme la lecture du contenu du document pour l'application d'affichage.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
