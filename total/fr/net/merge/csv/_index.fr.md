---
title: Fusionner des fichiers CSV en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différents fichiers CSV.Code de bibliothèque de fusion C# .NET pour fusionner des feuilles de calcul CSV dans d'autres formats.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents CSV en ligne via l'application Merger ou en utilisant .NET" h2="Développez une puissante application de fusion de documents CSV basée sur .NET.Combinez plusieurs documents CSV en un seul en ligne gratuitement via l'application.Enregistrez le fichier CSV fusionné au format PDF, Images, Word, Excel, PowerPoint et de nombreux autres formats en ligne." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Fusionner des fichiers CSV en ligne à l'aide de l'application" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier CSV via .NET" %}}

1. Chargez les deux CSV à l’aide des objets de classe Workbook.
...
1. Appelez la méthode Save et regroupez les fichiers CSV fusionnés en un seul.
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers CSV" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers CSV à l'aide de .NET</h2>

Besoin de développer une application utilitaire .NET pour fusionner facilement plusieurs fichiers CSV ?Avec [Aspose.Cells for .NET](https://products.aspose.com/cells/fr/net/), API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus pour concaténer facilement des documents.La puissante bibliothèque .NET pour la fusion de documents prend en charge de nombreux formats populaires, notamment le format CSV.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion .NET pour les fichiers CSV" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut développer une solution professionnelle pour combiner CSV en utilisant .NET.Utilisez l'API de fusion CSV pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d’utiliser l’application en ligne pour combiner plusieurs documents CSV ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la fusion de documents CSV en ligne.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Comment puis-je fusionner plusieurs fichiers CSV ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Commencez par télécharger un ou plusieurs fichiers que vous souhaitez fusionner. Vous pouvez soit glisser-déposer vos fichiers CSV, soit simplement cliquer dans la zone blanche.Ensuite, cliquez sur le bouton « Fusionner » et notre fusion traitera rapidement les fichiers téléchargés.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Combien de temps faut-il pour fusionner les fichiers CSV ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
