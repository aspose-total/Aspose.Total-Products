---
title: Fusionner des fichiers PDF en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différents fichiers PDF. Code .NET pour fusionner des documents PDF dans d'autres formats.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents PDF en ligne via l'application Merger ou en utilisant .NET" h2="Développez une puissante application de fusion de documents PDF basée sur .NET.Combinez plusieurs documents PDF en un seul en ligne gratuitement via l'application.Enregistrez le fichier PDF au format PDF, Images, Word, Excel, PowerPoint et bien d'autres formats en ligne." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Fusionner des fichiers PDF en ligne à l'aide de l'application" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier PDF via .NET" %}}
...
1. Appelez la méthode Save en utilisant le premier objet et récupérez les fichiers fusionnés.
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers PDF" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers PDF à l'aide de .NET</h2>

Besoin de développer un script .NET ou une application utilitaire pour fusionner facilement plusieurs fichiers PDF ?Avec [Aspose.PDF for .NET](https://products.aspose.com/pdf/fr/net/), API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus pour programmer la fusion d'applications entre documents.La puissante bibliothèque .NET permet de programmer une solution de fusion de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion .NET pour les fichiers PDF" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code et l'utiliser dans le but de développer des applications basées sur .NET axées sur la combinaison de documents PDF. Ce code peut servir de ressource précieuse pour améliorer les fonctionnalités et les capacités de vos projets dans le domaine de la fusion de documents.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
