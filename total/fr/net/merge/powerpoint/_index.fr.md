---
title: Fusionner des fichiers Powerpoint en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différentes présentations Powerpoint.Code de bibliothèque de fusion C# .NET pour fusionner la présentation Powerpoint dans le format de votre choix.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents Powerpoint en ligne via l'application Merger ou en utilisant .NET" h2="Développez une puissante application de fusion de documents Powerpoint basée sur .NET.Combinez plusieurs documents Powerpoint en un seul en ligne gratuitement via l'application.Enregistrez le fichier Powerpoint fusionné au format PDF, Images, Word, Excel, PowerPoint et de nombreux autres formats en ligne." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier Powerpoint via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers Powerpoint" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers Powerpoint à l'aide de .NET</h2>

Besoin de développer une application utilitaire de fusion .NET pour fusionner facilement plusieurs fichiers Powerpoint ?Avec [Aspose.Slides for .NET](https://products.aspose.com/slides/fr/net/), API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus pour concaténer facilement des documents.La puissante bibliothèque .NET pour la fusion de documents prend en charge de nombreux formats populaires, notamment le format Powerpoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion .NET pour les fichiers Powerpoint" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour combiner Powerpoint en utilisant .NET. Utilisez l'API de fusion Powerpoint pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
