---
title: Fusionner des fichiers XLSM en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différents fichiers XLSM.Code de bibliothèque de fusion C# .NET pour fusionner des feuilles de calcul XLSM dans d'autres formats.
...
{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier XLSM via .NET" %}}

1. Chargez les deux XLSM à l’aide des objets de classe Workbook.
...
1. Appelez la méthode Save et regroupez les fichiers XLSM fusionnés en un seul.
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers XLSM" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers XLSM à l'aide de .NET</h2>

Besoin de développer une application utilitaire .NET pour fusionner facilement plusieurs fichiers XLSM ?Avec [Aspose.Cells for .NET](https://products.aspose.com/cells/fr/net/), API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus pour concaténer facilement des documents.La puissante bibliothèque .NET pour la fusion de documents prend en charge de nombreux formats populaires, notamment le format XLSM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion .NET pour les fichiers XLSM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut développer une solution professionnelle pour combiner XLSM en utilisant .NET.Utilisez l'API de fusion XLSM pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
