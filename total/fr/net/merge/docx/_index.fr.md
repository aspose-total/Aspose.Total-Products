---
title: Fusionner des fichiers DOCX en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différents fichiers DOCX.Code de bibliothèque de fusion .NET pour fusionner des documents DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents DOCX en ligne via l'application Merger ou en utilisant .NET" h2="Développez une puissante application de fusion de documents DOCX basée sur .NET.Combinez plusieurs documents DOCX en un seul en ligne gratuitement via l'application.Enregistrez le fichier DOCX au format PDF, Images, Word, Excel, PowerPoint et bien d'autres formats en ligne." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Fusionner des fichiers DOCX en ligne à l'aide de l'application" %}}

1. Téléchargez des fichiers DOCX pour les fusionner en un seul
...
1. Cliquez sur le bouton "Fusionner" pour fusionner DOCX au format souhaité
1. Téléchargez le fichier DOCX fusionné
1. Afficher et obtenir le fichier DOCX fusionné unique

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier DOCX via .NET" %}}
...
1. Appelez la méthode Save et regroupez les fichiers DOCX fusionnés en un seul
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers DOCX" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers DOCX à l'aide de .NET</h2>

Besoin de développer une application utilitaire .NET pour fusionner facilement plusieurs fichiers DOCX ?Avec l'API enfant [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/) de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus pour programmer la fusion d'applications entre documents.La puissante bibliothèque .NET pour la fusion de documents prend en charge de nombreux formats populaires, notamment le format DOCX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion .NET pour les fichiers DOCX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour combiner DOCX en utilisant .NET.Utilisez l'API de fusion Aspose DOCX pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d’utiliser l’application en ligne pour combiner plusieurs documents DOCX ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la fusion de documents DOCX en ligne.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Comment puis-je fusionner plusieurs fichiers DOCX ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Commencez par télécharger un ou plusieurs fichiers que vous souhaitez fusionner. Vous pouvez soit glisser-déposer vos fichiers DOCX, soit simplement cliquer dans la zone blanche.Ensuite, cliquez sur le bouton « Fusionner » et notre fusion traitera rapidement les fichiers téléchargés.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Combien de temps faut-il pour fusionner les fichiers DOCX ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
