---
title: Fusionner des fichiers ODP en ligne ou en utilisant .NET
description: Application en ligne gratuite pour combiner différentes présentations ODP.Code de bibliothèque de fusion C# .NET pour fusionner la présentation ODP dans le format de votre choix.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents ODP en ligne via l'application Merger ou en utilisant .NET" h2="Développez une puissante application de fusion de documents ODP basée sur .NET.Combinez plusieurs documents ODP en un seul en ligne gratuitement via l'application.Enregistrez le fichier ODP fusionné au format PDF, Images, Word, Excel, PowerPoint et de nombreux autres formats en ligne." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Fusionner des fichiers ODP en ligne à l'aide de l'application" %}}
...
1. Afficher et obtenir le fichier ODP fusionné unique

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier ODP via .NET" %}}

1. Charger ODP à l'aide de l'objet de classe Présentation
...
{{% blocks/products/pf/agp/code-block title="Code .NET : fusionner les fichiers ODP" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour combiner ODP en utilisant .NET. Utilisez l'API de fusion ODP pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
