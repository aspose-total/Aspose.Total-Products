---
title: Mettre à jour le fichier TSV à l'aide de .NET
description: Modifiez les documents TSV dans les applications C# VB.NET sans utiliser Microsoft Excel. 
url: /fr/net/update/tsv/
family: total
platformtag: .NET
feature: update
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="Mettre à jour le fichier TSV via .NET" h2="Modifiez la feuille de calcul TSV via vos applications basées sur .NET sans installer Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Pour un développeur, qui essaie de mettre à jour des fichiers TSV via une application .NET ? L'API [Aspose.Total for .NET](https://products.aspose.com/total/net/) peut aider à automatiser le processus de mise à jour. Il s'agit d'un ensemble complet de diverses API .NET traitant différents formats, y compris les fichiers Microsoft Excel. L'API ASPOSE.CELL qui fait partie du package [Aspose.Total for .NET](https://products.aspose.com/total/net/) facilite ce processus de modification. Vous trouverez ci-dessous le processus de mise à jour du document TSV.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Comment mettre à jour le fichier TSV dans .NET" %}}

- Créer un nouvel objet de classe [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) ayant le fichier TSV source comme paramètre
...
- Pour la modification TSV, Microsoft Windows ou un système d'exploitation compatible avec les plates-formes .NET, .NET Core, Mono ou Xamarin
...
{{% blocks/products/pf/agp/code-block title="Code - Mettre à jour le fichier TSV dans .NET" offSpacer="" %}}
