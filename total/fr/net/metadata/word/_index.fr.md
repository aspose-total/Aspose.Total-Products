---
title: Afficher et mettre à jour les propriétés Word en ligne ou mettre à jour les métadonnées à l'aide de .NET
description: Affichez et modifiez gratuitement les propriétés du Word via l'application en ligne.Code API C# .NET pour mettre à jour les propriétés Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Afficher ou mettre à jour les métadonnées Word en ligne ou mettre à jour via .NET" h2="Développez une puissante application utilitaire de gestion des métadonnées de documents Word basée sur .NET.Code répertorié pour la mise à jour des métadonnées du fichier Word via .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Afficher ou mettre à jour les métadonnées Word en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mettre à jour les propriétés Word via .NET" %}}

1. Chargez le fichier Word à l’aide de la classe Document.
...
{{% blocks/products/pf/agp/code-block title="Code .NET : mettre à jour les métadonnées Word" offSpacer="" %}}
...
<h2>Développer une application de gestion de métadonnées Word via .NET</h2>

Besoin de développer une application ou un utilitaire de gestion des métadonnées Word ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de métadonnées de document.La puissante bibliothèque .NET permet de programmer n’importe quelle solution de métadonnées de document.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour gérer les métadonnées Word" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour gérer les propriétés des documents Word ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la gestion des propriétés des documents Word en ligne. Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
