---
title: Afficher et mettre à jour les propriétés DOT en ligne ou mettre à jour les métadonnées à l'aide de .NET
description: Affichez et modifiez gratuitement les propriétés du DOT via l'application en ligne.Code API C# .NET pour mettre à jour les propriétés DOT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Afficher ou mettre à jour les métadonnées DOT en ligne ou mettre à jour via .NET" h2="Développez une puissante application utilitaire de gestion des métadonnées de documents DOT basée sur .NET.Code répertorié pour la mise à jour des métadonnées du fichier DOT via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mettre à jour les propriétés DOT via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : mettre à jour les métadonnées DOT" offSpacer="" %}}
...
<h2>Développer une application de gestion de métadonnées DOT via .NET</h2>

Besoin de développer une application ou un utilitaire de gestion des métadonnées DOT ?Avec [Aspose.Words for .NET](https://products.aspose.com/words/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de métadonnées de document.La puissante bibliothèque .NET permet de programmer n’importe quelle solution de métadonnées de document.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format DOT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour gérer les métadonnées DOT" %}}
