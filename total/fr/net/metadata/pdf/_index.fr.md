---
title: Afficher et mettre à jour les propriétés PDF en ligne ou mettre à jour les métadonnées à l'aide de .NET
description: Affichez et modifiez gratuitement les propriétés du PDF via l'application en ligne.Code API C# .NET pour mettre à jour les propriétés PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Afficher ou mettre à jour les métadonnées PDF en ligne ou mettre à jour via .NET" h2="Développez une puissante application utilitaire de gestion des métadonnées de documents PDF basée sur .NET.Code répertorié pour la mise à jour des métadonnées du fichier PDF via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mettre à jour les métadonnées PDF via .NET" %}}

1. Chargez le fichier PDF à l’aide de la classe Document.
1. Créer un objet de classe DocumentInfo ayant le premier objet comme paramètre
1. Attribuer de nouvelles propriétés
...
{{% blocks/products/pf/agp/code-block title="Code .NET : mettre à jour les propriétés PDF" offSpacer="" %}}
...
<h2>Développer une application de gestion de métadonnées PDF via .NET</h2>

Besoin de développer une application ou un utilitaire de gestion des métadonnées PDF ?Avec [Aspose.PDF for .NET](https://products.aspose.com/pdf/fr/net/), une API enfant de [Aspose.Total for .NET](https://products.aspose.com/total/fr/net/), tout développeur .NET peut intégrer le code API ci-dessus dans son application de métadonnées de document.La puissante bibliothèque .NET permet de programmer n’importe quelle solution de métadonnées de document.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour gérer les métadonnées PDF" %}}
