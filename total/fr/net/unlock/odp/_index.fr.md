---
title: Supprimez la protection par mot de passe ODP en ligne ou en utilisant .NET
description: Supprimez gratuitement le mot de passe du document ODP via l'application en ligne.Code API .NET C# pour déverrouiller les fichiers ODP protégés par mot de passe.
...
{{< blocks/products/pf/feature-page-header-widget h1="Déverrouillez le mot de passe du document ODP en ligne ou via .NET" h2="Développez une puissante application utilitaire de verrouillage et de déverrouillage de documents ODP basée sur .NET.Code répertorié pour supprimer les restrictions de mot de passe du fichier ODP via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer le mot de passe ODP via .NET" %}}

1. Charger le fichier ODP à l'aide de la classe Présentation avec options de chargement
1. Invoquez la méthode RemoveEncryption() pour supprimer le mot de passe
...
{{% blocks/products/pf/agp/code-block title="Code .NET : Supprimer le mot de passe du document ODP" offSpacer="" %}}
...
<h2>Développer une application de gestion de la protection ODP via .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire .NET pour gérer la protection ODP" %}}
