---
title: Compresser les fichiers DOTM en ligne ou via .NET
description: Application en ligne gratuite pour compresser différents fichiers DOTM.Code de bibliothèque de compression C# .NET pour les documents DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOTM en ligne via l'application de compression ou en utilisant .NET" h2="Développez de puissantes applications de compression de documents DOTM basées sur .NET.Compressez librement divers documents, y compris les fichiers DOTM, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers DOTM en ligne à l'aide de l'application" %}}

1. Téléchargez des fichiers DOTM pour les compresser et les optimiser.
1. Choisissez le niveau de compression (faible, moyen ou élevé)
1. Cliquez sur le bouton "Compresser".
1. Téléchargez le fichier DOTM compressé.
1. Visualisez et obtenez le résultat de la compression en vérifiant sa taille et la qualité du contenu.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOTM via .NET" %}}

1. Référencez la bibliothèque .NET dans votre projet
1. Charger le document
1. Appeler la méthode Cleanup()
...
1. Appelez la méthode Save et obtenez le fichier DOTM compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code .NET : compresser les fichiers DOTM" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOTM à l'aide de .NET</h2>

Besoin de développer un script .NET ou une application utilitaire pour compresser facilement plusieurs fichiers DOTM ?Avec les API enfants [Aspose.Words for .NET](https://products.aspose.com/words/net/) de [Aspose.Total for .NET](https://products.aspose.com/total/net/), tout développeur .NET peut intégrer le code API ci-dessus pour programmer une application de compression sur plusieurs documents.La puissante bibliothèque .NET pour la compression de documents prend en charge de nombreux formats populaires, notamment le format DOTM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression .NET pour les fichiers DOTM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### Compression des fichiers DOTM pour l'efficacité des modèles de Word avec macros

Les fichiers DOTM (Modèles de Word avec macros) contiennent des scripts et du formatage qui augmentent la taille du fichier. La compression des fichiers DOTM garantit un accès plus rapide et une gestion plus aisée des modèles automatisés.

#### Cas d'utilisation :

- **Distribution de modèles avec macros**  
  Partager des modèles DOTM au niveau de l'organisation pour un déploiement plus rapide.

- **Stockage efficient des macros**  
  Archiver une collection de modèles DOTM sans gaspiller de place sur le disque.

- **Déploiement cross-système**  
  Compresser les fichiers DOTM pour une compatibilité et un déclenchement réduit des modèles sur différentes machines.

- **Optimisation du répertoire de modèles**  
  Conserver les bibliothèques de modèles légères et gérables en utilisant des fichiers DOTM compressés.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier DOTM en utilisant .NET.Utilisez l'API de compression Aspose DOTM pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour compresser plusieurs documents DOTM ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la compression de documents DOTM en ligne.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Comment puis-je compresser plusieurs fichiers DOTM ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Start by uploading one or more files you want to compress. Vous pouvez soit glisser-déposer vos fichiers DOTM, soit simplement cliquer dans la zone blanche.Ensuite, cliquez sur le bouton « Compresser » et notre application de compression en ligne traitera rapidement les fichiers téléchargés.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Combien de temps faut-il pour compresser les fichiers DOTM ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
