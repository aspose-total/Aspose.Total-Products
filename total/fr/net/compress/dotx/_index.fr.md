---
title: Compresser les fichiers DOTX en ligne ou via .NET
description: Application en ligne gratuite pour compresser différents fichiers DOTX.Code de bibliothèque de compression C# .NET pour les documents DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOTX en ligne via l'application de compression ou en utilisant .NET" h2="Développez de puissantes applications de compression de documents DOTX basées sur .NET.Compressez librement divers documents, y compris les fichiers DOTX, en ligne via une application avec téléchargement instantané." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOTX via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : compresser les fichiers DOTX" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOTX à l'aide de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression .NET pour les fichiers DOTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier DOTX en utilisant .NET.Utilisez l'API de compression Aspose DOTX pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
