---
title: Compresser les fichiers XLSM en ligne ou via .NET
description: Application en ligne gratuite pour compresser différents fichiers XLSM.Code de bibliothèque de compression .NET pour les documents XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier XLSM en ligne via l'application de compression ou en utilisant .NET" h2="Développez de puissantes applications de compression de documents XLSM basées sur .NET.Compressez librement divers documents, y compris les fichiers XLSM, en ligne via une application avec téléchargement instantané." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier XLSM via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : compresser les fichiers XLSM" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier XLSM en utilisant .NET.Utilisez l'API de compression Aspose XLSM pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
