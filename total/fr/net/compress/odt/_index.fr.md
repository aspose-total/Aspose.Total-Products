---
title: Compresser les fichiers ODT en ligne ou via .NET
description: Application en ligne gratuite pour compresser différents fichiers ODT.Code de bibliothèque de compression C# .NET pour les documents ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier ODT en ligne via l'application de compression ou en utilisant .NET" h2="Développez de puissantes applications de compression de documents ODT basées sur .NET.Compressez librement divers documents, y compris les fichiers ODT, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers ODT en ligne à l'aide de l'application" %}}

1. Téléchargez des fichiers ODT pour les compresser et les optimiser.
1. Choisissez le niveau de compression (faible, moyen ou élevé)
1. Cliquez sur le bouton "Compresser".
1. Téléchargez le fichier ODT compressé.
1. Visualisez et obtenez le résultat de la compression en vérifiant sa taille et la qualité du contenu.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier ODT via .NET" %}}
...
1. Appelez la méthode Save et obtenez le fichier ODT compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code .NET : compresser les fichiers ODT" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### Compression des fichiers ODT pour un Gestionnaire de Texte OpenDocument Léger

Les fichiers ODT (Texte OpenDocument), souvent utilisés dans des logiciels de bureau open-source comme LibreOffice, peuvent augmenter en taille à cause d'images intégrées, de tableaux et de formats avancés. La compression des fichiers ODT garantit une meilleure portabilité et des performances améliorées sur les systèmes.

#### Cas d'utilisation :

- **Partage optimal de documents**  
  Réduire la taille des fichiers ODT pour des chargements plus rapides, des attaches mails et une collaboration en ligne sans interruption.

- **Efficacité dans l'archivage**  
  Compresser les documents ODT pour économiser de l'espace dans les partages réseau et les repositories de documents.

- **Performance améliorée sur les appareils basse performance**  
  Des fichiers ODT plus compacts se chargent plus rapidement sur des systèmes avec peu de ressources, ce qui améliore l'expérience utilisateur.

- **Stockage structuré**  
  Stocker de grandes volumes de rapports ou manuels ODT avec des versions compressées.
  ...
  <div class="container tl dflex" itemscope="" itemtype="https://schema.org/FAQPage">
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier ODT en utilisant .NET.Utilisez l'API de compression Aspose ODT pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour compresser plusieurs documents ODT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Comment puis-je compresser plusieurs fichiers ODT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Combien de temps faut-il pour compresser les fichiers ODT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
