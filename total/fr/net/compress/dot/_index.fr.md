---
title: Compresser les fichiers DOT en ligne ou via .NET
description: Application en ligne gratuite pour compresser différents fichiers DOT.Code de bibliothèque de compression C# .NET pour les documents DOT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOT en ligne via l'application de compression ou en utilisant .NET" h2="Développez de puissantes applications de compression de documents DOT basées sur .NET.Compressez librement divers documents, y compris les fichiers DOT, en ligne via une application avec téléchargement instantané." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOT via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Code .NET : compresser les fichiers DOT" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOT à l'aide de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression .NET pour les fichiers DOT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### Comprimer les fichiers DOT pour la gestion de modèles Word héritiers

Les fichiers DOT (modèles Word 97–2003) sont des anciens modèles Word qui peuvent inclure des formattages riches ou des images. La compression de ces fichiers rend les systèmes de gestion de modèles legacy plus efficaces et portables.

#### Utilisations :

- **Nettoyage de la bibliothèque de modèles**  
  Réduire la taille des fichiers DOT pour maintenir un répertoire de modèles compact et organisé.

- **Accélération du chargement sur les systèmes legacy**  
  Des fichiers plus petits améliorent les temps de réponse sur des machines plus anciennes ou des environnements virtuels.

- **Stockage compact pour l'archivage**  
  Archiver les modèles legacy dans une forme compressée réduit les coûts de stockage à long terme.

- **Modèles de politique d'entreprise**  
  Faciliter la distribution rapide de modèles DOT standard à travers les départements.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier DOT en utilisant .NET.Utilisez l'API de compression Aspose DOT pour développer des logiciels de haut niveau indépendants de la plate-forme dans .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
