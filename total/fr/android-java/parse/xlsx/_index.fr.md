---
title: Extraire le texte et les images du fichier XLSX en ligne et à l'aide des applications mobiles Android
description: Application d'analyse de fichiers XLSX en ligne. Code API Android pour extraire le texte des lignes et des cellules des feuilles de calcul XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier XLSX en ligne ainsi que via les applications Android" h2="Développez une puissante application utilitaire d’analyse de documents XLSX basée sur Android. Code répertorié pour l’analyse des documents XLSX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document XLSX en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier XLSX via l'application Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Code : Analyser le document XLSX" offSpacer="" %}}
...
<h2>Développer une application Android d'analyseur de fichiers XLSX</h2>

Besoin de développer une application ou un utilitaire d'analyseur XLSX ? Avec [Aspose.Cells for Android via Java](https://products.aspose.com/cells/fr/android-java/), une API enfant de [Aspose.Total for Android via Java](https://products.aspose.com/total/fr/android-java/), tout développeur Android peut intégrer le code API ci-dessus dans son application d'analyse de documents. La puissante bibliothèque Android permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte. De plus, il peut prendre en charge de nombreux formats populaires, notamment le format XLSX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Android pour traiter le fichier XLSX pour l'application d'analyseur" %}}
