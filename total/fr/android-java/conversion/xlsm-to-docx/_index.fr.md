---
title: Exporter XLSM vers DOCX dans Android
description: API Android pour convertir XLSM en DOCX sans utiliser Microsoft Word
url: /fr/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLSM en DOCX sur Android via Java" h2="Transformez XLSM en DOCX dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
