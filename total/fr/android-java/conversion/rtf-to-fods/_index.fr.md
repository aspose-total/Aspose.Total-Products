---
title: API Android pour convertir RTF en FODS
description: Convertir RTF en FODS dans Android via Java sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/android-java/conversion/rtf-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Convertir RTF en FODS dans les applications Android" h2="Exportez RTF vers FODS dans Android via Java sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
