---
title: Exporter XLS vers DOCX dans Android
description: API Android pour convertir XLS en DOCX sans utiliser Microsoft Word
url: /fr/android-java/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLS en DOCX sur Android via Java" h2="Transformez XLS en DOCX dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
