---
title: Convertir PDF en SXC dans Android via Java
description: Rendu PDF au format SXC dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PDF
