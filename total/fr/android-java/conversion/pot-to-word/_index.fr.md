---
title: Exporter POT vers WORD sur Andorid via Java
description: Convertissez POT en WORD dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pot-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Rendre POT en WORD sur Andorid via Java" h2="API de format de fichier pour convertir POT en WORD dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
