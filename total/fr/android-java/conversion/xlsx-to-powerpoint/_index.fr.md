---
title: Exporter XLSX vers POWERPOINT dans Android
description: API Android pour convertir XLSX en POWERPOINT sans utiliser Microsoft Word
url: /fr/android-java/conversion/xlsx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLSX en POWERPOINT sur Android via Java" h2="Transformez XLSX en POWERPOINT dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/android-java/conversion/xlsx-to-powerpointx/" name="XLSX À POWERPOINTX" description="" >}}
