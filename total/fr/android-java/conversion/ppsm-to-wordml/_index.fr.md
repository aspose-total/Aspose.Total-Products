---
title: Exporter PPSM vers WORDML sur Andorid via Java
description: Convertissez PPSM en WORDML dans les applications mobiles sans installer de logiciel
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPSM en WORDML sur Andorid via Java" h2="API de format de fichier pour convertir PPSM en WORDML dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
