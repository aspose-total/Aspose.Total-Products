---
title: Convertir PPSX en ODS dans Android via Java
description: Convertissez PPSX en ODS dans Android via Java sans utiliser Microsoft Excel ou PowerPoint
url: /fr/android-java/conversion/ppsx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPSX en ODS dans Android via Java" h2="Exportez le fichier PPSX au format ODS dans les applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Afin de convertir PPSX en ODS, vous pouvez facilement utiliser Aspose.Total pour Android via Java directement depuis [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) et installez les bibliothèques dans votre application.
