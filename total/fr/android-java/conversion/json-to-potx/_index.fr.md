---
title: Convertir le format JSON en POTX dans Android via Java
description: Analyser JSON en POTX dans les applications Android sans utiliser Microsoft PowerPoint
url: /fr/android-java/conversion/json-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
4. Enregistrez le document au format POTX à l'aide de la méthode [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en POTX dans les applications Android" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en POTX avec filigrane dans Android via Java" %}}
