---
title: Convertir PDF en XLSM dans Android via Java
description: Rendu PDF au format XLSM dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PDF
