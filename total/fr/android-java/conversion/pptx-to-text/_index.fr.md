---
title: Exporter PPTX vers TEXT sur Andorid via Java
description: Convertissez PPTX en TEXT dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPTX en TEXT sur Andorid via Java" h2="API de format de fichier pour convertir PPTX en TEXT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
