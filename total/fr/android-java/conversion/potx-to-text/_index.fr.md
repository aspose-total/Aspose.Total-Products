---
title: Exporter POTX vers TEXT sur Andorid via Java
description: Convertissez POTX en TEXT dans les applications mobiles sans installer de logiciel
...
{{< blocks/products/pf/feature-page-header h1="Rendre POTX en TEXT sur Andorid via Java" h2="API de format de fichier pour convertir POTX en TEXT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
