---
title: Exporter POWERPOINT vers WORDML sur Andorid via Java
description: Convertissez POWERPOINT en WORDML dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Rendre POWERPOINT en WORDML sur Andorid via Java" h2="API de format de fichier pour convertir POWERPOINT en WORDML dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
...
Vous pouvez convertir votre wordmlument donné en deux étapes. Vous pouvez utiliser [Aspose.Slides pour Andorid via Java](https://products.aspose.com/slides/android-java/) qui est une API PowerPoint pour les applications Android pour rendre POWERPOINT en HTML. Après cela, en utilisant l'API de traitement de wordmlument [Aspose.Words pour Android via Java](https://products.aspose.com/words/android-java/), vous pouvez convertir le HTML en WORDML. 
{{% /blocks/products/pf/feature-page-summary  %}}
