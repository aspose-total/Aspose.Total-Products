---
title: Exporter XLSB vers POWERPOINT dans Android
description: API Android pour convertir XLSB en POWERPOINT sans utiliser Microsoft Word
url: /fr/android-java/conversion/xlsb-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLSB en POWERPOINT sur Android via Java" h2="Transformez XLSB en POWERPOINT dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
