---
title: Exporter PPTM vers DOTX sur Andorid via Java
description: Convertissez PPTM en DOTX dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pptm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPTM en DOTX sur Andorid via Java" h2="API de format de fichier pour convertir PPTM en DOTX dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
