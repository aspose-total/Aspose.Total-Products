---
title: Exporter PPTX vers DOTM sur Andorid via Java
description: Convertissez PPTX en DOTM dans les applications mobiles sans installer de logiciel
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPTX en DOTM sur Andorid via Java" h2="API de format de fichier pour convertir PPTX en DOTM dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
