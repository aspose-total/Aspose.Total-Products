---
title: Convertir le format JSON en RTF sous Android via Java
description: Analyser JSON en RTF en Java sans utiliser Microsoft Word
url: /fr/android-java/conversion/json-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{< blocks/products/pf/feature-page-header h1="Convertir le format JSON en RTF dans les applications Android" h2="Analyse JSON vers RTF dans les applications Android sans utiliser Microsoft<sup>&reg;</sup> Word" >}}

{{% blocks/products/pf/feature-page-summary %}}
Vous pouvez convertir JSON en RTF dans vos applications Android en deux étapes. Tout d'abord, en utilisant l'API de traitement de feuille de calcul puissante [Aspose.Cells pour Android via Java](https://products.aspose.com/cells/android-java/), vous pouvez analyser JSON en PDF. Dans la deuxième étape, vous pouvez convertir un PDF en RTF en utilisant l'API de traitement de texte [Aspose.Words pour Android via Java](https://products.aspose.com/words/android-java/). Les deux API appartiennent à la famille de produits [Aspose.Total pour Android via Java](https://products.aspose.com/total/android-java/). 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en RTF sous Android via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en RTF avec filigrane dans Android via Java" %}}
