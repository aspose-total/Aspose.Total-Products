---
title: Exporter PPTX vers WORDML sur Andorid via Java
description: Convertissez PPTX en WORDML dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pptx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPTX en WORDML sur Andorid via Java" h2="API de format de fichier pour convertir PPTX en WORDML dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
