---
title: Exporter FODS vers WORD dans Android
description: API Android pour convertir FODS en WORD sans utiliser Microsoft Word
url: /fr/android-java/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Rendu FODS en WORD sur Android via Java" h2="Transformez FODS en WORD dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
