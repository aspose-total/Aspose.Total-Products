---
title: Convertir PDF en XLAM dans Android via Java
description: Rendu PDF au format XLAM dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PDF
