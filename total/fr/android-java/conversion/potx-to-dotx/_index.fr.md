---
title: Exporter POTX vers DOTX sur Andorid via Java
description: Convertissez POTX en DOTX dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Rendre POTX en DOTX sur Andorid via Java" h2="API de format de fichier pour convertir POTX en DOTX dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
