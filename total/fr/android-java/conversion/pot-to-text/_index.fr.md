---
title: Exporter POT vers TEXT sur Andorid via Java
description: Convertissez POT en TEXT dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pot-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Rendre POT en TEXT sur Andorid via Java" h2="API de format de fichier pour convertir POT en TEXT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
