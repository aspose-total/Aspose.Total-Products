---
title: Exporter POTX vers WORD sur Andorid via Java
description: Convertissez POTX en WORD dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/potx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Rendre POTX en WORD sur Andorid via Java" h2="API de format de fichier pour convertir POTX en WORD dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
