---
title: Exporter PPS vers TEXT sur Andorid via Java
description: Convertissez PPS en TEXT dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPS en TEXT sur Andorid via Java" h2="API de format de fichier pour convertir PPS en TEXT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
