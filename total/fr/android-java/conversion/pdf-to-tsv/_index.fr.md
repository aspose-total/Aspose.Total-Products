---
title: Convertir PDF en TSV dans Android via Java
description: Rendu PDF au format TSV dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PDF
