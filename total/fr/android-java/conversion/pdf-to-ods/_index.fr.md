---
title: Convertir PDF en ODS dans Android via Java
description: Rendu PDF au format ODS dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PDF
