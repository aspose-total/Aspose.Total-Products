---
title: Exporter PPSM vers DOTM sur Andorid via Java
description: Convertissez PPSM en DOTM dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/ppsm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPSM en DOTM sur Andorid via Java" h2="API de format de fichier pour convertir PPSM en DOTM dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
