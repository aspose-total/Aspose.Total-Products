---
title: Convertir PDF en TXT dans Android via Java
description: Rendu PDF au format TXT dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
