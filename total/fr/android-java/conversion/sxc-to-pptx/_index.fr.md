---
title: Exporter SXC vers PPTX dans Android
description: API Android pour convertir SXC en PPTX sans utiliser Microsoft Word
url: /fr/android-java/conversion/sxc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Rendu SXC en PPTX sur Android via Java" h2="Transformez SXC en PPTX dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
