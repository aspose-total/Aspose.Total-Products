...
Vous pouvez convertir votre dotument donné en deux étapes. Vous pouvez utiliser [Aspose.Slides pour Andorid via Java](https://products.aspose.com/slides/android-java/) qui est une API PowerPoint pour les applications Android pour rendre PPTX en HTML. Après cela, en utilisant l'API de traitement de dotument [Aspose.Words pour Android via Java](https://products.aspose.com/words/android-java/), vous pouvez convertir le HTML en DOT. 
{{% /blocks/products/pf/feature-page-summary  %}}
