---
title: Exporter PPSX vers TEXT sur Andorid via Java
description: Convertissez PPSX en TEXT dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/ppsx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPSX en TEXT sur Andorid via Java" h2="API de format de fichier pour convertir PPSX en TEXT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
