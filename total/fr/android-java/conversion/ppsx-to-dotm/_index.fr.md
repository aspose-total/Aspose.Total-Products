---
title: Exporter PPSX vers DOTM sur Andorid via Java
description: Convertissez PPSX en DOTM dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPSX en DOTM sur Andorid via Java" h2="API de format de fichier pour convertir PPSX en DOTM dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
