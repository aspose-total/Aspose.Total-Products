---
title: Exporter PPTM vers DOC sur Andorid via Java
description: Convertissez PPTM en DOC dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPTM en DOC sur Andorid via Java" h2="API de format de fichier pour convertir PPTM en DOC dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
...
Vous pouvez convertir votre document donné en deux étapes. Vous pouvez utiliser [Aspose.Slides pour Andorid via Java](https://products.aspose.com/slides/android-java/) qui est une API PowerPoint pour les applications Android pour rendre PPTM en HTML. Après cela, en utilisant l'API de traitement de document [Aspose.Words pour Android via Java](https://products.aspose.com/words/android-java/), vous pouvez convertir le HTML en DOC. 
{{% /blocks/products/pf/feature-page-summary  %}}
