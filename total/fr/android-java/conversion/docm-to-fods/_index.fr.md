---
title: API Android pour convertir DOCM en FODS
description: Convertir DOCM en FODS dans Android via Java sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/android-java/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Convertir DOCM en FODS dans les applications Android" h2="Exportez DOCM vers FODS dans Android via Java sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
