---
title: Exporter PPSX vers WORDML sur Andorid via Java
description: Convertissez PPSX en WORDML dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/ppsx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPSX en WORDML sur Andorid via Java" h2="API de format de fichier pour convertir PPSX en WORDML dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
