---
title: Exporter XLTX vers DOCX dans Android
description: API Android pour convertir XLTX en DOCX sans utiliser Microsoft Word
url: /fr/android-java/conversion/xltx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLTX en DOCX sur Android via Java" h2="Transformez XLTX en DOCX dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
