---
title: Exporter PPS vers DOCX sur Andorid via Java
description: Convertissez PPS en DOCX dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Rendre PPS en DOCX sur Andorid via Java" h2="API de format de fichier pour convertir PPS en DOCX dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
...
Vous pouvez convertir votre docxument donné en deux étapes. Vous pouvez utiliser [Aspose.Slides pour Andorid via Java](https://products.aspose.com/slides/android-java/) qui est une API PowerPoint pour les applications Android pour rendre PPS en HTML. Après cela, en utilisant l'API de traitement de docxument [Aspose.Words pour Android via Java](https://products.aspose.com/words/android-java/), vous pouvez convertir le HTML en DOCX. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/android-java/conversion/pps-to-docxm/" name="PPS À DOCXM" description="" >}}
