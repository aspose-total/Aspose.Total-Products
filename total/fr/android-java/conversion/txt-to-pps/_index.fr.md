---
title: Convertir TXT en PPS dans Android via Java
description: Conversion TXT en PPS dans vos téléphones Android sans utiliser Microsoft Word de PowerPoint
url: /fr/android-java/conversion/txt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="Convertir TXT en PPS dans les applications Android" h2="Conversion TXT en PPS dans vos applications Android sans installer Microsoft Word<sup>&reg;</sup> ou PowerPoint" >}}
...
Pour la conversion de fichiers TXT en PPS, vous pouvez facilement utiliser Aspose.Total pour Android via Java directement depuis [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) et installez les bibliothèques dans votre application.
