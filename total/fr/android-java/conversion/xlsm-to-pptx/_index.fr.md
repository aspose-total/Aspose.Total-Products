---
title: Exporter XLSM vers PPTX dans Android
description: API Android pour convertir XLSM en PPTX sans utiliser Microsoft Word
url: /fr/android-java/conversion/xlsm-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Rendu XLSM en PPTX sur Android via Java" h2="Transformez XLSM en PPTX dans vos applications Android sans utiliser Microsoft<sup>&reg;</sup> Excel" >}}
