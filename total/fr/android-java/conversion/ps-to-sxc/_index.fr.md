---
title: Convertir PS en SXC dans Android via Java
description: Rendu PS au format SXC dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/ps-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
{{% blocks/products/pf/agp/feature-section-col title="API Android pour rendre PS en SXC" %}}
