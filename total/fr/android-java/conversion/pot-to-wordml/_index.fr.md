---
title: Exporter POT vers WORDML sur Andorid via Java
description: Convertissez POT en WORDML dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Rendre POT en WORDML sur Andorid via Java" h2="API de format de fichier pour convertir POT en WORDML dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
