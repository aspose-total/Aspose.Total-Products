---
title: Convertir PDF en XLSB dans Android via Java
description: Rendu PDF au format XLSB dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PDF
