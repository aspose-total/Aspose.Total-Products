---
title: Convertir RTF en PPSM dans Android via Java
description: Conversion RTF en PPSM dans vos téléphones Android sans utiliser Microsoft Word de PowerPoint
url: /fr/android-java/conversion/rtf-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="Convertir RTF en PPSM dans les applications Android" h2="Conversion RTF en PPSM dans vos applications Android sans installer Microsoft Word<sup>&reg;</sup> ou PowerPoint" >}}
...
Pour la conversion de fichiers RTF en PPSM, vous pouvez facilement utiliser Aspose.Total pour Android via Java directement depuis [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) et installez les bibliothèques dans votre application.
