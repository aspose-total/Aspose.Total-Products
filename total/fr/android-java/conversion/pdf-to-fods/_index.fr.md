---
title: Convertir PDF en FODS dans Android via Java
description: Rendu PDF au format FODS dans Android via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/android-java/conversion/pdf-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PDF
