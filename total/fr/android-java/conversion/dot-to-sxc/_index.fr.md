---
title: API Android pour convertir DOT en SXC
description: Convertir DOT en SXC dans Android via Java sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/android-java/conversion/dot-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="Convertir DOT en SXC dans les applications Android" h2="Exportez DOT vers SXC dans Android via Java sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
