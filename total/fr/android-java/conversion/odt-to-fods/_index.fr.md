---
title: API Android pour convertir ODT en FODS
description: Convertir ODT en FODS dans Android via Java sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/android-java/conversion/odt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Convertir ODT en FODS dans les applications Android" h2="Exportez ODT vers FODS dans Android via Java sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
