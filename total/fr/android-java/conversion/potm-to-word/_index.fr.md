---
title: Exporter POTM vers WORD sur Andorid via Java
description: Convertissez POTM en WORD dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/potm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Rendre POTM en WORD sur Andorid via Java" h2="API de format de fichier pour convertir POTM en WORD dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
