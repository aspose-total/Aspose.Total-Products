---
title: Exporter POTM vers DOT sur Andorid via Java
description: Convertissez POTM en DOT dans les applications mobiles sans installer de logiciel
url: /fr/android-java/conversion/potm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Rendre POTM en DOT sur Andorid via Java" h2="API de format de fichier pour convertir POTM en DOT dans les applications Android sans dépendre de Microsoft PowerPoint ou Word" >}}
