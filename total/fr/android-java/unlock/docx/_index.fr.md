---
title: Supprimez la protection par mot de passe DOCX en ligne ou à l'aide d'applications mobiles Android
description: Déverrouillez gratuitement le mot de passe du document DOCX via l'application en ligne. Code API Android pour supprimer le mot de passe des fichiers DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Déverrouillez le mot de passe du document DOCX en ligne ou via des applications Android" h2="Développez une puissante application utilitaire de déverrouillage de documents DOCX basée sur Android. Code répertorié pour supprimer les restrictions de mot de passe du fichier DOCX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Déverrouiller le mot de passe DOCX en ligne" %}}

1. Importez le fichier DOCX pour le déverrouiller en le téléchargeant
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer le mot de passe DOCX via l'application Android" %}}

1. Bibliothèque Android de référence au sein du projet 
1. Charger le fichier DOCX protégé par mot de passe à l'aide de la classe Document
...
{{% blocks/products/pf/agp/code-block title="Code : Supprimer le mot de passe du document DOCX" offSpacer="" %}}
...
<h2>Développer une application Android de gestion de la protection DOCX</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Android pour gérer la protection DOCX" %}}
