---
title: Supprimez la protection par mot de passe ODT en ligne ou à l'aide d'applications mobiles Android
description: Déverrouillez gratuitement le mot de passe du document ODT via l'application en ligne. Code API Android pour supprimer le mot de passe des fichiers ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Déverrouillez le mot de passe du document ODT en ligne ou via des applications Android" h2="Développez une puissante application utilitaire de déverrouillage de documents ODT basée sur Android. Code répertorié pour supprimer les restrictions de mot de passe du fichier ODT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer le mot de passe ODT via l'application Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Code : Supprimer le mot de passe du document ODT" offSpacer="" %}}
...
<h2>Développer une application Android de gestion de la protection ODT</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Android pour gérer la protection ODT" %}}
