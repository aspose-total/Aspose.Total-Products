---
title: Compresser les fichiers DOCM en ligne ou à l'aide d'applications mobiles Android
description: Application en ligne gratuite pour compresser différents fichiers DOCM.Code Java de la bibliothèque de compression Android pour les documents DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOCM en ligne ou en utilisant l'application Android" h2="Développez de puissantes applications de compression de documents DOCM basées sur Android.Compressez librement divers documents, y compris les fichiers DOCM, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers DOCM en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOCM via l'application Android" %}}
...
1. Appelez la méthode de sauvegarde et obtenez le fichier DOCM compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code Java : Compresser les fichiers DOCM" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOCM pour Android</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression Android pour les fichiers DOCM" %}}
