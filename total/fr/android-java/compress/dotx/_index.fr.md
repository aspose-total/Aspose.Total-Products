---
title: Compresser les fichiers DOTX en ligne ou à l'aide d'applications mobiles Android
description: Application en ligne gratuite pour compresser différents fichiers DOTX.Code Java de la bibliothèque de compression Android pour les documents DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOTX en ligne ou en utilisant l'application Android" h2="Développez de puissantes applications de compression de documents DOTX basées sur Android.Compressez librement divers documents, y compris les fichiers DOTX, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers DOTX en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOTX via l'application Android" %}}
...
1. Appelez la méthode de sauvegarde et obtenez le fichier DOTX compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code Java : Compresser les fichiers DOTX" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOTX pour Android</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression Android pour les fichiers DOTX" %}}
