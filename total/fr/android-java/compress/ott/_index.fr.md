---
title: Compresser les fichiers OTT en ligne ou à l'aide d'applications mobiles Android
description: Application en ligne gratuite pour compresser différents fichiers OTT.Code Java de la bibliothèque de compression Android pour les documents OTT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier OTT en ligne ou en utilisant l'application Android" h2="Développez de puissantes applications de compression de documents OTT basées sur Android.Compressez librement divers documents, y compris les fichiers OTT, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers OTT en ligne" %}}

1. Téléchargez des fichiers OTT pour les compresser et les optimiser.
1. Choisissez le niveau de compression (faible, moyen ou élevé)
1. Cliquez sur le bouton "Compresser".
1. Téléchargez le fichier OTT compressé.
1. Visualisez et obtenez le résultat de la compression en vérifiant sa taille et la qualité du contenu.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier OTT via l'application Android" %}}
...
1. Appelez la méthode de sauvegarde et obtenez le fichier OTT compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code Java : Compresser les fichiers OTT" offSpacer="" %}}
