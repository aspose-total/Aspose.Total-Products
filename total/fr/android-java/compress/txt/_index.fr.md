---
title: Compresser les fichiers TXT en ligne ou à l'aide d'applications mobiles Android
description: Application en ligne gratuite pour compresser différents fichiers TXT.Code Java de la bibliothèque de compression Android pour les documents TXT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier TXT en ligne ou en utilisant l'application Android" h2="Développez de puissantes applications de compression de documents TXT basées sur Android.Compressez librement divers documents, y compris les fichiers TXT, en ligne via une application avec téléchargement instantané." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers TXT en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier TXT via l'application Android" %}}
...
1. Appelez la méthode de sauvegarde et obtenez le fichier TXT compressé

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Code Java : Compresser les fichiers TXT" offSpacer="" %}}
