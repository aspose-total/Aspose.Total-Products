---
title: Protégez le document ODP en ligne avec un mot de passe ou à l'aide d'applications mobiles Android
description: Application de protection par mot de passe du fichier ODP en ligne.Code Java de l'API Android pour appliquer la protection par mot de passe sur les présentations ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents ODP en ligne ou définition d'un mot de passe via l'application Android" h2="Développez une puissante application utilitaire de protection de documents ODP basée sur Android.Code répertorié pour appliquer le mot de passe à la présentation ODP via Android." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protection par mot de passe ODP via l'application Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Code Java : Protection par mot de passe de présentation ODP" offSpacer="" %}}
...
<h2>Développer l'application Android de protection par mot de passe ODP</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Android pour traiter le fichier ODP pour protéger l'application" %}}
