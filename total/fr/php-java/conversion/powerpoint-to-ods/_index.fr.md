---
title: Convertissez POWERPOINT en ODS via PHP ou avec un convertisseur en ligne gratuit 
description: API PHP pour convertir POWERPOINT en ODS ou en application en ligne sans utiliser Microsoft Office Powerpoint ou Excel. Testez rapidement le convertisseur en ligne POWERPOINT vers ODS gratuit avant d'intégrer le code. 
...
{{< blocks/products/pf/feature-page-header h1="API PHP pour convertir POWERPOINT en ODS ou application en ligne" h2="Exportez la présentation POWERPOINT au format ODS via PHP sans utiliser Microsoft<sup>&reg;</sup> Office." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir POWERPOINT en ODS ?" %}}
