---
title: API PHP pour Excel, fichiers PowerPoint et traitement des codes-barres
weight: 50
description: Traitez des feuilles de calcul Excel et des documents PowerPoint via l'API PHP. Reconnaître et générer des codes-barres 1D, 2D et postaux via des applications PHP.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fichiers PHP Excel et PowerPoint ainsi que les API de traitement de codes-barres" h2="Manipulez des feuilles de calcul Excel ainsi que lisez, écrivez, créez et convertissez des présentations PowerPoint et OpenOffice via l'API PHP. De plus, générez et numérisez facilement des codes-barres." logoImageSrc="/total/images/aspose_total-for-php-java-header.svg" pfName="Aspose.Total" subTitlepfName="for PHP via Java" downloadUrl="https://releases.aspose.com/total/php-java/" >}}
...
Aspose.Total pour PHP via Java est un package complet pour la manipulation de feuilles de calcul Excel ainsi que pour les présentations PowerPoint et OpenOffice. Les développeurs peuvent créer, manipuler, rendre et convertir des fichiers Excel via des applications PHP ainsi que charger, lire, écrire et exporter des formats PowerPoint, notamment PPT, PPTX, PPS, POT, PPSX, OpenOffice ODP et d'autres formats. Les développeurs peuvent facilement intégrer l'API PHP pour la reconnaissance et la génération de codes-barres.
{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for PHP via Java inclut les API suivantes :" >}}
...
Aspose.PDF for PHP via Java est une API puissante qui permet aux développeurs PHP de créer, modifier, convertir et sécuriser des documents PDF sans utiliser Adobe Acrobat. Elle prend en charge les applications 32 et 64 bits et offre des fonctionnalités avancées telles que la gestion des formulaires, l'édition des métadonnées, la manipulation de texte et de pages, les annotations, les signets, les filigranes, les pièces jointes et la gestion des polices personnalisées.
...
Aspose.Cells for PHP via Java API est conçu pour gérer et traiter des feuilles de calcul Excel. Il gère des tâches telles que la conversion des formats de feuille de calcul, la gestion et le rendu des graphiques, la mise en œuvre de formules, l'application de styles détaillés aux feuilles de calcul, et bien plus encore. Grâce à l'intégration de JavaBridge, les développeurs peuvent incorporer de manière transparente la puissance de création, d'édition, de conversion et de rendu de fichiers Excel dans leurs applications PHP.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Slides pour PHP via la bibliothèque Java permet aux développeurs de travailler et de traiter efficacement les présentations. Il propose la lecture, l'édition et la conversion de présentations PowerPoint sans recourir à des applications externes. La bibliothèque permet de charger, d'ouvrir et de visualiser des présentations, de les convertir en différents formats, de rendre et d'imprimer des présentations, de les crypter et de les décrypter, de manipuler des entités de présentation telles que des diapositives principales, des formes, des graphiques, des images audio et vidéo, des animations, etc.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.BarCode pour PHP via Java est une collection d'API de génération et de lecture de codes à barres conçues pour les applications PHP. Il offre aux développeurs la possibilité de lire différents types de codes-barres, y compris les codes-barres 1D, 2D et postaux, à partir d'images capturées sous différents angles. L'API du générateur de codes-barres permet la création d'images de codes-barres dans différents formats tels que JPG, PNG, GIF et BMP. De plus, il offre plusieurs fonctionnalités d'imagerie, telles que la manipulation des bordures, le réglage des couleurs, la rotation de l'image, la personnalisation de la résolution, etc. En utilisant l'API, les développeurs peuvent facilement intégrer la fonctionnalité de code-barres dans leurs applications PHP.
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 Fonctionnalités avancées d'Aspose.Total pour PHP via les API Java
</h2>
     <p>
   </p>
   <div class="col-lg-4">
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Protéger les présentations &amp; PDF résultant
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-print ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Créer et amp; personnaliser les graphiques
    </p>
   </div>
            <div class="col-lg-4">
                <em class='fa fa-print ico-blue fa-2x col-lg-2'>
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-parameters/'>Gérer les paramètres de code-barres</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/customize-barcodes/'>Personnaliser la taille du code-barres</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/generate-codabar/'>Générer Codabar</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-text/'>Personnaliser les légendes de texte</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/barcode-reading-presets/'>Préréglages de lecture de codes-barres</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/read-damaged-barcodes/'>Lire les codes-barres endommagés</a>
                </p>
            </div>
<div class="col-lg-12">
 <h2 class="h2title">
  Traiter une multitude de formats Excel et PowerPoint
 </h2>
 <p>
  Avec Aspose.Total pour PHP via Java, on peut développer un système de rapport de documents polyvalent capable de gérer plusieurs formats de feuilles de calcul ainsi qu'une solution pour gérer et exporter des documents PowerPoint. 
 </p>
 <p>
  Aspose.Total pour PHP via Java prend actuellement en charge les types de fichiers suivants.
 </p>
 <ul class="unstyled">
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Total pour PHP via Java ?" tabId="success-stories" >}}
