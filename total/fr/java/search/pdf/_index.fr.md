---
title: Application de recherche de texte PDF en ligne ou développement d'un logiciel de recherche PDF via Java
description: Application en ligne gratuite pour rechercher dans les fichiers PDF. Code Java pour toute application de recherche de texte de fichier PDF.
...
{{< blocks/products/pf/feature-page-header h1="Application de documents consultables en ligne et code API de recherche de texte PDF" h2="Développez un puissant moteur de recherche de documents PDF basé sur Java ou une application utilitaire. Testez gratuitement l'application de recherche de texte de documents en ligne." >}}
...
<h3>Application gratuite de recherche de contenu de documents PDF en ligne</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher dans un fichier PDF en ligne à l'aide de l'application" %}}
...
1. Cliquez sur le bouton "RECHERCHE" pour rechercher PDF.
1. Téléchargez le PDF recherché pour le visualiser instantanément.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher un fichier PDF via Java" %}}

1. Installez « Aspose.PDF pour Java ».
1. Ajoutez une référence de bibliothèque (importez la bibliothèque) à votre projet Java.
1. Ouvrez le fichier source PDF à l'aide de la classe Document.
1. Créez un objet TextFragmentAbsorber pour rechercher toutes les instances de l'entrée.
1. ou définissez les critères de recherche dans Regex.
1. Acceptez l'absorbeur de la page en utilisant getPages().accept(textFragmentAbsorber).
1. Obtenez la collection de fragments de texte extraits via textFragmentAbsorber.getTextFragments().
1. Parcourez les fragments pour obtenir le résultat.
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Java pour rechercher du texte dans des fichiers PDF" offSpacer="" %}}
...
<h2>Développer le moteur de recherche de fichiers PDF via Java</h2>

Besoin de développer un logiciel ou un utilitaire de recherche PDF ? Avec Aspose.PDF pour Java, une API enfant d'Aspose.Total pour Java, tout développeur Java peut intégrer le code API ci-dessus pour programmer la recherche de texte dans les documents. La puissante bibliothèque Java permet de programmer une solution logicielle de recherche de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque Java pour rechercher le fichier PDF" %}}

- Nous hébergeons nos packages Java en [Maven repositories](https://releases.aspose.com/java/repo/com/aspose/aspose-pdf/). 
- « Aspose.PDF for Java » est un fichier JAR courant contenant du byte-code. 
- Suivez le [step-by-step instructions](https://docs.aspose.com/pdf/java/installation/#install-aspose-pdf-for-java-from-maven-repository) pour savoir comment l'installer dans votre environnement de développement Java.
...
- Support sur IBM i (Iseries ou As/400)
...
<br /><br />
Pour plus de détails, veuillez vous référer à [Product Documentation](https://docs.aspose.com/pdf/java/system-requirements/).
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne PDF Document Search ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser des navigateurs Web populaires tels que Google Chrome, Firefox, Opera ou Safari pour les recherches de documents PDF en ligne. Si vous créez une application de bureau, nous vous suggérons d'utiliser l'API Aspose.Total Document Search pour un traitement efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
