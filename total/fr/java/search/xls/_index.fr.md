---
title: Application de recherche de texte XLS en ligne ou développement d'un logiciel de recherche XLS via Java
description: Application en ligne gratuite pour rechercher dans les fichiers XLS. Code Java pour toute application de recherche de texte de fichier XLS.
...
{{< blocks/products/pf/feature-page-header h1="Application de documents consultables en ligne et code API de recherche XLS" h2="Développez un puissant moteur de recherche de documents XLS basé sur Java ou une application utilitaire. Testez gratuitement l'application de recherche de texte de documents en ligne." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher des fichiers XLS en ligne à l'aide de l'application" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher un fichier XLS via Java" %}}

1. Installez « Aspose.Cells pour Java ».
1. Ajoutez une référence de bibliothèque (importez la bibliothèque) à votre projet Java.
1. Chargez le fichier XLS à l’aide de la classe Workbook.
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Java pour rechercher dans les fichiers XLS" offSpacer="" %}}
              ...
              <h2>FAQs</h2>
               <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser des navigateurs Web populaires tels que Google Chrome, Firefox, Opera ou Safari pour les recherches de documents XLS en ligne. Si vous créez une application de bureau, nous vous suggérons d'utiliser l'API Aspose.Total Document Search pour un traitement efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
