---
title: Application de recherche de texte ODP en ligne ou développement d'un logiciel de recherche ODP via Java
description: Application en ligne gratuite pour rechercher dans les fichiers ODP. Code Java pour toute application de recherche de texte de fichier ODP.
...
{{< blocks/products/pf/feature-page-header h1="Application de documents consultables en ligne et code API de recherche de texte ODP" h2="Développez un puissant moteur de recherche de documents ODP basé sur Java ou une application utilitaire. Testez gratuitement l'application de recherche de texte de documents en ligne." >}}
...
<h3>Application gratuite de recherche de contenu de documents ODP en ligne</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher dans un fichier ODP en ligne à l'aide de l'application" %}}

1. Téléchargez le fichier ODP pour effectuer la recherche en cliquant dans la zone de dépôt ou par glisser-déposer.
1. Saisissez les critères de recherche en précisant les paramètres. 
1. Cliquez sur le bouton "RECHERCHE" pour rechercher ODP.
1. Téléchargez le ODP recherché pour le visualiser instantanément.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Comment rechercher un fichier ODP via Java" %}}

1. Installez « Aspose.Slides pour Java ».
1. Ajoutez une référence de bibliothèque (importez la bibliothèque) à votre projet Java.
1. Chargez ODP via une instance de la classe Présentation.
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Java pour rechercher du texte dans des fichiers ODP" offSpacer="" %}}
          ...
          <div>
              <h2>FAQs</h2>
                <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne ODP Document Search ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser des navigateurs Web populaires tels que Google Chrome, Firefox, Opera ou Safari pour les recherches de documents ODP en ligne. Si vous créez une application de bureau, nous vous suggérons d'utiliser l'API Aspose.Total Document Search pour un traitement efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
