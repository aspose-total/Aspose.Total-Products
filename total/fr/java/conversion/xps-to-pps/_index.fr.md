---
title: Convertir XPS en PPS via l'API Java
description: API Java pour convertir XPS en PPS sans utiliser Microsoft Word
url_ignore: /fr/java/conversion/xps-to-pps/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java pour exporter XPS vers PPS" h2="Exportez XPS vers PPS via l'API Java sur site sans utiliser Microsoft<sup>&reg;</sup> PowerPoint ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API Java pour convertir XPS en PPS" %}}
