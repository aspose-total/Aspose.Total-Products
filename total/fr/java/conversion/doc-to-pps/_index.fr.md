---
title: Convertir DOC en PPS via Java
description: API Java pour exporter DOC vers PPS sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/doc-to-pps/
family: total
platformtag: net
feature: conversion
informat: DOC
...
Pour la conversion de fichiers DOC en PPS, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
