---
title: API Java pour exporter PS vers DOCM
description: Convertir PS en DOCM à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/ps-to-docm/
family: total
platformtag: net
feature: conversion
informat: PS
