---
title: API Java pour exporter XPS vers MARKDOWN
description: Convertir XPS en MARKDOWN à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/xps-to-markdown/
family: total
platformtag: net
feature: conversion
informat: XPS
...
Lors de la conversion de XPS en MARKDOWN, même si votre document est protégé par un mot de passe, vous pouvez toujours l'ouvrir à l'aide de l'API de manipulation PDF [Aspose.PDF for Java](https://docs.aspose.com/pdf/java/installation/). Pour ouvrir le fichier chiffré, vous devez créer un objet [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document) et ouvrir le XPS à l'aide du mot de passe du propriétaire.  
{{% blocks/products/pf/feature-page-code %}}
