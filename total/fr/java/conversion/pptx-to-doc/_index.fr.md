---
title: Convertir PPTX en DOC via Java
description: API Java pour exporter PPTX vers DOC sans utiliser Microsoft Word ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTX en DOC via Java" h2="API Java sur site pour la conversion PowerPoint PPTX en DOC dans toutes les applications Java J2SE, J2EE, J2ME" >}}
...
2. Convertissez PPTX en HTML en utilisant [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides. Méthode ISaveOptions-) et définissez Html comme SaveFormat
...
Pour la conversion de fichiers PPTX en DOC, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
