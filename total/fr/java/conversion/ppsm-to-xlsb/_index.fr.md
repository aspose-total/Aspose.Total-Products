...
description: Convertissez le format PPSM au format XLSB via Java sans utiliser Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPSM en XLSB via Java" h2="API Java sur site pour exporter PPSM vers XLSB sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
