---
title: API Java pour exporter PDF vers DOTM
description: Convertir PDF en DOTM à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/pdf-to-dotm/
family: total
platformtag: net
feature: conversion
informat: PDF
