---
title: Convertir PPS en DOTX via Java
description: API Java pour exporter PPS vers DOTX sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/pps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: PPS
...
Pour la conversion de fichiers PPS en DOTX, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
