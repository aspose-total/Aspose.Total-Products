---
title: API Java pour exporter MHTML vers DOT
description: Convertir MHTML en DOT à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/mhtml-to-dot/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
4. Enregistrez le document au format DOT à l'aide de la méthode [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) et définissez DOT en tant que format de sauvegarde
