---
title: Convertir WORD en POTX via Java
description: API Java pour exporter WORD vers POTX sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/word-to-potx/
family: total
platformtag: net
feature: conversion
informat: WORDX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir WORD en POTX via Java" h2="Conversion WORD en POTX en utilisant l'API Java sur site dans toutes les applications Java J2SE, J2EE, J2ME sans utiliser Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
...
6. Enregistrez le wordument dans POTX à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Exigences de conversion" %}}
Pour la conversion de fichiers WORD en POTX, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
...
L'API vous permet également de convertir des worduments WORD protégés par mot de passe en POTX. Si votre wordument WORD d'entrée est protégé par un mot de passe, vous ne pouvez pas le convertir au format POTX sans utiliser le mot de passe. Pour ouvrir un wordument crypté, vous pouvez définir le mot de passe correct dans l'objet LoadOptions et le transmettre au constructeur Wordument.  
{{% blocks/products/pf/feature-page-code %}}
