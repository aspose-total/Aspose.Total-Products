...
<iframe title="Application de conversion en ligne gratuite TEX vers XAML" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xaml&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Code Java pour la conversion de TEX en XAML" offSpacer="" %}}
