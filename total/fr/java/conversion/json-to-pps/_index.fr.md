---
title: Convertir le format JSON en PPS via Java
description: Analyser JSON en PPS en Java sans utiliser Microsoft PowerPoint
url_ignore: /fr/java/conversion/json-to-pps/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. Enregistrez le document au format PPS à l'aide de la méthode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en PPS via Java" %}}
