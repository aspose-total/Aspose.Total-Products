...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POTX en SXC via Java ou en ligne" h2="API Java sur site pour exporter POTX vers SXC sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
