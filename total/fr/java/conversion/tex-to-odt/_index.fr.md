---
title: API Java pour exporter TEX vers ODT
description: Convertir TEX en ODT à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/tex-to-odt/
family: total
platformtag: net
feature: conversion
informat: TEX
