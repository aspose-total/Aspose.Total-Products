...
description: Convertir WORDML en CSV via Java sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/java/conversion/wordml-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Enregistrez le wordmlument au format CSV en utilisant [Save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. Méthode SaveOptions))
