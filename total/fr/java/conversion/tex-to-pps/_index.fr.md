---
title: Convertir TEX en PPS via l'API Java
description: API Java pour convertir TEX en PPS sans utiliser Microsoft Word
url_ignore: /fr/java/conversion/tex-to-pps/
family: total
platformtag: net
feature: conversion
informat: TEX
