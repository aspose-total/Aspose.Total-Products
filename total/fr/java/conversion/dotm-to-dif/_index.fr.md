---
title: API Java pour convertir DOTM en DIF ou avec le convertisseur en ligne gratuit
description: Convertir DOTM en DIF via Java ou application en ligne sans utiliser Microsoft Word ou Microsoft Excel ou en ligne. Testez rapidement le convertisseur en ligne DOTM vers DIF gratuit avant d'intégrer le code. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir DOTM en DIF via Java ou application en ligne" h2="API Java sur site pour convertir DOTM en DIF sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API Java pour convertir DOTM en DIF" %}}
...
<h3>Convertisseur en ligne gratuit pour DOTM en DIF</h3>

<iframe title="Outil en ligne de conversion dif en dotm" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dif&from=dotm" id="child-iframe" width="80%"></iframe>
