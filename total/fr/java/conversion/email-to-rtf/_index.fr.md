---
title: Exporter EMAIL vers RTF via Java
description: API Java pour convertir EMAIL en RTF sans utiliser Microsoft Word ou Outlook
url_ignore: /fr/java/conversion/email-to-rtf/
family: total
platformtag: net
feature: conversion
informat: MSG
...
- **Base de connaissances** : Convertissez les communications de support en manuels modifiables.
- **Collaboration** : Partagez le contenu de l'e-mail dans un format universellement modifiable.
...
- **Automatisation juridique** : Stockez les communications de preuve en RTF pour annotation.
