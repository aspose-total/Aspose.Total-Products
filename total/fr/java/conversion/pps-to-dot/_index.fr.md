---
title: Convertir PPS en DOT via Java
description: API Java pour exporter PPS vers DOT sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/pps-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPS en DOT via Java" h2="API Java sur site pour la conversion PowerPoint PPS en DOT dans toutes les applications Java J2SE, J2EE, J2ME" >}}
...
Pour la conversion de fichiers PPS en DOT, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
