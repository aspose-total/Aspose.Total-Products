---
title: Convertir FODS en WORD en utilisant Java
description: API Java pour exporter FODS vers WORD en utilisant Excel ou Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java pour exporter FODS vers WORD" h2="API Java sur site pour exporter FODS vers WORD sans dépendre de Microsoft Excel®" >}}
{{% blocks/products/pf/feature-page-summary %}}
Le rendu FODS en WORD est un processus en deux étapes. Vous utiliserez d'abord l'API [Aspose.Cells for Java](https://products.aspose.com/cells/java) pour convertir le wordument FODS donné en PDF, puis en utilisant [Aspose.Pdf for Java](https ://products.aspose.com/pdf/java) API, vous pouvez facilement convertir votre wordument PDF en WORD. Les deux API font partie de la collection de bibliothèques d'automatisation de format de fichier [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/net/conversion/fods-to-wordx/" name="FODS Pour WORDX" description="" >}}
