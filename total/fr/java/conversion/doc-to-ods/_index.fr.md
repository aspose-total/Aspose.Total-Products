---
title: API Java pour convertir DOC en ODS ou avec le convertisseur en ligne gratuit
description: Convertir DOC en ODS via Java ou application en ligne sans utiliser Microsoft Word ou Microsoft Excel ou en ligne. Testez rapidement le convertisseur en ligne DOC vers ODS gratuit avant d'intégrer le code. 
url_ignore: /fr/java/conversion/doc-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOC
