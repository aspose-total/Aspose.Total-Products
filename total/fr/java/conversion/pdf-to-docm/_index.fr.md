---
title: API Java pour exporter PDF vers DOCM
description: Convertir PDF en DOCM à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/pdf-to-docm/
family: total
platformtag: net
feature: conversion
informat: PDF
