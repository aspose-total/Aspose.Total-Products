---
title: API Java pour exporter PDF vers ODT
description: Convertir PDF en ODT à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/pdf-to-odt/
family: total
platformtag: net
feature: conversion
informat: PDF
