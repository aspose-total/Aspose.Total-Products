---
title: Convertir EXCEL en DOCX en utilisant Java ou avec le convertisseur en ligne gratuit
description: API Java pour exporter EXCEL vers DOCX ou en ligne en utilisant Excel ou Word ou en ligne. Testez rapidement le convertisseur en ligne CSV vers DOC gratuit avant d'intégrer le code.
url_ignore: /fr/java/conversion/excel-to-docx/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java pour exporter EXCEL vers DOCX ou en ligne" h2="API Java sur site pour exporter EXCEL vers DOCX sans dépendre de Microsoft Excel®" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment convertir EXCEL en DOCX via l'API Java" %}}
...
<h3>Convertisseur en ligne pour EXCEL en DOCX</h3>
