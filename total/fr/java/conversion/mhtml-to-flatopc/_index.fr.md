---
title: API Java pour exporter MHTML vers FLATOPC
description: Convertir MHTML en FLATOPC à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/mhtml-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
Lors de la conversion de MHTML en FLATOPC, même si votre document est protégé par un mot de passe, vous pouvez toujours l'ouvrir à l'aide de l'API de manipulation PDF [Aspose.PDF for Java](https://docs.aspose.com/pdf/java/installation/). Pour ouvrir le fichier chiffré, vous devez créer un objet [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) et ouvrir le MHTML à l'aide du mot de passe du propriétaire.  
{{% blocks/products/pf/feature-page-code %}}
