---
title: Convertir HTML en WMF via Java
description: Exportez le fichier HTML vers WMF dans vos applications Java sans utiliser d'application tierce
url_ignore: /fr/java/conversion/html-to-wmf/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Convertir et faire pivoter HTML en fichier WMF via Java" %}}
