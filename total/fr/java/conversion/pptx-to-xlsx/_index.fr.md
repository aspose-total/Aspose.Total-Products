---
title: Convertir PPTX au format XLSX via Java ou avec le convertisseur en ligne gratuit
description: Convertissez le format PPTX au format XLSX via Java sans utiliser Microsoft Excel ou PowerPoint ou en ligne. Testez rapidement le convertisseur en ligne PPTX vers XLSX gratuit avant d'intégrer le code. 
url_ignore: /fr/java/conversion/pptx-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTX en XLSX via Java ou application en ligne" h2="API Java sur site pour exporter PPTX vers XLSX sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">La vitesse de ce convertisseur en ligne dépend en grande partie de la taille du fichier PPTX. Si le fichier PPTX est de petite taille, la conversion en XLSX peut être effectuée en quelques secondes. De plus, si vous avez intégré le code de conversion dans une application Java, la vitesse du processus de conversion dépendra de la façon dont vous avez optimisé votre application à cette fin.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
