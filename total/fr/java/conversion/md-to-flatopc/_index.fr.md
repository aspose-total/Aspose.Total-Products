---
title: API Java pour exporter MD vers FLATOPC
description: Convertir MD en FLATOPC à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/md-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: MD
