...
description: Convertissez le format POWERPOINT au format XLTX via Java sans utiliser Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir POWERPOINT en XLTX via Java" h2="API Java sur site pour exporter POWERPOINT vers XLTX sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
2. Convertissez POWERPOINT en HTML en utilisant [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides. Méthode ISaveOptions-)
...
4. Enregistrez le document au format XLTX en utilisant [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. Méthode SaveOptions))
