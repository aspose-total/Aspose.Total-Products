...
url_ignore: /fr/java/conversion/cgm-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: CGM
...
- **Générateurs de fichiers de présentation basés sur Java** - Créer des fichiers PPSX directement à partir des sources CGM.
