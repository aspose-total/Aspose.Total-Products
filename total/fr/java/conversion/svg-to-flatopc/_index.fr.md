---
title: API Java pour exporter SVG vers FLATOPC
description: Convertir SVG en FLATOPC à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/svg-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: SVG
