---
title: Convertir DOCX en PPS via Java
description: API Java pour exporter DOCX vers PPS sans utiliser Microsoft Word ou PowerPoint
url: /fr/java/conversion/docx-to-pps/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir DOCX en PPS via Java" h2="Conversion DOCX en PPS en utilisant l'API Java sur site dans toutes les applications Java J2SE, J2EE, J2ME sans utiliser Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
...
Pour la conversion de fichiers DOCX en PPS, vous pouvez facilement utiliser Aspose.Total pour Java directement à partir d'un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) et incluez des bibliothèques dans votre fichier pom.xml.
