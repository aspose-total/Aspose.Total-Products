---
title: API Java pour rendre MHTML en XLT
description: Exportez MHTML vers XLT via l'API Java sans utiliser Microsoft Excel ou Adobe Reader
url_ignore: /fr/java/conversion/mhtml-to-xlt/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Exporter MHTML vers XLT via Java" h2="Convertissez le fichier MHTML en XLT en utilisant l'API Java sur site dans toutes les applications Java J2SE, J2EE, J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le fichier MHTML en XLT via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir MHTML protégé en XLT via Java" %}}
