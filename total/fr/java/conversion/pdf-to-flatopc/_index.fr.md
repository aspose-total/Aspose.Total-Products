---
title: API Java pour exporter PDF vers FLATOPC
description: Convertir PDF en FLATOPC à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/pdf-to-flatopc/
family: total
platformtag: net
feature: conversion
informat: PDF
