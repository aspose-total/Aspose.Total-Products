---
title: Convertir PPTM au format FODS via Java
description: Convertissez le format PPTM au format FODS via Java sans utiliser Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPTM en FODS via Java" h2="API Java sur site pour exporter PPTM vers FODS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
