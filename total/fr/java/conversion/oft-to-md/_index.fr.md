---
title: Exporter OFT vers MD via Java
description: API Java pour convertir OFT en MD sans utiliser Microsoft Word ou Outlook
url_ignore: /fr/java/conversion/oft-to-md/
family: total
platformtag: net
feature: conversion
informat: OFT
