---
title: API Java pour exporter TEX vers XAMLFLOW
description: Convertir TEX en XAMLFLOW à l'aide de l'API Java sur site
url: /fr/java/conversion/tex-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Transformez TEX en XAMLFLOW via Java" h2="API Java sur site pour rendre TEX en XAMLFLOW sans utiliser d'application tierce" >}}
{{% blocks/products/pf/feature-page-summary %}}
Vous pouvez convertir TEX en XAMLFLOW en utilisant deux étapes simples. Vous devez d'abord rendre le fichier TEX au format DOC à l'aide de [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Après cela, en utilisant la puissante API de traitement de documents [Aspose.Words pour Java](https://products.aspose.com/words/java/), vous pouvez convertir DOC en XAMLFLOW. Les deux API font partie du package [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API Java pour convertir TEX en XAMLFLOW" %}}
