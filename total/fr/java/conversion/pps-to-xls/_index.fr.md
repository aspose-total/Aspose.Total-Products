---
title: Convertir PPS au format XLS via Java ou avec le convertisseur en ligne gratuit
description: Convertissez le format PPS au format XLS via Java sans utiliser Microsoft Excel ou PowerPoint ou en ligne. Testez rapidement le convertisseur en ligne PPS vers XLS gratuit avant d'intégrer le code. 
url_ignore: /fr/java/conversion/pps-to-xls/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir PPS en XLS via Java ou application en ligne" h2="API Java sur site pour exporter PPS vers XLS sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
<h3>Convertisseur en ligne gratuit pour PPS en XLS</h3>

<iframe title="Outil en ligne de conversion xls en pps" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=xls&from=pps" id="child-iframe" width="80%"></iframe>
