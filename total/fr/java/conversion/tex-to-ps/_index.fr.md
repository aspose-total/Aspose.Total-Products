---
title: API Java pour exporter TEX vers PS
description: Convertir TEX en PS à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/tex-to-ps/
family: total
platformtag: net
feature: conversion
informat: TEX
