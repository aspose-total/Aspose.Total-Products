---
title: API Java pour exporter PDF vers MHTML
description: Convertir PDF en MHTML à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/pdf-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PDF
...
4. Enregistrez le document au format MHTML à l'aide de la méthode [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) et définissez MHTML en tant que format de sauvegarde
