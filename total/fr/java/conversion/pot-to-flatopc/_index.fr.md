...
3. Chargez le fichier HTML converti à l'aide de la classe [Flatopcument](https://apireference.aspose.com/words/java/com.aspose.words/Flatopcument)
4. Enregistrez le flatopcument au format FLATOPC à l'aide de la méthode [save](https://apireference.aspose.com/words/java/com.aspose.words/Flatopcument#save(java.lang.String,int))
