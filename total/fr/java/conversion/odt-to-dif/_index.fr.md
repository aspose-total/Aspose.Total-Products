...
description: Convertir ODT en DIF via Java sans utiliser Microsoft Word ou Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convertir ODT en DIF via Java" h2="API Java sur site pour convertir ODT en DIF sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le odtument au format DIF en utilisant [Save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. Méthode SaveOptions))
