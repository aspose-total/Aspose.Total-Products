---
title: API Java pour exporter SVG vers DOCM
description: Convertir SVG en DOCM à l'aide de l'API Java sur site
url_ignore: /fr/java/conversion/svg-to-docm/
family: total
platformtag: net
feature: conversion
informat: SVG
