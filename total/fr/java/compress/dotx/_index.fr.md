---
title: Compresser les fichiers DOTX en ligne ou via Java
description: Application en ligne gratuite pour compresser différents fichiers DOTX. Code de bibliothèque de compression Java pour les documents DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compresser le fichier DOTX en ligne via l'application de compression ou en utilisant Java" h2="Développez de puissantes applications de compression de documents DOTX basées sur Java.Compressez librement divers documents, y compris les fichiers DOTX, en ligne via une application avec téléchargement instantané." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser le fichier DOTX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Java pour compresser des fichiers DOTX" offSpacer="" %}}
...
<h2>Développer une application de compression de fichiers DOTX à l'aide de Java</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de compression Java pour les fichiers DOTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour compresser le fichier DOTX en utilisant Java. Utilisez l'API de compression Aspose DOTX pour développer des logiciels de haut niveau indépendants de la plate-forme en Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
