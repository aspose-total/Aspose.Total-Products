---
title: Reconnaître les images de codes-barres SWISSPOSTPARCEL via Python
description: Numérisez des images de codes-barres de symbologie SWISSPOSTPARCEL à l'aide d'applications Python sans utiliser d'autres logiciels. 
...
- Pour la lecture de codes-barres SWISSPOSTPARCEL, Python 3.5 ou version ultérieure est requis
...
{{% blocks/products/pf/agp/code-block title="Reconnaître le code-barres de la symbologie SWISSPOSTPARCEL en Python" offSpacer="" %}}
