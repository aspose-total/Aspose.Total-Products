---
title: Reconnaître les images de codes-barres DOTCODE via Python
description: Numérisez des images de codes-barres de symbologie DOTCODE à l'aide d'applications Python sans utiliser d'autres logiciels. 
...
- Pour la lecture de codes-barres DOTCODE, Python 3.5 ou version ultérieure est requis
...
{{% blocks/products/pf/agp/code-block title="Reconnaître le code-barres de la symbologie DOTCODE en Python" offSpacer="" %}}
