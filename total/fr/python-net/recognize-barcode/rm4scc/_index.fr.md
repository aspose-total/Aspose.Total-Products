---
title: Reconnaître les images de codes-barres RM4SCC via Python
description: Numérisez des images de codes-barres de symbologie RM4SCC à l'aide d'applications Python sans utiliser d'autres logiciels. 
...
- Pour la lecture de codes-barres RM4SCC, Python 3.5 ou version ultérieure est requis
...
{{% blocks/products/pf/agp/code-block title="Reconnaître le code-barres de la symbologie RM4SCC en Python" offSpacer="" %}}
