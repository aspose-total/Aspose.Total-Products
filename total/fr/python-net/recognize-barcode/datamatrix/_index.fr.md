---
title: Reconnaître les images de codes-barres DATAMATRIX via Python
description: Numérisez des images de codes-barres de symbologie DATAMATRIX à l'aide d'applications Python sans utiliser d'autres logiciels. 
...
- Pour la lecture de codes-barres DATAMATRIX, Python 3.5 ou version ultérieure est requis
...
{{% blocks/products/pf/agp/code-block title="Reconnaître le code-barres de la symbologie DATAMATRIX en Python" offSpacer="" %}}
