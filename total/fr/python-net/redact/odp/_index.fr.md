---
title: Rédiger la présentation ODP en ligne ou en utilisant Python
description: Ouvrez et rédigez gratuitement le document ODP en ligne via l'application. Code API Python pour rechercher et remplacer le texte ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Rédiger le document ODP en ligne ou via Python" h2="Développez une puissante application utilitaire de rédaction de présentations ODP basée sur Python.Code répertorié pour rechercher et remplacer du texte dans le fichier ODP via Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Rédiger le fichier ODP via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Code Python : Rédiger la présentation ODP" offSpacer="" %}}
...
<h2>Développer une application de rédaction ODP via Python</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour rédiger le fichier ODP" %}}
