---
title: Compression de fichiers ODS en ligne ou création d'applications Python pour archiver des fichiers ODS
description: Application en ligne gratuite pour compresser différents fichiers ODS. Code de bibliothèque d'archivage Python pour les documents ODS.
...
{{< blocks/products/pf/feature-page-header h1="Application de compression de documents en ligne et code Python pour archiver les fichiers ODS" h2="Développez de puissantes applications d’archivage de documents ODS basées sur Python.Archivez un ou plusieurs documents ODS au format ZIP, RAR et d'autres options d'archivage via votre application Python.Compressez librement divers documents, y compris les fichiers ODS, en ligne via une application avec téléchargement instantané." >}}
...
<h3>Application gratuite de compression de documents ODS en ligne</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Compresser et optimiser les fichiers ODS en ligne à l'aide de l'application" %}}

1. Téléchargez des fichiers ODS pour les compresser et les optimiser.
1. Choisissez le niveau de compression (faible, moyen ou élevé)
1. Cliquez sur le bouton "Compresser".
1. Téléchargez le fichier ODS compressé.
1. Visualisez et obtenez le résultat de la compression en vérifiant sa taille et la qualité du contenu.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Archiver le fichier ODS via l'API de compression Python" %}}
...
1. Ajoutez autant de fichiers ODS que vous souhaitez archiver en utilisant create_entry().
1. Appelez la méthode de sauvegarde et récupérez le fichier ODS archivé au format ZIP, RAR, etc.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Exemple de code en python pour archiver le fichier ODS" offSpacer="" %}}

{{< gist "aspose-com-gists" "533b68e0904932a37c25a576bd20448d" "compress-and-add-single-file-into-archive.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Code Python pour archiver plusieurs fichiers ODS" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour archiver le fichier ODS en utilisant Python.Utilisez l'API de compression Aspose ODS pour développer des logiciels de haut niveau indépendants de la plate-forme en Python.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour compresser plusieurs documents ODS ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour la compression de documents ODS en ligne.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Comment puis-je compresser plusieurs fichiers ODS ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Commencez par télécharger un ou plusieurs fichiers que vous souhaitez compresser. Vous pouvez soit glisser-déposer vos fichiers ODS, soit simplement cliquer dans la zone blanche.Ensuite, cliquez sur le bouton « Compresser » et notre application de compression en ligne traitera rapidement les fichiers téléchargés.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Combien de temps faut-il pour compresser les fichiers ODS ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
