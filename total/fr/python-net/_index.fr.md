---
title: Python via les API de traitement du format de fichier .NET - Aspose 

url_ignore: /python-net/ 
description: API Python pour les documents Microsoft Word, les présentations PowerPoint et les formats de courrier électronique Outlook à partir des applications Python.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Python pour automatiser les fichiers Microsoft Word, PowerPoint, Outlook et 3D" h2="Créez, modifiez ou convertissez des documents, des présentations, des e-mails et des fichiers 3D et CAO à l'aide de Python" logoImageSrc="/total/images/aspose_total-for-python-net-header.svg" pfName="Aspose.Total" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/total/python-net/" >}}
...
{{< blocks/products/pf/total/product-item href="/words/fr/python-net/" imgSrc="/total/images/aspose_words-for-python-net.svg" productName="Aspose.Words for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/cells/fr/python-net/" imgSrc="/total/images/aspose_cells-for-python-net.svg" productName="Aspose.Cells for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/email/fr/python-net/" imgSrc="/total/images/aspose_email-for-python-net.svg" productName="Aspose.Email for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/slides/fr/python-net/" imgSrc="/total/images/aspose_slides-for-python-net.svg" productName="Aspose.Slides for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/imaging/fr/python-net/" imgSrc="/total/images/aspose_imaging-for-python-net.svg" productName="Aspose.Imaging for Python via .NET">}}
Bibliothèque d'images Python qui fournit des fonctionnalités avancées de traitement d'image telles que le filtrage, le tramage, le masquage, le redressement ainsi que des fonctionnalités de base telles que la création, le chargement, la manipulation ou la conversion d'images sans nécessiter d'éditeur d'image.
{{< /blocks/products/pf/total/product-item >}}

{{< blocks/products/pf/total/product-item href="/barcode/fr/python-net/" imgSrc="/total/images/aspose_barcode-for-python-net.svg" productName="Aspose.BarCode for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/diagram/fr/python-net/" imgSrc="/total/images/aspose_diagram-for-python-net.svg" productName="Aspose.Diagram for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/tasks/fr/python-net/" imgSrc="/total/images/aspose_tasks-for-python-net.svg" productName="Aspose.Tasks for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/3d/fr/python-net/" imgSrc="/total/images/aspose_3d-for-python-net.svg" productName="Aspose.3D for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/finance/fr/python-net/" imgSrc="/total/images/aspose_finance-for-python-net.svg" productName="Aspose.Finance for Python via .NET">}}
...
{{< blocks/products/pf/total/product-item href="/html/fr/python-net/" imgSrc="/total/images/aspose_html-for-python-net.svg" productName="Aspose.HTML for Python via .NET">}}

Aspose.HTML for Python via .NET - API de traitement HTML, permettant la création, la modification, la conversion et le rendu de documents HTML sur plusieurs plates-formes sans logiciel externe. Il prend en charge des formats tels que EPUB, SVG et Markdown, et intègre des fonctionnalités avancées telles que CSS, HTML Canvas et JavaScript pour une manipulation et un rendu de haute qualité dans les applications Python.

{{< /blocks/products/pf/total/product-item >}}

{{< blocks/products/pf/total/product-item href="/page/fr/python-net/" imgSrc="/total/images/aspose_page-for-python-net.svg" productName="Aspose.Page for Python via .NET">}}

Aspose.Page for Python via .NET est une API robuste pour la création, l'édition et la conversion de fichiers EPS, PS, XPS et OXPS, offrant une solution fiable pour le rendu et la manipulation sans logiciel supplémentaire. Il permet une conversion transparente des fichiers PS et EPS aux formats PDF ou image raster et prend en charge la gestion efficace des documents XPS nouveaux et existants.

{{< /blocks/products/pf/total/product-item >}}

{{< blocks/products/pf/total/product-item href="/psd/fr/python-net/" imgSrc="/total/images/aspose_psd-for-python-net.svg" productName="Aspose.PSD for Python via .NET">}}

Aspose.PSD for Python via .NET est une API puissante pour créer, lire, éditer et convertir des fichiers PSD, PSB et AI sans avoir recours à Adobe Photoshop ou Illustrator. Il prend en charge des fonctionnalités avancées telles que les mises à jour de calques de texte et de forme, les objets intelligents, les modes de fusion, les effets de calque, les animations et la gestion des masques vectoriels ou raster, permettant une manipulation et une compression transparentes des images PSD et PSB.

{{< /blocks/products/pf/total/product-item >}}

{{< blocks/products/pf/total/product-item href="/svg/fr/python-net/" imgSrc="/total/images/aspose_svg-for-python-net.svg" productName="Aspose.SVG for Python via .NET">}}

Aspose.SVG for Python via .NET est une API complète pour créer, analyser, restituer et convertir des fichiers SVG dans des formats courants tels que PDF, PNG, JPEG et GIF sans avoir recours à des outils supplémentaires. Cette puissante bibliothèque prend en charge des fonctionnalités avancées telles que la modification du contenu SVG, les effets de filtre et la vectorisation, ce qui la rend idéale pour développer des applications de haut niveau telles que des éditeurs, des convertisseurs et des vectoriseurs SVG.

{{< /blocks/products/pf/total/product-item >}}

{{< blocks/products/pf/total/product-item href="/tex/fr/python-net/" imgSrc="/total/images/aspose_tex-for-python-net.svg" productName="Aspose.TEX for Python via .NET">}}

Aspose.TeX for Python via .NET est une API polyvalente pour la manipulation et la conversion de fichiers TeX et LaTeX, prenant en charge des formats de sortie tels que PDF, PNG, JPEG, SVG, etc. Avec des fonctionnalités telles que le rendu de fragments LaTeX, la création de formats TeX personnalisés et une syntaxe intuitive, cette bibliothèque est idéale pour intégrer les fonctionnalités TeX et LaTeX dans les applications Python, des logiciels de bureau aux services Web.
...
<h2 class="pr-ft">
 ...
 Fonctionnalités d'Aspose.Total pour Python via les API .NET
</h2>
<div class="col-lg-4">
 <em class="fa fa-recycle ico-blue fa-2x col-lg-2">
 </em>
 <p class="col-lg-10">
  Rendu en PDF et images avec la plus haute fidélité
 </p>
</div>
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Comparer des documents pour le texte ou le style
 </p>
</div>
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Protégez ou cryptez des documents et des présentations
 </p>
</div>
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Publipostage et création de rapports à l'aide de Python
 </p>
</div>
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Gestion des pièces jointes TNEF à l'aide de Python
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Créer ou manipuler des fichiers 3D et CAO
 </p>
</div>

<div class="col-lg-12">
 <h2 class="h2title">
  Traiter toutes les catégories de fichiers populaires
 </h2>
 <p>
  Aspose.Total pour Python via .NET peut gérer une multitude de formats de fichiers. 
 </p>
 <ul class="unstyled">
  ...
  <li>
   <b>Disposition fixe :</b> PDF, PDF/A, XPS, OpenXPS, PostScript (PS)
  </li>
  <li>
...
{{< blocks/products/pf/slr-tab tabTitle="Pourquoi Aspose.Total pour Python via .NET ?" tabId="success-stories" >}}
