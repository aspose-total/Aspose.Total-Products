---
title: Effacer les annotations OTT en ligne et en utilisant Python
description: Supprimez gratuitement les commentaires du document OTT via l'application en ligne.Code API Python pour supprimer les commentaires des fichiers OTT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Supprimer les commentaires du document OTT en ligne ou via Python" h2="Développez une puissante application utilitaire d’annotation de documents OTT basée sur Python. Code répertorié pour effacer les commentaires du fichier OTT via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Effacer les annotations OTT en ligne" %}}

1. Importez le fichier OTT pour effacer les commentaires en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires du document OTT via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour supprimer les commentaires du document OTT" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents OTT via Python</h2>

Besoin de développer une application ou un utilitaire d'annotation OTT ?Avec [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format OTT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour annoter les fichiers OTT" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour annoter un document OTT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'annotation de documents OTT en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
