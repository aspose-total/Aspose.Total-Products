---
title: Effacer les annotations ODT en ligne et en utilisant Python
description: Supprimez gratuitement les commentaires du document ODT via l'application en ligne.Code API Python pour supprimer les commentaires des fichiers ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Supprimer les commentaires du document ODT en ligne ou via Python" h2="Développez une puissante application utilitaire d’annotation de documents ODT basée sur Python. Code répertorié pour effacer les commentaires du fichier ODT via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Effacer les annotations ODT en ligne" %}}

1. Importez le fichier ODT pour effacer les commentaires en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires du document ODT via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour supprimer les commentaires du document ODT" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents ODT via Python</h2>

Besoin de développer une application ou un utilitaire d'annotation ODT ?Avec [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour annoter les fichiers ODT" %}}
