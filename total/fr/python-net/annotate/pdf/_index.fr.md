---
title: Effacer les annotations PDF en ligne et en utilisant Python
description: Supprimez gratuitement les commentaires des documents PDF via l'application en ligne. Code API Python pour supprimer les commentaires du fichier PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Supprimer les commentaires du document PDF en ligne ou via Python" h2="Développez une puissante application utilitaire d’annotation de documents PDF basée sur Python.Code répertorié pour effacer les commentaires du fichier PDF via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Effacer les annotations PDF en ligne" %}}

1. Importez le fichier PDF pour effacer les commentaires en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires du document PDF via Python" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.PDF](https://pypi.org/project/aspose-pdf/))
1. Créer un objet de classe Document et charger le fichier en l'utilisant
1. Charger toutes les annotations dans un tableau
1. Parcourez le tableau et appelez annotations.delete
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour supprimer les commentaires du document PDF" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents PDF via Python</h2>

Besoin de développer une application ou un utilitaire d'annotation PDF ?Avec [Aspose.PDF for Python via .NET](https://products.aspose.com/pdf/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour annoter les fichiers PDF" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour annoter un document PDF ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
