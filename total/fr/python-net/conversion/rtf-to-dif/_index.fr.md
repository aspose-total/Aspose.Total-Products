---
title: Convertir RTF en DIF en utilisant Python
description: Conversion RTF en DIF dans vos applications Python sans utiliser Microsoft Word ou Excel 
...
{{< blocks/products/pf/feature-page-header h1="Convertir RTF en DIF via Python" h2="Conversion RTF en DIF dans vos applications Python sans installer Microsoft Word<sup>&reg;</sup> ou Excel" >}}
