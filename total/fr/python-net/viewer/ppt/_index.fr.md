---
title: Afficher le fichier PPT en ligne et charger ou ouvrir le fichier PPT à l'aide de Python
description: Application gratuite de visualisation de fichiers PPT en ligne. Code API Python pour charger et ouvrir le fichier PPT pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier PPT en ligne et ouvrez ou chargez un document via Python" h2="Développez une puissante application utilitaire de visualisation de documents PPT basée sur Python.Code répertorié pour charger ou ouvrir le document PPT via Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Charger ou ouvrir le fichier PPT via Python pour l'application Viewer" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Créez un objet de classe Présentation et chargez le fichier source PPT en l'utilisant.
...
1. Et utilisez subprocess.run pour appeler le navigateur afin d'afficher le fichier PPT.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour afficher les fichiers PPT" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers PPT via Python</h2>

Besoin de développer une application ou un utilitaire de visualisation PPT ?Avec [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier PPT pour l'application d'affichage" %}}
