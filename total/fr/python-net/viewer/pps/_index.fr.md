---
title: Afficher le fichier PPS en ligne et charger ou ouvrir le fichier PPS à l'aide de Python
description: Application gratuite de visualisation de fichiers PPS en ligne. Code API Python pour charger et ouvrir le fichier PPS pour l'application de visualisation.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualisez librement le fichier PPS en ligne et ouvrez ou chargez un document via Python" h2="Développez une puissante application utilitaire de visualisation de documents PPS basée sur Python.Code répertorié pour charger ou ouvrir le document PPS via Python." >}}




{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Afficher le document PPS via l'application en ligne" %}}

1. Importez le fichier PPS pour le visualiser en le téléchargeant.
...
1. Naviguez entre les pages dans le cas d’un document PPS multi-pages.
1. Définissez le zoom avant ou arrière de l'affichage de la page.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Charger ou ouvrir le fichier PPS via Python pour l'application Viewer" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Créez un objet de classe Présentation et chargez le fichier source PPS en l'utilisant.
...
1. Et utilisez subprocess.run pour appeler le navigateur afin d'afficher le fichier PPS.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour afficher les fichiers PPS" offSpacer="" %}}
...
<h2>Développer une application de visualisation de fichiers PPS via Python</h2>

Besoin de développer une application ou un utilitaire de visualisation PPS ?Avec [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application de visualisation de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'affichage de documents pouvant prendre en charge de nombreux formats populaires, notamment le format PPS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier PPS pour l'application d'affichage" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour visualiser le document PPS ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
