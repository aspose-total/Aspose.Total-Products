---
title: Protégez le document POWERPOINT avec un mot de passe en ligne et en utilisant Python
description: Application de mot de passe de fichier POWERPOINT en ligne. Code API Python pour appliquer la protection par mot de passe sur le document POWERPOINT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protection des documents POWERPOINT en ligne ou définition d'un mot de passe via Python" h2="Développez une puissante application utilitaire de protection de documents POWERPOINT basée sur Python.Code répertorié pour appliquer le mot de passe au document POWERPOINT via Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protection par mot de passe POWERPOINT via Python" %}}
...
1. Utilisez la méthode de cryptage en passant le mot de passe en paramètre
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour définir le mot de passe d'un document POWERPOINT" offSpacer="" %}}
...
<h2>Développer une application de protection par mot de passe POWERPOINT via Python</h2>

Besoin de développer une application ou un utilitaire de protection par mot de passe POWERPOINT ?Avec [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application de protection de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution de protection par mot de passe de document pour sécuriser et verrouiller les présentations.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format POWERPOINT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier POWERPOINT pour protéger l'application" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour sécuriser le document POWERPOINT ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour le protecteur de documents POWERPOINT en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
