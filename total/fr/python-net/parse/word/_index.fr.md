---
title: Extraire le texte et les images du fichier WORD en ligne et à l'aide de Python
description: Application d'analyse de fichiers WORD en ligne. Code API Python pour extraire des images et du texte d'un document WORD.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier WORD en ligne et extraire du texte ou des images via Python" h2="Développez une puissante application utilitaire d’analyse de documents WORD basée sur Python.Code répertorié pour les images de documents WORD et l'extraction de texte via Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire le texte du fichier WORD via Python" %}}
...
1. Créer un document WORD distinct pour le texte extrait
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire le texte d'un document WORD" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire des images d'un fichier WORD via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire des images de documents WORD" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers WORD via Python</h2>

Besoin de développer une application ou un utilitaire d'analyseur WORD ?Avec [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format WORD.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier WORD pour l'application d'analyseur" %}}
