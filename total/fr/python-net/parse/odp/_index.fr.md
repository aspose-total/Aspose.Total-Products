---
title: Extraire le texte et les images du fichier ODP en ligne et à l'aide de Python
description: Application d'analyse de fichiers ODP en ligne. Code API Python pour extraire des images et du texte d'un document ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier ODP en ligne et extraire du texte ou des images via Python" h2="Développez une puissante application utilitaire d’analyse de documents ODP basée sur Python.Code répertorié pour les images ODP et l'extraction de texte via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document ODP via une application en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire le texte du fichier ODP via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire du texte ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire des images de ODP via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire des images ODP" offSpacer="" %}}
