---
title: Extraire le texte et les images du fichier PPT en ligne et à l'aide de Python
description: Application d'analyse de fichiers PPT en ligne. Code API Python pour extraire des images et du texte d'un document PPT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier PPT en ligne et extraire du texte ou des images via Python" h2="Développez une puissante application utilitaire d’analyse de documents PPT basée sur Python.Code répertorié pour les images PPT et l'extraction de texte via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document PPT via une application en ligne" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire le texte du fichier PPT via Python" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Pour tous les types de texte dans la présentation, utilisez PresentationFactory().get_presentation_text(string, TextExtractionArrangingMode)
1. Charger la présentation dans un objet de classe Présentation
1. Parcourez toutes les diapositives de la présentation
1. Extraire le texte de chaque diapositive à l'aide du tableau slides_text
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire du texte PPT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extraire des images de PPT via Python" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Accéder à la présentation à l'aide de Présentation
1. Parcourez chaque diapositive
1. Obtenez la photo du dos
1. Définissez le format souhaité si la photo arrière est disponible
1. Parcourez toutes les formes de diapositives et enregistrez
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour extraire des images PPT" offSpacer="" %}}
...
Besoin de développer une application ou un utilitaire d'analyseur PPT ?Avec [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), une API enfant de [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier PPT pour l'application d'analyseur" %}}
