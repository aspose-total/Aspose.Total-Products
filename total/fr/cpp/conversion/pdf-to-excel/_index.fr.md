---
title: API C++ pour convertir PDF en EXCEL
description: Convertissez PDF en EXCEL via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PDF
