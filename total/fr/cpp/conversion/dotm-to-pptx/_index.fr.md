...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en PPTX ou application en ligne" h2="Exportez DOTM vers PPTX dans vos applications C++ sans utiliser Microsoft Word® ou PowerPoint" >}}
