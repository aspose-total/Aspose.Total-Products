---
title: Convertir DOTM en XLS en C++
description: API C++ pour convertir DOTM en XLS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en XLS" h2="Exportez DOTM vers XLS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
