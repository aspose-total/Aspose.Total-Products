---
title: Convertir le format JSON en EPUB via C++
description: API C++ pour analyser JSON vers EPUB sans utiliser Microsoft Word
url: /fr/cpp/conversion/json-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
4. Enregistrez le document au format EPUB à l'aide de la méthode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat)
...
{{% blocks/products/pf/feature-page-section  h2="Définir la mise en page et convertir le format JSON en EPUB en C++" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en EPUB avec filigrane en C++" %}}
...
appelez la méthode SetText et passez le texte et l'objet du filigrane de TextWatermarkOptions. Après avoir ajouté le filigrane, vous pouvez enregistrer le document sur EPUB.
{{% blocks/products/pf/feature-page-code %}}
