---
title: Convertir RTF en TSV en C++
description: API C++ pour convertir RTF en TSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en TSV" h2="Exportez RTF vers TSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
