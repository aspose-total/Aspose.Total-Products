---
title: API C++ pour convertir POT en DOTM
description: Exportez POT vers DOTM dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POT en DOTM" h2="Exportez POT vers DOTM dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
