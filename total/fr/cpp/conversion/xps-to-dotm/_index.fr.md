...
description: Convertissez XPS en DOTM dans les applications C++.
url: /fr/cpp/conversion/xps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter XPS vers DOTM" h2="Rendre XPS en DOTM dans les applications C++ sans nécessiter d'application tierce" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour rendre XPS en DOTM" %}}
