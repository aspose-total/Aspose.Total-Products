---
title: Exporter EML vers ODT via C++
description: API C++ pour convertir EML en ODT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers ODT" h2="Transformez EML en ODT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
