---
title: Convertir DOCM en PPTM via C++ ou avec le convertisseur en ligne gratuit
description: Exportez DOCM vers PPTM dans vos applications C++ sans utiliser Microsoft Word ou PowerPoint ou en ligne. Testez rapidement le convertisseur en ligne DOCM vers PPTM gratuit avant d'intégrer le code.
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOCM en PPTM ou application en ligne" h2="Exportez DOCM vers PPTM dans vos applications C++ sans utiliser Microsoft Word® ou PowerPoint" >}}
...
6. Enregistrez le docmument au format PPTM à l'aide de la méthode [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) et définissez Pptm comme SaveFormat
