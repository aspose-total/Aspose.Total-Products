---
title: Convertir XLS en POWERPOINT avec C++
description: Convertir XLS en POWERPOINT dans les applications C++
url: /fr/cpp/conversion/xls-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Convertir XLS en POWERPOINT via C++" h2="Exporter Excel® XLS vers POWERPOINT dans des applications C++ entièrement fonctionnelles" >}}
