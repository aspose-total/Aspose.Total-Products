---
title: Exporter EMAIL vers GIF via C++
description: API C++ pour convertir EMAIL en GIF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-gif/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers GIF" h2="Transformez EMAIL en GIF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
