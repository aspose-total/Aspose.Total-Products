---
title: API C++ pour convertir PDF en TSV
description: Convertissez PDF en TSV via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PDF
