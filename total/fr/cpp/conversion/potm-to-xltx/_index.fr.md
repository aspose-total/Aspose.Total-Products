...
description: Exporter POTM vers XLTX en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/potm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Convertir POTM en XLTX via C++" h2="Conversion de fichiers POTM en XLTX via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
