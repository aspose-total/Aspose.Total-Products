---
title: Convertir XLS en WORD avec C++
description: Convertir XLS en WORD dans les applications C++
url: /fr/cpp/conversion/xls-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Convertir XLS en WORD via C++" h2="Exporter Excel® XLS vers WORD dans des applications C++ entièrement fonctionnelles" >}}
