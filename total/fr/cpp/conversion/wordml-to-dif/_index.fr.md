---
title: Convertir WORDML en DIF en C++
description: API C++ pour convertir WORDML en DIF sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORDML en DIF" h2="Exportez WORDML vers DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir WORDML en DIF" %}}
