---
title: Exporter MSG vers EPUB via C++
description: API C++ pour convertir MSG en EPUB sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers EPUB" h2="Transformez MSG en EPUB dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
