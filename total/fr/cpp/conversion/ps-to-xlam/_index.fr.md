---
title: API C++ pour convertir PS en XLAM
description: Convertissez PS en XLAM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PS
