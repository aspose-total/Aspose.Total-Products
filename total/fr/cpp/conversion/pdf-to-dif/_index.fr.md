---
title: API C++ pour convertir PDF en DIF
description: Convertissez PDF en DIF via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PDF
