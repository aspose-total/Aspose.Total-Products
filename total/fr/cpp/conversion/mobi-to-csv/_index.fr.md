---
title: Convertir MOBI en CSV en C++
description: API C++ pour convertir MOBI en CSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/mobi-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir MOBI en CSV" h2="Exportez MOBI vers CSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
