---
title: Convertir WORD en TSV en C++
description: API C++ pour convertir WORD en TSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en TSV" h2="Exportez WORD vers TSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
