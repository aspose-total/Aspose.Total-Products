---
title: API C++ pour convertir POWERPOINT en RTF
description: Exportez POWERPOINT vers RTF dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POWERPOINT en RTF" h2="Exportez POWERPOINT vers RTF dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
