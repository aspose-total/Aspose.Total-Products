---
title: Exporter EML vers EMF via C++
description: API C++ pour convertir EML en EMF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers EMF" h2="Transformez EML en EMF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
