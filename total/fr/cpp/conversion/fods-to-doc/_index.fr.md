---
title: Convertir FODS en DOC avec C++
description: Convertir FODS en DOC dans les applications C++
url: /fr/cpp/conversion/fods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Convertir FODS en DOC via C++" h2="Exporter Excel® FODS vers DOC dans des applications C++ entièrement fonctionnelles" >}}
