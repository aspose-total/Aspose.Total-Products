---
title: API C++ pour convertir POTX en WORD
description: Exportez POTX vers WORD dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POTX en WORD" h2="Exportez POTX vers WORD dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
