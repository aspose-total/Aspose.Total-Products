---
title: API C++ pour convertir XML en FODS
description: Convertissez XML en FODS via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/xml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: XML
