---
title: Exporter OFT vers EMF via C++
description: API C++ pour convertir OFT en EMF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers EMF" h2="Transformez OFT en EMF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir OFT en EMF" %}}
