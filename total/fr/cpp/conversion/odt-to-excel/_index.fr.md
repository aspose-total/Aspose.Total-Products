---
title: Convertir ODT en EXCEL en C++
description: API C++ pour convertir ODT en EXCEL sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en EXCEL" h2="Exportez ODT vers EXCEL via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
