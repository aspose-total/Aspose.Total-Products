---
title: API C++ pour convertir MHTML en XLAM
description: Convertissez MHTML en XLAM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
