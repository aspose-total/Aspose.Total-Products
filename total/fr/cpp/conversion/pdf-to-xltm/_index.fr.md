---
title: API C++ pour convertir PDF en XLTM
description: Convertissez PDF en XLTM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: PDF
