---
title: API C++ pour convertir XML en XLSB
description: Convertissez XML en XLSB via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/xml-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: XML
