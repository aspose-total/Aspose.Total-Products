---
title: Convertir RTF en XLTX en C++
description: API C++ pour convertir RTF en XLTX sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en XLTX" h2="Exportez RTF vers XLTX via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
