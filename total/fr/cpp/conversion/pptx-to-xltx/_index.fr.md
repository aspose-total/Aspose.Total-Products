...
description: Exporter PPTX vers XLTX en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPTX en XLTX via C++" h2="Conversion de fichiers PPTX en XLTX via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
