---
title: API C++ pour convertir PDF en SXC
description: Convertissez PDF en SXC via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PDF
