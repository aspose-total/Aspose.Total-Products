---
title: API C++ pour convertir PPTM en WORDML
description: Exportez PPTM vers WORDML dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPTM en WORDML" h2="Exportez PPTM vers WORDML dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
