---
title: Exporter MSG vers SVG via C++
description: API C++ pour convertir MSG en SVG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers SVG" h2="Transformez MSG en SVG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
