---
title: API C++ pour convertir PS en XLTX
description: Convertissez PS en XLTX via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: PS
