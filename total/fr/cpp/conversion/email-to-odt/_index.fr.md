---
title: Exporter EMAIL vers ODT via C++
description: API C++ pour convertir EMAIL en ODT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers ODT" h2="Transformez EMAIL en ODT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMAIL en ODT" %}}
