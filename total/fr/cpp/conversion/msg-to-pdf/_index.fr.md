---
title: Exporter MSG vers PDF via C++
description: API C++ pour convertir MSG en PDF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers PDF" h2="Transformez MSG en PDF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
