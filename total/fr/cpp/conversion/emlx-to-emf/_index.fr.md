---
title: Exporter EMLX vers EMF via C++
description: API C++ pour convertir EMLX en EMF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMLX en EMF" %}}
