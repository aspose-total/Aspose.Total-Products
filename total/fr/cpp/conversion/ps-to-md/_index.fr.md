---
title: API C++ pour convertir PS en MD
description: Convertissez PS en MD via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-md/
family: total
platformtag: cpp
feature: conversion
informat: PS
