---
title: API C++ pour convertir PPTM en DOCX
description: Exportez PPTM vers DOCX dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPTM en DOCX" h2="Exportez PPTM vers DOCX dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
