---
title: API C++ pour convertir PCL en XLAM
description: Convertissez PCL en XLAM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PCL
