---
title: API C++ pour exporter SVG vers RTF
description: Convertissez SVG en RTF dans les applications C++.
url: /fr/cpp/conversion/svg-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: SVG
