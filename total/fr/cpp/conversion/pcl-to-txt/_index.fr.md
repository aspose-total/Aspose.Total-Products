---
title: API C++ pour convertir PCL en TXT
description: Convertissez PCL en TXT via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: PCL
