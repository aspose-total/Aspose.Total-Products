---
title: API C++ pour exporter PDF vers FLATOPC
description: Convertissez PDF en FLATOPC dans les applications C++.
url: /fr/cpp/conversion/pdf-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PDF
