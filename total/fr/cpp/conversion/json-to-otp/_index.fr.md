---
title: Convertir le format JSON en OTP via C++
description: Analyser JSON en OTP en C++ sans utiliser Microsoft PowerPoint
url: /fr/cpp/conversion/json-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="Convertir le format JSON en OTP via C++" %}}
...
4. Enregistrez le document au format OTP à l'aide de la méthode [Enregistrer](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en OTP avec filigrane en C++" %}}
