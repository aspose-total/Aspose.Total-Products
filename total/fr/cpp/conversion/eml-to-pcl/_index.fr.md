---
title: Exporter EML vers PCL via C++
description: API C++ pour convertir EML en PCL sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers PCL" h2="Transformez EML en PCL dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
