---
title: Convertir WORD en XLTX en C++
description: API C++ pour convertir WORD en XLTX sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en XLTX" h2="Exportez WORD vers XLTX via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
