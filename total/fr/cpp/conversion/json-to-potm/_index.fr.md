---
title: Convertir le format JSON en POTM via C++
description: Analyser JSON en POTM en C++ sans utiliser Microsoft PowerPoint
url: /fr/cpp/conversion/json-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
4. Enregistrez le document au format POTM à l'aide de la méthode [Enregistrer](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir le format JSON en POTM avec filigrane en C++" %}}
