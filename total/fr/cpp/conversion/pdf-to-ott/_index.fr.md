---
title: API C++ pour exporter PDF vers OTT
description: Convertissez PDF en OTT dans les applications C++.
url: /fr/cpp/conversion/pdf-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PDF
...
4. Enregistrez le document au format OTT à l'aide de la fonction membre [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stream_saveformat)
