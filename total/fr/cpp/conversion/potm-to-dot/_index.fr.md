---
title: API C++ pour convertir POTM en DOT
description: Exportez POTM vers DOT dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POTM en DOT" h2="Exportez POTM vers DOT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
