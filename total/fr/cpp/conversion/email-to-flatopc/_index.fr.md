---
title: Exporter EMAIL vers FLATOPC via C++
description: API C++ pour convertir EMAIL en FLATOPC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers FLATOPC" h2="Transformez EMAIL en FLATOPC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
