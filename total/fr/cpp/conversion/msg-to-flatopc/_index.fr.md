---
title: Exporter MSG vers FLATOPC via C++
description: API C++ pour convertir MSG en FLATOPC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers FLATOPC" h2="Transformez MSG en FLATOPC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
