---
title: Exporter EMAIL vers PS via C++
description: API C++ pour convertir EMAIL en PS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers PS" h2="Transformez EMAIL en PS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
