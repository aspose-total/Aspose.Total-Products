...
description: Exporter PPT vers XLS en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPT en XLS via C++" h2="Conversion de fichiers PPT en XLS via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
