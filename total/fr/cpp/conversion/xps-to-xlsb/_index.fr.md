---
title: API C++ pour convertir XPS en XLSB
description: Convertissez XPS en XLSB via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/xps-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: XPS
