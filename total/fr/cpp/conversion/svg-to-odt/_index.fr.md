---
title: API C++ pour exporter SVG vers ODT
description: Convertissez SVG en ODT dans les applications C++.
url: /fr/cpp/conversion/svg-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: SVG
