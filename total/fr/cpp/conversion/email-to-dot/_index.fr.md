---
title: Exporter EMAIL vers DOT via C++
description: API C++ pour convertir EMAIL en DOT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers DOT" h2="Transformez EMAIL en DOT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
