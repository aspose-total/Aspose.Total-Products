---
title: Exporter OFT vers RTF via C++
description: API C++ pour convertir OFT en RTF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers RTF" h2="Transformez OFT en RTF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
