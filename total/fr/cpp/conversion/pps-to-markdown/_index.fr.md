...
description: Exporter PPS vers MARKDOWN en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPS en MARKDOWN via C++" h2="Conversion de fichiers PPS en MARKDOWN via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
