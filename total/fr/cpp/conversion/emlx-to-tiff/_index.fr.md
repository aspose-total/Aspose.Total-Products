---
title: Exporter EMLX vers TIFF via C++
description: API C++ pour convertir EMLX en TIFF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers TIFF" h2="Transformez EMLX en TIFF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
