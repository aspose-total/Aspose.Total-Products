---
title: API C++ pour exporter PDF vers ODT
description: Convertissez PDF en ODT dans les applications C++.
url: /fr/cpp/conversion/pdf-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
