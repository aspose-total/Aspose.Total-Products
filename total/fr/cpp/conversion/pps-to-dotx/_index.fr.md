---
title: API C++ pour convertir PPS en DOTX
description: Exportez PPS vers DOTX dans vos applications C++
url: /fr/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en DOTX" h2="Exportez PPS vers DOTX dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
