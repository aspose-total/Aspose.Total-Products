---
title: Convertir RTF en XLT en C++
description: API C++ pour convertir RTF en XLT sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en XLT" h2="Exportez RTF vers XLT via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
