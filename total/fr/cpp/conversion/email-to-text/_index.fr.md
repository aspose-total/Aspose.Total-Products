---
title: Exporter EMAIL vers TEXT via C++
description: API C++ pour convertir EMAIL en TEXT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-text/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers TEXT" h2="Transformez EMAIL en TEXT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
