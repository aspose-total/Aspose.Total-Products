---
title: Convertir DOTM en XLTM en C++
description: API C++ pour convertir DOTM en XLTM sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en XLTM" h2="Exportez DOTM vers XLTM via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir DOTM en XLTM" %}}
