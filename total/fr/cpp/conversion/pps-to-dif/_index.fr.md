...
description: Exporter PPS vers DIF en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/pps-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPS en DIF via C++" h2="Conversion de fichiers PPS en DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
