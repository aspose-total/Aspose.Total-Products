...
description: Exporter POWERPOINT vers CSV en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/powerpoint-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="Convertir POWERPOINT en CSV via C++" h2="Conversion de fichiers POWERPOINT en CSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
