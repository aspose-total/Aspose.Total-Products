---
title: API C++ pour convertir PPS en DOCX
description: Exportez PPS vers DOCX dans vos applications C++
url: /fr/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en DOCX" h2="Exportez PPS vers DOCX dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
