---
title: Exporter MSG vers DOT via C++
description: API C++ pour convertir MSG en DOT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers DOT" h2="Transformez MSG en DOT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
