---
title: API C++ pour convertir PS en TSV
description: Convertissez PS en TSV via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PS
