---
title: Convertir WORD en SXC en C++
description: API C++ pour convertir WORD en SXC sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en SXC" h2="Exportez WORD vers SXC via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
