---
title: Convertir FODS en WORD avec C++
description: Convertir FODS en WORD dans les applications C++
url: /fr/cpp/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Convertir FODS en WORD via C++" h2="Exporter Excel® FODS vers WORD dans des applications C++ entièrement fonctionnelles" >}}
