---
title: API C++ pour convertir MHTML en XLSM
description: Convertissez MHTML en XLSM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
