---
title: Exporter OFT vers DOTM via C++
description: API C++ pour convertir OFT en DOTM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers DOTM" h2="Transformez OFT en DOTM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
