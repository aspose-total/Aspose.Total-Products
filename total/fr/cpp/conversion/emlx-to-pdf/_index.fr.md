---
title: Exporter EMLX vers PDF via C++
description: API C++ pour convertir EMLX en PDF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers PDF" h2="Transformez EMLX en PDF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMLX en PDF" %}}
