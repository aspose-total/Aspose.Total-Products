---
title: Exporter EMAIL vers WORD via C++
description: API C++ pour convertir EMAIL en WORD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-word/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers WORD" h2="Transformez EMAIL en WORD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/msg-to-word/" name="MSG À WORD" description="" >}}
