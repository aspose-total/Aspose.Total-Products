---
title: Exporter EMLX vers MD via C++
description: API C++ pour convertir EMLX en MD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-md/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers MD" h2="Transformez EMLX en MD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
