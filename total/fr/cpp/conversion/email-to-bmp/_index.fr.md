---
title: Exporter EMAIL vers BMP via C++
description: API C++ pour convertir EMAIL en BMP sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers BMP" h2="Transformez EMAIL en BMP dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
