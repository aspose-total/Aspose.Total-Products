---
title: Convertir ODT en DIF en C++
description: API C++ pour convertir ODT en DIF sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en DIF" h2="Exportez ODT vers DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
