---
title: Exporter EML vers OTT via C++
description: API C++ pour convertir EML en OTT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers OTT" h2="Transformez EML en OTT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EML en OTT" %}}
