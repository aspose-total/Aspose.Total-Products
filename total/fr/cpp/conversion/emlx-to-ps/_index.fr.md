---
title: Exporter EMLX vers PS via C++
description: API C++ pour convertir EMLX en PS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers PS" h2="Transformez EMLX en PS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
