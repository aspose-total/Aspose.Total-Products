---
title: Convertir WORD en XLAM en C++
description: API C++ pour convertir WORD en XLAM sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en XLAM" h2="Exportez WORD vers XLAM via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
