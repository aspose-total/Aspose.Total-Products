---
title: Exporter OFT vers WORDML via C++
description: API C++ pour convertir OFT en WORDML sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers WORDML" h2="Transformez OFT en WORDML dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir OFT en WORDML" %}}
