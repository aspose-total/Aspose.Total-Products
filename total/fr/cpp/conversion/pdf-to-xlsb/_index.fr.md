---
title: API C++ pour convertir PDF en XLSB
description: Convertissez PDF en XLSB via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PDF
