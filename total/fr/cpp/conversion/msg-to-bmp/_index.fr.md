---
title: Exporter MSG vers BMP via C++
description: API C++ pour convertir MSG en BMP sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers BMP" h2="Transformez MSG en BMP dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir MSG en BMP" %}}
