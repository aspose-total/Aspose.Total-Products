---
title: API C++ pour convertir PPSX en TEXT
description: Exportez PPSX vers TEXT dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPSX en TEXT" h2="Exportez PPSX vers TEXT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
