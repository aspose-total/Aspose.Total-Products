---
title: Exporter EMAIL vers PNG via C++
description: API C++ pour convertir EMAIL en PNG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-png/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers PNG" h2="Transformez EMAIL en PNG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
