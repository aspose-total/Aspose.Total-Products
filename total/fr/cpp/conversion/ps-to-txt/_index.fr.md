---
title: API C++ pour convertir PS en TXT
description: Convertissez PS en TXT via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-txt/
family: total
platformtag: cpp
feature: conversion
informat: PS
