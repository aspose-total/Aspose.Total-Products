---
title: Convertir OTT en DIF en C++
description: API C++ pour convertir OTT en DIF sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/ott-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir OTT en DIF" h2="Exportez OTT vers DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
