---
title: Exporter MSG vers MD via C++
description: API C++ pour convertir MSG en MD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-md/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers MD" h2="Transformez MSG en MD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
