---
title: API C++ pour convertir PPS en DOTM ou avec le convertisseur en ligne gratuit
description: Exportez PPS vers DOTM dans vos applications C++ ou en ligne. Testez rapidement le convertisseur en ligne PPS vers DOTM gratuit avant d'intégrer le code.
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en DOTM ou application en ligne" h2="Exportez PPS vers DOTM dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
...
<h3>Convertisseur en ligne gratuit pour PPS en DOTM</h3>

<iframe title="Outil en ligne de conversion dotm en pps" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dotm&from=pps" id="child-iframe" width="80%"></iframe>
