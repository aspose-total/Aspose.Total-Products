---
title: API C++ pour convertir PS en XLT
description: Convertissez PS en XLT via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PS
