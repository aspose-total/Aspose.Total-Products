---
title: API C++ pour convertir PDF en XLAM
description: Convertissez PDF en XLAM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PDF
