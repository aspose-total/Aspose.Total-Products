---
title: Exporter OFT vers TIFF via C++
description: API C++ pour convertir OFT en TIFF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers TIFF" h2="Transformez OFT en TIFF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
