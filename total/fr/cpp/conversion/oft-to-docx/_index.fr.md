---
title: Exporter OFT vers DOCX via C++
description: API C++ pour convertir OFT en DOCX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers DOCX" h2="Transformez OFT en DOCX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
