---
title: Convertir DOTM en TSV en C++
description: API C++ pour convertir DOTM en TSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en TSV" h2="Exportez DOTM vers TSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
