---
title: Exporter EML vers WORDML via C++
description: API C++ pour convertir EML en WORDML sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers WORDML" h2="Transformez EML en WORDML dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
