---
title: API C++ pour convertir POT en DOTX
description: Exportez POT vers DOTX dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POT en DOTX" h2="Exportez POT vers DOTX dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
