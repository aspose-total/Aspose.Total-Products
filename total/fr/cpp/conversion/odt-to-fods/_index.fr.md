---
title: Convertir ODT en FODS en C++
description: API C++ pour convertir ODT en FODS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en FODS" h2="Exportez ODT vers FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
