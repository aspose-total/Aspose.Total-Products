---
title: Convertir PPS en XLS via C++
description: Exporter PPS vers XLS en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/pps-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPS en XLS via C++" h2="Conversion de fichiers PPS en XLS via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
