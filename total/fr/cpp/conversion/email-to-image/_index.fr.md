---
title: Exporter EMAIL vers IMAGE via C++
description: API C++ pour convertir EMAIL en IMAGE sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-image/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers IMAGE" h2="Transformez EMAIL en IMAGE dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/msg-to-image/" name="MSG À IMAGE" description="" >}}
