---
title: API C++ pour convertir PCL en TSV
description: Convertissez PCL en TSV via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: PCL
