---
title: Exporter OFT vers ODT via C++
description: API C++ pour convertir OFT en ODT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers ODT" h2="Transformez OFT en ODT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
