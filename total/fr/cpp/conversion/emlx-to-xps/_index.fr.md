---
title: Exporter EMLX vers XPS via C++
description: API C++ pour convertir EMLX en XPS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers XPS" h2="Transformez EMLX en XPS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
