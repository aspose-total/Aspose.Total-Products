...
description: Exporter PPT vers DIF en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/ppt-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPT en DIF via C++" h2="Conversion de fichiers PPT en DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
