---
title: Exporter OFT vers TEXT via C++
description: API C++ pour convertir OFT en TEXT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-text/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers TEXT" h2="Transformez OFT en TEXT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
