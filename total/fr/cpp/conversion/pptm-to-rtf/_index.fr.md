---
title: API C++ pour convertir PPTM en RTF
description: Exportez PPTM vers RTF dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPTM en RTF" h2="Exportez PPTM vers RTF dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
