---
title: Exporter OFT vers WORD via C++
description: API C++ pour convertir OFT en WORD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-word/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers WORD" h2="Transformez OFT en WORD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/oft-to-word/" name="OFT À WORD" description="" >}}
