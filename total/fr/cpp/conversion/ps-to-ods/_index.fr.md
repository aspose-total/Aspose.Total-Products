---
title: API C++ pour convertir PS en ODS
description: Convertissez PS en ODS via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PS
