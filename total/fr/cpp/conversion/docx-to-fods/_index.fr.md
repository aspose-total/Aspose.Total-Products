---
title: Convertir DOCX en FODS en C++
description: API C++ pour convertir DOCX en FODS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/docx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOCX en FODS" h2="Exportez DOCX vers FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Enregistrez le docxument au format FODS à l'aide de la fonction membre [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
