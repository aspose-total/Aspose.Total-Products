---
title: Exporter MSG vers PNG via C++
description: API C++ pour convertir MSG en PNG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-png/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers PNG" h2="Transformez MSG en PNG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
