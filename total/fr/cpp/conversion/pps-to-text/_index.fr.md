---
title: API C++ pour convertir PPS en TEXT
description: Exportez PPS vers TEXT dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en TEXT" h2="Exportez PPS vers TEXT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
