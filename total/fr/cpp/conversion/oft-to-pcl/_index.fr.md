---
title: Exporter OFT vers PCL via C++
description: API C++ pour convertir OFT en PCL sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers PCL" h2="Transformez OFT en PCL dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
