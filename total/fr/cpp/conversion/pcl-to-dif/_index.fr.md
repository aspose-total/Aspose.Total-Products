---
title: API C++ pour convertir PCL en DIF
description: Convertissez PCL en DIF via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: PCL
