---
title: Convertir DOCX en PPSM via C++ ou avec le convertisseur en ligne gratuit
description: Exportez DOCX vers PPSM dans vos applications C++ sans utiliser Microsoft Word ou PowerPoint ou en ligne. Testez rapidement le convertisseur en ligne DOCX vers PPSM gratuit avant d'intégrer le code.
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOCX en PPSM ou application en ligne" h2="Exportez DOCX vers PPSM dans vos applications C++ sans utiliser Microsoft Word® ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Conversion DOCX en PPSM sur C++" %}}
...
6. Enregistrez le document au format PPSM à l'aide de la méthode [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) et définissez Ppsm comme SaveFormat
