---
title: Convertir RTF en FODS en C++
description: API C++ pour convertir RTF en FODS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en FODS" h2="Exportez RTF vers FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir RTF en FODS" %}}
