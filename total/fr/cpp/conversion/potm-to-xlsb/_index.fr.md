---
title: Convertir POTM en XLSB via C++
description: Exporter POTM vers XLSB en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/potm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Convertir POTM en XLSB via C++" h2="Conversion de fichiers POTM en XLSB via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
