---
title: Convertir WORD en XLTM en C++
description: API C++ pour convertir WORD en XLTM sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en XLTM" h2="Exportez WORD vers XLTM via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
