---
title: API C++ pour convertir PS en XLSB
description: Convertissez PS en XLSB via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PS
