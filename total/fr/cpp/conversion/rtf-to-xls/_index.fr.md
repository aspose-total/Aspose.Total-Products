---
title: Convertir RTF en XLS en C++
description: API C++ pour convertir RTF en XLS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en XLS" h2="Exportez RTF vers XLS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
