...
description: Exporter PPSX vers XLTX en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/ppsx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPSX en XLTX via C++" h2="Conversion de fichiers PPSX en XLTX via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
