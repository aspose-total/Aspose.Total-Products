---
title: Exporter MSG vers DOTM via C++
description: API C++ pour convertir MSG en DOTM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers DOTM" h2="Transformez MSG en DOTM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
