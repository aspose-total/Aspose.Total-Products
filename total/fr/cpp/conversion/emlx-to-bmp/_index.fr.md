---
title: Exporter EMLX vers BMP via C++
description: API C++ pour convertir EMLX en BMP sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers BMP" h2="Transformez EMLX en BMP dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
