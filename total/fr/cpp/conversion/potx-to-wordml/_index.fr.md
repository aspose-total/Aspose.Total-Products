---
title: API C++ pour convertir POTX en WORDML
description: Exportez POTX vers WORDML dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POTX en WORDML" h2="Exportez POTX vers WORDML dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
