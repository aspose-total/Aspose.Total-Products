---
title: Convertir RTF en XLSB en C++
description: API C++ pour convertir RTF en XLSB sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en XLSB" h2="Exportez RTF vers XLSB via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
