---
title: API C++ pour convertir PDF en ODS
description: Convertissez PDF en ODS via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PDF
