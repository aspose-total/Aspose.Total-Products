---
title: Exporter MSG vers WORDML via C++
description: API C++ pour convertir MSG en WORDML sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers WORDML" h2="Transformez MSG en WORDML dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
