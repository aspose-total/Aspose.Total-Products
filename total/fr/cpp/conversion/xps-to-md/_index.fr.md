---
title: API C++ pour convertir XPS en MD
description: Convertissez XPS en MD via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/xps-to-md/
family: total
platformtag: cpp
feature: conversion
informat: XPS
