---
title: Exporter EMAIL vers DOCM via C++
description: API C++ pour convertir EMAIL en DOCM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers DOCM" h2="Transformez EMAIL en DOCM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMAIL en DOCM" %}}
