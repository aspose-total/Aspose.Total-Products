---
title: Convertir DOTM en CSV en C++
description: API C++ pour convertir DOTM en CSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en CSV" h2="Exportez DOTM vers CSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
