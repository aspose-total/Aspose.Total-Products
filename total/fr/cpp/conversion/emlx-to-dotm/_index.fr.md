---
title: Exporter EMLX vers DOTM via C++
description: API C++ pour convertir EMLX en DOTM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers DOTM" h2="Transformez EMLX en DOTM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
