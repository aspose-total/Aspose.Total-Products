---
title: Exporter EML vers TEXT via C++
description: API C++ pour convertir EML en TEXT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers TEXT" h2="Transformez EML en TEXT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
