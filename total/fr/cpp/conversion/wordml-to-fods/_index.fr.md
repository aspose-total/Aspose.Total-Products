---
title: Convertir WORDML en FODS en C++
description: API C++ pour convertir WORDML en FODS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/wordml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORDML en FODS" h2="Exportez WORDML vers FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
