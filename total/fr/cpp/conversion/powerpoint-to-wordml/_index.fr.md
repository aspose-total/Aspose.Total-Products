...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POWERPOINT en WORDML ou en ligne" h2="Exportez POWERPOINT vers WORDML dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
