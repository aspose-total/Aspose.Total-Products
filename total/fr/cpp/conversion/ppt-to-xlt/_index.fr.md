...
description: Exporter PPT vers XLT en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/ppt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPT en XLT via C++" h2="Conversion de fichiers PPT en XLT via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
