...
description: Convertissez MD en WORDML dans les applications C++.
url: /fr/cpp/conversion/md-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MD
...
4. Enregistrez le document au format WORDML à l'aide de la fonction membre [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stream_saveformat)
