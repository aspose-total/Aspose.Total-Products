---
title: Exporter MSG vers RTF via C++
description: API C++ pour convertir MSG en RTF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers RTF" h2="Transformez MSG en RTF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
