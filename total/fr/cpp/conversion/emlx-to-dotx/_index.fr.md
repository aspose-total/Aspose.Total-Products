---
title: Exporter EMLX vers DOTX via C++
description: API C++ pour convertir EMLX en DOTX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers DOTX" h2="Transformez EMLX en DOTX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
