---
title: Exporter EMAIL vers PDF via C++
description: API C++ pour convertir EMAIL en PDF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers PDF" h2="Transformez EMAIL en PDF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMAIL en PDF" %}}
...
4. Enregistrez le document au format PDF à l'aide de la méthode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) et définissez Pdf comme SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="API C++ pour restreindre l'édition du format de fichier PDF" %}}
