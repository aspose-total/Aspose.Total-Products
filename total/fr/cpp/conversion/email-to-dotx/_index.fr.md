---
title: Exporter EMAIL vers DOTX via C++
description: API C++ pour convertir EMAIL en DOTX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers DOTX" h2="Transformez EMAIL en DOTX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
