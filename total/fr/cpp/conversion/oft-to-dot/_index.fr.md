---
title: Exporter OFT vers DOT via C++
description: API C++ pour convertir OFT en DOT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers DOT" h2="Transformez OFT en DOT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
