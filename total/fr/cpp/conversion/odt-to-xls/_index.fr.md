---
title: Convertir ODT en XLS en C++
description: API C++ pour convertir ODT en XLS sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en XLS" h2="Exportez ODT vers XLS via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
