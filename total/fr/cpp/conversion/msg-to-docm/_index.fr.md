---
title: Exporter MSG vers DOCM via C++
description: API C++ pour convertir MSG en DOCM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers DOCM" h2="Transformez MSG en DOCM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
