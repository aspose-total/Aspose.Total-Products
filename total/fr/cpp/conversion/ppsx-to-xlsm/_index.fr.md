...
description: Exporter PPSX vers XLSM en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPSX en XLSM via C++" h2="Conversion de fichiers PPSX en XLSM via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
