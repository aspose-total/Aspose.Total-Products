---
title: Exporter EML vers XPS via C++
description: API C++ pour convertir EML en XPS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers XPS" h2="Transformez EML en XPS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
