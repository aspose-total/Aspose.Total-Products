---
title: Exporter MSG vers DOC via C++
description: API C++ pour convertir MSG en DOC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers DOC" h2="Transformez MSG en DOC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
