---
title: Exporter OFT vers JPEG via C++
description: API C++ pour convertir OFT en JPEG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-jpeg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers JPEG" h2="Transformez OFT en JPEG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
