---
title: Exporter MSG vers TIFF via C++
description: API C++ pour convertir MSG en TIFF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers TIFF" h2="Transformez MSG en TIFF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
