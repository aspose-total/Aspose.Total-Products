---
title: API C++ pour convertir PCL en FODS
description: Convertissez PCL en FODS via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PCL
