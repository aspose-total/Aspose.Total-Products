...
description: Exporter PPTX vers FODS en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/pptx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPTX en FODS via C++" h2="Conversion de fichiers PPTX en FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
