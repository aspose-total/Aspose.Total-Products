---
title: Convertir PPTX en FODS via C++ ou application en ligne ou avec le convertisseur en ligne gratuit
description: Exporter PPTX vers FODS en C++ sans utiliser Microsoft Excel ou Powerpoint ou en ligne. Testez rapidement le convertisseur en ligne PPTX vers FODS gratuit avant d'intégrer le code.
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPTX en FODS via C++ ou application en ligne" h2="Conversion de fichiers PPTX en FODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
