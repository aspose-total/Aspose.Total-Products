---
title: Exporter EMAIL vers DOCX via C++
description: API C++ pour convertir EMAIL en DOCX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir EMAIL en DOCX" %}}
