...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en DOT ou en ligne" h2="Exportez PPS vers DOT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
