---
title: Convertir EXCEL en PPTX avec C++
description: Convertir EXCEL en PPTX dans les applications C++
url: /fr/cpp/conversion/excel-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Convertir EXCEL en PPTX via C++" h2="Exporter Excel® EXCEL vers PPTX dans des applications C++ entièrement fonctionnelles" >}}
