---
title: Exporter EMLX vers RTF via C++
description: API C++ pour convertir EMLX en RTF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers RTF" h2="Transformez EMLX en RTF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
