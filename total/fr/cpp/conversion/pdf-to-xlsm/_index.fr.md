---
title: API C++ pour convertir PDF en XLSM
description: Convertissez PDF en XLSM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PDF
