---
title: Convertir POTM en TSV via C++
description: Exporter POTM vers TSV en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/potm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Convertir POTM en TSV via C++" h2="Conversion de fichiers POTM en TSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
