---
title: API C++ pour convertir PPSX en DOT
description: Exportez PPSX vers DOT dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPSX en DOT" h2="Exportez PPSX vers DOT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
