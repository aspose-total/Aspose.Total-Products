---
title: API C++ pour convertir PDF en XLTX
description: Convertissez PDF en XLTX via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pdf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: PDF
