---
title: Exporter EML vers EPUB via C++
description: API C++ pour convertir EML en EPUB sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers EPUB" h2="Transformez EML en EPUB dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
