---
title: Exporter EMLX vers FLATOPC via C++
description: API C++ pour convertir EMLX en FLATOPC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers FLATOPC" h2="Transformez EMLX en FLATOPC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
