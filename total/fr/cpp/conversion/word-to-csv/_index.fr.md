---
title: Convertir WORD en CSV en C++
description: API C++ pour convertir WORD en CSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/word-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORD en CSV" h2="Exportez WORD vers CSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
