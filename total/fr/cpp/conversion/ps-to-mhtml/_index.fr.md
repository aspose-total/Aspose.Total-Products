...
description: Convertissez PS en MHTML dans les applications C++.
url: /fr/cpp/conversion/ps-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter PS vers MHTML" h2="Rendre PS en MHTML dans les applications C++ sans nécessiter d'application tierce" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour rendre PS en MHTML" %}}
