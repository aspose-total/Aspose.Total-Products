...
description: Exporter PPTX vers MARKDOWN en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPTX en MARKDOWN via C++" h2="Conversion de fichiers PPTX en MARKDOWN via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
