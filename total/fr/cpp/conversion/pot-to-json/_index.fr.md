---
title: Convertir POT au format JSON via C++
description: Exporter POT au format JSON en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/pot-to-json/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Convertir POT au format JSON via C++" h2="Exportez le fichier POT au format JSON via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
En utilisant [Aspose.Total pour C++](https://products.aspose.com/total/cpp/), vous pouvez convertir le fichier POT au format JSON dans les applications C++ en deux étapes simples. Tout d'abord, en utilisant [Aspose.Slides pour C++](https://products.aspose.com/slides/cpp/), vous pouvez exporter POT vers HTML. Ensuite, en utilisant [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) Spreadsheet Programming API, vous pouvez convertir HTML en JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convertir POT au format JSON via C++" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir l'POT protégé au format JSON via C++" %}}
