---
title: Exporter EMLX vers TEXT via C++
description: API C++ pour convertir EMLX en TEXT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers TEXT" h2="Transformez EMLX en TEXT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
