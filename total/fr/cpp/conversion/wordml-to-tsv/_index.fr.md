---
title: Convertir WORDML en TSV en C++
description: API C++ pour convertir WORDML en TSV sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/wordml-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir WORDML en TSV" h2="Exportez WORDML vers TSV via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
