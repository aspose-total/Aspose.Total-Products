---
title: Exporter EMAIL vers MD via C++
description: API C++ pour convertir EMAIL en MD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-md/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers MD" h2="Transformez EMAIL en MD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
