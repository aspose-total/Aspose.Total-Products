---
title: API C++ pour convertir PPS en RTF
description: Exportez PPS vers RTF dans vos applications C++
url: /fr/cpp/conversion/pps-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en RTF" h2="Exportez PPS vers RTF dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
