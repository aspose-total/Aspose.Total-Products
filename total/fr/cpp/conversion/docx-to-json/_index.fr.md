...
url: /fr/cpp/conversion/docx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
En utilisant [Aspose.Total pour C++](https://products.aspose.com/total/cpp/), vous pouvez convertir le format DOCX au format JSON dans vos applications C++. Tout d'abord, en utilisant [Aspose.Words pour C++](https://products.aspose.com/words/cpp/), vous pouvez exporter DOCX vers HTML. Après cela, en utilisant [Aspose.Cells pour C++](https://products.aspose.com/cells/cpp/), vous pouvez convertir le HTML au format JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Enregistrez le docxument au format JSON à l'aide de la fonction membre [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/docx-to-csv/" name="DOCX À CSV" description="" >}}
