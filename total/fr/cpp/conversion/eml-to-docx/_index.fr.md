---
title: Exporter EML vers DOCX via C++
description: API C++ pour convertir EML en DOCX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers DOCX" h2="Transformez EML en DOCX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
