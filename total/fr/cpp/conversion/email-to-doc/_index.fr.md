---
title: Exporter EMAIL vers DOC via C++
description: API C++ pour convertir EMAIL en DOC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers DOC" h2="Transformez EMAIL en DOC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
