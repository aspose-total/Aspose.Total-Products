---
title: Convertir ODT en XLSX en C++
description: API C++ pour convertir ODT en XLSX sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en XLSX" h2="Exportez ODT vers XLSX via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
