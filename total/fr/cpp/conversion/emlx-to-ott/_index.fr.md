---
title: Exporter EMLX vers OTT via C++
description: API C++ pour convertir EMLX en OTT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers OTT" h2="Transformez EMLX en OTT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
