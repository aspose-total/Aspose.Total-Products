---
title: API C++ pour convertir PS en XLSM
description: Convertissez PS en XLSM via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/ps-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
4. Enregistrez le document au format XLSM à l'aide de la fonction membre [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/ps-to-fods/" name="PS À FODS" description="" >}}
