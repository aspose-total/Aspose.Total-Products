---
title: Exporter EMAIL vers EMF via C++
description: API C++ pour convertir EMAIL en EMF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers EMF" h2="Transformez EMAIL en EMF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
