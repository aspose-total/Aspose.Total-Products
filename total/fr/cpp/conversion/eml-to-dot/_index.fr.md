---
title: Exporter EML vers DOT via C++
description: API C++ pour convertir EML en DOT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers DOT" h2="Transformez EML en DOT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
