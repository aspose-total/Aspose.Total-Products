...
description: Exporter PPT vers XLAM en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/ppt-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPT en XLAM via C++" h2="Conversion de fichiers PPT en XLAM via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
