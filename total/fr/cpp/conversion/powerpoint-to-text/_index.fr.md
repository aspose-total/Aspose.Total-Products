---
title: API C++ pour convertir POWERPOINT en TEXT
description: Exportez POWERPOINT vers TEXT dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POWERPOINT en TEXT" h2="Exportez POWERPOINT vers TEXT dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
