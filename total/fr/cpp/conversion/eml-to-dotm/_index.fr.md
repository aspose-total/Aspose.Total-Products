---
title: Exporter EML vers DOTM via C++
description: API C++ pour convertir EML en DOTM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers DOTM" h2="Transformez EML en DOTM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
