...
description: Exporter PPS vers XLSM en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/pps-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPS en XLSM via C++" h2="Conversion de fichiers PPS en XLSM via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
