---
title: Exporter OFT vers XPS via C++
description: API C++ pour convertir OFT en XPS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers XPS" h2="Transformez OFT en XPS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
