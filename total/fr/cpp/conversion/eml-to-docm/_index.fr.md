---
title: Exporter EML vers DOCM via C++
description: API C++ pour convertir EML en DOCM sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers DOCM" h2="Transformez EML en DOCM dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
