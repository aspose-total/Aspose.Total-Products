---
title: Convertir DOTM en XLSB en C++
description: API C++ pour convertir DOTM en XLSB sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en XLSB" h2="Exportez DOTM vers XLSB via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
