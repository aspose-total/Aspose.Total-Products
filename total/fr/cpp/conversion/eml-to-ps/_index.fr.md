---
title: Exporter EML vers PS via C++
description: API C++ pour convertir EML en PS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers PS" h2="Transformez EML en PS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
