---
title: Convertir ODT en XLSM en C++
description: API C++ pour convertir ODT en XLSM sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en XLSM" h2="Exportez ODT vers XLSM via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
