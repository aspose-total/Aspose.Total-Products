---
title: API C++ pour exporter PDF vers PS
description: Convertissez PDF en PS dans les applications C++.
url: /fr/cpp/conversion/pdf-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: PDF
