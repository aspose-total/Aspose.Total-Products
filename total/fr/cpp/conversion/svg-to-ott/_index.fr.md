---
title: API C++ pour exporter SVG vers OTT
description: Convertissez SVG en OTT dans les applications C++.
url: /fr/cpp/conversion/svg-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: SVG
