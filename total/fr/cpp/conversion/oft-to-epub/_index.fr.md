---
title: Exporter OFT vers EPUB via C++
description: API C++ pour convertir OFT en EPUB sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers EPUB" h2="Transformez OFT en EPUB dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
