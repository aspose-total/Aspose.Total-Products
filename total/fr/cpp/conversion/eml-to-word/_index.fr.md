---
title: Exporter EML vers WORD via C++
description: API C++ pour convertir EML en WORD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-word/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers WORD" h2="Transformez EML en WORD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/fr/cpp/conversion/eml-to-word/" name="EML À WORD" description="" >}}
