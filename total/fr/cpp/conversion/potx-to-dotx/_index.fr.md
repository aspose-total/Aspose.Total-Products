---
title: API C++ pour convertir POTX en DOTX
description: Exportez POTX vers DOTX dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre POTX en DOTX" h2="Exportez POTX vers DOTX dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
