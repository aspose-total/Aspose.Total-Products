---
title: Exporter MSG vers JPEG via C++
description: API C++ pour convertir MSG en JPEG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-jpeg/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers JPEG" h2="Transformez MSG en JPEG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
