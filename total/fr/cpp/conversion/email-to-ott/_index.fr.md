---
title: Exporter EMAIL vers OTT via C++
description: API C++ pour convertir EMAIL en OTT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers OTT" h2="Transformez EMAIL en OTT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
