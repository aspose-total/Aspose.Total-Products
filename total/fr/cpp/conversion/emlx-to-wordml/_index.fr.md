---
title: Exporter EMLX vers WORDML via C++
description: API C++ pour convertir EMLX en WORDML sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers WORDML" h2="Transformez EMLX en WORDML dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
