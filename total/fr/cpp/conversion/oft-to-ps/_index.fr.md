---
title: Exporter OFT vers PS via C++
description: API C++ pour convertir OFT en PS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers PS" h2="Transformez OFT en PS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
