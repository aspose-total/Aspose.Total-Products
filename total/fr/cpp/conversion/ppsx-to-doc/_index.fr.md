---
title: API C++ pour convertir PPSX en DOC
description: Exportez PPSX vers DOC dans vos applications C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPSX en DOC" h2="Exportez PPSX vers DOC dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
