---
title: API C++ pour convertir PCL en XLSB
description: Convertissez PCL en XLSB via l'API C++ sans utiliser Microsoft Excel ou Adobe Reader
url: /fr/cpp/conversion/pcl-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PCL
