---
title: Convertir DOTM en EXCEL en C++
description: API C++ pour convertir DOTM en EXCEL sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOTM en EXCEL" h2="Exportez DOTM vers EXCEL via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
