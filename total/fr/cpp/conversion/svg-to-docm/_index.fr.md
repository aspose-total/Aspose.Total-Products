---
title: API C++ pour exporter SVG vers DOCM
description: Convertissez SVG en DOCM dans les applications C++.
url: /fr/cpp/conversion/svg-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: SVG
