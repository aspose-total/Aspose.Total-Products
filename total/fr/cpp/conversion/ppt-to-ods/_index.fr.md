...
description: Exporter PPT vers ODS en C++ sans utiliser Microsoft Excel ou Powerpoint
url: /fr/cpp/conversion/ppt-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPT en ODS via C++" h2="Conversion de fichiers PPT en ODS via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
