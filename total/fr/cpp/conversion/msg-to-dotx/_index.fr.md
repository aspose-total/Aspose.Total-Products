---
title: Exporter MSG vers DOTX via C++
description: API C++ pour convertir MSG en DOTX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers DOTX" h2="Transformez MSG en DOTX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
