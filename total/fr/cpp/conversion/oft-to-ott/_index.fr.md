---
title: Exporter OFT vers OTT via C++
description: API C++ pour convertir OFT en OTT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers OTT" h2="Transformez OFT en OTT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
