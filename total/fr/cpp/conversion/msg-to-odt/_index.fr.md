---
title: Exporter MSG vers ODT via C++
description: API C++ pour convertir MSG en ODT sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers ODT" h2="Transformez MSG en ODT dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
