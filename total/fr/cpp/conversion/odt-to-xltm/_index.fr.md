---
title: Convertir ODT en XLTM en C++
description: API C++ pour convertir ODT en XLTM sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/odt-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir ODT en XLTM" h2="Exportez ODT vers XLTM via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ pour convertir ODT en XLTM" %}}
