---
title: Exporter EML vers MD via C++
description: API C++ pour convertir EML en MD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-md/
family: total
platformtag: cpp
feature: conversion
informat: EML
