---
title: Exporter EMLX vers SVG via C++
description: API C++ pour convertir EMLX en SVG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers SVG" h2="Transformez EMLX en SVG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
