---
title: Exporter OFT vers BMP via C++
description: API C++ pour convertir OFT en BMP sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers BMP" h2="Transformez OFT en BMP dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
