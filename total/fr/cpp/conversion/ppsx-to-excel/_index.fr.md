...
description: Exporter PPSX vers EXCEL en C++ sans utiliser Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convertir PPSX en EXCEL via C++" h2="Conversion de fichiers PPSX en EXCEL via C++ sans utiliser Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
