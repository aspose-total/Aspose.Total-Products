---
title: Exporter EMLX vers EPUB via C++
description: API C++ pour convertir EMLX en EPUB sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/emlx-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMLX vers EPUB" h2="Transformez EMLX en EPUB dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
