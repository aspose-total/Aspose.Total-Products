---
title: Convertir EXCEL en POWERPOINT avec C++
description: Convertir EXCEL en POWERPOINT dans les applications C++
url: /fr/cpp/conversion/excel-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Convertir EXCEL en POWERPOINT via C++" h2="Exporter Excel® EXCEL vers POWERPOINT dans des applications C++ entièrement fonctionnelles" >}}
