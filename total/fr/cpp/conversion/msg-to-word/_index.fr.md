---
title: Exporter MSG vers WORD via C++
description: API C++ pour convertir MSG en WORD sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-word/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers WORD" h2="Transformez MSG en WORD dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
