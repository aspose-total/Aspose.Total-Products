---
title: Exporter OFT vers PNG via C++
description: API C++ pour convertir OFT en PNG sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-png/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers PNG" h2="Transformez OFT en PNG dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
