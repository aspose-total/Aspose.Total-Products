---
title: Exporter OFT vers DOTX via C++
description: API C++ pour convertir OFT en DOTX sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers DOTX" h2="Transformez OFT en DOTX dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
