---
title: Exporter OFT vers DOC via C++
description: API C++ pour convertir OFT en DOC sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/oft-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter OFT vers DOC" h2="Transformez OFT en DOC dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
