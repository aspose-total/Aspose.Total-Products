---
title: Exporter EMAIL vers XPS via C++
description: API C++ pour convertir EMAIL en XPS sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/email-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EMAIL vers XPS" h2="Transformez EMAIL en XPS dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
