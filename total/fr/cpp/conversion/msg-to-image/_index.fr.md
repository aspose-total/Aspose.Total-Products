---
title: Exporter MSG vers IMAGE via C++
description: API C++ pour convertir MSG en IMAGE sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-image/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers IMAGE" h2="Transformez MSG en IMAGE dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
