---
title: Exporter EML vers TIFF via C++
description: API C++ pour convertir EML en TIFF sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/eml-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter EML vers TIFF" h2="Transformez EML en TIFF dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
