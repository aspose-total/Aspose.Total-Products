---
title: Exporter MSG vers PCL via C++
description: API C++ pour convertir MSG en PCL sans utiliser Microsoft Word ou Outlook
url: /fr/cpp/conversion/msg-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour exporter MSG vers PCL" h2="Transformez MSG en PCL dans une application C++ sans nécessiter Microsoft Word ou Outlook" >}}
