---
title: API C++ pour convertir PPS en FLATOPC
description: Exportez PPS vers FLATOPC dans vos applications C++
url: /fr/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour rendre PPS en FLATOPC" h2="Exportez PPS vers FLATOPC dans des applications C++ sans aucune dépendance Microsoft PowerPoint ou Word" >}}
