---
title: API C++ pour exporter PDF vers DOT
description: Convertissez PDF en DOT dans les applications C++.
url: /fr/cpp/conversion/pdf-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PDF
