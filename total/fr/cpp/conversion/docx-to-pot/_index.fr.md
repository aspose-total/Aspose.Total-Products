---
title: Convertir DOCX en POT via C++ ou avec le convertisseur en ligne gratuit
description: Exportez DOCX vers POT dans vos applications C++ sans utiliser Microsoft Word ou PowerPoint ou en ligne. Testez rapidement le convertisseur en ligne DOCX vers POT gratuit avant d'intégrer le code.
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOCX en POT ou application en ligne" h2="Exportez DOCX vers POT dans vos applications C++ sans utiliser Microsoft Word® ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Conversion DOCX en POT sur C++" %}}
...
6. Enregistrez le document au format POT à l'aide de la méthode [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) et définissez Pot comme SaveFormat
