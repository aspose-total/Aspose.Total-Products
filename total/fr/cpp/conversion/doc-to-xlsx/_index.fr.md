---
title: Convertir DOC en XLSX en C++
description: API C++ pour convertir DOC en XLSX sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir DOC en XLSX" h2="Exportez DOC vers XLSX via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
