---
title: Convertir RTF en DIF en C++
description: API C++ pour convertir RTF en DIF sans utiliser Microsoft Word ou Microsoft Excel
url: /fr/cpp/conversion/rtf-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ pour convertir RTF en DIF" h2="Exportez RTF vers DIF via C++ sans utiliser Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
