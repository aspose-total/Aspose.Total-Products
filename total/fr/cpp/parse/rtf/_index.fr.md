---
title: Extraire le texte et les images du fichier RTF en ligne et en utilisant C++
description: Application d'analyse de fichiers RTF en ligne. Code API C++ pour extraire les images et le contenu textuel du document RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier RTF en ligne ainsi que via C++" h2="Développez une puissante application utilitaire d’analyse de documents RTF basée sur C++.Code C++ répertorié pour l'extraction de texte de document RTF." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier RTF via C++" %}}
...
<h2>Développer une application d'analyse de fichiers RTF via C++</h2>

Besoin de développer une application ou un logiciel d'analyseur RTF ?Avec [Aspose.Words for C++](https://products.aspose.com/words/cpp/), une API enfant de [Aspose.Total for C++](https://products.aspose.com/total/fr/cpp/), tout développeur C++ peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque C++ permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format RTF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire C++ pour traiter le fichier RTF pour l'application d'analyseur" %}}
