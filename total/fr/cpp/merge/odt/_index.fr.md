---
title: Fusionner des fichiers ODT en ligne ou en utilisant C++
description: Application en ligne gratuite pour combiner différents fichiers ODT.Code de bibliothèque de fusion C++ pour fusionner des documents ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Fusionner des documents ODT en ligne via l'application Merger ou en utilisant C++" h2="Développez une puissante application de fusion de documents ODT basée sur C++.Combinez plusieurs documents ODT en un seul en ligne gratuitement via l'application.Enregistrez le fichier ODT au format PDF, Images, Word, Excel, PowerPoint et bien d'autres formats en ligne." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Fusionner des fichiers ODT en ligne à l'aide de l'application" %}}
...
1. Afficher et obtenir le fichier ODT fusionné unique

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Fusionner le fichier ODT via C++" %}}

1. Charger les deux documents
1. Utiliser le AppendDocument ayant le deuxième document comme paramètre
1. Appelez la méthode Save et regroupez les fichiers ODT fusionnés en un seul
...
{{% blocks/products/pf/agp/code-block title="Code C++ : fusionner les fichiers ODT" offSpacer="" %}}
...
<h2>Développer la fusion de fichiers ODT en utilisant C++</h2>

Besoin de développer une application utilitaire C++ pour fusionner facilement plusieurs fichiers ODT ?Avec l'API enfant [Aspose.Words for C++](https://products.aspose.com/words/cpp/) de [Aspose.Total for C++](https://products.aspose.com/total/fr/cpp/), tout développeur C++ peut intégrer le code API ci-dessus pour programmer la fusion d'applications entre documents.La puissante bibliothèque C++ pour la fusion de documents prend en charge de nombreux formats populaires, notamment le format ODT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque de fusion C++ pour les fichiers ODT" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Oui, vous pouvez télécharger ce code. On peut facilement développer une solution professionnelle pour combiner ODT en utilisant C++.Utilisez l'API de fusion Aspose ODT pour développer des logiciels de haut niveau indépendants de la plate-forme en C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
