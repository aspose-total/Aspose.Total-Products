---
title: Supprimez l'annotation DOTX en ligne ou gérez les annotations via C++
description: supprimez gratuitement les commentaires du fichier DOTX via l'application en ligne. Code API C++ pour gérer les commentaires des fichiers DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Effacer les commentaires du document DOTX en ligne ou gérer via C++" h2="Développez une puissante application utilitaire d’annotation de documents DOTX basée sur C++. Code répertorié pour la gestion des commentaires du fichier DOTX via C++." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les annotations DOTX en ligne" %}}

1. Importez le fichier DOTX pour supprimer les commentaires en le téléchargeant
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires du document DOTX via C++" %}}

1. Ajouter une référence de bibliothèque au projet C++
1. Charger le fichier DOTX
...
{{% blocks/products/pf/agp/code-block title="Code C++ : supprimer les commentaires du fichier DOTX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C++ : Ajouter un commentaire au fichier DOTX" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents DOTX via C++</h2>

Besoin de développer une application ou un utilitaire d'annotation DOTX pour fournir des commentaires, faire des suggestions ou collaborer avec d'autres sur le document ?Avec [Aspose.Words for C++](https://products.aspose.com/words/cpp/), une API enfant de [Aspose.Total for C++](https://products.aspose.com/total/fr/cpp/), tout développeur C++ peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque C++ permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format DOTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque C++ pour annoter les fichiers DOTX" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sécuritaire d'utiliser l'application en ligne pour annoter un document DOTX ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'annotation de documents DOTX en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
