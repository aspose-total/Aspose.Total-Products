---
title: Supprimez l'annotation ODT en ligne ou gérez les annotations via C++
description: supprimez gratuitement les commentaires du fichier ODT via l'application en ligne. Code API C++ pour gérer les commentaires des fichiers ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Effacer les commentaires du document ODT en ligne ou gérer via C++" h2="Développez une puissante application utilitaire d’annotation de documents ODT basée sur C++. Code répertorié pour la gestion des commentaires du fichier ODT via C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Supprimer les commentaires du document ODT via C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C++ : supprimer les commentaires du fichier ODT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Code C++ : Ajouter un commentaire au fichier ODT" offSpacer="" %}}
...
<h2>Développer une application d'annotation de documents ODT via C++</h2>

Besoin de développer une application ou un utilitaire d'annotation ODT pour fournir des commentaires, faire des suggestions ou collaborer avec d'autres sur le document ?Avec [Aspose.Words for C++](https://products.aspose.com/words/cpp/), une API enfant de [Aspose.Total for C++](https://products.aspose.com/total/fr/cpp/), tout développeur C++ peut intégrer le code API ci-dessus dans son application d'annotation de documents.La puissante bibliothèque C++ permet de programmer n'importe quelle solution d'annotation de documents.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format ODT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bibliothèque C++ pour annoter les fichiers ODT" %}}
