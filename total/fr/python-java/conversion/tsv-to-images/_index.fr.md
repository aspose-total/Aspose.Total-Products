---
title: Convertir TSV en image en utilisant Python
description: Conversion de TSV en image TIFF BMP PNG JPEG GIF EMF SVG dans vos applications Python sans utiliser Microsoft Excel 
url: /fr/python-java/conversion/tsv-to-images/
family: total
platformtag: Python
feature: conversion
informat: TSV
...
{{% blocks/products/pf/agp/code-block title="Conversion TSV en images via Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="TSV À l'image" description="" >}}
