---
title: Convertir XLSM en image en utilisant Python
description: Conversion de XLSM en image TIFF BMP PNG JPEG GIF EMF SVG dans vos applications Python sans utiliser Microsoft Excel 
url: /fr/python-java/conversion/xlsm-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLSM
...
{{% blocks/products/pf/agp/code-block title="Conversion XLSM en images via Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLSM À l'image" description="" >}}
