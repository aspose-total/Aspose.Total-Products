---
title: Extraire le texte et les images du fichier XLSM en ligne et à l'aide de Python
description: Application d'analyse de fichiers XLSM en ligne. Code API Python pour extraire le texte des lignes et des cellules du document XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analyser le fichier XLSM en ligne ainsi que via Python" h2="Développez une puissante application utilitaire d’analyse de documents XLSM basée sur Python.Code répertorié pour l'analyse des documents XLSM via Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analyser le document XLSM via une application en ligne" %}}

1. Importez le fichier XLSM à analyser en le téléchargeant.
...
{{% blocks/products/pf/agp/feature-section-col title="Analyser le fichier XLSM via Python" %}}

1. API de référence au sein du projet directement depuis PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
1. Charger le fichier XLSM à l'aide de l'objet de classe Workbook
1. Accédez à toutes les feuilles de calcul ou à celle pertinente en utilisant getWorksheets().get(index)
1. Obtenez toutes les cellules en utilisant la méthode getCells()
1. Obtenez la cellule pertinente en passant l'index de ligne et de colonne
1. Utilisez la méthode getValue() pour extraire les données de contenu dans cette cellule
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Exemple de code en Python pour analyser un document XLSM" offSpacer="" %}}
...
<h2>Développer une application d'analyse de fichiers XLSM via Python</h2>

Besoin de développer une application ou un utilitaire d'analyseur XLSM ?Avec [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/), une API enfant de [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/), tout développeur Python peut intégrer le code API ci-dessus dans son application d'analyse de documents.La puissante bibliothèque Python permet de programmer n'importe quelle solution d'analyse de documents pour extraire des images ainsi que du texte.De plus, il peut prendre en charge de nombreux formats populaires, notamment le format XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitaire Python pour traiter le fichier XLSM pour l'application d'analyseur" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Est-il sûr d'utiliser l'application en ligne pour analyser un document XLSM ?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Vous pouvez utiliser n'importe quel navigateur Web moderne comme Google Chrome, Firefox, Opera ou Safari pour l'analyseur de documents XLSM en ligne.Toutefois, si vous développez une application de bureau, nous vous recommandons d'utiliser l'API de traitement de documents Aspose.Total pour une gestion efficace.</span>
                      </div>
                  </li>
              </ul>
          </div>
