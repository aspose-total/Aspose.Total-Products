---
title: Manipulation de PDF et ajout d'OCR via les API Node.js
description: API Node.js pour manipuler des fichiers PDF et extraire du texte à partir d'images via des applications.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Node.js pour l'extraction de PDF et de texte d'image" h2="Extrayez le texte des images et incluez des fonctionnalités de manipulation de PDF dans les applications Node.js sans aucune autre dépendance logicielle." logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total pour Node.js via C++ est un ensemble complet de bibliothèques Node.js.Ces bibliothèques offrent des fonctionnalités telles que travailler directement avec des PDF et améliorer vos applications pour transformer des images en texte.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total pour Node.js via C++ inclut les bibliothèques Node.js suivantes :" >}}
...
Aspose.PDF pour Node.js via C++ vous permet de gérer les fichiers PDF sur le backend. En l'utilisant, vous pouvez optimiser les PDF, incorporer et extraire du texte et des images, ainsi que mettre en œuvre des processus de cryptage et de décryptage. De plus, la fonctionnalité s'étend à la possibilité de diviser et de fusionner sans effort des documents PDF, fournissant ainsi une boîte à outils complète pour une manipulation rationalisée des fichiers PDF.
...
Aspose.OCR pour Node.js via C++ permet l'extraction de texte à partir d'images telles que des pages numérisées et des photos sur des plateformes compatibles Node.js.Améliorez les produits sur site, les services Web et les applications sans serveur avec une puissante fonctionnalité de reconnaissance optique de caractères, prenant en charge 28 langues, dont le chinois et l'hindi dans les formats populaires.
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 Présentation de Node.js via les bibliothèques C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total propose des solutions individuelles pour d'autres plateformes." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/fr/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/fr/nodejs-java/" 
