---
title: Remova a proteção de senha ODT online ou usando Java
description: desbloquear a senha do documento ODT através do aplicativo online gratuitamente. Código API Java para excluir senha de arquivos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Desbloqueie a senha do documento ODT online ou via Java" h2="Desenvolva um poderoso aplicativo utilitário de desbloqueio de documentos ODT baseado em Java.Código listado para remover restrições de senha do arquivo ODT por meio de Java." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Desbloquear senha ODT on-line" %}}

1. Importe o arquivo ODT para desbloquear enviando-o
...
{{% blocks/products/pf/agp/feature-section-col title="Remover senha ODT via Java" %}}

1. Biblioteca Java de referência dentro do projeto
1. Carregue o arquivo ODT protegido por senha usando a classe Document
...
{{% blocks/products/pf/agp/code-block title="Código Java para remover senha do documento ODT" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de proteção ODT via Java</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de proteção ODT?Com [Aspose.Words for Java](https://products.aspose.com/words/pt/java/), uma API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código API acima em seu aplicativo de proteção ou desproteção de documentos.A poderosa biblioteca Java permite programar qualquer solução de proteção de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Java para gerenciar proteção ODT" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para desportar documentos ODT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para desbloquear documentos ODT online.No entanto, se você estiver desenvolvendo um aplicativo de desktop, recomendamos usar a API de processamento de documentos Aspose.Total para um gerenciamento eficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
