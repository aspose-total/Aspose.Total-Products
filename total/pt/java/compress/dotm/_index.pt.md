---
title: Compactar arquivos DOTM online ou via Java
description: Aplicativo online gratuito para compactar diferentes arquivos DOTM. Código da biblioteca de compactação Java para documentos DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo DOTM on-line via aplicativo de compactação ou usando Java" h2="Desenvolva poderosos aplicativos de compactação de documentos DOTM baseados em Java.Comprima gratuitamente vários documentos, incluindo arquivos DOTM on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo DOTM via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Java para compactar arquivos DOTM" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo DOTM usando Java</h2>

Precisa desenvolver um script Java ou um aplicativo utilitário para compactar facilmente vários arquivos DOTM? Com as APIs filhas do [Aspose.Words for Java](https://products.aspose.com/words/java/) do [Aspose.Total for Java](https://products.aspose.com/total/java/), qualquer desenvolvedor Java pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca Java para compactação de documentos suporta muitos formatos populares, incluindo o formato DOTM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação Java para arquivos DOTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos DOTM usando Java. Use a API de compactação Aspose DOTM para desenvolver software independente de plataforma de alto nível em Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
