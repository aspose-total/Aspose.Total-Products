---
title: Visualize e atualize propriedades ODP on-line ou atualize metadados usando Java
description: Visualize e modifique as propriedades do ODP por meio do aplicativo online gratuitamente.Código da API Java para atualizar as propriedades ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados ODP on-line ou atualize via Java" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos ODP baseado em Java.Código listado para atualização de metadados do arquivo ODP por meio de Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Atualizar propriedades ODP via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java para atualizar metadados ODP" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados ODP via Java</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados ODP? Com o [Aspose.Slides for Java](https://products.aspose.com/slides/pt/java/), uma API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Java permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Java para gerenciar metadados ODP" %}}
