---
title: Visualize e atualize propriedades ODT on-line ou atualize metadados usando Java
description: Visualize e modifique as propriedades do ODT por meio do aplicativo online gratuitamente.Código da API Java para atualizar as propriedades ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados ODT on-line ou atualize via Java" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos ODT baseado em Java.Código listado para atualização de metadados de arquivo ODT por meio de Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Atualizar propriedades ODT via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java para atualizar metadados ODT" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados ODT via Java</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados ODT?Com o [Aspose.Words for Java](https://products.aspose.com/words/pt/java/), uma API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Java permite programar qualquer solução de metadados de documentos. Além disso, pode suportar muitos formatos populares, incluindo o formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Java para gerenciar metadados ODT" %}}
