---
title: Visualize e atualize propriedades DOCX on-line ou atualize metadados usando Java
description: Visualize e modifique as propriedades do DOCX por meio do aplicativo online gratuitamente.Código da API Java para atualizar as propriedades DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados DOCX on-line ou atualize via Java" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos DOCX baseado em Java.Código listado para atualização de metadados de arquivo DOCX por meio de Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Atualizar propriedades DOCX via Java" %}}

1. Adicione referência da biblioteca Java ao projeto
1. Carregue o arquivo DOCX usando a classe Document.
1. Obtenha tudo via getCustomDocumentProperties() e getBuiltInDocumentProperties()
1. Use o método setValue para atualizar propriedades
1. Salve o arquivo com metadados atualizados usando o método save()
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java para atualizar metadados DOCX" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados DOCX via Java</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados DOCX?Com o [Aspose.Words for Java](https://products.aspose.com/words/pt/java/), uma API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Java permite programar qualquer solução de metadados de documentos. Além disso, pode suportar muitos formatos populares, incluindo o formato DOCX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Java para gerenciar metadados DOCX" %}}
...
- Pacote separado para Java SE 6 caso você tenha esse JRE desatualizado.
