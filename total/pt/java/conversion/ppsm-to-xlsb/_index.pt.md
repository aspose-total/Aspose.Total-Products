...
description: Converta o formato PPSM para XLSB via Java sem usar o Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPSM para XLSB via Java" h2="API Java no local para exportar PPSM para XLSB sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter PPSM para XLSB, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
