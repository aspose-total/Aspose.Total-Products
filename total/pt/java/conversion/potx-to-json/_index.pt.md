---
title: Converter POTX para o formato JSON via Java
description: Converta o formato POTX para JSON via Java sem usar o Microsoft Excel ou PowerPoint
url_ignore: /pt/java/conversion/potx-to-json/
family: total
platformtag: net
feature: conversion
informat: POTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTX para o formato JSON via Java" h2="API Java no local para exportar POTX para JSON sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
{{% blocks/products/pf/feature-page-summary %}}
Converter o formato POTX para JSON via [Aspose.Total for Java](https://products.aspose.com/total/java/) é um processo simples de duas etapas. Na primeira etapa, você pode exportar POTX para HTML usando [Aspose.Slides for Java](https://products.aspose.com/slides/java/). Em segundo lugar, usando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), você pode converter HTML em JSON.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converter POTX para o formato JSON via Java" %}}
...
Usando a API, você também pode abrir o documento protegido por senha. Se o documento POTX de entrada estiver protegido por senha, você não poderá convertê-lo para o formato JSON sem usar a senha. A API permite que você abra o documento criptografado passando a senha correta em um objeto LoadOptions.  
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter POTX Protegido para o Formato JSON via Java" %}}
