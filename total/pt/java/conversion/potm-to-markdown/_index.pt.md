...
description: Converta o formato POTM para MARKDOWN via Java sem usar o Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTM para MARKDOWN via Java" h2="API Java no local para exportar POTM para MARKDOWN sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter POTM para MARKDOWN, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
