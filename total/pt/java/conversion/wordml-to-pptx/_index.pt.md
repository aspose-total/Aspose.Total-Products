...
url: /pt/java/conversion/wordml-to-pptx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
6. Salve o wordmlumento no PPTX usando o método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
A API também permite converter wordmlumentos WORDML protegidos por senha em PPTX. Se o wordmlumento WORDML de entrada estiver protegido por senha, você não poderá convertê-lo para o formato PPTX sem usar a senha. Para abrir um wordmlumento criptografado, você pode definir a senha correta no objeto LoadOptions e passá-la para o construtor Wordmlument.  
{{% blocks/products/pf/feature-page-code %}}
