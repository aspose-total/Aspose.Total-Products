---
title: API Java para converter DOTM para XLTX
description: Converta DOTM para XLTX via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/java/conversion/dotm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter DOTM para XLTX via Java" h2="API Java no local para converter DOTM para XLTX sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ para converter DOTM para XLTX" %}}
...
4. Salve o dotmumento no formato XLTX usando [Salvar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) método
