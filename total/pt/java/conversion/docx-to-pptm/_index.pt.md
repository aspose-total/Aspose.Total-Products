---
title: Converter DOCX para PPTM via Java
description: API Java para exportar DOCX para PPTM sem usar o Microsoft Word ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter DOCX para PPTM via Java" h2="Conversão de DOCX para PPTM usando a API Java local em qualquer aplicativo Java J2SE, J2EE, J2ME sem usar o Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
...
Para conversão de arquivos DOCX para PPTM, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
