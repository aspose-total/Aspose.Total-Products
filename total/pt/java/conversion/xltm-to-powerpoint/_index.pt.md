...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar XLTM para POWERPOINT ou online" h2="On Premise Java API para exportar XLTM para POWERPOINT sem depender do Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/xltm-to-powerpointx/" name="XLTM Para POWERPOINTX" description="" >}}
