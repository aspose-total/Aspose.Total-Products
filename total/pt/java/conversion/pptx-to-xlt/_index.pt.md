...
description: Converta o formato PPTX para XLT via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/java/conversion/pptx-to-xlt/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPTX para XLT via Java" h2="API Java no local para exportar PPTX para XLT sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter PPTX para XLT, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
