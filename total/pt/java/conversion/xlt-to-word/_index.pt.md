...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar XLT para WORD ou online" h2="On Premise Java API para exportar XLT para WORD sem depender do Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/xlt-to-wordx/" name="XLT Para WORDX" description="" >}}
