...
description: Converta DOCX para XLSM via Java sem usar o Microsoft Word ou o Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter DOCX para XLSM via Java" h2="API Java no local para converter DOCX para XLSM sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o documento no formato XLSM usando [Salvar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) método
