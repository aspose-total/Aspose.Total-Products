---
title: API Java para converter MOBI para EXCEL
description: Converta MOBI para EXCEL via Java sem usar o Microsoft Word ou o Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter MOBI para EXCEL via Java" h2="API Java no local para converter MOBI para EXCEL sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o mobiumento no formato EXCEL usando [Salvar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) método
