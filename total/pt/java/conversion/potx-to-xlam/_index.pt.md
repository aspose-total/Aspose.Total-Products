...
description: Converta o formato POTX para XLAM via Java sem usar o Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTX para XLAM via Java" h2="API Java no local para exportar POTX para XLAM sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
