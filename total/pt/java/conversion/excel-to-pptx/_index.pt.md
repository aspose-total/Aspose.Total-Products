---
title: Converter EXCEL para PPTX usando Java ou com o conversor online grátis
description: API Java para exportar EXCEL para PPTX ou online usando Excel ou Word ou on-line. Teste o conversor online gratuito de CSV para DOC rapidamente antes de integrar o código.
url_ignore: /pt/java/conversion/excel-to-pptx/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar EXCEL para PPTX ou online" h2="On Premise Java API para exportar EXCEL para PPTX sem depender do Microsoft Excel&reg;" >}}
{{% blocks/products/pf/feature-page-summary %}}
A renderização de EXCEL para PPTX é um processo de duas etapas. Você primeiro usará a API [Aspose.Cells for Java](https://products.aspose.com/cells/java) para converter o documento EXCEL fornecido em PDF e, em seguida, usará [Aspose.Pdf for Java](https://products.aspose.com/pdf/java), você pode facilmente converter seu documento PDF em PPTX. Ambas as APIs fazem parte da coleção de bibliotecas de automação de formato de arquivo [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
...
<h3>Conversor Online de EXCEL para PPTX</h3>
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/excel-to-pptxx/" name="EXCEL Para PPTXX" description="" >}}
