---
title: Converter MD para ODP via API Java
description: API Java para converter MD para ODP sem usar o Microsoft Word
url_ignore: /pt/java/conversion/md-to-odp/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar MD para ODP" h2="Exporte MD para ODP via API Java local sem usar o Microsoft<sup>&reg;</sup> PowerPoint ou Adobe<sup>&reg;</sup> Acrobat Reader" >}}
{{% blocks/products/pf/feature-page-summary %}}
Usando [Aspose.Total for Java](https://products.aspose.com/total/java/) você pode facilmente converter MD para ODP em qualquer aplicativo Java J2SE, J2EE, J2ME. Em primeiro lugar, usando [Aspose.PDF for Java](https://products.aspose.com/pdf/java/), você pode exportar MD para PPTX. Depois disso, usando [Aspose.Slides for Java](https://products.aspose.com/slides/java/) API de processamento do PowerPoint, você pode converter PPTX para ODP.
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API Java para converter MD em ODP" %}}
...
Converter Markdown (MD) para ODP (OpenDocument Presentation) permite às equipes transformar conteúdo simples baseado em texto em apresentações em formato aberto utilizáveis no LibreOffice Impress e em outras ferramentas de apresentação de código aberto. ODP é ideal para compartilhamento entre plataformas sem restrições proprietárias.
...
* Transformar notas de treinamento em Markdown em slides ODP.

* Apresentações em sala de aula criadas a partir de planos de aula baseados em MD.

* Publicar decks de conferência de código aberto gerados a partir de Markdown.

* Converter documentação em MD em slides ODP visualmente estruturados.
...
* Pipelines ETL gerando arquivos ODP a partir de repositórios Markdown.

* Criação em lote de apresentações educacionais para plataformas LMS.

* Produção automatizada de ODP em fluxos de trabalho de documentação como código.

* Conversão de MD para ODP acionada por lançamentos de projetos de código aberto.
