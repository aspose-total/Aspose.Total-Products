---
title: Converter DOC para PPSM via Java
description: API Java para exportar DOC para PPSM sem usar o Microsoft Word ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter DOC para PPSM via Java" h2="Conversão de DOC para PPSM usando a API Java local em qualquer aplicativo Java J2SE, J2EE, J2ME sem usar o Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
