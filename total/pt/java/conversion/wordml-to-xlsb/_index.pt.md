---
title: API Java para converter WORDML para XLSB
description: Converta WORDML para XLSB via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/java/conversion/wordml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter WORDML para XLSB via Java" h2="API Java no local para converter WORDML para XLSB sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
