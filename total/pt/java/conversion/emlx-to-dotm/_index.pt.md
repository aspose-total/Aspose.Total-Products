...
{{< /blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/feature-page-summary %}}
**E-mails EMLX** podem ser convertidos em **Modelos de Documento do Word habilitados para macro (DOTM)** para fluxos de trabalho de documentos reutilizáveis e automatizados.  

## ✅ Principais Casos de Uso  
- Criar modelos reutilizáveis a partir de e-mails estruturados  
- Incorporar macros em modelos para automação  
- Padronizar fluxos de trabalho empresariais a partir de formatos de e-mail  
- Geração de modelos legais e de conformidade  

## ⚙️ Cenários de Automação  
- Geração automática de modelos a partir de dados EMLX  
- Fluxos de trabalho DOTM para automação de documentos empresariais  
- Integração com sistemas de conformidade e relatórios  
- Pipelines de EMLX para DOTM para registros legais/empresariais  
