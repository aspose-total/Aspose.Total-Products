...
url: /pt/java/conversion/docm-to-ppsm/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
A API também permite converter documents DOCM protegidos por senha em PPSM. Se o ddocumentDOCM de entrada estiver protegido por senha, você não poderá convertê-lo para o formato PPSM sem usar a senha. Para abrir um dodocumentriptografado, você pode definir a senha correta no objeto LoadOptions e passá-la para o construtor Docmument.  
{{% blocks/products/pf/feature-page-code %}}
