---
title: Exportar OFT para GIF via Java
description: API Java para converter OFT para GIF sem usar o Microsoft Word ou Outlook
url_ignore: /pt/java/conversion/oft-to-gif/
family: total
platformtag: net
feature: conversion
informat: OFT
