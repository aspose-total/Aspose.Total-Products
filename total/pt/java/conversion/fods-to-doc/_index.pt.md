---
title: Converter FODS para DOC usando Java
description: API Java para exportar FODS para DOC usando Excel ou Word
url: /pt/java/conversion/fods-to-doc/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar FODS para DOC" h2="On Premise Java API para exportar FODS para DOC sem depender do Microsoft Excel&reg;" >}}
...
1. Abra o arquivo FODS usando a classe [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
