...
description: Converta o formato PPS para XLS via Java sem usar o Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para XLS via Java" h2="API Java no local para exportar PPS para XLS sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter PPS para XLS, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
