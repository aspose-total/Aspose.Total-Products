---
title: Converter FLATOPC para PPS via Java
description: API Java para exportar FLATOPC para PPS sem usar o Microsoft Word ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter FLATOPC para PPS via Java" h2="Conversão de FLATOPC para PPS usando a API Java local em qualquer aplicativo Java J2SE, J2EE, J2ME sem usar o Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
...
6. Salve o flatopcumento no PPS usando o método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversão" %}}
Para conversão de arquivos FLATOPC para PPS, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
