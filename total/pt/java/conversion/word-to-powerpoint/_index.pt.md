---
title: Converter WORD para POWERPOINT via Java
description: API Java para exportar WORD para POWERPOINT sem usar o Microsoft Word ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter WORD para POWERPOINT via Java" h2="Conversão de WORD para POWERPOINT usando a API Java local em qualquer aplicativo Java J2SE, J2EE, J2ME sem usar o Microsoft<sup>&reg;</sup> PowerPoint ou Word" >}}
