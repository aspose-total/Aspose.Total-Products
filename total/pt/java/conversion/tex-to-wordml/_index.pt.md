---
title: API Java para exportar TEX para WORDML
description: Converter TEX para WORDML usando a API Java local
url_ignore: /pt/java/conversion/tex-to-wordml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Transforme TEX em WORDML via Java" h2="On Premise Java API para renderizar TEX para WORDML sem usar nenhum aplicativo de terceiros" >}}
{{% blocks/products/pf/feature-page-summary %}}
Você pode converter TEX para WORDML usando duas etapas simples. Primeiro você precisa renderizar o arquivo TEX para DOC usando [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Depois disso, usando a poderosa API de processamento de documentos [Aspose.Words for Java](https://products.aspose.com/words/java/), você pode converter DOC para WORDML. Ambas as APIs estão no pacote [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API Java para converter TEX em WORDML" %}}
