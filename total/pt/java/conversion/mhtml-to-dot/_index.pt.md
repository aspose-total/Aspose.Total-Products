---
title: API Java para exportar MHTML para DOT
description: Converter MHTML para DOT usando a API Java local
url_ignore: /pt/java/conversion/mhtml-to-dot/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Transforme MHTML em DOT via Java" h2="On Premise Java API para renderizar MHTML para DOT sem usar nenhum aplicativo de terceiros" >}}
{{% blocks/products/pf/feature-page-summary %}}
Você pode converter MHTML para DOT usando duas etapas simples. Primeiro você precisa renderizar o arquivo MHTML para DOC usando [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Depois disso, usando a poderosa API de processamento de documentos [Aspose.Words for Java](https://products.aspose.com/words/java/), você pode converter DOC para DOT. Ambas as APIs estão no pacote [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="API Java para converter MHTML em DOT" %}}
...
4. Salve o documento no formato DOT usando o método [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) e defina o DOT como SalvarFormato
