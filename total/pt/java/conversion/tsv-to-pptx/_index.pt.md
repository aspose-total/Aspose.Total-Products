---
title: Converter TSV para PPTX usando Java
description: API Java para exportar TSV para PPTX usando Excel ou Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="API Java para exportar TSV para PPTX" h2="On Premise Java API para exportar TSV para PPTX sem depender do Microsoft Excel&reg;" >}}
{{% blocks/products/pf/feature-page-summary %}}
A renderização de TSV para PPTX é um processo de duas etapas. Você primeiro usará a API [Aspose.Cells for Java](https://products.aspose.com/cells/java) para converter o pptxumento TSV fornecido em PDF e, em seguida, usará [Aspose.Pdf for Java](https ://products.aspose.com/pdf/java), você pode facilmente converter seu pptxumento PDF em PPTX. Ambas as APIs fazem parte da coleção de bibliotecas de automação de formato de arquivo [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
