---
title: API Java para converter OTT para XLS
description: Converta OTT para XLS via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/java/conversion/ott-to-xls/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter OTT para XLS via Java" h2="API Java no local para converter OTT para XLS sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
{{% blocks/products/pf/feature-page-summary %}}
Converter OTT para XLS via [Aspose.Total for Java](https://products.aspose.com/total/java/) é um processo simples de duas etapas. Usando a API de conversão e manipulação de ottumentos rica em recursos [Aspose.Words for Java](https://products.aspose.com/words/java/), você pode exportar OTT para HTML. Depois disso, usando [Aspose.Cells for Java](https://products.aspose.com/cells/java/), você pode converter HTML para XLS.
{{% /blocks/products/pf/feature-page-summary  %}}
...
4. Salve o ottumento no formato XLS usando [Salvar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) método
