---
title: Converter PPSM para formato XLSM via Java
description: Converta o formato PPSM para XLSM via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/java/conversion/ppsm-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPSM para XLSM via Java" h2="API Java no local para exportar PPSM para XLSM sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter PPSM para XLSM, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
