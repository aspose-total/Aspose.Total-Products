---
title: Converter POWERPOINT para formato SXC via Java
description: Converta o formato POWERPOINT para SXC via Java sem usar o Microsoft Excel ou PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POWERPOINT para SXC via Java" h2="API Java no local para exportar POWERPOINT para SXC sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
2. Converta POWERPOINT em HTML usando [salvar](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) método
...
Para converter POWERPOINT para SXC, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
