---
title: Converter PPS para formato SXC via Java
description: Converta o formato PPS para SXC via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/java/conversion/pps-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para SXC via Java" h2="API Java no local para exportar PPS para SXC sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter PPS para SXC, você pode facilmente usar o Aspose.Total para Java diretamente de um [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e inclua bibliotecas em seu pom.xml.
