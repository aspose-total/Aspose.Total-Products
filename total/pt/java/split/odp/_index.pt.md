---
title: Divida arquivos ODP online ou via Java
description: Aplicativo online gratuito para dividir diferentes arquivos ODP. Código da biblioteca Java Splitter para documentos ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Divida arquivos ODP online via aplicativo Splitter ou usando Java" h2="Desenvolva aplicativos poderosos de divisão de documentos ODP baseados em Java.Divida documentos gratuitamente, incluindo arquivos ODP on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir arquivo ODP via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Java para dividir arquivos ODP" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo divisor de arquivos ODP usando Java</h2>

Precisa desenvolver um script Java ou um aplicativo utilitário para dividir facilmente arquivos ODP?Com [Aspose.Slides for Java](https://products.aspose.com/slides/pt/java/), API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código API acima para programar o aplicativo divisor.A poderosa biblioteca Java para divisor de documentos suporta muitos formatos populares, incluindo o formato ODP, como PDF, documentos do Microsoft Word, planilhas do Excel e apresentações do PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca ODP Splitter para Java" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código.Pode-se desenvolver facilmente uma solução profissional para dividir arquivos ODP usando Java.Use a API Aspose ODP Splitter para desenvolver software independente de plataforma de alto nível em Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
