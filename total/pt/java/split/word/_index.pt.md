---
title: Divida o arquivo Word online ou via Java
description: Aplicativo online gratuito para dividir diferentes arquivos Word.Código da biblioteca divisor Java para documentos Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Divida arquivos Word online via aplicativo Splitter ou usando Java" h2="Desenvolva aplicativos poderosos de divisão de documentos Word baseados em Java.Divida documentos gratuitamente, incluindo arquivos Word on-line por meio do aplicativo com download instantâneo." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Divida arquivos Word online usando o aplicativo" %}}

1. Carregue o arquivo Word para dividir.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir arquivo Word via Java" %}}

1. Adicione referência à biblioteca Java em seu projeto.
1. Carregue o documento Word usando a classe Document.
1. Conte o número total de páginas no arquivo Word.
1. Percorra cada página e use extractPages para extrair a página.
1. Salve a página extraída em um novo arquivo.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Exemplo de código em Java para dividir arquivos Word em páginas sábias" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código Java para dividir a seção de arquivos Word" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo divisor de arquivos Word usando Java</h2>

Precisa desenvolver um script Java ou um aplicativo utilitário para dividir facilmente arquivos Word?Com [Aspose.Words for Java](https://products.aspose.com/words/pt/java/), API filha do [Aspose.Total for Java](https://products.aspose.com/total/pt/java/), qualquer desenvolvedor Java pode integrar o código API acima para programar o aplicativo divisor.A poderosa biblioteca Java para divisão de documentos suporta muitos formatos populares, incluindo o formato Word, como arquivos PDF, Word, Excel e PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca Word Splitter para Java" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para dividir arquivos Word usando Java. Use a API divisor Aspose Word para desenvolver software independente de plataforma de alto nível em Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para dividir vários documentos Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para o divisor de documentos Word online.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Quanto tempo leva para dividir os arquivos Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
