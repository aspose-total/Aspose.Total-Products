---
title: Manipulação de PDF e adição de OCR por meio de APIs Node.js
description: API Node.js para manipular arquivos PDF, bem como extrair texto de imagens por meio de aplicativos.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API Node.js para extração de PDF e texto de imagem" h2="Extraia texto de imagens e inclua recursos de manipulação de PDF em aplicativos Node.js sem quaisquer outras dependências de software" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ é um conjunto completo de bibliotecas Node.js.Essas bibliotecas oferecem funcionalidades como trabalhar diretamente com PDFs e aprimorar suas aplicações para transformar imagens em texto.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ inclui as seguintes bibliotecas Node.js:" >}}
...
Aspose.PDF for Node.js via C++ permite que você manipule arquivos PDF no backend. Com ele você pode otimizar PDFs, incorporar e extrair textos e imagens, bem como implementar processos de criptografia e descriptografia. Além disso, a funcionalidade se estende à capacidade de dividir e mesclar documentos PDF sem esforço, fornecendo um kit de ferramentas abrangente para manipulação simplificada de arquivos PDF.
...
Aspose.OCR for Node.js via C++ permite a extração de texto de imagens como páginas digitalizadas e fotos em plataformas compatíveis com Node.js.Aprimore produtos locais, serviços Web e aplicativos sem servidor com poderosa funcionalidade de reconhecimento óptico de caracteres, com suporte para 28 idiomas, incluindo chinês e hindi em formatos populares.
{{< /blocks/products/pf/total/product-item >}}
...
O Aspose.Font for Node.js via C++ permite aos programadores carregar, renderizar e guardar vários formatos de fonte, incluindo TrueType, WOFF, EOT, OpenType, CFF e Type1. Concebido para simplificar operações complexas de tipos de letra, para que os programadores Node. js se possam concentrar facilmente na criação de aplicações excecionais sem o incómodo do manuseamento complexo de tipos de letra.
{{< /blocks/products/pf/total/product-item >}}
<!--<p></p>-->
<h2 class="pr-ft">
 <a class="anchor" id="features" name="features">
 </a>
 Visão geral do Node.js por meio de bibliotecas C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Adicione imagens em documentos PDF
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Converta arquivos PDF em imagens
 </p>
</div>
<div class="col-lg-4">
    <em class="fa fa-file-text-o ico-blue fa-2x col-lg-2">
...
{{< blocks/products/pf/testimonials title="O que as pessoas estão dizendo" subTitle="Não acredite apenas na nossa palavra. Veja o que os usuários têm a dizer sobre as APIs Aspose.Total." caseStudiesLink="https://releases.aspose.com/corporate/case-studies/aspose.total/" >}}
...
{{< blocks/products/pf/testimonials-quote poster="Bryan Thorton | Net Reaction LLC, EUA" >}}
Temos experiência significativa com o produto Office Automation e Office Writer da Soft Artisans. O Total.NET da Aspose é mais robusto, oferecendo mais funcionalidades do que qualquer coisa que usamos no passado.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Marcos Foley | Leão Nathan National Foods, Austrália" >}}
Efetivamente, o conjunto Aspose.Total for .NET é o 'canivete suíço' de componentes que usamos. Ao lado dos componentes da camada de apresentação, ele forma a 'cola' para extrair e enviar arquivos de dados no formato desejado.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualétech, França" >}}
A implementação foi direta, nós realmente nos concentramos em nossa arquitetura e o Aspose se encaixa perfeitamente. Nossa arquitetura é altamente otimizada para desempenho e multithreading e, novamente, não há problema em usar Aspose.Total.net.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Referências de API" href="https://reference.aspose.com/" >}} 
{{< blocks/products/pf/slr-element name="Vídeos tutoriais" href="https://www.youtube.com/user/asposevideo" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Suporte ao produto" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Suporte Gratuito" href="https://forum.aspose.com/c/total/7" >}} 
{{< blocks/products/pf/slr-element name="Suporte pago" href="https://helpdesk.aspose.com/" >}} 
{{< blocks/products/pf/slr-element name="Blogue" href="https://blog.aspose.com/" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Total para C++" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total oferece soluções individuais para outras plataformas." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/pt/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/pt/nodejs-java/" 
