---
title: Atualize o arquivo XLSX usando C++
description: Modifique o documento XLSX em aplicativos C++ sem usar o Microsoft Excel.
family: total
platformtag: C++
feature: update
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Atualize o arquivo XLSX via C++" h2="Modifique planilhas XLSX por meio de aplicativos baseados em C++ sem instalar o Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como atualizar o arquivo XLSX em C++" %}}

- Carregue o arquivo XLSX usando [CreateIWorkbook](https://reference.aspose.com/cells/cpp/class/aspose.cells.factory#a93f7282b976d2a001d44198dedaceee8)
...
- Para modificação XLSX, seguindo [requisitos de sistema](https://docs.aspose.com/cells/cpp/system-requirements/) para sistemas Windows e Linux 
...
{{% blocks/products/pf/agp/code-block title="Código - Atualizar arquivo XLSX em C++" offSpacer="" %}}
