---
title: Atualize o arquivo XLTM usando C++
description: Modifique o documento XLTM em aplicativos C++ sem usar o Microsoft Excel.
family: total
platformtag: C++
feature: update
informat: XLTM
...
- Para modificação XLTM, seguindo [requisitos de sistema](https://docs.aspose.com/cells/cpp/system-requirements/) para sistemas Windows e Linux 
...
{{% blocks/products/pf/agp/code-block title="Código - Atualizar arquivo XLTM em C++" offSpacer="" %}}
