---
title: Atualize o arquivo XLSB usando C++
description: Modifique o documento XLSB em aplicativos C++ sem usar o Microsoft Excel.
family: total
platformtag: C++
feature: update
informat: XLSB
...
- Para modificação XLSB, seguindo [requisitos de sistema](https://docs.aspose.com/cells/cpp/system-requirements/) para sistemas Windows e Linux 
...
{{% blocks/products/pf/agp/code-block title="Código - Atualizar arquivo XLSB em C++" offSpacer="" %}}
