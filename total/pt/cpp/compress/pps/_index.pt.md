---
title: Compactar arquivos PPS online ou via C++
description: Aplicativo online gratuito para compactar diferentes arquivos PPS.Código da biblioteca de compactação C++ para documentos PPS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo PPS on-line por meio do aplicativo de compactação ou usando C++" h2="Desenvolva aplicativos poderosos de compactação de documentos PPS baseados em C++.Comprima gratuitamente vários documentos, incluindo arquivos PPS on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo PPS via C++" %}}

1. Adicione referência da biblioteca C++ ao projeto
1. Carregue a apresentação PPS
1. Usar o método Compress::RemoveUnusedMasterSlides
1. Chame o método Save e obtenha a apresentação PPS compactada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código C++: compactar apresentação PPS" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo PPS usando C++</h2>

Precisa desenvolver um script C++ ou um aplicativo utilitário para compactar facilmente vários arquivos PPS?Com o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), APIs filhas do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca C++ para compactação de documentos suporta muitos formatos populares, incluindo o formato PPS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação C++ para arquivos PPS" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos PPS usando C++.Use a API de compactação Aspose PPS para desenvolver software independente de plataforma de alto nível em C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
