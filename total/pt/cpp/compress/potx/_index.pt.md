---
title: Compactar arquivos POTX online ou via C++
description: Aplicativo online gratuito para compactar diferentes arquivos POTX.Código da biblioteca de compactação C++ para documentos POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo POTX on-line por meio do aplicativo de compactação ou usando C++" h2="Desenvolva aplicativos poderosos de compactação de documentos POTX baseados em C++.Comprima gratuitamente vários documentos, incluindo arquivos POTX on-line por meio do aplicativo com download instantâneo." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compacte e otimize arquivos POTX on-line usando o aplicativo" %}}

1. Carregue arquivos POTX para compactar e otimizar.
1. Escolha o nível de compressão (baixo, médio ou alto)
1. Clique no botão "Compactar".
1. Baixe o arquivo POTX compactado.
1. Visualize e obtenha o resultado da compactação verificando seu tamanho e qualidade do conteúdo.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo POTX via C++" %}}

1. Adicione referência da biblioteca C++ ao projeto
1. Carregue a apresentação POTX
1. Usar o método Compress::RemoveUnusedMasterSlides
1. Chame o método Save e obtenha a apresentação POTX compactada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código C++: compactar apresentação POTX" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo POTX usando C++</h2>

Precisa desenvolver um script C++ ou um aplicativo utilitário para compactar facilmente vários arquivos POTX?Com o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), APIs filhas do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca C++ para compactação de documentos suporta muitos formatos populares, incluindo o formato POTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação C++ para arquivos POTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos POTX usando C++.Use a API de compactação Aspose POTX para desenvolver software independente de plataforma de alto nível em C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para compactar vários documentos POTX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para compactação online de documentos POTX.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Como posso compactar vários arquivos POTX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Comece enviando um ou mais arquivos que deseja compactar. Você pode arrastar e soltar seus arquivos POTX ou simplesmente clicar dentro da área branca.Depois, clique no botão ‘Compactar’ e nosso aplicativo de compactação online processará rapidamente os arquivos enviados.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Quanto tempo leva para compactar os arquivos POTX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
