---
title: Compactar arquivos ODP online ou via C++
description: Aplicativo online gratuito para compactar diferentes arquivos ODP.Código da biblioteca de compactação C++ para documentos ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo ODP on-line por meio do aplicativo de compactação ou usando C++" h2="Desenvolva aplicativos poderosos de compactação de documentos ODP baseados em C++.Comprima gratuitamente vários documentos, incluindo arquivos ODP on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo ODP via C++" %}}

1. Adicione referência da biblioteca C++ ao projeto
1. Carregue a apresentação ODP
1. Usar o método Compress::RemoveUnusedMasterSlides
1. Chame o método Save e obtenha a apresentação ODP compactada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código C++: compactar apresentação ODP" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo ODP usando C++</h2>

Precisa desenvolver um script C++ ou um aplicativo utilitário para compactar facilmente vários arquivos ODP?Com o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), APIs filhas do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca C++ para compactação de documentos suporta muitos formatos populares, incluindo o formato ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação C++ para arquivos ODP" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos ODP usando C++.Use a API de compactação Aspose ODP para desenvolver software independente de plataforma de alto nível em C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
