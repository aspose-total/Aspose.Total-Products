---
title: Compactar arquivos PPSX online ou via C++
description: Aplicativo online gratuito para compactar diferentes arquivos PPSX.Código da biblioteca de compactação C++ para documentos PPSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo PPSX on-line por meio do aplicativo de compactação ou usando C++" h2="Desenvolva aplicativos poderosos de compactação de documentos PPSX baseados em C++.Comprima gratuitamente vários documentos, incluindo arquivos PPSX on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo PPSX via C++" %}}

1. Adicione referência da biblioteca C++ ao projeto
1. Carregue a apresentação PPSX
1. Usar o método Compress::RemoveUnusedMasterSlides
1. Chame o método Save e obtenha a apresentação PPSX compactada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código C++: compactar apresentação PPSX" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo PPSX usando C++</h2>

Precisa desenvolver um script C++ ou um aplicativo utilitário para compactar facilmente vários arquivos PPSX?Com o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), APIs filhas do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca C++ para compactação de documentos suporta muitos formatos populares, incluindo o formato PPSX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação C++ para arquivos PPSX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos PPSX usando C++.Use a API de compactação Aspose PPSX para desenvolver software independente de plataforma de alto nível em C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
