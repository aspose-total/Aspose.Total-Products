---
title: Remova a anotação PPTX online ou gerencie anotações via C++
description: exclua comentários do arquivo PPTX por meio do aplicativo online gratuitamente.Código API C++ para gerenciar comentários de arquivos PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Limpar comentários da apresentação PPTX online ou gerenciar via C++" h2="Desenvolva um poderoso aplicativo utilitário de anotação de apresentação PPTX baseado em C++.Código listado para gerenciar comentários do arquivo PPTX através de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Remover comentários da apresentação PPTX via C++" %}}

1. Adicionar referência de biblioteca ao projeto C++
1. Carregar apresentação PPTX
1. Iterar através de cada autor via apresentação->get_CommentAuthors()
1. Invoque o método get_Comments()->Clear() para excluir seu comentário
1. Invoque o método get_CommentAuthors()->Clear() para remover todos os autores
...
<h2>Desenvolva aplicativo de anotação de documentos PPTX via C++</h2>

Precisa desenvolver um aplicativo ou utilitário de anotação PPTX para fornecer feedback, fazer sugestões ou colaborar com outras pessoas no documento?Com o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), uma API filha do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima em seu aplicativo de anotação de documentos.A poderosa biblioteca C++ permite programar qualquer solução de anotação de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato PPTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca C++ para anotar arquivos PPTX" %}}
...
- Install a [Pacote NuGet](https://www.nuget.org/packages/Aspose.Slides.Cpp/). See [Documentação](https://docs.aspose.com/slides/cpp/installation/#option-one-install-or-update-asposeslides-for-c-from-the-nuget-package-manager)
