---
title: Remova a anotação RTF online ou gerencie anotações via C++
description: exclua comentários do arquivo RTF por meio do aplicativo online gratuitamente. Código API C++ para gerenciar comentários de arquivos RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Limpar comentários do documento RTF online ou gerenciar via C++" h2="Desenvolva um poderoso aplicativo utilitário de anotação de documentos RTF baseado em C++. Código listado para gerenciar comentários do arquivo RTF através de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Excluir comentários do documento RTF via C++" %}}

1. Adicionar referência de biblioteca ao projeto C++
1. Carregar arquivo RTF
...
{{% blocks/products/pf/agp/code-block title="Código C++: Excluir comentários do arquivo RTF" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C++: Adicionar comentário ao arquivo RTF" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de anotação de documentos RTF via C++</h2>

Precisa desenvolver um aplicativo ou utilitário de anotação RTF para fornecer feedback, fazer sugestões ou colaborar com outras pessoas no documento?Com o [Aspose.Words for C++](https://products.aspose.com/words/cpp/), uma API filha do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima em seu aplicativo de anotação de documentos.A poderosa biblioteca C++ permite programar qualquer solução de anotação de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato RTF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca C++ para anotar arquivos RTF" %}}
