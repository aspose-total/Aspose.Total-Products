---
title: Visualize e atualize propriedades XLSM on-line ou adicione metadados usando C++
description: Visualize e modifique as propriedades do XLSM por meio do aplicativo online gratuitamente.Código da API C++ para adicionar propriedades XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados XLSM on-line ou atualize via C++" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos XLSM baseado em C++.Código listado para adicionar metadados de arquivo XLSM por meio de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gerenciar propriedades XLSM via C++" %}}

1. Opções de metadados definidos usando MetadataType::Document_Properties
1. Carregue a planilha XLSM usando WorkbookMetadata e opções como parâmetro
...
{{% blocks/products/pf/agp/code-block title="Código C++: Adicionar metadados XLSM" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados XLSM via C++</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados XLSM?Com o [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/), uma API filha do [Aspose.Total for C++](https://products.aspose.com/total/pt/cpp/), qualquer desenvolvedor C++ pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca C++ permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário C++ para gerenciar metadados XLSM" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para gerenciar propriedades de documentos XLSM?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
