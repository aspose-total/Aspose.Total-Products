---
title: API C++ para converter POWERPOINT em RTF
description: Exporte POWERPOINT para RTF em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para RTF" h2="Exporte POWERPOINT para RTF em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
