---
title: API C++ para converter PPTM em DOTM
description: Exporte PPTM para DOTM em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para DOTM" h2="Exporte PPTM para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
