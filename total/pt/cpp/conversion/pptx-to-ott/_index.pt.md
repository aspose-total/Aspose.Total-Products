---
title: API C++ para converter PPTX em OTT
description: Exporte PPTX para OTT em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para OTT" h2="Exporte PPTX para OTT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
