---
title: API C++ para converter POTM em DOC
description: Exporte POTM para DOC em seus aplicativos C++
url: /pt/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTM para DOC" h2="Exporte POTM para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
4. Salve o documento no formato DOC usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string)
