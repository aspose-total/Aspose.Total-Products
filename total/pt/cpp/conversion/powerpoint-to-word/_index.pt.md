---
title: API C++ para converter POWERPOINT em WORD
description: Exporte POWERPOINT para WORD em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para WORD" h2="Exporte POWERPOINT para WORD em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
