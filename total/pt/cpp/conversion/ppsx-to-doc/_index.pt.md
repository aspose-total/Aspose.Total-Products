---
title: API C++ para converter PPSX em DOC
description: Exporte PPSX para DOC em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para DOC" h2="Exporte PPSX para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
