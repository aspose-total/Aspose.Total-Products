...
description: Exporte PPT para XLSB em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/ppt-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Converter PPT para XLSB via C++" h2="Conversão de arquivo PPT para XLSB via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
