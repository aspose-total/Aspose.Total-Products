---
title: API C++ para converter PPT em DOC
description: Exporte PPT para DOC em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para DOC" h2="Exporte PPT para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
