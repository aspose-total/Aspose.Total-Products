---
title: Converter DOCX para CSV em C++
description: API C++ para converter DOCX para CSV sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/cpp/conversion/docx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter DOCX para CSV" h2="Exporte DOCX para CSV via C++ sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ para converter DOCX para CSV" %}}
