...
description: Exporte PPT para XLS em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/ppt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Converter PPT para XLS via C++" h2="Conversão de arquivo PPT para XLS via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
