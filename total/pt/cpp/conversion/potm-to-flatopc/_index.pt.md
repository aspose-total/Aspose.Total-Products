---
title: API C++ para converter POTM em FLATOPC
description: Exporte POTM para FLATOPC em seus aplicativos C++
url: /pt/cpp/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTM para FLATOPC" h2="Exporte POTM para FLATOPC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
