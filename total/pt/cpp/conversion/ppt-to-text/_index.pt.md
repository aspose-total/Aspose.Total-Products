---
title: API C++ para converter PPT em TEXT
description: Exporte PPT para TEXT em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para TEXT" h2="Exporte PPT para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
