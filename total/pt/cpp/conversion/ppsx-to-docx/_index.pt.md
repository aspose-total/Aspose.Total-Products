---
title: API C++ para converter PPSX em DOCX
description: Exporte PPSX para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para DOCX" h2="Exporte PPSX para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
