---
title: API C++ para converter PPSM em WORD
description: Exporte PPSM para WORD em seus aplicativos C++
url: /pt/cpp/conversion/ppsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSM para WORD" h2="Exporte PPSM para WORD em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
