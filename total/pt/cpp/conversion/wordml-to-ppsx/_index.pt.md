---
title: Converter WORDML para PPSX via C++
description: Exporte WORDML para PPSX em seus aplicativos C++ sem usar o Microsoft Word do PowerPoint
url: /pt/cpp/conversion/wordml-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter WORDML em PPSX" h2="Exporte WORDML para PPSX em seus aplicativos C++ sem usar o Microsoft Word&reg; ou PowerPoint" >}}
...
2. Converta WORDML para HTML usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.wordmlument#save_stdbasicostream_saveoptions)
