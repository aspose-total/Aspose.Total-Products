---
title: API C++ para converter POTX em RTF
description: Exporte POTX para RTF em seus aplicativos C++
url: /pt/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para RTF" h2="Exporte POTX para RTF em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
