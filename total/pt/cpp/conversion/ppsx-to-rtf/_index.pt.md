---
title: API C++ para converter PPSX em RTF
description: Exporte PPSX para RTF em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para RTF" h2="Exporte PPSX para RTF em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
4. Salve o rtfumento no formato RTF usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.rtfument#save_string)
