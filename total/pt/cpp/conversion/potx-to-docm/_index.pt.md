---
title: API C++ para converter POTX em DOCM
description: Exporte POTX para DOCM em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para DOCM" h2="Exporte POTX para DOCM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
