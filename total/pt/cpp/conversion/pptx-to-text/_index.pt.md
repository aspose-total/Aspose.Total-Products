---
title: API C++ para converter PPTX em TEXT
description: Exporte PPTX para TEXT em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para TEXT" h2="Exporte PPTX para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
4. Salve o textumento no formato TEXT usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.textument#save_string)
