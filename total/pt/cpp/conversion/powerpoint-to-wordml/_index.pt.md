---
title: API C++ para converter POWERPOINT em WORDML
description: Exporte POWERPOINT para WORDML em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para WORDML" h2="Exporte POWERPOINT para WORDML em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
