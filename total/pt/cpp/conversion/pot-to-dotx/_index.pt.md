---
title: API C++ para converter POT em DOTX
description: Exporte POT para DOTX em seus aplicativos C++
url: /pt/cpp/conversion/pot-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para DOTX" h2="Exporte POT para DOTX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
