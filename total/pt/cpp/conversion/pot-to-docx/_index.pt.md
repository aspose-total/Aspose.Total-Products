---
title: API C++ para converter POT em DOCX
description: Exporte POT para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para DOCX" h2="Exporte POT para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
