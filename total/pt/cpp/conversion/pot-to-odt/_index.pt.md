---
title: API C++ para converter POT em ODT
description: Exporte POT para ODT em seus aplicativos C++
url: /pt/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para ODT" h2="Exporte POT para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
4. Salve o odtumento no formato ODT usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.odtument#save_string)
