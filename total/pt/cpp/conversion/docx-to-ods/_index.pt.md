---
title: Converter DOCX para ODS em C++
description: API C++ para converter DOCX para ODS sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/cpp/conversion/docx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter DOCX para ODS" h2="Exporte DOCX para ODS via C++ sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C++ para converter DOCX para ODS" %}}
