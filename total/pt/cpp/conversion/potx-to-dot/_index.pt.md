---
title: API C++ para converter POTX em DOT
description: Exporte POTX para DOT em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para DOT" h2="Exporte POTX para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
