---
title: API C++ para converter PPS em DOT
description: Exporte PPS para DOT em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para DOT" h2="Exporte PPS para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
