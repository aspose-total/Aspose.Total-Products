---
title: API C++ para converter PPS em TEXT
description: Exporte PPS para TEXT em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para TEXT" h2="Exporte PPS para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/cpp/conversion/pps-to-textm/" name="PPS Para TEXTM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/cpp/conversion/pps-to-textx/" name="PPS Para TEXTX" description="" >}}
