...
description: Exporte PPT para EXCEL em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/ppt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Converter PPT para EXCEL via C++" h2="Conversão de arquivo PPT para EXCEL via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
2. Converta PPT para HTML usando o método [Salvar](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba)
...
4. Salve o documento no formato EXCEL usando o método [Salvar](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
