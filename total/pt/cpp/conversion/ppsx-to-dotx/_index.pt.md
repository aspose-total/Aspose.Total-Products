...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para DOTX ou aplicativo on-line" h2="Exporte PPSX para DOTX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
