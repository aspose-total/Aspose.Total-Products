---
title: API C++ para converter PPTX em DOT
description: Exporte PPTX para DOT em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para DOT" h2="Exporte PPTX para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
