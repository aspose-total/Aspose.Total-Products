...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para TEXT ou online" h2="Exporte PPTM para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
