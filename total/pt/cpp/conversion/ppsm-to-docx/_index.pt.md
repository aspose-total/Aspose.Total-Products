---
title: API C++ para converter PPSM em DOCX
description: Exporte PPSM para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSM para DOCX" h2="Exporte PPSM para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
