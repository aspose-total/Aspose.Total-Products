---
title: API C++ para converter PPSM em DOCM
description: Exporte PPSM para DOCM em seus aplicativos C++
url: /pt/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSM para DOCM" h2="Exporte PPSM para DOCM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
