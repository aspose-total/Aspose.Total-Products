---
title: Converter RTF para EXCEL em C++
description: API C++ para converter RTF para EXCEL sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/cpp/conversion/rtf-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter RTF para EXCEL" h2="Exporte RTF para EXCEL via C++ sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o rtfumento no formato EXCEL usando a função de membro [Salvar](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
