---
title: API C++ para converter POTM em DOCX
description: Exporte POTM para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/potm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTM para DOCX" h2="Exporte POTM para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
