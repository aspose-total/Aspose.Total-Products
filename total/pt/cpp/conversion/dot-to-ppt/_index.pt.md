---
title: Converter DOT para PPT via C++
description: Exporte DOT para PPT em seus aplicativos C++ sem usar o Microsoft Word do PowerPoint
url: /pt/cpp/conversion/dot-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter DOT em PPT" h2="Exporte DOT para PPT em seus aplicativos C++ sem usar o Microsoft Word&reg; ou PowerPoint" >}}
...
2. Converta DOT para HTML usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.dotument#save_stdbasicostream_saveoptions)
