---
title: API C++ para converter POWERPOINT em DOCM
description: Exporte POWERPOINT para DOCM em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para DOCM" h2="Exporte POWERPOINT para DOCM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
