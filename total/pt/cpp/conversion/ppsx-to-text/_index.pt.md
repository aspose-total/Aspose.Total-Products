---
title: API C++ para converter PPSX em TEXT
description: Exporte PPSX para TEXT em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para TEXT" h2="Exporte PPSX para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
