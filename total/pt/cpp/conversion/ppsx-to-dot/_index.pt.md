---
title: API C++ para converter PPSX em DOT
description: Exporte PPSX para DOT em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para DOT" h2="Exporte PPSX para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
