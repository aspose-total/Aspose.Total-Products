---
title: Converter XLSM para DOCX com C++
description: Converter XLSM para DOCX em aplicativos C++
url: /pt/cpp/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Converter XLSM para DOCX via C++" h2="Exportar Excel<sup>&reg;</sup> XLSM para DOCX em aplicativos C++ totalmente funcionais" >}}
