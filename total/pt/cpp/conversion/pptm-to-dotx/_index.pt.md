---
title: API C++ para converter PPTM em DOTX
description: Exporte PPTM para DOTX em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para DOTX" h2="Exporte PPTM para DOTX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
