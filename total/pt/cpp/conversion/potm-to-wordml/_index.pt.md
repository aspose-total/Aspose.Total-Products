---
title: API C++ para converter POTM em WORDML
description: Exporte POTM para WORDML em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTM para WORDML" h2="Exporte POTM para WORDML em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
