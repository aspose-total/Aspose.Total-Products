---
title: API C++ para converter POWERPOINT em DOTM
description: Exporte POWERPOINT para DOTM em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para DOTM" h2="Exporte POWERPOINT para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
