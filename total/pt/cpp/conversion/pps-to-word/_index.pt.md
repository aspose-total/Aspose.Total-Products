---
title: API C++ para converter PPS em WORD
description: Exporte PPS para WORD em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para WORD" h2="Exporte PPS para WORD em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
