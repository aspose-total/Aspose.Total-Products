---
title: Converter RTF para PPTX via C++
description: Exporte RTF para PPTX em seus aplicativos C++ sem usar o Microsoft Word do PowerPoint
url: /pt/cpp/conversion/rtf-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter RTF em PPTX" h2="Exporte RTF para PPTX em seus aplicativos C++ sem usar o Microsoft Word&reg; ou PowerPoint" >}}
...
2. Converta RTF para HTML usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.rtfument#save_stdbasicostream_saveoptions)
