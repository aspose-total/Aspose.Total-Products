---
title: Converter XLSB para DOC com C++
description: Converter XLSB para DOC em aplicativos C++
url: /pt/cpp/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Converter XLSB para DOC via C++" h2="Exportar Excel<sup>&reg;</sup> XLSB para DOC em aplicativos C++ totalmente funcionais" >}}
