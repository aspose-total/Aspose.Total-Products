---
title: API C++ para converter PPTX em DOTM
description: Exporte PPTX para DOTM em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para DOTM" h2="Exporte PPTX para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
