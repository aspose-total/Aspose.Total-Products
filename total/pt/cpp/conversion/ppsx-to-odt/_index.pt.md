---
title: API C++ para converter PPSX em ODT
description: Exporte PPSX para ODT em seus aplicativos C++
url: /pt/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para ODT" h2="Exporte PPSX para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
