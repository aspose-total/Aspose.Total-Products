---
title: API C++ para converter PPS em DOCX
description: Exporte PPS para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para DOCX" h2="Exporte PPS para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
