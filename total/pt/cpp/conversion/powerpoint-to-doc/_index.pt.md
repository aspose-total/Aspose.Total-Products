---
title: API C++ para converter POWERPOINT em DOC
description: Exporte POWERPOINT para DOC em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para DOC" h2="Exporte POWERPOINT para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
