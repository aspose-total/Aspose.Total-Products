---
title: API C++ para converter POWERPOINT em ODT
description: Exporte POWERPOINT para ODT em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para ODT" h2="Exporte POWERPOINT para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
