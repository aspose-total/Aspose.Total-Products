---
title: Converter DOTX para POWERPOINT via C++
description: Exporte DOTX para POWERPOINT em seus aplicativos C++ sem usar o Microsoft Word do PowerPoint
url: /pt/cpp/conversion/dotx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter DOTX em POWERPOINT" h2="Exporte DOTX para POWERPOINT em seus aplicativos C++ sem usar o Microsoft Word&reg; ou PowerPoint" >}}
