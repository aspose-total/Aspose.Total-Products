---
title: API C++ para converter PPS em DOC
description: Exporte PPS para DOC em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para DOC" h2="Exporte PPS para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
