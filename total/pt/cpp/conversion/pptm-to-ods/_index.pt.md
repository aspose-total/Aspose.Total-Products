...
description: Exporte PPTM para ODS em C++ sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Converter PPTM para ODS via C++" h2="Conversão de arquivo PPTM para ODS via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
