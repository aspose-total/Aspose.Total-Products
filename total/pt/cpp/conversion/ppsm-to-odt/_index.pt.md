---
title: API C++ para converter PPSM em ODT
description: Exporte PPSM para ODT em seus aplicativos C++
url: /pt/cpp/conversion/ppsm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSM para ODT" h2="Exporte PPSM para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
