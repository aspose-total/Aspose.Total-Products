---
title: API C++ para converter PPTX em RTF
description: Exporte PPTX para RTF em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para RTF" h2="Exporte PPTX para RTF em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
