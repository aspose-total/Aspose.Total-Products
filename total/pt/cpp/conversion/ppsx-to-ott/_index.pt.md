---
title: API C++ para converter PPSX em OTT
description: Exporte PPSX para OTT em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSX para OTT" h2="Exporte PPSX para OTT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
