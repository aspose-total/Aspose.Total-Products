---
title: API C++ para converter PPT em ODT
description: Exporte PPT para ODT em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para ODT" h2="Exporte PPT para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
