---
title: API C++ para converter PPSM em DOTM
description: Exporte PPSM para DOTM em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPSM para DOTM" h2="Exporte PPSM para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
