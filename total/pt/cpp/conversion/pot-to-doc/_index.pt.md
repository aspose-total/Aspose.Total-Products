---
title: API C++ para converter POT em DOC
description: Exporte POT para DOC em seus aplicativos C++
url: /pt/cpp/conversion/pot-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para DOC" h2="Exporte POT para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
