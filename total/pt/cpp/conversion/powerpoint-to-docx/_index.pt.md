---
title: API C++ para converter POWERPOINT em DOCX
description: Exporte POWERPOINT para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POWERPOINT para DOCX" h2="Exporte POWERPOINT para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
