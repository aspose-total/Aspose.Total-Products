---
title: API C++ para converter PPS em ODT
description: Exporte PPS para ODT em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para ODT" h2="Exporte PPS para ODT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
