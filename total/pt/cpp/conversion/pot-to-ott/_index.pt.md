---
title: API C++ para converter POT em OTT
description: Exporte POT para OTT em seus aplicativos C++
url: /pt/cpp/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para OTT" h2="Exporte POT para OTT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
