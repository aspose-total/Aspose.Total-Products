---
title: API C++ para converter PPT em WORDML
description: Exporte PPT para WORDML em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para WORDML" h2="Exporte PPT para WORDML em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
