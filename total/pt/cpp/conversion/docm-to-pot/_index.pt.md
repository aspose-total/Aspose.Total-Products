...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter DOCM em POT ou aplicativo on-line" h2="Exporte DOCM para POT em seus aplicativos C++ sem usar o Microsoft Word&reg; ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Conversão de DOCM para POT em C++" %}}
...
6. Salve o docmumento no formato POT usando o método [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) e defina Pot como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Adicionar comentários no docmumento POT via C++" %}}
Ao salvar o DOCM como POT, você também pode usar o [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) para adicionar mais recursos ao seu docmumento POT. Por exemplo, você pode adicionar comentários em sua apresentação. O comentário do slide da apresentação está associado a um autor específico. A classe Presentation contém a coleção de autores em ICommentAuthorCollection que são responsáveis por adicionar comentários ao slide. Para cada autor, há uma coleção de comentários em ICommentCollection.
{{% blocks/products/pf/feature-page-code %}}
