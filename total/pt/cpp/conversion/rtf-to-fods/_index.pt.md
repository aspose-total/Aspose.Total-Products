...
{{< blocks/products/pf/feature-page-header h1="API C++ para converter RTF para FODS" h2="Exporte RTF para FODS via C++ sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o rtfumento no formato FODS usando a função de membro [Salvar](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
