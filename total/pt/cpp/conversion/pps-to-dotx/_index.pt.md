---
title: API C++ para converter PPS em DOTX
description: Exporte PPS para DOTX em seus aplicativos C++
url: /pt/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPS para DOTX" h2="Exporte PPS para DOTX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
