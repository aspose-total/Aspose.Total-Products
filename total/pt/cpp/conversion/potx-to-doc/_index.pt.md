---
title: API C++ para converter POTX em DOC
description: Exporte POTX para DOC em seus aplicativos C++
url: /pt/cpp/conversion/potx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para DOC" h2="Exporte POTX para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
