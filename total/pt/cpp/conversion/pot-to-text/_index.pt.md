---
title: API C++ para converter POT em TEXT
description: Exporte POT para TEXT em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para TEXT" h2="Exporte POT para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
