...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POT para TEXT ou online" h2="Exporte POT para TEXT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
