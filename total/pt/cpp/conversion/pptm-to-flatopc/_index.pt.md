---
title: API C++ para converter PPTM em FLATOPC
description: Exporte PPTM para FLATOPC em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para FLATOPC" h2="Exporte PPTM para FLATOPC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
