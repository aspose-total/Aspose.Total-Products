---
title: API C++ para converter PPTX em DOTX
description: Exporte PPTX para DOTX em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para DOTX" h2="Exporte PPTX para DOTX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
