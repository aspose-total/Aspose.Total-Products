...
description: Exporte POWERPOINT para ODS em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/powerpoint-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="Converter POWERPOINT para ODS via C++" h2="Conversão de arquivo POWERPOINT para ODS via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
