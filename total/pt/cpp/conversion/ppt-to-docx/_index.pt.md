---
title: API C++ para converter PPT em DOCX
description: Exporte PPT para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para DOCX" h2="Exporte PPT para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
