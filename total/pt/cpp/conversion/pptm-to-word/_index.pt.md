---
title: API C++ para converter PPTM em WORD
description: Exporte PPTM para WORD em seus aplicativos C++
url: /pt/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para WORD" h2="Exporte PPTM para WORD em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
