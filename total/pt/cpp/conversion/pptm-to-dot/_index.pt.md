---
title: API C++ para converter PPTM em DOT
description: Exporte PPTM para DOT em seus aplicativos C++
url: /pt/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para DOT" h2="Exporte PPTM para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
