---
title: API C++ para converter PPTM em OTT
description: Exporte PPTM para OTT em seus aplicativos C++
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTM para OTT" h2="Exporte PPTM para OTT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
