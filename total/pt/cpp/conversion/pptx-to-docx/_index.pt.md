---
title: API C++ para converter PPTX em DOCX
description: Exporte PPTX para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para DOCX" h2="Exporte PPTX para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
...
3. Carregue o arquivo HTML convertido usando a referência de classe [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)
4. Salve o docxumento no formato DOCX usando a função de membro [Salvar](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/cpp/conversion/pptx-to-docxm/" name="PPTX Para DOCXM" description="" >}}
