---
title: API C++ para converter POTX em DOCX
description: Exporte POTX para DOCX em seus aplicativos C++
url: /pt/cpp/conversion/potx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para DOCX" h2="Exporte POTX para DOCX em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
