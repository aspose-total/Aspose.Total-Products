...
description: Exporte POWERPOINT para SXC em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/powerpoint-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="Converter POWERPOINT para SXC via C++" h2="Conversão de arquivo POWERPOINT para SXC via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
