...
description: Exporte POWERPOINT para XLS em C++ sem usar o Microsoft Excel ou Powerpoint
url: /pt/cpp/conversion/powerpoint-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="Converter POWERPOINT para XLS via C++" h2="Conversão de arquivo POWERPOINT para XLS via C++ sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
