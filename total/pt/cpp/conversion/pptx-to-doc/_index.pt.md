---
title: API C++ para converter PPTX em DOC
description: Exporte PPTX para DOC em seus aplicativos C++
url: /pt/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPTX para DOC" h2="Exporte PPTX para DOC em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
