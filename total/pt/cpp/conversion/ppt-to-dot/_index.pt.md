---
title: API C++ para converter PPT em DOT
description: Exporte PPT para DOT em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para DOT" h2="Exporte PPT para DOT em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
