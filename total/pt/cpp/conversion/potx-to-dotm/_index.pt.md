---
title: API C++ para converter POTX em DOTM
description: Exporte POTX para DOTM em seus aplicativos C++
url: /pt/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar POTX para DOTM" h2="Exporte POTX para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
