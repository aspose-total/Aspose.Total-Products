---
title: Converter XLS para PPTX com C++
description: Converter XLS para PPTX em aplicativos C++
url: /pt/cpp/conversion/xls-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Converter XLS para PPTX via C++" h2="Exportar Excel<sup>&reg;</sup> XLS para PPTX em aplicativos C++ totalmente funcionais" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/cpp/conversion/xls-to-pptxx/" name="XLS Para PPTXX" description="" >}}
