---
title: API C++ para converter PPT em DOTM
description: Exporte PPT para DOTM em seus aplicativos C++
url: /pt/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="API C++ para renderizar PPT para DOTM" h2="Exporte PPT para DOTM em aplicativos C++ sem dependências do Microsoft PowerPoint ou Word" >}}
