---
title: Remova a anotação PDF online ou gerencie anotações via .NET
description: exclua comentários do arquivo PDF por meio do aplicativo online gratuitamente.Código API C# .NET para gerenciar comentários de arquivos PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Limpar comentários do documento PDF online ou gerenciar via .NET" h2="Desenvolva um poderoso aplicativo utilitário de anotação de documentos PDF baseado em .NET.Código listado para gerenciar comentários do arquivo PDF através do .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Adicionar anotação via .NET" %}}

1. Adicionar referência de biblioteca ao projeto .NET
1. Criar objeto de classe Documento
1. Adicione a nova página e parágrafos usando Pages.Add e Paragraphs.Add
1. Use a classe TextAnnotation e defina as anotações
1. Use Pages[1].Annotations.Add para adicionar as anotações
1. Chame o método Save para salvar o arquivo com anotações
...
{{% blocks/products/pf/agp/code-block title="Código .NET: adicionar comentários no arquivo PDF" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de anotação de documentos PDF via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de anotação PDF para fornecer feedback, fazer sugestões ou colaborar com outras pessoas no documento?Com o [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de anotação de documentos.A poderosa biblioteca .NET permite programar qualquer solução de anotação de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato PDF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar arquivos PDF" %}}
