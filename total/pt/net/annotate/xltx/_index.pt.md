---
title: Remova a anotação XLTX online ou gerencie anotações via .NET
description: exclua comentários do arquivo XLTX por meio do aplicativo online gratuitamente.Código API .NET para gerenciar comentários de arquivos XLTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Limpar comentários do documento XLTX online ou gerenciar via .NET" h2="Desenvolva um poderoso aplicativo utilitário de anotação de documentos XLTX baseado em .NET.Código listado para gerenciar comentários do arquivo XLTX através do .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Remover comentários XLTX via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: excluir comentários do arquivo XLTX" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de anotação de documentos XLTX via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de anotação XLTX para fornecer feedback, fazer sugestões ou colaborar com outras pessoas no documento?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de anotação de documentos.A poderosa biblioteca .NET permite programar qualquer solução de anotação de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato XLTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar arquivos XLTX" %}}
