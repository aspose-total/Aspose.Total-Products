---
title: Compactar arquivos XLTM online ou via .NET
description: Aplicativo online gratuito para compactar diferentes arquivos XLTM.Código da biblioteca de compactação .NET para documentos XLTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compacte o arquivo XLTM online por meio do aplicativo de compactação ou usando .NET" h2="Desenvolva aplicativos poderosos de compactação de documentos XLTM baseados em .NET.Comprima gratuitamente vários documentos, incluindo arquivos XLTM on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo XLTM via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: compactar arquivos XLTM" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos XLTM usando .NET.Use a API de compactação Aspose XLTM para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
