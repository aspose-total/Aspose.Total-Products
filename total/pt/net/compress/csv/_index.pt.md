---
title: Compactar arquivos CSV online ou via .NET
description: Aplicativo online gratuito para compactar diferentes arquivos CSV.Código da biblioteca de compactação .NET para documentos CSV.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compacte o arquivo CSV online por meio do aplicativo de compactação ou usando .NET" h2="Desenvolva aplicativos poderosos de compactação de documentos CSV baseados em .NET.Comprima gratuitamente vários documentos, incluindo arquivos CSV on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo CSV via .NET" %}}
...
1. Chame o método save e obtenha o arquivo CSV compactado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: compactar arquivos CSV" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos CSV usando .NET.Use a API de compactação Aspose CSV para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
