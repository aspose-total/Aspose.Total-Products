---
title: Compactar arquivos XLS online ou via .NET
description: Aplicativo online gratuito para compactar diferentes arquivos XLS.Código da biblioteca de compactação .NET para documentos XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compacte o arquivo XLS online por meio do aplicativo de compactação ou usando .NET" h2="Desenvolva aplicativos poderosos de compactação de documentos XLS baseados em .NET.Comprima gratuitamente vários documentos, incluindo arquivos XLS on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo XLS via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: compactar arquivos XLS" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos XLS usando .NET.Use a API de compactação Aspose XLS para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
