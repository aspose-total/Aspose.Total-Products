---
title: Compactar arquivos XLSB online ou via .NET
description: Aplicativo online gratuito para compactar diferentes arquivos XLSB.Código da biblioteca de compactação .NET para documentos XLSB.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compacte o arquivo XLSB online por meio do aplicativo de compactação ou usando .NET" h2="Desenvolva aplicativos poderosos de compactação de documentos XLSB baseados em .NET.Comprima gratuitamente vários documentos, incluindo arquivos XLSB on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo XLSB via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: compactar arquivos XLSB" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos XLSB usando .NET.Use a API de compactação Aspose XLSB para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
