---
title: Compactar arquivos XLT online ou via .NET
description: Aplicativo online gratuito para compactar diferentes arquivos XLT.Código da biblioteca de compactação .NET para documentos XLT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compacte o arquivo XLT online por meio do aplicativo de compactação ou usando .NET" h2="Desenvolva aplicativos poderosos de compactação de documentos XLT baseados em .NET.Comprima gratuitamente vários documentos, incluindo arquivos XLT on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo XLT via .NET" %}}
...
1. Chame o método save e obtenha o arquivo XLT compactado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: compactar arquivos XLT" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para compactar arquivos XLT usando .NET.Use a API de compactação Aspose XLT para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
