---
title: Remova a proteção de senha ODS online ou usando .NET
description: Remova a senha do documento ODS por meio do aplicativo online gratuitamente.Código API .NET C# para desbloquear arquivos ODS protegidos por senha.
...
{{< blocks/products/pf/feature-page-header-widget h1="Desbloqueie a senha do documento ODS online ou via .NET" h2="Desenvolva um poderoso aplicativo utilitário de bloqueio e desbloqueio de documentos ODS baseado em .NET.Código listado para remover restrições de senha do arquivo ODS por meio do .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Desbloquear senha ODS on-line" %}}

1. Importe o arquivo ODS para desbloquear enviando-o.
...
{{% blocks/products/pf/agp/feature-section-col title="Remover senha ODS via .NET" %}}

1. Carregar arquivo ODS protegido por senha usando a classe Workbook
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Remover senha do documento ODS" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de proteção ODS via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de proteção ODS?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de proteção ou desproteção de documentos.A poderosa biblioteca .NET permite programar qualquer solução de proteção de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para gerenciar a proteção ODS" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para desportar documentos ODS?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
