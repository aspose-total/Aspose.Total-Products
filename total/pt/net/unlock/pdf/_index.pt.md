---
title: Remova a proteção de senha PDF online ou usando .NET
description: Remova a senha do documento PDF por meio do aplicativo online gratuitamente. Código API .NET C# para desbloquear arquivos PDF protegidos por senha.
...
{{< blocks/products/pf/feature-page-header-widget h1="Desbloqueie a senha do documento PDF online ou via .NET" h2="Desenvolva um poderoso aplicativo utilitário de bloqueio e desbloqueio de documentos PDF baseado em .NET.Código listado para remover restrições de senha do arquivo PDF por meio do .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Remover senha PDF via .NET" %}}

1. Carregue o arquivo PDF protegido por senha usando a classe Document
1. Invoque o método Decrypt() para remover a senha
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Remover senha do documento PDF" offSpacer="" %}}
