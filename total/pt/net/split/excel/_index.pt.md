---
title: Divida o arquivo Excel online ou via .NET
description: Aplicativo online gratuito para dividir diferentes planilhas Excel.Código da biblioteca divisora .NET C# para planilhas Excel.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir arquivo Excel via .NET" %}}

1. Carregar arquivo Excel usando a classe Workbook
...
{{% blocks/products/pf/agp/code-block title="Código .NET: dividir arquivos Excel" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo divisor de arquivos Excel usando .NET</h2>

Precisa desenvolver um script .NET ou aplicativo utilitário para dividir facilmente arquivos Excel?Com [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código API acima para programar o aplicativo divisor.A poderosa biblioteca .NET para divisão de documentos suporta muitos formatos populares, incluindo o formato Excel, como arquivos PDF, Word, Excel e PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca Excel Splitter para .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver facilmente uma solução profissional para dividir arquivos Excel usando .NET.Use a API do divisor Aspose Excel para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
