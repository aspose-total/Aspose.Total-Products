---
title: Atualizar arquivo XLTM usando .NET
description: Modifique documentos XLTM em aplicativos C# VB.NET sem usar o Microsoft Excel. 
url: /pt/net/update/xltm/
family: total
platformtag: .NET
feature: update
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Atualizar arquivo XLTM via .NET" h2="Modifique a planilha XLTM por meio de seus aplicativos baseados em .NET sem instalar o Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Para um desenvolvedor, quem está tentando atualizar arquivos XLTM via aplicativo .NET? A API [Aspose.Total for .NET](https://products.aspose.com/total/net/) pode ajudar a automatizar o processo de atualização. É um pacote completo de várias APIs .NET que lidam com diferentes formatos, incluindo arquivos do Microsoft Excel. A API ASPOSE.CELL que faz parte do pacote [Aspose.Total for .NET](https://products.aspose.com/total/net/) facilita esse processo de modificação. Abaixo está o processo de atualização do documento XLTM.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Como atualizar o arquivo XLTM no .NET" %}}

- Crie um novo objeto de classe [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) tendo o arquivo XLTM de origem como parâmetro
...
- Salve o arquivo como arquivo .xltm usando o método save() passando o arquivo com o caminho como parâmetro

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de modificação" %}}

- Para modificação de XLTM, Microsoft Windows ou um sistema operacional compatível com plataformas .NET, .NET Core, Mono ou Xamarin
...
{{% blocks/products/pf/agp/code-block title="Código - Atualizar arquivo XLTM em .NET" offSpacer="" %}}
