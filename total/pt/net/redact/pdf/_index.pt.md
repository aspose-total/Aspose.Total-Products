---
title: Editar documento PDF on-line ou usando .NET
description: Abra e edite documentos PDF on-line por meio do aplicativo gratuitamente. Código C# da API .NET para pesquisar e substituir texto PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redija o documento PDF on-line ou via .NET" h2="Desenvolva um poderoso aplicativo utilitário de redação de documentos PDF baseado em .NET.Código C# listado para pesquisar e substituir texto no arquivo PDF por meio de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Editar arquivo PDF via .NET" %}}
...
1. Obtenha todos os TextFragments em TextFragmentCollection
1. Iterar em cada coleção de fragmentos
1. Defina RedactionAnnotation e chame o método Redact()
...
{{% blocks/products/pf/agp/code-block title="Código C#: Redigir arquivo PDF" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 Redação em .pdf (Formato de Documento Portátil)

- Redigir texto sensível em documentos legais, médicos e financeiros.
- Redigir dados confidenciais antes de divulgações públicas ou comunicados à imprensa.
- Redigir conteúdo restrito em publicações relacionadas à Lei de Liberdade de Informação (FOIA) ou conformidade.
