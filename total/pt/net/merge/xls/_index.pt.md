---
title: Mesclar arquivos XLS online ou usando .NET
description: Aplicativo online gratuito para combinar diferentes arquivos XLS.C# .NET mesclando código de biblioteca para mesclar planilhas XLS em outros formatos.
...
{{< blocks/products/pf/feature-page-header-widget h1="Mesclar documentos XLS on-line por meio do aplicativo Merger ou usando .NET" h2="Desenvolva um poderoso aplicativo de mesclagem de documentos XLS baseado em .NET.Combine vários documentos XLS em um único online gratuitamente via aplicativo.Salve arquivos XLS mesclados como PDF, imagens, Word, Excel, PowerPoint e muitos outros formatos online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivo XLS via .NET" %}}

1. Carregue ambos os XLS usando objetos da classe Workbook.
...
{{% blocks/products/pf/agp/code-block title="Código .NET: mesclar arquivos XLS" offSpacer="" %}}
...
<h2>Desenvolva fusão de arquivos XLS usando .NET</h2>

Precisa desenvolver um aplicativo utilitário .NET para mesclar facilmente vários arquivos XLS?Com [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código API acima para concatenar documentos facilmente.A poderosa biblioteca .NET para mesclar documentos suporta muitos formatos populares, incluindo o formato XLS.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de mesclagem .NET para arquivos XLS" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se desenvolver uma solução profissional para combinar XLS usando .NET.Use a API de mesclagem XLS para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
