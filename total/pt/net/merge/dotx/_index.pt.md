---
title: Mesclar arquivos DOTX online ou usando .NET
description: Aplicativo online gratuito para combinar diferentes arquivos DOTX.Código da biblioteca de mesclagem .NET para mesclar documentos DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Mesclar documentos DOTX on-line por meio do aplicativo Merger ou usando .NET" h2="Desenvolva um poderoso aplicativo de mesclagem de documentos DOTX baseado em .NET.Combine vários documentos DOTX em um único online gratuitamente via aplicativo.Salve o arquivo DOTX como PDF, imagens, Word, Excel, PowerPoint e muitos outros formatos online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivo DOTX via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: mesclar arquivos DOTX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se facilmente desenvolver uma solução profissional para combinar DOTX usando .NET.Use a API de fusão Aspose DOTX para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
