---
title: Mesclar arquivos DOCX online ou usando .NET
description: Aplicativo online gratuito para combinar diferentes arquivos DOCX.Código da biblioteca de mesclagem .NET para mesclar documentos DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Mesclar documentos DOCX on-line por meio do aplicativo Merger ou usando .NET" h2="Desenvolva um poderoso aplicativo de mesclagem de documentos DOCX baseado em .NET.Combine vários documentos DOCX em um único online gratuitamente via aplicativo.Salve o arquivo DOCX como PDF, imagens, Word, Excel, PowerPoint e muitos outros formatos online." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivos DOCX online usando o aplicativo" %}}
...
1. Visualize e obtenha o único arquivo DOCX mesclado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivo DOCX via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: mesclar arquivos DOCX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código. Pode-se facilmente desenvolver uma solução profissional para combinar DOCX usando .NET.Use a API de fusão Aspose DOCX para desenvolver software independente de plataforma de alto nível em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
