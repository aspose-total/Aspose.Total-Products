---
title: API .NET para converter OTT para XLSM
description: API C# para converter OTT para XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter OTT para XLSM" h2="Exporte OTT para XLSM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o ottumento no formato XLSM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSM" como SaveFormat
