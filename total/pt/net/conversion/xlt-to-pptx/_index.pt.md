---
title: Converter XLT para PPTX com .NET 
description: Converter XLT para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlt-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLT para PPTX via C#" h2="Exportar Excel&reg; XLT para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
