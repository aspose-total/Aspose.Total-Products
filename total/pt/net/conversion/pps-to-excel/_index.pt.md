...
description: Converter PPS para EXCEL em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para EXCEL via C#" h2="API .NET para conversão de PPS para EXCEL sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
