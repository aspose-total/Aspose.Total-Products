---
title: Converter PPS para MHTML via C#
description: Converter PPS para MHTML em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para MHTML via C#" h2="API .NET para conversão de PPS para MHTML sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
1. Abra o arquivo PPS usando a classe [Apresentação](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Exporte PPS como HTML usando o método [Salvar](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
