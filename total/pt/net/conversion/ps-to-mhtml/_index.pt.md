---
title: API C# para exportar PS para MHTML
description: Converter PS para MHTML sem usar o Microsoft Word
url_ignore: /pt/net/conversion/ps-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PS para MHTML via .NET" h2="API .NET para exportar PS para MHTML no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PS em MHTML" %}}
