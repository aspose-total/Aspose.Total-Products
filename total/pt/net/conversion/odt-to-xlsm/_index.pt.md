...
description: API C# para converter ODT para XLSM sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter ODT para XLSM" h2="Exporte ODT para XLSM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Abra o arquivo ODT usando a classe [Document](https://apireference.aspose.com/words/net/aspose.words/document)
2. Converta ODT para HTML usando o método [Salvar](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4)
