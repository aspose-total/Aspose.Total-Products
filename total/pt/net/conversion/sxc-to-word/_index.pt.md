---
title: Converter SXC para WORD com .NET 
description: Converter SXC para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter SXC para WORD via C#" h2="Exportar Excel&reg; SXC para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
