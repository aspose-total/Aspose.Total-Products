...
<iframe title="Aplicativo gratuito de conversão de XPS para GIF online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=gif&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Converter XPS para GIF via C# .NET" offSpacer="" %}}
