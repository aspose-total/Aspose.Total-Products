---
title: Converter XLSB para PPTX com .NET 
description: Converter XLSB para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlsb-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSB para PPTX via C#" h2="Exportar Excel&reg; XLSB para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
