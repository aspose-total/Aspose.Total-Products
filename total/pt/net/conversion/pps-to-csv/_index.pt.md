---
title: Converter PPS para CSV via C#
description: Converter PPS para CSV em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPS para CSV via C#" h2="API .NET para conversão de PPS para CSV sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
4. Salve o documento em CSV usando o método [Salvar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
