---
title: API .NET para converter WORD para XLSM
description: API C# para converter WORD para XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORD para XLSM" h2="Exporte WORD para XLSM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato XLSM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSM" como SaveFormat
