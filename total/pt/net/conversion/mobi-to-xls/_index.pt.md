...
description: API C# para converter MOBI para XLS sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter MOBI para XLS" h2="Exporte MOBI para XLS via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o mobiumento no formato XLS usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLS" como SaveFormat
