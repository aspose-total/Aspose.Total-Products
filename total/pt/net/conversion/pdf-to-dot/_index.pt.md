---
title: API C# para exportar PDF para DOT
description: Converter PDF para DOT sem usar o Microsoft Word
url_ignore: /pt/net/conversion/pdf-to-dot/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PDF para DOT via .NET" h2="API .NET para exportar PDF para DOT no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PDF em DOT" %}}
