---
title: Conversão online de MHTML para DICOM ou criação de aplicativo baseado em .NET para converter arquivos MHTML
description: Aplicativo online gratuito para converter arquivos MHTML para DICOM. Código de biblioteca de conversão .NET C# para documentos MHTML. 
...
<iframe title="Aplicativo gratuito de conversão de MHTML para DICOM online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dicom&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converta arquivos MHTML para DICOM online usando o aplicativo" %}}
...
1. MHTML será convertido em documento DICOM
1. Baixe o arquivo DICOM convertido

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Converter MHTML para DICOM via API de automação .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Converter MHTML para DICOM via C# .NET" offSpacer="" %}}
...
Mais alguns casos para salvar MHTML em DICOM com outros recursos como Converter arquivo MHTML para DICOM em um único arquivo via C#, Converta e gire o arquivo MHTML para DICOM via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Salvando MHTML em DICOM Requisitos do aplicativo" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você é bem-vindo para baixar este código. Pode-se facilmente desenvolver uma solução profissional para exportar e salvar MHTML para arquivo DICOM usando .NET. Use a API de conversão Aspose MHTML para DICOM para desenvolver software de alto nível e independente de plataforma em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
