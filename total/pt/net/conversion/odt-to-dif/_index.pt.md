---
title: API .NET para converter ODT para DIF
description: API C# para converter ODT para DIF sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter ODT para DIF" h2="Exporte ODT para DIF via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o odtumento no formato DIF usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "DIF" como SaveFormat
