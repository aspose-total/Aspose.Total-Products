...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter SXC para PPTX via C# ou online" h2="Exportar Excel&reg; SXC para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
