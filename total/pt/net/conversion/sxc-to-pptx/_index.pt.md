---
title: Converter SXC para PPTX com .NET 
description: Converter SXC para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/sxc-to-pptx/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter SXC para PPTX via C#" h2="Exportar Excel&reg; SXC para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
