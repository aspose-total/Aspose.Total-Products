---
title: API C# para exportar TEX para WORDML
description: Converter TEX para WORDML sem usar o Microsoft Word
url_ignore: /pt/net/conversion/tex-to-wordml/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar TEX para WORDML via .NET" h2="API .NET para exportar TEX para WORDML no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter TEX em WORDML" %}}
