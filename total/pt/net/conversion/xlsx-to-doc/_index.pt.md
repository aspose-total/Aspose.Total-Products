---
title: Converter XLSX para DOC com .NET 
description: Converter XLSX para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSX para DOC via C#" h2="Exportar Excel&reg; XLSX para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
