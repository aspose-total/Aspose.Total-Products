---
title: Converter MHTML para MD via API C#
description: API C# para converter arquivo MHTML em MD sem usar o Microsoft Excel ou Adobe Reader
url_ignore: /pt/net/conversion/mhtml-to-md/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/feature-page-section  h2="Converter MHTML Protegido para MD via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo MHTML para MD com marca d'água via C #" %}}
