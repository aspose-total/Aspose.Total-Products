...
description: API C# para converter DOTM para TSV sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOTM para TSV" h2="Exporte DOTM para TSV via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o dotmumento no formato TSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "TSV" como SaveFormat
