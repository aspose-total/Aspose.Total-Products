---
title: Converter XLSM para PPTX com .NET 
description: Converter XLSM para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlsm-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSM para PPTX via C#" h2="Exportar Excel&reg; XLSM para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
