---
title: API .NET para converter ODT para XLAM
description: API C# para converter ODT para XLAM sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter ODT para XLAM" h2="Exporte ODT para XLAM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o odtumento no formato XLAM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLAM" como SaveFormat
