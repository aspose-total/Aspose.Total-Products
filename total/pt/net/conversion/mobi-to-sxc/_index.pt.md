...
description: API C# para converter MOBI para SXC sem usar o Microsoft Excel ou Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter MOBI para SXC" h2="Exporte MOBI para SXC via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o mobiumento no formato SXC usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "SXC" como SaveFormat
