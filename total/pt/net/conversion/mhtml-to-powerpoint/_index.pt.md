...
4. Salve o documento no formato POWERPOINT usando o método [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) e defina `Powerpoint` como SaveFormat
