...
1. Carregue o arquivo FLATOPC usando a classe [Aspose.Words.Flatopcument](https://apireference.aspose.com/words/net/aspose.words/flatopcument)
1. Salve o flatopcumento FLATOPC em HTML
...
1. Salve o flatopcumento usando [Aspose.Slides.Presentation.Save("output.odp", SaveFormat.Odp)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
...
// To convert multi pages FLATOPC flatopcuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to ODP.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/flatopc-to-odp/" name="FLATOPC Para ODP" description="" >}}
