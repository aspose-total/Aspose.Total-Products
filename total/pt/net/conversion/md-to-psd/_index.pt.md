---
title: Conversão online de MD para PSD ou criação de aplicativo baseado em .NET para converter arquivos MD
description: Aplicativo online gratuito para converter arquivos MD para PSD. Código de biblioteca de conversão .NET C# para documentos MD. 
...
<iframe title="Aplicativo gratuito de conversão de MD para PSD online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=psd&from=md" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converta arquivos MD para PSD online usando o aplicativo" %}}
...
1. MD será convertido em documento PSD
1. Baixe o arquivo PSD convertido

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Converter MD para PSD via API de automação .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Converter MD para PSD via C# .NET" offSpacer="" %}}
...
Mais alguns casos para salvar MD em PSD com outros recursos como Converter arquivo MD para PSD em um único arquivo via C#, Converta e gire o arquivo MD para PSD via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Salvando MD em PSD Requisitos do aplicativo" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você é bem-vindo para baixar este código. Pode-se facilmente desenvolver uma solução profissional para exportar e salvar MD para arquivo PSD usando .NET. Use a API de conversão Aspose MD para PSD para desenvolver software de alto nível e independente de plataforma em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
