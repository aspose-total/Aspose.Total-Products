...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORD para XLSB" h2="Exporte WORD para XLSB via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
