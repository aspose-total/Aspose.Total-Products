---
title: API C# para exportar SVG para MARKDOWN
description: Converter SVG para MARKDOWN sem usar o Microsoft Word
url_ignore: /pt/net/conversion/svg-to-markdown/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar SVG para MARKDOWN via .NET" h2="API .NET para exportar SVG para MARKDOWN no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter SVG em MARKDOWN" %}}
