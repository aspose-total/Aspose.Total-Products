---
title: Converter POTM para XLSX via C#
description: Converter POTM para XLSX em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/potm-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTM para XLSX via C#" h2="API .NET para conversão de POTM para XLSX sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
