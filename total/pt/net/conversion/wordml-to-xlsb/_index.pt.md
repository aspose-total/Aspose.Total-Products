---
title: API .NET para converter WORDML para XLSB
description: API C# para converter WORDML para XLSB sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORDML para XLSB" h2="Exporte WORDML para XLSB via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordmlumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
