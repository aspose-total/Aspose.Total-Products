---
title: API .NET para converter WORDML para XLSM
description: API C# para converter WORDML para XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/wordml-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORDML para XLSM" h2="Exporte WORDML para XLSM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordmlumento no formato XLSM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSM" como SaveFormat
