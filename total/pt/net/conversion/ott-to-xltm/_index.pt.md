---
title: API .NET para converter OTT para XLTM
description: API C# para converter OTT para XLTM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xltm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter OTT para XLTM" h2="Exporte OTT para XLTM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o ottumento no formato XLTM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTM" como SaveFormat
