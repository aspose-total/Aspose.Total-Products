...
description: Converter TEX para DOTM sem usar o Microsoft Word
url_ignore: /pt/net/conversion/tex-to-dotm/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar TEX para DOTM via .NET" h2="API .NET para exportar TEX para DOTM no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter TEX em DOTM" %}}
