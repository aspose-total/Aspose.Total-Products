---
title: Converter PPT para XLSM via C#
description: Converter PPT para XLSM em C# sem usar o Microsoft Excel ou Powerpoint
url: /pt/net/conversion/ppt-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: PPT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter PPT para XLSM via C#" h2="API .NET para conversão de PPT para XLSM sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
1. Abra o arquivo PPT usando a classe [Apresentação](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Exporte PPT como HTML usando o método [Salvar](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
