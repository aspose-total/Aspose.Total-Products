---
title: Conversão online de MD para TSV ou criação de aplicativo baseado em .NET para converter arquivos MD
description: Aplicativo online gratuito para converter arquivos MD para TSV. Código de biblioteca de conversão .NET C# para documentos MD. 
...
<iframe title="Aplicativo gratuito de conversão de MD para TSV online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=tsv&from=md" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converta arquivos MD para TSV online usando o aplicativo" %}}
...
1. MD será convertido em documento TSV
1. Baixe o arquivo TSV convertido

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Converter MD para TSV via API de automação .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Converter MD para TSV via C# .NET" offSpacer="" %}}
...
Mais alguns casos para salvar MD em TSV com outros recursos como Converter MD Protegido para TSV via C#, Converter arquivo MD para TSV com marca d'água via C#.
...
{{% blocks/products/pf/agp/feature-section-col title="Salvando MD em TSV Requisitos do aplicativo" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você é bem-vindo para baixar este código. Pode-se facilmente desenvolver uma solução profissional para exportar e salvar MD para arquivo TSV usando .NET. Use a API de conversão Aspose MD para TSV para desenvolver software de alto nível e independente de plataforma em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
