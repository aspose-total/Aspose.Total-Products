---
title: API .NET para converter DOT para XLT
description: API C# para converter DOT para XLT sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/dot-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOT para XLT" h2="Exporte DOT para XLT via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o dotumento no formato XLT usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLT" como SaveFormat
