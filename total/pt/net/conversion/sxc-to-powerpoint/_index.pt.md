---
title: Converter SXC para POWERPOINT com .NET 
description: Converter SXC para POWERPOINT em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/sxc-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter SXC para POWERPOINT via C#" h2="Exportar Excel&reg; SXC para POWERPOINT em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
