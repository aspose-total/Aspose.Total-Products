---
title: API .NET para converter WORD para EXCEL
description: API C# para converter WORD para EXCEL sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORD para EXCEL" h2="Exporte WORD para EXCEL via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato EXCEL usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "EXCEL" como SaveFormat
