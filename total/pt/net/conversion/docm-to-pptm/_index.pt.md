...
description: Converta docmumentos do Word em arquivos pptm do PowerPoint com C#. Converta vários arquivos no ASP.NET ou em outros aplicativos .NET.
---
...
1. Salve o docmumento usando [Aspose.Slides.Presentation.Save("output.pptm", SaveFormat.Pptm)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
...
// To convert multi pages DOCMM docmuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to PPTM.
