---
title: Converter XLSB para DOC com .NET 
description: Converter XLSB para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlsb-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSB para DOC via C#" h2="Exportar Excel&reg; XLSB para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
