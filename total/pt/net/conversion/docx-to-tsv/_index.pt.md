---
title: API .NET para converter DOCX para TSV
description: API C# para converter DOCX para TSV sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOCX para TSV" h2="Exporte DOCX para TSV via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o docxumento no formato TSV usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "TSV" como SaveFormat
