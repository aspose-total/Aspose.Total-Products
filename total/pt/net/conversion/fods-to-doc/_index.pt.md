---
title: Converter FODS para DOC com .NET 
description: Converter FODS para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/fods-to-doc/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter FODS para DOC via C#" h2="Exportar Excel&reg; FODS para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
