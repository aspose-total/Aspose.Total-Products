---
title: Converter XLSX para PPTX com .NET 
description: Converter XLSX para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSX para PPTX via C#" h2="Exportar Excel&reg; XLSX para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
