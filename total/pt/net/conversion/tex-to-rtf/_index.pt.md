---
title: API C# para exportar TEX para RTF
description: Converter TEX para RTF sem usar o Microsoft Word
url_ignore: /pt/net/conversion/tex-to-rtf/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar TEX para RTF via .NET" h2="API .NET para exportar TEX para RTF no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter TEX em RTF" %}}
