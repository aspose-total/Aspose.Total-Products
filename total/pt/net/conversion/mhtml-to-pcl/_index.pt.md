---
title: API C# para exportar MHTML para PCL
description: Converter MHTML para PCL sem usar o Microsoft Word
url_ignore: /pt/net/conversion/mhtml-to-pcl/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar MHTML para PCL via .NET" h2="API .NET para exportar MHTML para PCL no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter MHTML em PCL" %}}
...
4. Salve o documento no formato PCL usando o método [Save](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) e defina Pcl como SaveFormat
