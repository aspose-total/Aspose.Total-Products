...
description: Converta docxumentos do Word em arquivos ppsx do PowerPoint com C#. Converta vários arquivos no ASP.NET ou em outros aplicativos .NET.
---
...
1. Salve o docxumento usando [Aspose.Slides.Presentation.Save("output.ppsx", SaveFormat.Ppsx)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
