---
title: API .NET para converter OTT para XLSB
description: API C# para converter OTT para XLSB sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/ott-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter OTT para XLSB" h2="Exporte OTT para XLSB via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o ottumento no formato XLSB usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSB" como SaveFormat
