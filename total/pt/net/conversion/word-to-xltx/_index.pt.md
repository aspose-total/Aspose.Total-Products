---
title: API .NET para converter WORD para XLTX
description: API C# para converter WORD para XLTX sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/word-to-xltx/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter WORD para XLTX" h2="Exporte WORD para XLTX via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato XLTX usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLTX" como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Carregar wordumento WORD do fluxo via C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) também permite carregar wordumentos WORD via stream. Para abrir um wordumento de um stream, basta passar um objeto stream que contém o wordumento para o construtor [Wordument](https://apireference.aspose.com/words/net/aspose.words/wordument). O exemplo de código a seguir mostra como abrir um wordumento de um fluxo:  
{{% blocks/products/pf/feature-page-code %}}
...
Ao converter WORD para XLTX, o [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) permite adicionar propriedades personalizadas em seus wordumentos XLTX. Para adicionar uma propriedade personalizada, você pode usar o método [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection/methods/add/index) para o método [CustomWordumentPropertyCollection](https://apireference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection) classe. O método Add adiciona a propriedade ao arquivo Excel e retorna uma referência para a nova propriedade do wordumento como um [Aspose.Cells.Properties.WordumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /wordumentproperty) objeto. 
{{% blocks/products/pf/feature-page-code %}}
