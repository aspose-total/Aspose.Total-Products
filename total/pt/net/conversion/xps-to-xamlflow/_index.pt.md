...
description: Converter XPS para XAMLFLOW sem usar o Microsoft Word
url_ignore: /pt/net/conversion/xps-to-xamlflow/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar XPS para XAMLFLOW via .NET" h2="API .NET para exportar XPS para XAMLFLOW no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter XPS em XAMLFLOW" %}}
