...
description: Converta dotumentos do Word em arquivos pps do PowerPoint com C#. Converta vários arquivos no ASP.NET ou em outros aplicativos .NET.
---
...
1. Salve o dotumento usando [Aspose.Slides.Presentation.Save("output.pps", SaveFormat.Pps)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
