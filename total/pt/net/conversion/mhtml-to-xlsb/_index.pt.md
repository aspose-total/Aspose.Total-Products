---
title: Converter MHTML para XLSB via API C#
description: API C# para converter arquivo MHTML em XLSB sem usar o Microsoft Excel ou Adobe Reader
url_ignore: /pt/net/conversion/mhtml-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/feature-page-section  h2="Converter MHTML Protegido para XLSB via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo MHTML para XLSB com marca d'água via C#" %}}
