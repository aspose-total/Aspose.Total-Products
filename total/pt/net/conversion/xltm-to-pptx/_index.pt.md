---
title: Converter XLTM para PPTX com .NET 
description: Converter XLTM para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xltm-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLTM para PPTX via C#" h2="Exportar Excel&reg; XLTM para PPTX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
