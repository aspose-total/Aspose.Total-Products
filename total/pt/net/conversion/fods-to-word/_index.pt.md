...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter FODS para WORD via C# ou aplicativo on-line" h2="Exportar Excel&reg; FODS para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
