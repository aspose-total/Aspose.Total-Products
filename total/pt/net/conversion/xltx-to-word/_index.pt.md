---
title: Converter XLTX para WORD com .NET 
description: Converter XLTX para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xltx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLTX para WORD via C#" h2="Exportar Excel&reg; XLTX para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
