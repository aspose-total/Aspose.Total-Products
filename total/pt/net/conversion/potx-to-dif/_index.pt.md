---
title: Converter POTX para DIF via C#
description: Converter POTX para DIF em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTX para DIF via C#" h2="API .NET para conversão de POTX para DIF sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
