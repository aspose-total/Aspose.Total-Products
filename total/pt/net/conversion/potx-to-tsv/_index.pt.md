...
description: Converter POTX para TSV em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTX para TSV via C#" h2="API .NET para conversão de POTX para TSV sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
