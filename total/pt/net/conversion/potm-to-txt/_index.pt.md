---
title: Converter POTM para TXT via C# .NET 
url: /pt/net/conversion/potm-to-txt/ 
description: Converta txtumentos potm do PowerPoint em arquivos txt do Word com C#. Converta vários arquivos no ASP.NET ou em outros aplicativos .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter POTM para TXT usando C#" h2="Crie aplicativos de conversão de txtumentos do Microsoft PowerPoint POTM Presentation para Word TXT nas plataformas .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="POTM" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="TXTM" >}}
...
1. Salve o txtumento no objeto [MemoryStream](https://txts.microsoft.com/en-us/dotnet/api/system.io.memorystream?view=net-5.0)
1. Crie [Aspose.Words.Txtument](https://apireference.aspose.com/words/net/aspose.words/txtument) e inicialize-o com o objeto MemoryStream
1. Salve o txtumento usando [Aspose.Words.Txtument.Save("output.txt", SaveFormat.Txt)](https://apireference.aspose.com/words/net/aspose.words.txtument/save/methods /3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/potm-to-txtx" name="POTM Para TXTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/net/conversion/potm-to-txtm" name="POTM Para TXTM" description="" >}}
