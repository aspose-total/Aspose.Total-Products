...
description: Converter POTX para XLSB em C# sem usar o Microsoft Excel ou Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converter POTX para XLSB via C#" h2="API .NET para conversão de POTX para XLSB sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
