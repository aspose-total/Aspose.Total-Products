---
title: Converter ODS para DOC com .NET 
description: Converter ODS para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter ODS para DOC via C#" h2="Exportar Excel&reg; ODS para DOC em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
