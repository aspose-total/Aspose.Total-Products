---
title: Converter XLT para WORD com .NET 
description: Converter XLT para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlt-to-word/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLT para WORD via C#" h2="Exportar Excel&reg; XLT para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
