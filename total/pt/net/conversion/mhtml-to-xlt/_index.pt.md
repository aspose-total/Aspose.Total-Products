---
title: Converter MHTML para XLT via API C#
description: API C# para converter arquivo MHTML em XLT sem usar o Microsoft Excel ou Adobe Reader
url_ignore: /pt/net/conversion/mhtml-to-xlt/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/feature-page-section  h2="Converter MHTML Protegido para XLT via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converter arquivo MHTML para XLT com marca d'água via C#" %}}
