---
title: Converter XLSB para DOCX com .NET 
description: Converter XLSB para DOCX em plataformas .NET Framework, .NET Core, Mono ou Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSB para DOCX via C#" h2="Exportar Excel&reg; XLSB para DOCX em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
