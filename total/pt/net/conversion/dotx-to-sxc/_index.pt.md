---
title: API .NET para converter DOTX para SXC ou com o conversor online grátis
description: API C# para converter DOTX para SXC ou aplicativo on-line sem usar o Microsoft Excel ou Adobe Reader ou on-line. Teste o conversor online gratuito de DOTX para SXC rapidamente antes de integrar o código. ou com o conversor online gratuito
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOTX para SXC ou aplicativo on-line" h2="Exporte DOTX para SXC via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
<iframe title="Ferramenta on-line de conversão de sxc para dotx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=sxc&from=dotx" id="child-iframe" width="80%"></iframe>
