...
description: Converta dotxumentos do Word em arquivos potx do PowerPoint com C#. Converta vários arquivos no ASP.NET ou em outros aplicativos .NET.
---
...
1. Salve o dotxumento usando [Aspose.Slides.Presentation.Save("output.potx", SaveFormat.Potx)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
