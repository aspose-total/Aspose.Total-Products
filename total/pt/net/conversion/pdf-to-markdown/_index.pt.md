---
title: API C# para exportar PDF para MARKDOWN
description: Converter PDF para MARKDOWN sem usar o Microsoft Word
url_ignore: /pt/net/conversion/pdf-to-markdown/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PDF para MARKDOWN via .NET" h2="API .NET para exportar PDF para MARKDOWN no Windows, macOS e Linux sem usar o Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API C# para converter PDF em MARKDOWN" %}}
