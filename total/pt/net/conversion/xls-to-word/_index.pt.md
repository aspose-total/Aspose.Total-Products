---
title: Converter XLS para WORD com .NET 
description: Converter XLS para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLS para WORD via C#" h2="Exportar Excel&reg; XLS para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
