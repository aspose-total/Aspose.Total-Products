---
title: Conversão online de JSON para PCL ou criação de aplicativo baseado em .NET para converter arquivos JSON
description: Aplicativo online gratuito para converter arquivos JSON para PCL. Código de biblioteca de conversão .NET C# para documentos JSON. 
...
<iframe title="Aplicativo gratuito de conversão de JSON para PCL online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=pcl&from=json" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converta arquivos JSON para PCL online usando o aplicativo" %}}
...
1. JSON será convertido em documento PCL
1. Baixe o arquivo PCL convertido

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Converter JSON para PCL via API de automação .NET" %}}
...
4. Salve o documento no formato PCL usando o método [Salvar](https://reference.aspose.com/words/net/aspose.words.document/save/methods/3)



{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Converter JSON para PCL via C# .NET" offSpacer="" %}}
...
Mais alguns casos para salvar JSON em PCL com outros recursos como Defina o layout e converta o formato JSON para PCL via C#, Analisar o formato JSON para PCL com marca d'água.
...
{{% blocks/products/pf/agp/feature-section-col title="Salvando JSON em PCL Requisitos do aplicativo" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você é bem-vindo para baixar este código. Pode-se facilmente desenvolver uma solução profissional para exportar e salvar JSON para arquivo PCL usando .NET. Use a API de conversão Aspose JSON para PCL para desenvolver software de alto nível e independente de plataforma em .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
