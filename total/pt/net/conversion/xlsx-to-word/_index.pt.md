---
title: Converter XLSX para WORD com .NET 
description: Converter XLSX para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin
url: /pt/net/conversion/xlsx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Converter XLSX para WORD via C#" h2="Exportar Excel&reg; XLSX para WORD em plataformas .NET Framework, .NET Core, Mono ou Xamarin">}}
