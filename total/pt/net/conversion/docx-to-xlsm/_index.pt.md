...
description: API C# para converter DOCX para XLSM sem usar o Microsoft Excel ou Adobe Reader
url: /pt/net/conversion/docx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API C# para converter DOCX para XLSM" h2="Exporte DOCX para XLSM via C# sem usar o Microsoft<sup>&reg;</sup> Word ou o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o docxumento no formato XLSM usando o método [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) e defina "XLSM" como SaveFormat
