---
title: Proteja o documento Excel online com senha e usando .NET
description: Aplicativo online de proteção de senha de arquivo Excel.Código API .NET C# para aplicar proteção por senha em planilhas Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Proteção on-line de documentos Excel ou definição de senha via .NET" h2="Desenvolva um poderoso aplicativo utilitário de proteção de documentos Excel baseado em .NET.Código listado para aplicação de senha à planilha Excel através do .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteção de senha Excel via .NET" %}}

1. Carregar arquivo Excel por meio do objeto de classe Workbook
1. Chame SetEncryptionOptions com EncryptionType
1. Atribua a senha usando Settings.Password
1. Invoque o método Save para salvar a planilha.
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Proteção por senha de documento Excel" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de proteção de senha Excel via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de proteção por senha Excel?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de proteção de documentos.A poderosa biblioteca .NET permite programar qualquer solução de proteção por senha de documento para proteger e bloquear os arquivos.Além disso, pode suportar muitos formatos populares, incluindo o formato Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para processar arquivo Excel para aplicativo de proteção" %}}
