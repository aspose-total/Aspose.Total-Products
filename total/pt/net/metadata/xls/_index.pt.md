---
title: Visualize e atualize propriedades XLS on-line ou atualize metadados usando .NET
description: Visualize e modifique as propriedades do XLS por meio do aplicativo online gratuitamente. Código da API C# .NET para atualizar e adicionar propriedades XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados XLS on-line ou atualize via .NET" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos XLS baseado em .NET.Código listado para adicionar e modificar metadados de arquivo XLS por meio de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Visualizar ou atualizar metadados XLS on-line" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gerenciar propriedades XLS via .NET" %}}
...
1. Chame o método Save() para salvar o documento XLS atualizado.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: atualizar metadados XLS" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: Adicionar propriedades personalizadas XLS" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados XLS via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados XLS?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca .NET permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato XLS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para gerenciar metadados XLS" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📊 Casos de Uso para Planilha do Excel (`.xls`)

- Armazenar metadados de propósito e propriedade do documento.
- Melhorar o rastreamento e recuperação interna de arquivos.
- Automatizar fluxos de trabalho financeiros ou baseados em projetos por meio de regras de metadados.
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para gerenciamento on-line de propriedades de documentos XLS. No entanto, se você estiver desenvolvendo um aplicativo de desktop, recomendamos usar a API de processamento de documentos Aspose.Total para um gerenciamento eficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
