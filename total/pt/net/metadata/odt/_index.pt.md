---
title: Visualize e atualize propriedades ODT on-line ou atualize metadados usando .NET
description: Visualize e modifique as propriedades do ODT por meio do aplicativo online gratuitamente. Código da API C# .NET para atualizar e adicionar propriedades ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados ODT on-line ou atualize via .NET" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos ODT baseado em .NET.Código listado para adicionar e modificar metadados de arquivo ODT por meio de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gerenciar propriedades ODT via .NET" %}}
...
1. Chame o método Save() para salvar o documento ODT atualizado.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: atualizar metadados ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: Adicionar propriedades personalizadas ODT" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados ODT via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados ODT?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca .NET permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para gerenciar metadados ODT" %}}
...
- Utilize metadados para garantir compatibilidade entre suites de escritório.
- Acompanhe os contribuidores e histórico de colaboração.
- Organize e pesquise documentos em formato aberto dentro de sistemas empresariais.
- Suporte a motores de IA/ML que analisam ODT para insights.
