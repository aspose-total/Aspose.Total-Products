---
title: Visualize e atualize propriedades XLSM on-line ou atualize metadados usando .NET
description: Visualize e modifique as propriedades do XLSM por meio do aplicativo online gratuitamente. Código da API C# .NET para atualizar e adicionar propriedades XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados XLSM on-line ou atualize via .NET" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos XLSM baseado em .NET.Código listado para adicionar e modificar metadados de arquivo XLSM por meio de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Visualizar ou atualizar metadados XLSM on-line" %}}

1. Importe o arquivo XLSM fazendo upload dele.
1. Faça isso clicando dentro da área de soltar arrastando e soltando o aplicativo de metadados.
1. Dependendo do tamanho do arquivo XLSM e da velocidade da internet, aguarde alguns segundos.
...
{{% blocks/products/pf/agp/feature-section-col title="Gerenciar propriedades XLSM via .NET" %}}

1. Crie uma classe de pasta de trabalho.
1. Acesse propriedades definidas pelo sistema usando BuiltInDocumentProperties
1. Atribua valores atualizados, como Idioma
1. Chame o método Save() para salvar o documento XLSM atualizado.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: atualizar metadados XLSM" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: Adicionar propriedades personalizadas XLSM" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados XLSM via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados XLSM?Com o [Aspose.Cells for .NET](https://products.aspose.com/cells/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca .NET permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para gerenciar metadados XLSM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 🧠 Casos de Uso para Pasta de Trabalho com Macros (`.xlsm`)

- Identificar pastas de trabalho com scripts ativos usando metadados incorporados.
- Ajudar equipes de conformidade a classificar e auditar o uso de macros.
- Suportar alertas acionados por metadados para modelos financeiros sensíveis.
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para gerenciamento on-line de propriedades de documentos XLSM. No entanto, se você estiver desenvolvendo um aplicativo de desktop, recomendamos usar a API de processamento de documentos Aspose.Total para um gerenciamento eficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
