---
title: Visualize e atualize propriedades PDF on-line ou atualize metadados usando .NET
description: Visualize e modifique as propriedades do PDF por meio do aplicativo online gratuitamente.Código API C# .NET para atualizar propriedades PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados PDF on-line ou atualize via .NET" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos PDF baseado em .NET.Código listado para atualizar metadados de arquivo PDF por meio de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Atualizar metadados PDF via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: atualizar propriedades PDF" offSpacer="" %}}
