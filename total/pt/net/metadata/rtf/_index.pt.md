---
title: Visualize e atualize propriedades RTF on-line ou atualize metadados usando .NET
description: Visualize e modifique as propriedades do RTF por meio do aplicativo online gratuitamente.Código API C# .NET para atualizar propriedades RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados RTF on-line ou atualize via .NET" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos RTF baseado em .NET.Código listado para atualizar metadados de arquivo RTF por meio de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Atualizar propriedades RTF via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: atualizar metadados RTF" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados RTF via .NET</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados RTF?Com o [Aspose.Words for .NET](https://products.aspose.com/words/pt/net/), uma API filha do [Aspose.Total for .NET](https://products.aspose.com/total/pt/net/), qualquer desenvolvedor .NET pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca .NET permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato RTF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário .NET para gerenciar metadados RTF" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 Casos de uso para o Formato de Texto Rico (`.rtf`)

- Armazenar metadados básicos como título e autor em um formato leve.
- Classificar documentos RTF para transferência, publicação ou arquivamento.
- Preservar metadados em sistemas que não suportam formatos XML completos.
