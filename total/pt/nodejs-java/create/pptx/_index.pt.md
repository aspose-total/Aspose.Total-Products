---
title: Crie apresentações PPTX em Node.js
description: Gere uma apresentação do Microsoft Powerpoint PPTX usando aplicativos Node sem usar o Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="Crie o arquivo PPTX usando Node.js" h2="Gere arquivos do Microsoft Powerpoint PPTX por meio de seus aplicativos Node sem instalar o Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Para um desenvolvedor que está tentando criar arquivos PPTX por meio do aplicativo Node.js? A API [Aspose.Total for Node.js via Java](https://products.aspose.com/total/pt/nodejs-java/) pode ajudar a automatizar o processo de criação. É um pacote completo de várias APIs que lidam com diferentes formatos, incluindo arquivos e imagens do Microsoft Office. A API [Aspose.Slides for Node.js via Java](https://products.aspose.com/slides/pt/nodejs-java/) que faz parte do pacote [Aspose.Total for Node.js via Java](https://products.aspose.com/total/pt/nodejs-java/) facilita esse processo de geração. Além disso, os desenvolvedores podem facilmente aprimorar o aplicativo para modificação do arquivo PPTX. 

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Crie o arquivo PPTX no Node.js" %}}
...
- Escreva a apresentação modificada como um arquivo PPTX.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de criação" %}}

- Para criação de documentos PPTX, o Node.js deve estar instalado no sistema.
- O Oracle JDK (versão 7 ou posterior) é necessário.
- O pacote node-java deve ser configurado.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Criar arquivos PPTX" offSpacer="" %}}
