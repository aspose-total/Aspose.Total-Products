---
title: Compactar arquivos ODT on-line ou usando aplicativos móveis Android
description: Aplicativo online gratuito para compactar diferentes arquivos ODT.Código Java da biblioteca de compactação Android para documentos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Compactar arquivo ODT online ou usando aplicativo Android" h2="Desenvolva poderosos aplicativos de compactação de documentos ODT baseados em Android.Comprima gratuitamente vários documentos, incluindo arquivos ODT on-line por meio do aplicativo com download instantâneo." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Compactar e otimizar arquivos ODT online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo ODT via aplicativo Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java: compactar arquivos ODT" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivos ODT para Android</h2>

Precisa desenvolver um script Android ou aplicativo utilitário para compactar facilmente vários arquivos ODT?Com as APIs filhas do [Aspose.Words for Android via Java](https://products.aspose.com/words/pt/android-java/) do [Aspose.Total for Android via Java](https://products.aspose.com/total/pt/android-java/), qualquer desenvolvedor Android pode integrar o código da API acima para programar o aplicativo de compactação em documentos.A poderosa biblioteca Android para compactação de documentos suporta muitos formatos populares, incluindo o formato ODT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compactação Android para arquivos ODT" %}}
