---
title: API Android para converter DOCX para EXCEL
description: Converta DOCX para EXCEL no Android via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/android-java/conversion/docx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
4. Salve o docxumento no formato EXCEL usando [Salvar](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)) método
