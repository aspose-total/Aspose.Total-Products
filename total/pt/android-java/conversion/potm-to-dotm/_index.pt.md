---
title: Exportar POTM para DOTM no Andorid via Java
description: Converta POTM para DOTM em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderize POTM para DOTM no Andorid via Java" h2="APIs de formato de arquivo para converter POTM para DOTM em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
...
Você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale [Aspose.Slides for Android via Java](https://dotms.aspose.com/slides/androidjava/install-aspose-slides-for-android-via-java/) e [Aspose.Words for Andorid via Java](https://dotms.aspose.com/words/java/install-aspose-words-for-android-via-java/#install-asposewords-for-android-via-java-from-maven-repository) em seu formulários.
