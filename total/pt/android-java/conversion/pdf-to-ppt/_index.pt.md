---
title: Exportar PDF para PPT no Android
description: API do Android para converter PDF em PPT sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: PDF
