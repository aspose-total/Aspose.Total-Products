---
title: Exportar CGM para PPSM no Android
description: API do Android para converter CGM em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: CGM
