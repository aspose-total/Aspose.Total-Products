---
title: Converter POTM para XLT no Android via Java
description: Converta POTM para XLT no Android via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/android-java/conversion/potm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Converter POTM para XLT no Android via Java" h2="Exporte o arquivo POTM para XLT em aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter POTM para XLT, você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas em seu aplicativo.
