---
title: Exportar PCL para PPSX no Android
description: API do Android para converter PCL em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: PCL
