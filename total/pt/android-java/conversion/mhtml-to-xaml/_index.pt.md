---
title: Exportar MHTML para XAML no Android
description: API do Android para converter MHTML em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
