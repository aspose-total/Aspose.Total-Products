...
url: /pt/android-java/conversion/txt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
Para conversão de arquivos TXT para ODP, você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas em seu aplicativo.
