---
title: Exportar TEX para PPS no Android
description: API do Android para converter TEX em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: TEX
