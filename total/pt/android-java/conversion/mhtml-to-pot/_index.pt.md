---
title: Exportar MHTML para POT no Android
description: API do Android para converter MHTML em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
