---
title: Exportar PDF para PPSM no Android
description: API do Android para converter PDF em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: PDF
