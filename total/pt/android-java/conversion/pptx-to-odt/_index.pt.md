---
title: Exportar PPTX para ODT no Andorid via Java
description: Converta PPTX para ODT em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Renderize PPTX para ODT no Andorid via Java" h2="APIs de formato de arquivo para converter PPTX para ODT em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
