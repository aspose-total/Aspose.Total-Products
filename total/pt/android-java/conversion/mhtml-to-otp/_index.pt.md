---
title: Exportar MHTML para OTP no Android
description: API do Android para converter MHTML em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
