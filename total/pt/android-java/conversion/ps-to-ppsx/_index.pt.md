---
title: Exportar PS para PPSX no Android
description: API do Android para converter PS em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: PS
