---
title: Exportar PPTM para DOCM no Andorid via Java
description: Converta PPTM para DOCM em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Renderize PPTM para DOCM no Andorid via Java" h2="APIs de formato de arquivo para converter PPTM para DOCM em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/android-java/conversion/pptm-to-docmx/" name="PPTM Para DOCMX" description="" >}}
