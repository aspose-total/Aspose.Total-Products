---
title: Converter DOCX para formato JSON no Android via Java
description: Analise o formato DOCX para JSON no Android via Java sem usar o Microsoft Word ou Excel
url: /pt/android-java/conversion/docx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
4. Salve o docxumento no formato JSON usando [Salvar](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)) método
...
{{% blocks/products/pf/feature-page-section  h2="Converter DOCX para JSON em Range no Android via Java" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/android-java/conversion/docx-to-csv/" name="DOCX Para CSV" description="" >}}
