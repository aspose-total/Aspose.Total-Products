---
title: Exportar TEX para POT no Android
description: API do Android para converter TEX em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: TEX
