---
title: API do Android para renderizar PS para MHTML
description: Transforme PS em MHTML via Android via API Java
url: /pt/android-java/conversion/ps-to-mhtml/
family: total
platformtag: cpp
feature: conversion
informat: PS
...
{{< blocks/products/pf/feature-page-header h1="Renderize PS para MHTML no Android via Java" h2="Converta PS para MHTML em aplicativos móveis sem instalar nenhum software" >}}

{{% blocks/products/pf/feature-page-summary %}}
Você pode integrar o recurso de conversão PS para MHTML em seus aplicativos móveis usando duas APIs do pacote [Aspose.Total for Android Java](https://products.aspose.com/total/android-java/). Primeiro você precisa converter o arquivo PS para DOC usando [Aspose.PDF para Android via Java](https://products.aspose.com/pdf/android-java/). Em segundo lugar, usando a API de processamento de texto [Aspose.Words for Android Java](https://products.aspose.com/words/android-java/), você pode renderizar DOC para MHTML. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converter PS para MHTML no Android via Java" %}}
