---
title: Exportar EPUB para OTP no Android
description: API do Android para converter EPUB em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
