---
title: Exportar PCL para PPSM no Android
description: API do Android para converter PCL em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: PCL
