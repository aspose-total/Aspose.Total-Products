---
title: Converter POT para XLS no Android via Java
description: Converta POT para XLS no Android via Java sem usar o Microsoft Excel ou PowerPoint
url: /pt/android-java/conversion/pot-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Converter POT para XLS no Android via Java" h2="Exporte o arquivo POT para XLS em aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel ou PowerPoint" >}}
...
Para converter POT para XLS, você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas em seu aplicativo.
