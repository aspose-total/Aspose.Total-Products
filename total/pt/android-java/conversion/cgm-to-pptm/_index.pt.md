---
title: Exportar CGM para PPTM no Android
description: API do Android para converter CGM em PPTM sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: CGM
