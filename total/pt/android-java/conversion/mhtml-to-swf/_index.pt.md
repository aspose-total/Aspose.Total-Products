---
title: Exportar MHTML para SWF no Android
description: API do Android para converter MHTML em SWF sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
