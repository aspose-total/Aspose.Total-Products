---
title: Exportar MHTML para PPT no Android
description: API do Android para converter MHTML em PPT sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
