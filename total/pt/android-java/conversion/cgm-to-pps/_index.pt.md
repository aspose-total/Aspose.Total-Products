---
title: Exportar CGM para PPS no Android
description: API do Android para converter CGM em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: CGM
