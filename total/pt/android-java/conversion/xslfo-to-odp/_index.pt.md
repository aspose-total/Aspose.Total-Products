---
title: Exportar XSLFO para ODP no Android
description: API do Android para converter XSLFO em ODP sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
