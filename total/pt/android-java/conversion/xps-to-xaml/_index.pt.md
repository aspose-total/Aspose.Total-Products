---
title: Exportar XPS para XAML no Android
description: API do Android para converter XPS em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/xps-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: XPS
