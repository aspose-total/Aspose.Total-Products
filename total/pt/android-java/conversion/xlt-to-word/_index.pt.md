---
title: Exportar XLT para WORD no Android
description: API do Android para converter XLT para WORD sem usar o Microsoft Word
url: /pt/android-java/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLT para WORD no Android via Java" h2="Transforme XLT em WORD em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
