---
title: API do Android para renderizar SVG para RTF
description: Transforme SVG em RTF via Android via API Java
url: /pt/android-java/conversion/svg-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: SVG
...
{{< blocks/products/pf/feature-page-header h1="Renderize SVG para RTF no Android via Java" h2="Converta SVG para RTF em aplicativos móveis sem instalar nenhum software" >}}

{{% blocks/products/pf/feature-page-summary %}}
Você pode integrar o recurso de conversão SVG para RTF em seus aplicativos móveis usando duas APIs do pacote [Aspose.Total for Android Java](https://products.aspose.com/total/android-java/). Primeiro você precisa converter o arquivo SVG para DOC usando [Aspose.PDF para Android via Java](https://products.aspose.com/pdf/android-java/). Em segundo lugar, usando a API de processamento de texto [Aspose.Words for Android Java](https://products.aspose.com/words/android-java/), você pode renderizar DOC para RTF. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converter SVG para RTF no Android via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Inserir notas de fim no documento RTF no Android via Java" %}}
