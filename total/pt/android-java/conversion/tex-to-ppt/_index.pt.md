---
title: Exportar TEX para PPT no Android
description: API do Android para converter TEX em PPT sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: TEX
