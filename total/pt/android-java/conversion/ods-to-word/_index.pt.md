---
title: Exportar ODS para WORD no Android
description: API do Android para converter ODS para WORD sem usar o Microsoft Word
url: /pt/android-java/conversion/ods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Renderize ODS para WORD no Android via Java" h2="Transforme ODS em WORD em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
