---
title: Exportar SXC para WORD no Android
description: API do Android para converter SXC para WORD sem usar o Microsoft Word
url: /pt/android-java/conversion/sxc-to-word/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Renderize SXC para WORD no Android via Java" h2="Transforme SXC em WORD em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
