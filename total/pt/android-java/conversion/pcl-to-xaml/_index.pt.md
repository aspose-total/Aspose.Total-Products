---
title: Exportar PCL para XAML no Android
description: API do Android para converter PCL em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: PCL
