---
title: Exportar PS para POT no Android
description: API do Android para converter PS em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: PS
