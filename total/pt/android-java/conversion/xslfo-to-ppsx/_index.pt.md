---
title: Exportar XSLFO para PPSX no Android
description: API do Android para converter XSLFO em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
