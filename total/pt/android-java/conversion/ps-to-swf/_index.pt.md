---
title: Exportar PS para SWF no Android
description: API do Android para converter PS em SWF sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: PS
