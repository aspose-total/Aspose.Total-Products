---
title: Exportar PCL para OTP no Android
description: API do Android para converter PCL em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: PCL
