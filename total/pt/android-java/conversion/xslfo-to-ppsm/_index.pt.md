---
title: Exportar XSLFO para PPSM no Android
description: API do Android para converter XSLFO em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
