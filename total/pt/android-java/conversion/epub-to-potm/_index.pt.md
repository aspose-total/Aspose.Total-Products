---
title: Exportar EPUB para POTM no Android
description: API do Android para converter EPUB em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
