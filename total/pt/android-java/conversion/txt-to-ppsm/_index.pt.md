---
title: Converter TXT para PPSM no Android via Java
description: Conversão de TXT para PPSM em seus telefones Android sem usar o Microsoft Word do PowerPoint
url: /pt/android-java/conversion/txt-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="Converter TXT para PPSM em aplicativos Android" h2="Conversão de TXT para PPSM em seus aplicativos Android sem instalar o Microsoft Word<sup>&reg;</sup> ou PowerPoint" >}}
...
Para conversão de arquivos TXT para PPSM, você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas em seu aplicativo.
