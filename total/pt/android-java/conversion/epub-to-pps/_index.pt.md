---
title: Exportar EPUB para PPS no Android
description: API do Android para converter EPUB em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
