---
title: Exportar PDF para PPS no Android
description: API do Android para converter PDF em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: PDF
