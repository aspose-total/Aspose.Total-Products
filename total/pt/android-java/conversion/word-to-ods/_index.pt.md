---
title: API Android para converter WORD para ODS
description: Converta WORD para ODS no Android via Java sem usar o Microsoft Word ou o Microsoft Excel
url: /pt/android-java/conversion/word-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Converter WORD para ODS em aplicativos Android" h2="Exporte WORD para ODS no Android via Java sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato ODS usando [Salvar](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)) método
