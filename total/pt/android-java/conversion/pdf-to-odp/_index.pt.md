---
title: Exportar PDF para ODP no Android
description: API do Android para converter PDF em ODP sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: PDF
