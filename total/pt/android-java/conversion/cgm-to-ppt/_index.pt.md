---
title: Exportar CGM para PPT no Android
description: API do Android para converter CGM em PPT sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: CGM
