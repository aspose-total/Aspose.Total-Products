---
title: Exportar XLTX para POWERPOINT no Android
description: API do Android para converter XLTX para POWERPOINT sem usar o Microsoft Word
url: /pt/android-java/conversion/xltx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLTX para POWERPOINT no Android via Java" h2="Transforme XLTX em POWERPOINT em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
