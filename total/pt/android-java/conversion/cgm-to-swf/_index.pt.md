---
title: Exportar CGM para SWF no Android
description: API do Android para converter CGM em SWF sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: CGM
