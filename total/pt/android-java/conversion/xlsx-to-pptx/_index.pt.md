---
title: Exportar XLSX para PPTX no Android
description: API do Android para converter XLSX para PPTX sem usar o Microsoft Word
url: /pt/android-java/conversion/xlsx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLSX para PPTX no Android via Java" h2="Transforme XLSX em PPTX em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
