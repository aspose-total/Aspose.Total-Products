---
title: Exportar PS para ODP no Android
description: API do Android para converter PS em ODP sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: PS
