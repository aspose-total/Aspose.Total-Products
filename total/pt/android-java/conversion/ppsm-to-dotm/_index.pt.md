---
title: Exportar PPSM para DOTM no Andorid via Java
description: Converta PPSM para DOTM em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/ppsm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Renderize PPSM para DOTM no Andorid via Java" h2="APIs de formato de arquivo para converter PPSM para DOTM em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
