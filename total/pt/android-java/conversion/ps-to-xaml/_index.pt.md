---
title: Exportar PS para XAML no Android
description: API do Android para converter PS em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: PS
