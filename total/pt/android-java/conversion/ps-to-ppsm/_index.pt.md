---
title: Exportar PS para PPSM no Android
description: API do Android para converter PS em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: PS
