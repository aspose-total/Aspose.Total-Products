---
title: Exportar PCL para PPTM no Android
description: API do Android para converter PCL em PPTM sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: PCL
