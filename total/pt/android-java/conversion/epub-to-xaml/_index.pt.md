---
title: Exportar EPUB para XAML no Android
description: API do Android para converter EPUB em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
