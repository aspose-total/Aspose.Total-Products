---
title: Exportar MHTML para PPSM no Android
description: API do Android para converter MHTML em PPSM sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
