---
title: Exportar XLSX para DOC no Android
description: API do Android para converter XLSX para DOC sem usar o Microsoft Word
url: /pt/android-java/conversion/xlsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLSX para DOC no Android via Java" h2="Transforme XLSX em DOC em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
