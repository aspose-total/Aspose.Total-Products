---
title: Exportar PS para POTM no Android
description: API do Android para converter PS em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: PS
