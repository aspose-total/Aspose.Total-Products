---
title: Exportar PCL para PPS no Android
description: API do Android para converter PCL em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: PCL
