---
title: Exportar XSLFO para POTX no Android
description: API do Android para converter XSLFO em POTX sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
