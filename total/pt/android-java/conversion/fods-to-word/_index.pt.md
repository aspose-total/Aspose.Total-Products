---
title: Exportar FODS para WORD no Android
description: API do Android para converter FODS para WORD sem usar o Microsoft Word
url: /pt/android-java/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Renderize FODS para WORD no Android via Java" h2="Transforme FODS em WORD em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
