---
title: Exportar PDF para POTX no Android
description: API do Android para converter PDF em POTX sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: PDF
