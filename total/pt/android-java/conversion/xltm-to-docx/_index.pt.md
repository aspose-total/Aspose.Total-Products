---
title: Exportar XLTM para DOCX no Android
description: API do Android para converter XLTM para DOCX sem usar o Microsoft Word
url: /pt/android-java/conversion/xltm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLTM para DOCX no Android via Java" h2="Transforme XLTM em DOCX em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/android-java/conversion/xltm-to-docx/" name="XLTM Para DOCX" description="" >}}
