---
title: Exportar TEX para PPSX no Android
description: API do Android para converter TEX em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: TEX
