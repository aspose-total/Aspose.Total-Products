---
title: Exportar CGM para POTM no Android
description: API do Android para converter CGM em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: CGM
