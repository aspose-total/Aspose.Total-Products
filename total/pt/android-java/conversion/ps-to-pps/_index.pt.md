---
title: Exportar PS para PPS no Android
description: API do Android para converter PS em PPS sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: PS
