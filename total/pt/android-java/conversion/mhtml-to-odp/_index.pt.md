---
title: Exportar MHTML para ODP no Android
description: API do Android para converter MHTML em ODP sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
