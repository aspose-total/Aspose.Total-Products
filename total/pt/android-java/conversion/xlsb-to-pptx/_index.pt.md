---
title: Exportar XLSB para PPTX no Android
description: API do Android para converter XLSB para PPTX sem usar o Microsoft Word
url: /pt/android-java/conversion/xlsb-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLSB para PPTX no Android via Java" h2="Transforme XLSB em PPTX em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/android-java/conversion/xlsb-to-pptxx/" name="XLSB Para PPTXX" description="" >}}
