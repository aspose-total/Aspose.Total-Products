---
title: Exportar PCL para POTM no Android
description: API do Android para converter PCL em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: PCL
