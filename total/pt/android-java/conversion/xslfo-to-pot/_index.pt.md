---
title: Exportar XSLFO para POT no Android
description: API do Android para converter XSLFO em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
