---
title: Exportar EPUB para PPTM no Android
description: API do Android para converter EPUB em PPTM sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
