---
title: Exportar PS para POTX no Android
description: API do Android para converter PS em POTX sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: PS
