---
title: Exportar MHTML para POTX no Android
description: API do Android para converter MHTML em POTX sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
