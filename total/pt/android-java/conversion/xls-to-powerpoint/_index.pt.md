---
title: Exportar XLS para POWERPOINT no Android
description: API do Android para converter XLS para POWERPOINT sem usar o Microsoft Word
url: /pt/android-java/conversion/xls-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLS para POWERPOINT no Android via Java" h2="Transforme XLS em POWERPOINT em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
