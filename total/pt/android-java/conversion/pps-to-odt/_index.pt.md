---
title: Exportar PPS para ODT no Andorid via Java
description: Converta PPS para ODT em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Renderize PPS para ODT no Andorid via Java" h2="APIs de formato de arquivo para converter PPS para ODT em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
