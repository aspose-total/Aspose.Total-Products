---
title: Exportar EPUB para ODP no Android
description: API do Android para converter EPUB em ODP sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
