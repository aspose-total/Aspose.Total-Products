---
title: Exportar TEX para OTP no Android
description: API do Android para converter TEX em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: TEX
