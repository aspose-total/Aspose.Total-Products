---
title: Exportar PDF para POTM no Android
description: API do Android para converter PDF em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: PDF
