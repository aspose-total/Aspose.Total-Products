---
title: Exportar MHTML para PPTM no Android
description: API do Android para converter MHTML em PPTM sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
