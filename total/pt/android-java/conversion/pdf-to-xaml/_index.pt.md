---
title: Exportar PDF para XAML no Android
description: API do Android para converter PDF em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/pdf-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: PDF
