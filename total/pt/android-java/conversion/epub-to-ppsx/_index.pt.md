---
title: Exportar EPUB para PPSX no Android
description: API do Android para converter EPUB em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
