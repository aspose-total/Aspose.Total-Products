---
title: Converter DOT para ODP no Android via Java
description: Conversão de DOT para ODP em seus telefones Android sem usar o Microsoft Word do PowerPoint
url: /pt/android-java/conversion/dot-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="Converter DOT para ODP em aplicativos Android" h2="Conversão de DOT para ODP em seus aplicativos Android sem instalar o Microsoft Word<sup>&reg;</sup> ou PowerPoint" >}}
...
Para conversão de arquivos DOT para ODP, você pode facilmente usar o Aspose.Total para Android via Java diretamente do [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas em seu aplicativo.
