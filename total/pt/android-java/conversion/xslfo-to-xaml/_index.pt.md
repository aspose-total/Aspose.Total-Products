---
title: Exportar XSLFO para XAML no Android
description: API do Android para converter XSLFO em XAML sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
