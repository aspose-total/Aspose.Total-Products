---
title: Exportar XSLFO para POTM no Android
description: API do Android para converter XSLFO em POTM sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
