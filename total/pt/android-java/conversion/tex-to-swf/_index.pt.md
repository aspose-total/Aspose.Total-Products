---
title: Exportar TEX para SWF no Android
description: API do Android para converter TEX em SWF sem usar o Microsoft Word
url: /pt/android-java/conversion/tex-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: TEX
