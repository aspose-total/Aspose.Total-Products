---
title: Exportar SXC para PPTX no Android
description: API do Android para converter SXC para PPTX sem usar o Microsoft Word
url: /pt/android-java/conversion/sxc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Renderize SXC para PPTX no Android via Java" h2="Transforme SXC em PPTX em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pt/android-java/conversion/sxc-to-pptxx/" name="SXC Para PPTXX" description="" >}}
