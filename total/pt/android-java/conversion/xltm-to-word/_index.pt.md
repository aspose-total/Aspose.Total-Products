---
title: Exportar XLTM para WORD no Android
description: API do Android para converter XLTM para WORD sem usar o Microsoft Word
url: /pt/android-java/conversion/xltm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLTM para WORD no Android via Java" h2="Transforme XLTM em WORD em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
