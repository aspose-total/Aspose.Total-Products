---
title: Exportar PCL para POT no Android
description: API do Android para converter PCL em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/pcl-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: PCL
