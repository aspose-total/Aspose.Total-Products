---
title: Exportar CGM para OTP no Android
description: API do Android para converter CGM em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: CGM
