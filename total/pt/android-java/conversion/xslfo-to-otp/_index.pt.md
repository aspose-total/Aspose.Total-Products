---
title: Exportar XSLFO para OTP no Android
description: API do Android para converter XSLFO em OTP sem usar o Microsoft Word
url: /pt/android-java/conversion/xslfo-to-otp/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
