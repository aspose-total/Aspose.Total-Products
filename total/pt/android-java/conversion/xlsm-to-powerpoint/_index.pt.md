---
title: Exportar XLSM para POWERPOINT no Android
description: API do Android para converter XLSM para POWERPOINT sem usar o Microsoft Word
url: /pt/android-java/conversion/xlsm-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Renderize XLSM para POWERPOINT no Android via Java" h2="Transforme XLSM em POWERPOINT em seus aplicativos Android sem usar o Microsoft<sup>&reg;</sup> Excel" >}}
