---
title: Exportar EPUB para POT no Android
description: API do Android para converter EPUB em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/epub-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
