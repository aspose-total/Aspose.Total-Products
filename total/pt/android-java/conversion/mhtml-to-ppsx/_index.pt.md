---
title: Exportar MHTML para PPSX no Android
description: API do Android para converter MHTML em PPSX sem usar o Microsoft Word
url: /pt/android-java/conversion/mhtml-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
