---
title: Exportar CGM para POT no Android
description: API do Android para converter CGM em POT sem usar o Microsoft Word
url: /pt/android-java/conversion/cgm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: CGM
