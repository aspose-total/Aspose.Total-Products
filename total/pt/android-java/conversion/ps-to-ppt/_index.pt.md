---
title: Exportar PS para PPT no Android
description: API do Android para converter PS em PPT sem usar o Microsoft Word
url: /pt/android-java/conversion/ps-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: PS
