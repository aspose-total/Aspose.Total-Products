---
title: API Android para converter WORD para CSV ou com o conversor online gratuito
description: Converta WORD para CSV no Android via Java sem usar o Microsoft Word ou o Microsoft Excel ou on-line. Teste o conversor online gratuito de WORD para CSV rapidamente antes de integrar o código.
...
{{< blocks/products/pf/feature-page-header h1="Converter WORD para CSV em aplicativos Android ou aplicativo on-line" h2="Exporte WORD para CSV no Android via Java sem usar o Microsoft<sup>&reg;</sup> Word ou Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Salve o wordumento no formato CSV usando [Save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.SaveOptions)) método
...
<h3>Conversor Online Gratuito de WORD para CSV</h3>
          ...
          <div>
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Como posso converter WORD para CSV Online?</b></span>
                      </div>
