---
title: Exportar PPTM para ODT no Andorid via Java
description: Converta PPTM para ODT em aplicativos móveis sem instalar nenhum software
url: /pt/android-java/conversion/pptm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Renderize PPTM para ODT no Andorid via Java" h2="APIs de formato de arquivo para converter PPTM para ODT em aplicativos Android sem depender do Microsoft PowerPoint ou Word" >}}
