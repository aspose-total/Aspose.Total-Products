---
title: Mesclar arquivos TXT on-line ou usando aplicativos móveis Android
description: Aplicativo online gratuito para combinar diferentes arquivos TXT.Código Java da biblioteca de mesclagem do Android para mesclar documentos TXT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Mesclar documentos TXT on-line ou usando o aplicativo Android" h2="Desenvolva um poderoso aplicativo de mesclagem de documentos TXT baseado em Android.Combine vários documentos TXT em um único online gratuitamente via aplicativo.Salve o arquivo TXT como PDF, imagens, Word, Excel, PowerPoint e muitos outros formatos online." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivos TXT on-line" %}}

1. Carregue arquivos TXT para mesclá-los em um único
...
1. Clique no botão "Mesclar" para mesclar TXT no formato desejado
1. Baixe o arquivo TXT mesclado
1. Visualize e obtenha o único arquivo TXT mesclado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivo TXT via aplicativo Android" %}}
...
1. Chame o método save e obtenha os arquivos TXT mesclados em um
...
{{% blocks/products/pf/agp/code-block title="Código Java: mesclar arquivos TXT" offSpacer="" %}}
...
<h2>Desenvolva o aplicativo Android de fusão de arquivos TXT</h2>

Precisa desenvolver um aplicativo utilitário Android para mesclar facilmente vários arquivos TXT?Com a API filha [Aspose.Words for Android via Java](https://products.aspose.com/words/pt/android-java/) do [Aspose.Total for Android via Java](https://products.aspose.com/total/pt/android-java/), qualquer desenvolvedor Android pode integrar o código API acima para programar a mesclagem de aplicativos entre documentos.A poderosa biblioteca Android para mesclar documentos suporta muitos formatos populares, incluindo o formato TXT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de fusão do Android para arquivos TXT" %}}
