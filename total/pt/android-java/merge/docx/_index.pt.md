---
title: Mesclar arquivos DOCX on-line ou usando aplicativos móveis Android
description: Aplicativo online gratuito para combinar diferentes arquivos DOCX.Código Java da biblioteca de mesclagem do Android para mesclar documentos DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Mesclar documentos DOCX on-line ou usando o aplicativo Android" h2="Desenvolva um poderoso aplicativo de mesclagem de documentos DOCX baseado em Android.Combine vários documentos DOCX em um único online gratuitamente via aplicativo.Salve o arquivo DOCX como PDF, imagens, Word, Excel, PowerPoint e muitos outros formatos online." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivos DOCX on-line" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Mesclar arquivo DOCX via aplicativo Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java: mesclar arquivos DOCX" offSpacer="" %}}
...
<h2>Desenvolva o aplicativo Android de fusão de arquivos DOCX</h2>

Precisa desenvolver um aplicativo utilitário Android para mesclar facilmente vários arquivos DOCX?Com a API filha [Aspose.Words for Android via Java](https://products.aspose.com/words/pt/android-java/) do [Aspose.Total for Android via Java](https://products.aspose.com/total/pt/android-java/), qualquer desenvolvedor Android pode integrar o código API acima para programar a mesclagem de aplicativos entre documentos.A poderosa biblioteca Android para mesclar documentos suporta muitos formatos populares, incluindo o formato DOCX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de fusão do Android para arquivos DOCX" %}}
