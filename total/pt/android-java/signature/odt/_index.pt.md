---
title: Assine digitalmente o arquivo ODT on-line ou usando aplicativos móveis Android
description: Aplicativo online gratuito para assinatura digital em arquivos ODT.Desenvolva aplicativo Android para assinar eletronicamente documentos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Assine digitalmente o arquivo ODT on-line ou usando o aplicativo Android" h2="Desenvolva aplicativos poderosos de assinatura de documentos ODT baseados em Android.Adicione gratuitamente assinatura digital em vários documentos, incluindo arquivos ODT on-line via aplicativo com download instantâneo." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Adicionar assinatura digital em arquivos ODT online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Assine digitalmente o arquivo ODT por meio do aplicativo Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Java: Adicionar assinatura digital em arquivos ODT" offSpacer="" %}}
