---
title: Desbloqueie a proteção de senha EXCEL online ou usando Python
description: Remova a senha do documento EXCEL por meio do aplicativo online gratuitamente.Código API Python para desbloquear arquivos EXCEL protegidos por senha.
...
{{< blocks/products/pf/feature-page-header-widget h1="Remova a senha do documento EXCEL online ou via Python" h2="Desenvolva um poderoso aplicativo utilitário de bloqueio e desbloqueio de documentos EXCEL baseado em Python.Código listado para remover restrições de senha do arquivo EXCEL por meio de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Remover senha EXCEL via Python" %}}

1. Faça referência a APIs dentro do projeto diretamente do PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/)).
1. Carregue o arquivo EXCEL protegido por senha usando a classe Document.
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Python para remover senha do documento EXCEL" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de proteção EXCEL via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de proteção EXCEL?Com [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/), uma API filha do [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/), qualquer desenvolvedor python pode integrar o código API acima em seu aplicativo de proteção ou desproteção de documentos.A poderosa biblioteca Python permite programar qualquer solução de proteção de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato EXCEL.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para gerenciar proteção EXCEL" %}}
