---
title: Visualize e atualize propriedades EXCEL online ou usando Python
description: Visualize e modifique as propriedades do EXCEL por meio do aplicativo online gratuitamente.Código da API Python para visualizar, adicionar e excluir propriedades EXCEL.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados EXCEL online ou via Python" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos EXCEL baseado em Python.Código listado para adicionar, excluir e visualizar metadados de arquivos EXCEL por meio de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Visualizar ou atualizar metadados EXCEL on-line" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gerenciar propriedades EXCEL via Python" %}}
...
1. Obtenha todas as propriedades personalizadas por meio de getWorksheets().getCustomDocumentProperties().
1. Use o método get(index) para obter o valor da propriedade.
1. Use o método add() para adicionar mais propriedades.
1. Use o método remove() para remover uma propriedade.
1. Chame o método save() para salvar o documento EXCEL atualizado.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código Python: visualizar, adicionar e remover metadados EXCEL" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados EXCEL via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados EXCEL?Com o [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/), uma API filha do [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/), qualquer desenvolvedor python pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Python permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato EXCEL.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para gerenciar metadados EXCEL" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>É seguro usar o aplicativo online para gerenciar propriedades de documentos EXCEL?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode usar qualquer navegador moderno como Google Chrome, Firefox, Opera ou Safari para gerenciamento on-line de propriedades de documentos EXCEL.No entanto, se você estiver desenvolvendo um aplicativo de desktop, recomendamos usar a API de processamento de documentos Aspose.Total para um gerenciamento eficiente.</span>
                      </div>
                  </li>
              </ul>
          </div>
