---
title: Criar XLTX em Python
description: Gere o arquivo XLTX usando aplicativos Python sem usar o Microsoft Office. 
url: /pt/python-java/create/xltx/
family: total
platformtag: Python
feature: create
informat: XLTX
...
- Salve o documento como arquivo .xltx usando [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) passando o arquivo com caminho como parâmetro

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de criação" %}}

- Para geração de XLTX, faça referência a APIs dentro do projeto diretamente do PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Criar XLTX em Python" offSpacer="" %}}
