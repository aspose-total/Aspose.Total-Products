---
title: Criar XLS em Python
description: Gere o arquivo XLS usando aplicativos Python sem usar o Microsoft Office. 
url: /pt/python-java/create/xls/
family: total
platformtag: Python
feature: create
informat: XLS
...
- Salve o documento como arquivo .xls usando [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) passando o arquivo com caminho como parâmetro

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de criação" %}}

- Para geração de XLS, faça referência a APIs dentro do projeto diretamente do PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Criar XLS em Python" offSpacer="" %}}
