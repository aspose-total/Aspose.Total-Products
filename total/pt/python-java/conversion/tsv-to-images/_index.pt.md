---
title: Converter TSV em imagem usando Python
description: TSV para imagem TIFF BMP PNG JPEG GIF EMF Conversão SVG em seus aplicativos Python sem usar o Microsoft Excel 
url: /pt/python-java/conversion/tsv-to-images/
family: total
platformtag: Python
feature: conversion
informat: TSV
...
- Salve todas as páginas da planilha como uma imagem usando o método [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). Agora o arquivo TSV é convertido em Imagens no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="TSV para conversão de imagens via Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="TSV PARA Imagem" description="" >}}
