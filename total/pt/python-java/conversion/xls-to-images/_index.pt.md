---
title: Converter XLS em imagem usando Python
description: XLS para imagem TIFF BMP PNG JPEG GIF EMF Conversão SVG em seus aplicativos Python sem usar o Microsoft Excel 
...
- Salve todas as páginas da planilha como uma imagem usando o método [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). Agora o arquivo XLS é convertido em Imagens no caminho especificado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversão" %}}

- Para conversão de XLS para Imagens (JPG, PNG, GIF, BMP, TIFF), APIs de referência dentro do projeto diretamente do PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="XLS para conversão de imagens via Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLS PARA Imagem" description="" >}}
