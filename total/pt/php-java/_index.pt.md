---
title: PHP API para Excel, arquivos PowerPoint e processamento de código de barras
weight: 50
description: Processe planilhas do Excel e documentos do PowerPoint via PHP API. Reconhecer e gerar códigos de barras 1D, 2D e postais através de aplicações PHP.
---
...
<h2 class="pr-ft">
 ...
 Recursos avançados do Aspose.Total para PHP via APIs Java
</h2>
     <p>
   </p>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Suporte para CSV, delimitado por tabulações e formatos. formatos HTML
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Carregar &amp; salvar formato OpenDocument Spreadsheet (ODS)
    </p>
   </div>
   <div class="col-lg-4">
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Crie ou clone slides de modelos
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Adicionar gráficos do Excel como OleObjects aos slides
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Proteger apresentações e PDF resultante
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-print ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Criar &amp; personalizar gráficos
            ...
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-parameters/'>Gerenciar parâmetros de código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/customize-barcodes/'>Personalize o tamanho do código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/generate-codabar/'>Gerar Codabar</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/phpjava/set-barcode-text/'>Personalizar legendas de texto</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/barcode-reading-presets/'>Predefinições de leitura de código de barras</a>
                </p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="col-lg-10">
                    <a href='https://docs.aspose.com/barcode/read-damaged-barcodes/'>Ler códigos de barras danificados</a>
                </p>
            </div>
<div class="col-lg-12">
 <h2 class="h2title">
  Processar uma infinidade de formatos Excel e PowerPoint
 </h2>
 <p>
  Com o Aspose.Total para PHP via Java, pode-se desenvolver um sistema versátil de relatórios de documentos capaz de lidar com vários formatos de planilhas, bem como uma solução para lidar e exportar documentos do PowerPoint. 
 </p>
 <p>
  Aspose.Total para PHP via Java suporta atualmente os seguintes tipos de arquivo.
 </p>
 <ul class="unstyled">
  ...
  <li>
    Códigos de barras 1D, 2D e postais
  </li>
 </ul>
</div>
...
Tentamos várias outras soluções gratuitas e pagas, mas todas tinham limitações muito grandes para o nosso caso de uso. A maioria dos problemas com nossas soluções surgiu na conversão de arquivos do Microsoft Office para PDF. Apenas Aspose provou fazer isso perfeitamente todas as vezes.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="André Garcia | Fermator, Espanha" >}}
Só podemos dizer uma coisa: excelente produto e excelente atendimento. Às vezes, você pode encontrar um bom produto com falta de atendimento ao cliente. Este não é o caso do Aspose.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Documentação" href="https://docs.aspose.com/total/nodejsjava/" >}} 
...
{{< blocks/products/pf/slr-tab tabTitle="Por que Aspose.Total para PHP via Java?" tabId="success-stories" >}}
