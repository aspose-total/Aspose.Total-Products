---
title: Visualize e atualize propriedades PPTX online ou usando Python
description: Visualize e modifique as propriedades do PPTX por meio do aplicativo online gratuitamente.Código da API Python para visualizar e editar propriedades PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados PPTX online ou via Python" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos PPTX baseado em Python.Código listado para modificar e visualizar metadados de arquivos PPTX por meio de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Visualize ou modifique propriedades PPTX via Python" %}}
...
1. Obtenha todas as propriedades via document_properties.
1. Percorra todas as propriedades e imprima.
1. Para atualizar, use o método set_custom_property_value.
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Python para visualizar e atualizar metadados PPTX" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados PPTX via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados PPTX?Com o [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), uma API filha do [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), qualquer desenvolvedor python pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Python permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para gerenciar metadados PPTX" %}}
