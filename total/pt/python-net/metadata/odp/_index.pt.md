---
title: Visualize e atualize propriedades ODP online ou usando Python
description: Visualize e modifique as propriedades do ODP por meio do aplicativo online gratuitamente.Código da API Python para visualizar e editar propriedades ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Visualize ou atualize metadados ODP online ou via Python" h2="Desenvolva um poderoso aplicativo utilitário de gerenciamento de metadados de documentos ODP baseado em Python.Código listado para modificar e visualizar metadados de arquivos ODP por meio de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Visualize ou modifique propriedades ODP via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Python para visualizar e atualizar metadados ODP" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de gerenciamento de metadados ODP via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de gerenciamento de metadados ODP?Com o [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), uma API filha do [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), qualquer desenvolvedor python pode integrar o código da API acima em seu aplicativo de metadados de documentos.A poderosa biblioteca Python permite programar qualquer solução de metadados de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para gerenciar metadados ODP" %}}
