---
title: Compactação de arquivos PPT on-line ou criação de aplicativos Python para compactar ou arquivar arquivos PPT
description: Aplicativo online gratuito para compactar diferentes arquivos PPT. Compressão Python e código da biblioteca de arquivamento para documentos PPT. 
...
{{< blocks/products/pf/feature-page-header-widget h1="Aplicativo de compactação de documentos on-line e código Python para compactar arquivos PPT" h2="Desenvolva aplicativos poderosos de compactação de documentos PPT baseados em Python.Arquive documentos PPT únicos e múltiplos em ZIP, RAR e mais opções de arquivamento por meio de seu aplicativo Python.Comprima gratuitamente vários documentos, incluindo arquivos PPT on-line por meio do aplicativo com download instantâneo." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Compactar arquivo PPT via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código Python para compactar arquivos PPT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Arquivar arquivo PPT via Python" %}}
...
1. Adicione quantos arquivos PPT desejar arquivar usando create_entry().
1. Chame o método save e obtenha o arquivo PPT arquivado como ZIP, RAR etc.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Exemplo de código em python para arquivar arquivo PPT" offSpacer="" %}}

{{< gist "aspose-com-gists" "533b68e0904932a37c25a576bd20448d" "compress-and-add-single-file-into-archive.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código Python para arquivar vários arquivos PPT" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de compactação de arquivo PPT usando Python</h2>

Precisa desenvolver um script python ou um aplicativo utilitário para compactar facilmente vários arquivos PPT?Com Aspose.Slides for Python via .NET, Aspose.ZIP for Python via .NET, APIs filhas de Aspose.Total for Python via .NET, qualquer desenvolvedor python pode integrar o código API acima para programar compactação e arquivamento (ZIP, 7Zip, RAR, TAR, GZIP, BZ2, GZIP, LZ, CPIO, XZ, Z, CAB) aplicativo entre documentos.A poderosa biblioteca Python para compactação de documentos suporta muitos formatos populares, incluindo o formato PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca de compressão PPT para Python" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sim, você pode baixar este código.Pode-se desenvolver facilmente uma solução profissional para compactar e compactar arquivos PPT usando Python.Use a API de compactação Aspose PPT para desenvolver software independente de plataforma de alto nível em Python.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
