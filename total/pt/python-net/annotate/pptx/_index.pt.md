---
title: Limpar anotações PPTX online e usando Python
description: Remova comentários do documento PPTX por meio do aplicativo online gratuitamente.Código API Python para excluir comentários de apresentações PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Remover comentários da apresentação PPTX online ou via Python" h2="Desenvolva um poderoso aplicativo utilitário de anotação de apresentação PPTX baseado em Python.Código listado para limpar comentários do arquivo PPTX por meio de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Limpar anotações de apresentação PPTX on-line" %}}

1. Importe o arquivo PPTX para limpar comentários fazendo upload dele.
...
1. Clique no botão 'Remover' para excluir comentários.
1. Baixe o arquivo instantaneamente.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Remover comentários de documentos PPTX via Python" %}}

1. Faça referência a APIs dentro do projeto diretamente do PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Crie um objeto de classe de apresentação ou carregue um arquivo por meio deste objeto
1. Obtenha todos os autores
1. Invoque o método clear() para excluir todos os comentários
1. Chame comment_authors.clear() para remover todos os autores
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Python para remover comentários do documento PPTX" offSpacer="" %}}
...
<h2>Desenvolva um aplicativo de anotação de documentos PPTX via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de anotação PPTX?Com [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), uma API filha do [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), qualquer desenvolvedor python pode integrar o código API acima em seu aplicativo de anotação de documentos.A poderosa biblioteca Python permite programar qualquer solução de anotação de documentos.Além disso, pode suportar muitos formatos populares, incluindo o formato PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para anotar arquivos PPTX" %}}
