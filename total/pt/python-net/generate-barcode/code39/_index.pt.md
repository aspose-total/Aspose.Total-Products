---
title: Gere imagens de código de barras CODE39 via Python
description: Crie imagens de código de barras de simbologia CODE39 usando aplicativos Python sem usar nenhum outro software. 
...
{{< blocks/products/pf/feature-page-header h1="Gerar código de barras CODE39 usando Python" h2="Crie imagens de código de barras por meio de seus aplicativos Python sem instalar nenhum outro software." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como gerar código de barras CODE39 em Python" %}}
...
- Para criação de código de barras CODE39, Python 3.5 ou posterior é necessário
...
{{% blocks/products/pf/agp/code-block title="Gerar código de barras de simbologia CODE39 em Python" offSpacer="" %}}
