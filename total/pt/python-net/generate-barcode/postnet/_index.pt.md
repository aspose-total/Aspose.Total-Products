---
title: Gere imagens de código de barras POSTNET via Python
description: Crie imagens de código de barras de simbologia POSTNET usando aplicativos Python sem usar nenhum outro software. 
...
- Para criação de código de barras POSTNET, Python 3.5 ou posterior é necessário
...
{{% blocks/products/pf/agp/code-block title="Gerar código de barras de simbologia POSTNET em Python" offSpacer="" %}}
