---
title: Criar DOTM em Python
description: Gere o arquivo DOTM usando aplicativos Python sem usar o Microsoft Word. 
url: /pt/python-net/create/dotm/
family: total
platformtag: Python
feature: create
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Criar DOTM usando Python" h2="Gere DOTM por meio de seus aplicativos Python sem instalar o Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como criar um arquivo DOTM em Python" %}}
...
- Salve usando o método [save()](https://reference.aspose.com/words/python-net/aspose.words/document/save/) passando o caminho do documento DOTM relevante.
...
{{% blocks/products/pf/agp/code-block title="Criar DOTM em Python" offSpacer="" %}}
