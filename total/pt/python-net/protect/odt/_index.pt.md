---
title: Proteja o documento ODT com senha Online e usando Python
description: Aplicativo online de senha de arquivo ODT. Código API Python para aplicar proteção por senha no documento ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Proteção on-line de documentos ODT ou definição de senha via Python" h2="Desenvolva um poderoso aplicativo utilitário de proteção de documentos ODT baseado em Python.Código listado para aplicação de senha ao documento ODT por meio de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Proteção de senha ODT via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Exemplo de código em Python para definir senha para documento ODT" offSpacer="" %}}
...
<h2>Desenvolva aplicativo de proteção de senha ODT via Python</h2>

Precisa desenvolver um aplicativo ou utilitário de proteção por senha ODT?Com o [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/), uma API filha do [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), qualquer desenvolvedor python pode integrar o código da API acima em seu aplicativo de proteção de documentos.A poderosa biblioteca Python permite programar qualquer solução de proteção por senha de documento para proteger e bloquear os arquivos.Além disso, pode suportar muitos formatos populares, incluindo o formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilitário Python para processar arquivo ODT para proteger o aplicativo" %}}
