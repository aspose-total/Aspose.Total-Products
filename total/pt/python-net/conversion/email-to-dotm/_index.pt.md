---
title: Converter EMAIL para DOTM em Python
description: Salve EMAIL para DOTM em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para DOTM, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para DOTM em Python" offSpacer="" %}}
