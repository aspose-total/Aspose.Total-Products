---
title: Converter XLTX para MOBI usando Python ou com o conversor online gratuito
description: Conversão de XLTX para MOBI em seus aplicativos Python sem usar o Microsoft Office ou on-line. Teste o conversor online gratuito de XLTX para MOBI rapidamente antes de integrar o código. 
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter XLTX para MOBI em Python" %}}
...
-  Chame o método `save` ao especificar o caminho do arquivo MOBI de saída. Portanto, seu arquivo XLTX é convertido em MOBI no caminho especificado

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversão" %}}

- Para conversão de XLTX para MOBI, Python 3.5 ou posterior é necessário
...
<h3>Conversor Online Gratuito de XLTX para MOBI</h3>

<iframe title="Ferramenta on-line de conversão de mobi para xltx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=mobi&from=xltx" id="child-iframe" width="80%"></iframe>
          ...
          <div>
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Como posso converter XLTX para MOBI Online?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">O aplicativo online para conversão XLTX está integrado acima. Para começar, você pode converter arquivos XLTX em MOBI arrastando e soltando o arquivo ou clicando dentro da área branca para importar o documento. Após o upload do arquivo, clique no botão 'Converter'. Após a conclusão da conversão de XLTX para MOBI, você pode baixar facilmente o arquivo convertido com apenas um clique. Isso fornecerá os arquivos MOBI de saída.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Você pode utilizar qualquer navegador moderno, como Google Chrome, Firefox, Opera ou Safari, para esta conversão online. No entanto, se você estiver desenvolvendo um aplicativo de desktop, a API de conversão Aspose.Total XLTX funcionará perfeitamente.</span>
                      </div>
                  </li>
              </ul>
          </div>
