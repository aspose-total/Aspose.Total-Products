---
title: Converter MSG para TIFF em Python
description: Salve MSG para TIFF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="Converter MSG para TIFF usando Python" h2="Conversão de MSG para TIFF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter MSG para TIFF em Python" %}}
...
- Para conversão de MSG para TIFF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para TIFF em Python" offSpacer="" %}}
