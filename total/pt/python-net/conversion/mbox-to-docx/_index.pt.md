---
title: Converter MBOX para DOCX em Python
description: Salve MBOX para DOCX em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-docx/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para DOCX, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para DOCX em Python" offSpacer="" %}}
