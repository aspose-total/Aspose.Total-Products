---
title: Converter EMAIL para DOCX em Python
description: Salve EMAIL para DOCX em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-docx/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para DOCX, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para DOCX em Python" offSpacer="" %}}
