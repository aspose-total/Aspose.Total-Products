...
{{< blocks/products/pf/feature-page-header h1="Converter VCF para WORDML usando Python" h2="Conversão de VCF para WORDML em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter VCF para WORDML em Python" %}}
...
- Para conversão de VCF para WORDML, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar VCF para WORDML em Python" offSpacer="" %}}
