---
title: Converter PS para OFT em Python
description: Salve PS para OFT em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/ps-to-oft/
family: total
platformtag: Python
feature: conversion
informat: PS
...
- Para conversão de PS para OFT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PS para OFT em Python" offSpacer="" %}}
