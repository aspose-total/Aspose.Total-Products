---
title: Converter BMP para EMAIL em Python
description: Salve BMP para EMAIL em aplicativos Python sem usar o Microsoft Word ou Outlook
...
- Para conversão de BMP para EMAIL, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar BMP para EMAIL em Python" offSpacer="" %}}
