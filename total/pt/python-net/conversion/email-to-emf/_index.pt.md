---
title: Converter EMAIL para EMF em Python
description: Salve EMAIL para EMF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-emf/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para EMF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para EMF em Python" offSpacer="" %}}
