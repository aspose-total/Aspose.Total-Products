---
title: Converter MSG para DOTX em Python
description: Salve MSG para DOTX em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para DOTX, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para DOTX em Python" offSpacer="" %}}
