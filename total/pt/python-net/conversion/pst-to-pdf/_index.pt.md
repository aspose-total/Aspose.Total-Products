---
title: Converter PST para PDF em Python
description: Salve PST para PDF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-pdf/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para PDF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para PDF em Python" offSpacer="" %}}
