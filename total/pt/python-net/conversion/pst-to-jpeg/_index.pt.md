---
title: Converter PST para JPEG em Python
description: Salve PST para JPEG em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para JPEG, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para JPEG em Python" offSpacer="" %}}
