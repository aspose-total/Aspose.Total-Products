---
title: Converter PST para TIFF em Python
description: Salve PST para TIFF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: PST
...
{{< blocks/products/pf/feature-page-header h1="Converter PST para TIFF usando Python" h2="Conversão de PST para TIFF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter PST para TIFF em Python" %}}
...
- Para conversão de PST para TIFF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para TIFF em Python" offSpacer="" %}}
