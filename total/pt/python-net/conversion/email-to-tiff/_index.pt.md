---
title: Converter EMAIL para TIFF em Python
description: Salve EMAIL para TIFF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
{{< blocks/products/pf/feature-page-header h1="Converter EMAIL para TIFF usando Python" h2="Conversão de EMAIL para TIFF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter EMAIL para TIFF em Python" %}}
...
- Para conversão de EMAIL para TIFF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para TIFF em Python" offSpacer="" %}}
