---
title: Converter PS para OST em Python
description: Salve PS para OST em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/ps-to-ost/
family: total
platformtag: Python
feature: conversion
informat: PS
...
- Para conversão de PS para OST, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PS para OST em Python" offSpacer="" %}}
