---
title: Converter PST para EPUB em Python
description: Salve PST para EPUB em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-epub/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para EPUB, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para EPUB em Python" offSpacer="" %}}
