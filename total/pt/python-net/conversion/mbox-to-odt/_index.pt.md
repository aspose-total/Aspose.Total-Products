---
title: Converter MBOX para ODT em Python
description: Salve MBOX para ODT em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-odt/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para ODT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para ODT em Python" offSpacer="" %}}
