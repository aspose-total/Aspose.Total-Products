---
title: Converter EMAIL para WORDML em Python
description: Salve EMAIL para WORDML em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
...
- Para conversão de EMAIL para WORDML, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para WORDML em Python" offSpacer="" %}}
