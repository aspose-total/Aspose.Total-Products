---
title: Converter MSG para DOT em Python
description: Salve MSG para DOT em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-dot/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para DOT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para DOT em Python" offSpacer="" %}}
