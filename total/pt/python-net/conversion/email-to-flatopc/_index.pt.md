---
title: Converter EMAIL para FLATOPC em Python
description: Salve EMAIL para FLATOPC em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para FLATOPC, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para FLATOPC em Python" offSpacer="" %}}
