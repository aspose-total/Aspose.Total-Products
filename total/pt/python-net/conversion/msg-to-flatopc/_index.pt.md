---
title: Converter MSG para FLATOPC em Python
description: Salve MSG para FLATOPC em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para FLATOPC, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para FLATOPC em Python" offSpacer="" %}}
