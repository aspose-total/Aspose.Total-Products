---
title: Converter MBOX para DOTM em Python
description: Salve MBOX para DOTM em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para DOTM, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para DOTM em Python" offSpacer="" %}}
