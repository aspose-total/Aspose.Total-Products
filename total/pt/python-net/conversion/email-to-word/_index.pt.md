---
title: Converter EMAIL para WORD em Python
description: Salve EMAIL para WORD em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-word/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para WORD, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para WORD em Python" offSpacer="" %}}
