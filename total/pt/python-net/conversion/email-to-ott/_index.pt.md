---
title: Converter EMAIL para OTT em Python
description: Salve EMAIL para OTT em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-ott/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para OTT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para OTT em Python" offSpacer="" %}}
