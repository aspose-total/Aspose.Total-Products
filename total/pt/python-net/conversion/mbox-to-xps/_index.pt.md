---
title: Converter MBOX para XPS em Python
description: Salve MBOX para XPS em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-xps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para XPS, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para XPS em Python" offSpacer="" %}}
