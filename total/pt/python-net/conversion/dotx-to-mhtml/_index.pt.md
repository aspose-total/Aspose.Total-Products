---
title: Converter DOTX para MHTML em Python
description: DOTX para formato de arquivo da Web mhtml e conversão de arquivo HtmlFixed em seus aplicativos Python sem usar o Microsoft Word 
url: /pt/python-net/conversion/dotx-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: DOTX
...
- Chame o método `save` enquanto especifica o caminho do arquivo de saída e SaveFormat como parâmetros. Portanto, seu arquivo DOTX é convertido em MHTML no caminho especificado.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversão" %}}

- Para conversão de formato DOTX para MHTML ou HtmlFixed, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar DOTX para MHTML em Python - Simples" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Conversão de DOTX para MHTML em Python" offSpacer="" %}}
