---
title: Converter MSG para BMP em Python
description: Salve MSG para BMP em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para BMP, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para BMP em Python" offSpacer="" %}}
