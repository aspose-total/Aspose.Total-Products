---
title: Converter RTF para MHTML em Python
description: RTF para formato de arquivo da Web mhtml e conversão de arquivo HtmlFixed em seus aplicativos Python sem usar o Microsoft Word 
url: /pt/python-net/conversion/rtf-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: RTF
...
- Chame o método `save` enquanto especifica o caminho do arquivo de saída e SaveFormat como parâmetros. Portanto, seu arquivo RTF é convertido em MHTML no caminho especificado.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversão" %}}

- Para conversão de formato RTF para MHTML ou HtmlFixed, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar RTF para MHTML em Python - Simples" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Conversão de RTF para MHTML em Python" offSpacer="" %}}
