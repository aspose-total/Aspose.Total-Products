---
title: Converter MSG para ODT em Python
description: Salve MSG para ODT em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-odt/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para ODT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para ODT em Python" offSpacer="" %}}
