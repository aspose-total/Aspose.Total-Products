---
title: Converter PST para PNG em Python
description: Salve PST para PNG em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-png/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para PNG, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para PNG em Python" offSpacer="" %}}
