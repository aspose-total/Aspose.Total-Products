---
title: Converter MBOX para BMP em Python
description: Salve MBOX para BMP em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para BMP, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para BMP em Python" offSpacer="" %}}
