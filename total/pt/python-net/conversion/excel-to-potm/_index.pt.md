---
title: Converter EXCEL para POTM usando Python
description: Conversão de EXCEL para POTM em seus aplicativos Python sem usar o Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Converter EXCEL para POTM via Python" h2="Conversão de EXCEL para POTM em seus aplicativos Python sem instalar o Microsoft Excel<sup>&reg;</sup> ou PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter EXCEL para POTM em Python" %}}
...
-  Chame o método [save](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) ao especificar o caminho do arquivo POTM de saída. Portanto, seu arquivo EXCEL é convertido em POTM no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Salvar PDF em POTM em Python - Etapa 2" offSpacer="" %}}
