---
title: Converter MBOX para RTF em Python
description: Salve MBOX para RTF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para RTF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para RTF em Python" offSpacer="" %}}
