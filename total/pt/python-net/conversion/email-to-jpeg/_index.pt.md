---
title: Converter EMAIL para JPEG em Python
description: Salve EMAIL para JPEG em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para JPEG, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para JPEG em Python" offSpacer="" %}}
