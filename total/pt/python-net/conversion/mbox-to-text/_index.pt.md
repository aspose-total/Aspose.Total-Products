---
title: Converter MBOX para TEXT em Python
description: Salve MBOX para TEXT em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para TEXT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para TEXT em Python" offSpacer="" %}}
