---
title: Converter DOC para MHTML em Python
description: DOC para formato de arquivo da Web mhtml e conversão de arquivo HtmlFixed em seus aplicativos Python sem usar o Microsoft Word 
url: /pt/python-net/conversion/doc-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Converter DOC para MHTML usando Python" h2="Conversão de DOC para MHTML, HtmlFixed e HTML em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como Converter DOC para MHTML em Python" %}}
- Carregar arquivo DOC de origem usando a classe [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
...
{{% blocks/products/pf/agp/code-block title="Salvar DOC para MHTML em Python - Simples" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Conversão de DOC para MHTML em Python" offSpacer="" %}}
