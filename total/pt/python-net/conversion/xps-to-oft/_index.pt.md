---
title: Converter XPS para OFT em Python
description: Salve XPS para OFT em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/xps-to-oft/
family: total
platformtag: Python
feature: conversion
informat: XPS
...
- Para conversão de XPS para OFT, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar XPS para OFT em Python" offSpacer="" %}}
