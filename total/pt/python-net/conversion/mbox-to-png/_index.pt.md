---
title: Converter MBOX para PNG em Python
description: Salve MBOX para PNG em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-png/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para PNG, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para PNG em Python" offSpacer="" %}}
