---
title: Converter MSG para WORD em Python
description: Salve MSG para WORD em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-word/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para WORD, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para WORD em Python" offSpacer="" %}}
