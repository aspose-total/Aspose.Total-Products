---
title: Converter PDF para MHTML em Python
description: PDF para formato de arquivo da Web mhtml e conversão de arquivo HtmlFixed em seus aplicativos Python sem usar o Microsoft Word 
url: /pt/python-net/conversion/pdf-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: PDF
...
{{< blocks/products/pf/feature-page-header h1="Converter PDF para MHTML usando Python" h2="Conversão de PDF para MHTML, HtmlFixed e HTML em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como Converter PDF para MHTML em Python" %}}
...
- Chame o método `save` enquanto especifica o caminho do arquivo de saída e SaveFormat como parâmetros. Portanto, seu arquivo PDF é convertido em MHTML no caminho especificado.
...
{{% blocks/products/pf/agp/code-block title="Salvar PDF para MHTML em Python - Simples" offSpacer="" %}}

{{< gist "aspose-com-gists" "fe7c3ff0a8c783e4f0ed6bff199c6800" "convert-pdf-to-mhtml-simple.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Conversão de PDF para MHTML em Python" offSpacer="" %}}
