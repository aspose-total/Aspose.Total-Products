---
title: Converter EMAIL para DOCM em Python
description: Salve EMAIL para DOCM em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-docm/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para DOCM, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para DOCM em Python" offSpacer="" %}}
