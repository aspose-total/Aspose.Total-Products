---
title: Converter EMAIL para DOTX em Python
description: Salve EMAIL para DOTX em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para DOTX, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para DOTX em Python" offSpacer="" %}}
