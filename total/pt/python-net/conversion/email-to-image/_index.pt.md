---
title: Converter EMAIL para IMAGE em Python
description: Salve EMAIL para IMAGE em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-image/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para IMAGE, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para IMAGE em Python" offSpacer="" %}}
