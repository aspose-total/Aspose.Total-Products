---
title: Converter MBOX para DOC em Python
description: Salve MBOX para DOC em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-doc/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para DOC, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para DOC em Python" offSpacer="" %}}
