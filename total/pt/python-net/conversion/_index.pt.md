...
{{% blocks/products/pf/feature-page-section  h2="Conversão de e-mail para Word, PDF, HTML e imagens" %}}
Para conversão de arquivos de e-mail para PDF, Word, imagens e HTML, Email Python API [Aspose.Email for Python via .NET](https://products.aspose.com/email/python-net/) realiza a conversão. A API carrega o arquivo de origem em seu modelo de objeto e invoca o método Save com os parâmetros relevantes. 

{{% blocks/products/pf/feature-page-code h3="Python - Conversão de arquivos de e-mail para Word" %}}
