...
{{< blocks/products/pf/feature-page-header h1="Converter ICS para RTF usando Python" h2="Conversão de ICS para RTF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter ICS para RTF em Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Salvar ICS para RTF em Python" offSpacer="" %}}
