---
title: Converter MBOX para WORD em Python
description: Salve MBOX para WORD em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-word/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para WORD, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para WORD em Python" offSpacer="" %}}
