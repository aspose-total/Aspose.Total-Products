---
title: Converter MBOX para DOCM em Python
description: Salve MBOX para DOCM em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-docm/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Para conversão de MBOX para DOCM, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para DOCM em Python" offSpacer="" %}}
