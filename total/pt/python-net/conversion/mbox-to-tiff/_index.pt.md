---
title: Converter MBOX para TIFF em Python
description: Salve MBOX para TIFF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/mbox-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
{{< blocks/products/pf/feature-page-header h1="Converter MBOX para TIFF usando Python" h2="Conversão de MBOX para TIFF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter MBOX para TIFF em Python" %}}
...
- Para conversão de MBOX para TIFF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MBOX para TIFF em Python" offSpacer="" %}}
