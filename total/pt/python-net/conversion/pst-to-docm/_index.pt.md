---
title: Converter PST para DOCM em Python
description: Salve PST para DOCM em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-docm/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para DOCM, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para DOCM em Python" offSpacer="" %}}
