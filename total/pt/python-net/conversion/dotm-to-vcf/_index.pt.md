...
{{< blocks/products/pf/feature-page-header h1="Converter DOTM para VCF usando Python" h2="Conversão de DOTM para VCF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter DOTM para VCF em Python" %}}
...
- Para conversão de DOTM para VCF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar DOTM para VCF em Python" offSpacer="" %}}
