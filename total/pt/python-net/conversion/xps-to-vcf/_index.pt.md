---
title: Converter XPS para VCF em Python
description: Salve XPS para VCF em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/xps-to-vcf/
family: total
platformtag: Python
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="Converter XPS para VCF usando Python" h2="Conversão de XPS para VCF em seus aplicativos Python sem instalar o Microsoft Word<sup>&reg;</sup> ou Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como converter XPS para VCF em Python" %}}
...
- Para conversão de XPS para VCF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar XPS para VCF em Python" offSpacer="" %}}
