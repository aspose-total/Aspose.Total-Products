---
title: Converter EMAIL para EPUB em Python
description: Salve EMAIL para EPUB em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/email-to-epub/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Para conversão de EMAIL para EPUB, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar EMAIL para EPUB em Python" offSpacer="" %}}
