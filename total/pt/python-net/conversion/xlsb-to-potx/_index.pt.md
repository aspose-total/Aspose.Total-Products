---
title: Converter XLSB para POTX usando Python
description: Conversão de XLSB para POTX em seus aplicativos Python sem usar o Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Converter XLSB para POTX via Python" h2="Conversão de XLSB para POTX em seus aplicativos Python sem instalar o Microsoft Excel<sup>&reg;</sup> ou PowerPoint" >}}
