---
title: Converter XPS para ICS em Python
description: Salve XPS para ICS em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/xps-to-ics/
family: total
platformtag: Python
feature: conversion
informat: XPS
...
- Para conversão de XPS para ICS, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar XPS para ICS em Python" offSpacer="" %}}
