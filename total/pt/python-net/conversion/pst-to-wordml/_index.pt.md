---
title: Converter PST para WORDML em Python
description: Salve PST para WORDML em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/pst-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para conversão de PST para WORDML, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PST para WORDML em Python" offSpacer="" %}}
