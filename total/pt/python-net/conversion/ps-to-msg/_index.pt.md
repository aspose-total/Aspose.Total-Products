---
title: Converter PS para MSG em Python
description: Salve PS para MSG em aplicativos Python sem usar o Microsoft Word ou Outlook
url: /pt/python-net/conversion/ps-to-msg/
family: total
platformtag: Python
feature: conversion
informat: PS
...
- Para conversão de PS para MSG, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar PS para MSG em Python" offSpacer="" %}}
