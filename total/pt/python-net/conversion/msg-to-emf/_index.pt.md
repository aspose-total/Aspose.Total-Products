---
title: Converter MSG para EMF em Python
description: Salve MSG para EMF em seus aplicativos Python sem usar o Microsoft Outlook ou Word 
url: /pt/python-net/conversion/msg-to-emf/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Para conversão de MSG para EMF, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar MSG para EMF em Python" offSpacer="" %}}
