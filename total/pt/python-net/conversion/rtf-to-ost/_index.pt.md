...
- Para conversão de RTF para OST, é necessário o Python 3.5 ou posterior
...
{{% blocks/products/pf/agp/code-block title="Salvar RTF para OST em Python" offSpacer="" %}}
