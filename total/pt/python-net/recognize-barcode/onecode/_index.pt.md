---
title: Reconhecer imagens de código de barras ONECODE via Python
description: Digitalize imagens de código de barras de simbologia ONECODE usando aplicativos Python sem usar nenhum outro software. 
...
{{< blocks/products/pf/feature-page-header h1="Reconhecer ONECODE BarCode usando Python" h2="Digitalize imagens de código de barras por meio de seus aplicativos Python sem instalar nenhum outro software." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Como reconhecer o código de barras ONECODE em Python" %}}

- Use objeto de classe BarCodeReader com DecodeType.AllSupportedTypes como parâmetro
- Chamando read_bar_codes() para obter todo o código ONECODE
...
- Para leitura de código de barras ONECODE, Python 3.5 ou posterior é necessário
...
{{% blocks/products/pf/agp/code-block title="Reconhecer código de barras de simbologia ONECODE em Python" offSpacer="" %}}
