---
title: Divida archivos ODP en línea o mediante .NET
description: Aplicación online gratuita para dividir diferentes archivos ODP. Código de biblioteca .NET C# Splitter para documentos ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Divida archivos ODP en línea a través de la aplicación Splitter o usando .NET" h2="Desarrolle potentes aplicaciones de división de documentos ODP basadas en .NET.Divida documentos libremente, incluidos archivos ODP, en línea a través de una aplicación con descarga instantánea." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Divida archivos ODP en línea usando la aplicación" %}}

1. Cargue el archivo ODP para dividir.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo ODP a través de .NET" %}}

1. Cargue el archivo ODP usando la clase de presentación
1. Iterar por todas las diapositivas
1. Durante cada iteración, crea un nuevo objeto.
1. Eliminar la diapositiva predeterminada usando el método Remove()
1. Agregar diapositiva usando el método AddClone()
1. Finalmente guarde la diapositiva en un nuevo archivo ODP.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: dividir archivos ODP" offSpacer="" %}}
...
<h2>Desarrollar una aplicación divisora de archivos ODP usando .NET</h2>

¿Necesita desarrollar un script .NET o una aplicación de utilidad para dividir fácilmente archivos ODP?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior para programar la aplicación divisora.La potente biblioteca .NET para divisor de documentos admite muchos formatos populares, incluido el formato ODP, como PDF, documentos de Microsoft Word, hojas de cálculo de Excel y presentaciones de PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca divisora ODP para .NET" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### Formato de presentación OpenDocument .odp — Casos de uso para dividir

- Dividir archivos ODP para herramientas de presentación de código abierto para facilitar la edición y el intercambio.
- Organizar presentaciones en secciones para una gestión más sencilla y una entrega dirigida.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código. Se puede desarrollar fácilmente una solución profesional para dividir archivos ODP usando .NET.Utilice Aspose ODP Splitter API para desarrollar software independiente de plataforma de alto nivel en .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para dividir varios documentos ODP?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puede utilizar cualquier navegador web moderno como Google Chrome, Firefox, Opera o Safari para el divisor de documentos ODP en línea.</span>
                      </div>
                  </li>
 		 
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Cuánto tiempo lleva dividir los archivos ODP?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
