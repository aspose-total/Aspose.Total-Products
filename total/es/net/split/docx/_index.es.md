---
title: Divida el archivo DOCX en línea o mediante .NET
description: Aplicación online gratuita para dividir diferentes archivos DOCX. Código de biblioteca divisora .NET C# para documentos DOCX.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo DOCX a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: dividir archivos DOCX por páginas" offSpacer="" %}}
...
<h2>Desarrollar una aplicación divisora de archivos DOCX usando .NET</h2>

¿Necesita desarrollar un script .NET o una aplicación de utilidad para dividir fácilmente archivos DOCX?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior para programar la aplicación divisora. La potente biblioteca .NET para dividir documentos admite muchos formatos populares, incluido el formato DOCX, como archivos PDF, Word, Excel y PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca divisora DOCX para .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código.Se puede desarrollar fácilmente una solución profesional para dividir archivos DOCX usando .NET.Utilice la API divisora Aspose DOCX para desarrollar software independiente de plataforma de alto nivel en .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
