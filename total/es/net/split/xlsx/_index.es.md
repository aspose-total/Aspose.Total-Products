---
title: Divida el archivo XLSX en línea o mediante .NET
description: Aplicación online gratuita para dividir diferentes hojas XLSX.Código de biblioteca divisora .NET C# para hojas de cálculo XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Divida archivos XLSX en línea a través de la aplicación Splitter o usando .NET" h2="Desarrolle potentes aplicaciones de división de documentos XLSX basadas en .NET.Divida documentos libremente, incluidos archivos XLSX, en línea a través de una aplicación con descarga instantánea." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Divida archivos XLSX en línea usando la aplicación" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo XLSX a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: dividir archivos XLSX" offSpacer="" %}}
...
<h2>Desarrollar una aplicación divisora de archivos XLSX usando .NET</h2>

¿Necesita desarrollar un script .NET o una aplicación de utilidad para dividir fácilmente archivos XLSX?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/es/net/), API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior para programar la aplicación divisora.La potente biblioteca .NET para dividir documentos admite muchos formatos populares, incluido el formato XLSX, como archivos PDF, Word, Excel y PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca divisora XLSX para .NET" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
###  Formatos de hojas de cálculo de Microsoft Excel .xlsx — Casos de uso para dividir 
- Desglosar grandes libros de trabajo modernos de Excel para una mejor gestión y colaboración.  
- Crear informes personalizados dividiendo un archivo .xlsx principal en hojas personalizadas.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código. Se puede desarrollar fácilmente una solución profesional para dividir archivos XLSX usando .NET.Utilice la API divisora Aspose XLSX para desarrollar software independiente de plataforma de alto nivel en .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para dividir varios documentos XLSX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puede utilizar cualquier navegador web moderno como Google Chrome, Firefox, Opera o Safari para el divisor de documentos XLSX en línea.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Cuánto tiempo lleva dividir los archivos XLSX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
