---
title: Dividir archivos PDF en línea o usando .NET
description: Aplicación online gratuita para dividir diferentes archivos PDF.Código de biblioteca .NET C# Splitter para documentos PDF.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo PDF a través de .NET" %}}

1. Cargue el documento PDF usando la clase Documento.
1. Obtenga el total de páginas del documento cargado e itere.
1. Cree un nuevo objeto en cada iteración y agregue la página usando Pages.Add.
1. Guarde la página en un nuevo archivo PDF usando el método Save().

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: dividir archivos PDF por páginas" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código. Se puede desarrollar fácilmente una solución profesional para dividir archivos PDF usando .NET.Utilice la API divisora Aspose PDF para desarrollar software independiente de plataforma de alto nivel en .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
