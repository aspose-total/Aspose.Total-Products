---
title: Divida el archivo ODT en línea o mediante .NET
description: Aplicación online gratuita para dividir diferentes archivos ODT. Código de biblioteca divisora .NET C# para documentos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Divida archivos ODT en línea a través de la aplicación Splitter o usando .NET" h2="Desarrolle potentes aplicaciones de división de documentos ODT basadas en .NET. Divida documentos libremente, incluidos archivos ODT, en línea a través de una aplicación con descarga instantánea." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo ODT a través de .NET" %}}
...
1. Guarde la página extraída en un nuevo archivo ODT.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: dividir archivos ODT por páginas" offSpacer="" %}}
...
<h2>Desarrollar una aplicación divisora de archivos ODT usando .NET</h2>

¿Necesita desarrollar un script .NET o una aplicación de utilidad para dividir fácilmente archivos ODT?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior para programar la aplicación divisora. La potente biblioteca .NET para dividir documentos admite muchos formatos populares, incluido el formato ODT, como archivos PDF, Word, Excel y PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca divisora ODT para .NET" %}}
...
{{< /blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/feature-page-summary %}}
### Archivo .odt (OpenDocument Text) — Casos de uso para dividir documentos

- Dividir archivos de texto OpenDocument para compatibilidad y facilitar la edición en suites de código abierto.
- Facilitar la colaboración distribuyendo secciones específicas a múltiples colaboradores.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código.Se puede desarrollar fácilmente una solución profesional para dividir archivos ODT usando .NET.Utilice la API divisora Aspose ODT para desarrollar software independiente de plataforma de alto nivel en .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
