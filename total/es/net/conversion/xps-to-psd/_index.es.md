---
title: Convierta XPS a PSD a través de la API de C#
description: Exporte XPS a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/xps-to-psd/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos XPS a PSD a través de C#" %}}
