...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir WORD a CSV" h2="Exporte WORD a CSV a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el wordumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
