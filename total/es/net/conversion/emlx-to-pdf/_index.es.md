...
4. Guarde el documento en formato PDF usando el método [Guardar](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Pdf como SaveFormat
