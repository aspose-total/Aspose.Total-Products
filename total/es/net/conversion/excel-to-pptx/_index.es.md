---
title: Convierta EXCEL a PPTX con .NET 
description: Convierta EXCEL a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta EXCEL a PPTX a través de C#" h2="Exportar Excel&reg; EXCEL a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
