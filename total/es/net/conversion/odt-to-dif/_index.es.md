...
description: API de C# para convertir ODT a DIF sin usar Microsoft Excel o Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir ODT a DIF" h2="Exporte ODT a DIF a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el odtumento en formato DIF usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `DIF` como SaveFormat
