---
title: API .NET para convertir WORD a DIF o con el convertidor en línea gratuito
description: API de C# para convertir WORD a DIF o aplicación en línea sin usar Microsoft Excel o Adobe Reader o en línea. Pruebe el convertidor en línea gratuito de WORD a DIF rápidamente antes de integrar el código. 
url_ignore: /es/net/conversion/word-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORD
