...
4. Guarde el documento en formato EPUB usando el método [Guardar](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Epub como SaveFormat
