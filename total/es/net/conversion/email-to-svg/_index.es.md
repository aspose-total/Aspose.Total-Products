...
description: Convierta EMAIL a SVG sin usar Microsoft Word o Outlook en .NET
url_ignore: /es/net/conversion/email-to-svg/
family: total
platformtag: net
feature: conversion
informat: MSG
...
4. Guarde el documento en formato SVG usando el método [Guardar](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Svg como SaveFormat
