---
title: Convierta HTML a DXF a través de la API de C#
description: Exporte HTML a DXF en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/html-to-dxf/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta el archivo HTML a DXF a través de C#" h2="Exporte HTML a DXF dentro de aplicaciones .NET sin utilizar Adobe<sup>&reg;</sup> Acrobat Reader ni ninguna otra aplicación de terceros" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convierta el archivo HTML a DXF a través de .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos HTML a DXF a través de C#" %}}
