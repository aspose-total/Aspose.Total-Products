---
title: Convierta XLSB a WORD con .NET 
description: Convierta XLSB a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/xlsb-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSB a WORD a través de C#" h2="Exportar Excel&reg; XLSB a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
