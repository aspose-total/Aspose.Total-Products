---
title: Convierta PS a TGA a través de la API de C#
description: Exporte PS a TGA en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/ps-to-tga/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PS a TGA a través de C#" %}}
