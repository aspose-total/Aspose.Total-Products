...
<iframe title="Aplicación gratuita de conversión de PDF a PPSX en línea" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppsx&from=pdf" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertir PDF a PPSX mediante C# .NET" offSpacer="" %}}
