...
4. Guarde el documento en formato TIFF usando el método [Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Tiff como SaveFormat
