---
title: Convierta TEX a PSD a través de la API de C#
description: Exporte TEX a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/tex-to-psd/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos TEX a PSD a través de C#" %}}
