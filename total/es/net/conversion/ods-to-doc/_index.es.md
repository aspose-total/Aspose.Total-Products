---
title: Convierta ODS a DOC con .NET 
description: Convierta ODS a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta ODS a DOC a través de C#" h2="Exportar Excel&reg; ODS a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
