---
title: API .NET para convertir DOT a FODS
description: API de C# para convertir DOT a FODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dot-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOT a FODS" h2="Exporte DOT a FODS a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotumento en formato FODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `FODS` como SaveFormat
