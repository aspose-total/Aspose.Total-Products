...
<iframe title="Aplicación gratuita de conversión de TEX a PPT en línea" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppt&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertir TEX a PPT mediante C# .NET" offSpacer="" %}}
