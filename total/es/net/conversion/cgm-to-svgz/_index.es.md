---
title: Convierta CGM a SVGZ a través de la API de C#
description: Exporte CGM a SVGZ en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/cgm-to-svgz/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta el archivo CGM a SVGZ a través de C#" h2="Exporte CGM a SVGZ dentro de aplicaciones .NET sin utilizar Adobe<sup>&reg;</sup> Acrobat Reader ni ninguna otra aplicación de terceros" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convierta el archivo CGM a SVGZ a través de .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convierta un archivo CGM a SVGZ en un solo archivo a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos CGM a SVGZ a través de C#" %}}
