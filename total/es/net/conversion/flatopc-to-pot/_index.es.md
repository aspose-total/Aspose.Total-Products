...
description: Convierta flatopcumentos de Word flatopc en archivos pot de PowerPoint con C#. Convierta múltiples archivos dentro de ASP.NET u otras aplicaciones .NET.
---
...
1. Guarde el flatopcumento usando [Aspose.Slides.Presentation.Save("output.pot", SaveFormat.Pot)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
