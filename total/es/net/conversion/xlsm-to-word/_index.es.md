---
title: Convierta XLSM a WORD con .NET 
description: Convierta XLSM a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/xlsm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSM a WORD a través de C#" h2="Exportar Excel&reg; XLSM a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
