...
url: /es/net/conversion/word-to-xltx/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato XLTX usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLTX` como SaveFormat
