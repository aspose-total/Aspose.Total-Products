...
4. Guarde el documento en formato XAML usando el método [Guardar](https://reference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) y establezca `Xaml` como SaveFormat
