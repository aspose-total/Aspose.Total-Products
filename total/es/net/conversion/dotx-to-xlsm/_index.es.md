---
title: API .NET para convertir DOTX a XLSM
description: API de C# para convertir DOTX a XLSM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotx-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOTX a XLSM" h2="Exporte DOTX a XLSM a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotxumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Cargar dotxumento DOTX desde Stream a través de C#" %}}
[Aspose.Words for .NET](https://products.aspose.com/words/net/) también le permite cargar dotxumentos DOTX a través de la transmisión. Para abrir un dotxumento desde una secuencia, simplemente pase un objeto de secuencia que contenga el dotxumento al constructor [Dotxumento](https://apireference.aspose.com/words/net/aspose.words/dotxument). El siguiente ejemplo de código muestra cómo abrir un dotxumento desde una secuencia:  
{{% blocks/products/pf/feature-page-code %}}
...
Al convertir DOTX a XLSM, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) le permite agregar propiedades personalizadas en sus dotxumentos XLSM. Para agregar una propiedad personalizada, puede usar el método [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customdotxumentpropertycollection/methods/add/index) para la [CustomDotxumentPropertyCollection](https://apireference.aspose.com/cells/net/aspose.cells.properties/customdotxumentpropertycollection) clase. El método Add agrega la propiedad al archivo de Excel y devuelve una referencia para la propiedad del nuevo dotxumento como [Aspose.Cells.Properties.DotxumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /propiedaddotxumento) objeto. 
{{% blocks/products/pf/feature-page-code %}}
