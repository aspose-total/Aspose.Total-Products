...
description: API de C# para convertir MOBI a XLSM sin usar Microsoft Excel o Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir MOBI a XLSM" h2="Exporte MOBI a XLSM a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el mobiumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
