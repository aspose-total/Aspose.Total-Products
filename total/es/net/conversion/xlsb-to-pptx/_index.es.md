---
title: Convierta XLSB a PPTX con .NET 
description: Convierta XLSB a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSB a PPTX a través de C#" h2="Exportar Excel&reg; XLSB a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
