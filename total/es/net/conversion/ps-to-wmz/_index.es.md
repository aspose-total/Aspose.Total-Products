---
title: Convierta PS a WMZ a través de la API de C#
description: Exporte PS a WMZ en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/ps-to-wmz/
family: total
platformtag: net
feature: conversion
informat: PS
...
4. Guarde el documento en formato WMZ usando el método [Guardar](https://apireference.aspose.com/imaging/net/aspose.imaging.image/save/methods/4)
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PS a WMZ a través de C#" %}}
