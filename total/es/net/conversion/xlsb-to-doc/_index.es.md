---
title: Convierta XLSB a DOC con .NET 
description: Convierta XLSB a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/xlsb-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSB a DOC a través de C#" h2="Exportar Excel&reg; XLSB a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
