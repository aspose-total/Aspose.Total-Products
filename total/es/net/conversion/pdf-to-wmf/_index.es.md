---
title: Convierta PDF a WMF a través de la API de C#
description: Exporte PDF a WMF en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/pdf-to-wmf/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PDF a WMF a través de C#" %}}
