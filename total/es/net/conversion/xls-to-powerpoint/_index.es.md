---
title: Convierta XLS a POWERPOINT con .NET 
description: Convierta XLS a POWERPOINT en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLS a POWERPOINT a través de C#" h2="Exportar Excel&reg; XLS a POWERPOINT en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
