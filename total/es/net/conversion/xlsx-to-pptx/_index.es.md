---
title: Convierta XLSX a PPTX con .NET 
description: Convierta XLSX a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSX a PPTX a través de C#" h2="Exportar Excel&reg; XLSX a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
