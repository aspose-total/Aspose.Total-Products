---
title: Convierta XLS a WORD con .NET 
description: Convierta XLS a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLS a WORD a través de C#" h2="Exportar Excel&reg; XLS a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
