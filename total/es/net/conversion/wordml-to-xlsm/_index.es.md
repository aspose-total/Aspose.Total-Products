---
title: API .NET para convertir WORDML a XLSM
description: API de C# para convertir WORDML a XLSM sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir WORDML a XLSM" h2="Exporte WORDML a XLSM a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el wordmlumento en formato XLSM usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `XLSM` como SaveFormat
