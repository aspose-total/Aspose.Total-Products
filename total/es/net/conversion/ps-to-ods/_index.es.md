---
title: Convierta PS a ODS a través de la API de C#
description: API C# para convertir archivos PS a ODS sin usar Microsoft Excel o Adobe Reader
url_ignore: /es/net/conversion/ps-to-ods/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar PS a ODS" h2="Exporte el archivo PS a ODS a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir PS a ODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a ODS con marca de agua a través de C#" %}}
