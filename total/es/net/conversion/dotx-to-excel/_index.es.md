---
title: API .NET para convertir DOTX a EXCEL
description: API de C# para convertir DOTX a EXCEL sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotx-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOTX a EXCEL" h2="Exporte DOTX a EXCEL a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotxumento en formato EXCEL usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `EXCEL` como SaveFormat
