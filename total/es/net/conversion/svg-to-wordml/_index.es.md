...
<iframe title="Aplicación gratuita de conversión de SVG a WORDML en línea" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=wordml&from=svg" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Convertir SVG a WORDML mediante C# .NET" offSpacer="" %}}
