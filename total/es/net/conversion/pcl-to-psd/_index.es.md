---
title: Convierta PCL a PSD a través de la API de C#
description: Exporte PCL a PSD en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/pcl-to-psd/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PCL a PSD a través de C#" %}}
