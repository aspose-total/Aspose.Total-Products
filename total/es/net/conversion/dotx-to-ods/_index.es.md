---
title: API .NET para convertir DOTX a ODS
description: API de C# para convertir DOTX a ODS sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/dotx-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOTX a ODS" h2="Exporte DOTX a ODS a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotxumento en formato ODS usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `ODS` como SaveFormat
