---
title: Convierta PS a DIF a través de la API de C#
description: API C# para convertir archivos PS a DIF sin usar Microsoft Excel o Adobe Reader
url_ignore: /es/net/conversion/ps-to-dif/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar PS a DIF" h2="Exporte el archivo PS a DIF a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convierta PS protegido a DIF a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a DIF con marca de agua a través de C#" %}}
