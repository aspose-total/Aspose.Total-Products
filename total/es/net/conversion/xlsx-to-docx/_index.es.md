---
title: Convierta XLSX a DOCX con .NET 
description: Convierta XLSX a DOCX en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSX a DOCX a través de C#" h2="Exportar Excel&reg; XLSX a DOCX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
