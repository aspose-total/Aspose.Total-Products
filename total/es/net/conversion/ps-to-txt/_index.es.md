---
title: Convierta PS a TXT a través de la API de C#
description: API C# para convertir archivos PS a TXT sin usar Microsoft Excel o Adobe Reader
url_ignore: /es/net/conversion/ps-to-txt/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar PS a TXT" h2="Exporte el archivo PS a TXT a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir PS a TXT" %}}
...
4. Guarde el documento en formato TXT usando el método [Guardar](https://reference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `Txt` como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Convierta PS protegido a TXT a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a TXT con marca de agua a través de C#" %}}
Al convertir un archivo PS a TXT, también puede agregar una marca de agua a su formato de archivo TXT de salida. Para agregar una marca de agua, puede crear un nuevo objeto Libro de trabajo y abrir el documento XLSX convertido, seleccionar Hoja de trabajo a través de su índice, crear una Forma y usar su función AddTextEffect. Después de eso, puede guardar su documento XLSX como TXT con marca de agua. 
{{% blocks/products/pf/feature-page-code %}}
