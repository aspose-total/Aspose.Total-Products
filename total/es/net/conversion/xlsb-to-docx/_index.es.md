---
title: Convierta XLSB a DOCX con .NET 
description: Convierta XLSB a DOCX en plataformas .NET Framework, .NET Core, Mono o Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSB a DOCX a través de C#" h2="Exportar Excel&reg; XLSB a DOCX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
