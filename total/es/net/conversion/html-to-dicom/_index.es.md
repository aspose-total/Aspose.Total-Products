---
title: Convierta HTML a DICOM a través de la API de C#
description: Exporte HTML a DICOM en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/html-to-dicom/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos HTML a DICOM a través de C#" %}}
