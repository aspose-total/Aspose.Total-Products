---
title: Convierta WORDML a ODP a través de C# .NET o con el convertidor en línea gratuito
description: Convierta documentos de Word wordml en archivos odp de PowerPoint con C#. Convierta múltiples archivos dentro de ASP.NET u otras aplicaciones .NET.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta WORDML a ODP usando C# o en línea" h2="Cree aplicaciones de conversión de Microsoft Word WORDML a PowerPoint ODP en plataformas .NET Framework, .NET Core, Windows Azure, Mono o Xamarin." logoImageSrc="/total/images/aspose_total-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="ODP" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOCM" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Total " subTitlepfName="for .NET" >}}
{{% blocks/products/pf/agp/content h2="Cómo convertir WORDML a ODP usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir WORDML a ODP a través de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Este ejemplo de código muestra cómo convertir un WORDML a ODP usando C#" offSpacer="" %}}
...
<h3>Convertidor en línea de WORDML a ODP</h3>

<iframe title="Herramienta de conversión de odp a wordml" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=odp&from=wordml" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplicación gratuita para convertir WORDML a ODP" sectionDescription="" >}}
