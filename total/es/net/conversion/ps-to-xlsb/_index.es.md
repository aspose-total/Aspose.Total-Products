...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar PS a XLSB" h2="Exporte el archivo PS a XLSB a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir PS a XLSB" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a XLSB con marca de agua a través de C#" %}}
