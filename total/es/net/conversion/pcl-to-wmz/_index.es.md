---
title: Convierta PCL a WMZ a través de la API de C#
description: Exporte PCL a WMZ en sus aplicaciones .NET sin usar ninguna aplicación de terceros
url_ignore: /es/net/conversion/pcl-to-wmz/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/feature-page-section  h2="Convertir y rotar archivos PCL a WMZ a través de C#" %}}
