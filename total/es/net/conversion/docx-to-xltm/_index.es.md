---
title: API .NET para convertir DOCX a XLTM
description: API de C# para convertir DOCX a XLTM sin usar Microsoft Excel o Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para convertir DOCX a XLTM" h2="Exporte DOCX a XLTM a través de C# sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
