---
title: Convierta PS a FODS a través de la API de C#
description: API C# para convertir archivos PS a FODS sin usar Microsoft Excel o Adobe Reader
url_ignore: /es/net/conversion/ps-to-fods/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convierta PS protegido a FODS a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a FODS con marca de agua a través de C#" %}}
Al convertir un archivo PS a FODS, también puede agregar una marca de agua a su formato de archivo FODS de salida. Para agregar una marca de agua, puede crear un nuevo objeto Libro de trabajo y abrir el documento XLSX convertido, seleccionar Hoja de trabajo a través de su índice, crear una Forma y usar su función AddTextEffect. Después de eso, puede guardar su documento XLSX como FODS con marca de agua. 
{{% blocks/products/pf/feature-page-code %}}
