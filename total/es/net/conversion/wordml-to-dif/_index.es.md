---
title: API .NET para convertir WORDML a DIF
description: API de C# para convertir WORDML a DIF sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-dif/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Guarde el wordmlumento en formato DIF usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `DIF` como SaveFormat
