---
title: Convierta SXC a WORD con .NET 
description: Convierta SXC a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta SXC a WORD a través de C#" h2="Exportar Excel&reg; SXC a WORD en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
