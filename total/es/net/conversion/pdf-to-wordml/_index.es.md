...
description: Convierta PDF a WORDML sin usar Microsoft Word
url_ignore: /es/net/conversion/pdf-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderizar PDF a WORDML a través de .NET" h2="API .NET para exportar PDF a WORDML en Windows, macOS y Linux sin usar Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C# para convertir PDF a WORDML" %}}
...
4. Guarde el documento en formato WORDML usando el método [Guardar](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Wordml como SaveFormat
