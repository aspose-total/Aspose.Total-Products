---
title: API .NET para convertir WORDML a CSV
description: API de C# para convertir WORDML a CSV sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/wordml-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
4. Guarde el wordmlumento en formato CSV usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `CSV` como SaveFormat
