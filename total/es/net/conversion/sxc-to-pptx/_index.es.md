---
title: Convierta SXC a PPTX con .NET 
description: Convierta SXC a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/sxc-to-pptx/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta SXC a PPTX a través de C#" h2="Exportar Excel&reg; SXC a PPTX en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
