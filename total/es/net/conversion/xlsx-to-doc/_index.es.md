---
title: Convierta XLSX a DOC con .NET 
description: Convierta XLSX a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin
url: /es/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convierta XLSX a DOC a través de C#" h2="Exportar Excel&reg; XLSX a DOC en plataformas .NET Framework, .NET Core, Mono o Xamarin">}}
