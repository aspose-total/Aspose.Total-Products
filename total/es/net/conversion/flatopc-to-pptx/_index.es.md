...
1. Cargue el archivo FLATOPC usando la clase [Aspose.Words.Flatopcument](https://apireference.aspose.com/words/net/aspose.words/flatopcument)
1. Guarde el flatopcumento FLATOPC en HTML
...
1. Guarde el flatopcumento usando [Aspose.Slides.Presentation.Save("output.pptx", SaveFormat.Pptx)](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods /5)
