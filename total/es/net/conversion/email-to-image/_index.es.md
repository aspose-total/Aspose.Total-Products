...
description: Convierta EMAIL a IMAGE sin usar Microsoft Word o Outlook en .NET
url_ignore: /es/net/conversion/email-to-image/
family: total
platformtag: net
feature: conversion
informat: MSG
...
4. Guarde el documento en formato IMAGE usando el método [Guardar](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Image como SaveFormat
