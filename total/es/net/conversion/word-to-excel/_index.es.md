---
title: API .NET para convertir WORD a EXCEL
description: API de C# para convertir WORD a EXCEL sin usar Microsoft Excel o Adobe Reader
url: /es/net/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORD
...
4. Guarde el wordumento en formato EXCEL usando el método [Guardar](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) y configure `EXCEL` como SaveFormat
