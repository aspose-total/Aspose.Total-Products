---
title: Convierta PS a XLT a través de la API de C#
description: API C# para convertir archivos PS a XLT sin usar Microsoft Excel o Adobe Reader
url_ignore: /es/net/conversion/ps-to-xlt/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{< blocks/products/pf/i18n/feature-page-header h1="API de C# para renderizar PS a XLT" h2="Exporte el archivo PS a XLT a través de C# sin usar Microsoft<sup>&reg;</sup> Excel o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API .NET para convertir PS a XLT" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convierta PS protegido a XLT a través de C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convertir archivo PS a XLT con marca de agua a través de C#" %}}
