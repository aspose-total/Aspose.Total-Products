...
description: Convierta EMAIL a WORD sin usar Microsoft Word o Outlook en .NET
url_ignore: /es/net/conversion/email-to-word/
family: total
platformtag: net
feature: conversion
informat: MSG
...
4. Guarde el documento en formato WORD usando el método [Guardar](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) y configure Word como SaveFormat
