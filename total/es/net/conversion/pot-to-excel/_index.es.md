...
description: Convierta POT a EXCEL en C# sin usar Microsoft Excel o Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta POT a EXCEL a través de C#" h2="API .NET para conversión de POT a EXCEL sin usar Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
1. Abra el archivo POT usando la clase [Presentación](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Exporte POT como HTML usando el método [Guardar](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
