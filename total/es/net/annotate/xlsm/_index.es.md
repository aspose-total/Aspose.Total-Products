---
title: Elimine la anotación XLSM en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo XLSM a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLSM en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLSM basada en .NET.Código listado para administrar comentarios del archivo XLSM a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLSM a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo XLSM" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos XLSM a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos XLSM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
XLSM (Excel Macro-Enabled Workbook) admite la automatización a través de macros. Anotar estos archivos ayuda a los equipos a señalar los resultados de las macros, documentar los cambios automatizados y validar los resultados lógicos.

#### Anotar archivos XLSM para flujos de trabajo impulsados por macros - Casos de uso:

- **Análisis de Resultados de Macro**: Comentar sobre los datos generados automáticamente para validación.
- **Retroalimentación de Automatización**: Anotar salidas para indicar ejecuciones exitosas o fallidas.
- **Revisión de Código**: Agregar notas relacionadas con la lógica de la macro o sus efectos en los datos.
