---
title: Elimine la anotación Word en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo Word a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento Word en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos Word basada en .NET.Código listado para administrar comentarios del archivo Word a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eliminar anotaciones Word en línea" %}}

1. Importe el archivo Word para eliminar comentarios subiéndolo
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos Word de autor específico a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C#: eliminar comentarios de autor específicos del archivo Word" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Agregar comentario desde el archivo Word" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
