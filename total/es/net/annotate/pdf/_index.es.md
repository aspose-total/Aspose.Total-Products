---
title: Elimine la anotación PDF en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo PDF a través de la aplicación en línea de forma gratuita.Código API C# .NET para gestionar comentarios de archivos PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento PDF en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos PDF basada en .NET.Código listado para administrar comentarios del archivo PDF a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar anotaciones a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Crear objeto de clase de documento
1. Agregue la nueva página y párrafos usando Pages.Add y Paragraphs.Add
1. Utilice la clase TextAnnotation y defina las anotaciones.
1. Utilice Pages[1].Annotations.Add para agregar las anotaciones
1. Llame al método Save para guardar el archivo con anotaciones.
...
{{% blocks/products/pf/agp/code-block title="Código .NET: agregar comentarios en el archivo PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos PDF a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de anotación PDF para proporcionar comentarios, hacer sugerencias o colaborar con otros en el documento?Con [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de anotación de documentos.La potente biblioteca .NET permite programar cualquier solución de anotación de documentos.Además, puede admitir muchos formatos populares, incluido el formato PDF.<br />
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos PDF?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
