---
title: Elimine la anotación POTX en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo POTX a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos POTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios de la presentación POTX en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de presentaciones POTX basada en .NET.Código listado para administrar comentarios del archivo POTX a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de presentación POTX a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue POTX a través del objeto de clase Presentación
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar comentarios de presentación POTX a través de .NET" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos POTX a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos POTX" %}}
