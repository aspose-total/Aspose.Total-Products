---
title: Elimine la anotación ODT en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo ODT a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento ODT en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos ODT basada en .NET.Código listado para administrar comentarios del archivo ODT a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos ODT de autor específico a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C#: eliminar comentarios de autor específicos del archivo ODT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Agregar comentario desde el archivo ODT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos ODT a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos ODT" %}}
