---
title: Elimine la anotación XLT en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo XLT a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos XLT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLT en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLT basada en .NET.Código listado para administrar comentarios del archivo XLT a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLT a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo XLT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos XLT a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos XLT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
Los archivos XLT (Excel Template) proporcionan estructuras predefinidas para hojas de cálculo. Las anotaciones ayudan a identificar marcadores de posición, proporcionar instrucciones o capturar comentarios durante la personalización de la plantilla.

#### Anotar archivos XLT para personalización de plantillas - Casos de uso:

- **Instrucciones de plantilla**: Agregar comentarios para guiar a los usuarios finales en los campos de entrada.
- **Revisión de plantilla**: Anotar fórmulas o sugerencias de diseño para mejorar.
- **Notas de equipo**: Colaborar en borradores iniciales de plantillas con notas contextuales.
