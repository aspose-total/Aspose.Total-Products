---
title: Elimine la anotación XLTM en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo XLTM a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos XLTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLTM en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLTM basada en .NET.Código listado para administrar comentarios del archivo XLTM a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLTM a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo XLTM" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos XLTM a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos XLTM" %}}
