---
title: Elimine la anotación Powerpoint en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo Powerpoint a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos Powerpoint.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios de la presentación Powerpoint en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de presentaciones Powerpoint basada en .NET.Código listado para administrar comentarios del archivo Powerpoint a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eliminar anotaciones Powerpoint en línea" %}}

1. Importe el archivo Powerpoint para eliminar comentarios subiéndolo
1. Hágalo haciendo clic dentro del área de colocación arrastrando y soltando la aplicación de anotación
1. Dependiendo del tamaño del archivo Powerpoint y la velocidad de Internet, espere unos segundos
1. Haga clic en el botón 'Eliminar' para borrar los comentarios.
1. Descarga el archivo al instante

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de presentación Powerpoint a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue Powerpoint a través del objeto de clase Presentación
1. Iterar a través de cada autor a través de la presentación.CommentAuthors
1. Invocar el método Comments.Clear() para eliminar su comentario
...
{{% blocks/products/pf/agp/code-block title="Código C#: eliminar comentarios y autores de la presentación Powerpoint" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar comentarios de presentación Powerpoint a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue Powerpoint a través del objeto de clase Presentación
1. Agregue una diapositiva vacía usando el método AddEmptySlide
1. Utilice CommentAuthors.AddAuthor para agregar el nuevo autor
1. Utilice el nuevo autor con Comments.AddComment para insertar comentarios
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Agregar comentarios" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos Powerpoint a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de anotación Powerpoint para proporcionar comentarios, hacer sugerencias o colaborar con otros en el documento?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de anotación de documentos.La potente biblioteca .NET permite programar cualquier solución de anotación de documentos.Además, puede admitir muchos formatos populares, incluido el formato Powerpoint.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos Powerpoint" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos Powerpoint?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
