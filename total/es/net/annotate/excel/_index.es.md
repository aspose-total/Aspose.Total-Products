---
title: Elimine la anotación Excel en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo Excel a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento Excel en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos Excel basada en .NET.Código listado para administrar comentarios del archivo Excel a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios Excel a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo Excel" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos Excel a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos Excel" %}}
