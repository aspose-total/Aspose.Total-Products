---
title: Elimine la anotación XLS en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo XLS a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLS en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLS basada en .NET.Código listado para administrar comentarios del archivo XLS a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eliminar anotaciones XLS en línea" %}}

1. Importe el archivo XLS para eliminar comentarios subiéndolo
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLS a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo XLS" offSpacer="" %}}
