---
title: Elimine la anotación XLSB en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo XLSB a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos XLSB.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLSB en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLSB basada en .NET.Código listado para administrar comentarios del archivo XLSB a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eliminar anotaciones XLSB en línea" %}}

1. Importe el archivo XLSB para eliminar comentarios subiéndolo
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLSB a través de .NET" %}}
...
1. Utilice Comments.RemoveAt con la columna específica como índice
...
{{% blocks/products/pf/agp/code-block title="Código .NET: eliminar comentarios del archivo XLSB" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos XLSB a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de anotación XLSB para proporcionar comentarios, hacer sugerencias o colaborar con otros en el documento?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de anotación de documentos.La potente biblioteca .NET permite programar cualquier solución de anotación de documentos.Además, puede admitir muchos formatos populares, incluido el formato XLSB.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos XLSB" %}}
