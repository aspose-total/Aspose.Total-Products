---
title: Elimine la anotación ODP en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo ODP a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios de la presentación ODP en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de presentaciones ODP basada en .NET.Código listado para administrar comentarios del archivo ODP a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de presentación ODP a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C#: eliminar comentarios y autores de la presentación ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar comentarios de presentación ODP a través de .NET" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos ODP a través de .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos ODP" %}}
