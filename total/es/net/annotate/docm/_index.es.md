---
title: Elimine la anotación DOCM en línea o administre anotaciones a través de .NET
description: elimine comentarios del archivo DOCM a través de la aplicación en línea de forma gratuita.Código API .NET para gestionar comentarios de archivos DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento DOCM en línea o administrar a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos DOCM basada en .NET.Código listado para administrar comentarios del archivo DOCM a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eliminar anotaciones DOCM en línea" %}}

1. Importe el archivo DOCM para eliminar comentarios subiéndolo
1. Hágalo haciendo clic dentro del área de colocación arrastrando y soltando la aplicación de anotación
1. Dependiendo del tamaño del archivo DOCM y la velocidad de Internet, espere unos segundos
1. Haga clic en el botón 'Eliminar' para borrar los comentarios.
1. Descarga el archivo al instante

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos DOCM de autor específico a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargar documento a través del objeto de clase de documento
1. Obtenga todos los comentarios de los nodos utilizando GetChildNodes que tenga NodeType.Comment
1. Repita todos los comentarios y haga coincidir el nombre del autor.
1. Llame al método Remove para eliminar el comentario del autor específico
...
{{% blocks/products/pf/agp/code-block title="Código C#: eliminar comentarios de autor específicos del archivo DOCM" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar comentarios a través de .NET" %}}

1. Crear objeto de clase de documento
1. Utilice la clase Comentario
1. Agregue el nuevo párrafo usando Paragraphs.Add
1. Utilice FirstParagraph.Runs.Agregue el comentario
...
1. Iterar a través de cada colección y agregar comentarios en ArrayList
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Agregar comentario desde el archivo DOCM" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos DOCM a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de anotación DOCM para proporcionar comentarios, hacer sugerencias o colaborar con otros en el documento?Con [Aspose.Words for .NET](https://products.aspose.com/words/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de anotación de documentos.La potente biblioteca .NET permite programar cualquier solución de anotación de documentos.Además, puede admitir muchos formatos populares, incluido el formato DOCM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca .NET para anotar archivos DOCM" %}}

Hay tres opciones alternativas para instalar "Aspose.Words for .NET" o "Aspose.Total for .NET" en su sistema.Elija uno que se adapte a sus necesidades y siga las instrucciones paso a paso:<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
Los archivos DOCM (Documento habilitado para macros de Microsoft Word) admiten la integración de macros para la automatización. La anotación de archivos DOCM proporciona contexto esencial sobre los procesos automatizados, el seguimiento de los cambios realizados por las macros y facilita la revisión colaborativa.

#### Anotación de Archivos DOCM para Casos de Uso de Colaboración en Documentos Habilitados para Macros:

- **Documentación del Flujo de Trabajo de Macros**  
  Anote documentos habilitados para macros para explicar el propósito de cada macro, la salida esperada y su papel en la automatización del documento.

- **Instrucciones para el Usuario sobre Funciones de Macros**  
  Agregue anotaciones en documentos para guiar a los usuarios sobre cómo interactuar con las macros o los datos de entrada necesarios para acciones automatizadas.

- **Depuración y Seguimiento de Errores**  
  Inserte comentarios para resaltar secciones donde las macros fallan o donde se ingresan datos incorrectamente, lo que ayuda en la depuración.

- **Retroalimentación sobre la Automatización**  
  Proporcione retroalimentación sobre la efectividad de las macros en la automatización de tareas de documentos como la creación de tablas, formato o población de contenido.

- **Revisión del Contenido Generado por Macros**  
  Anote áreas donde el contenido generado por macros necesita revisión o modificación manual.
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puede descargar este código y utilizarlo con el fin de desarrollar una aplicación de anotación de documentos basada en .NET.Este código puede servir como un recurso valioso para mejorar la funcionalidad y las capacidades de sus proyectos en el dominio del procesamiento y manipulación de documentos backend.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos DOCM?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
