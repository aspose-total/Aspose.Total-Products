---
title: Proteja el documento ODP en línea con contraseña y usando .NET
description: Aplicación de protección de contraseña de archivos ODP en línea.Código API .NET C# para aplicar protección con contraseña en presentaciones ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protección de documentos ODP en línea o configuración de contraseña a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de protección de documentos ODP basada en .NET.Código listado para aplicar contraseña a la presentación ODP a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protección con contraseña ODP a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Protección con contraseña de presentación ODP" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de protección de contraseña ODP a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de protección con contraseña ODP?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de protección de documentos.La potente biblioteca .NET permite programar cualquier solución de protección con contraseña de documentos para proteger y bloquear las presentaciones.Además, puede admitir muchos formatos populares, incluido el formato ODP.<br /><br />
