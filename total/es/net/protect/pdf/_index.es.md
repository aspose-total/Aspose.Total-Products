---
title: Proteja el documento PDF en línea con contraseña y usando .NET
description: Aplicación de protección de contraseña de archivos PDF en línea.Código API .NET C# para aplicar protección con contraseña en documentos PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Protección de documentos PDF en línea o configuración de contraseña a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de protección de documentos PDF basada en .NET.Código listado para aplicar contraseña al documento PDF a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Protección con contraseña PDF en línea a través de la aplicación" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Protección con contraseña PDF a través de .NET" %}}

1. Cargue el archivo PDF a través de la clase Documento
1. Llame al método Encrypt
1. Proporcionar contraseña, prealdeas y tipo de protección como parámetros.
1. Llame al método Save para guardar el documento protegido
...
{{% blocks/products/pf/agp/code-block title="Código .NET: Protección con contraseña de documentos PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de protección de contraseña PDF a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de protección con contraseña PDF?Con [Aspose.PDF for .NET](https://products.aspose.com/pdf/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de protección de documentos.La potente biblioteca .NET permite programar cualquier solución de protección con contraseña de documentos para proteger y bloquear los archivos.Además, puede admitir muchos formatos populares, incluido el formato PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos PDF para proteger la aplicación" %}}
