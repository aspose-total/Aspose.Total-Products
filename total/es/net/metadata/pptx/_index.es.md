---
title: Ver y actualizar propiedades de PPTX en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de PPTX a través de la aplicación en línea de forma gratuita. Código API C# .NET para actualizar las propiedades de PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos PPTX en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos PPTX basada en .NET.Código listado para actualizar los metadatos de PPTX a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Actualizar las propiedades de PPTX a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar metadatos PPTX" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos PPTX a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos PPTX?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos PPTX" %}}
