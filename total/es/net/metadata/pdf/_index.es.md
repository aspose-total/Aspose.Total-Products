---
title: Ver y actualizar propiedades de PDF en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de PDF a través de la aplicación en línea de forma gratuita.Código API C# .NET para actualizar las propiedades de PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos PDF en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos PDF basada en .NET.Código enumerado para actualizar los metadatos del archivo PDF a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Actualizar metadatos PDF a través de .NET" %}}

1. Cargue el archivo PDF usando la clase Documento.
1. Cree un objeto de clase DocumentInfo que tenga el primer objeto como parámetro
1. Asignar nuevas propiedades
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar las propiedades de PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos PDF a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos PDF?Con [Aspose.PDF for .NET](https://products.aspose.com/pdf/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos PDF" %}}
