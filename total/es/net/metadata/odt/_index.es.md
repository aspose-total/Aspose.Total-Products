---
title: Ver y actualizar propiedades de ODT en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de ODT a través de la aplicación en línea de forma gratuita. Código API C# .NET para actualizar y agregar propiedades ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos ODT en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos ODT basada en .NET.Código enumerado para agregar y modificar metadatos de archivos ODT a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Administrar propiedades de ODT a través de .NET" %}}
...
1. Llame al método Save() para guardar el documento ODT actualizado.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar metadatos ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código .NET: agregar propiedades personalizadas de ODT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos ODT a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos ODT?Con [Aspose.Cells for .NET](https://products.aspose.com/cells/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos ODT" %}}
