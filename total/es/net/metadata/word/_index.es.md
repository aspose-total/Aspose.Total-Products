---
title: Ver y actualizar propiedades de Word en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de Word a través de la aplicación en línea de forma gratuita.Código API C# .NET para actualizar las propiedades de Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos Word en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos Word basada en .NET.Código enumerado para actualizar los metadatos del archivo Word a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ver o actualizar metadatos Word en línea" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Actualizar las propiedades de Word a través de .NET" %}}

1. Cargue el archivo Word usando la clase Documento.
1. Obtenga todo a través de CustomDocumentProperties y BuiltInDocumentProperties
1. Asignar los nuevos valores.
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar metadatos Word" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos Word a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos Word?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos Word" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puede descargar este código y utilizarlo con el fin de desarrollar una aplicación de metadatos de documentos basada en .NET. Este código puede servir como un recurso valioso para mejorar la funcionalidad y las capacidades de sus proyectos en el dominio del procesamiento y manipulación de documentos backend.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para administrar las propiedades del documento Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
