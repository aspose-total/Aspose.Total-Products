---
title: Ver y actualizar propiedades de ODP en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de ODP a través de la aplicación en línea de forma gratuita. Código API C# .NET para actualizar las propiedades de ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos ODP en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos ODP basada en .NET.Código listado para actualizar los metadatos de ODP a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Actualizar las propiedades de ODP a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar metadatos ODP" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos ODP a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos ODP?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos ODP" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 🎤 Casos de uso para la Presentación de OpenDocument (`.odp`)

- Utilice metadatos en formato abierto para mantener la compatibilidad entre plataformas.
- Etiquete el propósito de la presentación, el evento o la audiencia para su reutilización.
- Ayude a integrarse con un LMS de código abierto o la búsqueda de contenido empresarial.
