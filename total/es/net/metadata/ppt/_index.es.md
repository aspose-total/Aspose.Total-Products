---
title: Ver y actualizar propiedades de PPT en línea o actualizar metadatos usando .NET
description: Vea y modifique las propiedades de PPT a través de la aplicación en línea de forma gratuita. Código API C# .NET para actualizar las propiedades de PPT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ver o actualizar metadatos PPT en línea o actualizar a través de .NET" h2="Desarrolle una potente aplicación de utilidad de gestión de metadatos de documentos PPT basada en .NET.Código listado para actualizar los metadatos de PPT a través de .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ver o actualizar metadatos PPT en línea" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Actualizar las propiedades de PPT a través de .NET" %}}

1. Crear objeto de clase de presentación
1. Obtenga todas las propiedades a través de DocumentProperties
1. Asignar nuevas propiedades como Autor, Título, Asunto
...
{{% blocks/products/pf/agp/code-block title="Código .NET: actualizar metadatos PPT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de gestión de metadatos PPT a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de gestión de metadatos PPT?Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de metadatos de documentos.La potente biblioteca .NET permite programar cualquier solución de metadatos de documentos.Además, puede admitir muchos formatos populares, incluido el formato PPT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para gestionar metadatos PPT" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para administrar las propiedades del documento PPT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
