---
title: Redactar documento PDF en línea o usando .NET
description: Abra y redacte documentos PDF en línea a través de la aplicación de forma gratuita. Código .NET API C# para buscar y reemplazar texto PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento PDF en línea o mediante .NET" h2="Desarrolle una poderosa aplicación de utilidad de redacción de documentos PDF basada en .NET.Código C# listado para buscar y reemplazar texto en un archivo PDF a través de .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo PDF a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue el archivo PDF usando la clase Documento
1. Utilice el objeto de clase TextFragmentAbsorber con términos de búsqueda como parámetro
1. Obtenga todos los TextFragments en TextFragmentCollection
1. Iterar a través de cada colección de fragmentos.
1. Defina RedactionAnnotation y llame al método Redact()
...
{{% blocks/products/pf/agp/code-block title="Código C#: Redactar archivo PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de redacción PDF a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de redacción PDF?Con [Aspose.PDF for .NET](https://products.aspose.com/pdf/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de redacción de documentos.La potente biblioteca .NET permite programar cualquier solución de redacción de documentos. Además, puede admitir muchos formatos populares, incluido el formato PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para redactar archivos PDF" %}}
