---
title: Redactar documento DOC en línea o usando .NET
description: Abra y redacte documentos DOC en línea a través de la aplicación de forma gratuita.Código .NET API C# para buscar y reemplazar texto DOC.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento DOC en línea o mediante .NET" h2="Desarrolle una poderosa aplicación de utilidad de redacción de documentos DOC basada en .NET.Código C# listado para buscar y reemplazar texto en el archivo DOC." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Redactar documento DOC en línea" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo DOC a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cree un objeto de clase de documento o cargue el archivo usándolo
1. Cree un objeto DocumentBuilder con el objeto anterior como parámetro
1. Rellenar el documento
1. Definir la matriz de patrones de expresión regular
1. Utilice el método Reemplazar para buscar y reemplazar combinaciones de caracteres particulares
1. Guarde el documento DOC
...
{{% blocks/products/pf/agp/code-block title="Código C#: Redactar archivo DOC" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de redacción DOC a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de redacción DOC?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de redacción de documentos.La potente biblioteca .NET permite programar cualquier solución de redacción de documentos.Además, puede admitir muchos formatos populares, incluido el formato DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para redactar archivos DOC" %}}
...
- Redactar nombres, direcciones y cláusulas confidenciales en acuerdos legales.
- Redactar contenido privilegiado en presentaciones judiciales o divulgaciones legales.
- Redactar datos internos de documentos de recursos humanos, contratos o informes antes de compartirlos.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para gestionar la redacción de documentos DOC?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
