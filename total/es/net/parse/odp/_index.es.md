---
title: Extraiga texto e imágenes de un archivo ODP en línea y usando .NET
description: Aplicación de análisis de archivos ODP en línea. Código .NET API C# para extraer imágenes y texto de una presentación ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos ODP en línea y a través de .NET" h2="Desarrolle una potente aplicación de análisis de presentaciones ODP basada en .NET. Código C# listado para analizar ODP." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar la presentación ODP a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de texto de presentación ODP" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de imágenes de presentación ODP" offSpacer="" %}}
...
<h2>Desarrolle la aplicación analizador de presentaciones ODP a través de .NET</h2>

¿Necesita desarrollar una aplicación de análisis ODP? Con [Aspose.Slides for .NET](https://products.aspose.com/slides/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de análisis de documentos.La potente biblioteca .NET permite programar cualquier solución de análisis de documentos para extraer imágenes y texto.Además, puede admitir muchos formatos populares, incluido el formato ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos ODP para la aplicación del analizador" %}}
