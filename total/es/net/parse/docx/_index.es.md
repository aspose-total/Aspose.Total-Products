---
title: Extraiga texto e imágenes de un archivo DOCX en línea y usando .NET
description: Aplicación de análisis de archivos DOCX en línea. Código .NET API C# para extraer imágenes y contenido de texto de un documento DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos DOCX en línea y a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de análisis de documentos DOCX basada en .NET. Código C# listado para la extracción de texto de documentos DOCX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizar documento DOCX a través de la aplicación en línea" %}}

1. Importe el archivo DOCX para analizarlo cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar archivos DOCX a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue el archivo DOCX usando el objeto de clase Documento
1. Obtenga todos los nodos secundarios usando GetChildNodes()
1. Utilice NodeType.Shape como parámetro
1. Iterar a través de cada nodo y guardar la imagen.
1. Para extraer texto, recorra cada página
1. Llame al método ExtractPages
1. Guarde el archivo extraído en texto usando el método Node.ToString
...
{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de imágenes de documentos DOCX" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de texto de documento DOCX" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de análisis de archivos DOCX a través de .NET</h2>

¿Necesita desarrollar una aplicación o software de análisis DOCX?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de análisis de documentos.La potente biblioteca .NET permite programar cualquier solución de análisis de documentos para extraer imágenes y texto.Además, puede admitir muchos formatos populares, incluido el formato DOCX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos DOCX para la aplicación del analizador" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Casos de uso para analizar archivos .docx

- 📄 Extraer contenido estructurado, incluido texto, tablas, imágenes y metadatos.
- 📰 Convertir archivos `.docx` a HTML o Markdown para su publicación web.
- 🧾 Automatizar la generación de informes y flujos de trabajo de documentos.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para analizar documentos DOCX?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
