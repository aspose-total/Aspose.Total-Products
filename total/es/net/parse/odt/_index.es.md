---
title: Extraiga texto e imágenes de un archivo ODT en línea y usando .NET
description: Aplicación de análisis de archivos ODT en línea. Código .NET API C# para extraer imágenes y contenido de texto de un documento ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos ODT en línea y a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de análisis de documentos ODT basada en .NET. Código C# listado para la extracción de texto de documentos ODT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizar documento ODT a través de la aplicación en línea" %}}

1. Importe el archivo ODT para analizarlo cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar archivos ODT a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue el archivo ODT usando el objeto de clase Documento
...
{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de imágenes de documentos ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "56e34ac75fba2313ae00be996cc53d39" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de texto de documento ODT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de análisis de archivos ODT a través de .NET</h2>

¿Necesita desarrollar una aplicación o software de análisis ODT?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de análisis de documentos.La potente biblioteca .NET permite programar cualquier solución de análisis de documentos para extraer imágenes y texto.Además, puede admitir muchos formatos populares, incluido el formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos ODT para la aplicación del analizador" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para analizar documentos ODT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
