---
title: Extraiga texto e imágenes de un archivo Word en línea y usando .NET
description: Aplicación de análisis de archivos Word en línea. Código .NET API C# para extraer imágenes y contenido de texto de un documento Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos Word en línea y a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de análisis de documentos Word basada en .NET. Código C# listado para la extracción de texto de documentos Word." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar archivos Word a través de .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de texto de documento Word" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de análisis de archivos Word a través de .NET</h2>

¿Necesita desarrollar una aplicación o software de análisis Word?Con [Aspose.Words for .NET](https://products.aspose.com/words/es/net/), una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de .NET puede integrar el código API anterior dentro de su aplicación de análisis de documentos.La potente biblioteca .NET permite programar cualquier solución de análisis de documentos para extraer imágenes y texto.Además, puede admitir muchos formatos populares, incluido el formato Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos Word para la aplicación del analizador" %}}
