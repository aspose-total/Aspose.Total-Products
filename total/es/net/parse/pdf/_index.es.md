---
title: Extraiga texto e imágenes de un archivo PDF en línea y usando .NET
description: Aplicación de análisis de archivos PDF en línea. Código .NET API C# para extraer imágenes y texto de un documento PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos PDF en línea y extraer texto o imágenes a través de .NET" h2="Desarrolle una poderosa aplicación de utilidad de análisis de documentos PDF basada en .NET.Código C# listado para imágenes de documentos PDF y extracción de texto." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar archivos PDF a través de .NET" %}}

1. Agregar referencia de biblioteca al proyecto .NET
1. Cargue el archivo PDF usando la clase Documento
1. Usar objeto de clase TextAbsorber
1. Aceptar el absorbente para todas las páginas.
1. Obtenga el texto extraído y escriba
...
{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de texto de documento PDF" offSpacer="" %}}

{{< gist "aspose-com-gists" "56e34ac75fba2313ae00be996cc53d39" "parse-pdf-documents-by-extracting-text.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código C#: Extracción de imágenes de documentos PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de análisis de archivos PDF a través de .NET</h2>

¿Necesita desarrollar una aplicación o utilidad de análisis PDF?Dado que [Aspose.PDF for .NET](https://products.aspose.com/pdf/es/net/) es una API secundaria de [Aspose.Total for .NET](https://products.aspose.com/total/es/net/), cualquier desarrollador de Python puede integrar el código API anterior en su aplicación de análisis de documentos.La potente biblioteca .NET permite programar cualquier solución de análisis de documentos para extraer imágenes y texto.Además, puede admitir muchos formatos populares, incluido el formato PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad .NET para procesar archivos PDF para la aplicación de análisis" %}}

Existen opciones alternativas para instalar Aspose.PDF for .NET o Aspose.Total for .NET en su sistema.Elija uno que se adapte a sus necesidades y siga las instrucciones paso a paso:<br /><br />
