---
title: Ver archivos DOC en línea y usando .NET
description: Aplicación gratuita de visualización de archivos DOC en línea. Código .NET API C# para ver el archivo DOC para la aplicación de visor.
...
{{< blocks/products/pf/feature-page-header-widget h1="Vea libremente el archivo DOC en línea o mediante .NET" h2="Desarrolle una poderosa aplicación de utilidad de visualización de documentos DOC basada en .NET. Código C# listado para ver el documento DOC." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ver documento DOC a través de la aplicación en línea" %}}

1. Importe el archivo DOC para verlo cargándolo.
...
1. Navegue entre páginas en caso de un documento DOC de varias páginas.
1. Configure la vista de página para acercar o alejar.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Ver archivo DOC a través de .NET" %}}

1. Agregar referencia de biblioteca .NET al proyecto
1. Cargue el archivo DOC fuente usando el objeto de clase Documento
...
{{% blocks/products/pf/agp/code-block title="Código C#: Ver documento DOC" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para ver el documento DOC?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
