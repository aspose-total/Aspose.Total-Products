---
title: Actualizar archivo XLTM usando .NET
description: Modifique documentos XLTM en aplicaciones C# VB.NET sin usar Microsoft Excel. 
...
{{< blocks/products/pf/feature-page-header h1="Actualizar archivo XLTM a través de .NET" h2="Modifique la hoja de cálculo XLTM a través de sus aplicaciones basadas en .NET sin instalar Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Para un desarrollador, ¿quién intenta actualizar archivos XLTM a través de la aplicación .NET? La API [Aspose.Total for .NET](https://products.aspose.com/total/net/) puede ayudar a automatizar el proceso de actualización. Es un paquete completo de varias API de .NET que se ocupan de diferentes formatos, incluidos los archivos de Microsoft Excel. La API ASPOSE.CELL que forma parte del paquete [Aspose.Total for .NET](https://products.aspose.com/total/net/) facilita este proceso de modificación. A continuación se muestra el proceso de actualización del documento XLTM.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Cómo actualizar el archivo XLTM en .NET" %}}

- Cree un nuevo objeto de clase [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) que tenga el archivo XLTM de origen como parámetro
...
- Para la modificación de XLTM, Microsoft Windows o un sistema operativo compatible con las plataformas .NET, .NET Core, Mono o Xamarin
...
{{% blocks/products/pf/agp/code-block title="Código - Actualizar archivo XLTM en .NET" offSpacer="" %}}
