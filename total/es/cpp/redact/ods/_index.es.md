---
title: Redactar hoja de cálculo ODS en línea o usando C++
description: Abra y redacte documentos ODS en línea a través de la aplicación de forma gratuita.Código API C++ para buscar y reemplazar texto ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento ODS en línea o mediante C++" h2="Desarrolle una poderosa aplicación de utilidad de redacción de documentos ODS basada en C++.Código C++ listado para buscar y reemplazar texto en un archivo ODS." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo ODS mediante C++" %}}
...
<h2>Desarrollar una aplicación de redacción ODS a través de C++</h2>

¿Necesita desarrollar una aplicación o utilidad de redacción ODS?Con [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/), una API secundaria de [Aspose.Total for C++](https://products.aspose.com/total/es/cpp/), cualquier desarrollador de C++ puede integrar el código API anterior dentro de su aplicación de redacción de documentos.La potente biblioteca C++ permite programar cualquier solución de redacción de hojas de cálculo.Además, puede admitir muchos formatos populares, incluido el formato ODS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad C++ para redactar archivos ODS" %}}
