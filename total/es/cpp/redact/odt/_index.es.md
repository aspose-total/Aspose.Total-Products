---
title: Redactar documento ODT en línea o usando C++
description: Abra y redacte documentos ODT en línea a través de la aplicación de forma gratuita.Código API C++ para buscar y reemplazar texto ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento ODT en línea o mediante C++" h2="Desarrolle una poderosa aplicación de utilidad de redacción de documentos ODT basada en C++.Código C++ listado para buscar y reemplazar texto en un archivo ODT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo ODT mediante C++" %}}
...
<h2>Desarrollar una aplicación de redacción ODT a través de C++</h2>

¿Necesita desarrollar una aplicación o utilidad de redacción ODT?Con [Aspose.Words for C++](https://products.aspose.com/words/cpp/), una API secundaria de [Aspose.Total for C++](https://products.aspose.com/total/es/cpp/), cualquier desarrollador de C++ puede integrar el código API anterior dentro de su aplicación de redacción de documentos.La potente biblioteca C++ permite programar cualquier solución de redacción de documentos.Además, puede admitir muchos formatos populares, incluido el formato ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad C++ para redactar archivos ODT" %}}
