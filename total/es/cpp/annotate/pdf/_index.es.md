---
title: Elimine la anotación PDF en línea o administre anotaciones a través de C++
description: elimine comentarios del archivo PDF a través de la aplicación en línea de forma gratuita. Código API C++ para gestionar comentarios de archivos PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento PDF en línea o administrar mediante C++" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos PDF basada en C++. Código listado para administrar comentarios del archivo PDF a través de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Agregar anotación a través de C++" %}}

1. Agregar referencia de biblioteca al proyecto C++
1. Cargar documento PDF
1. Obtenga la página por su índice usando get_Pages()->idx_get
1. Usando el método get_Selected del selector de anotaciones, obtenga todas las anotaciones de texto
1. Iterar a través de cada anotación de texto e invocar el método Eliminar
...
{{% blocks/products/pf/agp/code-block title="Código C++: eliminar anotaciones de texto en un archivo PDF" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos PDF a través de C++</h2>

¿Necesita desarrollar una aplicación o utilidad de anotación PDF para proporcionar comentarios, hacer sugerencias o colaborar con otros en el documento?Dado que [Aspose.PDF for C++](https://products.aspose.com/pdf/cpp/) es una API secundaria de [Aspose.Total for C++](https://products.aspose.com/total/es/cpp/), cualquier desarrollador de C++ puede integrar el código API anterior en su aplicación de anotación de documentos.La potente biblioteca C++ permite programar cualquier solución de anotación de documentos. Además, puede admitir muchos formatos populares, incluido el formato PDF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca C++ para anotar archivos PDF" %}}
