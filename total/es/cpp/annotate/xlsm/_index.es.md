---
title: Elimine la anotación XLSM en línea o administre anotaciones a través de C++
description: elimine comentarios del archivo XLSM a través de la aplicación en línea de forma gratuita. Código API C++ para gestionar comentarios de archivos XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento XLSM en línea o administrar mediante C++" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos XLSM basada en C++. Código listado para administrar comentarios del archivo XLSM a través de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios XLSM a través de C++" %}}

1. Agregar referencia de biblioteca al proyecto C++
1. Cargue el archivo XLSM usando CreateIWorkbook
...
{{% blocks/products/pf/agp/code-block title="Código C++: Anotación de archivos XLSM" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos XLSM a través de C++</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca C++ para anotar archivos XLSM" %}}
