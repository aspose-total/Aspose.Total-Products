---
title: Elimine la anotación DOT en línea o administre anotaciones a través de C++
description: elimine comentarios del archivo DOT a través de la aplicación en línea de forma gratuita. Código API C++ para gestionar comentarios de archivos DOT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento DOT en línea o administrar mediante C++" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos DOT basada en C++. Código listado para administrar comentarios del archivo DOT a través de C++." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos DOT a través de C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C++: eliminar comentarios del archivo DOT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Código C++: agregar comentario al archivo DOT" offSpacer="" %}}
...
<h2>Desarrollar una aplicación de anotación de documentos DOT a través de C++</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca C++ para anotar archivos DOT" %}}
