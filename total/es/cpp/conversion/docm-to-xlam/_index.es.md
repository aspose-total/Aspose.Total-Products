---
title: Convertir DOCM a XLAM en C++
description: API de C++ para convertir DOCM a XLAM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLAM" h2="Exporte DOCM a XLAM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
