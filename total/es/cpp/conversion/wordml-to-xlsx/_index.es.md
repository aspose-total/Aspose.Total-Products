---
title: Convertir WORDML a XLSX en C++
description: API de C++ para convertir WORDML a XLSX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/wordml-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a XLSX" h2="Exporte WORDML a XLSX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
