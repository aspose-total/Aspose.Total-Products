---
title: Exportar EMAIL a PS a través de C++
description: API de C++ para convertir EMAIL a PS sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a PS" h2="Transforme EMAIL a PS dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a PS" %}}
...
4. Guarde el documento en formato PS usando el método [Guardar](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) y configure Ps como SaveFormat
