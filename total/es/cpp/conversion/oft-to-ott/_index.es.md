---
title: Exportar OFT a OTT a través de C++
description: API de C++ para convertir OFT a OTT sin usar Microsoft Word o Outlook
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a OTT" h2="Transforme OFT a OTT dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a OTT" %}}
...
4. Guarde el documento en formato OTT usando el método [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) y configure Ott como SaveFormat
