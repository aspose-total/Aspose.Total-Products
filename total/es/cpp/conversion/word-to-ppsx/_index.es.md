---
title: Convierta WORD a PPSX a través de C++
description: Exporte WORD a PPSX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/word-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORD a PPSX" h2="Exporte WORD a PPSX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
