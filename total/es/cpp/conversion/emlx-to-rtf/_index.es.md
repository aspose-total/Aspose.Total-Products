---
title: Exportar EMLX a RTF a través de C++
description: API de C++ para convertir EMLX a RTF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/emlx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMLX a RTF" h2="Transforme EMLX a RTF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMLX a RTF" %}}
