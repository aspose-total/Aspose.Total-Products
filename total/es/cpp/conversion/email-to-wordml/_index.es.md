---
title: Exportar EMAIL a WORDML a través de C++
description: API de C++ para convertir EMAIL a WORDML sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a WORDML" h2="Transforme EMAIL a WORDML dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a WORDML" %}}
