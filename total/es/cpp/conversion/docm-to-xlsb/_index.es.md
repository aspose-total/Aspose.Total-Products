---
title: Convertir DOCM a XLSB en C++
description: API de C++ para convertir DOCM a XLSB sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLSB" h2="Exporte DOCM a XLSB a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
