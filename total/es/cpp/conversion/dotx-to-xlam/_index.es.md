---
title: Convertir DOTX a XLAM en C++
description: API de C++ para convertir DOTX a XLAM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a XLAM" h2="Exporte DOTX a XLAM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOTX a XLAM" %}}
