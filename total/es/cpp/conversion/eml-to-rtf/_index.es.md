---
title: Exportar EML a RTF a través de C++
description: API de C++ para convertir EML a RTF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/eml-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EML a RTF" h2="Transforme EML a RTF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EML a RTF" %}}
...
4. Guarde el documento en formato RTF usando el método [Guardar](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) y configure Rtf como SaveFormat
