---
title: Exportar OFT a DOC a través de C++
description: API de C++ para convertir OFT a DOC sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a DOC" h2="Transforme OFT a DOC dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
