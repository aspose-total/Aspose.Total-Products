---
title: API de C++ para convertir PPT a TEXT
description: Exporte PPT a TEXT dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPT a TEXT" h2="Exporte PPT a TEXT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
