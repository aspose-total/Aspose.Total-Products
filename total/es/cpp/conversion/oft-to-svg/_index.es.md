---
title: Exportar OFT a SVG a través de C++
description: API de C++ para convertir OFT a SVG sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a SVG" h2="Transforme OFT a SVG dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a SVG" %}}
