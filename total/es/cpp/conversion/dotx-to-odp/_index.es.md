---
title: Convierta DOTX a ODP a través de C++
description: Exporte DOTX a ODP en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotx-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a ODP" h2="Exporte DOTX a ODP dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
