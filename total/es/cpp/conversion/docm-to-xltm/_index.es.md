---
title: Convertir DOCM a XLTM en C++
description: API de C++ para convertir DOCM a XLTM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLTM" h2="Exporte DOCM a XLTM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
