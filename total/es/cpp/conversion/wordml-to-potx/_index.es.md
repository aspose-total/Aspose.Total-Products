---
title: Convierta WORDML a POTX a través de C++
description: Exporte WORDML a POTX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/wordml-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a POTX" h2="Exporte WORDML a POTX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
