---
title: API de C++ para convertir MHTML a POT
description: Convierta MHTML a POT a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
url: /es/cpp/conversion/mhtml-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/feature-page-header h1="Renderizar MHTML a POT dentro de aplicaciones C++" h2="Convierta MHTML a POT dentro de sus aplicaciones C++ sin usar Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para exportar MHTML a POT" %}}
...
Después de convertir MHTML a POT, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo POT
{{% blocks/products/pf/feature-page-code %}}
