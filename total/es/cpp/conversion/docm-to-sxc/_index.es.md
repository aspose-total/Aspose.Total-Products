---
title: Convertir DOCM a SXC en C++
description: API de C++ para convertir DOCM a SXC sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a SXC" h2="Exporte DOCM a SXC a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
