---
title: Convertir WORDML a EXCEL en C++
description: API de C++ para convertir WORDML a EXCEL sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a EXCEL" h2="Exporte WORDML a EXCEL a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
