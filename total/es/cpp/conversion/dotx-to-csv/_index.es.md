---
title: Convertir DOTX a CSV en C++
description: API de C++ para convertir DOTX a CSV sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a CSV" h2="Exporte DOTX a CSV a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
