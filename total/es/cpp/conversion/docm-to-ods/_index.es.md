---
title: Convertir DOCM a ODS en C++
description: API de C++ para convertir DOCM a ODS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a ODS" h2="Exporte DOCM a ODS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
