---
title: Convierta DOTX a PPT a través de C++
description: Exporte DOTX a PPT en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotx-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a PPT" h2="Exporte DOTX a PPT dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
