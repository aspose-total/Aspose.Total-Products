---
title: API de C++ para convertir PPTM a DOTM
description: Exporte PPTM a DOTM dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPTM a DOTM" h2="Exporte PPTM a DOTM en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
