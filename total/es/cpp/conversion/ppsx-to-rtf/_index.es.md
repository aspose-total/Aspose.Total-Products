...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSX a RTF o en línea" h2="Exporte PPSX a RTF en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
