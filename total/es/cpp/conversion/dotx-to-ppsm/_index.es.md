---
title: Convierta DOTX a PPSM a través de C++
description: Exporte DOTX a PPSM en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotx-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a PPSM" h2="Exporte DOTX a PPSM dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
