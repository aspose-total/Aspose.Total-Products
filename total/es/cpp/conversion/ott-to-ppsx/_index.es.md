...
description: Exporte OTT a PPSX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint o en línea. Pruebe el convertidor en línea gratuito de POT a CSV rápidamente antes de integrar el código.
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir OTT a PPSX o en línea" h2="Exporte OTT a PPSX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
...
6. Guarde el ottumento en formato PPSX usando el método [Guardar](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) y configure Ppsx como SaveFormat
