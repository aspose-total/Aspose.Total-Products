---
title: API de C++ para convertir POTM a TEXT
description: Exporte POTM a TEXT dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTM a TEXT" h2="Exporte POTM a TEXT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
