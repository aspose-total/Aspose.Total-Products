---
title: Convertir XLSX a DOC con C++
description: Convierta XLSX a DOC dentro de aplicaciones C++
url: /es/cpp/conversion/xlsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Convierta XLSX a DOC a través de C++" h2="Exportar Excel<sup>&reg;</sup> XLSX a DOC dentro de aplicaciones C++ completamente funcionales" >}}
