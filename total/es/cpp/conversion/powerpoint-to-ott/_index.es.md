...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POWERPOINT a OTT o en línea" h2="Exporte POWERPOINT a OTT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
