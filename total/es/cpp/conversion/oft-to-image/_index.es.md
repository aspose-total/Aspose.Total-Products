---
title: Exportar OFT a IMAGE a través de C++
description: API de C++ para convertir OFT a IMAGE sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-image/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a IMAGE" h2="Transforme OFT a IMAGE dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a IMAGE" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/cpp/conversion/oft-to-image/" name="OFT A IMAGE" description="" >}}
