---
title: Convierta DOT a PPS a través de C++
description: Exporte DOT a PPS en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dot-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOT a PPS" h2="Exporte DOT a PPS dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
