...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSM a TEXT o en línea" h2="Exporte PPSM a TEXT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
