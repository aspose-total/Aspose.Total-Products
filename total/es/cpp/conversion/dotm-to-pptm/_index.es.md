---
title: Convierta DOTM a PPTM a través de C++
description: Exporte DOTM a PPTM en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotm-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTM a PPTM" h2="Exporte DOTM a PPTM dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
