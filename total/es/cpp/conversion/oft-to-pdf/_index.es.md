---
title: Exportar OFT a PDF a través de C++
description: API de C++ para convertir OFT a PDF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a PDF" h2="Transforme OFT a PDF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a PDF" %}}
