...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSM a DOTM o en línea" h2="Exporte PPSM a DOTM en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
