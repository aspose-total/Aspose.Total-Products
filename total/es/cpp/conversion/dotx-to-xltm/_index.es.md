---
title: Convertir DOTX a XLTM en C++
description: API de C++ para convertir DOTX a XLTM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a XLTM" h2="Exporte DOTX a XLTM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOTX a XLTM" %}}
