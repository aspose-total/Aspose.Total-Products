---
title: API de C++ para convertir PPS a DOC o con el convertidor en línea gratuito
description: Exporte PPS a DOC dentro de sus aplicaciones C++ o en línea. Pruebe el convertidor en línea gratuito de PPS a DOC rápidamente antes de integrar el código.
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPS a DOC o aplicación en línea" h2="Exporte PPS a DOC en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
...
4. Guarde el documento en formato DOC usando la función de miembro [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string)
...
<iframe title="Herramienta de conversión de doc a pps" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=doc&from=pps" id="child-iframe" width="80%"></iframe>
          ...
          <div>
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Cómo puedo convertir PPS a DOC en línea?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">La aplicación en línea para la conversión de PPS está integrada arriba. Para convertir su archivo PPS a DOC usando esta herramienta en línea, puede arrastrar y soltar el archivo PPS en el área designada o hacer clic dentro del área blanca para seleccionar el archivo desde su dispositivo. Una vez seleccionado el archivo PPS, haga clic en el botón Convertir. Una vez que se completa la conversión de PPS a DOC, puede descargar su archivo DOC convertido con solo un clic.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
