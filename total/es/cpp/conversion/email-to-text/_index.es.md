---
title: Exportar EMAIL a TEXT a través de C++
description: API de C++ para convertir EMAIL a TEXT sin usar Microsoft Word o Outlook
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a TEXT" h2="Transforme EMAIL a TEXT dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a TEXT" %}}
...
4. Guarde el documento en formato TEXT usando el método [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) y configure Text como SaveFormat
