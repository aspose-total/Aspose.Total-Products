---
title: Convertir DOTX a EXCEL en C++
description: API de C++ para convertir DOTX a EXCEL sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a EXCEL" h2="Exporte DOTX a EXCEL a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
