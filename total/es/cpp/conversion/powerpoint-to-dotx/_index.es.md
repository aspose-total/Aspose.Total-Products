---
title: API de C++ para convertir POWERPOINT a DOTX
description: Exporte POWERPOINT a DOTX dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POWERPOINT a DOTX" h2="Exporte POWERPOINT a DOTX en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
