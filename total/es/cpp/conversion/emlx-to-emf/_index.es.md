---
title: Exportar EMLX a EMF a través de C++
description: API de C++ para convertir EMLX a EMF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/emlx-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMLX a EMF" h2="Transforme EMLX a EMF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMLX a EMF" %}}
