---
title: Convertir WORDML a DIF en C++
description: API de C++ para convertir WORDML a DIF sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a DIF" h2="Exporte WORDML a DIF a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir WORDML a DIF" %}}
