---
title: Exportar EML a BMP a través de C++
description: API de C++ para convertir EML a BMP sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/eml-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EML a BMP" h2="Transforme EML a BMP dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EML a BMP" %}}
...
4. Guarde el documento en formato BMP usando el método [Guardar](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) y configure Bmp como SaveFormat
