---
title: Convertir DOTM a CSV en C++
description: API de C++ para convertir DOTM a CSV sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTM a CSV" h2="Exporte DOTM a CSV a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOTM a CSV" %}}
