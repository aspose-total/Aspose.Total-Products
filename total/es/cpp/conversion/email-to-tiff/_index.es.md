---
title: Exportar EMAIL a TIFF a través de C++
description: API de C++ para convertir EMAIL a TIFF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a TIFF" h2="Transforme EMAIL a TIFF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a TIFF" %}}
