---
title: Exportar OFT a JPEG a través de C++
description: API de C++ para convertir OFT a JPEG sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-jpeg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a JPEG" h2="Transforme OFT a JPEG dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
