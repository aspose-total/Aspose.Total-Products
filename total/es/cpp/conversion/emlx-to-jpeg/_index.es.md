---
title: Exportar EMLX a JPEG a través de C++
description: API de C++ para convertir EMLX a JPEG sin usar Microsoft Word o Outlook
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMLX a JPEG" h2="Transforme EMLX a JPEG dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMLX a JPEG" %}}
...
2. Convierta EMLX a HTML usando la función miembro [Save](https://reference.aspose.com/emlx/cpp/class/aspose.emlx.mail_message#a7e7c6b50c8db5a8bcc6934db02b4a786)
