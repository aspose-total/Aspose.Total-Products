---
title: Convierta DOCM a PPSX a través de C++
description: Exporte DOCM a PPSX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/docm-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a PPSX" h2="Exporte DOCM a PPSX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
