---
title: Convertir XLS a PPTX con C++
description: Convierta XLS a PPTX dentro de aplicaciones C++
url: /es/cpp/conversion/xls-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Convierta XLS a PPTX a través de C++" h2="Exportar Excel<sup>&reg;</sup> XLS a PPTX dentro de aplicaciones C++ completamente funcionales" >}}
