---
title: Convertir DOCM a TSV en C++
description: API de C++ para convertir DOCM a TSV sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a TSV" h2="Exporte DOCM a TSV a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
