---
title: Exportar EMAIL a PCL a través de C++
description: API de C++ para convertir EMAIL a PCL sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a PCL" h2="Transforme EMAIL a PCL dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a PCL" %}}
