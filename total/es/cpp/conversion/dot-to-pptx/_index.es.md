---
title: Convierta DOT a PPTX a través de C++
description: Exporte DOT a PPTX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dot-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOT a PPTX" h2="Exporte DOT a PPTX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
