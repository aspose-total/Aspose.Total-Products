---
title: API de C++ para convertir PPTM a DOCX
description: Exporte PPTM a DOCX dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPTM a DOCX" h2="Exporte PPTM a DOCX en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
