---
title: Convierta OTT a PPS a través de C++
description: Exporte OTT a PPS en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/ott-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir OTT a PPS" h2="Exporte OTT a PPS dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
