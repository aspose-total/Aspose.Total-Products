---
title: Exportar EMAIL a EMF a través de C++
description: API de C++ para convertir EMAIL a EMF sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a EMF" h2="Transforme EMAIL a EMF dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a EMF" %}}
