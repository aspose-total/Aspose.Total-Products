---
title: Convertir FODS a WORD con C++
description: Convierta FODS a WORD dentro de aplicaciones C++
url: /es/cpp/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Convierta FODS a WORD a través de C++" h2="Exportar Excel<sup>&reg;</sup> FODS a WORD dentro de aplicaciones C++ completamente funcionales" >}}
