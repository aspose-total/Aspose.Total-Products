---
title: API de C++ para convertir PPTX a DOTX
description: Exporte PPTX a DOTX dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPTX a DOTX" h2="Exporte PPTX a DOTX en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
