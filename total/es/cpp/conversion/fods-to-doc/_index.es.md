---
title: Convertir FODS a DOC con C++
description: Convierta FODS a DOC dentro de aplicaciones C++
url: /es/cpp/conversion/fods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Convierta FODS a DOC a través de C++" h2="Exportar Excel<sup>&reg;</sup> FODS a DOC dentro de aplicaciones C++ completamente funcionales" >}}
