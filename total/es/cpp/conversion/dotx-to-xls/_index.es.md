---
title: Convertir DOTX a XLS en C++
description: API de C++ para convertir DOTX a XLS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a XLS" h2="Exporte DOTX a XLS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
