...
url: /es/cpp/conversion/pdf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PDF
...
Convertir PDF a XLSB en C++ a través de las bibliotecas de automatización de formato de archivo [Aspose.Total for C++](https://products.aspose.com/total/cpp/) es un proceso simple de dos pasos. En el primer paso, puede exportar PDF a XLSX usando [Aspose.PDF para C++](https://products.aspose.com/pdf/cpp/), luego, usando [Aspose.Cells para C++]( https://products.aspose.com/cells/cpp/) API de programación de hojas de cálculo, puede convertir XLSX a XLSB. 
{{% /blocks/products/pf/feature-page-summary  %}}
