---
title: Convertir DOCM a FODS en C++
description: API de C++ para convertir DOCM a FODS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a FODS" h2="Exporte DOCM a FODS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOCM a FODS" %}}
