---
title: Convertir DOTM a XLSX en C++
description: API de C++ para convertir DOTM a XLSX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTM a XLSX" h2="Exporte DOTM a XLSX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
