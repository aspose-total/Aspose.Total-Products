---
title: Convertir DOCM a XLTX en C++
description: API de C++ para convertir DOCM a XLTX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLTX" h2="Exporte DOCM a XLTX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
