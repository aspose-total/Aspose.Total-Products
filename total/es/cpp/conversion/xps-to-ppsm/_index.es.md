---
title: API de C++ para convertir XPS a PPSM
description: Convierta XPS a PPSM a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
url: /es/cpp/conversion/xps-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="Renderizar XPS a PPSM dentro de aplicaciones C++" h2="Convierta XPS a PPSM dentro de sus aplicaciones C++ sin usar Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para exportar XPS a PPSM" %}}
...
Después de convertir XPS a PPSM, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo PPSM
{{% blocks/products/pf/feature-page-code %}}
