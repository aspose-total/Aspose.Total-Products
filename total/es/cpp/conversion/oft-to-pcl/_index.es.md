---
title: Exportar OFT a PCL a través de C++
description: API de C++ para convertir OFT a PCL sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a PCL" h2="Transforme OFT a PCL dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a PCL" %}}
