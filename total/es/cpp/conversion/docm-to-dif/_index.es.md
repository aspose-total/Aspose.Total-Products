---
title: Convertir DOCM a DIF en C++
description: API de C++ para convertir DOCM a DIF sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a DIF" h2="Exporte DOCM a DIF a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
