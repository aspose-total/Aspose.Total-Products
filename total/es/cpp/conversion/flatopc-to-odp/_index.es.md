---
title: Convierta FLATOPC a ODP a través de C++
description: Exporte FLATOPC a ODP en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/flatopc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir FLATOPC a ODP" h2="Exporte FLATOPC a ODP dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
