---
title: Exportar EMAIL a DOC a través de C++
description: API de C++ para convertir EMAIL a DOC sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a DOC" h2="Transforme EMAIL a DOC dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a DOC" %}}
