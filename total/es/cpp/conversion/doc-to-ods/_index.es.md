---
title: Convertir DOC a ODS en C++
description: API de C++ para convertir DOC a ODS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/doc-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOC a ODS" h2="Exporte DOC a ODS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOC a ODS" %}}
