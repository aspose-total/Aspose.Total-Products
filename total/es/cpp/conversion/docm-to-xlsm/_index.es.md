---
title: Convertir DOCM a XLSM en C++
description: API de C++ para convertir DOCM a XLSM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLSM" h2="Exporte DOCM a XLSM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
