---
title: API de C++ para convertir POTM a OTT
description: Exporte POTM a OTT dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTM a OTT" h2="Exporte POTM a OTT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
