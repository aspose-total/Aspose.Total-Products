---
title: Convierta WORDML a PPT a través de C++
description: Exporte WORDML a PPT en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/wordml-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a PPT" h2="Exporte WORDML a PPT dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
