---
title: Convierta DOCX a POTX a través de C++
description: Exporte DOCX a POTX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/docx-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCX a POTX" h2="Exporte DOCX a POTX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
