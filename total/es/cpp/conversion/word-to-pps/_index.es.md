---
title: Convierta WORD a PPS a través de C++
description: Exporte WORD a PPS en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/word-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORD a PPS" h2="Exporte WORD a PPS dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
