---
title: Convierta OTT a ODP a través de C++
description: Exporte OTT a ODP en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/ott-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir OTT a ODP" h2="Exporte OTT a ODP dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
