---
title: Convertir WORDML a XLS en C++
description: API de C++ para convertir WORDML a XLS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORDML a XLS" h2="Exporte WORDML a XLS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
