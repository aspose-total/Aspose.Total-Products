---
title: Exportar EMAIL a DOTM a través de C++
description: API de C++ para convertir EMAIL a DOTM sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a DOTM" h2="Transforme EMAIL a DOTM dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a DOTM" %}}
