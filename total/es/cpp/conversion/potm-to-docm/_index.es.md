---
title: API de C++ para convertir POTM a DOCM
description: Exporte POTM a DOCM dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTM a DOCM" h2="Exporte POTM a DOCM en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
