---
title: Convertir SXC a DOC con C++
description: Convierta SXC a DOC dentro de aplicaciones C++
url: /es/cpp/conversion/sxc-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Convierta SXC a DOC a través de C++" h2="Exportar Excel<sup>&reg;</sup> SXC a DOC dentro de aplicaciones C++ completamente funcionales" >}}
