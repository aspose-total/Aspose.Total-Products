---
title: API de C++ para convertir PPS a WORDML
description: Exporte PPS a WORDML dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPS a WORDML" h2="Exporte PPS a WORDML en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
