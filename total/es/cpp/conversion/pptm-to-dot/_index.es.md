...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPTM a DOT o en línea" h2="Exporte PPTM a DOT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
