---
title: Convertir DOCX a XLAM en C++
description: API de C++ para convertir DOCX a XLAM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCX a XLAM" h2="Exporte DOCX a XLAM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docxumento en formato XLAM usando la función miembro [Guardar](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e)
