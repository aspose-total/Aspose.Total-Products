---
title: Convertir DOTX a DIF en C++
description: API de C++ para convertir DOTX a DIF sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a DIF" h2="Exporte DOTX a DIF a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
