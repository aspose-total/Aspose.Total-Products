---
title: API de C++ para convertir SVG a SWF
description: Convierta SVG a SWF a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
url: /es/cpp/conversion/svg-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: SVG
...
{{< blocks/products/pf/feature-page-header h1="Renderizar SVG a SWF dentro de aplicaciones C++" h2="Convierta SVG a SWF dentro de sus aplicaciones C++ sin usar Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para exportar SVG a SWF" %}}
...
Después de convertir SVG a SWF, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo SWF
{{% blocks/products/pf/feature-page-code %}}
