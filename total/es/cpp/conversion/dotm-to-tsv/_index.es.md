---
title: Convertir DOTM a TSV en C++
description: API de C++ para convertir DOTM a TSV sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTM a TSV" h2="Exporte DOTM a TSV a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOTM a TSV" %}}
