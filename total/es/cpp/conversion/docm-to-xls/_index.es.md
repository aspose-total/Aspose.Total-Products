---
title: Convertir DOCM a XLS en C++
description: API de C++ para convertir DOCM a XLS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/docm-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOCM a XLS" h2="Exporte DOCM a XLS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOCM a XLS" %}}
