---
title: Convertir DOC a XLTX en C++
description: API de C++ para convertir DOC a XLTX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/doc-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOC a XLTX" h2="Exporte DOC a XLTX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOC a XLTX" %}}
