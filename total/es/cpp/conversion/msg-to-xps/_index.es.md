---
title: Exportar MSG a XPS a través de C++
description: API de C++ para convertir MSG a XPS sin usar Microsoft Word o Outlook
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar MSG a XPS" h2="Transforme MSG a XPS dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir MSG a XPS" %}}
