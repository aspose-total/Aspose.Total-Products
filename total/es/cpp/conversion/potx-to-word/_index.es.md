...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTX a WORD o en línea" h2="Exporte POTX a WORD en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
