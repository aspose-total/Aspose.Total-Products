---
title: API de C++ para convertir POTX a WORD
description: Exporte POTX a WORD dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTX a WORD" h2="Exporte POTX a WORD en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
