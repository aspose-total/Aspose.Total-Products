...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTX a WORDML o en línea" h2="Exporte POTX a WORDML en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
