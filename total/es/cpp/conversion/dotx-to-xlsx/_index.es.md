---
title: Convertir DOTX a XLSX en C++
description: API de C++ para convertir DOTX a XLSX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a XLSX" h2="Exporte DOTX a XLSX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
