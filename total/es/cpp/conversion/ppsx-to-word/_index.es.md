---
title: API de C++ para convertir PPSX a WORD
description: Exporte PPSX a WORD dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSX a WORD" h2="Exporte PPSX a WORD en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
