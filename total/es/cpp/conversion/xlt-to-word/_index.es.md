---
title: Convertir XLT a WORD con C++
description: Convierta XLT a WORD dentro de aplicaciones C++
url: /es/cpp/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Convierta XLT a WORD a través de C++" h2="Exportar Excel<sup>&reg;</sup> XLT a WORD dentro de aplicaciones C++ completamente funcionales" >}}
