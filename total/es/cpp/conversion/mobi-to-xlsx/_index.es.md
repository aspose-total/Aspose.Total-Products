---
title: Convertir MOBI a XLSX en C++
description: API de C++ para convertir MOBI a XLSX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/mobi-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir MOBI a XLSX" h2="Exporte MOBI a XLSX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
