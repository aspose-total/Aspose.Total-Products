---
title: Convertir XLS a DOC con C++
description: Convierta XLS a DOC dentro de aplicaciones C++
url: /es/cpp/conversion/xls-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Convierta XLS a DOC a través de C++" h2="Exportar Excel<sup>&reg;</sup> XLS a DOC dentro de aplicaciones C++ completamente funcionales" >}}
