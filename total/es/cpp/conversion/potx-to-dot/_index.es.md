---
title: API de C++ para convertir POTX a DOT
description: Exporte POTX a DOT dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar POTX a DOT" h2="Exporte POTX a DOT en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
