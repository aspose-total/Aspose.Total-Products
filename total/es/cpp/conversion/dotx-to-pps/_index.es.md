---
title: Convierta DOTX a PPS a través de C++
description: Exporte DOTX a PPS en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotx-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a PPS" h2="Exporte DOTX a PPS dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
