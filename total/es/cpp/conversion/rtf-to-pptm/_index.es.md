---
title: Convierta RTF a PPTM a través de C++ o con el convertidor en línea gratuito
description: Exporte RTF a PPTM en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint o en línea. Pruebe el convertidor en línea gratuito de RTF a PPTM rápidamente antes de integrar el código.
...
6. Guarde el rtfumento en formato PPTM usando el método [Guardar](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) y configure Pptm como SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="Agregar comentarios en el rtfumento PPTM a través de C++" %}}
Mientras guarda RTF como PPTM, también puede usar [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) para agregar más funciones en su rtfumento PPTM. Por ejemplo, puede agregar comentarios en su presentación. El comentario de la diapositiva de la presentación está asociado con un autor en particular. La clase Presentation contiene la colección de autores en ICommentAuthorCollection que son responsables de agregar comentarios de diapositivas. Para cada autor, hay una colección de comentarios en ICommentCollection.
{{% blocks/products/pf/feature-page-code %}}
