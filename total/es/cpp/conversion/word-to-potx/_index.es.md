---
title: Convierta WORD a POTX a través de C++
description: Exporte WORD a POTX en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/word-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir WORD a POTX" h2="Exporte WORD a POTX dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
