---
title: Convertir DOC a XLSX en C++
description: API de C++ para convertir DOC a XLSX sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOC a XLSX" h2="Exporte DOC a XLSX a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
