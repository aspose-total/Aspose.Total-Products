---
title: Convertir DOTX a FODS en C++
description: API de C++ para convertir DOTX a FODS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a FODS" h2="Exporte DOTX a FODS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
