---
title: API de C++ para convertir SVG a PPSM
description: Convierta SVG a PPSM a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
url: /es/cpp/conversion/svg-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: SVG
...
Después de convertir SVG a PPSM, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo PPSM
{{% blocks/products/pf/feature-page-code %}}
