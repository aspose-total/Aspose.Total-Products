---
title: API de C++ para convertir PCL a XAML
description: Convierta PCL a XAML a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
...
{{< blocks/products/pf/feature-page-header h1="Renderizar PCL a XAML dentro de aplicaciones C++" h2="Convierta PCL a XAML dentro de sus aplicaciones C++ sin usar Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para exportar PCL a XAML" %}}
...
4. Guarde el documento en formato XAML usando la función miembro [Save](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) y configure `Xaml` como SaveFormat
...
Después de convertir PCL a XAML, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo XAML
{{% blocks/products/pf/feature-page-code %}}
