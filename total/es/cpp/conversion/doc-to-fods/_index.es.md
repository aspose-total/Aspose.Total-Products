---
title: Convertir DOC a FODS en C++
description: API de C++ para convertir DOC a FODS sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/doc-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOC a FODS" h2="Exporte DOC a FODS a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOC a FODS" %}}
