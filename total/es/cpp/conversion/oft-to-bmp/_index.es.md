---
title: Exportar OFT a BMP a través de C++
description: API de C++ para convertir OFT a BMP sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/oft-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar OFT a BMP" h2="Transforme OFT a BMP dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir OFT a BMP" %}}
