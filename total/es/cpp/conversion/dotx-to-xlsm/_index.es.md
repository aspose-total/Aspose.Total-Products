---
title: Convertir DOTX a XLSM en C++
description: API de C++ para convertir DOTX a XLSM sin usar Microsoft Word o Microsoft Excel
url: /es/cpp/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTX a XLSM" h2="Exporte DOTX a XLSM a través de C++ sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
