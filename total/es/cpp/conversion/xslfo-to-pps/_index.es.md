---
title: API de C++ para convertir XSLFO a PPS
description: Convierta XSLFO a PPS a través de C++ sin usar Microsoft Word o Adobe Acrobat Reader
...
2. Convierta XSLFO a PPTX usando la función de método [Save](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.document#a0184df207563187be7df37b8dbe443f6)
...
Después de convertir XSLFO a PPS, también puede agregar imágenes de la web a su documento de salida. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) admite operaciones con imágenes en estos formatos populares: JPEG, PNG, BMP, GIF y otros. Puede agregar una o varias imágenes en su computadora a una diapositiva en una presentación. Este código de muestra en C++ le muestra cómo agregar una imagen a un archivo PPS
{{% blocks/products/pf/feature-page-code %}}
