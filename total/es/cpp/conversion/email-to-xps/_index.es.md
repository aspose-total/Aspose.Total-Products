---
title: Exportar EMAIL a XPS a través de C++
description: API de C++ para convertir EMAIL a XPS sin usar Microsoft Word o Outlook
url: /es/cpp/conversion/email-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para exportar EMAIL a XPS" h2="Transforme EMAIL a XPS dentro de la aplicación C++ sin necesidad de Microsoft Word o Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir EMAIL a XPS" %}}
