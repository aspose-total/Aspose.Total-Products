...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSX a DOTX o en línea" h2="Exporte PPSX a DOTX en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
