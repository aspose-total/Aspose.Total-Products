---
title: API de C++ para convertir PPSX a DOTX
description: Exporte PPSX a DOTX dentro de sus aplicaciones C++
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para renderizar PPSX a DOTX" h2="Exporte PPSX a DOTX en aplicaciones C++ sin dependencias de Microsoft PowerPoint o Word" >}}
