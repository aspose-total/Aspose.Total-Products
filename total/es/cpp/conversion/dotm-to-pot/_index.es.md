---
title: Convierta DOTM a POT a través de C++
description: Exporte DOTM a POT en sus aplicaciones C++ sin usar Microsoft Word o PowerPoint
url: /es/cpp/conversion/dotm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="API de C++ para convertir DOTM a POT" h2="Exporte DOTM a POT dentro de sus aplicaciones C++ sin usar Microsoft Word&reg; o PowerPoint" >}}
