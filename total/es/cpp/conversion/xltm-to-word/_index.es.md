---
title: Convertir XLTM a WORD con C++
description: Convierta XLTM a WORD dentro de aplicaciones C++
url: /es/cpp/conversion/xltm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Convierta XLTM a WORD a través de C++" h2="Exportar Excel<sup>&reg;</sup> XLTM a WORD dentro de aplicaciones C++ completamente funcionales" >}}
