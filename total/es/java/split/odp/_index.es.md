---
title: Divida archivos ODP en línea o mediante Java
description: Aplicación online gratuita para dividir diferentes archivos ODP. Código de biblioteca Java Splitter para documentos ODP.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo ODP a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Java para dividir archivos ODP" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código.Se puede desarrollar fácilmente una solución profesional para dividir archivos ODP utilizando Java.Utilice Aspose ODP Splitter API para desarrollar software independiente de plataforma de alto nivel en Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
