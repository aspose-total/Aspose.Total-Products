---
title: Divida el archivo Word en línea o mediante Java
description: Aplicación online gratuita para dividir diferentes archivos Word.Código de biblioteca divisora de Java para documentos Word.
...
{{% blocks/products/pf/agp/feature-section-col title="Dividir archivo Word a través de Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Java para dividir archivos Word según la página" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Código Java para dividir archivos Word por secciones" offSpacer="" %}}
...
<h2>Desarrollar una aplicación divisora de archivos Word usando Java</h2>

¿Necesita desarrollar un script Java o una aplicación de utilidad para dividir fácilmente archivos Word?Con [Aspose.Words for Java](https://products.aspose.com/words/es/java/), API secundaria de [Aspose.Total for Java](https://products.aspose.com/total/es/java/), cualquier desarrollador de Java puede integrar el código API anterior para programar la aplicación divisora.La potente biblioteca Java para dividir documentos admite muchos formatos populares, incluido el formato Word, como archivos PDF, Word, Excel y PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteca divisora Word para Java" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sí, puedes descargar este código. Se puede desarrollar fácilmente una solución profesional para dividir archivos Word utilizando Java. Utilice la API divisora Aspose Word para desarrollar software independiente de plataforma de alto nivel en Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
