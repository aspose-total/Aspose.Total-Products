---
title: API de Java para convertir DOCM a XLSB
description: Convierta DOCM a XLSB a través de Java sin usar Microsoft Word o Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOCM a XLSB a través de Java" h2="API de Java local para convertir DOCM a XLSB sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir DOCM a XLSB" %}}
...
4. Guarde el document en formato XLSB mediante [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
