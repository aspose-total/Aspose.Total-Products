---
title: API de Java para convertir MOBI a XLTX o con el convertidor en línea gratuito
description: Convierta MOBI a XLTX a través de Java o aplicación en línea sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de MOBI a XLTX rápidamente antes de integrar el código. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta MOBI a XLTX a través de Java o aplicación en línea" h2="API de Java local para convertir MOBI a XLTX sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de Java para convertir MOBI a XLTX" %}}
...
4. Guarde el mobiumento en formato XLTX mediante [save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
