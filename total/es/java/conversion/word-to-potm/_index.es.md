---
title: Convierta WORD a POTM a través de Java
description: API de Java para exportar WORD a POTM sin usar Microsoft Word o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta WORD a POTM a través de Java" h2="Conversión de WORD a POTM mediante el uso de la API Java local dentro de cualquier aplicación Java J2SE, J2EE, J2ME sin utilizar Microsoft<sup>&reg;</sup> PowerPoint o Word" >}}
...
6. Guarde el documento en POTM usando el método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}
Para la conversión de archivos WORD a POTM, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e incluya bibliotecas en su pom.xml.
