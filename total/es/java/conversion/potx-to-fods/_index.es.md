...
description: Convierta POTX a formato FODS a través de Java sin usar Microsoft Excel o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta POTX a FODS a través de Java" h2="API de Java local para exportar POTX a FODS sin usar Microsoft<sup>&reg;</sup> Excel o PowerPoint" >}}
...
Para convertir POTX a FODS, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e incluya bibliotecas en su pom.xml.
