...
description: Convierta OTT a XLTM a través de Java sin usar Microsoft Word o Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta OTT a XLTM a través de Java" h2="API de Java local para convertir OTT a XLTM sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el documento en formato XLTM mediante [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
