...
{{< blocks/products/pf/i18n/feature-page-header h1="API de Java para exportar CSV a PPTM o en línea" h2="API de Java local para exportar CSV a PPTM sin depender de Microsoft Excel&reg;" >}}
...
4. Guarde el documento en formato PPTM usando [guardar](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-) método y establecer Pptx como SaveFormat
