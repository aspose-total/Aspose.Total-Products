---
title: API de Java para convertir ODT a XLAM
description: Convierta ODT a XLAM a través de Java sin usar Microsoft Word o Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta ODT a XLAM a través de Java" h2="API de Java local para convertir ODT a XLAM sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir ODT a XLAM" %}}
1. Abra el archivo ODT usando la clase [Odtumento](https://apireference.aspose.com/words/java/com.aspose.words/Odtument)
2. Convierta ODT a HTML usando [save](https://apireference.aspose.com/words/java/com.aspose.words/Odtument#save(java.lang.String,com.aspose.words.SaveOptions)) método
...
4. Guarde el odtumento en formato XLAM mediante [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}
Puede usar fácilmente Aspose.Total para Java directamente desde un proyecto basado en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e incluya [Aspose.Words for Java](https://odts.aspose.com/words/java/installation/) y [Aspose.Cells for Java](https://odts.aspose.com/cells/java/installation/) en su pom.xml.
