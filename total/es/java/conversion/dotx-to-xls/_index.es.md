...
description: Convierta DOTX a XLS a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOTX a XLS a través de Java" h2="API de Java local para convertir DOTX a XLS sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el dotxumento en formato XLS mediante [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
