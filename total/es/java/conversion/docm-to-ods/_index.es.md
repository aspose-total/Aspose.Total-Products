---
title: API de Java para convertir DOCM a ODS o con el convertidor en línea gratuito
description: Convierta DOCM a ODS a través de Java o aplicación en línea sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de DOCM a ODS rápidamente antes de integrar el código. 
url_ignore: /es/java/conversion/docm-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta DOCM a ODS a través de Java o aplicación en línea" h2="API de Java local para convertir DOCM a ODS sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de Java para convertir DOCM a ODS" %}}
...
4. Guarde el document en formato ODS mediante [save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
