...
description: Convierta DOCX a XLSX a través de Java o aplicación en línea sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de POT a CSV rápidamente antes de integrar el código. 
...
Puede usar fácilmente Aspose.Total para Java directamente desde un proyecto basado en [Maven](https://releases.aspose.com/total/java/) e incluya [Aspose.Words for Java](https://docxs.aspose.com/words/java/installation/) y [Aspose.Cells for Java](https://docxs.aspose.com/cells/java/installation/) en su pom.xml.
