...
description: Convierta RTF a XLSX a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/rtf-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta RTF a XLSX a través de Java" h2="API de Java local para convertir RTF a XLSX sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el rtfumento en formato XLSX mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
