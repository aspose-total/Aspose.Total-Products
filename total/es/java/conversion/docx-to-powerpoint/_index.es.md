...
url: /es/java/conversion/docx-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
La API también le permite convertir docxumentos DOCX protegidos con contraseña a POWERPOINT. Si su docxumento DOCX de entrada está protegido con contraseña, no puede convertirlo al formato POWERPOINT sin usar la contraseña. Para abrir un docxumento cifrado, puede establecer la contraseña correcta en el objeto LoadOptions y pasarla al constructor del docxumento.  
{{% blocks/products/pf/feature-page-code %}}
