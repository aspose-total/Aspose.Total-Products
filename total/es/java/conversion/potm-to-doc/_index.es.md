---
title: Convierta POTM a DOC a través de Java
description: API de Java para exportar POTM a DOC sin usar Microsoft Word o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta POTM a DOC a través de Java" h2="API de Java en las instalaciones para la conversión de PowerPoint POTM a DOC dentro de cualquier aplicación Java J2SE, J2EE, J2ME" >}}
...
Para la conversión de archivos POTM a DOC, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e incluya bibliotecas en su pom.xml.
...
Usando la API, también puede realizar una conversión de archivo POTM a DOC con marca de agua. Para agregar una marca de agua a su documento DOC, primero puede convertir el archivo POTM a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
