...
description: Convierta RTF a XLS a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/rtf-to-xls/
family: total
platformtag: net
feature: conversion
informat: RTF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta RTF a XLS a través de Java" h2="API de Java local para convertir RTF a XLS sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el rtfumento en formato XLS mediante [Guardar](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. GuardarOpciones)) método
