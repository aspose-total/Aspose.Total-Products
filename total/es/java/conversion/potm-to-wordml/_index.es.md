---
title: Convierta POTM a WORDML a través de Java
description: API de Java para exportar POTM a WORDML sin usar Microsoft Word o PowerPoint
url: /es/java/conversion/potm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
Para la conversión de archivos POTM a WORDML, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e incluya bibliotecas en su pom.xml.
...
Usando la API, también puede realizar una conversión de archivo POTM a WORDML con marca de agua. Para agregar una marca de agua a su wordmlumento WORDML, primero puede convertir el archivo POTM a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Wordmlument](https://apireference.aspose.com/words/java/com.aspose.words/Wordmlument), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/potm-to-wordmlm/" name="POTM Para WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/potm-to-wordmlx/" name="POTM Para WORDMLX" description="" >}}
