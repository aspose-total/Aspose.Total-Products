...
<iframe title="Herramienta de conversión de xlsx a dotx" style="border: none; height: 426px;" scrolling="no" src="https://widgets.aspose.cloud/total-conversion/?to=xlsx&from=dotx" id="child-iframe" width="80%"></iframe>
