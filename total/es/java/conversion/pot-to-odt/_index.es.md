---
title: Convierta POT a ODT a través de Java
description: API de Java para exportar POT a ODT sin usar Microsoft Word o PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta POT a ODT a través de Java" h2="API de Java en las instalaciones para la conversión de PowerPoint POT a ODT dentro de cualquier aplicación Java J2SE, J2EE, J2ME" >}}
...
Para la conversión de archivos POT a ODT, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e incluya bibliotecas en su pom.xml.
...
Usando la API, también puede realizar una conversión de archivo POT a ODT con marca de agua. Para agregar una marca de agua a su documento ODT, primero puede convertir el archivo POT a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/pot-to-odtm/" name="POT Para ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/pot-to-odtx/" name="POT Para ODTX" description="" >}}
