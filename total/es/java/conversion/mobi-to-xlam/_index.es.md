---
title: API de Java para convertir MOBI a XLAM
description: Convierta MOBI a XLAM a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/java/conversion/mobi-to-xlam/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta MOBI a XLAM a través de Java" h2="API de Java local para convertir MOBI a XLAM sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de C++ para convertir MOBI a XLAM" %}}
1. Abra el archivo MOBI usando la clase [Mobiumento](https://apireference.aspose.com/words/java/com.aspose.words/Mobiument)
2. Convierta MOBI a HTML usando [save](https://apireference.aspose.com/words/java/com.aspose.words/Mobiument#save(java.lang.String,com.aspose.words.SaveOptions)) método
...
4. Guarde el mobiumento en formato XLAM mediante [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}
Puede usar fácilmente Aspose.Total para Java directamente desde un proyecto basado en [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e incluya [Aspose.Words for Java](https://mobis.aspose.com/words/java/installation/) y [Aspose.Cells for Java](https://mobis.aspose.com/cells/java/installation/) en su pom.xml.
