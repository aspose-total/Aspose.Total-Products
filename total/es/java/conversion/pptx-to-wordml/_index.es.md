---
title: Convierta PPTX a WORDML a través de Java
description: API de Java para exportar PPTX a WORDML sin usar Microsoft Word o PowerPoint
url: /es/java/conversion/pptx-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
Para la conversión de archivos PPTX a WORDML, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e incluya bibliotecas en su pom.xml.
...
Usando la API, también puede realizar una conversión de archivo PPTX a WORDML con marca de agua. Para agregar una marca de agua a su wordmlumento WORDML, primero puede convertir el archivo PPTX a HTML y agregarle una marca de agua. Para agregar una marca de agua, cargue el archivo HTML recién creado usando la clase [Wordmlument](https://apireference.aspose.com/words/java/com.aspose.words/Wordmlument), cree una instancia de TextWatermarkOptions y configure sus propiedades, llame al método Watermark.setText y pase el texto y el objeto de la marca de agua de TextWatermarkOptions.  
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/pptx-to-wordmlm/" name="PPTX Para WORDMLM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/es/net/conversion/pptx-to-wordmlx/" name="PPTX Para WORDMLX" description="" >}}
