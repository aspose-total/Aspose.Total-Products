---
title: Convierta WORD a PPTM a través de Java
description: API de Java para exportar WORD a PPTM sin usar Microsoft Word o PowerPoint
url: /es/java/conversion/word-to-pptm/
family: total
platformtag: net
feature: conversion
informat: WORDX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Convierta WORD a PPTM a través de Java" h2="Conversión de WORD a PPTM mediante el uso de la API Java local dentro de cualquier aplicación Java J2SE, J2EE, J2ME sin utilizar Microsoft<sup>&reg;</sup> PowerPoint o Word" >}}
...
6. Guarde el wordumento en PPTM usando el método [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}
Para la conversión de archivos WORD a PPTM, puede usar fácilmente Aspose.Total para Java directamente desde un [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) e incluya bibliotecas en su pom.xml.
...
La API también le permite convertir wordumentos WORD protegidos con contraseña a PPTM. Si su wordumento WORD de entrada está protegido con contraseña, no puede convertirlo al formato PPTM sin usar la contraseña. Para abrir un wordumento cifrado, puede establecer la contraseña correcta en el objeto LoadOptions y pasarla al constructor del wordumento.  
{{% blocks/products/pf/feature-page-code %}}
