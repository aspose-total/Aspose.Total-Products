---
title: Elimine la anotación DOTM en línea o administre anotaciones mediante aplicaciones móviles de Android
description: elimine comentarios del archivo DOTM a través de la aplicación en línea de forma gratuita.Código API de Android para gestionar comentarios de archivos DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Borrar comentarios del documento DOTM en línea o administrar a través de aplicaciones de Android" h2="Desarrolle una potente aplicación de utilidad de anotación de documentos DOTM basada en Android.Código listado para gestionar comentarios del archivo DOTM." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos DOTM a través de la aplicación de Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código: Eliminar comentarios del archivo DOTM" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Código: Eliminar y agregar respuesta de comentario del archivo DOTM" offSpacer="" %}}
