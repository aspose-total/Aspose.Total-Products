---
title: API de Android para convertir DOTX a XLTX o con el convertidor en línea gratuito
description: Convierta DOTX a XLTX en Android a través de Java sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de DOTX a XLTX rápidamente antes de integrar el código.
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOTX a XLTX en aplicaciones de Android o aplicación en línea" h2="Exporte DOTX a XLTX en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
<h3>Convertidor en línea gratuito para DOTX a XLTX</h3>

<iframe title="Herramienta de conversión de xltx a dotx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=xltx&from=dotx" id="child-iframe" width="80%"></iframe>
