---
title: API de Android para convertir DOCX a XLSM
description: Convierta DOCX a XLSM en Android a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/android-java/conversion/docx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOCX a XLSM en aplicaciones de Android" h2="Exporte DOCX a XLSM en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docxumento en formato XLSM mediante [Guardar](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
