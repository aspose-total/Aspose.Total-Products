---
title: Convierta DOCM a POTM en Android a través de Java
description: Conversión de DOCM a POTM en sus teléfonos Android sin usar Microsoft Word o PowerPoint
url: /es/android-java/conversion/docm-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOCM a POTM en aplicaciones de Android" h2="Conversión de DOCM a POTM en sus aplicaciones de Android sin instalar Microsoft Word<sup>&reg;</sup> o PowerPoint" >}}
...
Para la conversión de archivos DOCM a POTM, puede usar fácilmente Aspose.Total para Android a través de Java directamente desde [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas en su aplicación.
