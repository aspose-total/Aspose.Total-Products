---
title: API de Android para convertir WORD a ODS o con el convertidor en línea gratuito
description: Convierta WORD a ODS en Android a través de Java sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de WORD a ODS rápidamente antes de integrar el código.
...
{{< blocks/products/pf/feature-page-header h1="Convierta WORD a ODS en aplicaciones de Android o aplicación en línea" h2="Exporte WORD a ODS en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el wordumento en formato ODS mediante [Save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
