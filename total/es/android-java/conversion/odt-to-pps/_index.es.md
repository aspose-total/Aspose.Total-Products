---
title: Convierta ODT a PPS en Android a través de Java
description: Conversión de ODT a PPS en sus teléfonos Android sin usar Microsoft Word o PowerPoint
url: /es/android-java/conversion/odt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Convierta ODT a PPS en aplicaciones de Android" h2="Conversión de ODT a PPS en sus aplicaciones de Android sin instalar Microsoft Word<sup>&reg;</sup> o PowerPoint" >}}
...
Para la conversión de archivos ODT a PPS, puede usar fácilmente Aspose.Total para Android a través de Java directamente desde [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas en su aplicación.
