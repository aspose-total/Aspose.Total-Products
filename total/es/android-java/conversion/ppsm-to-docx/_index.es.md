...
url: /es/android-java/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
Puede convertir su docxumento dado en dos pasos. Puede usar [Aspose.Slides for Andorid via Java](https://products.aspose.com/slides/android-java/) que es una API de PowerPoint para aplicaciones de Android para convertir PPSM en HTML. Después de eso, al usar la API de procesamiento de docxumentos [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/), puede convertir el HTML a DOCX. 
{{% /blocks/products/pf/feature-page-summary  %}}
