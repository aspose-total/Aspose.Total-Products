---
title: API de Android para convertir DOTX a XLSX
description: Convierta DOTX a XLSX en Android a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/android-java/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOTX a XLSX en aplicaciones de Android" h2="Exporte DOTX a XLSX en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
