---
title: Convierta ODT a PPTX en Android a través de Java
description: Conversión de ODT a PPTX en sus teléfonos Android sin usar Microsoft Word o PowerPoint
url: /es/android-java/conversion/odt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Convierta ODT a PPTX en aplicaciones de Android" h2="Conversión de ODT a PPTX en sus aplicaciones de Android sin instalar Microsoft Word<sup>&reg;</sup> o PowerPoint" >}}
...
Para la conversión de archivos ODT a PPTX, puede usar fácilmente Aspose.Total for Android via Java directamente desde [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas en su aplicación.
