---
title: API de Android para convertir WORD a XLTX o con el convertidor en línea gratuito
description: Convierta WORD a XLTX en Android a través de Java sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de WORD a XLTX rápidamente antes de integrar el código.
...
4. Guarde el wordumento en formato XLTX mediante [Save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
...
<iframe title="Herramienta de conversión de xltx a docx" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xltx&from=docx" id="child-iframe" width="80%"></iframe>
