---
title: Exportar CGM a SWF en Android
description: API de Android para convertir CGM a SWF sin usar Microsoft Word
url: /es/android-java/conversion/cgm-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: CGM
...
{{< blocks/products/pf/feature-page-header h1="Convierta CGM a SWF en Android a través de Java" h2="Transforme CGM a SWF dentro de sus aplicaciones de Android sin usar Microsoft<sup>&reg;</sup> PowerPoint o Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="API de Android para exportar CGM a SWF" %}}
