...
url: /es/android-java/conversion/pps-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
Para convertir PPS a XLSX, puede usar fácilmente Aspose.Total para Android a través de Java directamente desde [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) e instale bibliotecas en su aplicación.
