---
title: API de Android para convertir DOTX a XLSM
description: Convierta DOTX a XLSM en Android a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/android-java/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOTX a XLSM en aplicaciones de Android" h2="Exporte DOTX a XLSM en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
