---
title: Exportar XLSX a PPTX en Android
description: API de Android para convertir XLSX a PPTX sin usar Microsoft Word
url: /es/android-java/conversion/xlsx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Renderizar XLSX a PPTX en Android a través de Java" h2="Transforme XLSX a PPTX dentro de sus aplicaciones de Android sin usar Microsoft<sup>&reg;</sup> Excel" >}}
