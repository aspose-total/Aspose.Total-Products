---
title: API de Android para convertir DOTX a DIF
description: Convierta DOTX a DIF en Android a través de Java sin usar Microsoft Word o Microsoft Excel
url: /es/android-java/conversion/dotx-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOTX a DIF en aplicaciones de Android" h2="Exporte DOTX a DIF en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
