---
title: API de Android para convertir DOCM a EXCEL o con el convertidor en línea gratuito
description: Convierta DOCM a EXCEL en Android a través de Java sin usar Microsoft Word o Microsoft Excel o en línea. Pruebe el convertidor en línea gratuito de DOCM a EXCEL rápidamente antes de integrar el código.
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOCM a EXCEL en aplicaciones de Android o aplicación en línea" h2="Exporte DOCM a EXCEL en Android a través de Java sin usar Microsoft<sup>&reg;</sup> Word o Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Guarde el docmumento en formato EXCEL mediante [Save](https://reference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells.GuardarOpciones)) método
