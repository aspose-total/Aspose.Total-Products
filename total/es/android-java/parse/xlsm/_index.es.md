---
title: Extraiga texto e imágenes de un archivo XLSM en línea y utilizando aplicaciones móviles de Android
description: Aplicación de análisis de archivos XLSM en línea. Código API de Android para extraer texto en filas y celdas de hojas de cálculo XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizar archivos XLSM en línea y a través de aplicaciones de Android" h2="Desarrolle una potente aplicación de utilidad de análisis de documentos XLSM basada en Android. Código listado para el análisis de documentos XLSM." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizar documento XLSM en línea" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizar archivos XLSM a través de la aplicación de Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código: Analizar documento XLSM" offSpacer="" %}}
...
<h2>Desarrollar la aplicación de Android XLSM File Parser</h2>

¿Necesita desarrollar una aplicación o utilidad de análisis XLSM? Con [Aspose.Cells for Android via Java](https://products.aspose.com/cells/es/android-java/), una API secundaria de [Aspose.Total for Android via Java](https://products.aspose.com/total/es/android-java/), cualquier desarrollador de Android puede integrar el código API anterior dentro de su aplicación de análisis de documentos. La potente biblioteca de Android permite programar cualquier solución de análisis de documentos para extraer imágenes y texto. Además, puede admitir muchos formatos populares, incluido el formato XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad de Android para procesar archivos XLSM para la aplicación de análisis" %}}
