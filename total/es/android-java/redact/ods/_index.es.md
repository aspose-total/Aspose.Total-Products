---
title: Redactar hoja de cálculo ODS en línea o usando aplicaciones móviles de Android
description: Abra y redacte documentos ODS en línea a través de la aplicación de forma gratuita. Código API de Android para buscar y reemplazar texto ODS con expresión regular.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento ODS en línea o mediante aplicaciones de Android" h2="Desarrolle una potente aplicación de utilidad de redacción de documentos ODS basada en Android. Código enumerado para buscar y reemplazar texto en un archivo ODS usando expresiones regulares." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo ODS a través de la aplicación de Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Código: Redactar hoja de cálculo ODS" offSpacer="" %}}
...
<h2>Desarrollar una aplicación para Android de redacción ODS</h2>

¿Necesita desarrollar una aplicación o utilidad de redacción ODS? Con [Aspose.Cells for Android via Java](https://products.aspose.com/cells/es/android-java/), una API secundaria de [Aspose.Total for Android via Java](https://products.aspose.com/total/es/android-java/), cualquier desarrollador de Android puede integrar el código API anterior dentro de su aplicación de redacción de documentos. La potente biblioteca de Android permite programar cualquier solución de redacción de hojas de cálculo. Además, puede admitir muchos formatos populares, incluido el formato ODS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Utilidad de Android para redactar archivos ODS" %}}
