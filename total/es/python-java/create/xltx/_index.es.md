---
title: Crear XLTX en Python
description: Genere un archivo XLTX usando aplicaciones de Python sin usar Microsoft Office. 
url: /es/python-java/create/xltx/
family: total
platformtag: Python
feature: create
informat: XLTX
...
- Guarde el documento como archivo .xltx usando [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) pasando el archivo con la ruta como parámetro

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de creación" %}}

- Para la generación de XLTX, haga referencia a las API dentro del proyecto directamente desde PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Crear XLTX en Python" offSpacer="" %}}
