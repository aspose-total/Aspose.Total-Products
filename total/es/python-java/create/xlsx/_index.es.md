---
title: Crear XLSX en Python
description: Genere un archivo XLSX usando aplicaciones de Python sin usar Microsoft Office. 
...
- Guarde el documento como archivo .xlsx usando [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) pasando el archivo con la ruta como parámetro
...
{{% blocks/products/pf/agp/code-block title="Crear XLSX en Python" offSpacer="" %}}
