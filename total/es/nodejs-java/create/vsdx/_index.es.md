---
title: Crear diagramas de Visio VSDX en Node.js
description: Genere diagramas de Microsoft Visio VSDX utilizando aplicaciones Node sin utilizar Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="Crear un archivo VSDX usando Node.js" h2="Genere archivos Microsoft Visio VSDX a través de sus aplicaciones de nodo sin instalar ningún otro software." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Crear archivo VSDX en Node.js" %}}

- Crear una instancia de la clase Diagrama.
- Llamar al método de guardar con los parámetros relevantes
- Ruta de archivo VSDX y extensión relevante de SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de creación" %}}

- Para la creación de documentos VSDX, se debe instalar Node.js en el sistema.
- Se requiere Oracle JDK (versión 7 o posterior).
- Se debe configurar el paquete node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Crear archivos VSDX" offSpacer="" %}}
