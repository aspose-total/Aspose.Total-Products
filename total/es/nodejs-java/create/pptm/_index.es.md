---
title: Crear presentaciones PPTM en Node.js
description: Genere presentaciones de Microsoft Powerpoint PPTM utilizando aplicaciones Node sin utilizar Microsoft Office. 
...
- Escriba la presentación modificada como un archivo PPTM.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de creación" %}}

- Para la creación de documentos PPTM, se debe instalar Node.js en el sistema.
- Se requiere Oracle JDK (versión 7 o posterior).
- Se debe configurar el paquete node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Crear archivos PPTM" offSpacer="" %}}
