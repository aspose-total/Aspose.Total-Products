---
title: Crear presentaciones PPT en Node.js
description: Genere presentaciones de Microsoft Powerpoint PPT utilizando aplicaciones Node sin utilizar Microsoft Office. 
...
- Para la creación de documentos PPT, se debe instalar Node.js en el sistema.
- Se requiere Oracle JDK (versión 7 o posterior).
- Se debe configurar el paquete node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Crear archivos PPT" offSpacer="" %}}
