---
title: Procesamiento de PDF y adición de OCR a través de API de JavaScript
description: API de JavaScript para manipular documentos PDF y agregar función OCR en aplicaciones web.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API de JavaScript para PDF y OCR" h2="Agregue funciones de manipulación de OCR y PDF dentro de aplicaciones web sin ninguna otra dependencia de software" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total para JavaScript a través de C++ es un conjunto completo de bibliotecas de JavaScript.Estas bibliotecas ofrecen funcionalidades como trabajar directamente con archivos PDF en navegadores web y mejorar sus aplicaciones con capacidades de reconocimiento óptico de caracteres.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total para JavaScript a través de C++ incluye las siguientes bibliotecas de JavaScript:" >}}
...
Aspose.PDF para JavaScript a través de C++ es un conjunto de herramientas seguro y fácil de usar diseñado para trabajar con archivos PDF directamente en navegadores web.Esta biblioteca admite 26 idiomas, incluidos latín, escritura cirílica y caracteres chinos.<br><br>
...
Aspose.OCR para JavaScript a través de C++ permite a sus aplicaciones un reconocimiento óptico eficiente de caracteres en solo 8 líneas de código.<br><br>
...
<h2 class="pr-ft">
 ...
 Descripción general de JavaScript a través de bibliotecas C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Extrae texto de imágenes y crea archivos PDF con capacidad de búsqueda
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Admite cualquier imagen que pueda obtener desde un escáner o una cámara
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Lee escrituras latinas y cirílicas extendidas
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Preprocesa imágenes antes del reconocimiento.
    </p>
   </div>
   <div class="col-lg-4">
    <em class="fa fa-image ico-blue fa-2x col-lg-2">
    ...
    <p class="col-lg-10">
     Procesa toda la imagen o solo áreas seleccionadas
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Admite imágenes rotadas, sesgadas y con ruido
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Reconoce imágenes proporcionadas como enlaces web.
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Encuentra y corrige automáticamente palabras mal escritas
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Obtener resultado de reconocimiento como JSON
    </p>
   </div>
