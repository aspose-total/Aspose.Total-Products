---
title: Convertir PST a TEXT en Python
description: Guarde PST en TEXT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-text/
family: total
platformtag: Python
feature: conversion
informat: PST
...
{{< blocks/products/pf/feature-page-header h1="Convierte PST a TEXT usando Python" h2="Conversión de PST a TEXT en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir PST a TEXT en Python" %}}
...
- Para la conversión de PST a TEXT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en TEXT en Python" offSpacer="" %}}
