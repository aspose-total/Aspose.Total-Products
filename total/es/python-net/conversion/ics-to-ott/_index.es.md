---
title: Convertir ICS a OTT en Python
description: Guarde ICS en OTT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-ott/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
{{< blocks/products/pf/feature-page-header h1="Convierte ICS a OTT usando Python" h2="Conversión de ICS a OTT en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir ICS a OTT en Python" %}}
...
- Para la conversión de ICS a OTT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en OTT en Python" offSpacer="" %}}
