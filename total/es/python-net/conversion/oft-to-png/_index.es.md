---
title: Convertir OFT a PNG en Python
description: Guarde OFT en PNG en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-png/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Convierte OFT a PNG usando Python" h2="Conversión de OFT a PNG en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir OFT a PNG en Python" %}}
...
- Para la conversión de OFT a PNG, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en PNG en Python" offSpacer="" %}}
