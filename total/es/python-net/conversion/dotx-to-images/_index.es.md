---
title: Convertir DOTX a imágenes en Python
description: Conversión de DOTX a imagen TIFF BMP PNG JPEG GIF SVG en sus aplicaciones de Python sin usar Microsoft Word 
url: /es/python-net/conversion/dotx-to-images/
family: total
platformtag: Python
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Convierta DOTX a imágenes usando Python" h2="Conversión de imágenes DOTX a JPG, TIFF, BMP, PNG y GIF en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup>." >}}
...
- Llame al método `save` mientras pasa la ruta del archivo de salida y las opciones especificadas como parámetros. Por lo tanto, su archivo DOTX se convierte en Imágenes en la ruta especificada.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de DOTX a imágenes (JPG, PNG, GIF, BMP, TIFF), se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar DOTX en imágenes en Python - Conversión simple" offSpacer="" %}}

{{< gist "aspose-com-gists" "fe7c3ff0a8c783e4f0ed6bff199c6800" "convert-documents-to-images-simple-in-python.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Conversión de DOTX a imágenes con opciones específicas" offSpacer="" %}}
