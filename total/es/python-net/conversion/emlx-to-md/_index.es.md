---
title: Convertir EMLX a MD en Python
description: Guarde EMLX en MD en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-md/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a MD, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en MD en Python" offSpacer="" %}}
