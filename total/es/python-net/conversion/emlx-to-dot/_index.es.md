---
title: Convertir EMLX a DOT en Python
description: Guarde EMLX en DOT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-dot/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a DOT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en DOT en Python" offSpacer="" %}}
