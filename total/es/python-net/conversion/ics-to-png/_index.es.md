---
title: Convertir ICS a PNG en Python
description: Guarde ICS en PNG en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-png/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
{{< blocks/products/pf/feature-page-header h1="Convierte ICS a PNG usando Python" h2="Conversión de ICS a PNG en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir ICS a PNG en Python" %}}
...
- Para la conversión de ICS a PNG, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en PNG en Python" offSpacer="" %}}
