---
title: Convertir ICS a IMAGE en Python
description: Guarde ICS en IMAGE en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-image/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a IMAGE, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en IMAGE en Python" offSpacer="" %}}
