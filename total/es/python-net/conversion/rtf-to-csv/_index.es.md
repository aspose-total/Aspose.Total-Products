---
title: Convierte RTF a CSV usando Python o con el convertidor en línea gratuito
description: Conversión de RTF a CSV en sus aplicaciones de Python sin usar Microsoft Word o Excel o en línea. Pruebe el convertidor en línea gratuito de RTF a CSV rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir RTF a CSV en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo CSV de salida. Entonces su archivo RTF se convierte a CSV en la ruta especificada
