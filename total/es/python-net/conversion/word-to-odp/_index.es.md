---
title: Convertir WORD a ODP en Python o con el convertidor en línea gratuito
description: Conversión de WORD a ODP en sus aplicaciones de Python sin usar Microsoft Word o PowerPoint o en línea. Pruebe el convertidor en línea gratuito de WORD a ODP rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="¿Cómo convertir WORD a ODP en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo de salida y SaveFormat.ODP como parámetros. Entonces, su archivo WORD se convierte a ODP en la ruta especificada.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de WORD a ODP, se requiere Python 3.5 o posterior
