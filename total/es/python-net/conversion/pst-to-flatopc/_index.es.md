---
title: Convertir PST a FLATOPC en Python
description: Guarde PST en FLATOPC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a FLATOPC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en FLATOPC en Python" offSpacer="" %}}
