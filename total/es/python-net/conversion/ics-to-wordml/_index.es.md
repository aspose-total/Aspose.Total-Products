---
title: Convertir ICS a WORDML en Python
description: Guarde ICS en WORDML en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a WORDML, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en WORDML en Python" offSpacer="" %}}
