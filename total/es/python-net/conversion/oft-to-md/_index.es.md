---
title: Convertir OFT a MD en Python
description: Guarde OFT en MD en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-md/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a MD, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en MD en Python" offSpacer="" %}}
