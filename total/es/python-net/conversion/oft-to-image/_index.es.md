---
title: Convertir OFT a IMAGE en Python
description: Guarde OFT en IMAGE en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-image/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a IMAGE, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en IMAGE en Python" offSpacer="" %}}
