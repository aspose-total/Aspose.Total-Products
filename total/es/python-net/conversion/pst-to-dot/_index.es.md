---
title: Convertir PST a DOT en Python
description: Guarde PST en DOT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-dot/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a DOT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en DOT en Python" offSpacer="" %}}
