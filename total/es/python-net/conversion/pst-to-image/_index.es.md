---
title: Convertir PST a IMAGE en Python
description: Guarde PST en IMAGE en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-image/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a IMAGE, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en IMAGE en Python" offSpacer="" %}}
