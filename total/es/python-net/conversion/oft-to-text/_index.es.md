---
title: Convertir OFT a TEXT en Python
description: Guarde OFT en TEXT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-text/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Convierte OFT a TEXT usando Python" h2="Conversión de OFT a TEXT en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir OFT a TEXT en Python" %}}
...
- Para la conversión de OFT a TEXT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en TEXT en Python" offSpacer="" %}}
