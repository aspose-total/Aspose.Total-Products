---
title: Convertir EMLX a FLATOPC en Python
description: Guarde EMLX en FLATOPC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a FLATOPC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en FLATOPC en Python" offSpacer="" %}}
