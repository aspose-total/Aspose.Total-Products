...
- Para la conversión de EMLX a RTF, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en RTF en Python" offSpacer="" %}}
