---
title: Convierte POTM a CSV usando Python o con el convertidor en línea gratuito
description: Conversión de POTM a CSV en sus aplicaciones de Python sin usar Microsoft Office o en línea. Pruebe el convertidor en línea gratuito de POTM a CSV rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir POTM a CSV en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo CSV de salida. Entonces su archivo POTM se convierte a CSV en la ruta especificada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de POTM a CSV, se requiere Python 3.5 o posterior
