---
title: Convertir PST a PNG en Python
description: Guarde PST en PNG en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-png/
family: total
platformtag: Python
feature: conversion
informat: PST
...
{{< blocks/products/pf/feature-page-header h1="Convierte PST a PNG usando Python" h2="Conversión de PST a PNG en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir PST a PNG en Python" %}}
...
- Para la conversión de PST a PNG, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en PNG en Python" offSpacer="" %}}
