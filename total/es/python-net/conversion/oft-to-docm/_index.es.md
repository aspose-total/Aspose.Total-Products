---
title: Convertir OFT a DOCM en Python
description: Guarde OFT en DOCM en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-docm/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a DOCM, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en DOCM en Python" offSpacer="" %}}
