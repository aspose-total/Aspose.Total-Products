---
title: Convertir ICS a DOTX en Python
description: Guarde ICS en DOTX en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a DOTX, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en DOTX en Python" offSpacer="" %}}
