---
title: Convierte MOBI a XLSB usando Python o con el convertidor en línea gratuito
description: Conversión de MOBI a XLSB en sus aplicaciones de Python sin usar Microsoft Word o Excel o en línea. Pruebe el convertidor en línea gratuito de MOBI a XLSB rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir MOBI a XLSB en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo XLSB de salida. Entonces su archivo MOBI se convierte a XLSB en la ruta especificada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de MOBI a XLSB, se requiere Python 3.5 o posterior
