---
title: Convertir PST a DOC en Python
description: Guarde PST en DOC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-doc/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a DOC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en DOC en Python" offSpacer="" %}}
