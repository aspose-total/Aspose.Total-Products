---
title: Convertir PST a SVG en Python
description: Guarde PST en SVG en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-svg/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a SVG, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en SVG en Python" offSpacer="" %}}
