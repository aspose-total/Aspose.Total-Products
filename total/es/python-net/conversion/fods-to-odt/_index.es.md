---
title: Convierte FODS a ODT usando Python o con el convertidor en línea gratuito
description: Conversión de FODS a ODT en sus aplicaciones de Python sin usar Microsoft Office o en línea. Pruebe el convertidor en línea gratuito de FODS a ODT rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir FODS a ODT en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo ODT de salida. Entonces su archivo FODS se convierte a ODT en la ruta especificada

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de FODS a ODT, se requiere Python 3.5 o posterior
...
<h3>Convertidor en línea gratuito para FODS a ODT</h3>

<iframe title="Herramienta de conversión de odt a fods" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=odt&from=fods" id="child-iframe" width="80%"></iframe>
