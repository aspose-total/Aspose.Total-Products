---
title: Convertir EMLX a WORDML en Python
description: Guarde EMLX en WORDML en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a WORDML, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en WORDML en Python" offSpacer="" %}}
