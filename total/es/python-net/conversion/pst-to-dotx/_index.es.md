---
title: Convertir PST a DOTX en Python
description: Guarde PST en DOTX en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/pst-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Para la conversión de PST a DOTX, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar PST en DOTX en Python" offSpacer="" %}}
