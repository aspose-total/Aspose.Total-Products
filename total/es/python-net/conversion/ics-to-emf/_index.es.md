---
title: Convertir ICS a EMF en Python
description: Guarde ICS en EMF en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-emf/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a EMF, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en EMF en Python" offSpacer="" %}}
