---
title: Convertir OFT a OTT en Python
description: Guarde OFT en OTT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-ott/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Convierte OFT a OTT usando Python" h2="Conversión de OFT a OTT en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir OFT a OTT en Python" %}}
...
- Para la conversión de OFT a OTT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en OTT en Python" offSpacer="" %}}
