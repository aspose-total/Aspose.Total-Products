---
title: Convertir EMLX a DOTX en Python
description: Guarde EMLX en DOTX en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a DOTX, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en DOTX en Python" offSpacer="" %}}
