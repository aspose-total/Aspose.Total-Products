---
title: Convertir OFT a WORD en Python
description: Guarde OFT en WORD en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-word/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a WORD, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en WORD en Python" offSpacer="" %}}
