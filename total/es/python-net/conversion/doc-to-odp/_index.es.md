---
title: Convertir DOC a ODP en Python o con el convertidor en línea gratuito
description: Conversión de DOC a ODP en sus aplicaciones de Python sin usar Microsoft Word o PowerPoint o en línea. Pruebe el convertidor en línea gratuito de DOC a ODP rápidamente antes de integrar el código. 
...
{{% blocks/products/pf/agp/feature-section-col title="¿Cómo convertir DOC a ODP en Python" %}}
...
-  Llame al método `save` mientras especifica la ruta del archivo de salida y SaveFormat.ODP como parámetros. Entonces, su archivo DOC se convierte a ODP en la ruta especificada.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Requisitos de conversión" %}}

- Para la conversión de DOC a ODP, se requiere Python 3.5 o posterior
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Puede usar cualquier navegador web moderno como Google Chrome, Firefox, Opera o Safari para esta conversión de DOC a ODP en línea. Sin embargo, si está creando una aplicación de escritorio, la API de conversión de DOC de Aspose.Total funcionará sin problemas.</span>
                      </div>
                  </li>
              </ul>
          </div>
