---
title: Convertir EMLX a DOTM en Python
description: Guarde EMLX en DOTM en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a DOTM, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en DOTM en Python" offSpacer="" %}}
