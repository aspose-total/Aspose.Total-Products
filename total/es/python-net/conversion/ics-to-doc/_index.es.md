---
title: Convertir ICS a DOC en Python
description: Guarde ICS en DOC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-doc/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a DOC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en DOC en Python" offSpacer="" %}}
