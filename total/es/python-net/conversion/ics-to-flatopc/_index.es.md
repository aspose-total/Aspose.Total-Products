---
title: Convertir ICS a FLATOPC en Python
description: Guarde ICS en FLATOPC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a FLATOPC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en FLATOPC en Python" offSpacer="" %}}
