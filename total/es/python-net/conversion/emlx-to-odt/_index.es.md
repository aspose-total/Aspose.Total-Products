---
title: Convertir EMLX a ODT en Python
description: Guarde EMLX en ODT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/emlx-to-odt/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Para la conversión de EMLX a ODT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar EMLX en ODT en Python" offSpacer="" %}}
