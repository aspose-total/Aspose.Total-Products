---
title: Convertir ICS a XPS en Python
description: Guarde ICS en XPS en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-xps/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a XPS, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en XPS en Python" offSpacer="" %}}
