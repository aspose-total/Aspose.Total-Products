---
title: Convertir ICS a TEXT en Python
description: Guarde ICS en TEXT en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-text/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
{{< blocks/products/pf/feature-page-header h1="Convierte ICS a TEXT usando Python" h2="Conversión de ICS a TEXT en sus aplicaciones Python sin instalar Microsoft Word<sup>&reg;</sup> o Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo convertir ICS a TEXT en Python" %}}
...
- Para la conversión de ICS a TEXT, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en TEXT en Python" offSpacer="" %}}
