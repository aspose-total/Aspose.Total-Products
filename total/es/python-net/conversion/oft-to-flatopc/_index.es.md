---
title: Convertir OFT a FLATOPC en Python
description: Guarde OFT en FLATOPC en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a FLATOPC, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en FLATOPC en Python" offSpacer="" %}}
