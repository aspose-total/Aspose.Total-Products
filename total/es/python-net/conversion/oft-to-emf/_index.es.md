---
title: Convertir OFT a EMF en Python
description: Guarde OFT en EMF en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/oft-to-emf/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Para la conversión de OFT a EMF, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar OFT en EMF en Python" offSpacer="" %}}
