---
title: Convertir ICS a PCL en Python
description: Guarde ICS en PCL en sus aplicaciones de Python sin usar Microsoft Outlook o Word 
url: /es/python-net/conversion/ics-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- Para la conversión de ICS a PCL, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Guardar ICS en PCL en Python" offSpacer="" %}}
