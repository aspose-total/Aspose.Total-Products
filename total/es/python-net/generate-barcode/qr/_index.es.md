---
title: Genere imágenes de código de barras QR a través de Python
description: Cree imágenes de código de barras con simbología QR usando aplicaciones de Python sin usar ningún otro software. 
...
- Para la creación de códigos de barras QR, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Generar código de barras de simbología QR en Python" offSpacer="" %}}
