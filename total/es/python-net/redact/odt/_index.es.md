---
title: Redactar documento ODT en línea o usando Python
description: Abra y redacte documentos ODT en línea a través de la aplicación de forma gratuita.Código API de Python para buscar y reemplazar texto ODT con expresiones regulares.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento ODT en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de redacción de documentos ODT basada en Python.Código listado para buscar y reemplazar texto en un archivo ODT usando expresiones regulares a través de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo ODT mediante Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Python: Redactar documento ODT" offSpacer="" %}}
