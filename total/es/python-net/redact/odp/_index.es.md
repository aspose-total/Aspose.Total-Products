---
title: Redactar presentación ODP en línea o usando Python
description: Abra y redacte documentos ODP en línea a través de la aplicación de forma gratuita. Código API de Python para buscar y reemplazar texto ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redactar documento ODP en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de redacción de presentaciones ODP basada en Python.Código listado para buscar y reemplazar texto en un archivo ODP a través de Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redactar archivo ODP mediante Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Código Python: Redactar presentación ODP" offSpacer="" %}}
