---
title: Crear DOCX en Python
description: Genere un archivo DOCX usando aplicaciones de Python sin usar Microsoft Word. 
url: /es/python-net/create/docx/
family: total
platformtag: Python
feature: create
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Crear DOCX usando Python" h2="Genere DOCX a través de sus aplicaciones Python sin instalar Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo crear un archivo DOCX en Python" %}}
...
- Guarde usando el método [save()](https://reference.aspose.com/words/python-net/aspose.words/document/save/) pasando la ruta del documento DOCX relevante.
...
{{% blocks/products/pf/agp/code-block title="Crear DOCX en Python" offSpacer="" %}}
