---
title: Borrar anotaciones OTT en línea y usando Python
description: Elimine comentarios del documento OTT a través de la aplicación en línea de forma gratuita.Código API de Python para eliminar comentarios de archivos OTT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Eliminar comentarios del documento OTT en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos OTT basada en Python. Código enumerado para borrar comentarios del archivo OTT a través de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Borrar anotaciones OTT en línea" %}}

1. Importe el archivo OTT para borrar los comentarios cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos OTT a través de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Python para eliminar comentarios del documento OTT" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos OTT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
