---
title: Borrar anotaciones DOT en línea y usando Python
description: Elimine comentarios del documento DOT a través de la aplicación en línea de forma gratuita.Código API de Python para eliminar comentarios de archivos DOT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Eliminar comentarios del documento DOT en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos DOT basada en Python. Código enumerado para borrar comentarios del archivo DOT a través de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Borrar anotaciones DOT en línea" %}}

1. Importe el archivo DOT para borrar los comentarios cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos DOT a través de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Python para eliminar comentarios del documento DOT" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>¿Es seguro utilizar la aplicación en línea para anotar documentos DOT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
