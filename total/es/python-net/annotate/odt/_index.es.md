---
title: Borrar anotaciones ODT en línea y usando Python
description: Elimine comentarios del documento ODT a través de la aplicación en línea de forma gratuita.Código API de Python para eliminar comentarios de archivos ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Eliminar comentarios del documento ODT en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos ODT basada en Python. Código enumerado para borrar comentarios del archivo ODT a través de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Borrar anotaciones ODT en línea" %}}

1. Importe el archivo ODT para borrar los comentarios cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos ODT a través de Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Python para eliminar comentarios del documento ODT" offSpacer="" %}}
