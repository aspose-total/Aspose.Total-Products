---
title: Borrar anotaciones PDF en línea y usando Python
description: Elimine comentarios de documentos PDF a través de una aplicación en línea de forma gratuita. Código API de Python para eliminar comentarios del archivo PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Eliminar comentarios del documento PDF en línea o mediante Python" h2="Desarrolle una poderosa aplicación de utilidad de anotación de documentos PDF basada en Python.Código enumerado para borrar comentarios del archivo PDF a través de Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Borrar anotaciones PDF en línea" %}}

1. Importe el archivo PDF para borrar los comentarios cargándolo.
...
{{% blocks/products/pf/agp/feature-section-col title="Eliminar comentarios de documentos PDF a través de Python" %}}

1. API de referencia dentro del proyecto directamente desde PyPI ([Aspose.PDF](https://pypi.org/project/aspose-pdf/))
1. Cree un objeto de clase de documento y cargue el archivo usándolo
1. Cargar todas las anotaciones en una matriz
1. Recorre la matriz y llama a anotaciones.delete
...
{{% blocks/products/pf/agp/code-block title="Ejemplo de código en Python para eliminar comentarios del documento PDF" offSpacer="" %}}
