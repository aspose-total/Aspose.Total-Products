---
title: Reconocer imágenes de código de barras PLANET a través de Python
description: Escanee imágenes de códigos de barras con simbología PLANET usando aplicaciones de Python sin usar ningún otro software. 
...
- Para el escaneo de códigos de barras PLANET, se requiere Python 3.5 o posterior
...
{{% blocks/products/pf/agp/code-block title="Reconocer código de barras de simbología PLANET en Python" offSpacer="" %}}
