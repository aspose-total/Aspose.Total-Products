---
title: Render DOCX to PPSX via ANDROID-JAVA 
description: Export DOCX to PPSX in your Andorid Phones without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/content h2="How to Convert DOCX to PPSX within Andorid Applications" %}}
Are you an Andoroid developer looking to add documment conversion feature in your application? [Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/) File Format Automation libraries can help you automate the document conversion process in you Android applications. In order to convert Microsoft Word DOCX to PowerPoint PPSX, you can first use document manipulation API [Aspose.Words for Andorid Java](https://products.aspose.com/words/android-java/) to convert DOCX file format to HTML. After that by using PowerPoint API [Aspose.Slides for Android Java](https://products.aspose.com/slides/android-java/), you can create a new Presentation, write HTML content in it, and save it as PPSX. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX to PPSX Conversion in Andorid via Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Android-java Code for DOCX to PPSX Conversion" gistPath="" %}}
```cs
