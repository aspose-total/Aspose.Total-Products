---
title: Android API to Render SVG to DOTX
description: Transform SVG to DOTX via Android via Java API
url: /android-java/conversion/svg-to-dotx/
family: total
...
{{% blocks/products/pf/agp/feature-section-col title="Convert SVG to DOTX on Android via Java" %}}
...
4. Save the document to DOTX format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method and set DOTX as SaveFormat
