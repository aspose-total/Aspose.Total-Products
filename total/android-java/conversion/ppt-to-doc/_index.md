---
title: Export PPT to DOC on Andorid via Java  
description: Convert PPT to DOC in mobile apps without installing any software 
url: /android-java/conversion/ppt-to-doc/
family: total
...
{{% blocks/products/pf/agp/content h2="How to Convert PPT to DOC within Android Applications" %}}
[Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/) allows manipulating file formats within Android applications. By using the APIs provided in the package you can automate PowerPoint PPT to Word DOC conversion process in your apps. 
You can convert your given document in two steps. You can use [Aspose.Slides for Andorid via Java](https://products.aspose.com/slides/android-java/) that is a PowerPoint API for Android applications to render PPT to HTML. After that by using document processing API [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/) you can convert the HTML to DOC. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="PPT to DOC Rendering in Android" %}}
...
4. Save the document to DOC format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method and set Doc as SaveFormat
...
{{% blocks/products/pf/agp/code-autogen title="Code to Render PPT to DOC within Andorid Applications" gistPath="" %}}
```cs
