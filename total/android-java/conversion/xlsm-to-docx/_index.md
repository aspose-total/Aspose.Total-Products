---
title: Export XLSM to DOCX in Android 
description: Android API to Convert XLSM to DOCX without using Microsoft Word
url: /android-java/conversion/xlsm-to-docx/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render XLSM to DOCX on Android via Java" h2="Transform XLSM to DOCX within your Android Applications without using Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Export XLSM to DOCX" %}}
