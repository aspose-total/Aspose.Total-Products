---
title: Android API to Render TEX to OTT
description: Transform TEX to OTT via Android via Java API
url: /android-java/conversion/tex-to-ott/
family: total
...
{{% blocks/products/pf/agp/feature-section-col title="Convert TEX to OTT on Android via Java" %}}
1. Open TEX file using [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) class
2. Convert TEX to DOC by using [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-) method
...
Before converting TEX to OTT, you might need information about the document including author, creation date, keywords, modify date, subject, and title. This information is helpful for the decision making for the conversion process. Using the powerful [Aspose.PDF for Android via Java](https://docs.aspose.com/pdf/androidjava/) API, you can get all of it. To get file-specific information about a TEX file, first get the [DocumentInfo](https://apireference.aspose.com/pdf/java/com.aspose.pdf/DocumentInfo) object using [getInfo](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#getInfo--) method. Once the DocumentInfo object is retrieved, you can get the values of the individual properties.
{{% blocks/products/pf/feature-page-code %}}
```java
// load TEX document
...
{{% blocks/products/pf/feature-page-section  h2="Insert Endnotes in OTT Document in Android via Java" %}}
