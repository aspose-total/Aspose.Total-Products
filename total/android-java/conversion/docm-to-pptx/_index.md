...
informat: DOCM
outformat: PPTX
otherformats: PPT PPS POWERPOINT POTM POTX PPTM PPSX PPSM POT ODP
---
...
6. Save the document to PPTX format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-) method and set Pptx as SaveFormat
