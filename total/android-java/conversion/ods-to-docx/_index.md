---
title: Export ODS to DOCX in Android 
description: Android API to Convert ODS to DOCX without using Microsoft Word
url: /android-java/conversion/ods-to-docx/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render ODS to DOCX on Android via Java" h2="Transform ODS to DOCX within your Android Applications without using Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Export ODS to DOCX" %}}
