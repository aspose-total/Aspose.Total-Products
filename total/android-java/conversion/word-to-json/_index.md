---
title: Convert WORD to JSON Format in Android via Java
description: Parse WORD to JSON format in Android via Java without using Microsoft Word or Excel
url: /android-java/conversion/word-to-json/
family: total
...
{{% blocks/products/pf/agp/feature-section-col title="Convert WORD to JSON Format in Android Applications" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected WORD to JSON Format in Android via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert WORD to JSON in Range in Android via Java" %}}
