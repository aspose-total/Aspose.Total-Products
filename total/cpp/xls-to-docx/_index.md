---
title: Convert XLS to DOCX with C++ 
description: Convert XLS to DOCX within C++ applications
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to DOCX via C++" h2="Export Excel&reg; XLS to DOCX within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to DOCX Conversion on C++" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for XLS to DOCX Conversion" gistPath="" %}}
```cs
