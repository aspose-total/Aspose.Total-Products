---
title: Convert XLS to PPTX with C++ 
description: Convert XLS to PPTX within C++ applications
url: /cpp/conversion/xls-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to PPTX via C++" h2="Export Excel&reg; XLS to PPTX within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to PPTX Conversion on C++" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for XLS to PPTX Conversion" gistPath="" %}}
```cs
