...
{{< blocks/products/pf/feature-page-header h1="Convert POWERPOINT to SXC via C++" h2="POWERPOINT  to SXC File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POWERPOINT to SXC via C++" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected POWERPOINT to SXC via C++" %}}
