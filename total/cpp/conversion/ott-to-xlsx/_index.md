---
title: Convert OTT to XLSX in C++
description: C++ API to Convert OTT to XLSX without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/ott-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert OTT to XLSX" h2="Export OTT to XLSX via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
