...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to DOC via C++" h2="Export Excel&reg; XLSX to DOC within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSX to DOC Conversion on C++" %}}
1. Open XLSX file using [IWorkbook](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook) member function of [Factory](https://apireference.aspose.com/cells/cpp/class/aspose.cells.factory) class reference
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for XLSX to DOC Conversion" gistPath="" %}}
```cs
