...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to SXC via C++" h2="PPTX  to SXC File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPTX to SXC via C++" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PPTX to SXC via C++" %}}
