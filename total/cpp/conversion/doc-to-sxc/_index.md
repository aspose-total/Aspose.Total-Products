...
description: C++ API to Convert DOC to SXC without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/doc-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOC to SXC" h2="Export DOC to SXC via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert DOC to SXC" %}}
