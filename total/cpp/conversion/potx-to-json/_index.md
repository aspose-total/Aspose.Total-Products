---
title: Convert POTX to JSON format via C++ 
description: Export POTX to JSON format in C++ without using Microsoft Excel or Powerpoint
url: /cpp/conversion/potx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{% blocks/products/pf/agp/feature-section-col title="Convert POTX to JSON Format via C++" %}}
...
4. Save the document to JSON format using [Save](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e) method
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected POTX to JSON Format via C++" %}}
