...
url: /cpp/conversion/wordml-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for WORDML to ODP Conversion" gistPath="" %}}
```cs
