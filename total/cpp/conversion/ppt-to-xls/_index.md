...
description: Export PPT to XLS in C++ without using Microsoft Excel or Powerpoint
url: /cpp/conversion/ppt-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to XLS via C++" h2="PPT  to XLS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
