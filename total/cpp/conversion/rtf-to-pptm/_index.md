...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert RTF to PPTM" h2="Export RTF to PPTM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="RTF to PPTM Conversion on C++" %}}
...
While saving RTF as PPTM, you can also use [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) to add further features in your PPTM document. For instance, you can add comments in your presentation. The presentation slide comment are associated with a particular author. The Presentation class holds the collection of authors in ICommentAuthorCollection that are responsible for adding slide comments. For each author, there is a collection of comments in ICommentCollection.
{{% blocks/products/pf/feature-page-code %}}
```cpp
