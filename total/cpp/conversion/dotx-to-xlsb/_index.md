...
description: C++ API to Convert DOTX to XLSB without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/dotx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
