---
title: Convert FODS to WORD with C++ 
description: Convert FODS to WORD within C++ applications
url: /cpp/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to WORD via C++" h2="Export Excel&reg; FODS to WORD within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="FODS to WORD Conversion on C++" %}}
1. Open FODS file using [IWorkbook](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook) member function of [Factory](https://apireference.aspose.com/cells/cpp/class/aspose.cells.factory) class reference
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for FODS to WORD Conversion" gistPath="" %}}
```cs
