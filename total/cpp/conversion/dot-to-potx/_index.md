...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOT to POTX" h2="Export DOT to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOT to POTX Conversion on C++" %}}
