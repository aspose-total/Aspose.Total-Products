---
title: Convert DOTX to POT via C++
description: Export DOTX to POT in your C++ applications without using Microsoft Word of PowerPoint 
url: /cpp/conversion/dotx-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to POT" h2="Export DOTX to POT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX to POT Conversion on C++" %}}
