...
description: C++ API to Convert DOCM to XLTM without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/docm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCM to XLTM" h2="Export DOCM to XLTM via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
