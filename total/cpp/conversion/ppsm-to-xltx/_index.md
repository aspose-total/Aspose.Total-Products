...
{{< blocks/products/pf/feature-page-header h1="Convert PPSM to XLTX via C++" h2="PPSM  to XLTX File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSM to XLTX via C++" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PPSM to XLTX via C++" %}}
