...
description: C++ API to Convert DOTX to XLSX without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to XLSX" h2="Export DOTX to XLSX via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert DOTX to XLSX" %}}
