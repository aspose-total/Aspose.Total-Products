---
title: Convert FODS to DOC with C++ 
description: Convert FODS to DOC within C++ applications
url: /cpp/conversion/fods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to DOC via C++" h2="Export Excel&reg; FODS to DOC within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="FODS to DOC Conversion on C++" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for FODS to DOC Conversion" gistPath="" %}}
```cs
