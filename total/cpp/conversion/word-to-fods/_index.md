---
title: Convert WORD to FODS in C++
description: C++ API to Convert WORD to FODS without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/word-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
