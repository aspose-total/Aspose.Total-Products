---
title: Convert DOC to POTX via C++
description: Export DOC to POTX in your C++ applications without using Microsoft Word of PowerPoint 
url: /cpp/conversion/doc-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOC to POTX" h2="Export DOC to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOC to POTX Conversion on C++" %}}
