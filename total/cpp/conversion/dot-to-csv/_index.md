...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOT to CSV" h2="Export DOT to CSV via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Save the document to CSV format using [Save](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e) member function
