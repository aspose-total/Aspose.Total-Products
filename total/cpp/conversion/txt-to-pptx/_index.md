...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert TXT to PPTX" h2="Export TXT to PPTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="TXT to PPTX Conversion on C++" %}}
