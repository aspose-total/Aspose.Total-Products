...
description: C++ API to Convert DOCX to XLAM without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/docx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCX to XLAM" h2="Export DOCX to XLAM via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert DOCX to XLAM" %}}
