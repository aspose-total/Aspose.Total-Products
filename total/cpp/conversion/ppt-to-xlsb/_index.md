...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to XLSB via C++" h2="PPT  to XLSB File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
