---
title: Convert DOTX to PPTM via C++
description: Export DOTX to PPTM in your C++ applications without using Microsoft Word of PowerPoint 
url: /cpp/conversion/dotx-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to PPTM" h2="Export DOTX to PPTM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX to PPTM Conversion on C++" %}}
...
While saving DOTX as PPTM, you can also use [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) to add further features in your PPTM document. For instance, you can add comments in your presentation. The presentation slide comment are associated with a particular author. The Presentation class holds the collection of authors in ICommentAuthorCollection that are responsible for adding slide comments. For each author, there is a collection of comments in ICommentCollection.
{{% blocks/products/pf/feature-page-code %}}
```cpp
