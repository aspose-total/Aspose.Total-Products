---
title: Convert POWERPOINT to XLS via C++ 
description: Export POWERPOINT to XLS in C++ without using Microsoft Excel or Powerpoint
url: /cpp/conversion/powerpoint-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="Convert POWERPOINT to XLS via C++" h2="POWERPOINT  to XLS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POWERPOINT to XLS via C++" %}}
1. Open POWERPOINT file using [Presentation](https://apireference.aspose.com/slides/cpp/class/aspose.slides.presentation) class reference
2. Convert POWERPOINT to HTML by using [Save](https://apireference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba) method
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected POWERPOINT to XLS via C++" %}}
