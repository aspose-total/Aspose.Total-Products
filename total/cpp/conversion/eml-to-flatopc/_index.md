---
title: Export EML to FLATOPC via C++
description: C++ API to Convert EML to FLATOPC without using Microsoft Word or Outlook
url: /cpp/conversion/eml-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
4. Save the document to FLATOPC format using [Save](https://apireference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) method and set FlatOpc as SaveFormat
