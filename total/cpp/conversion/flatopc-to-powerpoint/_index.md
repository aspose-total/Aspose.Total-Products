...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert FLATOPC to POWERPOINT" h2="Export FLATOPC to POWERPOINT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="FLATOPC to POWERPOINT Conversion on C++" %}}
