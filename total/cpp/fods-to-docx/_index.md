---
title: Convert FODS to DOCX with C++ 
description: Convert FODS to DOCX within C++ applications
url: /cpp/conversion/fods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to DOCX via C++" h2="Export Excel&reg; FODS to DOCX within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="FODS to DOCX Conversion on C++" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for FODS to DOCX Conversion" gistPath="" %}}
```cs
