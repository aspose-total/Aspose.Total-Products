---
title: Convert EXCEL to DOC with C++ 
description: Convert EXCEL to DOC within C++ applications
url: /cpp/conversion/excel-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert EXCEL to DOC via C++" h2="Export Excel&reg; EXCEL to DOC within full-functional C++ applications">}}
...
{{% blocks/products/pf/agp/feature-section-col title="EXCEL to DOC Conversion on C++" %}}
1. Open EXCEL file using [IWorkbook](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook) member function of [Factory](https://apireference.aspose.com/cells/cpp/class/aspose.cells.factory) class reference
...
{{% blocks/products/pf/agp/code-autogen title="C++ Code for EXCEL to DOC Conversion" gistPath="" %}}
```cs
