---
title: Entfernen Sie TSV-Anmerkungen online oder verwalten Sie Anmerkungen über Java
description: Löschen Sie Kommentare aus der TSV-Datei kostenlos über die Online-App.Java-API-Code zum Verwalten von Kommentaren von TSV-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus TSV-Dokumenten online oder verwalten Sie sie über Java" h2="Entwickeln Sie eine leistungsstarke Java-basierte TSV-Dienstprogrammanwendung zur Dokumentanmerkung.Code zum Verwalten von Kommentaren der TSV-Datei über Java aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie TSV-Anmerkungen online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie TSV-Dokumentkommentare über Java" %}}
...
1. Erhalten Sie alle Kommentare von [getComments()](https://reference.aspose.com/cells/java/com.aspose.cells/worksheet/#getComments--)
1. Erhalten Sie alle Thread-Kommentare über getThreadedComments
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel in Java zum Löschen von Kommentaren aus der TSV-Datei" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Aktualisieren Sie die Thread-TSV-Kommentare" %}}

1. Bibliotheksverweis zum Java-Projekt hinzufügen
1. Laden Sie das Dokument über das Workbook-Klassenobjekt
1. Holen Sie sich das spezifische Arbeitsblatt
1. Holen Sie sich den Thread-Kommentar mit getComments().getThreadedComments(Index).get(Index)
...
1. Bibliotheksverweis zum Java-Projekt hinzufügen
1. Erstellen Sie ein Dokument über das Klassenobjekt „Arbeitsmappe“.
1. Holen Sie sich das spezifische Arbeitsblatt
1. Kommentarindex über getComments().add hinzufügen
1. Verwenden Sie die setNotes-Methode, um Kommentare hinzuzufügen
...
{{% blocks/products/pf/agp/code-block title="Java-Code zum Aktualisieren des Thread-Kommentars der TSV-Datei" offSpacer="" %}}
...
<h2>Entwickeln Sie eine TSV-Dokumentanmerkungsanwendung über Java</h2>

Müssen Sie eine TSV-Anmerkungs-App oder ein Dienstprogramm entwickeln, um Feedback zu geben, Vorschläge zu machen oder mit anderen am Dokument zusammenzuarbeiten?Da [Aspose.Cells for Java](https://products.aspose.com/cells/java/) eine untergeordnete API von [Aspose.Total for Java](https://products.aspose.com/total/java/) ist, kann jeder Java-Entwickler den oben genannten API-Code in seine Dokumentanmerkungsanwendung integrieren.Die leistungsstarke Java-Bibliothek ermöglicht die Programmierung beliebiger Dokumentanmerkungslösungen. Darüber hinaus unterstützt es viele gängige Formate, einschließlich des TSV-Formats.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-Bibliothek zum Kommentieren von TSV-Dateien" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Ist es sicher, die Online-App zum Kommentieren von TSV-Dokumenten zu verwenden?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sie können jeden modernen Webbrowser wie Google Chrome, Firefox, Opera oder Safari für die Online-Anmerkung von TSV-Dokumenten verwenden.Wenn Sie jedoch eine Desktop-Anwendung entwickeln, empfehlen wir für eine effiziente Verwaltung die Verwendung der Aspose.Total-Dokumentverarbeitungs-API.</span>
                      </div>
                  </li>
              </ul>
          </div>
