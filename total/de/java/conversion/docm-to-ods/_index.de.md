...
description: Konvertieren Sie DOCM über Java in ODS, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/docm-to-ods/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOCM über Java in ODS" h2="Lokale Java-API zum Konvertieren von DOCM in ODS, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
