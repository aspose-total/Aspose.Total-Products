...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie POTM über Java in CSV oder online" h2="Lokale Java-API zum Exportieren von POTM in CSV ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
