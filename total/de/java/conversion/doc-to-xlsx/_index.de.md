...
description: Konvertieren Sie DOC über Java in XLSX, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/java/conversion/doc-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOC über Java in XLSX" h2="Lokale Java-API zum Konvertieren von DOC in XLSX, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
