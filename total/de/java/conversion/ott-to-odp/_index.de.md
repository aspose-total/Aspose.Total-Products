---
title: Konvertieren Sie OTT über Java in ODP
description: Java-API zum Exportieren von OTT in ODP, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/java/conversion/ott-to-odp/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie OTT über Java in ODP" h2="OTT-zu-ODP-Konvertierung durch Verwendung der lokalen Java-API in beliebigen Java J2SE-, J2EE-, J2ME-Anwendungen ohne Verwendung von Microsoft<sup>&reg;</sup> PowerPoint oder Word" >}}
...
Für die Konvertierung von OTT- in ODP-Dateien können Sie Aspose.Total für Java direkt von einem [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total)-basiertes Projekt und fügen Sie Bibliotheken in Ihre pom.xml ein.
...
Mit der API können Sie auch passwortgeschützte OTT-Dokumente in ODP konvertieren. Wenn Ihr eingegebenes OTT-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das ODP-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Ottument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
