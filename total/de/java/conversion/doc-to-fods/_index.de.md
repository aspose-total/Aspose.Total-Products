---
title: Java-API zum Konvertieren von DOC in FODS oder mit dem kostenlosen Online Converter
description: Konvertieren Sie DOC über Java in FODS oder Online-App, ohne Microsoft Word oder Microsoft Excel zu verwenden oder online. Testen Sie schnell den kostenlosen DOC-zu-FODS-Online-Konverter, bevor Sie den Code integrieren. 
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOC über Java in FODS oder Online-App" h2="Lokale Java-API zum Konvertieren von DOC in FODS, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java-API zum Konvertieren von DOC in FODS" %}}
...
<iframe title="fods bis doc Online-Tool" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=fods&from=doc" id="child-iframe" width="80%"></iframe>
