---
title: Java-API zum Konvertieren von ODT in XLAM
description: Konvertieren Sie ODT über Java in XLAM, ohne Microsoft Word oder Microsoft Excel zu verwenden
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie ODT über Java in XLAM" h2="Lokale Java-API zum Konvertieren von ODT in XLAM, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von ODT in XLAM" %}}
