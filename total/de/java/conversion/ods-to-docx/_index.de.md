...
{{< blocks/products/pf/i18n/feature-page-header h1="Java-API zum Exportieren von ODS in DOCX" h2="On-Premise-Java-API zum Exportieren von ODS in DOCX, ohne auf Microsoft Excel angewiesen zu sein&reg;" >}}
