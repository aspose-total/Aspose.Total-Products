---
title: Konvertieren Sie WORD über Java in POWERPOINT
description: Java-API zum Exportieren von WORD in POWERPOINT, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/java/conversion/word-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: WORDX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie WORD über Java in POWERPOINT" h2="WORD-zu-POWERPOINT-Konvertierung durch Verwendung der lokalen Java-API in beliebigen Java J2SE-, J2EE-, J2ME-Anwendungen ohne Verwendung von Microsoft<sup>&reg;</sup> PowerPoint oder Word" >}}
...
Für die Konvertierung von WORD- in POWERPOINT-Dateien können Sie Aspose.Total für Java direkt von einem [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total)-basiertes Projekt und fügen Sie Bibliotheken in Ihre pom.xml ein.
...
Mit der API können Sie auch passwortgeschützte WORD-Dokumente in POWERPOINT konvertieren. Wenn Ihr eingegebenes WORD-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das POWERPOINT-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Wordument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
