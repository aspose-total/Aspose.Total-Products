---
title: Java-API zum Konvertieren von DOCX in XLSX oder mit dem kostenlosen Online Converter
description: Konvertieren Sie DOCX über Java in XLSX oder Online-App, ohne Microsoft Word oder Microsoft Excel zu verwenden oder online. Testen Sie schnell den kostenlosen DOCX-zu-XLSX-Online-Konverter, bevor Sie den Code integrieren. 
url_ignore: /de/java/conversion/docx-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie DOCX über Java in XLSX oder Online-App" h2="Lokale Java-API zum Konvertieren von DOCX in XLSX, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java-API zum Konvertieren von DOCX in XLSX" %}}
