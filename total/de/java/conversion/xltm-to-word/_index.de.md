...
{{< blocks/products/pf/i18n/feature-page-header h1="Java-API zum Exportieren von XLTM in WORD" h2="On-Premise-Java-API zum Exportieren von XLTM in WORD, ohne auf Microsoft Excel angewiesen zu sein&reg;" >}}
