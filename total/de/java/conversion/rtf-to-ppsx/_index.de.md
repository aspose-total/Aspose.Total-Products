...
url: /de/java/conversion/rtf-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: RTF
...
2. Konvertieren Sie die RTF-Datei in HTML, indem Sie [save](https://apireference.aspose.com/words/java/com.aspose.words/Rtfument#save(java.lang.String,com.aspose.words.SaveOptions)) Methode
...
Mit der API können Sie auch passwortgeschützte RTF-Dokumente in PPSX konvertieren. Wenn Ihr eingegebenes RTF-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das PPSX-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Rtfument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
