---
title: Konvertieren Sie ODS in DOC mit Java
description: Java-API zum Exportieren von ODS in DOC mit Excel oder Word
url: /de/java/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java-API zum Exportieren von ODS in DOC" h2="On-Premise-Java-API zum Exportieren von ODS in DOC, ohne auf Microsoft Excel angewiesen zu sein&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/net/conversion/ods-to-docx/" name="ODS Zu DOCX" description="" >}}
