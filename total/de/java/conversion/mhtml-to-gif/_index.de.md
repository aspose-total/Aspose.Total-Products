...
<iframe title="Kostenlose Online-App zur Konvertierung von MHTML in GIF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=gif&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Java-Code für die Konvertierung von MHTML in GIF" offSpacer="" %}}
