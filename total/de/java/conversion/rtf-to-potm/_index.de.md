...
url: /de/java/conversion/rtf-to-potm/
family: total
platformtag: net
feature: conversion
informat: RTF
...
Mit der API können Sie auch passwortgeschützte RTF-Dokumente in POTM konvertieren. Wenn Ihr eingegebenes RTF-Dokument kennwortgeschützt ist, können Sie es ohne Verwendung des Kennworts nicht in das POTM-Format konvertieren. Um ein verschlüsseltes Dokument zu öffnen, können Sie das richtige Passwort im LoadOptions-Objekt setzen und es an den Rtfument-Konstruktor übergeben.  
{{% blocks/products/pf/feature-page-code %}}
