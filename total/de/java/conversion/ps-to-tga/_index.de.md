---
title: Konvertieren Sie PS über Java in TGA
description: Exportieren Sie die PS-Datei in TGA in Ihren Java-Anwendungen, ohne eine Anwendung von Drittanbietern zu verwenden
url_ignore: /de/java/conversion/ps-to-tga/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konvertieren und drehen Sie PS über Java in eine TGA-Datei" %}}
