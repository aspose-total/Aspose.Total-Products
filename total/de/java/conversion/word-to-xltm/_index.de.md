---
title: Java-API zum Konvertieren von WORD in XLTM
description: Konvertieren Sie WORD über Java in XLTM, ohne Microsoft Word oder Microsoft Excel zu verwenden
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie WORD über Java in XLTM" h2="Lokale Java-API zum Konvertieren von WORD in XLTM, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von WORD in XLTM" %}}
