---
title: Konvertieren Sie CGM über Java in DICOM
description: Exportieren Sie die CGM-Datei in DICOM in Ihren Java-Anwendungen, ohne eine Anwendung von Drittanbietern zu verwenden
url_ignore: /de/java/conversion/cgm-to-dicom/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konvertieren und drehen Sie CGM über Java in eine DICOM-Datei" %}}
