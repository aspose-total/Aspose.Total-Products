---
title: Java-API zum Konvertieren von WORD in XLSB
description: Konvertieren Sie WORD über Java in XLSB, ohne Microsoft Word oder Microsoft Excel zu verwenden
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie WORD über Java in XLSB" h2="Lokale Java-API zum Konvertieren von WORD in XLSB, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von WORD in XLSB" %}}
1. Öffnen Sie die WORD-Datei mit der Klasse [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document).
2. Konvertieren Sie WORD in HTML mit [Save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) Methode
...
Sie können Aspose.Total für Java direkt aus einem auf [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) basierenden Projekt verwenden und enthalten [Aspose.Words for Java](https://words.aspose.com/words/java/installation/) und [Aspose.Cells for Java](https://words.aspose.com/cells/java/installation/) in Ihrer pom.xml.
