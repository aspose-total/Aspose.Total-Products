---
title: Konvertieren Sie SXC in WORD mit Java
description: Java-API zum Exportieren von SXC in WORD mit Excel oder Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java-API zum Exportieren von SXC in WORD" h2="On-Premise-Java-API zum Exportieren von SXC in WORD, ohne auf Microsoft Excel angewiesen zu sein&reg;" >}}
...
4. Speichern Sie das Dokument im WORD-Format mit [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-) Methode und legen Sie Word als SaveFormat fest
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/net/conversion/sxc-to-wordx/" name="SXC Zu WORDX" description="" >}}
