---
title: Java-API zum Konvertieren von OTT in DIF oder mit dem kostenlosen Online Converter
description: Konvertieren Sie OTT über Java in DIF oder Online-App, ohne Microsoft Word oder Microsoft Excel zu verwenden oder online. Testen Sie schnell den kostenlosen OTT-zu-DIF-Online-Konverter, bevor Sie den Code integrieren. 
...
{{% blocks/products/pf/agp/feature-section-col title="Java-API zum Konvertieren von OTT in DIF" %}}
...
<h3>Kostenloser Online-Konverter für OTT zu DIF</h3>

<iframe title="dif bis ott Online-Tool" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dif&from=ott" id="child-iframe" width="80%"></iframe>
