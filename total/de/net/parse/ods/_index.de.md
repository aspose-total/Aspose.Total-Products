---
title: Extrahieren Sie Text und Bilder aus einer ODS-Datei online und mit .NET
description: Online-App zum Parsen von ODS-Dateien. .NET API C#-Code zum Extrahieren von Text in Zeilen und Zellen aus ODS-Spreadhseets.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analysieren Sie ODS-Dateien sowohl online als auch über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte ODS-Dokumentparser-Dienstprogrammanwendung. C#-Code für die Analyse von ODS-Dokumenten aufgeführt." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analysieren Sie die ODS-Datei über .NET" %}}

1. Bibliotheksverweis zum .NET-Projekt hinzufügen
1. Laden Sie die ODS-Datei mit dem Workbook-Klassenobjekt
1. Greifen Sie mit seinem Index auf das relevante Arbeitsblatt zu
1. Verwenden Sie die Klasse Drawing.Picture, um ein Bild mit seinem Index abzurufen
1. Legen Sie ImageOrPrintOptions fest, um die Bildeigenschaften festzulegen
1. Rufen Sie die ToImage-Methode auf, um das Bild zu speichern
...
{{% blocks/products/pf/agp/code-block title="C#-Code: Extraktion von ODS-Tabellenbildern" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "parse-excel-spreadsheet-for-images-extraction.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C#-Code: ODS-Tabellentextextraktion" offSpacer="" %}}
...
<h2>Entwickeln Sie eine ODS-Dateiparser-Anwendung über .NET</h2>

Müssen Sie eine ODS-Parser-App oder ein ODS-Parser-Dienstprogramm entwickeln? Da [Aspose.Cells for .NET](https://products.aspose.com/cells/de/net/) eine untergeordnete API von [Aspose.Total for .NET](https://products.aspose.com/total/de/net/) ist, kann jeder .NET-Entwickler den oben genannten API-Code in seine Dokumentparser-Anwendung integrieren.Die leistungsstarke .NET-Bibliothek ermöglicht die Programmierung jeder Lösung zum Parsen von Dokumenten, um sowohl Bilder als auch Text zu extrahieren.Darüber hinaus unterstützt es viele gängige Formate, einschließlich des ODS-Formats.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-Dienstprogramm zum Verarbeiten der ODS-Datei für die Parser-App" %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, Sie können diesen Code gerne herunterladen und für die Entwicklung einer .NET-basierten Dokumentparseranwendung verwenden.Dieser Code kann als wertvolle Ressource zur Verbesserung der Funktionalität und Leistungsfähigkeit Ihrer Projekte im Bereich der Backend-Dokumentverarbeitung dienen, z. B. beim Lesen von Knoten und beim Laden des Dokuments zur Text- und Bildextraktion.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
