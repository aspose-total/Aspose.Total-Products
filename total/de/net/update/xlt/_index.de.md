---
title: Aktualisieren Sie die XLT-Datei mit .NET
description: Ändern Sie XLT-Dokumente in C#-VB.NET-Anwendungen, ohne Microsoft Excel zu verwenden. 
url: /de/net/update/xlt/
family: total
platformtag: .NET
feature: update
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Aktualisieren Sie die XLT-Datei über .NET" h2="Ändern Sie XLT-Tabellen über Ihre .NET-basierten Anwendungen, ohne Microsoft Office<sup>&reg;</sup> zu installieren." >}}

{{% blocks/products/pf/feature-page-summary %}}

Wer versucht als Entwickler, XLT-Dateien über eine .NET-Anwendung zu aktualisieren? [Aspose.Total for .NET](https://products.aspose.com/total/net/) API kann helfen, den Aktualisierungsprozess zu automatisieren. Es ist ein vollständiges Paket verschiedener .NET-APIs, die verschiedene Formate verarbeiten, einschließlich Microsoft Excel-Dateien. Die ASPOSE.CELL-API, die Teil des [Aspose.Total for .NET](https://products.aspose.com/total/net/)-Pakets ist, vereinfacht diesen Änderungsprozess. Nachfolgend ist der Vorgang zum Aktualisieren des XLT-Dokuments beschrieben.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="So aktualisieren Sie die XLT-Datei in .NET" %}}

- Erstellen Sie ein neues [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/)-Klassenobjekt mit der Quell-XLT-Datei als Parameter
...
- Für XLT-Modifikationen Microsoft Windows oder ein kompatibles Betriebssystem mit .NET-, .NET Core-, Mono- oder Xamarin-Plattformen
...
{{% blocks/products/pf/agp/code-block title="Code - XLT-Datei in .NET aktualisieren" offSpacer="" %}}
