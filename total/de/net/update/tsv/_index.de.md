---
title: Aktualisieren Sie die TSV-Datei mit .NET
description: Ändern Sie TSV-Dokumente in C#-VB.NET-Anwendungen, ohne Microsoft Excel zu verwenden. 
url: /de/net/update/tsv/
family: total
platformtag: .NET
feature: update
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="Aktualisieren Sie die TSV-Datei über .NET" h2="Ändern Sie TSV-Tabellen über Ihre .NET-basierten Anwendungen, ohne Microsoft Office<sup>&reg;</sup> zu installieren." >}}

{{% blocks/products/pf/feature-page-summary %}}

Wer versucht als Entwickler, TSV-Dateien über eine .NET-Anwendung zu aktualisieren? [Aspose.Total for .NET](https://products.aspose.com/total/net/) API kann helfen, den Aktualisierungsprozess zu automatisieren. Es ist ein vollständiges Paket verschiedener .NET-APIs, die verschiedene Formate verarbeiten, einschließlich Microsoft Excel-Dateien. Die ASPOSE.CELL-API, die Teil des [Aspose.Total for .NET](https://products.aspose.com/total/net/)-Pakets ist, vereinfacht diesen Änderungsprozess. Nachfolgend ist der Vorgang zum Aktualisieren des TSV-Dokuments beschrieben.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="So aktualisieren Sie die TSV-Datei in .NET" %}}

- Erstellen Sie ein neues [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/)-Klassenobjekt mit der Quell-TSV-Datei als Parameter
...
- Speichern Sie die Datei als .tsv-Datei mit der Methode save(), indem Sie die Datei mit dem Pfad als Parameter übergeben

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Änderungsanforderungen" %}}

- Für TSV-Modifikationen Microsoft Windows oder ein kompatibles Betriebssystem mit .NET-, .NET Core-, Mono- oder Xamarin-Plattformen
...
{{% blocks/products/pf/agp/code-block title="Code - TSV-Datei in .NET aktualisieren" offSpacer="" %}}
