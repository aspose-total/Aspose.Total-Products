---
title: Anzeigen und Aktualisieren von PPT-Eigenschaften online oder Aktualisieren von Metadaten mit .NET
description: Zeigen Sie PPT-Eigenschaften kostenlos über die Online-App an und ändern Sie sie. C# .NET API-Code zum Aktualisieren von PPT-Eigenschaften.
...
{{< blocks/products/pf/feature-page-header-widget h1="PPT-Metadaten online anzeigen oder aktualisieren oder über .NET aktualisieren" h2="Entwickeln Sie eine leistungsstarke, auf .NET basierende PPT-Dienstprogrammanwendung für die Metadatenverwaltung von Dokumenten.Code zum Aktualisieren von PPT-Metadaten über .NET aufgeführt." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Aktualisieren Sie die PPT-Eigenschaften über .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-Code: PPT-Metadaten aktualisieren" offSpacer="" %}}
...
<h2>Entwickeln Sie eine PPT-Metadatenverwaltungsanwendung über .NET</h2>

Müssen Sie eine PPT-Metadatenverwaltungs-App oder ein Dienstprogramm entwickeln?Da [Aspose.Slides for .NET](https://products.aspose.com/slides/de/net/) eine untergeordnete API von [Aspose.Total for .NET](https://products.aspose.com/total/de/net/) ist, kann jeder .NET-Entwickler den oben genannten API-Code in seine Dokumentmetadatenanwendung integrieren.Die leistungsstarke .NET-Bibliothek ermöglicht die Programmierung beliebiger Dokumentmetadatenlösungen.Darüber hinaus unterstützt es viele gängige Formate, einschließlich des PPT-Formats.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-Dienstprogramm zum Verwalten von PPT-Metadaten" %}}
