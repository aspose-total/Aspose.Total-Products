---
title: Konvertieren Sie PCL über die C#-API in XLT
description: C#-API zum Konvertieren von PCL-Dateien in XLT ohne Verwendung von Microsoft Excel oder Adobe Reader
url_ignore: /de/net/conversion/pcl-to-xlt/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Rendern von PCL in XLT" h2="PCL-Datei über C# in XLT exportieren, ohne Microsoft<sup>&reg;</sup> Excel oder Adobe<sup>&reg;</sup> Acrobat Reader zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Mit [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie PCL-Dateien in allen .NET-, C#-, ASP.NET- und VB.NET-Anwendungen problemlos in XLT konvertieren. Erstens können Sie mit [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) PCL nach XLSX exportieren. Danach können Sie mithilfe der [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API XLSX in XLT konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-API zum Konvertieren von PCL in XLT" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie geschütztes PCL in XLT über C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie die PCL-Datei in XLT mit Wasserzeichen über C#" %}}
