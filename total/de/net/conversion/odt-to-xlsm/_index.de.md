...
description: C#-API zum Konvertieren von ODT in XLSM ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/odt-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von ODT in XLSM" h2="ODT über C# in XLSM exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
