---
title: .NET-API zum Konvertieren von WORDML in SXC
description: C#-API zum Konvertieren von WORDML in SXC ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/wordml-to-sxc/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von WORDML in SXC" h2="WORDML über C# in SXC exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
