---
title: .NET-API zum Konvertieren von WORDML in XLSX
description: C#-API zum Konvertieren von WORDML in XLSX ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/wordml-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von WORDML in XLSX" h2="WORDML über C# in XLSX exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
