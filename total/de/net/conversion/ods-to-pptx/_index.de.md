---
title: Konvertieren Sie ODS in PPTX mit .NET 
description: Konvertieren Sie ODS in PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie ODS in PPTX über C#" h2="Excel exportieren&reg; ODS zu PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen">}}
