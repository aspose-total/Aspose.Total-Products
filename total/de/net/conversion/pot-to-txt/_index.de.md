...
1. Erstellen Sie [Aspose.Words.Txtument](https://apireference.aspose.com/words/net/aspose.words/txtument) und initialisieren Sie es mit dem MemoryStream-Objekt
1. Speichern Sie das Dokument mit [Aspose.Words.Txtument.Save("output.txt", SaveFormat.Txt)](https://apireference.aspose.com/words/net/aspose.words.txtument/save/methods /3)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/net/conversion/pot-to-txtx" name="POT Zu TXTX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/net/conversion/pot-to-txtm" name="POT Zu TXTM" description="" >}}
