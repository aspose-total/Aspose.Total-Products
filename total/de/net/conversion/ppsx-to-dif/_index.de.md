---
title: Konvertieren Sie PPSX über C# in DIF
description: Konvertieren Sie PPSX in C# in DIF, ohne Microsoft Excel oder Powerpoint zu verwenden
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie PPSX über C# in DIF" h2=".NET-API für die PPSX-zu-DIF-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
1. Öffnen Sie die PPSX-Datei mit der Klasse [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation).
2. Exportieren Sie PPSX als HTML mit der Methode [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5).
