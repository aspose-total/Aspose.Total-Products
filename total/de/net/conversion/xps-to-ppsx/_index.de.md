...
<iframe title="Kostenlose Online-App zur Konvertierung von XPS in PPSX" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppsx&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Konvertieren Sie XPS in PPSX über C# .NET" offSpacer="" %}}
