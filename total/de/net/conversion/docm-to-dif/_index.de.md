...
description: C#-API zum Konvertieren von DOCM in DIF ohne Verwendung von Microsoft Excel oder Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOCM in DIF" h2="DOCM über C# in DIF exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
