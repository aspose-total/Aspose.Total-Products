...
description: C#-API zum Konvertieren von DOCM in XLSX ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/docm-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOCM in XLSX" h2="DOCM über C# in XLSX exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
