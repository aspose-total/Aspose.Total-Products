---
title: Konvertieren Sie XLSB in PPTX mit .NET 
description: Konvertieren Sie XLSB in PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie XLSB in PPTX über C#" h2="Excel exportieren&reg; XLSB zu PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen">}}
