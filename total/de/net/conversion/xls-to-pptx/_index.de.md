---
title: Konvertieren Sie XLS in PPTX mit .NET 
description: Konvertieren Sie XLS in PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie XLS in PPTX über C#" h2="Excel exportieren&reg; XLS zu PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen">}}
