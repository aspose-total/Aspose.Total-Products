...
description: C#-API zum Konvertieren von DOC in XLTM ohne Verwendung von Microsoft Excel oder Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von DOC in XLTM" h2="DOC über C# in XLTM exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
