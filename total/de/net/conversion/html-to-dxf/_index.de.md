---
title: Konvertieren Sie HTML über die C#-API in DXF
description: Exportieren Sie HTML in DXF in Ihren .NET-Anwendungen, ohne Anwendungen von Drittanbietern zu verwenden
url_ignore: /de/net/conversion/html-to-dxf/
family: total
platformtag: net
feature: conversion
informat: HTML
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie die HTML-Datei über C# in DXF" h2="Exportieren Sie HTML innerhalb von .NET-Anwendungen nach DXF, ohne Adobe<sup>&reg;</sup> Acrobat Reader oder andere Anwendungen von Drittanbietern zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Mit [Aspose.Total for .NET](https://products.aspose.com/total/net/) können Sie in zwei einfachen Schritten HTML-Bilder in DXF-Bilder aus beliebigen .NET-Anwendungen exportieren. Zunächst einmal können Sie mit [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) HTML in JPEG exportieren. Danach können Sie mit der Bildverarbeitungs-API von [Aspose.Imaging for .NET](https://products.aspose.com/imaging/net/) JPEG in DXF konvertieren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie die HTML-Datei über .NET in DXF" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie HTML-Dateien in DXF in einer einzigen Datei über C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren und Drehen von HTML-Dateien in DXF über C#" %}}
