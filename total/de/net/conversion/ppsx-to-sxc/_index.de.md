---
title: Konvertieren Sie PPSX über C# in SXC
description: Konvertieren Sie PPSX in C# in SXC, ohne Microsoft Excel oder Powerpoint zu verwenden
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konvertieren Sie PPSX über C# in SXC" h2=".NET-API für die PPSX-zu-SXC-Konvertierung ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
...
4. Speichern Sie das Dokument mit der Methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) im SXC-Format
