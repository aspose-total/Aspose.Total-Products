...
description: C#-API zum Konvertieren von OTT in EXCEL ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/ott-to-excel/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von OTT in EXCEL" h2="OTT über C# in EXCEL exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
