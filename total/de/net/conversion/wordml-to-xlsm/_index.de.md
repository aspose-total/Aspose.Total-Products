---
title: .NET-API zum Konvertieren von WORDML in XLSM
description: C#-API zum Konvertieren von WORDML in XLSM ohne Verwendung von Microsoft Excel oder Adobe Reader
url: /de/net/conversion/wordml-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C#-API zum Konvertieren von WORDML in XLSM" h2="WORDML über C# in XLSM exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
4. Speichern Sie das Dokument mit der Methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) im XLSM-Format und legen Sie „XLSM“ als SaveFormat fest
