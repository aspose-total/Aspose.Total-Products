...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konvertieren Sie XLT in PPTX über C# oder Online-App" h2="Excel exportieren&reg; XLT zu PPTX auf .NET Framework-, .NET Core-, Mono- oder Xamarin-Plattformen">}}
