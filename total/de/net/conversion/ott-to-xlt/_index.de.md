...
1. Öffnen Sie die OTT-Datei mit der Klasse [Document](https://apireference.aspose.com/words/net/aspose.words/ottument).
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) ermöglicht es Ihnen auch, OTT-Dokumente per Stream zu laden. Um ein Dokument aus einem Stream zu öffnen, übergeben Sie einfach ein Stream-Objekt, das das Dokument enthält, an den Konstruktor [Document](https://apireference.aspose.com/words/net/aspose.words/ottument). Das folgende Codebeispiel zeigt, wie Sie ein Dokument aus einem Stream öffnen:  
{{% blocks/products/pf/feature-page-code %}}
