---
title: Entfernen Sie ODP-Anmerkungen online oder verwalten Sie Anmerkungen über .NET
description: Löschen Sie Kommentare aus der ODP-Datei kostenlos über die Online-App..NET-API-Code zum Verwalten von Kommentaren von ODP-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus der ODP-Präsentation online oder verwalten Sie sie über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte ODP-Dienstprogrammanwendung für Präsentationsanmerkungen.Code zum Verwalten von Kommentaren der ODP-Datei über .NET aufgeführt." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie ODP-Präsentationskommentare über .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-Code: Kommentare und Autoren aus der ODP-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie ODP-Präsentationskommentare über .NET hinzu" %}}
...
<h2>Entwickeln Sie eine ODP-Dokumentanmerkungsanwendung über .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-Bibliothek zum Kommentieren von ODP-Dateien" %}}
