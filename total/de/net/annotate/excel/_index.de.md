---
title: Entfernen Sie Excel-Anmerkungen online oder verwalten Sie Anmerkungen über .NET
description: Löschen Sie Kommentare aus der Excel-Datei kostenlos über die Online-App..NET-API-Code zum Verwalten von Kommentaren von Excel-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus Excel-Dokumenten online oder verwalten Sie sie über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte Excel-Dienstprogrammanwendung für Dokumentanmerkungen.Code zum Verwalten von Kommentaren der Excel-Datei über .NET aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie Excel-Anmerkungen online" %}}

1. Importieren Sie die Excel-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie Excel-Kommentare über .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-Code: Kommentare aus der Excel-Datei löschen" offSpacer="" %}}
