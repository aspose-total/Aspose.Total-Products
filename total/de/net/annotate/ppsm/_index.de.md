---
title: Entfernen Sie PPSM-Anmerkungen online oder verwalten Sie Anmerkungen über .NET
description: Löschen Sie Kommentare aus der PPSM-Datei kostenlos über die Online-App..NET-API-Code zum Verwalten von Kommentaren von PPSM-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus der PPSM-Präsentation online oder verwalten Sie sie über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte PPSM-Dienstprogrammanwendung für Präsentationsanmerkungen.Code zum Verwalten von Kommentaren der PPSM-Datei über .NET aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie PPSM-Anmerkungen online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie PPSM-Präsentationskommentare über .NET" %}}

1. Bibliotheksverweis zum .NET-Projekt hinzufügen
1. Laden Sie PPSM über das Präsentationsklassenobjekt
1. Durchlaufen Sie jeden Autor über „presentation.CommentAuthors“.
1. Rufen Sie die Methode Comments.Clear() auf, um den Kommentar zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie PPSM-Präsentationskommentare über .NET hinzu" %}}

1. Bibliotheksverweis zum .NET-Projekt hinzufügen
1. Laden Sie PPSM über das Präsentationsklassenobjekt
1. Fügen Sie mit der AddEmptySlide-Methode eine leere Folie hinzu
1. Verwenden Sie CommentAuthors.AddAuthor, um den neuen Autor hinzuzufügen
1. Verwenden Sie den neuen Autor mit Comments.AddComment zum Einfügen von Kommentaren
...
{{% blocks/products/pf/agp/code-block title=".NET-Code: Kommentare hinzufügen" offSpacer="" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sie können jeden modernen Webbrowser wie Google Chrome, Firefox, Opera oder Safari für die Online-Anmerkung von PPSM-Dokumenten verwenden.Wenn Sie jedoch eine Desktop-Anwendung entwickeln, empfehlen wir für eine effiziente Verwaltung die Verwendung der Aspose.Total-Dokumentverarbeitungs-API.</span>
                      </div>
                  </li>
              </ul>
          </div>
