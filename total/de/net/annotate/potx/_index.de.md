---
title: Entfernen Sie POTX-Anmerkungen online oder verwalten Sie Anmerkungen über .NET
description: Löschen Sie Kommentare aus der POTX-Datei kostenlos über die Online-App..NET-API-Code zum Verwalten von Kommentaren von POTX-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus der POTX-Präsentation online oder verwalten Sie sie über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte POTX-Dienstprogrammanwendung für Präsentationsanmerkungen.Code zum Verwalten von Kommentaren der POTX-Datei über .NET aufgeführt." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie POTX-Präsentationskommentare über .NET" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie POTX-Präsentationskommentare über .NET hinzu" %}}
...
<h2>Entwickeln Sie eine POTX-Dokumentanmerkungsanwendung über .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-Bibliothek zum Kommentieren von POTX-Dateien" %}}
