---
title: Entfernen Sie PPTX-Anmerkungen online oder verwalten Sie Anmerkungen über .NET
description: Löschen Sie Kommentare aus der PPTX-Datei kostenlos über die Online-App..NET-API-Code zum Verwalten von Kommentaren von PPTX-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Löschen Sie Kommentare aus der PPTX-Präsentation online oder verwalten Sie sie über .NET" h2="Entwickeln Sie eine leistungsstarke .NET-basierte PPTX-Dienstprogrammanwendung für Präsentationsanmerkungen.Code zum Verwalten von Kommentaren der PPTX-Datei über .NET aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie PPTX-Anmerkungen online" %}}

1. Importieren Sie die PPTX-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie PPTX-Präsentationskommentare über .NET" %}}

1. Bibliotheksverweis zum .NET-Projekt hinzufügen
1. Laden Sie PPTX über das Präsentationsklassenobjekt
...
{{% blocks/products/pf/agp/code-block title="C#-Code: Kommentare und Autoren aus der PPTX-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie PPTX-Präsentationskommentare über .NET hinzu" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Ist es sicher, die Online-App zum Kommentieren von PPTX-Dokumenten zu verwenden?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sie können jeden modernen Webbrowser wie Google Chrome, Firefox, Opera oder Safari für die Online-Anmerkung von PPTX-Dokumenten verwenden.Wenn Sie jedoch eine Desktop-Anwendung entwickeln, empfehlen wir für eine effiziente Verwaltung die Verwendung der Aspose.Total-Dokumentverarbeitungs-API.</span>
                      </div>
                  </li>
              </ul>
          </div>
