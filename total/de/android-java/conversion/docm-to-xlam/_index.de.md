---
title: Android-API zum Konvertieren von DOCM in XLAM
description: Konvertieren Sie DOCM in XLAM in Android über Java, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/android-java/conversion/docm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie DOCM in XLAM in Android-Anwendungen" h2="Exportieren Sie DOCM in Android über Java in XLAM, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total für Android über Java](https://products.aspose.com/total/android-java/) können Sie die DOCM-zu-XLAM-Konvertierungsfunktion in Ihre Android-Anwendungen integrieren. Erstens können Sie DOCM in HTML konvertieren, indem Sie die funktionsreiche Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words für Android über Java](https://products.aspose.com/words/android-java/) verwenden. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) HTML in XLAM konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}
