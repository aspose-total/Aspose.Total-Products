---
title: Konvertieren Sie das JSON-Format in Android über Java in MOBI
description: Analysieren Sie JSON in MOBI in Java, ohne Microsoft Word zu verwenden
url: /de/android-java/conversion/json-to-mobi/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie das JSON-Format in Android-Anwendungen in MOBI" h2="Analysieren Sie JSON in MOBI in Android-Anwendungen, ohne Microsoft<sup>&reg;</sup> Word zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Sie können JSON in Ihren Android-Anwendungen in zwei Schritten in MOBI konvertieren. Erstens können Sie mit der leistungsstarken Spreadsheet Processing API [Aspose.Cells for Android via Java](https://products.aspose.com/cells/android-java/) JSON in PDF parsen. Im zweiten Schritt können Sie PDF in MOBI konvertieren, indem Sie die Textverarbeitungs-API [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/) verwenden. Beide APIs gehören zur Produktfamilie [Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/). 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie das JSON-Format in Android über Java in MOBI" %}}
...
4. Speichern Sie das Dokument im MOBI-Format mit [Save](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) Methode
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie das JSON-Format in MOBI mit Wasserzeichen in Android über Java" %}}
