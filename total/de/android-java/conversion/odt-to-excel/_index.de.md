---
title: Android-API zum Konvertieren von ODT in EXCEL
description: Konvertieren Sie ODT in EXCEL in Android über Java, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/android-java/conversion/odt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie ODT in EXCEL in Android-Anwendungen" h2="Exportieren Sie ODT in Android über Java in EXCEL, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total für Android über Java](https://products.aspose.com/total/android-java/) können Sie die ODT-zu-EXCEL-Konvertierungsfunktion in Ihre Android-Anwendungen integrieren. Erstens können Sie ODT in HTML konvertieren, indem Sie die funktionsreiche Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words für Android über Java](https://products.aspose.com/words/android-java/) verwenden. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) HTML in EXCEL konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}
