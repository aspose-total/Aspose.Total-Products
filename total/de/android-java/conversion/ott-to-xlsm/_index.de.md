---
title: Android-API zum Konvertieren von OTT in XLSM
description: Konvertieren Sie OTT in XLSM in Android über Java, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/android-java/conversion/ott-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie OTT in XLSM in Android-Anwendungen" h2="Exportieren Sie OTT in Android über Java in XLSM, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total für Android über Java](https://products.aspose.com/total/android-java/) können Sie die OTT-zu-XLSM-Konvertierungsfunktion in Ihre Android-Anwendungen integrieren. Erstens können Sie OTT in HTML konvertieren, indem Sie die funktionsreiche Dokumentbearbeitungs- und Konvertierungs-API [Aspose.Words für Android über Java](https://products.aspose.com/words/android-java/) verwenden. Danach können Sie mit [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) HTML in XLSM konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}
