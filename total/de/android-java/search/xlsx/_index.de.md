---
title: Online-Anwendung zur XLSX-Textsuche oder Entwicklung einer durchsuchbaren XLSX-App über Android
description: Kostenlose Online-App zur Suche in XLSX-Dateien. Java-Code für jede Android-Anwendung zur Textsuche in XLSX-Dateien.
family: total
platformtag: Android
feature: search
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Online durchsuchbare Dokument-App und XLSX-Textsuche-Android-API-Code" h2="Entwickeln Sie eine leistungsstarke Android-basierte XLSX-Dokumentsuchmaschinen-Dienstprogrammanwendung für Mobiltelefone. Testen Sie die Online-App zum Finden von Dokumententexten kostenlos." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So suchen Sie online in XLSX-Dateien mit der App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="So durchsuchen Sie eine XLSX-Datei über Android" %}}
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel für Android-Apps zum Durchsuchen von Text in XLSX-Dateien" offSpacer="" %}}
...
<h2>Entwickeln Sie eine Android-Anwendung für die XLSX-Dateisuche</h2>

Müssen Sie ein durchsuchbares XLSX-basiertes mobiles Dienstprogramm auf Android-Basis entwickeln? Mit Aspose.Cells für Android über Java, einer untergeordneten API von Aspose.Total für Android über Java, kann jeder Android-Entwickler den oben genannten API-Code integrieren, um die Textsuche in Dokumenten zu programmieren. Mit der leistungsstarken Android-Bibliothek können Programmierer eine Dokumentensuchlösung entwickeln, die viele gängige Formate einschließlich des XLSX-Formats unterstützt.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Android-Bibliothek zum Durchsuchen der XLSX-Datei" %}}
