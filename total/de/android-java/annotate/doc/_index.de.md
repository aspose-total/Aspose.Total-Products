---
title: DOC-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer DOC-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von DOC-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus DOC-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur DOC-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der DOC-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC-Anmerkungen online entfernen" %}}

1. Importieren Sie die DOC-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="DOC-Dokumentkommentare über die Android-App entfernen" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus DOC-Datei löschen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC-Kommentarantwort entfernen und hinzufügen" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Entfernen und Hinzufügen einer Kommentarantwort aus einer DOC-Datei" offSpacer="" %}}
