---
title: ODP-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer ODP-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von ODP-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus der ODP-Präsentation online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur Kommentierung von ODP-Präsentationen.Aufgelisteter Code zum Verwalten von Kommentaren der ODP-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODP-Anmerkungen online entfernen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP-Präsentationskommentare über die Android-App entfernen" %}}

1. Bibliotheksverweis zum Android-Projekt hinzufügen
1. Laden Sie ODP über das Objekt der Präsentationsklasse
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare und Autoren aus der ODP-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP-Präsentationskommentare über die Android-App hinzufügen" %}}
