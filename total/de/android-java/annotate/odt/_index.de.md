---
title: ODT-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer ODT-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von ODT-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus ODT-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur ODT-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der ODT-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT-Anmerkungen online entfernen" %}}

1. Importieren Sie die ODT-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="ODT-Dokumentkommentare über die Android-App entfernen" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus ODT-Datei löschen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT-Kommentarantwort entfernen und hinzufügen" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Entfernen und Hinzufügen einer Kommentarantwort aus einer ODT-Datei" offSpacer="" %}}
