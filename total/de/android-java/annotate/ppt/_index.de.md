---
title: PPT-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer PPT-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von PPT-Dateien.
...
{{% blocks/products/pf/agp/feature-section-col title="PPT-Präsentationskommentare über die Android-App entfernen" %}}

1. Bibliotheksverweis zum Android-Projekt hinzufügen
1. Laden Sie PPT über das Objekt der Präsentationsklasse
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare und Autoren aus der PPT-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PPT-Präsentationskommentare über die Android-App hinzufügen" %}}
