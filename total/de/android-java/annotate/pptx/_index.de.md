---
title: PPTX-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer PPTX-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von PPTX-Dateien.
...
{{% blocks/products/pf/agp/feature-section-col title="PPTX-Präsentationskommentare über die Android-App entfernen" %}}

1. Bibliotheksverweis zum Android-Projekt hinzufügen
1. Laden Sie PPTX über das Objekt der Präsentationsklasse
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare und Autoren aus der PPTX-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PPTX-Präsentationskommentare über die Android-App hinzufügen" %}}
