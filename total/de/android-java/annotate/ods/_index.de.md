---
title: ODS-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer ODS-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von ODS-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus ODS-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur ODS-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der ODS-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODS-Anmerkungen online entfernen" %}}

1. Importieren Sie die ODS-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie ODS-Dokumentkommentare über die Android App API" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus ODS-Dokument entfernen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Threadierte ODS-Kommentare aktualisieren" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Thread-Kommentar der ODS-Datei aktualisieren" offSpacer="" %}}
