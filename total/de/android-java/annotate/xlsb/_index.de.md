---
title: XLSB-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer XLSB-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von XLSB-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus XLSB-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur XLSB-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der XLSB-Datei." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie XLSB-Dokumentkommentare über die Android App API" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus XLSB-Dokument entfernen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Threadierte XLSB-Kommentare aktualisieren" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Thread-Kommentar der XLSB-Datei aktualisieren" offSpacer="" %}}
