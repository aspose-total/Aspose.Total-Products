---
title: XLT-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer XLT-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von XLT-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus XLT-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur XLT-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der XLT-Datei." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie XLT-Dokumentkommentare über die Android App API" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus XLT-Dokument entfernen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Threadierte XLT-Kommentare aktualisieren" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Thread-Kommentar der XLT-Datei aktualisieren" offSpacer="" %}}
