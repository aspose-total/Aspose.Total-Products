---
title: XLSM-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer XLSM-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von XLSM-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus XLSM-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur XLSM-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der XLSM-Datei." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie XLSM-Dokumentkommentare über die Android App API" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus XLSM-Dokument entfernen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Threadierte XLSM-Kommentare aktualisieren" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Thread-Kommentar der XLSM-Datei aktualisieren" offSpacer="" %}}
