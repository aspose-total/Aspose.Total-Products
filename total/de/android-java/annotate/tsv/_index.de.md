---
title: TSV-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer TSV-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von TSV-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus TSV-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur TSV-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der TSV-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="TSV-Anmerkungen online entfernen" %}}

1. Importieren Sie die TSV-Datei, um Kommentare durch Hochladen zu löschen
1. Klicken Sie dazu per Drag & Drop der Annotation-App in den Drop-Bereich
1. Warten Sie je nach Größe der TSV-Datei und Internetgeschwindigkeit einige Sekunden
1. Klicken Sie auf die Schaltfläche „Entfernen“, um Kommentare zu löschen
1. Laden Sie die Datei sofort herunter

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Entfernen Sie TSV-Dokumentkommentare über die Android App API" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus TSV-Dokument entfernen" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Threadierte TSV-Kommentare aktualisieren" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Thread-Kommentar der TSV-Datei aktualisieren" offSpacer="" %}}
