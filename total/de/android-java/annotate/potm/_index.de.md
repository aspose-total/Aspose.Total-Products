---
title: POTM-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer POTM-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von POTM-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus der POTM-Präsentation online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur Kommentierung von POTM-Präsentationen.Aufgelisteter Code zum Verwalten von Kommentaren der POTM-Datei." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="POTM-Anmerkungen online entfernen" %}}

1. Importieren Sie die POTM-Datei, um Kommentare durch Hochladen zu löschen
...
{{% blocks/products/pf/agp/feature-section-col title="POTM-Präsentationskommentare über die Android-App entfernen" %}}

1. Bibliotheksverweis zum Android-Projekt hinzufügen
1. Laden Sie POTM über das Objekt der Präsentationsklasse
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare und Autoren aus der POTM-Präsentation löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="POTM-Präsentationskommentare über die Android-App hinzufügen" %}}
