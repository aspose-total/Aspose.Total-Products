---
title: DOCM-Anmerkungen online entfernen oder Anmerkungen mit mobilen Android-Apps verwalten
description: Löschen Sie Kommentare kostenlos aus einer DOCM-Datei über die Online-App.Android-API-Code zum Verwalten von Kommentaren von DOCM-Dateien.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kommentare aus DOCM-Dokumenten online löschen oder über Android-Apps verwalten" h2="Entwickeln Sie eine leistungsstarke, Android-basierte Dienstprogrammanwendung zur DOCM-Dokumentanmerkung.Aufgelisteter Code zum Verwalten von Kommentaren der DOCM-Datei." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOCM-Dokumentkommentare über die Android-App entfernen" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Kommentare aus DOCM-Datei löschen" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="Code: Entfernen und Hinzufügen einer Kommentarantwort aus einer DOCM-Datei" offSpacer="" %}}
