---
title: Konvertieren Sie XLT mit Python in Image
description: XLT zu Bild TIFF BMP PNG JPEG GIF EMF SVG-Konvertierung in Ihren Python-Anwendungen ohne Verwendung von Microsoft Excel 
url: /de/python-java/conversion/xlt-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLT
...
- Speichern Sie alle Seiten des Arbeitsblatts als Bild mit der [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String))-Methode. Jetzt wird die XLT-Datei im angegebenen Pfad in Bilder konvertiert

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Konvertierungsanforderungen" %}}

- Verweisen Sie für die Konvertierung von XLT in Bilder (JPG, PNG, GIF, BMP, TIFF) auf APIs innerhalb des Projekts direkt von PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/)).
...
{{% blocks/products/pf/agp/code-block title="Konvertierung von XLT in Bilder über Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLT Vorstellen" description="" >}}
