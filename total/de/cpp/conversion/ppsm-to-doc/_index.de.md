---
title: C++-API zum Konvertieren von PPSM in DOC
description: Exportieren Sie PPSM in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSM in DOC" h2="Exportieren Sie PPSM in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
