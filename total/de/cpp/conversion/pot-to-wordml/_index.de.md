---
title: C++-API zum Konvertieren von POT in WORDML
description: Exportieren Sie POT in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in WORDML" h2="Exportieren Sie POT in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
