---
title: C++-API zum Konvertieren von POTM in FLATOPC
description: Exportieren Sie POTM in FLATOPC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in FLATOPC" h2="Exportieren Sie POTM in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
