---
title: Konvertieren Sie DOCX in XLS in C++
description: C++-API zum Konvertieren von DOCX in XLS, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/cpp/conversion/docx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOCX in XLS" h2="DOCX über C++ in XLS exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOCX in XLS" %}}
