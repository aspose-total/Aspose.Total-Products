---
title: C++-API zum Konvertieren von PPS in DOCM
description: Exportieren Sie PPS in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in DOCM" h2="Exportieren Sie PPS in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
