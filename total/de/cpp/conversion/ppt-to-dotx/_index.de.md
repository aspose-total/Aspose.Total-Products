---
title: C++-API zum Konvertieren von PPT in DOTX
description: Exportieren Sie PPT in DOTX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppt-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPT in DOTX" h2="Exportieren Sie PPT in DOTX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
