---
title: Konvertieren Sie SXC in WORD mit C++
description: Konvertieren Sie SXC in WORD innerhalb von C++-Anwendungen
url: /de/cpp/conversion/sxc-to-word/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie SXC über C++ in WORD" h2="Excel exportieren&reg; SXC zu WORD innerhalb voll funktionsfähiger C++-Anwendungen" >}}
