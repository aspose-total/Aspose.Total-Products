---
title: C++-API zum Konvertieren von PPTX in RTF
description: Exportieren Sie PPTX in RTF innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in RTF" h2="Exportieren Sie PPTX in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
