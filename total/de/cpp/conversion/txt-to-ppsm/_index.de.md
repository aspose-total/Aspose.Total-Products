---
title: Konvertieren Sie TXT über C++ in PPSM
description: Exportieren Sie TXT in PPSM in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/txt-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von TXT in PPSM" h2="Exportieren Sie TXT in PPSM innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
