---
title: C++-API zum Konvertieren von PPSM in DOT
description: Exportieren Sie PPSM in DOT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSM in DOT" h2="Exportieren Sie PPSM in DOT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
