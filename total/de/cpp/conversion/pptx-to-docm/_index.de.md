---
title: C++-API zum Konvertieren von PPTX in DOCM
description: Exportieren Sie PPTX in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOCM" h2="Exportieren Sie PPTX in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
