---
title: C++-API zum Konvertieren von PPSX in DOCM
description: Exportieren Sie PPSX in DOCM innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in DOCM" h2="Exportieren Sie PPSX in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
