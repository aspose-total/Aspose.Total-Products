---
title: C++-API zum Konvertieren von PPTX in FLATOPC
description: Exportieren Sie PPTX in FLATOPC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in FLATOPC" h2="Exportieren Sie PPTX in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
