---
title: C++-API zum Konvertieren von POWERPOINT in TEXT
description: Exportieren Sie POWERPOINT in TEXT innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in TEXT" h2="Exportieren Sie POWERPOINT in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
