---
title: Konvertieren Sie ODT über C++ in PPSX
description: Exportieren Sie ODT in PPSX in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/odt-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von ODT in PPSX" h2="Exportieren Sie ODT in PPSX innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
