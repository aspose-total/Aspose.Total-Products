---
title: C++-API zum Konvertieren von POTM in WORD
description: Exportieren Sie POTM in WORD innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in WORD" h2="Exportieren Sie POTM in WORD in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
