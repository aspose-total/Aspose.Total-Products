---
title: Konvertieren Sie TXT über C++ in PPTX
description: Exportieren Sie TXT in PPTX in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/txt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von TXT in PPTX" h2="Exportieren Sie TXT in PPTX innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
