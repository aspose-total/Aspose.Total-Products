---
title: Konvertieren Sie DOC in XLS in C++
description: C++-API zum Konvertieren von DOC in XLS, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/cpp/conversion/doc-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOC in XLS" h2="DOC über C++ in XLS exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOC in XLS" %}}
