---
title: Konvertieren Sie RTF über C++ in ODP
description: Exportieren Sie RTF in ODP in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/rtf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von RTF in ODP" h2="Exportieren Sie RTF in ODP innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
