---
title: C++-API zum Konvertieren von PPTM in DOT
description: Exportieren Sie PPTM in DOT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in DOT" h2="Exportieren Sie PPTM in DOT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
