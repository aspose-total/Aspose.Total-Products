---
title: C++-API zum Konvertieren von PPSX in TEXT
description: Exportieren Sie PPSX in TEXT innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in TEXT" h2="Exportieren Sie PPSX in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
