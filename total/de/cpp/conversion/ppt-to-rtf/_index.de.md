---
title: C++-API zum Konvertieren von PPT in RTF
description: Exportieren Sie PPT in RTF innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppt-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPT in RTF" h2="Exportieren Sie PPT in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
