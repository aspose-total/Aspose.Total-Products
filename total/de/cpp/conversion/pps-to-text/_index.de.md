---
title: C++-API zum Konvertieren von PPS in TEXT
description: Exportieren Sie PPS in TEXT innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in TEXT" h2="Exportieren Sie PPS in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
