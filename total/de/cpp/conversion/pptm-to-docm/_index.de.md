---
title: C++-API zum Konvertieren von PPTM in DOCM
description: Exportieren Sie PPTM in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in DOCM" h2="Exportieren Sie PPTM in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
