---
title: C++-API zum Konvertieren von POWERPOINT in OTT
description: Exportieren Sie POWERPOINT in OTT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in OTT" h2="Exportieren Sie POWERPOINT in OTT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
