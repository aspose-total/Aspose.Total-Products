---
title: Konvertieren Sie ODT über C++ in ODP
description: Exportieren Sie ODT in ODP in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/odt-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von ODT in ODP" h2="Exportieren Sie ODT in ODP innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
