---
title: C++-API zum Konvertieren von POWERPOINT in DOTX
description: Exportieren Sie POWERPOINT in DOTX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in DOTX" h2="Exportieren Sie POWERPOINT in DOTX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
