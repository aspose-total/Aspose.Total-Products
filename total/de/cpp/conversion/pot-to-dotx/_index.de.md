---
title: C++-API zum Konvertieren von POT in DOTX
description: Exportieren Sie POT in DOTX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in DOTX" h2="Exportieren Sie POT in DOTX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
