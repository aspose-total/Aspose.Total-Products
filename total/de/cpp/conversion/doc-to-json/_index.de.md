---
title: Konvertieren Sie DOC in das JSON-Format in C++
description: Exportieren Sie DOC in JSON in C++, ohne Microsoft Excel oder Word zu verwenden
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie DOC über C++ in das JSON-Format" h2="Exportieren Sie DOC über C++ nach JSON, ohne Microsoft<sup>&reg;</sup> Word oder Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for C++](https://products.aspose.com/total/cpp/) können Sie DOC in das JSON-Format innerhalb Ihrer C++-Anwendungen konvertieren. Erstens können Sie mit [Aspose.Words for C++](https://products.aspose.com/words/cpp/) DOC in HTML exportieren. Danach können Sie mithilfe von [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) HTML in das JSON-Format konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie DOC über C++ in das JSON-Format" %}}
...
4. Speichern Sie das Dokument mit der Member-Funktion [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997) im JSON-Format
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie geschütztes DOC über C++ in das JSON-Format" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/cpp/conversion/doc-to-csv/" name="DOC Zu CSV" description="" >}}
