---
title: C++-API zum Konvertieren von PPTX in OTT
description: Exportieren Sie PPTX in OTT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in OTT" h2="Exportieren Sie PPTX in OTT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
