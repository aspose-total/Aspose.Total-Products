---
title: C++-API zum Konvertieren von POT in TEXT
description: Exportieren Sie POT in TEXT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in TEXT" h2="Exportieren Sie POT in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
