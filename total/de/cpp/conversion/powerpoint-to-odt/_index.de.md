---
title: C++-API zum Konvertieren von POWERPOINT in ODT
description: Exportieren Sie POWERPOINT in ODT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in ODT" h2="Exportieren Sie POWERPOINT in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
