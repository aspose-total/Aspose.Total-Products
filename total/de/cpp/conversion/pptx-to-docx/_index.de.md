---
title: C++-API zum Konvertieren von PPTX in DOCX
description: Exportieren Sie PPTX in DOCX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOCX" h2="Exportieren Sie PPTX in DOCX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
