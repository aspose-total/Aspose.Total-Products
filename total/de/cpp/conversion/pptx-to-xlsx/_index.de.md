...
description: Exportieren Sie PPTX in C++ in XLSX, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/cpp/conversion/pptx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie PPTX über C++ in XLSX" h2="PPTX-zu-XLSX-Dateikonvertierung über C++ ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
