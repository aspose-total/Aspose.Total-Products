---
title: C++-API zum Konvertieren von POT in ODT
description: Exportieren Sie POT in ODT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in ODT" h2="Exportieren Sie POT in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
