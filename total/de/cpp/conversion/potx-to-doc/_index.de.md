---
title: C++-API zum Konvertieren von POTX in DOC
description: Exportieren Sie POTX in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in DOC" h2="Exportieren Sie POTX in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
