---
title: Konvertieren Sie TXT über C++ in POTM
description: Exportieren Sie TXT in POTM in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/txt-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von TXT in POTM" h2="Exportieren Sie TXT in POTM innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
