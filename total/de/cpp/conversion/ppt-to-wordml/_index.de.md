---
title: C++-API zum Konvertieren von PPT in WORDML
description: Exportieren Sie PPT in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPT in WORDML" h2="Exportieren Sie PPT in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
