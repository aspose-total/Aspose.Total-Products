---
title: C++-API zum Konvertieren von PPSM in DOCM
description: Exportieren Sie PPSM in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSM in DOCM" h2="Exportieren Sie PPSM in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
