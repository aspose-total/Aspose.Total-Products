---
title: Konvertieren Sie POTX über C++ in das JSON-Format
description: Exportieren Sie POTX in das JSON-Format in C++, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/cpp/conversion/potx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie POTX über C++ in das JSON-Format" h2="Exportieren Sie die POTX-Datei über C++ in das JSON-Format, ohne Microsoft<sup>&reg;</sup> Excel oder PowerPoint zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for C++](https://products.aspose.com/total/cpp/) können Sie POTX-Dateien innerhalb von C++-Anwendungen in zwei einfachen Schritten in das JSON-Format konvertieren. Erstens können Sie mit [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) POTX in HTML exportieren. Danach können Sie mithilfe der Spreadsheet Programming API [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) HTML in JSON konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie POTX über C++ in das JSON-Format" %}}
