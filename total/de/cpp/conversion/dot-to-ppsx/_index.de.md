---
title: Konvertieren Sie DOT über C++ in PPSX
description: Exportieren Sie DOT in PPSX in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/dot-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOT in PPSX" h2="Exportieren Sie DOT in PPSX innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
