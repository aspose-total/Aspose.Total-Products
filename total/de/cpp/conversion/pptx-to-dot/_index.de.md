---
title: C++-API zum Konvertieren von PPTX in DOT
description: Exportieren Sie PPTX in DOT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOT" h2="Exportieren Sie PPTX in DOT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
