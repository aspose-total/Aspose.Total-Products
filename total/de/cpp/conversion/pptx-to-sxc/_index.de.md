...
description: Exportieren Sie PPTX in C++ in SXC, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/cpp/conversion/pptx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie PPTX über C++ in SXC" h2="PPTX-zu-SXC-Dateikonvertierung über C++ ohne Verwendung von Microsoft<sup>&reg;</sup> Excel oder PowerPoint" >}}
