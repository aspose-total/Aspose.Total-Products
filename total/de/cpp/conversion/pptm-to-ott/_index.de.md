---
title: C++-API zum Konvertieren von PPTM in OTT
description: Exportieren Sie PPTM in OTT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in OTT" h2="Exportieren Sie PPTM in OTT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
