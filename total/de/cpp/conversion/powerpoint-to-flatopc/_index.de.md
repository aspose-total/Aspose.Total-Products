---
title: C++-API zum Konvertieren von POWERPOINT in FLATOPC
description: Exportieren Sie POWERPOINT in FLATOPC innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in FLATOPC" h2="Exportieren Sie POWERPOINT in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
