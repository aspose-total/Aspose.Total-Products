---
title: C++-API zum Konvertieren von PPTX in DOC
description: Exportieren Sie PPTX in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOC" h2="Exportieren Sie PPTX in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
