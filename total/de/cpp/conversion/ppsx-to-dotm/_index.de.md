---
title: C++-API zum Konvertieren von PPSX in DOTM
description: Exportieren Sie PPSX in DOTM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in DOTM" h2="Exportieren Sie PPSX in DOTM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
