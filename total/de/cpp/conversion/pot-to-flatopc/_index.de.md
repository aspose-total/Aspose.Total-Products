---
title: C++-API zum Konvertieren von POT in FLATOPC
description: Exportieren Sie POT in FLATOPC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in FLATOPC" h2="Exportieren Sie POT in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
