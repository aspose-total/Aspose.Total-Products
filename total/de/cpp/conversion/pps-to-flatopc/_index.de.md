---
title: C++-API zum Konvertieren von PPS in FLATOPC
description: Exportieren Sie PPS in FLATOPC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in FLATOPC" h2="Exportieren Sie PPS in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
