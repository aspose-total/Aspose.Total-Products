---
title: C++-API zum Konvertieren von PPTM in ODT
description: Exportieren Sie PPTM in ODT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in ODT" h2="Exportieren Sie PPTM in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
