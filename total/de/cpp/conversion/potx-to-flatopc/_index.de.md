---
title: C++-API zum Konvertieren von POTX in FLATOPC
description: Exportieren Sie POTX in FLATOPC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in FLATOPC" h2="Exportieren Sie POTX in FLATOPC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
