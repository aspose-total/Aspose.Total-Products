---
title: Konvertieren Sie XLS in DOC mit C++
description: Konvertieren Sie XLS in DOC innerhalb von C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie XLS über C++ in DOC" h2="Excel exportieren&reg; XLS zu DOC innerhalb voll funktionsfähiger C++-Anwendungen" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/cpp/conversion/xls-to-docx/" name="XLS Zu DOCX" description="" >}}
