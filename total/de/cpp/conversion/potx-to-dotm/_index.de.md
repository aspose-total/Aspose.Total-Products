---
title: C++-API zum Konvertieren von POTX in DOTM
description: Exportieren Sie POTX in DOTM innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in DOTM" h2="Exportieren Sie POTX in DOTM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
