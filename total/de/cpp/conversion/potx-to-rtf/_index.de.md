---
title: C++-API zum Konvertieren von POTX in RTF
description: Exportieren Sie POTX in RTF innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in RTF" h2="Exportieren Sie POTX in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
