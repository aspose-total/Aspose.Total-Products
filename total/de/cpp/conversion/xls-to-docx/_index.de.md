---
title: Konvertieren Sie XLS in DOCX mit C++
description: Konvertieren Sie XLS in DOCX innerhalb von C++-Anwendungen
url: /de/cpp/conversion/xls-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie XLS über C++ in DOCX" h2="Excel exportieren&reg; XLS zu DOCX innerhalb voll funktionsfähiger C++-Anwendungen" >}}
