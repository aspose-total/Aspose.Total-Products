---
title: Konvertieren Sie DOT über C++ in PPTX
description: Exportieren Sie DOT in PPTX in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/dot-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOT in PPTX" h2="Exportieren Sie DOT in PPTX innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
