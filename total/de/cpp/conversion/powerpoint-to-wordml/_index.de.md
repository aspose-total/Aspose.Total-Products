---
title: C++-API zum Konvertieren von POWERPOINT in WORDML
description: Exportieren Sie POWERPOINT in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in WORDML" h2="Exportieren Sie POWERPOINT in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
