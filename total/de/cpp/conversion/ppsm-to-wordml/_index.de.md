---
title: C++-API zum Konvertieren von PPSM in WORDML
description: Exportieren Sie PPSM in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSM in WORDML" h2="Exportieren Sie PPSM in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
