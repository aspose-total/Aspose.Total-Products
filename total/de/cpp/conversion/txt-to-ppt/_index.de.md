---
title: Konvertieren Sie TXT über C++ in PPT
description: Exportieren Sie TXT in PPT in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/txt-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von TXT in PPT" h2="Exportieren Sie TXT in PPT innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
