---
title: C++-API zum Konvertieren von POTM in DOT
description: Exportieren Sie POTM in DOT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in DOT" h2="Exportieren Sie POTM in DOT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
