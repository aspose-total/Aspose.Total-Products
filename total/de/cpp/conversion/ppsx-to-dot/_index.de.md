---
title: C++-API zum Konvertieren von PPSX in DOT
description: Exportieren Sie PPSX in DOT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in DOT" h2="Exportieren Sie PPSX in DOT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
