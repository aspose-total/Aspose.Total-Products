---
title: Konvertieren Sie DOC in TSV in C++
description: C++-API zum Konvertieren von DOC in TSV, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/cpp/conversion/doc-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOC in TSV" h2="DOC über C++ in TSV exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOC in TSV" %}}
