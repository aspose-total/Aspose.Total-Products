---
title: C++-API zum Konvertieren von PPSX in ODT
description: Exportieren Sie PPSX in ODT innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in ODT" h2="Exportieren Sie PPSX in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
