---
title: C++-API zum Konvertieren von POTX in ODT
description: Exportieren Sie POTX in ODT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in ODT" h2="Exportieren Sie POTX in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
