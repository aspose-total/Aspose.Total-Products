---
title: C++-API zum Konvertieren von PPT in ODT
description: Exportieren Sie PPT in ODT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPT in ODT" h2="Exportieren Sie PPT in ODT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
