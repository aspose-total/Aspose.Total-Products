---
title: C++-API zum Konvertieren von EPUB in XAML
description: Konvertieren Sie EPUB über C++ in XAML, ohne Microsoft Word oder Adobe Acrobat Reader zu verwenden
url: /de/cpp/conversion/epub-to-xaml/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
...
Nach der Konvertierung von EPUB in XAML können Sie Ihrem Ausgabedokument auch Bilder aus dem Internet hinzufügen. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) unterstützt Operationen mit Bildern in diesen gängigen Formaten: JPEG, PNG, BMP, GIF und andere. Sie können einer Folie in einer Präsentation ein oder mehrere Bilder auf Ihrem Computer hinzufügen. Dieser Beispielcode in C++ zeigt Ihnen, wie Sie einer XAML-Datei ein Bild hinzufügen
{{% blocks/products/pf/feature-page-code %}}
