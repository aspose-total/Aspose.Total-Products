---
title: Konvertieren Sie DOCX in das JSON-Format in C++
description: Exportieren Sie DOCX in JSON in C++, ohne Microsoft Excel oder Word zu verwenden
url: /de/cpp/conversion/docx-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie DOCX über C++ in das JSON-Format" h2="Exportieren Sie DOCX über C++ nach JSON, ohne Microsoft<sup>&reg;</sup> Word oder Excel zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for C++](https://products.aspose.com/total/cpp/) können Sie DOCX in das JSON-Format innerhalb Ihrer C++-Anwendungen konvertieren. Erstens können Sie mit [Aspose.Words for C++](https://products.aspose.com/words/cpp/) DOCX in HTML exportieren. Danach können Sie mithilfe von [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) HTML in das JSON-Format konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie DOCX über C++ in das JSON-Format" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/de/cpp/conversion/docx-to-csv/" name="DOCX Zu CSV" description="" >}}
