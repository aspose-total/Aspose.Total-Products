---
title: C++-API zum Konvertieren von POTX in DOCM
description: Exportieren Sie POTX in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in DOCM" h2="Exportieren Sie POTX in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
