---
title: C++-API zum Konvertieren von PPSX in DOC
description: Exportieren Sie PPSX in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPSX in DOC" h2="Exportieren Sie PPSX in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
