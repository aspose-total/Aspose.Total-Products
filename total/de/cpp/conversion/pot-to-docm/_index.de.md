---
title: C++-API zum Konvertieren von POT in DOCM
description: Exportieren Sie POT in DOCM innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in DOCM" h2="Exportieren Sie POT in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
