---
title: Konvertieren Sie DOC in XLSB in C++
description: C++-API zum Konvertieren von DOC in XLSB, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/cpp/conversion/doc-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOC in XLSB" h2="DOC über C++ in XLSB exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOC in XLSB" %}}
