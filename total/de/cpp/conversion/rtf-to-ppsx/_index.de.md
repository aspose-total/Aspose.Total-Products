---
title: Konvertieren Sie RTF über C++ in PPSX
description: Exportieren Sie RTF in PPSX in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/rtf-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von RTF in PPSX" h2="Exportieren Sie RTF in PPSX innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
