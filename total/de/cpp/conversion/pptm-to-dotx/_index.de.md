---
title: C++-API zum Konvertieren von PPTM in DOTX
description: Exportieren Sie PPTM in DOTX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in DOTX" h2="Exportieren Sie PPTM in DOTX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
