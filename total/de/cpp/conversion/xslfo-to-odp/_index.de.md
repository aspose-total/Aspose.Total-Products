---
title: C++-API zum Konvertieren von XSLFO in ODP
description: Konvertieren Sie XSLFO über C++ in ODP, ohne Microsoft Word oder Adobe Acrobat Reader zu verwenden
url: /de/cpp/conversion/xslfo-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
...
Nach der Konvertierung von XSLFO in ODP können Sie Ihrem Ausgabedokument auch Bilder aus dem Internet hinzufügen. [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) unterstützt Operationen mit Bildern in diesen gängigen Formaten: JPEG, PNG, BMP, GIF und andere. Sie können einer Folie in einer Präsentation ein oder mehrere Bilder auf Ihrem Computer hinzufügen. Dieser Beispielcode in C++ zeigt Ihnen, wie Sie einer ODP-Datei ein Bild hinzufügen
{{% blocks/products/pf/feature-page-code %}}
