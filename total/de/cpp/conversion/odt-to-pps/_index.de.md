---
title: Konvertieren Sie ODT über C++ in PPS
description: Exportieren Sie ODT in PPS in Ihren C++-Anwendungen, ohne Microsoft Word oder PowerPoint zu verwenden
url: /de/cpp/conversion/odt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von ODT in PPS" h2="Exportieren Sie ODT in PPS innerhalb Ihrer C++-Anwendungen, ohne Microsoft Word&reg; oder PowerPoint" >}}
