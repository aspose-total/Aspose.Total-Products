---
title: C++-API zum Konvertieren von PPS in DOTM
description: Exportieren Sie PPS in DOTM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in DOTM" h2="Exportieren Sie PPS in DOTM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
