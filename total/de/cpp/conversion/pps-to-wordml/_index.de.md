---
title: C++-API zum Konvertieren von PPS in WORDML
description: Exportieren Sie PPS in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in WORDML" h2="Exportieren Sie PPS in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
