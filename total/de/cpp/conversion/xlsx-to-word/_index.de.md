---
title: Konvertieren Sie XLSX in WORD mit C++
description: Konvertieren Sie XLSX in WORD innerhalb von C++-Anwendungen
url: /de/cpp/conversion/xlsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie XLSX über C++ in WORD" h2="Excel exportieren&reg; XLSX zu WORD innerhalb voll funktionsfähiger C++-Anwendungen" >}}
