---
title: C++-API zum Konvertieren von POTX in WORDML
description: Exportieren Sie POTX in WORDML innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTX in WORDML" h2="Exportieren Sie POTX in WORDML in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
