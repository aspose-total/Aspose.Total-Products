---
title: C++-API zum Konvertieren von PPS in OTT
description: Exportieren Sie PPS in OTT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in OTT" h2="Exportieren Sie PPS in OTT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
