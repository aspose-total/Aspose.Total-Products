---
title: C++-API zum Konvertieren von POT in DOC
description: Exportieren Sie POT in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pot-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POT in DOC" h2="Exportieren Sie POT in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
