---
title: C++-API zum Konvertieren von PPTM in WORD
description: Exportieren Sie PPTM in WORD innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in WORD" h2="Exportieren Sie PPTM in WORD in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
