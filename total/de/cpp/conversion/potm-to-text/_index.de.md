---
title: C++-API zum Konvertieren von POTM in TEXT
description: Exportieren Sie POTM in TEXT innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in TEXT" h2="Exportieren Sie POTM in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
