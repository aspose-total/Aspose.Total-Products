---
title: C++-API zum Konvertieren von PPS in DOC
description: Exportieren Sie PPS in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in DOC" h2="Exportieren Sie PPS in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
