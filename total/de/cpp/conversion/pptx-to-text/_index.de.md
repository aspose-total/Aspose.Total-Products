---
title: C++-API zum Konvertieren von PPTX in TEXT
description: Exportieren Sie PPTX in TEXT innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in TEXT" h2="Exportieren Sie PPTX in TEXT in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
