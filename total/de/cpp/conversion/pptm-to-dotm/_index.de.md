---
title: C++-API zum Konvertieren von PPTM in DOTM
description: Exportieren Sie PPTM in DOTM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTM in DOTM" h2="Exportieren Sie PPTM in DOTM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
