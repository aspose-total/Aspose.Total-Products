---
title: Konvertieren Sie POWERPOINT über C++ in das JSON-Format
description: Exportieren Sie POWERPOINT in das JSON-Format in C++, ohne Microsoft Excel oder Powerpoint zu verwenden
url: /de/cpp/conversion/powerpoint-to-json/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie POWERPOINT über C++ in das JSON-Format" h2="Exportieren Sie die POWERPOINT-Datei über C++ in das JSON-Format, ohne Microsoft<sup>&reg;</sup> Excel oder PowerPoint zu verwenden" >}}

{{% blocks/products/pf/feature-page-summary %}}
Durch die Verwendung von [Aspose.Total for C++](https://products.aspose.com/total/cpp/) können Sie POWERPOINT-Dateien innerhalb von C++-Anwendungen in zwei einfachen Schritten in das JSON-Format konvertieren. Erstens können Sie mit [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/) POWERPOINT in HTML exportieren. Danach können Sie mithilfe der Spreadsheet Programming API [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) HTML in JSON konvertieren. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Konvertieren Sie POWERPOINT über C++ in das JSON-Format" %}}
...
4. Speichern Sie das Dokument im JSON-Format mit der Methode [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e).
...
{{% blocks/products/pf/feature-page-section  h2="Konvertieren Sie geschütztes POWERPOINT über C++ in das JSON-Format" %}}
