---
title: C++-API zum Konvertieren von PPTX in DOTM
description: Exportieren Sie PPTX in DOTM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOTM" h2="Exportieren Sie PPTX in DOTM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
