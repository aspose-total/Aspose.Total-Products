---
title: C++-API zum Konvertieren von POWERPOINT in RTF
description: Exportieren Sie POWERPOINT in RTF innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in RTF" h2="Exportieren Sie POWERPOINT in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
