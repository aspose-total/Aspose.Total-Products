---
title: C++-API zum Konvertieren von POWERPOINT in DOCM
description: Exportieren Sie POWERPOINT in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in DOCM" h2="Exportieren Sie POWERPOINT in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
