---
title: C++-API zum Konvertieren von POWERPOINT in WORD
description: Exportieren Sie POWERPOINT in WORD innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in WORD" h2="Exportieren Sie POWERPOINT in WORD in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
