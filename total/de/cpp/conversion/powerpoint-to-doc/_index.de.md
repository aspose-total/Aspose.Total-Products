---
title: C++-API zum Konvertieren von POWERPOINT in DOC
description: Exportieren Sie POWERPOINT in DOC innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/powerpoint-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POWERPOINT in DOC" h2="Exportieren Sie POWERPOINT in DOC in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
