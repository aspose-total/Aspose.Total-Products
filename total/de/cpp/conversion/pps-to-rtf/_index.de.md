---
title: C++-API zum Konvertieren von PPS in RTF
description: Exportieren Sie PPS in RTF innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pps-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPS in RTF" h2="Exportieren Sie PPS in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
