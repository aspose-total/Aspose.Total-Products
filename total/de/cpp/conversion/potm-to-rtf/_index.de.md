---
title: C++-API zum Konvertieren von POTM in RTF
description: Exportieren Sie POTM in RTF innerhalb Ihrer C++-Anwendungen
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in RTF" h2="Exportieren Sie POTM in RTF in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
