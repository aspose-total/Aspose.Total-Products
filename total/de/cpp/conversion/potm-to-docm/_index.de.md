---
title: C++-API zum Konvertieren von POTM in DOCM
description: Exportieren Sie POTM in DOCM innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von POTM in DOCM" h2="Exportieren Sie POTM in DOCM in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
