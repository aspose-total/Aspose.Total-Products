---
title: C++-API zum Konvertieren von PPTX in DOTX
description: Exportieren Sie PPTX in DOTX innerhalb Ihrer C++-Anwendungen
url: /de/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Rendern von PPTX in DOTX" h2="Exportieren Sie PPTX in DOTX in C++-Anwendungen ohne Microsoft PowerPoint- oder Word-Abhängigkeiten" >}}
