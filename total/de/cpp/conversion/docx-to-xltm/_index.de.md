---
title: Konvertieren Sie DOCX in XLTM in C++
description: C++-API zum Konvertieren von DOCX in XLTM, ohne Microsoft Word oder Microsoft Excel zu verwenden
url: /de/cpp/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++-API zum Konvertieren von DOCX in XLTM" h2="DOCX über C++ in XLTM exportieren, ohne Microsoft<sup>&reg;</sup> Word oder Microsoft<sup>&reg;</sup> Excel zu verwenden" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++-API zum Konvertieren von DOCX in XLTM" %}}
...
2. Konvertieren Sie DOCX in HTML, indem Sie die Member-Funktion [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string_saveformat) verwenden
