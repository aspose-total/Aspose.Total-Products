---
title: Zeigen Sie DOTX-Eigenschaften online an und aktualisieren Sie sie oder fügen Sie Metadaten mit Python hinzu
description: Zeigen Sie DOTX-Eigenschaften kostenlos über die Online-App an und ändern Sie sie.Python-API-Code zum Anzeigen und Hinzufügen von DOTX-Eigenschaften.
...
{{< blocks/products/pf/feature-page-header-widget h1="DOTX-Metadaten online anzeigen oder aktualisieren oder über Python hinzufügen" h2="Entwickeln Sie eine leistungsstarke Python-basierte DOTX-Dienstprogrammanwendung für die Metadatenverwaltung von Dokumenten.Code zum Hinzufügen und Anzeigen von DOTX-Dateimetadaten über Python aufgeführt." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOTX-Eigenschaften über Python anzeigen" %}}
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel in Python zum Anzeigen von DOTX-Metadaten" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie DOTX-Eigenschaften über Python hinzu" %}}
...
{{% blocks/products/pf/agp/code-block title="Python-Code: DOTX-Metadateninformationen hinzufügen" offSpacer="" %}}
...
<h2>Entwickeln Sie eine DOTX-Metadatenverwaltungsanwendung über Python</h2>

Müssen Sie eine DOTX-Metadatenverwaltungs-App oder ein Dienstprogramm entwickeln?Da [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/) eine untergeordnete API von [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) ist, kann jeder Python-Entwickler den oben genannten API-Code in seine Dokumentmetadatenanwendung integrieren.Die leistungsstarke Python-Bibliothek ermöglicht die Programmierung beliebiger Dokumentmetadatenlösungen.Darüber hinaus unterstützt es viele gängige Formate, einschließlich des DOTX-Formats.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python-Dienstprogramm zum Verwalten von DOTX-Metadaten" %}}
