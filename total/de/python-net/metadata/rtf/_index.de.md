---
title: Zeigen Sie RTF-Eigenschaften online an und aktualisieren Sie sie oder fügen Sie Metadaten mit Python hinzu
description: Zeigen Sie RTF-Eigenschaften kostenlos über die Online-App an und ändern Sie sie.Python-API-Code zum Anzeigen und Hinzufügen von RTF-Eigenschaften.
...
{{< blocks/products/pf/feature-page-header-widget h1="RTF-Metadaten online anzeigen oder aktualisieren oder über Python hinzufügen" h2="Entwickeln Sie eine leistungsstarke Python-basierte RTF-Dienstprogrammanwendung für die Metadatenverwaltung von Dokumenten.Code zum Hinzufügen und Anzeigen von RTF-Dateimetadaten über Python aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="RTF-Metadaten online anzeigen oder aktualisieren" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="RTF-Eigenschaften über Python anzeigen" %}}

1. Referenzieren Sie APIs innerhalb des Projekts direkt aus PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)).
1. Laden Sie die RTF-Datei mit der Document-Klasse.
1. Erhalten Sie alle integrierten Eigenschaften überbuilt_in_document_properties.
1. Rufen Sie alle benutzerdefinierten Eigenschaften über custom_document_properties ab.
1. Schleifen Sie beide und geben Sie den Namen und den Wert jeder Eigenschaft aus.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel in Python zum Anzeigen von RTF-Metadaten" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Fügen Sie RTF-Eigenschaften über Python hinzu" %}}

1. Referenzieren Sie APIs innerhalb des Projekts direkt aus PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)).
1. Laden Sie die RTF-Datei mit der Document-Klasse.
1. Rufen Sie alle benutzerdefinierten Eigenschaften über custom_document_properties ab.
1. Verwenden Sie die Methode add(), um benutzerdefinierte Eigenschaften hinzuzufügen.
1. Schleifen Sie beide und geben Sie den Namen und den Wert jeder Eigenschaft aus.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Python-Code: RTF-Metadateninformationen hinzufügen" offSpacer="" %}}
...
<h2>Entwickeln Sie eine RTF-Metadatenverwaltungsanwendung über Python</h2>

Müssen Sie eine RTF-Metadatenverwaltungs-App oder ein Dienstprogramm entwickeln?Da [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/) eine untergeordnete API von [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) ist, kann jeder Python-Entwickler den oben genannten API-Code in seine Dokumentmetadatenanwendung integrieren.Die leistungsstarke Python-Bibliothek ermöglicht die Programmierung beliebiger Dokumentmetadatenlösungen.Darüber hinaus unterstützt es viele gängige Formate, einschließlich des RTF-Formats.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python-Dienstprogramm zum Verwalten von RTF-Metadaten" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Ist es sicher, die Online-App zum Verwalten von RTF-Dokumenteigenschaften zu verwenden?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sie können jeden modernen Webbrowser wie Google Chrome, Firefox, Opera oder Safari für die Online-Verwaltung von RTF-Dokumenteigenschaften verwenden.Wenn Sie jedoch eine Desktop-Anwendung entwickeln, empfehlen wir für eine effiziente Verwaltung die Verwendung der Aspose.Total-Dokumentverarbeitungs-API.</span>
                      </div>
                  </li>
              </ul>
          </div>
