---
title: Konvertieren Sie OFT in TEXT in Python
description: Speichern Sie OFT in TEXT in Ihren Python-Anwendungen, ohne Microsoft Outlook oder Word zu verwenden 
url: /de/python-net/conversion/oft-to-text/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Konvertieren Sie OFT mit Python in TEXT" h2="Konvertierung von OFT in TEXT in Ihren Python-Anwendungen ohne Installation von Microsoft Word<sup>&reg;</sup> oder Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So konvertieren Sie OFT in TEXT in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Speichern Sie OFT in TEXT in Python" offSpacer="" %}}
