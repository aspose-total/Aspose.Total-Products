---
title: Konvertieren Sie EML in WORD in Python
description: Speichern Sie EML in WORD in Ihren Python-Anwendungen, ohne Microsoft Outlook oder Word zu verwenden 
url: /de/python-net/conversion/eml-to-word/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- Für die Konvertierung von EML in WORD ist Python 3.5 oder höher erforderlich
...
{{% blocks/products/pf/agp/code-block title="Speichern Sie EML in WORD in Python" offSpacer="" %}}
