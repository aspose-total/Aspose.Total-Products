---
title: Konvertieren Sie OFT in PDF in Python
description: Speichern Sie OFT in PDF in Ihren Python-Anwendungen, ohne Microsoft Outlook oder Word zu verwenden 
url: /de/python-net/conversion/oft-to-pdf/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
- Für die Konvertierung von OFT in PDF ist Python 3.5 oder höher erforderlich
...
{{% blocks/products/pf/agp/code-block title="Speichern Sie OFT in PDF in Python" offSpacer="" %}}
