---
title: Extrahieren Sie Text und Bilder online und mit Python aus einer PPT-Datei
description: Online-App zum Parsen von PPT-Dateien. Python-API-Code zum Extrahieren von Bildern und Text aus PPT-Dokumenten.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analysieren Sie PPT-Dateien online und extrahieren Sie Text oder Bilder über Python" h2="Entwickeln Sie eine leistungsstarke Python-basierte PPT-Dokumentparser-Dienstprogrammanwendung.Code für PPT-Bilder und Textextraktion über Python aufgeführt." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analysieren Sie das PPT-Dokument über die Online-App" %}}

1. Importieren Sie die PPT-Datei zum Parsen, indem Sie sie hochladen.
...
{{% blocks/products/pf/agp/feature-section-col title="Extrahieren Sie Text aus einer PPT-Datei mit Python" %}}

1. Referenzieren Sie APIs innerhalb des Projekts direkt aus PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Verwenden Sie für alle Arten von Text in der Präsentation PresentationFactory().get_presentation_text(string, TextExtractionArrangingMode)
1. Laden Sie die Präsentation in ein Präsentationsklassenobjekt
1. Gehen Sie alle Folien der Präsentation durch
1. Extrahieren Sie Text aus jeder Folie mit dem Array slides_text
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel in Python zum Extrahieren von PPT-Text" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Extrahieren Sie Bilder aus PPT über Python" %}}

1. Referenzieren Sie APIs innerhalb des Projekts direkt aus PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Zugriff auf die Präsentation über „Präsentation“.
1. Gehen Sie jede Folie durch
1. Holen Sie sich das Bild von der Rückseite
1. Stellen Sie das gewünschte Format ein, sofern ein Rückbild verfügbar ist
1. Durchlaufen Sie alle Folienformen und speichern Sie
...
{{% blocks/products/pf/agp/code-block title="Codebeispiel in Python zum Extrahieren von PPT-Bildern" offSpacer="" %}}
...
Müssen Sie eine PPT-Parser-App oder ein PPT-Parser-Dienstprogramm entwickeln?Da [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/) eine untergeordnete API von [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) ist, kann jeder Python-Entwickler den oben genannten API-Code in seine Dokumentparser-Anwendung integrieren.Die leistungsstarke Python-Bibliothek ermöglicht die Programmierung jeder Lösung zum Parsen von Dokumenten, um sowohl Bilder als auch Text zu extrahieren.Darüber hinaus unterstützt es viele gängige Formate, einschließlich des PPT-Formats.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python-Dienstprogramm zum Verarbeiten der PPT-Datei für die Parser-App" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Ist es sicher, die Online-App zum Parsen von PPT-Dokumenten zu verwenden?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Sie können jeden modernen Webbrowser wie Google Chrome, Firefox, Opera oder Safari für den Online-Parser von PPT-Dokumenten verwenden.Wenn Sie jedoch eine Desktop-Anwendung entwickeln, empfehlen wir für eine effiziente Verwaltung die Verwendung der Aspose.Total-Dokumentverarbeitungs-API.</span>
                      </div>
                  </li>
              </ul>
          </div>
