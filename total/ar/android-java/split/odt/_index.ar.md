---
title: قم بتقسيم ملف ODT عبر الإنترنت أو باستخدام تطبيقات Android Mobile
description: تطبيق مجاني عبر الإنترنت لتقسيم ملفات ODT المختلفة.مكتبة جافا لتقسيم Android لمستندات ODT. 
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات ODT عبر الإنترنت أو باستخدام تطبيق Android" h2="قم بتطوير تطبيقات تقسيم المستندات ODT القوية المستندة إلى نظام Android.قم بتقسيم المستندات بحرية بما في ذلك ملفات ODT عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملفات ODT عبر الإنترنت" %}}

1. تحميل ملف ODT إلى سبليت.
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف ODT عبر تطبيق Android" %}}

1. أضف مرجع مكتبة Java ضمن مشروعك.
1. قم بتحميل مستند ODT باستخدام فئة المستند.
1. حساب العدد الإجمالي للصفحات في ملف ODT.
1. قم بالمرور خلال كل صفحة واستخدم extractPages لاستخراج الصفحة.
1. احفظ الصفحة المستخرجة في ملف جديد.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود جافا: تقسيم صفحة ملفات ODT الحكيمة" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a452c270dbb98a4adc268e209571f44" "split-word-document-by-page.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="كود جافا: قسم ملفات ODT الحكيمة" offSpacer="" %}}
...
<h2>تطوير تطبيق Android لتقسيم الملفات ODT</h2>

هل تحتاج إلى تطوير برنامج نصي يعمل بنظام Android أو تطبيق أداة مساعدة لتقسيم ملفات ODT بسهولة؟باستخدام [Aspose.Words for Android via Java](https://products.aspose.com/words/ar/android-java/)، واجهة برمجة التطبيقات التابعة لـ [Aspose.Total for Android via Java](https://products.aspose.com/total/ar/android-java/)، يمكن لأي مطور Android دمج رمز واجهة برمجة التطبيقات أعلاه في تطبيق تقسيم البرنامج.تدعم مكتبة android القوية لتقسيم المستندات العديد من التنسيقات الشائعة بما في ذلك تنسيق ODT مثل ملفات PDF وWord وExcel وPowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="مكتبة الفاصل أندرويد ODT" %}}
