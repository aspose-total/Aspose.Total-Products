---
title: Android API لتحويل WORD إلى XLTX
description: قم بتحويل WORD إلى XLTX في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى XLTX في تطبيقات Android" h2="تصدير WORD إلى XLTX في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
