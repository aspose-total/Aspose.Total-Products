---
title: تحويل WORD إلى POTM في Android عبر Java
description: WORD لتحويل POTM في هواتف Android الخاصة بك دون استخدام Microsoft Word of PowerPoint
url: /ar/android-java/conversion/word-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى POTM في تطبيقات Android" h2="تحويل WORD إلى POTM في تطبيقات Android دون تثبيت Microsoft Word <sup>&reg;</sup> أو PowerPoint" >}}
...
لتحويل ملف WORD إلى POTM ، يمكنك بسهولة استخدام Aspose.Total لنظام Android عبر Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) وقم بتثبيت المكتبات في تطبيقك.
