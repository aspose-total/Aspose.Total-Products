---
title: Android API لتحويل DOCX إلى CSV
description: قم بتحويل DOCX إلى CSV في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/docx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOCX إلى CSV في تطبيقات Android" h2="تصدير DOCX إلى CSV في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
