---
title: Android API لتحويل RTF إلى CSV
description: قم بتحويل RTF إلى CSV في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/rtf-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="تحويل RTF إلى CSV في تطبيقات Android" h2="تصدير RTF إلى CSV في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
