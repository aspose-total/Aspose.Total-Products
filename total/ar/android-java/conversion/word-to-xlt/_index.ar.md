---
title: Android API لتحويل WORD إلى XLT
description: قم بتحويل WORD إلى XLT في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى XLT في تطبيقات Android" h2="تصدير WORD إلى XLT في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
