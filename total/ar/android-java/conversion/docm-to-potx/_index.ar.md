---
title: تحويل DOCM إلى POTX في Android عبر Java
description: DOCM لتحويل POTX في هواتف Android الخاصة بك دون استخدام Microsoft Word of PowerPoint
url: /ar/android-java/conversion/docm-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOCM إلى POTX في تطبيقات Android" h2="تحويل DOCM إلى POTX في تطبيقات Android دون تثبيت Microsoft Word <sup>&reg;</sup> أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل DOCM إلى POTX في Android" %}}
...
لتحويل ملف DOCM إلى POTX ، يمكنك بسهولة استخدام Aspose.Total لنظام Android عبر Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) وقم بتثبيت المكتبات في تطبيقك.
...
{{% blocks/products/pf/feature-page-section  h2="تحويل DOCM المحمي إلى POTX في Android عبر Java" %}}
يمكنك أيضًا تحويل DOCM المحمي بكلمة مرور إلى POTX داخل تطبيقات Android. إذا كان مستند DOCM الذي تم إدخاله محميًا بكلمة مرور ، فلا يمكنك تحويله إلى تنسيق POTX بدون استخدام كلمة المرور. لفتح مستند مشفر ، يمكنك تعيين كلمة المرور الصحيحة في كائن LoadOptions وتمريرها إلى مُنشئ المستند.
{{% blocks/products/pf/feature-page-code %}}
