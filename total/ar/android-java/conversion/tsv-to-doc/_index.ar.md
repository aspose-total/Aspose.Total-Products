---
title: تصدير TSV إلى DOC في Android
description: Android API لتحويل TSV إلى DOC دون استخدام Microsoft Word
url: /ar/android-java/conversion/tsv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="تقديم TSV إلى DOC على Android عبر Java" h2="قم بتحويل ملف TSV إلى DOC داخل تطبيقات Android بدون استخدام Microsoft <sup>&reg;</sup> Excel" >}}
