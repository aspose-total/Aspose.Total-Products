---
title: Android API لتحويل WORD إلى SXC
description: قم بتحويل WORD إلى SXC في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/word-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى SXC في تطبيقات Android" h2="تصدير WORD إلى SXC في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
