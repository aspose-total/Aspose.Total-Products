---
title: Android API لتحويل WORD إلى DIF
description: قم بتحويل WORD إلى DIF في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى DIF في تطبيقات Android" h2="تصدير WORD إلى DIF في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
