---
title: Android API لتحويل RTF إلى TSV
description: قم بتحويل RTF إلى TSV في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/rtf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="تحويل RTF إلى TSV في تطبيقات Android" h2="تصدير RTF إلى TSV في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
