...
description: Android API لتحويل XLS إلى WORD دون استخدام Microsoft Word أو عبر الإنترنت. اختبر محول CSV إلى DOC على الإنترنت مجانًا بسرعة قبل دمج الكود.
...
{{< blocks/products/pf/feature-page-header h1="تقديم XLS إلى WORD على Android عبر Java أو عبر الإنترنت" h2="قم بتحويل ملف XLS إلى WORD داخل تطبيقات Android بدون استخدام Microsoft <sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/android-java/conversion/xls-to-wordx/" name="XLS إلى WORDX" description="" >}}
