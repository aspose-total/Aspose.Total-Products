---
title: Android API لتحويل RTF إلى XLAM
description: قم بتحويل RTF إلى XLAM في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/rtf-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="تحويل RTF إلى XLAM في تطبيقات Android" h2="تصدير RTF إلى XLAM في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
