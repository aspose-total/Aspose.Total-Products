---
title: تحويل DOCM إلى تنسيق JSON في Android عبر Java
description: تحليل DOCM إلى تنسيق JSON في Android عبر Java دون استخدام Microsoft Word أو Excel
url: /ar/android-java/conversion/docm-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOCM إلى تنسيق JSON في Android عبر Java" h2="تصميم تطبيقات Android لتصدير DOCM إلى JSON بدون استخدام Microsoft <sup>&reg;</sup> Word أو Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
يمكنك تحويل تنسيق DOCM إلى JSON في تطبيقات Android عبر [Aspose.Total for Android عبر Java](https://products.aspose.com/total/android-java/). باستخدام معالجة المستندات وتحويلها API [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/) ، يمكنك تصدير DOCM إلى HTML. بعد ذلك ، باستخدام [Aspose.Cells لنظام Android عبر Java](https://products.aspose.com/cells/android-java/) ، يمكنك تحويل HTML إلى JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تحويل DOCM إلى تنسيق JSON في Android" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل DOCM المحمي إلى تنسيق JSON في Android عبر Java" %}}
باستخدام API ، يمكنك أيضًا فتح المستند المحمي بكلمة مرور. إذا كان مستند DOCM الذي تم إدخاله محميًا بكلمة مرور ، فلا يمكنك تحويله إلى تنسيق JSON دون استخدام كلمة المرور. تسمح لك واجهة برمجة التطبيقات بفتح المستند المشفر عن طريق تمرير كلمة المرور الصحيحة في كائن LoadOptions. يوضح المثال التالي من التعليمات البرمجية كيفية فتح مستند مشفر بكلمة مرور.
{{% blocks/products/pf/feature-page-code %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل DOCM إلى JSON في النطاق في Android عبر Java" %}}
