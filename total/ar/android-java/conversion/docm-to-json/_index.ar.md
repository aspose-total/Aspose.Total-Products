...
يمكنك تحويل تنسيق DOCM إلى JSON في تطبيقات Android عبر [Aspose.Total for Android عبر Java](https://products.aspose.com/total/android-java/). باستخدام معالجة المستندات وتحويلها API [Aspose.Words for Android via Java](https://products.aspose.com/words/android-java/) ، يمكنك تصدير DOCM إلى HTML. بعد ذلك ، باستخدام [Aspose.Cells for Android via Java](https://products.aspose.com/cells/android-java/) ، يمكنك تحويل HTML إلى JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}
