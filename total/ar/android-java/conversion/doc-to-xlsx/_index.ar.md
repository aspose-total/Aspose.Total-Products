---
title: Android API لتحويل DOC إلى XLSX
description: قم بتحويل DOC إلى XLSX في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى XLSX في تطبيقات Android" h2="تصدير DOC إلى XLSX في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
