---
title: Android API لتحويل RTF إلى EXCEL
description: قم بتحويل RTF إلى EXCEL في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/rtf-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="تحويل RTF إلى EXCEL في تطبيقات Android" h2="تصدير RTF إلى EXCEL في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
