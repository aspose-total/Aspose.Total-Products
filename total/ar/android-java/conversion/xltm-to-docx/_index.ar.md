---
title: تصدير XLTM إلى DOCX في Android
description: Android API لتحويل XLTM إلى DOCX دون استخدام Microsoft Word
url: /ar/android-java/conversion/xltm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="تقديم XLTM إلى DOCX على Android عبر Java" h2="قم بتحويل ملف XLTM إلى DOCX داخل تطبيقات Android بدون استخدام Microsoft <sup>&reg;</sup> Excel" >}}
