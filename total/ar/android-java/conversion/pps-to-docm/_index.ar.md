---
title: تصدير PPS إلى DOCM على Andorid عبر Java
description: قم بتحويل PPS إلى DOCM في تطبيقات الأجهزة المحمولة دون تثبيت أي برنامج
url: /ar/android-java/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="تقديم PPS إلى DOCM على Andorid عبر Java" h2="تنسيق ملف APIs لتحويل PPS إلى DOCM داخل تطبيقات Android دون الاعتماد على Microsoft PowerPoint أو Word" >}}
