---
title: تصدير PPSM إلى TEXT على Andorid عبر Java
description: قم بتحويل PPSM إلى TEXT في تطبيقات الأجهزة المحمولة دون تثبيت أي برنامج
url: /ar/android-java/conversion/ppsm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="تقديم PPSM إلى TEXT على Andorid عبر Java" h2="تنسيق ملف APIs لتحويل PPSM إلى TEXT داخل تطبيقات Android دون الاعتماد على Microsoft PowerPoint أو Word" >}}

{{% blocks/products/pf/feature-page-summary %}}
يسمح [Aspose.Total لنظام Android عبر Java](https://products.aspose.com/total/android-java/) بمعالجة تنسيقات الملفات داخل تطبيقات Android. باستخدام واجهات برمجة التطبيقات المتوفرة في الحزمة ، يمكنك أتمتة عملية تحويل PowerPoint PPSM إلى Word TEXT في تطبيقاتك.
