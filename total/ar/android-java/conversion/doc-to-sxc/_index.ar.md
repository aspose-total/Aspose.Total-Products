---
title: Android API لتحويل DOC إلى SXC
description: قم بتحويل DOC إلى SXC في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى SXC في تطبيقات Android" h2="تصدير DOC إلى SXC في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
