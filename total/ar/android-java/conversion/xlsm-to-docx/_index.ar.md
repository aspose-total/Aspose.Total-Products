---
title: تصدير XLSM إلى DOCX في Android
description: Android API لتحويل XLSM إلى DOCX دون استخدام Microsoft Word
url: /ar/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="تقديم XLSM إلى DOCX على Android عبر Java" h2="قم بتحويل ملف XLSM إلى DOCX داخل تطبيقات Android بدون استخدام Microsoft <sup>&reg;</sup> Excel" >}}
