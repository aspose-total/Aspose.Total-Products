---
title: Android API لتحويل DOCX إلى FODS
description: قم بتحويل DOCX إلى FODS في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/docx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOCX إلى FODS في تطبيقات Android" h2="تصدير DOCX إلى FODS في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
