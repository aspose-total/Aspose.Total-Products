---
title: Android API لتحويل RTF إلى ODS
description: قم بتحويل RTF إلى ODS في Android عبر Java دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/android-java/conversion/rtf-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="تحويل RTF إلى ODS في تطبيقات Android" h2="تصدير RTF إلى ODS في Android عبر Java بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
