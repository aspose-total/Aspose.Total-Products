---
title: قم باستخراج النص والصور من ملف XLSM عبر الإنترنت واستخدام تطبيقات Android Mobile
description: تطبيق محلل الملفات XLSM عبر الإنترنت. كود Android API لاستخراج النص في الصفوف والخلايا من أوراق البيانات XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="تحليل ملف XLSM عبر الإنترنت وكذلك عبر تطبيقات Android" h2="قم بتطوير تطبيق الأداة المساعدة لمحلل المستندات XLSM القوي الذي يعمل بنظام Android. الكود المدرج لتحليل مستند XLSM." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تحليل مستند XLSM عبر الإنترنت" %}}

1. قم باستيراد ملف XLSM لتحليله عن طريق تحميله.
...
{{% blocks/products/pf/agp/feature-section-col title="تحليل ملف XLSM عبر تطبيق Android" %}}

1. إضافة مرجع المكتبة إلى مشروع android  
1. قم بتحميل ملف XLSM باستخدام كائن فئة المصنف
...
{{% blocks/products/pf/agp/code-block title="الكود: تحليل وثيقة XLSM" offSpacer="" %}}
...
<h2>تطوير تطبيق Android لمحلل الملفات XLSM</h2>

هل تحتاج إلى تطوير تطبيق أو أداة محلل XLSM؟ باستخدام [Aspose.Cells for Android via Java](https://products.aspose.com/cells/ar/android-java/)، وهي واجهة برمجة تطبيقات فرعية لـ [Aspose.Total for Android via Java](https://products.aspose.com/total/ar/android-java/)، يمكن لأي مطور Android دمج كود واجهة برمجة التطبيقات أعلاه داخل تطبيق محلل المستندات الخاص به. تتيح مكتبة Android القوية برمجة أي حل لتحليل المستندات لاستخراج الصور وكذلك النص. علاوة على ذلك، يمكنه دعم العديد من التنسيقات الشائعة بما في ذلك تنسيق XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="أداة Android لمعالجة ملف XLSM لتطبيق المحلل اللغوي" %}}
