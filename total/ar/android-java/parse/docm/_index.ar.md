---
title: قم باستخراج النص والصور من ملف DOCM عبر الإنترنت واستخدام تطبيقات Android Mobile
description: تطبيق محلل الملفات DOCM عبر الإنترنت. كود Android API لاستخراج الصور والمحتوى النصي من مستند DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="تحليل ملف DOCM عبر الإنترنت بالإضافة إلى استخراج النص عبر تطبيقات Android" h2="قم بتطوير تطبيق الأداة المساعدة لمحلل المستندات DOCM القوي الذي يعمل بنظام Android. الكود المدرج لاستخراج نص مستند DOCM." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تحليل مستند DOCM عبر الإنترنت" %}}

1. قم باستيراد ملف DOCM لتحليله عن طريق تحميله.
...
{{% blocks/products/pf/agp/feature-section-col title="استخرج النص من ملف DOCM عبر تطبيق Android" %}}

1. إضافة مرجع مكتبة لمشروع جافا  
1. قم بتحميل ملف DOCM باستخدام كائن فئة المستند
...
{{% blocks/products/pf/agp/code-block title="الكود: استخراج نص مستند DOCM" offSpacer="" %}}
