---
title: ضغط ملفات PDF عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لضغط ملفات PDF المختلفة.رمز مكتبة الضغط C# .NET لمستندات PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="ضغط ملف PDF عبر الإنترنت عبر تطبيق الضغط أو باستخدام .NET" h2="تطوير تطبيقات ضغط المستندات PDF القوية المستندة إلى .NET.قم بضغط المستندات المختلفة بما في ذلك ملفات PDF عبر الإنترنت عبر التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ضغط ملف PDF عبر .NET" %}}

1. قم بتحميل المستند عبر كائن فئة المستند
1. استخدم كائن فئة OptimizationOptions
1. استخدم كائن التحسين لـ CompressImages وImageQuality
1. استدعاء OptimizeResources باستخدام كائن المستند
1. استدعاء طريقة حفظ والحصول على ملف PDF المضغوط

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود .NET: ضغط ملفات PDF" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لضغط ملف PDF باستخدام .NET. استخدم واجهة برمجة تطبيقات ضغط Aspose PDF لتطوير برامج مستقلة عالية المستوى للنظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
