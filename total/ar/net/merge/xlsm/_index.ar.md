---
title: دمج ملفات XLSM عبر الإنترنت أو باستخدام .NET
description: تطبيق مجاني عبر الإنترنت لدمج ملفات XLSM المختلفة.C# .NET دمج كود المكتبة لدمج أوراق عمل XLSM في تنسيقات أخرى.
...
{{% blocks/products/pf/agp/feature-section-col title="دمج ملف XLSM عبر .NET" %}}

1. قم بتحميل كلا XLSM باستخدام كائنات فئة المصنف.
...
{{% blocks/products/pf/agp/code-block title="كود .NET: دمج ملفات XLSM" offSpacer="" %}}
...
<h2>تطوير برنامج دمج الملفات XLSM باستخدام .NET</h2>

هل تحتاج إلى تطوير تطبيق الأداة المساعدة .NET لدمج ملفات XLSM المتعددة بسهولة؟باستخدام [Aspose.Cells for .NET](https://products.aspose.com/cells/ar/net/)، API التابعة لـ [Aspose.Total for .NET](https://products.aspose.com/total/ar/net/)، يمكن لأي مطور .NET دمج رمز API أعلاه لتسلسل المستندات بسهولة.تدعم مكتبة .NET القوية لدمج المستندات العديد من التنسيقات الشائعة بما في ذلك تنسيق XLSM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="مكتبة دمج .NET لملفات XLSM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء تطوير حل احترافي لدمج XLSM باستخدام .NET.استخدم واجهة برمجة تطبيقات دمج XLSM لتطوير برامج مستقلة عالية المستوى للنظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
