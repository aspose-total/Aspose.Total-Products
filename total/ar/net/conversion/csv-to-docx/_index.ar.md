---
title: تحويل CSV إلى DOCX باستخدام .NET 
description: قم بتحويل ملف CSV إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل CSV إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ CSV إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
