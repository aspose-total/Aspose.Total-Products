---
title: تحويل PDF إلى XLTX عبر C# API
description: C# API لتحويل ملف PDF إلى XLTX بدون استخدام Microsoft Excel أو Adobe Reader
url_ignore: /ar/net/conversion/pdf-to-xltx/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{% blocks/products/pf/agp/feature-section-col title="NET API لتحويل PDF إلى XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل المحمية PDF إلى XLTX عبر C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="تحويل ملف PDF إلى XLTX بعلامة مائية عبر C#" %}}
أثناء تحويل ملف PDF إلى XLTX ، يمكنك أيضًا إضافة علامة مائية إلى تنسيق ملف XLTX الناتج. لإضافة علامة مائية ، يمكنك إنشاء كائن مصنف جديد وفتح مستند XLSX المحول ، وتحديد ورقة العمل عبر الفهرس الخاص به ، وإنشاء شكل واستخدام وظيفة AddTextEffect الخاصة به. بعد ذلك يمكنك حفظ مستند XLSX كملف XLTX مع علامة مائية. 
{{% blocks/products/pf/feature-page-code %}}
