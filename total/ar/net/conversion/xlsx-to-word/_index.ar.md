---
title: تحويل XLSX إلى WORD باستخدام .NET 
description: قم بتحويل ملف XLSX إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSX إلى WORD عبر C#" h2="تصدير Excel & reg ؛ XLSX إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
