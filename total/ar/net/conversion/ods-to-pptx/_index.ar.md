---
title: تحويل ODS إلى PPTX باستخدام .NET 
description: قم بتحويل ملف ODS إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/ods-to-pptx/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODS إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ ODS إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
