...
<iframe title="تطبيق مجاني عبر الإنترنت لتحويل XML إلى POTX" style="border: none; height: 426px;" scrolling="no" src="https://widgets.aspose.cloud/total-conversion/?to=potx&from=xml" id="child-iframe" width="80%"></iframe>
