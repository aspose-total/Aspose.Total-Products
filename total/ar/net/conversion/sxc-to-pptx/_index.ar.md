---
title: تحويل SXC إلى PPTX باستخدام .NET 
description: قم بتحويل ملف SXC إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل SXC إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ SXC إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
