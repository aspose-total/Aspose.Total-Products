---
title: تحويل XLTM إلى DOC باستخدام .NET 
description: قم بتحويل ملف XLTM إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xltm-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTM إلى DOC عبر C#" h2="تصدير Excel & reg ؛ XLTM إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
