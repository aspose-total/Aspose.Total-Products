---
title: تحويل ODS إلى POWERPOINT باستخدام .NET 
description: قم بتحويل ملف ODS إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODS إلى POWERPOINT عبر C#" h2="تصدير Excel & reg ؛ ODS إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
