---
title: تحويل XLTX إلى POWERPOINT باستخدام .NET 
description: قم بتحويل ملف XLTX إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xltx-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTX إلى POWERPOINT عبر C#" h2="تصدير Excel & reg ؛ XLTX إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
