---
title: تحويل TSV إلى WORD باستخدام .NET 
description: قم بتحويل ملف TSV إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/tsv-to-word/
family: total
platformtag: net
feature: conversion
informat: TSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل TSV إلى WORD عبر C#" h2="تصدير Excel & reg ؛ TSV إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
