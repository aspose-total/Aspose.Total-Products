...
description: C# API لتحويل DOT إلى FODS بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/dot-to-fods/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOT إلى FODS" h2="تصدير DOT إلى FODS عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
