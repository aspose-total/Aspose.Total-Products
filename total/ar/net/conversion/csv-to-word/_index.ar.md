---
title: تحويل CSV إلى WORD باستخدام .NET 
description: قم بتحويل ملف CSV إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/csv-to-word/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل CSV إلى WORD عبر C#" h2="تصدير Excel & reg ؛ CSV إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
