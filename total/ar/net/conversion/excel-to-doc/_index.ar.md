---
title: تحويل EXCEL إلى DOC باستخدام .NET 
description: قم بتحويل ملف EXCEL إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/excel-to-doc/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل EXCEL إلى DOC عبر C#" h2="تصدير Excel & reg ؛ EXCEL إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
