---
title: تحويل POTX إلى XLT عبر C#
description: قم بتحويل POTX إلى XLT في C# بدون استخدام Microsoft Excel أو Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTX إلى XLT عبر C#" h2="NET API لتحويل POTX إلى XLT بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTX إلى XLT عبر C#" %}}
