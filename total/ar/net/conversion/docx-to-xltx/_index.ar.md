...
description: C# API لتحويل DOCX إلى XLTX بدون استخدام Microsoft Excel أو Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOCX إلى XLTX" h2="تصدير DOCX إلى XLTX عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
