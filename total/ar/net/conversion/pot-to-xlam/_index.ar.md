---
title: تحويل POT إلى XLAM عبر C#
description: قم بتحويل POT إلى XLAM في C# بدون استخدام Microsoft Excel أو Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى XLAM عبر C#" h2="NET API لتحويل POT إلى XLAM بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى XLAM عبر C#" %}}
...
4. احفظ المستند في ملف XLAM باستخدام طريقة [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
