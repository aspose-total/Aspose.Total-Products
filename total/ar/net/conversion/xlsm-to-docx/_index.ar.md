---
title: تحويل XLSM إلى DOCX باستخدام .NET 
description: قم بتحويل ملف XLSM إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xlsm-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSM إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ XLSM إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
