...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSM إلى DOCX عبر C# أو التطبيق عبر الإنترنت" h2="تصدير Excel & reg ؛ XLSM إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
