...
description: C# API لتحويل DOCM إلى EXCEL بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/docm-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOCMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOCM إلى EXCEL" h2="تصدير DOCM إلى EXCEL عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
