...
description: C# API لتحويل WORD إلى SXC بدون استخدام Microsoft Excel أو Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل WORD إلى SXC" h2="تصدير WORD إلى SXC عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
