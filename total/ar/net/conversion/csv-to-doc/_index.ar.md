---
title: تحويل CSV إلى DOC باستخدام .NET 
description: قم بتحويل ملف CSV إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/csv-to-doc/
family: total
platformtag: net
feature: conversion
informat: CSV
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل CSV إلى DOC عبر C#" h2="تصدير Excel & reg ؛ CSV إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
