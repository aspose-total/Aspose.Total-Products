---
title: تحويل FODS إلى DOC باستخدام .NET 
description: قم بتحويل ملف FODS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/fods-to-doc/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى DOC عبر C#" h2="تصدير Excel & reg ؛ FODS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
