---
title: تحويل XLSB إلى DOC باستخدام .NET 
description: قم بتحويل ملف XLSB إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSB إلى DOC عبر C#" h2="تصدير Excel & reg ؛ XLSB إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
