---
title: تحويل SXC إلى WORD باستخدام .NET 
description: قم بتحويل ملف SXC إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/sxc-to-word/
family: total
platformtag: net
feature: conversion
informat: SXC
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل SXC إلى WORD عبر C#" h2="تصدير Excel & reg ؛ SXC إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
