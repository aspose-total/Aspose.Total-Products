---
title: تحويل XLSM إلى WORD باستخدام .NET 
description: قم بتحويل ملف XLSM إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xlsm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSM إلى WORD عبر C#" h2="تصدير Excel & reg ؛ XLSM إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
