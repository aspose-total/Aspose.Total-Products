...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSM إلى WORD عبر C# أو عبر الإنترنت" h2="تصدير Excel & reg ؛ XLSM إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
