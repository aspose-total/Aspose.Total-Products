---
title: تحويل XLT إلى DOC باستخدام .NET 
description: قم بتحويل ملف XLT إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xlt-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLT إلى DOC عبر C#" h2="تصدير Excel & reg ؛ XLT إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
