...
description: C# API لتحويل DOTM إلى XLTX بدون استخدام Microsoft Excel أو Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOTM إلى XLTX" h2="تصدير DOTM إلى XLTX عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
