---
title: تحويل XLTM إلى PPTX باستخدام .NET 
description: قم بتحويل ملف XLTM إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTM إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ XLTM إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
