---
title: تحويل PPTM إلى XLS عبر C# أو التطبيق عبر الإنترنت
description: قم بتحويل PPTM إلى XLS في C# بدون استخدام Microsoft Excel أو Powerpoint أو عبر الإنترنت. اختبر محول PPTM إلى XLS على الإنترنت مجانًا بسرعة قبل دمج الكود. أو مع محول مجاني على الإنترنت
url_ignore: /ar/net/conversion/pptm-to-xls/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPTM إلى XLS عبر C# أو التطبيق عبر الإنترنت" h2="NET API لتحويل PPTM إلى XLS بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
