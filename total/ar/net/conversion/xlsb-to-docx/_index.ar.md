---
title: تحويل XLSB إلى DOCX باستخدام .NET 
description: قم بتحويل ملف XLSB إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSB إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ XLSB إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
