---
title: تحويل EXCEL إلى WORD باستخدام .NET 
description: قم بتحويل ملف EXCEL إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل EXCEL إلى WORD عبر C#" h2="تصدير Excel & reg ؛ EXCEL إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
