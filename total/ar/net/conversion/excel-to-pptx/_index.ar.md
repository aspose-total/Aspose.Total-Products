---
title: تحويل EXCEL إلى PPTX باستخدام .NET 
description: قم بتحويل ملف EXCEL إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل EXCEL إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ EXCEL إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
