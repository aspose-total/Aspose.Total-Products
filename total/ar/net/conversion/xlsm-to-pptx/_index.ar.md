---
title: تحويل XLSM إلى PPTX باستخدام .NET 
description: قم بتحويل ملف XLSM إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSM إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ XLSM إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
