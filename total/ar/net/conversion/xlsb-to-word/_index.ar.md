---
title: تحويل XLSB إلى WORD باستخدام .NET 
description: قم بتحويل ملف XLSB إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xlsb-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSB إلى WORD عبر C#" h2="تصدير Excel & reg ؛ XLSB إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
