---
title: تحويل CSV إلى PPTX باستخدام .NET 
description: قم بتحويل ملف CSV إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل CSV إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ CSV إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
