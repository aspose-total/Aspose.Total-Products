...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل SXC إلى DOC عبر C# أو التطبيق عبر الإنترنت" h2="تصدير Excel & reg ؛ SXC إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
