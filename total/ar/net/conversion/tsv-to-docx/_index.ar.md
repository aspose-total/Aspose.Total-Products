---
title: تحويل TSV إلى DOCX باستخدام .NET 
description: قم بتحويل ملف TSV إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل TSV إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ TSV إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
