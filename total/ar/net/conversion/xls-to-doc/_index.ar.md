---
title: تحويل XLS إلى DOC باستخدام .NET 
description: قم بتحويل ملف XLS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xls-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLS إلى DOC عبر C#" h2="تصدير Excel & reg ؛ XLS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
