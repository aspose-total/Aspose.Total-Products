...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل MOBI إلى EXCEL" h2="تصدير MOBI إلى EXCEL عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
...
4. احفظ المستند بتنسيق EXCEL باستخدام طريقة [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) وعيّن `EXCEL` على أنه SaveFormat
