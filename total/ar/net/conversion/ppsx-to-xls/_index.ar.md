---
title: تحويل PPSX إلى XLS عبر C#
description: قم بتحويل PPSX إلى XLS في C# بدون استخدام Microsoft Excel أو Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPSX إلى XLS عبر C#" h2="NET API لتحويل PPSX إلى XLS بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSX إلى XLS عبر C#" %}}
