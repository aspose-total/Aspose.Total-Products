---
title: تحويل XLS إلى PPTX باستخدام .NET 
description: قم بتحويل ملف XLS إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLS إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ XLS إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
