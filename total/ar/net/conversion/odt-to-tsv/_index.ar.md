---
title: NET API لتحويل ODT إلى TSV
description: C# API لتحويل ODT إلى TSV بدون استخدام Microsoft Excel أو Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل ODT إلى TSV" h2="تصدير ODT إلى TSV عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
