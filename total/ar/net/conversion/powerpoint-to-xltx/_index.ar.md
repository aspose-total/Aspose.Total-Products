...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POWERPOINT إلى XLTX عبر C#" h2="NET API لتحويل POWERPOINT إلى XLTX بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى XLTX عبر C#" %}}
