---
title: تحويل POT إلى ODS عبر C#
description: قم بتحويل POT إلى ODS في C# بدون استخدام Microsoft Excel أو Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى ODS عبر C#" h2="NET API لتحويل POT إلى ODS بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى ODS عبر C#" %}}
