---
title: تحويل XLS إلى DOCX باستخدام .NET 
description: قم بتحويل ملف XLS إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLS إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ XLS إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
