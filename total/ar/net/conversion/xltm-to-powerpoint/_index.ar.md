---
title: تحويل XLTM إلى POWERPOINT باستخدام .NET 
description: قم بتحويل ملف XLTM إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xltm-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTM إلى POWERPOINT عبر C#" h2="تصدير Excel & reg ؛ XLTM إلى POWERPOINT على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
