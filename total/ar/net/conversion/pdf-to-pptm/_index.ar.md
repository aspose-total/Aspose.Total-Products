...
<iframe title="تطبيق مجاني عبر الإنترنت لتحويل PDF إلى PPTM" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=pptm&from=pdf" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="تحويل PDF إلى PPTM عبر C# .NET" offSpacer="" %}}
