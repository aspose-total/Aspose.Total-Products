---
title: تحويل POTX إلى SXC عبر C#
description: قم بتحويل POTX إلى SXC في C# بدون استخدام Microsoft Excel أو Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTX إلى SXC عبر C#" h2="NET API لتحويل POTX إلى SXC بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTX إلى SXC عبر C#" %}}
