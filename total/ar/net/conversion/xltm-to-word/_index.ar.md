---
title: تحويل XLTM إلى WORD باستخدام .NET 
description: قم بتحويل ملف XLTM إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xltm-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTM إلى WORD عبر C#" h2="تصدير Excel & reg ؛ XLTM إلى WORD على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
