---
title: تحويل XLSX إلى PPTX باستخدام .NET 
description: قم بتحويل ملف XLSX إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLSX إلى PPTX عبر C#" h2="تصدير Excel & reg ؛ XLSX إلى PPTX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
