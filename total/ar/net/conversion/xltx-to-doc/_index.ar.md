---
title: تحويل XLTX إلى DOC باستخدام .NET 
description: قم بتحويل ملف XLTX إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/xltx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLTX إلى DOC عبر C#" h2="تصدير Excel & reg ؛ XLTX إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
