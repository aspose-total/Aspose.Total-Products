...
description: C# API لتحويل DOCM إلى ODS بدون استخدام Microsoft Excel أو Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOCM إلى ODS" h2="تصدير DOCM إلى ODS عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
