...
description: C# API لتحويل DOTX إلى SXC بدون استخدام Microsoft Excel أو Adobe Reader
url: /ar/net/conversion/dotx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API لتحويل DOTX إلى SXC" h2="تصدير DOTX إلى SXC عبر C# بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
