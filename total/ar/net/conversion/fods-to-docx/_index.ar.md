---
title: تحويل FODS إلى DOCX باستخدام .NET 
description: قم بتحويل ملف FODS إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل FODS إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ FODS إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
