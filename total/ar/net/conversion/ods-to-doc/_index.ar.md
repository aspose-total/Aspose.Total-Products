---
title: تحويل ODS إلى DOC باستخدام .NET 
description: قم بتحويل ملف ODS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
url: /ar/net/conversion/ods-to-doc/
family: total
platformtag: net
feature: conversion
informat: ODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل ODS إلى DOC عبر C#" h2="تصدير Excel & reg ؛ ODS إلى DOC على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
