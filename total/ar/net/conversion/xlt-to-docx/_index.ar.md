---
title: تحويل XLT إلى DOCX باستخدام .NET 
description: قم بتحويل ملف XLT إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="تحويل XLT إلى DOCX عبر C#" h2="تصدير Excel & reg ؛ XLT إلى DOCX على الأنظمة الأساسية .NET Framework أو .NET Core أو Mono أو Xamarin">}}
