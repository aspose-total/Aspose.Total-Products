---
title: قم بتقسيم ملف Excel عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق Excel المختلفة.كود مكتبة .NET C# Splitter لجداول بيانات Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات Excel عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات Excel القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات Excel عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف Excel عبر .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم ملفات Excel" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات Excel باستخدام .NET.استخدم Aspose Excel Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
