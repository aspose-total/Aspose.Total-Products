---
title: قم بتقسيم ملف ODT عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم ملفات ODT المختلفة. كود مكتبة .NET C# Splitter لمستندات ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات ODT عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات ODT القوية المستندة إلى .NET. قم بتقسيم المستندات بحرية بما في ذلك ملفات ODT عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف ODT عبر .NET" %}}

1. قم بتحميل مستند ODT باستخدام فئة المستند.
1. احصل على إجمالي الصفحات باستخدام عدد الصفحات.
1. قم بالمرور عبر كل صفحة واستخدم ExtractPages لاستخراج الصفحة.
1. احفظ الصفحة المستخرجة في ملف ODT الجديد.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم صفحة ملفات ODT الحكيمة" offSpacer="" %}}
...
{{< /blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/feature-page-summary %}}
### .odt (ملف نص OpenDocument) — حالات الاستخدام لتقسيم المستند

- قسم ملفات النص الخاصة بـ OpenDocument لتحقيق التوافق وسهولة التحرير في حزم البرامج مفتوحة المصدر.
- تسهيل التعاون من خلال توزيع أقسام محددة على عدة مساهمين.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز.يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات ODT باستخدام .NET.استخدم Aspose ODT Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
