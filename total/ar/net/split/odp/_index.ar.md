---
title: قم بتقسيم ملفات ODP عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم ملفات ODP المختلفة. رمز مكتبة .NET C# Splitter لمستندات ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات ODP عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات ODP القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات ODP عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف ODP عبر .NET" %}}
...
1. أخيرًا احفظ الشريحة في ملف ODP الجديد

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم ملفات ODP" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### OpenDocument Presentation .odp Format — حالات الاستخدام للتقسيم

- قسم ملفات ODP لأدوات العروض مفتوحة المصدر لتسهيل التحرير والمشاركة.
- نظم العروض إلى أقسام لإدارة أسهل وتوصيل مستهدف.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات ODP باستخدام .NET.استخدم Aspose ODP Splitter API لتطوير برامج مستقلة عالية المستوى للنظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
