---
title: قم بتقسيم ملف XLS عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق XLS المختلفة.كود مكتبة .NET C# Splitter لجداول بيانات XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات XLS عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات XLS القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات XLS عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملفات XLS عبر الإنترنت باستخدام التطبيق" %}}

1. تحميل ملف XLS إلى سبليت.
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف XLS عبر .NET" %}}

1. قم بتحميل ملف XLS باستخدام فئة المصنف
...
{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم ملفات XLS" offSpacer="" %}}
...
<h2>تطوير تطبيق XLS File Splitter باستخدام .NET</h2>

هل تحتاج إلى تطوير البرنامج النصي .NET أو تطبيق الأداة المساعدة لتقسيم ملفات XLS بسهولة؟باستخدام [Aspose.Cells for .NET](https://products.aspose.com/cells/ar/net/)، واجهة برمجة التطبيقات التابعة لـ [Aspose.Total for .NET](https://products.aspose.com/total/ar/net/)، يمكن لأي مطور .NET دمج رمز واجهة برمجة التطبيقات أعلاه في تطبيق تقسيم البرنامج.تدعم مكتبة .NET القوية لتقسيم المستندات العديد من التنسيقات الشائعة بما في ذلك تنسيق XLS مثل ملفات PDF وWord وExcel وPowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="مكتبة XLS الفاصل ل.NET" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### تنسيقات جداول بيانات Microsoft Excel .xls — حالات الاستخدام للتقسيم

- تقسيم جداول بيانات Excel التقليدية لتحسين الأداء وتبسيط التحرير.
- مشاركة أجزاء من النماذج المالية أو البيانات مع أفراد الفريق المختلفين.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات XLS باستخدام .NET.استخدم Aspose XLS Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>هل من الآمن استخدام التطبيق عبر الإنترنت لتقسيم مستندات XLS متعددة؟</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">يمكنك استخدام أي متصفح ويب حديث مثل Google Chrome أو Firefox أو Opera أو Safari لفاصل المستندات XLS عبر الإنترنت.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>كم من الوقت يستغرق تقسيم ملفات XLS؟</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
