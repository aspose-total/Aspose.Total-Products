---
title: قم بتقسيم ملف XLSX عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق XLSX المختلفة.كود مكتبة .NET C# Splitter لجداول بيانات XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات XLSX عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات XLSX القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات XLSX عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملفات XLSX عبر الإنترنت باستخدام التطبيق" %}}

1. تحميل ملف XLSX إلى سبليت.
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف XLSX عبر .NET" %}}

1. قم بتحميل ملف XLSX باستخدام فئة المصنف
1. احصل على الخلية النشطة
1. تقسيم نافذة ورقة العمل
1. استدعاء أسلوب Save () لحفظ الملف

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم ملفات XLSX" offSpacer="" %}}
...
<h2>تطوير تطبيق XLSX File Splitter باستخدام .NET</h2>

هل تحتاج إلى تطوير البرنامج النصي .NET أو تطبيق الأداة المساعدة لتقسيم ملفات XLSX بسهولة؟باستخدام [Aspose.Cells for .NET](https://products.aspose.com/cells/ar/net/)، واجهة برمجة التطبيقات التابعة لـ [Aspose.Total for .NET](https://products.aspose.com/total/ar/net/)، يمكن لأي مطور .NET دمج رمز واجهة برمجة التطبيقات أعلاه في تطبيق تقسيم البرنامج.تدعم مكتبة .NET القوية لتقسيم المستندات العديد من التنسيقات الشائعة بما في ذلك تنسيق XLSX مثل ملفات PDF وWord وExcel وPowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="مكتبة XLSX الفاصل ل.NET" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### تنسيقات جداول بيانات Microsoft Excel .xlsx — حالات الاستخدام للتقسيم
- تقسيم سجلات العمل الحديثة الكبيرة لتحسين إدارتها والتعاون.
- إنشاء تقارير شخصية عن طريق تقسيم ملف .xlsx رئيسي إلى أوراق بيانات مخصصة.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات XLSX باستخدام .NET.استخدم Aspose XLSX Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>هل من الآمن استخدام التطبيق عبر الإنترنت لتقسيم مستندات XLSX متعددة؟</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">يمكنك استخدام أي متصفح ويب حديث مثل Google Chrome أو Firefox أو Opera أو Safari لفاصل المستندات XLSX عبر الإنترنت.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>كم من الوقت يستغرق تقسيم ملفات XLSX؟</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
