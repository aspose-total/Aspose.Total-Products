---
title: قم بتقسيم ملفات PDF عبر الإنترنت أو باستخدام .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم ملفات PDF المختلفة.رمز مكتبة .NET C# Splitter لمستندات PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات PDF عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات PDF القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات PDF عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف PDF عبر .NET" %}}

1. قم بتحميل مستند PDF باستخدام فئة المستند.
1. احصل على إجمالي صفحات المستند المحمل وكرره.
1. أنشئ كائنًا جديدًا في كل تكرار وأضف الصفحة باستخدام Pages.Add.
1. احفظ الصفحة في ملف PDF جديد باستخدام طريقة Save().

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم صفحة ملفات PDF الحكيمة" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات PDF باستخدام .NET.استخدم Aspose PDF Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
