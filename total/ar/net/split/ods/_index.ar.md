---
title: قم بتقسيم ملف ODS عبر الإنترنت أو عبر .NET
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق ODS المختلفة.كود مكتبة .NET C# Splitter لجداول بيانات ODS.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات ODS عبر الإنترنت عبر تطبيق Splitter أو باستخدام .NET" h2="قم بتطوير تطبيقات تقسيم المستندات ODS القوية المستندة إلى .NET.قم بتقسيم المستندات بحرية بما في ذلك ملفات ODS عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف ODS عبر .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="كود .NET: تقسيم ملفات ODS" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
### .ods (جدول بيانات OpenDocument) — حالات الاستخدام للتقسيم
- فصل ملفات ODS الكبيرة لتطبيقات جداول البيانات مفتوحة المصدر مثل LibreOffice.
- تعيين أجزاء متميزة من مجموعة بيانات للمساهمين الفرديين لتسهيل العمل الجماعي.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات ODS باستخدام .NET.استخدم Aspose ODS Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
