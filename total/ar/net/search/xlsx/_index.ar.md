...
description: تطبيق مجاني عبر الإنترنت للبحث في ملف XLSX. رمز C# API لأي تطبيق بحث عن نص ملف XLSX.
...
{{< blocks/products/pf/feature-page-header h1="تطبيق المستندات القابلة للبحث عبر الإنترنت ورمز API لبحث XLSX" h2="قم بتطوير برنامج محرك بحث مستندات XLSX قوي يعتمد على .NET أو تطبيق أداة مساعدة. اختبر تطبيق البحث عن نص المستندات عبر الإنترنت مجانًا." >}}
...
1. انقر فوق الزر "بحث" للبحث في XLSX.
...
{{% blocks/products/pf/agp/code-block title="مثال للتعليمات البرمجية في C# للبحث في ملفات XLSX" offSpacer="" %}}
...
<h2>تطوير محرك بحث الملفات XLSX عبر .NET</h2>

هل تحتاج إلى تطوير برنامج أو أداة مساعدة قابلة للبحث في XLSX؟ باستخدام Aspose.Cells for .NET، وهي واجهة برمجة تطبيقات فرعية لـ Aspose.Total لـ .NET، يمكن لأي مطور دمج رمز API C# أعلاه لبرمجة البحث عبر المستندات. تتيح مكتبة C# القوية برمجة حلول برامج البحث عن المستندات التي يمكنها دعم العديد من التنسيقات الشائعة بما في ذلك تنسيق XLSX.<br /><br />
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">يمكنك استخدام أي متصفح ويب حديث، مثل Google Chrome أو Firefox أو Opera أو Safari، للبحث في مستندات XLSX عبر الإنترنت. ومع ذلك، إذا كنت تقوم بتطوير تطبيق سطح مكتب، فمن المستحسن استخدام Aspose.Total Document Search API لإجراء معالجة سلسة وفعالة.</span>
                      </div>
                  </li>
              </ul>
          </div>
