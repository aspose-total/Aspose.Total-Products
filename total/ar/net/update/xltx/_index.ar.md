---
title: تحديث ملف XLTX باستخدام .NET
description: تعديل مستندات XLTX في تطبيقات C # VB.NET بدون استخدام Microsoft Excel. 
url: /ar/net/update/xltx/
family: total
platformtag: .NET
feature: update
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="تحديث ملف XLTX عبر .NET" h2="قم بتعديل جدول بيانات XLTX عبر تطبيقاتك المستندة إلى .NET دون تثبيت Microsoft Office <sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

بالنسبة للمطور ، من يحاول تحديث ملفات XLTX عبر تطبيق .NET؟ يمكن أن تساعد [Aspose.Total for .NET](https://products.aspose.com/total/net/) API في أتمتة عملية التحديث. إنها حزمة كاملة من العديد من واجهات برمجة تطبيقات .NET التي تتعامل مع تنسيقات مختلفة بما في ذلك ملفات Microsoft Excel. ASPOSE.CELL API الذي يعد جزءًا من حزمة [Aspose.Total for .NET](https://products.aspose.com/total/net/) يجعل عملية التعديل هذه سهلة. فيما يلي عملية تحديث وثيقة XLTX.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحديث ملف XLTX في .NET" %}}

- قم بإنشاء كائن فئة [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) جديد يحتوي على ملف XLTX المصدر كمعامل
...
- لتعديل XLTX ، Microsoft Windows أو نظام تشغيل متوافق مع .NET أو .NET Core أو Mono أو Xamarin Platforms
...
{{% blocks/products/pf/agp/code-block title="التعليمات البرمجية - تحديث ملف XLTX في .NET" offSpacer="" %}}
