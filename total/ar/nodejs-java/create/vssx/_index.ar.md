---
title: إنشاء مخططات Visio VSSX في Node.js
description: إنشاء مخططات Microsoft Visio VSSX باستخدام تطبيقات Node دون استخدام Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="إنشاء ملف VSSX باستخدام Node.js" h2="قم بإنشاء ملفات Microsoft Visio VSSX عبر تطبيقات Node الخاصة بك دون تثبيت أي برنامج آخر." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="إنشاء ملف VSSX في Node.js" %}}

- إنشاء مثيل لفئة الرسم التخطيطي.
- استدعاء طريقة الحفظ بالمعلمات ذات الصلة
- VSSX مسار الملف، والامتداد ذي الصلة SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات الإنشاء" %}}

- لإنشاء مستند VSSX، يجب تثبيت Node.js على النظام.
- يجب أن يكون لديك Oracle JDK (الإصدار 7 أو أحدث).
- يجب إعداد حزمة node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - إنشاء ملفات VSSX" offSpacer="" %}}
