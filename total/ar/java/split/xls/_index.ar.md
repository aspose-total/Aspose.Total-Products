---
title: قم بتقسيم ملف XLS عبر الإنترنت أو عبر Java
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق XLS المختلفة.رمز مكتبة جافا الفاصل لجداول البيانات XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات XLS عبر الإنترنت عبر تطبيق Splitter أو باستخدام Java" h2="تطوير تطبيقات قوية لتقسيم المستندات XLS تعتمد على Java.قم بتقسيم المستندات بحرية بما في ذلك ملفات XLS عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف XLS عبر جافا" %}}
...
{{% blocks/products/pf/agp/code-block title="مثال التعليمات البرمجية في Java لتقسيم ملفات XLS" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز.يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات XLS باستخدام Java.استخدم Aspose XLS Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
