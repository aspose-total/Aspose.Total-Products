---
title: قم بتقسيم ملف XLSX عبر الإنترنت أو عبر Java
description: تطبيق مجاني عبر الإنترنت لتقسيم أوراق XLSX المختلفة.رمز مكتبة جافا الفاصل لجداول البيانات XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بتقسيم ملفات XLSX عبر الإنترنت عبر تطبيق Splitter أو باستخدام Java" h2="تطوير تطبيقات قوية لتقسيم المستندات XLSX تعتمد على Java.قم بتقسيم المستندات بحرية بما في ذلك ملفات XLSX عبر الإنترنت من خلال التطبيق مع التنزيل الفوري." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف XLSX عبر جافا" %}}
...
{{% blocks/products/pf/agp/code-block title="مثال التعليمات البرمجية في Java لتقسيم ملفات XLSX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز.يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات XLSX باستخدام Java.استخدم Aspose XLSX Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في Java.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
