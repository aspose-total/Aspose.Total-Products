---
title: عرض ملف DOCM عبر الإنترنت واستخدام Java
description: تطبيق عارض الملفات DOCM المجاني عبر الإنترنت. رمز Java API لعرض ملف DOCM لتطبيق العارض.
...
{{< blocks/products/pf/feature-page-header-widget h1="عرض ملف DOCM بحرية عبر الإنترنت أو عبر Java" h2="تطوير تطبيق أداة عارض المستندات DOCM القوي المستند إلى Java.تم إدراج الرمز لعرض مستند DOCM من خلال Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="عرض ملف DOCM عبر جافا" %}}
...
{{% blocks/products/pf/agp/code-block title="كود جافا لعرض ملفات DOCM" offSpacer="" %}}
...
<h2>تطوير تطبيق عارض الملفات DOCM عبر Java</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="أداة Java لمعالجة ملف DOCM لتطبيق العرض" %}}
