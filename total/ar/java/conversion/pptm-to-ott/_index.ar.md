---
title: تحويل PPTM إلى OTT عبر Java
description: Java API لتصدير PPTM إلى OTT دون استخدام Microsoft Word أو PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPTM إلى OTT عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل PPTM إلى OTT داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPTM إلى OTT عبر Java" %}}
...
لتحويل ملف PPTM إلى OTT ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
