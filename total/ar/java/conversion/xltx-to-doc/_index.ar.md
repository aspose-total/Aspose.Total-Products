---
title: تحويل XLTX إلى DOC باستخدام Java
description: Java API لتصدير XLTX إلى DOC باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLTX إلى DOC" h2="في Premise Java API لتصدير XLTX إلى DOC دون الاعتماد على Microsoft Excel & reg ؛" >}}
