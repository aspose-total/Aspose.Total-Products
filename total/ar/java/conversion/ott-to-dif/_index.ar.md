...
description: قم بتحويل OTT إلى DIF عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل OTT إلى DIF عبر Java" h2="في Premise Java API لتحويل OTT إلى DIF بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
