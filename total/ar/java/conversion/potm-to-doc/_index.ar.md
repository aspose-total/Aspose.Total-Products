---
title: تحويل POTM إلى DOC عبر Java
description: Java API لتصدير POTM إلى DOC دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/potm-to-doc/
family: total
platformtag: net
feature: conversion
informat: POTMM
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTM إلى DOC عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل POTM إلى DOC داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTM إلى DOC عبر Java" %}}
...
لتحويل ملف POTM إلى DOC ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
