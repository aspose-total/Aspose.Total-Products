...
description: قم بتحويل POWERPOINT إلى تنسيق XLSM عبر Java دون استخدام Microsoft Excel أو PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POWERPOINT إلى XLSM عبر Java" h2="في Premise Java API لتصدير POWERPOINT إلى XLSM بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى XLSM عبر Java" %}}
...
لتحويل POWERPOINT إلى XLSM ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) قائم على المشروع وقم بتضمين مكتبات في ملفك pom.xml.
