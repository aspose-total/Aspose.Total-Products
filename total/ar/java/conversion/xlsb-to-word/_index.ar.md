---
title: تحويل XLSB إلى WORD باستخدام Java
description: Java API لتصدير XLSB إلى WORD باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLSB إلى WORD" h2="في Premise Java API لتصدير XLSB إلى WORD دون الاعتماد على Microsoft Excel & reg ؛" >}}
