...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOT إلى DIF عبر Java" h2="في Premise Java API لتحويل DOT إلى DIF بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
