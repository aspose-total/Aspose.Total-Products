...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOT إلى XLTM عبر Java" h2="في Premise Java API لتحويل DOT إلى XLTM بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
