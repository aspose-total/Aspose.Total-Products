---
title: تحويل CSV إلى WORD باستخدام Java
description: Java API لتصدير CSV إلى WORD باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير CSV إلى WORD" h2="في Premise Java API لتصدير CSV إلى WORD دون الاعتماد على Microsoft Excel & reg ؛" >}}
