...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPSX إلى EXCEL عبر Java أو عبر الإنترنت" h2="في Premise Java API لتصدير PPSX إلى EXCEL بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSX إلى EXCEL عبر Java أو عبر الإنترنت" %}}
