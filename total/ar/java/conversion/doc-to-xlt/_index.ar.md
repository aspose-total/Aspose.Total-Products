...
description: قم بتحويل DOC إلى XLT عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOC إلى XLT عبر Java" h2="في Premise Java API لتحويل DOC إلى XLT بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
