---
title: Java API لتحويل DOC إلى FODS أو مع محول مجاني على الإنترنت
description: قم بتحويل DOC إلى FODS عبر Java أو التطبيق عبر الإنترنت دون استخدام Microsoft Word أو Microsoft Excel أو عبر الإنترنت. اختبر محول DOC إلى FODS على الإنترنت مجانًا بسرعة قبل دمج الكود. 
...
{{% blocks/products/pf/agp/feature-section-col title="Java API لتحويل DOC إلى FODS" %}}
