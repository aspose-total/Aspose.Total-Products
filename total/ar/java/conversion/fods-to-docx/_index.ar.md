---
title: تحويل FODS إلى DOCX باستخدام Java
description: Java API لتصدير FODS إلى DOCX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير FODS إلى DOCX" h2="في Premise Java API لتصدير FODS إلى DOCX دون الاعتماد على Microsoft Excel & reg ؛" >}}
