---
title: تحويل CSV إلى POWERPOINT باستخدام Java
description: Java API لتصدير CSV إلى POWERPOINT باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير CSV إلى POWERPOINT" h2="في Premise Java API لتصدير CSV إلى POWERPOINT دون الاعتماد على Microsoft Excel & reg ؛" >}}
