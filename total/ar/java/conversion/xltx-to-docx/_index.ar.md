---
title: تحويل XLTX إلى DOCX باستخدام Java
description: Java API لتصدير XLTX إلى DOCX باستخدام Excel أو Word
url: /ar/java/conversion/xltx-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLTX إلى DOCX" h2="في Premise Java API لتصدير XLTX إلى DOCX دون الاعتماد على Microsoft Excel & reg ؛" >}}
