---
title: تحويل DOTM إلى POTM عبر Java
description: Java API لتصدير DOTM إلى POTM دون استخدام Microsoft Word أو PowerPoint
...
لتحويل ملف DOTM إلى POTM ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
