...
description: Java API لتصدير PPSX إلى ODT دون استخدام Microsoft Word أو PowerPoint أو عبر الإنترنت. اختبر محول PPSX إلى ODT على الإنترنت مجانًا بسرعة قبل دمج الكود. 
