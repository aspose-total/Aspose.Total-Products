...
<iframe title="تطبيق مجاني عبر الإنترنت لتحويل XML إلى XAML" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xaml&from=xml" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="كود جافا لتحويل XML إلى XAML" offSpacer="" %}}
