---
title: تحويل TSV إلى WORD باستخدام Java
description: Java API لتصدير TSV إلى WORD باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير TSV إلى WORD" h2="في Premise Java API لتصدير TSV إلى WORD دون الاعتماد على Microsoft Excel & reg ؛" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/tsv-to-wordx/" name="TSV ل WORDX" description="" >}}
