...
description: قم بتحويل PPSX إلى تنسيق XLTM عبر Java دون استخدام Microsoft Excel أو PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPSX إلى XLTM عبر Java" h2="في Premise Java API لتصدير PPSX إلى XLTM بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSX إلى XLTM عبر Java" %}}
...
لتحويل PPSX إلى XLTM ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) قائم على المشروع وقم بتضمين مكتبات في ملفك pom.xml.
