...
description: قم بتحويل DOTM إلى XLSM عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOTM إلى XLSM عبر Java" h2="في Premise Java API لتحويل DOTM إلى XLSM بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
