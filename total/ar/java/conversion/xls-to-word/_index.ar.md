---
title: تحويل XLS إلى WORD باستخدام Java
description: Java API لتصدير XLS إلى WORD باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLS إلى WORD" h2="في Premise Java API لتصدير XLS إلى WORD دون الاعتماد على Microsoft Excel & reg ؛" >}}
