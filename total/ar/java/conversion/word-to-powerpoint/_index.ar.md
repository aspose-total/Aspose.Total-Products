---
title: تحويل WORD إلى POWERPOINT عبر Java
description: Java API لتصدير WORD إلى POWERPOINT دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/word-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: WORDX
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل WORD إلى POWERPOINT عبر Java" h2="تحويل WORD إلى POWERPOINT باستخدام واجهة برمجة تطبيقات Java في أماكن العمل داخل أي تطبيقات Java J2SE و J2EE و J2ME دون استخدام Microsoft<sup>&reg;</sup> PowerPoint أو Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل WORD إلى POWERPOINT عبر Java" %}}
...
لتحويل ملف WORD إلى POWERPOINT ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
