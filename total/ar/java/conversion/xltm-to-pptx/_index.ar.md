---
title: تحويل XLTM إلى PPTX باستخدام Java
description: Java API لتصدير XLTM إلى PPTX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLTM إلى PPTX" h2="في Premise Java API لتصدير XLTM إلى PPTX دون الاعتماد على Microsoft Excel & reg ؛" >}}
