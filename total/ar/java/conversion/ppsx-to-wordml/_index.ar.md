...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل PPSX إلى WORDML عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل PPSX إلى WORDML داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPSX إلى WORDML عبر Java" %}}
...
لتحويل ملف PPSX إلى WORDML ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
