...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOCX إلى XLSM عبر Java" h2="في Premise Java API لتحويل DOCX إلى XLSM بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
