...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل OTT إلى XLT عبر Java" h2="في Premise Java API لتحويل OTT إلى XLT بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
