...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل RTF إلى XLSB عبر Java" h2="في Premise Java API لتحويل RTF إلى XLSB بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
