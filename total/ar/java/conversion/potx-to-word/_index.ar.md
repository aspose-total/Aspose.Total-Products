---
title: تحويل POTX إلى WORD عبر Java
description: Java API لتصدير POTX إلى WORD دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/potx-to-word/
family: total
platformtag: net
feature: conversion
informat: POTXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTX إلى WORD عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل POTX إلى WORD داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTX إلى WORD عبر Java" %}}
...
لتحويل ملف POTX إلى WORD ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/potx-to-wordm/" name="POTX ل WORDM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/net/conversion/potx-to-wordx/" name="POTX ل WORDX" description="" >}}
