...
description: قم بتحويل DOTM إلى EXCEL عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل DOTM إلى EXCEL عبر Java" h2="في Premise Java API لتحويل DOTM إلى EXCEL بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
