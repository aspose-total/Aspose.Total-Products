---
title: تحويل EXCEL إلى DOCX باستخدام Java
description: Java API لتصدير EXCEL إلى DOCX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير EXCEL إلى DOCX" h2="في Premise Java API لتصدير EXCEL إلى DOCX دون الاعتماد على Microsoft Excel & reg ؛" >}}
