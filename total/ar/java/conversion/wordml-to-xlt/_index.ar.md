...
description: قم بتحويل WORDML إلى XLT عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل WORDML إلى XLT عبر Java" h2="في Premise Java API لتحويل WORDML إلى XLT بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
