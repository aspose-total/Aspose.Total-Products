---
title: تحويل FODS إلى PPTX باستخدام Java
description: Java API لتصدير FODS إلى PPTX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير FODS إلى PPTX" h2="في Premise Java API لتصدير FODS إلى PPTX دون الاعتماد على Microsoft Excel & reg ؛" >}}
...
1. افتح ملف FODS باستخدام فئة [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook)
