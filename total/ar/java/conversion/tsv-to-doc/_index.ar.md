---
title: تحويل TSV إلى DOC باستخدام Java
description: Java API لتصدير TSV إلى DOC باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير TSV إلى DOC" h2="في Premise Java API لتصدير TSV إلى DOC دون الاعتماد على Microsoft Excel & reg ؛" >}}
...
4. احفظ المستند بتنسيق DOC باستخدام [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-) طريقة وتعيين Doc كـ SaveFormat
