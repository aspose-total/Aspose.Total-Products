...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل MOBI إلى EXCEL عبر Java" h2="في Premise Java API لتحويل MOBI إلى EXCEL بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
