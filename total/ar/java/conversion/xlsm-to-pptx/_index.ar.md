...
description: Java API لتصدير XLSM إلى PPTX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLSM إلى PPTX" h2="في Premise Java API لتصدير XLSM إلى PPTX دون الاعتماد على Microsoft Excel & reg ؛" >}}
