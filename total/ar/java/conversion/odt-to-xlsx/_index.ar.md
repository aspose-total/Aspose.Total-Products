...
description: قم بتحويل ODT إلى XLSX عبر Java دون استخدام Microsoft Word أو Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل ODT إلى XLSX عبر Java" h2="في Premise Java API لتحويل ODT إلى XLSX بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
