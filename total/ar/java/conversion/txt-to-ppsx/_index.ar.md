---
title: تحويل TXT إلى PPSX عبر Java
description: Java API لتصدير TXT إلى PPSX دون استخدام Microsoft Word أو PowerPoint
url: /ar/java/conversion/txt-to-ppsx/
family: total
platformtag: net
feature: conversion
informat: TXT
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل TXT إلى PPSX عبر Java" h2="تحويل TXT إلى PPSX باستخدام واجهة برمجة تطبيقات Java في أماكن العمل داخل أي تطبيقات Java J2SE و J2EE و J2ME دون استخدام Microsoft<sup>&reg;</sup> PowerPoint أو Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل TXT إلى PPSX عبر Java" %}}
...
لتحويل ملف TXT إلى PPSX ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
