...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى MARKDOWN عبر Java أو عبر الإنترنت" h2="في Premise Java API لتصدير POT إلى MARKDOWN بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى MARKDOWN عبر Java أو عبر الإنترنت" %}}
