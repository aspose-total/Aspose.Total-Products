...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTX إلى XLTM عبر Java أو عبر الإنترنت" h2="في Premise Java API لتصدير POTX إلى XLTM بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTX إلى XLTM عبر Java أو عبر الإنترنت" %}}
