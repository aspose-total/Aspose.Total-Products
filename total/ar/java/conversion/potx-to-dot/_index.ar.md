---
title: تحويل POTX إلى DOT عبر Java
description: Java API لتصدير POTX إلى DOT دون استخدام Microsoft Word أو PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POTX إلى DOT عبر Java" h2="في Premise Java API لـ PowerPoint ، تحويل POTX إلى DOT داخل أي تطبيقات Java J2SE ، J2EE ، J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POTX إلى DOT عبر Java" %}}
...
لتحويل ملف POTX إلى DOT ، يمكنك بسهولة استخدام Aspose.Total لـ Java مباشرة من [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) القائم على المشروع وتضمين المكتبات في ملفك pom.xml.
