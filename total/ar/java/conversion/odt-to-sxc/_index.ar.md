...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل ODT إلى SXC عبر Java" h2="في Premise Java API لتحويل ODT إلى SXC بدون استخدام Microsoft<sup>&reg;</sup> Word أو Microsoft<sup>&reg;</sup> Excel" >}}
