---
title: تحويل XLS إلى PPTX باستخدام Java
description: Java API لتصدير XLS إلى PPTX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLS إلى PPTX" h2="في Premise Java API لتصدير XLS إلى PPTX دون الاعتماد على Microsoft Excel & reg ؛" >}}
