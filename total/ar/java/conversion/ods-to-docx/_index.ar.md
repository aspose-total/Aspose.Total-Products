---
title: تحويل ODS إلى DOCX باستخدام Java
description: Java API لتصدير ODS إلى DOCX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير ODS إلى DOCX" h2="في Premise Java API لتصدير ODS إلى DOCX دون الاعتماد على Microsoft Excel & reg ؛" >}}
