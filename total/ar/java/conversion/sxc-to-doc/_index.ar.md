---
title: تحويل SXC إلى DOC باستخدام Java
description: Java API لتصدير SXC إلى DOC باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير SXC إلى DOC" h2="في Premise Java API لتصدير SXC إلى DOC دون الاعتماد على Microsoft Excel & reg ؛" >}}
