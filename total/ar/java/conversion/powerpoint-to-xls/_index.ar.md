...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POWERPOINT إلى XLS عبر Java أو عبر الإنترنت" h2="في Premise Java API لتصدير POWERPOINT إلى XLS بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى XLS عبر Java أو عبر الإنترنت" %}}
