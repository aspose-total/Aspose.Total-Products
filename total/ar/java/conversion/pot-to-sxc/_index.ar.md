...
{{< blocks/products/pf/i18n/feature-page-header h1="تحويل POT إلى SXC عبر Java أو عبر الإنترنت" h2="في Premise Java API لتصدير POT إلى SXC بدون استخدام Microsoft<sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POT إلى SXC عبر Java أو عبر الإنترنت" %}}
