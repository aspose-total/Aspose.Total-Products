...
description: Java API لتصدير XLTX إلى PPTX باستخدام Excel أو Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API لتصدير XLTX إلى PPTX" h2="في Premise Java API لتصدير XLTX إلى PPTX دون الاعتماد على Microsoft Excel & reg ؛" >}}
