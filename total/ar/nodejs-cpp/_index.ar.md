---
title: معالجة ملفات PDF وإضافة التعرف الضوئي على الحروف عبر واجهات برمجة تطبيقات Node.js
description: Node.js API لمعالجة ملفات PDF وكذلك استخراج النص من الصور عبر التطبيقات.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API لاستخراج نص PDF والصور" h2="قم باستخراج النص من الصور بالإضافة إلى تضمين ميزات معالجة PDF داخل تطبيقات Node.js دون أي تبعيات برامج أخرى" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total لـ Node.js عبر C++ عبارة عن مجموعة شاملة من مكتبات Node.js.توفر هذه المكتبات وظائف مثل العمل مباشرة مع ملفات PDF وتحسين تطبيقاتك لتحويل الصور إلى نص.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="يتضمن Aspose.Total لـ Node.js عبر C++ مكتبات Node.js التالية:" >}}
...
يمكّنك Aspose.PDF for Node.js عبر C++ من التعامل مع ملفات PDF على الواجهة الخلفية. باستخدامه، يمكنك تحسين ملفات PDF، ودمج واستخراج النصوص والصور، بالإضافة إلى تنفيذ عمليات التشفير وفك التشفير. علاوة على ذلك، تمتد الوظيفة إلى القدرة على تقسيم مستندات PDF ودمجها بسهولة، مما يوفر مجموعة أدوات شاملة لمعالجة ملفات PDF بشكل مبسط.
...
يتيح Aspose.OCR for Node.js عبر C++ إمكانية استخراج النص من الصور مثل الصفحات الممسوحة ضوئيًا والصور الموجودة على الأنظمة الأساسية المتوافقة مع Node.js.قم بتحسين المنتجات المحلية وخدمات الويب والتطبيقات بدون خادم من خلال وظيفة التعرف الضوئي على الأحرف القوية، التي تدعم 28 لغة بما في ذلك الصينية والهندية بالتنسيقات الشائعة.
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 نظرة عامة على Node.js عبر مكتبات C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
لدينا خبرة كبيرة في كل من منتج Office Automation وSoft Artisans’ Office Writer. يعد Total.NET من Aspose أكثر قوة، ويوفر وظائف أكثر من أي شيء استخدمناه في الماضي.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="يقدم Aspose.Total حلولاً فردية لمنصات أخرى." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/ar/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/ar/nodejs-java/" 
