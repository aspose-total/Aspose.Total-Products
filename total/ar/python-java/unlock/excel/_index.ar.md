---
title: فتح حماية كلمة المرور EXCEL عبر الإنترنت أو باستخدام Python
description: قم بإزالة كلمة المرور من مستند EXCEL من خلال التطبيق عبر الإنترنت مجانًا.رمز Python API لفتح ملفات EXCEL المحمية بكلمة مرور.
...
{{< blocks/products/pf/feature-page-header-widget h1="قم بإزالة كلمة المرور من مستند EXCEL عبر الإنترنت أو عبر Python" h2="قم بتطوير تطبيق الأداة المساعدة لقفل وفتح المستندات EXCEL القوي المستند إلى لغة Python.الرمز المدرج لإزالة قيود كلمة المرور من ملف EXCEL عبر Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="إزالة كلمة مرور EXCEL عبر بايثون" %}}

1. واجهات برمجة التطبيقات المرجعية داخل المشروع مباشرة من PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/)).
1. قم بتحميل ملف EXCEL محمي بكلمة مرور باستخدام فئة المستند.
...
{{% blocks/products/pf/agp/code-block title="مثال على التعليمات البرمجية في Python لإزالة كلمة المرور من مستند EXCEL" offSpacer="" %}}
...
<h2>تطوير تطبيق إدارة الحماية EXCEL عبر Python</h2>

هل تحتاج إلى تطوير تطبيق أو أداة لإدارة الحماية EXCEL؟باستخدام [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/)، وهي واجهة برمجة تطبيقات فرعية لـ [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/)، يمكن لأي مطور لغة بايثون دمج كود واجهة برمجة التطبيقات أعلاه ضمن تطبيق حماية المستندات أو إلغاء الحماية الخاص به.مكتبة بايثون القوية تسمح ببرمجة أي حل لحماية المستندات.علاوة على ذلك، يمكنه دعم العديد من التنسيقات الشائعة بما في ذلك تنسيق EXCEL.<br /><br />
