---
title: تحويل XLSB إلى صورة باستخدام Python
description: XLSB إلى صورة TIFF BMP PNG JPEG GIF EMF SVG التحويل في تطبيقات Python دون استخدام Microsoft Excel 
url: /ar/python-java/conversion/xlsb-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLSB
...
- احفظ جميع صفحات ورقة العمل كصورة باستخدام طريقة [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). الآن يتم تحويل ملف XLSB إلى صور بالمسار المحدد

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات التحويل" %}}

- لتحويل XLSB إلى صور (JPG و PNG و GIF و BMP و TIFF) ، قم بمراجعة واجهات برمجة التطبيقات داخل المشروع مباشرةً من PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="XLSB لتحويل الصور عبر Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLSB TO الصورة" description="" >}}
