---
title: تحويل EXCEL إلى صورة باستخدام Python
description: EXCEL إلى صورة TIFF BMP PNG JPEG GIF EMF SVG التحويل في تطبيقات Python دون استخدام Microsoft Excel 
...
- احفظ جميع صفحات ورقة العمل كصورة باستخدام طريقة [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). الآن يتم تحويل ملف EXCEL إلى صور بالمسار المحدد

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات التحويل" %}}

- لتحويل EXCEL إلى صور (JPG و PNG و GIF و BMP و TIFF) ، قم بمراجعة واجهات برمجة التطبيقات داخل المشروع مباشرةً من PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="EXCEL لتحويل الصور عبر Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="EXCEL TO الصورة" description="" >}}
