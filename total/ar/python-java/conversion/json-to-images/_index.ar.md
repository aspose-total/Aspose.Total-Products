---
title: تحويل JSON إلى صورة باستخدام Python
description: JSON إلى صورة TIFF BMP PNG JPEG GIF EMF SVG التحويل في تطبيقات Python دون استخدام Microsoft Excel 
url: /ar/python-java/conversion/json-to-images/
family: total
platformtag: Python
feature: conversion
informat: JSON
...
- احفظ جميع صفحات ورقة العمل كصورة باستخدام طريقة [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). الآن يتم تحويل ملف JSON إلى صور بالمسار المحدد

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات التحويل" %}}

- لتحويل JSON إلى صور (JPG و PNG و GIF و BMP و TIFF) ، قم بمراجعة واجهات برمجة التطبيقات داخل المشروع مباشرةً من PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="JSON لتحويل الصور عبر Python" offSpacer="" %}}
