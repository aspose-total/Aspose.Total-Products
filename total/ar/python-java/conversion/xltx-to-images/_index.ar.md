---
title: تحويل XLTX إلى صورة باستخدام Python
description: XLTX إلى صورة TIFF BMP PNG JPEG GIF EMF SVG التحويل في تطبيقات Python دون استخدام Microsoft Excel 
url: /ar/python-java/conversion/xltx-to-images/
family: total
platformtag: Python
feature: conversion
informat: XLTX
...
- احفظ جميع صفحات ورقة العمل كصورة باستخدام طريقة [SheetRender.toImage(pageIndex, fileName)](https://reference.aspose.com//cells/python-java/asposecells.api/sheetrender#toImage(int,%20java.lang.String)). الآن يتم تحويل ملف XLTX إلى صور بالمسار المحدد
...
{{% blocks/products/pf/agp/code-block title="XLTX لتحويل الصور عبر Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/python-java/conversion/bmp1-to-images/" name="XLTX TO الصورة" description="" >}}
