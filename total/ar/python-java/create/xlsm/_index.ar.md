---
title: أنشئ XLSM في Python
description: قم بإنشاء ملف XLSM باستخدام تطبيقات Python دون استخدام Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="أنشئ XLSM باستخدام Python" h2="قم بإنشاء XLSM عبر تطبيقات Python دون تثبيت Microsoft Office <sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

بالنسبة للمطور ، من يحاول إنشاء ملفات XLSM عبر تطبيق Python؟ يمكن أن تساعد [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) API في أتمتة عملية الإنشاء. إنها حزمة كاملة من واجهات برمجة التطبيقات المختلفة التي تتعامل مع تنسيقات مختلفة بما في ذلك ملفات وصور Microsoft Office. [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/) API الذي يعد جزءًا من حزمة [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) يجعل عملية التوليد هذه سهلة. فيما يلي عملية الخلق. علاوة على ذلك ، يمكن للمطورين تحسين تطبيق تعديل ملف XLSM بسهولة. لتحديث ملف XLSM باستخدام عملية Python هو نفسه باستثناء أنه يتطلب ملفًا موجودًا كمعامل أثناء إنشاء كائن المصنف.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="كيفية إنشاء ملف XLSM في بايثون" %}}
...
- احفظ المستند كملف .xlsm باستخدام [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) بتمرير الملف بالمسار كمعامل

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="متطلبات الخلق" %}}

- لإنشاء XLSM ، قم بالإشارة إلى واجهات برمجة التطبيقات (API) داخل المشروع مباشرةً من PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="أنشئ XLSM في Python" offSpacer="" %}}
