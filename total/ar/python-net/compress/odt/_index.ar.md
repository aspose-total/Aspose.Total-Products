---
title: ضغط ملفات ODT عبر الإنترنت أو إنشاء تطبيقات Python لضغط ملفات ODT أو أرشفتها
description: تطبيق مجاني عبر الإنترنت لضغط ملفات ODT المختلفة. كود مكتبة ضغط وأرشفة بايثون لمستندات ODT. 
...
{{< blocks/products/pf/feature-page-header h1="تطبيق ضغط المستندات عبر الإنترنت ورمز Python لضغط ملفات ODT" h2="تطوير تطبيقات ضغط المستندات ODT القوية المستندة إلى Python. أرشفة مستندات ODT الفردية والمتعددة في ملفات ZIP وRAR والمزيد عبر تطبيق Python الخاص بك. قم بضغط المستندات المختلفة بما في ذلك ملفات ODT عبر الإنترنت عبر التطبيق مع التنزيل الفوري." >}}
...
<h3>تطبيق مجاني لضغط المستندات ODT عبر الإنترنت</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="ضغط ملف ODT عبر بايثون" %}}
...
1. استدعاء طريقة الحفظ والحصول على ملف ODT المضغوط.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="مثال على التعليمات البرمجية في بيثون لضغط ملفات ODT" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="أرشفة ملف ODT عبر بايثون" %}}
...
1. أضف العدد الذي تريد أرشفته من ملفات ODT باستخدام create_entry().
1. اتصل بطريقة الحفظ واحصل على ملف ODT المؤرشف بتنسيق ZIP وRAR وما إلى ذلك.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="مثال على كود بايثون لأرشفة ملف ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "533b68e0904932a37c25a576bd20448d" "compress-and-add-single-file-into-archive.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="كود بايثون لأرشفة ملفات ODT متعددة" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز.يمكن للمرء بسهولة تطوير حل احترافي لضغط ملف ODT للأرشيف المضغوط باستخدام Python.استخدم واجهة برمجة تطبيقات ضغط Aspose ODT لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في Python.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
