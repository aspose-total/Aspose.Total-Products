---
title: أداة تقسيم ملفات PDF عبر الإنترنت أو إنشاء تطبيقات Python لتقسيم ملفات PDF
description: تطبيق مجاني عبر الإنترنت لتقسيم ملفات PDF المختلفة.رمز مكتبة Python Splitter لمستندات PDF.
...
{{% blocks/products/pf/agp/feature-section-col title="تقسيم ملف PDF عبر بايثون" %}}
...
1. أنشئ كائنًا جديدًا لفئة المستند وأضف الصفحة باستخدام pages.add(Page).
1. احفظ الصفحة في ملف جديد باستخدام طريقة save().

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="مثال على التعليمات البرمجية في بيثون لتقسيم صفحة ملفات PDF الحكيمة" offSpacer="" %}}

{{< gist "aspose-com-gists" "cab3cbb646eef9f3bdf5e1922d739399" "split-pdf-documents.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="كود بايثون لتقسيم نطاق صفحات PDF" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لتقسيم ملفات PDF باستخدام Python.استخدم Aspose PDF Splitter API لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في Python.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
