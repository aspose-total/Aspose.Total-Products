---
title: تحويل XLTX إلى RTF باستخدام Python
description: تحويل XLTX إلى RTF في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى RTF عبر Python" h2="تحويل XLTX إلى RTF في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
