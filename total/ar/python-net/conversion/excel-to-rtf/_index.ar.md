---
title: تحويل EXCEL إلى RTF باستخدام Python
description: تحويل EXCEL إلى RTF في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى RTF عبر Python" h2="تحويل EXCEL إلى RTF في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
