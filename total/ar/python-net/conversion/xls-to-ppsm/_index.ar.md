---
title: تحويل XLS إلى PPSM باستخدام Python
description: تحويل XLS إلى PPSM في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLS إلى PPSM عبر Python" h2="تحويل XLS إلى PPSM في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو PowerPoint" >}}
