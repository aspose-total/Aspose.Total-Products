---
title: تحويل EXCEL إلى DOTM باستخدام Python
description: تحويل EXCEL إلى DOTM في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى DOTM عبر Python" h2="تحويل EXCEL إلى DOTM في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
