---
title: تحويل WORDML إلى EMLX في Python
description: احفظ WORDML في EMLX داخل تطبيقات Python دون استخدام Microsoft Word أو Outlook
url: /ar/python-net/conversion/wordml-to-emlx/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
- لتحويل WORDML إلى EMLX ، يلزم Python 3.5 أو أحدث
...
{{% blocks/products/pf/agp/code-block title="حفظ WORDML إلى EMLX في Python" offSpacer="" %}}
