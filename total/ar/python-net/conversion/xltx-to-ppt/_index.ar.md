---
title: تحويل XLTX إلى PPT باستخدام Python
description: تحويل XLTX إلى PPT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى PPT عبر Python" h2="تحويل XLTX إلى PPT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو PowerPoint" >}}
