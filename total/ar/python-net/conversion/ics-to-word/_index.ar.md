---
title: تحويل ICS إلى WORD في Python
description: احفظ ICS في WORD في تطبيقات Python دون استخدام Microsoft Outlook أو Word 
url: /ar/python-net/conversion/ics-to-word/
family: total
platformtag: Python
feature: conversion
informat: ICS
...
- لتحويل ICS إلى WORD ، يلزم Python 3.5 أو أحدث
...
{{% blocks/products/pf/agp/code-block title="حفظ ICS إلى WORD في Python" offSpacer="" %}}
