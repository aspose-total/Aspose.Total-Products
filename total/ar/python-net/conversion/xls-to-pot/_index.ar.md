---
title: تحويل XLS إلى POT باستخدام Python
description: تحويل XLS إلى POT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLS إلى POT عبر Python" h2="تحويل XLS إلى POT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو PowerPoint" >}}
