---
title: تحويل XLTX إلى DOTX باستخدام Python
description: تحويل XLTX إلى DOTX في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى DOTX عبر Python" h2="تحويل XLTX إلى DOTX في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
