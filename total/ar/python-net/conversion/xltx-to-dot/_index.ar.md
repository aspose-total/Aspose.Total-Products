---
title: تحويل XLTX إلى DOT باستخدام Python
description: تحويل XLTX إلى DOT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى DOT عبر Python" h2="تحويل XLTX إلى DOT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
