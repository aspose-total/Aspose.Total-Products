---
title: تحويل EXCEL إلى DOT باستخدام Python
description: تحويل EXCEL إلى DOT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى DOT عبر Python" h2="تحويل EXCEL إلى DOT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
