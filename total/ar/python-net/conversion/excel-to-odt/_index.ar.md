---
title: تحويل EXCEL إلى ODT باستخدام Python
description: تحويل EXCEL إلى ODT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى ODT عبر Python" h2="تحويل EXCEL إلى ODT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
