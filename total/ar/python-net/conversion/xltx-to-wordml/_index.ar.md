---
title: تحويل XLTX إلى WORDML باستخدام Python
description: تحويل XLTX إلى WORDML في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى WORDML عبر Python" h2="تحويل XLTX إلى WORDML في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
