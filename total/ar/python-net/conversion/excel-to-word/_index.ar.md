---
title: تحويل EXCEL إلى WORD باستخدام Python
description: تحويل EXCEL إلى WORD في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى WORD عبر Python" h2="تحويل EXCEL إلى WORD في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
