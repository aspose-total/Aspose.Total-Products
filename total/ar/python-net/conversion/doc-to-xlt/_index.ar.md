---
title: تحويل DOC إلى XLT باستخدام Python
description: تحويل DOC إلى XLT في تطبيقات Python الخاصة بك دون استخدام Microsoft Word أو Excel 
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى XLT عبر Python" h2="تحويل DOC إلى XLT في تطبيقات Python دون تثبيت Microsoft Word <sup>&reg;</sup> أو Excel" >}}
