---
title: تحويل MSG إلى WORD في Python
description: احفظ MSG في WORD في تطبيقات Python دون استخدام Microsoft Outlook أو Word 
url: /ar/python-net/conversion/msg-to-word/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- لتحويل MSG إلى WORD ، يلزم Python 3.5 أو أحدث
...
{{% blocks/products/pf/agp/code-block title="حفظ MSG إلى WORD في Python" offSpacer="" %}}
