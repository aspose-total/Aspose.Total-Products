---
title: تحويل XLTX إلى MOBI باستخدام Python
description: تحويل XLTX إلى MOBI في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى MOBI عبر Python" h2="تحويل XLTX إلى MOBI في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
