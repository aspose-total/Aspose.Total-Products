---
title: تحويل XLTX إلى DOC باستخدام Python
description: تحويل XLTX إلى DOC في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى DOC عبر Python" h2="تحويل XLTX إلى DOC في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
