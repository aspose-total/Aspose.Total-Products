---
title: تحويل PPTX إلى XLSB باستخدام Python
description: تحويل PPTX إلى XLSB في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل PPTX إلى XLSB عبر Python" h2="تحويل PPTX إلى XLSB في تطبيقات Python دون تثبيت Microsoft PowerPoint <sup>&reg;</sup> أو Excel" >}}
