---
title: تحويل XLTX إلى DOTM باستخدام Python
description: تحويل XLTX إلى DOTM في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى DOTM عبر Python" h2="تحويل XLTX إلى DOTM في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
