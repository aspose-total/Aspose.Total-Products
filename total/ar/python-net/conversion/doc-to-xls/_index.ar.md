---
title: تحويل DOC إلى XLS باستخدام Python
description: تحويل DOC إلى XLS في تطبيقات Python الخاصة بك دون استخدام Microsoft Word أو Excel 
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى XLS عبر Python" h2="تحويل DOC إلى XLS في تطبيقات Python دون تثبيت Microsoft Word <sup>&reg;</sup> أو Excel" >}}
