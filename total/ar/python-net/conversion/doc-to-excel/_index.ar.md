---
title: تحويل DOC إلى EXCEL باستخدام Python
description: تحويل DOC إلى EXCEL في تطبيقات Python الخاصة بك دون استخدام Microsoft Word أو Excel 
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى EXCEL عبر Python" h2="تحويل DOC إلى EXCEL في تطبيقات Python دون تثبيت Microsoft Word <sup>&reg;</sup> أو Excel" >}}
