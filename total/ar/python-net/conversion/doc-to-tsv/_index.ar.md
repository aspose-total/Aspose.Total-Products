---
title: تحويل DOC إلى TSV باستخدام Python
description: تحويل DOC إلى TSV في تطبيقات Python الخاصة بك دون استخدام Microsoft Word أو Excel 
...
{{< blocks/products/pf/feature-page-header h1="تحويل DOC إلى TSV عبر Python" h2="تحويل DOC إلى TSV في تطبيقات Python دون تثبيت Microsoft Word <sup>&reg;</sup> أو Excel" >}}
