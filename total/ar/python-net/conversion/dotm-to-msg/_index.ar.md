---
title: تحويل DOTM إلى MSG في Python
description: احفظ DOTM في MSG داخل تطبيقات Python دون استخدام Microsoft Word أو Outlook
url: /ar/python-net/conversion/dotm-to-msg/
family: total
platformtag: Python
feature: conversion
informat: DOTM
...
- لتحويل DOTM إلى MSG ، يلزم Python 3.5 أو أحدث
...
{{% blocks/products/pf/agp/code-block title="حفظ DOTM إلى MSG في Python" offSpacer="" %}}
