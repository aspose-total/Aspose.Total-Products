---
title: تحويل XLS إلى POWERPOINT باستخدام Python
description: تحويل XLS إلى POWERPOINT في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLS إلى POWERPOINT عبر Python" h2="تحويل XLS إلى POWERPOINT في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو PowerPoint" >}}
