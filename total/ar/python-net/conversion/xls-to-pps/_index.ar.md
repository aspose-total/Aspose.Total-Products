---
title: تحويل XLS إلى PPS باستخدام Python
description: تحويل XLS إلى PPS في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLS إلى PPS عبر Python" h2="تحويل XLS إلى PPS في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو PowerPoint" >}}
