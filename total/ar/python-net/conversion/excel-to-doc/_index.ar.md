---
title: تحويل EXCEL إلى DOC باستخدام Python
description: تحويل EXCEL إلى DOC في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى DOC عبر Python" h2="تحويل EXCEL إلى DOC في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
