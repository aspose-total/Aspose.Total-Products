---
title: تحويل EXCEL إلى DOCM باستخدام Python
description: تحويل EXCEL إلى DOCM في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل EXCEL إلى DOCM عبر Python" h2="تحويل EXCEL إلى DOCM في تطبيقات Python دون تثبيت Microsoft Excel <sup>&reg;</sup> أو Word" >}}
