---
title: تحويل PPTX إلى EXCEL باستخدام Python
description: تحويل PPTX إلى EXCEL في تطبيقات Python الخاصة بك دون استخدام Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="تحويل PPTX إلى EXCEL عبر Python" h2="تحويل PPTX إلى EXCEL في تطبيقات Python دون تثبيت Microsoft PowerPoint <sup>&reg;</sup> أو Excel" >}}
