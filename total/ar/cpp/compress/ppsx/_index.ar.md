---
title: ضغط ملفات PPSX عبر الإنترنت أو عبر C++
description: تطبيق مجاني عبر الإنترنت لضغط ملفات PPSX المختلفة.رمز مكتبة الضغط C++ لمستندات PPSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="ضغط ملف PPSX عبر الإنترنت عبر تطبيق الضغط أو باستخدام C++" h2="تطوير تطبيقات ضغط المستندات PPSX القوية المستندة إلى C++.قم بضغط المستندات المختلفة بما في ذلك ملفات PPSX عبر الإنترنت عبر التطبيق مع التنزيل الفوري." >}}
...
1. انقر فوق الزر "ضغط".
1. قم بتحميل ملف PPSX المضغوط.
1. عرض والحصول على نتيجة الضغط عن طريق التحقق من حجمها وجودة محتواها.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="ضغط ملف PPSX عبر C++" %}}

1. أضف مرجع مكتبة C++ إلى المشروع
1. قم بتحميل العرض التقديمي PPSX
1. استخدم طريقة Compress::RemoveUnusedMasterSlides
1. اتصل بطريقة الحفظ واحصل على العرض التقديمي المضغوط لـ PPSX

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="كود C++: ضغط عرض PPSX" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">نعم، مرحبا بكم في تحميل هذا الرمز. يمكن للمرء بسهولة تطوير حل احترافي لضغط ملف PPSX باستخدام C++.استخدم واجهة برمجة تطبيقات ضغط Aspose PPSX لتطوير برامج مستقلة عالية المستوى عن النظام الأساسي في لغة C++.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
