...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى WORD أو عبر الإنترنت" h2="تصدير POTM إلى WORD في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
