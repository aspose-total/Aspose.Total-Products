---
title: تحويل ODT إلى XLT في C++
description: C++ API لتحويل ODT إلى XLT دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى XLT" h2="تصدير ODT إلى XLT عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
