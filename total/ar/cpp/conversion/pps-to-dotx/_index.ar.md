---
title: C++ API لتحويل PPS إلى DOTX
description: قم بتصدير PPS إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى DOTX" h2="تصدير PPS إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
