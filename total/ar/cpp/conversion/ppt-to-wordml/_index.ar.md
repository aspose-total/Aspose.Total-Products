---
title: C++ API لتحويل PPT إلى WORDML
description: قم بتصدير PPT إلى WORDML داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى WORDML" h2="تصدير PPT إلى WORDML في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
