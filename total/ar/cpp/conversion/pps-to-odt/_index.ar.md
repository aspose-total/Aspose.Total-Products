---
title: C++ API لتحويل PPS إلى ODT
description: قم بتصدير PPS إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى ODT" h2="تصدير PPS إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
