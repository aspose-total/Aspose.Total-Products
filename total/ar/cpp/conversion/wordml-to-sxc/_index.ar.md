---
title: تحويل WORDML إلى SXC في C++
description: C++ API لتحويل WORDML إلى SXC دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى SXC" h2="تصدير WORDML إلى SXC عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
