---
title: C++ API لتحويل PPTM إلى DOC
description: قم بتصدير PPTM إلى DOC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTM إلى DOC" h2="تصدير PPTM إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
