...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى POT أو عبر الإنترنت" h2="تصدير RTF إلى POT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
