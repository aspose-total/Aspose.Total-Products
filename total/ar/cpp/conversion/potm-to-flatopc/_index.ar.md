---
title: C++ API لتحويل POTM إلى FLATOPC
description: قم بتصدير POTM إلى FLATOPC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى FLATOPC" h2="تصدير POTM إلى FLATOPC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
4. احفظ المستند بتنسيق FLATOPC باستخدام [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.flatopcument#save_string) fucntion
