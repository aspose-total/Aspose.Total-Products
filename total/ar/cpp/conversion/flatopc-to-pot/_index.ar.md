...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى POT أو عبر الإنترنت" h2="تصدير FLATOPC إلى POT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
