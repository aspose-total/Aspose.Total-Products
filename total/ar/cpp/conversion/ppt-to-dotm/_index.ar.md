---
title: C++ API لتحويل PPT إلى DOTM
description: قم بتصدير PPT إلى DOTM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى DOTM" h2="تصدير PPT إلى DOTM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
