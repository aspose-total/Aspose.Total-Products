---
title: تحويل DOTX إلى FODS في C++
description: C++ API لتحويل DOTX إلى FODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTX إلى FODS" h2="تصدير DOTX إلى FODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
