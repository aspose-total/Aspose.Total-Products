---
title: C++ API لتحويل PPTM إلى OTT
description: قم بتصدير PPTM إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTM إلى OTT" h2="تصدير PPTM إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
