---
title: C++ API لتحويل PPTM إلى WORDML
description: قم بتصدير PPTM إلى WORDML داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTM إلى WORDML" h2="تصدير PPTM إلى WORDML في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
