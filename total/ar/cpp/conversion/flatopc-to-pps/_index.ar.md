---
title: تحويل FLATOPC إلى PPS عبر C++
description: قم بتصدير FLATOPC إلى PPS في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى PPS" h2="تصدير FLATOPC إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
