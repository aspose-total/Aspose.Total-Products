...
description: قم بتصدير PPS إلى SXC في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/pps-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="تحويل PPS إلى SXC عبر C++" h2="PPS لتحويل ملف SXC عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
