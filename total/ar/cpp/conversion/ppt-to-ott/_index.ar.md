---
title: C++ API لتحويل PPT إلى OTT
description: قم بتصدير PPT إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى OTT" h2="تصدير PPT إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
