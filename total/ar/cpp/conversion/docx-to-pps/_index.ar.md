...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCX إلى PPS أو عبر الإنترنت" h2="تصدير DOCX إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
