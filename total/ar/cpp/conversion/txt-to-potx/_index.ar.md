---
title: تحويل TXT إلى POTX عبر C++
description: قم بتصدير TXT إلى POTX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/txt-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى POTX" h2="تصدير TXT إلى POTX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
