---
title: C++ API لتحويل PPTX إلى WORD
description: قم بتصدير PPTX إلى WORD داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى WORD" h2="تصدير PPTX إلى WORD في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
