---
title: C++ API لتحويل PPS إلى OTT
description: قم بتصدير PPS إلى OTT داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى OTT" h2="تصدير PPS إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
