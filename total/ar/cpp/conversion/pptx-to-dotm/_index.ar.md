---
title: C++ API لتحويل PPTX إلى DOTM
description: قم بتصدير PPTX إلى DOTM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى DOTM" h2="تصدير PPTX إلى DOTM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
