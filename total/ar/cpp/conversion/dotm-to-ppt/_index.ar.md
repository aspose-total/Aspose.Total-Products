...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى PPT أو عبر الإنترنت" h2="تصدير DOTM إلى PPT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
