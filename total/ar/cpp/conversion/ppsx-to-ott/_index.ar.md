---
title: C++ API لتحويل PPSX إلى OTT
description: قم بتصدير PPSX إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSX إلى OTT" h2="تصدير PPSX إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
