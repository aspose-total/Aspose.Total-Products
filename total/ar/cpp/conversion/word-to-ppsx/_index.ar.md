---
title: تحويل WORD إلى PPSX عبر C++
description: قم بتصدير WORD إلى PPSX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/word-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى PPSX" h2="تصدير WORD إلى PPSX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
