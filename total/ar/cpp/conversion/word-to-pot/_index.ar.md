---
title: تحويل WORD إلى POT عبر C++
description: قم بتصدير WORD إلى POT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى POT" h2="تصدير WORD إلى POT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
