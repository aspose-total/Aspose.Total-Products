---
title: تحويل DOCM إلى ODP عبر C++
description: قم بتصدير DOCM إلى ODP في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى ODP" h2="تصدير DOCM إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
