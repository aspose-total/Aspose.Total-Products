---
title: تحويل FLATOPC إلى PPTM عبر C++
description: قم بتصدير FLATOPC إلى PPTM في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/flatopc-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى PPTM" h2="تصدير FLATOPC إلى PPTM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
