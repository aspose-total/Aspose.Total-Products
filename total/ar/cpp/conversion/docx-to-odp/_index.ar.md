---
title: تحويل DOCX إلى ODP عبر C++
description: قم بتصدير DOCX إلى ODP في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCX إلى ODP" h2="تصدير DOCX إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
