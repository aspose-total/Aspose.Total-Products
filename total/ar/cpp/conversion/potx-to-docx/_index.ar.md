---
title: C++ API لتحويل POTX إلى DOCX
description: قم بتصدير POTX إلى DOCX داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى DOCX" h2="تصدير POTX إلى DOCX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
