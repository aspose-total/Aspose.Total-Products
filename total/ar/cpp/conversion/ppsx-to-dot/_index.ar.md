---
title: C++ API لتحويل PPSX إلى DOT
description: قم بتصدير PPSX إلى DOT داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSX إلى DOT" h2="تصدير PPSX إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
