---
title: تحويل WORD إلى تنسيق JSON في C++
description: قم بتصدير WORD إلى JSON في C++ دون استخدام Microsoft Excel أو Word
url: /ar/cpp/conversion/word-to-json/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="تحويل WORD إلى تنسيق JSON عبر C++" h2="تصدير WORD إلى JSON عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
باستخدام [Aspose.Total for C++](https://products.aspose.com/total/cpp/) يمكنك تحويل WORD إلى تنسيق JSON داخل تطبيقات C++. أولاً ، باستخدام [Aspose.Words for C++](https://products.aspose.com/words/cpp/) ، يمكنك تصدير WORD إلى HTML. بعد ذلك ، باستخدام [Aspose.Cells for C++](https://products.aspose.com/cells/cpp/) ، يمكنك تحويل HTML إلى تنسيق JSON. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
باستخدام API ، يمكنك أيضًا فتح المستند المحمي بكلمة مرور. إذا كان مستند WORD الذي تم إدخاله محميًا بكلمة مرور ، فلا يمكنك تحويله إلى تنسيق JSON دون استخدام كلمة المرور. للقيام بذلك ، استخدم مُنشئ خاص overload ، والذي يقبل كائن LoadOptions. يحتوي هذا الكائن على خاصية كلمة المرور ، والتي تحدد سلسلة كلمة المرور.
{{% blocks/products/pf/feature-page-code %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/word-to-csv/" name="WORD إلى CSV" description="" >}}
