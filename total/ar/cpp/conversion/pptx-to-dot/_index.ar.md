---
title: C++ API لتحويل PPTX إلى DOT
description: قم بتصدير PPTX إلى DOT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى DOT" h2="تصدير PPTX إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
