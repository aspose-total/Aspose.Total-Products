---
title: تحويل XLT إلى POWERPOINT باستخدام C++
description: تحويل XLT إلى POWERPOINT داخل تطبيقات C++
url: /ar/cpp/conversion/xlt-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLT إلى POWERPOINT عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLT إلى POWERPOINT ضمن تطبيقات C++ كاملة الوظائف" >}}
