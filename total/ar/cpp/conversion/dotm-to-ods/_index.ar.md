---
title: تحويل DOTM إلى ODS في C++
description: C++ API لتحويل DOTM إلى ODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى ODS" h2="تصدير DOTM إلى ODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
