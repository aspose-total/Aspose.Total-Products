---
title: تحويل TXT إلى POWERPOINT عبر C++
description: قم بتصدير TXT إلى POWERPOINT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/txt-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى POWERPOINT" h2="تصدير TXT إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
