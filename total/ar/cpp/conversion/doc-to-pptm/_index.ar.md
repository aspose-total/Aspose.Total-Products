...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى PPTM أو عبر الإنترنت" h2="تصدير DOC إلى PPTM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
