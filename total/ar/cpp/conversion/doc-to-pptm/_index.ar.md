---
title: تحويل DOC إلى PPTM عبر C++
description: قم بتصدير DOC إلى PPTM في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/doc-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى PPTM" h2="تصدير DOC إلى PPTM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
...
2. تحويل DOC إلى HTML باستخدام وظيفة العضو [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stdbasicostream_saveoptions)
