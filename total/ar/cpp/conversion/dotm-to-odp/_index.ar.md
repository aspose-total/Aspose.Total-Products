...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى ODP أو عبر الإنترنت" h2="تصدير DOTM إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
