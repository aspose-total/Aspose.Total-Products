---
title: تحويل ODS إلى PPTX باستخدام C++
description: تحويل ODS إلى PPTX داخل تطبيقات C++
url: /ar/cpp/conversion/ods-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="تحويل ODS إلى PPTX عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ ODS إلى PPTX ضمن تطبيقات C++ كاملة الوظائف" >}}
