---
title: تحويل MOBI إلى XLTX في C++
description: C++ API لتحويل MOBI إلى XLTX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/mobi-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل MOBI إلى XLTX" h2="تصدير MOBI إلى XLTX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
