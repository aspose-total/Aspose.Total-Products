...
description: تحويل XLTM إلى DOCX داخل تطبيقات C++
url: /ar/cpp/conversion/xltm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTM إلى DOCX عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLTM إلى DOCX ضمن تطبيقات C++ كاملة الوظائف" >}}
