---
title: تحويل XLSX إلى DOC باستخدام C++
description: تحويل XLSX إلى DOC داخل تطبيقات C++
url: /ar/cpp/conversion/xlsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLSX إلى DOC عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLSX إلى DOC ضمن تطبيقات C++ كاملة الوظائف" >}}
