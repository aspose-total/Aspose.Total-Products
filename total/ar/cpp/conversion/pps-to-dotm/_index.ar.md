---
title: C++ API لتحويل PPS إلى DOTM
description: قم بتصدير PPS إلى DOTM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى DOTM" h2="تصدير PPS إلى DOTM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
