---
title: C++ API لتحويل POTX إلى DOCM
description: قم بتصدير POTX إلى DOCM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى DOCM" h2="تصدير POTX إلى DOCM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
