---
title: C++ API لتحويل POT إلى DOCX
description: قم بتصدير POT إلى DOCX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى DOCX" h2="تصدير POT إلى DOCX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
