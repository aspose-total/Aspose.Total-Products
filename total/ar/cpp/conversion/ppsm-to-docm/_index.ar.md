---
title: C++ API لتحويل PPSM إلى DOCM
description: قم بتصدير PPSM إلى DOCM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى DOCM" h2="تصدير PPSM إلى DOCM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
