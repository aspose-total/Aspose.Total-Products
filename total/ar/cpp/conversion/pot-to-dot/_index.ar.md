---
title: C++ API لتحويل POT إلى DOT
description: قم بتصدير POT إلى DOT داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى DOT" h2="تصدير POT إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
