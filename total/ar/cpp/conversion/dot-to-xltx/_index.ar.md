---
title: تحويل DOT إلى XLTX في C++
description: C++ API لتحويل DOT إلى XLTX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dot-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOT إلى XLTX" h2="تصدير DOT إلى XLTX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
