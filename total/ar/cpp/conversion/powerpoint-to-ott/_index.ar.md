---
title: C++ API لتحويل POWERPOINT إلى OTT
description: قم بتصدير POWERPOINT إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/powerpoint-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POWERPOINT إلى OTT" h2="تصدير POWERPOINT إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/pptx-to-ottm/" name="PPTX إلى OTTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/pptx-to-ottx/" name="PPTX إلى OTTX" description="" >}}
