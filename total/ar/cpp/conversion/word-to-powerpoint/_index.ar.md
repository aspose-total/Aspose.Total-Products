...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى POWERPOINT أو عبر الإنترنت" h2="تصدير WORD إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
