---
title: C++ API لتحويل PPT إلى DOC
description: قم بتصدير PPT إلى DOC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى DOC" h2="تصدير PPT إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
