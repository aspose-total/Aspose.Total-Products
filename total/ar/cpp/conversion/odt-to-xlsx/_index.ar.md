---
title: تحويل ODT إلى XLSX في C++
description: C++ API لتحويل ODT إلى XLSX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى XLSX" h2="تصدير ODT إلى XLSX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل ODT إلى XLSX" %}}
