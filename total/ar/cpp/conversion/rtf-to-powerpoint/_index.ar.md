---
title: تحويل RTF إلى POWERPOINT عبر C++
description: قم بتصدير RTF إلى POWERPOINT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/rtf-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى POWERPOINT" h2="تصدير RTF إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
