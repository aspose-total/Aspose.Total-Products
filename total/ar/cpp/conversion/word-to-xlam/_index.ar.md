---
title: تحويل WORD إلى XLAM في C++
description: C++ API لتحويل WORD إلى XLAM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/word-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى XLAM" h2="تصدير WORD إلى XLAM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
