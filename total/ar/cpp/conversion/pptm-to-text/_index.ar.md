---
title: C++ API لتحويل PPTM إلى TEXT
description: قم بتصدير PPTM إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTM إلى TEXT" h2="تصدير PPTM إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
