---
title: تحويل DOTM إلى DIF في C++
description: C++ API لتحويل DOTM إلى DIF دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى DIF" h2="تصدير DOTM إلى DIF عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
