---
title: تحويل XLT إلى WORD باستخدام C++
description: تحويل XLT إلى WORD داخل تطبيقات C++
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLT إلى WORD عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLT إلى WORD ضمن تطبيقات C++ كاملة الوظائف" >}}
