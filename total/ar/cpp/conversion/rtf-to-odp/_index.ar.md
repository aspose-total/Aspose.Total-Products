---
title: تحويل RTF إلى ODP عبر C++
description: قم بتصدير RTF إلى ODP في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى ODP" h2="تصدير RTF إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
