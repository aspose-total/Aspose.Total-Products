---
title: تحويل WORD إلى PPSM عبر C++
description: قم بتصدير WORD إلى PPSM في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/word-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى PPSM" h2="تصدير WORD إلى PPSM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
