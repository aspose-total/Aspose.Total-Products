---
title: C++ API لتحويل POTX إلى DOTX
description: قم بتصدير POTX إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى DOTX" h2="تصدير POTX إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
