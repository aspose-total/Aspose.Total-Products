---
title: تحويل DOCM إلى TSV في C++
description: C++ API لتحويل DOCM إلى TSV دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى TSV" h2="تصدير DOCM إلى TSV عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
