---
title: تحويل DOCX إلى POTX عبر C++
description: قم بتصدير DOCX إلى POTX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCX إلى POTX" h2="تصدير DOCX إلى POTX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
