---
title: تحويل ODT إلى XLTM في C++
description: C++ API لتحويل ODT إلى XLTM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى XLTM" h2="تصدير ODT إلى XLTM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل ODT إلى XLTM" %}}
