---
title: تحويل DOC إلى XLAM في C++
description: C++ API لتحويل DOC إلى XLAM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى XLAM" h2="تصدير DOC إلى XLAM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOC إلى XLAM" %}}
