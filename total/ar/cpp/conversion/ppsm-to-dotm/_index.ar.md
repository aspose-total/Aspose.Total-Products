---
title: C++ API لتحويل PPSM إلى DOTM
description: قم بتصدير PPSM إلى DOTM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى DOTM" h2="تصدير PPSM إلى DOTM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
4. احفظ المستند بتنسيق DOTM باستخدام [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.dotmument#save_string) fucntion
