---
title: C++ API لتحويل PPT إلى DOCM
description: قم بتصدير PPT إلى DOCM داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى DOCM" h2="تصدير PPT إلى DOCM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
