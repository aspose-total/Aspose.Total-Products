---
title: تحويل MOBI إلى XLS في C++
description: C++ API لتحويل MOBI إلى XLS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/mobi-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل MOBI إلى XLS" h2="تصدير MOBI إلى XLS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
