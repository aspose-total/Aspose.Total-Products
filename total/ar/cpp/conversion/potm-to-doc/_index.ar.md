---
title: C++ API لتحويل POTM إلى DOC
description: قم بتصدير POTM إلى DOC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى DOC" h2="تصدير POTM إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
