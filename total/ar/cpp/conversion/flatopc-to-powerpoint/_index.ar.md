---
title: تحويل FLATOPC إلى POWERPOINT عبر C++
description: قم بتصدير FLATOPC إلى POWERPOINT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/flatopc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى POWERPOINT" h2="تصدير FLATOPC إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
