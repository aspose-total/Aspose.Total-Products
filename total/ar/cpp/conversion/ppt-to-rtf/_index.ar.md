---
title: C++ API لتحويل PPT إلى RTF
description: قم بتصدير PPT إلى RTF داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى RTF" h2="تصدير PPT إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/ppt-to-rtfm/" name="PPT إلى RTFM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/ppt-to-rtfx/" name="PPT إلى RTFX" description="" >}}
