---
title: C++ API لتحويل PPTM إلى WORD
description: قم بتصدير PPTM إلى WORD داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTM إلى WORD" h2="تصدير PPTM إلى WORD في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
