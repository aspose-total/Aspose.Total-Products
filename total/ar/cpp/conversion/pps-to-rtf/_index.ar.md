...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى RTF أو عبر الإنترنت" h2="تصدير PPS إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
