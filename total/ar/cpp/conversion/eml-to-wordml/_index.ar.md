...
4. احفظ المستند بتنسيق WORDML باستخدام طريقة [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) وقم بتعيين Wordml كـ SaveFormat
