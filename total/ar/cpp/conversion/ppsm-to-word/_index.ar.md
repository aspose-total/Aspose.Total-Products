...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى WORD أو عبر الإنترنت" h2="تصدير PPSM إلى WORD في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
