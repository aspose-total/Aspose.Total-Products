---
title: تحويل FLATOPC إلى ODP عبر C++
description: قم بتصدير FLATOPC إلى ODP في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/flatopc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى ODP" h2="تصدير FLATOPC إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
