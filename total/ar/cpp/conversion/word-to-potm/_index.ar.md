---
title: تحويل WORD إلى POTM عبر C++
description: قم بتصدير WORD إلى POTM في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى POTM" h2="تصدير WORD إلى POTM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
