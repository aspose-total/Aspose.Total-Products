---
title: C++ API لتحويل PPTX إلى DOTX
description: قم بتصدير PPTX إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى DOTX" h2="تصدير PPTX إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
4. احفظ المستند بتنسيق DOTX باستخدام [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.dotxument#save_string) fucntion
