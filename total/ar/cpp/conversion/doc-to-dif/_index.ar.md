---
title: تحويل DOC إلى DIF في C++
description: C++ API لتحويل DOC إلى DIF دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/doc-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى DIF" h2="تصدير DOC إلى DIF عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
