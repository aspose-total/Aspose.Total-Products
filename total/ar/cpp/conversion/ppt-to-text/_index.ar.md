---
title: C++ API لتحويل PPT إلى TEXT
description: قم بتصدير PPT إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى TEXT" h2="تصدير PPT إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
