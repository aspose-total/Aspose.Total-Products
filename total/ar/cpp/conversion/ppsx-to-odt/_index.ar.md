---
title: C++ API لتحويل PPSX إلى ODT
description: قم بتصدير PPSX إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSX إلى ODT" h2="تصدير PPSX إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
