---
title: C++ API لتحويل POTM إلى RTF
description: قم بتصدير POTM إلى RTF داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى RTF" h2="تصدير POTM إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
