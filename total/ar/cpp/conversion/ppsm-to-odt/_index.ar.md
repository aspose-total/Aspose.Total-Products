---
title: C++ API لتحويل PPSM إلى ODT
description: قم بتصدير PPSM إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى ODT" h2="تصدير PPSM إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
