---
title: تحويل POWERPOINT إلى FODS عبر C++
description: قم بتصدير POWERPOINT إلى FODS في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/powerpoint-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="تحويل POWERPOINT إلى FODS عبر C++" h2="POWERPOINT لتحويل ملف FODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل POWERPOINT إلى FODS عبر C++" %}}
...
2. تحويل POWERPOINT إلى HTML باستخدام طريقة [حفظ](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba)
