---
title: تحويل MOBI إلى XLSB في C++
description: C++ API لتحويل MOBI إلى XLSB دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/mobi-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل MOBI إلى XLSB" h2="تصدير MOBI إلى XLSB عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
