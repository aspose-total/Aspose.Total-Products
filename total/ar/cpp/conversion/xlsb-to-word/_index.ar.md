---
title: تحويل XLSB إلى WORD باستخدام C++
description: تحويل XLSB إلى WORD داخل تطبيقات C++
url: /ar/cpp/conversion/xlsb-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLSB إلى WORD عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLSB إلى WORD ضمن تطبيقات C++ كاملة الوظائف" >}}
...
4. احفظ المستند بتنسيق WORD باستخدام وظيفة العضو [حفظ](https://reference.aspose.com/pdf/cpp/class/aspose.pdf.wordument#a6383c010776212483f51cc41235924db) وقم بتعيين Word على أنه SaveFormat
