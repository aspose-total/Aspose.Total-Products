---
title: C++ API لتحويل POTM إلى TEXT
description: قم بتصدير POTM إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى TEXT" h2="تصدير POTM إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
4. احفظ المستند بتنسيق TEXT باستخدام [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.textument#save_string) fucntion
