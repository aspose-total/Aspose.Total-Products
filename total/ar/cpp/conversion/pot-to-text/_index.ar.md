---
title: C++ API لتحويل POT إلى TEXT
description: قم بتصدير POT إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pot-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى TEXT" h2="تصدير POT إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
