...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى TEXT أو عبر الإنترنت" h2="تصدير POT إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
