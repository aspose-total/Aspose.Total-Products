---
title: تحويل DOTX إلى SXC في C++
description: C++ API لتحويل DOTX إلى SXC دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTX إلى SXC" h2="تصدير DOTX إلى SXC عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
