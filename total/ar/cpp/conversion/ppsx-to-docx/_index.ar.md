---
title: C++ API لتحويل PPSX إلى DOCX
description: قم بتصدير PPSX إلى DOCX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSX إلى DOCX" h2="تصدير PPSX إلى DOCX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
