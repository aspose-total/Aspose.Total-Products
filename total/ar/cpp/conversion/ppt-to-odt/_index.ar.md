---
title: C++ API لتحويل PPT إلى ODT
description: قم بتصدير PPT إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى ODT" h2="تصدير PPT إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
2. عرض PPT إلى HTML باستخدام funciton لعضو [حفظ](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) وتعيين Html كـ SaveFormat
3. قم بتحميل ملف HTML المحول باستخدام مرجع الفئة [المستند](https://reference.aspose.com/words/cpp/class/aspose.words.odtument)
4. احفظ المستند بتنسيق ODT باستخدام [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.odtument#save_string) fucntion
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/ppt-to-odtm/" name="PPT إلى ODTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/ppt-to-odtx/" name="PPT إلى ODTX" description="" >}}
