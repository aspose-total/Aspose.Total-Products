---
title: C++ API لتحويل PPSX إلى RTF
description: قم بتصدير PPSX إلى RTF داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSX إلى RTF" h2="تصدير PPSX إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
