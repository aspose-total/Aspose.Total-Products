---
title: تحويل WORDML إلى XLSB في C++
description: C++ API لتحويل WORDML إلى XLSB دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى XLSB" h2="تصدير WORDML إلى XLSB عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل WORDML إلى XLSB" %}}
