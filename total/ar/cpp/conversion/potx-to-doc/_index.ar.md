---
title: C++ API لتحويل POTX إلى DOC
description: قم بتصدير POTX إلى DOC داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى DOC" h2="تصدير POTX إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
