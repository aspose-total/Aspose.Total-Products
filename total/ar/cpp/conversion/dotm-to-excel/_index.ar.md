---
title: تحويل DOTM إلى EXCEL في C++
description: C++ API لتحويل DOTM إلى EXCEL دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى EXCEL" h2="تصدير DOTM إلى EXCEL عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOTM إلى EXCEL" %}}
