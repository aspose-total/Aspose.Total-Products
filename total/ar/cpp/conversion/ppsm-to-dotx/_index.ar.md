---
title: C++ API لتحويل PPSM إلى DOTX
description: قم بتصدير PPSM إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى DOTX" h2="تصدير PPSM إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
