---
title: تحويل RTF إلى PPS عبر C++
description: قم بتصدير RTF إلى PPS في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/rtf-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى PPS" h2="تصدير RTF إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
