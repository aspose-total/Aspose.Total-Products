---
title: تحويل DOC إلى CSV في C++
description: C++ API لتحويل DOC إلى CSV دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/doc-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى CSV" h2="تصدير DOC إلى CSV عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOC إلى CSV" %}}
