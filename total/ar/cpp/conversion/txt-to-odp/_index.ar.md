---
title: تحويل TXT إلى ODP عبر C++
description: قم بتصدير TXT إلى ODP في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى ODP" h2="تصدير TXT إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
