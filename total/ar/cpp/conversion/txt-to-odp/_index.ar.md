...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى ODP أو عبر الإنترنت" h2="تصدير TXT إلى ODP داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
