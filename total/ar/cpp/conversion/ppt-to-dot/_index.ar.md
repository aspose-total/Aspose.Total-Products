---
title: C++ API لتحويل PPT إلى DOT
description: قم بتصدير PPT إلى DOT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى DOT" h2="تصدير PPT إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
