---
title: C++ API لتحويل PPT إلى DOTX
description: قم بتصدير PPT إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppt-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPT إلى DOTX" h2="تصدير PPT إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
