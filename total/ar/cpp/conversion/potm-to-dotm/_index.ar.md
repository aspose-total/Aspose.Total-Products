---
title: C++ API لتحويل POTM إلى DOTM
description: قم بتصدير POTM إلى DOTM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى DOTM" h2="تصدير POTM إلى DOTM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
