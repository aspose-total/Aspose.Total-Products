---
title: تحويل DOCX إلى POWERPOINT عبر C++
description: قم بتصدير DOCX إلى POWERPOINT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCX إلى POWERPOINT" h2="تصدير DOCX إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
