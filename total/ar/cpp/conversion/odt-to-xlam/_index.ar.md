---
title: تحويل ODT إلى XLAM في C++
description: C++ API لتحويل ODT إلى XLAM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى XLAM" h2="تصدير ODT إلى XLAM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
