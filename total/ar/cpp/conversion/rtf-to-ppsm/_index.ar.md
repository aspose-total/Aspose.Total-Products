---
title: تحويل RTF إلى PPSM عبر C++
description: قم بتصدير RTF إلى PPSM في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/rtf-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى PPSM" h2="تصدير RTF إلى PPSM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
