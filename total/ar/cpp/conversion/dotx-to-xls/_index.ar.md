---
title: تحويل DOTX إلى XLS في C++
description: C++ API لتحويل DOTX إلى XLS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTX إلى XLS" h2="تصدير DOTX إلى XLS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
