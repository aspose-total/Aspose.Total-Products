---
title: C++ API لتحويل POTX إلى WORDML
description: قم بتصدير POTX إلى WORDML داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى WORDML" h2="تصدير POTX إلى WORDML في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/potx-to-wordmlx/" name="POTX إلى WORDMLX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ar/cpp/conversion/potx-to-wordmlm/" name="POTX إلى WORDMLM" description="" >}}
