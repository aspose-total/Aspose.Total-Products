...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى DOCM أو عبر الإنترنت" h2="تصدير POT إلى DOCM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
