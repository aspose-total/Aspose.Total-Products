---
title: تحويل DOCM إلى ODS في C++
description: C++ API لتحويل DOCM إلى ODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى ODS" h2="تصدير DOCM إلى ODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOCM إلى ODS" %}}
