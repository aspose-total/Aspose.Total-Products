...
description: تحويل XLT إلى PPTX داخل تطبيقات C++
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLT إلى PPTX عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLT إلى PPTX ضمن تطبيقات C++ كاملة الوظائف" >}}
