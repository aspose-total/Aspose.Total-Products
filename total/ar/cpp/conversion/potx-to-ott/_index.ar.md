---
title: C++ API لتحويل POTX إلى OTT
description: قم بتصدير POTX إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى OTT" h2="تصدير POTX إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
