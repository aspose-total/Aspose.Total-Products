---
title: تحويل TSV إلى DOC باستخدام C++
description: تحويل TSV إلى DOC داخل تطبيقات C++
url: /ar/cpp/conversion/tsv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: TSV
...
{{< blocks/products/pf/feature-page-header h1="تحويل TSV إلى DOC عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ TSV إلى DOC ضمن تطبيقات C++ كاملة الوظائف" >}}
