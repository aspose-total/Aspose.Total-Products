---
title: C++ API لتحويل POT إلى WORDML
description: قم بتصدير POT إلى WORDML داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى WORDML" h2="تصدير POT إلى WORDML في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
