...
description: تحويل XLSX إلى DOCX داخل تطبيقات C++
url: /ar/cpp/conversion/xlsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLSX إلى DOCX عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLSX إلى DOCX ضمن تطبيقات C++ كاملة الوظائف" >}}
