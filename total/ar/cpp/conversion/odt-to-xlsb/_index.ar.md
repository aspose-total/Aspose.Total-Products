---
title: تحويل ODT إلى XLSB في C++
description: C++ API لتحويل ODT إلى XLSB دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى XLSB" h2="تصدير ODT إلى XLSB عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
