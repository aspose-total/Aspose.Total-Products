---
title: C++ API لتحويل PPSM إلى DOCX
description: قم بتصدير PPSM إلى DOCX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى DOCX" h2="تصدير PPSM إلى DOCX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
