---
title: C++ API لتحويل POT إلى DOC
description: قم بتصدير POT إلى DOC داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى DOC" h2="تصدير POT إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
