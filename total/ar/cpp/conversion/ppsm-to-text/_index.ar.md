---
title: C++ API لتحويل PPSM إلى TEXT
description: قم بتصدير PPSM إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى TEXT" h2="تصدير PPSM إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
