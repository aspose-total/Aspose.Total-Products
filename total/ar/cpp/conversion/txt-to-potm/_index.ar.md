...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى POTM أو عبر الإنترنت" h2="تصدير TXT إلى POTM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
