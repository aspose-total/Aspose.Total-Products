---
title: تحويل FLATOPC إلى POTX عبر C++
description: قم بتصدير FLATOPC إلى POTX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/flatopc-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل FLATOPC إلى POTX" h2="تصدير FLATOPC إلى POTX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
