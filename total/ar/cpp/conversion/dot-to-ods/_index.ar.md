---
title: تحويل DOT إلى ODS في C++
description: C++ API لتحويل DOT إلى ODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dot-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOT إلى ODS" h2="تصدير DOT إلى ODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
