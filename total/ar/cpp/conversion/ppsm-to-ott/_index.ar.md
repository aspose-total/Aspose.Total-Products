---
title: C++ API لتحويل PPSM إلى OTT
description: قم بتصدير PPSM إلى OTT داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى OTT" h2="تصدير PPSM إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
