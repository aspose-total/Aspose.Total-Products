---
title: C++ API لتحويل POTM إلى DOCM
description: قم بتصدير POTM إلى DOCM داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTM إلى DOCM" h2="تصدير POTM إلى DOCM في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
