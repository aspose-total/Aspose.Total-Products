---
title: تحويل XLTX إلى WORD باستخدام C++
description: تحويل XLTX إلى WORD داخل تطبيقات C++
url: /ar/cpp/conversion/xltx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="تحويل XLTX إلى WORD عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ XLTX إلى WORD ضمن تطبيقات C++ كاملة الوظائف" >}}
