---
title: تحويل WORD إلى XLTM في C++
description: C++ API لتحويل WORD إلى XLTM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى XLTM" h2="تصدير WORD إلى XLTM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل WORD إلى XLTM" %}}
