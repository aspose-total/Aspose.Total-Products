---
title: تحويل TXT إلى PPS عبر C++
description: قم بتصدير TXT إلى PPS في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى PPS" h2="تصدير TXT إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
