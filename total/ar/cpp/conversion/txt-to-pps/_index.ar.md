...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل TXT إلى PPS أو عبر الإنترنت" h2="تصدير TXT إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
