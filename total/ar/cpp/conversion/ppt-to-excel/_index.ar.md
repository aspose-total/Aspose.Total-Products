---
title: تحويل PPT إلى EXCEL عبر C++
description: قم بتصدير PPT إلى EXCEL في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/ppt-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="تحويل PPT إلى EXCEL عبر C++" h2="PPT لتحويل ملف EXCEL عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="كيفية تحويل PPT إلى EXCEL عبر C++" %}}
1. افتح ملف PPT باستخدام مرجع فئة [Presentation](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation)
2. تحويل PPT إلى HTML باستخدام طريقة [حفظ](https://reference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba)
