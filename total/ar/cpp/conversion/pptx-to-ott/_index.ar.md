---
title: C++ API لتحويل PPTX إلى OTT
description: قم بتصدير PPTX إلى OTT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى OTT" h2="تصدير PPTX إلى OTT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
