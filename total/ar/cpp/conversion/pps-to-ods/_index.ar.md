...
description: قم بتصدير PPS إلى ODS في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/pps-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="تحويل PPS إلى ODS عبر C++" h2="PPS لتحويل ملف ODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
