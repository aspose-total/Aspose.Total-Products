---
title: تحويل DOC إلى PPSX عبر C++
description: قم بتصدير DOC إلى PPSX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/doc-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى PPSX" h2="تصدير DOC إلى PPSX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
