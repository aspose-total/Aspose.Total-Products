---
title: C++ API لتحويل PPTX إلى DOCX
description: قم بتصدير PPTX إلى DOCX داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى DOCX" h2="تصدير PPTX إلى DOCX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
