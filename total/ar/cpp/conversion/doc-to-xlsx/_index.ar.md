---
title: تحويل DOC إلى XLSX في C++
description: C++ API لتحويل DOC إلى XLSX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/doc-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى XLSX" h2="تصدير DOC إلى XLSX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOC إلى XLSX" %}}
