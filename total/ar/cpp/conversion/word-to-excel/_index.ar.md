...
description: C++ API لتحويل WORD إلى EXCEL دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/word-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى EXCEL" h2="تصدير WORD إلى EXCEL عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
