---
title: تحويل DOCM إلى XLSB في C++
description: C++ API لتحويل DOCM إلى XLSB دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى XLSB" h2="تصدير DOCM إلى XLSB عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
