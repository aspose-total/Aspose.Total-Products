---
title: C++ API لتحويل POTX إلى RTF
description: قم بتصدير POTX إلى RTF داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى RTF" h2="تصدير POTX إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
