---
title: تحويل ODT إلى FODS في C++
description: C++ API لتحويل ODT إلى FODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/odt-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل ODT إلى FODS" h2="تصدير ODT إلى FODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل ODT إلى FODS" %}}
1. افتح ملف ODT باستخدام [Odtument](https://reference.aspose.com/words/cpp/class/aspose.words.odtument) مرجع فئة
2. تحويل ODT إلى HTML باستخدام وظيفة العضو [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.odtument#save_string_saveformat)
