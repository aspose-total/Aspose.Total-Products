---
title: تحويل DOTX إلى XLSX في C++
description: C++ API لتحويل DOTX إلى XLSX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dotx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTX إلى XLSX" h2="تصدير DOTX إلى XLSX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
