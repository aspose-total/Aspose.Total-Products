---
title: C++ API لتحويل POWERPOINT إلى TEXT
description: قم بتصدير POWERPOINT إلى TEXT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/powerpoint-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POWERPOINT إلى TEXT" h2="تصدير POWERPOINT إلى TEXT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
