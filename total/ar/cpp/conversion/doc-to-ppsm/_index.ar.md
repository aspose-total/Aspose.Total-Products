...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى PPSM أو عبر الإنترنت" h2="تصدير DOC إلى PPSM داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
