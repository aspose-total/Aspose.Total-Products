---
title: تحويل WORD إلى XLSB في C++
description: C++ API لتحويل WORD إلى XLSB دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى XLSB" h2="تصدير WORD إلى XLSB عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
