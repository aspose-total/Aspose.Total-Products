---
title: تحويل ODS إلى DOC باستخدام C++
description: تحويل ODS إلى DOC داخل تطبيقات C++
...
{{< blocks/products/pf/feature-page-header h1="تحويل ODS إلى DOC عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ ODS إلى DOC ضمن تطبيقات C++ كاملة الوظائف" >}}
