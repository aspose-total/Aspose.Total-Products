---
title: C++ API لتحويل POWERPOINT إلى DOTX
description: قم بتصدير POWERPOINT إلى DOTX داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/powerpoint-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POWERPOINT إلى DOTX" h2="تصدير POWERPOINT إلى DOTX في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
