---
title: تحويل DOC إلى POTX عبر C++
description: قم بتصدير DOC إلى POTX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى POTX" h2="تصدير DOC إلى POTX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
