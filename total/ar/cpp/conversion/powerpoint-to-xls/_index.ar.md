...
description: قم بتصدير POWERPOINT إلى XLS في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/powerpoint-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="تحويل POWERPOINT إلى XLS عبر C++" h2="POWERPOINT لتحويل ملف XLS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
