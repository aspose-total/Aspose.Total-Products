---
title: تحويل DOC إلى PPS عبر C++
description: قم بتصدير DOC إلى PPS في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOC إلى PPS" h2="تصدير DOC إلى PPS داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
