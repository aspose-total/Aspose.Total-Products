---
title: تحويل WORDML إلى XLSM في C++
description: C++ API لتحويل WORDML إلى XLSM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى XLSM" h2="تصدير WORDML إلى XLSM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
