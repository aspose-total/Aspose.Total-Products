---
title: تحويل DOCX إلى POT عبر C++
description: قم بتصدير DOCX إلى POT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCX إلى POT" h2="تصدير DOCX إلى POT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
