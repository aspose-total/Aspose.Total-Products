---
title: تحويل DOT إلى XLT في C++
description: C++ API لتحويل DOT إلى XLT دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOT إلى XLT" h2="تصدير DOT إلى XLT عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
