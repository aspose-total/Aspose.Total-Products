...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى POWERPOINT أو عبر الإنترنت" h2="تصدير DOTM إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
