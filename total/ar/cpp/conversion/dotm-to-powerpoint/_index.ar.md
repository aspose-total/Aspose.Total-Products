---
title: تحويل DOTM إلى POWERPOINT عبر C++
description: قم بتصدير DOTM إلى POWERPOINT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/dotm-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOTM إلى POWERPOINT" h2="تصدير DOTM إلى POWERPOINT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
