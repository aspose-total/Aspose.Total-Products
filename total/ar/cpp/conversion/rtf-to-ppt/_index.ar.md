---
title: تحويل RTF إلى PPT عبر C++
description: قم بتصدير RTF إلى PPT في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/rtf-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل RTF إلى PPT" h2="تصدير RTF إلى PPT داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
