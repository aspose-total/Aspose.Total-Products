---
title: تحويل WORD إلى POTX عبر C++
description: قم بتصدير WORD إلى POTX في تطبيقات C++ دون استخدام Microsoft Word of PowerPoint
url: /ar/cpp/conversion/word-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى POTX" h2="تصدير WORD إلى POTX داخل تطبيقات C++ دون استخدام Microsoft Word <sup>&reg;</sup> ؛ أو PowerPoint" >}}
