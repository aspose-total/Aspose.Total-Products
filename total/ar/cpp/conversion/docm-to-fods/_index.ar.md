---
title: تحويل DOCM إلى FODS في C++
description: C++ API لتحويل DOCM إلى FODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى FODS" h2="تصدير DOCM إلى FODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
