---
title: تحويل WORDML إلى XLTM في C++
description: C++ API لتحويل WORDML إلى XLTM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى XLTM" h2="تصدير WORDML إلى XLTM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
