---
title: تحويل WORDML إلى DIF في C++
description: C++ API لتحويل WORDML إلى DIF دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى DIF" h2="تصدير WORDML إلى DIF عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
