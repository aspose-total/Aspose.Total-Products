---
title: C++ API لتحويل PPTX إلى ODT
description: قم بتصدير PPTX إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPTX إلى ODT" h2="تصدير PPTX إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
