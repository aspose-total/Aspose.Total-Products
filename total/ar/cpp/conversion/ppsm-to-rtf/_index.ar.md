---
title: C++ API لتحويل PPSM إلى RTF
description: قم بتصدير PPSM إلى RTF داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/ppsm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPSM إلى RTF" h2="تصدير PPSM إلى RTF في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
