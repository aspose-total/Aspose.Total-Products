---
title: تحويل SXC إلى POWERPOINT باستخدام C++
description: تحويل SXC إلى POWERPOINT داخل تطبيقات C++
url: /ar/cpp/conversion/sxc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="تحويل SXC إلى POWERPOINT عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ SXC إلى POWERPOINT ضمن تطبيقات C++ كاملة الوظائف" >}}
