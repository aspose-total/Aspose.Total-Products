---
title: C++ API لتحويل POTX إلى FLATOPC
description: قم بتصدير POTX إلى FLATOPC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/potx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POTX إلى FLATOPC" h2="تصدير POTX إلى FLATOPC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
