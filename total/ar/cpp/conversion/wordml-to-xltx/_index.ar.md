---
title: تحويل WORDML إلى XLTX في C++
description: C++ API لتحويل WORDML إلى XLTX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/wordml-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORDML إلى XLTX" h2="تصدير WORDML إلى XLTX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
