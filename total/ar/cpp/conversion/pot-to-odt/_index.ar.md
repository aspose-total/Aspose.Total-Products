---
title: C++ API لتحويل POT إلى ODT
description: قم بتصدير POT إلى ODT داخل تطبيقات C++ الخاصة بك
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POT إلى ODT" h2="تصدير POT إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
