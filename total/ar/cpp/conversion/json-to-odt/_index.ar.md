...
url: /ar/cpp/conversion/json-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
4. احفظ المستند بتنسيق ODT باستخدام طريقة [حفظ](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat)
