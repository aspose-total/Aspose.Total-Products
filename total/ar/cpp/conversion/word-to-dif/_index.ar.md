---
title: تحويل WORD إلى DIF في C++
description: C++ API لتحويل WORD إلى DIF دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/word-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل WORD إلى DIF" h2="تصدير WORD إلى DIF عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
