---
title: C++ API لتحويل POWERPOINT إلى ODT
description: قم بتصدير POWERPOINT إلى ODT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POWERPOINT إلى ODT" h2="تصدير POWERPOINT إلى ODT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
