---
title: C++ API لتحويل POWERPOINT إلى DOT
description: قم بتصدير POWERPOINT إلى DOT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم POWERPOINT إلى DOT" h2="تصدير POWERPOINT إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
