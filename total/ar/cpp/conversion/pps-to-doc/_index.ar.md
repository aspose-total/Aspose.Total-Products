---
title: C++ API لتحويل PPS إلى DOC
description: قم بتصدير PPS إلى DOC داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pps-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى DOC" h2="تصدير PPS إلى DOC في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
