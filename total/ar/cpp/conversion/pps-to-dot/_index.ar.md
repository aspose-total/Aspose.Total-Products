...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى DOT أو عبر الإنترنت" h2="تصدير PPS إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
