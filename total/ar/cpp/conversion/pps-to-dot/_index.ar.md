---
title: C++ API لتحويل PPS إلى DOT
description: قم بتصدير PPS إلى DOT داخل تطبيقات C++ الخاصة بك
url: /ar/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتقديم PPS إلى DOT" h2="تصدير PPS إلى DOT في تطبيقات C++ بدون أي تبعيات Microsoft PowerPoint أو Word" >}}
