---
title: تحويل DOCM إلى XLTM في C++
description: C++ API لتحويل DOCM إلى XLTM دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى XLTM" h2="تصدير DOCM إلى XLTM عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
