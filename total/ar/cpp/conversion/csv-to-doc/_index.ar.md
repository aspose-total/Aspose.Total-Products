---
title: تحويل CSV إلى DOC باستخدام C++
description: تحويل CSV إلى DOC داخل تطبيقات C++
url: /ar/cpp/conversion/csv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="تحويل CSV إلى DOC عبر C++" h2="تصدير Excel <sup>&reg;</sup> ؛ CSV إلى DOC ضمن تطبيقات C++ كاملة الوظائف" >}}
