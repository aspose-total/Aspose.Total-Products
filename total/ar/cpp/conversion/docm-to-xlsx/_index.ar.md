---
title: تحويل DOCM إلى XLSX في C++
description: C++ API لتحويل DOCM إلى XLSX دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/docm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOCM إلى XLSX" h2="تصدير DOCM إلى XLSX عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
