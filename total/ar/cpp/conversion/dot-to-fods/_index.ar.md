---
title: تحويل DOT إلى FODS في C++
description: C++ API لتحويل DOT إلى FODS دون استخدام Microsoft Word أو Microsoft Excel
url: /ar/cpp/conversion/dot-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API لتحويل DOT إلى FODS" h2="تصدير DOT إلى FODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Word أو Microsoft <sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API لتحويل DOT إلى FODS" %}}
