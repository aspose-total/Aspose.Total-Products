...
description: قم بتصدير POTX إلى ODS في C++ بدون استخدام Microsoft Excel أو Powerpoint
url: /ar/cpp/conversion/potx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="تحويل POTX إلى ODS عبر C++" h2="POTX لتحويل ملف ODS عبر C++ بدون استخدام Microsoft <sup>&reg;</sup> Excel أو PowerPoint" >}}
