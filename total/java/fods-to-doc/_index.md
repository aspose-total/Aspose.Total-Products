---
title: Convert FODS to DOC using Java 
description: Convert FODS to DOC using On Premise Java API
url: /java/conversion/fods-to-doc/
family: total
platformtag: java
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to DOC via Java" h2="On Premise Java API to Export FODS to DOC without relying on Microsoft Excel&reg;">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="FODS to DOC Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for FODS to DOC Conversion" gistPath="" %}}
```cs
