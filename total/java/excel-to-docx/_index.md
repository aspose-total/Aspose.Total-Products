---
title: Convert EXCEL to DOCX using Java 
description: Convert EXCEL to DOCX using On Premise Java API
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert EXCEL to DOCX via Java" h2="On Premise Java API to Export EXCEL to DOCX without relying on Microsoft Excel&reg;">}}
