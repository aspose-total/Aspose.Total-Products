---
title: Convert TSV to PPTX using Java 
description: Convert TSV to PPTX using On Premise Java API
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to PPTX via Java" h2="On Premise Java API to Export TSV to PPTX without relying on Microsoft Excel&reg;">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="TSV to PPTX Conversion on Java" %}}
1. Open TSV file using [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) class
