...
description: Java API to Export DOTM to POT without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOTM to POT Conversion" gistPath="" %}}
```cs
