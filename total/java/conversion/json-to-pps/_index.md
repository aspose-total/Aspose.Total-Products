...
informat: JSON
outformat: PPS
otherformats: POT PPTM PPSM POTM OTP POWERPOINT PPSX ODP PPT POTX
---
...
{{% blocks/products/pf/agp/feature-section-col title="Convert JSON Format to PPS via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Set Layout and Convert JSON Format to PPS via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert JSON Format to PPS with Watermark via Java" %}}
