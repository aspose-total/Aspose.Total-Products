---
title: Convert PPSX to ODT via Java
description: Java API to Export PPSX to ODT without using Microsoft Word or PowerPoint
url: /java/conversion/ppsx-to-odt/
family: total
platformtag: java
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to ODT via Java" h2="On Premise Java API for PowerPoint PPSX to ODT conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to ODT via Java" %}}
...
For PPSX to ODT file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert PPSX to ODT with Watermark via Java" %}}
Using the API, you can also perform PPSX file to ODT conversion with watermark. In order to add a watermark to your ODT document, you can first convert the PPSX  file to HTML and add a watermark to it. In order to add a watermark, load the newly created HTML file using the [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) class, create an instance of TextWatermarkOptions and set its properties, Call Watermark.setText method and pass watermark text & object of TextWatermarkOptions.
{{% blocks/products/pf/feature-page-code %}}
