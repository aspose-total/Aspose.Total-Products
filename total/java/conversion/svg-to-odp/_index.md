---
title: Convert SVG to ODP via Java API
description: Java API to Convert SVG to ODP without using Microsoft Word
url: /java/conversion/svg-to-odp/
family: total
platformtag: java
feature: conversion
informat: SVG
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert SVG to ODP" %}}
1. Open SVG file using [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) class
2. Convert SVG to PPTX by using [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-int-) method
