---
title: Convert DOCM to POTM via Java 
description: Java API to Export DOCM to POTM without using Microsoft Word of PowerPoint 
url: /java/conversion/docm-to-potm/
family: total
platformtag: java
feature: conversion
informat: DOCM
outformat: POTM
otherformats: POWERPOINT PPTM POT PPTX POTX PPS PPSM PPSX ODP PPT
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert DOCM to POTM" h2="Export Microsoft Word&reg; DOCM to PowerPoint POTM by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOCM to POTM Conversion" gistPath="" %}}
```cs
