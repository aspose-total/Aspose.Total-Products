---
title: Convert OTT to PPS via Java 
description: Java API to Export OTT to PPS without using Microsoft Word of PowerPoint 
url: /java/conversion/ott-to-pps/
family: total
platformtag: java
feature: conversion
informat: OTT
outformat: PPS
otherformats: POT PPTM PPTX PPSM ODP POTX PPSX POTM POWERPOINT PPT
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert OTT to PPS" h2="Export Microsoft Word&reg; OTT to PowerPoint PPS by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for OTT to PPS Conversion" gistPath="" %}}
```cs
