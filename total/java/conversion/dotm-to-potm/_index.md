...
description: Java API to Export DOTM to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOTM to POTM Conversion" gistPath="" %}}
```cs
