---
title: Convert PPSX to RTF via Java
description: Java API to Export PPSX to RTF without using Microsoft Word or PowerPoint
url: /java/conversion/ppsx-to-rtf/
family: total
platformtag: java
feature: conversion
informat: PPSX
outformat: RTF
otherformats: DOTX DOC DOCM FLATOPC WORD ODT TEXT WORDML DOTM DOT DOCX OTT
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to RTF via Java" h2="On Premise Java API for PowerPoint PPSX to RTF conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSX to RTF via Java" %}}
...
For PPSX to RTF file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
