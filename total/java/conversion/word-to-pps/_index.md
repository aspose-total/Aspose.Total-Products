...
description: Java API to Export WORD to PPS without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for WORD to PPS Conversion" gistPath="" %}}
```cs
