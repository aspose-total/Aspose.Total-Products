---
title: Convert PPSM to DOC via Java
description: Java API to Export PPSM to DOC without using Microsoft Word or PowerPoint
url: /java/conversion/ppsm-to-doc/
family: total
platformtag: java
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSM to DOC via Java" h2="On Premise Java API for PowerPoint PPSM to DOC conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSM to DOC via Java" %}}
...
For PPSM to DOC file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
