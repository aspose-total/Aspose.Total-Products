...
description: Java API to Export POT to DOTM without using PowerPoint or Word 
...
{{% blocks/products/pf/agp/content h2="How to Convert POT to DOTM Using Java" %}}
[Aspose.Total for Java](https://products.aspose.com/total/java/) File Format Automation libraries empowers Java developers to automate the batch conversion process of PowerPoint POT to Word DOTM. 
Rendering the document is a two step process and involves using two APIs. We’ll use [Aspose.Slides for Java](https://products.aspose.com/slides/java/) that is a PowerPoint API for presentations manipulation and management to convert POT to HTML. After that by using feature-rich Word Processing API [Aspose.Words for Java](https://products.aspose.com/words/java/) we will convert the HTML to DOTM. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="POT to DOTM Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for POT to DOTM Conversion" gistPath="" %}}
```cs
