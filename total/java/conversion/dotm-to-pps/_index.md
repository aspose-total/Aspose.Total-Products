...
description: Java API to Export DOTM to PPS without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOTM to PPS Conversion" gistPath="" %}}
```cs
