...
description: Java API to Export WORDML to POTX without using Microsoft Word of PowerPoint 
url: /java/conversion/wordml-to-potx/
family: total
platformtag: java
feature: conversion
informat: WORDML
outformat: POTX
otherformats: PPS POT PPTM POWERPOINT PPSX PPT ODP PPTX PPSM POTM
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert WORDML to POTX" h2="Export Microsoft Word&reg; WORDML to PowerPoint POTX by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert WORDML to POTX Using Java" %}}
Often times developers have to manipulate and convert Microsoft Word WORDML to PowerPoint POTX programatically. By using the File Automation Java libraries [Aspose.Total for Java](https://products.aspose.com/total/java/) you can automate the rendering process in few simple steps. You can load, generate, or manipulate your WORDML file format by using [Aspose.Words for Java](https://products.aspose.com/words/java/) and convert it to HTML. After that by using powerful PowerPoint manipulation Java API [Aspose.Slides for Java](https://products.aspose.com/slides/java/) you can create a new Presentation, write HTML content in it, and save it as POTX. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="WORDML to POTX Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for WORDML to POTX Conversion" gistPath="" %}}
```cs
