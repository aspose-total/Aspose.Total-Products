---
title: Java API to Export XPS to FLATOPC
description: Convert XPS to FLATOPC using on premise Java API
url: /java/conversion/xps-to-flatopc/
family: total
platformtag: java
feature: conversion
informat: XPS
outformat: FLAT_OPC
otherformats: MARKDOWN OTT DOTX PS DOT PCL WORDML MHTML DOCM DOTM RTF XAMLFLOW
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XPS to FLATOPC" %}}
