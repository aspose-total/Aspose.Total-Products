---
title: Convert ODT to PPS via Java 
description: Java API to Export ODT to PPS without using Microsoft Word of PowerPoint 
url: /java/conversion/odt-to-pps/
family: total
platformtag: java
feature: conversion
informat: ODT
outformat: PPS
otherformats: POTX POTM PPT POT PPTM PPTX PPSX ODP PPSM POWERPOINT
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert ODT to PPS" h2="Export Microsoft Word&reg; ODT to PowerPoint PPS by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for ODT to PPS Conversion" gistPath="" %}}
```cs
