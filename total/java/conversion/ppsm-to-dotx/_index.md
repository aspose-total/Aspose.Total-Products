---
title: Convert PPSM to DOTX via Java
description: Java API to Export PPSM to DOTX without using Microsoft Word or PowerPoint
url: /java/conversion/ppsm-to-dotx/
family: total
platformtag: java
feature: conversion
informat: PPSM
outformat: DOTX
otherformats: DOT FLATOPC DOCX RTF WORDML ODT DOCM TEXT DOTM WORD DOC OTT
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Convert PPSM to DOTX via Java" h2="On Premise Java API for PowerPoint PPSM to DOTX conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPSM to DOTX via Java" %}}
...
For PPSM to DOTX file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert PPSM to DOTX with Watermark via Java" %}}
Using the API, you can also perform PPSM file to DOTX conversion with watermark. In order to add a watermark to your DOTX document, you can first convert the PPSM  file to HTML and add a watermark to it. In order to add a watermark, load the newly created HTML file using the [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) class, create an instance of TextWatermarkOptions and set its properties, Call Watermark.setText method and pass watermark text & object of TextWatermarkOptions.
{{% blocks/products/pf/feature-page-code %}}
