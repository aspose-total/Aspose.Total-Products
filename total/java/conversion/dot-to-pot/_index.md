...
description: Java API to Export DOT to POT without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOT to POT Conversion" gistPath="" %}}
```cs
