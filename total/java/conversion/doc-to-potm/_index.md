...
description: Java API to Export DOC to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOC to POTM Conversion" gistPath="" %}}
```cs
