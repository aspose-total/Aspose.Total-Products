...
description: Java API to Export WORDML to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for WORDML to POTM Conversion" gistPath="" %}}
```cs
