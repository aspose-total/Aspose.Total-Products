...
description: Java API to Export DOCX to PPTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/content h2="How to Convert DOCX to PPTM Using Java" %}}
Often times developers have to manipulate and convert Microsoft Word DOCX to PowerPoint PPTM programatically. By using the File Automation Java libraries [Aspose.Total for Java](https://products.aspose.com/total/java/) you can automate the rendering process in few simple steps. You can load, generate, or manipulate your DOCX file format by using [Aspose.Words for Java](https://products.aspose.com/words/java/) and convert it to HTML. After that by using powerful PowerPoint manipulation Java API [Aspose.Slides for Java](https://products.aspose.com/slides/java/) you can create a new Presentation, write HTML content in it, and save it as PPTM. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX to PPTM Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOCX to PPTM Conversion" gistPath="" %}}
```cs
