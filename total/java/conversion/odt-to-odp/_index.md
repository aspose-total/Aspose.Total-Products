---
title: Convert ODT to ODP via Java 
description: Java API to Export ODT to ODP without using Microsoft Word of PowerPoint 
url: /java/conversion/odt-to-odp/
family: total
platformtag: java
feature: conversion
informat: ODT
outformat: ODP
otherformats: PPTX POTX POWERPOINT PPSM POT PPS PPTM PPSX POTM PPT
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert ODT to ODP" h2="Export Microsoft Word&reg; ODT to PowerPoint ODP by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert ODT to ODP Using Java" %}}
Often times developers have to manipulate and convert Microsoft Word ODT to PowerPoint ODP programatically. By using the File Automation Java libraries [Aspose.Total for Java](https://products.aspose.com/total/java/) you can automate the rendering process in few simple steps. You can load, generate, or manipulate your ODT file format by using [Aspose.Words for Java](https://products.aspose.com/words/java/) and convert it to HTML. After that by using powerful PowerPoint manipulation Java API [Aspose.Slides for Java](https://products.aspose.com/slides/java/) you can create a new Presentation, write HTML content in it, and save it as ODP. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT to ODP Conversion on Java" %}}
...
4. Save the document to ODP format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-) method and set Odp as SaveFormat
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for ODT to ODP Conversion" gistPath="" %}}
```cs
