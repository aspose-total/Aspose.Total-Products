...
description: Java API to Export OTT to PPTX without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/content h2="How to Convert OTT to PPTX Using Java" %}}
Often times developers have to manipulate and convert Microsoft Word OTT to PowerPoint PPTX programatically. By using the File Automation Java libraries [Aspose.Total for Java](https://products.aspose.com/total/java/) you can automate the rendering process in few simple steps. You can load, generate, or manipulate your OTT file format by using [Aspose.Words for Java](https://products.aspose.com/words/java/) and convert it to HTML. After that by using powerful PowerPoint manipulation Java API [Aspose.Slides for Java](https://products.aspose.com/slides/java/) you can create a new Presentation, write HTML content in it, and save it as PPTX. 
{{% /blocks/products/pf/agp/content %}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}
{{% blocks/products/pf/agp/feature-section-col title="OTT to PPTX Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for OTT to PPTX Conversion" gistPath="" %}}
```cs
