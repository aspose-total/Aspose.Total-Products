...
informat: PPTX
outformat: RTF
otherformats: DOT TEXT DOTM WORD FLATOPC DOC DOCX DOCM ODT WORDML DOTX OTT
---
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PPTX to RTF via Java" %}}
The API also allows you to perform PPTX to RTF conversion of password protected documents. If your input PPTX document is password protected, you cannot convert it to RTF format without using the password. The API allows you to open the encrypted document by passing the correct password in a LoadOptions object.
{{% blocks/products/pf/feature-page-code %}}
