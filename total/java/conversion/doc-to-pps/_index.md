...
description: Java API to Export DOC to PPS without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOC to PPS Conversion" gistPath="" %}}
```cs
