...
url: /java/conversion/powerpoint-to-json/
family: total
platformtag: java
feature: conversion
informat: PPT
...
Converting POWERPOINT to JSON format via [Aspose.Total for Java](https://products.aspose.com/total/java/) is a simple two step process. By [Aspose.Slides for Java](https://products.aspose.com/slides/java/), you can export POWERPOINT to HTML. After that, by using [Aspose.Cells for Java](https://products.aspose.com/cells/java/), you can convert HTML to JSON.
{{% /blocks/products/pf/feature-page-summary  %}}
