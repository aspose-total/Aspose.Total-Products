...
description: Java API to Export DOCX to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOCX to POTM Conversion" gistPath="" %}}
```cs
