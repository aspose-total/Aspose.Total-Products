---
title: Convert DOCX to ODP via Java
description: Java API to Export DOCX to ODP without using Microsoft Word or PowerPoint
url: /java/conversion/docx-to-odp/
family: total
platformtag: java
feature: conversion
informat: DOCX
outformat: ODP
otherformats: PPSX PPTM POTX POWERPOINT PPS PPT POTM POT PPSM PPTX CSV DIF FODS ODS SXC TSV XLAM XLTM EXCEL XLS XLSB XLSM XLSX XLT XLTM XLTX
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Convert DOCX to ODP via Java" h2="DOCX to ODP conversion by using on premise Java API within any Java J2SE, J2EE, J2ME applications without using Microsoft<sup>&reg;</sup> PowerPoint or Word" >}}
...
For DOCX to ODP file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
