---
title: Convert XML to ODP via Java API
description: Java API to Convert XML to ODP without using Microsoft Word
url: /java/conversion/xml-to-odp/
family: total
platformtag: java
feature: conversion
informat: XML
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XML to ODP" %}}
...
4. Save the document to ODP format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) method and set `Odp` as SaveFormat
