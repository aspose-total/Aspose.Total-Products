---
title: Convert RTF to POT via Java 
description: Java API to Export RTF to POT without using Microsoft Word of PowerPoint 
url: /java/conversion/rtf-to-pot/
family: total
platformtag: java
feature: conversion
informat: RTF
outformat: POT
otherformats: POTM POTX PPSX PPSM PPS PPTM POWERPOINT ODP PPTX PPT
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="Java API to Convert RTF to POT" h2="Export Microsoft Word&reg; RTF to PowerPoint POT by using on premise Java API within any Java J2SE, J2EE, J2ME applications" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="DOC" pfName="Aspose.Total" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for RTF to POT Conversion" gistPath="" %}}
```cs
