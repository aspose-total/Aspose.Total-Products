...
description: Java API to Export WORD to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for WORD to POTM Conversion" gistPath="" %}}
```cs
