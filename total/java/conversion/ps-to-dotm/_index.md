---
title: Java API to Export PS to DOTM
description: Convert PS to DOTM using on premise Java API
url: /java/conversion/ps-to-dotm/
family: total
platformtag: java
feature: conversion
informat: PS
outformat: DOTM
otherformats: DOCM OTT MHTML WORDML RTF XAMLFLOW ODT DOTX FLATOPC MARKDOWN PCL DOT
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert PS to DOTM" %}}
