...
description: Java API to Export DOTX to POTM without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOTX to POTM Conversion" gistPath="" %}}
```cs
