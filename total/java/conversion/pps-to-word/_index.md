---
title: Convert PPS to WORD via Java
description: Java API to Export PPS to WORD without using Microsoft Word or PowerPoint
url: /java/conversion/pps-to-word/
family: total
platformtag: java
feature: conversion
informat: PPS
outformat: DOCX
otherformats: DOTM TEXT DOCX OTT WORDML FLATOPC DOC DOT DOTX DOCM ODT RTF
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="Convert PPS to WORD via Java" h2="On Premise Java API for PowerPoint PPS to WORD conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPS to WORD via Java" %}}
...
For PPS to WORD file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert PPS to WORD with Watermark via Java" %}}
Using the API, you can also perform PPS file to WORD conversion with watermark. In order to add a watermark to your WORD document, you can first convert the PPS  file to HTML and add a watermark to it. In order to add a watermark, load the newly created HTML file using the [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) class, create an instance of TextWatermarkOptions and set its properties, Call Watermark.setText method and pass watermark text & object of TextWatermarkOptions.
{{% blocks/products/pf/feature-page-code %}}
