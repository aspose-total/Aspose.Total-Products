---
title: Java API to Export CGM to MARKDOWN
description: Convert CGM to MARKDOWN using on premise Java API
url: /java/conversion/cgm-to-markdown/
family: total
platformtag: java
feature: conversion
informat: CGM
outformat: MARKDOWN
otherformats: PCL OTT DOT XAMLFLOW PS MHTML ODT DOTM FLATOPC DOTX DOCM RTF
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert CGM to MARKDOWN" %}}
