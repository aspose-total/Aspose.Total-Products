---
title: Convert POTM to DOCX via Java
description: Java API to Export POTM to DOCX without using Microsoft Word or PowerPoint
url: /java/conversion/potm-to-docx/
family: total
platformtag: java
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Convert POTM to DOCX via Java" h2="On Premise Java API for PowerPoint POTM to DOCX conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POTM to DOCX via Java" %}}
...
For POTM to DOCX file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert POTM to DOCX with Watermark via Java" %}}
Using the API, you can also perform POTM file to DOCX conversion with watermark. In order to add a watermark to your DOCX document, you can first convert the POTM  file to HTML and add a watermark to it. In order to add a watermark, load the newly created HTML file using the [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) class, create an instance of TextWatermarkOptions and set its properties, Call Watermark.setText method and pass watermark text & object of TextWatermarkOptions.
{{% blocks/products/pf/feature-page-code %}}
