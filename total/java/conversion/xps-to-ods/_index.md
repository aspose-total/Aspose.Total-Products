...
description: Transform XPS to ODS via Java API without using Microsoft Excel or Adobe Reader
url: /java/conversion/xps-to-ods/
family: total
platformtag: java
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="Java API to Transform XPS to ODS" h2="Convert XPS to ODS by using on premise Java API within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XPS to ODS" %}}
