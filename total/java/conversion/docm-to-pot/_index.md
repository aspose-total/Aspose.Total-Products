...
description: Java API to Export DOCM to POT without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOCM to POT Conversion" gistPath="" %}}
```cs
