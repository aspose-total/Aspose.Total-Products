---
title: Convert POTX to DOCX via Java
description: Java API to Export POTX to DOCX without using Microsoft Word or PowerPoint
url: /java/conversion/potx-to-docx/
family: total
platformtag: java
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Convert POTX to DOCX via Java" h2="On Premise Java API for PowerPoint POTX to DOCX conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POTX to DOCX via Java" %}}
...
For POTX to DOCX file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert POTX to DOCX with Watermark via Java" %}}
