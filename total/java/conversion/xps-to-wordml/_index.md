---
title: Java API to Export XPS to WORDML
description: Convert XPS to WORDML using on premise Java API
url: /java/conversion/xps-to-wordml/
family: total
platformtag: java
feature: conversion
informat: XPS
outformat: WORD_ML
otherformats: MHTML PS DOTM PCL MARKDOWN FLATOPC XAMLFLOW DOCM DOTX RTF OTT ODT
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XPS to WORDML" %}}
