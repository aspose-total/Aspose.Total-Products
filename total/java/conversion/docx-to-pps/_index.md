...
description: Java API to Export DOCX to PPS without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOCX to PPS Conversion" gistPath="" %}}
```cs
