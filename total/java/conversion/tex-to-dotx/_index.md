---
title: Java API to Export TEX to DOTX
description: Convert TEX to DOTX using on premise Java API
url: /java/conversion/tex-to-dotx/
family: total
platformtag: java
feature: conversion
informat: TEX
outformat: DOTX
otherformats: MARKDOWN FLATOPC DOCM DOT MHTML DOTM XAMLFLOW RTF PCL ODT PS WORDML
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert TEX to DOTX" %}}
