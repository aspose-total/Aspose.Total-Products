---
title: Java API to Render PCL to XLTX
description: Export PCL to XLTX via Java API without using Microsoft Excel or Adobe Reader
url: /java/conversion/pcl-to-xltx/
family: total
platformtag: java
feature: conversion
informat: PCL
outformat: XLTX
otherformats: EXCEL ODS TXT XLSM DIF TSV XLTM FODS CSV XLAM MD XLSB
---
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PCL File to XLTX via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PCL to XLTX via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert PCL File to XLTX with Watermark via Java" %}}
While converting PCL file to XLTX, you can also add watermark to your output XLTX file format. In order to add a watermark, create a new Workbook to open the converted XLSX file. Select Worksheet via its index, create a Shape and use its addTextEffect function, set colors, transparency and more. After that you can save your XLSX document as XLTX with Watermark.  
{{% blocks/products/pf/feature-page-code %}}
