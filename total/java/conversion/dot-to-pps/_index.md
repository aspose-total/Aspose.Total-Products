...
description: Java API to Export DOT to PPS without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for DOT to PPS Conversion" gistPath="" %}}
```cs
