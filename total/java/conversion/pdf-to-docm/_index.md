---
title: Java API to Export PDF to DOCM
description: Convert PDF to DOCM using on premise Java API
url: /java/conversion/pdf-to-docm/
family: total
platformtag: java
feature: conversion
informat: PDF
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert PDF to DOCM" %}}
