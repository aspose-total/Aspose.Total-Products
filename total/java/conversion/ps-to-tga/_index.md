...
description: Export PS file to TGA  in your Java applications without using any third party application 
...
{{% blocks/products/pf/agp/feature-section-col title="Export PS to TGA via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert & Rotate PS to TGA File via Java" %}}
