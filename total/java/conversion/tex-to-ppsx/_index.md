---
title: Convert TEX to PPSX via Java API
description: Java API to Convert TEX to PPSX without using Microsoft Word
url: /java/conversion/tex-to-ppsx/
family: total
platformtag: java
feature: conversion
informat: TEX
outformat: PPSX
otherformats: PPSM POT SWF POWERPOINT XAML PPTM POTX PPS POTM ODP PPT OTP
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert TEX to PPSX" %}}
1. Open TEX file using [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) class
2. Convert TEX to PPTX by using [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-int-) method
