...
description: Java API to Export ODT to POT without using Microsoft Word of PowerPoint 
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for ODT to POT Conversion" gistPath="" %}}
```cs
