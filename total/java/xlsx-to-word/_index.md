---
title: Convert XLSX to WORD using Java 
description: Convert XLSX to WORD using On Premise Java API
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to WORD via Java" h2="On Premise Java API to Export XLSX to WORD without relying on Microsoft Excel&reg;">}}
{{< blocks/products/pf/main-container >}}
{{< blocks/products/pf/agp/feature-section isGrey="true" >}}

{{% blocks/products/pf/agp/feature-section-col title="XLSX to WORD Conversion on Java" %}}
...
{{% blocks/products/pf/agp/code-autogen title="Java Code for XLSX to WORD Conversion" gistPath="" %}}
```cs
