...
{{% blocks/products/pf/agp/code-autogen title="C# Code for PS to MARKDOWN Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly MARKDOWN via .NET " %}}
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect MARKDOWN file format" %}}
```cs
// load Doc with an instance of Document
