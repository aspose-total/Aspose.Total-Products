...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to DOCX via C#" h2="Export Excel&reg; SXC to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
