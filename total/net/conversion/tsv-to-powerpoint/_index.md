...
informat: TSV
outformat: PPTX
otherformats: PPTX DOC WORD POWERPOINT 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert TSV to POWERPOINT via C#" h2="Export Excel® TSV to POWERPOINT on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
