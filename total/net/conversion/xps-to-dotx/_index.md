...
description: Convert XPS to DOTX without using Microsoft Word
url: /net/conversion/xps-to-dotx/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="Render XPS to DOTX via .NET" h2=".NET API to Export XPS to DOTX on Windows, macOS, and Linux without using Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API to Convert XPS to DOTX" %}}
