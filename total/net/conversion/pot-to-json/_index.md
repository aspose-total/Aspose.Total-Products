---
title: Convert POT to JSON format via .NET 
description: Convert POT to JSON in C# without using Microsoft Excel or Powerpoint
url: /net/conversion/pot-to-json/
family: total
platformtag: net
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Convert POT to JSON Format via C#" h2="Export POT to JSON via C# without using Microsoft<sup>&reg;</sup> Word or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert POT to JSON Format via C#" %}}
1. Open POT file using [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation) class
2. Convert POT to HTML by using [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) method
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected POT to JSON Format via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert POT to JSON in Range via C#" %}}
