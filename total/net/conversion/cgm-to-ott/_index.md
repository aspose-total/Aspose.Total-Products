...
{{% blocks/products/pf/agp/content h2="How to Export CGM to OTT Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for CGM to OTT Conversion" gistPath="" %}}
```cs
