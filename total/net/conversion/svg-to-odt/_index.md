...
description: Convert SVG to ODT without using Microsoft Word
url: /net/conversion/svg-to-odt/
family: total
platformtag: net
feature: conversion
informat: SVG
outformat: ODT
otherformats: PS PCL XAMLFLOW MHTML FLATOPC WORDML DOCM DOT RTF OTT DOTX DOTM
---
...
{{% blocks/products/pf/agp/feature-section-col title="C# API to Convert SVG to ODT" %}}
