---
title: .NET API to Convert WORD to XLAM 
description: C# API to Convert WORD to XLAM without using Microsoft Excel or Adobe Reader
url: /net/conversion/word-to-xlam/
family: total
platformtag: net
feature: conversion
informat: DOC
outformat: XLAM
otherformats: XLSM XLSB XLTX XLSX ODS XLT TSV CSV SXC DIF FODS XLS EXCEL XLTM
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="C# API to Convert WORD to XLAM" h2="Export WORD to XLAM via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert WORD to XLAM" %}}
