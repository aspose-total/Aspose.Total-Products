...
{{% blocks/products/pf/agp/content h2="How to Export TEX to GIF Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for TEX to GIF Conversion" gistPath="" %}}
```cs
