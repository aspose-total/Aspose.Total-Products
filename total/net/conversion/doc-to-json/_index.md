...
url: /net/conversion/doc-to-json/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Convert DOC to JSON Format via C#" h2="Convert DOC to JSON via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOC to Export Range to JSON" %}}
