...
description: C# API to Convert CGM File to ODS without using Microsoft Excel or Adobe Reader
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected CGM to ODS via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert CGM File to ODS with Watermark via C#" %}}
