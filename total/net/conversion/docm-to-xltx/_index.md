---
title: .NET API to Convert DOCM to XLTX 
description: C# API to Convert DOCM to XLTX without using Microsoft Excel or Adobe Reader
...
informat: DOCM
outformat: XLTX
otherformats: XLSX SXC XLS TSV XLSM XLTM XLSB XLT CSV DIF ODS XLAM EXCEL FODS
---
