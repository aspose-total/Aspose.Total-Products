...
{{% blocks/products/pf/agp/content h2="How to Transform EMAIL to PCL Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMAIL to PCL Conversion" gistPath="" %}}
```cs
