...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMAIL to XPS Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect XPS file format" %}}
```cs
// load HTML with an instance of Document
Document document = new Document("HtmlOutput.html");
