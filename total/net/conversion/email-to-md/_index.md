...
{{% blocks/products/pf/agp/content h2="How to Transform EMAIL to MD Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMAIL to MD Conversion" gistPath="" %}}
```cs
