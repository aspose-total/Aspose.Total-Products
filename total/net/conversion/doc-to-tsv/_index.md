---
title: .NET API to Convert DOC to TSV 
description: C# API to Convert DOC to TSV without using Microsoft Excel or Adobe Reader
url: /net/conversion/doc-to-tsv/
family: total
platformtag: net
feature: conversion
informat: DOC
outformat: TSV
otherformats: ODS FODS XLSB XLTX XLSM EXCEL CSV XLSX XLTM SXC XLAM XLT DIF XLS
---
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert DOC to TSV" %}}
