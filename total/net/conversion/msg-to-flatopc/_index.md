...
{{% blocks/products/pf/agp/content h2="How to Transform MSG to FLATOPC Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for MSG to FLATOPC Conversion" gistPath="" %}}
```cs
