---
title: Convert DOC to PPSX via C# .NET 
url: /net/conversion/doc-to-ppsx/ 
description: Use source code to convert Word doc documents to PowerPoint ppsx files with C#. Convert multiple files within ASP.NET or other .NET applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert DOC to PPSX using C#" h2="Build Micrsoft Word DOC to PowerPoint PPSX conversion apps on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/total/272x272/aspose_total-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="PPSX" pfName="Aspose.Total" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="DOC" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert DOC to PPSX Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert DOC to PPSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Total makes it easy for the developers to load & convert DOC files to PPSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This code sample shows how to convert a DOC to PPSX using C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert DOC to PPSX" sectionDescription="Check our live demos for [DOC to PPSX conversion](https://products.aspose.app/words/conversion/word-to-ppsx) with following benefits." >}}
...
Files with .DOC extension represent documents generated by Microsoft Word or other word processing documents in binary file format. The extension was initially used for plain text documentation on several different operating systems. It can contain different types of data such as images, formatted as well as plain text, graphs, charts, embedded objects, links, pages, formatting, print settings and a lot more.
        ...
        {{< blocks/products/pf/agp/about-file-text fileFormat="PPSX" readMoreLink="https://docs.fileformat.com/word-processing/doc/" >}}
Files with .DOC extension represent documents generated by Microsoft Word or other word processing documents in binary file format. The extension was initially used for plain text documentation on several different operating systems. It can contain different types of data such as images, formatted as well as plain text, graphs, charts, embedded objects, links, pages, formatting, print settings and a lot more.
