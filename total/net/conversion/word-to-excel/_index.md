---
title: .NET API to Convert WORD to EXCEL 
description: C# API to Convert WORD to EXCEL without using Microsoft Excel or Adobe Reader
url: /net/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOC
outformat: XLSX
otherformats: XLSB TSV CSV FODS XLTX XLSM XLT DIF XLTM XLS XLSX ODS XLAM SXC
---
