...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSX to WORD via C#" h2="Export Excel® XLSX to WORD on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
