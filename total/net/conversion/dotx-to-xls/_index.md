---
title: .NET API to Convert DOTX to XLS 
description: C# API to Convert DOTX to XLS without using Microsoft Excel or Adobe Reader
...
informat: DOTX
outformat: XLS
otherformats: ODS TSV XLTX XLSX XLSM XLSB CSV XLAM SXC XLTM FODS DIF XLT EXCEL
---
