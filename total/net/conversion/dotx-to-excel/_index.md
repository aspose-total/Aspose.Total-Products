---
title: .NET API to Convert DOTX to EXCEL 
description: C# API to Convert DOTX to EXCEL without using Microsoft Excel or Adobe Reader
url: /net/conversion/dotx-to-excel/
family: total
platformtag: net
feature: conversion
informat: DOTX
outformat: XLSX
otherformats: ODS SXC XLT XLTM XLSM FODS XLTX CSV XLS XLSX XLSB DIF XLAM TSV
---
