...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to POWERPOINT via C#" h2="Export Excel® ODS to POWERPOINT on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
2. Open ODS file using [Aspose.Cells.Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) class
3. Convert ODS to PDF and set Aspose.Cells.SaveFormat to Auto
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for ODS to POWERPOINT Conversion" gistPath="" %}}
```cs
// load the ODS file using Aspose.Cells
