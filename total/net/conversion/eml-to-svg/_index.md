...
{{% blocks/products/pf/agp/content h2="How to Transform EML to SVG Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EML to SVG Conversion" gistPath="" %}}
```cs
