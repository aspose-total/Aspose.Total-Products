...
{{% blocks/products/pf/agp/content h2="How to Export TEX to DOTX Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for TEX to DOTX Conversion" gistPath="" %}}
```cs
