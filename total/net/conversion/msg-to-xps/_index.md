...
{{% blocks/products/pf/agp/content h2="How to Transform MSG to XPS Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for MSG to XPS Conversion" gistPath="" %}}
```cs
