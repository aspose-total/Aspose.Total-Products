...
{{% blocks/products/pf/agp/code-autogen title="C# Code for CGM to DOCM Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly DOCM via .NET " %}}
