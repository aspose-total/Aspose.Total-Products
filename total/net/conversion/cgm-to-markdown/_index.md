...
{{% blocks/products/pf/agp/content h2="How to Export CGM to MARKDOWN Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for CGM to MARKDOWN Conversion" gistPath="" %}}
```cs
