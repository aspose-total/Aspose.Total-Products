...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EML to WORD Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect WORD file format" %}}
```cs
// load HTML with an instance of Document
Document document = new Document("HtmlOutput.html");
