---
title: .NET API to Convert DOCM to XLSB 
description: C# API to Convert DOCM to XLSB without using Microsoft Excel or Adobe Reader
url: /net/conversion/docm-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOCM
outformat: XLSB
otherformats: XLTX ODS XLAM XLSX DIF XLSM XLTM FODS XLT TSV SXC XLS CSV EXCEL
---
