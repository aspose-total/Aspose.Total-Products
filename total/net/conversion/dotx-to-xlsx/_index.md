---
title: .NET API to Convert DOTX to XLSX 
description: C# API to Convert DOTX to XLSX without using Microsoft Excel or Adobe Reader
...
informat: DOTX
outformat: XLSX
otherformats: XLT DIF XLTX XLTM XLSM EXCEL SXC XLSB CSV FODS ODS XLAM TSV XLS
---
