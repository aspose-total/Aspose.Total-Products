...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected CGM to MD via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert CGM File to MD with Watermark via C#" %}}
While converting CGM file to MD, you can also add watermark to your output MD file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as MD with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
