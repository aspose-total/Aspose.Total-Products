---
title: Convert FODS to PPTX with .NET 
description: Convert FODS to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms
url: /net/conversion/fods-to-pptx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to PPTX via C#" h2="Export Excel&reg; FODS to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/feature-section-col title="FODS to PPTX Conversion on .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for FODS to PPTX Conversion" gistPath="" %}}
