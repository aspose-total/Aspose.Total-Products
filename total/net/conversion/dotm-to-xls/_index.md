---
title: .NET API to Convert DOTM to XLS 
description: C# API to Convert DOTM to XLS without using Microsoft Excel or Adobe Reader
...
informat: DOTM
outformat: XLS
otherformats: SXC FODS ODS TSV XLSX EXCEL XLSM XLTX XLSB DIF XLAM XLTM CSV XLT
---
