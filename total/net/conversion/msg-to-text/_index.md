...
{{% blocks/products/pf/agp/content h2="How to Transform MSG to TEXT Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for MSG to TEXT Conversion" gistPath="" %}}
```cs
