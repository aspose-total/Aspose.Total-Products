---
title: .NET API to Convert DOC to XLSB 
description: C# API to Convert DOC to XLSB without using Microsoft Excel or Adobe Reader
...
informat: DOC
outformat: XLSB
otherformats: EXCEL XLT TSV ODS DIF XLAM FODS SXC XLS XLTM CSV XLSM XLSX XLTX
---
