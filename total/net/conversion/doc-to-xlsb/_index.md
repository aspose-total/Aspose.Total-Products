---
title: Convert DOC to XLSB via .NET 
description: Convert DOC to XLSB in C# without using Microsoft Excel or Adobe Reader
url: /net/conversion/doc-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Convert DOC to XLSB via C#" h2="Convert DOC to XLSB via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert DOC to XLSB via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOC to XLSB via C#" %}}
