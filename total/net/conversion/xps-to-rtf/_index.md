...
description: Convert XPS to RTF without using Microsoft Word
url: /net/conversion/xps-to-rtf/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{< blocks/products/pf/feature-page-header h1="Render XPS to RTF via .NET" h2=".NET API to Export XPS to RTF on Windows, macOS, and Linux without using Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API to Convert XPS to RTF" %}}
