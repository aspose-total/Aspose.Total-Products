...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert SXC to PPTX via C#" h2="Export Excel® SXC to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/feature-section-col title="SXC to PPTX Conversion on Net" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for SXC to PPTX Conversion" gistPath="" %}}
```cs
