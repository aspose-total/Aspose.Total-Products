...
description: C# API to Convert MD File to SXC without using Microsoft Excel or Adobe Reader
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected MD to SXC via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert MD File to SXC with Watermark via C#" %}}
While converting MD file to SXC, you can also add watermark to your output SXC file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as SXC with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
