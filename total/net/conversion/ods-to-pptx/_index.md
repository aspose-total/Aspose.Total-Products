---
title: Convert ODS to PPTX with .NET 
description: Convert ODS to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert ODS to PPTX via C#" h2="Export Excel&reg; ODS to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for ODS to PPTX Conversion" gistPath="" %}}
```cs
