---
title: .NET API to Convert WORD to XLS 
description: C# API to Convert WORD to XLS without using Microsoft Excel or Adobe Reader
...
informat: DOC
outformat: XLS
otherformats: XLSB SXC ODS EXCEL XLTX TSV XLSX XLTM XLT FODS XLSM CSV XLAM DIF
---
