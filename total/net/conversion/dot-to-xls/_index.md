---
title: .NET API to Convert DOT to XLS 
description: C# API to Convert DOT to XLS without using Microsoft Excel or Adobe Reader
...
informat: DOT
outformat: XLS
otherformats: DIF TSV XLAM XLSM XLT CSV XLTM EXCEL XLSX XLSB SXC XLTX FODS ODS
---
