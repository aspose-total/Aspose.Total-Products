...
{{% blocks/products/pf/agp/code-autogen title="C# Code for PS to XAMLFLOW Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly XAMLFLOW via .NET " %}}
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect XAMLFLOW file format" %}}
```cs
// load Doc with an instance of Document
