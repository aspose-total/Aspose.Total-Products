...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLS to WORD via C#" h2="Export Excel&reg; XLS to WORD on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLS to WORD Conversion on .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for XLS to WORD Conversion" gistPath="" %}}
```cs
