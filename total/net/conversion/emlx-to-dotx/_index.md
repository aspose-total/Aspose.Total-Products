...
{{% blocks/products/pf/agp/content h2="How to Transform EMLX to DOTX Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMLX to DOTX Conversion" gistPath="" %}}
```cs
