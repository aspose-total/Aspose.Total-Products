---
title: Export XSLFO to POWERPOINT via C# API
description: .NET API to Convert XSLFO to POWERPOINT without using Microsoft Word
url: /net/conversion/xslfo-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XSLFO
outformat: PPT
otherformats: ODP OTP POT POTX PPSM PPSX POTM PPTM PPS XAML PPT SWF
---
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert XSLFO to POWERPOINT" %}}
