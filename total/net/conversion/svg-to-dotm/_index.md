---
title: C# API to Export SVG to DOTM
description: Convert SVG to DOTM without using Microsoft Word
url: /net/conversion/svg-to-dotm/
family: total
platformtag: net
feature: conversion
informat: SVG
outformat: DOTM
otherformats: RTF DOTX XAMLFLOW WORDML MHTML ODT MARKDOWN DOT DOCM FLATOPC PS PCL
---
...
{{% blocks/products/pf/agp/feature-section-col title="C# API to Convert SVG to DOTM" %}}
