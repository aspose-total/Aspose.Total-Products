---
title: Convert POTM to JSON format via .NET 
description: Convert POTM to JSON in C# without using Microsoft Excel or Powerpoint
url: /net/conversion/potm-to-json/
family: total
platformtag: net
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Convert POTM to JSON Format via C#" h2="Export POTM to JSON via C# without using Microsoft<sup>&reg;</sup> Word or PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert POTM to JSON Format via C#" %}}
1. Open POTM file using [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation) class
2. Convert POTM to HTML by using [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) method
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected POTM to JSON Format via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert POTM to JSON in Range via C#" %}}
