...
{{% blocks/products/pf/agp/code-autogen title="C# Code for SVG to DOTX Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly DOTX via .NET " %}}
