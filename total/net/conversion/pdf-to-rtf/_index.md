...
{{% blocks/products/pf/agp/code-autogen title="C# Code for PDF to RTF Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly RTF via .NET " %}}
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect RTF file format" %}}
```cs
// load Doc with an instance of Document
