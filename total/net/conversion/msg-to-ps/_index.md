...
{{% blocks/products/pf/agp/content h2="How to Transform MSG to PS Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for MSG to PS Conversion" gistPath="" %}}
```cs
