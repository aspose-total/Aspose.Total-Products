---
title: Convert FODS to DOCX with Net 
description: Convert FODS to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert FODS to DOCX via C#" h2="Export Excel® FODS to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for FODS to DOCX Conversion" gistPath="" %}}
```cs
