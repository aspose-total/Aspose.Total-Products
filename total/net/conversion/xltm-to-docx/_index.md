---
title: Convert XLTM to DOCX with .NET 
description: Convert XLTM to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTM to DOCX via C#" h2="Export Excel&reg; XLTM to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for XLTM to DOCX Conversion" gistPath="" %}}
```cs
