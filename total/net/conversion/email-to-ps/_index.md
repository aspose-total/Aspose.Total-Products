...
{{% blocks/products/pf/agp/content h2="How to Transform EMAIL to PS Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMAIL to PS Conversion" gistPath="" %}}
```cs
