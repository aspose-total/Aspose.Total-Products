...
informat: SVG
outformat: OTP
otherformats: PPSM POTX ODP POTM PPTM SWF PPSX POT PPT PPS XAML POWERPOINT
---
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert SVG to OTP" %}}
