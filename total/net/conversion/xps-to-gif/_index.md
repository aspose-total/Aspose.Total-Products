...
{{% blocks/products/pf/agp/code-autogen title="C# Code for XPS to GIF Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-section  h2="Create ReadOnly GIF via .NET " %}}
