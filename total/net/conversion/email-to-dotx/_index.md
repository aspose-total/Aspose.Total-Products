...
{{% blocks/products/pf/agp/content h2="How to Transform EMAIL to DOTX Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for EMAIL to DOTX Conversion" gistPath="" %}}
```cs
