---
title: .NET API to Convert DOCM to XLSM 
description: C# API to Convert DOCM to XLSM without using Microsoft Excel or Adobe Reader
...
informat: DOCM
outformat: XLSM
otherformats: EXCEL XLS XLTM XLSB TSV ODS XLT CSV XLSX FODS XLTX SXC DIF XLAM
---
