...
{{% blocks/products/pf/agp/content h2="How to Export TEX to XAMLFLOW Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for TEX to XAMLFLOW Conversion" gistPath="" %}}
```cs
