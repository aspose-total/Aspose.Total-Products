...
{{% blocks/products/pf/agp/code-autogen title="C# Code for MSG to DOTX Conversion" gistPath="" %}}
```cs
...
{{% blocks/products/pf/feature-page-code h3="C# code to protect DOTX file format" %}}
```cs
// load HTML with an instance of Document
Document document = new Document("HtmlOutput.html");
