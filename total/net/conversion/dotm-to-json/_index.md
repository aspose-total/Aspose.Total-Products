...
url: /net/conversion/dotm-to-json/
family: total
platformtag: net
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Convert DOTM to JSON Format via C#" h2="Convert DOTM to JSON via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOTM to Export Range to JSON" %}}
