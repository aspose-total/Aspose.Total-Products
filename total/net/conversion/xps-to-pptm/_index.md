---
title: Export XPS to PPTM via C# API
description: .NET API to Convert XPS to PPTM without using Microsoft Word
url: /net/conversion/xps-to-pptm/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert XPS to PPTM" %}}
