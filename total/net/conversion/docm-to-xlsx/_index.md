---
title: .NET API to Convert DOCM to XLSX 
description: C# API to Convert DOCM to XLSX without using Microsoft Excel or Adobe Reader
...
informat: DOCM
outformat: XLSX
otherformats: TSV XLSM XLS XLT XLAM CSV SXC XLSB XLTX EXCEL ODS DIF FODS XLTM
---
