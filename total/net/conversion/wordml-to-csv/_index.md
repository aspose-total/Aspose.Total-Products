...
{{< blocks/products/pf/feature-page-header h1="C# API to Convert WORDML to CSV" h2="Export WORDML to CSV via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert WORDML to CSV" %}}
