...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLT to DOCX via C#" h2="Export Excel® XLT to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
2. Open XLT file using [Aspose.Cells.Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) class
3. Convert XLT to PDF and set Aspose.Cells.SaveFormat to Auto
...
```cs
// load the XLT file using Aspose.Cells
