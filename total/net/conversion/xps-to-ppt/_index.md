---
title: Export XPS to PPT via C# API
description: .NET API to Convert XPS to PPT without using Microsoft Word
url: /net/conversion/xps-to-ppt/
family: total
platformtag: net
feature: conversion
informat: XPS
outformat: PPT
otherformats: POWERPOINT SWF OTP POTM PPTM ODP PPSM PPSX POT POTX XAML PPS
---
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert XPS to PPT" %}}
