---
title: Export PCL to POTM via C# API
description: .NET API to Convert PCL to POTM without using Microsoft Word
url: /net/conversion/pcl-to-potm/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert PCL to POTM" %}}
