...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to DOC via C#" h2="Export Excel&reg; XLSB to DOC on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
{{% blocks/products/pf/agp/feature-section-col title="XLSB to DOC Conversion on .NET" %}}
...
{{% blocks/products/pf/agp/code-autogen title=".NET C# Code for XLSB to DOC Conversion" gistPath="" %}}
```cs
