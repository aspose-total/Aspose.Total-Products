---
title: .NET API to Convert DOCM to XLT 
description: C# API to Convert DOCM to XLT without using Microsoft Excel or Adobe Reader
url: /net/conversion/docm-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOCM
outformat: XLT
otherformats: XLTX XLSX EXCEL FODS CSV SXC XLAM XLTM XLSM ODS DIF TSV XLSB XLS
---
