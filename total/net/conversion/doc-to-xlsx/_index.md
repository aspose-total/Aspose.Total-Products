---
title: .NET API to Convert DOC to XLSX 
description: C# API to Convert DOC to XLSX without using Microsoft Excel or Adobe Reader
...
informat: DOC
outformat: XLSX
otherformats: FODS XLAM EXCEL ODS CSV XLSM XLTM XLS TSV XLTX DIF XLT SXC XLSB
---
