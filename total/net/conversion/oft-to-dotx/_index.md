...
{{% blocks/products/pf/agp/content h2="How to Transform OFT to DOTX Using C#" %}}
...
{{% blocks/products/pf/agp/code-autogen title="C# Code for OFT to DOTX Conversion" gistPath="" %}}
```cs
