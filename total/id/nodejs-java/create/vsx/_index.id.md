---
title: Membuat Diagram Visio VSX di Node.js
description: Hasilkan Diagram Microsoft Visio VSX menggunakan aplikasi Node tanpa menggunakan Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="Buat File VSX menggunakan Node.js" h2="Hasilkan File Microsoft Visio VSX melalui Aplikasi Node Anda tanpa menginstal perangkat lunak lainnya." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Buat File VSX di Node.js" %}}

- Buat contoh kelas Diagram.
- Panggil metode save dengan parameter yang relevan
- VSX Jalur File, dan ekstensi relevan SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Persyaratan Penciptaan" %}}

- Untuk pembuatan dokumen VSX, Node.js harus diinstal pada sistem.
- Diperlukan Oracle JDK (versi 7 atau yang lebih baru).
- Paket node-java harus disiapkan.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - Buat File VSX" offSpacer="" %}}
