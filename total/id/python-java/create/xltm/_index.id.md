---
title: Buat XLTM dengan Python
description: Hasilkan file XLTM menggunakan aplikasi Python tanpa menggunakan Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="Buat XLTM menggunakan Python" h2="Hasilkan XLTM melalui Aplikasi Python Anda tanpa menginstal Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Untuk seorang pengembang, siapa yang mencoba membuat file XLTM melalui aplikasi Python? [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) API dapat membantu mengotomatiskan proses pembuatan. Ini adalah paket lengkap dari berbagai API yang menangani berbagai format termasuk file dan Gambar Microsoft Office. [Aspose.Cells for Python via Java](https://products.aspose.com/cells/python-java/) API yang merupakan bagian dari paket [Aspose.Total for Python via Java](https://products.aspose.com/total/python-java/) memudahkan proses pembuatan ini. Di bawah ini adalah proses pembuatannya. Selain itu, pengembang dapat dengan mudah meningkatkan aplikasi untuk modifikasi file XLTM. Untuk memperbarui file XLTM menggunakan proses Python sama kecuali membutuhkan file yang ada sebagai parameter saat membuat objek Workbook.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Cara Membuat Mengajukan XLTM dengan Python" %}}
...
- Simpan dokumen sebagai file .xltm menggunakan [save()](https://reference.aspose.com/cells/python/asposecells.api/workbook#save(java.lang.String) dengan melewatkan file dengan path sebagai parameter

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Persyaratan Pembuatan" %}}

- Untuk pembuatan XLTM, referensi API dalam proyek langsung dari PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Buat XLTM dengan Python" offSpacer="" %}}
