---
title: Buat XLSB dengan Python
description: Hasilkan file XLSB menggunakan aplikasi Python tanpa menggunakan Microsoft Office. 
...
- Untuk pembuatan XLSB, referensi API dalam proyek langsung dari PyPI ([Aspose.Cells](https://pypi.org/project/aspose-cells/))
...
{{% blocks/products/pf/agp/code-block title="Buat XLSB dengan Python" offSpacer="" %}}
