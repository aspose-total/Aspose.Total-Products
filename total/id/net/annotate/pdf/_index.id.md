---
title: Hapus Anotasi PDF Online atau Kelola Anotasi melalui .NET
description: hapus komentar dari file PDF melalui aplikasi online gratis.Kode C# .NET API untuk mengelola komentar file PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Hapus Komentar dari Dokumen PDF Online atau Kelola melalui .NET" h2="Kembangkan aplikasi utilitas anotasi dokumen PDF berbasis .NET yang kuat.Kode terdaftar untuk mengelola komentar file PDF melalui .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Tambahkan Anotasi melalui .NET" %}}

1. Tambahkan referensi perpustakaan ke proyek .NET
1. Buat objek kelas Dokumen
1. Tambahkan halaman dan paragraf baru menggunakan Pages.Add dan Paragraphs.Add
1. Gunakan kelas TextAnnotation dan tentukan anotasinya
1. Gunakan Pages[1].Annotations.Add untuk menambahkan anotasi
1. Panggil metode Simpan untuk menyimpan file dengan anotasi
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Tambahkan Komentar di File PDF" offSpacer="" %}}
...
<h2>Mengembangkan Aplikasi Anotasi Dokumen PDF melalui .NET</h2>

Perlu mengembangkan aplikasi atau utilitas anotasi PDF untuk memberikan umpan balik, memberikan saran, atau berkolaborasi dengan orang lain pada dokumen?Dengan [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas dalam aplikasi anotasi dokumennya.Pustaka .NET yang kuat memungkinkan pemrograman solusi anotasi dokumen apa pun.Selain itu dapat mendukung banyak format populer termasuk format PDF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan .NET untuk Menganotasi File PDF" %}}
