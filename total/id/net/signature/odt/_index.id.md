---
title: Menandatangani File ODT Secara Digital Secara Online atau menggunakan .NET
description: Aplikasi online gratis untuk tanda tangan digital dalam file ODT. Mengembangkan aplikasi .NET untuk menandatangani dokumen ODT secara elektronik.
...
{{< blocks/products/pf/feature-page-header-widget h1="Menandatangani File ODT Secara Digital Secara Online melalui Aplikasi Tanda Tangan Elektronik atau menggunakan .NET" h2="Kembangkan aplikasi penandatanganan dokumen ODT berbasis .NET yang kuat. Tambahkan tanda tangan digital secara bebas ke berbagai dokumen termasuk file ODT online melalui aplikasi dengan unduhan instan." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Menandatangani File ODT secara digital melalui .NET" %}}

1. Muat sertifikat pfx menggunakan kelas CertificateHolder
1. Tentukan opsi menggunakan SignOptions
1. Muat file ODT menggunakan FileStream
1. Gunakan kelas DigitalSignatureUtil untuk menandatangani dokumen yang dimuat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode .NET: Tambahkan Tanda Tangan Digital di File ODT" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat dengan mudah mengembangkan solusi profesional untuk menambahkan tanda tangan digital dalam file ODT menggunakan .NET. Gunakan Aspose ODT eSignature API untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
