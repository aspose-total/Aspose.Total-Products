---
title: .NET API untuk Mengonversi WORD ke XLT
description: C# API untuk Mengonversi WORD ke XLT tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/net/conversion/word-to-xlt/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi WORD ke XLT" h2="Ekspor WORD ke XLT melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
