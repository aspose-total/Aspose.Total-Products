---
title: .NET API untuk Mengonversi WORD ke CSV
description: C# API untuk Mengonversi WORD ke CSV tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/net/conversion/word-to-csv/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi WORD ke CSV" h2="Ekspor WORD ke CSV melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
