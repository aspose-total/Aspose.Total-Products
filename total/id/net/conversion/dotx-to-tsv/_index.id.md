---
title: .NET API untuk Mengonversi DOTX ke TSV
description: C# API untuk Mengonversi DOTX ke TSV tanpa menggunakan Microsoft Excel atau Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi DOTX ke TSV" h2="Ekspor DOTX ke TSV melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Buka file DOTX menggunakan kelas [Document](https://apireference.aspose.com/words/net/aspose.words/Document)
2. Konversi DOTX ke HTML dengan menggunakan metode [Simpan](https://apireference.aspose.com/words/net/aspose.words.Document/save/methods/4)
