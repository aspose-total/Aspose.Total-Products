---
title: .NET API untuk Mengonversi WORD ke EXCEL
description: C# API untuk Mengonversi WORD ke EXCEL tanpa menggunakan Microsoft Excel atau Adobe Reader
url: /id/net/conversion/word-to-excel/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi WORD ke EXCEL" h2="Ekspor WORD ke EXCEL melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Buka file WORD menggunakan kelas [Wordument](https://apireference.aspose.com/words/net/aspose.words/wordument)
2. Konversi WORD ke HTML dengan menggunakan metode [Simpan](https://apireference.aspose.com/words/net/aspose.words.wordument/save/methods/4)
...
[Aspose.Words for .NET](https://products.aspose.com/words/net/) juga memungkinkan Anda memuat dokumen WORD melalui aliran. Untuk membuka dokumen dari aliran, cukup teruskan objek aliran yang berisi dokumen ke konstruktor [Dokumen](https://apireference.aspose.com/words/net/aspose.words/wordument). Contoh kode berikut menunjukkan cara membuka dokumen dari aliran:  
{{% blocks/products/pf/feature-page-code %}}
...
Saat mengonversi WORD ke EXCEL, [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) memungkinkan Anda menambahkan properti khusus di dokumen EXCEL Anda. Untuk menambahkan properti kustom, Anda dapat menggunakan metode [Add](https://apireference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection/methods/add/index) untuk [CustomWordumentPropertyCollection](https://apireference.aspose.com/cells/net/aspose.cells.properties/customwordumentpropertycollection) kelas. Metode Add menambahkan properti ke file Excel dan mengembalikan referensi untuk properti dokumen baru sebagai [Aspose.Cells.Properties.WordumentProperty](https://apireference.aspose.com/cells/net/aspose.cells.properties /wordumentproperty) objek. 
{{% blocks/products/pf/feature-page-code %}}
