---
title: .NET API untuk Mengonversi DOTM ke XLAM
description: C# API untuk Mengonversi DOTM ke XLAM tanpa menggunakan Microsoft Excel atau Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API untuk Mengonversi DOTM ke XLAM" h2="Ekspor DOTM ke XLAM melalui C# tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
...
4. Simpan dokumen ke format XLAM menggunakan metode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) dan setel `XLAM` sebagai SaveFormat
