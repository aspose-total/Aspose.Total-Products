---
title: Konversi XLSB ke DOCX dengan .NET 
description: Konversi XLSB ke DOCX di .NET Framework, .NET Core, Mono atau Platform Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konversi XLSB ke DOCX melalui C#" h2="Ekspor Excel&reg; XLSB ke DOCX di .NET Framework, .NET Core, Mono atau Platform Xamarin">}}
