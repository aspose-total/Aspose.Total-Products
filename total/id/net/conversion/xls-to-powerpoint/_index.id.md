---
title: Konversi XLS ke POWERPOINT dengan .NET 
description: Konversi XLS ke POWERPOINT di .NET Framework, .NET Core, Mono atau Platform Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konversi XLS ke POWERPOINT melalui C#" h2="Ekspor Excel&reg; XLS ke POWERPOINT di .NET Framework, .NET Core, Mono atau Platform Xamarin">}}
