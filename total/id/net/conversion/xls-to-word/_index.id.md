---
title: Konversi XLS ke WORD dengan .NET 
description: Konversi XLS ke WORD di .NET Framework, .NET Core, Mono atau Platform Xamarin
url: /id/net/conversion/xls-to-word/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konversi XLS ke WORD melalui C#" h2="Ekspor Excel&reg; XLS ke WORD di .NET Framework, .NET Core, Mono atau Platform Xamarin">}}
