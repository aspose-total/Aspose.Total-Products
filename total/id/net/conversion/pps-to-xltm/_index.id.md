...
description: Konversi PPS ke XLTM dalam C# tanpa menggunakan Microsoft Excel atau Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi PPS ke XLTM melalui C#" h2=".NET API untuk konversi PPS ke XLTM tanpa menggunakan Microsoft<sup>&reg;</sup> Excel atau PowerPoint" >}}
...
4. Simpan dokumen ke XLTM menggunakan metode [Simpan](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
