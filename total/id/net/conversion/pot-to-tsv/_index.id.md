---
title: Konversi POT ke TSV melalui C#
description: Konversi POT ke TSV dalam C# tanpa menggunakan Microsoft Excel atau Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi POT ke TSV melalui C#" h2=".NET API untuk konversi POT ke TSV tanpa menggunakan Microsoft<sup>&reg;</sup> Excel atau PowerPoint" >}}
...
1. Buka file POT menggunakan kelas [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Ekspor POT sebagai HTML dengan menggunakan metode [Simpan](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5)
