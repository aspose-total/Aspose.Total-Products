---
title: Konversi XLS ke PPTX dengan .NET 
description: Konversi XLS ke PPTX di .NET Framework, .NET Core, Mono atau Platform Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konversi XLS ke PPTX melalui C#" h2="Ekspor Excel&reg; XLS ke PPTX di .NET Framework, .NET Core, Mono atau Platform Xamarin">}}
