---
title: Konversi WORDML ke PPTX melalui C# .NET atau dengan Konverter Online gratis
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi WORDML ke PPTX melalui C#" %}}
...
1. Muat file WORDML menggunakan kelas [Aspose.Words.Document](https://apireference.aspose.com/words/net/aspose.words/document)
1. Simpan dokumen WORDML ke dalam HTML
...
{{% blocks/products/pf/agp/code-block title="Contoh kode ini menunjukkan cara mengonversi WORDML ke PPTX menggunakan C#" offSpacer="" %}}
...
<h3>Konverter Online untuk WORDML ke PPTX</h3>
...
{{< blocks/products/pf/agp/i18n/demobox-app sectionTitle="Aplikasi Gratis untuk Mengonversi WORDML ke PPTX" sectionDescription="" >}}
