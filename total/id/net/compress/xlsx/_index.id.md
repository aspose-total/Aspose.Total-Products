---
title: Kompres File XLSX Online atau melalui .NET
description: Aplikasi online gratis untuk mengompres berbagai file XLSX.Kode perpustakaan kompresi .NET untuk dokumen XLSX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kompres File XLSX Online melalui Aplikasi Kompresi atau menggunakan .NET" h2="Kembangkan aplikasi kompresi dokumen XLSX berbasis .NET yang kuat.Kompres berbagai dokumen secara bebas termasuk file XLSX secara online melalui aplikasi dengan unduhan instan." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kompres File XLSX melalui .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Kompres File XLSX" offSpacer="" %}}
...
<h2>Mengembangkan Aplikasi Kompresi File XLSX menggunakan .NET</h2>

Perlu mengembangkan skrip .NET atau aplikasi utilitas untuk mengompresi beberapa file XLSX dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk memprogram aplikasi kompresi di seluruh dokumen.Pustaka .NET yang kuat untuk kompresi dokumen mendukung banyak format populer termasuk format XLSX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan Kompresi .NET untuk File XLSX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat dengan mudah mengembangkan solusi profesional untuk mengompres file XLSX menggunakan .NET.Gunakan API kompresi Aspose XLSX untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
