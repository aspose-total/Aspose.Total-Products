---
title: Kompres File PDF Online atau melalui .NET
description: Aplikasi online gratis untuk mengompres berbagai file PDF.Kode perpustakaan kompresi C# .NET untuk dokumen PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kompres File PDF Online melalui Aplikasi Kompresi atau menggunakan .NET" h2="Kembangkan aplikasi kompresi dokumen PDF berbasis .NET yang kuat.Kompres berbagai dokumen secara bebas termasuk file PDF secara online melalui aplikasi dengan unduhan instan." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kompres File PDF melalui .NET" %}}

1. Muat dokumen melalui objek kelas Dokumen
1. Gunakan objek kelas OptimizationOptions
1. Gunakan objek pengoptimalan untuk CompressImages dan ImageQuality
1. Panggil OptimizeResources menggunakan objek dokumen
1. Panggil metode Simpan dan dapatkan file PDF terkompresi

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode .NET: Kompres File PDF" offSpacer="" %}}
...
<h2>Mengembangkan Aplikasi Kompresi File PDF menggunakan .NET</h2>

Perlu mengembangkan skrip .NET atau aplikasi utilitas untuk mengompresi beberapa file PDF dengan mudah?Dengan API anak [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) dari [Aspose.Total for .NET](https://products.aspose.com/total/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk memprogram aplikasi kompresi di seluruh dokumen.Pustaka .NET yang kuat untuk kompresi dokumen mendukung banyak format populer termasuk format PDF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan Kompresi .NET untuk File PDF" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat dengan mudah mengembangkan solusi profesional untuk mengompres file PDF menggunakan .NET. Gunakan API kompresi Aspose PDF untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
