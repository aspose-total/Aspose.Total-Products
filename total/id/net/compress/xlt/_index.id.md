---
title: Kompres File XLT Online atau melalui .NET
description: Aplikasi online gratis untuk mengompres berbagai file XLT.Kode perpustakaan kompresi .NET untuk dokumen XLT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Kompres File XLT Online melalui Aplikasi Kompresi atau menggunakan .NET" h2="Kembangkan aplikasi kompresi dokumen XLT berbasis .NET yang kuat.Kompres berbagai dokumen secara bebas termasuk file XLT secara online melalui aplikasi dengan unduhan instan." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Kompres dan Optimalkan File XLT Online menggunakan Aplikasi" %}}

1. Unggah file XLT untuk dikompres dan dioptimalkan.
1. Pilih Tingkat Kompresi (Rendah, Sedang atau Tinggi)
1. Klik tombol "Kompres".
1. Unduh file XLT terkompresi.
1. Lihat dan dapatkan hasil kompresi dengan memeriksa ukuran dan kualitas kontennya.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Kompres File XLT melalui .NET" %}}

1. Muat dokumen melalui kelas Buku Kerja
1. Tentukan SaveOptions dan atur CompressionType
1. Ada 9 tingkat kompresi
1. LEVEL_1 hingga LEVEL_9, Gunakan yang relevan
1. Panggil metode penyimpanan dan dapatkan file XLT terkompresi

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode .NET: Kompres File XLT" offSpacer="" %}}
...
<h2>Mengembangkan Aplikasi Kompresi File XLT menggunakan .NET</h2>

Perlu mengembangkan skrip .NET atau aplikasi utilitas untuk mengompresi beberapa file XLT dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk memprogram aplikasi kompresi di seluruh dokumen.Pustaka .NET yang kuat untuk kompresi dokumen mendukung banyak format populer termasuk format XLT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan Kompresi .NET untuk File XLT" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat dengan mudah mengembangkan solusi profesional untuk mengompres file XLT menggunakan .NET.Gunakan API kompresi Aspose XLT untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Apakah aman menggunakan aplikasi online untuk mengompres beberapa dokumen XLT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Anda dapat menggunakan browser web modern apa pun seperti Google Chrome, Firefox, Opera, atau Safari untuk kompresi dokumen XLT online.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Bagaimana cara mengompres banyak file XLT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Mulailah dengan mengunggah satu atau lebih file yang ingin Anda kompres. Anda dapat menarik dan melepaskan file XLT Anda atau cukup mengeklik di dalam area putih.Setelah itu, klik tombol 'Kompres', dan aplikasi kompresi online kami akan memproses file yang diunggah dengan cepat.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Berapa lama waktu yang dibutuhkan untuk mengompres file XLT?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
