---
title: Tandai Air File DOC Online atau menggunakan .NET
description: Aplikasi online gratis untuk memberi tanda air pada berbagai file DOC.Kode C# pustaka tanda air .NET untuk dokumen DOC.
...
{{< blocks/products/pf/feature-page-header-widget h1="File Watermark DOC Online melalui Aplikasi Watermarking dan melalui aplikasi .NET" h2="Kembangkan aplikasi Watermarking dokumen DOC berbasis .NET yang kuat.Beri tanda air secara bebas pada berbagai dokumen termasuk file DOC secara online melalui aplikasi dengan unduhan instan." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Tanda air File DOC melalui .NET" %}}

1. Muat file melalui objek kelas Dokumen
1. Buat objek kelas TextWatermarkOptions
1. Atur opsi seperti font, warna, tata letak
1. Gunakan SetText untuk teks tanda air berbasis teks
1. Panggil metode Simpan dan dapatkan file DOC yang diberi Watermark
1. Dalam hal Tanda Air Gambar, Gunakan metode ImageWatermarkOptions dan SetImage

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kode .NET: Tambahkan File DOC Tanda Air Teks" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kode C# : Tambahkan Tanda Air Gambar ke File DOC" offSpacer="" %}}
...
<h2>Mengembangkan Aplikasi Watermarking File DOC menggunakan .NET</h2>

Perlu mengembangkan aplikasi utilitas .NET untuk memberi tanda air pada beberapa file DOC dengan mudah?Dengan [Aspose.Words for .NET](https://products.aspose.com/words/id/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/id/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk memprogram aplikasi watermarking di seluruh dokumen.Pustaka .NET yang kuat untuk penandaan air dokumen mendukung banyak format populer termasuk format DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan Tanda Air .NET untuk File DOC" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat dengan mudah mengembangkan solusi profesional untuk file Watermark DOC menggunakan .NET.Gunakan API Watermarking Aspose DOC untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Apakah aman menggunakan aplikasi online untuk memberi tanda air pada beberapa dokumen DOC?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Mulailah dengan mengunggah satu atau lebih file yang ingin Anda tandai air. Anda dapat menarik dan melepas file DOC Anda atau cukup mengeklik di dalam area putih.Setelah itu, klik tombol 'Tanda Air', dan aplikasi Tanda Air online kami akan memproses file yang diunggah dengan cepat.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
