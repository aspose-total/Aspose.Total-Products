---
title: Pencari Teks File ODS Online atau Bangun Perangkat Lunak Pencarian ODS melalui C#
description: Aplikasi online gratis untuk mencari dalam file ODS. Kode C# API untuk aplikasi pencarian teks file ODS apa pun.
...
{{< blocks/products/pf/feature-page-header h1="Aplikasi Dokumen yang Dapat Dicari Online dan Kode API Pencarian ODS" h2="Kembangkan perangkat lunak atau aplikasi utilitas mesin pencari dokumen ODS berbasis .NET yang kuat. Uji aplikasi pencari teks dokumen online secara gratis." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODS Online Menggunakan Aplikasi" %}}

1. Unggah file ODS untuk dicari dengan mengklik di dalam area drop atau melalui drag dan drop.
1. Masukkan kriteria pencarian dengan menentukan parameter. 
1. Klik tombol "CARI" untuk mencari ODS.
1. Unduh ODS yang dicari untuk dilihat secara instan.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODS melalui C#" %}}
...
1. Akses sel di lembar yang relevan.
1. Gunakan metode Temukan untuk mencari Angka, Tanggal dan Teks.
...
{{% blocks/products/pf/agp/code-block title="Contoh kode dalam C# untuk Mencari di File ODS" offSpacer="" %}}
...
<h2>Kembangkan Mesin Pencari File ODS melalui .NET</h2>

Perlu mengembangkan perangkat lunak atau utilitas ODS yang dapat dicari? Dengan Aspose.Cells for .NET, API turunan Aspose.Total untuk .NET, pengembang mana pun dapat mengintegrasikan kode API C# di atas untuk memprogram pencarian di seluruh dokumen. Pustaka C# yang kuat memungkinkan solusi perangkat lunak pencarian dokumen pemrograman yang dapat mendukung banyak format populer termasuk format ODS.<br /><br />
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan C# untuk Mencari File ODS" %}}
Ada tiga opsi alternatif untuk menginstal "Aspose.Cells for .NET" atau "Aspose.Total for .NET" ke sistem Anda. Silakan pilih salah satu yang sesuai dengan kebutuhan Anda dan ikuti petunjuk langkah demi langkah:<br /><br />
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Apakah aman menggunakan aplikasi online Pencarian Dokumen ODS?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Anda dapat menggunakan browser web modern apa pun, seperti Google Chrome, Firefox, Opera, atau Safari, untuk pencarian dokumen ODS online. Namun, jika Anda mengembangkan aplikasi desktop, Aspose.Total Document Search API direkomendasikan untuk pemrosesan yang lancar dan efisien.</span>
                      </div>
                  </li>
              </ul>
          </div>
