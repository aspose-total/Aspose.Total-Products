---
title: Pencari Teks File ODP Online atau Bangun Perangkat Lunak Pencarian ODP melalui C#
description: Aplikasi online gratis untuk mencari dalam file ODP. Kode C# API untuk aplikasi pencarian teks file ODP apa pun.
...
{{< blocks/products/pf/feature-page-header h1="Aplikasi Dokumen yang Dapat Dicari Online dan Kode API Pencarian Teks ODP" h2="Kembangkan perangkat lunak atau aplikasi utilitas mesin pencari dokumen ODP berbasis .NET yang kuat. Uji aplikasi pencari teks dokumen online secara gratis." >}}
...
<h3>Aplikasi Pencarian Isi Dokumen ODP Online Gratis</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODP Online Menggunakan Aplikasi" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODP melalui C#" %}}

1. Instal 'Aspose.Slides for .NET'.
...
1. Panggil metode 'Simpan()' untuk menyimpan dokumen dengan memasukkan nama file keluaran.
...
{{% blocks/products/pf/agp/code-block title="Contoh kode dalam C# untuk Mencari Teks di File ODP" offSpacer="" %}}
...
<h2>Kembangkan Mesin Pencari File ODP melalui .NET</h2>

Perlu mengembangkan perangkat lunak atau utilitas ODP yang dapat dicari? Dengan Aspose.Slides for .NET, API turunan dari Aspose.Total for .NET, pengembang mana pun dapat mengintegrasikan kode API C# di atas untuk memprogram pencarian teks di seluruh dokumen. Pustaka C# yang kuat memungkinkan solusi perangkat lunak pencarian dokumen pemrograman yang dapat mendukung banyak format populer termasuk format ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan C# untuk Mencari File ODP" %}}
There are three alternative options to install "Aspose.Slides for .NET" or "Aspose.Total for .NET" onto your system. Silakan pilih salah satu yang sesuai dengan kebutuhan Anda dan ikuti petunjuk langkah demi langkah:<br /><br />
...
<br /><br />
Untuk lebih jelasnya silakan lihat [Product Documentation](https://docs.aspose.com/slides/net/system-requirements/).
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Anda dapat menggunakan browser web modern apa pun, seperti Google Chrome, Firefox, Opera, atau Safari, untuk pencarian dokumen ODP online. Namun, jika Anda mengembangkan aplikasi desktop, Aspose.Total Document Search API direkomendasikan untuk pemrosesan yang lancar dan efisien.</span>
                      </div>
                  </li>
              </ul>
          </div>
