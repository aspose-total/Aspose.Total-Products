---
title: Pencari Teks File ODT Online atau Bangun Perangkat Lunak Pencarian ODT melalui C#
description: Aplikasi online gratis untuk mencari dalam file ODT. Kode C# API untuk aplikasi pencarian teks file ODT apa pun.
...
{{< blocks/products/pf/feature-page-header h1="Aplikasi Dokumen yang Dapat Dicari Online dan Kode API Pencarian Teks ODT" h2="Kembangkan perangkat lunak atau aplikasi utilitas mesin pencari dokumen ODT berbasis .NET yang kuat. Uji aplikasi pencari teks dokumen online secara gratis." >}}
...
<h3>Aplikasi Pencarian Isi Dokumen ODT Online Gratis</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODT Online Menggunakan Aplikasi" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari File ODT melalui C#" %}}

1. Instal 'Aspose.Words untuk .NET'.
1. Tambahkan referensi perpustakaan (impor perpustakaan) ke proyek C# Anda.
1. Buka file ODT sumber menggunakan kelas Dokumen.
...
{{% blocks/products/pf/agp/code-block title="Contoh kode dalam C# untuk Mencari Teks di File ODT" offSpacer="" %}}
...
<h2>Kembangkan Mesin Pencari File ODT melalui .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan C# untuk Mencari File ODT" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Anda dapat menggunakan browser web modern apa pun, seperti Google Chrome, Firefox, Opera, atau Safari, untuk pencarian dokumen ODT online. Namun, jika Anda mengembangkan aplikasi desktop, Aspose.Total Document Search API direkomendasikan untuk pemrosesan yang lancar dan efisien.</span>
                      </div>
                  </li>
              </ul>
          </div>
