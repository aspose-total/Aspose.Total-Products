---
title: Gabungkan File XLTM Online atau menggunakan .NET
description: Aplikasi online gratis untuk menggabungkan berbagai file XLTM.C# .NET menggabungkan kode perpustakaan untuk menggabungkan lembar kerja XLTM ke format lain.
...
{{< blocks/products/pf/feature-page-header-widget h1="Gabungkan Dokumen XLTM Secara Online melalui Aplikasi Penggabungan atau menggunakan .NET" h2="Kembangkan aplikasi penggabungan dokumen XLTM berbasis .NET yang kuat.Gabungkan beberapa dokumen XLTM menjadi satu secara online gratis melalui aplikasi.Simpan file XLTM gabungan sebagai PDF, Gambar, Word, Excel, PowerPoint & banyak format lainnya secara online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gabungkan File XLTM melalui .NET" %}}

1. Muat kedua XLTM menggunakan objek kelas Buku Kerja.
1. Pilih satu Buku Kerja sebagai file dasar.
1. Gunakan metode Gabungkan menggunakan objek dasar dan objek file XLTM kedua sebagai parameter.
1. Panggil metode Simpan dan gabungkan file XLTM menjadi satu.
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Gabungkan File XLTM" offSpacer="" %}}
...
<h2>Kembangkan Penggabungan File XLTM menggunakan .NET</h2>

Perlu mengembangkan aplikasi utilitas .NET untuk menggabungkan beberapa file XLTM dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/id/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/id/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk menggabungkan dokumen dengan mudah.Pustaka .NET yang kuat untuk menggabungkan dokumen mendukung banyak format populer termasuk format XLTM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Penggabungan Perpustakaan untuk File XLTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat mengembangkan solusi profesional untuk menggabungkan XLTM menggunakan .NET.Gunakan API penggabungan XLTM untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
