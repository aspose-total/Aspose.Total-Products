---
title: Gabungkan File XLTX Online atau menggunakan .NET
description: Aplikasi online gratis untuk menggabungkan berbagai file XLTX.C# .NET menggabungkan kode perpustakaan untuk menggabungkan lembar kerja XLTX ke format lain.
...
{{< blocks/products/pf/feature-page-header-widget h1="Gabungkan Dokumen XLTX Secara Online melalui Aplikasi Penggabungan atau menggunakan .NET" h2="Kembangkan aplikasi penggabungan dokumen XLTX berbasis .NET yang kuat.Gabungkan beberapa dokumen XLTX menjadi satu secara online gratis melalui aplikasi.Simpan file XLTX gabungan sebagai PDF, Gambar, Word, Excel, PowerPoint & banyak format lainnya secara online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gabungkan File XLTX melalui .NET" %}}

1. Muat kedua XLTX menggunakan objek kelas Buku Kerja.
1. Pilih satu Buku Kerja sebagai file dasar.
1. Gunakan metode Gabungkan menggunakan objek dasar dan objek file XLTX kedua sebagai parameter.
1. Panggil metode Simpan dan gabungkan file XLTX menjadi satu.
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Gabungkan File XLTX" offSpacer="" %}}
...
<h2>Kembangkan Penggabungan File XLTX menggunakan .NET</h2>

Perlu mengembangkan aplikasi utilitas .NET untuk menggabungkan beberapa file XLTX dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/id/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/id/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk menggabungkan dokumen dengan mudah.Pustaka .NET yang kuat untuk menggabungkan dokumen mendukung banyak format populer termasuk format XLTX.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Penggabungan Perpustakaan untuk File XLTX" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat mengembangkan solusi profesional untuk menggabungkan XLTX menggunakan .NET.Gunakan API penggabungan XLTX untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
