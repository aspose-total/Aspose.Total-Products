---
title: Gabungkan File TSV Online atau menggunakan .NET
description: Aplikasi online gratis untuk menggabungkan berbagai file TSV.C# .NET menggabungkan kode perpustakaan untuk menggabungkan lembar kerja TSV ke format lain.
...
{{% blocks/products/pf/agp/feature-section-col title="Gabungkan File TSV melalui .NET" %}}

1. Muat kedua TSV menggunakan objek kelas Buku Kerja.
1. Pilih satu Buku Kerja sebagai file dasar.
1. Gunakan metode Gabungkan menggunakan objek dasar dan objek file TSV kedua sebagai parameter.
1. Panggil metode Simpan dan gabungkan file TSV menjadi satu.
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Gabungkan File TSV" offSpacer="" %}}
...
<h2>Kembangkan Penggabungan File TSV menggunakan .NET</h2>

Perlu mengembangkan aplikasi utilitas .NET untuk menggabungkan beberapa file TSV dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/id/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/id/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk menggabungkan dokumen dengan mudah.Pustaka .NET yang kuat untuk menggabungkan dokumen mendukung banyak format populer termasuk format TSV.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Penggabungan Perpustakaan untuk File TSV" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat mengembangkan solusi profesional untuk menggabungkan TSV menggunakan .NET.Gunakan API penggabungan TSV untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
