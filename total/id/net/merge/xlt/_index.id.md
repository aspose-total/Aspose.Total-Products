---
title: Gabungkan File XLT Online atau menggunakan .NET
description: Aplikasi online gratis untuk menggabungkan berbagai file XLT.C# .NET menggabungkan kode perpustakaan untuk menggabungkan lembar kerja XLT ke format lain.
...
{{< blocks/products/pf/feature-page-header-widget h1="Gabungkan Dokumen XLT Secara Online melalui Aplikasi Penggabungan atau menggunakan .NET" h2="Kembangkan aplikasi penggabungan dokumen XLT berbasis .NET yang kuat.Gabungkan beberapa dokumen XLT menjadi satu secara online gratis melalui aplikasi.Simpan file XLT gabungan sebagai PDF, Gambar, Word, Excel, PowerPoint & banyak format lainnya secara online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gabungkan File XLT melalui .NET" %}}

1. Muat kedua XLT menggunakan objek kelas Buku Kerja.
...
{{% blocks/products/pf/agp/code-block title="Kode .NET: Gabungkan File XLT" offSpacer="" %}}
...
<h2>Kembangkan Penggabungan File XLT menggunakan .NET</h2>

Perlu mengembangkan aplikasi utilitas .NET untuk menggabungkan beberapa file XLT dengan mudah?Dengan [Aspose.Cells for .NET](https://products.aspose.com/cells/id/net/), API anak [Aspose.Total for .NET](https://products.aspose.com/total/id/net/), pengembang .NET mana pun dapat mengintegrasikan kode API di atas untuk menggabungkan dokumen dengan mudah.Pustaka .NET yang kuat untuk menggabungkan dokumen mendukung banyak format populer termasuk format XLT.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Penggabungan Perpustakaan untuk File XLT" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan untuk mengunduh kode ini. Seseorang dapat mengembangkan solusi profesional untuk menggabungkan XLT menggunakan .NET.Gunakan API penggabungan XLT untuk mengembangkan perangkat lunak independen platform tingkat tinggi di .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
