---
title: Gabungkan File PDF Online atau menggunakan Java
description: Aplikasi online gratis untuk menggabungkan berbagai file PDF.Kode Java untuk menggabungkan dokumen PDF ke format lain.
...
{{< blocks/products/pf/feature-page-header-widget h1="Gabungkan Dokumen PDF Online melalui Aplikasi Penggabungan atau menggunakan Java" h2="Kembangkan aplikasi penggabungan dokumen PDF berbasis Java yang kuat. Gabungkan beberapa dokumen PDF menjadi satu secara online gratis melalui aplikasi.Simpan file PDF sebagai PDF, Gambar, Word, Excel, PowerPoint & banyak format lainnya secara online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Gabungkan File PDF melalui Java" %}}

1. Tambahkan referensi perpustakaan Java ke proyek Anda
1. Muat dokumen PDF pertama menggunakan kelas Dokumen.
1. Muat dokumen PDF kedua menggunakan instance lain dari kelas yang sama.
1. Gunakan instance pertama dan panggil fungsi getPages().add dengan instance kedua sebagai parameter.
1. Panggil metode penyimpanan menggunakan objek pertama dan dapatkan file yang digabungkan.
...
{{% blocks/products/pf/agp/code-block title="Kode Java untuk Menggabungkan File PDF" offSpacer="" %}}
...
<h2>Kembangkan Penggabungan File PDF menggunakan Java</h2>

Perlu mengembangkan skrip Java atau aplikasi utilitas untuk menggabungkan beberapa file PDF dengan mudah?Dengan [Aspose.PDF for Java](https://products.aspose.com/pdf/id/java/), API anak [Aspose.Total for Java](https://products.aspose.com/total/id/java/), pengembang Java mana pun dapat mengintegrasikan kode API di atas untuk memprogram penggabungan aplikasi di seluruh dokumen.Pustaka Java yang kuat memungkinkan solusi penggabungan dokumen pemrograman yang dapat mendukung banyak format populer termasuk format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Perpustakaan Penggabungan Java untuk File PDF" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ya, Anda dipersilakan mengunduh kode ini dan menggunakannya untuk tujuan pengembangan aplikasi berbasis Java yang berfokus pada penggabungan dokumen PDF.Kode ini dapat berfungsi sebagai sumber daya berharga untuk meningkatkan fungsionalitas dan kemampuan proyek Anda dalam domain penggabungan dokumen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
