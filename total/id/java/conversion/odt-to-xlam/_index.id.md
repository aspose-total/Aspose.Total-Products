...
description: Konversi ODT ke XLAM melalui Java tanpa menggunakan Microsoft Word atau Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi ODT ke XLAM melalui Java" h2="On Premise Java API untuk mengonversi ODT ke XLAM tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
...
2. Konversi ODT ke HTML dengan menggunakan [Simpan](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions) ) metode
