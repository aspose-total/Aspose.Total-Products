---
title: Java API untuk Merender PCL ke XLSB
description: Ekspor PCL ke XLSB melalui Java API tanpa menggunakan Microsoft Excel atau Adobe Reader
url_ignore: /id/java/conversion/pcl-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Ekspor PCL ke XLSB melalui Java" h2="Konversikan file PCL ke XLSB dengan menggunakan Java API lokal dalam aplikasi Java J2SE, J2EE, J2ME" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi File PCL ke XLSB melalui Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konversi PCL Terproteksi ke XLSB melalui Java" %}}
Saat mengonversi file PCL ke XLSB, Anda juga dapat menambahkan tanda air ke format file XLSB keluaran Anda. Untuk menambahkan tanda air, buat Buku Kerja baru untuk membuka file XLSX yang dikonversi. Pilih Lembar Kerja melalui indeksnya, buat Bentuk dan gunakan fungsi addTextEffect, atur warna, transparansi, dan lainnya. Setelah itu Anda dapat menyimpan dokumen XLSX Anda sebagai XLSB dengan Watermark. 
{{% blocks/products/pf/feature-page-code %}}
