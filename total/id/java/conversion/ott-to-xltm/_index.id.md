...
description: Konversi OTT ke XLTM melalui Java tanpa menggunakan Microsoft Word atau Microsoft Excel
url: /id/java/conversion/ott-to-xltm/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi OTT ke XLTM melalui Java" h2="On Premise Java API untuk mengonversi OTT ke XLTM tanpa menggunakan Microsoft<sup>&reg;</sup> Word atau Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Buka file OTT menggunakan kelas [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document)
2. Konversi OTT ke HTML dengan menggunakan [Simpan](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions) ) metode
