---
title: Konversi DOCX ke POT melalui Java
description: Java API untuk Mengekspor DOCX ke POT tanpa menggunakan Microsoft Word atau PowerPoint
url: /id/java/conversion/docx-to-pot/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi DOCX ke POT melalui Java" h2="Konversi DOCX ke POT dengan menggunakan API Java lokal dalam aplikasi Java J2SE, J2EE, J2ME tanpa menggunakan Microsoft<sup>&reg;</sup> PowerPoint atau Word" >}}
...
Untuk konversi file DOCX ke POT, Anda dapat dengan mudah menggunakan Aspose.Total untuk Java langsung dari [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) berdasarkan proyek dan sertakan perpustakaan di pom.xml Anda.
