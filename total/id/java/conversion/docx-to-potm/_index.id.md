---
title: Konversi DOCX ke POTM melalui Java
description: Java API untuk Mengekspor DOCX ke POTM tanpa menggunakan Microsoft Word atau PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi DOCX ke POTM melalui Java" h2="Konversi DOCX ke POTM dengan menggunakan API Java lokal dalam aplikasi Java J2SE, J2EE, J2ME tanpa menggunakan Microsoft<sup>&reg;</sup> PowerPoint atau Word" >}}
...
2. Konversi file DOCX ke HTML dengan menggunakan [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions)) metode
...
Untuk konversi file DOCX ke POTM, Anda dapat dengan mudah menggunakan Aspose.Total untuk Java langsung dari [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) berdasarkan proyek dan sertakan perpustakaan di pom.xml Anda.
