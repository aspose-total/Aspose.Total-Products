---
title: Konversi Format JSON ke POTM melalui Java
description: Parsing JSON ke POTM di Java tanpa menggunakan Microsoft PowerPoint
url_ignore: /id/java/conversion/json-to-potm/
family: total
platformtag: net
feature: conversion
informat: JSON
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konversi Format JSON ke POTM melalui Java" h2="Java API untuk mengurai format JSON ke POTM tanpa menggunakan Microsoft<sup>&reg;</sup> PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi Format JSON ke POTM melalui Java" %}}
...
4. Simpan dokumen ke format POTM menggunakan metode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
{{% blocks/products/pf/feature-page-section  h2="Atur Tata Letak dan Konversi Format JSON ke POTM melalui Java" %}}
