---
title: Pemrosesan PDF dan Penambahan OCR melalui API JavaScript
description: JavaScript API untuk memanipulasi dokumen PDF serta menambahkan fitur OCR pada aplikasi web.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="API JavaScript untuk PDF dan OCR" h2="Tambahkan fitur manipulasi OCR dan PDF dalam aplikasi web tanpa ketergantungan perangkat lunak lainnya" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.PDF for JavaScript via C++ adalah toolkit yang ramah pengguna dan aman yang dirancang untuk bekerja dengan PDF langsung di browser web.Perpustakaan ini mendukung 26 bahasa, termasuk skrip Latin, Sirilik, dan karakter Cina.

Ini adalah solusi ringan yang memungkinkan pengembang memproses PDF secara efisien dengan JavaScript.Ini skalabel dan kaya fitur, memungkinkan pengembang membuat produk manipulasi PDF berbasis JavaScript mereka sendiri dan dengan mudah membagikannya ke seluruh web.
...
Aspose.Cells for JavaScript via C++ adalah API berbasis WebAssembly yang andal dan memberikan performa mendekati native untuk membuat, mengedit, mengonversi, dan merender spreadsheet di berbagai format Excel (XLS, XLSX, XLSB, XLSM), ODS, CSV, dan HTML di lingkungan browser maupun Node.js. Dirancang untuk kompatibilitas dan fleksibilitas maksimal, Aspose.Cells memungkinkan pemrosesan spreadsheet yang lancar tanpa server, sehingga ideal untuk aplikasi tanpa server, dasbor, alur data, dan alat pembuat dokumen. Dengan ukurannya yang ringan dan dukungan penuh untuk berbagai format Excel, Aspose.Cells for JavaScript via C++ memastikan manipulasi spreadsheet yang cepat, andal, dan berkinerja tinggi di seluruh platform web, sisi server, dan hybrid.
...
Aspose.OCR for JavaScript via C++ memberdayakan aplikasi Anda dengan pengenalan karakter optik yang efisien hanya dalam 8 baris kode.
...
<h2 class="pr-ft">
 ...
 Ikhtisar JavaScript melalui Perpustakaan C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Tambahkan gambar dalam dokumen PDF
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mendukung gambar apa pun yang bisa Anda peroleh dari pemindai atau kamera
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Membaca skrip Latin dan Sirilik yang Diperluas
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Mendeteksi dan mengenali semua tipografi dan format populer
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Dapatkan hasil pengenalan sebagai JSON
    </p>
   </div>
...
{{< blocks/products/pf/testimonials title="Apa Kata Orang" subTitle="Jangan hanya percaya kata-kata kami begitu saja. Lihat apa yang dikatakan pengguna tentang Aspose.Total API." caseStudiesLink="https://releases.aspose.com/corporate/case-studies/aspose.total/" >}}
{{< blocks/products/pf/testimonials-quote poster="Stefan Pelajar | Nowhow Solutions AG, Swiss" >}}
Manual instruksi yang terdokumentasi dengan baik dan ketahanan komponen Aspose.Total menghasilkan integrasi langsung ke DOCO.Hal ini membantu kami mempersingkat waktu pengembangan lebih dari yang diperkirakan.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Bryan Thornton | Reaksi Bersih LLC, AS" >}}
Kami memiliki pengalaman yang signifikan dengan produk Office Automation dan Soft Artisans Office Writer.Total.NET Aspose lebih kuat, menawarkan fungsionalitas lebih dari apa pun yang pernah kami gunakan sebelumnya.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Tandai Foley | Makanan Nasional Lion Nathan, Australia" >}}
Secara efektif rangkaian Aspose.Total untuk .NET adalah komponen 'pisau tentara Swiss' yang kami gunakan.Berada di samping komponen lapisan presentasi, ia membentuk 'perekat' untuk menarik dan mendorong file data dalam format yang diinginkan.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Yassine Loudad | Qualetech, Perancis" >}}
Implementasinya sangat mudah, kami benar-benar fokus pada arsitektur kami dan Aspose sangat cocok. Arsitektur kami sangat dioptimalkan untuk kinerja dan multi-threading, dan sekali lagi tidak ada masalah untuk menggunakan Aspose.Total.net.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="Referensi API" href="https://reference.aspose.com/" >}} 
{{< blocks/products/pf/slr-element name="Video Tutorial" href="https://www.youtube.com/user/asposevideo" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Dukungan Produk" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Dukungan Gratis" href="https://forum.aspose.com/c/total/7" >}} 
{{< blocks/products/pf/slr-element name="Dukungan Berbayar" href="https://helpdesk.aspose.com/" >}} 
{{< blocks/products/pf/slr-element name="Blog" href="https://blog.aspose.com/" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Mengapa Aspose.Total untuk C++" tabId="success-stories" >}}
