---
title: Pencarian Teks ODT Online atau Bangun Perangkat Lunak Pencarian ODT melalui Python
description: Aplikasi online gratis untuk pencarian konten dalam file ODT. Kode API Python untuk aplikasi pencarian teks file ODT apa pun.
...
{{< blocks/products/pf/feature-page-header h1="Aplikasi Pencarian Teks Online dan Kode API Pencarian Konten ODT" h2="Kembangkan aplikasi utilitas mesin pencari dokumen ODT berbasis Python yang kuat. Uji aplikasi pencarian teks dokumen online secara gratis." >}}
...
<h3>Aplikasi Pencarian Teks Dokumen ODT Online Gratis</h3>
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari Teks di File ODT Online menggunakan App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cara Mencari di File ODT melalui Python" %}}

1. Referensi API dalam proyek langsung dari PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)) 
1. Buat objek kelas Dokumen atau muat file ODT menggunakannya.
...
{{% blocks/products/pf/agp/code-block title="Contoh kode dengan Python untuk Mencari Teks di File ODT" offSpacer="" %}}
          ...
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Anda dapat menggunakan browser web modern apa pun seperti Google Chrome, Firefox, Opera, atau Safari untuk pencarian dokumen ODT online. Namun, jika Anda mengembangkan aplikasi desktop, sebaiknya gunakan Aspose.Total Document Search API untuk pemrosesan yang efisien.</span>
                      </div>
                  </li>
              </ul>
          </div>
