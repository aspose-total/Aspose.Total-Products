---
title: Konversi OST ke GIF dengan Python
description: Simpan OST ke GIF di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-gif/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke GIF, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke GIF dengan Python" offSpacer="" %}}
