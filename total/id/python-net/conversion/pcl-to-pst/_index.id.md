---
title: Konversi PCL ke PST dengan Python
description: Simpan PCL ke PST dalam aplikasi Python tanpa menggunakan Microsoft Word atau Outlook
url: /id/python-net/conversion/pcl-to-pst/
family: total
platformtag: Python
feature: conversion
informat: PCL
...
- Untuk konversi PCL ke PST, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan PCL Ke PST dengan Python" offSpacer="" %}}
