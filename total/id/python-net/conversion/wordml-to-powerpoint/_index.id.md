---
title: Konversi WORDML ke POWERPOINT dengan Python
description: Konversi WORDML ke POWERPOINT dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-powerpoint/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke POWERPOINT dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POWERPOINT sebagai parameter. Jadi file WORDML Anda dikonversi ke POWERPOINT di jalur yang ditentukan.
