---
title: Konversi OST ke DOTX dengan Python
description: Simpan OST ke DOTX di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke DOTX, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke DOTX dengan Python" offSpacer="" %}}
