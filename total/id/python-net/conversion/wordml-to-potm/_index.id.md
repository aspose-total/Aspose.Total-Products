---
title: Konversi WORDML ke POTM dengan Python
description: Konversi WORDML ke POTM dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-potm/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke POTM dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POTM sebagai parameter. Jadi file WORDML Anda dikonversi ke POTM di jalur yang ditentukan.
