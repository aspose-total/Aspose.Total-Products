---
title: Konversi OST ke PNG dengan Python
description: Simpan OST ke PNG di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-png/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke PNG, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke PNG dengan Python" offSpacer="" %}}
