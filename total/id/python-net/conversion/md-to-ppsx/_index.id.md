...
url: /id/python-net/conversion/md-to-ppsx/
family: total
platformtag: Python
feature: conversion
informat: MD
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi MD ke PPSX dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPSX sebagai parameter. Jadi file MD Anda dikonversi ke PPSX di jalur yang ditentukan.
