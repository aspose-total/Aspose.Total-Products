...
{{% blocks/products/pf/agp/feature-section-col title="Konversi ODT ke POWERPOINT dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POWERPOINT sebagai parameter. Jadi file ODT Anda dikonversi ke POWERPOINT di jalur yang ditentukan.
