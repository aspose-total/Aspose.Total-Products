---
title: Konversi WORDML ke PPTX dengan Python
description: Konversi WORDML ke PPTX dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-pptx/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke PPTX dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPTX sebagai parameter. Jadi file WORDML Anda dikonversi ke PPTX di jalur yang ditentukan.
