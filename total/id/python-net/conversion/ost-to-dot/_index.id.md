---
title: Konversi OST ke DOT dengan Python
description: Simpan OST ke DOT di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-dot/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke DOT, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke DOT dengan Python" offSpacer="" %}}
