---
title: Konversi OST ke BMP dengan Python
description: Simpan OST ke BMP di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke BMP, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke BMP dengan Python" offSpacer="" %}}
