---
title: Konversi OST ke PDF dengan Python
description: Simpan OST ke PDF di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-pdf/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke PDF, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke PDF dengan Python" offSpacer="" %}}
