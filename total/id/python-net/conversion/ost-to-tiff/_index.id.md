---
title: Konversi OST ke TIFF dengan Python
description: Simpan OST ke TIFF di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke TIFF, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke TIFF dengan Python" offSpacer="" %}}
