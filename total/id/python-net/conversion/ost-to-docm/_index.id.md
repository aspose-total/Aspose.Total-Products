---
title: Konversi OST ke DOCM dengan Python
description: Simpan OST ke DOCM di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-docm/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke DOCM, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke DOCM dengan Python" offSpacer="" %}}
