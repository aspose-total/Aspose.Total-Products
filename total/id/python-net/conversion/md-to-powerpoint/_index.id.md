---
title: Konversi MD ke POWERPOINT dengan Python
description: Konversi MD ke POWERPOINT dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/md-to-powerpoint/
family: total
platformtag: Python
feature: conversion
informat: MD
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi MD ke POWERPOINT dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POWERPOINT sebagai parameter. Jadi file MD Anda dikonversi ke POWERPOINT di jalur yang ditentukan.
