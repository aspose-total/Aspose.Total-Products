...
url: /id/python-net/conversion/md-to-potm/
family: total
platformtag: Python
feature: conversion
informat: MD
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi MD ke POTM dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POTM sebagai parameter. Jadi file MD Anda dikonversi ke POTM di jalur yang ditentukan.
