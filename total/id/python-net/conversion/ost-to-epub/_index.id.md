---
title: Konversi OST ke EPUB dengan Python
description: Simpan OST ke EPUB di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-epub/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke EPUB, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke EPUB dengan Python" offSpacer="" %}}
