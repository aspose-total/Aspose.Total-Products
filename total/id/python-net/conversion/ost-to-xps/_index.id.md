---
title: Konversi OST ke XPS dengan Python
description: Simpan OST ke XPS di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-xps/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke XPS, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke XPS dengan Python" offSpacer="" %}}
