...
{{% blocks/products/pf/agp/feature-section-col title="Konversi MD ke PPS dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPS sebagai parameter. Jadi file MD Anda dikonversi ke PPS di jalur yang ditentukan.
