---
title: Konversi OST ke IMAGE dengan Python
description: Simpan OST ke IMAGE di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-image/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke IMAGE, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke IMAGE dengan Python" offSpacer="" %}}
