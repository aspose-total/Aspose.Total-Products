---
title: Konversi OST ke RTF dengan Python
description: Simpan OST ke RTF di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke RTF, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke RTF dengan Python" offSpacer="" %}}
