...
{{% blocks/products/pf/agp/feature-section-col title="Konversi RTF ke POTM dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POTM sebagai parameter. Jadi file RTF Anda dikonversi ke POTM di jalur yang ditentukan.
