---
title: Konversi OST ke SVG dengan Python
description: Simpan OST ke SVG di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-svg/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke SVG, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke SVG dengan Python" offSpacer="" %}}
