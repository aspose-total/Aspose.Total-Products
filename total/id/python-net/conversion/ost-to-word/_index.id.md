---
title: Konversi OST ke WORD dengan Python
description: Simpan OST ke WORD di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-word/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke WORD, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke WORD dengan Python" offSpacer="" %}}
