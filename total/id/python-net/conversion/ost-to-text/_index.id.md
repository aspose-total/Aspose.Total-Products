---
title: Konversi OST ke TEXT dengan Python
description: Simpan OST ke TEXT di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-text/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke TEXT, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke TEXT dengan Python" offSpacer="" %}}
