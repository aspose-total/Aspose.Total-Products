---
title: Konversi OST ke ODT dengan Python
description: Simpan OST ke ODT di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-odt/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke ODT, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke ODT dengan Python" offSpacer="" %}}
