...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke PPT dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPT sebagai parameter. Jadi file WORDML Anda dikonversi ke PPT di jalur yang ditentukan.
