---
title: Konversi OST ke PS dengan Python
description: Simpan OST ke PS di aplikasi Python Anda tanpa menggunakan Microsoft Outlook atau Word 
url: /id/python-net/conversion/ost-to-ps/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Untuk konversi OST ke PS, Python 3.5 atau lebih baru diperlukan
...
{{% blocks/products/pf/agp/code-block title="Simpan OST Ke PS dengan Python" offSpacer="" %}}
