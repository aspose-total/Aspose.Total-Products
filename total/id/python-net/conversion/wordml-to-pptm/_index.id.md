---
title: Konversi WORDML ke PPTM dengan Python
description: Konversi WORDML ke PPTM dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-pptm/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke PPTM dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPTM sebagai parameter. Jadi file WORDML Anda dikonversi ke PPTM di jalur yang ditentukan.
