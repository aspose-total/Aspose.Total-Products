---
title: Konversi WORDML ke PPSM dengan Python
description: Konversi WORDML ke PPSM dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-ppsm/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke PPSM dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPSM sebagai parameter. Jadi file WORDML Anda dikonversi ke PPSM di jalur yang ditentukan.
