...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke POT dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POT sebagai parameter. Jadi file WORDML Anda dikonversi ke POT di jalur yang ditentukan.
