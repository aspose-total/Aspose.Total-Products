...
url: /id/python-net/conversion/wordml-to-potx/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke POTX dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.POTX sebagai parameter. Jadi file WORDML Anda dikonversi ke POTX di jalur yang ditentukan.
