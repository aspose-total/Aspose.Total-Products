---
title: Konversi WORDML ke PPSX dengan Python
description: Konversi WORDML ke PPSX dalam aplikasi Python Anda tanpa menggunakan Microsoft Word atau PowerPoint 
url: /id/python-net/conversion/wordml-to-ppsx/
family: total
platformtag: Python
feature: conversion
informat: WORDML
...
{{% blocks/products/pf/agp/feature-section-col title="Konversi WORDML ke PPSX dengan Python" %}}
...
-  Panggil metode `save` saat menentukan jalur file keluaran & SaveFormat.PPSX sebagai parameter. Jadi file WORDML Anda dikonversi ke PPSX di jalur yang ditentukan.
