---
title: C++ API untuk Mengonversi POT ke DOCX
description: Ekspor POT ke DOCX dalam aplikasi C++ Anda
url: /id/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender POT ke DOCX" h2="Ekspor POT ke DOCX dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
...
3. Muat file HTML yang dikonversi dengan menggunakan referensi kelas [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)
4. Simpan dokumen ke format DOCX dengan menggunakan fungsi anggota [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/id/cpp/conversion/pot-to-docxm/" name="POT Ke DOCXM" description="" >}}
