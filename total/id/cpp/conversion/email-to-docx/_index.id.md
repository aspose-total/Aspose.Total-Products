---
title: Ekspor EMAIL ke DOCX melalui C++
description: C++ API untuk Mengonversi EMAIL ke DOCX tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format DOCX menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Docx sebagai SaveFormat
