---
title: C++ API untuk Mengonversi PPTX ke DOCX
description: Ekspor PPTX ke DOCX dalam aplikasi C++ Anda
url: /id/cpp/conversion/pptx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender PPTX ke DOCX" h2="Ekspor PPTX ke DOCX dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
