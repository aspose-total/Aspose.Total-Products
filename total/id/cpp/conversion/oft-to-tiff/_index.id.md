---
title: Ekspor OFT ke TIFF melalui C++
description: C++ API untuk Mengonversi OFT ke TIFF tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke TIFF" h2="Ubah OFT menjadi TIFF dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
