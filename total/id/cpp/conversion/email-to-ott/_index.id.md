---
title: Ekspor EMAIL ke OTT melalui C++
description: C++ API untuk Mengonversi EMAIL ke OTT tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format OTT menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Ott sebagai SaveFormat
