---
title: Ekspor OFT ke XPS melalui C++
description: C++ API untuk Mengonversi OFT ke XPS tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke XPS" h2="Ubah OFT menjadi XPS dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
