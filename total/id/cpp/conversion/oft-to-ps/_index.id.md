---
title: Ekspor OFT ke PS melalui C++
description: C++ API untuk Mengonversi OFT ke PS tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke PS" h2="Ubah OFT menjadi PS dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
