---
title: Ekspor EML ke RTF melalui C++
description: C++ API untuk Mengonversi EML ke RTF tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/eml-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
4. Simpan dokumen ke format RTF menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Rtf sebagai SaveFormat
