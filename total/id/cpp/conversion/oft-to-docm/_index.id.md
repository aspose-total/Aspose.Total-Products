---
title: Ekspor OFT ke DOCM melalui C++
description: C++ API untuk Mengonversi OFT ke DOCM tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke DOCM" h2="Ubah OFT menjadi DOCM dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
