---
title: Ekspor OFT ke ODT melalui C++
description: C++ API untuk Mengonversi OFT ke ODT tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke ODT" h2="Ubah OFT menjadi ODT dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
