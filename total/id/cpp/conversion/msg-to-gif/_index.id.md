---
title: Ekspor MSG ke GIF melalui C++
description: C++ API untuk Mengonversi MSG ke GIF tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/msg-to-gif/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format GIF menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Gif sebagai SaveFormat
