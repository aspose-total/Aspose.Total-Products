---
title: Ekspor OFT ke WORDML melalui C++
description: C++ API untuk Mengonversi OFT ke WORDML tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke WORDML" h2="Ubah OFT menjadi WORDML dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
