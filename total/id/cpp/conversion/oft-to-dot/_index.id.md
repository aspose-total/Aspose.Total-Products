---
title: Ekspor OFT ke DOT melalui C++
description: C++ API untuk Mengonversi OFT ke DOT tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke DOT" h2="Ubah OFT menjadi DOT dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
