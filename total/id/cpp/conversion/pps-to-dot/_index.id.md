---
title: C++ API untuk Mengonversi PPS ke DOT
description: Ekspor PPS ke DOT dalam aplikasi C++ Anda
url: /id/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender PPS ke DOT" h2="Ekspor PPS ke DOT dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
