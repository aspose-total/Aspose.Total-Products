---
title: C++ API untuk Mengonversi PPS ke DOCM
description: Ekspor PPS ke DOCM dalam aplikasi C++ Anda
url: /id/cpp/conversion/pps-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender PPS ke DOCM" h2="Ekspor PPS ke DOCM dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
