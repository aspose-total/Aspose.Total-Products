---
title: Ekspor OFT ke TEXT melalui C++
description: C++ API untuk Mengonversi OFT ke TEXT tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-text/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke TEXT" h2="Ubah OFT menjadi TEXT dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
