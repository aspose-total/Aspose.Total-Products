---
title: Ekspor EMAIL ke PS melalui C++
description: C++ API untuk Mengonversi EMAIL ke PS tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format PS menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Ps sebagai SaveFormat
...
{{% blocks/products/pf/feature-page-section  h2="C++ API untuk Membatasi Pengeditan Format File PS" %}}
