---
title: C++ API untuk Mengonversi PPSX ke ODT
description: Ekspor PPSX ke ODT dalam aplikasi C++ Anda
url: /id/cpp/conversion/ppsx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender PPSX ke ODT" h2="Ekspor PPSX ke ODT dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
