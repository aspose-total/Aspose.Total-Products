---
title: Ekspor OFT ke DOC melalui C++
description: C++ API untuk Mengonversi OFT ke DOC tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke DOC" h2="Ubah OFT menjadi DOC dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
