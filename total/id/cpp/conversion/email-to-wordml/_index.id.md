---
title: Ekspor EMAIL ke WORDML melalui C++
description: C++ API untuk Mengonversi EMAIL ke WORDML tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor EMAIL ke WORDML" h2="Ubah EMAIL menjadi WORDML dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
