---
title: Ekspor OFT ke EPUB melalui C++
description: C++ API untuk Mengonversi OFT ke EPUB tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke EPUB" h2="Ubah OFT menjadi EPUB dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
