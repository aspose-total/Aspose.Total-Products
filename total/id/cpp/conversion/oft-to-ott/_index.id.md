---
title: Ekspor OFT ke OTT melalui C++
description: C++ API untuk Mengonversi OFT ke OTT tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke OTT" h2="Ubah OFT menjadi OTT dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
