---
title: Ekspor OFT ke PDF melalui C++
description: C++ API untuk Mengonversi OFT ke PDF tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke PDF" h2="Ubah OFT menjadi PDF dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
