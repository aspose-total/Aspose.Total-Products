---
title: Ekspor OFT ke DOTM melalui C++
description: C++ API untuk Mengonversi OFT ke DOTM tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke DOTM" h2="Ubah OFT menjadi DOTM dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
