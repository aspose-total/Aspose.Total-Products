---
title: C++ API untuk Mengonversi POTM ke DOCM
description: Ekspor POTM ke DOCM dalam aplikasi C++ Anda
url: /id/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender POTM ke DOCM" h2="Ekspor POTM ke DOCM dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
