---
title: C++ API untuk Mengonversi POTX ke DOTX
description: Ekspor POTX ke DOTX dalam aplikasi C++ Anda
url: /id/cpp/conversion/potx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender POTX ke DOTX" h2="Ekspor POTX ke DOTX dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
