---
title: Ekspor OFT ke DOCX melalui C++
description: C++ API untuk Mengonversi OFT ke DOCX tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke DOCX" h2="Ubah OFT menjadi DOCX dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
