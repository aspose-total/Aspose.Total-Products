---
title: Ekspor OFT ke FLATOPC melalui C++
description: C++ API untuk Mengonversi OFT ke FLATOPC tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke FLATOPC" h2="Ubah OFT menjadi FLATOPC dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
