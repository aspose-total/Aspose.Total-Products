---
title: Ekspor OFT ke PCL melalui C++
description: C++ API untuk Mengonversi OFT ke PCL tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke PCL" h2="Ubah OFT menjadi PCL dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
