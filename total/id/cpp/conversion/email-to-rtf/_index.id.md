---
title: Ekspor EMAIL ke RTF melalui C++
description: C++ API untuk Mengonversi EMAIL ke RTF tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor EMAIL ke RTF" h2="Ubah EMAIL menjadi RTF dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
