---
title: Ekspor OFT ke IMAGE melalui C++
description: C++ API untuk Mengonversi OFT ke IMAGE tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-image/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke IMAGE" h2="Ubah OFT menjadi IMAGE dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API untuk Mengonversi OFT ke IMAGE" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/id/cpp/conversion/oft-to-image/" name="OFT Ke IMAGE" description="" >}}
