---
title: Ekspor MSG ke MD melalui C++
description: C++ API untuk Mengonversi MSG ke MD tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/msg-to-md/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format MD menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Md sebagai SaveFormat
