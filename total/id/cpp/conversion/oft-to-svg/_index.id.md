---
title: Ekspor OFT ke SVG melalui C++
description: C++ API untuk Mengonversi OFT ke SVG tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke SVG" h2="Ubah OFT menjadi SVG dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
