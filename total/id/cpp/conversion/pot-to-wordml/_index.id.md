---
title: C++ API untuk Mengonversi POT ke WORDML
description: Ekspor POT ke WORDML dalam aplikasi C++ Anda
url: /id/cpp/conversion/pot-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Merender POT ke WORDML" h2="Ekspor POT ke WORDML dalam aplikasi C++ tanpa ketergantungan Microsoft PowerPoint atau Word" >}}
