---
title: Ekspor OFT ke MD melalui C++
description: C++ API untuk Mengonversi OFT ke MD tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/oft-to-md/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor OFT ke MD" h2="Ubah OFT menjadi MD dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
