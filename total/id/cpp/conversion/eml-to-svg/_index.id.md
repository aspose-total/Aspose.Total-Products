---
title: Ekspor EML ke SVG melalui C++
description: C++ API untuk Mengonversi EML ke SVG tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/eml-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
4. Simpan dokumen ke format SVG menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Svg sebagai SaveFormat
