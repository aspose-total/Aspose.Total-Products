---
title: Ekspor MSG ke WORDML melalui C++
description: C++ API untuk Mengonversi MSG ke WORDML tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/msg-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Simpan dokumen ke format WORDML menggunakan metode [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) dan atur Wordml sebagai SaveFormat
