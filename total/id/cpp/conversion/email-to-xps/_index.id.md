---
title: Ekspor EMAIL ke XPS melalui C++
description: C++ API untuk Mengonversi EMAIL ke XPS tanpa menggunakan Microsoft Word atau Outlook
url: /id/cpp/conversion/email-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API untuk Mengekspor EMAIL ke XPS" h2="Ubah EMAIL menjadi XPS dalam aplikasi C++ tanpa memerlukan Microsoft Word atau Outlook" >}}
