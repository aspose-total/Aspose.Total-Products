---
title: 在 Python 中將 MSG 轉換為 TEXT
description: 在 Python 應用程序中將 MSG 保存為 TEXT，而無需使用 Microsoft Outlook 或 Word 
url: /zh-hant/python-net/conversion/msg-to-text/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- 對於 MSG 到 TEXT 的轉換，需要 Python 3.5 或更高版本
...
{{% blocks/products/pf/agp/code-block title="在 Python 中將 MSG 保存為 TEXT" offSpacer="" %}}
