---
title: 使用 Python 將 DOTX 轉換為 XLSX 或使用免費的在線轉換器
description: 在不使用 Microsoft Word 或 Excel 的 Python 應用程序中將 DOTX 轉換為 XLSX 或在線。在集成代碼之前快速測試免費的 DOTX 到 XLSX 在線轉換器。 
...
{{< blocks/products/pf/feature-page-header h1="通過 Python 將 DOTX 轉換為 XLSX 或在線應用程序" h2="無需安裝 Microsoft Word<sup>&reg;</sup> 或 Excel，即可在 Python 應用程序中將 DOTX 轉換為 XLSX" >}}

{{% blocks/products/pf/feature-page-summary %}}

對於嘗試在應用程序中添加 DOTX 到 XLSX 轉換功能的 Python 開發人員。 [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API 可以幫助自動化轉換過程。 它是處理不同格式的各種 API 的完整包。
...
{{% blocks/products/pf/agp/feature-section-col title="如何在 Python 中將 DOTX 轉換為 XLSX" %}}
...
-  在指定輸出 XLSX 文件路徑時調用 `save` 方法。 這樣你的DOTX文件就在指定路徑下轉成XLSX了

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="轉換要求" %}}

- 對於 DOTX 到 XLSX 的轉換，需要 Python 3.5 或更高版本
