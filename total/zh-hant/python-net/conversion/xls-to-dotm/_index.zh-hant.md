---
title: 使用 Python 將 XLS 轉換為 DOTM
description: 在不使用 Microsoft Office 的情況下在 Python 應用程序中將 XLS 轉換為 DOTM 
...
{{< blocks/products/pf/feature-page-header h1="通過 Python 將 XLS 轉換為 DOTM" h2="無需安裝 Microsoft Excel<sup>&reg;</sup> 或 Word，即可在 Python 應用程序中將 XLS 轉換為 DOTM" >}}
