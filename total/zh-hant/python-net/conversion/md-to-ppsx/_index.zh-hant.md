---
title: 在 Python 中將 MD 轉換為 PPSX
description: 在 Python 應用程序中將 MD 轉換為 PPSX，而無需使用 Microsoft Word 或 PowerPoint 
url: /zh-hant/python-net/conversion/md-to-ppsx/
family: total
platformtag: Python
feature: conversion
informat: MD
...
{{< blocks/products/pf/feature-page-header h1="使用 Python 將 MD 轉換為 PPSX" h2="無需安裝 Microsoft Word<sup>&reg;</sup> 或 PowerPoint 即可在 Python 應用程序中將 MD 轉換為 PPSX" >}}
