---
title: 在 Python 中將 OST 轉換為 WORDML
description: 在 Python 應用程序中將 OST 保存為 WORDML，而無需使用 Microsoft Outlook 或 Word 
url: /zh-hant/python-net/conversion/ost-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: OST
...
{{% blocks/products/pf/agp/code-block title="在 Python 中將 OST 保存為 WORDML" offSpacer="" %}}
