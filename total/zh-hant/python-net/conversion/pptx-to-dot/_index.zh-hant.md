---
title: 在 Python 中將 PPTX 轉換為 DOT
description: 在 Python 應用程序中將 PPTX 轉換為 DOT，而無需使用 Microsoft Word 或 PowerPoint 
url: /zh-hant/python-net/conversion/pptx-to-dot/
family: total
platformtag: Python
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="使用 Python 將 PPTX 轉換為 DOT" h2="無需安裝 Microsoft Word<sup>&reg;</sup> 或 PowerPoint 即可在 Python 應用程序中將 PPTX 轉換為 DOT" >}}
