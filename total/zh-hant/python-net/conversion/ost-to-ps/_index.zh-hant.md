---
title: 在 Python 中將 OST 轉換為 PS
description: 在 Python 應用程序中將 OST 保存為 PS，而無需使用 Microsoft Outlook 或 Word 
url: /zh-hant/python-net/conversion/ost-to-ps/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- 對於 OST 到 PS 的轉換，需要 Python 3.5 或更高版本
...
{{% blocks/products/pf/agp/code-block title="在 Python 中將 OST 保存為 PS" offSpacer="" %}}
