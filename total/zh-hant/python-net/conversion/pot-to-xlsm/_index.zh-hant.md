---
title: 使用 Python 將 POT 轉換為 XLSM
description: 在不使用 Microsoft Office 的情況下在 Python 應用程序中將 POT 轉換為 XLSM 
...
{{< blocks/products/pf/feature-page-header h1="通過 Python 將 POT 轉換為 XLSM" h2="無需安裝 Microsoft PowerPoint<sup>&reg;</sup> 或 Excel，即可在 Python 應用程序中將 POT 轉換為 XLSM" >}}
