---
title: 在 Python 中將 EMAIL 轉換為 EPUB
description: 在 Python 應用程序中將 EMAIL 保存為 EPUB，而無需使用 Microsoft Outlook 或 Word 
...
- 對於 EMAIL 到 EPUB 的轉換，需要 Python 3.5 或更高版本
...
{{% blocks/products/pf/agp/code-block title="在 Python 中將 EMAIL 保存為 EPUB" offSpacer="" %}}
