---
title: 在 Python 中將 ODP 轉換為 DOCM 或使用免費的在線轉換器
description: 在 Python 應用程序中將 ODP 轉換為 DOCM，而無需使用 Microsoft Word 或 PowerPoint 或在線。在集成代碼之前快速測試免費的 ODP 到 DOCM 在線轉換器。 
...
{{< blocks/products/pf/feature-page-header h1="使用 Python 將 ODP 轉換為 DOCM 或在線應用程序" h2="無需安裝 Microsoft Word<sup>&reg;</sup> 或 PowerPoint 即可在 Python 應用程序中將 ODP 轉換為 DOCM" >}}

{{% blocks/products/pf/feature-page-summary %}}

對於 Python 開發人員，誰正在嘗試在應用程序中添加 ODP 到 DOCM 轉換功能？ [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API 可以幫助自動化轉換過程。它是處理不同格式的各種 API 的完整包。  

主要分兩步。 首先使用 [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/) API 將 ODP 文件轉換為 PDF。 之後，使用 Microsoft Word Python API [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/)，將創建的 PDF 以 DOCM 格式保存到 Microsoft Word 中。 

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="如何在 Python 中將 ODP 轉換為 DOCM？" %}}
...
- 對於 ODP 到 DOCM 的轉換，需要 Python 3.5 或更高版本
