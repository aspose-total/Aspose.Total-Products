---
title: 使用 Python 在線從 WORD 檔案中提取文字和圖像
description: 線上 WORD 檔案解析器應用程式。 用於從 WORD 文件中提取圖像和文字的 Python API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上解析 WORD 檔案以及透過 Python 提取文字或圖像" h2="開發強大的基於 Python 的 WORD 文件解析器實用應用程式。列出了透過 Python 進行 WORD 文件圖像和文字提取的程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 Python 從 WORD 檔案中提取文本" %}}

1. 直接從 PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)) 參考項目內的 API
1. 定義要包含在文字擷取過程中的節點
1. 包含或排除第一個和最後一個節點
1. 提取指定節點中的內容
1. 為提取的文字建立單獨的 WORD 文檔
1. extract_content 函數中列出的程式碼.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Python 中提取 WORD 文件文字的程式碼範例" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過Python從WORD檔案中擷取影像" %}}

1. 直接從 PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)) 參考項目內的 API
1. 儲存在 Document 物件的 Shape 節點中的映像
1. 若要選取所有形狀節點，請使用 Document.get_child_nodes 方法
1. 循環遍歷結果節點集合
1. 如果 Shape.has_image 傳回 true。
1. 使用 Shape.image_data 屬性擷取影像資料。
1. 將影像資料儲存到檔案中
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Python 中提取 WORD 文件圖像的程式碼範例" offSpacer="" %}}
...
<h2>透過 Python 開發 WORD 文件解析器應用程式</h2>

需要開發 WORD 解析器應用程式或實用程式？透過 [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/)（[Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) 的子 API），任何 Python 開發人員都可以將上述 API 程式碼整合到其文件解析器應用程式中。強大的 Python 庫允許對任何文件解析解決方案進行編程以提取圖像和文字。而且它可以支援許多流行的格式，包括WORD格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於為解析器應用程式處理 WORD 檔案的 Python 實用程式" %}}
...
<div class="col-md-12 tl bg-gray-dark howtolist section">
  ...
  <div class="container tl dflex" itemscope="" itemtype="https://schema.org/FAQPage">
      <div class="col-md-4 howtosectiongfx">
          <img class="social-panel-hide-on-mobile" src="https://www.groupWORDs.cloud/templates/brand/images/groupWORDs/conversion/groupWORDs_conversion-brand.png" alt="常見問題解答" width="335" height="283">
      </div>
