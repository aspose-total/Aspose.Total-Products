---
title: 透過 Node.js API 進行 PDF 操作和 OCR 添加
description: Node.js API 用於操作 PDF 檔案以及透過應用程式從圖像中提取文字。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於 PDF 和圖像文字擷取的 Node.js API" h2="從圖像中提取文字以及在 Node.js 應用程式中包含 PDF 操作功能，無需任何其他軟體依賴項" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ 包含以下 Node.js 函式庫：" >}}
...
Aspose.Font for Node.js via C++ 允許開發人員載入、渲染和儲存各種字體格式，包括 TrueType、WOFF、EOT、OpenType、CFF 和 Type1。旨在簡化複雜的字體操作，因此 Node.js 開發人員可以輕鬆專注於製作出色的應用程序，而無需處理複雜的字體。
{{< /blocks/products/pf/total/product-item >}}
...
詳細記錄的說明手冊和 Aspose.Total 組件的穩健性使得可以直接整合到 DOCO 中。這幫助我們比預期縮短了更多的開發時間。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="布萊恩桑頓 |美國淨反應有限責任公司" >}}
我們在辦公室自動化和 Soft Artisans 的 Office Writer 產品方面擁有豐富的經驗。 Aspose 的 Total.NET 更強大，提供的功能比我們過去使用的任何產品都多。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="馬克·弗利 |獅子內森國家食品公司，澳大利亞" >}}
實際上，Aspose.Total for .NET 套件是我們使用的元件的「瑞士軍刀」。它與表示層組件並排，形成了以所需格式拉取和推送資料檔案的「黏合劑」。
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="亞辛·勞達 |法國奎萊泰克" >}}
實作很簡單，我們真正專注於我們的架構，而 Aspose 非常適合。我們的架構針對效能和多執行緒進行了高度最佳化，使用 Aspose.Total.net 也沒有問題。
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-element name="文件" href="https://docs.aspose.com/total/cpp/" >}} 
...
{{< blocks/products/pf/slr-element name="部落格" href="https://blog.aspose.com/" >}} 
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="為什麼選擇 Aspose.Total 用於 C++" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total 為其他平台提供個人化解決方案。" >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/zh-hant/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/zh-hant/nodejs-java/" 
