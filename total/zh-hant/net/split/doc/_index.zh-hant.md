---
title: 在線或透過 .NET 分割 DOC 文件
description: 用於分割不同 DOC 檔案的免費線上應用程式。 DOC 文件的 .NET C# 拆分器庫程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過 Splitter 應用程式或使用 .NET 在線上分割 DOC 文件" h2="開發功能強大的基於 .NET 的 DOC 文件分割器應用程式。 透過應用程式線上自由分割文檔，包括 DOC 文件，並可即時下載。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用App在線分割DOC文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過.NET分割DOC文件" %}}

1. 使用 Document 類別載入 DOC 文件。
1. 使用頁數取得總頁數。
1. 循環遍歷每個頁面並使用 ExtractPages 提取頁面。
1. 將提取的頁面儲存到新的 DOC 檔案中。

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 代碼：按頁拆分 DOC 文件" offSpacer="" %}}
...
<h2>使用 .NET 開發 DOC 檔案分割器應用程式</h2>

需要開發 .NET 腳本或實用程式應用程式來輕鬆分割 DOC 檔案？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Words for .NET](https://products.aspose.com/words/zh-hant/net/)，任何 .NET 開發人員都可以將上述 API 程式碼整合到分割器應用程式中。 強大的.NET 文件分割庫支援多種流行格式，包括 DOC 格式，如 PDF、Word、Excel 和 PowerPoint 文件。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="適用於 .NET 的 DOC 拆分器庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。人們可以輕鬆開發一個專業的解決方案來使用 .NET 分割 DOC 檔案。使用 Aspose DOC splitter API 在 .NET 中開發進階、與平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式分割多個 DOC 文件是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）來進行線上 DOC 文件分割器。</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>分割DOC檔案需要多久時間？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
