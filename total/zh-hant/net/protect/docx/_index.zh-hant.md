---
title: 使用密碼和.NET 在線保護 DOCX 文檔
description: 線上DOCX檔案密碼保護應用程式。對 DOCX 文件套用密碼保護的 C# .NET API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上 DOCX 文件保護或透過 .NET 設定密碼" h2="開發強大的基於 .NET 的 DOCX 文件保護實用程式。列出用於透過 .NET 將密碼套用到 DOCX 文件的程式碼。" >}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代碼：DOCX 文件密碼保護" offSpacer="" %}}
...
<h2>透過.NET開發DOCX密碼保護應用程式</h2>

需要開發 DOCX 密碼保護應用程式或實用程式？透過 [Aspose.Words for .NET](https://products.aspose.com/words/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件保護應用程式中。強大的 .NET 程式庫允許對任何文件密碼保護解決方案進行程式設計以保護和鎖定檔案。而且它可以支援許多流行的格式，包括DOCX格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 實用程式處理 DOCX 檔案以保護應用程式" %}}
