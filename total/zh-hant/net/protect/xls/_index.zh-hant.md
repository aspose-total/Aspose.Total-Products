---
title: 使用密碼和.NET 在線保護 XLS 文檔
description: 線上XLS檔案密碼保護應用程式。.NET C# API 程式碼，用於在 XLS 電子表格上套用密碼保護。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上 XLS 文件保護或透過 .NET 設定密碼" h2="開發強大的基於 .NET 的 XLS 文件保護實用程式。列出用於透過 .NET 將密碼套用到 XLS 電子表格的程式碼。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="透過應用程式進行線上 XLS 密碼保護" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 的 XLS 密碼保護" %}}

1. 透過Workbook類別物件載入XLS文件
1. 使用 EncryptionType 呼叫 SetEncryptionOptions
1. 使用 Settings.Password 分配密碼
1. 呼叫 Save 方法來儲存工作表。
...
{{% blocks/products/pf/agp/code-block title=".NET 代碼：XLS 文件密碼保護" offSpacer="" %}}
...
<h2>透過.NET開發XLS密碼保護應用程式</h2>

需要開發 XLS 密碼保護應用程式或實用程式？透過 [Aspose.Cells for .NET](https://products.aspose.com/cells/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件保護應用程式中。強大的 .NET 程式庫允許對任何文件密碼保護解決方案進行程式設計以保護和鎖定檔案。而且它可以支援許多流行的格式，包括XLS格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 實用程式處理 XLS 檔案以保護應用程式" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式來保護 XLS 文件安全嗎？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）作為線上 XLS 文件保護器。但是，如果您正在開發桌面應用程序，我們建議使用 Aspose.Total 文件處理 API 進行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
