---
title: 使用 .NET 在線從 Excel 檔案中提取文字和圖像
description: 線上 Excel 檔案解析器應用程式。 .NET API C# 程式碼，用於從 Excel 電子表格中提取行和單元格中的文字。
...
{{< blocks/products/pf/feature-page-header-widget h1="在線以及透過 .NET 解析 Excel 文件" h2="開發強大的基於 .NET 的 Excel 文件解析器實用程式。列出用於 Excel 文件解析的 C# 程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過.NET解析Excel文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C# 代碼：Excel 電子表格影像擷取" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "parse-excel-spreadsheet-for-images-extraction.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 代碼：Excel 電子表格文字擷取" offSpacer="" %}}
...
<h2>透過 .NET 開發 Excel 檔案解析器應用程式</h2>

需要開發 Excel 解析器應用程式或實用程式？透過 [Aspose.Cells for .NET](https://products.aspose.com/cells/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件解析器應用程式中。強大的 .NET 程式庫允許對任何文件解析解決方案進行編程以提取圖像和文字。而且它可以支援許多流行的格式，包括Excel格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 實用程式為解析器應用程式處理 Excel 文件" %}}
