---
title: 使用 .NET 在線從 PPT 檔案中提取文字和圖像
description: 線上 PPT 檔案解析器應用程式。 .NET API C# 程式碼，用於從 PPT 簡報中擷取圖像和文字。
...
{{< blocks/products/pf/feature-page-header-widget h1="在線以及透過 .NET 解析 PPT 文件" h2="開發功能強大的基於 .NET 的 PPT 表示解析器應用程式。列出用於解析 PPT 的 C# 程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 解析 PPT 簡報" %}}
...
{{% blocks/products/pf/agp/code-block title="C# 程式碼：PPT 簡報文字擷取" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 程式碼：PPT 示範影像擷取" offSpacer="" %}}
...
<h2>透過 .NET 開發 PPT 表示解析器應用程式</h2>

需要開發 PPT 解析器應用程式嗎？透過 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件解析器應用程式中。強大的 .NET 程式庫允許對任何文件解析解決方案進行編程以提取圖像和文字。而且它可以支援許多流行的格式，包括PPT格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET 實用程式為解析器應用程式處理 PPT 文件" %}}
