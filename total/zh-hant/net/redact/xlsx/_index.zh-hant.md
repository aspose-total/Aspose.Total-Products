---
title: 線上編輯 XLSX 電子表格或使用 .NET
description: 透過應用程式免費線上開啟和編輯 XLSX 文件。用於搜尋和取代 XLSX 文字的 .NET API C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上或透過 .NET 編輯 XLSX 文檔" h2="開發功能強大的基於 .NET 的 XLSX 文件編輯實用程式。列出用於搜尋和替換 XLSX 檔案中文字的 C# 代碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 編輯 XLSX 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C# 代碼：編輯 XLSX 試算表" offSpacer="" %}}
...
<h2>透過 .NET 開發 XLSX 修訂應用程式</h2>

需要開發 XLSX 修訂應用程式或實用程式？透過 [Aspose.Cells for .NET](https://products.aspose.com/cells/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件編輯應用程式中。強大的 .NET 程式庫允許對任何電子表格編輯解決方案進行程式設計。而且它可以支援許多流行的格式，包括XLSX格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於編輯 XLSX 檔案的 .NET 實用程式" %}}
