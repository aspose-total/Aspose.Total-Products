---
title: 線上或使用 .NET 對 ODP 檔案進行數位簽名
description: 用於 ODP 簡報中數位簽章的免費線上應用程式。開發 .NET 應用程式以電子方式簽署 ODP 簡報。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過電子簽名應用程式或使用 .NET 對 ODP 檔案進行線上數位簽名" h2="開發功能強大的基於 .NET 的 ODP 文件簽章應用程式。透過應用程式在線自由添加數位簽名到各種文檔，包括 ODP 文件，並可即時下載。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用應用程式在線上將數位簽章新增至 ODP 檔案中" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 對 ODP 檔案進行數位簽名" %}}

1. 建立Presentation類別對象
1. 使用 PFX 檔案和密碼作為參數建立 DigitalSignature 對象
1. 評論新的數位簽名
1. 使用 DigitalSignatures.Add 新增數位簽名
1. 保存簽署的 ODP 文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 代碼：在 ODP 檔案中新增數位簽名" offSpacer="" %}}
...
<h2>使用 .NET 開發電子簽名應用程式</h2>

需要開發 .NET 腳本或實用應用程式以輕鬆地以電子方式簽署多個 ODP 檔案嗎？ 借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net/)，任何 .NET 開發人員都可以整合上述 API 程式碼來編寫跨文件簽署的電子簽章應用程式。強大的.NET文件簽章庫，支援許多流行的格式，包括ODP格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="適用於 .NET 的 ODP 電子簽章庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。人們可以輕鬆地開發專業的解決方案，使用.NET 在 ODP 檔案中加入數位簽章。使用 Aspose ODP e-Sign API 在 .NET 中開發進階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式簽署多個 ODP 文件是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）進行線上 ODP 文件壓縮。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>如何對多個 ODP 檔案進行簽署？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">首先上傳您想要簽署的一個或多個檔案。您可以拖放 ODP 檔案或只需在白色區域內點擊。然後，點擊“簽名”按鈕，我們的線上設計應用程式將快速處理上傳的檔案。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>簽署 ODP 文件需要多長時間？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
