---
title: 線上或使用 .NET 合併 PPTX 文件
description: 免費線上應用程式可組合不同的 PPTX 簡報。C# .NET 合併程式庫程式碼可將 PPTX 簡報合併為您選擇的格式。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過合併應用程式或使用 .NET 在線合併 PPTX 文檔" h2="開發功能強大的基於 .NET 的 PPTX 文件合併應用程式。透過應用程式免費線上將多個 PPTX 文件合併為一個文件。將合併的 PPTX 檔案儲存為 PDF、圖像、Word、Excel、PowerPoint 和許多其他線上格式。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過.NET合併PPTX文件" %}}

1. 使用Presentation類別物件載入PPTX
1. 選擇一個簡報作為基礎文件
1. 循環瀏覽其他幻燈片的每張幻燈片
...
{{% blocks/products/pf/agp/code-block title=".NET 代碼：合併 PPTX 文件" offSpacer="" %}}
...
<h2>使用 .NET 開發 PPTX 檔案合併器</h2>

需要開發 .NET 合併實用程式應用程式來輕鬆合併多個 PPTX 檔案嗎？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net/)，任何 .NET 開發人員都可以整合上述 API 程式碼來輕鬆連接文件。用於合併文件的強大 .NET 程式庫支援許多流行格式，包括 PPTX 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="PPTX 檔案的 .NET 合併程式庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。人們可以輕鬆地開發出專業的解決方案來使用 .NET 組合 PPTX。使用 PPTX 合併 API 在 .NET 中開發進階、與平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
