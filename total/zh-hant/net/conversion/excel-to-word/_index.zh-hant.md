---
title: 使用 .NET 將 EXCEL 轉換為 WORD 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 EXCEL 轉換為 WORD
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 EXCEL 轉換為 WORD" h2="導出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 EXCEL 到 WORD">}}
