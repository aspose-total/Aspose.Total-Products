---
title: 使用 .NET 將 XLTX 轉換為 WORD 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 XLTX 轉換為 WORD
url: /zh-hant/net/conversion/xltx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 XLTX 轉換為 WORD" h2="導出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLTX 到 WORD">}}
