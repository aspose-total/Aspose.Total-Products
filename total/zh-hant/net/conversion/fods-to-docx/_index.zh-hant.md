---
title: 使用 .NET 將 FODS 轉換為 DOCX 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 FODS 轉換為 DOCX
url: /zh-hant/net/conversion/fods-to-docx/
family: total
platformtag: net
feature: conversion
informat: FODS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 FODS 轉換為 DOCX" h2="導出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 FODS 到 DOCX">}}
