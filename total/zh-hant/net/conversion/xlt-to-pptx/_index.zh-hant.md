---
title: 使用 .NET 將 XLT 轉換為 PPTX 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 XLT 轉換為 PPTX
url: /zh-hant/net/conversion/xlt-to-pptx/
family: total
platformtag: net
feature: conversion
informat: XLT
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 XLT 轉換為 PPTX" h2="導出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLT 到 PPTX">}}
