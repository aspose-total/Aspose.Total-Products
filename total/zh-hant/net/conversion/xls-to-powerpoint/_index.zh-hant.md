---
title: 使用 .NET 將 XLS 轉換為 POWERPOINT 
description: 在 .NET Framework、.NET Core、Mono 或 Xamarin 平台上將 XLS 轉換為 POWERPOINT
url: /zh-hant/net/conversion/xls-to-powerpoint/
family: total
platformtag: net
feature: conversion
informat: XLS
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="通過 C# 將 XLS 轉換為 POWERPOINT" h2="導出 Excel&reg; .NET Framework、.NET Core、Mono 或 Xamarin 平台上的 XLS 到 POWERPOINT">}}
