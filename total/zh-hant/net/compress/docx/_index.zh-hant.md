---
title: 在線或透過 .NET 壓縮 DOCX 文件
description: 用於壓縮不同 DOCX 檔案的免費線上應用程式。DOCX 文件的 C# .NET 壓縮函式庫程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過壓縮應用程式或使用.NET在線壓縮DOCX文件" h2="開發功能強大的基於 .NET 的 DOCX 文件壓縮應用程式。透過應用程式在線自由壓縮包括 DOCX 文件在內的各種文檔，並可即時下載。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過.NET壓縮DOCX文件" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET 代碼：壓縮 DOCX 文件" offSpacer="" %}}
...
<h2>使用.NET開發DOCX檔案壓縮應用程式</h2>

需要開發 .NET 腳本或實用程式應用程式來輕鬆壓縮多個 DOCX 檔案？借助 [Aspose.Total for .NET](https://products.aspose.com/total/net/) 的 [Aspose.Words for .NET](https://products.aspose.com/words/net/) 子 API，任何 .NET 開發人員都可以將上述 API 程式碼整合到跨文件的壓縮應用程式中。強大的.NET 文件壓縮庫支持許多流行的格式，包括 DOCX 格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX 檔案的 .NET 壓縮函式庫" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用.NET 可以輕鬆開發專業的解決方案來壓縮DOCX 檔案。使用 Aspose DOCX 壓縮 API 在 .NET 中開發進階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
 		  ...
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Start by uploading one or more files you want to compress. 您可以拖放 DOCX 檔案或只需在白色區域內點擊。然後，點擊“壓縮”按鈕，我們的線上壓縮應用程式將快速處理上傳的檔案。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
