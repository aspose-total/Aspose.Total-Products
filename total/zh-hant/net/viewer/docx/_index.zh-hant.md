---
title: 在線查看 DOCX 檔案並使用 .NET
description: 免費線上 DOCX 檔案檢視器應用程式。用於查看檢視器應用程式的 DOCX 檔案的 .NET API C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="在線或透過 .NET 自由查看 DOCX 文件" h2="開發功能強大的基於 .NET 的 DOCX 文件檢視器實用程式。列出用於檢視 DOCX 文件的 C# 程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 查看 DOCX 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C#程式碼：查看DOCX文檔" offSpacer="" %}}
...
<h2>透過.NET 開發 DOCX 文件檢視器應用程式</h2>

需要開發 DOCX 檢視器應用程式或實用程式？透過 [Aspose.Words for .NET](https://products.aspose.com/words/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件檢視器應用程式中。強大的.NET 程式庫允許對任何支援多種流行格式（包括 DOCX 格式）的文件顯示解決方案進行程式設計。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於處理顯示應用程式的 DOCX 檔案的 .NET 實用程式" %}}
