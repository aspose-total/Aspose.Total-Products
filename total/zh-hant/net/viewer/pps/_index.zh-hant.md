---
title: 在線查看 PPS 檔案並使用 .NET
description: 免費線上 PPS 檔案檢視器應用程式。用於檢視檢視器應用程式的 PPS 簡報的 .NET API C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="在線或透過 .NET 自由查看 PPS 文件" h2="開發功能強大的基於 .NET 的 PPS 簡報檢視器實用程式。列出用於查看 PPS 簡報的 C# 程式碼。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="透過線上應用程式查看 PPS 簡報" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 查看 PPS 簡報" %}}

1. 將 .NET 程式庫參考新增到專案中
1. 使用Presentation類別物件載入來源PPS文件
1. 將文件另存為 HTML 文件
...
{{% blocks/products/pf/agp/code-block title="C# 程式碼：查看 PPS 簡報" offSpacer="" %}}
...
<h2>透過.NET 開發 PPS 文件檢視器應用程式</h2>

需要開發 PPS 檢視器應用程式或實用程式？透過 [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件檢視器應用程式中。強大的.NET 程式庫允許對任何支援多種流行格式（包括 PPS 格式）的文件顯示解決方案進行程式設計。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於處理顯示應用程式的 PPS 檔案的 .NET 實用程式" %}}
