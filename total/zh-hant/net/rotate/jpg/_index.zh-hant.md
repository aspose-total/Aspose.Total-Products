---
title: 線上或使用 .NET 旋轉 JPG 文檔
description: 透過線上應用程式免費旋轉 JPG 文件。用於旋轉 JPG 檔案的 .NET API C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上或透過 .NET 旋轉 JPG 文檔" h2="開發強大的基於 .NET 的 JPG 文件旋轉實用程式。列出用於透過 .NET 旋轉 JPG 檔案的程式碼。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="線上旋轉 JPG" %}}

1. 導入JPG檔案透過上傳來解鎖。
1. 透過拖放旋轉應用程式在放置區域內點擊來完成此操作。
1. 根據 JPG 檔案的大小和網路速度，等待幾秒鐘。
1. 輸入包括旋轉角度在內的條件。
1. 按一下「旋轉」按鈕可旋轉文件。
1. 立即下載文件。
...
{{% blocks/products/pf/agp/feature-section-col title="透過.NET旋轉JPG文件" %}}

1. 使用 Image.Load 載入 JPG 文件
...
{{% blocks/products/pf/agp/code-block title=".NET 程式碼：旋轉 JPG 文件" offSpacer="" %}}
...
<h2>透過.NET開發JPG旋轉應用程式</h2>

需要開發 JPG 旋轉應用程式或實用程式？透過 [Aspose.Imaging for .NET](https://products.aspose.com/imaging/zh-hant/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件旋轉應用程式中。強大的.NET 程式庫允許對任何文件輪換解決方案進行程式設計。而且它可以支援許多流行的格式，包括JPG格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於管理 JPG 旋轉的 .NET 實用程式" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式旋轉 JPG 文件是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）進行線上 JPG 文件輪換。但是，如果您正在開發桌面應用程序，我們建議使用 Aspose.Total 文件處理 API 進行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
