---
title: 線上刪除 PPTM 註釋或透過 .NET 管理註釋
description: 透過線上應用程式免費刪除 PPTM 檔案中的註釋。用於管理 PPTM 檔案註解的 .NET API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="從 PPTM 線上示範或透過 .NET 管理清除註釋" h2="開發功能強大的基於 .NET 的 PPTM 演示註解實用程式。列出用於透過 .NET 管理 PPTM 檔案註解的程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 刪除 PPTM 簡報註釋" %}}
...
{{% blocks/products/pf/agp/code-block title="C# 程式碼：從 PPTM 簡報中刪除評論和作者" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 新增 PPTM 簡報註釋" %}}
...
<h2>透過.NET開發PPTM文件註解應用程式</h2>

需要開發 PPTM 註釋應用程式或實用程式來提供回饋、提出建議或與其他人協作處理文件？透過 [Aspose.Slides for .NET](https://products.aspose.com/slides/net/)（[Aspose.Total for .NET](https://products.aspose.com/total/net/) 的子 API），任何 .NET 開發人員都可以將上述 API 程式碼整合到其文件註解應用程式中。強大的.NET 程式庫允許對任何文件註解解決方案進行程式設計。而且它可以支援許多流行的格式，包括PPTM格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於註解 PPTM 檔案的 .NET 函式庫" %}}
