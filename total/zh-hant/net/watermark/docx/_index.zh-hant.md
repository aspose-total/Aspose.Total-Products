---
title: 線上或使用 .NET 浮水印 DOCX 文件
description: 免費線上應用程式可為不同的 DOCX 檔案添加浮水印。DOCX 文件的 .NET 水印庫 C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過 Watermarking App 和 .NET 應用程式線上浮水印 DOCX 文件" h2="開發功能強大的基於 .NET 的 DOCX 文件浮水印應用程式。透過應用程式在線免費為各種文件（包括 DOCX 文件）添加浮水印，並可即時下載。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用應用程式在線浮水印 DOCX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 的浮水印 DOCX 文件" %}}

1. 透過 Document 類別物件載入文件
1. 建立 TextWatermarkOptions 類別對象
1. 設定字體、顏色、版面等選項
1. 對基於文字的水印文字使用 SetText
1. 呼叫Save方法並取得帶有浮水印的DOCX文件
1. 如果是影像浮水印，請使用 ImageWatermarkOptions 和 SetImage 方法

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET程式碼：新增文字浮水印DOCX文件" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 程式碼：在 DOCX 檔案中新增影像浮水印" offSpacer="" %}}
...
<h2>使用 .NET 開發 DOCX 文件浮水印應用程式</h2>

需要開發 .NET 實用應用程式來輕鬆為多個 DOCX 檔案添加浮水印嗎？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Words for .NET](https://products.aspose.com/words/zh-hant/net/)，任何 .NET 開發人員都可以整合上述 API 程式碼來編寫跨文件的浮水印應用程式。用於文件浮水印的強大.NET 庫支援許多流行的格式，包括DOCX 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX 檔案的 .NET 浮水印庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用.NET 可以輕鬆開發專業的浮水印DOCX 檔案解決方案。使用 Aspose DOCX Watermarking API 在 .NET 中開發高階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式為多個 DOCX 文件添加浮水印是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）進行線上 DOCX 文件浮水印。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>如何為多個 DOCX 檔案添加浮水印？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">首先上傳一個或多個您想要新增浮水印的檔案。您可以拖放 DOCX 檔案或只需在白色區域內點擊。然後，點擊「浮水印」按鈕，我們的線上浮水印應用程式將快速處理上傳的檔案。</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>為 DOCX 檔案添加浮水印需要多長時間？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
