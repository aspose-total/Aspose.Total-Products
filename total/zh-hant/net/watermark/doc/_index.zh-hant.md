---
title: 線上或使用 .NET 浮水印 DOC 文件
description: 免費線上應用程式可為不同的 DOC 檔案添加浮水印。DOC 文件的 .NET 水印庫 C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過 Watermarking App 和 .NET 應用程式線上浮水印 DOC 文件" h2="開發功能強大的基於 .NET 的 DOC 文件浮水印應用程式。透過應用程式在線免費為各種文件（包括 DOC 文件）添加浮水印，並可即時下載。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 的浮水印 DOC 文件" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET程式碼：新增文字浮水印DOC文件" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 程式碼：在 DOC 檔案中新增影像浮水印" offSpacer="" %}}
...
<h2>使用 .NET 開發 DOC 文件浮水印應用程式</h2>

需要開發 .NET 實用應用程式來輕鬆為多個 DOC 檔案添加浮水印嗎？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Words for .NET](https://products.aspose.com/words/zh-hant/net/)，任何 .NET 開發人員都可以整合上述 API 程式碼來編寫跨文件的浮水印應用程式。用於文件浮水印的強大.NET 庫支援許多流行的格式，包括DOC 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOC 檔案的 .NET 浮水印庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用.NET 可以輕鬆開發專業的浮水印DOC 檔案解決方案。使用 Aspose DOC Watermarking API 在 .NET 中開發高階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
