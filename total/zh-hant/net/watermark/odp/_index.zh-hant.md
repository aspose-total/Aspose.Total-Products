---
title: 線上或使用 .NET 浮水印 ODP 文件
description: 免費線上應用程式可為不同的 ODP 檔案添加浮水印。用於 ODP 簡報的 .NET 浮水印庫 C# 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過 Watermarking App 和 .NET 應用程式線上浮水印 ODP 文件" h2="開發功能強大的基於 .NET 的 ODP 演示浮水印應用程式。透過應用程式在線上免費為各種文件添加浮水印，包括 ODP 簡報並可即時下載。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 .NET 的浮水印 ODP 文件" %}}
...
1. 呼叫Save方法並取得帶有浮水印的ODP文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET 程式碼：文字浮水印 ODP 文件" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "add-text-watermark-in-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# 程式碼：在 ODP 檔案中新增影像浮水印" offSpacer="" %}}
...
<h2>使用 .NET 開發 ODP 文件浮水印應用程式</h2>

需要開發 .NET 應用程式來輕鬆為多個 ODP 檔案添加浮水印嗎？借助 [Aspose.Total for .NET](https://products.aspose.com/total/zh-hant/net/) 的子 API [Aspose.Slides for .NET](https://products.aspose.com/slides/zh-hant/net/)，任何 .NET 開發人員都可以整合上述 API 程式碼來跨簡報編寫浮水印應用程式。用於簡報浮水印的強大 .NET 程式庫支援許多流行格式，包括 ODP 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODP 檔案的 .NET 浮水印庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用 .NET 可以輕鬆開發專業的 Watermark ODP 檔案解決方案。使用 Aspose ODP Watermarking API 在 .NET 中開發進階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
