...
description: 在不使用 Microsoft Excel 的情況下修改 C# VB.NET 應用程序中的 XLTX 文檔。 
url: /zh-hant/net/update/xltx/
family: total
platformtag: .NET
feature: update
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="通過 .NET 更新 XLTX 文件" h2="通過基於 .NET 的應用程序修改 XLTX 電子表格，無需安裝 Microsoft Office<sup>&reg;</sup>。" >}}

{{% blocks/products/pf/feature-page-summary %}}

對於開發人員，誰正在嘗試通過 .NET 應用程序更新 XLTX 文件？ [Aspose.Total for .NET](https://products.aspose.com/total/net/) API 可以幫助自動化更新過程。 它是處理不同格式（包括 Microsoft Excel 文件）的各種 .NET API 的完整包。 作為 [Aspose.Total for .NET](https://products.aspose.com/total/net/) 包一部分的 ASPOSE.CELL API 使這個修改過程變得容易。 以下是更新 XLTX 文檔的過程。
...
- 創建以源 XLTX 文件為參數的新 [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) 類對象
...
{{% blocks/products/pf/agp/code-block title="代碼 - 在 .NET 中更新 XLTX 文件" offSpacer="" %}}
