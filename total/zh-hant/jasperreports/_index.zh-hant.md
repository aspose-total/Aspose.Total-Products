---
title: JasperReports Exporters Suite - 生成業務文檔格式的報告 
weight: 80

description: JasperReports 導出套件可將報告導出為 Word Excel PDF 和 PowerPoint 格式。將條形碼添加到導出的報告
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="JasperReports 擴展以提供 Office 格式的報告" h2="輕鬆將 JasperReports 導出為 Word、Excel、PDF、PowerPoint 和圖像格式，同時為導出的文檔添加條形碼。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/headers/aspose_total-for-jasperreports.svg" pfName="Aspose.Total" subTitlepfName="for JasperReports" downloadUrl="https://downloads.aspose.com/total/jasperreports" >}}
...
<h2 class="pr-ft">
 ...
 JasperReports 的 Aspose.Total 高級功能
</h2>
<div class="col-lg-4">
 <em class="fa fa-file-word-o ico-blue fa-2x col-lg-2">
 </em>
 <p class="col-lg-10">
  將報告導出為 Microsoft Word 文檔
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  將報告導出為 Microsoft PowerPoint 演示文稿
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-12">
 ...
 <p>
  JasperReports 沒有將報告導出為 Microsoft Office 格式或 PDF 的本機功能，但是，通過使用 Aspose.Total for JasperReports，您將可以訪問以下附加導出格式：
 </p>
 <ul class="unstyled">
  <li>
...
<div class="col-lg-12">
 ...
 <p>
  JasperReports 的 Aspose.Total 以最高精度導出所有報表功能。無論結果格式如何，結果看起來都與內置 JasperReports 導出器導出的原始報告相同。
 </p>
</div>
<div class="col-lg-12">
 <h2 class="h2title">
 ...
 <p>
  JasperReports 的 Aspose.BarCode 支持大量條碼符號。它支持數字、字母數字和二維符號。使用 Aspose.BarCode for JasperReports 提供的自定義標籤，Aspose.BarCode for JasperReports 可以輕鬆集成到現有和新的 JasperReport (jrxml) 報告文件中。
 </p>
</div>
<div class="col-lg-12">
 <h2 class="h2title">
 ...
 <p>
  JasperReports 的 Aspose.Total 完全用 Java 編寫，並以 JAR 文件的形式提供，可以輕鬆部署在運行 JasperReports 或 JasperServer 的機器上。 要為 JasperReports 安裝 Aspose.Total，只需將 JAR 文件複製到正確的文件夾即可。 為了將產品與 JasperServer 集成，唯一的額外步驟是對 JasperServer 配置文件進行一個小的更改，然後您就可以使用 Aspose 導出器了。
 </p>
</div>
...
{{< blocks/products/pf/slr-element name="文檔" href="https://docs.aspose.com/total/jasperreports/" >}} 
