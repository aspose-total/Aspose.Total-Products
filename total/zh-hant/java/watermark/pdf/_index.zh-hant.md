---
title: 線上或使用 Java 水印 PDF 文件
description: 免費線上應用程式可為不同的 PDF 檔案添加浮水印。PDF 文件的 Java 水印庫程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過 Watermarking App 和 Java 應用程式線上浮水印 PDF 文件" h2="開發功能強大的基於 Java 的 PDF 文件浮水印應用程式。透過應用程式在線免費為各種文件（包括 PDF 文件）添加浮水印，並可即時下載。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 Java 的浮水印 PDF 文件" %}}

1. 在專案中新增 Java 庫引用
1. 載入文檔。
1. 使用 FormattedText 設定文字和屬性的格式
1. 使用 WatermarkArtifact 設定文字、對齊方式等。
1. 呼叫 save 方法並取得帶有浮水印的 PDF 檔案。
1. 對於圖像，請使用BackgroundArtifact類

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Java 中為 PDF 檔案添加浮水印的程式碼範例" offSpacer="" %}}

{{< gist "aspose-com-gists" "ef226c1da156645d71cf4c291e9960c8" "add-text-watermark-to-pdf-document.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Java程式碼為PDF檔案添加圖像浮水印" offSpacer="" %}}
...
<h2>使用 Java 開發 PDF 檔案浮水印應用程式</h2>

需要開發 Java 腳本或實用應用程式來輕鬆為多個 PDF 檔案添加浮水印嗎？透過 [Aspose.Total for Java](https://products.aspose.com/total/java/) 的 [Aspose.PDF for Java](https://products.aspose.com/pdf/java/) 子 API，任何 Java 開發人員都可以整合上述 API 程式碼來編寫跨文件的浮水印應用程式。用於文件浮水印的強大 Java 庫支援許多流行格式，包括 PDF 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="PDF 檔案的 Java 水印庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用 Java 可以輕鬆開發專業的 Watermark PDF 檔案解決方案。使用 Aspose PDF Watermarking API 在 Java 中開發進階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
