---
title: 透過 JavaScript API 進行 PDF 處理和 OCR 添加
description: JavaScript API 用於操作 PDF 文件以及在 Web 應用程式中新增 OCR 功能。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="用於 PDF 和 OCR 的 JavaScript API" h2="在 Web 應用程式中新增 OCR 和 PDF 操作功能，無需任何其他軟體依賴" logoImageSrc="/total/images/aspose_total-for-javascript-via-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for JavaScript via C++" downloadUrl="https://releases.aspose.com/total/javascript-cpp" >}}
...
Aspose.Total for JavaScript via C++ 是一套包羅萬象的 JavaScript 函式庫。這些庫提供的功能包括在 Web 瀏覽器中直接處理 PDF 以及透過光學字元辨識功能增強您的應用程式。

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for JavaScript via C++ 包含以下 JavaScript 函式庫：" >}}
...
Aspose.Font for JavaScript via C++ 提供一系列強大的功能來簡化字體管理。它可以直接在瀏覽器中輕鬆轉換字體，支援無縫處理 TTF、EOT、WOFF、CFF 和 Type1 等多種格式，並提供全面存取字體元資料的權限以獲得詳細的見解。
...
實際上，Aspose.Total for .NET 套件是我們使用的元件中的「瑞士軍刀」。它與表示層組件並排，形成“粘合劑”，以所需的格式拉取和推送數據文件。
{{< /blocks/products/pf/testimonials-quote >}}
