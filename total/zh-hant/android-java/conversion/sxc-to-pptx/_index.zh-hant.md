---
title: 在 Android 中將 SXC 導出為 PPTX
description: 無需使用 Microsoft Word 即可將 SXC 轉換為 PPTX 的 Android API
url: /zh-hant/android-java/conversion/sxc-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 SXC 渲染為 PPTX" h2="在您的 Android 應用程序中將 SXC 轉換為 PPTX，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/sxc-to-pptxx/" name="SXC 至 PPTXX" description="" >}}
