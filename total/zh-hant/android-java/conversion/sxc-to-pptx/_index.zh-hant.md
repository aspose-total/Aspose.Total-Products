...
description: 無需使用 Microsoft Word 即可將 SXC 轉換為 PPTX 的 Android API 或在線。在集成代碼之前快速測試免費的 CSV 到 DOC 在線轉換器。
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 SXC 渲染為 PPTX 或在線" h2="在您的 Android 應用程序中將 SXC 轉換為 PPTX，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
