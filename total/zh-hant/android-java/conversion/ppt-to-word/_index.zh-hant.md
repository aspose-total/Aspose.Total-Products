---
title: 通過 Java 將 PPT 導出到 Andorid 上的 WORD
description: 在移動應用程序中將 PPT 轉換為 WORD，無需安裝任何軟件
url: /zh-hant/android-java/conversion/ppt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 PPT 渲染到 WORD" h2="文件格式 API 可在 Android 應用程序中將 PPT 轉換為 WORD，而不依賴於 Microsoft PowerPoint 或 Word" >}}
