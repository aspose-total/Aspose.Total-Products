---
title: Android API 將 RTF 轉換為 XLS
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 RTF 轉換為 XLS
url: /zh-hant/android-java/conversion/rtf-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 RTF 轉換為 XLS" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 RTF 導出為 XLS" >}}
