...
您可以使用 [Aspose.Total for Android Java](https://products.aspose.com/total/android-java/) 包的兩個 API 在您的移動應用程序中集成 TEX 到 OTT 的轉換功能。首先，您需要使用 [Aspose.PDF for Android via Java](https://products.aspose.com/pdf/android-java/) 將 TEX 文件轉換為 DOC。其次，通過使用文字處理 API [Aspose.Words for Android Java](https://products.aspose.com/words/android-java/)，您可以將 DOC 渲染為 OTT。 
{{% /blocks/products/pf/feature-page-summary  %}}
