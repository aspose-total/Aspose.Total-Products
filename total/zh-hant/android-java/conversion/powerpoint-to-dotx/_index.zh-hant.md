---
title: 通過 Java 將 POWERPOINT 導出到 Andorid 上的 DOTX
description: 在移動應用程序中將 POWERPOINT 轉換為 DOTX，無需安裝任何軟件
url: /zh-hant/android-java/conversion/powerpoint-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 POWERPOINT 渲染到 DOTX" h2="文件格式 API 可在 Android 應用程序中將 POWERPOINT 轉換為 DOTX，而不依賴於 Microsoft PowerPoint 或 Word" >}}
