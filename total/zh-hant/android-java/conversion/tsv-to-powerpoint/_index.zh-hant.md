---
title: 在 Android 中將 TSV 導出為 POWERPOINT
description: 無需使用 Microsoft Word 即可將 TSV 轉換為 POWERPOINT 的 Android API
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 TSV 渲染為 POWERPOINT" h2="在您的 Android 應用程序中將 TSV 轉換為 POWERPOINT，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/tsv-to-powerpointx/" name="TSV 至 POWERPOINTX" description="" >}}
