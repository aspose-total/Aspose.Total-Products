---
title: 在 Android 中將 XLT 導出為 PPTX
description: 無需使用 Microsoft Word 即可將 XLT 轉換為 PPTX 的 Android API
url: /zh-hant/android-java/conversion/xlt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 XLT 渲染為 PPTX" h2="在您的 Android 應用程序中將 XLT 轉換為 PPTX，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
