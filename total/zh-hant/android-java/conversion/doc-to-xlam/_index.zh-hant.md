---
title: Android API 將 DOC 轉換為 XLAM
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 DOC 轉換為 XLAM
url: /zh-hant/android-java/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 DOC 轉換為 XLAM" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 DOC 導出為 XLAM" >}}
