---
title: 通過 Java 在 Android 中將 POTX 轉換為 TSV 或在線 或使用免費的在線轉換器
description: 在不使用 Microsoft Excel 或 PowerPoint 的情況下，通過 Java 在 Android 中將 POTX 轉換為 TSV 或在線 或在線。在集成代碼之前快速測試免費的 CSV 到 DOC 在線轉換器。
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 中將 POTX 轉換為 TSV 或在線" h2="無需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint 在 Android 應用程序中將 POTX 文件導出為 TSV" >}}
