---
title: 在 Android 中將 XLT 導出為 POWERPOINT
description: 無需使用 Microsoft Word 即可將 XLT 轉換為 POWERPOINT 的 Android API
url: /zh-hant/android-java/conversion/xlt-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 XLT 渲染為 POWERPOINT" h2="在您的 Android 應用程序中將 XLT 轉換為 POWERPOINT，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
