---
title: 通過 Java 將 PPSX 導出到 Andorid 上的 FLATOPC
description: 在移動應用程序中將 PPSX 轉換為 FLATOPC，無需安裝任何軟件
url: /zh-hant/android-java/conversion/ppsx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 PPSX 渲染到 FLATOPC" h2="文件格式 API 可在 Android 應用程序中將 PPSX 轉換為 FLATOPC，而不依賴於 Microsoft PowerPoint 或 Word" >}}
