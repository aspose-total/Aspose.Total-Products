---
title: 通過 Java 將 PPS 導出到 Andorid 上的 DOTM
description: 在移動應用程序中將 PPS 轉換為 DOTM，無需安裝任何軟件
url: /zh-hant/android-java/conversion/pps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 PPS 渲染到 DOTM" h2="文件格式 API 可在 Android 應用程序中將 PPS 轉換為 DOTM，而不依賴於 Microsoft PowerPoint 或 Word" >}}
