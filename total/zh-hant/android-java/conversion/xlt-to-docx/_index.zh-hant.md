---
title: 在 Android 中將 XLT 導出為 DOCX
description: 無需使用 Microsoft Word 即可將 XLT 轉換為 DOCX 的 Android API
url: /zh-hant/android-java/conversion/xlt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 XLT 渲染為 DOCX" h2="在您的 Android 應用程序中將 XLT 轉換為 DOCX，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
