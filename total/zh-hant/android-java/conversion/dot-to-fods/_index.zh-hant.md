---
title: Android API 將 DOT 轉換為 FODS
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 DOT 轉換為 FODS
url: /zh-hant/android-java/conversion/dot-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 DOT 轉換為 FODS" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 DOT 導出為 FODS" >}}
