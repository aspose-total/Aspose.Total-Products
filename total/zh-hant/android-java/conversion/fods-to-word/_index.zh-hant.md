---
title: 在 Android 中將 FODS 導出為 WORD
description: 無需使用 Microsoft Word 即可將 FODS 轉換為 WORD 的 Android API
url: /zh-hant/android-java/conversion/fods-to-word/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 FODS 渲染為 WORD" h2="在您的 Android 應用程序中將 FODS 轉換為 WORD，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
