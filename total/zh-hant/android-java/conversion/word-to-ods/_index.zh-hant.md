---
title: Android API 將 WORD 轉換為 ODS
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 WORD 轉換為 ODS
url: /zh-hant/android-java/conversion/word-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 WORD 轉換為 ODS" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 WORD 導出為 ODS" >}}
