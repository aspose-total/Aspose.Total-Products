---
title: 通過 Java 將 POT 導出到 Andorid 上的 ODT
description: 在移動應用程序中將 POT 轉換為 ODT，無需安裝任何軟件
url: /zh-hant/android-java/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 POT 渲染到 ODT" h2="文件格式 API 可在 Android 應用程序中將 POT 轉換為 ODT，而不依賴於 Microsoft PowerPoint 或 Word" >}}
