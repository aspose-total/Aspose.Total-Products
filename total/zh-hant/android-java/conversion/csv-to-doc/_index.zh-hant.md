---
title: 在 Android 中將 CSV 導出為 DOC
description: 無需使用 Microsoft Word 即可將 CSV 轉換為 DOC 的 Android API
url: /zh-hant/android-java/conversion/csv-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 CSV 渲染為 DOC" h2="在您的 Android 應用程序中將 CSV 轉換為 DOC，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="用於將 CSV 導出為 DOC 的 Android API" %}}
...
除了文檔轉換，[Aspose.Cells for Android via Java](https://products.aspose.com/cells/android-java/) 還提供了大量其他功能。在轉換過程之前，您可以刪除 CSV 文檔的自定義屬性。要刪除自定義屬性，請調用 [DocumentPropertyCollection.remove](https://reference.aspose.com/cells/java/com.aspose.cells/documentpropertycollection#remove(java.lang.String)) 方法並傳遞名稱要刪除的文檔屬性。
{{% blocks/products/pf/feature-page-code %}}
