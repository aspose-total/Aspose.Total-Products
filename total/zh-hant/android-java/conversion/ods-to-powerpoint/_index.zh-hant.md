---
title: 在 Android 中將 ODS 導出為 POWERPOINT
description: 無需使用 Microsoft Word 即可將 ODS 轉換為 POWERPOINT 的 Android API
url: /zh-hant/android-java/conversion/ods-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Android 上將 ODS 渲染為 POWERPOINT" h2="在您的 Android 應用程序中將 ODS 轉換為 POWERPOINT，而無需使用 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/ods-to-powerpointx/" name="ODS 至 POWERPOINTX" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/ods-to-powerpoint/" name="ODS 至 POWERPOINT" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/ods-to-word/" name="ODS 至 WORD" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/android-java/conversion/ods-to-pptx/" name="ODS 至 PPTX" description="" >}}
