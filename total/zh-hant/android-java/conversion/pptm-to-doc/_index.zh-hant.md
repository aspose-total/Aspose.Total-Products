---
title: 通過 Java 將 PPTM 導出到 Andorid 上的 DOC
description: 在移動應用程序中將 PPTM 轉換為 DOC，無需安裝任何軟件
url: /zh-hant/android-java/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 PPTM 渲染到 DOC" h2="文件格式 API 可在 Android 應用程序中將 PPTM 轉換為 DOC，而不依賴於 Microsoft PowerPoint 或 Word" >}}
