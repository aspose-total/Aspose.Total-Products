---
title: Android API 將 WORDML 轉換為 ODS
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 WORDML 轉換為 ODS
url: /zh-hant/android-java/conversion/wordml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 WORDML 轉換為 ODS" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 WORDML 導出為 ODS" >}}
