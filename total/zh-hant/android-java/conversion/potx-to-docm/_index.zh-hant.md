---
title: 通過 Java 將 POTX 導出到 Andorid 上的 DOCM
description: 在移動應用程序中將 POTX 轉換為 DOCM，無需安裝任何軟件
url: /zh-hant/android-java/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="通過 Java 在 Andorid 上將 POTX 渲染到 DOCM" h2="文件格式 API 可在 Android 應用程序中將 POTX 轉換為 DOCM，而不依賴於 Microsoft PowerPoint 或 Word" >}}
