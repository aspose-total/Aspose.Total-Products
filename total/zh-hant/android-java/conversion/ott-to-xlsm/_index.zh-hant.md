...
description: 在不使用 Microsoft Word 或 Microsoft Excel 的情況下，通過 Java 在 Android 中將 OTT 轉換為 XLSM 或在線。在集成代碼之前快速測試免費的 CSV 到 DOC 在線轉換器。
...
{{< blocks/products/pf/feature-page-header h1="在 Android 應用程序中將 OTT 轉換為 XLSM 或在線" h2="在不使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel 的情況下，通過 Java 在 Android 中將 OTT 導出為 XLSM" >}}
