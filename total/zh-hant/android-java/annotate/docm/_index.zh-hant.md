---
title: 在線刪除 DOCM 註釋或使用 Android 行動應用程式管理註釋
description: 透過線上應用程式免費刪除 DOCM 檔案中的註釋。用於管理 DOCM 檔案註解的 Android API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="在線清除 DOCM 文件中的註釋或透過 Android 應用程式進行管理" h2="開發強大的基於 Android 的 DOCM 文件註釋實用程式。列出用於管理 DOCM 檔案註解的程式碼。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="線上刪除 DOCM 註釋" %}}

1. 匯入DOCM檔案上傳刪除評論
1. 透過拖放註釋應用程式在放置區域內點擊來完成此操作
1. 根據 DOCM 檔案的大小和網路速度等待幾秒鐘
1. 點擊「刪除」按鈕清除評論
1. 立即下載文件

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="透過 Android 應用程式刪除 DOCM 文件註釋" %}}
...
{{% blocks/products/pf/agp/code-block title="程式碼：刪除DOCM檔案中的註釋" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="刪除並添加 DOCM 評論回复" %}}
...
{{% blocks/products/pf/agp/code-block title="代碼：從 DOCM 檔案中刪除並新增註釋回复" offSpacer="" %}}
...
<h2>開發 DOCM 文件註釋 Android 應用程式</h2>

需要開發 DOCM 註釋行動應用程式或實用程式來提供回饋、提出建議或與其他人協作處理文件？透過 [Aspose.Words for Android via Java](https://products.aspose.com/words/zh-hant/android-java/)（[Aspose.Total for Android via Java](https://products.aspose.com/total/zh-hant/android-java/) 的子 API），任何 Android 開發人員都可以將上述 API 程式碼整合到其文件註釋應用程式中。強大的 android 庫允許對任何文檔註釋解決方案進行編程。而且它可以支援許多流行的格式，包括DOCM格式。<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於註釋 DOCM 檔案的 Android 函式庫" %}}
