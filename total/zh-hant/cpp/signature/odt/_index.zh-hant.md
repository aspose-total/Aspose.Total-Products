---
title: 在線或使用 C++ 對 ODT 檔案進行數位簽名
description: 用於 ODT 檔案數位簽章的免費線上應用程式。開發 C++ 應用程式以電子方式簽署 ODT 文件。
...
{{< blocks/products/pf/feature-page-header-widget h1="透過電子簽名應用程式或使用 C++ 對 ODT 檔案進行線上數位簽名" h2="開發功能強大的基於 C++ 的 ODT 文件簽章應用程式。透過應用程式在線自由添加數位簽名到各種文檔，包括 ODT 文件，並可即時下載。" >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="使用應用程式在線上將數位簽章新增至 ODT 檔案中" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 對 ODT 檔案進行數位簽名" %}}

1. 使用CertificateHolder載入pfx憑證
1. 使用 DigitalSignatureUtil::Sign 簽署 ODT 文檔

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="C++ 程式碼：在 ODT 檔案中加入數位簽名" offSpacer="" %}}
...
需要開發 C++ 腳本或實用程式應用程式來輕鬆對多個 ODT 檔案進行數位簽章？借助 [Aspose.Total for C++](https://products.aspose.com/total/zh-hant/cpp/) 的子 API [Aspose.Words for C++](https://products.aspose.com/words/cpp/)，任何 C++ 開發人員都可以整合上述 API 程式碼來編寫 eSignature 應用程式以進行跨文件簽章。用於文件簽章的強大 C++ 函式庫，支援許多流行格式，包括 ODT 格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="C++ 的 ODT 電子簽章庫" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">是的，歡迎您下載此程式碼。使用 C++ 可以輕鬆開發專業的解決方案，在 ODT 檔案中加入數位簽章。使用 Aspose ODT eSignature API 用 C++ 開發高階、平台無關的軟體。</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
