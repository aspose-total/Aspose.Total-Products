---
title: 線上或使用 C++ 編輯 DOCX 文檔
description: 透過應用程式免費線上開啟和編輯 DOCX 文件。用於搜尋和取代 DOCX 文字的 C++ API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上或透過 C++ 編輯 DOCX 文檔" h2="開發功能強大的基於 C++ 的 DOCX 文件編輯實用程式。列出用於搜尋和替換 DOCX 檔案中文字的 C++ 程式碼。" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 編輯 DOCX 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="C++ 程式碼：編輯 DOCX 文件" offSpacer="" %}}
...
<h2>透過 C++ 開發 DOCX 修訂應用程式</h2>

需要開發 DOCX 修訂應用程式或實用程式？透過 [Aspose.Words for C++](https://products.aspose.com/words/cpp/)（[Aspose.Total for C++](https://products.aspose.com/total/zh-hant/cpp/) 的子 API），任何 C++ 開發人員都可以將上述 API 程式碼整合到其文件編輯應用程式中。強大的 C++ 程式庫允許對任何文件編輯解決方案進行程式設計。而且它可以支援許多流行的格式，包括DOCX格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於編輯 DOCX 檔案的 C++ 實用程式" %}}
您可以選擇將 Aspose.Words for C++ 或 Aspose.Total for C++ 安裝到您的開發環境。請選擇符合您需求的一項並按照逐步說明進行操作：<br /><br />
