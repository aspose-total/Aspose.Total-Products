---
title: 線上或使用 C++ 刪除 ODT 密碼保護
description: 透過線上應用程式免費解鎖 ODT 文件的密碼。從 ODT 檔案中刪除密碼的 C++ API 程式碼。
...
{{< blocks/products/pf/feature-page-header-widget h1="線上或透過 C++ 解鎖 ODT 文件密碼" h2="開發功能強大的基於 C++ 的 ODT 文件解鎖實用程式。列出用於透過 C++ 從 ODT 檔案中刪除密碼限制的程式碼。" >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="線上解鎖ODT密碼" %}}

1. 導入ODT檔案上傳即可解鎖
1. 透過拖放應用程式在放置區域內單擊來完成此操作
...
{{% blocks/products/pf/agp/feature-section-col title="透過 C++ 刪除 ODT 密碼" %}}

1. 載入受保護的 ODT 文件
1. 呼叫Unprotect()方法刪除密碼保護
1. 呼叫保存方法
...
{{% blocks/products/pf/agp/code-block title="C++ 程式碼：從 ODT 文件中刪除密碼" offSpacer="" %}}
...
<h2>透過 C++ 開發 ODT 保護管理應用程式</h2>

需要開發 ODT 保護管理應用程式或實用程式？透過 [Aspose.Words for C++](https://products.aspose.com/words/cpp/)（[Aspose.Total for C++](https://products.aspose.com/total/zh-hant/cpp/) 的子 API），任何 C++ 開發人員都可以將上述 API 程式碼整合到其文件保護或取消保護應用程式中。強大的 C++ 程式庫允許對任何文件保護解決方案進行程式設計。而且它可以支援許多流行的格式，包括ODT格式。<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="用於管理 ODT 保護的 C++ 實用程式" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>使用線上應用程式取消 ODT 文件的保護是否安全？</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">您可以使用任何現代網頁瀏覽器（例如 Google Chrome、Firefox、Opera 或 Safari）進行線上 ODT 文件解鎖。但是，如果您正在開發桌面應用程序，我們建議使用 Aspose.Total 文件處理 API 進行高效管理。</span>
                      </div>
                  </li>
              </ul>
          </div>
