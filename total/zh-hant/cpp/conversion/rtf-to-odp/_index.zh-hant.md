---
title: 通過 C++ 將 RTF 轉換為 ODP
description: 在您的 C++ 應用程序中將 RTF 導出為 ODP，而無需使用 Microsoft Word of PowerPoint
url: /zh-hant/cpp/conversion/rtf-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="將 RTF 轉換為 ODP 的 C++ API" h2="在您的 C++ 應用程序中將 RTF 導出為 ODP，而無需使用 Microsoft Word&reg;或 PowerPoint" >}}
