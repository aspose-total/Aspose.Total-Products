---
title: 通過 C++ 將 PPTX 轉換為 ODS
description: 在 C++ 中將 PPTX 導出為 ODS，而不使用 Microsoft Excel 或 Powerpoint
url: /zh-hant/cpp/conversion/pptx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="通過 C++ 將 PPTX 轉換為 ODS" h2="通過 C++ 將 PPTX 轉換為 ODS 文件，無需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 C++ 將 PPTX 轉換為 ODS" %}}
