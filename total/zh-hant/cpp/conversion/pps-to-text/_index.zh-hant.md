---
title: 將 PPS 轉換為 TEXT 的 C++ API
description: 在 C++ 應用程序中將 PPS 導出為 TEXT
url: /zh-hant/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="將 PPS 渲染為 TEXT 的 C++ API" h2="在 C++ 應用程序中將 PPS 導出為 TEXT，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
