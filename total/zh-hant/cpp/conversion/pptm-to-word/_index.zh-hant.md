---
title: 將 PPTM 轉換為 WORD 的 C++ API
description: 在 C++ 應用程序中將 PPTM 導出為 WORD
url: /zh-hant/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="將 PPTM 渲染為 WORD 的 C++ API" h2="在 C++ 應用程序中將 PPTM 導出為 WORD，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
