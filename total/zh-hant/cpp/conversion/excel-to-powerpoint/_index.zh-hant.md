---
title: 使用 C++ 將 EXCEL 轉換為 POWERPOINT
description: 在 C++ 應用程序中將 EXCEL 轉換為 POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="通過 C++ 將 EXCEL 轉換為 POWERPOINT" h2="導出 Excel<sup>&reg;</sup>全功能 C++ 應用程序中的 EXCEL 到 POWERPOINT" >}}
