---
title: 將 PPT 轉換為 DOT 的 C++ API
description: 在 C++ 應用程序中將 PPT 導出為 DOT
url: /zh-hant/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="將 PPT 渲染為 DOT 的 C++ API" h2="在 C++ 應用程序中將 PPT 導出為 DOT，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
