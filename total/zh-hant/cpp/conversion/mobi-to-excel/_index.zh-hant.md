...
description: 無需使用 Microsoft Word 或 Microsoft Excel 即可將 MOBI 轉換為 EXCEL 的 C++ API 或在線 或在線。在集成代碼之前快速測試免費的 POT 到 CSV 在線轉換器。
...
{{< blocks/products/pf/feature-page-header h1="將 MOBI 轉換為 EXCEL 的 C++ API 或在線" h2="通過 C++ 將 MOBI 導出為 EXCEL，無需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="將 MOBI 轉換為 EXCEL 的 C++ API 或在線" %}}
