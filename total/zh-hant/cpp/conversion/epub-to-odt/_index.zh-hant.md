...
url: /zh-hant/cpp/conversion/epub-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
...
4.使用[Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stream_saveformat)成員函數將文檔保存為ODT格式
