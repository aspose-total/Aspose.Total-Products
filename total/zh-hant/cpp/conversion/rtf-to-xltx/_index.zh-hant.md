---
title: 在 C++ 中將 RTF 轉換為 XLTX
description: 無需使用 Microsoft Word 或 Microsoft Excel 即可將 RTF 轉換為 XLTX 的 C++ API
url: /zh-hant/cpp/conversion/rtf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="將 RTF 轉換為 XLTX 的 C++ API" h2="通過 C++ 將 RTF 導出為 XLTX，無需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="將 RTF 轉換為 XLTX 的 C++ API" %}}
