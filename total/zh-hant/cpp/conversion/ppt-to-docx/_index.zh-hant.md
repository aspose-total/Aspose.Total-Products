---
title: 將 PPT 轉換為 DOCX 的 C++ API
description: 在 C++ 應用程序中將 PPT 導出為 DOCX
url: /zh-hant/cpp/conversion/ppt-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="將 PPT 渲染為 DOCX 的 C++ API" h2="在 C++ 應用程序中將 PPT 導出為 DOCX，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
...
3. 使用 [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument) 類引用加載轉換後的 HTML 文件
4. 使用[保存](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string)成員函數將文檔保存為DOCX格式
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/cpp/conversion/ppt-to-docxm/" name="PPT 至 DOCXM" description="" >}}
