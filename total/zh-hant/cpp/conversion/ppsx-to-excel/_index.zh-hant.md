---
title: 通過 C++ 將 PPSX 轉換為 EXCEL
description: 在 C++ 中將 PPSX 導出為 EXCEL，而不使用 Microsoft Excel 或 Powerpoint
url: /zh-hant/cpp/conversion/ppsx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="通過 C++ 將 PPSX 轉換為 EXCEL" h2="通過 C++ 將 PPSX 轉換為 EXCEL 文件，無需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 C++ 將 PPSX 轉換為 EXCEL" %}}
