---
title: 通過 C++ 將 POWERPOINT 轉換為 MARKDOWN
description: 在 C++ 中將 POWERPOINT 導出為 MARKDOWN，而不使用 Microsoft Excel 或 Powerpoint
url: /zh-hant/cpp/conversion/powerpoint-to-markdown/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
{{< blocks/products/pf/feature-page-header h1="通過 C++ 將 POWERPOINT 轉換為 MARKDOWN" h2="通過 C++ 將 POWERPOINT 轉換為 MARKDOWN 文件，無需使用 Microsoft<sup>&reg;</sup> Excel 或 PowerPoint" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 C++ 將 POWERPOINT 轉換為 MARKDOWN" %}}
