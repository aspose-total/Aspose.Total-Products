---
title: 將 PPTX 轉換為 TEXT 的 C++ API
description: 在 C++ 應用程序中將 PPTX 導出為 TEXT
url: /zh-hant/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="將 PPTX 渲染為 TEXT 的 C++ API" h2="在 C++ 應用程序中將 PPTX 導出為 TEXT，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
