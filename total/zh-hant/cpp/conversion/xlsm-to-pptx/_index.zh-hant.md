---
title: 使用 C++ 將 XLSM 轉換為 PPTX
description: 在 C++ 應用程序中將 XLSM 轉換為 PPTX
...
{{< blocks/products/pf/feature-page-header h1="通過 C++ 將 XLSM 轉換為 PPTX" h2="導出 Excel<sup>&reg;</sup>全功能 C++ 應用程序中的 XLSM 到 PPTX" >}}
