---
title: 在 C++ 中將 RTF 轉換為 TSV
description: 無需使用 Microsoft Word 或 Microsoft Excel 即可將 RTF 轉換為 TSV 的 C++ API
url: /zh-hant/cpp/conversion/rtf-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="將 RTF 轉換為 TSV 的 C++ API" h2="通過 C++ 將 RTF 導出為 TSV，無需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="將 RTF 轉換為 TSV 的 C++ API" %}}
