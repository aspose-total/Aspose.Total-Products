---
title: 將 POWERPOINT 轉換為 DOCM 的 C++ API
description: 在 C++ 應用程序中將 POWERPOINT 導出為 DOCM
url: /zh-hant/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="將 POWERPOINT 渲染為 DOCM 的 C++ API" h2="在 C++ 應用程序中將 POWERPOINT 導出為 DOCM，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
