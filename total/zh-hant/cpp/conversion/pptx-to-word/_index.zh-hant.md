---
title: 將 PPTX 轉換為 WORD 的 C++ API
description: 在 C++ 應用程序中將 PPTX 導出為 WORD
...
{{< blocks/products/pf/feature-page-header h1="將 PPTX 渲染為 WORD 的 C++ API" h2="在 C++ 應用程序中將 PPTX 導出為 WORD，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/cpp/conversion/pptx-to-wordx/" name="PPTX 至 WORDX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/cpp/conversion/pptx-to-wordm/" name="PPTX 至 WORDM" description="" >}}
