---
title: 將 POTM 轉換為 OTT 的 C++ API
description: 在 C++ 應用程序中將 POTM 導出為 OTT
url: /zh-hant/cpp/conversion/potm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="將 POTM 渲染為 OTT 的 C++ API" h2="在 C++ 應用程序中將 POTM 導出為 OTT，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/cpp/conversion/potm-to-ottm/" name="POTM 至 OTTM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/zh-hant/cpp/conversion/potm-to-ottx/" name="POTM 至 OTTX" description="" >}}
