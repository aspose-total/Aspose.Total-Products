---
title: 將 PPSX 轉換為 DOCX 的 C++ API
description: 在 C++ 應用程序中將 PPSX 導出為 DOCX
url: /zh-hant/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="將 PPSX 渲染為 DOCX 的 C++ API" h2="在 C++ 應用程序中將 PPSX 導出為 DOCX，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
