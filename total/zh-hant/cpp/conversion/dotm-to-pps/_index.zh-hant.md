---
title: 通過 C++ 將 DOTM 轉換為 PPS
description: 在您的 C++ 應用程序中將 DOTM 導出為 PPS，而無需使用 Microsoft Word of PowerPoint
url: /zh-hant/cpp/conversion/dotm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="將 DOTM 轉換為 PPS 的 C++ API" h2="在您的 C++ 應用程序中將 DOTM 導出為 PPS，而無需使用 Microsoft Word&reg;或 PowerPoint" >}}
