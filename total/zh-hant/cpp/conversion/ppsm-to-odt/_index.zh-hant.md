---
title: 將 PPSM 轉換為 ODT 的 C++ API
description: 在 C++ 應用程序中將 PPSM 導出為 ODT
url: /zh-hant/cpp/conversion/ppsm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="將 PPSM 渲染為 ODT 的 C++ API" h2="在 C++ 應用程序中將 PPSM 導出為 ODT，無需任何 Microsoft PowerPoint 或 Word 依賴項" >}}
