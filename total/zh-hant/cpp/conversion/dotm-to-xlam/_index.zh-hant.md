---
title: 在 C++ 中將 DOTM 轉換為 XLAM
description: 無需使用 Microsoft Word 或 Microsoft Excel 即可將 DOTM 轉換為 XLAM 的 C++ API
url: /zh-hant/cpp/conversion/dotm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="將 DOTM 轉換為 XLAM 的 C++ API" h2="通過 C++ 將 DOTM 導出為 XLAM，無需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="將 DOTM 轉換為 XLAM 的 C++ API" %}}
