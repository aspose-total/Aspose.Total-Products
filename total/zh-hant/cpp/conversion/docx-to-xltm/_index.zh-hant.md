...
{{< blocks/products/pf/feature-page-header h1="將 DOCX 轉換為 XLTM 的 C++ API" h2="通過 C++ 將 DOCX 導出為 XLTM，無需使用 Microsoft<sup>&reg;</sup> Word 或 Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="將 DOCX 轉換為 XLTM 的 C++ API" %}}
1.使用[Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)類參考打開DOCX文件
2. 使用 [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string_saveformat) 成員函數將 DOCX 轉換為 HTML
...
{{% blocks/products/pf/feature-page-section  h2="通過 C++ 訪問 DOCX 文檔屬性" %}}
[Aspose.Words for C++](https://products.aspose.com/words/cpp/) 還允許您訪問 DOCX 文件的文檔屬性，並讓您在轉換過程之前做出明智的決定。要訪問文檔屬性，您可以使用 [BuiltInDocxumentProperties](https://reference.aspose.com/words/cpp/class/aspose.words.properties.built_in_docxument_properties) 來獲取內置屬性和 [CustomDocxumentProperties](https:// reference.aspose.com/words/cpp/class/aspose.words.properties.custom_docxument_properties)來獲取自定義屬性。以下代碼示例演示如何枚舉文檔中的所有內置和自定義屬性。
{{% blocks/products/pf/feature-page-code %}}
