---
title: המרה מקוונת של VSSX ל-PDF או יישום מבוסס Node.js להמרת קבצי VSSX
description: אפליקציה מקוונת בחינם להמרת קבצי VSSX ל-PDF. קוד ספריית ההמרות של Node.js עבור מסמכי Microsoft Visio VSSX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של VSSX ל-PDF וקוד Node.js להמרת קבצי VSSX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Node.js VSSX.  המר קבצי Microsoft Visio VSSX בודדים או מרובים ל-PDF ולפורמטים אחרים באמצעות ממשק API של Node.js.  המר באופן חופשי קבצי VSSX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-VSSX ל-PDF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pdf&from=vssx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של VSSX ל-PDF באמצעות אפליקציה" %}}

1. העלה קבצי Microsoft Visio VSSX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל VSSX
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. VSSX יומר למסמך PDF
1. הורד את קובץ ה-PDF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את VSSX ל-PDF באמצעות ממשק API של Node.js Automation" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את VSSX ל-PDF דרך Node.js" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את VSSX ל-PDF פלטפורמות ודרישות לאפליקציה" %}}
