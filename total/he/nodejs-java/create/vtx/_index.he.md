---
title: צור דיאגרמות Visio VTX ב-Node.js
description: צור דיאגרמות של Microsoft Visio VTX באמצעות יישומי Node מבלי להשתמש ב-Microsoft Office.  
...
{{< blocks/products/pf/feature-page-header h1="צור קובץ VTX באמצעות Node.js" h2="צור קבצי Microsoft Visio VTX דרך יישומי הצומת שלך מבלי להתקין תוכנה אחרת." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="צור קובץ VTX ב-Node.js" %}}

- צור מופע מחלקה של Diagram.
- קרא לשיטת השמירה עם פרמטרים רלוונטיים
- VTX נתיב קובץ וסיומת SaveFileFormat הרלוונטית

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="דרישות יצירה" %}}

- ליצירת מסמך VTX, יש להתקין את Node.js במערכת.
- נדרש Oracle JDK (גרסה 7 ואילך).
- יש להגדיר את חבילת ה-node-java.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - צור קבצי VTX" offSpacer="" %}}
