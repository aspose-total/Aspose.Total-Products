---
title: הסר הערות PDF באינטרנט או נהל הערות באמצעות .NET
description: מחק הערות מקובץ PDF דרך האפליקציה המקוונת בחינם. קוד C# .NET API לניהול הערות של קבצי PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="נקה הערות מ-PDF Document Online או נהל באמצעות NET" h2="פתח יישום רב עוצמה המבוסס על PDF מסמכים PDF. קוד רשום לניהול הערות של קובץ PDF דרך NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="הוסף הערה באמצעות NET" %}}

1. הוסף הפניה לספרייה לפרויקט NET 
1. צור אובייקט בכיתה Document
1. הוסף את העמוד והפסקאות החדשות באמצעות Pages.Add ו- Paragraphs.Add
1. השתמש במחלקה TextAnnotation והגדר את ההערות
1. השתמש בעמודים[1].הערות.הוסף כדי להוסיף את ההערות
1. התקשר לשיטת השמירה כדי לשמור את הקובץ עם הערות
...
{{% blocks/products/pf/agp/code-block title="קוד NET: הוסף הערות בקובץ PDF" offSpacer="" %}}
...
<h2>פתח יישום הערות מסמכים PDF באמצעות NET</h2>

צריך לפתח אפליקציית הערות PDF או כלי עזר כדי לספק משוב, להציע הצעות או לשתף פעולה עם אחרים במסמך? עם [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/) צאצא API של [Aspose.Total for .NET](https://products.aspose.com/total/he/net/), כל מפתח NET יכול לשלב את קוד ה-API שלמעלה בתוך יישום הערת המסמכים שלו. ספריית .NET רבת עוצמה מאפשרת לתכנת כל פתרון להערות מסמכים. יתר על כן, זה יכול לתמוך בפורמטים פופולריים רבים כולל פורמט PDF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ספריית NET לביאור קבצי PDF" %}}
