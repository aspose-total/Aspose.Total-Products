---
title: הסר הערות XLSM באינטרנט או נהל הערות באמצעות .NET
description: מחק הערות מקובץ XLSM דרך האפליקציה המקוונת בחינם. קוד .NET API לניהול הערות של קבצי XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="נקה הערות מ-XLSM Document Online או נהל באמצעות NET" h2="פתח יישום רב עוצמה מבוסס XLSM למסמכים XLSM. קוד רשום לניהול הערות של קובץ XLSM דרך NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="הסר הערות XLSM באופן מקוון" %}}

1. ייבא קובץ XLSM כדי למחוק הערות על ידי העלאתו
...
{{% blocks/products/pf/agp/feature-section-col title="הסר הערות XLSM דרך NET" %}}

1. הוסף הפניה לספרייה לפרויקט NET 
1. טען מסמך באמצעות אובייקט מחלקה של חוברת עבודה
1. בחר את גליון העבודה הספציפי
1. השתמש ב-Comments.RemoveAt עם העמודה הספציפית כאינדקס
...
{{% blocks/products/pf/agp/code-block title="קוד NET: מחק הערות מקובץ XLSM" offSpacer="" %}}
...
<h2>פתח יישום הערות מסמכים XLSM באמצעות NET</h2>

צריך לפתח אפליקציית הערות XLSM או כלי עזר כדי לספק משוב, להציע הצעות או לשתף פעולה עם אחרים במסמך? עם [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) צאצא API של [Aspose.Total for .NET](https://products.aspose.com/total/he/net/), כל מפתח NET יכול לשלב את קוד ה-API שלמעלה בתוך יישום הערות המסמכים שלו. ספריית .NET רבת עוצמה מאפשרת לתכנת כל פתרון להערות מסמכים. יתר על כן, זה יכול לתמוך בפורמטים פופולריים רבים כולל פורמט XLSM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ספריית NET לביאור קבצי XLSM" %}}
ישנן שלוש אפשרויות חלופיות להתקנת "Aspose.Cells for .NET" או "Aspose.Total for .NET" במערכת שלך. אנא בחר אחד שדומה לצרכים שלך ופעל לפי ההוראות המפורטות:<br /><br />
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>האם זה בטוח להשתמש באפליקציה המקוונת כדי להוסיף הערות למסמך XLSM?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">אתה יכול להשתמש בכל דפדפן אינטרנט מודרני כמו גוגל כרום, פיירפוקס, אופרה או ספארי להערות מקוונות במסמך XLSM. עם זאת, אם אתה מפתח יישום שולחן עבודה, אנו ממליצים להשתמש ב-API לעיבוד מסמכים Aspose.Total לניהול יעיל.</span>
                      </div>
                  </li>
              </ul>
          </div>
