---
title: המרה מקוונת של XLSX ל-DOT או בניית אפליקציה מבוססת Python להמרת קבצי XLSX
description: אפליקציה מקוונת בחינם להמרת קבצי XLSX ל-DOT. קוד ספריית ההמרות של Python עבור מסמכי XLSX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLSX ל-DOT וקוד Python להמרת קבצי XLSX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLSX.  המר קבצי XLSX בודדים או מרובים ל-DOT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLSX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת XLSX ל-DOT מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dot&from=xlsx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLSX ל-DOT באמצעות אפליקציה" %}}

1. העלה קבצים XLSX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLSX
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLSX יומר למסמך DOT
1. הורד את קובץ ה-DOT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLSX ל-DOT באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ DOT פלט. אז קובץ ה-XLSX שלך מומר ל-DOT בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את XLSX ל-DOT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLSX ב-DOT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLSX ל-DOT דרישות האפליקציה" %}}
