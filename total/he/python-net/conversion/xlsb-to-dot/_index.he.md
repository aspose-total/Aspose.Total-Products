---
title: המרה מקוונת של XLSB ל-DOT או בניית אפליקציה מבוססת Python להמרת קבצי XLSB
description: אפליקציה מקוונת בחינם להמרת קבצי XLSB ל-DOT. קוד ספריית ההמרות של Python עבור מסמכי XLSB.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLSB ל-DOT וקוד Python להמרת קבצי XLSB" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLSB.  המר קבצי XLSB בודדים או מרובים ל-DOT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLSB באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLSB ל-DOT באמצעות אפליקציה" %}}

1. העלה קבצים XLSB להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLSB
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLSB יומר למסמך DOT
1. הורד את קובץ ה-DOT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLSB ל-DOT באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את XLSB ל-DOT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLSB ב-DOT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLSB ל-DOT דרישות האפליקציה" %}}
