---
title: המרה מקוונת של DOCX ל-Powerpoint או בניית אפליקציה מבוססת Python להמרת קבצי DOCX
description: אפליקציה מקוונת בחינם להמרת קבצי DOCX ל-Powerpoint. קוד ספריית ההמרות של Python עבור מסמכי DOCX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCX ל-Powerpoint וקוד Python להמרת קבצי DOCX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCX.  המר קבצי DOCX בודדים או מרובים ל-Powerpoint ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOCX to Powerpoint Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pptx&from=docx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOCX ל-Powerpoint באמצעות אפליקציה" %}}

1. העלה קבצים DOCX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOCX
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOCX יומר למסמך Powerpoint
1. הורד את קובץ ה-Powerpoint שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOCX ל-Powerpoint באמצעות Python Automation API" %}}
...
-  **Step 2** Load PDF file with an instance of [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) class
	-  Call the `save` method while specifying output file path & SaveFormat.POWERPOINT as parameters. So your DOCX file is converted to POWERPOINT at the specified path.
...
{{% blocks/products/pf/agp/code-block title="המר את DOCX ל-Powerpoint באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCX ב-Powerpoint עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOCX ל-Powerpoint דרישות האפליקציה" %}}
