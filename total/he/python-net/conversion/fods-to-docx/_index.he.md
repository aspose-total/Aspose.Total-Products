...
<iframe title="Free Online FODS to DOCX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docx&from=fods" id="child-iframe" width="80%"></iframe>
...
-  Call the `save` method while specifying output DOCX file path. So your FODS file is converted to DOCX at the specified path
