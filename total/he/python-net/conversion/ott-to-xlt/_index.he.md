---
title: המרה מקוונת של OTT ל-XLT או בניית אפליקציה מבוססת Python להמרת קבצי OTT
description: אפליקציה מקוונת בחינם להמרת קבצי OTT ל-XLT. קוד ספריית ההמרות של Python עבור מסמכי OTT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של OTT ל-XLT וקוד Python להמרת קבצי OTT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה OTT.  המר קבצי OTT בודדים או מרובים ל-XLT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי OTT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת OTT ל-XLT מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xlt&from=ott" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את OTT ל-XLT באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ XLT פלט. אז קובץ ה-OTT שלך מומר ל-XLT בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את OTT ל-XLT באמצעות Python" offSpacer="" %}}
