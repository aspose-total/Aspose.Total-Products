---
title: המרה מקוונת של OFT ל-IMAGE או בניית אפליקציה מבוססת Python להמרת קבצי OFT
description: אפליקציה מקוונת בחינם להמרת קבצי OFT ל-IMAGE. קוד ספריית ההמרות של Python עבור מסמכי OFT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של OFT ל-IMAGE וקוד Python להמרת קבצי OFT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה OFT.  המר קבצי OFT בודדים או מרובים ל-IMAGE ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי OFT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת OFT ל-IMAGE מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=image&from=oft" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את OFT ל-IMAGE באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את OFT ל-IMAGE באמצעות Python" offSpacer="" %}}
