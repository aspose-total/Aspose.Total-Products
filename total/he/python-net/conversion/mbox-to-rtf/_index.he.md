---
title: המרה מקוונת של MBOX ל-RTF או בניית אפליקציה מבוססת Python להמרת קבצי MBOX
description: אפליקציה מקוונת בחינם להמרת קבצי MBOX ל-RTF. קוד ספריית ההמרות של Python עבור מסמכי MBOX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MBOX ל-RTF וקוד Python להמרת קבצי MBOX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה MBOX.  המר קבצי MBOX בודדים או מרובים ל-RTF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי MBOX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של MBOX ל-RTF באמצעות אפליקציה" %}}

1. העלה קבצים MBOX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל MBOX
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. MBOX יומר למסמך RTF
1. הורד את קובץ ה-RTF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MBOX ל-RTF באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את MBOX ל-RTF באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MBOX ב-RTF עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MBOX ל-RTF דרישות האפליקציה" %}}
