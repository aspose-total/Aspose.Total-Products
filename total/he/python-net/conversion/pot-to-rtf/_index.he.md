---
title: המרה מקוונת של POT ל-RTF או בניית אפליקציה מבוססת Python להמרת קבצי POT
description: אפליקציה מקוונת בחינם להמרת קבצי POT ל-RTF. קוד ספריית ההמרות של Python עבור מסמכי POT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POT ל-RTF וקוד Python להמרת קבצי POT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה POT.  המר קבצי POT בודדים או מרובים ל-RTF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי POT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online POT to RTF Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=pot" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של POT ל-RTF באמצעות אפליקציה" %}}

1. העלה קבצים POT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל POT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. POT יומר למסמך RTF
1. הורד את קובץ ה-RTF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את POT ל-RTF באמצעות Python Automation API" %}}
...
-  **Step 1** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PDF כפרמטרים. אז קובץ ה-POT שלך מומר ל-PDF בנתיב שצוין.
- **Step 2** פתח את קובץ ה-PDF באמצעות מחלקת [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
	- שמור קובץ PDF לקובץ RTF באמצעות שיטת [Save](https://reference.aspose.com/words/python-net/aspose.words/document/save/) על ידי מתן שם הקובץ ונתיב הספרייה הרצוי.
...
{{% blocks/products/pf/agp/code-block title="המר את POT ל-RTF באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POT ב-RTF עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את POT ל-RTF דרישות האפליקציה" %}}
