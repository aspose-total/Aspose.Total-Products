---
title: המרה מקוונת של DOC ל-PPTM או בניית אפליקציה מבוססת Python להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-PPTM. קוד ספריית ההמרות של Python עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-PPTM וקוד Python להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOC.  המר קבצי DOC בודדים או מרובים ל-PPTM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOC to PPTM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pptm&from=doc" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOC ל-PPTM באמצעות אפליקציה" %}}

1. העלה קבצים DOC להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOC
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOC יומר למסמך PPTM
1. הורד את קובץ ה-PPTM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-PPTM באמצעות Python Automation API" %}}
...
-  **Step 2** Load PDF file with an instance of [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) class
	-  Call the `save` method while specifying output file path & SaveFormat.PPTM as parameters. So your DOC file is converted to PPTM at the specified path.
...
{{% blocks/products/pf/agp/code-block title="המר את DOC ל-PPTM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOC ב-PPTM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOC ל-PPTM דרישות האפליקציה" %}}
