...
<iframe title="Free Online POT to XLTX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xltx&from=pot" id="child-iframe" width="80%"></iframe>
...
-  Call the `save` method while specifying output XLTX file path. So your POT file is converted to XLTX at the specified path
