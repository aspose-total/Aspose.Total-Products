---
title: המרה מקוונת של MOBI ל-DIF או בניית אפליקציה מבוססת Python להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-DIF. קוד ספריית ההמרות של Python עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-DIF וקוד Python להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה MOBI.  המר קבצי MOBI בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-DIF באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את MOBI ל-DIF באמצעות Python" offSpacer="" %}}
