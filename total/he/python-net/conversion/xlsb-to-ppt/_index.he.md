---
title: המרה מקוונת של XLSB ל-PPT או בניית אפליקציה מבוססת Python להמרת קבצי XLSB
description: אפליקציה מקוונת בחינם להמרת קבצי XLSB ל-PPT. קוד ספריית ההמרות של Python עבור מסמכי XLSB.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLSB ל-PPT וקוד Python להמרת קבצי XLSB" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLSB.  המר קבצי XLSB בודדים או מרובים ל-PPT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLSB באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online XLSB to PPT Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppt&from=xlsb" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLSB ל-PPT באמצעות אפליקציה" %}}

1. העלה קבצים XLSB להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLSB
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLSB יומר למסמך PPT
1. הורד את קובץ ה-PPT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLSB ל-PPT באמצעות Python Automation API" %}}
...
-  Call the [save](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) method while specifying output PPT file path. So your XLSB file is converted to PPT at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את XLSB ל-PPT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLSB ב-PPT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLSB ל-PPT דרישות האפליקציה" %}}
