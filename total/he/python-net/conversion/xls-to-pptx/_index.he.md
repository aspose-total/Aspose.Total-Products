---
title: המרה מקוונת של XLS ל-PPTX או בניית אפליקציה מבוססת Python להמרת קבצי XLS
description: אפליקציה מקוונת בחינם להמרת קבצי XLS ל-PPTX. קוד ספריית ההמרות של Python עבור מסמכי XLS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLS ל-PPTX וקוד Python להמרת קבצי XLS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLS.  המר קבצי XLS בודדים או מרובים ל-PPTX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת XLS ל-PPTX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pptx&from=xls" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLS ל-PPTX באמצעות אפליקציה" %}}

1. העלה קבצים XLS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLS יומר למסמך PPTX
1. הורד את קובץ ה-PPTX שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLS ל-PPTX באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את XLS ל-PPTX באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLS ב-PPTX עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLS ל-PPTX דרישות האפליקציה" %}}
