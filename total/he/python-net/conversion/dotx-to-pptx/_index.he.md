---
title: המרה מקוונת של DOTX ל-PPTX או בניית אפליקציה מבוססת Python להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-PPTX. קוד ספריית ההמרות של Python עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-PPTX וקוד Python להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOTX.  המר קבצי DOTX בודדים או מרובים ל-PPTX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOTX ל-PPTX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pptx&from=dotx" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-PPTX באמצעות Python Automation API" %}}
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PPTX כפרמטרים. אז קובץ ה-DOTX שלך מומר ל-PPTX בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOTX ל-PPTX באמצעות Python" offSpacer="" %}}
