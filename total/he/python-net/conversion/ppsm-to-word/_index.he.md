---
title: המרה מקוונת של PPSM ל-Word או בניית אפליקציה מבוססת Python להמרת קבצי PPSM
description: אפליקציה מקוונת בחינם להמרת קבצי PPSM ל-Word. קוד ספריית ההמרות של Python עבור מסמכי PPSM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPSM ל-Word וקוד Python להמרת קבצי PPSM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה PPSM.  המר קבצי PPSM בודדים או מרובים ל-Word ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי PPSM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online PPSM to Word Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docx&from=ppsm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PPSM ל-Word באמצעות אפליקציה" %}}

1. העלה קבצים PPSM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל PPSM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. PPSM יומר למסמך Word
1. הורד את קובץ ה-Word שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PPSM ל-Word באמצעות Python Automation API" %}}
...
-  **Step 1** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PDF כפרמטרים. אז קובץ ה-PPSM שלך מומר ל-PDF בנתיב שצוין.
- **Step 2** פתח את קובץ ה-PDF באמצעות מחלקת [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
	- שמור קובץ PDF לקובץ WORD באמצעות שיטת [Save](https://reference.aspose.com/words/python-net/aspose.words/document/save/) על ידי מתן שם הקובץ ונתיב הספרייה הרצוי.
...
{{% blocks/products/pf/agp/code-block title="המר את PPSM ל-Word באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPSM ב-Word עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PPSM ל-Word דרישות האפליקציה" %}}
