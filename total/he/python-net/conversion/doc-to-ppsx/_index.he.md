...
<iframe title="אפליקציית המרת DOC ל-PPSX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppsx&from=doc" id="child-iframe" width="80%"></iframe>
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PPSX כפרמטרים. אז קובץ ה-DOC שלך מומר ל-PPSX בנתיב שצוין.
