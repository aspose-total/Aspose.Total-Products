---
title: המרה מקוונת של DOC ל-PPSX או בניית אפליקציה מבוססת Python להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-PPSX. קוד ספריית ההמרות של Python עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-PPSX וקוד Python להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOC.  המר קבצי DOC בודדים או מרובים ל-PPSX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-PPSX באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DOC ל-PPSX באמצעות Python" offSpacer="" %}}
