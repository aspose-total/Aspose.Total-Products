---
title: המרה מקוונת של XPS ל-PST או בניית אפליקציה מבוססת Python להמרת קבצי XPS
description: אפליקציה מקוונת בחינם להמרת קבצי XPS ל-PST. קוד ספריית ההמרות של Python עבור מסמכי XPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XPS ל-PST וקוד Python להמרת קבצי XPS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XPS.  המר קבצי XPS בודדים או מרובים ל-PST ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online XPS to PST Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pst&from=xps" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XPS ל-PST באמצעות אפליקציה" %}}

1. העלה קבצים XPS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XPS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XPS יומר למסמך PST
1. הורד את קובץ ה-PST שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XPS ל-PST באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את XPS ל-PST באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XPS ב-PST עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XPS ל-PST דרישות האפליקציה" %}}
