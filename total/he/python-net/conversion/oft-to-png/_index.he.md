---
title: המרה מקוונת של OFT ל-PNG או בניית אפליקציה מבוססת Python להמרת קבצי OFT
description: אפליקציה מקוונת בחינם להמרת קבצי OFT ל-PNG. קוד ספריית ההמרות של Python עבור מסמכי OFT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של OFT ל-PNG וקוד Python להמרת קבצי OFT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה OFT.  המר קבצי OFT בודדים או מרובים ל-PNG ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי OFT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת OFT ל-PNG מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=png&from=oft" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של OFT ל-PNG באמצעות אפליקציה" %}}

1. העלה קבצים OFT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל OFT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. OFT יומר למסמך PNG
1. הורד את קובץ ה-PNG שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את OFT ל-PNG באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את OFT ל-PNG באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת OFT ב-PNG עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את OFT ל-PNG דרישות האפליקציה" %}}
