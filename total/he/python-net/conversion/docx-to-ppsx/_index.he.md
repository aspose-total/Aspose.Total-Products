---
title: המרה מקוונת של DOCX ל-PPSX או בניית אפליקציה מבוססת Python להמרת קבצי DOCX
description: אפליקציה מקוונת בחינם להמרת קבצי DOCX ל-PPSX. קוד ספריית ההמרות של Python עבור מסמכי DOCX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCX ל-PPSX וקוד Python להמרת קבצי DOCX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCX.  המר קבצי DOCX בודדים או מרובים ל-PPSX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOCX to PPSX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppsx&from=docx" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCX ל-PPSX באמצעות Python Automation API" %}}
...
-  **Step 2** Load PDF file with an instance of [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) class
	-  Call the `save` method while specifying output file path & SaveFormat.PPSX as parameters. So your DOCX file is converted to PPSX at the specified path.
...
{{% blocks/products/pf/agp/code-block title="המר את DOCX ל-PPSX באמצעות Python" offSpacer="" %}}
