...
<iframe title="אפליקציית המרת RTF ל-ODP מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odp&from=rtf" id="child-iframe" width="80%"></iframe>
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.ODP כפרמטרים. אז קובץ ה-RTF שלך מומר ל-ODP בנתיב שצוין.
