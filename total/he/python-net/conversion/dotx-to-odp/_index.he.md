---
title: המרה מקוונת של DOTX ל-ODP או בניית אפליקציה מבוססת Python להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-ODP. קוד ספריית ההמרות של Python עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-ODP וקוד Python להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOTX.  המר קבצי DOTX בודדים או מרובים ל-ODP ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-ODP באמצעות Python Automation API" %}}
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.ODP כפרמטרים. אז קובץ ה-DOTX שלך מומר ל-ODP בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOTX ל-ODP באמצעות Python" offSpacer="" %}}
