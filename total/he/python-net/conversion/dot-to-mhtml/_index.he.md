---
title: המרה מקוונת של DOT ל-MHTML או בניית אפליקציה מבוססת Python להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-MHTML. קוד ספריית ההמרות של Python עבור מסמכי DOT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOT ל-MHTML וקוד Python להמרת קבצי DOT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOT.  המר קבצי DOT בודדים או מרובים ל-MHTML ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOT ל-MHTML מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=mhtml&from=dot" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOT ל-MHTML באמצעות אפליקציה" %}}

1. העלה קבצים DOT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOT יומר למסמך MHTML
1. הורד את קובץ ה-MHTML שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-MHTML באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DOT ל-MHTML באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOT ב-MHTML עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOT ל-MHTML דרישות האפליקציה" %}}
