---
title: המרה מקוונת של OTT ל-MHTML או בניית אפליקציה מבוססת Python להמרת קבצי OTT
description: אפליקציה מקוונת בחינם להמרת קבצי OTT ל-MHTML. קוד ספריית ההמרות של Python עבור מסמכי OTT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של OTT ל-MHTML וקוד Python להמרת קבצי OTT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה OTT.  המר קבצי OTT בודדים או מרובים ל-MHTML ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי OTT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online OTT to MHTML Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=mhtml&from=ott" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של OTT ל-MHTML באמצעות אפליקציה" %}}

1. העלה קבצים OTT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל OTT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. OTT יומר למסמך MHTML
1. הורד את קובץ ה-MHTML שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את OTT ל-MHTML באמצעות Python Automation API" %}}
...
- Call the `save` method while specifying output file path & SaveFormat as parameters. So your OTT file is converted to MHTML at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את OTT ל-MHTML באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת OTT ב-MHTML עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את OTT ל-MHTML דרישות האפליקציה" %}}
