---
title: המרה מקוונת של DOTM ל-ODS או בניית אפליקציה מבוססת Python להמרת קבצי DOTM
description: אפליקציה מקוונת בחינם להמרת קבצי DOTM ל-ODS. קוד ספריית ההמרות של Python עבור מסמכי DOTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTM ל-ODS וקוד Python להמרת קבצי DOTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOTM.  המר קבצי DOTM בודדים או מרובים ל-ODS ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOTM to ODS Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ods&from=dotm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTM ל-ODS באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ ODS פלט. אז קובץ ה-DOTM שלך מומר ל-ODS בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את DOTM ל-ODS באמצעות Python" offSpacer="" %}}
