---
title: המרה מקוונת של FODS ל-DOTX או בניית אפליקציה מבוססת Python להמרת קבצי FODS
description: אפליקציה מקוונת בחינם להמרת קבצי FODS ל-DOTX. קוד ספריית ההמרות של Python עבור מסמכי FODS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של FODS ל-DOTX וקוד Python להמרת קבצי FODS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה FODS.  המר קבצי FODS בודדים או מרובים ל-DOTX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי FODS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online FODS to DOTX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotx&from=fods" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של FODS ל-DOTX באמצעות אפליקציה" %}}

1. העלה קבצים FODS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל FODS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. FODS יומר למסמך DOTX
1. הורד את קובץ ה-DOTX שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את FODS ל-DOTX באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output DOTX file path. So your FODS file is converted to DOTX at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את FODS ל-DOTX באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת FODS ב-DOTX עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את FODS ל-DOTX דרישות האפליקציה" %}}
