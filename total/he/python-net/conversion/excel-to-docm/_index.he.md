---
title: המרה מקוונת של Excel ל-DOCM או בניית אפליקציה מבוססת Python להמרת קבצי Excel
description: אפליקציה מקוונת בחינם להמרת קבצי Excel ל-DOCM. קוד ספריית ההמרות של Python עבור מסמכי Excel.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של Excel ל-DOCM וקוד Python להמרת קבצי Excel" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה Excel.  המר קבצי Excel בודדים או מרובים ל-DOCM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי Excel באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online Excel to DOCM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docm&from=xls" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של Excel ל-DOCM באמצעות אפליקציה" %}}

1. העלה קבצים Excel להמרה
1. המתן מספר שניות או יותר בהתאם לגודל Excel
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. Excel יומר למסמך DOCM
1. הורד את קובץ ה-DOCM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את Excel ל-DOCM באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output DOCM file path. So your EXCEL file is converted to DOCM at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את Excel ל-DOCM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת Excel ב-DOCM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את Excel ל-DOCM דרישות האפליקציה" %}}
