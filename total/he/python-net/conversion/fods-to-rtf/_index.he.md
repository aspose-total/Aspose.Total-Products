---
title: המרה מקוונת של FODS ל-RTF או בניית אפליקציה מבוססת Python להמרת קבצי FODS
description: אפליקציה מקוונת בחינם להמרת קבצי FODS ל-RTF. קוד ספריית ההמרות של Python עבור מסמכי FODS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של FODS ל-RTF וקוד Python להמרת קבצי FODS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה FODS.  המר קבצי FODS בודדים או מרובים ל-RTF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי FODS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת FODS ל-RTF מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=fods" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של FODS ל-RTF באמצעות אפליקציה" %}}

1. העלה קבצים FODS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל FODS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. FODS יומר למסמך RTF
1. הורד את קובץ ה-RTF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את FODS ל-RTF באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ RTF פלט. אז קובץ ה-FODS שלך מומר ל-RTF בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את FODS ל-RTF באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת FODS ב-RTF עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את FODS ל-RTF דרישות האפליקציה" %}}
