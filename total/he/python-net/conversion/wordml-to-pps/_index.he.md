---
title: המרה מקוונת של WORDML ל-PPS או בניית אפליקציה מבוססת Python להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-PPS. קוד ספריית ההמרות של Python עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-PPS וקוד Python להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה WORDML.  המר קבצי WORDML בודדים או מרובים ל-PPS ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online WORDML to PPS Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pps&from=wordml" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של WORDML ל-PPS באמצעות אפליקציה" %}}

1. העלה קבצים WORDML להמרה
1. המתן מספר שניות או יותר בהתאם לגודל WORDML
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. WORDML יומר למסמך PPS
1. הורד את קובץ ה-PPS שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-PPS באמצעות Python Automation API" %}}
...
-  **Step 2** Load PDF file with an instance of [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/) class
	-  Call the `save` method while specifying output file path & SaveFormat.PPS as parameters. So your WORDML file is converted to PPS at the specified path.
...
{{% blocks/products/pf/agp/code-block title="המר את WORDML ל-PPS באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת WORDML ב-PPS עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את WORDML ל-PPS דרישות האפליקציה" %}}
