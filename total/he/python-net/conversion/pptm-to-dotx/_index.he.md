...
<iframe title="אפליקציית המרת PPTM ל-DOTX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotx&from=pptm" id="child-iframe" width="80%"></iframe>
...
-  **Step 1** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PDF כפרמטרים. אז קובץ ה-PPTM שלך מומר ל-PDF בנתיב שצוין.
