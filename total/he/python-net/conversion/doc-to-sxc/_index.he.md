...
<iframe title="אפליקציית המרת DOC ל-SXC מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=sxc&from=doc" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ SXC פלט. אז קובץ ה-DOC שלך מומר ל-SXC בנתיב שצוין
