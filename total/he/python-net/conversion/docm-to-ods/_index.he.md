...
<iframe title="אפליקציית המרת DOCM ל-ODS מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ods&from=docm" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ ODS פלט. אז קובץ ה-DOCM שלך מומר ל-ODS בנתיב שצוין
