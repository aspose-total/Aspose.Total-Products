---
title: המרה מקוונת של PST ל-TEXT או בניית אפליקציה מבוססת Python להמרת קבצי PST
description: אפליקציה מקוונת בחינם להמרת קבצי PST ל-TEXT. קוד ספריית ההמרות של Python עבור מסמכי PST.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PST ל-TEXT וקוד Python להמרת קבצי PST" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה PST.  המר קבצי PST בודדים או מרובים ל-TEXT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי PST באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PST ל-TEXT באמצעות אפליקציה" %}}

1. העלה קבצים PST להמרה
1. המתן מספר שניות או יותר בהתאם לגודל PST
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. PST יומר למסמך TEXT
1. הורד את קובץ ה-TEXT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PST ל-TEXT באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PST ל-TEXT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PST ב-TEXT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PST ל-TEXT דרישות האפליקציה" %}}
