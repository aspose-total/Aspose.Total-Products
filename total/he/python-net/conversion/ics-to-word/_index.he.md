---
title: המרה מקוונת של ICS ל-Word או בניית אפליקציה מבוססת Python להמרת קבצי ICS
description: אפליקציה מקוונת בחינם להמרת קבצי ICS ל-Word. קוד ספריית ההמרות של Python עבור מסמכי ICS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ICS ל-Word וקוד Python להמרת קבצי ICS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה ICS.  המר קבצי ICS בודדים או מרובים ל-Word ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי ICS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של ICS ל-Word באמצעות אפליקציה" %}}

1. העלה קבצים ICS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל ICS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. ICS יומר למסמך Word
1. הורד את קובץ ה-Word שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את ICS ל-Word באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את ICS ל-Word באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ICS ב-Word עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את ICS ל-Word דרישות האפליקציה" %}}
