---
title: המרה מקוונת של ICS ל-ODT או בניית אפליקציה מבוססת Python להמרת קבצי ICS
description: אפליקציה מקוונת בחינם להמרת קבצי ICS ל-ODT. קוד ספריית ההמרות של Python עבור מסמכי ICS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ICS ל-ODT וקוד Python להמרת קבצי ICS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה ICS.  המר קבצי ICS בודדים או מרובים ל-ODT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי ICS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת ICS ל-ODT מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odt&from=ics" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של ICS ל-ODT באמצעות אפליקציה" %}}

1. העלה קבצים ICS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל ICS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. ICS יומר למסמך ODT
1. הורד את קובץ ה-ODT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את ICS ל-ODT באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את ICS ל-ODT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ICS ב-ODT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את ICS ל-ODT דרישות האפליקציה" %}}
