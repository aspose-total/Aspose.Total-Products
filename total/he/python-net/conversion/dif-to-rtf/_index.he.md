---
title: המרה מקוונת של DIF ל-RTF או בניית אפליקציה מבוססת Python להמרת קבצי DIF
description: אפליקציה מקוונת בחינם להמרת קבצי DIF ל-RTF. קוד ספריית ההמרות של Python עבור מסמכי DIF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DIF ל-RTF וקוד Python להמרת קבצי DIF" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DIF.  המר קבצי DIF בודדים או מרובים ל-RTF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DIF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DIF to RTF Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=dif" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DIF ל-RTF באמצעות אפליקציה" %}}

1. העלה קבצים DIF להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DIF
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DIF יומר למסמך RTF
1. הורד את קובץ ה-RTF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DIF ל-RTF באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output RTF file path. So your DIF file is converted to RTF at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את DIF ל-RTF באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DIF ב-RTF עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DIF ל-RTF דרישות האפליקציה" %}}
