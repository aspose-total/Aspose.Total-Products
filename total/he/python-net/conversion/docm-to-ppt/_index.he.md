---
title: המרה מקוונת של DOCM ל-PPT או בניית אפליקציה מבוססת Python להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-PPT. קוד ספריית ההמרות של Python עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-PPT וקוד Python להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCM.  המר קבצי DOCM בודדים או מרובים ל-PPT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOCM ל-PPT מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppt&from=docm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-PPT באמצעות Python Automation API" %}}
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PPT כפרמטרים. אז קובץ ה-DOCM שלך מומר ל-PPT בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-PPT באמצעות Python" offSpacer="" %}}
