---
title: המרה מקוונת של RTF ל-TSV או בניית אפליקציה מבוססת Python להמרת קבצי RTF
description: אפליקציה מקוונת בחינם להמרת קבצי RTF ל-TSV. קוד ספריית ההמרות של Python עבור מסמכי RTF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של RTF ל-TSV וקוד Python להמרת קבצי RTF" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה RTF.  המר קבצי RTF בודדים או מרובים ל-TSV ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי RTF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את RTF ל-TSV באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output TSV file path. So your RTF file is converted to TSV at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את RTF ל-TSV באמצעות Python" offSpacer="" %}}
