---
title: המרה מקוונת של DOTM ל-POT או בניית אפליקציה מבוססת Python להמרת קבצי DOTM
description: אפליקציה מקוונת בחינם להמרת קבצי DOTM ל-POT. קוד ספריית ההמרות של Python עבור מסמכי DOTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTM ל-POT וקוד Python להמרת קבצי DOTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOTM.  המר קבצי DOTM בודדים או מרובים ל-POT ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOTM ל-POT מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pot&from=dotm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOTM ל-POT באמצעות אפליקציה" %}}

1. העלה קבצים DOTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOTM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOTM יומר למסמך POT
...
{{% blocks/products/pf/agp/code-block title="המר את DOTM ל-POT באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTM ב-POT עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOTM ל-POT דרישות האפליקציה" %}}
