---
title: המרה מקוונת של PPSM ל-Excel או בניית אפליקציה מבוססת Python להמרת קבצי PPSM
description: אפליקציה מקוונת בחינם להמרת קבצי PPSM ל-Excel. קוד ספריית ההמרות של Python עבור מסמכי PPSM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPSM ל-Excel וקוד Python להמרת קבצי PPSM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה PPSM.  המר קבצי PPSM בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי PPSM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPSM ל-Excel באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PPSM ל-Excel באמצעות Python" offSpacer="" %}}
