---
title: המרה מקוונת של DOCM ל-EML או בניית אפליקציה מבוססת Python להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-EML. קוד ספריית ההמרות של Python עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-EML וקוד Python להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCM.  המר קבצי DOCM בודדים או מרובים ל-EML ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOCM to EML Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=eml&from=docm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOCM ל-EML באמצעות אפליקציה" %}}

1. העלה קבצים DOCM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOCM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOCM יומר למסמך EML
1. הורד את קובץ ה-EML שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-EML באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-EML באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCM ב-EML עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOCM ל-EML דרישות האפליקציה" %}}
