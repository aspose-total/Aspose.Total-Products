---
title: המרה מקוונת של ODP ל-DOTM או בניית אפליקציה מבוססת Python להמרת קבצי ODP
description: אפליקציה מקוונת בחינם להמרת קבצי ODP ל-DOTM. קוד ספריית ההמרות של Python עבור מסמכי ODP.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODP ל-DOTM וקוד Python להמרת קבצי ODP" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה ODP.  המר קבצי ODP בודדים או מרובים ל-DOTM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי ODP באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online ODP to DOTM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotm&from=odp" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של ODP ל-DOTM באמצעות אפליקציה" %}}

1. העלה קבצים ODP להמרה
1. המתן מספר שניות או יותר בהתאם לגודל ODP
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. ODP יומר למסמך DOTM
1. הורד את קובץ ה-DOTM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את ODP ל-DOTM באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את ODP ל-DOTM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ODP ב-DOTM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את ODP ל-DOTM דרישות האפליקציה" %}}
