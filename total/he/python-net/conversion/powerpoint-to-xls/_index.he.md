...
<iframe title="Free Online PowerPoint to XLS Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xls&from=ppt" id="child-iframe" width="80%"></iframe>
...
-  Call the `save` method while specifying output XLS file path. So your POWERPOINT file is converted to XLS at the specified path
