---
title: המרה מקוונת של OTT ל-Excel או בניית אפליקציה מבוססת Python להמרת קבצי OTT
description: אפליקציה מקוונת בחינם להמרת קבצי OTT ל-Excel. קוד ספריית ההמרות של Python עבור מסמכי OTT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של OTT ל-Excel וקוד Python להמרת קבצי OTT" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה OTT.  המר קבצי OTT בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי OTT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את OTT ל-Excel באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ EXCEL פלט. אז קובץ ה-OTT שלך מומר ל-EXCEL בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את OTT ל-Excel באמצעות Python" offSpacer="" %}}
