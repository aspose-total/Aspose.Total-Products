---
title: המרה מקוונת של Excel ל-RTF או בניית אפליקציה מבוססת Python להמרת קבצי Excel
description: אפליקציה מקוונת בחינם להמרת קבצי Excel ל-RTF. קוד ספריית ההמרות של Python עבור מסמכי Excel.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של Excel ל-RTF וקוד Python להמרת קבצי Excel" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה Excel.  המר קבצי Excel בודדים או מרובים ל-RTF ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי Excel באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של Excel ל-RTF באמצעות אפליקציה" %}}

1. העלה קבצים Excel להמרה
1. המתן מספר שניות או יותר בהתאם לגודל Excel
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. Excel יומר למסמך RTF
1. הורד את קובץ ה-RTF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את Excel ל-RTF באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ RTF פלט. אז קובץ ה-EXCEL שלך מומר ל-RTF בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את Excel ל-RTF באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת Excel ב-RTF עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את Excel ל-RTF דרישות האפליקציה" %}}
