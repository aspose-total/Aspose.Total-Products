...
<iframe title="אפליקציית המרת PPSM ל-CSV מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=csv&from=ppsm" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ CSV פלט. אז קובץ ה-PPSM שלך מומר ל-CSV בנתיב שצוין
