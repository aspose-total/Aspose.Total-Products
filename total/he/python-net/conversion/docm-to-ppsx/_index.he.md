---
title: המרה מקוונת של DOCM ל-PPSX או בניית אפליקציה מבוססת Python להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-PPSX. קוד ספריית ההמרות של Python עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-PPSX וקוד Python להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCM.  המר קבצי DOCM בודדים או מרובים ל-PPSX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOCM ל-PPSX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppsx&from=docm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-PPSX באמצעות Python Automation API" %}}
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PPSX כפרמטרים. אז קובץ ה-DOCM שלך מומר ל-PPSX בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-PPSX באמצעות Python" offSpacer="" %}}
