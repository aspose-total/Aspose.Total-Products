...
<iframe title="אפליקציית המרת RTF ל-ODS מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ods&from=rtf" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ ODS פלט. אז קובץ ה-RTF שלך מומר ל-ODS בנתיב שצוין
