---
title: המרה מקוונת של XLTM ל-PPSX או בניית אפליקציה מבוססת Python להמרת קבצי XLTM
description: אפליקציה מקוונת בחינם להמרת קבצי XLTM ל-PPSX. קוד ספריית ההמרות של Python עבור מסמכי XLTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLTM ל-PPSX וקוד Python להמרת קבצי XLTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLTM.  המר קבצי XLTM בודדים או מרובים ל-PPSX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת XLTM ל-PPSX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ppsx&from=xltm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLTM ל-PPSX באמצעות אפליקציה" %}}

1. העלה קבצים XLTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLTM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLTM יומר למסמך PPSX
1. הורד את קובץ ה-PPSX שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLTM ל-PPSX באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את XLTM ל-PPSX באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLTM ב-PPSX עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLTM ל-PPSX דרישות האפליקציה" %}}
