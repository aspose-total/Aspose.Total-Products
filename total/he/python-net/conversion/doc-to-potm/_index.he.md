---
title: המרה מקוונת של DOC ל-POTM או בניית אפליקציה מבוססת Python להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-POTM. קוד ספריית ההמרות של Python עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-POTM וקוד Python להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOC.  המר קבצי DOC בודדים או מרובים ל-POTM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOC to POTM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=potm&from=doc" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOC ל-POTM באמצעות אפליקציה" %}}

1. העלה קבצים DOC להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOC
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOC יומר למסמך POTM
1. הורד את קובץ ה-POTM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-POTM באמצעות Python Automation API" %}}
...
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.POTM כפרמטרים. אז קובץ ה-DOC שלך מומר ל-POTM בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOC ל-POTM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOC ב-POTM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOC ל-POTM דרישות האפליקציה" %}}
