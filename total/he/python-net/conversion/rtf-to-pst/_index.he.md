---
title: המרה מקוונת של RTF ל-PST או בניית אפליקציה מבוססת Python להמרת קבצי RTF
description: אפליקציה מקוונת בחינם להמרת קבצי RTF ל-PST. קוד ספריית ההמרות של Python עבור מסמכי RTF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של RTF ל-PST וקוד Python להמרת קבצי RTF" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה RTF.  המר קבצי RTF בודדים או מרובים ל-PST ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי RTF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת RTF ל-PST מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pst&from=rtf" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של RTF ל-PST באמצעות אפליקציה" %}}

1. העלה קבצים RTF להמרה
1. המתן מספר שניות או יותר בהתאם לגודל RTF
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. RTF יומר למסמך PST
1. הורד את קובץ ה-PST שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את RTF ל-PST באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את RTF ל-PST באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת RTF ב-PST עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את RTF ל-PST דרישות האפליקציה" %}}
