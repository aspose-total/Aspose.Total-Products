---
title: המרה מקוונת של PowerPoint ל-DOCX או בניית אפליקציה מבוססת Python להמרת קבצי PowerPoint
description: אפליקציה מקוונת בחינם להמרת קבצי PowerPoint ל-DOCX. קוד ספריית ההמרות של Python עבור מסמכי PowerPoint.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PowerPoint ל-DOCX וקוד Python להמרת קבצי PowerPoint" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה PowerPoint.  המר קבצי PowerPoint בודדים או מרובים ל-DOCX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי PowerPoint באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online PowerPoint to DOCX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docx&from=ppt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PowerPoint ל-DOCX באמצעות אפליקציה" %}}

1. העלה קבצים PowerPoint להמרה
1. המתן מספר שניות או יותר בהתאם לגודל PowerPoint
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. PowerPoint יומר למסמך DOCX
1. הורד את קובץ ה-DOCX שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PowerPoint ל-DOCX באמצעות Python Automation API" %}}
...
-  **Step 1** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PDF כפרמטרים. אז קובץ ה-POWERPOINT שלך מומר ל-PDF בנתיב שצוין.
- **Step 2** פתח את קובץ ה-PDF באמצעות מחלקת [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
	- שמור קובץ PDF לקובץ DOCX באמצעות שיטת [Save](https://reference.aspose.com/words/python-net/aspose.words/document/save/) על ידי מתן שם הקובץ ונתיב הספרייה הרצוי.
...
{{% blocks/products/pf/agp/code-block title="המר את PowerPoint ל-DOCX באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PowerPoint ב-DOCX עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PowerPoint ל-DOCX דרישות האפליקציה" %}}
