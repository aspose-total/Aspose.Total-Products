...
<iframe title="אפליקציית המרת RTF ל-XLTX מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xltx&from=rtf" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ XLTX פלט. אז קובץ ה-RTF שלך מומר ל-XLTX בנתיב שצוין
