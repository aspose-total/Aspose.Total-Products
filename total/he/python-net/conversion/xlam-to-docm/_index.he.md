...
<iframe title="Free Online XLAM to DOCM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docm&from=xlam" id="child-iframe" width="80%"></iframe>
...
-  Call the `save` method while specifying output DOCM file path. So your XLAM file is converted to DOCM at the specified path
