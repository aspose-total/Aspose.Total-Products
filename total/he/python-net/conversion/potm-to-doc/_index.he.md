---
title: המרה מקוונת של POTM ל-DOC או בניית אפליקציה מבוססת Python להמרת קבצי POTM
description: אפליקציה מקוונת בחינם להמרת קבצי POTM ל-DOC. קוד ספריית ההמרות של Python עבור מסמכי POTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTM ל-DOC וקוד Python להמרת קבצי POTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה POTM.  המר קבצי POTM בודדים או מרובים ל-DOC ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי POTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת POTM ל-DOC מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=doc&from=potm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של POTM ל-DOC באמצעות אפליקציה" %}}

1. העלה קבצים POTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל POTM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. POTM יומר למסמך DOC
1. הורד את קובץ ה-DOC שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את POTM ל-DOC באמצעות Python Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את POTM ל-DOC באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POTM ב-DOC עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את POTM ל-DOC דרישות האפליקציה" %}}
