---
title: המרה מקוונת של MOBI ל-SXC או בניית אפליקציה מבוססת Python להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-SXC. קוד ספריית ההמרות של Python עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-SXC וקוד Python להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה MOBI.  המר קבצי MOBI בודדים או מרובים ל-SXC ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online MOBI to SXC Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=sxc&from=mobi" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של MOBI ל-SXC באמצעות אפליקציה" %}}

1. העלה קבצים MOBI להמרה
1. המתן מספר שניות או יותר בהתאם לגודל MOBI
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. MOBI יומר למסמך SXC
1. הורד את קובץ ה-SXC שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-SXC באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output SXC file path. So your MOBI file is converted to SXC at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את MOBI ל-SXC באמצעות Python" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MOBI ל-SXC דרישות האפליקציה" %}}
