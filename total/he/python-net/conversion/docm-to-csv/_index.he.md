---
title: המרה מקוונת של DOCM ל-CSV או בניית אפליקציה מבוססת Python להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-CSV. קוד ספריית ההמרות של Python עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-CSV וקוד Python להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCM.  המר קבצי DOCM בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOCM to CSV Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=csv&from=docm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-CSV באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output CSV file path. So your DOCM file is converted to CSV at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-CSV באמצעות Python" offSpacer="" %}}
