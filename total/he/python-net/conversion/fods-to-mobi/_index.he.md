...
<iframe title="Free Online FODS to MOBI Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=mobi&from=fods" id="child-iframe" width="80%"></iframe>
...
-  Call the `save` method while specifying output MOBI file path. So your FODS file is converted to MOBI at the specified path
