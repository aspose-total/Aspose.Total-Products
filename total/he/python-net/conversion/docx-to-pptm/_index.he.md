---
title: המרה מקוונת של DOCX ל-PPTM או בניית אפליקציה מבוססת Python להמרת קבצי DOCX
description: אפליקציה מקוונת בחינם להמרת קבצי DOCX ל-PPTM. קוד ספריית ההמרות של Python עבור מסמכי DOCX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCX ל-PPTM וקוד Python להמרת קבצי DOCX" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCX.  המר קבצי DOCX בודדים או מרובים ל-PPTM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online DOCX to PPTM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pptm&from=docx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOCX ל-PPTM באמצעות אפליקציה" %}}

1. העלה קבצים DOCX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOCX
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOCX יומר למסמך PPTM
1. הורד את קובץ ה-PPTM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOCX ל-PPTM באמצעות Python Automation API" %}}


- **Step 1** פתח את קובץ ה-DOCX המקור באמצעות מחלקת [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
	- שמור קובץ DOCX ל-PDF באמצעות שיטת [Save](https://reference.aspose.com/words/python-net/aspose.words/document/save/) על ידי מתן שם הקובץ ונתיב הספרייה הרצוי.
-  **Step 2** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PPTM כפרמטרים. אז קובץ ה-DOCX שלך מומר ל-PPTM בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את DOCX ל-PPTM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCX ב-PPTM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOCX ל-PPTM דרישות האפליקציה" %}}
