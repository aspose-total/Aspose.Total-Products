---
title: המרה מקוונת של POTM ל-DOCM או בניית אפליקציה מבוססת Python להמרת קבצי POTM
description: אפליקציה מקוונת בחינם להמרת קבצי POTM ל-DOCM. קוד ספריית ההמרות של Python עבור מסמכי POTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTM ל-DOCM וקוד Python להמרת קבצי POTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה POTM.  המר קבצי POTM בודדים או מרובים ל-DOCM ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי POTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online POTM to DOCM Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=docm&from=potm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של POTM ל-DOCM באמצעות אפליקציה" %}}

1. העלה קבצים POTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל POTM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. POTM יומר למסמך DOCM
1. הורד את קובץ ה-DOCM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את POTM ל-DOCM באמצעות Python Automation API" %}}
...
-  **Step 1** טען קובץ PDF עם מופע של מחלקת [Presentation](https://reference.aspose.com/slides/python-net/aspose.slides/presentation/)
	-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ הפלט & SaveFormat.PDF כפרמטרים. אז קובץ ה-POTM שלך מומר ל-PDF בנתיב שצוין.
...
{{% blocks/products/pf/agp/code-block title="המר את POTM ל-DOCM באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POTM ב-DOCM עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את POTM ל-DOCM דרישות האפליקציה" %}}
