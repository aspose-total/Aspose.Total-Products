...
<iframe title="אפליקציית המרת XLS ל-DOTM מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotm&from=xls" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ DOTM פלט. אז קובץ ה-XLS שלך מומר ל-DOTM בנתיב שצוין
