---
title: המרה מקוונת של XLS ל-DOTX או בניית אפליקציה מבוססת Python להמרת קבצי XLS
description: אפליקציה מקוונת בחינם להמרת קבצי XLS ל-DOTX. קוד ספריית ההמרות של Python עבור מסמכי XLS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XLS ל-DOTX וקוד Python להמרת קבצי XLS" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה XLS.  המר קבצי XLS בודדים או מרובים ל-DOTX ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי XLS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online XLS to DOTX Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotx&from=xls" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XLS ל-DOTX באמצעות אפליקציה" %}}

1. העלה קבצים XLS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XLS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XLS יומר למסמך DOTX
1. הורד את קובץ ה-DOTX שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XLS ל-DOTX באמצעות Python Automation API" %}}


- **Step 1** פתח את קובץ ה-XLS המקור באמצעות מחלקה Workbook
- שמור קובץ XLS ב-HTML על ידי שימוש בשיטת שמירה (קובץ, SaveFormat.HTML) על ידי מתן שם הקובץ ונתיב הספרייה הרצוי
-  **Step 2** טען קובץ HTML עם מופע של מחלקת [Document](https://reference.aspose.com/words/python-net/aspose.words/document/)
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ DOTX פלט. אז קובץ ה-XLS שלך מומר ל-DOTX בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את XLS ל-DOTX באמצעות Python" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XLS ב-DOTX עם תכונות אחרות כמו .
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XLS ל-DOTX דרישות האפליקציה" %}}
