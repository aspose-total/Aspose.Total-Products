---
title: המרה מקוונת של DOCM ל-FODS או בניית אפליקציה מבוססת Python להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-FODS. קוד ספריית ההמרות של Python עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-FODS וקוד Python להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה DOCM.  המר קבצי DOCM בודדים או מרובים ל-FODS ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרת DOCM ל-FODS מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=fods&from=docm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-FODS באמצעות Python Automation API" %}}
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ FODS פלט. אז קובץ ה-DOCM שלך מומר ל-FODS בנתיב שצוין
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-FODS באמצעות Python" offSpacer="" %}}
