---
title: המרה מקוונת של MOBI ל-CSV או בניית אפליקציה מבוססת Python להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-CSV. קוד ספריית ההמרות של Python עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-CSV וקוד Python להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא המבוססת על Python רבת עוצמה MOBI.  המר קבצי MOBI בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות Python Automation API.  המרה חופשית של קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="Free Online MOBI to CSV Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=csv&from=mobi" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-CSV באמצעות Python Automation API" %}}
...
-  Call the `save` method while specifying output CSV file path. So your MOBI file is converted to CSV at the specified path
...
{{% blocks/products/pf/agp/code-block title="המר את MOBI ל-CSV באמצעות Python" offSpacer="" %}}
