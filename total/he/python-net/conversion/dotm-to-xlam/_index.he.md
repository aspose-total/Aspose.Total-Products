...
<iframe title="אפליקציית המרת DOTM ל-XLAM מקוונת בחינם" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xlam&from=dotm" id="child-iframe" width="80%"></iframe>
...
-  קרא לשיטת 'שמור' תוך ציון נתיב קובץ XLAM פלט. אז קובץ ה-DOTM שלך מומר ל-XLAM בנתיב שצוין
