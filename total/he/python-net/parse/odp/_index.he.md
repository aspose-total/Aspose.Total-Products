---
title: חלץ טקסט ותמונות מקובץ ODP באינטרנט ובאמצעות Python
description: אפליקציית מנתח קבצי ODP מקוונת. קוד Python API לחילוץ תמונות וטקסט ממסמך ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="נתח קובץ ODP באינטרנט וכן חלץ טקסט או תמונות באמצעות Python" h2="פתח יישום כלי עזר לנתח מסמכים ODP רב עוצמה מבוסס Python. קוד רשום עבור תמונות ODP וחילוץ טקסט דרך Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="נתח מסמך ODP באמצעות אפליקציה מקוונת" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="חלץ טקסט מקובץ ODP באמצעות Python" %}}

1. התייחסות לממשקי API בתוך הפרויקט ישירות מ- PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/)) 
1. עבור כל סוגי הטקסט במצגת, השתמש ב-JPG1
1. טען מצגת באובייקט מחלקה של Presentation
1. עברו בלולאה בין כל השקופיות במצגת
1. חלץ טקסט מכל שקופית באמצעות מערך slides_text
...
{{% blocks/products/pf/agp/code-block title="דוגמה לקוד ב-Python לחילוץ טקסט ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="חלץ תמונות מ-ODP באמצעות Python" %}}

1. התייחסות לממשקי API בתוך הפרויקט ישירות מ- PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/)) 
1. גישה למצגת באמצעות מצגת
1. חזור על כל שקופית
1. קבלו את התמונה האחורית
1. הגדר את הפורמט הרצוי אם התמונה האחורית זמינה
1. עברו בלולאה בכל צורות השקופיות ושמור 
...
{{% blocks/products/pf/agp/code-block title="דוגמה לקוד ב-Python לחילוץ תמונות ODP" offSpacer="" %}}
...
<h2>Develop ODP File Parser Application via Python</h2>

צריך לפתח אפליקציית מנתח ODP או כלי שירות? עם Aspose.Slides for Python via .NET, ילד API של Aspose.Total for Python via .NET, כל מפתח פיתון יכול לשלב את קוד ה-API שלעיל בתוך אפליקציית מנתח המסמכים שלו. ספריית Python רבת עוצמה מאפשרת לתכנת כל פתרון לניתוח מסמכים כדי לחלץ תמונות כמו גם טקסט. יתר על כן, זה יכול לתמוך בפורמטים פופולריים רבים כולל פורמט ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="כלי Python לעיבוד קובץ ODP עבור אפליקציית מנתח" %}}
