---
title: זיהוי תמונות ברקוד POSTNET באמצעות Python
description: סרוק תמונות ברקוד POSTNET symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד POSTNET, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד POSTNET Symbology ב-Python" offSpacer="" %}}
