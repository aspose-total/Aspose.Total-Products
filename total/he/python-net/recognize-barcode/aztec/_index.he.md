---
title: זיהוי תמונות ברקוד AZTEC באמצעות Python
description: סרוק תמונות ברקוד AZTEC symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד AZTEC, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד AZTEC Symbology ב-Python" offSpacer="" %}}
