---
title: זיהוי תמונות ברקוד PLANET באמצעות Python
description: סרוק תמונות ברקוד PLANET symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד PLANET, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד PLANET Symbology ב-Python" offSpacer="" %}}
