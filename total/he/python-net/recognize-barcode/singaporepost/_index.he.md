---
title: זיהוי תמונות ברקוד SINGAPOREPOST באמצעות Python
description: סרוק תמונות ברקוד SINGAPOREPOST symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד SINGAPOREPOST, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד SINGAPOREPOST Symbology ב-Python" offSpacer="" %}}
