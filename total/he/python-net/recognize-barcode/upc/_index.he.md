---
title: זיהוי תמונות ברקוד UPC באמצעות Python
description: סרוק תמונות ברקוד UPC symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד UPC, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד UPC Symbology ב-Python" offSpacer="" %}}
