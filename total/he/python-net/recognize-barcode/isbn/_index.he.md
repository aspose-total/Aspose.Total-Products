---
title: זיהוי תמונות ברקוד ISBN באמצעות Python
description: סרוק תמונות ברקוד ISBN symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד ISBN, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד ISBN Symbology ב-Python" offSpacer="" %}}
