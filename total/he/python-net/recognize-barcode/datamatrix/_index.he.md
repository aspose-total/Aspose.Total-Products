---
title: זיהוי תמונות ברקוד DATAMATRIX באמצעות Python
description: סרוק תמונות ברקוד DATAMATRIX symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד DATAMATRIX, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד DATAMATRIX Symbology ב-Python" offSpacer="" %}}
