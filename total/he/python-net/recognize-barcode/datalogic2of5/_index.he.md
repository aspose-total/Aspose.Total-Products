---
title: זיהוי תמונות ברקוד DATALOGIC2OF5 באמצעות Python
description: סרוק תמונות ברקוד DATALOGIC2OF5 symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד DATALOGIC2OF5, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד DATALOGIC2OF5 Symbology ב-Python" offSpacer="" %}}
