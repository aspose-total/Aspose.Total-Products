---
title: זיהוי תמונות ברקוד EAN באמצעות Python
description: סרוק תמונות ברקוד EAN symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד EAN, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד EAN Symbology ב-Python" offSpacer="" %}}
