---
title: זיהוי תמונות ברקוד ISMN באמצעות Python
description: סרוק תמונות ברקוד ISMN symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד ISMN, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד ISMN Symbology ב-Python" offSpacer="" %}}
