---
title: זיהוי תמונות ברקוד ONECODE באמצעות Python
description: סרוק תמונות ברקוד ONECODE symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד ONECODE, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד ONECODE Symbology ב-Python" offSpacer="" %}}
