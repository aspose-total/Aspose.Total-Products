---
title: זיהוי תמונות ברקוד DOTCODE באמצעות Python
description: סרוק תמונות ברקוד DOTCODE symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד DOTCODE, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד DOTCODE Symbology ב-Python" offSpacer="" %}}
