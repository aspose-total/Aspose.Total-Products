---
title: זיהוי תמונות ברקוד SWISSPOSTPARCEL באמצעות Python
description: סרוק תמונות ברקוד SWISSPOSTPARCEL symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד SWISSPOSTPARCEL, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד SWISSPOSTPARCEL Symbology ב-Python" offSpacer="" %}}
