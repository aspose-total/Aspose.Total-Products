---
title: זיהוי תמונות ברקוד AUSTRALIAPOST באמצעות Python
description: סרוק תמונות ברקוד AUSTRALIAPOST symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד AUSTRALIAPOST, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד AUSTRALIAPOST Symbology ב-Python" offSpacer="" %}}
