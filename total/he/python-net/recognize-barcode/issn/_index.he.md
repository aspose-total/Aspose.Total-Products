---
title: זיהוי תמונות ברקוד ISSN באמצעות Python
description: סרוק תמונות ברקוד ISSN symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד ISSN, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד ISSN Symbology ב-Python" offSpacer="" %}}
