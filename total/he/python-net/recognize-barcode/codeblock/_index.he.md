---
title: זיהוי תמונות ברקוד CODEBLOCK באמצעות Python
description: סרוק תמונות ברקוד CODEBLOCK symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד CODEBLOCK, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד CODEBLOCK Symbology ב-Python" offSpacer="" %}}
