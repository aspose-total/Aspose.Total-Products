---
title: זיהוי תמונות ברקוד DEUTSCHEPOST באמצעות Python
description: סרוק תמונות ברקוד DEUTSCHEPOST symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד DEUTSCHEPOST, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד DEUTSCHEPOST Symbology ב-Python" offSpacer="" %}}
