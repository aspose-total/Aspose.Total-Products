---
title: זיהוי תמונות ברקוד ITF באמצעות Python
description: סרוק תמונות ברקוד ITF symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד ITF, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד ITF Symbology ב-Python" offSpacer="" %}}
