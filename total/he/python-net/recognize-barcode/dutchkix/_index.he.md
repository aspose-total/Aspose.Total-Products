---
title: זיהוי תמונות ברקוד DUTCHKIX באמצעות Python
description: סרוק תמונות ברקוד DUTCHKIX symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- עבור סריקת ברקוד DUTCHKIX, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="זיהוי ברקוד DUTCHKIX Symbology ב-Python" offSpacer="" %}}
