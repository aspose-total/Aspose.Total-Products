---
title: צור תמונות ברקוד AZTEC באמצעות Python
description: צור תמונות ברקוד AZTEC symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד AZTEC, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור AZTEC Symbology BarCode ב-Python" offSpacer="" %}}
