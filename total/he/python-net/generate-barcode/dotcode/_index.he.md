---
title: צור תמונות ברקוד DOTCODE באמצעות Python
description: צור תמונות ברקוד DOTCODE symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד DOTCODE, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור DOTCODE Symbology BarCode ב-Python" offSpacer="" %}}
