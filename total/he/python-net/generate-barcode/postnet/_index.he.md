---
title: צור תמונות ברקוד POSTNET באמצעות Python
description: צור תמונות ברקוד POSTNET symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד POSTNET, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור POSTNET Symbology BarCode ב-Python" offSpacer="" %}}
