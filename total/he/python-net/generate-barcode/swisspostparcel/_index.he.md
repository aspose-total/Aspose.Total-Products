---
title: צור תמונות ברקוד SWISSPOSTPARCEL באמצעות Python
description: צור תמונות ברקוד SWISSPOSTPARCEL symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד SWISSPOSTPARCEL, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור SWISSPOSTPARCEL Symbology BarCode ב-Python" offSpacer="" %}}
