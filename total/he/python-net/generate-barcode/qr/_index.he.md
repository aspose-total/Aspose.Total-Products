---
title: צור תמונות ברקוד QR באמצעות Python
description: צור תמונות ברקוד QR symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד QR, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור QR Symbology BarCode ב-Python" offSpacer="" %}}
