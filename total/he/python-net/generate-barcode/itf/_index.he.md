---
title: צור תמונות ברקוד ITF באמצעות Python
description: צור תמונות ברקוד ITF symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד ITF, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור ITF Symbology BarCode ב-Python" offSpacer="" %}}
