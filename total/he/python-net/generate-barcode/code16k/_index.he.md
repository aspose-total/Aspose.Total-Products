---
title: צור תמונות ברקוד CODE16K באמצעות Python
description: צור תמונות ברקוד CODE16K symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד CODE16K, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור CODE16K Symbology BarCode ב-Python" offSpacer="" %}}
