---
title: צור תמונות ברקוד MATRIX2OF5 באמצעות Python
description: צור תמונות ברקוד MATRIX2OF5 symbology באמצעות יישומי Python ללא שימוש בתוכנה אחרת. 
...
- ליצירת ברקוד MATRIX2OF5, נדרשת Python 3.5 ואילך
...
{{% blocks/products/pf/agp/code-block title="צור MATRIX2OF5 Symbology BarCode ב-Python" offSpacer="" %}}
