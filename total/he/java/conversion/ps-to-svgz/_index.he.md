---
title: המר את PS ל-SVGZ באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-SVGZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-SVGZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-SVGZ ופורמטים אחרים באמצעות Java Automation API." >}}
