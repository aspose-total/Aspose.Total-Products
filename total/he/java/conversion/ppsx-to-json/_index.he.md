---
title: המרה מקוונת של PPSX ל-JSON או פיתוח אפליקציה מבוססת Java להמרת קבצי PPSX
description: אפליקציה מקוונת בחינם להמרת קבצי PPSX ל-JSON. קוד ספריית המרות Java עבור מסמכי PPSX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPSX ל-JSON וקוד Java להמרת קבצי PPSX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PPSX.  המר קבצי PPSX בודדים או מרובים ל-JSON ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PPSX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPSX ל-JSON באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PPSX ל-JSON" offSpacer="" %}}
