---
title: המר את CGM ל-XLTM באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XLTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XLTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XLTM ופורמטים אחרים באמצעות Java Automation API." >}}
