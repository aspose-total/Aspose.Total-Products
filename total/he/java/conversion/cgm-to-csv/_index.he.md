---
title: המר את CGM ל-CSV באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-CSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-CSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-CSV ופורמטים אחרים באמצעות Java Automation API." >}}
