---
title: המר את EPUB ל-CSV באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-CSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-CSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-CSV ופורמטים אחרים באמצעות Java Automation API." >}}
