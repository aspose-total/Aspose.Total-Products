---
title: המר את CGM ל-PPSX באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-PPSX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-PPSX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-PPSX ופורמטים אחרים באמצעות Java Automation API." >}}
...
2. המר CGM ל-PPTX באמצעות שיטת [save](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-int-)
