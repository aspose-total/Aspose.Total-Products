---
title: המר את EPUB ל-DIF באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-DIF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-DIF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-DIF ופורמטים אחרים באמצעות Java Automation API." >}}
