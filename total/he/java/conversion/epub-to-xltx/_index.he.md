---
title: המר את EPUB ל-XLTX באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XLTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XLTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XLTX ופורמטים אחרים באמצעות Java Automation API." >}}
