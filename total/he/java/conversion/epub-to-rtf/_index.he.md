---
title: המר את EPUB ל-RTF באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-RTF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-RTF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-RTF ופורמטים אחרים באמצעות Java Automation API." >}}
