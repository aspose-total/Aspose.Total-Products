---
title: המר את MD ל-DICOM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DICOM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DICOM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DICOM ופורמטים אחרים באמצעות Java Automation API." >}}
