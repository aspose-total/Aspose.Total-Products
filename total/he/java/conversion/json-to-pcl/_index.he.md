---
title: המרה מקוונת של JSON ל-PCL או פיתוח אפליקציה מבוססת Java להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-PCL. קוד ספריית המרות Java עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-PCL באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של JSON ל-PCL" offSpacer="" %}}
