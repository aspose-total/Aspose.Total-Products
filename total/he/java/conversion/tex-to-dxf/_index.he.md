---
title: המרה מקוונת של TEX ל-DXF או פיתוח אפליקציה מבוססת Java להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-DXF. קוד ספריית המרות Java עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-DXF וקוד Java להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה TEX.  המר קבצי TEX בודדים או מרובים ל-DXF ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-TEX ל-DXF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dxf&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-DXF באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של TEX ל-DXF" offSpacer="" %}}
