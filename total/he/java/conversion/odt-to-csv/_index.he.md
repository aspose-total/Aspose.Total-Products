---
title: המרה מקוונת של ODT ל-CSV או פיתוח אפליקציה מבוססת Java להמרת קבצי ODT
description: אפליקציה מקוונת בחינם להמרת קבצי ODT ל-CSV. קוד ספריית המרות Java עבור מסמכי ODT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODT ל-CSV וקוד Java להמרת קבצי ODT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה ODT.  המר קבצי ODT בודדים או מרובים ל-CSV ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי ODT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-ODT ל-CSV" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=csv&from=odt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של ODT ל-CSV באמצעות אפליקציה" %}}

1. העלה קבצים ODT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל ODT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. ODT יומר למסמך CSV
1. הורד את קובץ ה-CSV שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את ODT ל-CSV באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של ODT ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ODT ב-CSV עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את ODT ל-CSV דרישות האפליקציה" %}}
