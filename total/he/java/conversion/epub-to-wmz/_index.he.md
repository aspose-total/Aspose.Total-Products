---
title: המרה מקוונת של EPUB ל-WMZ או פיתוח אפליקציה מבוססת Java להמרת קבצי EPUB
description: אפליקציה מקוונת בחינם להמרת קבצי EPUB ל-WMZ. קוד ספריית המרות Java עבור מסמכי EPUB.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של EPUB ל-WMZ וקוד Java להמרת קבצי EPUB" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה EPUB.  המר קבצי EPUB בודדים או מרובים ל-WMZ ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי EPUB באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-EPUB ל-WMZ" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=wmz&from=epub" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את EPUB ל-WMZ באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של EPUB ל-WMZ" offSpacer="" %}}
