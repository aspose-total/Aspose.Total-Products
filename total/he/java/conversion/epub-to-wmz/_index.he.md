---
title: המר את EPUB ל-WMZ באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-WMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-WMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-WMZ ופורמטים אחרים באמצעות Java Automation API." >}}
