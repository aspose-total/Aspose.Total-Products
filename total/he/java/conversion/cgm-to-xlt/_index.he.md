---
title: המר את CGM ל-XLT באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XLT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XLT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XLT ופורמטים אחרים באמצעות Java Automation API." >}}
