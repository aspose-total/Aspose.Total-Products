---
title: המרה מקוונת של MHTML ל-CSV או פיתוח אפליקציה מבוססת Java להמרת קבצי MHTML
description: אפליקציה מקוונת בחינם להמרת קבצי MHTML ל-CSV. קוד ספריית המרות Java עבור מסמכי MHTML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MHTML ל-CSV וקוד Java להמרת קבצי MHTML" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה MHTML.  המר קבצי MHTML בודדים או מרובים ל-CSV ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי MHTML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MHTML ל-CSV באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של MHTML ל-CSV" offSpacer="" %}}
