---
title: המרה מקוונת של CGM ל-DOT או פיתוח אפליקציה מבוססת Java להמרת קבצי CGM
description: אפליקציה מקוונת בחינם להמרת קבצי CGM ל-DOT. קוד ספריית המרות Java עבור מסמכי CGM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של CGM ל-DOT וקוד Java להמרת קבצי CGM" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה CGM.  המר קבצי CGM בודדים או מרובים ל-DOT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי CGM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-CGM ל-DOT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dot&from=cgm" id="child-iframe" width="80%"></iframe>
