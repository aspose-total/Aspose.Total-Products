---
title: המר את PS ל-XLTX באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-XLTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-XLTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-XLTX ופורמטים אחרים באמצעות Java Automation API." >}}
