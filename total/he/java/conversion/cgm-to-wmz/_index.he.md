---
title: המר את CGM ל-WMZ באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-WMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-WMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-WMZ ופורמטים אחרים באמצעות Java Automation API." >}}
