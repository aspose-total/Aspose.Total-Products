---
title: המרה מקוונת של DOT ל-POT או פיתוח אפליקציה מבוססת Java להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-POT. קוד ספריית המרות Java עבור מסמכי DOT.  
...
informat: DOT
outformat: POT
otherformats: PPTX PPSM PPT ODP POWERPOINT PPSX POTX PPS PPTM POTM CSV DIF FODS ODS SXC TSV XLAM XLTM EXCEL XLS XLSB XLSM XLSX XLT XLTM XLTX
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOT ל-POT וקוד Java להמרת קבצי DOT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOT.  המר קבצי DOT בודדים או מרובים ל-POT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-DOT ל-POT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pot&from=dot" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOT ל-POT באמצעות אפליקציה" %}}

1. העלה קבצים DOT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOT
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOT יומר למסמך POT
1. הורד את קובץ ה-POT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-POT באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOT ל-POT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOT ב-POT עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOT ל-POT דרישות האפליקציה" %}}
