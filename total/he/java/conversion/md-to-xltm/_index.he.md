---
title: המר את MD ל-XLTM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XLTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XLTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XLTM ופורמטים אחרים באמצעות Java Automation API." >}}
