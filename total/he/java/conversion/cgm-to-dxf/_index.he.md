---
title: המר את CGM ל-DXF באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-DXF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-DXF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-DXF ופורמטים אחרים באמצעות Java Automation API." >}}
