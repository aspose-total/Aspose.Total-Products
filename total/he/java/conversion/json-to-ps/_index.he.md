---
title: המרה מקוונת של JSON ל-PS או פיתוח אפליקציה מבוססת Java להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-PS. קוד ספריית המרות Java עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-PS באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של JSON ל-PS" offSpacer="" %}}
