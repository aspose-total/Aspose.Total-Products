---
title: המר את CGM ל-SXC באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-SXC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-SXC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-SXC ופורמטים אחרים באמצעות Java Automation API." >}}
