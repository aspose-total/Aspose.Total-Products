---
title: המר את EPUB ל-PPSX באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-PPSX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-PPSX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-PPSX ופורמטים אחרים באמצעות Java Automation API." >}}
