---
title: המר את EPUB ל-WMF באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-WMF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-WMF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-WMF ופורמטים אחרים באמצעות Java Automation API." >}}
