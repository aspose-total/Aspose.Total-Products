---
title: המר את PS ל-CSV באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-CSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-CSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-CSV ופורמטים אחרים באמצעות Java Automation API." >}}
