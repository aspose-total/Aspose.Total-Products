---
title: המר את PS ל-ODP באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-ODP באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-ODP" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-ODP ופורמטים אחרים באמצעות Java Automation API." >}}
