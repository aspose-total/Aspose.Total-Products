---
title: המר את PS ל-DOTX באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-DOTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-DOTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-DOTX ופורמטים אחרים באמצעות Java Automation API." >}}
