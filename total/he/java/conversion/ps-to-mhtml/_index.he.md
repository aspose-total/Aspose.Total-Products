---
title: המר את PS ל-MHTML באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-MHTML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-MHTML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-MHTML ופורמטים אחרים באמצעות Java Automation API." >}}
