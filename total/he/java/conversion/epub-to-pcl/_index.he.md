---
title: המר את EPUB ל-PCL באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-PCL באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-PCL" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-PCL ופורמטים אחרים באמצעות Java Automation API." >}}
