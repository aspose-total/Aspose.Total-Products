---
title: המרה מקוונת של PPS ל-XLT או פיתוח אפליקציה מבוססת Java להמרת קבצי PPS
description: אפליקציה מקוונת בחינם להמרת קבצי PPS ל-XLT. קוד ספריית המרות Java עבור מסמכי PPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPS ל-XLT וקוד Java להמרת קבצי PPS" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PPS.  המר קבצי PPS בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPS ל-XLT באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PPS ל-XLT" offSpacer="" %}}
