---
title: המר את EPUB ל-DOT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-DOT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-DOT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-DOT ופורמטים אחרים באמצעות Java Automation API." >}}
