---
title: המר את EPUB ל-TXT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-TXT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-TXT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-TXT ופורמטים אחרים באמצעות Java Automation API." >}}
