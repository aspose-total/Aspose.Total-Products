---
title: המר את EPUB ל-MHTML באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-MHTML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-MHTML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-MHTML ופורמטים אחרים באמצעות Java Automation API." >}}
