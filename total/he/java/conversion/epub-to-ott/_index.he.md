---
title: המר את EPUB ל-OTT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-OTT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-OTT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-OTT ופורמטים אחרים באמצעות Java Automation API." >}}
