---
title: המר את MD ל-XLSM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XLSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XLSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XLSM ופורמטים אחרים באמצעות Java Automation API." >}}
