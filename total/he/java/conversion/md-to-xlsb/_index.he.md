---
title: המרה מקוונת של MD ל-XLSB או פיתוח אפליקציה מבוססת Java להמרת קבצי MD
description: אפליקציה מקוונת בחינם להמרת קבצי MD ל-XLSB. קוד ספריית המרות Java עבור מסמכי MD.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MD ל-XLSB וקוד Java להמרת קבצי MD" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה MD.  המר קבצי MD בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי MD באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-MD ל-XLSB" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xlsb&from=md" id="child-iframe" width="80%"></iframe>
