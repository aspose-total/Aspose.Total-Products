---
title: המר את EPUB ל-TSV באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-TSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-TSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-TSV ופורמטים אחרים באמצעות Java Automation API." >}}
