---
title: המר את MD ל-EMZ באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-EMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-EMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-EMZ ופורמטים אחרים באמצעות Java Automation API." >}}
