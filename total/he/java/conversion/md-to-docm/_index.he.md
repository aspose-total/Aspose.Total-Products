---
title: המר את MD ל-DOCM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DOCM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DOCM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DOCM ופורמטים אחרים באמצעות Java Automation API." >}}
