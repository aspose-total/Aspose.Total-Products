---
title: המרה מקוונת של XSLFO ל-XLTX או פיתוח אפליקציה מבוססת Java להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-XLTX. קוד ספריית המרות Java עבור מסמכי XSLFO.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-XLTX באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XSLFO ל-XLTX" offSpacer="" %}}
