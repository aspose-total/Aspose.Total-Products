---
title: המר את MD ל-FLATOPC באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-FLATOPC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-FLATOPC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-FLATOPC ופורמטים אחרים באמצעות Java Automation API." >}}
