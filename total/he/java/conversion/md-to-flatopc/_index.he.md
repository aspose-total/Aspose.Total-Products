---
title: המרה מקוונת של MD ל-FLATOPC או פיתוח אפליקציה מבוססת Java להמרת קבצי MD
description: אפליקציה מקוונת בחינם להמרת קבצי MD ל-FLATOPC. קוד ספריית המרות Java עבור מסמכי MD.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MD ל-FLATOPC וקוד Java להמרת קבצי MD" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה MD.  המר קבצי MD בודדים או מרובים ל-FLATOPC ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי MD באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-MD ל-FLATOPC" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=flatopc&from=md" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של MD ל-FLATOPC באמצעות אפליקציה" %}}

1. העלה קבצים MD להמרה
1. המתן מספר שניות או יותר בהתאם לגודל MD
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. MD יומר למסמך FLATOPC
1. הורד את קובץ ה-FLATOPC שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-FLATOPC באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של MD ל-FLATOPC" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ב-FLATOPC עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MD ל-FLATOPC דרישות האפליקציה" %}}
