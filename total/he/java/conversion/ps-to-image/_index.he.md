---
title: המר את PS ל-IMAGE באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-IMAGE באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-IMAGE" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-IMAGE ופורמטים אחרים באמצעות Java Automation API." >}}
