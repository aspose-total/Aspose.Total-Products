---
title: המר את PS ל-WMZ באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-WMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-WMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-WMZ ופורמטים אחרים באמצעות Java Automation API." >}}
