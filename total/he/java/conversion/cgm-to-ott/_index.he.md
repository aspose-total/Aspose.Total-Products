---
title: המר את CGM ל-OTT באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-OTT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-OTT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-OTT ופורמטים אחרים באמצעות Java Automation API." >}}
