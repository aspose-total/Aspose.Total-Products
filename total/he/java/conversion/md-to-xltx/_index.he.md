---
title: המר את MD ל-XLTX באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XLTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XLTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XLTX ופורמטים אחרים באמצעות Java Automation API." >}}
