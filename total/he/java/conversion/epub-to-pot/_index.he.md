---
title: המר את EPUB ל-POT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-POT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-POT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-POT ופורמטים אחרים באמצעות Java Automation API." >}}
