---
title: המרה מקוונת של PPS ל-SXC או פיתוח אפליקציה מבוססת Java להמרת קבצי PPS
description: אפליקציה מקוונת בחינם להמרת קבצי PPS ל-SXC. קוד ספריית המרות Java עבור מסמכי PPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPS ל-SXC וקוד Java להמרת קבצי PPS" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PPS.  המר קבצי PPS בודדים או מרובים ל-SXC ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPS ל-SXC באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PPS ל-SXC" offSpacer="" %}}
