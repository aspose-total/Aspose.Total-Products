---
title: המר את PS ל-EMZ באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-EMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-EMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-EMZ ופורמטים אחרים באמצעות Java Automation API." >}}
