---
title: המר את MD ל-TSV באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-TSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-TSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-TSV ופורמטים אחרים באמצעות Java Automation API." >}}
