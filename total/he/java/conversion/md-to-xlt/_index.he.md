---
title: המר את MD ל-XLT באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XLT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XLT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XLT ופורמטים אחרים באמצעות Java Automation API." >}}
