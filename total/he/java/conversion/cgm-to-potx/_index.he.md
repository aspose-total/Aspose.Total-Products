---
title: המר את CGM ל-POTX באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-POTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-POTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-POTX ופורמטים אחרים באמצעות Java Automation API." >}}
