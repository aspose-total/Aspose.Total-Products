---
title: המר את MD ל-WMF באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-WMF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-WMF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-WMF ופורמטים אחרים באמצעות Java Automation API." >}}
