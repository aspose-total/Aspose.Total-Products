---
title: המר את MD ל-POTX באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-POTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-POTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-POTX ופורמטים אחרים באמצעות Java Automation API." >}}
