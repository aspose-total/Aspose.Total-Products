---
title: המר את EPUB ל-EMZ באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-EMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-EMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-EMZ ופורמטים אחרים באמצעות Java Automation API." >}}
...
2. אתחול אובייקט מחלקה ועיבוד EPUB ל-JPEG באמצעות שיטת [Process](https://reference.aspose.com/pdf/java/com.aspose.pdf.devices/JpegDevice#process-com.aspose.pdf.Page-java.io.OutputStream-)
