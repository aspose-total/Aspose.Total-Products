---
title: המר את PS ל-JPEG2000 באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-JPEG2000 באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-JPEG2000" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-JPEG2000 ופורמטים אחרים באמצעות Java Automation API." >}}
