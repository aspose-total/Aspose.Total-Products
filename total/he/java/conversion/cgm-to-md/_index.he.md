---
title: המר את CGM ל-MD באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-MD באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-MD" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-MD ופורמטים אחרים באמצעות Java Automation API." >}}
