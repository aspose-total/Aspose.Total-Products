---
title: המרה מקוונת של DOT ל-PPS או פיתוח אפליקציה מבוססת Java להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-PPS. קוד ספריית המרות Java עבור מסמכי DOT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOT ל-PPS וקוד Java להמרת קבצי DOT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOT.  המר קבצי DOT בודדים או מרובים ל-PPS ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-PPS באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOT ל-PPS" offSpacer="" %}}
