---
title: המר את PS ל-RTF באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-RTF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-RTF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-RTF ופורמטים אחרים באמצעות Java Automation API." >}}
