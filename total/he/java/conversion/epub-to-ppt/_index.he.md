---
title: המר את EPUB ל-PPT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-PPT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-PPT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-PPT ופורמטים אחרים באמצעות Java Automation API." >}}
