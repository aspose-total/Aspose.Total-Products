---
title: המר את PS ל-POT באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-POT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-POT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-POT ופורמטים אחרים באמצעות Java Automation API." >}}
