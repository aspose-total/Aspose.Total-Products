---
title: המרה מקוונת של XPS ל-XLSB או פיתוח אפליקציה מבוססת Java להמרת קבצי XPS
description: אפליקציה מקוונת בחינם להמרת קבצי XPS ל-XLSB. קוד ספריית המרות Java עבור מסמכי XPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XPS ל-XLSB וקוד Java להמרת קבצי XPS" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה XPS.  המר קבצי XPS בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי XPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XPS ל-XLSB באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XPS ל-XLSB" offSpacer="" %}}
