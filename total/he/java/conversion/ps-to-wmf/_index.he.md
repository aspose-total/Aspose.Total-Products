---
title: המר את PS ל-WMF באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-WMF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-WMF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-WMF ופורמטים אחרים באמצעות Java Automation API." >}}
