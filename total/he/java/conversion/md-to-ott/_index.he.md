---
title: המר את MD ל-OTT באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-OTT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-OTT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-OTT ופורמטים אחרים באמצעות Java Automation API." >}}
