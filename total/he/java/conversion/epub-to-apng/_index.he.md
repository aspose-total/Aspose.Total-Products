---
title: המר את EPUB ל-APNG באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-APNG באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-APNG" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-APNG ופורמטים אחרים באמצעות Java Automation API." >}}
