---
title: המר את PS ל-XLAM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-XLAM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-XLAM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-XLAM ופורמטים אחרים באמצעות Java Automation API." >}}
