---
title: המר את MD ל-DOTM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DOTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DOTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DOTM ופורמטים אחרים באמצעות Java Automation API." >}}
