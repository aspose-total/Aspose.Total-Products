---
title: המרה מקוונת של MD ל-DOTM או פיתוח אפליקציה מבוססת Java להמרת קבצי MD
description: אפליקציה מקוונת בחינם להמרת קבצי MD ל-DOTM. קוד ספריית המרות Java עבור מסמכי MD.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MD ל-DOTM וקוד Java להמרת קבצי MD" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה MD.  המר קבצי MD בודדים או מרובים ל-DOTM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי MD באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-MD ל-DOTM" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dotm&from=md" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-DOTM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של MD ל-DOTM" offSpacer="" %}}
