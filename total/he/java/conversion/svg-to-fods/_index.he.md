---
title: המרה מקוונת של SVG ל-FODS או פיתוח אפליקציה מבוססת Java להמרת קבצי SVG
description: אפליקציה מקוונת בחינם להמרת קבצי SVG ל-FODS. קוד ספריית המרות Java עבור מסמכי SVG.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של SVG ל-FODS וקוד Java להמרת קבצי SVG" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה SVG.  המר קבצי SVG בודדים או מרובים ל-FODS ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי SVG באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את SVG ל-FODS באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של SVG ל-FODS" offSpacer="" %}}
