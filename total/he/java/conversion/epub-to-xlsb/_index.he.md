---
title: המר את EPUB ל-XLSB באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XLSB באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XLSB" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XLSB ופורמטים אחרים באמצעות Java Automation API." >}}
