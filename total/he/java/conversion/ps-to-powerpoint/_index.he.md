---
title: המר את PS ל-Powerpoint באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-Powerpoint באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-Powerpoint" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-Powerpoint ופורמטים אחרים באמצעות Java Automation API." >}}
