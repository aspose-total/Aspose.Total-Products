---
title: המר את MD ל-RTF באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-RTF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-RTF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-RTF ופורמטים אחרים באמצעות Java Automation API." >}}
