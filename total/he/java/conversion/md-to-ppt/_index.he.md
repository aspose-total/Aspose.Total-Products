---
title: המר את MD ל-PPT באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PPT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PPT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PPT ופורמטים אחרים באמצעות Java Automation API." >}}
