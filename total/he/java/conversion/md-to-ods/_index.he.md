---
title: המר את MD ל-ODS באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-ODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-ODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-ODS ופורמטים אחרים באמצעות Java Automation API." >}}
