---
title: המר את EPUB ל-SVGZ באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-SVGZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-SVGZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-SVGZ ופורמטים אחרים באמצעות Java Automation API." >}}
