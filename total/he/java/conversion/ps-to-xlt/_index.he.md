---
title: המר את PS ל-XLT באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-XLT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-XLT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-XLT ופורמטים אחרים באמצעות Java Automation API." >}}
