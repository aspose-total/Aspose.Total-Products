---
title: המרה מקוונת של XSLFO ל-IMAGE או פיתוח אפליקציה מבוססת Java להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-IMAGE. קוד ספריית המרות Java עבור מסמכי XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XSLFO ל-IMAGE וקוד Java להמרת קבצי XSLFO" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה XSLFO.  המר קבצי XSLFO בודדים או מרובים ל-IMAGE ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי XSLFO באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-XSLFO ל-IMAGE" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=image&from=xslfo" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-IMAGE באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XSLFO ל-IMAGE" offSpacer="" %}}
