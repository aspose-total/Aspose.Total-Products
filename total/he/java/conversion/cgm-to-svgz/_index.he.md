---
title: המר את CGM ל-SVGZ באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-SVGZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-SVGZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-SVGZ ופורמטים אחרים באמצעות Java Automation API." >}}
