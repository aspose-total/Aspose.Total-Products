---
title: המר את PS ל-DICOM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-DICOM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-DICOM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-DICOM ופורמטים אחרים באמצעות Java Automation API." >}}
