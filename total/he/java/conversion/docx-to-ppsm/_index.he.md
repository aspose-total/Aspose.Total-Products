---
title: המרה מקוונת של DOCX ל-PPSM או פיתוח אפליקציה מבוססת Java להמרת קבצי DOCX
description: אפליקציה מקוונת בחינם להמרת קבצי DOCX ל-PPSM. קוד ספריית המרות Java עבור מסמכי DOCX.  
...
informat: DOCX
outformat: PPSM
otherformats: PPTX POT POTM PPS PPTM PPT POTX POWERPOINT PPSX ODP CSV DIF FODS ODS SXC TSV XLAM XLTM EXCEL XLS XLSB XLSM XLSX XLT XLTM XLTX
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCX ל-PPSM וקוד Java להמרת קבצי DOCX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOCX.  המר קבצי DOCX בודדים או מרובים ל-PPSM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOCX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCX ל-PPSM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOCX ל-PPSM" offSpacer="" %}}
