---
title: המרה מקוונת של ODT ל-XLTX או פיתוח אפליקציה מבוססת Java להמרת קבצי ODT
description: אפליקציה מקוונת בחינם להמרת קבצי ODT ל-XLTX. קוד ספריית המרות Java עבור מסמכי ODT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODT ל-XLTX וקוד Java להמרת קבצי ODT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה ODT.  המר קבצי ODT בודדים או מרובים ל-XLTX ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי ODT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של ODT ל-XLTX" offSpacer="" %}}
