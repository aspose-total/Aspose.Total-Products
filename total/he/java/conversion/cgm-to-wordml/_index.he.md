---
title: המר את CGM ל-WORDML באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-WORDML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-WORDML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-WORDML ופורמטים אחרים באמצעות Java Automation API." >}}
