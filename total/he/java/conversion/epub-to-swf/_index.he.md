---
title: המר את EPUB ל-SWF באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-SWF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-SWF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-SWF ופורמטים אחרים באמצעות Java Automation API." >}}
