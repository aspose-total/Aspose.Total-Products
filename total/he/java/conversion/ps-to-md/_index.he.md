---
title: המר את PS ל-MD באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-MD באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-MD" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-MD ופורמטים אחרים באמצעות Java Automation API." >}}
