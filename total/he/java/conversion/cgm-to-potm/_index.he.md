---
title: המר את CGM ל-POTM באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-POTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-POTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-POTM ופורמטים אחרים באמצעות Java Automation API." >}}
