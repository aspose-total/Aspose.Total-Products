---
title: המר את CGM ל-JPEG2000 באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-JPEG2000 באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-JPEG2000" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-JPEG2000 ופורמטים אחרים באמצעות Java Automation API." >}}
