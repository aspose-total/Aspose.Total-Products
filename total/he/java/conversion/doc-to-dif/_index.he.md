---
title: המרה מקוונת של DOC ל-DIF או פיתוח אפליקציה מבוססת Java להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-DIF. קוד ספריית המרות Java עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-DIF וקוד Java להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOC.  המר קבצי DOC בודדים או מרובים ל-DIF ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOC ל-DIF באמצעות אפליקציה" %}}

1. העלה קבצים DOC להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOC
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. DOC יומר למסמך DIF
1. הורד את קובץ ה-DIF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-DIF באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOC ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOC ב-DIF עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOC ל-DIF דרישות האפליקציה" %}}
