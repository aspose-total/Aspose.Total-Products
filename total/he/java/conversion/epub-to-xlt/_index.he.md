---
title: המר את EPUB ל-XLT באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XLT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XLT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XLT ופורמטים אחרים באמצעות Java Automation API." >}}
