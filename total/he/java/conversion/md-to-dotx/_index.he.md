---
title: המר את MD ל-DOTX באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DOTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DOTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DOTX ופורמטים אחרים באמצעות Java Automation API." >}}
