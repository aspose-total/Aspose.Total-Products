---
title: המרה מקוונת של PCL ל-CSV או פיתוח אפליקציה מבוססת Java להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-CSV. קוד ספריית המרות Java עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-CSV וקוד Java להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PCL.  המר קבצי PCL בודדים או מרובים ל-CSV ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-CSV באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PCL ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ב-CSV עם תכונות אחרות כמו.
