---
title: המר את PS ל-XLSM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-XLSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-XLSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-XLSM ופורמטים אחרים באמצעות Java Automation API." >}}
