---
title: המר את PS ל-SWF באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-SWF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-SWF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-SWF ופורמטים אחרים באמצעות Java Automation API." >}}
