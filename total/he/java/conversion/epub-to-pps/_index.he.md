---
title: המר את EPUB ל-PPS באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-PPS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-PPS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-PPS ופורמטים אחרים באמצעות Java Automation API." >}}
