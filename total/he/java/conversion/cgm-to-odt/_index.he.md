---
title: המר את CGM ל-ODT באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-ODT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-ODT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-ODT ופורמטים אחרים באמצעות Java Automation API." >}}
