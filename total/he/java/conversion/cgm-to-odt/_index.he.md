---
title: המרה מקוונת של CGM ל-ODT או פיתוח אפליקציה מבוססת Java להמרת קבצי CGM
description: אפליקציה מקוונת בחינם להמרת קבצי CGM ל-ODT. קוד ספריית המרות Java עבור מסמכי CGM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של CGM ל-ODT וקוד Java להמרת קבצי CGM" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה CGM.  המר קבצי CGM בודדים או מרובים ל-ODT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי CGM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-CGM ל-ODT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odt&from=cgm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-ODT באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של CGM ל-ODT" offSpacer="" %}}
