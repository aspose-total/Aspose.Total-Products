---
title: המרה מקוונת של PDF ל-XLSB או פיתוח אפליקציה מבוססת Java להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-XLSB. קוד ספריית המרות Java עבור מסמכי PDF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PDF ל-XLSB וקוד Java להמרת קבצי PDF" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PDF.  המר קבצי PDF בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PDF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-XLSB באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PDF ל-XLSB" offSpacer="" %}}
