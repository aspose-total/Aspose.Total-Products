---
title: המר את CGM ל-Excel באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-Excel באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-Excel" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-Excel ופורמטים אחרים באמצעות Java Automation API." >}}
