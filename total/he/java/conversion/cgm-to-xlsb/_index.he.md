---
title: המר את CGM ל-XLSB באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XLSB באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XLSB" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XLSB ופורמטים אחרים באמצעות Java Automation API." >}}
