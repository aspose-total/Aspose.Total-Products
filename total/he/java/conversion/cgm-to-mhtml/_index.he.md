---
title: המר את CGM ל-MHTML באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-MHTML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-MHTML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-MHTML ופורמטים אחרים באמצעות Java Automation API." >}}
