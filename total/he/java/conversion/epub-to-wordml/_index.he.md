---
title: המר את EPUB ל-WORDML באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-WORDML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-WORDML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-WORDML ופורמטים אחרים באמצעות Java Automation API." >}}
