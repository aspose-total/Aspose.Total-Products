---
title: המר את PS ל-PPTM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-PPTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-PPTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-PPTM ופורמטים אחרים באמצעות Java Automation API." >}}
...
4. שמור את המסמך בפורמט PPTM בשיטת [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) והגדר את 'Pptm' בתור SaveFormat
