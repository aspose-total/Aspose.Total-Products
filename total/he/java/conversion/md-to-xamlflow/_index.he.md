---
title: המר את MD ל-XAMLFLOW באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XAMLFLOW באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XAMLFLOW" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XAMLFLOW ופורמטים אחרים באמצעות Java Automation API." >}}
...
2. המר MD ל-DOC באמצעות שיטת [save](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-)
