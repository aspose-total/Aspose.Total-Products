---
title: המר את MD ל-XAML באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XAML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XAML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XAML ופורמטים אחרים באמצעות Java Automation API." >}}
