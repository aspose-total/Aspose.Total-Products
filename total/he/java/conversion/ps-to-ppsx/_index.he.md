---
title: המר את PS ל-PPSX באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-PPSX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-PPSX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-PPSX ופורמטים אחרים באמצעות Java Automation API." >}}
