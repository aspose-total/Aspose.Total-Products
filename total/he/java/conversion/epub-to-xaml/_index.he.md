---
title: המרה מקוונת של EPUB ל-XAML או פיתוח אפליקציה מבוססת Java להמרת קבצי EPUB
description: אפליקציה מקוונת בחינם להמרת קבצי EPUB ל-XAML. קוד ספריית המרות Java עבור מסמכי EPUB.  
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-EPUB ל-XAML" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xaml&from=epub" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של EPUB ל-XAML" offSpacer="" %}}
