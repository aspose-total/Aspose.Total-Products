---
title: המר את EPUB ל-XAML באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XAML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XAML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XAML ופורמטים אחרים באמצעות Java Automation API." >}}
