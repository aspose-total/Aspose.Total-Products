---
title: המר את EPUB ל-XAMLFLOW באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XAMLFLOW באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XAMLFLOW" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XAMLFLOW ופורמטים אחרים באמצעות Java Automation API." >}}
