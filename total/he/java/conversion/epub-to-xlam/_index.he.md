---
title: המר את EPUB ל-XLAM באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XLAM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XLAM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XLAM ופורמטים אחרים באמצעות Java Automation API." >}}
