---
title: המר את PS ל-Excel באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-Excel באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-Excel" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-Excel ופורמטים אחרים באמצעות Java Automation API." >}}
