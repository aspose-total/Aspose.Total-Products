---
title: המר את EPUB ל-FLATOPC באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-FLATOPC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-FLATOPC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-FLATOPC ופורמטים אחרים באמצעות Java Automation API." >}}
