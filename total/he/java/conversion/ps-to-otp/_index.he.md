---
title: המר את PS ל-OTP באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-OTP באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-OTP" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-OTP ופורמטים אחרים באמצעות Java Automation API." >}}
