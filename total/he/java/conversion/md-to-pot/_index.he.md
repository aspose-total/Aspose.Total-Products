---
title: המר את MD ל-POT באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-POT באמצעות קוד ספריית המרות Java. 
...
informat: MD
outformat: POT
otherformats: XAML OTP SWF POTM PPTM POWERPOINT PPSM ODP PPS PPT PPSX POTX
---
{{< blocks/products/pf/feature-page-wrap >}}
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-POT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-POT ופורמטים אחרים באמצעות Java Automation API." >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-POT באמצעות Java Automation API" %}}
...
4. שמור את המסמך בפורמט POT בשיטת [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) והגדר את 'Pot' בתור SaveFormat



{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של MD ל-POT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ב-POT עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MD ל-POT דרישות האפליקציה" %}}
