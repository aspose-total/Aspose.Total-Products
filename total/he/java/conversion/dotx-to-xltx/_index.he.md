---
title: המרה מקוונת של DOTX ל-XLTX או פיתוח אפליקציה מבוססת Java להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-XLTX. קוד ספריית המרות Java עבור מסמכי DOTX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-XLTX באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOTX ל-XLTX" offSpacer="" %}}
