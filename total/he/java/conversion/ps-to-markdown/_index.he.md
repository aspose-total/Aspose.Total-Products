---
title: המר את PS ל-MARKDOWN באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-MARKDOWN באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-MARKDOWN" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-MARKDOWN ופורמטים אחרים באמצעות Java Automation API." >}}
