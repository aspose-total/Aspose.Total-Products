---
title: המר את PS ל-DOTM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-DOTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-DOTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-DOTM ופורמטים אחרים באמצעות Java Automation API." >}}
