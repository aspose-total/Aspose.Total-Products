---
title: המרה מקוונת של TXT ל-ODP או פיתוח אפליקציה מבוססת Java להמרת קבצי TXT
description: אפליקציה מקוונת בחינם להמרת קבצי TXT ל-ODP. קוד ספריית המרות Java עבור מסמכי TXT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TXT ל-ODP וקוד Java להמרת קבצי TXT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה TXT.  המר קבצי TXT בודדים או מרובים ל-ODP ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי TXT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TXT ל-ODP באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של TXT ל-ODP" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TXT ב-ODP עם תכונות אחרות כמו.
