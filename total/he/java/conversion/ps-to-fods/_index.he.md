---
title: המר את PS ל-FODS באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-FODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-FODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-FODS ופורמטים אחרים באמצעות Java Automation API." >}}
