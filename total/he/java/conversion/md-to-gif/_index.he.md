---
title: המר את MD ל-GIF באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-GIF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-GIF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-GIF ופורמטים אחרים באמצעות Java Automation API." >}}
