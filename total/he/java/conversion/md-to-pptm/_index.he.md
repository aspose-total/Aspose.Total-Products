---
title: המר את MD ל-PPTM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PPTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PPTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PPTM ופורמטים אחרים באמצעות Java Automation API." >}}
