---
title: המרה מקוונת של TEX ל-XLTX או פיתוח אפליקציה מבוססת Java להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-XLTX. קוד ספריית המרות Java עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-XLTX וקוד Java להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה TEX.  המר קבצי TEX בודדים או מרובים ל-XLTX ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-XLTX באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של TEX ל-XLTX" offSpacer="" %}}
