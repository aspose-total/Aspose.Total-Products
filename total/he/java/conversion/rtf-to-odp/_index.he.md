---
title: המרה מקוונת של RTF ל-ODP או פיתוח אפליקציה מבוססת Java להמרת קבצי RTF
description: אפליקציה מקוונת בחינם להמרת קבצי RTF ל-ODP. קוד ספריית המרות Java עבור מסמכי RTF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של RTF ל-ODP וקוד Java להמרת קבצי RTF" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה RTF.  המר קבצי RTF בודדים או מרובים ל-ODP ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי RTF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את RTF ל-ODP באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של RTF ל-ODP" offSpacer="" %}}
