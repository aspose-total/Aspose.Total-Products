---
title: המר את CGM ל-XLAM באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XLAM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XLAM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XLAM ופורמטים אחרים באמצעות Java Automation API." >}}
