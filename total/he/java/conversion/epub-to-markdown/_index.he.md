---
title: המר את EPUB ל-MARKDOWN באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-MARKDOWN באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-MARKDOWN" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-MARKDOWN ופורמטים אחרים באמצעות Java Automation API." >}}
...
4. שמור את המסמך בפורמט MARKDOWN בשיטת [save](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) והגדר את MARKDOWN כ-SaveFormat
