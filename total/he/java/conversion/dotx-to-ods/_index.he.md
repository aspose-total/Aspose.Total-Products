---
title: המרה מקוונת של DOTX ל-ODS או פיתוח אפליקציה מבוססת Java להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-ODS. קוד ספריית המרות Java עבור מסמכי DOTX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-ODS באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOTX ל-ODS" offSpacer="" %}}
