---
title: המר את EPUB ל-PPSM באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-PPSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-PPSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-PPSM ופורמטים אחרים באמצעות Java Automation API." >}}
...
4. שמור את המסמך בפורמט PPSM בשיטת [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) והגדר את 'Ppsm' בתור SaveFormat
