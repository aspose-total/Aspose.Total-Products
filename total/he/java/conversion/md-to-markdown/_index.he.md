---
title: המר את MD ל-MARKDOWN באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-MARKDOWN באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-MARKDOWN" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-MARKDOWN ופורמטים אחרים באמצעות Java Automation API." >}}
