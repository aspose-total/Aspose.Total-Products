---
title: המרה מקוונת של DOTX ל-PPSM או פיתוח אפליקציה מבוססת Java להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-PPSM. קוד ספריית המרות Java עבור מסמכי DOTX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-PPSM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOTX ל-PPSM" offSpacer="" %}}
