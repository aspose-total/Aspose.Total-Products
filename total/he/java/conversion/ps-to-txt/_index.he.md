---
title: המר את PS ל-TXT באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-TXT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-TXT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-TXT ופורמטים אחרים באמצעות Java Automation API." >}}
