---
title: המרה מקוונת של PCL ל-WMZ או פיתוח אפליקציה מבוססת Java להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-WMZ. קוד ספריית המרות Java עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-WMZ וקוד Java להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PCL.  המר קבצי PCL בודדים או מרובים ל-WMZ ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-PCL ל-WMZ" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=wmz&from=pcl" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PCL ל-WMZ באמצעות אפליקציה" %}}

1. העלה קבצים PCL להמרה
1. המתן מספר שניות או יותר בהתאם לגודל PCL
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. PCL יומר למסמך WMZ
1. הורד את קובץ ה-WMZ שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-WMZ באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PCL ל-WMZ" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ב-WMZ עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PCL ל-WMZ דרישות האפליקציה" %}}
