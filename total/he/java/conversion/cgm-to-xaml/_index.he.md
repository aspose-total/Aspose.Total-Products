---
title: המר את CGM ל-XAML באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XAML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XAML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XAML ופורמטים אחרים באמצעות Java Automation API." >}}
