---
title: המר את CGM ל-TGA באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-TGA באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-TGA" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-TGA ופורמטים אחרים באמצעות Java Automation API." >}}
