---
title: המרה מקוונת של DOC ל-PPSM או פיתוח אפליקציה מבוססת Java להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-PPSM. קוד ספריית המרות Java עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-PPSM וקוד Java להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOC.  המר קבצי DOC בודדים או מרובים ל-PPSM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-PPSM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOC ל-PPSM" offSpacer="" %}}
