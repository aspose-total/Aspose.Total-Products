---
title: המר את MD ל-TGA באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-TGA באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-TGA" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-TGA ופורמטים אחרים באמצעות Java Automation API." >}}
