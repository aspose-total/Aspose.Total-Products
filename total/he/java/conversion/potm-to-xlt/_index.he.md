---
title: המרה מקוונת של POTM ל-XLT או פיתוח אפליקציה מבוססת Java להמרת קבצי POTM
description: אפליקציה מקוונת בחינם להמרת קבצי POTM ל-XLT. קוד ספריית המרות Java עבור מסמכי POTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTM ל-XLT וקוד Java להמרת קבצי POTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה POTM.  המר קבצי POTM בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי POTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את POTM ל-XLT באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של POTM ל-XLT" offSpacer="" %}}
