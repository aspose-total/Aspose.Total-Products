---
title: המרה מקוונת של XSLFO ל-XLSM או פיתוח אפליקציה מבוססת Java להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-XLSM. קוד ספריית המרות Java עבור מסמכי XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XSLFO ל-XLSM וקוד Java להמרת קבצי XSLFO" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה XSLFO.  המר קבצי XSLFO בודדים או מרובים ל-XLSM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי XSLFO באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-XLSM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XSLFO ל-XLSM" offSpacer="" %}}
