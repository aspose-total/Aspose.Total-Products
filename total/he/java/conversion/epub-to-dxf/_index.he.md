---
title: המר את EPUB ל-DXF באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-DXF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-DXF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-DXF ופורמטים אחרים באמצעות Java Automation API." >}}
