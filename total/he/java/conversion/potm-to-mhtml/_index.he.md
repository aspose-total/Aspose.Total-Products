---
title: המרה מקוונת של POTM ל-MHTML או פיתוח אפליקציה מבוססת Java להמרת קבצי POTM
description: אפליקציה מקוונת בחינם להמרת קבצי POTM ל-MHTML. קוד ספריית המרות Java עבור מסמכי POTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTM ל-MHTML וקוד Java להמרת קבצי POTM" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה POTM.  המר קבצי POTM בודדים או מרובים ל-MHTML ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי POTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של POTM ל-MHTML באמצעות אפליקציה" %}}

1. העלה קבצים POTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל POTM
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. POTM יומר למסמך MHTML
1. הורד את קובץ ה-MHTML שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את POTM ל-MHTML באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של POTM ל-MHTML" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POTM ב-MHTML עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את POTM ל-MHTML דרישות האפליקציה" %}}
