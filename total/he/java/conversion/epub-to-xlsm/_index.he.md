---
title: המר את EPUB ל-XLSM באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-XLSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-XLSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-XLSM ופורמטים אחרים באמצעות Java Automation API." >}}
