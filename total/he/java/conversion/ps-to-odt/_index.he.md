---
title: המר את PS ל-ODT באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-ODT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-ODT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-ODT ופורמטים אחרים באמצעות Java Automation API." >}}
