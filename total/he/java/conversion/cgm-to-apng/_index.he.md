---
title: המר את CGM ל-APNG באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-APNG באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-APNG" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-APNG ופורמטים אחרים באמצעות Java Automation API." >}}
