---
title: המר את CGM ל-PCL באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-PCL באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-PCL" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-PCL ופורמטים אחרים באמצעות Java Automation API." >}}
