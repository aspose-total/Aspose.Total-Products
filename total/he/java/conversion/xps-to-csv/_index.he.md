---
title: המרה מקוונת של XPS ל-CSV או פיתוח אפליקציה מבוססת Java להמרת קבצי XPS
description: אפליקציה מקוונת בחינם להמרת קבצי XPS ל-CSV. קוד ספריית המרות Java עבור מסמכי XPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XPS ל-CSV וקוד Java להמרת קבצי XPS" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה XPS.  המר קבצי XPS בודדים או מרובים ל-CSV ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי XPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XPS ל-CSV באמצעות אפליקציה" %}}

1. העלה קבצים XPS להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XPS
1. עקוב אחר שורת המצב של העלאה
1. לחץ על כפתור "המר".
1. XPS יומר למסמך CSV
1. הורד את קובץ ה-CSV שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XPS ל-CSV באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XPS ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XPS ב-CSV עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XPS ל-CSV דרישות האפליקציה" %}}
