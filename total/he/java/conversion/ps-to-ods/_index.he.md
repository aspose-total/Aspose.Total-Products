---
title: המר את PS ל-ODS באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-ODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-ODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-ODS ופורמטים אחרים באמצעות Java Automation API." >}}
