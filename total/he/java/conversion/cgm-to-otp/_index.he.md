---
title: המר את CGM ל-OTP באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-OTP באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-OTP" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-OTP ופורמטים אחרים באמצעות Java Automation API." >}}
