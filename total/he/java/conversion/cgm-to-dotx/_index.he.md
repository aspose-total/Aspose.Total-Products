---
title: המר את CGM ל-DOTX באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-DOTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-DOTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-DOTX ופורמטים אחרים באמצעות Java Automation API." >}}
