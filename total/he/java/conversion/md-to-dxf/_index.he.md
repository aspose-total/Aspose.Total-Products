---
title: המר את MD ל-DXF באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DXF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DXF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DXF ופורמטים אחרים באמצעות Java Automation API." >}}
