---
title: המר את PS ל-SXC באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-SXC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-SXC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-SXC ופורמטים אחרים באמצעות Java Automation API." >}}
