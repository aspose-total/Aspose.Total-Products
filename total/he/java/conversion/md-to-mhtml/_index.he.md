---
title: המר את MD ל-MHTML באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-MHTML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-MHTML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-MHTML ופורמטים אחרים באמצעות Java Automation API." >}}
