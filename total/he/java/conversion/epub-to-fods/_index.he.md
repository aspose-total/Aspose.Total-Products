---
title: המר את EPUB ל-FODS באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-FODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-FODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-FODS ופורמטים אחרים באמצעות Java Automation API." >}}
