---
title: המר את PS ל-POTM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-POTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-POTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-POTM ופורמטים אחרים באמצעות Java Automation API." >}}
