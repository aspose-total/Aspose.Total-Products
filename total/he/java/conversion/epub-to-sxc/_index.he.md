---
title: המר את EPUB ל-SXC באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-SXC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-SXC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-SXC ופורמטים אחרים באמצעות Java Automation API." >}}
