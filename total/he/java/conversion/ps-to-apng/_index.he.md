---
title: המר את PS ל-APNG באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-APNG באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-APNG" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-APNG ופורמטים אחרים באמצעות Java Automation API." >}}
