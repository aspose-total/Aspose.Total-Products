---
title: המר את MD ל-PS באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PS ופורמטים אחרים באמצעות Java Automation API." >}}
