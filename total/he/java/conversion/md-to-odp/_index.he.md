---
title: המר את MD ל-ODP באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-ODP באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-ODP" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-ODP ופורמטים אחרים באמצעות Java Automation API." >}}
