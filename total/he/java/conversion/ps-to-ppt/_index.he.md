---
title: המר את PS ל-PPT באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-PPT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-PPT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-PPT ופורמטים אחרים באמצעות Java Automation API." >}}
