---
title: המרה מקוונת של PCL ל-MD או פיתוח אפליקציה מבוססת Java להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-MD. קוד ספריית המרות Java עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-MD וקוד Java להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PCL.  המר קבצי PCL בודדים או מרובים ל-MD ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-PCL ל-MD" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=md&from=pcl" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PCL ל-MD באמצעות אפליקציה" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-MD באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PCL ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ב-MD עם תכונות אחרות כמו.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PCL ל-MD דרישות האפליקציה" %}}
