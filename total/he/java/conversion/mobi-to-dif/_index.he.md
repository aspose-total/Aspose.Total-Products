---
title: המרה מקוונת של MOBI ל-DIF או פיתוח אפליקציה מבוססת Java להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-DIF. קוד ספריית המרות Java עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-DIF וקוד Java להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה MOBI.  המר קבצי MOBI בודדים או מרובים ל-DIF ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-DIF באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של MOBI ל-DIF" offSpacer="" %}}
