---
title: המר את MD ל-FODS באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-FODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-FODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-FODS ופורמטים אחרים באמצעות Java Automation API." >}}
