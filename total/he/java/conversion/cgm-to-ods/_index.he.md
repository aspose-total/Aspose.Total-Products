---
title: המר את CGM ל-ODS באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-ODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-ODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-ODS ופורמטים אחרים באמצעות Java Automation API." >}}
