---
title: המרה מקוונת של XSLFO ל-XLTM או פיתוח אפליקציה מבוססת Java להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-XLTM. קוד ספריית המרות Java עבור מסמכי XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XSLFO ל-XLTM וקוד Java להמרת קבצי XSLFO" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה XSLFO.  המר קבצי XSLFO בודדים או מרובים ל-XLTM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי XSLFO באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-XLTM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של XSLFO ל-XLTM" offSpacer="" %}}
