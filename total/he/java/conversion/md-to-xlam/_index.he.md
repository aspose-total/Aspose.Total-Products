---
title: המר את MD ל-XLAM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-XLAM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-XLAM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-XLAM ופורמטים אחרים באמצעות Java Automation API." >}}
...
2. המר MD ל-XLSX באמצעות שיטת [save](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-)
