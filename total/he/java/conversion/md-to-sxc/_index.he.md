---
title: המר את MD ל-SXC באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-SXC באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-SXC" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-SXC ופורמטים אחרים באמצעות Java Automation API." >}}
