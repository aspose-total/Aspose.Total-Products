---
title: המר את MD ל-IMAGE באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-IMAGE באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-IMAGE" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-IMAGE ופורמטים אחרים באמצעות Java Automation API." >}}
