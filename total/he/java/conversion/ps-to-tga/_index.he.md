---
title: המר את PS ל-TGA באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-TGA באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-TGA" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-TGA ופורמטים אחרים באמצעות Java Automation API." >}}
