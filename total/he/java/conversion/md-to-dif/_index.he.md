---
title: המר את MD ל-DIF באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-DIF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-DIF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-DIF ופורמטים אחרים באמצעות Java Automation API." >}}
