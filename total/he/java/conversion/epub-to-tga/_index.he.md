---
title: המר את EPUB ל-TGA באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-TGA באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-TGA" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-TGA ופורמטים אחרים באמצעות Java Automation API." >}}
