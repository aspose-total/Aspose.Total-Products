---
title: המר את PS ל-PPS באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-PPS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-PPS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-PPS ופורמטים אחרים באמצעות Java Automation API." >}}
