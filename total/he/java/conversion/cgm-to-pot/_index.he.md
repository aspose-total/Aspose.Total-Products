---
title: המר את CGM ל-POT באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-POT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-POT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-POT ופורמטים אחרים באמצעות Java Automation API." >}}
