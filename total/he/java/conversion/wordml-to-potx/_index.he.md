---
title: המרה מקוונת של WORDML ל-POTX או פיתוח אפליקציה מבוססת Java להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-POTX. קוד ספריית המרות Java עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-POTX וקוד Java להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה WORDML.  המר קבצי WORDML בודדים או מרובים ל-POTX ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-POTX באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של WORDML ל-POTX" offSpacer="" %}}
