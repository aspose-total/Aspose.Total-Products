---
title: המר את CGM ל-PPSM באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-PPSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-PPSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-PPSM ופורמטים אחרים באמצעות Java Automation API." >}}
