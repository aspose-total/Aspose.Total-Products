---
title: המר את CGM ל-XLSM באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-XLSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-XLSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-XLSM ופורמטים אחרים באמצעות Java Automation API." >}}
