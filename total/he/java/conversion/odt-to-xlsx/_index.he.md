---
title: המרה מקוונת של ODT ל-XLSX או פיתוח אפליקציה מבוססת Java להמרת קבצי ODT
description: אפליקציה מקוונת בחינם להמרת קבצי ODT ל-XLSX. קוד ספריית המרות Java עבור מסמכי ODT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODT ל-XLSX וקוד Java להמרת קבצי ODT" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה ODT.  המר קבצי ODT בודדים או מרובים ל-XLSX ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי ODT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את ODT ל-XLSX באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של ODT ל-XLSX" offSpacer="" %}}
