---
title: המר את MD ל-TXT באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-TXT באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-TXT" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-TXT ופורמטים אחרים באמצעות Java Automation API." >}}
