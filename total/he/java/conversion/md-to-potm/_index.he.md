---
title: המר את MD ל-POTM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-POTM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-POTM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-POTM ופורמטים אחרים באמצעות Java Automation API." >}}
