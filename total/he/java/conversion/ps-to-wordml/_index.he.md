---
title: המר את PS ל-WORDML באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-WORDML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-WORDML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-WORDML ופורמטים אחרים באמצעות Java Automation API." >}}
