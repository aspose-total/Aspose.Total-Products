---
title: המר את MD ל-WORDML באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-WORDML באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-WORDML" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-WORDML ופורמטים אחרים באמצעות Java Automation API." >}}
