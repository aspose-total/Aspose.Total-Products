---
title: המר את CGM ל-EMZ באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-EMZ באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-EMZ" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-EMZ ופורמטים אחרים באמצעות Java Automation API." >}}
