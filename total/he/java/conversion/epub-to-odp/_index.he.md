---
title: המר את EPUB ל-ODP באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-ODP באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-ODP" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-ODP ופורמטים אחרים באמצעות Java Automation API." >}}
