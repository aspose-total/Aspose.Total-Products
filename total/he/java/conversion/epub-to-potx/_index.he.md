---
title: המר את EPUB ל-POTX באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-POTX באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-POTX" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-POTX ופורמטים אחרים באמצעות Java Automation API." >}}
