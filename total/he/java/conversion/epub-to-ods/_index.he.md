---
title: המר את EPUB ל-ODS באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-ODS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-ODS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-ODS ופורמטים אחרים באמצעות Java Automation API." >}}
