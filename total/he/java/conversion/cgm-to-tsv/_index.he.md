---
title: המר את CGM ל-TSV באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-TSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-TSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-TSV ופורמטים אחרים באמצעות Java Automation API." >}}
