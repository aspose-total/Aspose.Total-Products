---
title: המר את CGM ל-GIF באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-GIF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-GIF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-GIF ופורמטים אחרים באמצעות Java Automation API." >}}
