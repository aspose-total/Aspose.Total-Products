---
title: המר את MD ל-PPS באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PPS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PPS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PPS ופורמטים אחרים באמצעות Java Automation API." >}}
