---
title: המרה מקוונת של TEX ל-XLT או פיתוח אפליקציה מבוססת Java להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-XLT. קוד ספריית המרות Java עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-XLT וקוד Java להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה TEX.  המר קבצי TEX בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-XLT באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של TEX ל-XLT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ב-XLT עם תכונות אחרות כמו.
