---
title: המר את EPUB ל-DOCM באמצעות יישומים מבוססי Java
description: המר קבצי EPUB ל-DOCM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי EPUB ל-DOCM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java EPUB. המר קובץ EPUB אחד או יותר ל-DOCM ופורמטים אחרים באמצעות Java Automation API." >}}
