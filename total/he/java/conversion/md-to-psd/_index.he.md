---
title: המר את MD ל-PSD באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PSD באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PSD" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PSD ופורמטים אחרים באמצעות Java Automation API." >}}
