---
title: המר את PS ל-PPSM באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-PPSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-PPSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-PPSM ופורמטים אחרים באמצעות Java Automation API." >}}
