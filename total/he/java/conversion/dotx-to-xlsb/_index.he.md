---
title: המרה מקוונת של DOTX ל-XLSB או פיתוח אפליקציה מבוססת Java להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-XLSB. קוד ספריית המרות Java עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-XLSB וקוד Java להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה DOTX.  המר קבצי DOTX בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-XLSB באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של DOTX ל-XLSB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ב-XLSB עם תכונות אחרות כמו.
