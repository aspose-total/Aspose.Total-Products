---
title: המר את PS ל-DXF באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-DXF באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-DXF" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-DXF ופורמטים אחרים באמצעות Java Automation API." >}}
...
2. אתחול אובייקט מחלקה ועיבוד PS ל-JPEG באמצעות שיטת [Process](https://reference.aspose.com/pdf/java/com.aspose.pdf.devices/JpegDevice#process-com.aspose.pdf.Page-java.io.OutputStream-)
