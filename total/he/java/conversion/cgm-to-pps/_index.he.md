---
title: המר את CGM ל-PPS באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-PPS באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-PPS" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-PPS ופורמטים אחרים באמצעות Java Automation API." >}}
