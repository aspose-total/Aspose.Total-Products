---
title: המרה מקוונת של PPSM ל-XLSM או פיתוח אפליקציה מבוססת Java להמרת קבצי PPSM
description: אפליקציה מקוונת בחינם להמרת קבצי PPSM ל-XLSM. קוד ספריית המרות Java עבור מסמכי PPSM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPSM ל-XLSM וקוד Java להמרת קבצי PPSM" h2="פתח אפליקציית המרה וייצוא המבוססת על Java רבת עוצמה PPSM.  המר קבצי PPSM בודדים או מרובים ל-XLSM ופורמטים אחרים באמצעות Java Automation API.  המרה חופשית של קבצי PPSM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-PPSM ל-XLSM" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=xlsm&from=ppsm" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPSM ל-XLSM באמצעות Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד Java עבור המרה של PPSM ל-XLSM" offSpacer="" %}}
