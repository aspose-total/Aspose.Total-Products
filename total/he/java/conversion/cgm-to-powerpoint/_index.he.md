---
title: המר את CGM ל-Powerpoint באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-Powerpoint באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-Powerpoint" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-Powerpoint ופורמטים אחרים באמצעות Java Automation API." >}}
