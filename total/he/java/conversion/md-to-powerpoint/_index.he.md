---
title: המר את MD ל-Powerpoint באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-Powerpoint באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-Powerpoint" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-Powerpoint ופורמטים אחרים באמצעות Java Automation API." >}}
...
4. שמור את המסמך בפורמט PPT בשיטת [save](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) והגדר 'Ppt' בתור SaveFormat
