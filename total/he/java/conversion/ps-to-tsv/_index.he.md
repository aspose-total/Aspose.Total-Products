---
title: המר את PS ל-TSV באמצעות יישומים מבוססי Java
description: המר קבצי PS ל-TSV באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי PS ל-TSV" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java PS. המר קובץ PS אחד או יותר ל-TSV ופורמטים אחרים באמצעות Java Automation API." >}}
