---
title: המר את MD ל-PCL באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PCL באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PCL" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PCL ופורמטים אחרים באמצעות Java Automation API." >}}
