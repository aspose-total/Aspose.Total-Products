---
title: המר את MD ל-PPSM באמצעות יישומים מבוססי Java
description: המר קבצי MD ל-PPSM באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי MD ל-PPSM" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java MD. המר קובץ MD אחד או יותר ל-PPSM ופורמטים אחרים באמצעות Java Automation API." >}}
