---
title: המר את CGM ל-IMAGE באמצעות יישומים מבוססי Java
description: המר קבצי CGM ל-IMAGE באמצעות קוד ספריית המרות Java. 
...
{{< blocks/products/pf/feature-page-header h1="קוד Java להמרת קבצי CGM ל-IMAGE" h2="פתח אפליקציית המרה וייצוא חזקה מבוססת Java CGM. המר קובץ CGM אחד או יותר ל-IMAGE ופורמטים אחרים באמצעות Java Automation API." >}}
