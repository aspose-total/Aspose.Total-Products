---
title: המרה מקוונת של DOT ל-POTM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-POTM. קוד ספריית ההמרות של Android עבור מסמכי DOT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOT ל-POTM וקוד אנדרואיד להמרת קבצי DOT" h2="פתח אפליקציית המרה וייצוא של DOT מבוססת אנדרואיד.  המר קבצי DOT בודדים או מרובים ל-POTM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-DOT ל-POTM" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=potm&from=dot" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOT ל-POTM באמצעות אפליקציה" %}}

1. העלה קבצים DOT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOT
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. DOT יומר למסמך POTM
1. הורד את קובץ ה-POTM שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-POTM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOT ל-POTM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOT ל-POTM עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOT ל-POTM דרישות האפליקציה" %}}
