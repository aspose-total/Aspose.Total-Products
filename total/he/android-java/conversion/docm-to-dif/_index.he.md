---
title: המרה מקוונת של DOCM ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-DIF וקוד אנדרואיד להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא של DOCM מבוססת אנדרואיד.  המר קבצי DOCM בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-DIF באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOCM ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCM ל-DIF עם תכונות אחרות.
