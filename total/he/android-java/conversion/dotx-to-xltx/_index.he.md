---
title: המרה מקוונת של DOTX ל-XLTX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-XLTX. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-XLTX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-XLTX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-XLTX עם תכונות אחרות.
