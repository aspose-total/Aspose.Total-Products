---
title: המרה מקוונת של XPS ל-SXC או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי XPS
description: אפליקציה מקוונת בחינם להמרת קבצי XPS ל-SXC. קוד ספריית ההמרות של Android עבור מסמכי XPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XPS ל-SXC וקוד אנדרואיד להמרת קבצי XPS" h2="פתח אפליקציית המרה וייצוא של XPS מבוססת אנדרואיד.  המר קבצי XPS בודדים או מרובים ל-SXC ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי XPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XPS ל-SXC באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של XPS ל-SXC" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XPS ל-SXC עם תכונות אחרות.
