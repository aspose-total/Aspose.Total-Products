---
title: המרה מקוונת של PCL ל-XLTX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-XLTX. קוד ספריית ההמרות של Android עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-XLTX וקוד אנדרואיד להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא של PCL מבוססת אנדרואיד.  המר קבצי PCL בודדים או מרובים ל-XLTX ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-XLTX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PCL ל-XLTX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ל-XLTX עם תכונות אחרות.
