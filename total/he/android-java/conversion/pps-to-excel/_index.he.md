---
title: המרה מקוונת של PPS ל-Excel או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PPS
description: אפליקציה מקוונת בחינם להמרת קבצי PPS ל-Excel. קוד ספריית ההמרות של Android עבור מסמכי PPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPS ל-Excel וקוד אנדרואיד להמרת קבצי PPS" h2="פתח אפליקציית המרה וייצוא של PPS מבוססת אנדרואיד.  המר קבצי PPS בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PPS ל-Excel" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPS ל-Excel עם תכונות אחרות.
