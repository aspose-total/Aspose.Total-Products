---
title: המרה מקוונת של WORDML ל-POT או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-POT. קוד ספריית ההמרות של Android עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-POT וקוד אנדרואיד להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא של WORDML מבוססת אנדרואיד.  המר קבצי WORDML בודדים או מרובים ל-POT ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-POT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של WORDML ל-POT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת WORDML ל-POT עם תכונות אחרות.
