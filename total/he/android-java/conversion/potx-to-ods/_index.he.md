---
title: המרה מקוונת של POTX ל-ODS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי POTX
description: אפליקציה מקוונת בחינם להמרת קבצי POTX ל-ODS. קוד ספריית ההמרות של Android עבור מסמכי POTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTX ל-ODS וקוד אנדרואיד להמרת קבצי POTX" h2="פתח אפליקציית המרה וייצוא של POTX מבוססת אנדרואיד.  המר קבצי POTX בודדים או מרובים ל-ODS ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי POTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-POTX ל-ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ods&from=potx" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את POTX ל-ODS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של POTX ל-ODS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POTX ל-ODS עם תכונות אחרות.
