---
title: המרה מקוונת של TEX ל-ODS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-ODS. קוד ספריית ההמרות של Android עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-ODS וקוד אנדרואיד להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא של TEX מבוססת אנדרואיד.  המר קבצי TEX בודדים או מרובים ל-ODS ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-ODS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TEX ל-ODS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ל-ODS עם תכונות אחרות.
