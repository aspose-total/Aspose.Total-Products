---
title: המרה מקוונת של DOT ל-CSV או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-CSV. קוד ספריית ההמרות של Android עבור מסמכי DOT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOT ל-CSV וקוד אנדרואיד להמרת קבצי DOT" h2="פתח אפליקציית המרה וייצוא של DOT מבוססת אנדרואיד.  המר קבצי DOT בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-CSV באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOT ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOT ל-CSV עם תכונות אחרות.
