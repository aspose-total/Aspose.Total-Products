---
title: המרה מקוונת של Word ל-POTM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי Word
description: אפליקציה מקוונת בחינם להמרת קבצי Word ל-POTM. קוד ספריית ההמרות של Android עבור מסמכי Word.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של Word ל-POTM וקוד אנדרואיד להמרת קבצי Word" h2="פתח אפליקציית המרה וייצוא של Word מבוססת אנדרואיד.  המר קבצי Word בודדים או מרובים ל-POTM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי Word באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את Word ל-POTM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של Word ל-POTM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת Word ל-POTM עם תכונות אחרות.
