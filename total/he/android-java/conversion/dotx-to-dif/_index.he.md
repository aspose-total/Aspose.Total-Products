---
title: המרה מקוונת של DOTX ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-DIF וקוד אנדרואיד להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא של DOTX מבוססת אנדרואיד.  המר קבצי DOTX בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-DOTX ל-DIF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dif&from=dotx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOTX ל-DIF באמצעות אפליקציה" %}}

1. העלה קבצים DOTX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOTX
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. DOTX יומר למסמך DIF
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-DIF עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOTX ל-DIF דרישות האפליקציה" %}}
