---
title: המרה מקוונת של PDF ל-CSV או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-CSV. קוד ספריית ההמרות של Android עבור מסמכי PDF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PDF ל-CSV וקוד אנדרואיד להמרת קבצי PDF" h2="פתח אפליקציית המרה וייצוא של PDF מבוססת אנדרואיד.  המר קבצי PDF בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PDF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-CSV באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PDF ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PDF ל-CSV עם תכונות אחרות.
