---
title: המרה מקוונת של PPTX ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PPTX
description: אפליקציה מקוונת בחינם להמרת קבצי PPTX ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי PPTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPTX ל-DIF וקוד אנדרואיד להמרת קבצי PPTX" h2="פתח אפליקציית המרה וייצוא של PPTX מבוססת אנדרואיד.  המר קבצי PPTX בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PPTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPTX ל-DIF באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PPTX ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPTX ל-DIF עם תכונות אחרות.
