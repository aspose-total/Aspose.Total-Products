---
title: המרה מקוונת של TEX ל-MD או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-MD. קוד ספריית ההמרות של Android עבור מסמכי TEX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-MD באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TEX ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ל-MD עם תכונות אחרות.
