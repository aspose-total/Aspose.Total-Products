---
title: המרה מקוונת של PCL ל-MD או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-MD. קוד ספריית ההמרות של Android עבור מסמכי PCL.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-MD באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PCL ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ל-MD עם תכונות אחרות.
