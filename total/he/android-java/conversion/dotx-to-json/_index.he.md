---
title: המרה מקוונת של DOTX ל-JSON או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-JSON. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-JSON וקוד אנדרואיד להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא של DOTX מבוססת אנדרואיד.  המר קבצי DOTX בודדים או מרובים ל-JSON ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-JSON באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-JSON" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-JSON עם תכונות אחרות.
