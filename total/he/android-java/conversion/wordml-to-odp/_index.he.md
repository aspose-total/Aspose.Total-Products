---
title: המרה מקוונת של WORDML ל-ODP או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-ODP. קוד ספריית ההמרות של Android עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-ODP וקוד אנדרואיד להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא של WORDML מבוססת אנדרואיד.  המר קבצי WORDML בודדים או מרובים ל-ODP ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-ODP באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של WORDML ל-ODP" offSpacer="" %}}
...
עוד כמה מקרים לשמירת WORDML ל-ODP עם תכונות אחרות.
