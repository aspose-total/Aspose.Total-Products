---
title: המרה מקוונת של POTM ל-XLSB או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי POTM
description: אפליקציה מקוונת בחינם להמרת קבצי POTM ל-XLSB. קוד ספריית ההמרות של Android עבור מסמכי POTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של POTM ל-XLSB וקוד אנדרואיד להמרת קבצי POTM" h2="פתח אפליקציית המרה וייצוא של POTM מבוססת אנדרואיד.  המר קבצי POTM בודדים או מרובים ל-XLSB ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי POTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את POTM ל-XLSB באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של POTM ל-XLSB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת POTM ל-XLSB עם תכונות אחרות.
