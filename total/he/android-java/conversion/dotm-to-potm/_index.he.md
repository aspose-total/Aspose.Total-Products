---
title: המרה מקוונת של DOTM ל-POTM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTM
description: אפליקציה מקוונת בחינם להמרת קבצי DOTM ל-POTM. קוד ספריית ההמרות של Android עבור מסמכי DOTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTM ל-POTM וקוד אנדרואיד להמרת קבצי DOTM" h2="פתח אפליקציית המרה וייצוא של DOTM מבוססת אנדרואיד.  המר קבצי DOTM בודדים או מרובים ל-POTM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTM ל-POTM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTM ל-POTM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTM ל-POTM עם תכונות אחרות.
