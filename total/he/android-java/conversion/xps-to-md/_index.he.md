---
title: המרה מקוונת של XPS ל-MD או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי XPS
description: אפליקציה מקוונת בחינם להמרת קבצי XPS ל-MD. קוד ספריית ההמרות של Android עבור מסמכי XPS.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XPS ל-MD באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של XPS ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XPS ל-MD עם תכונות אחרות.
