---
title: המרה מקוונת של DOT ל-XLTX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOT
description: אפליקציה מקוונת בחינם להמרת קבצי DOT ל-XLTX. קוד ספריית ההמרות של Android עבור מסמכי DOT.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOT ל-XLTX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOT ל-XLTX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOT ל-XLTX עם תכונות אחרות.
