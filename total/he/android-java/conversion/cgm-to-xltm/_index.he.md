...
description: המר קבצי CGM ל-XLTM באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי CGM" h2="פתח אפליקציית המרה וייצוא של CGM מבוססת אנדרואיד.  המר קבצי CGM בודדים או מרובים ל-XLTM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-XLTM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של CGM ל-XLTM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת CGM ל-XLTM עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את CGM ל-XLTM דרישות האפליקציה" %}}
