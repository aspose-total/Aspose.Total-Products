---
title: המרה מקוונת של TEX ל-SXC או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-SXC. קוד ספריית ההמרות של Android עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-SXC וקוד אנדרואיד להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא של TEX מבוססת אנדרואיד.  המר קבצי TEX בודדים או מרובים ל-SXC ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-SXC באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TEX ל-SXC" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ל-SXC עם תכונות אחרות.
