---
title: המרה מקוונת של MHTML ל-XLTM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי MHTML
description: אפליקציה מקוונת בחינם להמרת קבצי MHTML ל-XLTM. קוד ספריית ההמרות של Android עבור מסמכי MHTML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MHTML ל-XLTM וקוד אנדרואיד להמרת קבצי MHTML" h2="פתח אפליקציית המרה וייצוא של MHTML מבוססת אנדרואיד.  המר קבצי MHTML בודדים או מרובים ל-XLTM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי MHTML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MHTML ל-XLTM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MHTML ל-XLTM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MHTML ל-XLTM עם תכונות אחרות.
