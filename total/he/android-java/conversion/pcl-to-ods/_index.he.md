---
title: המרה מקוונת של PCL ל-ODS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-ODS. קוד ספריית ההמרות של Android עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-ODS וקוד אנדרואיד להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא של PCL מבוססת אנדרואיד.  המר קבצי PCL בודדים או מרובים ל-ODS ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-PCL ל-ODS" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=ods&from=pcl" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-ODS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PCL ל-ODS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ל-ODS עם תכונות אחרות.
