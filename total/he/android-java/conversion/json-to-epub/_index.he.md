---
title: המרה מקוונת של JSON ל-EPUB או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-EPUB. קוד ספריית ההמרות של Android עבור מסמכי JSON.  
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-JSON ל-EPUB" style="border: none; height: 426px;" scrolling="no" src="https://widgets.aspose.cloud/total-conversion/?to=epub&from=json" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של JSON ל-EPUB באמצעות אפליקציה" %}}

1. העלה קבצים JSON להמרה
1. המתן מספר שניות או יותר בהתאם לגודל JSON
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. JSON יומר למסמך EPUB
1. הורד את קובץ ה-EPUB שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-EPUB באמצעות Android Automation API" %}}
...
4. שמור את המסמך בפורמט EPUB בשיטת [Save](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions))



{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של JSON ל-EPUB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת JSON ל-EPUB עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את JSON ל-EPUB דרישות האפליקציה" %}}
