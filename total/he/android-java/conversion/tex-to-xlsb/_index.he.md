---
title: המרה מקוונת של TEX ל-XLSB או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-XLSB. קוד ספריית ההמרות של Android עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-XLSB וקוד אנדרואיד להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא של TEX מבוססת אנדרואיד.  המר קבצי TEX בודדים או מרובים ל-XLSB ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TEX ל-XLSB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ל-XLSB עם תכונות אחרות.
