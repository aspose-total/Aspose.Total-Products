---
title: פתח אפליקציה מבוססת אנדרואיד להמרת קבצי EPUB
description: המר קבצי EPUB ל-TXT באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי EPUB" h2="פתח אפליקציית המרה וייצוא של EPUB מבוססת אנדרואיד.  המר קבצי EPUB בודדים או מרובים ל-TXT ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את EPUB ל-TXT באמצעות Android Automation API" %}}


1. פתח קובץ EPUB באמצעות מחלקת [Document](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document)
2. המר EPUB ל-XLSX באמצעות שיטת [save](https://reference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-com.aspose.pdf.SaveOptions-)
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של EPUB ל-TXT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת EPUB ל-TXT עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את EPUB ל-TXT דרישות האפליקציה" %}}
