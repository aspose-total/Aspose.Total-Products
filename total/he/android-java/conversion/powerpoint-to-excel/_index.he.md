---
title: המרה מקוונת של PowerPoint ל-Excel או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PowerPoint
description: אפליקציה מקוונת בחינם להמרת קבצי PowerPoint ל-Excel. קוד ספריית ההמרות של Android עבור מסמכי PowerPoint.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PowerPoint ל-Excel וקוד אנדרואיד להמרת קבצי PowerPoint" h2="פתח אפליקציית המרה וייצוא של PowerPoint מבוססת אנדרואיד.  המר קבצי PowerPoint בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PowerPoint באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PowerPoint ל-Excel באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PowerPoint ל-Excel" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PowerPoint ל-Excel עם תכונות אחרות.
