---
title: המרה מקוונת של TEX ל-CSV או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-CSV. קוד ספריית ההמרות של Android עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-CSV וקוד אנדרואיד להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא של TEX מבוססת אנדרואיד.  המר קבצי TEX בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-CSV באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TEX ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ל-CSV עם תכונות אחרות.
