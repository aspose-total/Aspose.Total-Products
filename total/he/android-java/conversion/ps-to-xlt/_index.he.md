...
description: המר קבצי PS ל-XLT באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי PS" h2="פתח אפליקציית המרה וייצוא של PS מבוססת אנדרואיד.  המר קבצי PS בודדים או מרובים ל-XLT ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PS ל-XLT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PS ל-XLT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PS ל-XLT עם תכונות אחרות.
