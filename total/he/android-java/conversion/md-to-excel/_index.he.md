...
description: המר קבצי MD ל-Excel באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי MD" h2="פתח אפליקציית המרה וייצוא של MD מבוססת אנדרואיד.  המר קבצי MD בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-Excel באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MD ל-Excel" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ל-Excel עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MD ל-Excel דרישות האפליקציה" %}}
