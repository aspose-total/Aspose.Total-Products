...
description: המר קבצי CGM ל-Excel באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי CGM" h2="פתח אפליקציית המרה וייצוא של CGM מבוססת אנדרואיד.  המר קבצי CGM בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-Excel באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של CGM ל-Excel" offSpacer="" %}}
...
עוד כמה מקרים לשמירת CGM ל-Excel עם תכונות אחרות.
