---
title: המרה מקוונת של DOCM ל-PPSX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-PPSX. קוד ספריית ההמרות של Android עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-PPSX וקוד אנדרואיד להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא של DOCM מבוססת אנדרואיד.  המר קבצי DOCM בודדים או מרובים ל-PPSX ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-PPSX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOCM ל-PPSX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCM ל-PPSX עם תכונות אחרות.
