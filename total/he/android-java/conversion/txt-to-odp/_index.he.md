---
title: המרה מקוונת של TXT ל-ODP או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי TXT
description: אפליקציה מקוונת בחינם להמרת קבצי TXT ל-ODP. קוד ספריית ההמרות של Android עבור מסמכי TXT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TXT ל-ODP וקוד אנדרואיד להמרת קבצי TXT" h2="פתח אפליקציית המרה וייצוא של TXT מבוססת אנדרואיד.  המר קבצי TXT בודדים או מרובים ל-ODP ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי TXT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-TXT ל-ODP" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odp&from=txt" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של TXT ל-ODP באמצעות אפליקציה" %}}

1. העלה קבצים TXT להמרה
1. המתן מספר שניות או יותר בהתאם לגודל TXT
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. TXT יומר למסמך ODP
1. הורד את קובץ ה-ODP שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את TXT ל-ODP באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של TXT ל-ODP" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TXT ל-ODP עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את TXT ל-ODP דרישות האפליקציה" %}}
