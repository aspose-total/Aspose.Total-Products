---
title: המרה מקוונת של RTF ל-ODP או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי RTF
description: אפליקציה מקוונת בחינם להמרת קבצי RTF ל-ODP. קוד ספריית ההמרות של Android עבור מסמכי RTF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של RTF ל-ODP וקוד אנדרואיד להמרת קבצי RTF" h2="פתח אפליקציית המרה וייצוא של RTF מבוססת אנדרואיד.  המר קבצי RTF בודדים או מרובים ל-ODP ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי RTF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-RTF ל-ODP" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odp&from=rtf" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של RTF ל-ODP באמצעות אפליקציה" %}}

1. העלה קבצים RTF להמרה
1. המתן מספר שניות או יותר בהתאם לגודל RTF
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. RTF יומר למסמך ODP
1. הורד את קובץ ה-ODP שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את RTF ל-ODP באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של RTF ל-ODP" offSpacer="" %}}
...
עוד כמה מקרים לשמירת RTF ל-ODP עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את RTF ל-ODP דרישות האפליקציה" %}}
