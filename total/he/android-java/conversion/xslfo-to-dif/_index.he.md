---
title: המרה מקוונת של XSLFO ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XSLFO ל-DIF וקוד אנדרואיד להמרת קבצי XSLFO" h2="פתח אפליקציית המרה וייצוא של XSLFO מבוססת אנדרואיד.  המר קבצי XSLFO בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי XSLFO באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-XSLFO ל-DIF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dif&from=xslfo" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של XSLFO ל-DIF באמצעות אפליקציה" %}}

1. העלה קבצים XSLFO להמרה
1. המתן מספר שניות או יותר בהתאם לגודל XSLFO
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. XSLFO יומר למסמך DIF
1. הורד את קובץ ה-DIF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-DIF באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של XSLFO ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XSLFO ל-DIF עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את XSLFO ל-DIF דרישות האפליקציה" %}}
