---
title: המרה מקוונת של PCL ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-DIF וקוד אנדרואיד להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא של PCL מבוססת אנדרואיד.  המר קבצי PCL בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-DIF באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PCL ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ל-DIF עם תכונות אחרות.
