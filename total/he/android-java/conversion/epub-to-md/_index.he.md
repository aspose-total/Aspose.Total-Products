...
description: המר קבצי EPUB ל-MD באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי EPUB" h2="פתח אפליקציית המרה וייצוא של EPUB מבוססת אנדרואיד.  המר קבצי EPUB בודדים או מרובים ל-MD ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את EPUB ל-MD באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של EPUB ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת EPUB ל-MD עם תכונות אחרות.
