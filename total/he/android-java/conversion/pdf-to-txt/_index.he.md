---
title: המרה מקוונת של PDF ל-TXT או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-TXT. קוד ספריית ההמרות של Android עבור מסמכי PDF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PDF ל-TXT וקוד אנדרואיד להמרת קבצי PDF" h2="פתח אפליקציית המרה וייצוא של PDF מבוססת אנדרואיד.  המר קבצי PDF בודדים או מרובים ל-TXT ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PDF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-TXT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PDF ל-TXT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PDF ל-TXT עם תכונות אחרות.
