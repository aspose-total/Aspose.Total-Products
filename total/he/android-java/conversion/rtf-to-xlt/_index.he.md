---
title: המרה מקוונת של RTF ל-XLT או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי RTF
description: אפליקציה מקוונת בחינם להמרת קבצי RTF ל-XLT. קוד ספריית ההמרות של Android עבור מסמכי RTF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של RTF ל-XLT וקוד אנדרואיד להמרת קבצי RTF" h2="פתח אפליקציית המרה וייצוא של RTF מבוססת אנדרואיד.  המר קבצי RTF בודדים או מרובים ל-XLT ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי RTF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את RTF ל-XLT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של RTF ל-XLT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת RTF ל-XLT עם תכונות אחרות.
