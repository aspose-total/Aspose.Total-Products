---
title: המרה מקוונת של DOTX ל-PPTX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-PPTX. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTX ל-PPTX וקוד אנדרואיד להמרת קבצי DOTX" h2="פתח אפליקציית המרה וייצוא של DOTX מבוססת אנדרואיד.  המר קבצי DOTX בודדים או מרובים ל-PPTX ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOTX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-PPTX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-PPTX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-PPTX עם תכונות אחרות.
