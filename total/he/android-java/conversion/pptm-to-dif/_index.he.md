---
title: המרה מקוונת של PPTM ל-DIF או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PPTM
description: אפליקציה מקוונת בחינם להמרת קבצי PPTM ל-DIF. קוד ספריית ההמרות של Android עבור מסמכי PPTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPTM ל-DIF וקוד אנדרואיד להמרת קבצי PPTM" h2="פתח אפליקציית המרה וייצוא של PPTM מבוססת אנדרואיד.  המר קבצי PPTM בודדים או מרובים ל-DIF ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PPTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-PPTM ל-DIF" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=dif&from=pptm" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של PPTM ל-DIF באמצעות אפליקציה" %}}

1. העלה קבצים PPTM להמרה
1. המתן מספר שניות או יותר בהתאם לגודל PPTM
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. PPTM יומר למסמך DIF
1. הורד את קובץ ה-DIF שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את PPTM ל-DIF באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PPTM ל-DIF" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPTM ל-DIF עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את PPTM ל-DIF דרישות האפליקציה" %}}
