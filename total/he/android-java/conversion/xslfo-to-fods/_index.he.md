---
title: המרה מקוונת של XSLFO ל-FODS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-FODS. קוד ספריית ההמרות של Android עבור מסמכי XSLFO.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XSLFO ל-FODS וקוד אנדרואיד להמרת קבצי XSLFO" h2="פתח אפליקציית המרה וייצוא של XSLFO מבוססת אנדרואיד.  המר קבצי XSLFO בודדים או מרובים ל-FODS ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי XSLFO באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-FODS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של XSLFO ל-FODS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XSLFO ל-FODS עם תכונות אחרות.
