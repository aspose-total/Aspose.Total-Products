---
title: המרה מקוונת של DOTX ל-PPS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-PPS. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-PPS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-PPS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-PPS עם תכונות אחרות.
