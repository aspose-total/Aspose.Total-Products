---
title: המרה מקוונת של PPSX ל-MHTML או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PPSX
description: אפליקציה מקוונת בחינם להמרת קבצי PPSX ל-MHTML. קוד ספריית ההמרות של Android עבור מסמכי PPSX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPSX ל-MHTML וקוד אנדרואיד להמרת קבצי PPSX" h2="פתח אפליקציית המרה וייצוא של PPSX מבוססת אנדרואיד.  המר קבצי PPSX בודדים או מרובים ל-MHTML ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PPSX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPSX ל-MHTML באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PPSX ל-MHTML" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPSX ל-MHTML עם תכונות אחרות.
