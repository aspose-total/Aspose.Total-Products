---
title: המרה מקוונת של XML ל-XLAM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי XML
description: אפליקציה מקוונת בחינם להמרת קבצי XML ל-XLAM. קוד ספריית ההמרות של Android עבור מסמכי XML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של XML ל-XLAM וקוד אנדרואיד להמרת קבצי XML" h2="פתח אפליקציית המרה וייצוא של XML מבוססת אנדרואיד.  המר קבצי XML בודדים או מרובים ל-XLAM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי XML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XML ל-XLAM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של XML ל-XLAM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XML ל-XLAM עם תכונות אחרות.
