---
title: המרה מקוונת של DOTX ל-POT או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTX
description: אפליקציה מקוונת בחינם להמרת קבצי DOTX ל-POT. קוד ספריית ההמרות של Android עבור מסמכי DOTX.  
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-DOTX ל-POT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=pot&from=dotx" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של DOTX ל-POT באמצעות אפליקציה" %}}

1. העלה קבצים DOTX להמרה
1. המתן מספר שניות או יותר בהתאם לגודל DOTX
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. DOTX יומר למסמך POT
1. הורד את קובץ ה-POT שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את DOTX ל-POT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTX ל-POT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTX ל-POT עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את DOTX ל-POT דרישות האפליקציה" %}}
