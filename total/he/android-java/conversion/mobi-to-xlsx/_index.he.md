---
title: המרה מקוונת של MOBI ל-XLSX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-XLSX. קוד ספריית ההמרות של Android עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-XLSX וקוד אנדרואיד להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא של MOBI מבוססת אנדרואיד.  המר קבצי MOBI בודדים או מרובים ל-XLSX ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-XLSX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MOBI ל-XLSX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MOBI ל-XLSX עם תכונות אחרות.
