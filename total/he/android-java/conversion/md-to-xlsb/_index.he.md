...
description: המר קבצי MD ל-XLSB באמצעות ספריית ההמרות של אנדרואיד.  
...
{{< blocks/products/pf/feature-page-header h1="קוד אנדרואיד להמרת קבצי MD" h2="פתח אפליקציית המרה וייצוא של MD מבוססת אנדרואיד.  המר קבצי MD בודדים או מרובים ל-XLSB ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד." >}}

{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-XLSB באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MD ל-XLSB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ל-XLSB עם תכונות אחרות.
