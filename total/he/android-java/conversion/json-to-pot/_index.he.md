---
title: המרה מקוונת של JSON ל-POT או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-POT. קוד ספריית ההמרות של Android עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-POT באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של JSON ל-POT" offSpacer="" %}}
...
עוד כמה מקרים לשמירת JSON ל-POT עם תכונות אחרות.
