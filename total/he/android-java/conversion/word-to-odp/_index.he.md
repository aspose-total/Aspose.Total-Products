---
title: המרה מקוונת של Word ל-ODP או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי Word
description: אפליקציה מקוונת בחינם להמרת קבצי Word ל-ODP. קוד ספריית ההמרות של Android עבור מסמכי Word.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של Word ל-ODP וקוד אנדרואיד להמרת קבצי Word" h2="פתח אפליקציית המרה וייצוא של Word מבוססת אנדרואיד.  המר קבצי Word בודדים או מרובים ל-ODP ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי Word באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-Word ל-ODP" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odp&from=doc" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של Word ל-ODP באמצעות אפליקציה" %}}

1. העלה קבצים Word להמרה
1. המתן מספר שניות או יותר בהתאם לגודל Word
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. Word יומר למסמך ODP
1. הורד את קובץ ה-ODP שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את Word ל-ODP באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של Word ל-ODP" offSpacer="" %}}
...
עוד כמה מקרים לשמירת Word ל-ODP עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את Word ל-ODP דרישות האפליקציה" %}}
