---
title: המרה מקוונת של DOTM ל-XLSX או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOTM
description: אפליקציה מקוונת בחינם להמרת קבצי DOTM ל-XLSX. קוד ספריית ההמרות של Android עבור מסמכי DOTM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOTM ל-XLSX וקוד אנדרואיד להמרת קבצי DOTM" h2="פתח אפליקציית המרה וייצוא של DOTM מבוססת אנדרואיד.  המר קבצי DOTM בודדים או מרובים ל-XLSX ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOTM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOTM ל-XLSX באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOTM ל-XLSX" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOTM ל-XLSX עם תכונות אחרות.
