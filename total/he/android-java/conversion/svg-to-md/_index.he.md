---
title: המרה מקוונת של SVG ל-MD או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי SVG
description: אפליקציה מקוונת בחינם להמרת קבצי SVG ל-MD. קוד ספריית ההמרות של Android עבור מסמכי SVG.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את SVG ל-MD באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של SVG ל-MD" offSpacer="" %}}
...
עוד כמה מקרים לשמירת SVG ל-MD עם תכונות אחרות.
