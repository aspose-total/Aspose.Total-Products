---
title: המרה מקוונת של DOCX ל-Excel או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOCX
description: אפליקציה מקוונת בחינם להמרת קבצי DOCX ל-Excel. קוד ספריית ההמרות של Android עבור מסמכי DOCX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCX ל-Excel וקוד אנדרואיד להמרת קבצי DOCX" h2="פתח אפליקציית המרה וייצוא של DOCX מבוססת אנדרואיד.  המר קבצי DOCX בודדים או מרובים ל-Excel ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOCX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCX ל-Excel באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOCX ל-Excel" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCX ל-Excel עם תכונות אחרות.
