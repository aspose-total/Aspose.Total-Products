---
title: המרה מקוונת של ODT ל-XLSM או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי ODT
description: אפליקציה מקוונת בחינם להמרת קבצי ODT ל-XLSM. קוד ספריית ההמרות של Android עבור מסמכי ODT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODT ל-XLSM וקוד אנדרואיד להמרת קבצי ODT" h2="פתח אפליקציית המרה וייצוא של ODT מבוססת אנדרואיד.  המר קבצי ODT בודדים או מרובים ל-XLSM ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי ODT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את ODT ל-XLSM באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של ODT ל-XLSM" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ODT ל-XLSM עם תכונות אחרות.
