---
title: המרה מקוונת של JSON ל-FLATOPC או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-FLATOPC. קוד ספריית ההמרות של Android עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של JSON ל-FLATOPC" offSpacer="" %}}
...
עוד כמה מקרים לשמירת JSON ל-FLATOPC עם תכונות אחרות.
