---
title: המרה מקוונת של DOCM ל-Powerpoint או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-Powerpoint. קוד ספריית ההמרות של Android עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-Powerpoint וקוד אנדרואיד להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא של DOCM מבוססת אנדרואיד.  המר קבצי DOCM בודדים או מרובים ל-Powerpoint ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-Powerpoint באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של DOCM ל-Powerpoint" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCM ל-Powerpoint עם תכונות אחרות.
