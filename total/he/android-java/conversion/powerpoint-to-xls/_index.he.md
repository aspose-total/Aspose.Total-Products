---
title: המרה מקוונת של PowerPoint ל-XLS או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PowerPoint
description: אפליקציה מקוונת בחינם להמרת קבצי PowerPoint ל-XLS. קוד ספריית ההמרות של Android עבור מסמכי PowerPoint.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PowerPoint ל-XLS וקוד אנדרואיד להמרת קבצי PowerPoint" h2="פתח אפליקציית המרה וייצוא של PowerPoint מבוססת אנדרואיד.  המר קבצי PowerPoint בודדים או מרובים ל-XLS ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PowerPoint באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PowerPoint ל-XLS באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PowerPoint ל-XLS" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PowerPoint ל-XLS עם תכונות אחרות.
