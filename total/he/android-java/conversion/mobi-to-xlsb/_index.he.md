---
title: המרה מקוונת של MOBI ל-XLSB או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי MOBI
description: אפליקציה מקוונת בחינם להמרת קבצי MOBI ל-XLSB. קוד ספריית ההמרות של Android עבור מסמכי MOBI.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MOBI ל-XLSB וקוד אנדרואיד להמרת קבצי MOBI" h2="פתח אפליקציית המרה וייצוא של MOBI מבוססת אנדרואיד.  המר קבצי MOBI בודדים או מרובים ל-XLSB ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי MOBI באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MOBI ל-XLSB באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MOBI ל-XLSB" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MOBI ל-XLSB עם תכונות אחרות.
