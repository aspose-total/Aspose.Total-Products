---
title: המרה מקוונת של MHTML ל-CSV או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי MHTML
description: אפליקציה מקוונת בחינם להמרת קבצי MHTML ל-CSV. קוד ספריית ההמרות של Android עבור מסמכי MHTML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של MHTML ל-CSV וקוד אנדרואיד להמרת קבצי MHTML" h2="פתח אפליקציית המרה וייצוא של MHTML מבוססת אנדרואיד.  המר קבצי MHTML בודדים או מרובים ל-CSV ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי MHTML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
<iframe title="אפליקציית המרות מקוונת בחינם מ-MHTML ל-CSV" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=csv&from=mhtml" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="המר קבצים מקוונים של MHTML ל-CSV באמצעות אפליקציה" %}}

1. העלה קבצים MHTML להמרה
1. המתן מספר שניות או יותר בהתאם לגודל MHTML
1. עקוב אחר שורת הסטטוס של העלאה
1. לחץ על כפתור "המר".
1. MHTML יומר למסמך CSV
1. הורד את קובץ ה-CSV שהומר

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MHTML ל-CSV באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של MHTML ל-CSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MHTML ל-CSV עם תכונות אחרות.
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את MHTML ל-CSV דרישות האפליקציה" %}}
