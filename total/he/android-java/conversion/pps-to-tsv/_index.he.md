---
title: המרה מקוונת של PPS ל-TSV או פיתוח אפליקציה מבוססת אנדרואיד להמרת קבצי PPS
description: אפליקציה מקוונת בחינם להמרת קבצי PPS ל-TSV. קוד ספריית ההמרות של Android עבור מסמכי PPS.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PPS ל-TSV וקוד אנדרואיד להמרת קבצי PPS" h2="פתח אפליקציית המרה וייצוא של PPS מבוססת אנדרואיד.  המר קבצי PPS בודדים או מרובים ל-TSV ולפורמטים אחרים באמצעות API של אוטומציה של אנדרואיד. המר באופן חופשי קבצי PPS באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PPS ל-TSV באמצעות Android Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="קוד אנדרואיד עבור המרה של PPS ל-TSV" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PPS ל-TSV עם תכונות אחרות.
