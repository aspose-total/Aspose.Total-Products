---
title: המרה CGM ל-TSV באמצעות יישום C++
description: המרת קבצי CGM ל-TSV באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את CGM ל-TSV באמצעות C++" h2="פתח אפליקציית המרה וייצוא של CGM רבת עוצמה מבוססת C++.  המר קבצי CGM בודדים או מרובים ל-TSV ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-TSV באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את CGM ל-TSV באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת CGM ב-TSV עם תכונות אחרות כמו Get or Set CGM File Information via C++, Save TSV File Format to Stream via C++.
