---
title: המרה מקוונת של MHTML ל-MD או פיתוח יישום C++ להמרת קבצי MHTML
description: אפליקציה מקוונת בחינם להמרת קבצי MHTML ל-MD. קוד ספריית המרות C++ עבור מסמכי MHTML.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את MHTML ל-MD באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את MHTML ל-MD באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MHTML ב-MD עם תכונות אחרות כמו Get or Set MHTML File Information via C++, Save MD File Format to Stream via C++.
