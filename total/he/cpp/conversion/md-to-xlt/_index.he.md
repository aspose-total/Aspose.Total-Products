---
title: המרה MD ל-XLT באמצעות יישום C++
description: המרת קבצי MD ל-XLT באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את MD ל-XLT באמצעות C++" h2="פתח אפליקציית המרה וייצוא של MD רבת עוצמה מבוססת C++.  המר קבצי MD בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-XLT באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את MD ל-XLT באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ב-XLT עם תכונות אחרות כמו Get or Set MD File Information via C++, Save XLT File Format to Stream via C++.
