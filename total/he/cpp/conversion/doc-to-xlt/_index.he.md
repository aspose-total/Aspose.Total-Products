---
title: המרה מקוונת של DOC ל-XLT או פיתוח יישום C++ להמרת קבצי DOC
description: אפליקציה מקוונת בחינם להמרת קבצי DOC ל-XLT. קוד ספריית המרות C++ עבור מסמכי DOC.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOC ל-XLT וקוד C++ להמרת קבצי DOC" h2="פתח אפליקציית המרה וייצוא של DOC רבת עוצמה מבוססת C++. המר קבצי DOC בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי DOC באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOC ל-XLT באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DOC ל-XLT באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOC ב-XLT עם תכונות אחרות כמו Access DOC Document Properties via C++, Save XLT File to Stream via C++.
