---
title: המרה מקוונת של PDF ל-MD או פיתוח יישום C++ להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-MD. קוד ספריית המרות C++ עבור מסמכי PDF.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-MD באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PDF ל-MD באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PDF ב-MD עם תכונות אחרות כמו Get or Set PDF File Information via C++, Save MD File Format to Stream via C++.
