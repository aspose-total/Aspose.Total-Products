---
title: המרה CGM ל-XLSB באמצעות יישום C++
description: המרת קבצי CGM ל-XLSB באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את CGM ל-XLSB באמצעות C++" h2="פתח אפליקציית המרה וייצוא של CGM רבת עוצמה מבוססת C++.  המר קבצי CGM בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-XLSB באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את CGM ל-XLSB באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת CGM ב-XLSB עם תכונות אחרות כמו Get or Set CGM File Information via C++, Save XLSB File Format to Stream via C++.
