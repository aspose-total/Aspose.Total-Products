---
title: המרה מקוונת של JSON ל-PCL או פיתוח יישום C++ להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-PCL. קוד ספריית המרות C++ עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-PCL באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את JSON ל-PCL באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת JSON ב-PCL עם תכונות אחרות כמו Set Layout & Convert JSON Format to PCL in C++, Convert JSON Format to PCL with Watermark in C++.
