---
title: המרה מקוונת של DOCM ל-XLSB או פיתוח יישום C++ להמרת קבצי DOCM
description: אפליקציה מקוונת בחינם להמרת קבצי DOCM ל-XLSB. קוד ספריית המרות C++ עבור מסמכי DOCM.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של DOCM ל-XLSB וקוד C++ להמרת קבצי DOCM" h2="פתח אפליקציית המרה וייצוא של DOCM רבת עוצמה מבוססת C++. המר קבצי DOCM בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי DOCM באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את DOCM ל-XLSB באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את DOCM ל-XLSB באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת DOCM ב-XLSB עם תכונות אחרות כמו Access DOCM Document Properties via C++, Save XLSB File to Stream via C++.
