---
title: המרה CGM ל-DIF באמצעות יישום C++
description: המרת קבצי CGM ל-DIF באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את CGM ל-DIF באמצעות C++" h2="פתח אפליקציית המרה וייצוא של CGM רבת עוצמה מבוססת C++.  המר קבצי CGM בודדים או מרובים ל-DIF ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את CGM ל-DIF באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את CGM ל-DIF באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת CGM ב-DIF עם תכונות אחרות כמו Get or Set CGM File Information via C++, Save DIF File Format to Stream via C++.
