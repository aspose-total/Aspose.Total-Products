---
title: המרה מקוונת של TEX ל-MD או פיתוח יישום C++ להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-MD. קוד ספריית המרות C++ עבור מסמכי TEX.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-MD באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את TEX ל-MD באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת TEX ב-MD עם תכונות אחרות כמו Get or Set TEX File Information via C++, Save MD File Format to Stream via C++.
