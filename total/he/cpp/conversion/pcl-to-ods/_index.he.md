---
title: המרה מקוונת של PCL ל-ODS או פיתוח יישום C++ להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-ODS. קוד ספריית המרות C++ עבור מסמכי PCL.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PCL ל-ODS וקוד C++ להמרת קבצי PCL" h2="פתח אפליקציית המרה וייצוא של PCL רבת עוצמה מבוססת C++. המר קבצי PCL בודדים או מרובים ל-ODS ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי PCL באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-ODS באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PCL ל-ODS באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ב-ODS עם תכונות אחרות כמו Get or Set PCL File Information via C++, Save ODS File Format to Stream via C++.
