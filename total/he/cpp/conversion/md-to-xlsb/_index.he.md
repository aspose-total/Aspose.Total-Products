---
title: המרה MD ל-XLSB באמצעות יישום C++
description: המרת קבצי MD ל-XLSB באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את MD ל-XLSB באמצעות C++" h2="פתח אפליקציית המרה וייצוא של MD רבת עוצמה מבוססת C++.  המר קבצי MD בודדים או מרובים ל-XLSB ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את MD ל-XLSB באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את MD ל-XLSB באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת MD ב-XLSB עם תכונות אחרות כמו Get or Set MD File Information via C++, Save XLSB File Format to Stream via C++.
