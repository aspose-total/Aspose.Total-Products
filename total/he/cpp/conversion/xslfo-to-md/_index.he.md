---
title: המרה מקוונת של XSLFO ל-MD או פיתוח יישום C++ להמרת קבצי XSLFO
description: אפליקציה מקוונת בחינם להמרת קבצי XSLFO ל-MD. קוד ספריית המרות C++ עבור מסמכי XSLFO.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את XSLFO ל-MD באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את XSLFO ל-MD באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת XSLFO ב-MD עם תכונות אחרות כמו Get or Set XSLFO File Information via C++, Save MD File Format to Stream via C++.
