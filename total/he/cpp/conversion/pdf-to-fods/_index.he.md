---
title: המרה מקוונת של PDF ל-FODS או פיתוח יישום C++ להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-FODS. קוד ספריית המרות C++ עבור מסמכי PDF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PDF ל-FODS וקוד C++ להמרת קבצי PDF" h2="פתח אפליקציית המרה וייצוא של PDF רבת עוצמה מבוססת C++. המר קבצי PDF בודדים או מרובים ל-FODS ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי PDF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-FODS באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PDF ל-FODS באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PDF ב-FODS עם תכונות אחרות כמו Get or Set PDF File Information via C++, Save FODS File Format to Stream via C++.
