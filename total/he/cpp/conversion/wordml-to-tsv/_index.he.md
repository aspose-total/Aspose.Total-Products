---
title: המרה מקוונת של WORDML ל-TSV או פיתוח יישום C++ להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-TSV. קוד ספריית המרות C++ עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-TSV וקוד C++ להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא של WORDML רבת עוצמה מבוססת C++. המר קבצי WORDML בודדים או מרובים ל-TSV ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-TSV באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את WORDML ל-TSV באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת WORDML ב-TSV עם תכונות אחרות כמו Access WORDML Document Properties via C++, Save TSV File to Stream via C++.
