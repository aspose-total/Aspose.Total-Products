---
title: המרה מקוונת של ODT ל-XLT או פיתוח יישום C++ להמרת קבצי ODT
description: אפליקציה מקוונת בחינם להמרת קבצי ODT ל-XLT. קוד ספריית המרות C++ עבור מסמכי ODT.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של ODT ל-XLT וקוד C++ להמרת קבצי ODT" h2="פתח אפליקציית המרה וייצוא של ODT רבת עוצמה מבוססת C++. המר קבצי ODT בודדים או מרובים ל-XLT ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי ODT באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את ODT ל-XLT באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את ODT ל-XLT באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת ODT ב-XLT עם תכונות אחרות כמו Access ODT Document Properties via C++, Save XLT File to Stream via C++.
