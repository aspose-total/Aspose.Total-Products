---
title: המרה מקוונת של JSON ל-ODP או פיתוח יישום C++ להמרת קבצי JSON
description: אפליקציה מקוונת בחינם להמרת קבצי JSON ל-ODP. קוד ספריית המרות C++ עבור מסמכי JSON.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את JSON ל-ODP באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את JSON ל-ODP באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת JSON ב-ODP עם תכונות אחרות כמו Set Layout and Convert JSON Format to ODP via C++, Convert JSON Format to ODP with Watermark in C++.
