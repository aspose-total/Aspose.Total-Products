---
title: המרה מקוונת של PCL ל-MD או פיתוח יישום C++ להמרת קבצי PCL
description: אפליקציה מקוונת בחינם להמרת קבצי PCL ל-MD. קוד ספריית המרות C++ עבור מסמכי PCL.  
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PCL ל-MD באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PCL ל-MD באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PCL ב-MD עם תכונות אחרות כמו Get or Set PCL File Information via C++, Save MD File Format to Stream via C++.
