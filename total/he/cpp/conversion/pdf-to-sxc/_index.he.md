---
title: המרה מקוונת של PDF ל-SXC או פיתוח יישום C++ להמרת קבצי PDF
description: אפליקציה מקוונת בחינם להמרת קבצי PDF ל-SXC. קוד ספריית המרות C++ עבור מסמכי PDF.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של PDF ל-SXC וקוד C++ להמרת קבצי PDF" h2="פתח אפליקציית המרה וייצוא של PDF רבת עוצמה מבוססת C++. המר קבצי PDF בודדים או מרובים ל-SXC ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי PDF באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את PDF ל-SXC באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את PDF ל-SXC באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת PDF ב-SXC עם תכונות אחרות כמו Get or Set PDF File Information via C++, Save SXC File Format to Stream via C++.
