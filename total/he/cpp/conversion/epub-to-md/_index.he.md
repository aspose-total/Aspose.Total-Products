---
title: המרה EPUB ל-MD באמצעות יישום C++
description: המרת קבצי EPUB ל-MD באמצעות קוד ספריית ההמרות של C++.  
...
{{< blocks/products/pf/feature-page-header h1="המר את EPUB ל-MD באמצעות C++" h2="פתח אפליקציית המרה וייצוא של EPUB רבת עוצמה מבוססת C++.  המר קבצי EPUB בודדים או מרובים ל-MD ופורמטים אחרים באמצעות API של אוטומציה של C++.  " >}}


{{< blocks/products/pf/agp/feature-section >}}

{{% blocks/products/pf/agp/feature-section-col title="המר את EPUB ל-MD באמצעות C++ Automation API" %}}
...
4. שמור את המסמך בפורמט MD באמצעות פונקציית חבר [Save](https://reference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997)



{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="המר את EPUB ל-MD באמצעות C++" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="שומר את EPUB ל-MD דרישות האפליקציה" %}}
