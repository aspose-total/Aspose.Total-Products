---
title: המרה מקוונת של TEX ל-SXC או פיתוח יישום C++ להמרת קבצי TEX
description: אפליקציה מקוונת בחינם להמרת קבצי TEX ל-SXC. קוד ספריית המרות C++ עבור מסמכי TEX.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של TEX ל-SXC וקוד C++ להמרת קבצי TEX" h2="פתח אפליקציית המרה וייצוא של TEX רבת עוצמה מבוססת C++. המר קבצי TEX בודדים או מרובים ל-SXC ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי TEX באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את TEX ל-SXC באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את TEX ל-SXC באמצעות C++" offSpacer="" %}}
