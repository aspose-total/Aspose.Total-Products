---
title: המרה מקוונת של WORDML ל-Excel או פיתוח יישום C++ להמרת קבצי WORDML
description: אפליקציה מקוונת בחינם להמרת קבצי WORDML ל-Excel. קוד ספריית המרות C++ עבור מסמכי WORDML.  
...
{{< blocks/products/pf/feature-page-header h1="אפליקציית המרה מקוונת של WORDML ל-Excel וקוד C++ להמרת קבצי WORDML" h2="פתח אפליקציית המרה וייצוא של WORDML רבת עוצמה מבוססת C++. המר קבצי WORDML בודדים או מרובים ל-Excel ופורמטים אחרים באמצעות API של אוטומציה של C++. המר באופן חופשי קבצי WORDML באופן מקוון באמצעות אפליקציה עם הורדה מיידית." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="המר את WORDML ל-Excel באמצעות C++ Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="המר את WORDML ל-Excel באמצעות C++" offSpacer="" %}}
...
עוד כמה מקרים לשמירת WORDML ב-Excel עם תכונות אחרות כמו Access WORDML Document Properties via C++, Save EXCEL File to Stream via C++.
