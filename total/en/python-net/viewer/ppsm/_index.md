---
title: View PPSM File Online and Load or Open PPSM File using Python
description: Free online PPSM file viewer app. Python API code to load and open PPSM file for viewer application.
...
{{< blocks/products/pf/feature-page-header-widget h1="Freely View PPSM File Online and Open or Load Document via Python" h2="Develop powerful Python based PPSM document viewer utility application. Code listed to load or open PPSM document through Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Load or Open PPSM File via Python for Viewer App" %}}

1. Reference APIs within the project directly from PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/)) 
1. Create Presentation class object and load source PPSM file using it.
...
1. And use subprocess.run to invoke the browser to view PPSM file.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Code example in Python to view PPSM Files" offSpacer="" %}}
...
<h2>Develop PPSM File Viewer Application via Python</h2>

Need to develop a PPSM viewer app or utility? With [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/) a child API of [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), any python developer can integrate the above API code within its document viewer application. Powerful Python library allows programming any document display solution that can support many popular formats including PPSM format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python utility to process PPSM file for display app" %}}
