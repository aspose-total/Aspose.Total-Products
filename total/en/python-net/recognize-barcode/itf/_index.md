---
title: Recognize ITF BarCode Images via Python
description: Scan ITF symbology barcode images using Python applications without using any other software. 
...
{{% blocks/products/pf/agp/code-block title="Recognize ITF Symbology BarCode in Python" offSpacer="" %}}
