---
title: Recognize MATRIX2OF5 BarCode Images via Python
description: Scan MATRIX2OF5 symbology barcode images using Python applications without using any other software. 
...
- For MATRIX2OF5 Barcode scanning, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Recognize MATRIX2OF5 Symbology BarCode in Python" offSpacer="" %}}
