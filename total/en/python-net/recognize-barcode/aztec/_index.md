---
title: Recognize AZTEC BarCode Images via Python
description: Scan AZTEC symbology barcode images using Python applications without using any other software. 
...
- For AZTEC Barcode scanning, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Recognize AZTEC Symbology BarCode in Python" offSpacer="" %}}
