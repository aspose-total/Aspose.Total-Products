---
title: Recognize CODEBLOCK BarCode Images via Python
description: Scan CODEBLOCK symbology barcode images using Python applications without using any other software. 
...
- For CODEBLOCK Barcode scanning, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Recognize CODEBLOCK Symbology BarCode in Python" offSpacer="" %}}
