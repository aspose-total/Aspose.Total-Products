---
title: Recognize DATAMATRIX BarCode Images via Python
description: Scan DATAMATRIX symbology barcode images using Python applications without using any other software. 
...
- For DATAMATRIX Barcode scanning, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Recognize DATAMATRIX Symbology BarCode in Python" offSpacer="" %}}
