---
title: Recognize RM4SCC BarCode Images via Python
description: Scan RM4SCC symbology barcode images using Python applications without using any other software. 
...
- For RM4SCC Barcode scanning, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Recognize RM4SCC Symbology BarCode in Python" offSpacer="" %}}
