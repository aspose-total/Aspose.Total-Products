---
title: Recognize PLANET BarCode Images via Python
description: Scan PLANET symbology barcode images using Python applications without using any other software. 
...
{{% blocks/products/pf/agp/code-block title="Recognize PLANET Symbology BarCode in Python" offSpacer="" %}}
