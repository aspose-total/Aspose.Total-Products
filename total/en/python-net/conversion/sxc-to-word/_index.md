---
title: Convert SXC to WORD using Python
description: SXC to WORD conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert SXC to WORD via Python" h2="SXC to WORD conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
