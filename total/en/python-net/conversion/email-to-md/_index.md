---
title: Convert EMAIL to MD in Python
description: Save EMAIL to MD in your Python applications without using Microsoft Outlook or Word 
...
{{< blocks/products/pf/feature-page-header h1="Convert EMAIL to MD using Python" h2="EMAIL to MD conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/code-block title="Save EMAIL To MD in Python" offSpacer="" %}}
