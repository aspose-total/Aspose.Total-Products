---
title: Convert PPSX to TSV using Python
description: PPSX to TSV conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to TSV via Python" h2="PPSX to TSV conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
