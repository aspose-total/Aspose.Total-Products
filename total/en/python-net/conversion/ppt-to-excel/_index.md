---
title: Convert PPT to EXCEL using Python
description: PPT to EXCEL conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to EXCEL via Python" h2="PPT to EXCEL conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
