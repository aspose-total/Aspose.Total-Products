---
title: Convert DIF to DOTX using Python
description: DIF to DOTX conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert DIF to DOTX via Python" h2="DIF to DOTX conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
