---
title: Convert DOC to EXCEL using Python or with free Online Converter
...
For a Python developer, who is trying to add a DOC to EXCEL conversion feature within application. [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API can help to automate the conversion process. It's a full package of various APIs dealing different formats.
...
- For DOC to EXCEL conversion, Python 3.5 or later is required
