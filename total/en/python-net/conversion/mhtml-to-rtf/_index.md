---
title: Convert MHTML to RTF in Python
description: MHTML and HtmlFixed to RTF conversion in your Python applications without using Microsoft Word 
url: /python-net/conversion/mhtml-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MHTML
...
{{< blocks/products/pf/feature-page-header h1="Convert MHTML to RTF using Python" h2="MHTML to RTF conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert MHTML to RTF in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Save MHTML To RTF in Python" offSpacer="" %}}
