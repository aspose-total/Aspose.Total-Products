---
title: Convert DOCM to CSV using Python
description: DOCM to CSV conversion in your Python applications without using Microsoft Word or Excel 
...
{{< blocks/products/pf/feature-page-header h1="Convert DOCM to CSV via Python" h2="DOCM to CSV conversion in your Python applications without installing Microsoft Word<sup>&reg;</sup> or Excel" >}}
