---
title: Convert XLSM to DOTM using Python
description: XLSM to DOTM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert XLSM to DOTM via Python" h2="XLSM to DOTM conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
