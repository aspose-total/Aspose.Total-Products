---
title: Convert PPTX to XLSX using Python
description: PPTX to XLSX conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to XLSX via Python" h2="PPTX to XLSX conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
