...
{{% blocks/products/pf/feature-page-section  h2="Email to Word, PDF, HTML and Images Conversion" %}}
For Email files converson to PDF, Word, Images and HTML, Email Python API [Aspose.Email for Python via .NET](https://products.aspose.com/email/python-net/) performs the conversion. API load the source file in its object model and invoke the Save method with relevant parameters. 

{{% blocks/products/pf/feature-page-code h3="Python - Email Files to Word Conversion" %}}
