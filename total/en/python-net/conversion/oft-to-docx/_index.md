---
title: Convert OFT to DOCX in Python
description: Save OFT to DOCX in your Python applications without using Microsoft Outlook or Word 
...
{{< blocks/products/pf/feature-page-header h1="Convert OFT to DOCX using Python" h2="OFT to DOCX conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
The conversion process is a two step process. Firstly, the Email needs to be loaded and rendered into HTML using the "Aspose.Email for Python via .NET" API. Secondly, the HTML needs to be loaded using the "Aspose.Words for Python via .NET" API and saved into the respective Word DOCX format. 
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert OFT to DOCX in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Save OFT To DOCX in Python" offSpacer="" %}}
