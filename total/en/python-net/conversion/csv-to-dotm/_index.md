---
title: Convert CSV to DOTM using Python
description: CSV to DOTM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert CSV to DOTM via Python" h2="CSV to DOTM conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
