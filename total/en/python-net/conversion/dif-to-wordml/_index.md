---
title: Convert DIF to WORDML using Python
description: DIF to WORDML conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert DIF to WORDML via Python" h2="DIF to WORDML conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
