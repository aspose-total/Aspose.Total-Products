---
title: Convert XLSB to ODT using Python
description: XLSB to ODT conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert XLSB to ODT via Python" h2="XLSB to ODT conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
