---
title: Convert POTM to CSV using Python
description: POTM to CSV conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert POTM to CSV via Python" h2="POTM to CSV conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
