...
{{< blocks/products/pf/feature-page-header h1="Convert XLSB to DOT via Python or online" h2="XLSB to DOT conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
