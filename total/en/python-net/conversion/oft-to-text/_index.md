---
title: Convert OFT to TEXT in Python
description: Save OFT to TEXT in your Python applications without using Microsoft Outlook or Word 
...
{{< blocks/products/pf/feature-page-header h1="Convert OFT to TEXT using Python" h2="OFT to TEXT conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/code-block title="Save OFT To TEXT in Python" offSpacer="" %}}
