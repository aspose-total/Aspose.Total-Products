---
title: Convert DIF to DOT using Python
description: DIF to DOT conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert DIF to DOT via Python" h2="DIF to DOT conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
