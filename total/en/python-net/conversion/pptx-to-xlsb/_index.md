---
title: Convert PPTX to XLSB using Python
description: PPTX to XLSB conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to XLSB via Python" h2="PPTX to XLSB conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
