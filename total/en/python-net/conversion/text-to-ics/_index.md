...
url: /python-net/conversion/text-to-ics/
family: total
platformtag: Python
feature: conversion
informat: TEXT
...
{{< blocks/products/pf/feature-page-header h1="Convert TEXT to ICS using Python" h2="TEXT to ICS conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/code-block title="Save TEXT To ICS in Python" offSpacer="" %}}
