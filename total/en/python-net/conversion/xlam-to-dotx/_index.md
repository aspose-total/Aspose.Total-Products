---
title: Convert XLAM to DOTX using Python
description: XLAM to DOTX conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert XLAM to DOTX via Python" h2="XLAM to DOTX conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
