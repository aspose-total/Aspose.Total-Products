---
title: Convert PPS to XLSX using Python or with free Online Converter
description: PPS to XLSX conversion in your Python applications without using Microsoft Office or online. Test free PPS to XLSX online converter quickly before integrating the code. 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPS to XLSX via Python or Online App" h2="PPS to XLSX conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPS to XLSX in Python" %}}
...
- For PPS to XLSX conversion, Python 3.5 or later is required
