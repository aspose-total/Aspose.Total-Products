---
title: Convert FODS to DOCM using Python
description: FODS to DOCM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert FODS to DOCM via Python" h2="FODS to DOCM conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
