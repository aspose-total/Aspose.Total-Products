---
title: Convert PPTX to EXCEL using Python or with free Online Converter
description: PPTX to EXCEL conversion in your Python applications without using Microsoft Office or online. Test free PPTX to EXCEL online converter quickly before integrating the code. 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to EXCEL via Python or Online App" h2="PPTX to EXCEL conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPTX to EXCEL in Python" %}}
...
-  Call the `save` method while specifying output EXCEL file path. So your PPTX file is converted to EXCEL at the specified path

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Conversion Requirements" %}}

- For PPTX to EXCEL conversion, Python 3.5 or later is required
