---
title: Convert PPTX to XLSM using Python
description: PPTX to XLSM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to XLSM via Python" h2="PPTX to XLSM conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
