---
title: Convert POTX to XLS using Python or with free Online Converter
description: POTX to XLS conversion in your Python applications without using Microsoft Office or online. Test free POTX to XLS online converter quickly before integrating the code. 
...
{{< blocks/products/pf/feature-page-header h1="Convert POTX to XLS via Python or Online App" h2="POTX to XLS conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert POTX to XLS in Python" %}}
...
- For POTX to XLS conversion, Python 3.5 or later is required
