---
title: Convert DOCM to MHTML in Python
description: DOCM to mhtml Web archive format and HtmlFixed file conversion in your Python applications without using Microsoft Word 
url: /python-net/conversion/docm-to-mhtml/
family: total
platformtag: Python
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Convert DOCM to MHTML using Python" h2="DOCM to MHTML, HtmlFixed and HTML conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOCM to MHTML in Python" %}}
...
- Call the `save` method while specifying output file path & SaveFormat as parameters. So your DOCM file is converted to MHTML at the specified path.
...
{{% blocks/products/pf/agp/code-block title="Save DOCM To MHTML in Python - Simple" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title="DOCM To MHTML Conversion in Python" offSpacer="" %}}
