---
title: Convert POTX to XLSX using Python
description: POTX to XLSX conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert POTX to XLSX via Python" h2="POTX to XLSX conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
