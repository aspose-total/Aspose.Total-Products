---
title: Convert PPT to CSV using Python
description: PPT to CSV conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to CSV via Python" h2="PPT to CSV conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
