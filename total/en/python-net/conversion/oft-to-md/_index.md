---
title: Convert OFT to MD in Python
description: Save OFT to MD in your Python applications without using Microsoft Outlook or Word 
url: /python-net/conversion/oft-to-md/
family: total
platformtag: Python
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="Convert OFT to MD using Python" h2="OFT to MD conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert OFT to MD in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Save OFT To MD in Python" offSpacer="" %}}
