---
title: Convert POT to XLSB using Python
description: POT to XLSB conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert POT to XLSB via Python" h2="POT to XLSB conversion in your Python applications without installing Microsoft PowerPoint<sup>&reg;</sup> or Excel" >}}
