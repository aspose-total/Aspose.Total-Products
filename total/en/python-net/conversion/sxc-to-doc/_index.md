---
title: Convert SXC to DOC using Python
description: SXC to DOC conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert SXC to DOC via Python" h2="SXC to DOC conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
