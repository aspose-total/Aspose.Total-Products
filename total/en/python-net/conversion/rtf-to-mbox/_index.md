---
title: Convert RTF to MBOX in Python
description: Save RTF to MBOX within Python applications without using Microsoft Word or Outlook
...
{{< blocks/products/pf/feature-page-header h1="Convert RTF to MBOX using Python" h2="RTF to MBOX conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/code-block title="Save RTF To MBOX in Python" offSpacer="" %}}
