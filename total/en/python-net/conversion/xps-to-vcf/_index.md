---
title: Convert XPS to VCF in Python
description: Save XPS to VCF within Python applications without using Microsoft Word or Outlook
...
{{< blocks/products/pf/feature-page-header h1="Convert XPS to VCF using Python" h2="XPS to VCF conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}

{{% blocks/products/pf/feature-page-summary %}}


<h2>Why to Convert XPS to VCF?</h2>
...
{{% blocks/products/pf/agp/code-block title="Save XPS To VCF in Python" offSpacer="" %}}
