---
title: Convert XLSM to DOCM using Python
description: XLSM to DOCM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert XLSM to DOCM via Python" h2="XLSM to DOCM conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
