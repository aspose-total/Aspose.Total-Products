---
title: Convert XLAM to DOTM using Python
description: XLAM to DOTM conversion in your Python applications without using Microsoft Office 
...
{{< blocks/products/pf/feature-page-header h1="Convert XLAM to DOTM via Python" h2="XLAM to DOTM conversion in your Python applications without installing Microsoft Excel<sup>&reg;</sup> or Word" >}}
