---
title: Convert RTF to MSG in Python
description: Save RTF to MSG within Python applications without using Microsoft Word or Outlook
...
{{< blocks/products/pf/feature-page-header h1="Convert RTF to MSG using Python" h2="RTF to MSG conversion in your Python Applications without installing Microsoft Word<sup>&reg;</sup> or Outlook." >}}
...
{{% blocks/products/pf/agp/code-block title="Save RTF To MSG in Python" offSpacer="" %}}
