---
title: Generate AUSTRALIAPOST BarCode Images via Python
description: Create AUSTRALIAPOST symbology BarCode Images using Python applications without using any other software. 
...
- For AUSTRALIAPOST barcode creation, Python 3.5 or later is required
...
{{% blocks/products/pf/agp/code-block title="Generate AUSTRALIAPOST Symbology BarCode in Python" offSpacer="" %}}
