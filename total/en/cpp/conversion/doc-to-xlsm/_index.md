...
description: C++ API to Convert DOC to XLSM without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOC to XLSM" h2="Export DOC to XLSM via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
