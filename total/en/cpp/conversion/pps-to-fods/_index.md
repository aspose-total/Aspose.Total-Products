---
title: Convert PPS to FODS via C++ 
description: Export PPS to FODS in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPS to FODS via C++" h2="PPS  to FODS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
1. Open PPS file using [Presentation](https://apireference.aspose.com/slides/cpp/class/aspose.slides.presentation) class reference
2. Convert PPS to HTML by using [Save](https://apireference.aspose.com/slides/cpp/class/aspose.slides.presentation#a06fe2a156063c8c3e5ada2713bb697ba) method
