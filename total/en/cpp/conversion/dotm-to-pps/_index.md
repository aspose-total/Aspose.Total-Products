...
description: Export DOTM to PPS in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTM to PPS" h2="Export DOTM to PPS within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
