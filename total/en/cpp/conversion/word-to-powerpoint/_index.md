...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORD to POWERPOINT" h2="Export WORD to POWERPOINT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
