---
title: C++ API to Convert XSLFO to SXC
description: Convert XSLFO to SXC via C++ API without using Microsoft Excel or Adobe Reader
url_ignore: /cpp/conversion/xslfo-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: XSLFO
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert XSLFO to SXC" %}}
1. Open XSLFO file using [Document](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document) class reference
2. Convert XSLFO to XLSX by using [Save](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document#a6383c010776212483f51cc41235924db) member function
