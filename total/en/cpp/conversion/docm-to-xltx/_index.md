...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCM to XLTX" h2="Export DOCM to XLTX via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
