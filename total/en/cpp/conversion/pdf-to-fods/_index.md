---
title: C++ API to Convert PDF to FODS
description: Convert PDF to FODS via C++ API without using Microsoft Excel or Adobe Reader
url_ignore: /cpp/conversion/pdf-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PDF
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert PDF to FODS" %}}
...
4. Save the document to FODS format using [Save](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a9460f52a2dec8f4bf623a4905167d997) member function
