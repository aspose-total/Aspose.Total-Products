...
description: Export DOCM to POTX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCM to POTX" h2="Export DOCM to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
