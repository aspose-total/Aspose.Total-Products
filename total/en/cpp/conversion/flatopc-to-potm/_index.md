...
description: Export FLATOPC to POTM in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert FLATOPC to POTM" h2="Export FLATOPC to POTM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
