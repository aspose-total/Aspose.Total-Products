...
description: Export DOTM to PPSM in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTM to PPSM" h2="Export DOTM to PPSM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
