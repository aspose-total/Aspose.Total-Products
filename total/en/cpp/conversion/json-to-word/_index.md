---
title: Convert JSON Format to WORD via C++ 
description: C++ API t0 Parse JSON to WORD without using Microsoft Word
url_ignore: /cpp/conversion/json-to-word/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="Convert JSON Format to WORD in C++" %}}
...
call SetText method and pass watermark text & object of TextWatermarkOptions. After adding the watermark, you can save the document to WORD.
{{% blocks/products/pf/feature-page-code %}}
