...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOC to PPT" h2="Export DOC to PPT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
