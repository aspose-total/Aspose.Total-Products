...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert EPUB to CSV" %}}
1. Open EPUB file using [Document](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document) class reference
2. Convert EPUB to XLSX by using [Save](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document#a6383c010776212483f51cc41235924db) member function
