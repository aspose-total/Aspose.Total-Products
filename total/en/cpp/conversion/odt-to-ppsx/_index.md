...
description: Export ODT to PPSX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert ODT to PPSX" h2="Export ODT to PPSX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
