...
{{% blocks/products/pf/agp/feature-section-col title="Convert JSON Format to FLATOPC in C++" %}}
...
4. Save the document to FLATOPC format using [Save](https://apireference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) method
...
call SetText method and pass watermark text & object of TextWatermarkOptions. After adding the watermark, you can save the document to FLATOPC.
{{% blocks/products/pf/feature-page-code %}}
