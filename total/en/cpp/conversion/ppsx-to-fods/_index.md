---
title: Convert PPSX to FODS via C++ 
description: Export PPSX to FODS in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to FODS via C++" h2="PPSX  to FODS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
