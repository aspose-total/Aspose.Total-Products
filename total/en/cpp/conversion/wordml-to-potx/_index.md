...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORDML to POTX" h2="Export WORDML to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
