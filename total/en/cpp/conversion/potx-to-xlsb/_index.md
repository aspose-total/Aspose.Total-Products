...
description: Export POTX to XLSB in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert POTX to XLSB via C++" h2="POTX  to XLSB File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
