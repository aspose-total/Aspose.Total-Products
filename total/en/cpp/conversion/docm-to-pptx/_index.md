...
description: Export DOCM to PPTX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCM to PPTX" h2="Export DOCM to PPTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
