---
title: Convert WORDML to XLAM in C++
description: C++ API to Convert WORDML to XLAM without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORDML to XLAM" h2="Export WORDML to XLAM via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
