---
title: Convert PPTX to ODS via C++ 
description: Export PPTX to ODS in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to ODS via C++" h2="PPTX  to ODS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
