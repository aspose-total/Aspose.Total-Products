...
description: Export DOCM to ODP in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOCM to ODP" h2="Export DOCM to ODP within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
