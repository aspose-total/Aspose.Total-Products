...
description: Export DOTX to POTM in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to POTM" h2="Export DOTX to POTM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
