---
title: Convert PPTX to DIF via C++ 
description: Export PPTX to DIF in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to DIF via C++" h2="PPTX  to DIF File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
