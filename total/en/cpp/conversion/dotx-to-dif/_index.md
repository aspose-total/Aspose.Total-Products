...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to DIF" h2="Export DOTX to DIF via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
