---
title: Convert TXT to POTX via C++
description: Export TXT to POTX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert TXT to POTX" h2="Export TXT to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
...
6. Save the document to POTX format using [Save](https://apireference.aspose.com/slides/cpp/class/aspose.slides.presentation#afcd59ec697bf05c10f78c3869de2ec9e) method and set Potx as SaveFormat
