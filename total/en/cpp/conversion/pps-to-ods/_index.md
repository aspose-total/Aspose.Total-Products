---
title: Convert PPS to ODS via C++ 
description: Export PPS to ODS in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPS to ODS via C++" h2="PPS  to ODS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
