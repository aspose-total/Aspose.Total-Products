...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOC to POWERPOINT" h2="Export DOC to POWERPOINT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
