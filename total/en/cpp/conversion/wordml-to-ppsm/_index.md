...
description: Export WORDML to PPSM in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORDML to PPSM" h2="Export WORDML to PPSM within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
