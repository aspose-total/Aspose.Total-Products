...
{{< blocks/products/pf/feature-page-header h1="Convert POWERPOINT to DIF via C++" h2="POWERPOINT  to DIF File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
4. Save the document to DIF format using [Save](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e) method
