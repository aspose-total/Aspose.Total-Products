...
description: Export FLATOPC to PPS in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert FLATOPC to PPS" h2="Export FLATOPC to PPS within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
