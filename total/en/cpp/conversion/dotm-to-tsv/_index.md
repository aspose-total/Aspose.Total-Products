...
description: C++ API to Convert DOTM to TSV without using using Microsoft Word or Microsoft Excel
url: /cpp/conversion/dotm-to-tsv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTM to TSV" h2="Export DOTM to TSV via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert DOTM to TSV" %}}
