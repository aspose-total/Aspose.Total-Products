...
description: Export DOTM to POTX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTM to POTX" h2="Export DOTM to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
