---
title: Convert POTM to DIF via C++ 
description: Export POTM to DIF in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert POTM to DIF via C++" h2="POTM  to DIF File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
