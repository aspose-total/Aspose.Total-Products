...
description: C++ API to Convert DOTX to FODS without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to FODS" h2="Export DOTX to FODS via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
