...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert EMAIL to RTF" %}}
...
4. Save the document to RTF format using [Save](https://apireference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) method and set Rtf as SaveFormat
