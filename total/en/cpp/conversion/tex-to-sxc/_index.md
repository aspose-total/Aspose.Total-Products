---
title: C++ API to Convert TEX to SXC
description: Convert TEX to SXC via C++ API without using Microsoft Excel or Adobe Reader
url_ignore: /cpp/conversion/tex-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: TEX
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Convert TEX to SXC" %}}
1. Open TEX file using [Document](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document) class reference
2. Convert TEX to XLSX by using [Save](https://apireference.aspose.com/pdf/cpp/class/aspose.pdf.document#a6383c010776212483f51cc41235924db) member function
