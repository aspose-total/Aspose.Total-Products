...
description: Convert EPUB to WORDML within C++ applications.
url_ignore: /cpp/conversion/epub-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API to Render EPUB to WORDML" %}}
...
In the process of rendering EPUB to WORDML, you can open a password protected EPUB and also change its password. In order to change the password of a EPUB file, you must know the owner password of that document. You can load password protected PDF document with [Aspose.PDF for C++](https://products.aspose.com/pdf/cpp/) by specifying its owner password and use ChangePasswords method to change the password.
{{% blocks/products/pf/feature-page-code %}}
```cpp
