...
description: Export WORD to POT in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORD to POT" h2="Export WORD to POT within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
