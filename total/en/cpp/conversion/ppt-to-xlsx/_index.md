...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to XLSX via C++" h2="PPT  to XLSX File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
