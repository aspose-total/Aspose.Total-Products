...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORD to POTX" h2="Export WORD to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
