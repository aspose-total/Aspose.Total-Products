...
description: Export DOTX to POTX in your C++ applications without using Microsoft Word of PowerPoint 
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to POTX" h2="Export DOTX to POTX within your C++ applications without using Microsoft Word&reg; or PowerPoint" >}}
