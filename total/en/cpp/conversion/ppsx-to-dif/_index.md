...
description: Export PPSX to DIF in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to DIF via C++" h2="PPSX  to DIF File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
