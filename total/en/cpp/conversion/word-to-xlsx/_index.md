...
description: C++ API to Convert WORD to XLSX without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORD to XLSX" h2="Export WORD to XLSX via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
