---
title: Convert POTX to TSV via C++ 
description: Export POTX to TSV in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert POTX to TSV via C++" h2="POTX  to TSV File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
...
4. Save the document to TSV format using [Save](https://apireference.aspose.com/cells/cpp/class/aspose.cells.i_workbook#a5dc7de23f7ceba76a05dc1d49f51502e) method
