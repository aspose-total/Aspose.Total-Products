...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTM to DIF" h2="Export DOTM to DIF via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
