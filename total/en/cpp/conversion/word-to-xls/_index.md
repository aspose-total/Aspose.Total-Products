...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert WORD to XLS" h2="Export WORD to XLS via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
...
2. Convert WORD to HTML by using [Save](https://apireference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) member function
