...
{{< blocks/products/pf/feature-page-header h1="C++ API to Convert DOTX to EXCEL" h2="Export DOTX to EXCEL via C++ without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
