...
description: Export PPTX to XLS in C++ without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to XLS via C++" h2="PPTX  to XLS File Conversion via C++ without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
