---
title: Update XLS File using C++
description: Modify XLS document in C++ applications without using Microsoft Excel.
family: total
platformtag: C++
feature: update
informat: XLS
...
- For XLS modification, following [system requirements](https://docs.aspose.com/cells/cpp/system-requirements/) for Windows and Linux systems 
...
{{% blocks/products/pf/agp/code-block title="Code - Update XLS File in C++" offSpacer="" %}}
