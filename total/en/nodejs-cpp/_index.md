---
title: PDF Manipulation and OCR Addition via Node.js APIs
description: Node.js API to manipulate PDF files as well as extract text from images via applications.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API for PDF and Image Text Extraction" h2="Extract text from Images as well as include PDF manipulation features within Node.js applications without any other software dependencies" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ is an all-inclusive set of Node.js libraries. These libraries offer functionalities like working directly with PDFs and enhancing your applications for turning images into text.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ includes the following Node.js libraries:" >}}
...
<h2 class="pr-ft">
 ...
 Overview of Node.js via C++ Libraries
</h2>
   <p>
   </p>
<div class="col-lg-4">
