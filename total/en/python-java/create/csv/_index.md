...
{{< blocks/products/pf/feature-page-header h1="Create CSV File Via Python" h2="Generate Excel CSV Files via your Python Applications without installing Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Create CSV File via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Create CSV File using Python" offSpacer="" %}}
