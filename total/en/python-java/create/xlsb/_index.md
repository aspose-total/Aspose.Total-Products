---
title: Create XLSB in Python
description: Generate XLSB file using Python applications without using Microsoft Office. 
...
{{< blocks/products/pf/feature-page-header h1="Create XLSB using Python" h2="Generate XLSB via your Python Applications without installing Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/code-block title="Create XLSB in Python" offSpacer="" %}}
