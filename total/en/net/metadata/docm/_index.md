---
title: View and Update DOCM Properties Online or Update metadata using .NET
description: View and modify DOCM properties through online app for free. .NET API code to update DOCM properties.
family: total
platformtag: net
feature: Metadata
informat: DOCM
...
hero:
  h1: View or Update DOCM Metadata Online or Update via .NET
  h2: Develop powerful .NET based DOCM document metadata management utility application. Code listed for updating DOCM file metadata through .NET.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: View or Update DOCM Metadata Online
      items:
      - Import DOCM file by uploading it.
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Update DOCM Properties via .NET
      items:
      - Load DOCM file using Document class.
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: '.NET Code: Update DOCM metadata'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: '#### 📝 Use Cases for Word Macro-Enabled Document (`.docm`)
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOCM Metadata Management Application via .NET


        Need to develop a DOCM Metadata management app or utility? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) a child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code within its document metadata application. Powerful .NET library allows programming any document metadata solution. Moreover it can support many popular formats including DOCM format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: .NET Utility to Manage DOCM Metadata
...
- type: faq
  ...
  - question: Is it safe to use the online app to manage DOCM document properties?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOCM document properties management. However, if you're developing a desktop application, we recommend using the Aspose.Total document processing API for efficient management.
- type: autogen_total
---
