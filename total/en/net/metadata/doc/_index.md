...
{{< blocks/products/pf/feature-page-header-widget h1="View or Update DOC Metadata Online or Update via .NET" h2="Develop powerful .NET based DOC document metadata management utility application. Code listed for updating DOC file metadata through .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Update DOC Properties via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code: Update DOC metadata" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Utility to Manage DOC Metadata" %}}
