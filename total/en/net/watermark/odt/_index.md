...
{{< blocks/products/pf/feature-page-header-widget h1="Watermark ODT File Online via Watermarking App and via .NET applications" h2="Develop powerful .NET based ODT document Watermarking applications. Freely Watermark various documents including ODT files online via app with instant download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Watermark ODT File via .NET" %}}

1. Load file the via Document class object
1. Create TextWatermarkOptions class object
1. Set options like font, color, layout
1. Use SetText for text based watermark text
1. Call Save method and get the Watermarked ODT file
1. In case of Image Watermark, Use ImageWatermarkOptions and SetImage method

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Add Text Watermark ODT Files" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C# Code : Add Image Watermark to ODT Files" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to Watermark ODT file using .NET. Use Aspose ODT Watermarking API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
