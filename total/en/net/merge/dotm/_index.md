---
title: Merge DOTM Files Online or using .NET
description: Free online app to combine different DOTM files. .NET merging library code to merge DOTM documents.
family: total
platformtag: net
feature: Merge
informat: DOTM
...
hero:
  h1: Merge DOTM Documents Online via Merger App or using .NET
  h2: Develop powerful .NET based DOTM document merging application. Combine multiple DOTM documents into single one online for free via app. Save DOTM file as PDF, Images, Word, Excel, PowerPoint & many other formats online.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Merge DOTM Files Online using App
      items:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: '.NET Code: Merge DOTM Files'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOTM File Merger using .NET


        Need to develop .NET utility app to easily merge multiple DOTM files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program merging app across documents. Powerful .NET library for merging documents supports many popular formats including DOTM format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: .NET Merger Library for DOTM Files
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to combine DOTM using .NET. Use Aspose DOTM merging API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to combine multiple DOTM documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOTM document merging.
  - question: How can I merge multiple DOTM files?
    answer: Start by uploading one or more files you want to merge. You can either drag and drop your DOTM files or simply click inside the white area. Afterward, click the 'Merge' button, and our merger will quickly process the uploaded files.
  - question: How long does it take to merge the DOTM files?
