...
{{% blocks/products/pf/agp/feature-section-col title="Merge ODT File via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code: Merge ODT Files" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to combine ODT using .NET. Use Aspose ODT merging API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
