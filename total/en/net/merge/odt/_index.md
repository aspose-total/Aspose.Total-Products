---
title: Merge ODT Files Online or using .NET
description: Free online app to combine different ODT files. .NET merging library code to merge ODT documents.
family: total
platformtag: net
feature: Merge
informat: ODT
...
hero:
  h1: Merge ODT Documents Online via Merger App or using .NET
  h2: Develop powerful .NET based ODT document merging application. Combine multiple ODT documents into single one online for free via app. Save ODT file as PDF, Images, Word, Excel, PowerPoint & many other formats online.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Merge ODT Files Online using App
      items:
      - Upload ODT files to merge them into single one
      - Enter the parameters like selection from dropdown
      - 'Save to required format: DOCX, DOC, PDF, XLSX, PPTX, Image, HTML, and others'
      - Click the "Merge" button to Merge ODT into desired format
      - Download the merged ODT file
      - View and get the single merged ODT file
  - width: 6
    blocks:
    - type: steps
      role: api
      title: Merge ODT File via .NET
      items:
      ...
      - Call Save method and get the merged ODT files into one
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code: Merge ODT Files'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop ODT File Merger using .NET


        Need to develop .NET utility app to easily merge multiple ODT files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program merging app across documents. Powerful .NET library for merging documents supports many popular formats including ODT format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: .NET Merger Library for ODT Files
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to combine ODT using .NET. Use Aspose ODT merging API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to combine multiple ODT documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online ODT document merging.
  - question: How can I merge multiple ODT files?
    answer: Start by uploading one or more files you want to merge. You can either drag and drop your ODT files or simply click inside the white area. Afterward, click the 'Merge' button, and our merger will quickly process the uploaded files.
  - question: How long does it take to merge the ODT files?
