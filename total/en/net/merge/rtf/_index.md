---
title: Merge RTF Files Online or using .NET
description: Free online app to combine different RTF files. .NET merging library code to merge RTF documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Merge RTF File via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code: Merge RTF Files" offSpacer="" %}}
...
Need to develop .NET utility app to easily merge multiple RTF files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program merging app across documents. Powerful .NET library for merging documents supports many popular formats including RTF format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library for RTF Files" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to combine RTF using .NET. Use Aspose RTF merging API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
