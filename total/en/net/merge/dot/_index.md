---
title: Merge DOT Files Online or using .NET
description: Free online app to combine different DOT files. .NET merging library code to merge DOT documents. 
...
{{< blocks/products/pf/feature-page-header-widget h1="Merge DOT Documents Online via Merger App or using .NET" h2="Develop powerful .NET based DOT document merging application. Combine multiple DOT documents into single one online for free via app. Save DOT file as PDF, Images, Word, Excel, PowerPoint & many other formats online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Merge DOT File via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code: Merge DOT Files" offSpacer="" %}}
...
Need to develop .NET utility app to easily merge multiple DOT files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program merging app across documents. Powerful .NET library for merging documents supports many popular formats including DOT format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library for DOT Files" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to combine DOT using .NET. Use Aspose DOT merging API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
