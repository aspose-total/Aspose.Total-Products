...
hero:
  h1: Merge Image Documents Online via Merger App or using .NET
  h2: Develop powerful .NET based Image document merging application. Combine multiple Image documents into single one online for free via app. Save merged Image file as PDF, Images, Word & many other formats online.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Merge Image Files Online using App
      items:
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Merge Image File via .NET
      items:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: '.NET Code: Merge Image Files'
      gist:
...
- layout: columns
  ...
  - width: 6
    blocks:
    - type: markdown
      title: .NET Merger Library for Image Files
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code and utilize it for the purpose of developing .NET-based applications focused on combining Image documents. One can develop professional solution to combine Image using .NET. Use our Image merging API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to combine multiple Image documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online Image document merging.
  - question: How can I merge multiple Image files?
    answer: Start by uploading one or more files you want to merge. You can either drag and drop your Image files or simply click inside the white area. Afterward, click the 'Merge' button, and our merger will quickly process the uploaded files.
  - question: How long does it take to merge the Image files?
