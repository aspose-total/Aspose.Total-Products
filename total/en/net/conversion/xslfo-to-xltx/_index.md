---
title: Convert XSLFO to XLTX via C# API
description: C# API to Convert XSLFO File to XLTX without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/xslfo-to-xltx/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert XSLFO to XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected XSLFO to XLTX via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert XSLFO File to XLTX with Watermark via C#" %}}
While converting XSLFO file to XLTX, you can also add watermark to your output XLTX file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as XLTX with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
