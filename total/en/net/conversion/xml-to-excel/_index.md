...
hero:
  h1: Convert XML to Excel via C#, .NET Core
  h2: Export XML to Excel formats via C# without using Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup>
sections:
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Why Convert XML to Excel formats?
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: How to Convert XML to Excel via C#?
      items:
      - Create an instance of the [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) class
      - Import XML into workbook using [ImportXml](https://reference.aspose.com/cells/net/aspose.cells/workbook/importxml/) method
      - Save Workbook as Excel file with SaveFormat as parameter for relevant format
  - width: 6
    blocks:
    - type: markdown
      title: XML to Excel Converter API for .NET Core
  ...
  - width: 12
    ...
    - type: code
      ...
      gist:
        user: aspose-com-gists
        id: e5efce39c7b6b48485533ae75ddb8694
        file: Convert-XML-to-Excel-CSharp_ConvertSpecificColumns.cs
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: markdown
      markdown: ''
      title: Sample XML and XSLT Files
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      ...
      gist:
        user: aspose-com-gists
        id: e5efce39c7b6b48485533ae75ddb8694
        file: Convert-XML-to-Excel-CSharp_Catalog.xml
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      ...
      gist:
        user: aspose-com-gists
        id: e5efce39c7b6b48485533ae75ddb8694
        file: Convert-XML-to-Excel-CSharp_CatalogXSLT.xslt
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: markdown
      markdown: 'XML (Extensible Markup Language) files are used to store structured data, making them ideal for creating semi-structured documents and configuration files. However, when working with dynamic data visualization and analysis capabilities, spreadsheets like Excel become essential.
      ...
      title: 'Transforming XML File to EXCEL Programmatically : Use Cases'
- type: autogen_total
---
