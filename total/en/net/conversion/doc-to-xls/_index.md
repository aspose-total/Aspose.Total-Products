...
{{< blocks/products/pf/feature-page-header h1="Convert DOC to XLS via C#" h2="Convert DOC to XLS via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
