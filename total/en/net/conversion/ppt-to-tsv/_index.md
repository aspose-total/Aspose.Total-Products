...
description: Convert PPT to TSV in C# without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPT to TSV via C#" h2=".NET API for PPT to TSV conversion without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
