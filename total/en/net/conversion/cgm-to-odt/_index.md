...
hero:
  h1: Render CGM to ODT via .NET
  h2: .NET API to Export CGM to ODT on Windows, macOS, and Linux without using Microsoft Word
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: C# API to Convert CGM to ODT
      items:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Converting CGM Files to ODT Formats is Necessary to Unlock the Full Potential of Your Document Visualization and Analysis Capabilities.
      ...
      title: 'Transforming CGM File to ODT Programmatically : Use Cases'
- type: autogen_total
---
