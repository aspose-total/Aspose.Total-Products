---
title: Convert XPS to JPEG2000 via C# API
description: Export XPS to JPEG2000 in your .NET applications without using any third party application 
url_ignore: /net/conversion/xps-to-jpeg2000/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS file to JPEG2000 via .NET" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert XPS File to JPEG2000 in a Single File via C#" %}}
Using the API, you can also convert XPS file to JPEG2000 to a single image file. In order to convert all pages, you can first render your XPS document to one TIFF file and after that you can export TIFF file to JPEG2000. You can open the input file using [Document](https://apireference.aspose.com/pdf/net/aspose.pdf/document) class and create Resolution, TiffSettings, & TIFF device objects. You can get a single TIFF image using [Process](https://apireference.aspose.com/pdf/net/aspose.pdf.devices.documentdevice/process/methods/3) method of [TiffDevice](https://apireference.aspose.com/pdf/net/aspose.pdf.devices/tiffdevice) class. Finally, you can load TIFF file using [Image](https://apireference.aspose.com/imaging/net/aspose.imaging/image) class 
...
{{% blocks/products/pf/feature-page-section  h2="Convert XPS to JPEG2000 With Watermark via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert & Rotate XPS File to JPEG2000 via C#" %}}
