...
description: C# API to Convert PS File to TSV without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/ps-to-tsv/
family: total
platformtag: net
feature: conversion
informat: PS
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PS to TSV via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert PS File to TSV with Watermark via C#" %}}
While converting PS file to TSV, you can also add watermark to your output TSV file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as TSV with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
