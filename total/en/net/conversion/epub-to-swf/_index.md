...
hero:
  h1: Render EPUB to SWF via .NET
  h2: .NET API to Export EPUB to SWF on Windows, macOS, and Linux without using Microsoft<sup>&reg;</sup> PowerPoint
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: .NET API to Convert EPUB to SWF
      items:
...
- layout: columns
  ...
  - width: 12
    ...
    - type: markdown
      ...
      title: 'Transforming EPUB File to SWF Programmatically : Use Cases'
- type: autogen_total
---
