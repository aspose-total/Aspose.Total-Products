---
title: Convert PCL to MD via C# API
description: C# API to Convert PCL File to MD without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/pcl-to-md/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert PCL to MD" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PCL to MD via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert PCL File to MD with Watermark via C#" %}}
While converting PCL file to MD, you can also add watermark to your output MD file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as MD with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
