---
title: Convert PPT to XLS via C# or with free Online Converter 
description: Convert PPT to XLS in C# without using Microsoft Excel or Powerpoint or online. Test free PPT to XLS online converter quickly before integrating the code. 
url_ignore: /net/conversion/ppt-to-xls/
family: total
platformtag: net
feature: conversion
informat: PPT
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert PPT to XLS via C# or Online App" %}}
...
For PPT file to XLS Conversion in C#, please install the API from the command line as ```nuget install Aspose.Total``` or via Package Manager Console of Visual Studio.
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PPT to XLS via C#" %}}
While converting PPT file to XLS, if your input PPT document is password protected you cannot convert it to XLS without decrypting the document. When your document is password protected, it means it enforces certain restrictions on the presentation. To remove the restrictions, the password has to be entered. A password-protected presentation is considered a locked presentation. The API allows you to open the encrypted document by passing the correct password in a LoadOptions object.
{{% blocks/products/pf/feature-page-code %}}
{{< gist "aspose-com-gists" "c67832c79481518ab87f3f0b311cb1cd" "convert-protected-powerpoint-to-excel.cs" >}}
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}

{{% blocks/products/pf/feature-page-section  h2="Convert PPT to XLS with Watermark via C#" %}}
While converting PPT file to XLS, you can also add watermark to your output XLS file format. In order to add a watermark, you can create a new Workbook object and open the converted HTML document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your HTML document as XLS with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Online App for PPT conversion is integrated above. To initiate the PPT to XLS conversion process, simply add the PPT file by either dragging and dropping it into the designated area or clicking on it to import the document. Next, click on the "Convert" button. Once the PPT to XLS conversion has been completed, you can download the converted file. With just a single click, you will receive your output XLS files.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
