...
description: C# API to Convert MD File to XLSB without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/md-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected MD to XLSB via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert MD File to XLSB with Watermark via C#" %}}
While converting MD file to XLSB, you can also add watermark to your output XLSB file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as XLSB with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
