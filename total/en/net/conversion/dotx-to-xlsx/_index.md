...
description: Convert DOTX to XLSX in C# without using Microsoft Excel or Adobe Reader
...
{{< blocks/products/pf/feature-page-header h1="Convert DOTX to XLSX via C#" h2="Convert DOTX to XLSX via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
