...
description: C# API to Convert XPS File to XLAM without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/xps-to-xlam/
family: total
platformtag: net
feature: conversion
informat: XPS
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected XPS to XLAM via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert XPS File to XLAM with Watermark via C#" %}}
