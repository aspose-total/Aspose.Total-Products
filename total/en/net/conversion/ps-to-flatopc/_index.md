...
hero:
  h1: Render PS to FLATOPC via .NET
  h2: .NET API to Export PS to FLATOPC on Windows, macOS, and Linux without using Microsoft Word
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: C# API to Convert PS to FLATOPC
      items:
...
- layout: columns
  ...
  - width: 12
    ...
    - type: markdown
      ...
      title: 'Transforming PS File to FLATOPC Programmatically : Use Cases'
- type: autogen_total
---
