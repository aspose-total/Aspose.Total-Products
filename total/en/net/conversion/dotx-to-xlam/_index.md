...
description: C# API to Convert DOTX to XLAM without using Microsoft Excel or Adobe Reader
...
{{< blocks/products/pf/feature-page-header h1="C# API to Convert DOTX to XLAM" h2="Export DOTX to XLAM via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
