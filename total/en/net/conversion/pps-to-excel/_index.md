...
description: Convert PPS to EXCEL in C# without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPS to EXCEL via C#" h2=".NET API for PPS to EXCEL conversion without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
