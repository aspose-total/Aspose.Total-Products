...
hero:
  h1: Render PS to MARKDOWN via .NET
  h2: .NET API to Export PS to MARKDOWN on Windows, macOS, and Linux without using Microsoft Word
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: C# API to Convert PS to MARKDOWN
      items:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: '**PS Format (Portable Document Format) files are used to store raster graphics information, making them ideal for creating static images and documents. However, when working with dynamic data, Markdown becomes essential for documentation and presentation.
      ...
      title: 'Transforming PS File to MARKDOWN Programmatically : Use Cases'
- type: autogen_total
---
