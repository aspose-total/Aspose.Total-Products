...
{{< blocks/products/pf/feature-page-header h1="Convert WORD to XLSB via C#" h2="Convert WORD to XLSB via C# without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
