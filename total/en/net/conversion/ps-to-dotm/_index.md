...
hero:
  h1: Render PS to DOTM via .NET
  h2: .NET API to Export PS to DOTM on Windows, macOS, and Linux without using Microsoft Word
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: C# API to Convert PS to DOTM
      items:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'The conversion of PS files into DOTM formats is necessary to unlock the full potential of your document editing and analysis capabilities. This conversion enables you to:
      ...
      title: 'Transforming PS File to DOTM Programmatically : Use Cases'
- type: autogen_total
---
