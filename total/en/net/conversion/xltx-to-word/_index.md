...
description: Convert XLTX to WORD on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLTX to WORD via C#" h2="Export Excel&reg; XLTX to WORD on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
...
1. Open XLTX file using [Workbook](https://apireference.aspose.com/cells/net/aspose.cells/workbook) class
