---
title: Convert CGM to XLTX via C# API
description: C# API to Convert CGM File to XLTX without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/cgm-to-xltx/
family: total
platformtag: net
feature: conversion
informat: CGM
outformat: XLTX
otherformats: EXCEL TXT ODS MD FODS SXC XLSB XLTM XLT TSV DIF CSV
---
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert CGM to XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected CGM to XLTX via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert CGM File to XLTX with Watermark via C#" %}}
While converting CGM file to XLTX, you can also add watermark to your output XLTX file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as XLTX with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
