...
description: Convert XLSB to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to DOCX via C#" h2="Export Excel&reg; XLSB to DOCX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
