...
description: Convert XLSB to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Convert XLSB to PPTX via C#" h2="Export Excel&reg; XLSB to PPTX on .NET Framework, .NET Core, Mono or Xamarin Platforms">}}
