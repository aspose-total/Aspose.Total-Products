---
title: Export XML to PPS via C# API
description: .NET API to Convert XML to PPS without using Microsoft Word
url_ignore: /net/conversion/xml-to-pps/
family: total
platformtag: net
feature: conversion
informat: XML
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert XML to PPS" %}}
...
4. Save the document to PPS format using [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) method and set `Pps` as SaveFormat
