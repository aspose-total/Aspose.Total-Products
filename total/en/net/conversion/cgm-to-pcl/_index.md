...
hero:
  h1: Render CGM to PCL via .NET
  h2: .NET API to Export CGM to PCL on Windows, macOS, and Linux without using Microsoft Word
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: C# API to Convert CGM to PCL
      items:
...
- layout: columns
  ...
  - width: 12
    ...
    - type: markdown
      ...
      title: 'Transforming CGM File to PCL Programmatically : Use Cases'
- type: autogen_total
---
