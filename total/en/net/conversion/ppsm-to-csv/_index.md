...
description: Convert PPSM to CSV in C# without using Microsoft Excel or Powerpoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSM to CSV via C#" h2=".NET API for PPSM to CSV conversion without using Microsoft<sup>&reg;</sup> Excel or PowerPoint" >}}
