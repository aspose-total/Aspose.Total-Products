...
description: C# API to Convert TEX File to SXC without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/tex-to-sxc/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected TEX to SXC via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert TEX File to SXC with Watermark via C#" %}}
While converting TEX file to SXC, you can also add watermark to your output SXC file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as SXC with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
