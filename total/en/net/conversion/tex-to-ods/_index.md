---
title: Convert TEX to ODS via C# API
description: C# API to Convert TEX File to ODS without using Microsoft Excel or Adobe Reader
url_ignore: /net/conversion/tex-to-ods/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API to Convert TEX to ODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected TEX to ODS via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert TEX File to ODS with Watermark via C#" %}}
While converting TEX file to ODS, you can also add watermark to your output ODS file format. In order to add a watermark, you can create a new Workbook object and open the converted XLSX document, select Worksheet via its index, create a Shape and use its AddTextEffect function. After that you can save your XLSX document as ODS with Watermark. 
{{% blocks/products/pf/feature-page-code %}}
