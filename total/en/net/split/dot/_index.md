---
title: Split DOT File Online or via .NET
description: Free online app to split different DOT files. .NET C# splitter library code for DOT documents.
family: total
platformtag: net
feature: Split
informat: DOT
...
hero:
  h1: Split DOT Files Online via Splitter App or using .NET
  h2: Develop powerful .NET based DOT document splitter applications. Freely split documents including DOT files online via app with instant download.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Split DOT Files Online using App
      items:
      - Upload DOT File to Split.
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Split DOT File via .NET
      items:
      - Load the DOT document using Document class.
      - Get total pages using Page Count.
      - Loop through each page and use ExtractPages to extract the page.
      - Save the extracted page into new DOT file.
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code : Split DOT Files Page Wise'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOT File Splitter Application using .NET


        Need to develop .NET script or utility app to easily split DOT files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/), child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program splitter app. Powerful .NET library for splitting document supports many popular formats including DOT format such as PDF, Word, Excel and PowerPoint files.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: DOT Splitter library for .NET
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to split DOT files using .NET. Use Aspose DOT splitter API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to Split multiple DOT documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOT document Splitter.
  - question: How long does it take to split the DOT files?
