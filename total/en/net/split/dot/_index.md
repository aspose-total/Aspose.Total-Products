...
{{< blocks/products/pf/feature-page-header-widget h1="Split DOT Files Online via Splitter App or using .NET" h2="Develop powerful .NET based DOT document splitter applications. Freely split documents including DOT files online via app with instant download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Split DOT File via .NET" %}}
...
1. Save the extracted page into new DOT file.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Split DOT Files Page Wise" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to split DOT files using .NET. Use Aspose DOT splitter API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
