...
hero:
  h1: Split DOTX Files Online via Splitter App or using .NET
  h2: Develop powerful .NET based DOTX document splitter applications. Freely split documents including DOTX files online via app with instant download.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Split DOTX Files Online using App
      items:
      - Upload DOTX File to Split.
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Split DOTX File via .NET
      items:
      - Load the DOTX document using Document class.
      - Get total pages using Page Count.
      - Loop through each page and use ExtractPages to extract the page.
      - Save the extracted page into new DOTX file.
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code : Split DOTX Files Page Wise'
      gist:
...
- layout: columns
  ...
  - width: 6
    blocks:
    - type: markdown
      title: DOTX Splitter library for .NET
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to split DOTX files using .NET. Use Aspose DOTX splitter API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to Split multiple DOTX documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOTX document Splitter.
  - question: How long does it take to split the DOTX files?
