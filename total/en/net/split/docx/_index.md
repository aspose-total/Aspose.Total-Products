...
hero:
  h1: Split DOCX Files Online via Splitter App or using .NET
  h2: Develop powerful .NET based DOCX document splitter applications. Freely split documents including DOCX files online via app with instant download.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Split DOCX Files Online using App
      items:
      - Upload DOCX File to Split.
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Split DOCX File via .NET
      items:
      - Load the DOCX document using Document class.
      - Get total pages using Page Count.
      - Loop through each page and use ExtractPages to extract the page.
      - Save the extracted page into new DOCX file.
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code : Split DOCX Files Page Wise'
      gist:
        user: aspose-com-gists
        id: 3b6d15a45dcf974c4ad761007e8a392e
        file: split-word-document-page-by-page.cs
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: markdown
      markdown: "#### .docx File — Use Cases for Document Splitting\n \n- Split modern Word documents for improved navigation and modular editing.  \n- Generate personalized documents from a master .docx file by extracting sections."
      role: summary
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    blocks:
    - type: markdown
      title: DOCX Splitter library for .NET
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to split DOCX files using .NET. Use Aspose DOCX splitter API to develop high-level, platform independent software in .NET.
  - question: Is this document Splitter App work only on Windows?
    answer: You have the flexibility to initiate document splitter from any device, irrespective of the operating system it runs on, whether it be Windows, Linux, Mac OS, or Android. All that's required is a contemporary web browser and an active internet connection.
  - question: Is it safe to use the online app to Split multiple DOCX documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOCX document Splitter.
  - question: How long does it take to split the DOCX files?
    answer: This splitter application operates quickly, It may take a few seconds to upload the files and Split them.
- type: autogen_total
---
