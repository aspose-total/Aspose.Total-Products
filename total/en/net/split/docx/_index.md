---
title: Split DOCX File Online or via .NET
description: Free online app to split different DOCX files. .NET C# splitter library code for DOCX documents. 
...
{{< blocks/products/pf/feature-page-header-widget h1="Split DOCX Files Online via Splitter App or using .NET" h2="Develop powerful .NET based DOCX document splitter applications. Freely split documents including DOCX files online via app with instant download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Split DOCX File via .NET" %}}

1. Load the DOCX document using Document class.
1. Get total pages using Page Count.
1. Loop through each page and use ExtractPages to extract the page.
1. Save the extracted page into new DOCX file.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Split DOCX Files Page Wise" offSpacer="" %}}
...
Need to develop .NET script or utility app to easily split DOCX files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/), child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program splitter app. Powerful .NET library for splitting document supports many popular formats including DOCX format such as PDF, Word, Excel and PowerPoint files.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCX Splitter library for .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to split DOCX files using .NET. Use Aspose DOCX splitter API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
