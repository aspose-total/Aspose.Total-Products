...
hero:
  h1: Split DOCM Files Online via Splitter App or using .NET
  h2: Develop powerful .NET based DOCM document splitter applications. Freely split documents including DOCM files online via app with instant download.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Split DOCM Files Online using App
      items:
      - Upload DOCM File to Split.
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Split DOCM File via .NET
      items:
      - Load the DOCM document using Document class.
      - Get total pages using Page Count.
      - Loop through each page and use ExtractPages to extract the page.
      - Save the extracted page into new DOCM file.
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code : Split DOCM Files Page Wise'
      gist:
...
- layout: columns
  ...
  - width: 6
    blocks:
    - type: markdown
      title: DOCM Splitter library for .NET
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to split DOCM files using .NET. Use Aspose DOCM splitter API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to Split multiple DOCM documents?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOCM document Splitter.
  - question: How long does it take to split the DOCM files?
