---
title: Split DOCM File Online or via .NET
description: Free online app to split different DOCM files. .NET C# splitter library code for DOCM documents. 
...
{{< blocks/products/pf/feature-page-header-widget h1="Split DOCM Files Online via Splitter App or using .NET" h2="Develop powerful .NET based DOCM document splitter applications. Freely split documents including DOCM files online via app with instant download." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Split DOCM Files Online using App" %}}

1. Upload DOCM File to Split.
...
{{% blocks/products/pf/agp/feature-section-col title="Split DOCM File via .NET" %}}

1. Load the DOCM document using Document class.
1. Get total pages using Page Count.
1. Loop through each page and use ExtractPages to extract the page.
1. Save the extracted page into new DOCM file.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Split DOCM Files Page Wise" offSpacer="" %}}
...
Need to develop .NET script or utility app to easily split DOCM files? With [Aspose.Words for .NET](https://products.aspose.com/words/net/), child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program splitter app. Powerful .NET library for splitting document supports many popular formats including DOCM format such as PDF, Word, Excel and PowerPoint files.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="DOCM Splitter library for .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to split DOCM files using .NET. Use Aspose DOCM splitter API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is it safe to use the online app to Split multiple DOCM documents?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOCM document Splitter.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>How long does it take to split the DOCM files?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
