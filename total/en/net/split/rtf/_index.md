...
{{< blocks/products/pf/feature-page-header-widget h1="Split RTF Files Online via Splitter App or using .NET" h2="Develop powerful .NET based RTF document splitter applications. Freely split documents including RTF files online via app with instant download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Split RTF File via .NET" %}}
...
1. Save the extracted page into new RTF file.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Split RTF Files Page Wise" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to split RTF files using .NET. Use Aspose RTF splitter API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
