---
title: Digitally Sign DOCX File Online or using .NET
description: Free online app for digital signature in DOCX files. Develop .NET application to electronically sign DOCX documents. 
...
{{< blocks/products/pf/feature-page-header-widget h1="Digitally Sign DOCX File Online via e-Signature App or using .NET" h2="Develop powerful .NET based DOCX document signing applications. Freely add digital signature into various documents including DOCX files online via app with instant download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Digitally Sign DOCX File via .NET" %}}

1. Load pfx certificate using CertificateHolder class
1. Define the options using SignOptions
1. Load DOCX file using FileStream
1. Use the DigitalSignatureUtil class to sign the loaded document

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Add Digital Signature in DOCX Files" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to add digital signature in DOCX file using .NET. Use Aspose DOCX eSignature API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
