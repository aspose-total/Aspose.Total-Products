---
title: Digitally Sign ODT File Online or using .NET
description: Free online app for digital signature in ODT files. Develop .NET application to electronically sign ODT documents.
family: total
platformtag: net
feature: Signature
informat: ODT
...
hero:
  h1: Digitally Sign ODT File Online via e-Signature App or using .NET
  h2: Develop powerful .NET based ODT document signing applications. Freely add digital signature into various documents including ODT files online via app with instant download.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: Add Digital Signature into ODT Files Online using App
      items:
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: Digitally Sign ODT File via .NET
      items:
      - Load pfx certificate using CertificateHolder class
      - Define the options using SignOptions
      - Load ODT file using FileStream
      - Use the DigitalSignatureUtil class to sign the loaded document
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: code
      title: '.NET Code : Add Digital Signature in ODT Files'
      gist:
        user: aspose-com-gists
        id: cae6b5ad09161ce61647c5b8dfffbeef
        file: esign-word-documents.cs
- layout: columns
  columns:
  - width: 12
    blocks:
    - type: markdown
      markdown: '#### Use Cases of Signing ODT Files with Digital or Electronic Signatures
  ...
  - width: 12
    ...
    - type: markdown
      markdown: 'Develop E-Signature Application using .NET
        ...
        Need to develop .NET script or utility app to easily sign multiple ODT files digitally? With [Aspose.Words for .NET](https://products.aspose.com/words/net/), child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code to program eSignature app for signing across documents. Powerful .NET library for document signing, supports many popular formats including ODT format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: ODT eSignature library for .NET
...
- type: faq
  ...
  - question: Can I use above .NET code in my application?
    answer: Yes, you are welcome to download this code. One can easily develop a professional solution to add digital signature in ODT file using .NET. Use Aspose ODT eSignature API to develop high-level, platform independent software in .NET.
  ...
  - question: Is it safe to use the online app to sign multiple ODT documents?
  ...
  - question: How can I sign multiple ODT files?
    answer: Start by uploading one or more files you want to sign. You can either drag and drop your ODT files or simply click inside the white area. Afterward, click the 'Sign' button, and our online esigning app will quickly process the uploaded files.
  - question: How long does it take to sign the ODT files?
