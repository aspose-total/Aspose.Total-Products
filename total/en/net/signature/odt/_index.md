...
{{< blocks/products/pf/feature-page-header-widget h1="Digitally Sign ODT File Online via e-Signature App or using .NET" h2="Develop powerful .NET based ODT document signing applications. Freely add digital signature into various documents including ODT files online via app with instant download." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Add Digital Signature into ODT Files Online using App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Digitally Sign ODT File via .NET" %}}

1. Load pfx certificate using CertificateHolder class
1. Define the options using SignOptions
1. Load ODT file using FileStream
1. Use the DigitalSignatureUtil class to sign the loaded document

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET Code : Add Digital Signature in ODT Files" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="ODT eSignature library for .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Yes, you are welcome to download this code. One can easily develop a professional solution to add digital signature in ODT file using .NET. Use Aspose ODT eSignature API to develop high-level, platform independent software in .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
