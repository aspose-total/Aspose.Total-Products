---
title: View PPSX File Online and using .NET
description: Free online PPSX file viewer app. .NET API C# code to view PPSX presentation for viewer application.
...
{{< blocks/products/pf/feature-page-header-widget h1="Freely View PPSX File Online or via .NET" h2="Develop powerful .NET based PPSX presentation viewer utility application. C# code listed to view PPSX presentation." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="View PPSX Presentation via Online App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="View PPSX Presentation via .NET" %}}

1. Add .NET library reference into project
1. Load source PPSX file using Presentation class object
...
{{% blocks/products/pf/agp/code-block title="C# Code : View PPSX Presentation" offSpacer="" %}}
...
Need to develop a PPSX viewer app or utility? With [Aspose.Slides for .NET](https://products.aspose.com/slides/net/) a child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code within its document viewer application. Powerful .NET library allows programming any document display solution that can support many popular formats including PPSX format.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET utility to process PPSX file for display app" %}}
