---
title: View DOCM File Online and using .NET
description: Free online DOCM file viewer app. .NET API C# code to view DOCM file for viewer application.
family: total
platformtag: net
feature: Viewer
informat: DOCM
...
hero:
  h1: Freely View DOCM File Online or via .NET
  h2: Develop powerful .NET based DOCM document viewer utility application. C# code listed to view DOCM document.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: View DOCM Document via Online App
      items:
      - Import DOCM file to view by uploading it.
      ...
      - Navigate between pages in case of multi pages DOCM document.
      - Set page view zoom-in or zoom-out.
  - width: 6
    blocks:
    - type: steps
      role: api
      title: View DOCM File via .NET
      items:
      - Add .NET library reference into project
      - Load source DOCM file using Document class object
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: 'C# Code : View DOCM Document'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: '`.docm` — Word Macro-Enabled Document - This format is similar to `.docx` but includes support for embedded macros, making it suitable for automated document processes.
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOCM File Viewer Application via .NET


        Need to develop a DOCM viewer app or utility? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) a child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code within its document viewer application. Powerful .NET library allows programming any document display solution that can support many popular formats including DOCM format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: .NET utility to process DOCM file for display app
...
- type: faq
  ...
  - question: Is it safe to use the online app for viewing DOCM document?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOCM document viewer. However, if you're developing a desktop application, we recommend using the Aspose.Total document processing API for efficient management.
- type: autogen_total
---
