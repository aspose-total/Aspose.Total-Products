...
{{< blocks/products/pf/feature-page-header-widget h1="Freely View DOCM File Online or via .NET" h2="Develop powerful .NET based DOCM document viewer utility application. C# code listed to view DOCM document." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="View DOCM File via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code : View DOCM Document" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET utility to process DOCM file for display app" %}}
