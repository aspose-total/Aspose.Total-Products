...
hero:
  h1: Freely View DOC File Online or via .NET
  h2: Develop powerful .NET based DOC document viewer utility application. C# code listed to view DOC document.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: View DOC Document via Online App
      items:
      - Import DOC file to view by uploading it.
      ...
      - Navigate between pages in case of multi pages DOC document.
      - Set page view zoom-in or zoom-out.
  - width: 6
    blocks:
    - type: steps
      role: api
      title: View DOC File via .NET
      items:
      - Add .NET library reference into project
      - Load source DOC file using Document class object
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: 'C# Code : View DOC Document'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: '`.doc` — Word 97–2003 Document - An older binary file format used by Microsoft Word before 2007. Though less common today, many legacy systems still rely on `.doc`.
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOC File Viewer Application via .NET
...
- layout: columns
  ...
  - width: 6
    blocks:
    - type: markdown
      title: .NET utility to process DOC file for display app
...
- type: faq
  ...
  - question: Is it safe to use the online app for viewing DOC document?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOC document viewer. However, if you're developing a desktop application, we recommend using the Aspose.Total document processing API for efficient management.
- type: autogen_total
---
