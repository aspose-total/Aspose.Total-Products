...
{{< blocks/products/pf/feature-page-header-widget h1="Freely View DOTX File Online or via .NET" h2="Develop powerful .NET based DOTX document viewer utility application. C# code listed to view DOTX document." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="View DOTX File via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code : View DOTX Document" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET utility to process DOTX file for display app" %}}
