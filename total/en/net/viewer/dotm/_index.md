...
{{< blocks/products/pf/feature-page-header-widget h1="Freely View DOTM File Online or via .NET" h2="Develop powerful .NET based DOTM document viewer utility application. C# code listed to view DOTM document." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="View DOTM File via .NET" %}}

1. Add .NET library reference into project 
1. Load source DOTM file using Document class object
...
{{% blocks/products/pf/agp/code-block title="C# Code : View DOTM Document" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET utility to process DOTM file for display app" %}}
