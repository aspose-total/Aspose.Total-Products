---
title: View DOTM File Online and using .NET
description: Free online DOTM file viewer app. .NET API C# code to view DOTM file for viewer application.
family: total
platformtag: net
feature: Viewer
informat: DOTM
...
hero:
  h1: Freely View DOTM File Online or via .NET
  h2: Develop powerful .NET based DOTM document viewer utility application. C# code listed to view DOTM document.
sections:
- layout: columns
  columns:
  - width: 6
    ...
    - type: steps
      role: online
      title: View DOTM Document via Online App
      items:
      - Import DOTM file to view by uploading it.
      ...
      - Navigate between pages in case of multi pages DOTM document.
      - Set page view zoom-in or zoom-out.
  - width: 6
    blocks:
    - type: steps
      role: api
      title: View DOTM File via .NET
      items:
      - Add .NET library reference into project
      - Load source DOTM file using Document class object
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: code
      title: 'C# Code : View DOTM Document'
      gist:
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: '`.dotm` — Word Macro-Enabled Template - A macro-enabled template format used to generate multiple Word documents with reusable structure and embedded automation.
...
- layout: columns
  ...
  - width: 12
    blocks:
    - type: markdown
      markdown: 'Develop DOTM File Viewer Application via .NET


        Need to develop a DOTM viewer app or utility? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) a child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code within its document viewer application. Powerful .NET library allows programming any document display solution that can support many popular formats including DOTM format.'
      role: summary
- layout: columns
  columns:
  - width: 6
    blocks:
    - type: markdown
      title: .NET utility to process DOTM file for display app
...
- type: faq
  ...
  - question: Is it safe to use the online app for viewing DOTM document?
  ...
  - question: What browser should to use App?
    answer: You can use any modern web browser like Google Chrome, Firefox, Opera, or Safari for online DOTM document viewer. However, if you're developing a desktop application, we recommend using the Aspose.Total document processing API for efficient management.
- type: autogen_total
---
