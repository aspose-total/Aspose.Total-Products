...
hero:
  h1: Update XLS File via .NET
  h2: Modify XLS spreadsheet via your .NET based applications without installing Microsoft Office<sup>&reg;</sup>.
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: How to Update XLS File in .NET
      items:
