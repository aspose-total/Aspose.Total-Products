...
hero:
  h1: Update XLSX File via .NET
  h2: Modify XLSX spreadsheet via your .NET based applications without installing Microsoft Office<sup>&reg;</sup>.
sections:
- layout: columns
  columns:
  - width: 12
...
- layout: columns
  ...
  - width: 6
    ...
    - type: steps
      role: api
      title: How to Update XLSX File in .NET
      items:
      - Create new [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) class object having the source XLSX file as parameter
