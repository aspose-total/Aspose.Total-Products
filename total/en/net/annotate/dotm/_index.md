...
{{< blocks/products/pf/feature-page-header-widget h1="Clear Comments from DOTM Document Online or Manage via .NET" h2="Develop powerful .NET based DOTM document annotation utility application. Code listed for managing comments of DOTM file through .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Delete Specific Author DOTM Document Comments via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code: Delete Specific Author Comments from DOTM File" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code : Add Comment from DOTM File" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Library to Annotate DOTM Files" %}}
