---
title: Remove DOT Annotation Online or Manage Annotations via .NET
description: delete comments from DOT file through online app for free. .NET API code to manage comments of DOT files.
...
{{< blocks/products/pf/feature-page-header-widget h1="Clear Comments from DOT Document Online or Manage via .NET" h2="Develop powerful .NET based DOT document annotation utility application. Code listed for managing comments of DOT file through .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Delete Specific Author DOT Document Comments via .NET" %}}

1. Add library reference to .NET project 
1. Load Document via Document class object
1. Get all nodes comments by using GetChildNodes having NodeType.Comment
1. Iterate through all comments and match the author name
1. Call the Remove method to delete the specific author comment
...
{{% blocks/products/pf/agp/code-block title="C# Code: Delete Specific Author Comments from DOT File" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Add Comments via .NET" %}}

1. Create Document class object
1. Use the Comment class
1. Add the new paragraph using Paragraphs.Add
1. Use FirstParagraph.Runs.Add the add the comment
...
1. Iterate through each collection and add comments in ArrayList
...
{{% blocks/products/pf/agp/code-block title=".NET Code : Add Comment from DOT File" offSpacer="" %}}
...
Need to develop a DOT annotation app or utility to provide feedback, make suggestions, or collaborate with others on the document? With [Aspose.Words for .NET](https://products.aspose.com/words/net/) a child API of [Aspose.Total for .NET](https://products.aspose.com/total/net/), any .NET developer can integrate the above API code within its document annotation application. Powerful .NET library allows programming any document annotation solution. Moreover it can support many popular formats including DOT format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Library to Annotate DOT Files" %}}
