...
{{< blocks/products/pf/feature-page-header-widget h1="Clear Comments from ODT Document Online or Manage via .NET" h2="Develop powerful .NET based ODT document annotation utility application. Code listed for managing comments of ODT file through .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Delete Specific Author ODT Document Comments via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code: Delete Specific Author Comments from ODT File" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET Code : Add Comment from ODT File" offSpacer="" %}}
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Library to Annotate ODT Files" %}}
