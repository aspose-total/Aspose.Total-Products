---
title: Convert DOT to JSON Format in Android Apps
description: Parse DOT to JSON format in Android Apps without using Microsoft Word or Excel
...
{{< blocks/products/pf/feature-page-header h1="Convert DOT to JSON Format in Android Apps" h2="Design Android applications to export DOT to JSON without using Microsoft<sup>&reg;</sup> Word or Excel" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOT to JSON Format in Android Apps" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOT to JSON in Range in Android Apps" %}}
