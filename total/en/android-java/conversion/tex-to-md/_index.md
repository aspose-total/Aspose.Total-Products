---
title: Convert TEX to MD in Android Apps
description: Render TEX to MD in Android Apps API without using Microsoft Excel or Adobe Reader
...
{{< blocks/products/pf/feature-page-header h1="Render TEX to MD in Android Apps" h2="Transform TEX to MD within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render TEX to MD" %}}
