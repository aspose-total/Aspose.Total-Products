---
title: Convert EPUB to ODS in Android Apps
description: Render EPUB to ODS in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/epub-to-ods/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render EPUB to ODS in Android Apps" h2="Transform EPUB to ODS within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render EPUB to ODS" %}}
