---
title: Convert XSLFO to XLTX in Android Apps
description: Render XSLFO to XLTX in Android Apps API without using Microsoft Excel or Adobe Reader
...
{{< blocks/products/pf/feature-page-header h1="Render XSLFO to XLTX in Android Apps" h2="Transform XSLFO to XLTX within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
The Aspose.PDF for Android via Java API can be used to convert XSLFO to XLSX. It provides a wide range of features to help you create, manipulate, and convert PDF documents. It also supports a variety of formats, including XSLFO, XLSX, and XLTX.
