...
description: Convert POTX to FLATOPC in mobile apps without installing any software 
...
4. Save the document to FLATOPC format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method and set FlatOpc as SaveFormat
