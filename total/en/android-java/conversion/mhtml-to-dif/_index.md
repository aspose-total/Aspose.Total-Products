---
title: Convert MHTML to DIF in Android Apps
description: Render MHTML to DIF in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/mhtml-to-dif/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render MHTML to DIF in Android Apps" h2="Transform MHTML to DIF within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render MHTML to DIF" %}}
