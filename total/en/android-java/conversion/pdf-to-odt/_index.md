---
title: Android API to Render PDF to ODT
description: Transform PDF to ODT via Android via Java API
url_ignore: /android-java/conversion/pdf-to-odt/
family: total
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PDF to ODT on Android via Java" %}}
...
Before converting PDF to ODT, you might need information about the document including author, creation date, keywords, modify date, subject, and title. This information is helpful for the decision making for the conversion process. Using the powerful [Aspose.PDF for Android via Java](https://docs.aspose.com/pdf/androidjava/) API, you can get all of it. To get file-specific information about a PDF file, first get the [DocumentInfo](https://apireference.aspose.com/pdf/java/com.aspose.pdf/DocumentInfo) object using [getInfo](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#getInfo--) method. Once the DocumentInfo object is retrieved, you can get the values of the individual properties.
{{% blocks/products/pf/feature-page-code %}}
```java
// load PDF document
...
{{% blocks/products/pf/feature-page-section  h2="Insert Endnotes in ODT Document in Android via Java" %}}
