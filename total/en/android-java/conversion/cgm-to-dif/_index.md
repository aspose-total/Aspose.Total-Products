---
title: Convert CGM to DIF in Android Apps
description: Render CGM to DIF in Android Apps API without using Microsoft Excel or Adobe Reader
...
{{< blocks/products/pf/feature-page-header h1="Render CGM to DIF in Android Apps" h2="Transform CGM to DIF within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render CGM to DIF" %}}
