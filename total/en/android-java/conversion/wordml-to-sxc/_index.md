...
{{< blocks/products/pf/feature-page-header h1="Convert WORDML to SXC in Android Applications" h2="Export WORDML to SXC in Android via Java without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
