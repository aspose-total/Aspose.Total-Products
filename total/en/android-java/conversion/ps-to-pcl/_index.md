...
{{% blocks/products/pf/agp/feature-section-col title="Convert PS to PCL on Android via Java" %}}
...
4. Save the document to PCL format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method and set PCL as SaveFormat
