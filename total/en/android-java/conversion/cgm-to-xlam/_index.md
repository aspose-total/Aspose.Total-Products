---
title: Convert CGM to XLAM in Android via Java
description: Render CGM to XLAM in Android via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/cgm-to-xlam/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render CGM to XLAM in Android via Java" h2="Transform CGM to XLAM within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
