---
title: Convert DOCX to JSON Format in Android via Java
description: Parse DOCX to JSON format in Android via Java without using Microsoft Word or Excel
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOCX to JSON Format in Android via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOCX to JSON in Range in Android via Java" %}}
