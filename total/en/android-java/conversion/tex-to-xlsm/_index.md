---
title: Convert TEX to XLSM in Android Apps
description: Render TEX to XLSM in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/tex-to-xlsm/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render TEX to XLSM in Android Apps" h2="Transform TEX to XLSM within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render TEX to XLSM" %}}
