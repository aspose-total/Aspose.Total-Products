---
title: Convert DOCM to JSON Format in Android via Java
description: Parse DOCM to JSON format in Android via Java without using Microsoft Word or Excel
url: /android-java/conversion/docm-to-json/
family: total
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOCM to JSON Format in Android via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOCM to JSON in Range in Android via Java" %}}
