...
description: Convert DOTX to ODS in Android via Java without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Convert DOTX to ODS in Android Applications" h2="Export DOTX to ODS in Android via Java without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
