---
title: Convert CGM to MD in Android Apps
description: Render CGM to MD in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/cgm-to-md/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render CGM to MD in Android Apps" h2="Transform CGM to MD within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render CGM to MD" %}}
