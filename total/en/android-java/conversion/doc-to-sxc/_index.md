...
{{< blocks/products/pf/feature-page-header h1="Convert DOC to SXC in Android Applications or online" h2="Export DOC to SXC in Android via Java without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
