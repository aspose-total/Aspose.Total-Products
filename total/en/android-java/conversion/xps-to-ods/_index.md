---
title: Convert XPS to ODS in Android Apps
description: Render XPS to ODS in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/xps-to-ods/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render XPS to ODS in Android Apps" h2="Transform XPS to ODS within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render XPS to ODS" %}}
