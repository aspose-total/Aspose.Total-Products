---
title: Convert MD to XLAM in Android Apps
description: Render MD to XLAM in Android Apps API without using Microsoft Excel or Adobe Reader
url_ignore: /android-java/conversion/md-to-xlam/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render MD to XLAM in Android Apps" h2="Transform MD to XLAM within Android applications without requiring Microsoft<sup>&reg;</sup> Excel or Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Android API to Render MD to XLAM" %}}
