...
description: Android API to Convert EXCEL to DOCX without using Microsoft Word
url: /android-java/conversion/excel-to-docx/
family: total
...
{{< blocks/products/pf/feature-page-header h1="Render EXCEL to DOCX on Android via Java" h2="Transform EXCEL to DOCX within your Android Applications without using Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Open EXCEL file using [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) class
