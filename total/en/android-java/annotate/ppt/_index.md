---
title: Remove PPT Annotation Online or Manage Annotations using Android Mobile Apps
description: delete comments from PPT file through online app for free. Android API code to manage comments of PPT files.
...
{{< blocks/products/pf/feature-page-header-widget h1="Clear Comments from PPT Presentation Online or Manage via Android Apps" h2="Develop powerful Android based PPT presentation annotation utility application. Code listed for managing comments of PPT file." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Remove PPT Presentation Comments via Android App" %}}

1. Add library reference to android project 
1. Load PPT via Presentation class object
...
{{% blocks/products/pf/agp/code-block title="Code : Delete Comments and Authors from PPT Presentation" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Add PPT Presentation Comments via Android App" %}}
...
<h2>Develop PPT Document Annotation Android App</h2>

Need to develop a PPT annotation mobile app or utility to provide feedback, make suggestions, or collaborate with others on the document? With [Aspose.Slides for Android via Java](https://products.aspose.com/slides/android-java/) a child API of [Aspose.Total for Android via Java](https://products.aspose.com/total/android-java/), any android developer can integrate the above API code within its document annotation application. Powerful android library allows programming any document annotation solution. Moreover it can support many popular formats including PPT format.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Android Library to Annotate PPT Files" %}}
