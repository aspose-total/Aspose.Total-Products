---
title: Update XLS File using Java
description: Modify XLS document in Java applications without using Microsoft Excel. Optimize code for fastest way to write and edit excel file in java.
...
{{< blocks/products/pf/feature-page-header h1="Update XLS File via Java" h2="Modify XLS spreadsheets via your Java based applications without installing Microsoft Office<sup>&reg;</sup>." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Update XLS File in Java" %}}

- Create new [Workbook](https://reference.aspose.com/cells/java/com.aspose.cells/Workbook) class object having the source XLS file as parameter
...
{{% blocks/products/pf/agp/code-block title="Code - Update XLS File in Java" offSpacer="" %}}
