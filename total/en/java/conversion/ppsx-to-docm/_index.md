---
title: Convert PPSX to DOCM via Java
description: Java API to Export PPSX to DOCM without using Microsoft Word or PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPSX to DOCM via Java" h2="On Premise Java API for PowerPoint PPSX to DOCM conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
For PPSX to DOCM file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
