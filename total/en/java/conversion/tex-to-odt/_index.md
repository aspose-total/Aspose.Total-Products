---
title: Online TEX to ODT Conversion or Develop Java based Application to Convert TEX Files
description: Free online app to convert TEX to ODT files. Java conversion library code for TEX documents. 
...
<iframe title="Free Online TEX to ODT Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=odt&from=tex" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convert TEX to ODT Files Online using App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert TEX to ODT via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for TEX to ODT Conversion" offSpacer="" %}}
...
Few more cases for saving TEX to ODT with other features like Open Password Protected TEX Document via Java, Save ODT Document to a Database via Java.
...
{{% blocks/products/pf/agp/feature-section-col title="Saving TEX to ODT App Requirements" %}}
