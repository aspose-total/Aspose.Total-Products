---
title: Online XPS to MHTML Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to MHTML files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to MHTML via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to MHTML Conversion" offSpacer="" %}}
