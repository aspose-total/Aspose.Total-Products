---
title: Online XPS to PPS Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to PPS files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to PPS via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to PPS Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to PPS with other features like Open Encrypted XPS File via Java, Save PPS File with Predefined View Type via Java.
