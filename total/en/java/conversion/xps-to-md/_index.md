---
title: Java API to Render XPS to MD
description: Export XPS to MD via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /java/conversion/xps-to-md/
family: total
platformtag: java
feature: conversion
informat: XPS
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS File to MD via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected XPS to MD via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert XPS File to MD with Watermark via Java" %}}
While converting XPS file to MD, you can also add watermark to your output MD file format. In order to add a watermark, create a new Workbook to open the converted XLSX file. Select Worksheet via its index, create a Shape and use its addTextEffect function, set colors, transparency and more. After that you can save your XLSX document as MD with Watermark.  
{{% blocks/products/pf/feature-page-code %}}
