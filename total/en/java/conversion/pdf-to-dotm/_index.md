---
title: Java API to Export PDF to DOTM
description: Convert PDF to DOTM using on premise Java API
url_ignore: /java/conversion/pdf-to-dotm/
family: total
platformtag: java
feature: conversion
informat: PDF
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert PDF to DOTM" %}}
