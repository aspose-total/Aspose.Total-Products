---
title: Online TEX to PPS Conversion or Develop Java based Application to Convert TEX Files
description: Free online app to convert TEX to PPS files. Java conversion library code for TEX documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert TEX to PPS via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for TEX to PPS Conversion" offSpacer="" %}}
...
Few more cases for saving TEX to PPS with other features like Open Encrypted TEX File via Java, Save PPS File with Predefined View Type via Java.
