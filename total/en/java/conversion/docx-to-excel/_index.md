---
title: Convert DOCX to EXCEL via Java
description: Convert DOCX to EXCEL via Java without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Convert DOCX to EXCEL via Java" h2="On Premise Java API to convert DOCX to EXCEL without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
