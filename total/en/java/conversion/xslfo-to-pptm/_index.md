---
title: Online XSLFO to PPTM Conversion or Develop Java based Application to Convert XSLFO Files
description: Free online app to convert XSLFO to PPTM files. Java conversion library code for XSLFO documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XSLFO to PPTM via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XSLFO to PPTM Conversion" offSpacer="" %}}
...
Few more cases for saving XSLFO to PPTM with other features like Open Encrypted XSLFO File via Java, Save PPTM File with Predefined View Type via Java.
