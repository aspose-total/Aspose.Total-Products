---
title: Java API to Export XPS to ODT
description: Convert XPS to ODT using on premise Java API
url_ignore: /java/conversion/xps-to-odt/
family: total
platformtag: java
feature: conversion
informat: XPS
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XPS to ODT" %}}
