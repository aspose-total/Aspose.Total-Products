---
title: Convert DOTX to XLSM via Java
description: Convert DOTX to XLSM via Java without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Convert DOTX to XLSM via Java" h2="On Premise Java API to convert DOTX to XLSM without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
