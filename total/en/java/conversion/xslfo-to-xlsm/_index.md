...
description: Export XSLFO to XLSM via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /java/conversion/xslfo-to-xlsm/
family: total
platformtag: java
feature: conversion
informat: XSLFO
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XSLFO File to XLSM via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected XSLFO to XLSM via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert XSLFO File to XLSM with Watermark via Java" %}}
While converting XSLFO file to XLSM, you can also add watermark to your output XLSM file format. In order to add a watermark, create a new Workbook to open the converted XLSX file. Select Worksheet via its index, create a Shape and use its addTextEffect function, set colors, transparency and more. After that you can save your XLSX document as XLSM with Watermark.  
{{% blocks/products/pf/feature-page-code %}}
