---
title: Online PDF to DOTX Conversion or Develop Java based Application to Convert PDF Files
description: Free online app to convert PDF to DOTX files. Java conversion library code for PDF documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PDF to DOTX via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for PDF to DOTX Conversion" offSpacer="" %}}
...
Few more cases for saving PDF to DOTX with other features like Open Password Protected PDF Document via Java, Save DOTX Document to a Database via Java.
