---
title: Online XPS to DOCM Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to DOCM files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to DOCM via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to DOCM Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to DOCM with other features like Open Password Protected XPS Document via Java, Save DOCM Document to a Database via Java.
