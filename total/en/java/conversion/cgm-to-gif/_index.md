---
title: Java API to Export CGM to GIF
description: Convert CGM to GIF using on premise Java API
url_ignore: /java/conversion/cgm-to-gif/
family: total
platformtag: java
feature: conversion
informat: CGM
outformat: GIF
otherformats: XAMLFLOW DOCM PS MHTML PCL DOTX DOTM FLATOPC WORDML DOT RTF OTT
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert CGM to GIF" %}}
