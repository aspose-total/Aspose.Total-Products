---
title: Online XPS to DOT Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to DOT files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to DOT via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to DOT Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to DOT with other features like Open Password Protected XPS Document via Java, Save DOT Document to a Database via Java.
