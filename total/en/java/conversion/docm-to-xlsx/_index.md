---
title: Convert DOCM to XLSX via Java
description: Convert DOCM to XLSX via Java without using using Microsoft Word or Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Convert DOCM to XLSX via Java" h2="On Premise Java API to convert DOCM to XLSX without using Microsoft<sup>&reg;</sup> Word or Microsoft<sup>&reg;</sup> Excel" >}}
