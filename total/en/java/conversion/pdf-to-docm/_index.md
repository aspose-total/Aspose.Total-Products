---
title: Online PDF to DOCM Conversion or Develop Java based Application to Convert PDF Files
description: Free online app to convert PDF to DOCM files. Java conversion library code for PDF documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PDF to DOCM via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for PDF to DOCM Conversion" offSpacer="" %}}
...
Few more cases for saving PDF to DOCM with other features like Open Password Protected PDF Document via Java, Save DOCM Document to a Database via Java.
