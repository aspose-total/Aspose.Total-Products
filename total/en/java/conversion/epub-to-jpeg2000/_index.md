...
description: Export EPUB file to JPEG2000  in your Java applications without using any third party application 
url_ignore: /java/conversion/epub-to-jpeg2000/
family: total
platformtag: java
feature: conversion
informat: EPUB
...
{{% blocks/products/pf/agp/feature-section-col title="Export EPUB to JPEG2000 via Java" %}}
