---
title: Convert POTM to WORDML via Java
description: Java API to Export POTM to WORDML without using Microsoft Word or PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="Convert POTM to WORDML via Java" h2="On Premise Java API for PowerPoint POTM to WORDML conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
For POTM to WORDML file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
