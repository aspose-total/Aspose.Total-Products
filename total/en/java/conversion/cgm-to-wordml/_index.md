---
title: Java API to Export CGM to WORDML
description: Convert CGM to WORDML using on premise Java API
url_ignore: /java/conversion/cgm-to-wordml/
family: total
platformtag: java
feature: conversion
informat: CGM
outformat: WORD_ML
otherformats: FLATOPC ODT DOTM DOT MARKDOWN OTT PCL DOCM PS MHTML XAMLFLOW RTF
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert CGM to WORDML" %}}
