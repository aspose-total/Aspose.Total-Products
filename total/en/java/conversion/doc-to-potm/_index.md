---
title: Convert DOC to POTM via Java
description: Java API to Export DOC to POTM without using Microsoft Word or PowerPoint
...
For DOC to POTM file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
