---
title: Java API to Render MD to XLTX
description: Export MD to XLTX via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /java/conversion/md-to-xltx/
family: total
platformtag: java
feature: conversion
informat: MD
...
{{% blocks/products/pf/agp/feature-section-col title="Convert MD File to XLTX via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected MD to XLTX via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert MD File to XLTX with Watermark via Java" %}}
While converting MD file to XLTX, you can also add watermark to your output XLTX file format. In order to add a watermark, create a new Workbook to open the converted XLSX file. Select Worksheet via its index, create a Shape and use its addTextEffect function, set colors, transparency and more. After that you can save your XLSX document as XLTX with Watermark.  
{{% blocks/products/pf/feature-page-code %}}
