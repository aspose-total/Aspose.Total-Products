...
{{% blocks/products/pf/agp/feature-section-col title="Convert JSON Format to POT via Java" %}}
...
4. Save the document to POT format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) method
...
{{% blocks/products/pf/feature-page-section  h2="Set Layout and Convert JSON Format to POT via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert JSON Format to POT with Watermark via Java" %}}
Using the API, you can also convert JSON to POT with watermark. In order to add a watermark to your POT document, you can first parse JSON to PPTX and add a watermark to it. In order to add a watermark, load the newly created PPTX file using the [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) class, loop through all slides, add text using addTextFrame, set all the relevant options like color, fillType and more and can save the document to POT.
{{% blocks/products/pf/feature-page-code %}}
