---
title: Convert POWERPOINT to DOT via Java
description: Java API to Export POWERPOINT to DOT without using Microsoft Word or PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="Convert POWERPOINT to DOT via Java" h2="On Premise Java API for PowerPoint POWERPOINT to DOT conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
For POWERPOINT to DOT file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
