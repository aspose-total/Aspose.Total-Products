...
description: Export CGM to DIF via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /java/conversion/cgm-to-dif/
family: total
platformtag: java
feature: conversion
informat: CGM
...
{{< blocks/products/pf/feature-page-header h1="Export CGM to DIF via Java" h2="Convert CGM file to DIF by using on premise Java API within any Java J2SE, J2EE, J2ME applications" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert CGM File to DIF via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected CGM to DIF via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert CGM File to DIF with Watermark via Java" %}}
