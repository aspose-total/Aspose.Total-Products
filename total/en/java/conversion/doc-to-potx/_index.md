---
title: Convert DOC to POTX via Java or with free Online Converter
description: Java API to Export DOC to POTX without using Microsoft Word or PowerPoint or online. Test free DOC to POTX online converter quickly before integrating the code. 
url_ignore: /java/conversion/doc-to-potx/
family: total
platformtag: java
feature: conversion
informat: DOC
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOC to POTX via Java" %}}
...
For DOC to POTX file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://releases.aspose.com/total/java/) based project and include libraries in your pom.xml.
          ...
          <div>
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>How can I convert DOC to POTX Online?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">The above-integrated online app allows you to convert DOC files to POTX. To get started, simply drag and drop or click inside the white area to import your DOC file. Once your file is uploaded, click the "Convert" button. After the DOC to POTX conversion process is complete, you can download your converted file with just one click.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
