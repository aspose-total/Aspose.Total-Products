---
title: Online TEX to DOTX Conversion or Develop Java based Application to Convert TEX Files
description: Free online app to convert TEX to DOTX files. Java conversion library code for TEX documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert TEX to DOTX via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for TEX to DOTX Conversion" offSpacer="" %}}
...
Few more cases for saving TEX to DOTX with other features like Open Password Protected TEX Document via Java, Save DOTX Document to a Database via Java.
