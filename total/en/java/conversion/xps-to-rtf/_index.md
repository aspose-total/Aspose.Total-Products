---
title: Online XPS to RTF Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to RTF files. Java conversion library code for XPS documents. 
...
<iframe title="Free Online XPS to RTF Conversion App" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=rtf&from=xps" id="child-iframe" width="80%"></iframe>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to RTF Files Online using App" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to RTF via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to RTF Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to RTF with other features like Open Password Protected XPS Document via Java, Save RTF Document to a Database via Java.
...
{{% blocks/products/pf/agp/feature-section-col title="Saving XPS to RTF App Requirements" %}}
