---
title: Convert CGM to POTX via Java API
description: Java API to Convert CGM to POTX without using Microsoft Word
url_ignore: /java/conversion/cgm-to-potx/
family: total
platformtag: java
feature: conversion
informat: CGM
outformat: POTX
otherformats: PPTM POT PPS PPSX PPSM POTM ODP OTP PPT SWF XAML POWERPOINT
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert CGM to POTX" %}}
