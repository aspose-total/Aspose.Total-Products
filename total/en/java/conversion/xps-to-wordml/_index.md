---
title: Online XPS to WORDML Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to WORDML files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to WORDML via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to WORDML Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to WORDML with other features like Open Password Protected XPS Document via Java, Save WORDML Document to a Database via Java.
