---
title: Convert DOCX to POWERPOINT via Java
description: Java API to Export DOCX to POWERPOINT without using Microsoft Word or PowerPoint
url_ignore: /java/conversion/docx-to-powerpoint/
family: total
platformtag: java
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Convert DOCX to POWERPOINT via Java" h2="DOCX to POWERPOINT conversion by using on premise Java API within any Java J2SE, J2EE, J2ME applications without using Microsoft<sup>&reg;</sup> PowerPoint or Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOCX to POWERPOINT via Java" %}}
...
For DOCX to POWERPOINT file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOCX to POWERPOINT via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOCX to POWERPOINT with Watermark via Java" %}}
Using the API, you can also perform DOCX file to POWERPOINT conversion with watermark. In order to add a watermark to your POWERPOINT document, you can first export DOCX to HTML and write HTML content in [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) object. After that to add a watermark, you can add text using addTextFrame, set all the relevant options like color, fillType and more and can save the document to POWERPOINT.
{{% blocks/products/pf/feature-page-code %}}
