---
title: Convert JSON Format to PPSX via Java 
description: Parse JSON to PPSX in Java without using Microsoft PowerPoint
url_ignore: /java/conversion/json-to-ppsx/
family: total
platformtag: java
feature: conversion
informat: JSON
...
{{% blocks/products/pf/agp/feature-section-col title="Convert JSON Format to PPSX via Java" %}}
...
4. Save the document to PPSX format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) method
...
{{% blocks/products/pf/feature-page-section  h2="Set Layout and Convert JSON Format to PPSX via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert JSON Format to PPSX with Watermark via Java" %}}
Using the API, you can also convert JSON to PPSX with watermark. In order to add a watermark to your PPSX document, you can first parse JSON to PPTX and add a watermark to it. In order to add a watermark, load the newly created PPTX file using the [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation) class, loop through all slides, add text using addTextFrame, set all the relevant options like color, fillType and more and can save the document to PPSX.
{{% blocks/products/pf/feature-page-code %}}
