---
title: Java API to Render PCL to ODS
description: Export PCL to ODS via Java API without using Microsoft Excel or Adobe Reader
url_ignore: /java/conversion/pcl-to-ods/
family: total
platformtag: java
feature: conversion
informat: PCL
...
{{% blocks/products/pf/agp/feature-section-col title="Convert PCL File to ODS via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected PCL to ODS via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert PCL File to ODS with Watermark via Java" %}}
While converting PCL file to ODS, you can also add watermark to your output ODS file format. In order to add a watermark, create a new Workbook to open the converted XLSX file. Select Worksheet via its index, create a Shape and use its addTextEffect function, set colors, transparency and more. After that you can save your XLSX document as ODS with Watermark.  
{{% blocks/products/pf/feature-page-code %}}
