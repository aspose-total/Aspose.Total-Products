---
title: Convert DOCX to POT via Java or with free Online Converter
description: Java API to Export DOCX to POT without using Microsoft Word or PowerPoint or online. Test free DOCX to POT online converter quickly before integrating the code. 
url_ignore: /java/conversion/docx-to-pot/
family: total
platformtag: java
feature: conversion
informat: DOCX
outformat: POT
otherformats: POWERPOINT PPS POTM PPTX POTX PPSM ODP PPT PPSX PPTM CSV DIF FODS ODS SXC TSV XLAM XLTM EXCEL XLS XLSB XLSM XLSX XLT XLTM XLTX
---
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOCX to POT via Java or Online App" %}}
...
For DOCX to POT file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://releases.aspose.com/total/java/) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOCX to POT via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert DOCX to POT with Watermark via Java" %}}
Using the API, you can also perform DOCX file to POT conversion with watermark. In order to add a watermark to your POT document, you can first export DOCX to HTML and write HTML content in [Presentation](https://reference.aspose.com/slides/java/com.aspose.slides/Presentation) object. After that to add a watermark, you can add text using addTextFrame, set all the relevant options like color, fillType and more and can save the document to POT.
{{% blocks/products/pf/feature-page-code %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">The above-integrated online app allows you to convert DOCX files to POT. To get started, simply drag and drop or click inside the white area to import your DOCX file. Once your file is uploaded, click the "Convert" button. After the DOCX to POT conversion process is complete, you can download your converted file with just one click.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
