---
title: Convert POWERPOINT to RTF via Java
description: Java API to Export POWERPOINT to RTF without using Microsoft Word or PowerPoint
...
For POWERPOINT to RTF file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
