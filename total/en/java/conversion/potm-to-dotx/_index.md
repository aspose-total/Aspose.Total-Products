...
url: /java/conversion/potm-to-dotx/
family: total
platformtag: java
feature: conversion
informat: POTM
...
4. Save the document to DOTX format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method
