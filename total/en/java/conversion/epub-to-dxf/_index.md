...
description: Export EPUB file to DXF  in your Java applications without using any third party application 
url_ignore: /java/conversion/epub-to-dxf/
family: total
platformtag: java
feature: conversion
informat: EPUB
...
{{% blocks/products/pf/agp/feature-section-col title="Export EPUB to DXF via Java" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Convert & Rotate EPUB to DXF File via Java" %}}
