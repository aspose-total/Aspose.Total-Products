---
title: Online XPS to GIF Conversion or Develop Java based Application to Convert XPS Files
description: Free online app to convert XPS to GIF files. Java conversion library code for XPS documents. 
...
{{% blocks/products/pf/agp/feature-section-col title="Convert XPS to GIF via Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Java Code for XPS to GIF Conversion" offSpacer="" %}}
...
Few more cases for saving XPS to GIF with other features like Open Password Protected XPS Document via Java, Save GIF Document to a Database via Java.
