---
title: Java API to Export CGM to MHTML
description: Convert CGM to MHTML using on premise Java API
url_ignore: /java/conversion/cgm-to-mhtml/
family: total
platformtag: java
feature: conversion
informat: CGM
outformat: MHTML
otherformats: XAMLFLOW DOTX WORDML OTT FLATOPC DOTM PCL ODT PS DOCM MARKDOWN DOT
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert CGM to MHTML" %}}
