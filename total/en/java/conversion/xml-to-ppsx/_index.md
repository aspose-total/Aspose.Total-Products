---
title: Convert XML to PPSX via Java API
description: Java API to Convert XML to PPSX without using Microsoft Word
url_ignore: /java/conversion/xml-to-ppsx/
family: total
platformtag: java
feature: conversion
informat: XML
...
{{% blocks/products/pf/agp/feature-section-col title="Java API to Convert XML to PPSX" %}}
1. Open XML file using [Document](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document) class
2. Convert XML to PPTX by using [save](https://apireference.aspose.com/pdf/java/com.aspose.pdf/Document#save-java.lang.String-int-) method
...
4. Save the document to PPSX format using [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-) method and set `Ppsx` as SaveFormat
