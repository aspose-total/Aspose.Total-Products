---
title: Convert DOT to PPSX via Java or with free Online Converter
description: Java API to Export DOT to PPSX without using Microsoft Word or PowerPoint or online. Test free DOT to PPSX online converter quickly before integrating the code. 
url_ignore: /java/conversion/dot-to-ppsx/
family: total
platformtag: java
feature: conversion
informat: DOT
...
{{% blocks/products/pf/agp/feature-section-col title="How to Convert DOT to PPSX via Java or Online App" %}}
...
For DOT to PPSX file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://releases.aspose.com/total/java/) based project and include libraries in your pom.xml.
...
{{% blocks/products/pf/feature-page-section  h2="Convert Protected DOT to PPSX via Java" %}}
The API also allows you to convert password-protected DOT documents to PPSX. If your input DOT document is password protected, you cannot convert it to PPSX format without using the password. In order to open a encrypted document you can set the correct password in LoadOptions object and pass it to the Document constructor. 
{{% blocks/products/pf/feature-page-code %}}
              ...
              <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">The above-integrated online app allows you to convert DOT files to PPSX. To get started, simply drag and drop or click inside the white area to import your DOT file. Once your file is uploaded, click the "Convert" button. After the DOT to PPSX conversion process is complete, you can download your converted file with just one click.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
