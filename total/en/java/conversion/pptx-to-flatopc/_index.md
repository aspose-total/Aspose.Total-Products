---
title: Convert PPTX to FLATOPC via Java
description: Java API to Export PPTX to FLATOPC without using Microsoft Word or PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="Convert PPTX to FLATOPC via Java" h2="On Premise Java API for PowerPoint PPTX to FLATOPC conversion within any Java J2SE, J2EE, J2ME applications" >}}
...
4. Save the document to FLATOPC format using [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) method
{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="PPTX File Conversion in Java" %}}
For PPTX to FLATOPC file conversion, you can easily use Aspose.Total for Java directly from a [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) based project and include libraries in your pom.xml.
