---
title: Herken ITF BarCode-afbeeldingen via Python
description: Scan ITF symbologie barcode afbeeldingen met behulp van Python-applicaties zonder andere software te gebruiken. 
...
- Voor het scannen van ITF-streepjescodes is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Herken ITF Symbologie BarCode in Python" offSpacer="" %}}
