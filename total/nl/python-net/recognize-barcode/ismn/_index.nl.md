---
title: Herken ISMN BarCode-afbeeldingen via Python
description: Scan ISMN symbologie barcode afbeeldingen met behulp van Python-applicaties zonder andere software te gebruiken. 
...
- Voor het scannen van ISMN-streepjescodes is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Herken ISMN Symbologie BarCode in Python" offSpacer="" %}}
