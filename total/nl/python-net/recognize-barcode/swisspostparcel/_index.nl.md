---
title: Herken SWISSPOSTPARCEL BarCode-afbeeldingen via Python
description: Scan SWISSPOSTPARCEL symbologie barcode afbeeldingen met behulp van Python-applicaties zonder andere software te gebruiken. 
...
- Voor het scannen van SWISSPOSTPARCEL-streepjescodes is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Herken SWISSPOSTPARCEL Symbologie BarCode in Python" offSpacer="" %}}
