...
{{< blocks/products/pf/i18n/upper-banner h1="Python-API's om Microsoft Word-, PowerPoint-, Outlook- en 3D-bestanden te automatiseren" h2="Maak, bewerk of converteer documenten, presentaties, e-mails 3D- en CAD-bestanden met Python" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/headers/aspose_total-for-python-via-net.svg" pfName="Aspose.Total" subTitlepfName="for Python via .NET" downloadUrl="https://releases.aspose.com/total/python-net/" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total biedt individuele oplossingen voor andere platformen." >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/nl/python-java/" imgSrc="https://cms.admin.containerize.com/templates/aspose/img/products/total/aspose_total-for-python-via-java.svg" sdkName=" Python via Java" >}}
