---
title: Converteer EMLX naar XPS in Python
description: Bewaar EMLX naar XPS in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/emlx-to-xps/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Voor EMLX naar XPS-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar EMLX naar XPS in Python" offSpacer="" %}}
