---
title: Converteer VCF naar JPEG in Python
description: Bewaar VCF naar JPEG in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-jpeg/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar JPEG-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar JPEG in Python" offSpacer="" %}}
