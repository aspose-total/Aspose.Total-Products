---
title: Converteer VCF naar DOT in Python
description: Bewaar VCF naar DOT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-dot/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar DOT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar DOT in Python" offSpacer="" %}}
