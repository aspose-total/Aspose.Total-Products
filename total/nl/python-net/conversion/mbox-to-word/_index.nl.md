---
title: Converteer MBOX naar WORD in Python
description: Bewaar MBOX naar WORD in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-word/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar WORD-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar WORD in Python" offSpacer="" %}}
