---
title: Converteer MBOX naar IMAGE in Python
description: Bewaar MBOX naar IMAGE in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-image/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar IMAGE-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar IMAGE in Python" offSpacer="" %}}
