---
title: Converteer VCF naar EPUB in Python
description: Bewaar VCF naar EPUB in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-epub/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar EPUB-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar EPUB in Python" offSpacer="" %}}
