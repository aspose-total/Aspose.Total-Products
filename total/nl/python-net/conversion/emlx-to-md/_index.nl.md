---
title: Converteer EMLX naar MD in Python
description: Bewaar EMLX naar MD in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/emlx-to-md/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Voor EMLX naar MD-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar EMLX naar MD in Python" offSpacer="" %}}
