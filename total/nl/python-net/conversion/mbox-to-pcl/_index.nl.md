---
title: Converteer MBOX naar PCL in Python
description: Bewaar MBOX naar PCL in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar PCL-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar PCL in Python" offSpacer="" %}}
