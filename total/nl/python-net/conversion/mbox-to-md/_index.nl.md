---
title: Converteer MBOX naar MD in Python
description: Bewaar MBOX naar MD in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-md/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar MD-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar MD in Python" offSpacer="" %}}
