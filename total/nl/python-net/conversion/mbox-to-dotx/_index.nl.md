---
title: Converteer MBOX naar DOTX in Python
description: Bewaar MBOX naar DOTX in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar DOTX-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar DOTX in Python" offSpacer="" %}}
