---
title: Converteer VCF naar PCL in Python
description: Bewaar VCF naar PCL in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar PCL-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar PCL in Python" offSpacer="" %}}
