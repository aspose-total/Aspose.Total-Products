---
title: Converteer MBOX naar SVG in Python
description: Bewaar MBOX naar SVG in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-svg/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar SVG-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar SVG in Python" offSpacer="" %}}
