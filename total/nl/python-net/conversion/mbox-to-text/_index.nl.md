---
title: Converteer MBOX naar TEXT in Python
description: Bewaar MBOX naar TEXT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar TEXT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar TEXT in Python" offSpacer="" %}}
