---
title: Converteer MBOX naar OTT in Python
description: Bewaar MBOX naar OTT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-ott/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar OTT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar OTT in Python" offSpacer="" %}}
