---
title: Converteer VCF naar MD in Python
description: Bewaar VCF naar MD in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-md/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar MD-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar MD in Python" offSpacer="" %}}
