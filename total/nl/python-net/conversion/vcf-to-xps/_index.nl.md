---
title: Converteer VCF naar XPS in Python
description: Bewaar VCF naar XPS in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-xps/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar XPS-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar XPS in Python" offSpacer="" %}}
