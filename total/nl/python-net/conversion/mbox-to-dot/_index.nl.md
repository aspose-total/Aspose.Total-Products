---
title: Converteer MBOX naar DOT in Python
description: Bewaar MBOX naar DOT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-dot/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar DOT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar DOT in Python" offSpacer="" %}}
