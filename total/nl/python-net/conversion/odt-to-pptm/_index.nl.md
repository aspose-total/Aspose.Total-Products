...
url: /nl/python-net/conversion/odt-to-pptm/
family: total
platformtag: Python
feature: conversion
informat: ODT
...
{{% blocks/products/pf/agp/feature-section-col title="Converteer ODT naar PPTM in Python" %}}
...
-  Roep de `save`-methode aan terwijl u het pad van het uitvoerbestand & SaveFormat.PPTM als parameters opgeeft. Dus uw ODT-bestand wordt geconverteerd naar PPTM op het opgegeven pad.
