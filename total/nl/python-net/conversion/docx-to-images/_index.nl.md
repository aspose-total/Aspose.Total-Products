---
title: Converteer DOCX naar afbeeldingen in Python
description: DOCX naar afbeelding TIFF BMP PNG JPEG GIF SVG-conversie in uw Python-toepassingen zonder Microsoft Word te gebruiken 
url: /nl/python-net/conversion/docx-to-images/
family: total
platformtag: Python
feature: conversion
informat: DOCX
...
- Roep de `save`-methode aan terwijl u het pad van het uitvoerbestand en de opgegeven opties als parameters doorgeeft. Dus uw DOCX-bestand wordt geconverteerd naar afbeeldingen op het opgegeven pad.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Conversievereisten" %}}

- Voor conversie van DOCX naar afbeeldingen (JPG, PNG, GIF, BMP, TIFF) is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="DOCX opslaan in afbeeldingen in Python - Eenvoudige conversie" offSpacer="" %}}

{{< gist "aspose-com-gists" "fe7c3ff0a8c783e4f0ed6bff199c6800" "convert-documents-to-images-simple-in-python.py" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="DOCX naar afbeeldingenconversie met specifieke opties" offSpacer="" %}}
