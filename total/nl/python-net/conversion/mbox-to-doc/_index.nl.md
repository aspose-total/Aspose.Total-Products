---
title: Converteer MBOX naar DOC in Python
description: Bewaar MBOX naar DOC in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-doc/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar DOC-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar DOC in Python" offSpacer="" %}}
