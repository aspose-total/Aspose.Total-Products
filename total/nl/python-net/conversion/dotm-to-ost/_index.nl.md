---
title: Converteer DOTM naar OST in Python
description: Bewaar DOTM naar OST binnen Python-toepassingen zonder Microsoft Word of Outlook te gebruiken
...
{{< blocks/products/pf/feature-page-header h1="Converteer DOTM naar OST met Python" h2="DOTM naar OST-conversie in uw Python-toepassingen zonder Microsoft Word<sup>&reg;</sup> of Outlook te installeren." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Hoe DOTM naar OST te converteren in Python" %}}
...
- Voor DOTM naar OST-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar DOTM naar OST in Python" offSpacer="" %}}
