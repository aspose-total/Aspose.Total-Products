---
title: Converteer VCF naar WORDML in Python
description: Bewaar VCF naar WORDML in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar WORDML-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar WORDML in Python" offSpacer="" %}}
