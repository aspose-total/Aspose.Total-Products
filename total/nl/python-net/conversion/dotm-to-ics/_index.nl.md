---
title: Converteer DOTM naar ICS in Python
description: Bewaar DOTM naar ICS binnen Python-toepassingen zonder Microsoft Word of Outlook te gebruiken
url: /nl/python-net/conversion/dotm-to-ics/
family: total
platformtag: Python
feature: conversion
informat: DOTM
...
- Voor DOTM naar ICS-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar DOTM naar ICS in Python" offSpacer="" %}}
