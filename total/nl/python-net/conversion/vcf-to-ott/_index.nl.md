---
title: Converteer VCF naar OTT in Python
description: Bewaar VCF naar OTT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-ott/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar OTT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar OTT in Python" offSpacer="" %}}
