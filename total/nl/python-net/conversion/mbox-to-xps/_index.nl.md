---
title: Converteer MBOX naar XPS in Python
description: Bewaar MBOX naar XPS in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-xps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar XPS-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar XPS in Python" offSpacer="" %}}
