---
title: Converteer VCF naar DOTM in Python
description: Bewaar VCF naar DOTM in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar DOTM-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar DOTM in Python" offSpacer="" %}}
