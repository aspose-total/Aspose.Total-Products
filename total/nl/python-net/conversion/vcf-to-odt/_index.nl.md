---
title: Converteer VCF naar ODT in Python
description: Bewaar VCF naar ODT in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/vcf-to-odt/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Voor VCF naar ODT-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar VCF naar ODT in Python" offSpacer="" %}}
