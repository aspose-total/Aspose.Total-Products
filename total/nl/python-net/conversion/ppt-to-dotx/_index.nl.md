...
{{% blocks/products/pf/agp/feature-section-col title="Converteer PPT naar DOTX in Python" %}}
...
-  Roep de `save`-methode aan terwijl u het pad van het uitvoerbestand & SaveFormat.PDF opgeeft als parameters. Dus uw PPT-bestand wordt geconverteerd naar PDF op het opgegeven pad.
