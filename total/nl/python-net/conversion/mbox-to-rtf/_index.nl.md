---
title: Converteer MBOX naar RTF in Python
description: Bewaar MBOX naar RTF in uw Python-toepassingen zonder Microsoft Outlook of Word te gebruiken 
url: /nl/python-net/conversion/mbox-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Voor MBOX naar RTF-conversie is Python 3.5 of hoger vereist
...
{{% blocks/products/pf/agp/code-block title="Bewaar MBOX naar RTF in Python" offSpacer="" %}}
