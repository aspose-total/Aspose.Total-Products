---
title: Bekijk en update RTF-eigenschappen online of voeg metadata toe met Python
description: Bekijk en wijzig RTF-eigenschappen gratis via de online app.Python API-code om RTF-eigenschappen te bekijken en toe te voegen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk of update RTF-metagegevens online of voeg ze toe via Python" h2="Ontwikkel een krachtige, op Python gebaseerde RTF-hulpprogramma voor het beheren van metadata voor documenten.Code vermeld voor het toevoegen en bekijken van metagegevens van RTF-bestanden via Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Bekijk RTF-eigenschappen via Python" %}}
...
1. Haal alle ingebouwde eigenschappen op via ingebouwde_document_properties.
1. Haal alle aangepaste eigenschappen op via custom_document_properties.
1. Loop beide en druk de naam en waarde van elke eigenschap af.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Codevoorbeeld in Python om RTF-metagegevens te bekijken" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg RTF-eigenschappen toe via Python" %}}

1. Referentie-API's binnen het project rechtstreeks vanuit PyPI ([Aspose.Words](https://pypi.org/project/aspose-words/)).
1. Laad het RTF-bestand met de Document-klasse.
1. Haal alle aangepaste eigenschappen op via custom_document_properties.
1. Gebruik de methode add() om aangepaste eigenschappen toe te voegen.
1. Loop beide en druk de naam en waarde van elke eigenschap af.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Python-code: RTF-metagegevensinformatie toevoegen" offSpacer="" %}}
...
<h2>Ontwikkel een RTF-applicatie voor metadatabeheer via Python</h2>

Wilt u een app of hulpprogramma voor het beheren van RTF-metagegevens ontwikkelen?Met [Aspose.Words for Python via .NET](https://products.aspose.com/words/python-net/), een onderliggende API van [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), kan elke Python-ontwikkelaar de bovenstaande API-code integreren in zijn documentmetagegevenstoepassing.Krachtige Python-bibliotheek maakt het programmeren van elke document-metadata-oplossing mogelijk.Bovendien ondersteunt het vele populaire formaten, waaronder het RTF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Python-hulpprogramma voor het beheren van RTF-metagegevens" %}}
...
<div class="col-md-12 tl bg-gray-dark howtolist section">
  ...
  <div class="container tl dflex" itemscope="" itemtype="https://schema.org/FAQPage">
      <div class="col-md-4 howtosectiongfx">
          <img class="social-panel-hide-on-mobile" src="https://www.groupRTFs.cloud/templates/brand/images/groupRTFs/conversion/groupRTFs_conversion-brand.png" alt="Veelgestelde vragen" width="335" height="283">
      </div>
