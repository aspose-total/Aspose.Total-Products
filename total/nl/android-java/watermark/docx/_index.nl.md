---
title: Watermerk DOCX-bestanden online of met behulp van mobiele Android-apps
description: Gratis online app om verschillende DOCX-bestanden van een watermerk te voorzien.Android-watermerkbibliotheek Java-code voor DOCX-documenten.
...
{{< blocks/products/pf/feature-page-header-widget h1="Watermerk DOCX-bestand online of via Android-applicatie" h2="Ontwikkel krachtige Android-gebaseerde DOCX-documentwatermerkapplicaties.Watermerk gratis verschillende documenten, waaronder DOCX-bestanden, online via de app met onmiddellijke download." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Watermerk DOCX-bestand via Android-apps" %}}
...
1. Gebruik getWatermark().setImage met afbeeldings- en watermerkopties

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Java-code: tekstwatermerk toevoegen aan DOCX-bestanden" offSpacer="" %}}

{{< gist "aspose-com-gists" "ef226c1da156645d71cf4c291e9960c8" "add-text-watermark-to-word-files.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Java-code: voeg afbeeldingswatermerk toe aan DOCX-documenten" offSpacer="" %}}
...
<h2>Ontwikkel een DOCX-bestandswatermerkapplicatie voor Android</h2>

Moet u een Android-hulpprogramma ontwikkelen om eenvoudig meerdere DOCX-bestanden van een watermerk te voorzien?Met [Aspose.Words for Android via Java](https://products.aspose.com/words/nl/android-java/), de onderliggende API van [Aspose.Total for Android via Java](https://products.aspose.com/total/nl/android-java/), kan elke mobiele Android-ontwikkelaar de bovenstaande API-code integreren om de watermerk-app in documenten te programmeren.Krachtige Android-bibliotheek voor documentwatermerken ondersteunt vele populaire formaten, waaronder het DOCX-formaat.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Android-watermerkbibliotheek voor DOCX-bestanden" %}}
