---
title: Verwijder PPSM-annotatie online of beheer annotaties met behulp van mobiele Android-apps
description: verwijder opmerkingen uit het PPSM-bestand gratis via de online app.Android API-code om opmerkingen over PPSM-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit PPSM-presentatie online of beheer via Android-apps" h2="Ontwikkel een krachtige Android-gebaseerde PPSM-hulpprogramma voor presentatieannotaties.Code vermeld voor het beheren van opmerkingen over het PPSM-bestand." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Verwijder PPSM-annotaties online" %}}

1. Importeer het PPSM-bestand om opmerkingen te verwijderen door deze te uploaden
1. Doe dit door in het neerzetgebied te klikken via slepen en neerzetten van de annotatie-app
1. Wacht enkele seconden, afhankelijk van de grootte van het PPSM-bestand en de internetsnelheid
1. Klik op de knop 'Verwijderen' om reacties te verwijderen
1. Download het bestand direct

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Verwijder PPSM-presentatieopmerkingen via de Android-app" %}}

1. Voeg bibliotheekreferentie toe aan het Android-project
1. Laad PPSM via het klasseobject Presentatie
...
{{% blocks/products/pf/agp/code-block title="Code: verwijder opmerkingen en auteurs uit de PPSM-presentatie" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg PPSM-presentatieopmerkingen toe via de Android-app" %}}
