...
url: /nl/android-java/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
Door [Aspose.Total voor Android via Java](https://products.aspose.com/total/android-java/) te gebruiken, kunt u de RTF-naar-XLSB-conversiefunctie in uw Android-applicaties integreren. Ten eerste kunt u RTF naar HTML converteren door gebruik te maken van de veelzijdige, rtfumentmanipulatie- en conversie-API [Aspose.Words voor Android via Java](https://products.aspose.com/words/android-java/). Daarna kunt u met [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) HTML naar XLSB converteren. 
{{% /blocks/products/pf/feature-page-summary  %}}
