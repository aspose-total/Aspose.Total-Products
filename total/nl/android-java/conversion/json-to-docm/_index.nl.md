---
title: Converteer JSON-indeling naar DOCM in Android via Java
description: JSON ontleden naar DOCM in Java zonder Microsoft Word te gebruiken
url: /nl/android-java/conversion/json-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: JSON
...
4. Sla het document op in DOCM-formaat met [Save](https://reference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions) )) methode
...
{{% blocks/products/pf/feature-page-section  h2="Converteer JSON-indeling naar DOCM met watermerk in Android via Java" %}}
