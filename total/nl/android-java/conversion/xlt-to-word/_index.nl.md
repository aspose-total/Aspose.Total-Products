---
title: XLT exporteren naar WORD in Android
description: Android API om XLT naar WORD te converteren zonder Microsoft Word te gebruiken
url: /nl/android-java/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Render XLT naar WORD op Android via Java" h2="Transformeer XLT naar WORD binnen uw Android-applicaties zonder Microsoft<sup>&reg;</sup> Excel" >}}

{{% blocks/products/pf/feature-page-summary %}}
[Aspose.Total voor Android via Java](https://products.aspose.com/total/android-java/) is een pakket krachtige API's voor bestandsautomatisering. Door twee van zijn API's te gebruiken, kunt u de conversiefunctie van XLT naar WORD in uw Android-applicaties integreren. In de eerste stap kunt u XLT naar PDF exporteren met [Aspose.Cells voor Android via Java](https://products.aspose.com/cells/android-java/). Daarna kunt u met [Aspose.PDF voor Android via Java](https://products.aspose.com/pdf/android-java/) PDF naar WORD converteren. 
{{% /blocks/products/pf/feature-page-summary  %}}
