---
title: Android API om ODT naar XLSX te converteren
description: Converteer ODT naar XLSX in Android via Java zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/android-java/conversion/odt-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="Converteer ODT naar XLSX in Android-applicaties" h2="Exporteer ODT naar XLSX in Android via Java zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}

{{% blocks/products/pf/feature-page-summary %}}
Door [Aspose.Total voor Android via Java](https://products.aspose.com/total/android-java/) te gebruiken, kunt u de ODT-naar-XLSX-conversiefunctie in uw Android-applicaties integreren. Ten eerste kunt u ODT naar HTML converteren door gebruik te maken van de veelzijdige, odtumentmanipulatie- en conversie-API [Aspose.Words voor Android via Java](https://products.aspose.com/words/android-java/). Daarna kunt u met [Aspose.Cells for Java](https://products.aspose.com/cells/android-java/) HTML naar XLSX converteren. 
{{% /blocks/products/pf/feature-page-summary  %}}
