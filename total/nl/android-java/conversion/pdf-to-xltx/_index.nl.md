---
title: Converteer PDF naar XLTX in Android Apps
description: Render PDF naar XLTX in Android Apps API zonder Microsoft Excel of Adobe Reader te gebruiken
...
{{< blocks/products/pf/feature-page-header h1="Render PDF naar XLTX in Android Apps" h2="Transformeer PDF naar XLTX binnen Android-applicaties zonder dat Microsoft<sup>&reg;</sup> Excel of Adobe<sup>&reg;</sup> Acrobat Reader nodig is" >}}
...
{{% blocks/products/pf/feature-page-section  h2="Krijg XMP-metadata van PDF-bestand in Android Apps" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Bescherm XLTX-document in Android Apps" %}}
