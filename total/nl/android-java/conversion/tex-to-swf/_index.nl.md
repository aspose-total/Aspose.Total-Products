...
url: /nl/android-java/conversion/tex-to-swf/
family: total
platformtag: cpp
feature: conversion
informat: TEX
...
U kunt de conversiefunctie van TEX naar SWF in uw Android-applicaties integreren met behulp van twee eenvoudige stappen. In de eerste stap kunt u TEX naar PPTX exporteren met [Aspose.PDF voor Android via Java](https://products.aspose.com/pdf/android-java/). Daarna kunt u met [Aspose.Slides voor Android via Java](https://products.aspose.com/slides/android-java/) PPTX naar SWF converteren. Beide API's vallen onder het pakket [Aspose.Total voor Android via Java](https://products.aspose.com/total/android-java/). 
{{% /blocks/products/pf/feature-page-summary  %}}
