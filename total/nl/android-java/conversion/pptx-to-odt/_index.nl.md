...
url: /nl/android-java/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
[Aspose.Total voor Android via Java](https://products.aspose.com/total/android-java/) maakt het manipuleren van bestandsindelingen binnen Android-applicaties mogelijk. Door de API's in het pakket te gebruiken, kunt u het conversieproces van PowerPoint PPTX naar Word ODT in uw apps automatiseren.
U kunt uw opgegeven odtument in twee stappen converteren. U kunt [Aspose.Slides for Andorid via Java](https://products.aspose.com/slides/android-java/) gebruiken, een PowerPoint-API voor Android-toepassingen om PPTX naar HTML weer te geven. Daarna kunt u met behulp van de odtumentverwerkings-API [Aspose.Words voor Android via Java](https://products.aspose.com/words/android-java/) de HTML naar ODT converteren. 
{{% /blocks/products/pf/feature-page-summary  %}}
