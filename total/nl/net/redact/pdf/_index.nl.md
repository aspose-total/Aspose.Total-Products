---
title: PDF-document online redigeren of met .NET
description: Open en redigeer het PDF-document gratis online via de app. .NET API C#-code om PDF-tekst te zoeken en te vervangen.
...
{{< blocks/products/pf/feature-page-header-widget h1="PDF-document online of via .NET redigeren" h2="Ontwikkel een krachtige, op .NET gebaseerde PDF-hulpprogramma voor documentredactie.C#-code vermeld voor het zoeken en vervangen van tekst in PDF-bestanden via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="PDF-bestand redigeren via .NET" %}}

1. Voeg een bibliotheekverwijzing toe aan het .NET-project
1. Laad het PDF-bestand met de Document-klasse
1. Gebruik het klasseobject TextFragmentAbsorber met zoektermen als parameter
1. Haal alle tekstfragmenten op in TextFragmentCollection
1. Herhaal elke fragmentverzameling
1. Definieer RedactionAnnotation en roep de methode Redact() aan
...
<h2>Ontwikkel een PDF-redactietoepassing via .NET</h2>

Wilt u een PDF-redactie-app of -hulpprogramma ontwikkelen?Met [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/), een onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren in zijn documentredactietoepassing.Dankzij de krachtige .NET-bibliotheek kunt u elke oplossing voor documentredactie programmeren. Bovendien ondersteunt het vele populaire formaten, waaronder het PDF-formaat.<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 Redactie in .pdf (Portable Document Format)

- Redigeer gevoelige tekst in juridische, medische en financiële documenten.
- Verberg vertrouwelijke gegevens vóór openbare bekendmakingen of persberichten.
- Verdoezel beperkte inhoud in FOIA- of nalevingsgerelateerde publicaties.
