---
title: Verwijder RTF-annotatie online of beheer annotaties via .NET
description: verwijder opmerkingen uit het RTF-bestand gratis via de online app..NET API-code om opmerkingen over RTF-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit RTF-documenten online of beheer ze via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde RTF-hulpprogramma voor documentannotatie.Code vermeld voor het beheren van opmerkingen over het RTF-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder specifieke auteur RTF-documentopmerkingen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: verwijder specifieke auteursopmerkingen uit het RTF-bestand" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: commentaar toevoegen vanuit RTF-bestand" offSpacer="" %}}
