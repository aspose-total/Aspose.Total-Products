---
title: Verwijder Excel-annotatie online of beheer annotaties via .NET
description: verwijder opmerkingen uit het Excel-bestand gratis via de online app..NET API-code om opmerkingen over Excel-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit Excel-documenten online of beheer ze via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde Excel-hulpprogramma voor documentannotatie.Code vermeld voor het beheren van opmerkingen over het Excel-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder Excel-opmerkingen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: verwijder opmerkingen uit het Excel-bestand" offSpacer="" %}}
