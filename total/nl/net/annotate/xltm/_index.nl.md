---
title: Verwijder XLTM-annotatie online of beheer annotaties via .NET
description: verwijder opmerkingen uit het XLTM-bestand gratis via de online app..NET API-code om opmerkingen over XLTM-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit XLTM-documenten online of beheer ze via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde XLTM-hulpprogramma voor documentannotatie.Code vermeld voor het beheren van opmerkingen over het XLTM-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder XLTM-opmerkingen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: verwijder opmerkingen uit het XLTM-bestand" offSpacer="" %}}
