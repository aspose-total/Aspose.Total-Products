---
title: Verwijder Word-annotatie online of beheer annotaties via .NET
description: verwijder opmerkingen uit het Word-bestand gratis via de online app..NET API-code om opmerkingen over Word-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit Word-documenten online of beheer ze via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde Word-hulpprogramma voor documentannotatie.Code vermeld voor het beheren van opmerkingen over het Word-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder specifieke auteur Word-documentopmerkingen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: verwijder specifieke auteursopmerkingen uit het Word-bestand" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: commentaar toevoegen vanuit Word-bestand" offSpacer="" %}}
