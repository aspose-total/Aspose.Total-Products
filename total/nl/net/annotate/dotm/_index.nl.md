---
title: Verwijder DOTM-annotatie online of beheer annotaties via .NET
description: verwijder opmerkingen uit het DOTM-bestand gratis via de online app..NET API-code om opmerkingen over DOTM-bestanden te beheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Wis opmerkingen uit DOTM-documenten online of beheer ze via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde DOTM-hulpprogramma voor documentannotatie.Code vermeld voor het beheren van opmerkingen over het DOTM-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder specifieke auteur DOTM-documentopmerkingen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: verwijder specifieke auteursopmerkingen uit het DOTM-bestand" offSpacer="" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: commentaar toevoegen vanuit DOTM-bestand" offSpacer="" %}}
