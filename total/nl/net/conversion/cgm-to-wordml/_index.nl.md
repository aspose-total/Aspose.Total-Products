---
title: C# API om CGM naar WORDML te exporteren
description: Converteer CGM naar WORDML zonder Microsoft Word te gebruiken
url_ignore: /nl/net/conversion/cgm-to-wordml/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Render CGM naar WORDML via .NET" h2=".NET API om CGM naar WORDML te exporteren op Windows, macOS en Linux zonder Microsoft Word te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API om CGM naar WORDML te converteren" %}}
