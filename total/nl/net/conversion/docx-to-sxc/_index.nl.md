---
title: .NET API om DOCX naar SXC te converteren
description: C# API om DOCX naar SXC te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/docx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: DOCXX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOCX naar SXC te converteren" h2="Exporteer DOCX naar SXC via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het docxument op in SXC-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `SXC` in als SaveFormat
