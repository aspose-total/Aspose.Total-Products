...
description: C# API om DOCM naar CSV te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOCM naar CSV te converteren" h2="Exporteer DOCM naar CSV via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het documentop in CSV-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `CSV` in als SaveFormat
