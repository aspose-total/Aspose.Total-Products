---
title: Converteer PPSX naar XLSM via C#
description: Converteer PPSX naar XLSM in C# zonder Microsoft Excel of Powerpoint te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer PPSX naar XLSM via C#" h2=".NET API voor PPSX naar XLSM-conversie zonder Microsoft<sup>&reg;</sup> Excel of PowerPoint" >}}
...
4. Sla het document op als XLSM met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
