...
description: C# API om DOTM naar XLS te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOTM naar XLS te converteren" h2="Exporteer DOTM naar XLS via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotmument op in XLS-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLS` in als SaveFormat
