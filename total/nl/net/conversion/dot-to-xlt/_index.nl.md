---
title: .NET API om DOT naar XLT te converteren
description: C# API om DOT naar XLT te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/dot-to-xlt/
family: total
platformtag: net
feature: conversion
informat: DOT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOT naar XLT te converteren" h2="Exporteer DOT naar XLT via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotument op in XLT-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLT` in als SaveFormat
