---
title: .NET API om DOTX naar XLS te converteren
description: C# API om DOTX naar XLS te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/dotx-to-xls/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOTX naar XLS te converteren" h2="Exporteer DOTX naar XLS via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotxument op in XLS-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLS` in als SaveFormat
