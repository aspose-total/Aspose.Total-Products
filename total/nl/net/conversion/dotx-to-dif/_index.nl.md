---
title: .NET API om DOTX naar DIF te converteren
description: C# API om DOTX naar DIF te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/dotx-to-dif/
family: total
platformtag: net
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOTX naar DIF te converteren" h2="Exporteer DOTX naar DIF via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotxument op in DIF-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `DIF` in als SaveFormat
