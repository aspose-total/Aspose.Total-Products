...
description: C# API om DOTM naar XLSM te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOTM naar XLSM te converteren" h2="Exporteer DOTM naar XLSM via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotmument op in XLSM-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLSM` in als SaveFormat
