---
title: Converteer POTX naar JSON-formaat via .NET
description: Converteer POTX naar JSON in C# zonder Microsoft Excel of Powerpoint te gebruiken
url_ignore: /nl/net/conversion/potx-to-json/
family: total
platformtag: net
feature: conversion
informat: POTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer POTX naar JSON-formaat via C#" h2="Exporteer POTX naar JSON via C# zonder Microsoft<sup>&reg;</sup> Excel of PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Door [Aspose.Total for .NET](https://products.aspose.com/total/net/) te gebruiken, kunt u POTX naar JSON-indeling converteren binnen elke .NET-, C#-, ASP.NET- en VB.NET-toepassing in twee eenvoudige stappen. Ten eerste, door [Aspose.Slides for .NET](https://products.aspose.com/slides/net/) te gebruiken, kunt u POTX naar HTML exporteren. Daarna kunt u met behulp van [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API HTML naar JSON converteren.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Converteer POTX naar JSON-formaat via C#" %}}
1. Open het POTX-bestand met de klasse [Presentation](https://apireference.aspose.com/slides/net/aspose.slides/presentation)
2. Converteer POTX naar HTML met behulp van de [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) methode
...
{{% blocks/products/pf/feature-page-section  h2="Converteer beveiligde POTX naar JSON-indeling via C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Converteer POTX naar JSON binnen bereik via C#" %}}
