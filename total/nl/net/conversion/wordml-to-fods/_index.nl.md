---
title: .NET API om WORDML naar FODS te converteren
description: C# API om WORDML naar FODS te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/wordml-to-fods/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om WORDML naar FODS te converteren" h2="Exporteer WORDML naar FODS via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het wordmlument op in FODS-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `FODS` in als SaveFormat
