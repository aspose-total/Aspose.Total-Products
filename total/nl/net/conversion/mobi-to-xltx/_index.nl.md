...
description: C# API om MOBI naar XLTX te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/mobi-to-xltx/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om MOBI naar XLTX te converteren" h2="Exporteer MOBI naar XLTX via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het mobiument op in XLTX-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLTX` in als SaveFormat
