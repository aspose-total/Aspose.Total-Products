---
title: .NET API om WORDML naar XLTM te converteren
description: C# API om WORDML naar XLTM te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/wordml-to-xltm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om WORDML naar XLTM te converteren" h2="Exporteer WORDML naar XLTM via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het wordmlument op in XLTM-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLTM` in als SaveFormat
