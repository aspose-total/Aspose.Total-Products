...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om DOT naar ODS te converteren" h2="Exporteer DOT naar ODS via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het dotument op in ODS-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `ODS` in als SaveFormat
