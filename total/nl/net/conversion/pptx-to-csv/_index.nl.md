---
title: Converteer PPTX naar CSV via C#
description: Converteer PPTX naar CSV in C# zonder Microsoft Excel of Powerpoint te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer PPTX naar CSV via C#" h2=".NET API voor PPTX naar CSV-conversie zonder Microsoft<sup>&reg;</sup> Excel of PowerPoint" >}}
...
4. Sla het document op als CSV met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4)
