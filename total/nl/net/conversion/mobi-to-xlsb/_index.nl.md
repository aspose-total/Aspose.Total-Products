---
title: .NET API om MOBI naar XLSB te converteren
description: C# API om MOBI naar XLSB te converteren zonder Microsoft Excel of Adobe Reader te gebruiken
url: /nl/net/conversion/mobi-to-xlsb/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API om MOBI naar XLSB te converteren" h2="Exporteer MOBI naar XLSB via C# zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
4. Sla het mobiument op in XLSB-indeling met de methode [Save](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) en stel `XLSB` in als SaveFormat
