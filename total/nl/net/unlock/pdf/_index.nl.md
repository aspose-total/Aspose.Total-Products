---
title: Verwijder PDF-wachtwoordbeveiliging online of via .NET
description: Verwijder het wachtwoord gratis uit het PDF-document via de online app. .NET C# API-code om met een wachtwoord beveiligde PDF-bestanden te ontgrendelen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ontgrendel het PDF-documentwachtwoord online of via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde PDF-hulpprogramma voor het vergrendelen en ontgrendelen van documenten.Code vermeld voor het verwijderen van wachtwoordbeperkingen uit het PDF-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder het PDF-wachtwoord via .NET" %}}

1. Laad een met een wachtwoord beveiligd PDF-bestand met behulp van de documentklasse
1. Roep de methode Decrypt() aan om het wachtwoord te verwijderen
...
{{% blocks/products/pf/agp/code-block title=".NET-code: verwijder wachtwoord uit PDF-document" offSpacer="" %}}
...
<h2>Ontwikkel een PDF Protection Management-applicatie via .NET</h2>

Wilt u een app of hulpprogramma voor PDF-beveiligingsbeheer ontwikkelen?Met [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/), een onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren in zijn toepassing voor documentbeveiliging of het opheffen van de beveiliging.Dankzij de krachtige .NET-bibliotheek kunt u elke documentbeveiligingsoplossing programmeren. Bovendien ondersteunt het vele populaire formaten, waaronder het PDF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-hulpprogramma om PDF-beveiliging te beheren" %}}
