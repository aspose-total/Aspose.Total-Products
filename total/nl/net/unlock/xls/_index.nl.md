---
title: Verwijder XLS-wachtwoordbeveiliging online of via .NET
description: Verwijder het wachtwoord gratis uit het XLS-document via de online app..NET C# API-code om met een wachtwoord beveiligde XLS-bestanden te ontgrendelen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ontgrendel het XLS-documentwachtwoord online of via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde XLS-hulpprogramma voor het vergrendelen en ontgrendelen van documenten.Code vermeld voor het verwijderen van wachtwoordbeperkingen uit het XLS-bestand via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Verwijder het XLS-wachtwoord via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: verwijder wachtwoord uit XLS-document" offSpacer="" %}}
