---
title: Bescherm ODT-document online met wachtwoord en gebruik .NET
description: Online ODT-app voor wachtwoordbeveiliging voor bestanden. C# .NET API-code om wachtwoordbeveiliging toe te passen op een ODT-document.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ODT-documentbeveiliging of wachtwoord instellen via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde ODT-hulpprogramma voor documentbeveiliging.Code vermeld voor het toepassen van een wachtwoord op een ODT-document via .NET." >}}
...
1. Gebruik het object om de methode Protect() aan te roepen
...
{{% blocks/products/pf/agp/code-block title=".NET-code: ODT-documentwachtwoordbeveiliging" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 .odt | OpenDocument-tekst — Gebruiksscenario's voor beveiliging

- Gebruikt in open-source omgevingen (bijv. LibreOffice).
- Bescherming nodig om consistentie te waarborgen over meerdere softwareplatforms.
- Handig bij het verwerken van samenwerkingsdocumenten tussen verschillende platforms.
- Helpt ongeautoriseerde structurele wijzigingen te voorkomen.
