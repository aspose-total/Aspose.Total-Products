---
title: Bescherm ODP-document online met wachtwoord en gebruik .NET
description: Online ODP-app voor wachtwoordbeveiliging voor bestanden..NET C# API-code om wachtwoordbeveiliging toe te passen op ODP-presentaties.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online ODP-documentbeveiliging of wachtwoord instellen via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde ODP-hulpprogramma voor documentbeveiliging.Code vermeld voor het toepassen van wachtwoord op ODP-presentatie via .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ODP-wachtwoordbeveiliging via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: ODP-presentatiewachtwoordbeveiliging" offSpacer="" %}}
...
<h2>Ontwikkel een ODP-toepassing voor wachtwoordbeveiliging via .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-hulpprogramma om het ODP-bestand te verwerken voor het beveiligen van de app" %}}
