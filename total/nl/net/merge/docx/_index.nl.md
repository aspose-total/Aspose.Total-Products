---
title: Voeg DOCX-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende DOCX-bestanden te combineren..NET samenvoegende bibliotheekcode om DOCX-documenten samen te voegen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg DOCX-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde DOCX-toepassing voor het samenvoegen van documenten.Combineer meerdere DOCX-documenten gratis online via de app.Sla het DOCX-bestand online op als PDF, afbeeldingen, Word, Excel, PowerPoint en vele andere formaten." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg DOCX-bestand samen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: DOCX-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel DOCX-bestandsfusie met behulp van .NET</h2>

Moet u een .NET-hulpprogramma-app ontwikkelen om eenvoudig meerdere DOCX-bestanden samen te voegen?Met de onderliggende [Aspose.Words for .NET](https://products.aspose.com/words/nl/net/)-API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/) kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om het samenvoegen van apps in documenten te programmeren.Krachtige .NET-bibliotheek voor het samenvoegen van documenten ondersteunt vele populaire formaten, waaronder het DOCX-formaat.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library voor DOCX-bestanden" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden. Men kan eenvoudig een professionele oplossing ontwikkelen om DOCX te combineren met .NET.Gebruik de Aspose DOCX merge-API om platformonafhankelijke software op hoog niveau in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
