---
title: Voeg DOCM-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende DOCM-bestanden te combineren..NET samenvoegende bibliotheekcode om DOCM-documenten samen te voegen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg DOCM-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde DOCM-toepassing voor het samenvoegen van documenten.Combineer meerdere DOCM-documenten gratis online via de app.Sla het DOCM-bestand online op als PDF, afbeeldingen, Word, Excel, PowerPoint en vele andere formaten." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg DOCM-bestand samen via .NET" %}}
...
1. Roep de Save-methode aan en verzamel de samengevoegde DOCM-bestanden in één
...
{{% blocks/products/pf/agp/code-block title=".NET-code: DOCM-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel DOCM-bestandsfusie met behulp van .NET</h2>

Moet u een .NET-hulpprogramma-app ontwikkelen om eenvoudig meerdere DOCM-bestanden samen te voegen?Met de onderliggende [Aspose.Words for .NET](https://products.aspose.com/words/nl/net/)-API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/) kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om het samenvoegen van apps in documenten te programmeren.Krachtige .NET-bibliotheek voor het samenvoegen van documenten ondersteunt vele populaire formaten, waaronder het DOCM-formaat.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library voor DOCM-bestanden" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden. Men kan eenvoudig een professionele oplossing ontwikkelen om DOCM te combineren met .NET.Gebruik de Aspose DOCM merge-API om platformonafhankelijke software op hoog niveau in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
