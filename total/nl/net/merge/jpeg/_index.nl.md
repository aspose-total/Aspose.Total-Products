---
title: Voeg JPEG-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende JPEG-bestanden te combineren. .NET samenvoegende bibliotheekcode om JPEG-documenten samen te voegen in het gewenste formaat.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg JPEG-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde JPEG-toepassing voor het samenvoegen van documenten.Combineer meerdere JPEG-documenten gratis online in één app via de app.Sla het samengevoegde JPEG-bestand online op als PDF, afbeeldingen, Word en vele andere formaten." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Voeg JPEG-bestanden online samen met de app" %}}
...
1. Klik op de knop "Samenvoegen" om JPEG in het gewenste formaat samen te voegen
1. Download het samengevoegde JPEG-bestand
1. Bekijk en ontvang het enkele samengevoegde JPEG-bestand

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Voeg JPEG-bestand samen via .NET" %}}
...
1. Roep de Save-methode aan en ontvang de samengevoegde JPEG-bestanden in één bestand.
...
{{% blocks/products/pf/agp/code-block title=".NET-code: JPEG-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel JPEG-bestandsfusie met behulp van .NET</h2>

Moet u een .NET-hulpprogramma-app ontwikkelen om eenvoudig meerdere JPEG-bestanden samen te voegen?Met de [Aspose.Imaging for .NET](https://products.aspose.com/imaging/nl/net/) onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/) kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om het samenvoegen van apps in documenten te programmeren.Krachtige .NET-bibliotheek voor het samenvoegen van documenten ondersteunt vele populaire formaten, waaronder het JPEG-formaat.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library voor JPEG-bestanden" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden en te gebruiken voor het ontwikkelen van op .NET gebaseerde applicaties gericht op het combineren van JPEG-documenten.Men kan een professionele oplossing ontwikkelen om JPEG te combineren met behulp van .NET. Gebruik onze JPEG merge-API om hoogwaardige, platformonafhankelijke software in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is het veilig om de online app te gebruiken om meerdere JPEG-documenten te combineren?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">U kunt elke moderne webbrowser zoals Google Chrome, Firefox, Opera of Safari gebruiken voor het online samenvoegen van JPEG-documenten.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe kan ik meerdere JPEG-bestanden samenvoegen?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Begin met het uploaden van een of meer bestanden die u wilt samenvoegen.U kunt uw JPEG-bestanden slepen en neerzetten of eenvoudigweg in het witte gebied klikken. Klik daarna op de knop 'Samenvoegen' en onze fusie zal de geüploade bestanden snel verwerken.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe lang duurt het om de JPEG-bestanden samen te voegen?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
