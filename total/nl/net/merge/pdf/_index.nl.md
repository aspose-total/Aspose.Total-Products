---
title: Voeg PDF-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende PDF-bestanden te combineren. .NET-code om PDF-documenten in andere formaten samen te voegen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg PDF-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde PDF-toepassing voor het samenvoegen van documenten.Combineer meerdere PDF-documenten gratis online in één app via de app.Sla het PDF-bestand online op als PDF, afbeeldingen, Word, Excel, PowerPoint en vele andere formaten." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg PDF-bestand samen via .NET" %}}

1. Laad de beide PDF-documenten met behulp van de documentklasse.
1. Gebruik de eerste instantie en roep de Pages.Add-functie aan met de tweede als parameter.
1. Roep de Save-methode aan met behulp van het eerste object en haal de samengevoegde bestanden op.
...
{{% blocks/products/pf/agp/code-block title=".NET-code: PDF-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel PDF-bestandsfusie met behulp van .NET</h2>

Moet u een .NET-script of een hulpprogramma-app ontwikkelen om eenvoudig meerdere PDF-bestanden samen te voegen?Met [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/), de onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om het samenvoegen van apps in verschillende documenten te programmeren.De krachtige .NET-bibliotheek maakt het programmeren van een oplossing voor het samenvoegen van documenten mogelijk die veel populaire formaten ondersteunt, waaronder het PDF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET samenvoegbibliotheek voor PDF-bestanden" %}}
