---
title: Voeg PPTX-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende PPTX-presentaties te combineren.C# .NET voegt bibliotheekcode samen om de PPTX-presentatie samen te voegen in het formaat van uw keuze.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg PPTX-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde PPTX-toepassing voor het samenvoegen van documenten.Combineer meerdere PPTX-documenten gratis online via de app.Sla het samengevoegde PPTX-bestand online op als PDF, Afbeeldingen, Word, Excel, PowerPoint en vele andere formaten." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Voeg PPTX-bestanden online samen met de app" %}}

1. Upload PPTX-bestanden om ze samen te voegen tot één bestand
...
1. Klik op de knop "Samenvoegen" om PPTX in het gewenste formaat samen te voegen
1. Download het samengevoegde PPTX-bestand
1. Bekijk en ontvang het enkele samengevoegde PPTX-bestand

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Voeg PPTX-bestand samen via .NET" %}}

1. Laad PPTX met behulp van het klasseobject Presentation
1. Selecteer de ene presentatie als basisbestand
1. Loop door elke dia van andere dia's
1. Gebruik de AddClone-methode voor elke dia tijdens de iteratie
1. Roep de Save-methode aan en ontvang een enkele samengevoegde presentatie
...
{{% blocks/products/pf/agp/code-block title=".NET-code: PPTX-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel PPTX-bestandsfusie met behulp van .NET</h2>

Moet u de .NET Merger Utility-app ontwikkelen om eenvoudig meerdere PPTX-bestanden samen te voegen?Met [Aspose.Slides for .NET](https://products.aspose.com/slides/nl/net/), de onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om documenten eenvoudig samen te voegen.Krachtige .NET-bibliotheek voor het samenvoegen van documenten ondersteunt vele populaire formaten, waaronder het PPTX-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET samenvoegbibliotheek voor PPTX-bestanden" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden. Men kan eenvoudig een professionele oplossing ontwikkelen om PPTX te combineren met .NET. Gebruik de PPTX merge-API om platformonafhankelijke software op hoog niveau in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is het veilig om de online app te gebruiken om meerdere PPTX-documenten te combineren?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">U kunt elke moderne webbrowser zoals Google Chrome, Firefox, Opera of Safari gebruiken voor het online samenvoegen van PPTX-documenten.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe kan ik meerdere PPTX-bestanden samenvoegen?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Begin met het uploaden van een of meer bestanden die u wilt samenvoegen. U kunt uw PPTX-bestanden slepen en neerzetten of eenvoudigweg in het witte gebied klikken. Klik daarna op de knop 'Samenvoegen' en onze fusie zal de geüploade bestanden snel verwerken.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe lang duurt het om de PPTX-bestanden samen te voegen?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
