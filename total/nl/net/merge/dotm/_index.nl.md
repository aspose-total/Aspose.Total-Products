---
title: Voeg DOTM-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende DOTM-bestanden te combineren..NET samenvoegende bibliotheekcode om DOTM-documenten samen te voegen.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg DOTM-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde DOTM-toepassing voor het samenvoegen van documenten.Combineer meerdere DOTM-documenten gratis online via de app.Sla het DOTM-bestand online op als PDF, afbeeldingen, Word, Excel, PowerPoint en vele andere formaten." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Voeg DOTM-bestand samen via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title=".NET-code: DOTM-bestanden samenvoegen" offSpacer="" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden. Men kan eenvoudig een professionele oplossing ontwikkelen om DOTM te combineren met .NET.Gebruik de Aspose DOTM merge-API om platformonafhankelijke software op hoog niveau in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
