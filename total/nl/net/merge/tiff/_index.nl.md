---
title: Voeg TIFF-bestanden online samen of gebruik .NET
description: Gratis online app om verschillende TIFF-bestanden te combineren. .NET samenvoegende bibliotheekcode om TIFF-documenten samen te voegen in het gewenste formaat.
...
{{< blocks/products/pf/feature-page-header-widget h1="Voeg TIFF-documenten online samen via de Merger-app of met behulp van .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde TIFF-toepassing voor het samenvoegen van documenten.Combineer meerdere TIFF-documenten gratis online in één app via de app.Sla het samengevoegde TIFF-bestand online op als PDF, afbeeldingen, Word en vele andere formaten." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Voeg TIFF-bestanden online samen met de app" %}}
...
1. Bekijk en ontvang het enkele samengevoegde TIFF-bestand

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Voeg TIFF-bestand samen via .NET" %}}
...
1. Roep de Save-methode aan en ontvang de samengevoegde TIFF-bestanden in één bestand.
...
{{% blocks/products/pf/agp/code-block title=".NET-code: TIFF-bestanden samenvoegen" offSpacer="" %}}
...
<h2>Ontwikkel TIFF-bestandsfusie met behulp van .NET</h2>

Moet u een .NET-hulpprogramma-app ontwikkelen om eenvoudig meerdere TIFF-bestanden samen te voegen?Met de [Aspose.Imaging for .NET](https://products.aspose.com/imaging/nl/net/) onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/) kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om het samenvoegen van apps in documenten te programmeren.Krachtige .NET-bibliotheek voor het samenvoegen van documenten ondersteunt vele populaire formaten, waaronder het TIFF-formaat.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Merger Library voor TIFF-bestanden" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden en te gebruiken voor het ontwikkelen van op .NET gebaseerde applicaties gericht op het combineren van TIFF-documenten.Men kan een professionele oplossing ontwikkelen om TIFF te combineren met behulp van .NET. Gebruik onze TIFF merge-API om hoogwaardige, platformonafhankelijke software in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
