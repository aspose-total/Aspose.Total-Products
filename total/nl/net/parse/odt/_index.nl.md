---
title: Extraheer tekst en afbeeldingen uit het ODT-bestand online en gebruik .NET
description: Online ODT-bestandsparser-app. .NET API C#-code om afbeeldingen en tekstinhoud uit het ODT-document te extraheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parseer het ODT-bestand zowel online als via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde ODT-hulpprogramma voor documentparser. C#-code vermeld voor extractie van ODT-documenttekst." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Parseer het ODT-bestand via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: ODT-documenttekstextractie" offSpacer="" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Gebruiksscenario's voor het parseren van .odt-bestanden

- 📄 Tekst, afbeeldingen en metadata extraheren uit OpenDocument-tekstbestanden.
- 🧾 `.odt`-bestanden converteren naar HTML, Markdown of PDF voor publicatie.
- 📚 Open-source documentindelingen archiveren door inhoud te converteren en indexeren.
