---
title: Extraheer tekst en afbeeldingen uit het Word-bestand online en gebruik .NET
description: Online Word-bestandsparser-app. .NET API C#-code om afbeeldingen en tekstinhoud uit het Word-document te extraheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parseer het Word-bestand zowel online als via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde Word-hulpprogramma voor documentparser. C#-code vermeld voor extractie van Word-documenttekst." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Parseer het Word-bestand via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: Word-documenttekstextractie" offSpacer="" %}}
