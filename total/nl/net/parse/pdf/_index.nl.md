---
title: Extraheer tekst en afbeeldingen uit het PDF-bestand online en gebruik .NET
description: Online PDF-bestandsparser-app. .NET API C#-code om afbeeldingen en tekst uit het PDF-document te extraheren.
...
{{< blocks/products/pf/feature-page-header-widget h1="Parseer het PDF-bestand online en extraheer tekst of afbeeldingen via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde PDF-hulpprogramma voor documentparser.C#-code vermeld voor PDF-documentafbeeldingen en tekstextractie." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Parseer het PDF-bestand via .NET" %}}

1. Voeg een bibliotheekverwijzing toe aan het .NET-project
1. Laad het PDF-bestand met de documentklasse
1. Gebruik het TextAbsorber-klasseobject
1. Accepteer het absorber voor alle pagina's
1. Haal de geëxtraheerde tekst op en schrijf
...
{{% blocks/products/pf/agp/code-block title="C#-code: PDF-documenttekstextractie" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "parse-pdf-documents-by-extracting-text.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="C#-code: PDF-extractie van documentafbeeldingen" offSpacer="" %}}
...
<h2>Ontwikkel een PDF-bestandsparsertoepassing via .NET</h2>

Wilt u een PDF-parser-app of -hulpprogramma ontwikkelen?Met [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/), een onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke Python-ontwikkelaar de bovenstaande API-code integreren in zijn documentparsertoepassing.Dankzij de krachtige .NET-bibliotheek kunt u elke oplossing voor het parseren van documenten programmeren om zowel afbeeldingen als tekst te extraheren.Bovendien ondersteunt het vele populaire formaten, waaronder het PDF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-hulpprogramma om het PDF-bestand voor de parser-app te verwerken" %}}
