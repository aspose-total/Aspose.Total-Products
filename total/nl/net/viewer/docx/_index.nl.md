---
title: Bekijk het DOCX-bestand online en gebruik .NET
description: Gratis online DOCX-bestandsviewer-app. .NET API C#-code om het DOCX-bestand voor viewertoepassing te bekijken.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk het DOCX-bestand gratis online of via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde DOCX-hulpprogramma voor documentviewer. C#-code vermeld om het DOCX-document te bekijken." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bekijk het DOCX-document via de online app" %}}

1. Importeer het DOCX-bestand om het te bekijken door het te uploaden.
...
1. Navigeer tussen pagina's in het geval van een DOCX-document met meerdere pagina's.
1. In- of uitzoomen van de paginaweergave instellen.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Bekijk DOCX-bestand via .NET" %}}

1. Voeg .NET-bibliotheekreferentie toe aan het project
1. Laad het bron-DOCX-bestand met behulp van het documentklasseobject
...
{{% blocks/products/pf/agp/code-block title="C#-code: DOCX-document bekijken" offSpacer="" %}}
...
<h2>Ontwikkel een DOCX File Viewer-applicatie via .NET</h2>

Wilt u een DOCX-viewer-app of -hulpprogramma ontwikkelen?Met [Aspose.Words for .NET](https://products.aspose.com/words/nl/net/), een onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren in zijn documentviewertoepassing.Dankzij de krachtige .NET-bibliotheek kunt u elke oplossing voor documentweergave programmeren die veel populaire formaten ondersteunt, waaronder het DOCX-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-hulpprogramma om het DOCX-bestand voor de weergave-app te verwerken" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is het veilig om de online app te gebruiken om het DOCX-document te bekijken?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">U kunt elke moderne webbrowser zoals Google Chrome, Firefox, Opera of Safari gebruiken voor de online DOCX-documentviewer. Als u echter een desktoptoepassing ontwikkelt, raden we u aan de documentverwerkings-API Aspose.Total te gebruiken voor efficiënt beheer.</span>
                      </div>
                  </li>
              </ul>
          </div>
