---
title: Bekijk het PDF-bestand online en gebruik .NET
description: Gratis online PDF-bestandsviewer-app. .NET API C#-code om het PDF-bestand voor viewertoepassing te bekijken.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk het PDF-bestand gratis online of via .NET" h2="Ontwikkel een krachtige, op .NET gebaseerde PDF-hulpprogramma voor documentviewer. C#-code vermeld om het PDF-document te bekijken." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Bekijk PDF-document via .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-code: PDF-document bekijken" offSpacer="" %}}
...
<h2>Ontwikkel een PDF File Viewer-applicatie via .NET</h2>

Wilt u een PDF-viewer-app of -hulpprogramma ontwikkelen?Met [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/), een onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/), kan elke .NET-ontwikkelaar de bovenstaande API-code integreren in zijn documentviewertoepassing.Dankzij de krachtige .NET-bibliotheek kunt u elke oplossing voor documentweergave programmeren die veel populaire formaten ondersteunt, waaronder het PDF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET-hulpprogramma om het PDF-bestand voor de weergave-app te verwerken" %}}
