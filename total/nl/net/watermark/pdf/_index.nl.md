---
title: Watermerk PDF-bestanden online of via .NET
description: Gratis online app om verschillende PDF-bestanden van een watermerk te voorzien. .NET-watermerkbibliotheek C#-code voor PDF-documenten.
...
{{< blocks/products/pf/feature-page-header-widget h1="Watermark PDF-bestand online via de Watermarking-app en via .NET-applicaties" h2="Ontwikkel krachtige .NET-gebaseerde PDF-documentwatermerktoepassingen.Watermerk gratis verschillende documenten, waaronder PDF-bestanden, online via de app met onmiddellijke download." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Watermerk PDF-bestanden online met behulp van app" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Watermerk PDF-bestand via .NET" %}}

1. Laad het PDF-document met de documentklasse
1. Maak een WatermarkArtifact-object
1. Gebruik het artefact om eigenschappen zoals SetTextAndState en meer toe te wijzen
1. Roep de Save-methode aan en haal het Watermarked PDF-bestand op

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title=".NET-code: PDF-bestanden met watermerk" offSpacer="" %}}
...
<h2>Ontwikkel een PDF-bestandswatermerktoepassing met behulp van .NET</h2>

Moet u een .NET-script of een hulpprogramma-app ontwikkelen om eenvoudig meerdere PDF-bestanden van een watermerk te voorzien?Met de [Aspose.PDF for .NET](https://products.aspose.com/pdf/nl/net/) onderliggende API van [Aspose.Total for .NET](https://products.aspose.com/total/nl/net/) kan elke .NET-ontwikkelaar de bovenstaande API-code integreren om de Watermarking-app in documenten te programmeren.Krachtige .NET-bibliotheek voor documentwatermerken ondersteunt vele populaire formaten, waaronder het PDF-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET Watermark Library voor PDF-bestanden" %}}

Er zijn drie alternatieve opties om "Aspose.PDF for .NET" of "Aspose.Total for .NET" op uw systeem te installeren.Kies er een die aan uw behoeften voldoet en volg de stapsgewijze instructies:<br /><br />
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Ja, u bent van harte welkom om deze code te downloaden. U kunt eenvoudig een professionele oplossing voor het Watermark PDF-bestand ontwikkelen met behulp van .NET.Gebruik de Aspose PDF Watermarking API om hoogwaardige, platformonafhankelijke software in .NET te ontwikkelen.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is het veilig om de online app te gebruiken om meerdere PDF-documenten van een watermerk te voorzien?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">U kunt elke moderne webbrowser zoals Google Chrome, Firefox, Opera of Safari gebruiken voor online PDF-documentwatermerken.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe kan ik meerdere PDF-bestanden van een watermerk voorzien?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Begin met het uploaden van een of meer bestanden die u van een watermerk wilt voorzien. U kunt uw PDF-bestanden slepen en neerzetten of eenvoudigweg in het witte gebied klikken.Klik daarna op de knop 'Watermerk' en onze online Watermarking-app verwerkt de geüploade bestanden snel.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Hoe lang duurt het om de PDF-bestanden van een watermerk te voorzien?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
