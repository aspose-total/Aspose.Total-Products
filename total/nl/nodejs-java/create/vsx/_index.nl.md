---
title: Maak VSX Visio-diagrammen in Node.js
description: Genereer Microsoft Visio VSX-diagrammen met Node-toepassingen zonder Microsoft Office te gebruiken. 
...
{{< blocks/products/pf/feature-page-header h1="Maak VSX-bestand met Node.js" h2="Genereer Microsoft Visio VSX-bestanden via uw Node-toepassingen zonder dat u andere software hoeft te installeren." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Maak VSX-bestand in Node.js" %}}

- Maak een Diagram-klasse-instantie.
- Roep de save-methode aan met relevante parameters
- VSX Bestandspad en relevante extensie voor SaveFileFormat

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Creatievereisten" %}}

- Voor het maken van VSX-documenten moet Node.js op het systeem geïnstalleerd zijn.
- Oracle JDK (versie 7 of hoger) is vereist.
- Het node-java-pakket moet worden geïnstalleerd.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js - VSX-bestanden maken" offSpacer="" %}}
