---
title: Converteer OTT naar XLT in C++
description: C++ API om OTT naar XLT te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/ott-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OTT naar XLT te converteren" h2="Exporteer OTT naar XLT via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om OTT naar XLT te converteren" %}}
