---
title: Export OFT naar PCL via C++
description: C++ API om OFT naar PCL te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/oft-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OFT naar PCL te exporteren" h2="Transformeer OFT naar PCL binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
