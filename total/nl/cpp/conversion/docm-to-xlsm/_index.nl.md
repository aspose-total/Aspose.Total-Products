---
title: Converteer DOCM naar XLSM in C++
description: C++ API om DOCM naar XLSM te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/docm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOCM naar XLSM te converteren" h2="Exporteer DOCM naar XLSM via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOCM naar XLSM te converteren" %}}
