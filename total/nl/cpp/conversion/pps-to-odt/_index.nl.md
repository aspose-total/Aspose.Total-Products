---
title: C++ API om PPS naar ODT te converteren
description: Exporteer PPS naar ODT binnen uw C++-toepassingen
url: /nl/cpp/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API om PPS naar ODT te renderen" h2="Exporteer PPS naar ODT in C++-toepassingen zonder Microsoft PowerPoint- of Word-afhankelijkheden" >}}
