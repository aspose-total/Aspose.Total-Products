---
title: Converteer XLSX naar DOCX met C++
description: Converteer XLSX naar DOCX binnen C++-toepassingen
url: /nl/cpp/conversion/xlsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Converteer XLSX naar DOCX via C++" h2="Excel exporteren&reg; XLSX naar DOCX binnen volledig functionele C++-toepassingen" >}}
