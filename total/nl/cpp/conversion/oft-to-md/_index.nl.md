---
title: Export OFT naar MD via C++
description: C++ API om OFT naar MD te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/oft-to-md/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OFT naar MD te exporteren" h2="Transformeer OFT naar MD binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
