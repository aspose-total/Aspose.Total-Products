...
description: Exporteer POT naar XLT in C++ zonder Microsoft Excel of Powerpoint te gebruiken
url: /nl/cpp/conversion/pot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Converteer POT naar XLT via C++" h2="POT naar XLT-bestandsconversie via C++ zonder Microsoft<sup>&reg;</sup> Excel of PowerPoint" >}}
