---
title: Export OFT naar PNG via C++
description: C++ API om OFT naar PNG te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/oft-to-png/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OFT naar PNG te exporteren" h2="Transformeer OFT naar PNG binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
