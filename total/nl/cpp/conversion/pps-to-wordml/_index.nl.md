---
title: C++ API om PPS naar WORDML te converteren
description: Exporteer PPS naar WORDML binnen uw C++-toepassingen
url: /nl/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API om PPS naar WORDML te renderen" h2="Exporteer PPS naar WORDML in C++-toepassingen zonder Microsoft PowerPoint- of Word-afhankelijkheden" >}}
