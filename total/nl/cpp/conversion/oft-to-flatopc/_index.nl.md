---
title: Export OFT naar FLATOPC via C++
description: C++ API om OFT naar FLATOPC te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/oft-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OFT naar FLATOPC te exporteren" h2="Transformeer OFT naar FLATOPC binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
