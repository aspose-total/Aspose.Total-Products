---
title: Converteer WORD naar PPSM via C++
description: Exporteer WORD naar PPSM in uw C++-toepassingen zonder Microsoft Word of PowerPoint te gebruiken
url: /nl/cpp/conversion/word-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API om WORD naar PPSM te converteren" h2="Exporteer WORD naar PPSM binnen uw C++-toepassingen zonder Microsoft Word&reg; of PowerPoint" >}}
