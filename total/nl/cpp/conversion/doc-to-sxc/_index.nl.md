---
title: Converteer DOC naar SXC in C++
description: C++ API om DOC naar SXC te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/doc-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOC naar SXC te converteren" h2="Exporteer DOC naar SXC via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOC naar SXC te converteren" %}}
