---
title: Converteer DOTX naar SXC in C++
description: C++ API om DOTX naar SXC te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/dotx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOTX naar SXC te converteren" h2="Exporteer DOTX naar SXC via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOTX naar SXC te converteren" %}}
