---
title: Converteer WORD naar PPS via C++
description: Exporteer WORD naar PPS in uw C++-toepassingen zonder Microsoft Word of PowerPoint te gebruiken
url: /nl/cpp/conversion/word-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API om WORD naar PPS te converteren" h2="Exporteer WORD naar PPS binnen uw C++-toepassingen zonder Microsoft Word&reg; of PowerPoint" >}}
