---
title: Export EML naar DOCM via C++
description: C++ API om EML naar DOCM te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/eml-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API om EML naar DOCM te exporteren" h2="Transformeer EML naar DOCM binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
