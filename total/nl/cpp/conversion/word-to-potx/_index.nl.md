---
title: Converteer WORD naar POTX via C++
description: Exporteer WORD naar POTX in uw C++-toepassingen zonder Microsoft Word of PowerPoint te gebruiken
url: /nl/cpp/conversion/word-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API om WORD naar POTX te converteren" h2="Exporteer WORD naar POTX binnen uw C++-toepassingen zonder Microsoft Word&reg; of PowerPoint" >}}
