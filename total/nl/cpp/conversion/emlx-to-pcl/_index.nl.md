---
title: Export EMLX naar PCL via C++
description: C++ API om EMLX naar PCL te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/emlx-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API om EMLX naar PCL te exporteren" h2="Transformeer EMLX naar PCL binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
