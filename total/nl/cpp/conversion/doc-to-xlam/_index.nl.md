---
title: Converteer DOC naar XLAM in C++
description: C++ API om DOC naar XLAM te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOC naar XLAM te converteren" h2="Exporteer DOC naar XLAM via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOC naar XLAM te converteren" %}}
