---
title: Export OFT naar DOCX via C++
description: C++ API om OFT naar DOCX te converteren zonder Microsoft Word of Outlook te gebruiken
url: /nl/cpp/conversion/oft-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API om OFT naar DOCX te exporteren" h2="Transformeer OFT naar DOCX binnen de C++-toepassing zonder dat Microsoft Word of Outlook nodig is" >}}
...
U kunt ook functies voor documentbeveiliging in uw app toevoegen terwijl u het document van OFT naar DOCX exporteert. Beveiliging toevoegen aan uw document is een eenvoudig proces, aangezien u alleen de beveiligingsmethode op uw document hoeft toe te passen. U kunt het beveiligingstype instellen op Alleen-lezen om de gebruiker te beperken om het document te bewerken.
{{% blocks/products/pf/feature-page-code %}}
