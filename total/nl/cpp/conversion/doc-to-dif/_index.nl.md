---
title: Converteer DOC naar DIF in C++
description: C++ API om DOC naar DIF te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/doc-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOC naar DIF te converteren" h2="Exporteer DOC naar DIF via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOC naar DIF te converteren" %}}
