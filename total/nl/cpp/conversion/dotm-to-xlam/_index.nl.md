---
title: Converteer DOTM naar XLAM in C++
description: C++ API om DOTM naar XLAM te converteren zonder Microsoft Word of Microsoft Excel te gebruiken
url: /nl/cpp/conversion/dotm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API om DOTM naar XLAM te converteren" h2="Exporteer DOTM naar XLAM via C++ zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API om DOTM naar XLAM te converteren" %}}
