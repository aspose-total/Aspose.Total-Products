---
title: Converteer PPSM naar DOCX via Java
description: Java API om PPSM naar DOCX te exporteren zonder Microsoft Word of PowerPoint te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer PPSM naar DOCX via Java" h2="On Premise Java API voor PowerPoint PPSM naar DOCX conversie binnen alle Java J2SE, J2EE, J2ME applicaties" >}}
...
2. Converteer PPSM naar HTML met behulp van [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) methode en stel Html in als SaveFormat
...
Voor PPSM-naar-DOCX-bestandsconversie kunt u Aspose.Total voor Java eenvoudig rechtstreeks vanuit een [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) gebaseerd project en neem bibliotheken op in uw pom.xml.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/nl/net/conversion/ppsm-to-docxm/" name="PPSM Tot DOCXM" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/nl/net/conversion/ppsm-to-docxx/" name="PPSM Tot DOCXX" description="" >}}
