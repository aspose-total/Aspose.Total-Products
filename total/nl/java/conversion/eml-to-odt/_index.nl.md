---
title: Exporteer EML naar ODT via Java
description: Java API om EML naar ODT te converteren zonder Microsoft Word of Outlook te gebruiken
url_ignore: /nl/java/conversion/eml-to-odt/
family: total
platformtag: net
feature: conversion
informat: EML
...
{{< /blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/feature-page-summary %}}
**ODT (OpenDocument Tekst)** wordt gebruikt door LibreOffice en OpenOffice. Het converteren van **EML naar ODT** zorgt voor open-source compatibiliteit.

## ✅ Belangrijkste Gebruiksscenario's
- E-mails bewerken in LibreOffice of Apache OpenOffice.
- Langetermijnarchivering in ISO-compatibel documentformaat.
- Ondernemingsworkflows die open standaarden vereisen.

## ⚙️ Automatiseringsscenario's
- Batchgewijs converteren van EML naar ODT voor documentopslag.
- Automatiseren van export naar door de overheid goedgekeurde formaten.
- Samenwerking mogelijk maken in open-source kantooromgevingen.
