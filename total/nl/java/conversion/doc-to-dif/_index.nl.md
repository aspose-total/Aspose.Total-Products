...
description: Converteer DOC naar DIF via Java zonder Microsoft Word of Microsoft Excel te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer DOC naar DIF via Java" h2="On Premise Java API om DOC naar DIF te converteren zonder Microsoft<sup>&reg;</sup> Word of Microsoft<sup>&reg;</sup> Excel te gebruiken" >}}
