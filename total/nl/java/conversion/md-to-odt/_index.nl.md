---
title: Java API om MD naar ODT te exporteren
description: Converteer MD naar ODT met behulp van on-premise Java API
url_ignore: /nl/java/conversion/md-to-odt/
family: total
platformtag: net
feature: conversion
informat: MD
...
{{< blocks/products/pf/i18n/feature-page-header h1="Transformeer MD naar ODT via Java" h2="On Premise Java API om MD naar ODT te renderen zonder een applicatie van derden te gebruiken" >}}
{{% blocks/products/pf/feature-page-summary %}}
U kunt MD naar ODT converteren met behulp van twee eenvoudige stappen. Eerst moet u het MD-bestand naar DOC renderen met [Aspose.PDF for Java](https://products.aspose.com/pdf/java/). Daarna kunt u met behulp van de krachtige API voor documentverwerking [Aspose.Words for Java](https://products.aspose.com/words/java/) DOC naar ODT converteren. Beide API's vallen onder het pakket [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java API om MD naar ODT te converteren" %}}
...
4. Sla het document op in ODT-formaat met behulp van [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) methode en stel ODT in als OpslaanFormaat
