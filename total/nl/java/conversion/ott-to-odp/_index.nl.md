...
url: /nl/java/conversion/ott-to-odp/
family: total
platformtag: net
feature: conversion
informat: OTT
...
6. Sla het ottument op in ODP met de methode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
Met de API kunt u ook met een wachtwoord beveiligde OTT-ottumenten naar ODP converteren. Als uw OTT-invoerottument met een wachtwoord is beveiligd, kunt u het niet converteren naar ODP-indeling zonder het wachtwoord te gebruiken. Om een versleuteld ottument te openen, kunt u het juiste wachtwoord instellen in het object LoadOptions en dit doorgeven aan de ottumentconstructor.  
{{% blocks/products/pf/feature-page-code %}}
