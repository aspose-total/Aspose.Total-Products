...
6. Sla het odtument op in PPS met de methode [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.io.OutputStream-int-)
...
Met de API kunt u ook met een wachtwoord beveiligde ODT-odtumenten naar PPS converteren. Als uw ODT-invoerodtument met een wachtwoord is beveiligd, kunt u het niet converteren naar PPS-indeling zonder het wachtwoord te gebruiken. Om een versleuteld odtument te openen, kunt u het juiste wachtwoord instellen in het object LoadOptions en dit doorgeven aan de odtumentconstructor.  
{{% blocks/products/pf/feature-page-code %}}
