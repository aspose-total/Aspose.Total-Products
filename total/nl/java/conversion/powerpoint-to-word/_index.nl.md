---
title: Converteer POWERPOINT naar WORD via Java
description: Java API om POWERPOINT naar WORD te exporteren zonder Microsoft Word of PowerPoint te gebruiken
...
{{< blocks/products/pf/i18n/feature-page-header h1="Converteer POWERPOINT naar WORD via Java" h2="On Premise Java API voor PowerPoint POWERPOINT naar WORD conversie binnen alle Java J2SE, J2EE, J2ME applicaties" >}}
...
4. Sla het document op in WORD-indeling met de methode [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int))
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Conversievereisten" %}}
Voor POWERPOINT-naar-WORD-bestandsconversie kunt u Aspose.Total voor Java eenvoudig rechtstreeks vanuit een [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) gebaseerd project en neem bibliotheken op in uw pom.xml.
