---
title: Bescherm DOC-document online met wachtwoord en gebruik van Java
description: Online DOC-app voor wachtwoordbeveiliging voor bestanden.Java API-code om wachtwoordbeveiliging toe te passen op het DOC-document.
...
{{< blocks/products/pf/feature-page-header-widget h1="Online DOC-documentbeveiliging of wachtwoord instellen via Java" h2="Ontwikkel een krachtige op Java gebaseerde DOC-hulpprogramma voor documentbeveiliging.Code vermeld voor het toepassen van een wachtwoord op een DOC-document via Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="DOC-wachtwoordbeveiliging via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java-code voor DOC-documentwachtwoordbeveiliging" offSpacer="" %}}
...
<h2>Ontwikkel een DOC-wachtwoordbeveiligingsapplicatie via Java</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-hulpprogramma om DOC-bestand te verwerken voor beveiligingsapp" %}}
