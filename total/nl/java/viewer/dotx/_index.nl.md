---
title: Bekijk het DOTX-bestand online en gebruik Java
description: Gratis online DOTX-bestandsviewer-app. Java API-code om het DOTX-bestand voor viewertoepassing te bekijken.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk het DOTX-bestand gratis online of via Java" h2="Ontwikkel een krachtige op Java gebaseerde DOTX-documentviewer-hulpprogramma.Code vermeld om het DOTX-document via Java te bekijken." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Bekijk DOTX-bestand via Java" %}}

1. Voeg een Java-bibliotheekreferentie toe aan het project
1. Laad het bron-DOTX-bestand met behulp van het documentklasseobject
...
{{% blocks/products/pf/agp/code-block title="Java-code om DOTX-bestanden te bekijken" offSpacer="" %}}
...
<h2>Ontwikkel een DOTX File Viewer-applicatie via Java</h2>

Wilt u een DOTX-viewer-app of -hulpprogramma ontwikkelen?Met [Aspose.Words for Java](https://products.aspose.com/words/nl/java/), een onderliggende API van [Aspose.Total for Java](https://products.aspose.com/total/nl/java/), kan elke Java-ontwikkelaar de bovenstaande API-code integreren in zijn documentviewertoepassing.Dankzij de krachtige Java-bibliotheek kunt u elke oplossing voor documentweergave programmeren die veel populaire formaten ondersteunt, waaronder het DOTX-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-hulpprogramma om het DOTX-bestand voor de weergave-app te verwerken" %}}
