---
title: Bekijk het XLSB-bestand online en gebruik Java
description: Gratis online XLSB-bestandsviewer-app. Java API-code om het XLSB-bestand te lezen voor viewertoepassing.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk het XLSB-bestand gratis online of via Java" h2="Ontwikkel een krachtige op Java gebaseerde XLSB-documentviewer-hulpprogramma.Code vermeld om het XLSB-document via Java te bekijken." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Bekijk het XLSB-document via de online app" %}}
...
1. Navigeer tussen pagina's in het geval van een XLSB-document met meerdere pagina's.
1. In- of uitzoomen van de paginaweergave instellen.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Bekijk XLSB-bestand via Java" %}}

1. Voeg een Java-bibliotheekreferentie toe aan het project
1. Laad het bron-XLSB-bestand met behulp van het Workbook-klasseobject
...
{{% blocks/products/pf/agp/code-block title="Java-code om XLSB-bestanden te bekijken" offSpacer="" %}}
...
<h2>Ontwikkel een XLSB File Viewer-applicatie via Java</h2>

Wilt u een XLSB-viewer-app of -hulpprogramma ontwikkelen?Met [Aspose.Cells for Java](https://products.aspose.com/cells/nl/java/), een onderliggende API van [Aspose.Total for Java](https://products.aspose.com/total/nl/java/), kan elke Java-ontwikkelaar de bovenstaande API-code integreren in zijn documentviewertoepassing.Dankzij de krachtige Java-bibliotheek kunt u elke oplossing voor documentweergave programmeren die veel populaire formaten ondersteunt, waaronder het XLSB-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-hulpprogramma om het XLSB-bestand voor de weergave-app te verwerken" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Is het veilig om de online app te gebruiken om het XLSB-document te bekijken?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">U kunt elke moderne webbrowser zoals Google Chrome, Firefox, Opera of Safari gebruiken voor de online XLSB-documentviewer.Als u echter een desktoptoepassing ontwikkelt, raden we u aan de documentverwerkings-API Aspose.Total te gebruiken voor efficiënt beheer.</span>
                      </div>
                  </li>
              </ul>
          </div>
