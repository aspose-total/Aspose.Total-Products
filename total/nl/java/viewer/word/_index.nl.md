---
title: Bekijk het Word-bestand online en gebruik Java
description: Gratis online Word-bestandsviewer-app. Java API-code om het Word-bestand voor viewertoepassing te bekijken.
...
{{< blocks/products/pf/feature-page-header-widget h1="Bekijk het Word-bestand gratis online of via Java" h2="Ontwikkel een krachtige op Java gebaseerde Word-documentviewer-hulpprogramma.Code vermeld om het Word-document via Java te bekijken." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Bekijk Word-bestand via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Java-code om Word-bestanden te bekijken" offSpacer="" %}}
...
<h2>Ontwikkel een Word File Viewer-applicatie via Java</h2>

Wilt u een Word-viewer-app of -hulpprogramma ontwikkelen?Met [Aspose.Words for Java](https://products.aspose.com/words/nl/java/), een onderliggende API van [Aspose.Total for Java](https://products.aspose.com/total/nl/java/), kan elke Java-ontwikkelaar de bovenstaande API-code integreren in zijn documentviewertoepassing.Dankzij de krachtige Java-bibliotheek kunt u elke oplossing voor documentweergave programmeren die veel populaire formaten ondersteunt, waaronder het Word-formaat.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Java-hulpprogramma om het Word-bestand voor de weergave-app te verwerken" %}}
