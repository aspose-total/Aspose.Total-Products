---
title: Eksportuj POTM do WORDML na Androidzie przez Javę
description: Konwertuj POTM na WORDML w aplikacjach mobilnych bez instalowania żadnego oprogramowania
url: /pl/android-java/conversion/potm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Renderuj POTM do WORDML na Androidzie przez Javę" h2="Interfejsy API formatów plików do konwersji POTM na WORDML w aplikacjach na Androida bez konieczności korzystania z programu Microsoft PowerPoint lub Word" >}}
