---
title: Eksportuj XLS do WORD w Androidzie
description: Android API do konwersji XLS na WORD bez użycia Microsoft Word
url: /pl/android-java/conversion/xls-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Renderuj XLS do WORD na Androidzie przez Javę" h2="Przekształć XLS w WORD w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/android-java/conversion/xls-to-wordx/" name="XLS Do WORDX" description="" >}}
