---
title: Android API do konwersji DOCX na XLSX
description: Konwertuj DOCX na XLSX w Androidzie przez Javę bez używania Microsoft Word lub Microsoft Excel
url: /pl/android-java/conversion/docx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj DOCX na XLSX w aplikacjach na Androida" h2="Eksportuj DOCX do XLSX w Androidzie przez Javę bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
