---
title: Konwertuj DOCM na PPSX w Androidzie przez Java
description: Konwersja DOCM do PPSX w telefonach z systemem Android bez korzystania z programu Microsoft Word lub PowerPoint
url: /pl/android-java/conversion/docm-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj DOCM na PPSX w aplikacjach na Androida" h2="Konwersja DOCM na PPSX w aplikacjach na Androida bez instalowania programu Microsoft Word<sup>&reg;</sup> lub PowerPoint" >}}
...
Do konwersji plików DOCM na PPSX możesz łatwo użyć Aspose.Total dla Androida przez Javę bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i zainstaluj biblioteki w swojej aplikacji.
...
Możesz także przekonwertować chroniony hasłem DOCM na PPSX w swoich aplikacjach na Androida. Jeśli wejściowy dokument DOCM jest chroniony hasłem, nie można go przekonwertować do formatu PPSX bez użycia hasła. Aby otworzyć zaszyfrowany dokument, możesz ustawić poprawne hasło w obiekcie LoadOptions i przekazać je do konstruktora Docmument.
{{% blocks/products/pf/feature-page-code %}}
