---
title: Konwertuj PPSM na CSV w Androidzie przez Java
description: Konwertuj PPSM na CSV w Androidzie przez Javę bez używania Microsoft Excel lub PowerPoint
url: /pl/android-java/conversion/ppsm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPSM na CSV w Androidzie przez Java" h2="Eksportuj plik PPSM do CSV w aplikacjach na Androida bez użycia programu Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}

{{% blocks/products/pf/feature-page-summary %}}
Możesz łatwo przekonwertować plik PPSM na CSV w swoich aplikacjach na Androida w dwuetapowym procesie za pomocą [Aspose.Total dla Androida przez Javę](https://products.aspose.com/total/android-java/). W pierwszym kroku możesz wyeksportować plik PPSM do HTML, używając [Aspose.Slides na Androida przez Javę](https://products.aspose.com/slides/android-java/). Po drugie, używając [Aspose.Cells na Androida przez Javę](https://products.aspose.com/cells/android-java/), możesz przekonwertować HTML na CSV. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
Aby przekonwertować PPSM do CSV, możesz łatwo użyć Aspose.Total dla Androida przez Javę bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i zainstaluj biblioteki w swojej aplikacji.
