---
title: Eksportuj FODS do POWERPOINT w Androidzie
description: Android API do konwersji FODS na POWERPOINT bez użycia Microsoft Word
url: /pl/android-java/conversion/fods-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Renderuj FODS do POWERPOINT na Androidzie przez Javę" h2="Przekształć FODS w POWERPOINT w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
