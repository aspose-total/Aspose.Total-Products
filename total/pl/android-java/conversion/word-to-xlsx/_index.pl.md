---
title: Android API do konwersji WORD na XLSX
description: Konwertuj WORD na XLSX w Androidzie przez Javę bez używania Microsoft Word lub Microsoft Excel
url: /pl/android-java/conversion/word-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj WORD na XLSX w aplikacjach na Androida" h2="Eksportuj WORD do XLSX w Androidzie przez Javę bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
