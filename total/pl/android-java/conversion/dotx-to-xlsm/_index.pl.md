---
title: Android API do konwersji DOTX na XLSM
description: Konwertuj DOTX na XLSM w Androidzie przez Javę bez używania Microsoft Word lub Microsoft Excel
url: /pl/android-java/conversion/dotx-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj DOTX na XLSM w aplikacjach na Androida" h2="Eksportuj DOTX do XLSM w Androidzie przez Javę bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
