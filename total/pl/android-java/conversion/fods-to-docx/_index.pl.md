---
title: Eksportuj FODS do DOCX w Androidzie
description: Android API do konwersji FODS na DOCX bez użycia Microsoft Word
url: /pl/android-java/conversion/fods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Renderuj FODS do DOCX na Androidzie przez Javę" h2="Przekształć FODS w DOCX w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
