---
title: Android API do konwersji WORD na XLSB
description: Konwertuj WORD na XLSB w Androidzie przez Javę bez używania Microsoft Word lub Microsoft Excel
url: /pl/android-java/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj WORD na XLSB w aplikacjach na Androida" h2="Eksportuj WORD do XLSB w Androidzie przez Javę bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
