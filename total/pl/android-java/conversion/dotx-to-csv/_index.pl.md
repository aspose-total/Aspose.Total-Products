---
title: Android API do konwersji DOTX na CSV
description: Konwertuj DOTX na CSV w Androidzie przez Javę bez używania Microsoft Word lub Microsoft Excel
url: /pl/android-java/conversion/dotx-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj DOTX na CSV w aplikacjach na Androida" h2="Eksportuj DOTX do CSV w Androidzie przez Javę bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
