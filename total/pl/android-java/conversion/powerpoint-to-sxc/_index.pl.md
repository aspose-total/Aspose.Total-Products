...
url: /pl/android-java/conversion/powerpoint-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POWERPOINT
...
Możesz łatwo przekonwertować plik POWERPOINT na SXC w swoich aplikacjach na Androida w dwuetapowym procesie za pomocą [Aspose.Total dla Androida przez Javę](https://products.aspose.com/total/android-java/). W pierwszym kroku możesz wyeksportować plik POWERPOINT do HTML, używając [Aspose.Slides na Androida przez Javę](https://products.aspose.com/slides/android-java/). Po drugie, używając [Aspose.Cells na Androida przez Javę](https://products.aspose.com/cells/android-java/), możesz przekonwertować HTML na SXC. 
{{% /blocks/products/pf/feature-page-summary  %}}
...
Aby przekonwertować POWERPOINT do SXC, możesz łatwo użyć Aspose.Total dla Androida przez Javę bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i zainstaluj biblioteki w swojej aplikacji.
