---
title: Eksportuj PPS do ODT na Androidzie przez Javę
description: Konwertuj PPS na ODT w aplikacjach mobilnych bez instalowania żadnego oprogramowania
url: /pl/android-java/conversion/pps-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Renderuj PPS do ODT na Androidzie przez Javę" h2="Interfejsy API formatów plików do konwersji PPS na ODT w aplikacjach na Androida bez konieczności korzystania z programu Microsoft PowerPoint lub Word" >}}
