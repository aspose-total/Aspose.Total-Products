---
title: Eksportuj XLTM do DOCX w Androidzie
description: Android API do konwersji XLTM na DOCX bez użycia Microsoft Word
url: /pl/android-java/conversion/xltm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLTM
...
{{< blocks/products/pf/feature-page-header h1="Renderuj XLTM do DOCX na Androidzie przez Javę" h2="Przekształć XLTM w DOCX w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
