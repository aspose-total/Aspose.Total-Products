---
title: Eksportuj XLSM do WORD w Androidzie
description: Android API do konwersji XLSM na WORD bez użycia Microsoft Word
url: /pl/android-java/conversion/xlsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Renderuj XLSM do WORD na Androidzie przez Javę" h2="Przekształć XLSM w WORD w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
