---
title: Eksportuj XLSM do DOCX w Androidzie
description: Android API do konwersji XLSM na DOCX bez użycia Microsoft Word
url: /pl/android-java/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Renderuj XLSM do DOCX na Androidzie przez Javę" h2="Przekształć XLSM w DOCX w swoich aplikacjach na Androida bez użycia Microsoft<sup>&reg;</sup> Excel" >}}
