---
title: Wyodrębnij tekst i obrazy z pliku DOCM online i za pomocą aplikacji mobilnych na Androida
description: Aplikacja do analizowania plików online DOCM. Kod API Androida do wyodrębniania obrazów i treści tekstowych z dokumentu DOCM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik DOCM online, a także wyodrębnij tekst za pomocą aplikacji na Androida" h2="Twórz potężną aplikację do analizowania dokumentów DOCM na Androida. Kod wymieniony dla ekstrakcji tekstu dokumentu DOCM." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument DOCM online" %}}

1. Zaimportuj plik DOCM do analizy, przesyłając go.
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij tekst z pliku DOCM za pomocą aplikacji na Androida" %}}

1. Dodaj odwołanie do biblioteki do projektu Java  
1. Załaduj plik DOCM przy użyciu obiektu klasy Document
...
{{% blocks/products/pf/agp/code-block title="Kod: wyodrębnij tekst dokumentu DOCM" offSpacer="" %}}
...
<h2>Opracuj aplikację do analizowania plików DOCM na Androida</h2>

Potrzebujesz opracować aplikację lub oprogramowanie analizatora składni DOCM? Dzięki [Aspose.Words for Android via Java](https://products.aspose.com/words/pl/android-java/), podrzędnemu API [Aspose.Total for Android via Java](https://products.aspose.com/total/pl/android-java/), każdy programista Androida może zintegrować powyższy kod API ze swoją aplikacją do analizowania dokumentów. Potężna biblioteka dla Androida umożliwia zaprogramowanie dowolnego rozwiązania do analizowania dokumentów w celu wyodrębnienia obrazów i tekstu. Ponadto może obsługiwać wiele popularnych formatów, w tym format DOCM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie dla Androida do przetwarzania pliku DOCM dla aplikacji parsera" %}}
