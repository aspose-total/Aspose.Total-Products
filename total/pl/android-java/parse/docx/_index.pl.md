---
title: Wyodrębnij tekst i obrazy z pliku DOCX online i za pomocą aplikacji mobilnych na Androida
description: Aplikacja do analizowania plików online DOCX. Kod API Androida do wyodrębniania obrazów i treści tekstowych z dokumentu DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik DOCX online, a także wyodrębnij tekst za pomocą aplikacji na Androida" h2="Twórz potężną aplikację do analizowania dokumentów DOCX na Androida. Kod wymieniony dla ekstrakcji tekstu dokumentu DOCX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument DOCX online" %}}

1. Zaimportuj plik DOCX do analizy, przesyłając go.
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij tekst z pliku DOCX za pomocą aplikacji na Androida" %}}

1. Dodaj odwołanie do biblioteki do projektu Java  
1. Załaduj plik DOCX przy użyciu obiektu klasy Document
...
{{% blocks/products/pf/agp/code-block title="Kod: wyodrębnij tekst dokumentu DOCX" offSpacer="" %}}
