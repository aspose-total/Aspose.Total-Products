---
title: Manipulacja plikami PDF i dodawanie OCR za pośrednictwem interfejsów API Node.js
description: API Node.js do manipulowania plikami PDF i wyodrębniania tekstu z obrazów za pośrednictwem aplikacji.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Interfejs API Node.js do wyodrębniania plików PDF i tekstu obrazu" h2="Wyodrębnij tekst z obrazów, a także dołącz funkcje manipulacji plikami PDF w aplikacjach Node.js bez żadnych innych zależności programowych" logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total dla Node.js poprzez C++ to kompleksowy zestaw bibliotek Node.js.Biblioteki te oferują takie funkcje, jak bezpośrednia praca z plikami PDF i ulepszanie aplikacji w celu przekształcania obrazów w tekst.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total dla Node.js poprzez C++ zawiera następujące biblioteki Node.js:" >}}
...
Aspose.PDF dla Node.js poprzez C++ umożliwia obsługę plików PDF na zapleczu. Korzystając z niego, możesz optymalizować pliki PDF, włączać i wyodrębniać tekst i obrazy, a także wdrażać procesy szyfrowania i deszyfrowania. Co więcej, funkcjonalność obejmuje możliwość łatwego dzielenia i łączenia dokumentów PDF, zapewniając kompleksowy zestaw narzędzi do usprawnionej manipulacji plikami PDF.
...
Aspose.OCR dla Node.js poprzez C++ umożliwia wyodrębnianie tekstu z obrazów, takich jak zeskanowane strony i zdjęcia, na platformach kompatybilnych z Node.js.Ulepsz lokalne produkty, usługi internetowe i aplikacje bezserwerowe dzięki zaawansowanej funkcji optycznego rozpoznawania znaków, obsługującej 28 języków, w tym chiński i hindi w popularnych formatach.
{{< /blocks/products/pf/total/product-item >}}
...
<h2 class="pr-ft">
 ...
 Omówienie Node.js za pośrednictwem bibliotek C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
W rzeczywistości pakiet Aspose.Total dla .NET jest „szwajcarskim scyzorykiem” wśród komponentów, których używamy. Znajdując się obok komponentów warstwy prezentacji, tworzy „klej” umożliwiający ściąganie i przesyłanie plików danych w żądanym formacie.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total oferuje indywidualne rozwiązania dla innych platform." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/pl/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/pl/nodejs-java/" 
