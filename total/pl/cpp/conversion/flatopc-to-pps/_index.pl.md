---
title: Konwertuj FLATOPC na PPS za pomocą C++
description: Eksportuj FLATOPC do PPS w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji FLATOPC na PPS" h2="Eksportuj FLATOPC do PPS w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
