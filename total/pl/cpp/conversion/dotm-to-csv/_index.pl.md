---
title: Konwertuj DOTM na CSV w C++
description: C++ API do konwersji DOTM na CSV bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na CSV" h2="Eksportuj DOTM do CSV za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
