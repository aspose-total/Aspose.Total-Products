---
title: C++ API do konwersji PPSM na ODT
description: Eksportuj PPSM do ODT w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do ODT" h2="Eksportuj PPSM do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
