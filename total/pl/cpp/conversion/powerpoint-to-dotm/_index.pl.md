---
title: C++ API do konwersji POWERPOINT na DOTM
description: Eksportuj POWERPOINT do DOTM w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do DOTM" h2="Eksportuj POWERPOINT do DOTM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
