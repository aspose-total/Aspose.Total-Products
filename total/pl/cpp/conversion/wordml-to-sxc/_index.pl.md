---
title: Konwertuj WORDML na SXC w C++
description: C++ API do konwersji WORDML na SXC bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na SXC" h2="Eksportuj WORDML do SXC za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
