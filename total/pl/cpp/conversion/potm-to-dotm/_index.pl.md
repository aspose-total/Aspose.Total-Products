---
title: C++ API do konwersji POTM na DOTM
description: Eksportuj POTM do DOTM w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do DOTM" h2="Eksportuj POTM do DOTM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
