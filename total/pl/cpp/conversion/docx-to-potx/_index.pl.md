---
title: Konwertuj DOCX na POTX za pomocą C++
description: Eksportuj DOCX do POTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docx-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na POTX" h2="Eksportuj DOCX do POTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
