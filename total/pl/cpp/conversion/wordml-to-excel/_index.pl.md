---
title: Konwertuj WORDML na EXCEL w C++
description: C++ API do konwersji WORDML na EXCEL bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na EXCEL" h2="Eksportuj WORDML do EXCEL za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
