---
title: Konwertuj DOT na XLT w C++
description: C++ API do konwersji DOT na XLT bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na XLT" h2="Eksportuj DOT do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji DOT na XLT" %}}
