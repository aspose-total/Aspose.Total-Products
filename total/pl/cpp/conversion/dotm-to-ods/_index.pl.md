---
title: Konwertuj DOTM na ODS w C++
description: C++ API do konwersji DOTM na ODS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na ODS" h2="Eksportuj DOTM do ODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
