---
title: Konwertuj WORDML na XLAM w C++
description: C++ API do konwersji WORDML na XLAM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLAM" h2="Eksportuj WORDML do XLAM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji WORDML na XLAM" %}}
