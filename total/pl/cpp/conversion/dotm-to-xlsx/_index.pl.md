---
title: Konwertuj DOTM na XLSX w C++
description: C++ API do konwersji DOTM na XLSX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLSX" h2="Eksportuj DOTM do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
