---
title: Konwertuj DOC na XLAM w C++
description: C++ API do konwersji DOC na XLAM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOC na XLAM" h2="Eksportuj DOC do XLAM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
