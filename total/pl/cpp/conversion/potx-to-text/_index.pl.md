---
title: C++ API do konwersji POTX na TEXT
description: Eksportuj POTX do TEXT w swoich aplikacjach C++
url: /pl/cpp/conversion/potx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do TEXT" h2="Eksportuj POTX do TEXT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
