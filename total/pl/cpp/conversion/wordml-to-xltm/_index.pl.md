---
title: Konwertuj WORDML na XLTM w C++
description: C++ API do konwersji WORDML na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLTM" h2="Eksportuj WORDML do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
