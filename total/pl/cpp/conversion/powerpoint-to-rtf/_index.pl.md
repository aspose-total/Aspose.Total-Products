---
title: C++ API do konwersji POWERPOINT na RTF
description: Eksportuj POWERPOINT do RTF w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do RTF" h2="Eksportuj POWERPOINT do RTF w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
