---
title: Konwertuj POT na XLT za pomocą C++
description: Eksportuj POT do XLT w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/pot-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj POT na XLT za pomocą C++" h2="Konwersja plików POT do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
