---
title: Konwertuj DOT na PPTM za pomocą C++
description: Eksportuj DOT do PPTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dot-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPTM" h2="Eksportuj DOT do PPTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
