---
title: C++ API do konwersji PPTX na WORDML
description: Eksportuj PPTX do WORDML w swoich aplikacjach C++
url: /pl/cpp/conversion/pptx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do WORDML" h2="Eksportuj PPTX do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
