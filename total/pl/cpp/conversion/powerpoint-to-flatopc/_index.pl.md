---
title: C++ API do konwersji POWERPOINT na FLATOPC
description: Eksportuj POWERPOINT do FLATOPC w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do FLATOPC" h2="Eksportuj POWERPOINT do FLATOPC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
