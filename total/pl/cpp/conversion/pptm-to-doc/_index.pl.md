---
title: C++ API do konwersji PPTM na DOC
description: Eksportuj PPTM do DOC w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do DOC" h2="Eksportuj PPTM do DOC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
