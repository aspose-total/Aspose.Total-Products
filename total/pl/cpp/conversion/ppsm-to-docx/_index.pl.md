---
title: C++ API do konwersji PPSM na DOCX
description: Eksportuj PPSM do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do DOCX" h2="Eksportuj PPSM do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/ppsm-to-docxm/" name="PPSM Do DOCXM" description="" >}}
