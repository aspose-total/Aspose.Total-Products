---
title: C++ API do konwersji PPSX na DOCX
description: Eksportuj PPSX do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/ppsx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSX do DOCX" h2="Eksportuj PPSX do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
