---
title: C++ API do konwersji POTX na WORDML
description: Eksportuj POTX do WORDML w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do WORDML" h2="Eksportuj POTX do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
