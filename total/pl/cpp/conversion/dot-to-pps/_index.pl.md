---
title: Konwertuj DOT na PPS za pomocą C++
description: Eksportuj DOT do PPS w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPS" h2="Eksportuj DOT do PPS w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
