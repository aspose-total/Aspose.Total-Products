---
title: C++ API do konwersji PPS na WORD
description: Eksportuj PPS do WORD w swoich aplikacjach C++
url: /pl/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPS do WORD" h2="Eksportuj PPS do WORD w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pps-to-wordx/" name="PPS Do WORDX" description="" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pps-to-wordm/" name="PPS Do WORDM" description="" >}}
