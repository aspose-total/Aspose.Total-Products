---
title: C++ API do konwersji PPTX na DOCM
description: Eksportuj PPTX do DOCM w swoich aplikacjach C++
url: /pl/cpp/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do DOCM" h2="Eksportuj PPTX do DOCM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
