---
title: C++ API do konwersji POTX na DOTM
description: Eksportuj POTX do DOTM w swoich aplikacjach C++
url: /pl/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do DOTM" h2="Eksportuj POTX do DOTM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
