---
title: Konwertuj DOC na FODS w C++
description: C++ API do konwersji DOC na FODS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/doc-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOC na FODS" h2="Eksportuj DOC do FODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
