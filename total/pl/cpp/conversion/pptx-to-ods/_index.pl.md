---
title: Konwertuj PPTX na ODS za pomocą C++
description: Eksportuj PPTX do ODS w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/pptx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPTX na ODS za pomocą C++" h2="Konwersja plików PPTX do ODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
