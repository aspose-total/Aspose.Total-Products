---
title: C++ API do konwersji PPT na DOCX
description: Eksportuj PPT do DOCX w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do DOCX" h2="Eksportuj PPT do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/ppt-to-docxm/" name="PPT Do DOCXM" description="" >}}
