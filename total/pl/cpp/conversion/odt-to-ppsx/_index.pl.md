---
title: Konwertuj ODT na PPSX za pomocą C++
description: Eksportuj ODT do PPSX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/odt-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji ODT na PPSX" h2="Eksportuj ODT do PPSX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
