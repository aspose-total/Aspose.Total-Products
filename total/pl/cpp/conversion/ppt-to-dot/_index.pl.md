---
title: C++ API do konwersji PPT na DOT
description: Eksportuj PPT do DOT w swoich aplikacjach C++
url: /pl/cpp/conversion/ppt-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do DOT" h2="Eksportuj PPT do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
