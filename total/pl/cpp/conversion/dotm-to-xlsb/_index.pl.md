---
title: Konwertuj DOTM na XLSB w C++
description: C++ API do konwersji DOTM na XLSB bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLSB" h2="Eksportuj DOTM do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
