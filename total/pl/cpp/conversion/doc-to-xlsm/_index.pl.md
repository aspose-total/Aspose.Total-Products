---
title: Konwertuj DOC na XLSM w C++
description: C++ API do konwersji DOC na XLSM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/doc-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOC na XLSM" h2="Eksportuj DOC do XLSM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
