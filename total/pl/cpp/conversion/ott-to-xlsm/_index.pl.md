---
title: Konwertuj OTT na XLSM w C++
description: C++ API do konwersji OTT na XLSM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/ott-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji OTT na XLSM" h2="Eksportuj OTT do XLSM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
