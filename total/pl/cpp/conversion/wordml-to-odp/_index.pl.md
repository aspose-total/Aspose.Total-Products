---
title: Konwertuj WORDML na ODP za pomocą C++ lub za pomocą bezpłatnego konwertera online
description: Eksportuj WORDML do ODP w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint lub online. Szybko przetestuj darmowy konwerter online WORDML na ODP przed integracją kodu.
...
{{% blocks/products/pf/agp/feature-section-col title="Konwersja WORDML do ODP w C++" %}}
...
Zapisując WORDML jako ODP, możesz również użyć [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), aby dodać kolejne funkcje do swojego dokumentu ODP. Na przykład możesz dodać komentarze do swojej prezentacji. Komentarz do slajdu prezentacji jest powiązany z konkretnym autorem. Klasa Presentation zawiera kolekcję autorów w ICommentAuthorCollection, którzy są odpowiedzialni za dodawanie komentarzy do slajdów. Dla każdego autora istnieje zbiór komentarzy w ICommentCollection.
{{% blocks/products/pf/feature-page-code %}}
