---
title: Konwertuj WORDML na ODP za pomocą C++
description: Eksportuj WORDML do ODP w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/wordml-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na ODP" h2="Eksportuj WORDML do ODP w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
