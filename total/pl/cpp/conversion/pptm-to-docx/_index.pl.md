---
title: C++ API do konwersji PPTM na DOCX
description: Eksportuj PPTM do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do DOCX" h2="Eksportuj PPTM do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
3. Załaduj przekonwertowany plik HTML, korzystając z odwołania do klasy [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)
4. Zapisz dokument w formacie DOCX, używając funkcji członka [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string)
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pptm-to-docxm/" name="PPTM Do DOCXM" description="" >}}
