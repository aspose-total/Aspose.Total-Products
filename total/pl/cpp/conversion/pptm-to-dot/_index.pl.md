---
title: C++ API do konwersji PPTM na DOT
description: Eksportuj PPTM do DOT w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do DOT" h2="Eksportuj PPTM do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
