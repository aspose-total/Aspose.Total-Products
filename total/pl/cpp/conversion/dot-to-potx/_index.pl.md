---
title: Konwertuj DOT na POTX za pomocą C++
description: Eksportuj DOT do POTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dot-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na POTX" h2="Eksportuj DOT do POTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
