---
title: C++ API do konwersji PPTM na DOTM
description: Eksportuj PPTM do DOTM w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do DOTM" h2="Eksportuj PPTM do DOTM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
