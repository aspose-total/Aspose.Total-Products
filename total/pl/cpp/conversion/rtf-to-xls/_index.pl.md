---
title: Konwertuj RTF na XLS w C++
description: C++ API do konwersji RTF na XLS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLS" h2="Eksportuj RTF do XLS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
