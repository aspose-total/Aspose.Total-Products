---
title: Konwertuj DOCX na SXC w C++
description: C++ API do konwersji DOCX na SXC bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na SXC" h2="Eksportuj DOCX do SXC za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
