---
title: Konwertuj OTT na PPT za pomocą C++
description: Eksportuj OTT do PPT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/ott-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji OTT na PPT" h2="Eksportuj OTT do PPT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
