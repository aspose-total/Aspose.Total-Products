---
title: Konwertuj DOTM na XLSM w C++
description: C++ API do konwersji DOTM na XLSM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLSM" h2="Eksportuj DOTM do XLSM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
