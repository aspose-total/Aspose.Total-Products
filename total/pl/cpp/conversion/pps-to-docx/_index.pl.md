---
title: C++ API do konwersji PPS na DOCX
description: Eksportuj PPS do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/pps-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPS do DOCX" h2="Eksportuj PPS do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pps-to-docxm/" name="PPS Do DOCXM" description="" >}}
