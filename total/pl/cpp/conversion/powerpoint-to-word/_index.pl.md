---
title: C++ API do konwersji POWERPOINT na WORD
description: Eksportuj POWERPOINT do WORD w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do WORD" h2="Eksportuj POWERPOINT do WORD w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
