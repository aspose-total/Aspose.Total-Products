---
title: Konwertuj DOCX na XLT w C++
description: C++ API do konwersji DOCX na XLT bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLT" h2="Eksportuj DOCX do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
