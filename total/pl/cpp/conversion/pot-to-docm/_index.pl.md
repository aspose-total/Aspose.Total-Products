---
title: C++ API do konwersji POT na DOCM
description: Eksportuj POT do DOCM w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do DOCM" h2="Eksportuj POT do DOCM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
3. Załaduj przekonwertowany plik HTML, korzystając z odwołania do klasy [Docmument](https://reference.aspose.com/words/cpp/class/aspose.words.docmument)
