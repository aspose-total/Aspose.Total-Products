---
title: Konwertuj DOT na POWERPOINT za pomocą C++
description: Eksportuj DOT do POWERPOINT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na POWERPOINT" h2="Eksportuj DOT do POWERPOINT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
