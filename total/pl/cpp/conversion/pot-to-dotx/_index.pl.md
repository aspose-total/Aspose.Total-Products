---
title: C++ API do konwersji POT na DOTX
description: Eksportuj POT do DOTX w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do DOTX" h2="Eksportuj POT do DOTX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
