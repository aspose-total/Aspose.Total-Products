---
title: Konwertuj WORDML na PPTM za pomocą C++
description: Eksportuj WORDML do PPTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/wordml-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na PPTM" h2="Eksportuj WORDML do PPTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
