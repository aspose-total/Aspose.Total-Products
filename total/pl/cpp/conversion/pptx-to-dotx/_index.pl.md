---
title: C++ API do konwersji PPTX na DOTX
description: Eksportuj PPTX do DOTX w swoich aplikacjach C++
url: /pl/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do DOTX" h2="Eksportuj PPTX do DOTX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
