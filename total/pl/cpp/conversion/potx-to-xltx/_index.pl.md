---
title: Konwertuj POTX na XLTX za pomocą C++
description: Eksportuj POTX do XLTX w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/potx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj POTX na XLTX za pomocą C++" h2="Konwersja plików POTX do XLTX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
