---
title: Konwertuj PPTX na XLS za pomocą C++
description: Eksportuj PPTX do XLS w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/pptx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPTX na XLS za pomocą C++" h2="Konwersja plików PPTX do XLS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
