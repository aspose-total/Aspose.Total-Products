---
title: Konwertuj FLATOPC na ODP za pomocą C++
description: Eksportuj FLATOPC do ODP w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/flatopc-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji FLATOPC na ODP" h2="Eksportuj FLATOPC do ODP w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
