---
title: Konwertuj WORDML na POTM za pomocą C++
description: Eksportuj WORDML do POTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na POTM" h2="Eksportuj WORDML do POTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
