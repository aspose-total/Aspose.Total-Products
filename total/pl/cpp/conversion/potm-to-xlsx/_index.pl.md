---
title: Konwertuj POTM na XLSX za pomocą C++
description: Eksportuj POTM do XLSX w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/potm-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj POTM na XLSX za pomocą C++" h2="Konwersja plików POTM do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
