---
title: C++ API do konwersji POWERPOINT na DOTX
description: Eksportuj POWERPOINT do DOTX w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do DOTX" h2="Eksportuj POWERPOINT do DOTX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
