---
title: C++ API do konwersji PPTM na WORD
description: Eksportuj PPTM do WORD w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do WORD" h2="Eksportuj PPTM do WORD w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
