---
title: Konwertuj POTM na XLT za pomocą C++
description: Eksportuj POTM do XLT w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/potm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj POTM na XLT za pomocą C++" h2="Konwersja plików POTM do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
