---
title: C++ API do konwersji POWERPOINT na ODT
description: Eksportuj POWERPOINT do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do ODT" h2="Eksportuj POWERPOINT do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
