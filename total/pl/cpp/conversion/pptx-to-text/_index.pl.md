---
title: C++ API do konwersji PPTX na TEXT
description: Eksportuj PPTX do TEXT w swoich aplikacjach C++
url: /pl/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do TEXT" h2="Eksportuj PPTX do TEXT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
