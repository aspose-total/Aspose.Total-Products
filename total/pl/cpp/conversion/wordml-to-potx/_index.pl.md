---
title: Konwertuj WORDML na POTX za pomocą C++
description: Eksportuj WORDML do POTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/wordml-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na POTX" h2="Eksportuj WORDML do POTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
