---
title: Konwertuj FLATOPC na PPSX za pomocą C++
description: Eksportuj FLATOPC do PPSX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji FLATOPC na PPSX" h2="Eksportuj FLATOPC do PPSX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
