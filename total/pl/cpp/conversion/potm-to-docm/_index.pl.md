---
title: C++ API do konwersji POTM na DOCM
description: Eksportuj POTM do DOCM w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do DOCM" h2="Eksportuj POTM do DOCM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
