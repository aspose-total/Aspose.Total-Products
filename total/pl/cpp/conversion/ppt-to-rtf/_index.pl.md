---
title: C++ API do konwersji PPT na RTF
description: Eksportuj PPT do RTF w swoich aplikacjach C++
url: /pl/cpp/conversion/ppt-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do RTF" h2="Eksportuj PPT do RTF w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
