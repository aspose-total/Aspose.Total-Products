---
title: Konwertuj DOTM na POTX za pomocą C++
description: Eksportuj DOTM do POTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dotm-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na POTX" h2="Eksportuj DOTM do POTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
