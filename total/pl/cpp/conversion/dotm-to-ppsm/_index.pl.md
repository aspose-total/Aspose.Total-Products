---
title: Konwertuj DOTM na PPSM za pomocą C++
description: Eksportuj DOTM do PPSM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dotm-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na PPSM" h2="Eksportuj DOTM do PPSM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
