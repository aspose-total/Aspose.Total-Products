---
title: Konwertuj WORD na XLTM w C++
description: C++ API do konwersji WORD na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na XLTM" h2="Eksportuj WORD do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
