---
title: Konwertuj DOCM na PPT za pomocą C++
description: Eksportuj DOCM do PPT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docm-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCM na PPT" h2="Eksportuj DOCM do PPT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
