---
title: Konwertuj DOTM na POWERPOINT za pomocą C++
description: Eksportuj DOTM do POWERPOINT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na POWERPOINT" h2="Eksportuj DOTM do POWERPOINT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
