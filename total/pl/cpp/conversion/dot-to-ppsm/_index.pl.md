---
title: Konwertuj DOT na PPSM za pomocą C++
description: Eksportuj DOT do PPSM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dot-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPSM" h2="Eksportuj DOT do PPSM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
