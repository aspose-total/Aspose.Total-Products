---
title: C++ API do konwersji PPTM na ODT
description: Eksportuj PPTM do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do ODT" h2="Eksportuj PPTM do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
