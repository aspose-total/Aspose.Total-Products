---
title: C++ API do konwersji PPSM na WORDML
description: Eksportuj PPSM do WORDML w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do WORDML" h2="Eksportuj PPSM do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
