---
title: Konwertuj OTT na PPSM za pomocą C++
description: Eksportuj OTT do PPSM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/ott-to-ppsm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji OTT na PPSM" h2="Eksportuj OTT do PPSM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
