---
title: Konwertuj WORD na CSV w C++
description: C++ API do konwersji WORD na CSV bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na CSV" h2="Eksportuj WORD do CSV za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
