---
title: Konwertuj WORDML na XLS w C++
description: C++ API do konwersji WORDML na XLS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLS" h2="Eksportuj WORDML do XLS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
