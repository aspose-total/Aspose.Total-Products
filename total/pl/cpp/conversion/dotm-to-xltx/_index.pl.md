---
title: Konwertuj DOTM na XLTX w C++
description: C++ API do konwersji DOTM na XLTX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLTX" h2="Eksportuj DOTM do XLTX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
