---
title: Konwertuj DOT na PPSX za pomocą C++
description: Eksportuj DOT do PPSX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dot-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPSX" h2="Eksportuj DOT do PPSX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
