---
title: Konwertuj DOCX na XLAM w C++
description: C++ API do konwersji DOCX na XLAM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLAM" h2="Eksportuj DOCX do XLAM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
