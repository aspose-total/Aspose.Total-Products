---
title: Konwertuj POTX na ODS za pomocą C++
description: Eksportuj POTX do ODS w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/potx-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj POTX na ODS za pomocą C++" h2="Konwersja plików POTX do ODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
