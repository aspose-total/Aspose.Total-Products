---
title: C++ API do konwersji PPTX na ODT
description: Eksportuj PPTX do ODT w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do ODT" h2="Eksportuj PPTX do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
