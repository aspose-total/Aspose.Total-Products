---
title: C++ API do konwersji POTM na DOT
description: Eksportuj POTM do DOT w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do DOT" h2="Eksportuj POTM do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
