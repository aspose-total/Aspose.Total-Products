---
title: Konwertuj WORDML na ODS w C++
description: C++ API do konwersji WORDML na ODS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na ODS" h2="Eksportuj WORDML do ODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
