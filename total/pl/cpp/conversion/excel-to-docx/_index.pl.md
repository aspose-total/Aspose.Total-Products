---
title: Konwertuj EXCEL na DOCX za pomocą C++
description: Konwertuj EXCEL na DOCX w aplikacjach C++
url: /pl/cpp/conversion/excel-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: CSV
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj EXCEL na DOCX za pomocą C++" h2="Eksportuj Excel<sup>&reg;</sup> EXCEL do DOCX w ramach w pełni funkcjonalnych aplikacji C++" >}}
