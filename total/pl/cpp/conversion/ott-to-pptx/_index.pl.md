---
title: Konwertuj OTT na PPTX za pomocą C++
description: Eksportuj OTT do PPTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/ott-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji OTT na PPTX" h2="Eksportuj OTT do PPTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
