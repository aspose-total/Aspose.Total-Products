---
title: Konwertuj DOCM na POWERPOINT za pomocą C++
description: Eksportuj DOCM do POWERPOINT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docm-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCM na POWERPOINT" h2="Eksportuj DOCM do POWERPOINT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
