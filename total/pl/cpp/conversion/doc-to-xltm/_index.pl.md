---
title: Konwertuj DOC na XLTM w C++
description: C++ API do konwersji DOC na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/doc-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOC na XLTM" h2="Eksportuj DOC do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji DOC na XLTM" %}}
