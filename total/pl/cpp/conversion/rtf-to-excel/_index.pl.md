---
title: Konwertuj RTF na EXCEL w C++
description: C++ API do konwersji RTF na EXCEL bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na EXCEL" h2="Eksportuj RTF do EXCEL za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
