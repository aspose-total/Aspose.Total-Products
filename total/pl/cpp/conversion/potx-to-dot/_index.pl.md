---
title: C++ API do konwersji POTX na DOT
description: Eksportuj POTX do DOT w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do DOT" h2="Eksportuj POTX do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
