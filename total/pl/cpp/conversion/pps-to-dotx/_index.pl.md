---
title: C++ API do konwersji PPS na DOTX
description: Eksportuj PPS do DOTX w swoich aplikacjach C++
url: /pl/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPS do DOTX" h2="Eksportuj PPS do DOTX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
