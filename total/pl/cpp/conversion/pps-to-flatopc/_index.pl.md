---
title: C++ API do konwersji PPS na FLATOPC
description: Eksportuj PPS do FLATOPC w swoich aplikacjach C++
url: /pl/cpp/conversion/pps-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPS do FLATOPC" h2="Eksportuj PPS do FLATOPC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
