---
title: Konwertuj WORDML na DIF w C++
description: C++ API do konwersji WORDML na DIF bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na DIF" h2="Eksportuj WORDML do DIF za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
