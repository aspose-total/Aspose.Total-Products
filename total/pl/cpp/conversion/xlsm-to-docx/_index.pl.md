---
title: Konwertuj XLSM na DOCX za pomocą C++
description: Konwertuj XLSM na DOCX w aplikacjach C++
url: /pl/cpp/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj XLSM na DOCX za pomocą C++" h2="Eksportuj Excel<sup>&reg;</sup> XLSM do DOCX w ramach w pełni funkcjonalnych aplikacji C++" >}}
