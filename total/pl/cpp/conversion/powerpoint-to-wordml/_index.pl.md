---
title: C++ API do konwersji POWERPOINT na WORDML
description: Eksportuj POWERPOINT do WORDML w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do WORDML" h2="Eksportuj POWERPOINT do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
