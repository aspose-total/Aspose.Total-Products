---
title: Konwertuj XLSX na DOC za pomocą C++
description: Konwertuj XLSX na DOC w aplikacjach C++
url: /pl/cpp/conversion/xlsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj XLSX na DOC za pomocą C++" h2="Eksportuj Excel&reg; XLSX do DOC w ramach w pełni funkcjonalnych aplikacji C++" >}}
