---
title: Konwertuj DOT na PPT za pomocą C++
description: Eksportuj DOT do PPT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dot-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPT" h2="Eksportuj DOT do PPT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
