---
title: C++ API do konwersji PPSM na DOC
description: Eksportuj PPSM do DOC w swoich aplikacjach C++
url: /pl/cpp/conversion/ppsm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do DOC" h2="Eksportuj PPSM do DOC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
