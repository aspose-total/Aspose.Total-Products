---
title: Konwertuj WORDML na XLSB w C++
description: C++ API do konwersji WORDML na XLSB bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLSB" h2="Eksportuj WORDML do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
