---
title: Konwertuj DOTM na SXC w C++
description: C++ API do konwersji DOTM na SXC bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na SXC" h2="Eksportuj DOTM do SXC za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
