---
title: C++ API do konwersji POT na DOC
description: Eksportuj POT do DOC w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do DOC" h2="Eksportuj POT do DOC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
