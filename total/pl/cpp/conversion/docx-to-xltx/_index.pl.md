---
title: Konwertuj DOCX na XLTX w C++
description: C++ API do konwersji DOCX na XLTX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLTX" h2="Eksportuj DOCX do XLTX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji DOCX na XLTX" %}}
1. Otwórz plik DOCX, korzystając z odwołania do klasy [Docxument](https://reference.aspose.com/words/cpp/class/aspose.words.docxument)
2. Konwertuj DOCX na HTML za pomocą funkcji członkowskiej [Save](https://reference.aspose.com/words/cpp/class/aspose.words.docxument#save_string_saveformat)
