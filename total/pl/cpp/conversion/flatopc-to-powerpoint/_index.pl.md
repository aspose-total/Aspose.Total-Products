---
title: Konwertuj FLATOPC na POWERPOINT za pomocą C++
description: Eksportuj FLATOPC do POWERPOINT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/flatopc-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji FLATOPC na POWERPOINT" h2="Eksportuj FLATOPC do POWERPOINT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
