---
title: Konwertuj DOCX na XLSB w C++
description: C++ API do konwersji DOCX na XLSB bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLSB" h2="Eksportuj DOCX do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
