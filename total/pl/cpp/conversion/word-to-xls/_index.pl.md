---
title: Konwertuj WORD na XLS w C++
description: C++ API do konwersji WORD na XLS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na XLS" h2="Eksportuj WORD do XLS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
