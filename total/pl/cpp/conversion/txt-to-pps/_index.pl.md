---
title: Konwertuj TXT na PPS za pomocą C++
description: Eksportuj TXT do PPS w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/txt-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji TXT na PPS" h2="Eksportuj TXT do PPS w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
