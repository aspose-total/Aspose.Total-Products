---
title: C++ API do konwersji POT na DOCX
description: Eksportuj POT do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do DOCX" h2="Eksportuj POT do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
