---
title: C++ API do konwersji POTM na ODT
description: Eksportuj POTM do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do ODT" h2="Eksportuj POTM do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
