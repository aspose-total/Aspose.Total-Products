---
title: C++ API do konwersji POTX na DOCX
description: Eksportuj POTX do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/potx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do DOCX" h2="Eksportuj POTX do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
