---
title: Konwertuj WORDML na PPSM za pomocą C++
description: Eksportuj WORDML do PPSM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na PPSM" h2="Eksportuj WORDML do PPSM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
