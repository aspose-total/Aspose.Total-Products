---
title: Konwertuj OTT na POT za pomocą C++
description: Eksportuj OTT do POT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/ott-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji OTT na POT" h2="Eksportuj OTT do POT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
