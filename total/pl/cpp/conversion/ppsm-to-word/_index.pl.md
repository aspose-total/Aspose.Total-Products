---
title: C++ API do konwersji PPSM na WORD
description: Eksportuj PPSM do WORD w swoich aplikacjach C++
url: /pl/cpp/conversion/ppsm-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do WORD" h2="Eksportuj PPSM do WORD w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
