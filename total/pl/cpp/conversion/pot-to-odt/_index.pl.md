---
title: C++ API do konwersji POT na ODT
description: Eksportuj POT do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do ODT" h2="Eksportuj POT do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
