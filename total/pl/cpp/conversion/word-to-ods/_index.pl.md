---
title: Konwertuj WORD na ODS w C++
description: C++ API do konwersji WORD na ODS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na ODS" h2="Eksportuj WORD do ODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji WORD na ODS" %}}
