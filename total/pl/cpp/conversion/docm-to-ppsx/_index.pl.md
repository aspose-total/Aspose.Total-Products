---
title: Konwertuj DOCM na PPSX za pomocą C++
description: Eksportuj DOCM do PPSX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCM na PPSX" h2="Eksportuj DOCM do PPSX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
