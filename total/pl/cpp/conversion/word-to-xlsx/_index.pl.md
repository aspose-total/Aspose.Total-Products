---
title: Konwertuj WORD na XLSX w C++
description: C++ API do konwersji WORD na XLSX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na XLSX" h2="Eksportuj WORD do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
