---
title: C++ API do konwersji PPSX na DOT
description: Eksportuj PPSX do DOT w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSX do DOT" h2="Eksportuj PPSX do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
