---
title: C++ API do konwersji PPSM na RTF
description: Eksportuj PPSM do RTF w swoich aplikacjach C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do RTF" h2="Eksportuj PPSM do RTF w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
