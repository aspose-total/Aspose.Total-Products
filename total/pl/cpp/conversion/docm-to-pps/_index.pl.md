---
title: Konwertuj DOCM na PPS za pomocą C++
description: Eksportuj DOCM do PPS w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCM na PPS" h2="Eksportuj DOCM do PPS w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
