---
title: Konwertuj RTF na SXC w C++
description: C++ API do konwersji RTF na SXC bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na SXC" h2="Eksportuj RTF do SXC za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
