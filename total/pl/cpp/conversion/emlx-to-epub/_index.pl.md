---
title: Eksportuj EMLX do EPUB przez C++
description: C++ API do konwersji EMLX na EPUB bez użycia Microsoft Word lub Outlook
url: /pl/cpp/conversion/emlx-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do eksportu EMLX do EPUB" h2="Przekształć EMLX w EPUB w aplikacji C++ bez konieczności korzystania z Microsoft Word lub Outlook" >}}

{{% blocks/products/pf/feature-page-summary %}}
Czy jesteś programistą C++ i chcesz dodać funkcje konwersji wiadomości e-mail do swoich aplikacji? Używając [Aspose.Emlx for C++](https://products.aspose.com/emlx/cpp/) możesz przekonwertować format pliku EMLX na HTML. Następnie za pomocą API [Aspose.Words for C++](https://products.aspose.com/words/cpp/) możesz wyeksportować HTML do EPUB. Oba interfejsy API są objęte pakietem [Aspose.Total for C++](https://products.aspose.com/total/cpp/). 
{{% /blocks/products/pf/feature-page-summary  %}}
