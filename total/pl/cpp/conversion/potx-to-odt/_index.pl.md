---
title: C++ API do konwersji POTX na ODT
description: Eksportuj POTX do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/potx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do ODT" h2="Eksportuj POTX do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
