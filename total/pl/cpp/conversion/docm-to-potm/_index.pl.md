---
title: Konwertuj DOCM na POTM za pomocą C++
description: Eksportuj DOCM do POTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docm-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCM na POTM" h2="Eksportuj DOCM do POTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
