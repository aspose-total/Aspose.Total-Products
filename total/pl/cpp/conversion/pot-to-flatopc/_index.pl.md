---
title: C++ API do konwersji POT na FLATOPC
description: Eksportuj POT do FLATOPC w swoich aplikacjach C++
url: /pl/cpp/conversion/pot-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POT do FLATOPC" h2="Eksportuj POT do FLATOPC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
