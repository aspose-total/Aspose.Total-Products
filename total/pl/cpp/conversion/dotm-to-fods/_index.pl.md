---
title: Konwertuj DOTM na FODS w C++
description: C++ API do konwersji DOTM na FODS bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na FODS" h2="Eksportuj DOTM do FODS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
