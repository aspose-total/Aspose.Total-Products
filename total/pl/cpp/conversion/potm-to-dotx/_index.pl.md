---
title: C++ API do konwersji POTM na DOTX
description: Eksportuj POTM do DOTX w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do DOTX" h2="Eksportuj POTM do DOTX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
