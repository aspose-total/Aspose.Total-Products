---
title: C++ API do konwersji POWERPOINT na DOT
description: Eksportuj POWERPOINT do DOT w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do DOT" h2="Eksportuj POWERPOINT do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
