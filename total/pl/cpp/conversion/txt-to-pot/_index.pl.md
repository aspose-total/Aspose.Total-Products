---
title: Konwertuj TXT na POT za pomocą C++
description: Eksportuj TXT do POT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/txt-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: TXT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji TXT na POT" h2="Eksportuj TXT do POT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
