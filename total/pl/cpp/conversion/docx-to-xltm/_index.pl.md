---
title: Konwertuj DOCX na XLTM w C++
description: C++ API do konwersji DOCX na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLTM" h2="Eksportuj DOCX do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
