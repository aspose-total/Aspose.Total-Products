---
title: Konwertuj FLATOPC na POT za pomocą C++
description: Eksportuj FLATOPC do POT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/flatopc-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji FLATOPC na POT" h2="Eksportuj FLATOPC do POT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
