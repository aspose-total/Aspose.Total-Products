---
title: Konwertuj PPSX na XLS za pomocą C++
description: Eksportuj PPSX do XLS w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/ppsx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPSX na XLS za pomocą C++" h2="Konwersja plików PPSX do XLS za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
