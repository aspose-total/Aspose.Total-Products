---
title: Konwertuj DOCX na POWERPOINT za pomocą C++
description: Eksportuj DOCX do POWERPOINT w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/docx-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na POWERPOINT" h2="Eksportuj DOCX do POWERPOINT w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
