---
title: Konwertuj DOTM na EXCEL w C++
description: C++ API do konwersji DOTM na EXCEL bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na EXCEL" h2="Eksportuj DOTM do EXCEL za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
