---
title: Konwertuj RTF na XLSM w C++
description: C++ API do konwersji RTF na XLSM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLSM" h2="Eksportuj RTF do XLSM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
