---
title: C++ API do konwersji POTX na RTF
description: Eksportuj POTX do RTF w swoich aplikacjach C++
url: /pl/cpp/conversion/potx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTX do RTF" h2="Eksportuj POTX do RTF w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
