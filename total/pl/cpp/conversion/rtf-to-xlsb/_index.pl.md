---
title: Konwertuj RTF na XLSB w C++
description: C++ API do konwersji RTF na XLSB bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLSB" h2="Eksportuj RTF do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji RTF na XLSB" %}}
