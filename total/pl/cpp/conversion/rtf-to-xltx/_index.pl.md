---
title: Konwertuj RTF na XLTX w C++
description: C++ API do konwersji RTF na XLTX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLTX" h2="Eksportuj RTF do XLTX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
