---
title: C++ API do konwersji POWERPOINT na DOCX
description: Eksportuj POWERPOINT do DOCX w swoich aplikacjach C++
url: /pl/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POWERPOINT do DOCX" h2="Eksportuj POWERPOINT do DOCX w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
