---
title: Konwertuj DOTM na XLT w C++
description: C++ API do konwersji DOTM na XLT bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLT" h2="Eksportuj DOTM do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji DOTM na XLT" %}}
