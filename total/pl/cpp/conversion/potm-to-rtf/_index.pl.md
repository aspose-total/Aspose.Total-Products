---
title: C++ API do konwersji POTM na RTF
description: Eksportuj POTM do RTF w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do RTF" h2="Eksportuj POTM do RTF w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
