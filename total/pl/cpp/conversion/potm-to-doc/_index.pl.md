---
title: C++ API do konwersji POTM na DOC
description: Eksportuj POTM do DOC w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do DOC" h2="Eksportuj POTM do DOC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
