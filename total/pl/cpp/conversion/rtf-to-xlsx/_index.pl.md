---
title: Konwertuj RTF na XLSX w C++
description: C++ API do konwersji RTF na XLSX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLSX" h2="Eksportuj RTF do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
