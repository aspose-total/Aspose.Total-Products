---
title: Konwertuj DOT na PPTX za pomocą C++
description: Eksportuj DOT do PPTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOT na PPTX" h2="Eksportuj DOT do PPTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
