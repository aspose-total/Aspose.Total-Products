---
title: C++ API do konwersji PPSM na DOT
description: Eksportuj PPSM do DOT w swoich aplikacjach C++
url: /pl/cpp/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPSM do DOT" h2="Eksportuj PPSM do DOT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
