---
title: Konwertuj WORDML na XLSX w C++
description: C++ API do konwersji WORDML na XLSX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLSX" h2="Eksportuj WORDML do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
