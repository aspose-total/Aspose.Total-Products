---
title: Konwertuj XLT na PPTX za pomocą C++
description: Konwertuj XLT na PPTX w aplikacjach C++
url: /pl/cpp/conversion/xlt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj XLT na PPTX za pomocą C++" h2="Eksportuj Excel<sup>&reg;</sup> XLT do PPTX w ramach w pełni funkcjonalnych aplikacji C++" >}}
