---
title: C++ API do konwersji PPTM na DOCM
description: Eksportuj PPTM do DOCM w swoich aplikacjach C++
url: /pl/cpp/conversion/pptm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTM do DOCM" h2="Eksportuj PPTM do DOCM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
