---
title: C++ API do konwersji PPT na DOTM
description: Eksportuj PPT do DOTM w swoich aplikacjach C++
url: /pl/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do DOTM" h2="Eksportuj PPT do DOTM w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
