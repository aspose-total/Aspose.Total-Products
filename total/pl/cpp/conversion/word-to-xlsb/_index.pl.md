---
title: Konwertuj WORD na XLSB w C++
description: C++ API do konwersji WORD na XLSB bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na XLSB" h2="Eksportuj WORD do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji WORD na XLSB" %}}
