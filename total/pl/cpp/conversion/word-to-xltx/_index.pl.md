---
title: Konwertuj WORD na XLTX w C++
description: C++ API do konwersji WORD na XLTX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/word-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORD na XLTX" h2="Eksportuj WORD do XLTX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
