---
title: C++ API do konwersji PPTX na DOC
description: Eksportuj PPTX do DOC w swoich aplikacjach C++
url: /pl/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPTX do DOC" h2="Eksportuj PPTX do DOC w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
