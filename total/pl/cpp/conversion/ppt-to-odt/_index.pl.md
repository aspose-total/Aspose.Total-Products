---
title: C++ API do konwersji PPT na ODT
description: Eksportuj PPT do ODT w swoich aplikacjach C++
url: /pl/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do ODT" h2="Eksportuj PPT do ODT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
