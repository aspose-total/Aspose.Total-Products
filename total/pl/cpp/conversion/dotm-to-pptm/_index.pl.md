---
title: Konwertuj DOTM na PPTM za pomocą C++
description: Eksportuj DOTM do PPTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dotm-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na PPTM" h2="Eksportuj DOTM do PPTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
