---
title: Konwertuj DOTM na XLTM w C++
description: C++ API do konwersji DOTM na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLTM" h2="Eksportuj DOTM do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
