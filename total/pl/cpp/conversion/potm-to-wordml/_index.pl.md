---
title: C++ API do konwersji POTM na WORDML
description: Eksportuj POTM do WORDML w swoich aplikacjach C++
url: /pl/cpp/conversion/potm-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania POTM do WORDML" h2="Eksportuj POTM do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
