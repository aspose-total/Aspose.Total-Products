---
title: Konwertuj PPTX na XLSB za pomocą C++
description: Eksportuj PPTX do XLSB w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/pptx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPTX na XLSB za pomocą C++" h2="Konwersja plików PPTX do XLSB za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
