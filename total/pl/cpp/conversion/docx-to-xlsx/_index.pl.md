---
title: Konwertuj DOCX na XLSX w C++
description: C++ API do konwersji DOCX na XLSX bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/docx-to-xlsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOCX na XLSX" h2="Eksportuj DOCX do XLSX za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
