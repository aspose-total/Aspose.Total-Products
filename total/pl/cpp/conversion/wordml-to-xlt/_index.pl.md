---
title: Konwertuj WORDML na XLT w C++
description: C++ API do konwersji WORDML na XLT bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na XLT" h2="Eksportuj WORDML do XLT za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
