---
title: Konwertuj DOTM na XLAM w C++
description: C++ API do konwersji DOTM na XLAM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/dotm-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na XLAM" h2="Eksportuj DOTM do XLAM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
