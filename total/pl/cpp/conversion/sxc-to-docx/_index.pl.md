---
title: Konwertuj SXC na DOCX za pomocą C++
description: Konwertuj SXC na DOCX w aplikacjach C++
url: /pl/cpp/conversion/sxc-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: SXC
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj SXC na DOCX za pomocą C++" h2="Eksportuj Excel<sup>&reg;</sup> SXC do DOCX w ramach w pełni funkcjonalnych aplikacji C++" >}}
