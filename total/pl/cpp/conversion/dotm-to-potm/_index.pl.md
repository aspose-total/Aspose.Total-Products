---
title: Konwertuj DOTM na POTM za pomocą C++
description: Eksportuj DOTM do POTM w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na POTM" h2="Eksportuj DOTM do POTM w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
