---
title: Konwertuj DOTM na ODP za pomocą C++
description: Eksportuj DOTM do ODP w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/dotm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOTM na ODP" h2="Eksportuj DOTM do ODP w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
