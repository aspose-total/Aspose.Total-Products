---
title: Konwertuj WORDML na CSV w C++
description: C++ API do konwersji WORDML na CSV bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/wordml-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji WORDML na CSV" h2="Eksportuj WORDML do CSV za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
