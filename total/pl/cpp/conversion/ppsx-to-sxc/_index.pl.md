---
title: Konwertuj PPSX na SXC za pomocą C++
description: Eksportuj PPSX do SXC w C++ bez użycia Microsoft Excel lub Powerpoint
url: /pl/cpp/conversion/ppsx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="Konwertuj PPSX na SXC za pomocą C++" h2="Konwersja plików PPSX do SXC za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
