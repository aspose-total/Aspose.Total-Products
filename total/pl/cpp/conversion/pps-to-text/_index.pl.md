---
title: C++ API do konwersji PPS na TEXT
description: Eksportuj PPS do TEXT w swoich aplikacjach C++
url: /pl/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPS do TEXT" h2="Eksportuj PPS do TEXT w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pps-to-textm/" name="PPS Do TEXTM" description="" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/cpp/conversion/pps-to-textx/" name="PPS Do TEXTX" description="" >}}
