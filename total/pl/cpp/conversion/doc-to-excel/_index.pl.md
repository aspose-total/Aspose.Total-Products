---
title: Konwertuj DOC na EXCEL w C++
description: C++ API do konwersji DOC na EXCEL bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/doc-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji DOC na EXCEL" h2="Eksportuj DOC do EXCEL za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
