---
title: Konwertuj RTF na XLTM w C++
description: C++ API do konwersji RTF na XLTM bez używania Microsoft Word lub Microsoft Excel
url: /pl/cpp/conversion/rtf-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji RTF na XLTM" h2="Eksportuj RTF do XLTM za pomocą C++ bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
