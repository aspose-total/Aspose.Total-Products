---
title: C++ API do konwersji PPT na WORDML
description: Eksportuj PPT do WORDML w swoich aplikacjach C++
url: /pl/cpp/conversion/ppt-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do renderowania PPT do WORDML" h2="Eksportuj PPT do WORDML w aplikacjach C++ bez żadnych zależności Microsoft PowerPoint lub Word" >}}
