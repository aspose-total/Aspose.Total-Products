---
title: Konwertuj ODT na PPTX za pomocą C++
description: Eksportuj ODT do PPTX w aplikacjach C++ bez użycia Microsoft Word lub PowerPoint
url: /pl/cpp/conversion/odt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API do konwersji ODT na PPTX" h2="Eksportuj ODT do PPTX w swoich aplikacjach C++ bez użycia Microsoft Word&reg; lub PowerPoint" >}}
