---
title: Wyodrębnij tekst i obrazy z pliku PPT online i używając C++
description: Aplikacja do analizowania plików online PPT.Kod API C++ do wyodrębniania obrazów i tekstu z prezentacji PPT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik PPT online, a także poprzez C++" h2="Opracuj potężną aplikację do analizowania prezentacji PPT opartą na języku C++. Kod C++ wymieniony do analizowania PPT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj prezentację PPT za pomocą C++" %}}

1. Dodaj odwołanie do biblioteki do projektu C++
1. Załaduj plik PPT
1. Zdefiniuj obiekt ITextFrame
1. Iteruj po klatce i części
1. Pobierz tekst i wydrukuj lub zapisz
...
{{% blocks/products/pf/agp/code-block title="Kod C++: Ekstrakcja tekstu prezentacji PPT" offSpacer="" %}}
