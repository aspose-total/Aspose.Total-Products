---
title: Wyodrębnij tekst i obrazy z pliku ODP online i używając C++
description: Aplikacja do analizowania plików online ODP.Kod API C++ do wyodrębniania obrazów i tekstu z prezentacji ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik ODP online, a także poprzez C++" h2="Opracuj potężną aplikację do analizowania prezentacji ODP opartą na języku C++. Kod C++ wymieniony do analizowania ODP." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj prezentację ODP za pośrednictwem aplikacji online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj prezentację ODP za pomocą C++" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod C++: Ekstrakcja tekstu prezentacji ODP" offSpacer="" %}}
