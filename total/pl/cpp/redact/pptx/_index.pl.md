---
title: Zredaguj prezentację PPTX online lub używając C++
description: Otwieraj i redaguj dokument PPTX online za pomocą bezpłatnej aplikacji.Kod API C++ do wyszukiwania i zamiany tekstu PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaguj dokument PPTX online lub poprzez C++" h2="Opracuj potężną aplikację narzędziową do redagowania prezentacji PPTX opartą na języku C++.Kod C++ wymieniony do wyszukiwania i zamiany tekstu w pliku PPTX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Zredaguj prezentację PPTX online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Zredaguj plik PPTX za pomocą C++" %}}

1. Dodaj odwołanie do biblioteki do projektu C++
1. Załaduj prezentację PPTX
1. Użyj SlideUtil::FindAndReplaceText
1. Podaj odpowiednie parametry, w tym wyszukiwanie i zamianę tekstu
1. Zapisz plik PPTX
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Kod C++: Zredaguj prezentację PPTX" offSpacer="" %}}
...
<h2>Opracuj aplikację redakcyjną PPTX w języku C++</h2>

Chcesz opracować aplikację lub narzędzie do redagowania PPTX?Dzięki [Aspose.Slides for C++](https://products.aspose.com/slides/cpp/), podrzędnemu API [Aspose.Total for C++](https://products.aspose.com/total/pl/cpp/), każdy programista C++ może zintegrować powyższy kod API ze swoją aplikacją do redagowania dokumentów.Potężna biblioteka C++ umożliwia zaprogramowanie dowolnego rozwiązania do redakcji dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie C++ do redagowania pliku PPTX" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy korzystanie z aplikacji online do zarządzania redakcją dokumentów PPTX jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
