---
title: Utwórz prezentacje POTM w Node.js
description: Generuj prezentację Microsoft Powerpoint POTM przy użyciu aplikacji Node bez korzystania z pakietu Microsoft Office. 
...
- Zapisz zmodyfikowaną prezentację jako plik POTM.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Wymagania dotyczące tworzenia" %}}

- Aby utworzyć dokument POTM, w systemie musi być zainstalowany Node.js.
- Wymagany jest Oracle JDK (wersja 7 lub nowsza).
- Pakiet node-java musi być skonfigurowany.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js — tworzenie plików POTM" offSpacer="" %}}
