---
title: Utwórz prezentacje PPS w Node.js
description: Generuj prezentację Microsoft Powerpoint PPS przy użyciu aplikacji Node bez korzystania z pakietu Microsoft Office. 
...
- Zapisz zmodyfikowaną prezentację jako plik PPS.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Wymagania dotyczące tworzenia" %}}

- Aby utworzyć dokument PPS, w systemie musi być zainstalowany Node.js.
- Wymagany jest Oracle JDK (wersja 7 lub nowsza).
- Pakiet node-java musi być skonfigurowany.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Node.js — tworzenie plików PPS" offSpacer="" %}}
