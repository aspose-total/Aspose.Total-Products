...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj POTM na XLSX przez Java lub online" h2="On Premise Java API do eksportowania POTM do XLSX bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
