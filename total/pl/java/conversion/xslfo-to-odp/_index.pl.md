---
title: Konwersja XSLFO do ODP online lub opracowanie aplikacji opartej na Javie do konwersji plików XSLFO
description: Darmowa aplikacja online do konwersji plików XSLFO na ODP. Kod biblioteki konwersji Java dla dokumentów XSLFO. 
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj XSLFO na ODP za pomocą Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Java dla konwersji XSLFO do ODP" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania XSLFO w ODP przy użyciu innych funkcji, takich jak Wymagania dotyczące konwersji, Otwórz zaszyfrowany plik XSLFO przez Java.
