...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na SXC przez Java lub online" h2="On Premise Java API do eksportowania PPTM do SXC bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
