...
description: Konwertuj PPTM do formatu SXC za pomocą Javy bez używania programu Microsoft Excel lub PowerPoint lub online. Szybko przetestuj darmowy konwerter online POT na CSV przed integracją kodu. lub za pomocą bezpłatnego konwertera online
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na SXC przez Java lub Aplikacja internetowa" h2="On Premise Java API do eksportowania PPTM do SXC bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
...
Aby przekonwertować PPTM do SXC, możesz łatwo użyć Aspose.Total dla Javy bezpośrednio z [Maven](https://releases.aspose.com/total/java/) i dołącz biblioteki do swojego pom.xml.
