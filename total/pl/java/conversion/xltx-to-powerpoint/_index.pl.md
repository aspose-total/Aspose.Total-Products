---
title: Konwertuj XLTX na POWERPOINT za pomocą Java
description: Java API do eksportu XLTX do POWERPOINT za pomocą programu Excel lub Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API do eksportu XLTX do POWERPOINT" h2="On Premise Java API do eksportu XLTX do POWERPOINT bez korzystania z Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/pl/net/conversion/xltx-to-powerpointx/" name="XLTX W celu POWERPOINTX" description="" >}}
