...
<iframe title="Darmowa aplikacja do konwersji XPS na WORDML online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.k8s.dynabic.com/?to=wordml&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Kod Java dla konwersji XPS do WORDML" offSpacer="" %}}
