---
title: Java API do eksportu PCL do WORDML
description: Konwertuj PCL na WORDML za pomocą lokalnego interfejsu Java API
url_ignore: /pl/java/conversion/pcl-to-wordml/
family: total
platformtag: net
feature: conversion
informat: PCL
