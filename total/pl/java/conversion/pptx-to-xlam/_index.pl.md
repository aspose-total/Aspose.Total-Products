...
description: Konwertuj PPTX do formatu XLAM za pomocą Javy bez używania programu Microsoft Excel lub PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTX na XLAM przez Java" h2="On Premise Java API do eksportowania PPTX do XLAM bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
...
Aby przekonwertować PPTX do XLAM, możesz łatwo użyć Aspose.Total dla Javy bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
