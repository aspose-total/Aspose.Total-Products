---
title: Java API do konwersji DOCX na ODS
description: Konwertuj DOCX na ODS za pomocą Javy bez używania Microsoft Word lub Microsoft Excel lub online. Szybko przetestuj darmowy konwerter online DOC na CSV przed integracją kodu. lub za pomocą bezpłatnego konwertera online
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API do konwersji DOCX na ODS" %}}
...
Możesz łatwo użyć Aspose.Total for Java bezpośrednio z projektu opartego na [Maven](https://releases.aspose.com/total/java/) i dołącz [Aspose.Words for Java](https://docxs.aspose.com/words/java/installation/) i [Aspose.Cells for Java](https://docxs.aspose.com/cells/java/installation/) w pliku pom.xml.
