---
title: Java API do eksportu TEX do WORDML
description: Konwertuj TEX na WORDML za pomocą lokalnego interfejsu Java API
url_ignore: /pl/java/conversion/tex-to-wordml/
family: total
platformtag: net
feature: conversion
informat: TEX
