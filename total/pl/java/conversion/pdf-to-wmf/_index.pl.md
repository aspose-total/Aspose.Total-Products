---
title: Konwertuj PDF na WMF przez Java
description: Eksportuj plik PDF do WMF w swoich aplikacjach Java bez korzystania z aplikacji innych firm
url_ignore: /pl/java/conversion/pdf-to-wmf/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PDF na WMF przez Java" h2="Eksportuj plik PDF do WMF w dowolnej aplikacji Java J2SE, J2EE, J2ME bez użycia Adobe<sup>&reg;</sup> Acrobat Reader" >}}
{{% blocks/products/pf/feature-page-summary %}}
Możesz przekonwertować plik pdf na obraz WMF w Javie w dwóch prostych krokach. Po pierwsze, używając [Aspose.PDF for Java](https://products.aspose.com/pdf/java/), możesz wyeksportować PDF do JPEG. Następnie za pomocą interfejsu API przetwarzania obrazów [Aspose.Imaging for Java](https://products.aspose.com/imaging/java/) możesz renderować JPEG do WMF. Oba interfejsy API są objęte pakietem [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eksportuj PDF do WMF przez Javę" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konwertuj i obracaj PDF do pliku WMF za pomocą Java" %}}
...
```
{{< blocks/products/pf/agp/feature-section >}}
Konwertowanie **PDF na WMF** lub **PDF na WMZ** pozwala na wykorzystanie grafiki wektorowej z plików PDF w **aplikacjach opartych na systemie Windows**, prezentacjach oraz skalowalnych ilustracjach do zastosowań w firmach, instytucjach rządowych oraz w procesach projektowych.
{{% blocks/products/pf/agp/feature-section-col title="Główne przypadki użycia" %}}
- Osadzanie wektorowej grafiki PDF w aplikacjach biurowych
- Tworzenie materiałów prezentacyjnych i marketingowych
- Skalowalne diagramy i ilustracje
- Grafika dokumentów firmowych i rządowych
- Kompresowane przechowywanie formatu wektorowego za pomocą WMZ
{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Scenariusze automatyzacji" %}}
- Zautomatyzowane **potoki konwersji PDF na WMF/WMZ**
- Przetwarzanie wsadowe wektorowej grafiki PDF
- Integracja z prezentacjami i procesami biurowymi
- Automatyzacja grafiki firmowej do publikacji
- Automatyzacja przechowywania i ponownego wykorzystywania wektorów
{{% /blocks/products/pf/agp/feature-section-col %}}
{{< /blocks/products/pf/agp/feature-section >}}
```
