---
title: Konwersja PCL do ODP online lub opracowanie aplikacji opartej na Javie do konwersji plików PCL
description: Darmowa aplikacja online do konwersji plików PCL na ODP. Kod biblioteki konwersji Java dla dokumentów PCL. 
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj PCL na ODP za pomocą Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Java dla konwersji PCL do ODP" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania PCL w ODP przy użyciu innych funkcji, takich jak Wymagania dotyczące konwersji, Otwórz zaszyfrowany plik PCL przez Java.
