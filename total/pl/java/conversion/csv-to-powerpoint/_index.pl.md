...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API do eksportu CSV do POWERPOINT lub online" h2="On Premise Java API do eksportu CSV do POWERPOINT lub online bez korzystania z Microsoft Excel&reg;" >}}
