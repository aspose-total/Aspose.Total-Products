---
title: Java API do konwersji RTF na XLT
description: Konwertuj RTF na XLT za pomocą Javy bez używania Microsoft Word lub Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj RTF na XLT przez Java" h2="On Premise Java API do konwersji RTF na XLT bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
Po przekonwertowaniu RTF na XLT [Aspose.Cells for Java](https://products.aspose.com/cells/java/) umożliwia zapisanie dokumentu do przesyłania strumieniowego. Jeśli chcesz zapisać pliki w Stream, powinieneś utworzyć obiekt FileOutputStream, a następnie [save](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.io.OutputStream.%20com.aspose.cells.SaveOptions)) plik do tego obiektu Stream przez wywołanie metody save [Workbook](https://apireference.aspose.com/cells/java/com.aspose.cells/Workbook) obiekt. 
{{% blocks/products/pf/feature-page-code %}}
