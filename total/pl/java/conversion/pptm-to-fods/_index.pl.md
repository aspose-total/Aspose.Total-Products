---
title: Konwertuj PPTM na format FODS za pomocą Java
description: Konwertuj PPTM do formatu FODS za pomocą Javy bez używania programu Microsoft Excel lub PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na FODS przez Java" h2="On Premise Java API do eksportowania PPTM do FODS bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
...
2. Przekonwertuj PPTM na HTML, używając [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides. Metoda ISaveOptions-)
...
Aby przekonwertować PPTM do FODS, możesz łatwo użyć Aspose.Total dla Javy bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
