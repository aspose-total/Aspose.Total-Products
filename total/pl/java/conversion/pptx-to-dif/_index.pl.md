...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTX na DIF przez Java" h2="On Premise Java API do eksportowania PPTX do DIF bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
...
Aby przekonwertować PPTX do DIF, możesz łatwo użyć Aspose.Total dla Javy bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
