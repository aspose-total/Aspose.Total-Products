...
description: Java API do eksportu PPTM do DOT bez użycia Microsoft Word lub PowerPoint
url: /pl/java/conversion/pptm-to-dot/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na DOT przez Java" h2="On Premise Java API do konwersji PowerPoint PPTM do DOT w dowolnych aplikacjach Java J2SE, J2EE, J2ME" >}}
...
Do konwersji plików PPTM do DOT można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) i dołącz biblioteki do swojego pom.xml.
