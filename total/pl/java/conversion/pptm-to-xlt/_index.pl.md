...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na XLT przez Java lub online" h2="On Premise Java API do eksportowania PPTM do XLT bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
