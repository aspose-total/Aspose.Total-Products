---
title: Konwersja XPS do ODP online lub opracowanie aplikacji opartej na Javie do konwersji plików XPS
description: Darmowa aplikacja online do konwersji plików XPS na ODP. Kod biblioteki konwersji Java dla dokumentów XPS. 
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj XPS na ODP za pomocą Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Java dla konwersji XPS do ODP" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania XPS w ODP przy użyciu innych funkcji, takich jak Wymagania dotyczące konwersji, Otwórz zaszyfrowany plik XPS przez Java.
