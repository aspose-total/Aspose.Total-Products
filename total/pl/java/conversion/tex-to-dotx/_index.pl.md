---
title: Java API do eksportu TEX do DOTX
description: Konwertuj TEX na DOTX za pomocą lokalnego interfejsu Java API
url_ignore: /pl/java/conversion/tex-to-dotx/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Przekształć TEX w DOTX za pomocą Javy" h2="On Premise Java API do renderowania TEX do DOTX bez korzystania z aplikacji innych firm" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java API do konwersji TEX na DOTX" %}}
