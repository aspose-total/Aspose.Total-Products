...
description: Java API do eksportu PPT do WORDML bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPT na WORDML przez Java" h2="On Premise Java API do konwersji PowerPoint PPT do WORDML w dowolnych aplikacjach Java J2SE, J2EE, J2ME" >}}
...
Do konwersji plików PPT do WORDML można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
