---
title: Konwertuj XLTX na DOCX za pomocą Java
description: Java API do eksportu XLTX do DOCX za pomocą programu Excel lub Word
url: /pl/java/conversion/xltx-to-docx/
family: total
platformtag: net
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API do eksportu XLTX do DOCX" h2="On Premise Java API do eksportu XLTX do DOCX bez korzystania z Microsoft Excel&reg;" >}}
