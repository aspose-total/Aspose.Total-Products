...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj DOC na SXC przez Java lub online" h2="On Premise Java API do konwersji DOC na SXC bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
