...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj POTM na EXCEL przez Java lub online" h2="On Premise Java API do eksportowania POTM do EXCEL bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
