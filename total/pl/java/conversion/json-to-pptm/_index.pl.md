...
url: /pl/java/conversion/json-to-pptm/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. Zapisz dokument w formacie PPTM za pomocą metody [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-)
...
Korzystając z API, możesz również przekonwertować JSON na PPTM ze znakiem wodnym. Aby dodać znak wodny do dokumentu PPTM, możesz najpierw przeanalizować JSON do PPTX i dodać do niego znak wodny. Aby dodać znak wodny, wczytaj nowo utworzony plik PPTX za pomocą klasy [Presentation](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation), przejdź przez wszystkie slajdy, dodaj tekst używając addTextFrame, ustaw wszystkie pptmowiednie opcje, takie jak kolor, fillType i inne, i zapisz dokument w PPTM. 
{{% blocks/products/pf/feature-page-code %}}
