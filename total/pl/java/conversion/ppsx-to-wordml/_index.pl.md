...
description: Java API do eksportu PPSX do WORDML bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPSX na WORDML przez Java" h2="On Premise Java API do konwersji PowerPoint PPSX do WORDML w dowolnych aplikacjach Java J2SE, J2EE, J2ME" >}}
...
Do konwersji plików PPSX do WORDML można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
