---
title: Konwertuj PPTM na format XLAM za pomocą Java
description: Konwertuj PPTM do formatu XLAM za pomocą Javy bez używania programu Microsoft Excel lub PowerPoint
url: /pl/java/conversion/pptm-to-xlam/
family: total
platformtag: net
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTM na XLAM przez Java" h2="On Premise Java API do eksportowania PPTM do XLAM bez użycia Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
...
Aby przekonwertować PPTM do XLAM, możesz łatwo użyć Aspose.Total dla Javy bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/ aspose/aspose-total) i dołącz biblioteki do swojego pom.xml.
