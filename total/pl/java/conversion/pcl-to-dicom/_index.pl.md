---
title: Konwertuj PCL na DICOM przez Java
description: Eksportuj plik PCL do DICOM w swoich aplikacjach Java bez korzystania z aplikacji innych firm
url_ignore: /pl/java/conversion/pcl-to-dicom/
family: total
platformtag: net
feature: conversion
informat: PCL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PCL na DICOM przez Java" h2="Eksportuj plik PCL do DICOM w dowolnej aplikacji Java J2SE, J2EE, J2ME bez użycia Adobe<sup>&reg;</sup> Acrobat Reader" >}}
{{% blocks/products/pf/feature-page-summary %}}
Możesz przekonwertować plik pcl na obraz DICOM w Javie w dwóch prostych krokach. Po pierwsze, używając [Aspose.PDF for Java](https://products.aspose.com/pdf/java/), możesz wyeksportować PCL do JPEG. Następnie za pomocą interfejsu API przetwarzania obrazów [Aspose.Imaging for Java](https://products.aspose.com/imaging/java/) możesz renderować JPEG do DICOM. Oba interfejsy API są objęte pakietem [Aspose.Total for Java](https://products.aspose.com/total/java/).
{{% /blocks/products/pf/feature-page-summary  %}}
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Eksportuj PCL do DICOM przez Javę" %}}
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Konwertuj i obracaj PCL do pliku DICOM za pomocą Java" %}}
...
Konwertowanie **PCL na DICOM** umożliwia przekształcenie wyników **Printer Command Language** na pliki **Digital Imaging and Communications in Medicine (DICOM)**. Jest to szczególnie przydatne w środowiskach medycznych, które potrzebują archiwizować lub wizualizować dane diagnostyczne w systemach obrazowania.

{{% blocks/products/pf/agp/feature-section-col title="Główne przypadki użycia" %}}

* Konwertowanie wydrukowanych raportów diagnostycznych do formatu obrazu DICOM
* Osadzanie zeskanowanych danych drukowanych w archiwach obrazowania medycznego
* Integracja dokumentów medycznych opartych na PCL w systemach PACS
* Standaryzacja formatów kartotek medycznych zgodnie z przepisami dotyczącymi ochrony zdrowia

{{% /blocks/products/pf/agp/feature-section-col %}}
{{% blocks/products/pf/agp/feature-section-col title="Scenariusze automatyzacji" %}}

* Automatyczna konwersja wydrukowanych raportów medycznych na format DICOM do dokumentacji szpitalnej
* Integracja konwersji druk-do-DICOM w ramach przepływów pracy w opiece zdrowotnej
* Partiowa transformacja archiwów PCL dla systemów przechowywania obrazów medycznych
