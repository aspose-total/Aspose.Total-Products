---
title: Konwersja PDF do ODP online lub opracowanie aplikacji opartej na Javie do konwersji plików PDF
description: Darmowa aplikacja online do konwersji plików PDF na ODP. Kod biblioteki konwersji Java dla dokumentów PDF. 
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj PDF na ODP za pomocą Java Automation API" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Java dla konwersji PDF do ODP" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania PDF w ODP przy użyciu innych funkcji, takich jak Wymagania dotyczące konwersji, Otwórz zaszyfrowany plik PDF przez Java.
