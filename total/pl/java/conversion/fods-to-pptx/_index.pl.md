...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API do eksportu FODS do PPTX lub online" h2="On Premise Java API do eksportu FODS do PPTX lub online bez korzystania z Microsoft Excel<sup>&reg;</sup>" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak przekonwertować FODS do PPTX za pomocą Java API" %}}
