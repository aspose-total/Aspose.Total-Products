...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj DOTM na XLS przez Java lub online" h2="On Premise Java API do konwersji DOTM na XLS bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
