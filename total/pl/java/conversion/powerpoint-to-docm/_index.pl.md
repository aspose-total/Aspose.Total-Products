...
description: Java API do eksportu POWERPOINT do DOCM bez użycia Microsoft Word lub PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj POWERPOINT na DOCM przez Java" h2="On Premise Java API do konwersji PowerPoint POWERPOINT do DOCM w dowolnych aplikacjach Java J2SE, J2EE, J2ME" >}}
...
2. Przekonwertuj POWERPOINT na HTML, używając [save](https://apireference.aspose.com/slides/java/com.aspose.slides/Presentation#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) i ustaw HTML jako SaveFormat
...
Do konwersji plików POWERPOINT do DOCM można łatwo użyć Aspose.Total dla Java bezpośrednio z [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose /aspose-total) i dołącz biblioteki do swojego pom.xml.
