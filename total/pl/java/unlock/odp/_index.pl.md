---
title: Usuń ochronę hasłem ODP online lub za pomocą Java
description: Usuń hasło z dokumentu ODP za pośrednictwem aplikacji online za darmo.Kod Java API do odblokowania chronionych hasłem plików ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Odblokuj hasło do dokumentu ODP online lub przez Javę" h2="Opracuj potężną aplikację narzędziową do blokowania i odblokowywania dokumentów ODP opartą na Javie.Wymieniony kod umożliwiający usunięcie ograniczeń haseł z pliku ODP za pośrednictwem języka Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Usuń hasło ODP przez Javę" %}}

1. Odwołaj się do biblioteki Java w projekcie
1. Załaduj chroniony hasłem plik ODP przy użyciu klasy Prezentacja
...
{{% blocks/products/pf/agp/code-block title="Kod Java do usuwania hasła z dokumentu ODP" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e5a45839a6a8a82a098aeead8c4e2f6" "remove-password-from-powerpoint-presentation.java" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod Java wyłączający ochronę przed zapisem z dokumentu ODP" offSpacer="" %}}
...
<h2>Twórz aplikację do zarządzania ochroną ODP za pośrednictwem języka Java</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania ochroną ODP?Dzięki [Aspose.Slides for Java](https://products.aspose.com/slides/pl/java/), podrzędnemu interfejsowi API [Aspose.Total for Java](https://products.aspose.com/total/pl/java/), każdy programista Java może zintegrować powyższy kod API ze swoją aplikacją do ochrony dokumentów lub usuwania ich z ochrony.Potężna biblioteka Java umożliwia zaprogramowanie dowolnego rozwiązania do ochrony dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie Java do zarządzania ochroną ODP" %}}
