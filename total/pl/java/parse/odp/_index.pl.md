---
title: Wyodrębnij tekst i obrazy z pliku ODP online i używając Java
description: Aplikacja do analizowania plików online ODP. Kod Java API do wyodrębniania obrazów i tekstu z prezentacji ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik ODP online, a także za pośrednictwem Java" h2="Opracuj potężną aplikację do analizowania dokumentów ODP opartą na Javie. Kod do analizowania ODP poprzez Javę." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj prezentację ODP za pośrednictwem języka Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod Java do analizowania prezentacji ODP" offSpacer="" %}}
...
<h2>Tworzenie aplikacji analizatora prezentacji ODP w języku Java</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie Java do przetwarzania pliku ODP dla aplikacji parsera" %}}
