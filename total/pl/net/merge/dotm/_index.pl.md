---
title: Scal pliki DOTM online lub przy użyciu platformy .NET
description: Bezpłatna aplikacja internetowa do łączenia różnych plików DOTM..NET scalanie kodu biblioteki w celu scalania dokumentów DOTM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Scal dokumenty DOTM online za pomocą aplikacji Merger lub .NET" h2="Opracuj potężną aplikację do łączenia dokumentów DOTM opartą na platformie .NET.Połącz wiele dokumentów DOTM w jeden online, bezpłatnie za pośrednictwem aplikacji.Zapisz plik DOTM jako plik PDF, obrazy, Word, Excel, PowerPoint i wiele innych formatów online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Scal plik DOTM przez .NET" %}}

1. Utwórz obiekt klasy Dokument
1. Załaduj oba dokumenty do dwóch oddzielnych obiektów klasy Document
1. Aby połączyć dokumenty, użyj funkcji AppendDocument
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Scal pliki DOTM" offSpacer="" %}}
...
<h2>Opracuj fuzję plików DOTM przy użyciu .NET</h2>

Chcesz opracować aplikację narzędziową .NET, która umożliwi łatwe łączenie wielu plików DOTM?Dzięki podrzędnemu interfejsowi API [Aspose.Words for .NET](https://products.aspose.com/words/pl/net/) w formacie [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/) każdy programista .NET może zintegrować powyższy kod API, aby zaprogramować scalanie aplikacji między dokumentami.Wydajna biblioteka .NET do łączenia dokumentów obsługuje wiele popularnych formatów, w tym format DOTM.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka łączenia .NET dla plików DOTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tak, możesz pobrać ten kod. Można łatwo opracować profesjonalne rozwiązanie umożliwiające połączenie DOTM przy użyciu platformy .NET.Użyj interfejsu API łączenia Aspose DOTM, aby opracować oprogramowanie wysokiego poziomu, niezależne od platformy w .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
