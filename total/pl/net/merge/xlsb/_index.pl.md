---
title: Scal pliki XLSB online lub przy użyciu platformy .NET
description: Bezpłatna aplikacja internetowa do łączenia różnych plików XLSB.C# .NET scalanie kodu biblioteki w celu łączenia arkuszy XLSB z innymi formatami.
...
{{< blocks/products/pf/feature-page-header-widget h1="Scal dokumenty XLSB online za pomocą aplikacji Merger lub .NET" h2="Opracuj potężną aplikację do łączenia dokumentów XLSB opartą na platformie .NET.Połącz wiele dokumentów XLSB w jeden online, bezpłatnie za pośrednictwem aplikacji.Zapisz połączony plik XLSB jako plik PDF, obrazy, Word, Excel, PowerPoint i wiele innych formatów online." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Scal pliki XLSB online za pomocą aplikacji" %}}

1. Prześlij pliki XLSB, aby połączyć je w jeden
...
1. Kliknij przycisk „Scal”, aby połączyć XLSB w żądanym formacie
1. Pobierz połączony plik XLSB
1. Wyświetl i pobierz pojedynczy scalony plik XLSB

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Scal plik XLSB przez .NET" %}}

1. Załaduj oba XLSB, używając obiektów klasy Workbook.
1. Wybierz jeden skoroszyt jako plik podstawowy.
1. Użyj metody Combine, używając obiektu bazowego i drugiego obiektu pliku XLSB jako parametru.
1. Wywołaj metodę Save i pobierz połączone pliki XLSB w jeden.
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Scal pliki XLSB" offSpacer="" %}}
...
<h2>Opracuj fuzję plików XLSB przy użyciu .NET</h2>

Chcesz opracować aplikację narzędziową .NET, która umożliwi łatwe łączenie wielu plików XLSB?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API w celu łatwego łączenia dokumentów.Wydajna biblioteka .NET do łączenia dokumentów obsługuje wiele popularnych formatów, w tym format XLSB.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka łączenia .NET dla plików XLSB" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tak, możesz pobrać ten kod. Można opracować profesjonalne rozwiązanie umożliwiające połączenie XLSB przy użyciu platformy .NET.Użyj interfejsu API łączenia XLSB, aby opracować oprogramowanie wysokiego poziomu, niezależne od platformy w .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy używanie aplikacji online do łączenia wielu dokumentów XLSB jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Do łączenia dokumentów XLSB online można używać dowolnej nowoczesnej przeglądarki internetowej, takiej jak Google Chrome, Firefox, Opera lub Safari.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Jak mogę połączyć wiele plików XLSB?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Zacznij od przesłania jednego lub więcej plików, które chcesz połączyć. Możesz przeciągnąć i upuścić pliki XLSB lub po prostu kliknąć wewnątrz białego obszaru.Następnie kliknij przycisk „Scal”, a nasza fuzja szybko przetworzy przesłane pliki.</span>
                      </div>
                  </li>
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Ile czasu zajmuje scalanie plików XLSB?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
