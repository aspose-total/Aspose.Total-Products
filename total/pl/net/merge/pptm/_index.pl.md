---
title: Scal pliki PPTM online lub przy użyciu platformy .NET
description: Bezpłatna aplikacja internetowa umożliwiająca łączenie różnych prezentacji PPTM.Łączenie kodu biblioteki C# .NET w celu połączenia prezentacji PPTM z wybranym formatem.
...
{{< blocks/products/pf/feature-page-header-widget h1="Scal dokumenty PPTM online za pomocą aplikacji Merger lub .NET" h2="Opracuj potężną aplikację do łączenia dokumentów PPTM opartą na platformie .NET.Połącz wiele dokumentów PPTM w jeden, bezpłatnie online za pośrednictwem aplikacji.Zapisz połączony plik PPTM jako plik PDF, obrazy, Word, Excel, PowerPoint i wiele innych formatów online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Scal plik PPTM przez .NET" %}}

1. Załaduj PPTM przy użyciu obiektu klasy Prezentacja
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Scal pliki PPTM" offSpacer="" %}}
...
<h2>Opracuj fuzję plików PPTM przy użyciu .NET</h2>

Chcesz opracować aplikację do łączenia .NET, która umożliwi łatwe łączenie wielu plików PPTM?Dzięki [Aspose.Slides for .NET](https://products.aspose.com/slides/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API w celu łatwego łączenia dokumentów.Wydajna biblioteka .NET do łączenia dokumentów obsługuje wiele popularnych formatów, w tym format PPTM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka łączenia .NET dla plików PPTM" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tak, możesz pobrać ten kod. Można łatwo opracować profesjonalne rozwiązanie umożliwiające połączenie PPTM przy użyciu platformy .NET. Użyj interfejsu API łączenia PPTM, aby opracować oprogramowanie wysokiego poziomu, niezależne od platformy w .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
