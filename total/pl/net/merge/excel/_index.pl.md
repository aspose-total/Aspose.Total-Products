---
title: Scal pliki Excel online lub przy użyciu platformy .NET
description: Bezpłatna aplikacja internetowa do łączenia różnych plików Excel.C# .NET scalanie kodu biblioteki w celu łączenia arkuszy Excel z innymi formatami.
...
{{< blocks/products/pf/feature-page-header-widget h1="Scal dokumenty Excel online za pomocą aplikacji Merger lub .NET" h2="Opracuj potężną aplikację do łączenia dokumentów Excel opartą na platformie .NET.Połącz wiele dokumentów Excel w jeden online, bezpłatnie za pośrednictwem aplikacji.Zapisz połączony plik Excel jako plik PDF, obrazy, Word, Excel, PowerPoint i wiele innych formatów online." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Scal plik Excel przez .NET" %}}

1. Załaduj oba Excel, używając obiektów klasy Workbook.
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Scal pliki Excel" offSpacer="" %}}
...
<h2>Opracuj fuzję plików Excel przy użyciu .NET</h2>

Chcesz opracować aplikację narzędziową .NET, która umożliwi łatwe łączenie wielu plików Excel?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API w celu łatwego łączenia dokumentów.Wydajna biblioteka .NET do łączenia dokumentów obsługuje wiele popularnych formatów, w tym format Excel.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka łączenia .NET dla plików Excel" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tak, możesz pobrać ten kod. Można opracować profesjonalne rozwiązanie umożliwiające połączenie Excel przy użyciu platformy .NET.Użyj interfejsu API łączenia Excel, aby opracować oprogramowanie wysokiego poziomu, niezależne od platformy w .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
