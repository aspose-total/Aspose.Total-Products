---
title: Konwertuj XLSB na WORD za pomocą .NET 
description: Konwertuj XLSB na WORD na platformach .NET Framework, .NET Core, Mono lub Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj XLSB na WORD za pomocą C#" h2="Eksportuj Excel&reg; XLSB do WORD na platformach .NET Framework, .NET Core, Mono lub Xamarin">}}
