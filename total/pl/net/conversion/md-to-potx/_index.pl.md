---
title: Eksportuj MD do POTX przez C# API
description: .NET API do konwersji MD na POTX bez użycia Microsoft Word
url_ignore: /pl/net/conversion/md-to-potx/
family: total
platformtag: net
feature: conversion
informat: MD
