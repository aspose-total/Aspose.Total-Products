---
title: .NET API do konwersji OTT na EXCEL
description: C# API do konwersji OTT na EXCEL bez użycia Microsoft Excel lub Adobe Reader
url: /pl/net/conversion/ott-to-excel/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji OTT na EXCEL" h2="Eksportuj OTT do EXCEL za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Otwórz plik OTT za pomocą klasy [Document](https://apireference.aspose.com/words/net/aspose.words/ottument)
