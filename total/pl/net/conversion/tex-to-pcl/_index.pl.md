...
<iframe title="Darmowa aplikacja do konwersji TEX na PCL online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=pcl&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Konwertuj TEX na PCL przez C# .NET" offSpacer="" %}}
