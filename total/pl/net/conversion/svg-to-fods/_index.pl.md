---
title: Konwertuj SVG na FODS za pomocą C# API
description: C# API do konwersji pliku SVG na FODS bez użycia Microsoft Excel lub Adobe Reader
url_ignore: /pl/net/conversion/svg-to-fods/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do renderowania SVG do FODS" h2="Eksportuj plik SVG do FODS za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Excel lub Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
Używając [Aspose.Total for .NET](https://products.aspose.com/total/net/) możesz łatwo przekonwertować plik SVG na FODS w dowolnej aplikacji .NET, C#, ASP.NET i VB.NET. Po pierwsze, używając [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), możesz wyeksportować SVG do XLSX. Następnie, używając [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, możesz przekonwertować XLSX na FODS.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API do konwersji SVG na FODS" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj chroniony plik SVG na FODS za pomocą C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj plik SVG na FODS za pomocą znaku wodnego za pomocą C#" %}}
