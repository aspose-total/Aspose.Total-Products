---
title: Konwertuj XLSB na POWERPOINT za pomocą .NET 
description: Konwertuj XLSB na POWERPOINT na platformach .NET Framework, .NET Core, Mono lub Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj XLSB na POWERPOINT za pomocą C#" h2="Eksportuj Excel&reg; XLSB do POWERPOINT na platformach .NET Framework, .NET Core, Mono lub Xamarin">}}
