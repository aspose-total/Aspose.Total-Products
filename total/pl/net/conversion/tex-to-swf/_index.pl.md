---
title: Konwersja online TEX do SWF lub budowa aplikacji opartej na .NET do konwersji plików TEX
description: Darmowa aplikacja online do konwersji plików TEX na SWF. Kod biblioteki konwersji .NET C# dla dokumentów TEX. 
...
<iframe title="Darmowa aplikacja do konwersji TEX na SWF online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=swf&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj TEX na SWF za pomocą interfejsu API automatyzacji .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Konwertuj TEX na SWF przez C# .NET" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania TEX w SWF przy użyciu innych funkcji, takich jak Uzyskaj metadane XMP z pliku TEX przez .NET, Utwórz plik SWF tylko do odczytu przez .NET.
