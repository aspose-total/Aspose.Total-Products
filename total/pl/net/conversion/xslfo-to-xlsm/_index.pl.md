---
title: Konwertuj XSLFO na XLSM za pomocą C# API
description: C# API do konwersji pliku XSLFO na XLSM bez użycia Microsoft Excel lub Adobe Reader
url_ignore: /pl/net/conversion/xslfo-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do renderowania XSLFO do XLSM" h2="Eksportuj plik XSLFO do XLSM za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Excel lub Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
Używając [Aspose.Total for .NET](https://products.aspose.com/total/net/) możesz łatwo przekonwertować plik XSLFO na XLSM w dowolnej aplikacji .NET, C#, ASP.NET i VB.NET. Po pierwsze, używając [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), możesz wyeksportować XSLFO do XLSX. Następnie, używając [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, możesz przekonwertować XLSX na XLSM.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API do konwersji XSLFO na XLSM" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj chroniony plik XSLFO na XLSM za pomocą C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj plik XSLFO na XLSM za pomocą znaku wodnego za pomocą C#" %}}
Konwertując plik XSLFO na XLSM, możesz także dodać znak wodny do wyjściowego formatu pliku XLSM. Aby dodać znak wodny, możesz utworzyć nowy obiekt Workbook i otworzyć przekonwertowany dokument XLSX, wybrać Arkusz roboczy poprzez jego indeks, utworzyć Kształt i użyć jego funkcji AddTextEffect. Następnie możesz zapisać dokument XLSX jako XLSM ze znakiem wodnym. 
{{% blocks/products/pf/feature-page-code %}}
