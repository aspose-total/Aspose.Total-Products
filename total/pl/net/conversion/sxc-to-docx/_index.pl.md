---
title: Konwertuj SXC na DOCX za pomocą .NET 
description: Konwertuj SXC na DOCX na platformach .NET Framework, .NET Core, Mono lub Xamarin
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj SXC na DOCX za pomocą C#" h2="Eksportuj Excel&reg; SXC do DOCX na platformach .NET Framework, .NET Core, Mono lub Xamarin">}}
