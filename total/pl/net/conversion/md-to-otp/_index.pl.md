---
title: Eksportuj MD do OTP przez C# API
description: .NET API do konwersji MD na OTP bez użycia Microsoft Word
url_ignore: /pl/net/conversion/md-to-otp/
family: total
platformtag: net
feature: conversion
informat: MD
