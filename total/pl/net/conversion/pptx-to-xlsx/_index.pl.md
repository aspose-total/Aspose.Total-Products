...
description: Konwertuj PPTX na XLSX w C# bez użycia Microsoft Excel lub Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPTX na XLSX za pomocą C#" h2=".NET API do konwersji PPTX na XLSX bez użycia programu Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
