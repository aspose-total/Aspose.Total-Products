---
title: C# API do eksportu TEX do RTF
description: Konwertuj TEX na RTF bez użycia Microsoft Word
url_ignore: /pl/net/conversion/tex-to-rtf/
family: total
platformtag: net
feature: conversion
informat: TEX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Renderuj TEX do RTF przez .NET" h2=".NET API do eksportu TEX do RTF w systemach Windows, macOS i Linux bez użycia Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API do konwersji TEX na RTF" %}}
...
Przed konwersją TEX do RTF, jeśli chcesz odszyfrować swój dokument, możesz to zrobić za pomocą interfejsu API. Aby odszyfrować plik PDF, musisz najpierw utworzyć obiekt [Dokument](https://apireference.aspose.com/pdf/net/aspose.pdf/document) i otworzyć TEX przy użyciu hasła właściciela. Następnie musisz wywołać metodę [Decrypt](https://apireference.aspose.com/pdf/net/aspose.pdf/document/methods/decrypt) obiektu Document. Na koniec zapisz zaktualizowany plik za pomocą metody Save obiektu Document.  
{{% blocks/products/pf/feature-page-code %}}
