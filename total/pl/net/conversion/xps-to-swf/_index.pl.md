---
title: Konwersja online XPS do SWF lub budowa aplikacji opartej na .NET do konwersji plików XPS
description: Darmowa aplikacja online do konwersji plików XPS na SWF. Kod biblioteki konwersji .NET C# dla dokumentów XPS. 
...
<iframe title="Darmowa aplikacja do konwersji XPS na SWF online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=swf&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj XPS na SWF za pomocą interfejsu API automatyzacji .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Konwertuj XPS na SWF przez C# .NET" offSpacer="" %}}
...
Jeszcze kilka przypadków zapisania XPS w SWF przy użyciu innych funkcji, takich jak Uzyskaj metadane XMP z pliku XPS przez .NET, Utwórz plik SWF tylko do odczytu przez .NET.
