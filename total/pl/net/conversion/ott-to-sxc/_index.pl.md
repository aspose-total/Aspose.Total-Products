---
title: .NET API do konwersji OTT na SXC
description: C# API do konwersji OTT na SXC bez użycia Microsoft Excel lub Adobe Reader
url: /pl/net/conversion/ott-to-sxc/
family: total
platformtag: net
feature: conversion
informat: OTT
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji OTT na SXC" h2="Eksportuj OTT do SXC za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
