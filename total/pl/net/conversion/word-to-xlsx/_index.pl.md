---
title: .NET API do konwersji WORD na XLSX
description: C# API do konwersji WORD na XLSX bez użycia Microsoft Excel lub Adobe Reader
url: /pl/net/conversion/word-to-xlsx/
family: total
platformtag: net
feature: conversion
informat: WORD
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji WORD na XLSX" h2="Eksportuj WORD do XLSX za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
