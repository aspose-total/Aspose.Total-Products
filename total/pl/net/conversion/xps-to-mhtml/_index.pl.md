...
<iframe title="Darmowa aplikacja do konwersji XPS na MHTML online" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=mhtml&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Konwertuj XPS na MHTML przez C# .NET" offSpacer="" %}}
