---
title: Eksportuj MHTML do PPT przez C# API
description: .NET API do konwersji MHTML na PPT bez użycia Microsoft Word
url_ignore: /pl/net/conversion/mhtml-to-ppt/
family: total
platformtag: net
feature: conversion
informat: MHTML
...
4. Zapisz dokument w formacie PPT za pomocą metody [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) i ustaw `Ppt` jako SaveFormat
