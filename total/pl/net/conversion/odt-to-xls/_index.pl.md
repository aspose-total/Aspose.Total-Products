---
title: .NET API do konwersji ODT na XLS
description: C# API do konwersji ODT na XLS bez użycia Microsoft Excel lub Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji ODT na XLS" h2="Eksportuj ODT do XLS za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Otwórz plik ODT za pomocą klasy [Odtument](https://apireference.aspose.com/words/net/aspose.words/odtument)
2. Konwertuj ODT na HTML za pomocą metody [Save](https://apireference.aspose.com/words/net/aspose.words.odtument/save/methods/4)
