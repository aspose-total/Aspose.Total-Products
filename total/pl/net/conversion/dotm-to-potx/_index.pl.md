...
url: /pl/net/conversion/dotm-to-potx/ 
...
Aby zautomatyzować proces konwersji dowolnych plików dokumentów programu Word do wsadowej konwersji prezentacji PowerPoint potx , użyjemy [Aspose.Words for .NET](https://products.aspose.com/words/net) i [Aspose.Slides dla .NET](https://products.aspose.com/slides/net) API. Ten pierwszy to interfejs API do przetwarzania tekstu do przetwarzania lub manipulowania dokumentami Microsoft Word. Natomiast ten ostatni to interfejs API do manipulacji prezentacją, który pozwala tworzyć lub modyfikować slajdy programu Microsoft PowerPoint. Oba interfejsy API są częścią pakietu [Aspose.Total for .NET](https://products.aspose.com/total/net). Możesz bezpośrednio [pobrać](https://downloads.aspose.com/) z Nuget lub użyć następujących poleceń z konsoli Menedżera pakietów.
...
// To convert multi pages DOTM dotmuments, export each page to HTML separately using Aspose.Words and then use the below code to convert to POTX.
