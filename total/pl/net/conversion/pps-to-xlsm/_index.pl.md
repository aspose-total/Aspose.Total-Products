...
description: Konwertuj PPS na XLSM w C# bez użycia Microsoft Excel lub Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Konwertuj PPS na XLSM za pomocą C#" h2=".NET API do konwersji PPS na XLSM bez użycia programu Microsoft<sup>&reg;</sup> Excel lub PowerPoint" >}}
