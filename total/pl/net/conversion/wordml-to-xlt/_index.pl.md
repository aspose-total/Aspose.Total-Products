...
description: C# API do konwersji WORDML na XLT bez użycia Microsoft Excel lub Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji WORDML na XLT" h2="Eksportuj WORDML do XLT za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
