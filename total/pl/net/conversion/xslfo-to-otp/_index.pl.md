---
title: Eksportuj XSLFO do OTP przez C# API
description: .NET API do konwersji XSLFO na OTP bez użycia Microsoft Word
url_ignore: /pl/net/conversion/xslfo-to-otp/
family: total
platformtag: net
feature: conversion
informat: XSLFO
...
4. Zapisz dokument w formacie OTP za pomocą metody [Save](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5) i ustaw `Otp` jako SaveFormat
