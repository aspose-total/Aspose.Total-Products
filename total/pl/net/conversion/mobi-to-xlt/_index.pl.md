---
title: .NET API do konwersji MOBI na XLT
description: C# API do konwersji MOBI na XLT bez użycia Microsoft Excel lub Adobe Reader
url: /pl/net/conversion/mobi-to-xlt/
family: total
platformtag: net
feature: conversion
informat: MOBI
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji MOBI na XLT" h2="Eksportuj MOBI do XLT za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
