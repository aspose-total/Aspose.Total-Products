---
title: Konwertuj XLSX na WORD za pomocą .NET 
description: Konwertuj XLSX na WORD na platformach .NET Framework, .NET Core, Mono lub Xamarin
url: /pl/net/conversion/xlsx-to-word/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Konwertuj XLSX na WORD za pomocą C#" h2="Eksportuj Excel&reg; XLSX do WORD na platformach .NET Framework, .NET Core, Mono lub Xamarin">}}
