---
title: Konwertuj SVG na CSV za pomocą C# API
description: C# API do konwersji pliku SVG na CSV bez użycia Microsoft Excel lub Adobe Reader
url_ignore: /pl/net/conversion/svg-to-csv/
family: total
platformtag: net
feature: conversion
informat: SVG
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do renderowania SVG do CSV" h2="Eksportuj plik SVG do CSV za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Excel lub Adobe<sup>&reg;</sup> Acrobat Reader" >}}

{{% blocks/products/pf/feature-page-summary %}}
Używając [Aspose.Total for .NET](https://products.aspose.com/total/net/) możesz łatwo przekonwertować plik SVG na CSV w dowolnej aplikacji .NET, C#, ASP.NET i VB.NET. Po pierwsze, używając [Aspose.PDF for .NET](https://products.aspose.com/pdf/net/), możesz wyeksportować SVG do XLSX. Następnie, używając [Aspose.Cells for .NET](https://products.aspose.com/cells/net/) Spreadsheet Programming API, możesz przekonwertować XLSX na CSV.
{{% /blocks/products/pf/feature-page-summary  %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title=".NET API do konwersji SVG na CSV" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj chroniony plik SVG na CSV za pomocą C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Konwertuj plik SVG na CSV za pomocą znaku wodnego za pomocą C#" %}}
Konwertując plik SVG na CSV, możesz także dodać znak wodny do wyjściowego formatu pliku CSV. Aby dodać znak wodny, możesz utworzyć nowy obiekt Workbook i otworzyć przekonwertowany dokument XLSX, wybrać Arkusz roboczy poprzez jego indeks, utworzyć Kształt i użyć jego funkcji AddTextEffect. Następnie możesz zapisać dokument XLSX jako CSV ze znakiem wodnym. 
{{% blocks/products/pf/feature-page-code %}}
