---
title: .NET API do konwersji RTF na TSV
description: C# API do konwersji RTF na TSV bez użycia Microsoft Excel lub Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API do konwersji RTF na TSV" h2="Eksportuj RTF do TSV za pomocą C# bez użycia Microsoft<sup>&reg;</sup> Word lub Microsoft<sup>&reg;</sup> Excel" >}}
...
1. Otwórz plik RTF za pomocą klasy [Document](https://apireference.aspose.com/words/net/aspose.words/Document)
2. Konwertuj RTF na HTML za pomocą metody [Save](https://apireference.aspose.com/words/net/aspose.words.Document/save/methods/4)
