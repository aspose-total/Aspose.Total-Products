---
title: Podziel plik Word online lub przez .NET
description: Darmowa aplikacja online do dzielenia różnych plików Word. Kod biblioteki rozdzielacza .NET C# dla dokumentów Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Dziel pliki Word online za pomocą aplikacji Splitter lub platformy .NET" h2="Twórz wydajne aplikacje do dzielenia dokumentów Word w oparciu o platformę .NET. Swobodnie dziel dokumenty, w tym pliki Word, online za pośrednictwem aplikacji z możliwością natychmiastowego pobrania." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Podziel plik Word przez .NET" %}}
...
1. Zapisz wyodrębnioną stronę w nowym pliku Word.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Kod .NET: Podziel pliki Word na stronę" offSpacer="" %}}
...
<h2>Opracuj aplikację do rozdzielania plików Word przy użyciu platformy .NET</h2>

Chcesz opracować skrypt .NET lub aplikację narzędziową, aby łatwo dzielić pliki Word?Dzięki [Aspose.Words for .NET](https://products.aspose.com/words/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API z aplikacją rozdzielającą programy. Potężna biblioteka .NET do dzielenia dokumentów obsługuje wiele popularnych formatów, w tym format Word, takich jak pliki PDF, Word, Excel i PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka rozdzielacza Word dla .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Tak, możesz pobrać ten kod.Można łatwo opracować profesjonalne rozwiązanie do dzielenia plików Word za pomocą .NET.Użyj interfejsu API rozdzielacza Aspose Word, aby opracować oprogramowanie wysokiego poziomu, niezależne od platformy w .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
