---
title: Chroń dokument ODP online za pomocą hasła i używając .NET
description: Aplikacja do ochrony hasłem plików ODP online.Kod API .NET C# umożliwiający zastosowanie ochrony hasłem w prezentacjach ODP.
...
{{% blocks/products/pf/agp/feature-section-col title="Ochrona hasłem ODP przez .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Ochrona hasłem prezentacji ODP" offSpacer="" %}}
...
<h2>Opracuj aplikację do ochrony hasłem ODP za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do ochrony hasłem ODP?Dzięki [Aspose.Slides for .NET](https://products.aspose.com/slides/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do ochrony dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do ochrony dokumentów hasłem w celu zabezpieczenia i zablokowania prezentacji.Ponadto może obsługiwać wiele popularnych formatów, w tym format ODP.<br /><br />
