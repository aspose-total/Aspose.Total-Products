---
title: Chroń dokument Excel online za pomocą hasła i używając .NET
description: Aplikacja do ochrony hasłem plików Excel online.Kod API .NET C# umożliwiający zastosowanie ochrony hasłem w arkuszach kalkulacyjnych Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Ochrona dokumentów Excel online lub ustaw hasło za pośrednictwem .NET" h2="Opracuj potężną aplikację narzędziową do ochrony dokumentów Excel opartą na platformie .NET.Kod umożliwiający zastosowanie hasła do arkusza kalkulacyjnego Excel za pośrednictwem platformy .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Ochrona hasłem Excel online za pośrednictwem aplikacji" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Ochrona hasłem Excel przez .NET" %}}

1. Załaduj plik Excel poprzez obiekt klasy Workbook
1. Wywołaj SetEncryptionOptions z EncryptionType
1. Przypisz hasło za pomocą opcji Ustawienia.Hasło
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Ochrona hasłem dokumentu Excel" offSpacer="" %}}
...
<h2>Opracuj aplikację do ochrony hasłem Excel za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do ochrony hasłem Excel?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do ochrony dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do ochrony hasłem dokumentu w celu zabezpieczenia i zablokowania plików.Ponadto może obsługiwać wiele popularnych formatów, w tym format Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku Excel dla aplikacji zabezpieczającej" %}}
