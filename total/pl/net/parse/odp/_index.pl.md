---
title: Wyodrębnij tekst i obrazy z pliku ODP online i przy użyciu platformy .NET
description: Aplikacja do analizowania plików online ODP. Kod .NET API C# do wyodrębniania obrazów i tekstu z prezentacji ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik ODP online, a także za pośrednictwem .NET" h2="Opracuj potężną aplikację do analizowania prezentacji ODP opartą na platformie .NET. Kod C# wymieniony do analizowania ODP." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj prezentację ODP za pośrednictwem platformy .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja obrazów prezentacyjnych ODP" offSpacer="" %}}
...
<h2>Opracuj aplikację analizatora prezentacji ODP za pośrednictwem platformy .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku ODP dla aplikacji parsera" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Przypadki użycia do analizowania plików .odp

- 📄 Wyodrębnij zawartość z plików prezentacji OpenDocument.
- 🔁 Konwertuj pliki `.odp` na prezentacje PowerPoint lub oparte na sieci.
- 🖼️ Archiwizuj i indeksuj slajdy `.odp` w celu wyszukiwania i ponownego wykorzystania.
