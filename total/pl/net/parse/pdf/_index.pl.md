---
title: Wyodrębnij tekst i obrazy z pliku PDF online i przy użyciu platformy .NET
description: Aplikacja do analizowania plików online PDF. Kod .NET API C# do wyodrębniania obrazów i tekstu z dokumentu PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik PDF online, a także wyodrębniaj tekst lub obrazy za pośrednictwem platformy .NET" h2="Opracuj potężną aplikację narzędziową do analizowania dokumentów PDF opartą na platformie .NET.Kod C# wymieniony dla obrazów dokumentów PDF i wyodrębniania tekstu." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument PDF za pośrednictwem aplikacji online" %}}

1. Zaimportuj plik PDF do analizy, przesyłając go.
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj plik PDF za pośrednictwem platformy .NET" %}}

1. Dodaj odwołanie do biblioteki do projektu .NET
1. Załaduj plik PDF przy użyciu klasy Dokument
1. Użyj obiektu klasy TextAbsorber
1. Zaakceptuj pochłaniacz dla wszystkich stron
1. Pobierz wyodrębniony tekst i napisz
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja tekstu dokumentu PDF" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "parse-pdf-documents-by-extracting-text.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja obrazów dokumentów PDF" offSpacer="" %}}
...
<h2>Twórz aplikację analizatora plików PDF za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do analizowania składni PDF?Dzięki [Aspose.PDF for .NET](https://products.aspose.com/pdf/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista Pythona może zintegrować powyższy kod API ze swoją aplikacją do analizowania dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do analizowania dokumentów w celu wyodrębnienia obrazów i tekstu.Ponadto może obsługiwać wiele popularnych formatów, w tym format PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku PDF dla aplikacji parsera" %}}
...
- Zainstaluj bibliotekę przy użyciu [Konsola menedżera pakietów](https://docs.aspose.com/pdf/net/installation/#install-package-using-the-package-manager-console) w środowisku Visual Studio IDE
...
<br /><br />
Więcej szczegółów znajdziesz w [Dokumentacja produktu](https://docs.aspose.com/pdf/net/system-requirements/).
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy korzystanie z aplikacji online do analizowania dokumentu PDF jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
