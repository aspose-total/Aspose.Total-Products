---
title: Wyodrębnij tekst i obrazy z pliku DOTX online i przy użyciu platformy .NET
description: Aplikacja do analizowania plików online DOTX. Kod .NET API C# do wyodrębniania obrazów i treści tekstowych z dokumentu DOTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik DOTX online, a także za pośrednictwem platformy .NET" h2="Opracuj potężną aplikację narzędziową do analizowania dokumentów DOTX opartą na platformie .NET. Kod C# wymieniony dla wyodrębniania tekstu dokumentu DOTX." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj plik DOTX za pośrednictwem platformy .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja obrazów dokumentów DOTX" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja tekstu dokumentu DOTX" offSpacer="" %}}
...
<h2>Opracuj aplikację analizatora plików DOTX za pośrednictwem platformy .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku DOTX dla aplikacji parsera" %}}
