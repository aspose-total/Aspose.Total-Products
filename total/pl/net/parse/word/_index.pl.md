---
title: Wyodrębnij tekst i obrazy z pliku Word online i przy użyciu platformy .NET
description: Aplikacja do analizowania plików online Word. Kod .NET API C# do wyodrębniania obrazów i treści tekstowych z dokumentu Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik Word online, a także za pośrednictwem platformy .NET" h2="Opracuj potężną aplikację narzędziową do analizowania dokumentów Word opartą na platformie .NET. Kod C# wymieniony dla wyodrębniania tekstu dokumentu Word." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument Word za pośrednictwem aplikacji online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj plik Word za pośrednictwem platformy .NET" %}}

1. Dodaj odwołanie do biblioteki do projektu .NET
1. Załaduj plik Word przy użyciu obiektu klasy Document
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja obrazów dokumentów Word" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja tekstu dokumentu Word" offSpacer="" %}}
...
<h2>Opracuj aplikację analizatora plików Word za pośrednictwem platformy .NET</h2>

Potrzebujesz opracować aplikację lub oprogramowanie analizatora składni Word?Dzięki [Aspose.Words for .NET](https://products.aspose.com/words/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do analizowania dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do analizowania dokumentów w celu wyodrębnienia obrazów i tekstu.Ponadto może obsługiwać wiele popularnych formatów, w tym format Word.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku Word dla aplikacji parsera" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy korzystanie z aplikacji online do analizowania dokumentu Word jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
