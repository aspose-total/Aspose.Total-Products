---
title: Wyodrębnij tekst i obrazy z pliku ODT online i przy użyciu platformy .NET
description: Aplikacja do analizowania plików online ODT. Kod .NET API C# do wyodrębniania obrazów i treści tekstowych z dokumentu ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik ODT online, a także za pośrednictwem platformy .NET" h2="Opracuj potężną aplikację narzędziową do analizowania dokumentów ODT opartą na platformie .NET. Kod C# wymieniony dla wyodrębniania tekstu dokumentu ODT." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument ODT za pośrednictwem aplikacji online" %}}

1. Zaimportuj plik ODT do analizy, przesyłając go.
...
{{% blocks/products/pf/agp/feature-section-col title="Analizuj plik ODT za pośrednictwem platformy .NET" %}}

1. Dodaj odwołanie do biblioteki do projektu .NET
1. Załaduj plik ODT przy użyciu obiektu klasy Document
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja obrazów dokumentów ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod C#: Ekstrakcja tekstu dokumentu ODT" offSpacer="" %}}
...
<h2>Opracuj aplikację analizatora plików ODT za pośrednictwem platformy .NET</h2>

Potrzebujesz opracować aplikację lub oprogramowanie analizatora składni ODT?Dzięki [Aspose.Words for .NET](https://products.aspose.com/words/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do analizowania dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do analizowania dokumentów w celu wyodrębnienia obrazów i tekstu.Ponadto może obsługiwać wiele popularnych formatów, w tym format ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do przetwarzania pliku ODT dla aplikacji parsera" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## Przypadki użycia analizowania plików .odt

- 📄 Wyodrębnij tekst, obrazy i metadane z plików OpenDocument Text.
- 🧾 Konwertuj pliki `.odt` na HTML, Markdown lub PDF do publikacji.
- 📚 Zarchiwizuj formaty dokumentów typu open-source, konwertując i indeksując zawartość.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy korzystanie z aplikacji online do analizowania dokumentu ODT jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
