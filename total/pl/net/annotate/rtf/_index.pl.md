---
title: Usuń adnotację RTF online lub zarządzaj adnotacjami za pośrednictwem platformy .NET
description: usuwaj komentarze z pliku RTF za pośrednictwem aplikacji online za darmo.Kod API .NET do zarządzania komentarzami plików RTF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Usuń komentarze z dokumentu RTF online lub zarządzaj przez .NET" h2="Opracuj potężną aplikację do tworzenia adnotacji w dokumentach RTF opartą na platformie .NET.Wymieniony kod do zarządzania komentarzami do pliku RTF za pośrednictwem platformy .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Usuń adnotacje RTF online" %}}

1. Zaimportuj plik RTF, aby usunąć komentarze, przesyłając go
...
{{% blocks/products/pf/agp/feature-section-col title="Usuń komentarze do dokumentu RTF określonego autora za pośrednictwem platformy .NET" %}}

1. Dodaj odwołanie do biblioteki do projektu .NET
1. Załaduj dokument poprzez obiekt klasy Dokument
1. Pobierz komentarze do wszystkich węzłów, używając GetChildNodes z NodeType.Comment
1. Przejrzyj wszystkie komentarze i dopasuj nazwisko autora
1. Wywołaj metodę Remove, aby usunąć komentarz konkretnego autora
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Usuń konkretne komentarze autora z pliku RTF" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Dodawaj komentarze za pośrednictwem platformy .NET" %}}

1. Utwórz obiekt klasy Dokument
1. Skorzystaj z klasy Komentarz
1. Dodaj nowy akapit za pomocą opcji Akapity.Dodaj
1. Użyj opcji FirstParagraph.Runs. Dodaj komentarz
...
1. Załaduj dokument poprzez obiekt klasy Dokument
1. Utwórz obiekt ArrayList
1. Zdobądź wszystkie GetChildNodes w NodeCollection
1. Iteruj po każdej kolekcji i dodaj komentarze w ArrayList
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: Dodaj komentarz z pliku RTF" offSpacer="" %}}
...
<h2>Opracuj aplikację do adnotacji w dokumentach RTF za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do adnotacji RTF, aby przekazywać opinie, zgłaszać sugestie lub współpracować z innymi osobami nad dokumentem?Dzięki [Aspose.Words for .NET](https://products.aspose.com/words/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do adnotacji w dokumentach.Potężna biblioteka .NET umożliwia programowanie dowolnego rozwiązania do adnotacji w dokumentach.Ponadto może obsługiwać wiele popularnych formatów, w tym format RTF.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Biblioteka .NET do opisywania plików RTF" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy używanie aplikacji online do dodawania adnotacji do dokumentu RTF jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
