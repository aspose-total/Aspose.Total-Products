---
title: Przeglądaj i aktualizuj właściwości XLSM online lub aktualizuj metadane za pomocą .NET
description: Przeglądaj i modyfikuj właściwości XLSM za pośrednictwem aplikacji online za darmo. Kod API C# .NET do aktualizacji i dodawania właściwości XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Przeglądaj lub aktualizuj metadane XLSM online lub aktualizuj za pośrednictwem .NET" h2="Opracuj potężną aplikację narzędziową do zarządzania metadanymi dokumentów XLSM w oparciu o platformę .NET.Wymieniony kod umożliwiający dodawanie i modyfikowanie metadanych pliku XLSM za pośrednictwem platformy .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Zarządzaj właściwościami XLSM poprzez .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: zaktualizuj metadane XLSM" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod .NET: Dodaj właściwości niestandardowe XLSM" offSpacer="" %}}
...
<h2>Opracuj aplikację do zarządzania metadanymi XLSM za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania metadanymi XLSM?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją metadanych dokumentów.Potężna biblioteka .NET umożliwia programowanie dowolnego rozwiązania dotyczącego metadanych dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do zarządzania metadanymi XLSM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 🧠 Przypadki użycia skoroszytu z włączoną obsługą makr (`.xlsm`)

- Identyfikacja skoroszytów z aktywnymi skryptami za pomocą osadzonych metadanych.
- Pomoc zespołom ds. zgodności w klasyfikowaniu i audytowaniu użycia makr.
- Wsparcie dla alertów wywoływanych metadanymi dla wrażliwych modeli finansowych.
