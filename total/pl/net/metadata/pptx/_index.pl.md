---
title: Przeglądaj i aktualizuj właściwości PPTX online lub aktualizuj metadane za pomocą .NET
description: Przeglądaj i modyfikuj właściwości PPTX za pośrednictwem aplikacji online za darmo. Kod API C# .NET do aktualizacji właściwości PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Przeglądaj lub aktualizuj metadane PPTX online lub aktualizuj za pośrednictwem .NET" h2="Opracuj potężną aplikację narzędziową do zarządzania metadanymi dokumentów PPTX w oparciu o platformę .NET.Wymieniony kod umożliwiający aktualizację metadanych PPTX za pośrednictwem platformy .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Zaktualizuj właściwości PPTX za pośrednictwem platformy .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: zaktualizuj metadane PPTX" offSpacer="" %}}
...
<h2>Opracuj aplikację do zarządzania metadanymi PPTX za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania metadanymi PPTX?Dzięki [Aspose.Slides for .NET](https://products.aspose.com/slides/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją metadanych dokumentów.Potężna biblioteka .NET umożliwia programowanie dowolnego rozwiązania dotyczącego metadanych dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do zarządzania metadanymi PPTX" %}}
