---
title: Przeglądaj i aktualizuj właściwości XLS online lub aktualizuj metadane za pomocą .NET
description: Przeglądaj i modyfikuj właściwości XLS za pośrednictwem aplikacji online za darmo. Kod API C# .NET do aktualizacji i dodawania właściwości XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Przeglądaj lub aktualizuj metadane XLS online lub aktualizuj za pośrednictwem .NET" h2="Opracuj potężną aplikację narzędziową do zarządzania metadanymi dokumentów XLS w oparciu o platformę .NET.Wymieniony kod umożliwiający dodawanie i modyfikowanie metadanych pliku XLS za pośrednictwem platformy .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Przeglądaj lub aktualizuj metadane XLS online" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Zarządzaj właściwościami XLS poprzez .NET" %}}

1. Utwórz klasę skoroszytu.
1. Uzyskaj dostęp do właściwości zdefiniowanych przez system, korzystając z BuildingInDocumentProperties
1. Przypisz zaktualizowane wartości, takie jak Język
1. Wywołaj metodę Save(), aby zapisać zaktualizowany dokument XLS.
{{% /blocks/products/pf/agp/feature-section-col %}}
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: zaktualizuj metadane XLS" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod .NET: Dodaj właściwości niestandardowe XLS" offSpacer="" %}}
...
<h2>Opracuj aplikację do zarządzania metadanymi XLS za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania metadanymi XLS?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją metadanych dokumentów.Potężna biblioteka .NET umożliwia programowanie dowolnego rozwiązania dotyczącego metadanych dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format XLS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do zarządzania metadanymi XLS" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 📊 Przypadki użycia arkusza kalkulacyjnego Excel (`.xls`)

- Przechowywanie metadanych dotyczących celu dokumentu i właściciela.
- Poprawa wewnętrznego śledzenia i odzyskiwania plików.
- Automatyzacja procesów finansowych lub opartych na projektach za pomocą reguł metadanych.
