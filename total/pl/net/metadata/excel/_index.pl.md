---
title: Przeglądaj i aktualizuj właściwości Excel online lub aktualizuj metadane za pomocą .NET
description: Przeglądaj i modyfikuj właściwości Excel za pośrednictwem aplikacji online za darmo. Kod API C# .NET do aktualizacji i dodawania właściwości Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Przeglądaj lub aktualizuj metadane Excel online lub aktualizuj za pośrednictwem .NET" h2="Opracuj potężną aplikację narzędziową do zarządzania metadanymi dokumentów Excel w oparciu o platformę .NET.Wymieniony kod umożliwiający dodawanie i modyfikowanie metadanych pliku Excel za pośrednictwem platformy .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Zarządzaj właściwościami Excel poprzez .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Kod .NET: zaktualizuj metadane Excel" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Kod .NET: Dodaj właściwości niestandardowe Excel" offSpacer="" %}}
...
<h2>Opracuj aplikację do zarządzania metadanymi Excel za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania metadanymi Excel?Dzięki [Aspose.Cells for .NET](https://products.aspose.com/cells/pl/net/), podrzędnemu interfejsowi API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją metadanych dokumentów.Potężna biblioteka .NET umożliwia programowanie dowolnego rozwiązania dotyczącego metadanych dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie .NET do zarządzania metadanymi Excel" %}}
