---
title: Redaguj dokument PDF online lub przy użyciu platformy .NET
description: Otwieraj i redaguj dokument PDF online za pomocą bezpłatnej aplikacji. Kod .NET API C# do wyszukiwania i zamiany tekstu PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Redaguj dokument PDF online lub przez .NET" h2="Opracuj potężną aplikację narzędziową do redagowania dokumentów PDF opartą na platformie .NET.Kod C# wymieniony do wyszukiwania i zamiany tekstu w pliku PDF za pośrednictwem platformy .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Redaguj plik PDF poprzez .NET" %}}
...
1. Pobierz wszystkie TextFragments w TextFragmentCollection
1. Iteruj po każdym zbiorze fragmentów
1. Zdefiniuj RedactionAnnotation i wywołaj metodę Redact().
...
{{% blocks/products/pf/agp/code-block title="Kod C#: Zredaguj plik PDF" offSpacer="" %}}
...
<h2>Opracuj aplikację redakcyjną PDF za pośrednictwem platformy .NET</h2>

Chcesz opracować aplikację lub narzędzie do redagowania PDF?Dzięki [Aspose.PDF for .NET](https://products.aspose.com/pdf/pl/net/), podrzędnemu API [Aspose.Total for .NET](https://products.aspose.com/total/pl/net/), każdy programista .NET może zintegrować powyższy kod API ze swoją aplikacją do redagowania dokumentów.Potężna biblioteka .NET umożliwia zaprogramowanie dowolnego rozwiązania do redakcji dokumentów. Ponadto może obsługiwać wiele popularnych formatów, w tym format PDF.<br /><br />
...
{{% blocks/products/pf/feature-page-summary %}}
## 📄 Cenzura w formacie .pdf (Portable Document Format)

- Cenzuruj wrażliwy tekst w dokumentach prawnych, medycznych i finansowych.
- Cenzuruj poufne dane przed publikacją lub komunikatami prasowymi.
- Cenzuruj ograniczone treści w publikacjach związanych z FOIA lub zgodnością.
