---
title: Wyodrębnij tekst i obrazy z pliku DOCX online i używając języka Python
description: Aplikacja do analizowania plików online DOCX. Kod API Pythona do wyodrębniania obrazów i tekstu z dokumentu DOCX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik DOCX online, a także wyodrębnij tekst lub obrazy za pomocą Pythona" h2="Twórz potężną aplikację narzędziową do analizowania dokumentów DOCX opartą na języku Python.Kod wymieniony dla obrazów dokumentów DOCX i ekstrakcji tekstu za pomocą języka Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij tekst z pliku DOCX za pomocą Pythona" %}}
...
1. Utwórz oddzielny dokument DOCX dla wyodrębnionego tekstu
...
{{% blocks/products/pf/agp/code-block title="Przykład kodu w Pythonie do wyodrębniania tekstu dokumentu DOCX" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij obrazy z pliku DOCX za pomocą Pythona" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykład kodu w Pythonie do wyodrębniania obrazów dokumentów DOCX" offSpacer="" %}}
