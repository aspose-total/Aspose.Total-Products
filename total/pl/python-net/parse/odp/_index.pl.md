---
title: Wyodrębnij tekst i obrazy z pliku ODP online i używając języka Python
description: Aplikacja do analizowania plików online ODP. Kod API Pythona do wyodrębniania obrazów i tekstu z dokumentu ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Analizuj plik ODP online, a także wyodrębnij tekst lub obrazy za pomocą Pythona" h2="Twórz potężną aplikację narzędziową do analizowania dokumentów ODP opartą na języku Python.Kod wymieniony dla obrazów ODP i ekstrakcji tekstu za pomocą języka Python." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Analizuj dokument ODP za pośrednictwem aplikacji online" %}}

1. Zaimportuj plik ODP do analizy, przesyłając go.
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij tekst z pliku ODP za pomocą Pythona" %}}

1. Referencyjne interfejsy API w projekcie bezpośrednio z PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. W przypadku wszystkich typów tekstu w prezentacji użyj formatu PresentationFactory().get_presentation_text(string, TextExtractionArrangingMode)
1. Załaduj prezentację do obiektu klasy Prezentacja
1. Przeglądaj w pętli wszystkie slajdy w prezentacji
1. Wyodrębnij tekst z każdego slajdu, używając tablicy slides_text
...
{{% blocks/products/pf/agp/code-block title="Przykład kodu w Pythonie do wyodrębnienia tekstu ODP" offSpacer="" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Wyodrębnij obrazy z ODP za pomocą Pythona" %}}

1. Referencyjne interfejsy API w projekcie bezpośrednio z PyPI ([Aspose.Slides](https://pypi.org/project/Aspose.Slides/))
1. Dostęp do prezentacji za pomocą Prezentacji
1. Iteruj po każdym slajdzie
1. Zdobądź zdjęcie z tyłu
1. Ustaw żądany format, jeśli dostępne jest zdjęcie z tyłu
1. Przejrzyj wszystkie kształty slajdów i zapisz
...
{{% blocks/products/pf/agp/code-block title="Przykład kodu w Pythonie do wyodrębniania obrazów ODP" offSpacer="" %}}
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Czy korzystanie z aplikacji online do analizowania dokumentu ODP jest bezpieczne?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
