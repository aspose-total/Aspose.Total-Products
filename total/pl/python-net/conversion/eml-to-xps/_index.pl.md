---
title: Konwertuj EML na XPS w Pythonie
description: Zapisz EML w formacie XPS w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/eml-to-xps/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- Do konwersji EML na XPS wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EML do XPS w Pythonie" offSpacer="" %}}
