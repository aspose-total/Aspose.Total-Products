---
title: Konwertuj EML na DOT w Pythonie
description: Zapisz EML w formacie DOT w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/eml-to-dot/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- Do konwersji EML na DOT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EML do DOT w Pythonie" offSpacer="" %}}
