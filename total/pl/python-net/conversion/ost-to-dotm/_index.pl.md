---
title: Konwertuj OST na DOTM w Pythonie
description: Zapisz OST w formacie DOTM w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na DOTM wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do DOTM w Pythonie" offSpacer="" %}}
