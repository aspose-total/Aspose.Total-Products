---
title: Konwertuj MBOX na IMAGE w Pythonie
description: Zapisz MBOX w formacie IMAGE w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-image/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na IMAGE wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do IMAGE w Pythonie" offSpacer="" %}}
