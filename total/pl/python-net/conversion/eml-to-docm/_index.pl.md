---
title: Konwertuj EML na DOCM w Pythonie
description: Zapisz EML w formacie DOCM w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/eml-to-docm/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- Do konwersji EML na DOCM wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EML do DOCM w Pythonie" offSpacer="" %}}
