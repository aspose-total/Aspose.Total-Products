...
- Do konwersji OST na TEXT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do TEXT w Pythonie" offSpacer="" %}}
