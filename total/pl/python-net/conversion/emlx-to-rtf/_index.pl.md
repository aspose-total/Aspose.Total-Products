---
title: Konwertuj EMLX na RTF w Pythonie
description: Zapisz EMLX w formacie RTF w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/emlx-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Do konwersji EMLX na RTF wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EMLX do RTF w Pythonie" offSpacer="" %}}
