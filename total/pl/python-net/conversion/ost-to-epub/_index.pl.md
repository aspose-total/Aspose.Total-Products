---
title: Konwertuj OST na EPUB w Pythonie
description: Zapisz OST w formacie EPUB w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-epub/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na EPUB wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do EPUB w Pythonie" offSpacer="" %}}
