---
title: Konwertuj OST na OTT w Pythonie
description: Zapisz OST w formacie OTT w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-ott/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na OTT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do OTT w Pythonie" offSpacer="" %}}
