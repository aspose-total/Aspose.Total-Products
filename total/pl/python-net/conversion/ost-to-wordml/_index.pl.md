---
title: Konwertuj OST na WORDML w Pythonie
description: Zapisz OST w formacie WORDML w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na WORDML wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do WORDML w Pythonie" offSpacer="" %}}
