---
title: Konwertuj OST na MD w Pythonie
description: Zapisz OST w formacie MD w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-md/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na MD wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do MD w Pythonie" offSpacer="" %}}
