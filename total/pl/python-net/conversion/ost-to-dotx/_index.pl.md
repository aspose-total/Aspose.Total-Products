---
title: Konwertuj OST na DOTX w Pythonie
description: Zapisz OST w formacie DOTX w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-dotx/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na DOTX wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do DOTX w Pythonie" offSpacer="" %}}
