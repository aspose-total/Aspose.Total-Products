---
title: Konwertuj OST na RTF w Pythonie
description: Zapisz OST w formacie RTF w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na RTF wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do RTF w Pythonie" offSpacer="" %}}
