---
title: Konwertuj MBOX na RTF w Pythonie
description: Zapisz MBOX w formacie RTF w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-rtf/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na RTF wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do RTF w Pythonie" offSpacer="" %}}
