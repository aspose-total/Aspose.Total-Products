---
title: Konwertuj OST na EMF w Pythonie
description: Zapisz OST w formacie EMF w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-emf/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na EMF wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do EMF w Pythonie" offSpacer="" %}}
