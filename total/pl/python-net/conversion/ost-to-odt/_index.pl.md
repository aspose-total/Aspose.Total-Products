---
title: Konwertuj OST na ODT w Pythonie
description: Zapisz OST w formacie ODT w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-odt/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na ODT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do ODT w Pythonie" offSpacer="" %}}
