---
title: Konwertuj MBOX na XPS w Pythonie
description: Zapisz MBOX w formacie XPS w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-xps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na XPS wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do XPS w Pythonie" offSpacer="" %}}
