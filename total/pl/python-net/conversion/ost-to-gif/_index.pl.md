---
title: Konwertuj OST na GIF w Pythonie
description: Zapisz OST w formacie GIF w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-gif/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na GIF wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do GIF w Pythonie" offSpacer="" %}}
