---
title: Konwertuj MBOX na WORDML w Pythonie
description: Zapisz MBOX w formacie WORDML w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na WORDML wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do WORDML w Pythonie" offSpacer="" %}}
