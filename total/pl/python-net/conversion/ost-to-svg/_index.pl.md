---
title: Konwertuj OST na SVG w Pythonie
description: Zapisz OST w formacie SVG w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-svg/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na SVG wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do SVG w Pythonie" offSpacer="" %}}
