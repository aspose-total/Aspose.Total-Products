---
title: Konwertuj MBOX na TEXT w Pythonie
description: Zapisz MBOX w formacie TEXT w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-text/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na TEXT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do TEXT w Pythonie" offSpacer="" %}}
