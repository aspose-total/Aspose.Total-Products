...
url: /pl/python-net/conversion/dot-to-ppt/
family: total
platformtag: Python
feature: conversion
informat: DOT
...
Dla programisty Pythona, kto próbuje dodać funkcję konwersji DOT do PPT w aplikacji? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API może pomóc zautomatyzować proces konwersji. Jest to pełny pakiet różnych interfejsów API obsługujących różne formaty. Więc **Jak przekonwertować DOT na PPT w Pythonie?**
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj DOT na PPT w Pythonie" %}}
...
-  Wywołaj metodę `save`, określając ścieżkę pliku wyjściowego i SaveFormat.PPT jako parametry. Więc twój plik DOT jest konwertowany na PPT w określonej ścieżce.
