---
title: Konwertuj EMLX na DOCM w Pythonie
description: Zapisz EMLX w formacie DOCM w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/emlx-to-docm/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Do konwersji EMLX na DOCM wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EMLX do DOCM w Pythonie" offSpacer="" %}}
