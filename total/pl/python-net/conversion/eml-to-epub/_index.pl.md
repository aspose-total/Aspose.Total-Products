---
title: Konwertuj EML na EPUB w Pythonie
description: Zapisz EML w formacie EPUB w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/eml-to-epub/
family: total
platformtag: Python
feature: conversion
informat: EML
...
- Do konwersji EML na EPUB wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EML do EPUB w Pythonie" offSpacer="" %}}
