---
title: Konwertuj OST na DOCM w Pythonie
description: Zapisz OST w formacie DOCM w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-docm/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na DOCM wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do DOCM w Pythonie" offSpacer="" %}}
