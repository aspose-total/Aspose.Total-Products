...
url: /pl/python-net/conversion/docx-to-ppsx/
family: total
platformtag: Python
feature: conversion
informat: DOCX
...
Dla programisty Pythona, kto próbuje dodać funkcję konwersji DOCX do PPSX w aplikacji? [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/) API może pomóc zautomatyzować proces konwersji. Jest to pełny pakiet różnych interfejsów API obsługujących różne formaty. Więc **Jak przekonwertować DOCX na PPSX w Pythonie?**
...
{{% blocks/products/pf/agp/feature-section-col title="Konwertuj DOCX na PPSX w Pythonie" %}}
...
-  Wywołaj metodę `save`, określając ścieżkę pliku wyjściowego i SaveFormat.PPSX jako parametry. Więc twój plik DOCX jest konwertowany na PPSX w określonej ścieżce.
