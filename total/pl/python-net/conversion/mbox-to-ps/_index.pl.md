---
title: Konwertuj MBOX na PS w Pythonie
description: Zapisz MBOX w formacie PS w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-ps/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na PS wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do PS w Pythonie" offSpacer="" %}}
