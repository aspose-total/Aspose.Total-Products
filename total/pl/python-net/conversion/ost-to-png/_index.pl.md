---
title: Konwertuj OST na PNG w Pythonie
description: Zapisz OST w formacie PNG w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-png/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na PNG wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do PNG w Pythonie" offSpacer="" %}}
