---
title: Konwertuj MBOX na DOTM w Pythonie
description: Zapisz MBOX w formacie DOTM w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/mbox-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Do konwersji MBOX na DOTM wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MBOX do DOTM w Pythonie" offSpacer="" %}}
