---
title: Konwertuj EMLX na DOT w Pythonie
description: Zapisz EMLX w formacie DOT w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/emlx-to-dot/
family: total
platformtag: Python
feature: conversion
informat: EMLX
...
- Do konwersji EMLX na DOT wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz EMLX do DOT w Pythonie" offSpacer="" %}}
