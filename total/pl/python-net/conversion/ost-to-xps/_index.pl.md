---
title: Konwertuj OST na XPS w Pythonie
description: Zapisz OST w formacie XPS w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-xps/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na XPS wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do XPS w Pythonie" offSpacer="" %}}
