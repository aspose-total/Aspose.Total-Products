---
title: Konwertuj OST na IMAGE w Pythonie
description: Zapisz OST w formacie IMAGE w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-image/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na IMAGE wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do IMAGE w Pythonie" offSpacer="" %}}
