...
- Do konwersji MSG na BMP wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MSG do BMP w Pythonie" offSpacer="" %}}
