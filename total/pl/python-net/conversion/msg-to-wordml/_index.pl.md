---
title: Konwertuj MSG na WORDML w Pythonie
description: Zapisz MSG w formacie WORDML w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/msg-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: MSG
...
- Do konwersji MSG na WORDML wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz MSG do WORDML w Pythonie" offSpacer="" %}}
