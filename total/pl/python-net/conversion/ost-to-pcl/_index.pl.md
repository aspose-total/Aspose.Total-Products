---
title: Konwertuj OST na PCL w Pythonie
description: Zapisz OST w formacie PCL w aplikacjach Pythona bez korzystania z Microsoft Outlook lub Word 
url: /pl/python-net/conversion/ost-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: OST
...
- Do konwersji OST na PCL wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do PCL w Pythonie" offSpacer="" %}}
