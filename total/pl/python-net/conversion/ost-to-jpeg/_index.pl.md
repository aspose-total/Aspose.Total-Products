...
- Do konwersji OST na JPEG wymagany jest Python 3.5 lub nowszy
...
{{% blocks/products/pf/agp/code-block title="Zapisz OST do JPEG w Pythonie" offSpacer="" %}}
