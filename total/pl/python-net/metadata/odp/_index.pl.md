---
title: Przeglądaj i aktualizuj właściwości ODP online lub używając Pythona
description: Przeglądaj i modyfikuj właściwości ODP za pośrednictwem aplikacji online za darmo.Kod API Pythona do przeglądania i edytowania właściwości ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Przeglądaj lub aktualizuj metadane ODP online lub za pośrednictwem Pythona" h2="Opracuj potężną aplikację narzędziową do zarządzania metadanymi dokumentów ODP w języku Python.Wymieniony kod umożliwiający modyfikowanie i przeglądanie metadanych pliku ODP za pomocą języka Python." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Przeglądaj lub modyfikuj właściwości ODP za pomocą Pythona" %}}
...
{{% blocks/products/pf/agp/code-block title="Przykład kodu w Pythonie umożliwiający przeglądanie i aktualizację metadanych ODP" offSpacer="" %}}
...
<h2>Opracuj aplikację do zarządzania metadanymi ODP w języku Python</h2>

Chcesz opracować aplikację lub narzędzie do zarządzania metadanymi ODP?Dzięki [Aspose.Slides for Python via .NET](https://products.aspose.com/slides/python-net/), podrzędnemu API [Aspose.Total for Python via .NET](https://products.aspose.com/total/python-net/), każdy programista Pythona może zintegrować powyższy kod API ze swoją aplikacją metadanych dokumentów.Potężna biblioteka Pythona umożliwia programowanie dowolnego rozwiązania dotyczącego metadanych dokumentów.Ponadto może obsługiwać wiele popularnych formatów, w tym format ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Narzędzie Pythona do zarządzania metadanymi ODP" %}}
