---
title: Преобразование EMAIL в TIFF в Python
description: Сохраняйте EMAIL в TIFF в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-tiff/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в TIFF требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в TIFF в Python" offSpacer="" %}}
