---
title: Преобразование EMAIL в ODT в Python
description: Сохраняйте EMAIL в ODT в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-odt/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в ODT требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в ODT в Python" offSpacer="" %}}
