...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование WORDML в PPSM в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPSM в качестве параметров. Таким образом, ваш файл WORDML преобразуется в PPSM по указанному пути.
