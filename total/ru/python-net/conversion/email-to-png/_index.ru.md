---
title: Преобразование EMAIL в PNG в Python
description: Сохраняйте EMAIL в PNG в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-png/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в PNG требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в PNG в Python" offSpacer="" %}}
