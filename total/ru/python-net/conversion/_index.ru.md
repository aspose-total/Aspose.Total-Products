...
{{% blocks/products/pf/feature-page-section  h2="Преобразование электронной почты в Word, PDF, HTML и изображений" %}}
Для преобразования файлов электронной почты в PDF, Word, изображения и HTML, Email Python API [Aspose.Email for Python via .NET](https://products.aspose.com/email/python-net/) выполняет преобразование. API загружает исходный файл в свою объектную модель и вызывает метод Save с соответствующими параметрами. 

{{% blocks/products/pf/feature-page-code h3="Python — преобразование файлов электронной почты в Word" %}}
