---
title: Преобразование PST в MD в Python
description: Сохраняйте PST в MD в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-md/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в MD требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в MD в Python" offSpacer="" %}}
