...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование DOCM в POWERPOINT в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.POWERPOINT в качестве параметров. Таким образом, ваш файл DOCM преобразуется в POWERPOINT по указанному пути.
