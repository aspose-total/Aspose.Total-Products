---
title: Преобразование EMAIL в EMF в Python
description: Сохраняйте EMAIL в EMF в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-emf/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в EMF требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в EMF в Python" offSpacer="" %}}
