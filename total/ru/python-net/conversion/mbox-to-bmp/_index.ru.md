---
title: Преобразование MBOX в BMP в Python
description: Сохраняйте MBOX в BMP в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/mbox-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Для преобразования MBOX в BMP требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить MBOX в BMP в Python" offSpacer="" %}}
