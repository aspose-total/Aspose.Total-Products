---
title: Преобразование MBOX в DOC в Python
description: Сохраняйте MBOX в DOC в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/mbox-to-doc/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Для преобразования MBOX в DOC требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить MBOX в DOC в Python" offSpacer="" %}}
