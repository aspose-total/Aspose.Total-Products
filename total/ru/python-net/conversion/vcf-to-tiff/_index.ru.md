...
- Для преобразования VCF в TIFF требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в TIFF в Python" offSpacer="" %}}
