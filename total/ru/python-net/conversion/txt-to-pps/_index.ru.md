...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование TXT в PPS в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPS в качестве параметров. Таким образом, ваш файл TXT преобразуется в PPS по указанному пути.
