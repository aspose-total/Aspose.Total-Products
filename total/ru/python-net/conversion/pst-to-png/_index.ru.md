---
title: Преобразование PST в PNG в Python
description: Сохраняйте PST в PNG в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-png/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в PNG требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в PNG в Python" offSpacer="" %}}
