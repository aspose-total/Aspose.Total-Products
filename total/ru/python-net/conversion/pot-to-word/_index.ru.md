...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование POT в WORD в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PDF в качестве параметров. Таким образом, ваш файл POT преобразуется в PDF по указанному пути.
