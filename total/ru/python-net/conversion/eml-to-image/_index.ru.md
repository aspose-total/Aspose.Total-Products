...
- Для преобразования EML в IMAGE требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EML в IMAGE в Python" offSpacer="" %}}
