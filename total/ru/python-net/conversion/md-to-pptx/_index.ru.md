...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование MD в PPTX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPTX в качестве параметров. Таким образом, ваш файл MD преобразуется в PPTX по указанному пути.
