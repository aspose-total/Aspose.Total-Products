---
title: Преобразование EMAIL в FLATOPC в Python
description: Сохраняйте EMAIL в FLATOPC в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в FLATOPC требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в FLATOPC в Python" offSpacer="" %}}
