...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование PPSM в DOCX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PDF в качестве параметров. Таким образом, ваш файл PPSM преобразуется в PDF по указанному пути.
