...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование POTX в DOC в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PDF в качестве параметров. Таким образом, ваш файл POTX преобразуется в PDF по указанному пути.
