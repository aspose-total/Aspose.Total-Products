...
- Для преобразования EMLX в OTT требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMLX в OTT в Python" offSpacer="" %}}
