...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование MD в POTX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.POTX в качестве параметров. Таким образом, ваш файл MD преобразуется в POTX по указанному пути.
