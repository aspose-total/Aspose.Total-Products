...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование DOCM в POTX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.POTX в качестве параметров. Таким образом, ваш файл DOCM преобразуется в POTX по указанному пути.
