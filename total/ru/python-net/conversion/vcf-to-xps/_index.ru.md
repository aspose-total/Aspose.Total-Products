---
title: Преобразование VCF в XPS в Python
description: Сохраняйте VCF в XPS в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/vcf-to-xps/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Для преобразования VCF в XPS требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в XPS в Python" offSpacer="" %}}
