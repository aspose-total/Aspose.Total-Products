...
- Для преобразования VCF в WORD требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в WORD в Python" offSpacer="" %}}
