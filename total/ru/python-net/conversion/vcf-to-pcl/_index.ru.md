---
title: Преобразование VCF в PCL в Python
description: Сохраняйте VCF в PCL в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/vcf-to-pcl/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Для преобразования VCF в PCL требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в PCL в Python" offSpacer="" %}}
