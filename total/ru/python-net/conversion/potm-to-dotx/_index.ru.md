...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование POTM в DOTX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PDF в качестве параметров. Таким образом, ваш файл POTM преобразуется в PDF по указанному пути.
