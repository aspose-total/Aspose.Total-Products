...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование WORDML в PPT в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPT в качестве параметров. Таким образом, ваш файл WORDML преобразуется в PPT по указанному пути.
