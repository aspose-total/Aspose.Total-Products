---
title: Преобразование PST в ODT в Python
description: Сохраняйте PST в ODT в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-odt/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в ODT требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в ODT в Python" offSpacer="" %}}
