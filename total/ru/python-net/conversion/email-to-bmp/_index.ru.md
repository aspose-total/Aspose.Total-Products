---
title: Преобразование EMAIL в BMP в Python
description: Сохраняйте EMAIL в BMP в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-bmp/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в BMP требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в BMP в Python" offSpacer="" %}}
