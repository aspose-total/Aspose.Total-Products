---
title: Преобразование EMAIL в SVG в Python
description: Сохраняйте EMAIL в SVG в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/email-to-svg/
family: total
platformtag: Python
feature: conversion
informat: EMAIL
...
- Для преобразования EMAIL в SVG требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить EMAIL в SVG в Python" offSpacer="" %}}
