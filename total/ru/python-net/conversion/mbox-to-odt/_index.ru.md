---
title: Преобразование MBOX в ODT в Python
description: Сохраняйте MBOX в ODT в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/mbox-to-odt/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Для преобразования MBOX в ODT требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить MBOX в ODT в Python" offSpacer="" %}}
