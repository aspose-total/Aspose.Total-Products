...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование MD в POTM в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.POTM в качестве параметров. Таким образом, ваш файл MD преобразуется в POTM по указанному пути.
