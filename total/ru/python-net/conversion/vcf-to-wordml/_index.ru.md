---
title: Преобразование VCF в WORDML в Python
description: Сохраняйте VCF в WORDML в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/vcf-to-wordml/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Для преобразования VCF в WORDML требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в WORDML в Python" offSpacer="" %}}
