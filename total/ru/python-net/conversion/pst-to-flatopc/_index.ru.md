---
title: Преобразование PST в FLATOPC в Python
description: Сохраняйте PST в FLATOPC в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-flatopc/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в FLATOPC требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в FLATOPC в Python" offSpacer="" %}}
