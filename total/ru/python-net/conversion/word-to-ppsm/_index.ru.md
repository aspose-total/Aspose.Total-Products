...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование WORD в PPSM в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPSM в качестве параметров. Таким образом, ваш файл WORD преобразуется в PPSM по указанному пути.
