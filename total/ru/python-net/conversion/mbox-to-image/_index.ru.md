---
title: Преобразование MBOX в IMAGE в Python
description: Сохраняйте MBOX в IMAGE в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/mbox-to-image/
family: total
platformtag: Python
feature: conversion
informat: MBOX
...
- Для преобразования MBOX в IMAGE требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить MBOX в IMAGE в Python" offSpacer="" %}}
