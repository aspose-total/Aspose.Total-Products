---
title: Преобразование PST в PS в Python
description: Сохраняйте PST в PS в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-ps/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в PS требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в PS в Python" offSpacer="" %}}
