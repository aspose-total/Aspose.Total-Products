---
title: Преобразование PST в OTT в Python
description: Сохраняйте PST в OTT в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/pst-to-ott/
family: total
platformtag: Python
feature: conversion
informat: PST
...
- Для преобразования PST в OTT требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить PST в OTT в Python" offSpacer="" %}}
