---
title: Преобразование VCF в DOTM в Python
description: Сохраняйте VCF в DOTM в своих приложениях Python без использования Microsoft Outlook или Word. 
url: /ru/python-net/conversion/vcf-to-dotm/
family: total
platformtag: Python
feature: conversion
informat: VCF
...
- Для преобразования VCF в DOTM требуется Python 3.5 или более поздней версии.
...
{{% blocks/products/pf/agp/code-block title="Сохранить VCF в DOTM в Python" offSpacer="" %}}
