...
{{% blocks/products/pf/agp/feature-section-col title="Преобразование DOC в PPSX в Python" %}}
...
-  Вызовите метод `save`, указав путь к выходному файлу и SaveFormat.PPSX в качестве параметров. Таким образом, ваш файл DOC преобразуется в PPSX по указанному пути.
