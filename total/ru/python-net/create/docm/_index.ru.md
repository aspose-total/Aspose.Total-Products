...
Использование DOCM целесообразно, когда бизнес-логика (пользовательские поля, кнопки экспорта или макросы сбора данных) должна находиться внутри документа; автоматизация позволяет вставлять, тестировать и контролировать содержимое макросов для выполнения проверок безопасности и соответствия.



Автоматизированные тесты и процессы непрерывной интеграции могут гарантировать целостность кода макросов и подписывать макросы перед их распространением.
