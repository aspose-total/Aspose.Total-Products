---
title: Извлечение текста и изображений из файла DOC онлайн и с помощью C++
description: Онлайн-приложение для парсера файлов DOC. Код API C++ для извлечения изображений и текстового содержимого из документа DOC.
...
{{< blocks/products/pf/feature-page-header-widget h1="Разбор файла DOC онлайн, а также через C++" h2="Разработайте мощное приложение для анализа документов DOC на базе C++.Код C++ указан для извлечения текста документа DOC." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Разбор файла DOC через C++" %}}

1. Добавить ссылку на библиотеку в проект C++
1. Загрузить файл DOC
1. Получить все дочерние узлы с помощью GetChildNodes
1. Используйте NodeType::Shape в качестве параметра
1. Перебрать каждый узел и сохранить изображение.
1. Сохраните извлеченный файл, используя метод shape->get_ImageData()->Save.
...
{{% blocks/products/pf/agp/code-block title="Код C++: извлечение изображений документов DOC" offSpacer="" %}}
...
<h2>Разработка приложения для анализа файлов DOC с помощью C++</h2>

Вам необходимо разработать приложение или программное обеспечение для анализатора DOC?Благодаря [Aspose.Words for C++](https://products.aspose.com/words/cpp/), дочернему API [Aspose.Total for C++](https://products.aspose.com/total/ru/cpp/), любой разработчик C++ может интегрировать приведенный выше код API в свое приложение для анализа документов.Мощная библиотека C++ позволяет программировать любое решение для анализа документов для извлечения изображений, а также текста.Более того, он может поддерживать многие популярные форматы, включая формат DOC.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита C++ для обработки файла DOC для приложения синтаксического анализатора" %}}
...
<br /><br />
Если вы разрабатываете программное обеспечение для Linux или macOS, проверьте информацию о дополнительных зависимостях библиотеки (пакетах с открытым исходным кодомfontconfig и mesa-glu) в [Документация продукта](https://docs.aspose.com/words/cpp/system-requirements/).
