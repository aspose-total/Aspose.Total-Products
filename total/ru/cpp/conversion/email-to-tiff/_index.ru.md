---
title: Экспорт EMAIL в TIFF через C++
description: C++ API для преобразования EMAIL в TIFF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
4. Сохраните документ в формате TIFF с помощью метода [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) и установите Tiff в качестве SaveFormat.
