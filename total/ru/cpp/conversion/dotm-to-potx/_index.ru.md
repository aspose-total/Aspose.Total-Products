---
title: Преобразование DOTM в POTX через C++
description: Экспортируйте DOTM в POTX в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/dotm-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в POTX" h2="Экспортируйте DOTM в POTX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
