---
title: C++ API для преобразования PPS в DOC
description: Экспорт PPS в DOC в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в DOC" h2="Экспорт PPS в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
