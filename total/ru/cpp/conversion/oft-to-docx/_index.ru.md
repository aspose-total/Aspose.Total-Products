---
title: Экспорт OFT в DOCX через C++
description: C++ API для преобразования OFT в DOCX без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в DOCX" h2="Преобразование OFT в DOCX в приложении C++ без использования Microsoft Word или Outlook" >}}
