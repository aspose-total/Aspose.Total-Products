---
title: Преобразование DOTM в POTM через C++
description: Экспортируйте DOTM в POTM в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/dotm-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в POTM" h2="Экспортируйте DOTM в POTM в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
