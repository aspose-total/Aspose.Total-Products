...
description: C++ API для преобразования DOTM в DIF без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/dotm-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в DIF" h2="Экспорт DOTM в DIF через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
