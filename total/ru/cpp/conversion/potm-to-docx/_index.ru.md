---
title: C++ API для преобразования POTM в DOCX
description: Экспорт POTM в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/potm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в DOCX" h2="Экспорт POTM в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
