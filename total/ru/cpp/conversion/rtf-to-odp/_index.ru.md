---
title: Преобразование RTF в ODP через C++
description: Экспортируйте RTF в ODP в свои приложения C++ без использования Microsoft Word of PowerPoint.
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования RTF в ODP" h2="Экспортируйте RTF в ODP в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
