---
title: Экспорт MSG в PCL через C++
description: C++ API для преобразования MSG в PCL без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в PCL" h2="Преобразование MSG в PCL в приложении C++ без использования Microsoft Word или Outlook" >}}
