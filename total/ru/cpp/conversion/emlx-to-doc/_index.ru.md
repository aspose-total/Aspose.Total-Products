---
title: Экспорт EMLX в DOC через C++
description: C++ API для преобразования EMLX в DOC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/emlx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMLX в DOC" h2="Преобразование EMLX в DOC в приложении C++ без использования Microsoft Word или Outlook" >}}
