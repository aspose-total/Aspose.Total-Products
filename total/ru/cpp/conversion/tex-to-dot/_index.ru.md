...
4. Сохраните документ в формате DOT, используя функцию-член [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stream_saveformat).
