---
title: Экспорт MSG в EMF через C++
description: C++ API для преобразования MSG в EMF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в EMF" h2="Преобразование MSG в EMF в приложении C++ без использования Microsoft Word или Outlook" >}}
