---
title: C++ API для преобразования PPS в DOTX
description: Экспорт PPS в DOTX в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в DOTX" h2="Экспорт PPS в DOTX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
