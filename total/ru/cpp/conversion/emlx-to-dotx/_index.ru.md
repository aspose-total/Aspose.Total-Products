---
title: Экспорт EMLX в DOTX через C++
description: C++ API для преобразования EMLX в DOTX без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/emlx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMLX в DOTX" h2="Преобразование EMLX в DOTX в приложении C++ без использования Microsoft Word или Outlook" >}}
