---
title: C++ API для преобразования PPSX в DOT
description: Экспорт PPSX в DOT в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в DOT" h2="Экспорт PPSX в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
