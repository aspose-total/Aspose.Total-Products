...
description: C++ API для преобразования DOTM в CSV без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/dotm-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в CSV" h2="Экспорт DOTM в CSV через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
