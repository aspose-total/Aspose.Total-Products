---
title: Экспорт EMAIL в DOTM через C++
description: C++ API для преобразования EMAIL в DOTM без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в DOTM" h2="Преобразование EMAIL в DOTM в приложении C++ без использования Microsoft Word или Outlook" >}}
