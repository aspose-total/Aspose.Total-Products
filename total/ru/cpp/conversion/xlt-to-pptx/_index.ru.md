...
url: /ru/cpp/conversion/xlt-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLT в PPTX через C++" h2="Экспорт Excel&reg; XLT в PPTX в полнофункциональных приложениях C++" >}}
