---
title: C++ API для преобразования PPTM в FLATOPC
description: Экспорт PPTM в FLATOPC в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в FLATOPC" h2="Экспорт PPTM в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
