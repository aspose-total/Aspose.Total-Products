---
title: C++ API для преобразования PPSX в RTF
description: Экспорт PPSX в RTF в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в RTF" h2="Экспорт PPSX в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
