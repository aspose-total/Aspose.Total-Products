---
title: Экспорт OFT в TIFF через C++
description: C++ API для преобразования OFT в TIFF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-tiff/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в TIFF" h2="Преобразование OFT в TIFF в приложении C++ без использования Microsoft Word или Outlook" >}}
