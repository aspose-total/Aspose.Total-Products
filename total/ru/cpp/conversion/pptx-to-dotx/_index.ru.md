---
title: C++ API для преобразования PPTX в DOTX
description: Экспорт PPTX в DOTX в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в DOTX" h2="Экспорт PPTX в DOTX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
