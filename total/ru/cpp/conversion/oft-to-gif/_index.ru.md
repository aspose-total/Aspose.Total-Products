---
title: Экспорт OFT в GIF через C++
description: C++ API для преобразования OFT в GIF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-gif/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в GIF" h2="Преобразование OFT в GIF в приложении C++ без использования Microsoft Word или Outlook" >}}
