---
title: Экспорт OFT в PS через C++
description: C++ API для преобразования OFT в PS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в PS" h2="Преобразование OFT в PS в приложении C++ без использования Microsoft Word или Outlook" >}}
