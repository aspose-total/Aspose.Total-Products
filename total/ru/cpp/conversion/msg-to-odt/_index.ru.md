---
title: Экспорт MSG в ODT через C++
description: C++ API для преобразования MSG в ODT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в ODT" h2="Преобразование MSG в ODT в приложении C++ без использования Microsoft Word или Outlook" >}}
