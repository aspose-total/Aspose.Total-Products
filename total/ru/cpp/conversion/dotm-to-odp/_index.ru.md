---
title: Преобразование DOTM в ODP через C++
description: Экспортируйте DOTM в ODP в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/dotm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в ODP" h2="Экспортируйте DOTM в ODP в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
