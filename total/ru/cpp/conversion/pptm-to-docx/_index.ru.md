---
title: C++ API для преобразования PPTM в DOCX
description: Экспорт PPTM в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/pptm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в DOCX" h2="Экспорт PPTM в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
