---
title: Экспорт EMLX в FLATOPC через C++
description: C++ API для преобразования EMLX в FLATOPC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/emlx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMLX в FLATOPC" h2="Преобразование EMLX в FLATOPC в приложении C++ без использования Microsoft Word или Outlook" >}}
