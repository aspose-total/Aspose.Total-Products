---
title: C++ API для преобразования POWERPOINT в RTF
description: Экспорт POWERPOINT в RTF в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в RTF" h2="Экспорт POWERPOINT в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
