---
title: Преобразование WORDML в XLSM на C++
description: C++ API для преобразования WORDML в XLSM без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/wordml-to-xlsm/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORDML в XLSM" h2="Экспорт WORDML в XLSM через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
