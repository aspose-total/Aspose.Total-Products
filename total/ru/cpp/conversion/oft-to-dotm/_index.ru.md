---
title: Экспорт OFT в DOTM через C++
description: C++ API для преобразования OFT в DOTM без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в DOTM" h2="Преобразование OFT в DOTM в приложении C++ без использования Microsoft Word или Outlook" >}}
