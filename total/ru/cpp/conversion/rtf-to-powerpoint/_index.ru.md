---
title: Преобразование RTF в POWERPOINT через C++
description: Экспортируйте RTF в POWERPOINT в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/rtf-to-powerpoint/
family: total
platformtag: cpp
feature: conversion
informat: RTF
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования RTF в POWERPOINT" h2="Экспортируйте RTF в POWERPOINT в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
