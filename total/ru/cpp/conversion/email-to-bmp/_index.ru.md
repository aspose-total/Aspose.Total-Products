---
title: Экспорт EMAIL в BMP через C++
description: C++ API для преобразования EMAIL в BMP без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-bmp/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в BMP" h2="Преобразование EMAIL в BMP в приложении C++ без использования Microsoft Word или Outlook" >}}
