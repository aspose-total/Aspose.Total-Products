---
title: C++ API для преобразования PPS в DOTM
description: Экспорт PPS в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в DOTM" h2="Экспорт PPS в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
