---
title: C++ API для преобразования PPT в DOC
description: Экспорт PPT в DOC в ваших приложениях C++
url: /ru/cpp/conversion/ppt-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в DOC" h2="Экспорт PPT в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
