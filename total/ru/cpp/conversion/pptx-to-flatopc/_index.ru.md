---
title: C++ API для преобразования PPTX в FLATOPC
description: Экспорт PPTX в FLATOPC в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в FLATOPC" h2="Экспорт PPTX в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
