---
title: C++ API для преобразования PPSX в DOTM
description: Экспорт PPSX в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в DOTM" h2="Экспорт PPSX в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
