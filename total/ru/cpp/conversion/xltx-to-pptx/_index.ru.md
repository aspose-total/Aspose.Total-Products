...
url: /ru/cpp/conversion/xltx-to-pptx/
family: total
platformtag: cpp
feature: conversion
informat: XLTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLTX в PPTX через C++" h2="Экспорт Excel&reg; XLTX в PPTX в полнофункциональных приложениях C++" >}}
