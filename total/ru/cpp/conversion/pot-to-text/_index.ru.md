---
title: C++ API для преобразования POT в TEXT
description: Экспорт POT в TEXT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в TEXT" h2="Экспорт POT в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
