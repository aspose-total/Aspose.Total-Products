---
title: Экспорт EMAIL в EPUB через C++
description: C++ API для преобразования EMAIL в EPUB без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в EPUB" h2="Преобразование EMAIL в EPUB в приложении C++ без использования Microsoft Word или Outlook" >}}
