---
title: Конвертировать POTX в XLS через C++
description: Экспорт POTX в XLS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/potx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать POTX в XLS через C++" h2="Преобразование файлов POTX в XLS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
