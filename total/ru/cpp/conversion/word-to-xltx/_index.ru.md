---
title: Преобразование WORD в XLTX на C++
description: C++ API для преобразования WORD в XLTX без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/word-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в XLTX" h2="Экспорт WORD в XLTX через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
