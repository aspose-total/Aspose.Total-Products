---
title: C++ API для преобразования POWERPOINT в OTT
description: Экспорт POWERPOINT в OTT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в OTT" h2="Экспорт POWERPOINT в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
