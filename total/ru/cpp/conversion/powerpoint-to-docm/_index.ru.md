---
title: C++ API для преобразования POWERPOINT в DOCM
description: Экспорт POWERPOINT в DOCM в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в DOCM" h2="Экспорт POWERPOINT в DOCM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
