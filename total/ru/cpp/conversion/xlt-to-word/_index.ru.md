...
url: /ru/cpp/conversion/xlt-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLT в WORD через C++" h2="Экспорт Excel&reg; XLT в WORD в полнофункциональных приложениях C++" >}}
