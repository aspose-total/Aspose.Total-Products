---
title: Экспорт EML в ODT через C++
description: C++ API для преобразования EML в ODT без использования Microsoft Word или Outlook
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в ODT" h2="Преобразование EML в ODT в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования EML в ODT" %}}
