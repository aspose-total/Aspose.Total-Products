---
title: C++ API для преобразования POT в FLATOPC
description: Экспорт POT в FLATOPC в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в FLATOPC" h2="Экспорт POT в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
