---
title: Преобразование DOTX в PPSX через C++
description: Экспортируйте DOTX в PPSX в свои приложения C++ без использования Microsoft Word of PowerPoint.
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTX в PPSX" h2="Экспортируйте DOTX в PPSX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
