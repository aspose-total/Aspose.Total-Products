---
title: C++ API для преобразования POT в RTF
description: Экспорт POT в RTF в ваших приложениях C++
url: /ru/cpp/conversion/pot-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в RTF" h2="Экспорт POT в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
