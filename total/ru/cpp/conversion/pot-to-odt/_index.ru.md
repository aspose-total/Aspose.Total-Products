---
title: C++ API для преобразования POT в ODT
description: Экспорт POT в ODT в ваших приложениях C++
url: /ru/cpp/conversion/pot-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в ODT" h2="Экспорт POT в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
