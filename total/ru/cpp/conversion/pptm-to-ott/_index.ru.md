---
title: C++ API для преобразования PPTM в OTT
description: Экспорт PPTM в OTT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в OTT" h2="Экспорт PPTM в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
