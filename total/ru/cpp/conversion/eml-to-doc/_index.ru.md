---
title: Экспорт EML в DOC через C++
description: C++ API для преобразования EML в DOC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в DOC" h2="Преобразование EML в DOC в приложении C++ без использования Microsoft Word или Outlook" >}}
