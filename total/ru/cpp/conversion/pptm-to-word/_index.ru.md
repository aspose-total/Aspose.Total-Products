---
title: C++ API для преобразования PPTM в WORD
description: Экспорт PPTM в WORD в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в WORD" h2="Экспорт PPTM в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
