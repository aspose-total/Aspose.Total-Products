---
title: C++ API для преобразования PPTM в DOT
description: Экспорт PPTM в DOT в ваших приложениях C++
url: /ru/cpp/conversion/pptm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в DOT" h2="Экспорт PPTM в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
