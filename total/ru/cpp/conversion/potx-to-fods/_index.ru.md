---
title: Конвертировать POTX в FODS через C++
description: Экспорт POTX в FODS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/potx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать POTX в FODS через C++" h2="Преобразование файлов POTX в FODS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
