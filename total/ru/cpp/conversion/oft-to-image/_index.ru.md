---
title: Экспорт OFT в IMAGE через C++
description: C++ API для преобразования OFT в IMAGE без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-image/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в IMAGE" h2="Преобразование OFT в IMAGE в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/cpp/conversion/oft-to-image/" name="OFT К IMAGE" description="" >}}
