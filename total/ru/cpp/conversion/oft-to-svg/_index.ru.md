---
title: Экспорт OFT в SVG через C++
description: C++ API для преобразования OFT в SVG без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-svg/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
4. Сохраните документ в формате SVG с помощью метода [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) и установите Svg в качестве SaveFormat.
