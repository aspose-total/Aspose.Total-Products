---
title: Конвертировать POTX в SXC через C++
description: Экспорт POTX в SXC на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/potx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать POTX в SXC через C++" h2="Преобразование файлов POTX в SXC с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
