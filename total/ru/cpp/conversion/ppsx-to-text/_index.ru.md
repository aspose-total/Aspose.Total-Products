---
title: C++ API для преобразования PPSX в TEXT
description: Экспорт PPSX в TEXT в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в TEXT" h2="Экспорт PPSX в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
