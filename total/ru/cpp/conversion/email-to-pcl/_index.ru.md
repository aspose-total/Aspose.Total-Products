---
title: Экспорт EMAIL в PCL через C++
description: C++ API для преобразования EMAIL в PCL без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в PCL" h2="Преобразование EMAIL в PCL в приложении C++ без использования Microsoft Word или Outlook" >}}
