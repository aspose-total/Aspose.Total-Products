---
title: Экспорт MSG в PS через C++
description: C++ API для преобразования MSG в PS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в PS" h2="Преобразование MSG в PS в приложении C++ без использования Microsoft Word или Outlook" >}}
