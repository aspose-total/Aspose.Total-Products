---
title: Преобразование WORD в ODP через C++
description: Экспортируйте WORD в ODP в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/word-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в ODP" h2="Экспортируйте WORD в ODP в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
