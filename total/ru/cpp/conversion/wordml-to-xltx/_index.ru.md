---
title: Преобразование WORDML в XLTX на C++
description: C++ API для преобразования WORDML в XLTX без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/wordml-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORDML в XLTX" h2="Экспорт WORDML в XLTX через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
