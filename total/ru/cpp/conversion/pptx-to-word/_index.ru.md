---
title: C++ API для преобразования PPTX в WORD
description: Экспорт PPTX в WORD в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в WORD" h2="Экспорт PPTX в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
