---
title: Преобразование ODT в PPTM через C++
description: Экспортируйте ODT в PPTM в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/odt-to-pptm/
family: total
platformtag: cpp
feature: conversion
informat: ODT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования ODT в PPTM" h2="Экспортируйте ODT в PPTM в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
