---
title: Экспорт EML в EMF через C++
description: C++ API для преобразования EML в EMF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-emf/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в EMF" h2="Преобразование EML в EMF в приложении C++ без использования Microsoft Word или Outlook" >}}
