---
title: C++ API для преобразования PPTX в DOTM
description: Экспорт PPTX в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в DOTM" h2="Экспорт PPTX в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
