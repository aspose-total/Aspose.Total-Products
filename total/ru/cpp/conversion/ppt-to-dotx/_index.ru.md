---
title: C++ API для преобразования PPT в DOTX
description: Экспорт PPT в DOTX в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в DOTX" h2="Экспорт PPT в DOTX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
