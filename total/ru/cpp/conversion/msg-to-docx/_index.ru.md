---
title: Экспорт MSG в DOCX через C++
description: C++ API для преобразования MSG в DOCX без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в DOCX" h2="Преобразование MSG в DOCX в приложении C++ без использования Microsoft Word или Outlook" >}}
