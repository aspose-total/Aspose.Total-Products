---
title: Экспорт MSG в DOTM через C++
description: C++ API для преобразования MSG в DOTM без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в DOTM" h2="Преобразование MSG в DOTM в приложении C++ без использования Microsoft Word или Outlook" >}}
