---
title: Преобразование OTT в PPT через C++
description: Экспортируйте OTT в PPT в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/ott-to-ppt/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования OTT в PPT" h2="Экспортируйте OTT в PPT в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
