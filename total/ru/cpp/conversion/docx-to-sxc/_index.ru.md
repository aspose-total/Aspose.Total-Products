...
description: C++ API для преобразования DOCX в SXC без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/docx-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCX в SXC" h2="Экспорт DOCX в SXC через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
