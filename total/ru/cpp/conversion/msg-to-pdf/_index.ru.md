---
title: Экспорт MSG в PDF через C++
description: C++ API для преобразования MSG в PDF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в PDF" h2="Преобразование MSG в PDF в приложении C++ без использования Microsoft Word или Outlook" >}}
