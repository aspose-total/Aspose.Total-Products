---
title: C++ API для преобразования PPT в DOCX
description: Экспорт PPT в DOCX в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в DOCX" h2="Экспорт PPT в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
