---
title: Экспорт MSG в EPUB через C++
description: C++ API для преобразования MSG в EPUB без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в EPUB" h2="Преобразование MSG в EPUB в приложении C++ без использования Microsoft Word или Outlook" >}}
