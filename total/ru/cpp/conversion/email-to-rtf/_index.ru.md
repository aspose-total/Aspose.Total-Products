---
title: Экспорт EMAIL в RTF через C++
description: C++ API для преобразования EMAIL в RTF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в RTF" h2="Преобразование EMAIL в RTF в приложении C++ без использования Microsoft Word или Outlook" >}}
