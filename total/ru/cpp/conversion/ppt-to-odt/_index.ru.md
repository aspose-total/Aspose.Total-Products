---
title: C++ API для преобразования PPT в ODT
description: Экспорт PPT в ODT в ваших приложениях C++
url: /ru/cpp/conversion/ppt-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в ODT" h2="Экспорт PPT в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
