---
title: Экспорт EML в FLATOPC через C++
description: C++ API для преобразования EML в FLATOPC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в FLATOPC" h2="Преобразование EML в FLATOPC в приложении C++ без использования Microsoft Word или Outlook" >}}
