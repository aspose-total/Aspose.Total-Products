---
title: C++ API для преобразования PPSM в DOT
description: Экспорт PPSM в DOT в ваших приложениях C++
url: /ru/cpp/conversion/ppsm-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в DOT" h2="Экспорт PPSM в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
