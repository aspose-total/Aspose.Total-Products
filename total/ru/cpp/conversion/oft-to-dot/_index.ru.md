---
title: Экспорт OFT в DOT через C++
description: C++ API для преобразования OFT в DOT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в DOT" h2="Преобразование OFT в DOT в приложении C++ без использования Microsoft Word или Outlook" >}}
