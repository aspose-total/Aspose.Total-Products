---
title: C++ API для преобразования POTM в ODT
description: Экспорт POTM в ODT в ваших приложениях C++
url: /ru/cpp/conversion/potm-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в ODT" h2="Экспорт POTM в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
