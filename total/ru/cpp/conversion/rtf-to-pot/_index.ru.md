---
title: Преобразование RTF в POT через C++
description: Экспортируйте RTF в POT в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/rtf-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: RTF
