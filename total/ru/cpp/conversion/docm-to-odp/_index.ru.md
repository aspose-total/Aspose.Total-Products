---
title: Преобразование DOCM в ODP через C++
description: Экспортируйте DOCM в ODP в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/docm-to-odp/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCM в ODP" h2="Экспортируйте DOCM в ODP в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
