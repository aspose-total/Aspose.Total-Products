---
title: C++ API для преобразования POWERPOINT в TEXT
description: Экспорт POWERPOINT в TEXT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в TEXT" h2="Экспорт POWERPOINT в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
