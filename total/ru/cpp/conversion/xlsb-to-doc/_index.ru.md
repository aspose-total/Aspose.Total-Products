---
title: Преобразование XLSB в DOC с помощью C++
description: Преобразование XLSB в DOC в приложениях C++
url: /ru/cpp/conversion/xlsb-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLSB в DOC через C++" h2="Экспорт Excel<sup>&reg;</sup> XLSB в DOC в полнофункциональных приложениях C++" >}}
