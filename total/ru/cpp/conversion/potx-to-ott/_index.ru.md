---
title: C++ API для преобразования POTX в OTT
description: Экспорт POTX в OTT в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в OTT" h2="Экспорт POTX в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
