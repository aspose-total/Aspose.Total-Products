---
title: Экспорт OFT в OTT через C++
description: C++ API для преобразования OFT в OTT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в OTT" h2="Преобразование OFT в OTT в приложении C++ без использования Microsoft Word или Outlook" >}}
