---
title: Преобразование WORDML в EXCEL на C++
description: C++ API для преобразования WORDML в EXCEL без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/wordml-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORDML в EXCEL" h2="Экспорт WORDML в EXCEL через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования WORDML в EXCEL" %}}
