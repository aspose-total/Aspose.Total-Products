---
title: C++ API для преобразования PPS в ODT
description: Экспорт PPS в ODT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в ODT" h2="Экспорт PPS в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
