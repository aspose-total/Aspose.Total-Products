---
title: Экспорт EMAIL в PDF через C++
description: C++ API для преобразования EMAIL в PDF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-pdf/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в PDF" h2="Преобразование EMAIL в PDF в приложении C++ без использования Microsoft Word или Outlook" >}}
