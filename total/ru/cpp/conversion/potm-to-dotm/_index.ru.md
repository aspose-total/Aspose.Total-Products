---
title: C++ API для преобразования POTM в DOTM
description: Экспорт POTM в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/potm-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в DOTM" h2="Экспорт POTM в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
