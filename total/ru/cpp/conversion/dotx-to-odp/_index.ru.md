---
title: Преобразование DOTX в ODP через C++
description: Экспортируйте DOTX в ODP в свои приложения C++ без использования Microsoft Word of PowerPoint.
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTX в ODP" h2="Экспортируйте DOTX в ODP в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
