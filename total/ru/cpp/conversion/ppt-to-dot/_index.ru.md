---
title: C++ API для преобразования PPT в DOT
description: Экспорт PPT в DOT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в DOT" h2="Экспорт PPT в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
