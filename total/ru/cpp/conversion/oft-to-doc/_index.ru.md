---
title: Экспорт OFT в DOC через C++
description: C++ API для преобразования OFT в DOC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в DOC" h2="Преобразование OFT в DOC в приложении C++ без использования Microsoft Word или Outlook" >}}
