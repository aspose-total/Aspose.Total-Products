---
title: Конвертировать PPS в ODS через C++
description: Экспорт PPS в ODS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/pps-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать PPS в ODS через C++" h2="Преобразование файлов PPS в ODS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
