---
title: Экспорт OFT в XPS через C++
description: C++ API для преобразования OFT в XPS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в XPS" h2="Преобразование OFT в XPS в приложении C++ без использования Microsoft Word или Outlook" >}}
