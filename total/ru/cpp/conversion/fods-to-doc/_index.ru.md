...
{{< blocks/products/pf/feature-page-header h1="Конвертировать FODS в DOC через C++" h2="Экспорт Excel<sup>&reg;</sup> FODS в DOC в полнофункциональных приложениях C++" >}}
