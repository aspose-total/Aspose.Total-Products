---
title: C++ API для преобразования POTX в DOCM
description: Экспорт POTX в DOCM в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в DOCM" h2="Экспорт POTX в DOCM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
