---
title: Экспорт EMAIL в DOTX через C++
description: C++ API для преобразования EMAIL в DOTX без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в DOTX" h2="Преобразование EMAIL в DOTX в приложении C++ без использования Microsoft Word или Outlook" >}}
