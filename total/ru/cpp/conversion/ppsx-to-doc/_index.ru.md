---
title: C++ API для преобразования PPSX в DOC
description: Экспорт PPSX в DOC в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в DOC" h2="Экспорт PPSX в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
