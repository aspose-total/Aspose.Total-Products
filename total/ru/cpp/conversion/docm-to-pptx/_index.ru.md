---
title: Преобразование DOCM в PPTX через C++
description: Экспортируйте DOCM в PPTX в свои приложения C++ без использования Microsoft Word of PowerPoint.
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCM в PPTX" h2="Экспортируйте DOCM в PPTX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
