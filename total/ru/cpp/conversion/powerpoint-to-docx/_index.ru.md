---
title: C++ API для преобразования POWERPOINT в DOCX
description: Экспорт POWERPOINT в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в DOCX" h2="Экспорт POWERPOINT в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
