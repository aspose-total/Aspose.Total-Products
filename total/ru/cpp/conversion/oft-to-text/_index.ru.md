---
title: Экспорт OFT в TEXT через C++
description: C++ API для преобразования OFT в TEXT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-text/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в TEXT" h2="Преобразование OFT в TEXT в приложении C++ без использования Microsoft Word или Outlook" >}}
