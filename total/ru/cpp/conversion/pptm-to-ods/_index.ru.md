---
title: Конвертировать PPTM в ODS через C++
description: Экспорт PPTM в ODS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/pptm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать PPTM в ODS через C++" h2="Преобразование файлов PPTM в ODS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
