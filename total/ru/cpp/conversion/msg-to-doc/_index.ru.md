---
title: Экспорт MSG в DOC через C++
description: C++ API для преобразования MSG в DOC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в DOC" h2="Преобразование MSG в DOC в приложении C++ без использования Microsoft Word или Outlook" >}}
