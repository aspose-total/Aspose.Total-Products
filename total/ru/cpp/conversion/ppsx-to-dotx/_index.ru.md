---
title: C++ API для преобразования PPSX в DOTX
description: Экспорт PPSX в DOTX в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-dotx/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в DOTX" h2="Экспорт PPSX в DOTX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
