---
title: Экспорт OFT в MD через C++
description: C++ API для преобразования OFT в MD без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-md/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в MD" h2="Преобразование OFT в MD в приложении C++ без использования Microsoft Word или Outlook" >}}
