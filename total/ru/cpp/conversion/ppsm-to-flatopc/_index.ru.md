---
title: C++ API для преобразования PPSM в FLATOPC
description: Экспорт PPSM в FLATOPC в ваших приложениях C++
url: /ru/cpp/conversion/ppsm-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в FLATOPC" h2="Экспорт PPSM в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
