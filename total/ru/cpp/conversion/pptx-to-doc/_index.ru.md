---
title: C++ API для преобразования PPTX в DOC
description: Экспорт PPTX в DOC в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в DOC" h2="Экспорт PPTX в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
