---
title: C++ API для преобразования POTX в TEXT
description: Экспорт POTX в TEXT в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в TEXT" h2="Экспорт POTX в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
