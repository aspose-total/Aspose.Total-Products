---
title: Экспорт EMAIL в WORDML через C++
description: C++ API для преобразования EMAIL в WORDML без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в WORDML" h2="Преобразование EMAIL в WORDML в приложении C++ без использования Microsoft Word или Outlook" >}}
