---
title: Экспорт MSG в WORDML через C++
description: C++ API для преобразования MSG в WORDML без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в WORDML" h2="Преобразование MSG в WORDML в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования MSG в WORDML" %}}
