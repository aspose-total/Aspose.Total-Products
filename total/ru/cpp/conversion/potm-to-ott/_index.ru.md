---
title: C++ API для преобразования POTM в OTT
description: Экспорт POTM в OTT в ваших приложениях C++
url: /ru/cpp/conversion/potm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в OTT" h2="Экспорт POTM в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
