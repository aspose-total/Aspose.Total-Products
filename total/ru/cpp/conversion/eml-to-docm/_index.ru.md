---
title: Экспорт EML в DOCM через C++
description: C++ API для преобразования EML в DOCM без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в DOCM" h2="Преобразование EML в DOCM в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования EML в DOCM" %}}
