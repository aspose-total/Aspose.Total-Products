---
title: C++ API для преобразования POTX в ODT
description: Экспорт POTX в ODT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в ODT" h2="Экспорт POTX в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
