---
title: C++ API для преобразования PPS в OTT
description: Экспорт PPS в OTT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в OTT" h2="Экспорт PPS в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
