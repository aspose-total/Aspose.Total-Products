---
title: Преобразование DOT в PPSX через C++
description: Экспортируйте DOT в PPSX в свои приложения C++ без использования Microsoft Word of PowerPoint.
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOT в PPSX" h2="Экспортируйте DOT в PPSX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
