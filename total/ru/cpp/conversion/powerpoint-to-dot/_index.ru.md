---
title: C++ API для преобразования POWERPOINT в DOT
description: Экспорт POWERPOINT в DOT в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в DOT" h2="Экспорт POWERPOINT в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
