---
title: Преобразование XLSM в DOCX с помощью C++
description: Преобразование XLSM в DOCX в приложениях C++
url: /ru/cpp/conversion/xlsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSM
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLSM в DOCX через C++" h2="Экспорт Excel<sup>&reg;</sup> XLSM в DOCX в полнофункциональных приложениях C++" >}}
