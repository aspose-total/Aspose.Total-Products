---
title: Экспорт MSG в DOT через C++
description: C++ API для преобразования MSG в DOT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в DOT" h2="Преобразование MSG в DOT в приложении C++ без использования Microsoft Word или Outlook" >}}
