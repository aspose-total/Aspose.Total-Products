---
title: Экспорт MSG в FLATOPC через C++
description: C++ API для преобразования MSG в FLATOPC без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в FLATOPC" h2="Преобразование MSG в FLATOPC в приложении C++ без использования Microsoft Word или Outlook" >}}
