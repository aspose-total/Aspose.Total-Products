---
title: Преобразование WORD в CSV на C++
description: C++ API для преобразования WORD в CSV без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/word-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в CSV" h2="Экспорт WORD в CSV через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
