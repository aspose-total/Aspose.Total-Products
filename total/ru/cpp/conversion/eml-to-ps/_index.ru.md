---
title: Экспорт EML в PS через C++
description: C++ API для преобразования EML в PS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в PS" h2="Преобразование EML в PS в приложении C++ без использования Microsoft Word или Outlook" >}}
