---
title: Экспорт EMAIL в WORD через C++
description: C++ API для преобразования EMAIL в WORD без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-word/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в WORD" h2="Преобразование EMAIL в WORD в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/cpp/conversion/msg-to-word/" name="MSG К WORD" description="" >}}
