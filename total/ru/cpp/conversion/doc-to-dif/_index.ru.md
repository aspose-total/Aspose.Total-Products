---
title: Преобразование DOC в DIF на C++
description: C++ API для преобразования DOC в DIF без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/doc-to-dif/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOC в DIF" h2="Экспорт DOC в DIF через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
