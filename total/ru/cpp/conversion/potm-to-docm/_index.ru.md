---
title: C++ API для преобразования POTM в DOCM
description: Экспорт POTM в DOCM в ваших приложениях C++
url: /ru/cpp/conversion/potm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: POTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в DOCM" h2="Экспорт POTM в DOCM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
