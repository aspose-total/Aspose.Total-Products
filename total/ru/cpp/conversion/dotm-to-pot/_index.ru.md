---
title: Преобразование DOTM в POT через C++
description: Экспортируйте DOTM в POT в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/dotm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOTM в POT" h2="Экспортируйте DOTM в POT в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
