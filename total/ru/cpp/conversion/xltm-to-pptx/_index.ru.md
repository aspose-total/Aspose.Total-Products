...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLTM в PPTX через C++" h2="Экспорт Excel<sup>&reg;</sup> XLTM в PPTX в полнофункциональных приложениях C++" >}}
