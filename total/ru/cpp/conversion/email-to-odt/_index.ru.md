---
title: Экспорт EMAIL в ODT через C++
description: C++ API для преобразования EMAIL в ODT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в ODT" h2="Преобразование EMAIL в ODT в приложении C++ без использования Microsoft Word или Outlook" >}}
