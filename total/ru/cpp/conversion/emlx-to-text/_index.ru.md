---
title: Экспорт EMLX в TEXT через C++
description: C++ API для преобразования EMLX в TEXT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/emlx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: EMLX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMLX в TEXT" h2="Преобразование EMLX в TEXT в приложении C++ без использования Microsoft Word или Outlook" >}}
...
4. Сохраните документ в формате TEXT с помощью метода [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_string_saveformat) и установите Text в качестве SaveFormat.
