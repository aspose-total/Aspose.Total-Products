---
title: Преобразование FLATOPC в PPS через C++
description: Экспортируйте FLATOPC в PPS в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/flatopc-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: FLATOPC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования FLATOPC в PPS" h2="Экспортируйте FLATOPC в PPS в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
