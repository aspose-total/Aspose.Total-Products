---
title: Экспорт OFT в PCL через C++
description: C++ API для преобразования OFT в PCL без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-pcl/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в PCL" h2="Преобразование OFT в PCL в приложении C++ без использования Microsoft Word или Outlook" >}}
