---
title: Конвертировать POTX в XLSB через C++
description: Экспорт POTX в XLSB на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/potx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать POTX в XLSB через C++" h2="Преобразование файлов POTX в XLSB с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
