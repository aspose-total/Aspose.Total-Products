---
title: Экспорт OFT в ODT через C++
description: C++ API для преобразования OFT в ODT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в ODT" h2="Преобразование OFT в ODT в приложении C++ без использования Microsoft Word или Outlook" >}}
