---
title: Экспорт OFT в WORD через C++
description: C++ API для преобразования OFT в WORD без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-word/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в WORD" h2="Преобразование OFT в WORD в приложении C++ без использования Microsoft Word или Outlook" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/cpp/conversion/oft-to-word/" name="OFT К WORD" description="" >}}
