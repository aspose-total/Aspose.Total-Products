---
title: Экспорт OFT в RTF через C++
description: C++ API для преобразования OFT в RTF без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в RTF" h2="Преобразование OFT в RTF в приложении C++ без использования Microsoft Word или Outlook" >}}
