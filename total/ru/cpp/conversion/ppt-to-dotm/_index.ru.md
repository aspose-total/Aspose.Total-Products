---
title: C++ API для преобразования PPT в DOTM
description: Экспорт PPT в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/ppt-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в DOTM" h2="Экспорт PPT в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
