---
title: Преобразование DOCX в XLS на C++
description: C++ API для преобразования DOCX в XLS без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/docx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCX в XLS" h2="Экспорт DOCX в XLS через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
