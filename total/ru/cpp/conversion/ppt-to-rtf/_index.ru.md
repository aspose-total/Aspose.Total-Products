---
title: C++ API для преобразования PPT в RTF
description: Экспорт PPT в RTF в ваших приложениях C++
url: /ru/cpp/conversion/ppt-to-rtf/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в RTF" h2="Экспорт PPT в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
