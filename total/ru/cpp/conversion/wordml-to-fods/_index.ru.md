---
title: Преобразование WORDML в FODS на C++
description: C++ API для преобразования WORDML в FODS без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/wordml-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: WORDML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORDML в FODS" h2="Экспорт WORDML в FODS через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
