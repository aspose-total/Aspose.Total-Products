---
title: C++ API для преобразования PPTM в DOC
description: Экспорт PPTM в DOC в ваших приложениях C++
url: /ru/cpp/conversion/pptm-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTM в DOC" h2="Экспорт PPTM в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
