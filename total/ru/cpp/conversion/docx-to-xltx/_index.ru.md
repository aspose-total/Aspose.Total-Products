...
description: C++ API для преобразования DOCX в XLTX без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/docx-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCX в XLTX" h2="Экспорт DOCX в XLTX через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
