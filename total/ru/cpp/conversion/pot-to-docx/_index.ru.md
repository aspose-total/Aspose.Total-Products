---
title: C++ API для преобразования POT в DOCX
description: Экспорт POT в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/pot-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в DOCX" h2="Экспорт POT в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
