---
title: C++ API для преобразования PPSM в DOCX
description: Экспорт PPSM в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/ppsm-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в DOCX" h2="Экспорт PPSM в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
