---
title: Преобразование DOT в PPS через C++
description: Экспортируйте DOT в PPS в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/dot-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOT в PPS" h2="Экспортируйте DOT в PPS в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
