---
title: Преобразование OTT в POTM через C++
description: Экспортируйте OTT в POTM в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/ott-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования OTT в POTM" h2="Экспортируйте OTT в POTM в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
