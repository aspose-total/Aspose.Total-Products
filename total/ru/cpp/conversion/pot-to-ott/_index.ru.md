---
title: C++ API для преобразования POT в OTT
description: Экспорт POT в OTT в ваших приложениях C++
url: /ru/cpp/conversion/pot-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в OTT" h2="Экспорт POT в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
