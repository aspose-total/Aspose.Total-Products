---
title: C++ API для преобразования PPSM в ODT
description: Экспорт PPSM в ODT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в ODT" h2="Экспорт PPSM в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
