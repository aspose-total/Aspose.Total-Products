---
title: C++ API для преобразования POWERPOINT в WORD
description: Экспорт POWERPOINT в WORD в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в WORD" h2="Экспорт POWERPOINT в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
