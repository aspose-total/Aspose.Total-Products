---
title: C++ API для преобразования POTX в DOTM
description: Экспорт POTX в DOTM в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-dotm/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в DOTM" h2="Экспорт POTX в DOTM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
