---
title: Преобразование WORD в FODS на C++
description: C++ API для преобразования WORD в FODS без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/word-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в FODS" h2="Экспорт WORD в FODS через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
