---
title: C++ API для преобразования PPTX в RTF
description: Экспорт PPTX в RTF в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в RTF" h2="Экспорт PPTX в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
