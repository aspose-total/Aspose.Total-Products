---
title: Преобразование OTT в POTX через C++
description: Экспортируйте OTT в POTX в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/ott-to-potx/
family: total
platformtag: cpp
feature: conversion
informat: OTT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования OTT в POTX" h2="Экспортируйте OTT в POTX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
