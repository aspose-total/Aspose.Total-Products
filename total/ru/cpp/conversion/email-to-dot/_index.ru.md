---
title: Экспорт EMAIL в DOT через C++
description: C++ API для преобразования EMAIL в DOT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в DOT" h2="Преобразование EMAIL в DOT в приложении C++ без использования Microsoft Word или Outlook" >}}
