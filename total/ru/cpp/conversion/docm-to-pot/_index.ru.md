---
title: Преобразование DOCM в POT через C++
description: Экспортируйте DOCM в POT в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/docm-to-pot/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCM в POT" h2="Экспортируйте DOCM в POT в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
