---
title: Преобразование DOC в EXCEL на C++
description: C++ API для преобразования DOC в EXCEL без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/doc-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOC в EXCEL" h2="Экспорт DOC в EXCEL через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
