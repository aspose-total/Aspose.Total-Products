---
title: C++ API для преобразования PPS в DOT
description: Экспорт PPS в DOT в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в DOT" h2="Экспорт PPS в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
