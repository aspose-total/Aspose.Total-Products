---
title: C++ API для преобразования PPSX в ODT
description: Экспорт PPSX в ODT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в ODT" h2="Экспорт PPSX в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
