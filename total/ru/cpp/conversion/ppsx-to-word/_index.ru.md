---
title: C++ API для преобразования PPSX в WORD
description: Экспорт PPSX в WORD в ваших приложениях C++
url: /ru/cpp/conversion/ppsx-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPSX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в WORD" h2="Экспорт PPSX в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
