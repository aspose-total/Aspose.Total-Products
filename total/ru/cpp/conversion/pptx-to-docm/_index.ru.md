---
title: C++ API для преобразования PPTX в DOCM
description: Экспорт PPTX в DOCM в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в DOCM" h2="Экспорт PPTX в DOCM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
