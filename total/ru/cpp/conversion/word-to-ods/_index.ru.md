...
description: C++ API для преобразования WORD в ODS без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/word-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в ODS" h2="Экспорт WORD в ODS через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
