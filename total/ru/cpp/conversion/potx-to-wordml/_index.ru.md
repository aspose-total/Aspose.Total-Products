---
title: C++ API для преобразования POTX в WORDML
description: Экспорт POTX в WORDML в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в WORDML" h2="Экспорт POTX в WORDML в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
