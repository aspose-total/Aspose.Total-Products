...
url: /ru/cpp/conversion/xls-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать XLS в DOC через C++" h2="Экспорт Excel&reg; XLS в DOC в полнофункциональных приложениях C++" >}}
