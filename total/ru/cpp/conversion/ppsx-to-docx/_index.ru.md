---
title: C++ API для преобразования PPSX в DOCX
description: Экспорт PPSX в DOCX в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSX в DOCX" h2="Экспорт PPSX в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
