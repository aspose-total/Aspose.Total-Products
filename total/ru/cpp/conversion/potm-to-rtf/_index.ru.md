---
title: C++ API для преобразования POTM в RTF
description: Экспорт POTM в RTF в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в RTF" h2="Экспорт POTM в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
