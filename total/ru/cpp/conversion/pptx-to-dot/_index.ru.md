---
title: C++ API для преобразования PPTX в DOT
description: Экспорт PPTX в DOT в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-dot/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в DOT" h2="Экспорт PPTX в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
