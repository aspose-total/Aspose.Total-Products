...
{{< blocks/products/pf/feature-page-header h1="Конвертировать TSV в DOCX через C++" h2="Экспорт Excel<sup>&reg;</sup> TSV в DOCX в полнофункциональных приложениях C++" >}}
