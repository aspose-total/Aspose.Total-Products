---
title: Экспорт OFT в EPUB через C++
description: C++ API для преобразования OFT в EPUB без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/oft-to-epub/
family: total
platformtag: cpp
feature: conversion
informat: OFT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта OFT в EPUB" h2="Преобразование OFT в EPUB в приложении C++ без использования Microsoft Word или Outlook" >}}
