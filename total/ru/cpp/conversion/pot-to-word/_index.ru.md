---
title: C++ API для преобразования POT в WORD
description: Экспорт POT в WORD в ваших приложениях C++
url: /ru/cpp/conversion/pot-to-word/
family: total
platformtag: cpp
feature: conversion
informat: POT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в WORD" h2="Экспорт POT в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
