---
title: Экспорт EMAIL в PS через C++
description: C++ API для преобразования EMAIL в PS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-ps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в PS" h2="Преобразование EMAIL в PS в приложении C++ без использования Microsoft Word или Outlook" >}}
