---
title: C++ API для преобразования PPSM в DOTX
description: Экспорт PPSM в DOTX в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в DOTX" h2="Экспорт PPSM в DOTX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
