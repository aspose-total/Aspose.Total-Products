---
title: Конвертировать PPTX в XLS через C++
description: Экспорт PPTX в XLS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/pptx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать PPTX в XLS через C++" h2="Преобразование файлов PPTX в XLS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
