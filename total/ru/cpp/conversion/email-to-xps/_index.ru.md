---
title: Экспорт EMAIL в XPS через C++
description: C++ API для преобразования EMAIL в XPS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в XPS" h2="Преобразование EMAIL в XPS в приложении C++ без использования Microsoft Word или Outlook" >}}
