---
title: C++ API для преобразования POWERPOINT в FLATOPC
description: Экспорт POWERPOINT в FLATOPC в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в FLATOPC" h2="Экспорт POWERPOINT в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
