---
title: C++ API для преобразования POWERPOINT в DOC
description: Экспорт POWERPOINT в DOC в ваших приложениях C++
url: /ru/cpp/conversion/powerpoint-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POWERPOINT в DOC" h2="Экспорт POWERPOINT в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
