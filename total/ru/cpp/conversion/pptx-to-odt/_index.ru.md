---
title: C++ API для преобразования PPTX в ODT
description: Экспорт PPTX в ODT в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-odt/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в ODT" h2="Экспорт PPTX в ODT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
