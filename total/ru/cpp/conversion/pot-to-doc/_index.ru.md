---
title: C++ API для преобразования POT в DOC
description: Экспорт POT в DOC в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POT в DOC" h2="Экспорт POT в DOC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
