---
title: Преобразование DOCX в PPSX через C++
description: Экспортируйте DOCX в PPSX в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/docx-to-ppsx/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCX в PPSX" h2="Экспортируйте DOCX в PPSX в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
