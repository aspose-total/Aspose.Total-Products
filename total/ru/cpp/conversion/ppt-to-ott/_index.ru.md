---
title: C++ API для преобразования PPT в OTT
description: Экспорт PPT в OTT в ваших приложениях C++
url: /ru/cpp/conversion/ppt-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPT
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPT в OTT" h2="Экспорт PPT в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
