---
title: C++ API для преобразования PPSM в DOCM
description: Экспорт PPSM в DOCM в ваших приложениях C++
url: /ru/cpp/conversion/ppsm-to-docm/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в DOCM" h2="Экспорт PPSM в DOCM в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
