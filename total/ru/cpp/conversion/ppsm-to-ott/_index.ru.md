---
title: C++ API для преобразования PPSM в OTT
description: Экспорт PPSM в OTT в ваших приложениях C++
url: /ru/cpp/conversion/ppsm-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: PPSM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в OTT" h2="Экспорт PPSM в OTT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
