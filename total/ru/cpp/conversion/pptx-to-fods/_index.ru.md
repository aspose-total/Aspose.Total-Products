---
title: Конвертировать PPTX в FODS через C++
description: Экспорт PPTX в FODS на C++ без использования Microsoft Excel или Powerpoint
url: /ru/cpp/conversion/pptx-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать PPTX в FODS через C++" h2="Преобразование файлов PPTX в FODS с помощью C++ без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
