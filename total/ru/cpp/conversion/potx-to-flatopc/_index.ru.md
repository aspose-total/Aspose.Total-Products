---
title: C++ API для преобразования POTX в FLATOPC
description: Экспорт POTX в FLATOPC в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-flatopc/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в FLATOPC" h2="Экспорт POTX в FLATOPC в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
