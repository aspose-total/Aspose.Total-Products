---
title: Преобразование ODS в DOCX с помощью C++
description: Преобразование ODS в DOCX в приложениях C++
url: /ru/cpp/conversion/ods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: ODS
...
{{< blocks/products/pf/feature-page-header h1="Конвертировать ODS в DOCX через C++" h2="Экспорт Excel<sup>&reg;</sup> ODS в DOCX в полнофункциональных приложениях C++" >}}
