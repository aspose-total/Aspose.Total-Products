...
description: C++ API для преобразования DOC в XLAM без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/doc-to-xlam/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOC в XLAM" h2="Экспорт DOC в XLAM через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
