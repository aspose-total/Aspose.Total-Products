---
title: Преобразование DOCM в PPS через C++
description: Экспортируйте DOCM в PPS в свои приложения C++ без использования Microsoft Word of PowerPoint.
url: /ru/cpp/conversion/docm-to-pps/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCM в PPS" h2="Экспортируйте DOCM в PPS в приложениях C++ без использования Microsoft Word&reg; или PowerPoint" >}}
