---
title: Экспорт MSG в XPS через C++
description: C++ API для преобразования MSG в XPS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/msg-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта MSG в XPS" h2="Преобразование MSG в XPS в приложении C++ без использования Microsoft Word или Outlook" >}}
