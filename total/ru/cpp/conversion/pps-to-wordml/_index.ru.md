---
title: C++ API для преобразования PPS в WORDML
description: Экспорт PPS в WORDML в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в WORDML" h2="Экспорт PPS в WORDML в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
