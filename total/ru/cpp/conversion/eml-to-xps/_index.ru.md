---
title: Экспорт EML в XPS через C++
description: C++ API для преобразования EML в XPS без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/eml-to-xps/
family: total
platformtag: cpp
feature: conversion
informat: EML
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EML в XPS" h2="Преобразование EML в XPS в приложении C++ без использования Microsoft Word или Outlook" >}}
