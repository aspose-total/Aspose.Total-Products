...
description: C++ API для преобразования DOCX в XLT без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/docx-to-xlt/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования DOCX в XLT" h2="Экспорт DOCX в XLT через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
