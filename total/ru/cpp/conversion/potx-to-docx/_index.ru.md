---
title: C++ API для преобразования POTX в DOCX
description: Экспорт POTX в DOCX в ваших приложениях C++
url: /ru/cpp/conversion/potx-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: POTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTX в DOCX" h2="Экспорт POTX в DOCX в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
