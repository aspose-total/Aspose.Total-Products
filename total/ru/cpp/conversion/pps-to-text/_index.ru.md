---
title: C++ API для преобразования PPS в TEXT
description: Экспорт PPS в TEXT в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в TEXT" h2="Экспорт PPS в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
