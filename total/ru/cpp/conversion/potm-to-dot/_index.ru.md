---
title: C++ API для преобразования POTM в DOT
description: Экспорт POTM в DOT в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга POTM в DOT" h2="Экспорт POTM в DOT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
