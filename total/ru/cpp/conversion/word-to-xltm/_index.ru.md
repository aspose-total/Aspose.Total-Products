...
description: C++ API для преобразования WORD в XLTM без использования Microsoft Word или Microsoft Excel
url: /ru/cpp/conversion/word-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="C++ API для преобразования WORD в XLTM" h2="Экспорт WORD в XLTM через C++ без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
