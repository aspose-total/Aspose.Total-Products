---
title: C++ API для преобразования PPS в WORD
description: Экспорт PPS в WORD в ваших приложениях C++
url: /ru/cpp/conversion/pps-to-word/
family: total
platformtag: cpp
feature: conversion
informat: PPS
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPS в WORD" h2="Экспорт PPS в WORD в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
