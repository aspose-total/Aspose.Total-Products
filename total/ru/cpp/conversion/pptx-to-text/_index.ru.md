---
title: C++ API для преобразования PPTX в TEXT
description: Экспорт PPTX в TEXT в ваших приложениях C++
url: /ru/cpp/conversion/pptx-to-text/
family: total
platformtag: cpp
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPTX в TEXT" h2="Экспорт PPTX в TEXT в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
