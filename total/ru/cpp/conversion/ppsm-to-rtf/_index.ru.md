---
title: C++ API для преобразования PPSM в RTF
description: Экспорт PPSM в RTF в ваших приложениях C++
...
{{< blocks/products/pf/feature-page-header h1="C++ API для рендеринга PPSM в RTF" h2="Экспорт PPSM в RTF в приложениях C++ без каких-либо зависимостей от Microsoft PowerPoint или Word." >}}
