---
title: Экспорт EMAIL в TEXT через C++
description: C++ API для преобразования EMAIL в TEXT без использования Microsoft Word или Outlook
url: /ru/cpp/conversion/email-to-text/
family: total
platformtag: cpp
feature: conversion
informat: MSG
...
{{< blocks/products/pf/feature-page-header h1="C++ API для экспорта EMAIL в TEXT" h2="Преобразование EMAIL в TEXT в приложении C++ без использования Microsoft Word или Outlook" >}}
