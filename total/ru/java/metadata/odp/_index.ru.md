---
title: Просмотр и обновление свойств ODP в Интернете или обновление метаданных с помощью Java
description: Просматривайте и изменяйте свойства ODP через онлайн-приложение бесплатно.Код Java API для обновления свойств ODP.
...
{{< blocks/products/pf/feature-page-header-widget h1="Просмотр или обновление метаданных ODP онлайн или обновление через Java" h2="Разработайте мощное приложение для управления метаданными документов ODP на базе Java.Перечислен код для обновления метаданных файла ODP через Java." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Обновление свойств ODP через Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Код Java для обновления метаданных ODP" offSpacer="" %}}
...
<h2>Разработка приложения управления метаданными ODP с помощью Java</h2>

Вам нужно разработать приложение или утилиту для управления метаданными ODP? Благодаря тому, что [Aspose.Slides for Java](https://products.aspose.com/slides/ru/java/) является дочерним API [Aspose.Total for Java](https://products.aspose.com/total/ru/java/), любой разработчик Java может интегрировать приведенный выше код API в свое приложение метаданных документа.Мощная библиотека Java позволяет программировать любое решение для метаданных документов.Более того, он может поддерживать многие популярные форматы, включая формат ODP.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита Java для управления метаданными ODP" %}}
