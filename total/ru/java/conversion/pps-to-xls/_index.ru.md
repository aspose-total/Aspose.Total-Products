...
description: Преобразуйте формат PPS в XLS через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPS в XLS через Java" h2="Локальный Java API для экспорта PPS в XLS без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
