...
description: Преобразуйте формат PPSX в XLT через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в XLT через Java" h2="Локальный Java API для экспорта PPSX в XLT без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
