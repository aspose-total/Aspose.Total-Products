...
description: Преобразуйте формат PPSX в ODS через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в ODS через Java" h2="Локальный Java API для экспорта PPSX в ODS без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
