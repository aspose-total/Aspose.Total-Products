---
title: Преобразование SXC в POWERPOINT с помощью Java
description: Java API для экспорта SXC в POWERPOINT с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта SXC в POWERPOINT" h2="Локальный Java API для экспорта SXC в POWERPOINT, не полагаясь на Microsoft Excel&reg;" >}}
