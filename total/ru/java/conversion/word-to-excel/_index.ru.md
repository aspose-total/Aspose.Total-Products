...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать WORD в EXCEL через Java или онлайн" h2="Локальный Java API для преобразования WORD в EXCEL без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
