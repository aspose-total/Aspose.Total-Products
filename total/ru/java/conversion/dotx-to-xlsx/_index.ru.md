...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать DOTX в XLSX через Java или онлайн" h2="Локальный Java API для преобразования DOTX в XLSX без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
