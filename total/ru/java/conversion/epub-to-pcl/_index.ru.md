...
4. Сохраните документ в формате PCL, используя метод [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,int)) и установите PCL как СохранитьФормат
