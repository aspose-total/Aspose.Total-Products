---
title: Java API для преобразования WORDML в XLSM или с помощью бесплатного онлайн-конвертера
description: Преобразование WORDML в XLSM через Java без использования Microsoft Word или Microsoft Excel или онлайн. Быстро протестируйте бесплатный онлайн-конвертер WORDML в XLSM, прежде чем интегрировать код. 
url_ignore: /ru/java/conversion/wordml-to-xlsm/
family: total
platformtag: net
feature: conversion
informat: WORDML
...
Вы можете легко использовать Aspose.Total для Java непосредственно из проекта на основе [Maven](https://releases.aspose.com/total/java/). и включите [Aspose.Words для Java](https://wordmls.aspose.com/words/java/installation/) и [Aspose.Cells для Java](https://wordmls.aspose.com/cells/java/installation/) в вашем pom.xml.
