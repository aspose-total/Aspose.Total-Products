...
url: /ru/java/conversion/eml-to-svg/
family: total
platformtag: net
feature: conversion
informat: EML
...
4. Сохраните документ в формате SVG, используя [save](https://apireference.aspose.com/words/java/com.aspose.words/Document#save(java.lang.String,com.aspose.words.SaveOptions).)) и установите SVG как SaveFormat
