---
title: Преобразование ODT в PPTM через Java
description: Java API для экспорта ODT в PPTM без использования Microsoft Word или PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование ODT в PPTM через Java" h2="Преобразование ODT в PPTM с помощью локального Java API в любых приложениях Java J2SE, J2EE, J2ME без использования Microsoft<sup>&reg;</sup> PowerPoint или Word" >}}
...
Для преобразования файлов ODT в PPTM вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) и включите библиотеки в ваш pom.xml.
