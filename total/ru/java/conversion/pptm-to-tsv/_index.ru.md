...
description: Преобразуйте формат PPTM в TSV через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPTM в TSV через Java" h2="Локальный Java API для экспорта PPTM в TSV без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
