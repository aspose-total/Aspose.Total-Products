...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать DOTM в XLAM через Java или онлайн" h2="Локальный Java API для преобразования DOTM в XLAM без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
