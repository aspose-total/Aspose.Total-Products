...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать DOC в XLSM через Java или онлайн" h2="Локальный Java API для преобразования DOC в XLSM без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
