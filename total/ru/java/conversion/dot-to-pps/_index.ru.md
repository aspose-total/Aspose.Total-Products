---
title: Преобразование DOT в PPS через Java
description: Java API для экспорта DOT в PPS без использования Microsoft Word или PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование DOT в PPS через Java" h2="Преобразование DOT в PPS с помощью локального Java API в любых приложениях Java J2SE, J2EE, J2ME без использования Microsoft<sup>&reg;</sup> PowerPoint или Word" >}}
...
Для преобразования файлов DOT в PPS вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) и включите библиотеки в ваш pom.xml.
