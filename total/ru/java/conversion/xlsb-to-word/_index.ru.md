---
title: Преобразование XLSB в WORD с помощью Java
description: Java API для экспорта XLSB в WORD с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта XLSB в WORD" h2="Локальный Java API для экспорта XLSB в WORD, не полагаясь на Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/xlsb-to-wordx/" name="XLSB К WORDX" description="" >}}
