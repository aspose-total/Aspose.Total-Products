---
title: Преобразование EXCEL в WORD с помощью Java
description: Java API для экспорта EXCEL в WORD с использованием Excel или Word
url: /ru/java/conversion/excel-to-word/
family: total
platformtag: net
feature: conversion
informat: EXCEL
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта EXCEL в WORD" h2="Локальный Java API для экспорта EXCEL в WORD, не полагаясь на Microsoft Excel&reg;" >}}
