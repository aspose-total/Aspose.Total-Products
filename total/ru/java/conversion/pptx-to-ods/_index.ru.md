...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPTX в ODS через Java или онлайн" h2="Локальный Java API для экспорта PPTX в ODS без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
