---
title: Преобразование ODS в WORD с помощью Java
description: Java API для экспорта ODS в WORD с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта ODS в WORD" h2="Локальный Java API для экспорта ODS в WORD, не полагаясь на Microsoft Excel&reg;" >}}
