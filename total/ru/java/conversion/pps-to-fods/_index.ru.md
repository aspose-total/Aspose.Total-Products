...
description: Преобразуйте формат PPS в FODS через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPS в FODS через Java" h2="Локальный Java API для экспорта PPS в FODS без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
