...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в XLS через Java" h2="Локальный Java API для экспорта PPSX в XLS без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
