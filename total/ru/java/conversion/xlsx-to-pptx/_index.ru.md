---
title: Преобразование XLSX в PPTX с помощью Java
description: Java API для экспорта XLSX в PPTX с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта XLSX в PPTX" h2="Локальный Java API для экспорта XLSX в PPTX, не полагаясь на Microsoft Excel&reg;" >}}
