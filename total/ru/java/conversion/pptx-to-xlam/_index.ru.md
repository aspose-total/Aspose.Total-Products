...
description: Преобразуйте формат PPTX в XLAM через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPTX в XLAM через Java" h2="Локальный Java API для экспорта PPTX в XLAM без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
