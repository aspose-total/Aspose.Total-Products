...
description: Преобразуйте формат PPSX в CSV через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в CSV через Java" h2="Локальный Java API для экспорта PPSX в CSV без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
