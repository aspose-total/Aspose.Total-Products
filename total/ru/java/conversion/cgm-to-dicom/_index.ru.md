---
title: Преобразование CGM в DICOM через Java
description: Экспорт файла CGM в DICOM в ваших приложениях Java без использования каких-либо сторонних приложений.
url_ignore: /ru/java/conversion/cgm-to-dicom/
family: total
platformtag: net
feature: conversion
informat: CGM
...
{{% /blocks/products/pf/feature-page-code  %}}
{{% /blocks/products/pf/feature-page-section %}}
{{% blocks/products/pf/feature-page-section  h2="Преобразование и поворот CGM в файл DICOM через Java" %}}
...
- **Системы информационной поддержки больниц (HIS)**  
  Преобразование CGM в DICOM для стандартизированных изображений, доступных в сети больниц.

- **Обмен радиологическими данными**  
  Обеспечение плавного передачи преобразованных изображений между медицинскими учреждениями с использованием глобального стандарта DICOM.
...
- **Интеграция с системой PACS**  
  Подача преобразованных изображений DICOM непосредственно в системы архивирования и передачи изображений для мгновенного извлечения и хранения.

- **Java-ориентированные конвейеры ETL**  
  Интеграция автоматизированного преобразования в рамках рабочих процессов извлечения-трансформации-загрузки для управления изображениями на уровне всей больницы.
