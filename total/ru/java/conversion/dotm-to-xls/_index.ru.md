...
description: Преобразование DOTM в XLS через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать DOTM в XLS через Java" h2="Локальный Java API для преобразования DOTM в XLS без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
