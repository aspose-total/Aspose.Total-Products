...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPTM в XLTM через Java или онлайн" h2="Локальный Java API для экспорта PPTM в XLTM без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
