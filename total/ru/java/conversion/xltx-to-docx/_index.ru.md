---
title: Преобразование XLTX в DOCX с помощью Java
description: Java API для экспорта XLTX в DOCX с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта XLTX в DOCX" h2="Локальный Java API для экспорта XLTX в DOCX, не полагаясь на Microsoft Excel&reg;" >}}
