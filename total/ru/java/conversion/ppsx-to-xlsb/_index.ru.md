---
title: Преобразование PPSX в формат XLSB через Java
description: Преобразуйте формат PPSX в XLSB через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в XLSB через Java" h2="Локальный Java API для экспорта PPSX в XLSB без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
