...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать POT в XLT через Java" h2="Локальный Java API для экспорта POT в XLT без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
