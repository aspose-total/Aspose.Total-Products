---
title: Преобразование POT в формат DIF через Java
description: Преобразуйте формат POT в DIF через Java без использования Microsoft Excel или PowerPoint.
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать POT в DIF через Java" h2="Локальный Java API для экспорта POT в DIF без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
