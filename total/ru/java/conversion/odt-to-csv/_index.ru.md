---
title: Java API для преобразования ODT в CSV
description: Преобразование ODT в CSV через Java без использования Microsoft Word или Microsoft Excel
url: /ru/java/conversion/odt-to-csv/
family: total
platformtag: net
feature: conversion
informat: ODT
...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать ODT в CSV через Java" h2="Локальный Java API для преобразования ODT в CSV без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C++ API для преобразования ODT в CSV" %}}
...
4. Сохраните документ в формате CSV с помощью [Сохранить](https://apireference.aspose.com/cells/java/com.aspose.cells/workbook#save(java.lang.String,%20com.aspose.cells. SaveOptions)) метод
