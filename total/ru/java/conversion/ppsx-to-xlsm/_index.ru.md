...
{{< blocks/products/pf/i18n/feature-page-header h1="Конвертировать PPSX в XLSM через Java или онлайн" h2="Локальный Java API для экспорта PPSX в XLSM без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
