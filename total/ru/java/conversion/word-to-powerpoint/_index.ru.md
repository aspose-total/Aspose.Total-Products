---
title: Преобразование WORD в POWERPOINT через Java
description: Java API для экспорта WORD в POWERPOINT без использования Microsoft Word или PowerPoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование WORD в POWERPOINT через Java" h2="Преобразование WORD в POWERPOINT с помощью локального Java API в любых приложениях Java J2SE, J2EE, J2ME без использования Microsoft<sup>&reg;</sup> PowerPoint или Word" >}}
...
Для преобразования файлов WORD в POWERPOINT вы можете легко использовать Aspose.Total для Java непосредственно из [Maven](https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-total) и включите библиотеки в ваш pom.xml.
