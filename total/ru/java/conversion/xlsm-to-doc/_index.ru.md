---
title: Преобразование XLSM в DOC с помощью Java
description: Java API для экспорта XLSM в DOC с использованием Excel или Word
...
{{< blocks/products/pf/i18n/feature-page-header h1="Java API для экспорта XLSM в DOC" h2="Локальный Java API для экспорта XLSM в DOC, не полагаясь на Microsoft Excel&reg;" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/net/conversion/xlsm-to-docx/" name="XLSM К DOCX" description="" >}}
