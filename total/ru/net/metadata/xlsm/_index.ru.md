---
title: Просмотр и обновление свойств XLSM в Интернете или обновление метаданных с помощью .NET.
description: Просматривайте и изменяйте свойства XLSM через онлайн-приложение бесплатно. Код API C# .NET для обновления и добавления свойств XLSM.
...
{{< blocks/products/pf/feature-page-header-widget h1="Просмотр или обновление метаданных XLSM онлайн или обновление через .NET." h2="Разработайте мощное приложение для управления метаданными документов XLSM на базе .NET.Перечислен код для добавления и изменения метаданных файла XLSM через .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Управление свойствами XLSM через .NET" %}}

1. Создайте класс рабочей книги.
1. Доступ к свойствам, определенным системой, с помощью встроенных свойств документа.
1. Назначьте обновленные значения, такие как Язык.
...
{{% blocks/products/pf/agp/code-block title="Код .NET: обновление метаданных XLSM" offSpacer="" %}}

{{< gist "aspose-com-gists" "4a24d575e6a00d294868ca9df12f21ae" "manage-system-defined-excel-file-metadata.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Код .NET: добавление пользовательских свойств XLSM" offSpacer="" %}}
...
<h2>Разработка приложения управления метаданными XLSM через .NET.</h2>

Вам нужно разработать приложение или утилиту для управления метаданными XLSM?Благодаря [Aspose.Cells for .NET](https://products.aspose.com/cells/ru/net/), дочернему API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API в свое приложение метаданных документа.Мощная библиотека .NET позволяет программировать любое решение для метаданных документов.Более того, он может поддерживать многие популярные форматы, включая формат XLSM.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для управления метаданными XLSM" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
## 🧠 Применение макросов в рабочей книге (.xlsm)

- Определить книги работы с активными скриптами за счет встроенных метаданных.  
- Помочь команде по соблюдению требований к стандартам классифицировать и аудитировать использование макросов.  
- Поддерживать алармы, триггерные на основе метаданных для чувствительных финансовых моделей.
