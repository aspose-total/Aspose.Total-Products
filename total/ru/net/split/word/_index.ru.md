---
title: Разделить файл Word онлайн или через .NET
description: Бесплатное онлайн-приложение для разделения различных файлов Word. Код библиотеки разделителя .NET C# для документов Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Разделите файлы Word онлайн через приложение Splitter или с помощью .NET." h2="Разрабатывайте мощные приложения для разделения документов Word на базе .NET. Свободно разделяйте документы, включая файлы Word, онлайн через приложение с мгновенной загрузкой." >}}


{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Разделите файлы Word онлайн с помощью приложения" %}}

1. Загрузите файл Word в Split.
...
{{% blocks/products/pf/agp/feature-section-col title="Разделить файл Word через .NET" %}}

1. Загрузите документ Word, используя класс Document.
1. Получите общее количество страниц, используя счетчик страниц.
1. Прокрутите каждую страницу и используйте ExtractPages для извлечения страницы.
1. Сохраните извлеченную страницу в новый файл Word.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Код .NET: разделение файлов Word постранично" offSpacer="" %}}
...
<h2>Разработка приложения для разделения файлов Word с использованием .NET.</h2>

Вам нужно разработать сценарий .NET или служебное приложение для простого разделения файлов Word?С помощью [Aspose.Words for .NET](https://products.aspose.com/words/ru/net/), дочернего API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой разработчик .NET может интегрировать приведенный выше код API в приложение-разделитель программ. Мощная библиотека .NET для разделения документов поддерживает множество популярных форматов, включая формат Word, например файлы PDF, Word, Excel и PowerPoint.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Библиотека разделителя Word для .NET" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Да, вы можете скачать этот код.Можно легко разработать профессиональное решение для разделения файлов Word с использованием .NET.Используйте API-интерфейс сплиттера Aspose Word для разработки высокоуровневого независимого от платформы программного обеспечения в .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Безопасно ли использовать онлайн-приложение для разделения нескольких документов Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Вы можете использовать любой современный веб-браузер, например Google Chrome, Firefox, Opera или Safari, для онлайн-разделения документов Word.</span>
                      </div>
                  </li>
 		  
 		  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Сколько времени занимает разделение файлов Word?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
