---
title: Файлы водяных знаков ODT онлайн или с использованием .NET
description: Бесплатное онлайн-приложение для нанесения водяных знаков на различные файлы ODT.Код C# библиотеки водяных знаков .NET для документов ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Файл водяного знака ODT онлайн через приложение для создания водяных знаков и через приложения .NET." h2="Разрабатывайте мощные приложения для создания водяных знаков в документах ODT на базе .NET.Бесплатно ставьте водяные знаки на различные документы, включая файлы ODT, онлайн через приложение с мгновенной загрузкой." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Файл водяного знака ODT через .NET" %}}
...
1. Используйте SetText для текстового текста водяного знака.
1. Вызовите метод Save и получите файл ODT с водяным знаком.
1. В случае водяного знака изображения используйте метод ImageWatermarkOptions и SetImage.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/code-block title="Код .NET: добавление текстовых водяных знаков в файлы ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "cecbed9c9305a305ce3a43a933b1e3b5" "insert-text-based-watermark-in-word-documents.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Код C#: добавление водяного знака изображения в файлы ODT" offSpacer="" %}}
...
<h2>Разработка приложения для создания водяных знаков в файлах ODT с использованием .NET.</h2>

Вам нужно разработать служебное приложение .NET, позволяющее легко создавать водяные знаки для нескольких файлов ODT?С помощью [Aspose.Words for .NET](https://products.aspose.com/words/ru/net/), дочернего API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой разработчик .NET может интегрировать приведенный выше код API для программирования приложения с водяными знаками в документах.Мощная библиотека .NET для нанесения водяных знаков на документы поддерживает множество популярных форматов, включая формат ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Библиотека водяных знаков .NET для файлов ODT" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
ODT — это открытый формат документа обработки текста, используемый в LibreOffice и аналогичных инструментах.

**Настоящие случаи использования включают:**

- Обозначение публичных, приватных или внутренних документов,
- Показвание совместного владения или циклов отзывов,
- Включение имени организации или информации о открытом лицензионном соглашении,
- Определение документов для выпуска в общественный сектор,
- Поддержка контроля версий в многодокументах с несколькими авторами.
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Да, вы можете скачать этот код. Можно легко разработать профессиональное решение для файла водяного знака ODT, используя .NET.Используйте API водяных знаков Aspose ODT для разработки высокоуровневого независимого от платформы программного обеспечения в .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
