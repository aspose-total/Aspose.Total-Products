---
title: Редактируйте документ PDF онлайн или с помощью .NET.
description: Откройте и отредактируйте документ PDF онлайн через приложение бесплатно. Код .NET API C# для поиска и замены текста PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Редактируйте документ PDF онлайн или через .NET." h2="Разработайте мощное приложение для редактирования документов PDF на базе .NET.Код C# указан для поиска и замены текста в файле PDF через .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Редактировать документ PDF онлайн" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Редактировать файл PDF через .NET" %}}

1. Добавить ссылку на библиотеку в проект .NET
1. Загрузите файл PDF, используя класс Document
1. Используйте объект класса TextFragmentAbsorber с условиями поиска в качестве параметра.
1. Получить все TextFragments в TextFragmentCollection.
1. Перебрать каждую коллекцию фрагментов.
1. Определите RedactionAnnotation и вызовите метод Redact().
...
{{% blocks/products/pf/agp/code-block title="Код C#: Редактирование файла PDF" offSpacer="" %}}
...
<h2>Разработка приложения редактирования PDF через .NET</h2>

Вам нужно разработать приложение или утилиту для редактирования PDF?Благодаря тому, что [Aspose.PDF for .NET](https://products.aspose.com/pdf/ru/net/) является дочерним API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API в свое приложение для редактирования документов.Мощная библиотека .NET позволяет программировать любое решение для редактирования документов. Более того, он может поддерживать многие популярные форматы, включая формат PDF.<br /><br />
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Безопасно ли использовать онлайн-приложение для управления редактированием документов PDF?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Вы можете использовать любой современный веб-браузер, например Google Chrome, Firefox, Opera или Safari, для онлайн-редактирования документов PDF.Однако, если вы разрабатываете настольное приложение, мы рекомендуем использовать API обработки документов Aspose.Total для эффективного управления.</span>
                      </div>
                  </li>
              </ul>
          </div>
