---
title: Редактируйте электронную таблицу XLS онлайн или с помощью .NET.
description: Откройте и отредактируйте документ XLS онлайн через приложение бесплатно. Код .NET API C# для поиска и замены текста XLS.
...
{{< blocks/products/pf/feature-page-header-widget h1="Редактируйте документ XLS онлайн или через .NET." h2="Разработайте мощное приложение для редактирования документов XLS на базе .NET. Код C# указан для поиска и замены текста в файле XLS." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Редактировать файл XLS через .NET" %}}
...
{{% blocks/products/pf/agp/code-block title="Код C#: Редактирование электронной таблицы XLS" offSpacer="" %}}
...
<h2>Разработка приложения редактирования XLS через .NET</h2>

Вам нужно разработать приложение или утилиту для редактирования XLS? Благодаря тому, что [Aspose.Cells for .NET](https://products.aspose.com/cells/ru/net/) является дочерним API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API в свое приложение для редактирования документов. Мощная библиотека .NET позволяет программировать любое решение для редактирования электронных таблиц. Более того, он может поддерживать многие популярные форматы, включая формат XLS.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для редактирования файла XLS" %}}
