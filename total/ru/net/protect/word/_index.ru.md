---
title: Защитите документ Word онлайн паролем и с помощью .NET.
description: Онлайн-приложение для защиты паролем файлов Word. Код C# .NET API для применения защиты паролем к документу Word.
...
{{< blocks/products/pf/feature-page-header-widget h1="Защита документов Word онлайн или установка пароля через .NET" h2="Разработайте мощное приложение для защиты документов Word на базе .NET.Перечислен код для применения пароля к документу Word через .NET." >}}
...
{{% blocks/products/pf/agp/code-block title="Код .NET: защита документа Word паролем" offSpacer="" %}}
...
<h2>Разработка приложения для защиты паролем Word через .NET</h2>
...
{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для обработки файла Word для приложения защиты" %}}
