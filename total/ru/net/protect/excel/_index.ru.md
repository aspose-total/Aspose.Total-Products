---
title: Защитите документ Excel онлайн паролем и с помощью .NET.
description: Онлайн-приложение для защиты паролем файлов Excel.Код API .NET C# для применения защиты паролем к электронным таблицам Excel.
...
{{< blocks/products/pf/feature-page-header-widget h1="Защита документов Excel онлайн или установка пароля через .NET" h2="Разработайте мощное приложение для защиты документов Excel на базе .NET.Перечислен код для применения пароля к электронной таблице Excel через .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Защита паролем Excel через .NET" %}}

1. Загрузите файл Excel через объект класса Workbook.
1. Вызов SetEncryptionOptions с EncryptionType
1. Назначьте пароль с помощью Settings.Password.
...
{{% blocks/products/pf/agp/code-block title="Код .NET: защита документа Excel паролем" offSpacer="" %}}
...
<h2>Разработка приложения для защиты паролем Excel через .NET</h2>

Вам нужно разработать приложение или утилиту для защиты паролем Excel?Благодаря тому, что [Aspose.Cells for .NET](https://products.aspose.com/cells/ru/net/) является дочерним API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой разработчик .NET может интегрировать приведенный выше код API в свое приложение для защиты документов.Мощная библиотека .NET позволяет программировать любое решение для защиты документов паролем для защиты и блокировки файлов.Более того, он может поддерживать многие популярные форматы, включая формат Excel.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для обработки файла Excel для приложения защиты" %}}
