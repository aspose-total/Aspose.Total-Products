---
title: Поворот документов PNG онлайн или с помощью .NET
description: Поверните документ PNG через онлайн-приложение бесплатно.Код .NET API C# для поворота файлов PNG.
...
{{< blocks/products/pf/feature-page-header-widget h1="Поворот документа PNG онлайн или через .NET" h2="Разработайте мощное приложение для ротации документов PNG на базе .NET.Перечислен код для поворота файла PNG через .NET." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Поворот PNG онлайн" %}}

1. Импортируйте файл PNG, чтобы разблокировать его, загрузив его.
...
{{% blocks/products/pf/agp/feature-section-col title="Поворот файла PNG через .NET" %}}

1. Загрузите файл PNG с помощью Image.Load.
...
{{% blocks/products/pf/agp/code-block title="Код .NET: поворот файлов PNG" offSpacer="" %}}
...
<h2>Разработка приложения ротации PNG через .NET</h2>

Вам нужно разработать приложение или утилиту для ротации PNG?Благодаря [Aspose.Imaging for .NET](https://products.aspose.com/imaging/ru/net/), дочернему API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API в свое приложение ротации документов.Мощная библиотека .NET позволяет программировать любое решение для ротации документов.Более того, он может поддерживать многие популярные форматы, включая формат PNG.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для управления ротацией PNG" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
- Исправление ориентации элементов интерфейса (например, кнопок, иконок).  
- Аjustирование скриншотов для документации или презентаций.  
- Aligning marketing banners for vertical or horizontal display.
      ...
      <div class="howtosection col-md-8">
          <div>
              ...
              <ul>
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
                          <span itemprop="name"><b>Безопасно ли использовать онлайн-приложение для поворота документа PNG?</b></span>
                      </div>
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  ...
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Вы можете использовать любой современный веб-браузер, например Google Chrome, Firefox, Opera или Safari, для онлайн-ротации документов PNG.Однако, если вы разрабатываете настольное приложение, мы рекомендуем использовать API обработки документов Aspose.Total для эффективного управления.</span>
                      </div>
                  </li>
              </ul>
          </div>
