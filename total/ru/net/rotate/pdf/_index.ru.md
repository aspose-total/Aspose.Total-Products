---
title: Поворот документов PDF онлайн или с помощью .NET
description: Поверните документ PDF через онлайн-приложение бесплатно. Код .NET API C# для ротации файлов PDF.
...
{{< blocks/products/pf/feature-page-header-widget h1="Поворот документа PDF онлайн или через .NET" h2="Разработайте мощное приложение для ротации документов PDF на базе .NET. Перечислен код для поворота файла PDF через .NET." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Поворот файла PDF через .NET" %}}

1. Загрузите файл PDF, используя класс Document
1. Перебирать каждую страницу
1. Назначайте различные свойства, включая угол поворота
...
{{% blocks/products/pf/agp/code-block title="Код .NET: поворот страниц документа PDF" offSpacer="" %}}
...
<h2>Разработка приложения ротации PDF через .NET</h2>

Вам нужно разработать приложение или утилиту для ротации PDF?Благодаря [Aspose.PDF for .NET](https://products.aspose.com/pdf/ru/net/), дочернему API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API в свое приложение ротации документов.Мощная библиотека .NET позволяет программировать любое решение для ротации документов.Более того, он может поддерживать многие популярные форматы, включая формат PDF.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для управления ротацией PDF" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
- Проверить правильное отображение сканированных PDF-документов контрактов или факур.  
- Проверить ориентацию сертификатов и лицензий в портфолио.  
- Проверить ориентацию страниц для оптимизации печатного формата в буклетах или руководствах.
