---
title: Обновить файл XLT с помощью .NET
description: Изменяйте документы XLT в приложениях C# VB.NET без использования Microsoft Excel. 
url: /ru/net/update/xlt/
family: total
platformtag: .NET
feature: update
informat: XLT
...
{{< blocks/products/pf/feature-page-header h1="Обновите файл XLT через .NET" h2="Изменяйте электронные таблицы XLT с помощью приложений на основе .NET, не устанавливая Microsoft Office<sup>&reg;</sup>." >}}

{{% blocks/products/pf/feature-page-summary %}}

Для разработчика, который пытается обновить файлы XLT через приложение .NET? [Aspose.Total for .NET](https://products.aspose.com/total/net/) API может помочь автоматизировать процесс обновления. Это полный пакет различных API-интерфейсов .NET, работающих с различными форматами, включая файлы Microsoft Excel. ASPOSE.CELL API, который является частью пакета [Aspose.Total for .NET](https://products.aspose.com/total/net/), упрощает этот процесс модификации. Ниже показан процесс обновления документа XLT.

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Как обновить файл XLT в .NET" %}}

- Создайте новый объект класса [Workbook](https://reference.aspose.com/cells/net/aspose.cells/workbook/) с исходным файлом XLT в качестве параметра.
...
- Сохраните файл как файл .xlt, используя метод save(), передав файл с путем в качестве параметра.

{{% /blocks/products/pf/agp/feature-section-col %}}

{{% blocks/products/pf/agp/feature-section-col title="Требования к модификации" %}}

- Для модификации XLT Microsoft Windows или совместимая ОС с платформами .NET, .NET Core, Mono или Xamarin.
...
{{% blocks/products/pf/agp/code-block title="Код — обновить файл XLT в .NET" offSpacer="" %}}
