---
title: C# API для экспорта EMAIL в RTF
description: Преобразование EMAIL в RTF без использования Microsoft Word или Outlook на .NET
url_ignore: /ru/net/conversion/email-to-rtf/
family: total
platformtag: net
feature: conversion
informat: MSG
...
{{< blocks/products/pf/i18n/feature-page-header h1="Экспорт EMAIL в RTF через .NET" h2=".NET API для преобразования электронной почты в RTF в Windows, macOS и Linux без использования Word или Outlook" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования EMAIL в RTF" %}}
