---
title: Преобразование PPTX в XLSX через C#
description: Преобразование PPTX в XLSX на C# без использования Microsoft Excel или Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование PPTX в XLSX через C#" h2=".NET API для преобразования PPTX в XLSX без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
