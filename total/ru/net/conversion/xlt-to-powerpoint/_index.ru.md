...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать XLT в POWERPOINT через C# или онлайн" h2="Экспорт Excel&reg; XLT в POWERPOINT на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
