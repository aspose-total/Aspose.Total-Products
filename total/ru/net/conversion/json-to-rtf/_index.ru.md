...
url: /ru/net/conversion/json-to-rtf/
family: total
platformtag: net
feature: conversion
informat: JSON
...
4. Сохраните документ в формате RTF, используя метод [Сохранить](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/3).
