...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Конвертировать XLT в WORD через C# или онлайн-приложение" h2="Экспорт Excel&reg; XLT в WORD на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
