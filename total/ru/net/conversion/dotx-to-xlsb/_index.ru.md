...
description: C# API для преобразования DOTX в XLSB без использования Microsoft Excel или Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API для преобразования DOTX в XLSB" h2="Экспорт DOTX в XLSB с помощью C# без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
