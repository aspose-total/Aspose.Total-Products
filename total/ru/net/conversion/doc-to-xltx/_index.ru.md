...
description: C# API для преобразования DOC в XLTX без использования Microsoft Excel или Adobe Reader
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API для преобразования DOC в XLTX" h2="Экспорт DOC в XLTX с помощью C# без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
