...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг SVG в PCL через .NET" h2=".NET API для экспорта SVG в PCL в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования SVG в PCL" %}}
