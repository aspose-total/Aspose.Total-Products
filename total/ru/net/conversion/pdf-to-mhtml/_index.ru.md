---
title: C# API для экспорта PDF в MHTML
description: Преобразование PDF в MHTML без использования Microsoft Word
url_ignore: /ru/net/conversion/pdf-to-mhtml/
family: total
platformtag: net
feature: conversion
informat: PDF
...
{{< blocks/products/pf/i18n/feature-page-header h1="Рендеринг PDF в MHTML через .NET" h2=".NET API для экспорта PDF в MHTML в Windows, macOS и Linux без использования Microsoft Word" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# API для преобразования PDF в MHTML" %}}
