...
description: Преобразование XLSX в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.
url: /ru/net/conversion/xlsx-to-doc/
family: total
platformtag: net
feature: conversion
informat: XLSX
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLSX в DOC через C#" h2="Экспорт Excel&reg; XLSX в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
