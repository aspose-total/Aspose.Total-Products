...
<iframe title="Бесплатное онлайн-приложение для конвертации SVG в PPSM" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppsm&from=svg" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Конвертировать SVG в PPSM через C# .NET" offSpacer="" %}}
