---
title: Преобразование PPSM в формат JSON через .NET
description: Преобразование PPSM в JSON на C# без использования Microsoft Excel или Powerpoint
url_ignore: /ru/net/conversion/ppsm-to-json/
family: total
platformtag: net
feature: conversion
informat: PPSM
...
2. Преобразуйте PPSM в HTML, используя метод [Сохранить](https://apireference.aspose.com/slides/net/aspose.slides.presentation/save/methods/5).
...
{{% blocks/products/pf/feature-page-section  h2="Преобразование PPSM в JSON в диапазоне через C#" %}}
