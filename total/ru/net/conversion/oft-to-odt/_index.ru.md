...
4. Сохраните документ в формате ODT с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Odt в качестве формата сохранения.
