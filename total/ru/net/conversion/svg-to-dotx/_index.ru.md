...
<iframe title="Бесплатное онлайн-приложение для конвертации SVG в DOTX" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=dotx&from=svg" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Конвертировать SVG в DOTX через C# .NET" offSpacer="" %}}
