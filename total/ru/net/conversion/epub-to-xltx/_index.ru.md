---
title: Преобразование EPUB в XLTX через C# API
description: C# API для преобразования файла EPUB в XLTX без использования Microsoft Excel или Adobe Reader
url_ignore: /ru/net/conversion/epub-to-xltx/
family: total
platformtag: net
feature: conversion
informat: EPUB
...
{{< blocks/products/pf/i18n/feature-page-header h1="C# API для рендеринга EPUB в XLTX" h2="Экспорт файла EPUB в XLTX с помощью C# без использования Microsoft<sup>&reg;</sup> Excel или Adobe<sup>&reg;</sup> Acrobat Reader" >}}
...
{{% blocks/products/pf/agp/feature-section-col title=".NET API для преобразования EPUB в XLTX" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Преобразование защищенного EPUB в XLTX через C#" %}}
...
{{% blocks/products/pf/feature-page-section  h2="Преобразование файла EPUB в XLTX с водяным знаком через C#" %}}
