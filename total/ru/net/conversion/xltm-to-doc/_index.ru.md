...
description: Преобразование XLTM в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.
...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование XLTM в DOC через C#" h2="Экспорт Excel&reg; XLTM в DOC на платформах .NET Framework, .NET Core, Mono или Xamarin.">}}
