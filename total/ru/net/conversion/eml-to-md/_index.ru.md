...
4. Сохраните документ в формате MD с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Md в качестве формата сохранения.
