...
4. Сохраните документ в формате JPEG с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Jpeg в качестве формата сохранения.
