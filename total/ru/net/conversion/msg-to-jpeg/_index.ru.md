...
url: /ru/net/conversion/msg-to-jpeg/
family: total
platformtag: net
feature: conversion
informat: MSG
...
4. Сохраните документ в формате JPEG с помощью метода [Сохранить](https://apireference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Jpeg в качестве формата сохранения.
