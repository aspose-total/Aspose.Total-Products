...
<iframe title="Бесплатное онлайн-приложение для конвертации XPS в OTT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ott&from=xps" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Конвертировать XPS в OTT через C# .NET" offSpacer="" %}}
