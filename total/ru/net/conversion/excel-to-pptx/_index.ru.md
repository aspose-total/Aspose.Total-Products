...
{{< blocks/products/pf/agp/upper-banner-autogen h1="Преобразование EXCEL в PPTX через C# или онлайн-приложение" h2="Экспорт Excel&reg; EXCEL в PPTX на платформах .NET Framework, .NET Core, Mono или Xamarin">}}
