...
4. Сохраните документ в формате BMP с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Bmp в качестве формата сохранения.
