---
title: Преобразование PPTX в SXC через C#
description: Преобразование PPTX в SXC на C# без использования Microsoft Excel или Powerpoint
url: /ru/net/conversion/pptx-to-sxc/
family: total
platformtag: net
feature: conversion
informat: PPTX
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование PPTX в SXC через C#" h2=".NET API для преобразования PPTX в SXC без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
