---
title: Преобразование PPTM в TSV через C#
description: Преобразование PPTM в TSV на C# без использования Microsoft Excel или Powerpoint
...
{{< blocks/products/pf/i18n/feature-page-header h1="Преобразование PPTM в TSV через C#" h2=".NET API для преобразования PPTM в TSV без использования Microsoft<sup>&reg;</sup> Excel или PowerPoint" >}}
...
4. Сохраните документ в формате TSV, используя метод [Сохранить](https://apireference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4).
