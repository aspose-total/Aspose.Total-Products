...
4. Сохраните документ в формате WORD с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Word в качестве формата сохранения.
