...
4. Сохраните документ в формате TEXT с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Text в качестве формата сохранения.
