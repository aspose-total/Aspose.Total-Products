...
4. Сохраните документ в формате SVG с помощью метода [Сохранить](https://reference.aspose.com/words/net/aspose.words.document/save/methods/4) и установите Svg в качестве формата сохранения.
