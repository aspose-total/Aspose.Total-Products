...
<iframe title="Бесплатное онлайн-приложение для конвертации TEX в PPT" style="border: none; height: 426px;" scrolling="no" src="https://total-conversion-app-65z5r2lp.qa.k8s.dynabic.com/?to=ppt&from=tex" id="child-iframe" width="80%"></iframe>
...
{{% blocks/products/pf/agp/code-block title="Конвертировать TEX в PPT через C# .NET" offSpacer="" %}}
