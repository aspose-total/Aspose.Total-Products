...
4. Сохраните документ в формате TSV с помощью метода [Сохранить](https://reference.aspose.com/cells/net/aspose.cells.workbook/save/methods/4) и установите `Tsv` в качестве SaveFormat.
