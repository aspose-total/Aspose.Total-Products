---
title: Извлеките текст и изображения из файла ODT онлайн и используйте .NET.
description: Онлайн-приложение для парсера файлов ODT. Код .NET API C# для извлечения изображений и текстового содержимого из документа ODT.
...
{{< blocks/products/pf/feature-page-header-widget h1="Анализ файла ODT онлайн, а также через .NET" h2="Разработайте мощное приложение для анализа документов ODT на базе .NET. Код C# указан для извлечения текста документа ODT." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Разбор файла ODT через .NET" %}}

1. Добавить ссылку на библиотеку в проект .NET
1. Загрузите файл ODT, используя объект класса Document.
1. Получите все дочерние узлы, используя GetChildNodes().
1. Используйте NodeType.Shape в качестве параметра
1. Перебрать каждый узел и сохранить изображение.
1. Для извлечения текста пройдитесь по каждой странице.
1. Вызов метода ExtractPages
1. Сохраните извлеченный файл в текст, используя метод Node.ToString.
...
{{% blocks/products/pf/agp/code-block title="Код C#: извлечение изображений документов ODT" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-images-from-word-document.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Код C#: извлечение текста документа ODT" offSpacer="" %}}
...
<h2>Разработка приложения для анализа файлов ODT через .NET.</h2>

Вам необходимо разработать приложение или программное обеспечение для анализатора ODT?Благодаря тому, что [Aspose.Words for .NET](https://products.aspose.com/words/ru/net/) является дочерним API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой разработчик .NET может интегрировать приведенный выше код API в свое приложение для анализа документов.Мощная библиотека .NET позволяет программировать любое решение для анализа документов для извлечения изображений, а также текста.Более того, он может поддерживать многие популярные форматы, включая формат ODT.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для обработки файла ODT для приложения синтаксического анализатора" %}}
