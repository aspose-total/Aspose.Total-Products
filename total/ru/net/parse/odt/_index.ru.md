...
{{% blocks/products/pf/feature-page-summary %}}
## Примеры парсинга файлов .odt

- 📄 Извлечь текст, изображения и метаданные из OpenDocument Text файлов.
- 🧾 Перевести файлы OpenDocument (.odt) в форматы HTML, Markdown или PDF для публикации.
- 📚 Архивировать открыть форматы документов открытого источника, конвертируя и индексируя содержание.
