---
title: Извлеките текст и изображения из файла PPTX онлайн и используйте .NET.
description: Онлайн-приложение для парсера файлов PPTX. Код .NET API C# для извлечения изображений и текста из презентации PPTX.
...
{{< blocks/products/pf/feature-page-header-widget h1="Анализ файла PPTX онлайн, а также через .NET" h2="Разработайте мощное приложение для анализа презентаций PPTX на базе .NET. Код C# указан для анализа PPTX." >}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Разбор презентации PPTX через онлайн-приложение" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Разбор презентации PPTX через .NET" %}}

1. Добавить ссылку на библиотеку в проект .NET
1. Загрузите файл PPTX, используя объект класса Presentation.
...
{{% blocks/products/pf/agp/code-block title="Код C#: Извлечение текста презентации PPTX" offSpacer="" %}}

{{< gist "aspose-com-gists" "ab98758eea66dd544d4a7964d10ec4fc" "extract-text-from-powerpoint-presentation.cs" >}}

{{% /blocks/products/pf/agp/code-block %}}

{{% blocks/products/pf/agp/code-block title="Код C#: извлечение изображений презентации PPTX" offSpacer="" %}}
...
<h2>Разработка приложения анализатора презентаций PPTX через .NET.</h2>

Вам необходимо разработать приложение для анализа PPTX? Благодаря тому, что [Aspose.Slides for .NET](https://products.aspose.com/slides/ru/net/) является дочерним API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой разработчик .NET может интегрировать приведенный выше код API в свое приложение для анализа документов.Мощная библиотека .NET позволяет программировать любое решение для анализа документов для извлечения изображений, а также текста.Более того, он может поддерживать многие популярные форматы, включая формат PPTX.<br /><br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Утилита .NET для обработки файла PPTX для приложения синтаксического анализатора" %}}
...
{{% blocks/products/pf/feature-page-summary %}}
1. Извлечь текст слайдов, изображения и метаданные для использования в веб- или приложении.  
2. Автоматизировать процессы генерации и преобразования презентаций.  
3. Перевести .pptx-файлы в HTML, PDF-файлов или интерактивных форматов.
