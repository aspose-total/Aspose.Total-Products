---
title: Объедините файлы XLS онлайн или с помощью .NET.
description: Бесплатное онлайн-приложение для объединения различных файлов XLS.Код библиотеки слияния C# .NET для объединения листов XLS в другие форматы.
...
{{< blocks/products/pf/feature-page-header-widget h1="Объедините документы XLS онлайн через приложение Merger или с помощью .NET." h2="Разработайте мощное приложение для объединения документов XLS на базе .NET.Объедините несколько документов XLS в один онлайн бесплатно через приложение.Сохраните объединенный файл XLS в формате PDF, изображений, Word, Excel, PowerPoint и многих других форматах онлайн." >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Объединить файл XLS через .NET" %}}

1. Загрузите оба XLS, используя объекты класса Workbook.
...
{{% blocks/products/pf/agp/code-block title="Код .NET: объединение файлов XLS" offSpacer="" %}}
...
<h2>Разработка средства слияния файлов XLS с использованием .NET.</h2>

Вам нужно разработать служебное приложение .NET для простого объединения нескольких файлов XLS?С помощью [Aspose.Cells for .NET](https://products.aspose.com/cells/ru/net/), дочернего API [Aspose.Total for .NET](https://products.aspose.com/total/ru/net/), любой .NET-разработчик может интегрировать приведенный выше код API для легкого объединения документов.Мощная библиотека .NET для объединения документов поддерживает множество популярных форматов, включая формат XLS.<br />

{{% /blocks/products/pf/feature-page-summary %}}

{{< blocks/products/pf/agp/feature-section >}}
{{% blocks/products/pf/agp/feature-section-col title="Библиотека слияния .NET для файлов XLS" %}}
               ...
               <ul>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      ...
                      <div itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                          <span itemprop="text">Да, вы можете скачать этот код. Можно разработать профессиональное решение для объединения XLS с использованием .NET.Используйте API-интерфейс слияния XLS для разработки высокоуровневого платформонезависимого программного обеспечения в .NET.</span>
                      </div>
                  </li>
                  <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                      <div>
