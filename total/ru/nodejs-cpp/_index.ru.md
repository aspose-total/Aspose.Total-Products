---
title: Манипулирование PDF-файлами и добавление оптического распознавания символов через API-интерфейсы Node.js
description: API Node.js для управления PDF-файлами, а также извлечения текста из изображений с помощью приложений.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js API для извлечения текста из PDF и изображений" h2="Извлечение текста из изображений, а также включение функций манипулирования PDF в приложения Node.js без каких-либо других программных зависимостей." logoImageSrc="/total/images/aspose_total-for-nodejs-cpp-header.svg" pfName="Aspose.Total" subTitlepfName="for Node.js via C++" downloadUrl="https://releases.aspose.com/total/nodejs-cpp" >}}
...
Aspose.Total for Node.js via C++ — это комплексный набор библиотек Node.js.Эти библиотеки предлагают такие функции, как работа напрямую с PDF-файлами и расширение возможностей ваших приложений для преобразования изображений в текст.

{{< /blocks/products/pf/total/overview >}}

{{< blocks/products/pf/total/products description="Aspose.Total for Node.js via C++ включает следующие библиотеки Node.js:" >}}
...
Aspose.PDF for Node.js via C++ позволяет вам обрабатывать PDF-файлы на серверной стороне. Используя его, вы можете оптимизировать PDF-файлы, включать и извлекать текст и изображения, а также реализовывать процессы шифрования и дешифрования. Кроме того, функциональность расширяется до возможности легко разделять и объединять PDF-документы, предоставляя комплексный набор инструментов для упрощения работы с PDF-файлами.
...
Aspose.OCR for Node.js via C++ позволяет извлекать текст из изображений, таких как отсканированные страницы и фотографии, на Node.js-совместимых платформах.Усовершенствуйте локальные продукты, веб-сервисы и бессерверные приложения с помощью мощной функции оптического распознавания символов, поддерживающей 28 языков, включая китайский и хинди, в популярных форматах.
{{< /blocks/products/pf/total/product-item >}}
...
Aspose.Font for Node.js via C++ позволяет разработчикам загружать, отображать и сохранять различные форматы шрифтов, включая TrueType, WOFF, EOT, OpenType, CFF и Type1. Разработан для упрощения сложных операций со шрифтами, поэтому разработчики Node.js могут легко сосредоточиться на создании исключительных приложений без хлопот со сложной обработкой шрифтов.
{{< /blocks/products/pf/total/product-item >}}
<!--<p></p>-->
<h2 class="pr-ft">
 <a class="anchor" id="features" name="features">
 </a>
 Обзор Node.js через библиотеки C++
</h2>
   <p>
   </p>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Добавляйте изображения в PDF-документы
 </p>
</div>
<div class="col-lg-4">
...
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Объединить и разделить PDF-файл
 </p>
</div>
<div class="col-lg-4">
 ...
 <p class="col-lg-10">
  Преобразование PDF-файлов в изображения
 </p>
</div>
<div class="col-lg-4">
    <em class="fa fa-file-text-o ico-blue fa-2x col-lg-2">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Прочитайте все изображения из многостраничных документов, папок и архивов.
    </p>
   </div>
   <div class="col-lg-4">
...
Хорошо документированное руководство по эксплуатации и надежность компонентов Aspose.Total привели к простой интеграции в DOCO. Это помогло нам сократить время разработки больше, чем ожидалось.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Брайан Торнтон | ООО «Нет Реакшн», США" >}}
...
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Марк Фоули | Лайон Натан National Foods, Австралия" >}}
По сути, пакет Aspose.Total для .NET — это «швейцарский армейский нож» компонентов, которые мы используем. Находясь рядом с компонентами уровня представления, он образует «клей» для извлечения и передачи файлов данных в желаемом формате.
{{< /blocks/products/pf/testimonials-quote >}}
{{< blocks/products/pf/testimonials-quote poster="Ясин Лудад | Квалетек, Франция" >}}
Реализация была простой, мы действительно уделяем внимание нашей архитектуре, и Aspose просто вписывается. Наша архитектура высоко оптимизирована для производительности и многопоточности, и опять же, использование Aspose.Total.net не представляет никаких проблем.
{{< /blocks/products/pf/testimonials-quote >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Почему Aspose.Total для C++" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Total" description="Aspose.Total предлагает индивидуальные решения для других платформ." >}}
   ...
   {{< blocks/products/pf/offers-section-item link="/total/ru/cpp/" imgSrc="/total/images/aspose_total-for-cpp.svg" sdkName=" C++" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/total/ru/nodejs-java/" 
