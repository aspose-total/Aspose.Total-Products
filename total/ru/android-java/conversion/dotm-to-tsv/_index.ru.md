---
title: Android API для преобразования DOTM в TSV
description: Преобразование DOTM в TSV в Android через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOTM в TSV в приложениях для Android" h2="Экспорт DOTM в TSV на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
