---
title: Android API для преобразования DOTM в XLTX
description: Преобразование DOTM в XLTX в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/dotm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
