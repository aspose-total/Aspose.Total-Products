---
title: Android API для преобразования DOTM в XLTM
description: Преобразование DOTM в XLTM в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/dotm-to-xltm/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOTM в XLTM в приложениях для Android" h2="Экспорт DOTM в XLTM на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
