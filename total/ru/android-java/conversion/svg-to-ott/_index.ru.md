---
title: Android API для рендеринга SVG в OTT
description: Преобразование SVG в OTT через Android через Java API
url: /ru/android-java/conversion/svg-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: SVG
