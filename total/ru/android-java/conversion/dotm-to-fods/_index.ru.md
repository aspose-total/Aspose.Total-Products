---
title: Android API для преобразования DOTM в FODS
description: Преобразование DOTM в FODS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/dotm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOTM в FODS в приложениях для Android" h2="Экспорт DOTM в FODS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
