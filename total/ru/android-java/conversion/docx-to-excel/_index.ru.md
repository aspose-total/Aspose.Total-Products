---
title: Android API для преобразования DOCX в EXCEL
description: Преобразование DOCX в EXCEL в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/docx-to-excel/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCX в EXCEL в приложениях для Android" h2="Экспорт DOCX в EXCEL на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
