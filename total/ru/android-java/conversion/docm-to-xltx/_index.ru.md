---
title: Android API для преобразования DOCM в XLTX
description: Преобразование DOCM в XLTX в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/docm-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCM в XLTX в приложениях для Android" h2="Экспорт DOCM в XLTX на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
