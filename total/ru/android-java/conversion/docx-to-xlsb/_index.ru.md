---
title: Android API для преобразования DOCX в XLSB
description: Преобразование DOCX в XLSB в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/docx-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCX в XLSB в приложениях для Android" h2="Экспорт DOCX в XLSB на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
