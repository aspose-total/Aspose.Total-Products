---
title: Преобразование MHTML в SXC в Android через Java
description: Рендеринг MHTML в SXC на Android через Java API без использования Microsoft Excel или Adobe Reader
url: /ru/android-java/conversion/mhtml-to-sxc/
family: total
platformtag: cpp
feature: conversion
informat: MHTML
...
{{% blocks/products/pf/agp/feature-section-col title="Android API для рендеринга MHTML в SXC" %}}
