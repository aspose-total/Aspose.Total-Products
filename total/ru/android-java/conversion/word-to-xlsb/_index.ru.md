---
title: Android API для преобразования WORD в XLSB
description: Преобразование WORD в XLSB в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/word-to-xlsb/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в XLSB в приложениях для Android" h2="Экспорт WORD в XLSB на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
