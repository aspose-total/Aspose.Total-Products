---
title: Android API для преобразования WORD в XLS
description: Преобразование WORD в XLS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/word-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в XLS в приложениях для Android" h2="Экспорт WORD в XLS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
