---
title: Экспорт XLTM в WORD на Android
description: Android API для преобразования XLTM в WORD без использования Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг XLTM в WORD на Android через Java" h2="Преобразование XLTM в WORD в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
