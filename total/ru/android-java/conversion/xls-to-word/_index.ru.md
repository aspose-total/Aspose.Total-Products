---
title: Экспорт XLS в WORD на Android
description: Android API для преобразования XLS в WORD без использования Microsoft Word
url: /ru/android-java/conversion/xls-to-word/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг XLS в WORD на Android через Java" h2="Преобразование XLS в WORD в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
