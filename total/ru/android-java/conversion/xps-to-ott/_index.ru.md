---
title: Android API для рендеринга XPS в OTT
description: Преобразование XPS в OTT через Android через Java API
url: /ru/android-java/conversion/xps-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: XPS
