---
title: Android API для рендеринга EPUB в OTT
description: Преобразование EPUB в OTT через Android через Java API
url: /ru/android-java/conversion/epub-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: EPUB
