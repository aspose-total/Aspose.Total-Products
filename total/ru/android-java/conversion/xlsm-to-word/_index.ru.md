---
title: Экспорт XLSM в WORD на Android
description: Android API для преобразования XLSM в WORD без использования Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг XLSM в WORD на Android через Java" h2="Преобразование XLSM в WORD в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
