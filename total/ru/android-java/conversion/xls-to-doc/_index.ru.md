---
title: Экспорт XLS в DOC на Android
description: Android API для преобразования XLS в DOC без использования Microsoft Word
url: /ru/android-java/conversion/xls-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: XLS
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг XLS в DOC на Android через Java" h2="Преобразование XLS в DOC в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
