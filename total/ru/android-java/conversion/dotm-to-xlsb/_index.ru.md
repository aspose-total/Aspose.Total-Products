---
title: Android API для преобразования DOTM в XLSB
description: Преобразование DOTM в XLSB в Android через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOTM в XLSB в приложениях для Android" h2="Экспорт DOTM в XLSB на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
