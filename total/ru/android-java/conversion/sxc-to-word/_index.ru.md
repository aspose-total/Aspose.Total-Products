---
title: Экспорт SXC в WORD на Android
description: Android API для преобразования SXC в WORD без использования Microsoft Word
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг SXC в WORD на Android через Java" h2="Преобразование SXC в WORD в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/total/ru/android-java/conversion/sxc-to-wordx/" name="SXC К WORDX" description="" >}}
