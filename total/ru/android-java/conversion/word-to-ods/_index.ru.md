---
title: Android API для преобразования WORD в ODS
description: Преобразование WORD в ODS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/word-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в ODS в приложениях для Android" h2="Экспорт WORD в ODS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
