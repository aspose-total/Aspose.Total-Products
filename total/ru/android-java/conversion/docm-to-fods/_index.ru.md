---
title: Android API для преобразования DOCM в FODS
description: Преобразование DOCM в FODS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/docm-to-fods/
family: total
platformtag: cpp
feature: conversion
informat: DOCM
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCM в FODS в приложениях для Android" h2="Экспорт DOCM в FODS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
