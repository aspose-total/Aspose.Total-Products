---
title: Android API для преобразования DOTM в ODS
description: Преобразование DOTM в ODS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/dotm-to-ods/
family: total
platformtag: cpp
feature: conversion
informat: DOTM
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOTM в ODS в приложениях для Android" h2="Экспорт DOTM в ODS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
