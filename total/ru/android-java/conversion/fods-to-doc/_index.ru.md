---
title: Экспорт FODS в DOC на Android
description: Android API для преобразования FODS в DOC без использования Microsoft Word
url: /ru/android-java/conversion/fods-to-doc/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг FODS в DOC на Android через Java" h2="Преобразование FODS в DOC в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
