---
title: Android API для рендеринга PS в WORDML
description: Преобразование PS в WORDML через Android через Java API
url: /ru/android-java/conversion/ps-to-wordml/
family: total
platformtag: cpp
feature: conversion
informat: PS
