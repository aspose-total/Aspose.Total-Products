---
title: Android API для рендеринга TEX в OTT
description: Преобразование TEX в OTT через Android через Java API
url: /ru/android-java/conversion/tex-to-ott/
family: total
platformtag: cpp
feature: conversion
informat: TEX
