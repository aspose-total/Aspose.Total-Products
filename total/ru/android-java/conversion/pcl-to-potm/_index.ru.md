---
title: Экспорт PCL в POTM в Android
description: Android API для преобразования PCL в POTM без использования Microsoft Word
url: /ru/android-java/conversion/pcl-to-potm/
family: total
platformtag: cpp
feature: conversion
informat: PCL
...
{{% blocks/products/pf/agp/feature-section-col title="Android API для экспорта PCL в POTM" %}}
