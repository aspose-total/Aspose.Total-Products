---
title: Экспорт XLSB в DOCX на Android
description: Android API для преобразования XLSB в DOCX без использования Microsoft Word
url: /ru/android-java/conversion/xlsb-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: XLSB
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг XLSB в DOCX на Android через Java" h2="Преобразование XLSB в DOCX в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
