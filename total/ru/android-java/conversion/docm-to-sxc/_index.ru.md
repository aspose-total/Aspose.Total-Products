---
title: Android API для преобразования DOCM в SXC
description: Преобразование DOCM в SXC в Android через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCM в SXC в приложениях для Android" h2="Экспорт DOCM в SXC на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
