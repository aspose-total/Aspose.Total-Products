---
title: Экспорт FODS в DOCX на Android
description: Android API для преобразования FODS в DOCX без использования Microsoft Word
url: /ru/android-java/conversion/fods-to-docx/
family: total
platformtag: cpp
feature: conversion
informat: FODS
...
{{< blocks/products/pf/feature-page-header h1="Рендеринг FODS в DOCX на Android через Java" h2="Преобразование FODS в DOCX в приложениях для Android без использования Microsoft<sup>&reg;</sup> Excel" >}}
