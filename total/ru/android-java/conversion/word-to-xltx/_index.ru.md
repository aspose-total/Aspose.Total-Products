---
title: Android API для преобразования WORD в XLTX
description: Преобразование WORD в XLTX в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/word-to-xltx/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в XLTX в приложениях для Android" h2="Экспорт WORD в XLTX на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
