---
title: Android API для преобразования DOCX в XLS
description: Преобразование DOCX в XLS в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/docx-to-xls/
family: total
platformtag: cpp
feature: conversion
informat: DOCX
...
{{< blocks/products/pf/feature-page-header h1="Преобразование DOCX в XLS в приложениях для Android" h2="Экспорт DOCX в XLS на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
