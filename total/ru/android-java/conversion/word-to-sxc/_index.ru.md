---
title: Android API для преобразования WORD в SXC
description: Преобразование WORD в SXC в Android через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в SXC в приложениях для Android" h2="Экспорт WORD в SXC на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
