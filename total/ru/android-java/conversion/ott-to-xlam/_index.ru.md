---
title: Android API для преобразования OTT в XLAM
description: Преобразование OTT в XLAM в Android через Java без использования Microsoft Word или Microsoft Excel
...
{{< blocks/products/pf/feature-page-header h1="Преобразование OTT в XLAM в приложениях для Android" h2="Экспорт OTT в XLAM на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
