---
title: Android API для преобразования WORD в CSV
description: Преобразование WORD в CSV в Android через Java без использования Microsoft Word или Microsoft Excel
url: /ru/android-java/conversion/word-to-csv/
family: total
platformtag: cpp
feature: conversion
informat: DOC
...
{{< blocks/products/pf/feature-page-header h1="Преобразование WORD в CSV в приложениях для Android" h2="Экспорт WORD в CSV на Android через Java без использования Microsoft<sup>&reg;</sup> Word или Microsoft<sup>&reg;</sup> Excel" >}}
